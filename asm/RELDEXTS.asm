*          DATA SET RELDEXTS   AT LEVEL 004 AS OF 05/01/02                      
...
* CLEAR IT                                                                      
         ...
         CLI   0(R6),X'08'         TEST FOR ADVERTISER                          
         BE    DOADV                                                            
         CLI   0(R6),X'09'         TEST FOR PRODUCT                             
         BE    DOPRD                                                            
         CLI   0(R6),X'0A'         TEST FOR AGENCY                              
         BE    DOAGY                                                            
         B     DMXPURGE                                                         
*                                                                               
* PROCESS FOR ADVERTISER                                                        
*                                                                               
DOADV    DS    0H                                                               
         USING RADVREC,R6                                                       
         CLC   =C'IR',RADVKREP     MUST BE IR                                   
         BNE   DMXPURGE                                                         
         LA    R3,MISSADV                                                       
*                                                                               
DOADV10  DS    0H                                                               
         CLC   RADVKADV,0(R3)      CHECK CODE                                   
         BNE   DOADV20                                                          
         AP    ADVCOUNT,=P'1'                                                   
         B     PUTREC                                                           
*                                                                               
...
DOPRD    DS    0H                                                               
         USING RPRDREC,R6                                                       
         CLC   =C'IR',RPRDKREP     MUST BE IR                                   
         BNE   DMXPURGE                                                         
         LA    R3,MISSPRD                                                       
*                                                                               
DOPRD10  DS    0H                                                               
         CLC   RPRDKADV(7),0(R3)      CHECK CODE                                
         BNE   DOPRD20                                                          
         AP    PRDCOUNT,=P'1'                                                   
         B     PUTREC                                                           
*                                                                               
...
DOAGY    DS    0H                                                               
         USING RAGYREC,R6                                                       
         CLC   =C'IR',RAGYKREP     MUST BE IR                                   
         BNE   DMXPURGE                                                         
         LA    R3,MISSAGY                                                       
*                                                                               
DOAGY10  DS    0H                                                               
         CLC   RAGYKAGY(6),0(R3)   CHECK CODE                                   
         BNE   DOAGY20                                                          
         AP    AGYCOUNT,=P'1'                                                   
         B     PUTREC                                                           
*                                                                               
...
PUTREC   DS    0H                                                               
         AP    TSTCOUNT,=P'1'                                                   
         B     DMXKEEP             KEEP RECORD BUT COUNT EXTRACTED              
*                                                                               
         LA    RF,REC              DESTINATION                                  
         ZICM  R1,27(R6),2         REC LENGTH                                   
         LA    RE,0(R6)            SOURCE                                       
                                                                                
         MOVE  ((RF),(R1)),(RE)    MOVE RECORD TO OUTPUT AREA                   
...
AGYCOUNT DC    PL5'0'                                                           
         ...
         EJECT                                                                  
*                                                                               
*APEOUT  DCB   DDNAME=TAPEOUT,DSORG=PS,RECFM=VB,MACRF=PM,              X        
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004RELDEXTS  05/01/02'                                      
         END                                                                    
