*          DATA SET REWRK02    AT LEVEL 004 AS OF 05/01/02                      
*          DATA SET REWRK02    AT LEVEL 002 AS OF 09/17/84                      
*PHASE T81102A                                                                  
         TITLE 'REP WRK - FILE DATA RECORD FUNCTIONS'                           
         PRINT NOGEN                                                            
WKRDIS   CSECT                                                                  
         NMOD1 000,**RWK2**                                                     
         LR    RC,R1                                                            
...
*DDFLDHDR                                                                       
       ++INCLUDE DDFLDHDR                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004REWRK02   05/01/02'                                      
         END                                                                    
