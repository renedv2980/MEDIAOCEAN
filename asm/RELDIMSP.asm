*          DATA SET RELDIMSP   AT LEVEL 002 AS OF 05/01/02                      
*PHASE RELDIMSP                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDIMSP - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
***********************************************************************         
*   MAR24/98 (BU ) --- STRIP INTEREP FILES, MOD TO REPFIL9 POWER      *         
*                      CODES FOR                                      *         
*                      ** INTEREP MASTER SALESPERSON **  TESTING      *         
*                                                                     *         
***********************************************************************         
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*   MODIFY ALL REFERENCES TO INTEREP POWER CODES: PROD-->TEST     *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
*                                                                               
         CLC   =C'AQ',0(R7)        ALLIED?                                      
         BNE   DMXREC3             NO                                           
         MVC   0(2,R7),=C'5T'      YES - CHANGE TO 5T (ALLIED/TEST)             
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC3  EQU   *                                                                
         CLC   =C'MG',0(R7)        MCGAVREN?                                    
         BNE   DMXREC4             NO                                           
         MVC   0(2,R7),=C'6T'      YES - CHANGE TO 6T (MCGAV/TEST)              
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC4  EQU   *                                                                
         CLC   =C'IF',0(R7)        INFINITY?                                    
         BNE   DMXREC5             NO                                           
         MVC   0(2,R7),=C'7T'      YES - CHANGE TO 7T (INFINITY/TEST)           
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC5  EQU   *                                                                
         CLC   =C'I2',0(R7)        NONREP?                                      
         BNE   DMXREC6             NO                                           
         MVC   0(2,R7),=C'8T'      YES - CHANGE TO 8T (NONREP/TEST)             
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC6  EQU   *                                                                
         CLC   =C'I8',0(R7)        CABALLERO?                                   
         BNE   DMXREC7             NO                                           
         MVC   0(2,R7),=C'9T'      YES - CHANGE TO 9T (CABRADIO/TEST)           
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC7  EQU   *                                                                
         CLC   =C'I9',0(R7)        SCHUBERT?                                    
         BNE   DMXREC8             NO                                           
         MVC   0(2,R7),=C'T0'      YES - CHANGE TO T0 (SCHUBERT/TEST)           
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC8  EQU   *                                                                
         CLC   =C'RM',0(R7)        RADIO MKTG?                                  
         BNE   DMXREC9             NO                                           
         MVC   0(2,R7),=C'0T'      YES - CHANGE TO 0T (RADIOMKT/TEST)           
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC9  EQU   *                                                                
         CLC   =C'D4',0(R7)        D&R?                                         
         BNE   DMXREC10            NO                                           
         MVC   0(2,R7),=C'1S'      YES - CHANGE TO 1S (D&R/TEST)                
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC10 EQU   *                                                                
         CLC   =C'S1',0(R7)        SHAMROCK?                                    
         BNE   DMXREC11            NO                                           
         MVC   0(2,R7),=C'2S'      YES - CHANGE TO 2S (SHAMROCK/TEST)           
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC11 EQU   *                                                                
         CLC   =C'CN',0(R7)        CLEAR CHANNEL?                               
         BNE   DMXREC12            NO                                           
         MVC   0(2,R7),=C'3S'      YES - CHANGE TO 3S (CLEARCHN/TEST)           
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC12 EQU   *                                                                
         CLC   =C'IB',0(R7)        ABC RADIO?                                   
         BNE   DMXREC1A            NO                                           
         MVC   0(2,R7),=C'R0'      YES - CHANGE TO R0 (ABC RADIO)               
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC1A EQU   *                                                                
         CLC   =C'L7',0(R7)        CABALLERO TV?                                
         BNE   DMXREC13            NO                                           
         MVC   0(2,R7),=C'8S'      YES - CHANGE TO 8S (CABTV/TEST)              
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC13 EQU   *                                                                
         CLC   =C'IR',0(R7)        INTEREP RADIO MASTER?                        
****>>>  BNE   DMXREC14            NO  - SKIP ALL OTHER REPS                    
         BNE   DMXKEEP             NO  - KEEP ALL OTHER REPS                    
         MVC   0(2,R7),=C'7S'      YES - CHANGE TO 7S (MASTER/TEST)             
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC14 EQU   *                                                                
         CLC   =C'B1',0(R7)        TELEMUNDO?                                   
         BNE   DMXREC15            NO  -                                        
         B     DMXPURGE            YES - DROP TO SAVE SPACE                     
DMXREC15 EQU   *                                                                
         CLC   =C'IR',0(R7)        UNIVISON?                                    
         BNE   DMXKEEP             NO  -                                        
         B     DMXPURGE            YES - DROP TO SAVE SPACE                     
         EJECT                                                                  
*******************************************************************             
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002RELDIMSP  05/01/02'                                      
         END                                                                    
