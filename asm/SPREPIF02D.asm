*          DATA SET SPREPIF02D AT LEVEL 006 AS OF 05/01/02                      
*PHASE SPIF02A                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE COVAIL                                                                 
         ...
         SPACE 2                                                                
***********************************************************************         
*        NOTE - THIS PROGRAM ONLY TAKES CARE OF-                                
*               - ZERO STATUS AND INVOICE (ZZ)                                  
*               - STATUS BUT NO INVOICE (NI)                                    
*               - PRD=0, PRD=POL, AND EST=0                                     
*               - STATION NOT OF FILE                                           
*               OTHER ERRORS DEALT WITH IN SPREPIF02                            
*                                                                               
***********************************************************************         
         SPACE 2                                                                
SPIF02   CSECT                                                                  
...
RPT05K   DS    0H                                                               
         MVI   DELSW,C'N'                                                       
*                                                                               
         TM    SCTSTAT,X'80'       IF NO STATUS REC                             
         BZ    RPT30               CAN'T DELETE IT                              
*                                                                               
         CLI   SCTPRD,0            PRD=0 IS ERROR                               
         BE    RPT08                                                            
         CLI   SCTPRD,X'FF'        PRD=POL IS ERROR                             
         BE    RPT08                                                            
         CLI   SCTEST,0            EST=0 IS ERROR                               
         BE    RPT08                                                            
         OC    SCTHOME,SCTHOME     HOME=0 IS ERR (STATION NOT FOUND)            
         BZ    RPT08                                                            
*                                                                               
...
*                                                                               
         ...
         BNE   RPT30                                                            
         OC    SCTHOME,SCTHOME     IF HAVE HOME MKT                             
         BZ    RPT08                                                            
         CLC   SCTHOME,SCTMKT      DON'T DELETE IF NON-HOME MKT??               
         BNE   RPT30                                                            
*                                                                               
RPT08    DS    0H                                                               
         XC    MINMKEY,MINMKEY                                                  
...
*                                                                               
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         MVI   DELSW,C'Y'          SET HAVE DONE DELETE                         
*                                                                               
RPT30    DS    0H                                                               
         B     RPT50                                                            
*                                                                               
RPT50    DS    0H                                                               
         CLI   DELSW,C'Y'          TEST HAVE DONE DELETE                        
         BNE   RPT52                                                            
         GOTO1 REPORT                                                           
*                                                                               
RPT52    DS    0H                                                               
         LA    R4,SCTABDL(R4)      NEXT ENTRY                                   
         BCT   R3,RPT04                                                         
*                                                                               
RPTX     DS    0H                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006SPREPIF02D05/01/02'                                      
         END                                                                    
