*          DATA SET SPREPLR17  AT LEVEL 025 AS OF 05/01/02                      
*PHASE SPLR02B,+0,NOAUTO                                                        
         TITLE 'SPREPLR17 FIX UP ARB BOOK TYPES - TPT'                          
         PRINT NOGEN                                                            
SPLR02   CSECT                                                                  
...
SPLRM1   OC    0(2,RE),0(RE)       DOES MARKET MATCH TABLE                      
         ...
         LA    RE,L'MARKETS(RE)                                                 
         B     SPLRM1                                                           
         CLC   BSBTYP,2(RE)        YES - BYPASS IT                              
         BE    SPLR2                                                            
         CLI   2(RE),C' '          BYPASS NON-FORCED BOOK TYPES                 
         BE    SPLR2                                                            
         MVC   BKTYPE,BSBTYP                                                    
         MVC   BSBTYP,2(RE)                                                     
*                                                                               
...
PSBOOKS  DS    CL80                                                             
       ...
       ++INCLUDE SPREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025SPREPLR17 05/01/02'                                      
         END                                                                    
