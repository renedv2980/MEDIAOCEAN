*          DATA SET SRTRC00S   AT LEVEL 004 AS OF 05/01/02                      
*PHASE T12B00A                                                                  
*INCLUDE TWANG                                                                  
...
*--------------------------------                                               
PROCDSP  XC    SRVP1,SRVP1           NO, JUST A DISPLAY.CLEAR FLD 1             
...
*                                                                               
         ...
         AH    R1,TRCNUM             ADD OFFSET                                 
         ST    R1,TEMP               SAVE ACTUAL NUMBER FOR DISPLAY             
         EDIT  (2,TEMP+2),(4,SRVP1),0,ALIGN=LEFT,ZERO=NOBLANK                   
         OI    SRVP1H+6,X'80'        TRANSMIT FIELD                             
...
GETHDR   ST    RE,RTNADR             SAVE RETURN ADDRESS                        
         ...
         LA    R1,1(R1)              LAST#-FIRST#+1 = NUMBER ENTRIES            
         ST    R1,HDRENTY            SAVE AWAY                                  
*                                                                               
GETHDR2  LH    R1,START              GET REQUESTED ENTRY                        
         LA    R1,1(R1)              ADJUST FOR TESTING                         
...
*                                                                               
         ...
         LH    R1,START              DISPLAY ENTRY #                            
         AH    R1,TRCNUM             ADD OFFSET TO TRACE # BASE                 
         ST    R1,TEMP               SAVE ENTRY #                               
...
*                                                                               
         ...
         MVC   PRTQID,=C'PRTQU '   EXTRACT PRTQ FILE ID                         
         MVC   PRTQID+4(1),QLREPCHR                                             
         CLI   PRTQID+4,C'1'                                                    
         BNL   *+8                                                              
         MVI   PRTQID+4,C'U'       TIDY UP FOR OLD SINGLE PRTQUE                
*                                                                               
         MVC   PQLINE,SPACES                                                    
         MVI   PQLINE,X'8B'                                                     
         B     PRINT4                                                           
...
HDRLBL   DS    CL32                  TRACEBUF**TRACEBUF*** LABEL                
HDRSYS   DS    CL4                   CURRENT SYSTEM INPUT NUMBER                
HDRENTY  DS    CL4                   CURRENT # OF ENTRIES IN BUFFER             
HDRENDA  DS    CL4                   ADDRESS OF BUFFER END                      
HDRSUSP  DS    CL1                   TRACE SUSPENDED=X'80'                      
HDRSUSQ  EQU   X'40'                 SUSPEND TRACE                              
HDREXTN  DS    CL1                   EXTENDED DISPLAY                           
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004SRTRC00S  05/01/02'                                      
         END                                                                    
