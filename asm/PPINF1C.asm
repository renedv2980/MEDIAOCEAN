*          DATA SET PPINF1C    AT LEVEL 020 AS OF 05/01/02                      
*PHASE T41A1CA,+0,NOAUTO       NOTE: "A" PHASE                                  
*                                                                               
* KWAN 05/99    CORRECT FILTER ERROR DISPLAY                                    
*                                                                               
         TITLE 'T41A1C   PRINTPAK  INFO   DISTRICTS'                            
T41A1C   CSECT                                                                  
         NMOD1 0,T41A1C                                                         
         USING FLDHDRD,R2                                                       
         L     RC,0(R1)                                                         
...
*                                                                               
         ...
         MVC   FLDDATA+1(18),=C'DISTRICT CODE/NAME'                             
