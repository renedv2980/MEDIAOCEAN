*          DATA SET GELDMSG    AT LEVEL 001 AS OF 08/18/87                      
*PHASE GELDMSG,*                                                                
*INCLUDE HEXOUT                                                                 
*INCLUDE SCANNER                                                                
...
*                          ANY OMMITTED PARAMS ARE ASSUMED 'ALL'                
*                                                                               
...
DMXI050  OC    REQEND,REQEND       END MESSAGE NUMBER OPTION                    
         ...
         B     DMXI090                                                          
         EJECT                                                                  
DMXI090  LA    R3,32(R3)           A(NEXT SCANWRK AREA)                         
         BCT   R5,DMXI002                                                       
         B     DMXIT                                                            
         EJECT                                                                  
*                                                                               
...
*DDDPRINT                                                                       
       ++INCLUDE DDDPRINT                                                       
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001GELDMSG   08/18/87'                                      
         END                                                                    
