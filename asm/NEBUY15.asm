*          DATA SET NEBUY15    AT LEVEL 066 AS OF 08/01/19                      
*PHASE T31115B,+0                                                               
...
FLD13    GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(ELCODE,NBAIO),(LFIL,DUB)             
         ...
         BNE   *+12                                                             
         CLI   DECDEMO+1,C'T'      TEST FOR HUNDREDS IMP                        
         BE    FLD14B                                                           
...
*                                                                               
DISIC2   NTR1                                                                   
         TM    NBUNITST,X'42'       CHECK IF MISSED OR PREEMPT                  
         BNZ   DIC2EX                                                           
         MVI   FLDH+7,0                                                         
         MVI   BYTE,X'74'                                                       
         BAS   RE,GETEL                                                         
...
DDATE    ST    RE,SAVEREG                                                       
         ...
         EJECT                                                                  
*                                                                               
DAFDATE  ST    RE,SAVEREG          DISPLAY AFFIRMATIVE DATE                     
         GOTO1 =A(OVFLRTN),DMCB,(1,DUB),(RC),(R9),RR=MYRELO                     
DAFDATEX L     RE,SAVEREG                                                       
         BR    RE                                                               
*                                                                               
...
CHA30    DS    0H                                                               
*                                                                               
CHA35    L     R2,AUNPRFLD         BUMP TO NEXT FIELD                           
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
         B     CHA2                                                             
         SPACE                                                                  
...
EFEEDC   NTR1                                                                   
         ...
         B     EXXMOD                                                           
         EJECT                                                                  
* SUB ROUTINE TO EDIT FEED AND SHARE REQUESTS                                   
*                                                                               
EFEDSHR  NTR1                                                                   
...
OV300    CLI   1(R2),USERMOD       TEST FOR USER DEMO                           
         BE    OV305               YES                                          
         BAS   RE,ENCDUB                                                        
OV305    GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(LFIL,DUB)          
         MVC   DUB2,DUB                                                         
         CLI   1(R2),USERMOD       TEST FOR USER DEMO                           
         BE    OV360               YES                                          
         CLI   DMDECHLD+1,C'T'     CHECK FOR IMPRESSION                         
*******  CLI   3(R2),C'T'          TEST FOR RATING                              
         BE    OV320                                                            
...
*******  CLI   3(R2),C'R'          TEST FOR RATING                              
         ...
         BAS   RE,ENCDUB2                                                       
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(LFIL,DUB2)         
...
*                                                                               
         ...
         MVI   NUOVLEN,12                                                       
*****    MVC   NUOVCAT(3),0(R2)                                                 
         MVC   DECDEMO,DMDECHLD    RESET FIELD                                  
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OV440                                                            
         CLI   DECDEMO+1,C'T'                                                   
         BNE   OV440                                                            
...
OVBRANCH B     EDDEM                                                            
         ...
         B     DISBILL                                                          
         B     DISTRADE                                                         
         B     DISDCS              DEAL,CONTRACT,SERIAL#                        
         B     EFEDCD                                                           
         B     DISPID                                                           
         EJECT                                                                  
*                                                                               
DAFDTE   DS    0H                  DISPLAY AFFADAVIT DATE                       
...
******   DC    X'00',AL3(DMAXC),AL3(EMAXC)                                      
*                                                                               
         DC    CL7'EARNC',AL1(EIC),AL1(5),AL1(UEARNC),AL1(10),X'00'             
         DC    X'00',AL3(DEICC),AL3(0)                                          
******   DC    X'00',AL3(DEICC),AL3(EEICC)                                      
*                                                                               
ESTLK    DC    CL7'EST',AL1(ESTDE),AL1(3),AL1(0),AL1(10),X'00'                  
...
MINUSSW  DS    C                   CHECK FOR NEGATIVE VALUE                     
...
TAPRSAVE DS    CL6                 TRAFFIC SAVE OF ALPHA                        
*                                                                               
KEYLIST  DS    CL71                                                             
...
*                                                                               
       ...
       ++INCLUDE SEACSFILE                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'066NEBUY15   08/01/19'                                      
         END                                                                    
