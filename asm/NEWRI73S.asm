*          DATA SET NEWRI73S   AT LEVEL 031 AS OF 05/01/02                      
*PHASE T32073A,+0                                                               
*INCLUDE MOBILE                                                                 
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
...
EDT32    LA    R2,SPLINDH           INVOICE DATE                                
         CLI   5(R2),0                                                          
         BE    EDTX                                                             
         GOTO1 DATVAL,DMCB,(0,8(R2)),INVDATSV                                   
         OC    DMCB(4),DMCB                                                     
         BZ    EDINV                                                            
...
MYD30    DS    0H                                                               
         ...
         ICM   R1,15,BILLFRML+1       GET SIGNED RATE NN.NNNN                   
         CVD   R1,DUB                                                           
         ...
         ZAP   PAKWRK(8),DUB                                                    
         LA    R2,PAKWRK                                                        
*        EDIT  (P8,PAKWRK),(12,0(R3)),2,MINUS=YES,ZERO=YES   EDIT ACT+          
*        B     MDTX                                                             
...
MYOITOT  DS    0H                                                               
         ...
         MVI   0(R3),9                                                          
         LA    R3,198(R3)                                                       
         MVC   0(28,R3),=C'DUE AND PAYABLE ON OR BEFORE'                        
...
*                                                                               
       ...
       ++INCLUDE CTGENDIC                                                       
         PRINT OFF                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'031NEWRI73S  05/01/02'                                      
         END                                                                    
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
         END                                                                    
