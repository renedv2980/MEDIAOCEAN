*          DATA SET RECNT7D    AT LEVEL 188 AS OF 05/01/02                      
*PHASE T8027DA,+0                                                               
*INCLUDE OUTDAY                                                                 
         TITLE 'T8027D - REPPAK SPORTS BUY DISPLAY'                             
*                                                                               
*******************************************************************             
*                                                                 *             
*        RECNT7D (T8027D) --- SPORTS BUY DISPLAY                  *             
*                                                                 *             
* --------------------------------------------------------------- *             
...
*                                                                               
         ...
         B     DISP4                                                            
DISP0    EQU   *                                                                
         LA    R4,SBSDATEH         TURN OFF PROTECTED BITS TO FOUT              
...
DISP4    DS    0H                                                               
*                                                                               
DISP10   GOTO1 VFOUTBLK,DMCB,SBSDATEH,SBSLAST,0                                 
         LA    R2,CONBNUMH                                                      
         LA    R3,BUYERR                                                        
*                                                                               
         CLC   BUYACT,=C'BUY'                                                   
...
DISP190  DS    0H                                                               
         ...
         LA    R3,1(R3)                                                         
         B     DISP180                                                          
DISP200  MVC   SBSDATE,WORK2       DATES                                        
         CLI   WORK2+60,C' '                                                    
         BE    *+6                                                              
         DC    H'0'                NO 2ND LINE FOR SPORTS BUYS                  
***>     BE    *+10                                                             
...
***>>    EDIT  (4,RBUYCOS),(9,BUYRATE),2,ALIGN=LEFT,FLOAT=-      RATE           
         EDIT  (4,RBUYTCOS),(9,SBSCOST),2,ALIGN=LEFT,FLOAT=-     RATE           
...
*              GET 1ST COMMENT                                                  
         ...
         CH    R4,=H'60'                                                        
         BL    DISP218                                                          
         DC    H'0'                SPORTS BUYS - 60 CHAR MAX                    
*                                                                               
...
*                                                                               
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   SBSCMT2(0),RBUYCMNT                                              
         DROP  R6                                                               
*                                                                               
         MVC   SBSOCM1,MYSPACES    IN CASE THERE ARE NO COMMENTS                
         MVC   SBSOCM2,MYSPACES                                                 
...
DISP230  DS    0H                                                               
         ...
         BNE   DISPXIT                                                          
         CLI   1(R6),4                                                          
         BL    DISPXIT             SKIP IF NOTHING TO PRINT                     
         ZIC   R4,1(R6)                                                         
         SH    R4,=H'4'                                                         
*                                                                               
         CH    R4,=H'60'                                                        
...
*&&                                                                             
DISPX10  DS    0H                                                               
         LA    R4,SBSDATEH         PREPARE TO SET ALL VALID BITS ON             
         LA    R5,SBSLAST                                                       
         SR    RE,RE                                                            
...
DISPX15  DS    0H                                                               
         ...
         OI    CONBNUMH+4,X'20'                                                 
*                                                                               
DISPX20  GOTO1 VFOUTBLK,DMCB,SBSDATEH,SBSLAST,1                                 
         SPACE 1                                                                
         CLI   TWAACCS,C'$'        STATION                                      
         BNE   DISPX60                                                          
*                                                                               
         LA    R4,SBSDATEH         SET PROTECTED BITS ON ALL FIELDS             
         LA    R5,SBSOCM1H         EXCEPT BUY ORDER COMMENTS                    
*                                                                               
DISPX40  DS    0H                                                               
...
*                                                                               
         ...
         CLI   TWAACCS,C'$'             STATION?                                
         BE    CLPRX                                                            
         OI    BUYCLSH+1,X'20'          PROTECT PATTERN                         
*&&                                                                             
CLPRX    XIT1                                                                   
         EJECT                                                                  
         GETEL2 R6,34,ELCODE                                                    
...
*                                                                               
FIELDTBL DC    AL4(SBSDATEH-TWAD),X'00'                                         
         DC    AL4(SBSCOSTH-TWAD),X'00'                                         
         DC    X'FF'               DELIMITER                                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'188RECNT7D   05/01/02'                                      
         END                                                                    
