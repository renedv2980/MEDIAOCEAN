*          DATA SET REDAR12    AT LEVEL 052 AS OF 04/23/98                      
*          DATA SET REDAR10    AT LEVEL 114 AS OF 05/31/94                      
*PHASE T80F12A                                                                  
*                                                                               
         TITLE 'T80F12 - REDAR12 - DARE REVISION OFFLINE REPORT EDIT'           
***********************************************************************         
*                                                                     *         
*  REDAR12 (T80F12) --- DARE REVISION OFFLINE REPORT EDIT             *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
...
WORKLQ   EQU   *-MYAREAD                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'052REDAR12   04/23/98'                                      
         END                                                                    
