*          DATA SET REVIEW21   AT LEVEL 035 AS OF 09/27/05                      
*          DATA SET REVIEW21   AT LEVEL 033 AS OF 11/19/99                      
*PHASE T81721A                                                                  
VIEW21   TITLE 'W1/3/7 REPORTS FOR VIEWER'                                      
VIEW21   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,REVIEW21,R7,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
         L     R8,AGWORK                                                        
         USING GWORKD,R8                                                        
...
***********************************************************************         
         SPACE 1                                                                
DISGRP   MVC   FVIFLD(L'REW1GRSB),FLTIFLD                                       
         B     EXITOK                                                           
         SPACE 1                                                                
***********************************************************************         
...
VALGRP   GOTOX AVALGRP                                                          
         BNE   EXITL                                                            
         MVC   REW1GRSB,BOWORK1                                                 
         MVC   FLTIFLD(L'REW1GRSB),BOWORK1                                      
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* DO GROUP FILTERING                                                  *         
...
***********************************************************************         
         SPACE 1                                                                
DOFQTR   OC    REW1TOT,REW1TOT                                                  
         BZ    FLTXX               NOT A TOTAL LINE                             
*                                                                               
         CLC   REW1PRD+1(1),FLTIFLD                                             
         BL    FLTXL                                                            
         BE    FLTXE                                                            
         BH    FLTXH                                                            
         DROP  R2                                                               
...
*                                                                               
         ...
         MVCL  R0,RE                                                            
*                                                                               
         MVC   IOKEY,REW1KEY       SET CURRENT RECORD INTO IO1                  
...
*                                                                               
         MVC   IOKEY,0(R4)         SET KEY IN IOKEY                             
         CLC   REW1KEY(REW1PRD-REW1KEY),REC.REW1KEY                             
...
*                                                                               
         L     RF,AIO3                                                          
         CLC   =C'DATES=',REW1GRSB                                              
         BNE   EXITL                                                            
         MVC   SVFROM,REW1GRSB+6                                                
         MVC   SVTO,REW1GRSB+10                                                 
*                                                                               
         LA    R1,REW1FRST                                                      
         MVC   SVWHEN,2(R1)                                                     
         CLC   SVWHEN,BCSPACES                                                  
...
*                               ** PERIOD IS YYMM BINARY                        
         ...
         CLI   REW1PRD+1,X'0D'      IF MM IS 'OD' THIS IS A YRLY TOTAL          
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         MVC   L1PED(L'ALL),ALL                                                 
         CLI   REW1PRD+1,FF         IF MM IS 'FF' PUT OUT 'ALL'                 
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
...
SCRL02   MVC   0(L'GROUP,R4),GROUP                                              
         MVI   L'GROUP(R4),C'='                                                 
         LA    R4,L'GROUP+1(R4)                                                 
         MVC   0(L'REW1GRSB,R4),REW1GRSB                                        
         CLC   REW1GRSB,BCEFFS     IS THIS FOR ALL GROUPS?                      
         BNE   SCRL04             NO                                            
         MVC   0(L'ALL,R4),ALL                                                  
         LA    R4,L'ALL(R4)                                                     
         B     *+8                                                              
SCRL04   LA    R4,L'REW1GRSB(R4)                                                
         MVI   0(R4),C','                                                       
         LA    R4,1(R4)                                                         
*                               ** STATION FILTER                               
...
NLST02   L     RF,AIOREC           I/S RETURNS INTO RECORD BUFFER               
         CLC   0(REW1PAD-REW1KEY,RF),LSINIKEY                                   
         BNE   EXITL               MAKE SURE SAME REPORT/REP                    
*                                                                               
         CLC   =C'DATES=',REW1GRSB-REW1KEY(RF)                                  
         BE    NLST                                                             
*                                                                               
...
FF       EQU   X'FF'                                                            
         SPACE 1                                                                
FILTTAB  DC    AL2(00001),AL1(REW1GRSB-REW1DSCT,L'REW1GRSB)                     
         DC    AL2(00002),AL1(REW1STN-REW1DSCT,L'REW1STN)                       
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035REVIEW21  09/27/05'                                      
         END                                                                    
