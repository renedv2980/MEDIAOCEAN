*          DATA SET DDSTATPRNT AT LEVEL 036 AS OF 05/01/02                      
*PHASE STATPRNT                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE FATAB                                                                  
...
*                                                                               
         MVC   MID1(103),INHEAD                                                 
         MVC   TITLE(28),=C'STATPRNT - FIND BAD TRANSACTIONS'                   
         B     INPUT                                                            
*                                                                               
INHEAD   DC    C'  LINE TRM  SYSTEM   PROGRAM  TASK    SIN     START   X        
                 END     DURTN  CPU TM    I/O  STTM(TU)  NDTM(TU)'              
SORTCARD DC    CL80'SORT FIELDS=(1,16,BI,A),WORK=1'                             
RECCARD  DC    CL80'RECORD TYPE=F,LENGTH=54'                                    
         EJECT                                                                  
...
INPUT2   OC    ADRREC(38),ADRREC   IGNORE NULL RECORDS                          
         BZ    INPUT                                                            
         CLC   ADRSTTM,=X'002B3000'                                             
         BL    INPUT4                                                           
         CLC   ADRNDTM,=X'002BD000'                                             
         BH    INPUT4                                                           
**       CLC   ADRIOCNT,=H'500'    MORE THAN 500 I/O'S                          
**       BNL   INSORT                                                           
**       CLC   ADRCPUTM,=F'600'    OR 2 SEC CPU TM                              
**       BNL   INSORT                                                           
**       B     INPUT4                                                           
         SPACE 1                                                                
INSORT   DS    0H                                                               
**NOP    GOTO1 =V(HEXOUT),P1,ADRREC,P,38,=C'TOG'                                
**NOP    GOTO1 =V(PRINTER)                                                      
         XC    SORTKEY,SORTKEY                                                  
**       MVC   SRTOVSYS,ADROVSYS                                                
**       MVC   SRTSYSNO,ADRSYSNO                                                
**       MVC   SRTPRGNO,ADRPRGNO                                                
**       MVC   SRTLINE,ADRLINE     LINE/TERM                                    
         MVC   SRTSTTM,ADRSTTM                                                  
         GOTO1 =V(SORTER),P1,=C'PUT',SORTKEY                                    
         B     INPUT4                                                           
         EJECT                                                                  
...
**NOP    B     ENDX                                                             
*                                                                               
INPRT2   GOTO1 =V(SORTER),P1,=C'GET'                                            
         ICM   RF,15,4(R1)                                                      
         BZ    ENDX                                                             
*                                                                               
         MVC   SORTREC,L'SORTKEY(RF)   PUT ADRREC IN SORTREC                    
*                                                                               
         MVC   PLN,ADRLINE                                                      
         MVC   PTRM,ADRADDR                                                     
*                                                                               
