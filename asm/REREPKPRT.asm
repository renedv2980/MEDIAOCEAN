*          DATA SET REREPKPRT  AT LEVEL 006 AS OF 05/01/02                      
*PHASE REST02C,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE BINSRCH2                                                               
...
*INCLUDE XSORT                                                                  
*INCLUDE SCANNER                                                                
         TITLE 'REREPSKAT - PRINT AGENCY/ADVERTISER NAMES'                      
*                                                                               
********************************************************************            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
* OCT21/99 (BU ) --- ORIGINAL ENTRY                                *            
*                                                                  *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
*                                                                               
         ...
         BE    LDIR0100            YES - PROCESS AS ADVERT                      
...
*                                                                               
         ...
         L     R4,AWRKBLK2                                                      
         MVC   0(4,R1),12(R4)      INSERT AGENCY CODE IN TABLE                  
         MVC   4(2,R1),44(R4)      INSERT AGENCY OFFICE INTO TABLE              
         L     RE,AWORKBLK         SET A(WORKSPACE)                             
         XC    MYWORK2,MYWORK2                                                  
...
*                                                                               
****     B     LDIR0180            **NOOP FOR TABLE PRINT                       
*                                                                               
...
*                                                                               
         ...
         XC    KEY,KEY                                                          
         MVI   KEY,X'0A'                                                        
         MVC   KEY+19(6),6(R2)     INSERT AGY/OFF                               
         MVC   KEY+25(2),NEWREP    INSERT REP CODE                              
         GOTO1 HIGHDIR             READ KEY                                     
         CLC   KEY(27),KEYSAVE     KEY FOUND                                    
         BNE   LDIR0162            NO  - PUT OUT MESSAGE                        
         GOTO1 GETRECRD                                                         
         LA    R3,REC                                                           
         USING RAGYREC,R3                                                       
         MVC   P+12(20),RAGYNAM1   INSERT NAME                                  
         DROP  R3                                                               
         B     LDIR0164                                                         
LDIR0162 EQU   *                                                                
         MVC   P+12(11),=C'NOT ON FILE'                                         
LDIR0164 EQU   *                                                                
         GOTO1 REPORT                                                           
*                                                                               
         LA    R2,AGYTABLN(R2)     BUMP TO NEXT SLOT                            
         B     LDIR0160            GO BACK FOR NEXT SLOT                        
LDIR0180 EQU   *                                                                
**       MVC   P+1(07),=C'AGYCTR='                                              
**       EDIT  AGYCTR,(6,P+10)                                                  
**       GOTO1 REPORT                                                           
...
*                                                                               
***      B     LDIR0240            **NOOP FOR TABLE PRINT                       
*                                                                               
...
*                                                                               
         ...
         XC    KEY,KEY                                                          
         MVI   KEY,X'08'                                                        
         MVC   KEY+21(4),4(R2)     INSERT ADVERT                                
         MVC   KEY+25(2),NEWREP    INSERT REP CODE                              
         GOTO1 HIGHDIR             READ KEY                                     
         CLC   KEY(27),KEYSAVE     KEY FOUND                                    
         BNE   LDIR0220            NO  - PUT OUT MESSAGE                        
         GOTO1 GETRECRD                                                         
         LA    R3,REC                                                           
         USING RADVREC,R3                                                       
         MVC   P+12(20),RADVNAME   INSERT NAME                                  
         DROP  R3                                                               
         B     LDIR0230                                                         
LDIR0220 EQU   *                                                                
         MVC   P+12(11),=C'NOT ON FILE'                                         
...
*                                                                               
         ...
         B     LDIR0200            GO BACK FOR NEXT SLOT                        
*                                                                               
LDIR0240 EQU   *                                                                
         XIT1                                                                   
*                                                                               
...
*                                                                               
         ...
         BE    LSTA0100            NO  - USE LAST STATION                       
         MVC   LASTSTA,12(R4)                                                   
LSTA0100 EQU   *                                                                
...
LSTA0120 EQU   *                                                                
*                                                                               
         B     LSTA0160            **NOOP TO DISPLAY TABLE**                    
*                                                                               
...
LDIR0380 EQU   *                                                                
         ...
         BZ    LDIR0460            YES - FINISHED                               
         BAS   RE,LIVESTA          STATION BEING PROCESSED?                     
         BNZ   LDIR0440            NO  - SKIP THIS ENTRY                        
...
*   TEST                                                                        
         ...
         CLC   =C'WNEP',0(R2)      PROCESS SINGLE STATION ONLY                  
         BE    CONT0040                                                         
...
INTAPE1  DCB   DDNAME=INTAPE1,DSORG=PS,RECFM=VB,LRECL=255,             X        
               BLKSIZE=6233,MACRF=GM,EODAD=LDIR0140                             
INTAPE2  DCB   DDNAME=INTAPE2,DSORG=PS,RECFM=VB,LRECL=255,             X        
               BLKSIZE=6233,MACRF=GM,EODAD=LSTA0120                             
         SPACE 3                                                                
         SPACE 3                                                                
         EJECT                                                                  
         LTORG                                                                  
...
MASTD    DSECT                                                                  
       ++INCLUDE DDMASTC                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006REREPKPRT 05/01/02'                                      
         END                                                                    
