*          DATA SET RERMP32    AT LEVEL 063 AS OF 01/11/11                      
*PHASE T81032C,*                                                                
...
*  --------                                                           *         
*                                                                     *         
* 15APR09 KUI SUPPORT NEW INVENTORY KEY                               *         
*                                                                     *         
...
*                                                                               
         DC    H'0'              REPORT NOT ALLOWED TO RUN UNTIL                
...
*                                                                               
         ...
         MVC   4(1,RE),NEWSE       SET UP TO NEW SE NUMBER (REC AGENCY)         
         MVC   KEY,HOLDKEY                                                      
         MVC   KEY+RINVKREP-RINVKEY(2),NEWREP                                   
...
*                                                                               
         ...
         MVC   RINVKSTD,STRTOPT    MOVE DATE IN                                 
         MVC   COMPKEY,KEY                                                      
GTINV50  GOTO1 HIGH                                                             
...
GTINV800 CLI   KEY,RINVKTYQ        READ ALL THE INVENTORY                       
         BNE   GTINV450                                                         
         XC    NEXTKEY,NEXTKEY                                                  
         MVC   NEXTKEY(RINVKRTP-RINVKEY),KEY                                    
         B     EXXMOD                                                           
         DROP  R4                                                               
         EJECT                                                                  
*                                                                               
...
*                                  INV HEADER RECORD                            
         ...
         BNE   DLINEX                                                           
*                                                                               
DLI200   DS    0H                  CHECK UP TO RECORD TYPE                      
         CLC   KEY(RINVKINV-RINVKEY),KEYSAVE                                    
         BNE   DLI300                                                           
*        GOTO1 =V(PRNTBL),DMCB,=C'KEY',KEY,C'DUMP',30,=C'1D'                    
...
CKBOOK   NTR1                                                                   
         ...
         USING COMFACSD,R7                                                      
*                                                                               
         CLI   RINVKRTP,0          BYPASS HEADERS                               
         BE    CKBYES                                                           
         CLI   RINVKRTP,C'M'       BYPASS MARKET LEVEL                          
         BE    CKBYES                                                           
         CLI   RINVKRTP,C'S'       BYPASS STATION LEVEL                         
         BE    CKBYES                                                           
         CLI   RINVKRTP,X'FF'      BYPASS TEXT RECORDS                          
         BE    CKBYES                                                           
*                                                                               
         XC    DBLOCK,DBLOCK                                                    
...
REPTAB   DC    CL4'AMSZ'           AM --> SZ                                    
         ...
         DC    CL4'PQNB'           PAXSNY --> NBC                               
         DC    CL4'PQPV'           PAXSNY --> PETRY                             
         DC    X'FF'                                                            
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'063RERMP32   01/11/11'                                      
         END                                                                    
