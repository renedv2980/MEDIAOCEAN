*          DATA SET SPNWS39    AT LEVEL 174 AS OF 05/14/09                      
*PHASE T20739A,*                                                                
...
*                                                                               
         ...
         MVI   SVUPFRBT,0          SVUPFRBK BOOK TYPE (BINARY)                  
         XC    SVUPFBL,SVUPFBL                                                  
         XC    SVUPINP,SVUPINP                                                  
         XC    SVUPDAY,SVUPDAY                                                  
         XC    SVUPTIM,SVUPTIM                                                  
         ...
         XC    SVUPSHR,SVUPSHR                                                  
         XC    SVBKS,SVBKS                                                      
         XC    SVBKTPS,SVBKTPS     SVBKS BOOKTYPES (BINARY)                     
         XC    SVDEM,SVDEM                                                      
         MVI   SVRTGSVC,0                                                       
         LA    R0,NMAXSTA                                                       
         LA    R1,SVSTA                                                         
...
*                                                                               
         ...
         MVC   SVUPGRD,CMPUP                                                    
         MVC   SVUPFRBK,CMPFB                                                   
         MVC   SVUPFRBT,CMPFBTP     SVUPFRBK BOOKTYPE (BINARY)                  
         TM    CMPFB+1,BTY2CHAR                                                 
         BNO   FSTR3G                                                           
         CLI   CMPFBTP,0                                                        
         BNE   *+6                                                              
...
*                                                                               
         ...
         BNE   *+6                                                              
         DC    H'0'                                                             
         MVC   DBBTYPE,0(RE)        - YUP                                       
         B     FSTR42N                                                          
*                                                                               
FSTR42M  GOTO1 AGETBKTY,APPARM,(C'B',DBSELBK+1),DBBTYPE                         
FSTR42N  NI    DBSELBK+1,X'FF'-BTYBITSQ  REMOVE SPECIAL NOW                     
*                                                                               
...
*                                                                               
FSTR44   DS    0H                                                               
         BRAS  RE,GETPJPUT         GET PROJECTED PUT VALUE                      
         GOTO1 ADEMUP              DO THE UPGRADES                              
         MVC   FVMSGNO,=AL2(FVFOK)                                              
         TM    LFLAG,LPUTADJ       TEST PUT WAS ADJUSTED                        
         BZ    *+8                                                              
         BRAS  RE,GETPJPUT         YES-FORMAT PUT VALUE AGAIN                   
...
STAH03   LA    R1,APWORK                                                        
         USING STAPACKD,R1                                                      
         MVI   STAPACT,C'Y'        TRANSLATE 3CHAR NET TO 4CHAR                 
         MVC   STAPAGY,QAGY                                                     
         MVC   STAPMED,QMED                                                     
         MVI   STAPCTRY,C'U'                                                    
...
*********                                                                       
         XC    COMSUB,COMSUB       DON'T KNOW IF WE NEED IT YET                 
         MVI   COMSDP,0                                                         
         CLI   0(R3),NBRKTYPQ      BUY REVISION RECORD?                         
...
*                                                                               
         MVC   COMSDP,NBRSSBDP     SAVE OFF THE SUBDAYPART AS WELL              
         CLI   COMSDP,C' '         DOES IT HAVE ANYTHING?                       
...
DISR11   TM    COMBK1H+FVIIND-FVIHDR,FVIVAL    TEST ANY BOOK CHANGES            
         ...
         B     DISR14                                                           
*                                                                               
*ISR12   OI    COMBK1H+FVIIND-FVIHDR,FVIVAL                                     
...
DISR23   TM    LCHG,LDEMO+LPUT     TEST DEMO OR PROJECTED PUT CHANGE            
         ...
         BRAS  RE,GETPJPUT         GET AND FORMAT PROJECTED PUT VALUE           
*                                                                               
...
DISB2    TM    LFLAG1,LF1NOLBK     DID WE FIND THE LATEST BOOK?                 
         ...
         MVI   0(R3),0             CLAER OUT SVBKTPS                            
         OI    FVIIND-FVIHDR(R8),FVIVAL   VALIDATED                             
         B     DISB4               NEXT, PLZ                                    
*****                                          MHC  02/05/03                    
*                                                                               
DISB2A   CLI   6(R8),C'+'          IGNORE LPM?                                  
...
*                                                                               
         TM    SPLKDBK+1,BTYBITSQ  SPECIAL BOOK TYPE INPUT BY USER?             
         BZ    GETD4G              NO, NOT MANUALLY INPUT BY USER               
...
GETD4F   NI    SPLKDBK+1,X'FF'-BTYBITSQ                                         
         B     GETD5                                                            
*                                                                               
GETD4G   CLI   STABKTYP,C'H'       NO, HISPANIC OR NO BOOK TYPE CAN             
...
*                                                                               
         TM    SVWKYIND,SVONEBK    TEST 1 BOOK, 4 WEEKS                         
         BZ    GETD5A                                                           
         ZIC   RF,SPLKWKN          GET THE WEEK NUMBER                          
*                                                                               
GETD5A   MVC   0(L'L1PROG1,R5),SPLKPRG    PROGRAM NAME                          
...
***  2 DECIMAL                                                                  
         TM    APROFBTS,A00TWODC   IS 2 DECIMAL PRECISION ON?                   
         BZ    DEMU27E                                                          
         CLI   SVDEM+1,C'R'        IS IT A RATING?                              
         BE    *+12                 - YUP                                       
         CLI   SVDEM+1,C'E'        IS IT AN E-RATING?                           
         BNE   DEMU27E                                                          
         D     R0,=F'100'                                                       
         B     DEMU27G                                                          
***  2 DECIMAL                                                                  
...
*****  CABLE/FUSION DATE LOOKUP                                                 
         CLI   QSTA,C'0'           IS IT A NUMBER?                              
         BL    SDEMUP5E             - NOPE, WE DON'T HAVE CABLE NETWORK         
         XC    SPUPSTA,SPUPSTA                                                  
         MVC   SPUPSTA(3),QSTA+5     MOVE THE NETWORK IN                        
         MVC   SPUPSYSE,QSTA                                                    
         B     SDEMUP5G                                                         
*****  CABLE/FUSION DATE LOOKUP                                                 
SDEMUP5E MVC   SPUPSTA,QSTA                                                     
SDEMUP5G MVC   SPUPDAY,NBRSDAYS                                                 
         TM    LFLAG2,LDAYOVR      TEST DAYS OVERRIDDEN                         
         BZ    *+10                                                             
         MVC   SPUPDAY,LDAYS                                                    
         MVC   SPUPTIM,NBRSTIMS                                                 
...
SDEM10   DS    0H                                                               
         ...
         BNE   SDEM10E                                                          
         CLI   STABKTYP,0          ANYTHING HERE?                               
         BNE   SDEM10G              - NO, OVERRIDE CMPBKTYP REGARDLESS          
...
* DDGLOBEQUS                                                                    
       ...
       ++INCLUDE DDGLOBEQUS                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'174SPNWS39   05/14/09'                                      
         END                                                                    
