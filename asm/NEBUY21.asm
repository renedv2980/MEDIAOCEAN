*          DATA SET NEBUY21    AT LEVEL 013 AS OF 03/05/18                      
*PHASE T31121B,+0                                                               
...
*                                                                               
         ...
         L     RF,NBEXTEND                                                      
         USING NBXTNDD,RF                                                       
         MVC   ANBXCDNL,NBXCDNL    A(COMSCORE DEMO NAME LIST)                   
         DROP  RF                                                               
         SPACE 2                                                                
...
*                                                                               
         ...
         L     R4,ACOMFACS                                                      
         USING COMFACSD,R4                                                      
         GOTO1 CDEMOVAL,DMCB,FLDH,(1,FULL),DBLOCKA,,,WORK                       
...
UNIT5B   CLI   DEMO+2,0            COMSCORE DEMO?                               
         JE    UNIT5G                                                           
         LA    RE,ESTDEMSE                                                      
         ZIC   RF,ESTNDEMS                                                      
...
UNIT5F   LA    RE,3(RE)                                                         
         ...
         B     UNITR                                                            
*                                                                               
UNIT5G   L     RE,ANBXCDNL         A(COMSCORE DEMO NAME LIST)                   
UNIT5H   CLI   0(RE),0                                                          
         JNE   *+14                                                             
UNIT5I   MVC   XTRA(L'DEMERR),DEMERR                                            
         B     UNITR                                                            
*                                                                               
         CLC   WORK(8),0(RE)       FOUND MATCH?                                 
         JE    UNIT10                                                           
         AHI   RE,8                                                             
         J     UNIT5H                                                           
*                                                                               
...
VALPRD   ST    RE,SAVEREG                                                       
         LA    R0,255              VALIDATE THE CODE AGAINST BRAND LIST         
         LA    RF,CLILIST                                                       
         SPACE                                                                  
...
READF    NTR1                                                                   
         ...
         LA    RE,SVDEMTAB                                                      
         ST    RE,NBINVFLT                                                      
* SET UP DEMO TABLE FOR NETVLDEMO                                               
         XC    SVDEMTAB,SVDEMTAB                                                
         MVC   SVDEMTAB(4),=CL4'NLIV'                                           
         MVC   SVDEMTAB+9(4),=CL4'CAVG'                                         
         OI    NBINDS7,X'02'                                                    
*                                                                               
...
*                                                                               
       ...
       ++INCLUDE NEBUYWRK                                                       
         EJECT                                                                  
       ++INCLUDE NETDEMOT                                                       
* NETDEMOP (DSECT COVERING NETWORK DEMO BLOCK SUPPORTS 50 DEMOS)                
*                                                                               
       ++INCLUDE NETDEMOP                                                       
         EJECT                                                                  
* INFO UNIT SCREEN                                                              
...
SVDEMTAB DS    CL20                TABLE NETVALUE NEEDS TO PRODESS DEMO         
*                                                                               
...
MAXIOCTR DS    H                                                                
*                                                                               
ANBXCDNL DS    F                   A(COMSCORE DEMO NAME LIST)                   
*                                                                               
ENTRIES  DS    X                                                                
*                                                                               
CPMP     DS    PL8                 CPM                                          
...
EOF      EQU   X'02'               FINISHED DISPLAY LAST TIME                   
       ...
       ++INCLUDE NETBLKXTND                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013NEBUY21   03/05/18'                                      
         END                                                                    
