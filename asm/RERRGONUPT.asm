*          DATA SET RERRGONUPT AT LEVEL 077 AS OF 05/01/02                      
*PHASE RERRGUPA,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE ADDAY                                                                  
*INCLUDE CARDS                                                                  
...
*        BCT   R0,*-14                                                          
         SPACE                                                                  
         CLI   RCONKGRP,C'A'       ALLOW GROUPS A/F/I/P/R/N & T                 
         BE    IN024                                                            
         CLI   RCONKGRP,C'F'                                                    
         BE    IN024                                                            
         CLI   RCONKGRP,C'I'                                                    
...
PR20     CLI   LASTSW,C'Y'         TEST LAST REP                                
         ...
         GOTO1 =V(SORTER),DMCB,A(SORTCD2),A(RECCD2)                             
         XC    SVGROUP,SVGROUP                                                  
         XC    SVSTA,SVSTA                                                      
         MVI   SVSTATY,0                                                        
         XC    SVTVB,SVTVB                                                      
...
GW060    L     RF,THISWKL                                                       
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'077RERRGONUPT05/01/02'                                      
         END                                                                    
