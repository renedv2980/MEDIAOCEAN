*          DATA SET RELDUNCT   AT LEVEL 003 AS OF 05/01/02                      
*PHASE RELDUNCT,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDUNCT - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
***********************************************************************         
*   DROP OLD DDS CATEGORY CODES                                       *         
***********************************************************************         
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         USING RCTGREC,R3                                                       
         CLC   RCTGKREP,=C'UV'     UNIVISION RECORD?                            
         BNE   DMXKEEP             NO  - KEEP IT                                
         CLI   RCTGKTYP,X'0F'      CATEGORY RECORD?                             
         BNE   DMXKEEP             NO  - KEEP IT                                
         BAS   RE,CHEKTABL         YES - LOOK UP CATEGORY IN TABLE              
         BZ    DMXPURGE            FOUND IN TABLE: DROP IT                      
         B     DMXKEEP             NOT IN TABLE: KEEP IT                        
         EJECT                                                                  
*                                                                               
CHEKTABL NTR1                                                                   
...
CHTA0020 EQU   *                                                                
         ...
         CLC   RCTGKCTG,0(R2)      CATEGORY FOUND IN TABLE?                     
         BE    CHTA0040            YES - DISPLAY REC TO BE PURGED               
         LA    R2,4(R2)            NO  - BUMP TO NEXT ENTRY                     
         B     CHTA0020            GO BACK FOR NEXT                             
CHTA0040 EQU   *                                                                
         MVC   P+1(09),=C'PURGING: '                                            
         MVC   P+10(96),RCTGREC                                                 
         GOTO1 VPRINTER                                                         
         GOTO1 VPRINTER                                                         
         SR    R0,R0               SET CC = ZERO                                
         B     CHTA0160            EXIT CC ZERO                                 
CHTA0120 EQU   *                                                                
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003RELDUNCT  05/01/02'                                      
         END                                                                    
