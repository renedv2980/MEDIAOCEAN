*          DATA SET DERA9911   AT LEVEL 028 AS OF 10/16/20                      
...
*                                                                               
         L     R0,=F'2400000'      GRAB 2.4M FROM HI-CORE                       
...
*                                                                               
         ...
         MVC   DUB(4),PAPSNAM+2    YYYY                                         
         MVC   DUB+4(4),=C'0101'   ANY MONTH/DAY WILL DO                        
         GOTO1 VDATCON,DMCB,(9,DUB),(3,FULL)   *** Y2K ***                      
         MVC   CURRBOOK(1),FULL                                                 
*                                                                               
         L     R1,ABOOKEQ           SURVEY MONTH                                
         BRAS  RE,ISCDM                                                         
         BNE   RA045                                                            
         CLI   CURRBOOK,119         EFFECTIVE YEAR 2019 ONLY                    
         BL    RA045                                                            
         L     R1,ABOOKEQ2          2019 CDM TABLE                              
         BE    RA045                                                            
         L     R1,ABOOKEQ3          FULL YEAR CDM TABLE                         
RA045    DS    0H                                                               
         CLI   0(R1),EOT                                                        
         BNE   *+6                                                              
         DC    H'0'                                                             
         ...
         CLI   CURRBOOK,120                                                     
         BL    RA046                                                            
* AFTER 2020 WE HAD A FEW MKTS FALLING OUT OF CDM                               
         CLI   ISCDMMKT,C'Y'                                                    
         BNE   RA046                                                            
* DID MKT FALL OUT OF CDM?                                                      
         OC    SVCDMEBK,SVCDMEBK                                                
         BZ    RA046                                                            
         CLC   CURRBOOK,SVCDMEBK                                                
         BNH   RA046                                                            
* IF LOAD BOOK PAST END CDM BK                                                  
         MVI   ISCDMMKT,C'N'                                                    
*&&DO                                                                           
* RESTORE ORIGINAL CURRBOOK FROM PAPSNAM                                        
         MVC   DUB(4),PAPSNAM+2    YYYY                                         
         MVC   DUB+4(4),=C'0101'   ANY MONTH/DAY WILL DO                        
         GOTO1 VDATCON,DMCB,(9,DUB),(3,FULL)   *** Y2K ***                      
         MVC   CURRBOOK(1),FULL                                                 
*&&                                                                             
         L     R1,ABOOKEQ           RESET TO NON CDM                            
         B     RA045                                                            
...
*                                                                               
         ...
         CLC   =C' 6',PARPTYPE                                                  
         BNE   *+8                                                              
         MVI   STDCNDMK,C'C'       SMALL MARKET REPORT ARE CONDENSED            
         MVI   CURRHO,0                                                         
         MVI   CURRACTV,0                                                       
...
*                                                                               
         ...
         CLC   PJSCMBTP,=C' 8'     IF MARKET TOTALS,                            
         BNE   *+8                                                              
...
*                                                                               
         ...
         BE    RV004X                                                           
         CLC   PVSCMBTP,=C' 8'      AND MARKET TOTALS                           
         BE    RV004X                                                           
         B     RVRDNXT                                                          
RV004X   EQU   *                                                                
*^^eotest                                                                       
...
ENDJOB   DS    0H                                                               
         ...
         EJECT                                                                  
**********************************************************************          
* SEE IF THIS IS A CDM MARKET                                                   
**********************************************************************          
ISCDM    NTR1                                                                   
         L     RF,ACOMFACS                                                      
         ICM   RF,15,CDEMTABS-COMFACSD(RF)                                      
         GOTO1 (RF),DMCB,CDMTAB                                                 
         ICM   R2,15,0(R1)                                                      
         BNZ   *+6                                                              
         DC    H'0'                                                             
         ...
         USING CDMTABD,R2                                                       
*                                                                               
ISCDM28  CLI   0(R2),X'FF'                                                      
         BE    ISCDMN                                                           
         CLC   CURRMKT,CDMNMKT                                                  
         BNE   ISCDM40                                                          
***      CLC   CURRBOOK,CDMLIVBK                                                
***      BL    ISCDMN                                                           
         B     ISCDMY                                                           
ISCDM40  AR    R2,R0                                                            
         B     ISCDM28                                                          
* IS BOOK CDM AS PER TABLE ENTRY PPMLIVBK?                                      
ISCDMY   MVI  ISCDMMKT,C'Y'                                                     
         MVC  SVCDMEBK,CDMENDBK                                                 
         CR   RE,RE                                                             
         B    ISCDMX                                                            
ISCDMN   MVI  ISCDMMKT,C'N'                                                     
         CR   RE,RB                                                             
ISCDMX   XIT1                                                                   
**********************************************************************          
...
*                                                                               
         ...
         L     R1,ASAMBTTB          R1-->TABLE OF KNOWN REPORT TYPES            
CNVRP027 DS    0H                                                               
         CLI   0(R1),EOT                                                        
         BNE   *+6                                                              
         DC    H'0'                                                             
...
*                                                                               
         ...
         MVC   TEMPMKT,3(RE)       ALPHA MARKET NAME                            
GETBTYP9 EQU   *                                                                
*                                                                               
         CLI   SAMPLEBT,0                                                       
         BE    *+14                                                             
...
*                                                                               
         ...
         MVI   MSGFLAG,1                                                        
*                                                                               
         BC    0,MSGRX             ONLY FILL SUBJECT ONCE                       
         MVI   *-3,X'F0'                                                        
         GOTO1 VDATCON,DMCB,(3,TEMPBK),(6,EMMM)                                 
         MVC   ESUBJBK(6),EMMM                                                  
         LA    R1,SEASONS                                                       
MSGR90   CLI   0(R1),X'FF'                                                      
***      BE    MSGR95                                                           
         BE    MSGR92                                                           
         CLC   EMMM,0(R1)                                                       
         BE    *+12                                                             
         LA    R1,L'SEASONS(R1)                                                 
         B     MSGR90                                                           
* JUL19 and forward no longer seasonal.                                         
* JUST USE THE MONTH FOR CDM MARKETS                                            
         CLI   ISCDMMKT,C'Y'                                                    
         BNE   MSGR91                                                           
         CLC   EYY(2),=C'19'                                                    
****     CLC   EYY(2),=C'16'                                                    
         ...
         BL    MSGR91                                                           
         B     MSGR92                                                           
MSGR91   MVC   ESUBJSN,3(R1)                                                    
         MVI   ESUBJSL,C'/'                                                     
         MVC   ESUBJYR,EYY                                                      
MSGR92   L     RF,AESUB                                                         
MSGR95   MVC   0(ESUBJEQU,RF),ESUBJ                                             
*                                                                               
MSGRX    J     EXITE                                                            
*                                                                               
         DROP  R2                                                               
...
***********************************************************************         
*====================== DERA9911 INITIALIZATION ======================*         
DERAINIT NTR1                                                                   
                                                                                
*                                                                               
         DS    0H                  INITIALIZE ADDRESS CONSTANTS                 
         LHI   R0,DISPTABQ                                                      
         LHI   R1,(DISPTAB-DERA9911)                                            
         A     R1,MYBASE1                                                       
*                                                                               
DI012    DS    0H                                                               
...
LSI015   MVI   NEWSTTN,C'Y'                   NEW STTN COMBO ID                 
...
MAXCDN   EQU   22   <============  MAX # OF CNV-DEFINED DEMO NUMBERS            
...
ESUBJ    DS    0CL70                                                            
         DC    AL2(ESUBJEQU)                                                    
         DC    H'0'                                                             
         DC    C'SUBJECT=ARBITRON DIARY MARKETS LOADED FOR: '                   
ESUBJBK  DS    0CL9                                                             
ESUBJSN  DC    CL6' '                                                           
ESUBJSL  DC    C' '                                                             
ESUBJYR  DC    CL2' '                                                           
...
DISPTAB  DS    0XL(1+3+1+2)                                                     
         DC     C'B',AL3(RTYPGOTB-DERA9911),C'L',AL2(ARTYPGOT-LOCWORKD)         
         DC     C'B',AL3(SAMBTTAB-DERA9911),C'L',AL2(ASAMBTTB-LOCWORKD)         
         DC     C'B',AL3(RPTDSPTB-DERA9911),C'L',AL2(ARPTDSPT-LOCWORKD)         
         DC     C'B',AL3(PERDSPTB-DERA9911),C'L',AL2(APERDSPT-LOCWORKD)         
         DC     C'B',AL3(MKTDSPTB-DERA9911),C'L',AL2(AMKTDSPT-LOCWORKD)         
         DC     C'B',AL3(STNDSPTB-DERA9911),C'L',AL2(ASTNDSPT-LOCWORKD)         
         DC     C'B',AL3(DPTDSPTB-DERA9911),C'L',AL2(ADPTDSPT-LOCWORKD)         
         DC     C'B',AL3(BOOKEQ-DERA9911),C'L',AL2(ABOOKEQ-LOCWORKD)            
         DC     C'B',AL3(DEMODEFN-DERA9911),C'L',AL2(ADEMODEF-LOCWORKD)         
         DC     C'B',AL3(QCATDEFN-DERA9911),C'L',AL2(AQCATDEF-LOCWORKD)         
         DC     C'B',AL3(DEMQCTAB-DERA9911),C'L',AL2(ADEMQCTB-LOCWORKD)         
         DC     C'B',AL3(CVDSPTAB-DERA9911),C'L',AL2(ACVDSPTB-LOCWORKD)         
         DC     C'B',AL3(DPTTAB-DERA9911),C'L',AL2(ADPTTAB-LOCWORKD)            
         DC     C'B',AL3(UPCASETB-DERA9911),C'L',AL2(AUPCSETB-LOCWORKD)         
         DC     C'B',AL3(UNIVS-DERA9911),C'L',AL2(AUNIVS-LOCWORKD)              
         DC     C'B',AL3(STALIST-DERA9911),C'L',AL2(ASTALIST-LOCWORKD)          
         DC     C'B',AL3(CLCTAB-DERA9911),C'L',AL2(ACLCTAB-LOCWORKD)            
         DC     C'B',AL3(SCITAB-DERA9911),C'L',AL2(ASCITAB-LOCWORKD)            
         DC     C'B',AL3(DVMATRIX-DERA9911),C'L',AL2(ADVMATRX-LOCWORKD)         
         DC     C'B',AL3(PREVREC-DERA9911),C'L',AL2(APREC-LOCWORKD)             
         DC     C'B',AL3(SVSREC-DERA9911),C'L',AL2(ASVSREC-LOCWORKD)            
         DC     C'B',AL3(SVSREC2-DERA9911),C'L',AL2(ASVSREC2-LOCWORKD)          
         DC     C'B',AL3(BOOKEQ2-DERA9911),C'L',AL2(ABOOKEQ2-LOCWORKD)          
         DC     C'B',AL3(BOOKEQ3-DERA9911),C'L',AL2(ABOOKEQ3-LOCWORKD)          
DISPTABQ EQU   ((*-DISPTAB)/(L'DISPTAB))                                        
         EJECT                                                                  
RTYPGOTB DS    0XL(1+2)            RECORD TYPE PROCESS-ROUTINE DSPLCMNT         
         DC     C'A',AL2(RA000-DERA9911)                                        
         DC     C'D',AL2(RD000-DERA9911)                                        
         DC     C'G',AL2(RG000-DERA9911)                                        
         DC     C'H',AL2(RH000-DERA9911)                                        
         DC     C'J',AL2(RJ000-DERA9911)                                        
         DC     C'M',AL2(RM000-DERA9911)                                        
         DC     C'P',AL2(RP000-DERA9911)                                        
         DC     C'S',AL2(RS000-DERA9911)                                        
         DC     C'V',AL2(RV000-DERA9911)                                        
         DC    AL1(EOT)                                                         
                                                                                
                                                                                
SAMBTTAB DS    0CL(2+1)            BOOKTYPE GIVEN IN SAMPLE (TAPE)              
         DC     C' 1',X'00'         STANDARD SURVEY                             
         DC     C' 2',C'B'          ETHNIC BLACK SURVEY                         
         DC     C' 3',C'H'          ETHNIC HISPANIC SURVEY                      
         DC     C' 4',C'N'          NATIONWIDE SURVEY                           
         DC     C' 6',X'00'         SMALL MARKET SURVEY                         
         DC     C' C',C'C'          CSAR                                        
         DC    AL1(EOT)                                                         
...
* CDM WILL BE SENDING REAL MONTHS ON A MONTHLY BASIS WITH THE EXCEPTION         
* OF MARCH, JUN, SEP, DEC WHERE THEY CONTINUE TO USE THE OLD SEASONAL           
* NUMBER OF 13,14,15,16                                                         
         DC     C'01',AL1(1)                                                    
         DC     C'02',AL1(2)                                                    
         DC     C'03',AL1(3)                                                    
         DC     C'04',AL1(4)                                                    
         ...
         DC     C'12',AL1(12)                                                   
*                                                                               
         DC     C'13',AL1(2)        WINTER  -CDM WILL BE MARCH                  
         DC     C'14',AL1(5)        SPRING  -CDM WILL BE JUNE                   
         DC     C'15',AL1(7)        SUMMER  -CDM WILL BE SEP                    
         DC     C'16',AL1(11)       FALL    -CDM WILL BE DEC                    
         DC     C'17',AL1(05)       WINTER/SPRING ETHNIC                        
         DC     C'18',AL1(05)       FALL/WINTER/SPRING ETHNIC                   
         DC     C'19',AL1(11)       SUMMER/FALL ETHNIC                          
         DC     C'21',AL1(05)       SPRING/FALL (RECEIVE FOR MAY)               
         DC     C'22',AL1(11)       FALL/SPRING (RECEIVE FOR NOV)               
         DC    AL1(EOT)                                                         
         EJECT                                                                  
* PARTIAL CDM YEAR - 2019 CDM STARTS ON JULY BOOK                               
BOOKEQ2  DS    0XL(2+1)            BOOK EQUATES FOR SURVEY MONTH                
* CDM WILL BE SENDING REAL MONTHS ON A MONTHLY BASIS WITH THE EXCEPTION         
* OF MARCH, JUN, SEP, DEC WHERE THEY CONTINUE TO USE THE OLD SEASONAL           
* NUMBER OF 13,14,15,16                                                         
* FOR YEAR 2019 WE CDM IS GOING LIVE JULY BOOK SO WE STILL HAVE                 
* WINTER AND SPRING BOOK FOR NON CDM                                            
         DC     C'01',AL1(1)                                                    
         DC     C'02',AL1(2)                                                    
         DC     C'03',AL1(3)                                                    
         DC     C'04',AL1(4)                                                    
         ...
         DC     C'11',AL1(11)                                                   
         DC     C'12',AL1(12)                                                   
* SEASONAL BOOKS WINTER/SPRING/SUMMER/FALL CHANGES FOR CDM                      
         DC     C'13',AL1(2)        STILL WINTER BOOK FOR 2019                  
         DC     C'14',AL1(5)        STILL SPRING BOOK FOR 2019                  
         DC     C'15',AL1(9)        SUMMER  -CDM WILL BE SEP                    
         DC     C'16',AL1(12)       FALL    -CDM WILL BE DEC                    
*   FOLLOWING DID NOT CHANGE FOR CDM                                            
         DC     C'17',AL1(05)       WINTER/SPRING ETHNIC                        
         DC     C'18',AL1(05)       FALL/WINTER/SPRING ETHNIC                   
         DC     C'19',AL1(11)       SUMMER/FALL ETHNIC                          
         DC     C'21',AL1(05)       SPRING/FALL (RECEIVE FOR MAY)               
         ...
         DC    AL1(EOT)                                                         
         EJECT                                                                  
* FULL CDM ENTIRE YEAR                                                          
BOOKEQ3  DS    0XL(2+1)            BOOK EQUATES FOR SURVEY MONTH                
* CDM WILL BE SENDING REAL MONTHS ON A MONTHLY BASIS WITH THE EXCEPTION         
* OF MARCH, JUN, SEP, DEC WHERE THEY CONTINUE TO USE THE OLD SEASONAL           
* NUMBER OF 13,14,15,16                                                         
         DC     C'01',AL1(1)                                                    
         ...
         DC     C'12',AL1(12)                                                   
* SEASONAL BOOKS WINTER/SPRING/SUMMER/FALL CHANGES FOR CDM                      
         DC     C'13',AL1(3)        WINTER  -CDM WILL BE MARCH                  
         DC     C'14',AL1(6)        SPRING  -CDM WILL BE JUNE                   
         DC     C'15',AL1(9)        SUMMER  -CDM WILL BE SEP                    
         DC     C'16',AL1(12)       FALL    -CDM WILL BE DEC                    
*   FOLLOWING DID NOT CHANGE FOR CDM                                            
         DC     C'17',AL1(05)       WINTER/SPRING ETHNIC                        
...
*   SEE  DPTTABD  FOR DESCRIPTION                                               
         ...
         ORG   DERA9911+((((*-DERA9911)+X'000F')/X'0010')*X'0010')              
...
*                                                                               
NDEMS    EQU   20                  16 DEMO CATAGORIES ON RECORDS                
...
ABOOKEQ2 DS    A                   A(BOOKEQ2)                                   
ABOOKEQ3 DS    A                   A(BOOKEQ3)                                   
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028DERA9911  10/16/20'                                      
         END                                                                    
