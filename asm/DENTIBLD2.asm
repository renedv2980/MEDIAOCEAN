*          DATA SET DENTIBLD2  AT LEVEL 098 AS OF 05/01/02                      
*PHASE DENTIB2A DENTIBLD                                                        
DENTIBLD CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         USING DPRINT,R9                                                        
         MVC   P(18),0(R2)                                                      
         GOTO1 VHEXOUT,DMCB,(R6),P+50,18                                        
         GOTO1 VPRINTER                                                         
*                                                                               
GETN21   MVC   NTINUM,PNPNUM                                                    
*                                                                               
* NHTI:                                                                         
         MVI   STATN,C'H'                                                       
         SR    R6,R6                                                            
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'098DENTIBLD2 05/01/02'                                      
         END                                                                    
