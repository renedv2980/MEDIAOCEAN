*          DATA SET TAGENA7    AT LEVEL 008 AS OF 04/08/14                      
*PHASE T702A7A,*                                                                
         TITLE 'T702A7 - W2 LIST'                                               
T702A7   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T702A7                                                         
...
VK05     CLI   5(R2),4             INPUT MUST BE 4 LONG                         
         ...
         CLC   WORK(4),=4X'F0'                                                  
         BNE   INVERR                                                           
         MVC   TIFYEAR(2),SW2YEAR+2                                             
*                                                                               
VK10     OI    4(R2),X'20'                                                      
         LA    R2,SW2CURRH         CURRENCY FILTER                              
         TM    4(R2),X'20'         ALREADY VALIDATED                            
         BO    VK12                                                             
         MVI   MYCURR,C'U'         DEFAULT US DOLLARS                           
         CLI   5(R2),0                                                          
         BE    VK12                                                             
         CLI   8(R2),C'N'                                                       
         BE    VK12                                                             
         ...
         MVI   MYCURR,C'C'                                                      
*                                                                               
VK12     MVC   TIFCUR,MYCURR                                                    
         OI    4(R2),X'20'                                                      
         BAS   RE,SETTAL           SET TALENT FILE                              
         LA    R2,SW2EMPH          EMP FILTER                                   
         TM    4(R2),X'20'         ALREADY VALIDATED                            
         BO    VK15                                                             
         MVC   SW2EMPN,SPACES                                                   
         OI    SW2EMPNH+6,X'80'                                                 
...
VK13     BAS   RE,SETTAL           SET TALENT FILE                              
         GOTO1 RECVAL,DMCB,TLEMCDQ,(X'28',(R2)),SW2EMPNH                        
         BAS   RE,SETCHK           SET CHECK FILE                               
*                                                                               
VK15     MVC   TIFEMP,TGEMP                                                     
         OI    4(R2),X'20'                                                      
         LA    R2,SW2STRH          START AT                                     
         TM    4(R2),X'20'         ALREADY VALIDATED                            
         BO    VK20                                                             
...
*                                                                               
         ...
         MVI   TIREAD,TLW2CDQ      LIST W2 RECORDS                              
*                                                                               
INITX    B     XIT                                                              
         EJECT                                                                  
*                                                                               
...
PR02     MVC   LISTAR,SPACES       CLEAR PREVIOUS LINE                          
         ...
         MVC   TGSSN,TISSN                                                      
         OC    TLW2CDTE,TLW2CDTE                                                
         BZ    PR05                                                             
         MVC   TEMP,TLW2CDTE       LAST CHANGED DATE                            
         XC    TEMP,=X'FFFFFF'     UNCOMPLEMENT IT                              
         GOTO1 DATCON,DMCB,(1,TEMP),(5,W2CHANGE)                                
*                                                                               
...
* DDSPLWORKD                                                                    
       ...
       ++INCLUDE DDSPLWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008TAGENA7   04/08/14'                                      
         END                                                                    
