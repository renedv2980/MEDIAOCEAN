*          DATA SET NEMED6E    AT LEVEL 004 AS OF 01/23/20                      
*          DATA SET NEMED6E    AT LEVEL 088 AS OF 06/10/15                      
*PHASE T31E6EA,*                                                                
*INCLUDE NETNET                                                                 
*INCLUDE DDUCOM                                                                 
         TITLE 'T31E6E-SJN NETWORK INTERFACE TAPE'                              
***********************************************************************         
* USER    JIRA       DATE                  CHANGE LOG                 *         
* ---- ----------  -------- ----------------------------------------- *         
* AKAT SPEC-42647  01/23/20 INCREASE STATION BUFFER TO 6K             *         
***********************************************************************         
T31E6E   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**SCJP**,RR=R2                                                 
...
DODET20  BAS   RE,GETEST       *RETURNS EST STRT DAT IN WORK YYYYMMDD           
         MVC   PHURN,WORK+8    REFERENCE NUMBER                                 
         CLC   PHURN,=8X'40'       SKIP IF EMPTY                                
         BH    *+8                                                              
         MVI   BYTE,C'N'                                                        
         MVC   PHESTDAT,WORK                                                    
...
GETEST10 CLI   0(R1),0                                                          
         ...
         BE    GETEST20                                                         
         LA    R1,22(R1)           BUMP ESTABLE                                 
         B     GETEST10                                                         
GETEST20 MVC   WORK(16),6(R1)      MOVE DATE AND REFERENCE NUMBER               
         B     GETESTX                                                          
*                                                                               
...
*                                                                               
*  SPACE FILL THE REFERENCE NUMBER                                              
         LA    RE,WORK+8                                                        
         LA    RF,EUSER1+7                                                      
         LA    R1,8                                                             
GETEST30 CLI   0(RF),X'40'                                                      
         BH    GETEST35                                                         
         MVI   0(RE),X'F0'                                                      
         LA    RE,1(RE)                                                         
         BCTR  RF,0                                                             
         BCT   R1,GETEST30                                                      
GETEST35 MVC   0(8,RE),EUSER1                                                   
******   MVC   WORK+8(8),EUSER1    REFERENCE NUMBER                             
*                                                                               
         LAY   R1,ESTABLE          ADD DATE TO TABLE                            
GETEST40 CLI   0(R1),X'FF'         EOF?                                         
         ...
         LA    R1,22(R1)           BUMP ESTABLE                                 
         B     GETEST40                                                         
         MVC   6(16,R1),WORK       ADD DATE AND REF NUMBER TO TABLE             
*                                                                               
...
*******************************************************************             
         ...
         LTORG                                                                  
*********************************************************************           
NETBUFF  DS    CL6000   INCREASE TO 6K                                          
*                                                                               
ESTABLE  DS    CL4400   ROOM FOR 200 (CL22) RECORDS                             
         DC    X'FF'                                                            
...
*                                                                               
       ...
       ++INCLUDE NEDATELSTD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004NEMED6E   01/23/20'                                      
         END                                                                    
