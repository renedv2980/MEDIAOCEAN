*          DATA SET SRSSB00A   AT LEVEL 024 AS OF 05/01/02                      
*PHASE T13000A                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         PUSH  USING                                                            
         USING TTSSHDRD,IOA                                                     
         EDIT  (B2,TTSMAX),(5,MAXTMPT),ALIGN=LEFT                               
         EDIT  (B4,TTSMAXCI),(5,MAXTMPS),ALIGN=LEFT,ZERO=NOBLANK                
         EDIT  (B4,TTSUSECI),(5,ACTTMPS),ALIGN=LEFT,ZERO=NOBLANK                
*                                                                               
         LA    R5,SRVL15           TEMPEST INFO                                 
         USING LINEF1,R5                                                        
         EDIT  (B4,TTSHICI),(5,HITMPS),ALIGN=LEFT,ZERO=NOBLANK                  
         POP   USING                                                            
*                                                                               
         LA    R5,SRVL14                                                        
         USING LINEF,R5                                                         
...
* DDCOMFACS                                                                     
       ...
       ++INCLUDE DDCOMFACS                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024SRSSB00A  05/01/02'                                      
         END                                                                    
