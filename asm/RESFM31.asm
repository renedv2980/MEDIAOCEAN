*          DATA SET RESFM31    AT LEVEL 099 AS OF 01/23/04                      
*PHASE T81831A                                                                  
...
**       OI    TKOSTATH+4,X'20'    SET VALIDATED                                
         ...
         OI    TKOKPPNH+4,X'20'    SET VALIDATED                                
         OI    TKOKPRDH+4,X'20'    SET VALIDATED                                
...
*                                                                               
         XC    TKOKEY,TKOKEY                                                    
         MVI   MISCFLAG,0          CLEAR MISCELLANEOUS FLAGS                    
*                                                                               
...
VKEY0180 DS    0H                                                               
         ...
         LA    R2,TKOKPPNH         POINT HERE IF ERROR                          
         ZIC   RF,FILTER                                                        
         LA    RF,1(RF)                                                         
         STC   RF,FILTER                                                        
                                                                                
         MVC   TKOHFLD(3),=C'PPN'  SOFT SCREEN HEADING                          
                                                                                
         MVI   TKOKEY,X'1F'                                                     
         MVC   TKOKEY+16(2),AGENCY                                              
         MVC   TKOKEY+18(2),SRCEREP                                             
         MVI   TKOKEY+20,7         SET KEY TO 'CONTYPE'                         
         CLI   TKOKPPN,C'?'        START WITH FIRST RECORD?                     
         BE    VKEY0220            YES                                          
         MVC   TKOKEY+21(1),TKOKPPN                                             
...
VKEY0200 DS    0H                                                               
         ...
         LA    R2,TKOKPRDH         POINT HERE IF ERROR                          
         ZIC   RF,FILTER                                                        
         LA    RF,1(RF)                                                         
         STC   RF,FILTER                                                        
                                                                                
         OI    MISCFLAG,X'80'      SET 'PRODUCT CODES' FLAG                     
         MVC   TKOHFLD(3),=C'PRD'  SOFT SCREEN HEADING                          
                                                                                
         MVI   TKOKEY,X'1F'        SPECIAL KEY FOR PRODUCT                      
         MVI   TKOKEY+1,X'01'                                                   
         MVC   TKOKEY+16(2),AGENCY                                              
         MVC   TKOKEY+18(2),SRCEREP                                             
*                                                                               
*   THERE IS NO TYPE FOR THIS RECORD.  SPECIAL KEY HANDLES                      
*                                                                               
***>>>   MVI   TKOKEY+20,*         SET KEY TO 'CONTYPE'                         
*                                                                               
         CLI   TKOKPRD,C'?'        START WITH FIRST RECORD?                     
         BE    VKEY0220            YES                                          
         MVC   TKOKEY+21(1),TKOKPRD                                             
...
LIST40   DS    0H                                                               
         TM    MISCFLAG,X'80'      PRODUCT CODE DISPLAY?                        
         BO    LIST60              YES                                          
...
*                                                                               
LIST60   DS    0H                                                               
         CLC   KEY(20),KEYSAVE     SAME KEY THRU REP CODE?                      
         BNE   LIST200             NO                                           
*                                                                               
LIST100  DS    0H                                                               
...
DILI0040 EQU   *                                                                
         ...
         B     DILI0055                                                         
DILI0050 DS    0H                                                               
         MVC   8(7,R2),RTK2KCOD    INSERT ORIGINAL (SOURCE) CODE                
         MVC   SAVE2ADV,RTK2ADV    SAVE ADV EQUIV   CODE                        
*                                     FOR PRODUCT RECORD TYPE                   
*                                  THIS IS IN THE X'02' ELEMENT                 
*                                     BUT IS DIRECTLY ADDRESSABLE               
*                                     (AT LEAST FOR NOW)                        
DILI0055 DS    0H                                                               
         ...
         TM    MISCFLAG,X'80'      PRODUCT CODE DISPLAY?                        
         BNO   DILI0058            NO  -                                        
         GOTO1 VPRD                EXPANDED PRODUCT    NAME                     
         ZIC   R0,0(R2)            BUMP TO NEXT FIELD                           
         AR    R2,R0                                                            
         MVC   8(20,R2),WORK       INSERT EXPANSION INTO FIELD                  
         B     DILI0120                                                         
...
DILI0110 DS    0H                                                               
         CLI   RTKOKRTP,7          POINT PERSON TYPE RECORD?                    
         BE    *+6                                                              
         DC    H'0'                                                             
         GOTO1 VPPN                EXPANDED CONTYPE NAME                        
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
         MVC   8(20,R2),WORK                                                    
         B     DILI0120                                                         
...
VNEW0066 EQU   *                                                                
         CLC   =C'PPN',TKOHFLD     POINTPERSON?                                 
         BNE   VNEW0072            NO                                           
         MVI   KEY,X'31'           SET 'P/P    KEY'                             
         LR    R3,R2               BUMP TO CODE FIELD                           
         ZIC   RF,0(R3)                                                         
         AR    R3,RF               BUMP TO NEXT FIELD                           
         CLI   5(R3),3             EXCEED MAX LENGTH?                           
         ...
         B     VNEW0440            CHECK NEXT FIELD                             
VNEW0072 EQU   *                                                                
         CLC   =C'PRD',TKOHFLD     PRODUCT?                                     
         BNE   VNEW0080            NO                                           
         MVI   KEY,X'09'           SET 'PRODUCT KEY'                            
         LR    R3,R2               BUMP TO CODE FIELD                           
         ZIC   RF,0(R3)                                                         
         AR    R3,RF               BUMP TO NEXT FIELD                           
         CLI   5(R3),7             EXCEED MAX LENGTH?                           
         BH    VNEW0900            YES                                          
         MVC   KEY+25(2),AGENCY    INSERT REP CODE INTO KEY                     
         MVC   KEY+18(7),8(R3)     INSERT CODE IN KEY                           
         OC    KEY+18(7),SPACES    SET BIN ZERO TO SPACE                        
         GOTO1 HIGH                READ KEY                                     
         CLC   KEY(27),KEYSAVE     KEY FOUND?                                   
         BNE   VNEW0900            NO  - ERROR ENCOUNTERED                      
         B     VNEW0440            CHECK NEXT FIELD                             
...
VPRD     NTR1                                                                   
         ...
         MVC   RPRDKADV,SAVE2ADV   ADV                                          
*                                                                               
         MVC   RPRDKPRD,SAVEEQIV   PRODUCT CODE                                 
         OC    RPRDKADV(7),SPACES                                               
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE                                                  
         BNE   NO                                                               
         DROP  R6                                                               
...
VSAL     NTR1                                                                   
         ...
         EJECT                                                                  
*********************************************************************           
* RETRIEVES POINTPERSON NAME TO WORK                                            
* R2 IS FIELD HEADER                                                            
* USES AIO3 FOR TEMP IOAREA                                                     
*********************************************************************           
VPPN     NTR1                                                                   
         ...
         MVC   RPTPKREC,SAVEEQIV   POINT PERSON INITIALS                        
         OC    RPTPKREC,SPACES                                                  
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE                                                  
         BNE   EXIT                                                             
...
SAVE2ADV DS    CL4                 SAVE ADV EQUIV   CODE                        
*                                                                               
...
MISCFLAG DS    X                   X'80' = PRODUCT: DIFFERENT KEY               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'099RESFM31   01/23/04'                                      
         END                                                                    
