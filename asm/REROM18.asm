*          DATA SET REROM18    AT LEVEL 155 AS OF 02/07/03                      
*PHASE T82F18A                                                                  
         TITLE 'T82F18 - REROM18 - MAKEGOOD LIST'                               
***********************************************************************         
*                                                                     *         
*  REROM18 (T82F18) --- MAKEGOOD LIST                                 *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
...
***>>>   PRINT OFF                                                              
       ...
       ++INCLUDE DDGENTWA                                                       
         ORG   CONTAGH                                                          
*                                                                               
*      PRODUCTION SCREEN IS REROMF2D - REORDER BEFORE GOING LIVE                
*                                                                               
       ++INCLUDE REROMF2D                                                       
       ++INCLUDE REDARTWA                                                       
       ++INCLUDE REDARWORKD                                                     
...
LSTCWHO  DS    CL3                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'155REROM18   02/07/03'                                      
         END                                                                    
