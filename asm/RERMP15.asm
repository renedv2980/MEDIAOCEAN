*          DATA SET RERMP15    AT LEVEL 080 AS OF 04/14/09                      
*PHASE T81015C                                                                  
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLST                                                                
...
*******************************************************************             
*                                                                 *             
*        RERMP15 (T81015) --- REPPAK FILE MAINT - MULT INV ADD    *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
*                                                                 *             
* MAR25/09 (SMY) --- SUPPORT NEW INVENTORY KEY                    *             
*                                                                 *             
...
*                                                                               
         MVI   ERROR,INVALID                                                    
         CLC   =C'ALL',8(R2)       DON'T ALLOW INV 'ALL'                        
         BE    ERREND                                                           
         CLI   5(R2),1                                                          
         BNE   BLDL060                                                          
...
*                                                                               
         MVI   ERROR,OVERLAP                                                    
*                                  DOES RETURNED RECORD QUALIFY                 
         CLC   SAVEKEY(RINVKSTD-RINVKEY),0(R3)                                  
         BNE   CHKDEX              NO EXIT                                      
...
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(RINVKSTD-RINVKEY),0(R2)                                      
         GOTO1 HIGH                                                             
         SPACE 1                                                                
ENDOLDA  DS    0H                                                               
         CLC   KEYSAVE(RINVKSTD-RINVKEY),0(R2)                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'080RERMP15   04/14/09'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
