*          DATA SET PUBCOPYJ   AT LEVEL 011 AS OF 05/01/02                      
*PHASE PUBCOPYJ,*,NOAUTO                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PUBCOPYJ - PRT/PUB FILE PEEL-OFF'                               
PUBCOPYJ CSECT                                                                  
         NBASE 0,PUBCOPYJ,=V(REGSAVE)                                           
         SPACE 2                                                                
         BAS   RE,PRNT                                                          
*&&DO                                                                           
         OPEN  IN,OUT                                                           
...
GET      DS    0H                                                               
         ...
         BE    EOJ                                                              
***                                                                             
         CLI   REC,0          SKIP ALL PUBS WITH NO MEDIA                       
         BE    GET                                                              
         B     PUT            COPY ALL PUBS WITH A MEDIA                        
***                                                                             
         LA    R4,AGMLST                                                        
         MVC   WORK(2),REC+7                                                    
         MVC   WORK+2(1),REC                                                    
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011PUBCOPYJ  05/01/02'                                      
         END                                                                    
