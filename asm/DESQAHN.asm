*          DATA SET DESQAHN    AT LEVEL 002 AS OF 02/13/18                      
...
* BOOKTYPE                                                                      
***************************************************************                 
         MVI   BOOKTYPE,C'R'    DEFAULT BOOKTYPE IS 'R'                         
         MVC   DRBTYP,BOOKTYPE                                                  
***************************************************************                 
* QUARTER NAME                                                                  
*   BYTES 0-3 = YEAR                                                            
...
*                                                                               
         ...
         MVC   DRHIQHR,4(R4)       DAYPART EQUATE                               
**********************************************************                      
*                                                                               
**********************************************************                      
         GOTO1 MKTTYPE                                                          
...
OUT230   LARL  RE,OUTDATA                                                       
         ...
         B     GET                                                              
*                                                                               
ENDJOB   TM    DATAFLAG,DFGOTREC   ANY RECORD IN INPUT DATASET?                 
         JZ    CLSE                                                             
         BAS   RE,HEADFILL                                                      
         PUT   OUT,SVOUTREC                                                     
         LARL  RF,OUTDATA                                                       
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002DESQAHN   02/13/18'                                      
         END                                                                    
