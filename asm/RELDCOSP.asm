*          DATA SET RELDCOSP   AT LEVEL 016 AS OF 05/01/02                      
*PHASE RELDDELE,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
*INCLUDE RECUP                                                                  
*INCLUDE HEXOUT                                                                 
         TITLE 'RELDDELE - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
*                                  PROCESS FOR CONTRACT RECORDS                 
         CLI   RCONKTYP,X'0C'                                                   
         BNE   DMX0020                                                          
         CLC   =C'B1',RCONKREP     TELEMUNDO?                                   
         BE    DMXPURGE                                                         
         CLC   =C'UV',RCONKREP     UNIVISION?                                   
         BE    DMXPURGE                                                         
         B     DMXKEEP                                                          
         DROP  R5                                                               
*                                                                               
DMX0020  EQU   *                                                                
         L     R5,AREC             POINT TO RECORD                              
         USING RBUYREC,R5                                                       
*                                  PROCESS FOR BUY RECORDS                      
         CLI   RBUYKTYP,X'0B'                                                   
         BNE   DMXKEEP                                                          
         CLC   =C'B1',RBUYKREP     TELEMUNDO?                                   
         BE    DMXPURGE                                                         
         CLC   =C'UV',RBUYKREP     UNIVISION?                                   
         BE    DMXPURGE                                                         
         B     DMXKEEP                                                          
         DROP  R5                                                               
*                                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016RELDCOSP  05/01/02'                                      
         END                                                                    
