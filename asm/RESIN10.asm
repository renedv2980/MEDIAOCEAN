*          DATA SET RESIN10    AT LEVEL 093 AS OF 05/01/02                      
*PHASE T80610A,*                                                                
...
*                    WORKING STORAGE                                *           
*                                                                   *           
* 25MAR99  (BU ) --- ALTERNATE CALENDAR $ PROCESSING                *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*********************************************************************           
...
* BUILD INVOICE ELEMENT                                                         
         MVC   WORK(2),=X'040A'    SET REGULAR $ INV BUCKET                     
         CLC   =C'CHN',SINACT      ALTERNATE CALENDAR REQUEST?                  
         BNE   C055                NO                                           
         MVC   WORK(2),=X'540A'    SET ALTERNATE CALENDAR $ INV BKT             
C055     EQU   *                                                                
...
C112     CLC   =C'CHN',SINACT      ALTERNATE CALENDAR REQUEST?                  
         BNE   C115                NO                                           
         GOTO1 VGETMON,(R1),(X'54',RCONREC),(R5),FULL                           
         B     C117                                                             
...
*                                                                               
       ++INCLUDE FATWA                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'093RESIN10   05/01/02'                                      
         END                                                                    
