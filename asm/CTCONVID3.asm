*          DATA SET CTCONVID3  AT LEVEL 224 AS OF 05/01/02                      
*PHASE CONVID3                                                                  
*INCLUDE DMDMGRL                                                                
*INCLUDE DMUTLCT                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE GETFACT                                                                
*INCLUDE CARDS                                                                  
         TITLE 'CONVID3 - ID RECORD CLEAR EXTERNAL'                             
CONVID3  CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         BNE   MERR                  EXIT IF ERROR                              
*                                                                               
         BAS   RE,UPDAGYT          READ CTFILE & UPDATE AGENCY TABLE            
         BNE   MERR                  EXIT IF ERROR                              
*                                                                               
...
RAGYOK   ST    R2,AAGYTABL                                                      
         ...
         EJECT                                                                  
***********************************************************************         
* READ CONTROL FILE ACCESS RECORDS AND UPDATE AGENCY TABLE            *         
***********************************************************************         
UPDAGYT  NTR1  ,                                                                
         ZAP   LINE,=P'99'                                                      
         MVC   P(15),=C'NEW AGENCY LIST'                                        
         GOTO1 VPRINTER                                                         
         GOTO1 VPRINTER                                                         
...
*                                                                               
         ...
         USING CT5REC,R2                                                        
         XC    CT5KEY,CT5KEY                                                    
         GOTO1 ,DMCB,DMRDHI,CTFILE,CT5KEY,CT5KEY                                
*                                                                               
UPDA010  GOTO1 VDATAMGR,DMCB       GET FIRST/NEXT RECORD                        
         LA    R0,DMRSEQ                                                        
         ST    R0,DMCB                                                          
         CLI   8(R1),0                                                          
         BE    *+14                                                             
...
*                                                                               
         ...
         BE    UPDA020                                                          
         B     UPDA010                                                          
*                                  PROCESS ACCESS RECORD                        
UPDA020  MVC   AGYALPH,CT5KALPH    GET AGENCY ALPHA                             
         MVC   P+2(2),AGYALPH                                                   
         BAS   RE,VALAGY                                                        
         BE    UPDA010             AGENCY ALREADY IN LIST                       
         L     RF,AAGYTABL           ELSE PUT NEW AGENCY IN LIST                
         MVC   0(2,RF),AGYALPH                                                  
         MVI   2(RF),C'+'                                                       
         LA    RF,3(RF)                                                         
         C     RF,AAGYTABX                                                      
         ...
         B     UPDA010                                                          
*                                                                               
UPDA2000 MVC   P,SPACES                                                         
         GOTO1 VPRINTER                                                         
         MVC   P(22),=C'END OF NEW AGENCY LIST'                                 
         GOTO1 VPRINTER                                                         
         B     UPDAOK                                                           
*                                                                               
UPDANO   B     NO                                                               
...
RUID2000 MVC   P,SPACES                                                         
         GOTO1 VPRINTER                                                         
         MVC   P(23),=C'# OF RECORDS INVALID = '                                
         EDIT  COUNT1,(8,P+24),ALIGN=LEFT,ZERO=NOBLANK                          
         GOTO1 VPRINTER                                                         
...
RCTF100  CLI   0(R4),0             END OF TABLE                                 
         BE    RCTF1000              RECORD TYPE NOT IN TABLE                   
...
RCTF110  MVC   P,SPACES                                                         
         ...
         MVI   FIRSTFLG,1                                                       
         B     RCTF110B                                                         
RCTF110A MVC   P(23),=C'# OF RECORDS DELETED = '                                
         EDIT  COUNT1,(8,P+24),ALIGN=LEFT,ZERO=NOBLANK                          
         GOTO1 VPRINTER                                                         
         MVC   P(20),=C'# OF CHANGES MADE = '                                   
         EDIT  COUNT2,(8,P+24),ALIGN=LEFT,ZERO=NOBLANK                          
         GOTO1 VPRINTER                                                         
RCTF110B ZAP   LINE,=P'99'                                                      
         GOTO1 VPRINTER                                                         
...
ATER130  EQU   *                                                                
         ...
         MVC   P+30(10),2(R3)                                                   
* ??     BAS   RE,DELETE                                                        
         MVC   P+42(33),=C'!?*% PRINCIPLE ID IS INVALID $#@+'                   
         GOTO1 VPRINTER                                                         
*        BAS   RE,BUMPCNT2                                                      
* ??     B     ATER110                                                          
         B     ATER120                                                          
...
UIDTABX  EQU   *                                                                
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'224CTCONVID3 05/01/02'                                      
         END                                                                    
