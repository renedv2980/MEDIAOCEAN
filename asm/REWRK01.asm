*          DATA SET REWRK01    AT LEVEL 004 AS OF 05/01/02                      
*          DATA SET REWRK01    AT LEVEL 002 AS OF 09/17/84                      
*PHASE T81101A                                                                  
*INCLUDE XSORT                                                                  
         TITLE 'REP WRK - DISPLAY/STATUS FILE FUNCTIONS'                        
         PRINT NOGEN                                                            
WKDISP   CSECT                                                                  
         NMOD1 000,**RWK1**                                                     
         LR    RC,R1                                                            
...
*DDFLDHDR                                                                       
       ++INCLUDE DDFLDHDR                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004REWRK01   05/01/02'                                      
         END                                                                    
