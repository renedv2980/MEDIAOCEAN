*          DATA SET REPFACSJ   AT LEVEL 081 AS OF 04/14/99                      
*PHASE T00AACA                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE REGENPTR                                                               
*INCLUDE REBROWSE                                                               
...
RFTAB    DS    0H                                                               
         ...
         DC    AL1(RFCKPSEC),VL4(RECKPSEC),X'90'                                
...
*                                                                               
* INPUT:                                                                        
*             P1 - A(OLD CONTRACT)  - IF 0 THEN THIS IS AN ADD                  
*             P2 - A(NEW CONTRACT)                                              
*             P3 - DISK ADRESS                                                  
*             P4 - A(RFBLOCK)                                                   
*                                                                               
...
*                                                                               
         LTR   R3,R3                                                            
         BZ    CKEY002             THIS IS AN ADD REQUEST                       
*                                                                               
...
*                                                                               
         LTR   R3,R3                                                            
         BZ    CKEY150             THIS IS AN ADD REQUEST                       
*                                                                               
...
*                                                                               
CKEY020  DS    0H                                                               
         CLI   0(R2),X'DC'       SPECIAL BOP COMPARE                            
         BNE   CKEY022                                                          
*                                                                               
         CLC   0(RCONBDTE-RCONBTYP,R2),0(R4)     DO NOT CHECK DATE              
         BNE   CKEY030                                                          
         CLC   0(27-((RCONBDTE+L'RCONBDTE)-RCONBTYP),R2),0(R4)                  
         BNE   CKEY030                                                          
         B     CKEY024                                                          
*                                                                               
CKEY022  DS    0H                                                               
...
*                                                                               
         ...
         AHI   R2,2048                                                          
         SR    R3,R3                                                            
         ICM   R3,1,2(R2)            GET NEW KEY COUNT                          
         BZ    CKEY250                                                          
         LA    R2,3(R2)                                                         
*                                                                               
CKEY200  DS    0H                                                               
...
*                                                                               
         ...
         BNE   CKEY210                                                          
*                                                                               
         NI    KEY+27,X'FF'-X'80'   UNSET DELETED BIT                           
...
*                                                                               
       ...
       ++INCLUDE SEACSFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'081REPFACSJ  04/14/99'                                      
         END                                                                    
