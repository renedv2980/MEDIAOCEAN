*          DATA SET PPREPWB01  AT LEVEL 001 AS OF 03/20/12                      
*PHASE PPWB01A,+0                                                               
         TITLE 'PPWB01 - PRINTPAK P&&G INTERFACE SPECS'                         
PPWB01   CSECT                                                                  
         SPACE 2                                                                
         FSPEC READ,BILLS                                                       
         SPACE 2                                                                
         SPROG 0,50                                                             
         PSPEC H1,1,MEDIA                                                       
         PSPEC H1,51,C'PRINTPAK WARNER BROS. INTERFACE'                         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001PPREPWB01 03/20/12'                                      
         END                                                                    
