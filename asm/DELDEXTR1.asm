*          DATA SET DELDEXTR1  AT LEVEL 018 AS OF 05/01/02                      
*PHASE DELDEXR,+0                                                               
*INCLUDE LOGIO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
*                                                                               
         ...
         CLI   2(R3),C'A'                                                       
         BNE   DMXOK                                                            
         LA    R2,ARBRECS          NEITHER ARB OR NSI OR BBM                    
         SPACE 1                                                                
DMXREC1  DS    0H                                                               
         ...
         CLI   BSIND,2                                                          
         BNE   DMXM2                                                            
         CLC   BSBOOK,=X'9AFD'     FEB/01                                       
         BNE   DMXOK                                                            
         CLI   BSBTYP,X'00'                                                     
         BNE   DMXOK                                                            
*                                                                               
         LA    RE,MKTLIST                                                       
BSMCHK   CLI   0(RE),X'FF'                                                      
         BE    DMXOK                                                            
         CLC   BSRMKT(2),0(RE)                                                  
         BE *+12                                                                
         LA    RE,2(RE)                                                         
...
*        CLC   MLRMKT,=H'299'                                                   
*        BE    DMXREC2                                                          
         CLC   MLBOOK,=X'9AFD'     FEB/01                                       
         BNE   DMXOK                                                            
*                                                                               
         LA    RE,MKTLIST                                                       
MLBCHK   CLI   0(RE),X'FF'                                                      
         BE    DMXOK                                                            
         CLC   MLRMKT(2),0(RE)                                                  
         BE    *+12                                                             
         LA    RE,2(RE)                                                         
...
DMXSTA   CLI   0(R3),C'S'                                                       
         ...
         CLI   SBBTYP,X'00'                                                     
         BNE   DMXOK                                                            
         CLC   SBBOOK,=X'6502'     FEB/01                                       
         BNE   DMXOK                                                            
*                                                                               
         LA    RE,MKTLIST                                                       
STACHK   CLI   0(RE),X'FF'                                                      
         BE    DMXOK                                                            
         CLC   SBRMKT(2),0(RE)                                                  
         BE    *+12                                                             
         LA    RE,2(RE)                                                         
...
DMXRTG   CLI   0(R3),C'D'                                                       
         ...
         CLI   DRBTYP,X'00'                                                     
         BNE   DMXOK                                                            
         CLC   DRBOOK,=X'9AFD'     FEB/01                                       
         BNE   DMXOK                                                            
*                                                                               
         LA    RE,MKTLIST                                                       
RTGCHK   CLI   0(RE),X'FF'                                                      
         BE    DMXOK                                                            
         CLC   DRKMKT(2),0(RE)                                                  
         BE    *+12                                                             
         LA    RE,2(RE)                                                         
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018DELDEXTR1 05/01/02'                                      
         END                                                                    
