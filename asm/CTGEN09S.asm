*          DATA SET CTGEN09S   AT LEVEL 004 AS OF 05/01/02                      
*PHASE TA0B09A                                                                  
*INCLUDE SCINKEY                                                                
*INCLUDE CHOPPER                                                                
*INCLUDE SQUASHER                                                               
...
DATAVAL  EQU   *                                                                
         ...
         LA    R4,3(R4)                                                         
         STC   R4,APELEM+1                                                      
         GOTO1 AADDELS,CTPREC      AND ADD TO RECORD                            
*                                                                               
...
*                                  ALL OTHER ELEMENTS S/B PROFILES              
         MVC   APWORK(1),0(R3)                                                  
         NI    APWORK,X'F0'                                                     
         CLI   APWORK,X'40'        IS THIS A PROFILE ELEMENT                    
         BNE   DISPR4              NO - IGNORE                                  
         CLC   2(1,R3),PROTYPE       ELSE FILTER ON PROFILE TYPE/DATA           
         BE    DISPR3                                                           
         CLI   0(R3),CTPRIELQ        UNLESS PRIORITY CODE EL.                   
         BNE   DISPR4                                                           
...
DISPDE4  L     RE,RETURN                                                        
         MVI   PRODSTI,C'#'                                                     
         LA    R4,PRODSTI+1                                                     
         EDIT  (B2,CTDCNUM),(3,0(R4)),ALIGN=LEFT                                
         MVI   PRODESL+17,C'*'                                                  
         BR    RE                                                               
         EJECT                                                                  
...
LOCALX   EQU   *                                                                
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004CTGEN09S  05/01/02'                                      
         END                                                                    
