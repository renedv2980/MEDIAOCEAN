*          DATA SET CTSFM08    AT LEVEL 014 AS OF 05/01/02                      
*PHASE TA0A08A                                                                  
*                                                                               
***********************************************************************         
* GENCON CALLS THIS MODULE WHEN THE USER ENTERS - RECORD: SCRIPT      *         
* ACTION: REPORT. THE FIRST PARAM IS THE ADDRESS OF GENCON'S WORK     *         
* AREA. REGISTER USAGE:                                               *         
*                                                                     *         
*   R0  LOCAL WORK                                                    *         
*   R1  LOCAL WORK                                                    *         
*   R2  SCREEN FIELDS                                                 *         
*   R3  RECORDS AND ELEMENTS                                          *         
*   R4                                                                *         
*   R5                                                                *         
*   R6  BASE                                                          *         
*   R7  BASE                                                          *         
...
*                                                                     *         
***********************************************************************         
         TITLE 'TA0A08 HELP RECORD UPDATE'                                      
TA0A08   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,TA0A08,R7,R6                                                   
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
...
PR120    MVC   PFLD3(4),=C'PAGE'                                                
         EDIT  HV1PAGE,(2,PFLD4),ALIGN=LEFT                                     
*                                                                               
...
PR160    MVC   KEYSAVE,KEY                                                      
         ...
         DC    H'0'                                                             
*                                                                               
PR170    CLI   RECFOUND,C'Y'       TEST ANY RECORDS FOUND                       
         BE    PRX                 YES                                          
         MVI   USEHDHK,C'N'        NO HELP RECORDS                              
         MVC   P(21),=C'NO HELP RECORDS FOUND'                                  
         GOTO1 SPOOL,DMCB,(R8)     PRINT ERROR MESSAGE                          
*                                                                               
PRX      B     XIT                                                              
         EJECT                                                                  
...
HEADING  SSPEC H1,95,REPORT                                                     
         ...
         GETEL R3,42,ELCODE                                                     
         EJECT                                                                  
* TABLE TO TRANSLATE SYSTEM NAMES INTO NUMBERS                                  
         SPACE 2                                                                
       ++INCLUDE FASYSLST                                                       
         EJECT                                                                  
* TABLE TO TRANSLATE LANGUAGE NAMES INTO NUMBERS                                
         SPACE 2                                                                
       ++INCLUDE FALANGTAB                                                      
         EJECT                                                                  
* DSECT COVERING HELP RECORDS                                                   
         SPACE 2                                                                
       ++INCLUDE CTGENHV1                                                       
         EJECT                                                                  
* DSECT COVERING PRINT AREA                                                     
         SPACE 2                                                                
       ++INCLUDE DDSPOOLD                                                       
         EJECT                                                                  
* DSECT COVERING GENCON'S WORK AREA                                             
         SPACE 2                                                                
       ++INCLUDE DDSPLWORKD                                                     
         EJECT                                                                  
* DSECT COVERING TABLE THAT TRANSLATES SYSTEM NAMES INTO NUMBERS                
         SPACE 2                                                                
       ++INCLUDE FASYSLSTD                                                      
         EJECT                                                                  
* DSECT COVERING TABLE THAT TRANSLATES SYS NUM INTO A(PROG TABLE)               
         SPACE 2                                                                
       ++INCLUDE FASELIST                                                       
         EJECT                                                                  
* DSECT COVERING TABLE THAT TRANSLATES PROGRAM NAMES INTO NUMBERS               
         SPACE 2                                                                
       ++INCLUDE FAPGMLST                                                       
         EJECT                                                                  
* DSECT COVERING TABLE THAT TRANSLATES LANGUAGE NAMES INTO NUMBERS              
         SPACE 2                                                                
       ++INCLUDE FALANG                                                         
         EJECT                                                                  
* DSECT COVERING ACTIVITY ELEMENT OF THE HELP RECORD. (INFO ABOUT               
* LAST CHANGE DATE, FIRST ADDED DATE, ETC).                                     
         SPACE 2                                                                
       ++INCLUDE DDACTIVD                                                       
         EJECT                                                                  
* DSECT COVERING CONTROLLER SCREEN                                              
         SPACE 2                                                                
       ++INCLUDE CTSFMFFD          CONTROLLER SCREEN                            
         EJECT                                                                  
         ORG   CONTAGH                                                          
* DSECT COVERING MY SCREEN                                                      
         SPACE 2                                                                
       ++INCLUDE CTSFMF8D          MY SCREEN                                    
         EJECT                                                                  
* DSECT COVERING SFM WORK AREA (THE PROGRAM TO WHICH I AM MEERLY                
* A HUMBLE OVERLAY.                                                             
         SPACE 2                                                                
       ++INCLUDE CTSFMWORKD                                                     
         EJECT                                                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014CTSFM08   05/01/02'                                      
         END                                                                    
