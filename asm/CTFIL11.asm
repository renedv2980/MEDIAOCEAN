*          DATA SET CTFIL11    AT LEVEL 015 AS OF 08/22/00                      
*&&      SET   NOP=N                                                            
*PHASE TA1311A                                                                  
...
INIT     GOTO1 VDICTAT,BOPARM,C'LU  ',DCLIST,DSLIST                             
         CLI   CSACT,A#BUILD                                                    
         BNE   EXITOK                                                           
         MVI   BASOPTX,1           SET HELP NUMBER FOR OPTIONS FIELD            
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* PFKEY  OBJECT                                                       *         
...
BLDSCR   GOTOX ('FLDVAL',AGROUTS),BASOPTH                                       
         CLI   BCPFKEY,0           DID USER PRESS PFKEY?                        
         BNE   BLDR04              YES - GO PROCESS IT THEN                     
*                                                                               
         CLI   FVIFLD,C'&&'        WANT TO VALIDATE TAG?                        
         BNE   BLDR01              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BADDTAG,FSRRECD,0                 
         B     EXIT                                                             
*                                                                               
BLDR01   CLI   FVIFLD,C'='         WANT TO MAKE SELECTION FOR ADD?              
         BNE   BLDR02              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BSFFORAD,FSRRECD,0                
         B     EXIT                                                             
*                                                                               
BLDR02   NI    GCINDS2,FF-GCIACTCP RESET FLAG                                   
         MVI   FVOMTYP,GTMINF                                                   
         MVC   FVMSGNO,=AL2(CI#WHAT)                                            
         B     EXITL                                                            
*                                                                               
BLDR04   CLI   BCPFKEY,PFK02       ADDING A FIELD?                              
         BNE   BLDR08              NO                                           
         CLI   FVILEN,0            INSTRUCTIONS IN OPTIONS FIELD                
         BE    EXITNO              SO SOMETHING MUST BE THERE!                  
*                                                                               
         CLI   FVIFLD,C'&&'        ADDING A TAG?                                
         BNE   BLDR06              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BADDTAG,FSRRECD,0                 
         B     EXIT                                                             
*                                                                               
BLDR06   TM    FVIIND,FVINUM       FIELDS ARE ADDED BY NUMBER                   
         BZ    EXITNV              INVALID                                      
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BADDFLD,FSRRECD,0                 
         B     EXIT                                                             
*                                                                               
BLDR08   CLI   BCPFKEY,PFK03       DELETING A FIELD?                            
         BNE   BLDR10              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BDELFLD,FSRRECD,0                 
         B     EXIT                                                             
*                                                                               
BLDR10   CLI   BCPFKEY,PFK04       ADDING A LINE?                               
         BNE   BLDR12              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BADDLINE,FSRRECD,0                
         B     EXIT                                                             
*                                                                               
BLDR12   CLI   BCPFKEY,PFK05       DELETING A LINE                              
         BNE   BLDR14              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BDELLINE,FSRRECD,0                
         B     EXIT                                                             
*                                                                               
BLDR14   CLI   BCPFKEY,PFK06       SELECTIVELY EDITING FIELD ON SCREEN          
         BNE   BLDR16              NO                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BEFCONSC,FSRRECD,0                
         B     EXIT                                                             
*                                                                               
BLDR16   CLI   BCPFKEY,PFK07       STARTING MAINTENANCE LIST                    
         BNE   BLDR18                                                           
         GOTO1 AGEN,BOPARM,('GCBOVER',OBUILD),BSLST,FSRRECD,0                   
         B     EXIT                                                             
*                                                                               
BLDR18   CLI   BCPFKEY,PFK08       ENDING MAINTENANCE LIST                      
         BNE   BLDR20                                                           
...
ADDT20   XR    RF,RF                                                            
         ...
         BNE   EXITL                                                            
*                                                                               
         CLI   BCPFKEY,PFK02       ADDING TAG TO SCREEN?                        
         BE    ADDT22                                                           
         MVI   FVOMTYP,GTMINF                                                   
         MVC   FVMSGNO,=AL2(CI#TOKAY)                                           
         B     EXITL               DON`T WANT TO ADD RIGHT NOW                  
*                                                                               
ADDT22   XC    BOELEM(FSRLN2Q),BOELEM                                           
         PUSH  USING                                                            
         USING FSRELD,BOELEM                                                    
...
*                                                                               
         ...
         CLM   R1,3,=AL2(24*80)    WILL IT FIT ONSCREEN?                        
         BNH   *+14                                                             
         MVC   FVMSGNO,=AL2(CE#SCROV)                                           
         B     EXITL                                                            
*                                                                               
ALIN04   IC    RE,FSRLN                                                         
         LA    RF,0(RE,RF)                                                      
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015CTFIL11   08/22/00'                                      
         END                                                                    
