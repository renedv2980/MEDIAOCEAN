*          DATA SET REREP3V02  AT LEVEL 254 AS OF 02/06/09                      
*PHASE RE3V02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3V02 - REREP3V02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3V02 - RE3V02 - MEDIA OCEAN DEMO FEED - (UNIVISION/HISP)   *           
*                                                                   *           
*********************************************************************           
...
RE3V02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3V02,R7,R8,RR=RE                                    
*                                                                               
...
*                                                                               
INPBLOCK DC    X'02'               NUMSTAS:   2                                 
         DC    CL05'KUVN '         STATION :  1                                 
         DC    CL05'KSTR '         STATION :  2                                 
*********************************************************************           
         DC    X'0F'                  NUMDPTS                                   
...
NUMDEMQ  EQU   (2*NUMCATQ)                                                      
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'254REREP3V02 02/06/09'                                      
         END                                                                    
**  INSERT END  >>                                                              
