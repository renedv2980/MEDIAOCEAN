*          DATA SET REREPMS02  AT LEVEL 021 AS OF 11/16/00                      
*          DATA SET REREPMS02  AT LEVEL 019 AS OF 05/19/99                      
*PHASE REMS02A                                                                  
*INCLUDE RECUP                                                                  
...
**  TEST REP CODE                                                               
*        MVC   P(2),REPCODE                                                     
*        MVC   P+5(16),=C' FOUND.  MASTER='                                     
*        MVC   P+24(2),R.RREPMAST                                               
*        MVC   P+28(27),R.RREPREC                                               
*        GOTO1 REPORT                                                           
**       CLC   =C'NU',REPCODE                                                   
*        BNE   *+6                                                              
*        DC    H'0'                                                             
...
*                                                                               
         ...
         BE    UPREC040            YES                                          
*                                                                               
         XC    WORK,WORK           NO - CREATE A PREVIOUS                       
         SR    R4,R4                                                            
         LA    RE,RSTAELEM                                                      
E        USING RSTAMCEL,RE                                                      
UPREC030 DS    0H                                                               
...
*                                                                               
         MVI   WORK,RSTAMCPQ       ADD AS PREVIOUS REP                          
         GOTO1 =V(RECUP),DMCB,(C'R',RSTAREC),WORK,RSTAELEM                      
*                                                                               
UPREC040 DS    0H                                                               
...
*  INCLUDE DDTSARD                                                              
       ...
       ++INCLUDE DDTSARD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021REREPMS02 11/16/00'                                      
         END                                                                    
