*          DATA SET REREP1H07A AT LEVEL 003 AS OF 05/01/02                      
*PHASE RE1H02A,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
POST0010 EQU   *                                                                
         ...
         USING RCONSTEL,R2                                                      
         CLC   RCONSTYR(2),=X'6001'   LESS THAN JAN96?                          
         BL    POST0010            YES - SKIP IT                                
         CLC   RCONSTYR(2),=X'6004'   MORE THAN APR96?                          
         BH    POST0010            YES - SKIP IT                                
         MVI   0(R2),X'FF'         NO  - SET TO DELETE IT                       
         MVI   HELOFLAG,C'Y'                                                    
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003REREP1H07A05/01/02'                                      
         END                                                                    
