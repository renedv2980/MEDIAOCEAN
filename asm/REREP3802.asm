*          DATA SET REREP3802  AT LEVEL 034 AS OF 05/01/02                      
*PHASE RE3802C,*                                                                
***********************************************************************         
* HISTORY OF CHANGES                                                  *         
***********************************************************************         
...
*                                                                   * *         
* OCT11/99 (BU ) --- Y2K UPGRADE:  FIX TABLE ERROR                  * *         
*                                                                   * *         
*                                                                   * *         
*                    *** END TOMBSTONE  ***                           *         
***********************************************************************         
...
*   TEST                                                                        
         ...
         GOTO1 DATCON,DMCB,(0,WORK),(3,WORK+50)                                 
         ZIC   RF,WORK+50          GET YEAR                                     
         BCTR  RF,0                BACK UP ONE YEAR                             
         STC   RF,WORK+50          REPLACE YEAR                                 
         GOTO1 DATCON,DMCB,(3,WORK+50),(0,WORK)                                 
*   TEST                                                                        
***      MVC   P+1(06),=C'WORK  '                                               
***      MVC   P+8(06),WORK                                                     
***      GOTO1 REPORT                                                           
...
*              STORAGE FOR MODULE                                               
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034REREP3802 05/01/02'                                      
         END                                                                    
