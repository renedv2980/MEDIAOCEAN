*          DATA SET DMPRTQXEZB AT LEVEL 015 AS OF 02/21/01                      
*PHASE PRTQEXTB                                                                 
...
DMXINX   CLOSE (EXTSYSIN)          OPEN EXTERN PARAMETER FILE                   
         ...
         DC    H'0'                                                             
*                                                                               
         CLC   FAXFMT,BLANKS       FAX NUMBER IS REQUIRED                       
         BNE   *+6                                                              
         DC    H'0'                                                             
*                                                                               
         MVC   HDRREC+9(L'FAXFMT),FAXFMT                                        
         LA    R1,HDRRECLN                                                      
         STCM  R1,3,HDRRECOV                                                    
         LA    R1,TRNRECLN                                                      
         STCM  R1,3,TRNRECOV                                                    
...
WORKX    EQU   *                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015DMPRTQXEZB02/21/01'                                      
         END                                                                    
