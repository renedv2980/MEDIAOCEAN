*          DATA SET REREQ02    AT LEVEL 148 AS OF 02/20/13                      
...
*                                                                     *         
*  NOV13/03 (BU ) --- ADD BGAN/PGAN TO $GAN FOR PETRY/BLAIR           *         
*                                                                     *         
*  FEB01/12 (SMY) --- ++INCLUDE REAFFLIST IN AFFTAB                   *         
*                                                                     *         
*                                                                     *         
*                                                                     *         
*                     ***  END TOMBSTONE  ***                         *         
...
*                                                                               
         LA    R7,XSTARTDT            FLDVAL OUT-OF-RANGE AS A LABEL SO         
         LA    R7,FLDVAL-XSTARTDT(R7)    SET ACCESSABILITY VIA R7               
*                                                                               
*SMY*    LA    RF,FLDVAL           SET END OF TABLE                             
*SMY*    LA    RF,FLDVALX-FLDVAL(RF)                                            
         LA    RF,FLDVALX-FLDVAL(R7)     RF POINTING TO TABLE END               
         PRINT GEN                                                              
*SMY*    GOTO1 GOINDEX,P1,(R4),FLDVAL,(RF)                                      
         GOTO1 GOINDEX,P1,(R4),(R7),(RF)                                        
         PRINT NOGEN                                                            
         BNZ   ERROR                                                            
*                                                                               
...
ADNR0240 EQU   *                                                                
         ...
         BZ    ADNR0260                                                         
*                                                                               
         LA    R7,XSTARTDT            XVALX OUT-OF-RANGE AS A LABEL SO          
         LA    R7,XVALX-XSTARTDT(R7)    SET ACCESSABILITY VIA R7                
*                                                                               
*SMY*    GOTO1 GOINDEX,P1,(R4),XVAL,XVALX                                       
         GOTO1 GOINDEX,P1,(R4),XVAL,(R7)                                        
         BNZ   ERROR                                                            
*                                                                               
...
*                                                                               
*                                                                               
*   VALR30  - NO VALIDATION FOR THE 1H REPORT:                                  
*                                                                               
VALR30   EQU   *                                                                
*                                                                               
         B     COMMGOOD                                                         
...
ESTARTDT DC    AL2(XSTARTDT-*),AL2(VSTARTDT)     START DATE                     
         ...
         DC    AL2(VASATDAT)                                                    
         DC    H'0'                                                             
XSTARTDT EQU   *    **** DO NOT REMOVE THIS LABEL - IT IS USED FOR ***          
*                   ****  DISPLACEMENT ADDRESSING TO LABELS BELOW  ***          
*                                                                               
...
OPT1VTBL DS    0C                                                               
         ...
         DC    AL1(3+2),C'1H',C'SO'    SELF-APPLIED, OPEN M/G REPORT            
...
SOFL0040 EQU   *                                                                
*                                                                               
         CLC   8(2,RF),=C'1H'      REQUEST FOR 1H REPORT?                       
...
*                                                                               
         ...
         BE    OLIM0060            YES                                          
         CLC   RSETSTA(4),=C'BGAN' NO  - SPECIAL SET REQUESTED?                 
         BE    OLIM0060            YES                                          
         CLC   RSETSTA(4),=C'PGAN' NO  - SPECIAL SET REQUESTED?                 
         BNE   OLIM0070            NO                                           
OLIM0060 EQU   *                                                                
...
DEMOD    DSECT                                                                  
       ++INCLUDE DEDBLOCK                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'148REREQ02   02/20/13'                                      
         END                                                                    
