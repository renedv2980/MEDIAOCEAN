*          DATA SET REPRO17S   AT LEVEL 012 AS OF 08/20/97                      
*&&      SET   NOP=N                                                            
*PHASE T80A17A                                                                  
...
*                                                                               
         ...
         USING TLSTD,R2                                                         
*                                                                               
         CLC   TLRRTCD,BCSPACES    RATE CARD?                                   
         BH    DLDV10              YES                                          
*                                                                               
         CLI   TLRSLN,0                                                         
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012REPRO17S  08/20/97'                                      
         END                                                                    
