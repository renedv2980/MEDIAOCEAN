*          DATA SET ACPOP02B   AT LEVEL 003 AS OF 06/07/13                      
*PHASE T60A02BA                                                                 
*INCLUDE ACRAPPER                                                               
...
ORDCLOS  CLI   ACTION,CLO          TEST ACTION CLOSE                            
         BNE   ORDREST                                                          
...
ORD00    GOTO1 AWRITE,AIOAREA1     WRITE THE ORDER RECORD BACK                  
         BNE   EXIT                                                             
...
* ACGENFILE                                                                     
       ...
       ++INCLUDE ACGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003ACPOP02B  06/07/13'                                      
         END                                                                    
