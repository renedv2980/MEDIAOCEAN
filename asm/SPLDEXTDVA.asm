*          DATA SET SPLDEXTDVA AT LEVEL 092 AS OF 08/07/00                      
*PHASE SPEXTDOV                                                                 
*INCLUDE RECUP                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
DMXREC   DS    0H                                                               
         ...
         BNE   DMX30                                                            
         USING DOVEL05,R6                                                       
         CLI   1(R6),X'19'      IS THE LENGTH ALREADY 25?                       
         BE    DMXKEEP             YES                                          
*        NI    FLAG,X'FF'-AFTCHNGE REC BEFORE CHANGES                           
*        BAS   RE,DMPUT            PRINT REC BEFORE CHANGES                     
         B     DMX10                                                            
...
*        GOTO1 VRECUP,DMCB,(C'S',AREC),SVELEM,(R6) ADD OLD ELEM AGAIN           
...
PURGEREC DS    0H                                                               
         L     R6,AREC                                                          
*        MVC   P(13),=C'RECORD PURGED'                                          
*        GOTO1 VHEXOUT,DMCB,(R6),P+25,13         PRINT KEY                      
*        GOTO1 VPRINTER                                                         
         L     R1,PRGCOUNT                                                      
         LA    R1,1(R1)                                                         
         ST    R1,PRGCOUNT                                                      
...
*        NI    FLAG,X'FF'-RECBIG                                                
         ...
         BNE   DMXKEEP                                                          
         USING DOVEL01,R6                                                       
         CLI   1(R6),X'2A'      IS THE LENGTH ALREADY 42?                       
         BE    DMXKEEP             YES                                          
*        NI    FLAG,X'FF'-AFTCHNGE REC BEFORE CHANGES                           
*        BAS   RE,DMPUT            PRINT REC BEFORE CHANGES                     
         B     DMX40                                                            
...
*                                                                               
DMXPRT   DS    0H                                                               
*        OI    FLAG,AFTCHNGE       REC AFTER CHANGES                            
         SR    R2,R2                                                            
         L     R3,COUNT                                                         
         D     R2,=F'100'                                                       
         LTR   R2,R2                                                            
...
*        TM    FLAG,RECBIG                                                      
*        BZ    DMXKEEP                                                          
         BAS   RE,DMPUT            PRINT REC AFTER CHANGES                      
         B     DMXKEEP                                                          
*                                                                               
DMXEOF   DS    0H                                                               
...
SPGENBUYD DSECT                                                                 
       ++INCLUDE SPGENBUY                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'092SPLDEXTDVA08/07/00'                                      
         END                                                                    
