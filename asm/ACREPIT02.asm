*          DATA SET ACREPIT02  AT LEVEL 049 AS OF 05/01/02                      
*PHASE ACIT02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*                                                                               
...
*--------------------------------------------------------------------*          
*        PROCESS BILLING                                             *          
*        PROIFSBILLLHASGBEEN ADDED WITHIN THE DETAILS OF REQUEST     *          
*           WRITE IT TO TAPE                                         *          
*--------------------------------------------------------------------*          
         SPACE 1                                                                
...
*                                                                               
         ...
         BAS   RE,PUTDR                                                         
*                                                                               
PTRN140  BAS   RE,PUTTRAIL         PUT INVOICE TRAILER RECORD                   
         B     EXIT                                                             
*                                                                               
         DROP  R7,R5                                                            
         EJECT                                                                  
...
*                                                                               
         ...
         BE    REQL10              YES, SKIP TOTAL RECEIVABLE                   
*                                                                               
         ZAP   DOUBLE,TOTLRECV                                                  
         LA    R3,P                                                             
         LA    R3,PRRECV                                                        
...
*                                                                               
         MVC   TXDWC,DRTWC                                                      
         MVC   TXDWCNM,WCDESC      ADD NAME TO TAPE                             
...
JBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE ACJOBBERD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'049ACREPIT02 05/01/02'                                      
         END                                                                    
