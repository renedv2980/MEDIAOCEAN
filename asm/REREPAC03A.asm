*          DATA SET REREPAC03A AT LEVEL 100 AS OF 05/01/02                      
*PHASE REAC02B,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE DAYPAK                                                                 
...
CKACT010 GET   INTAPE,ACTREC                                                    
         SPACE                                                                  
*                                                                               
*   CONVERT TAPE REP CODES FOR TEST FILE                                        
         CLC   =C'BF',AREP                                                      
         BNE   CKACT011                                                         
         MVC   AREP(2),=C'QT'                                                   
         B     CKACT014                                                         
...
CKACT012 EQU   *                                                                
         ...
         B     CKACT014                                                         
CKACT013 EQU   *                                                                
         B     CKACT010            SKIP: GO BACK FOR NEXT                       
CKACT014 EQU   *                                                                
*   END CONVERT ROUTINE                                                         
*                                                                               
...
* SKELETON KEY FOR 93 PRODUCTION                                                
         SPACE                                                                  
SKEY93   DC    X'0C00',C'QTRBKACYAATEGAC  EGAC',X'03096769'                     
         DS    0H                                                               
* SKELETON KEY FOR 94 PRODUCTION                                                
         SPACE                                                                  
         DC    X'0C00',C'QTRBKACYAATEGAC  EGAC',X'03096770'                     
         DS    0H                                                               
* SKELETON KEY FOR 95 PRODUCTION                                                
         SPACE                                                                  
         DC    X'0C00',C'QTRBKACYAATEGAC  EGAC',X'03096771'                     
         DS    0H                                                               
* SKELETON KEY FOR 96 PRODUCTION                                                
         SPACE                                                                  
SKEY96   DC    X'0C00',C'QTRBKACYAATEGAC  EGAC',X'03120768'                     
         DS    0H                                                               
...
INIT0040 EQU   *                                                                
         ...
         BE    INIT0100                                                         
         CLC   AGYREP,=C'QT'       THIS A KATZ RUN                              
         BE    INIT0100                                                         
         DC    H'0'                                                             
...
SCLO0840 EQU   *                                                                
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'100REREPAC03A05/01/02'                                      
         END                                                                    
