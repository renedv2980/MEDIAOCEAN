*          DATA SET DDDRONE    AT LEVEL 027 AS OF 09/22/03                      
*PHASE T00A39A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
...
WHOTAB   DS    0D                                                               
         ...
         DC    AL1(DRREPWHO),AL3(0),A(REPTAB)                                   
...
*                                                                               
         ...
         MVI   ELCODE,X'88'        SECURITY GROUP ELEMENT                       
         BAS   RE,GETEL            HAVE ONE?                                    
         BNE   ROW125              NO                                           
         USING DESGRPD,R3                                                       
*                                                                               
         ICM   R7,15,DRSECBLK      HAVE SECRET BLOCK?                           
         BZ    ROW125              NO                                           
         USING SECD,R7                                                          
         GOTO1 CSECRET,DMCB,('SECPOPTP',0(R7)),DESECGRP                         
         CLI   DMCB,SECPYES        HAVE ACCESS TO THIS KEYWORD?                 
         BE    ROW125              YES                                          
*                                                                               
         MVI   DRERROR,ERRSECUR    SECURITY LOCKOUT                             
         B     MYERR                                                            
         DROP  R3,R7                                                            
*                                                                               
ROW125   L     R3,AIO              A(DICTIONARY ENTRY)                          
         USING DICKEYD,R3                                                       
...
*                                                                               
         ...
         DROP  R3,R7                                                            
*                                                                               
COL125   L     R3,AIO              A(DICTIONARY ENTRY)                          
         USING DICKEYD,R3                                                       
         XC    DRATTRIB,DRATTRIB                                                
         MVI   ELCODE,X'08'        ATTRIBUTE ELEMENT                            
         BAS   RE,GETEL                                                         
...
VENTRY10 MVI   DICSYS,DICSYSQ      SYSTEM                                       
         ...
         MVC   DICENTRY,SPACES     PAD WITH BLANKS                              
         ZIC   R1,5(R4)                                                         
         BCTR  R1,0                                                             
         EX    R1,*+8                                                           
         B     *+10                                                             
...
*                                                                               
         ...
         BNE   VENTRY20            NO                                           
         TM    SAVFLAG,X'01'       TEST OFFLINE                                 
         BO    *+22                YES -- DON'T CHECK LANGUAGE                  
         CLI   DICKLANG,X'FF'      'ALL' LANGUAGE?                              
         BE    *+14                YES                                          
         CLC   SAVLANG,DICKLANG    IS THIS ENTRY IN USER'S LANGUAGE?            
         BNE   VENTRY20            NO -- IT'S INVALID                           
*                                                                               
...
DD36B    CLI   DEOONUM,8                                                        
         ...
         CLI   DEOONUM,9                                                        
         BNE   *+8                                                              
         OI    DROPTSO+1,DRTRMDEC                                               
         CLI   DEOONUM,X'0A'                                                    
         BNE   *+8                                                              
         OI    DROPTSO+1,DRPBELOW                                               
         CLI   DEOONUM,X'20'                                                    
         BNE   DD36D                                                            
         CLI   DEOOVAL,C'L'                                                     
         BNE   *+12                                                             
         ...
         OI    DROPTSO,DRALGNRO                                                 
*                                                                               
DD36D    CLI   DEOONUM,X'23'                                                    
         BNE   *+8                                                              
         OI    DROPTSO+1,DRNOLBOX                                               
         CLI   DEOONUM,X'29'                                                    
         BNE   *+8                                                              
         OI    DROPTSO+1,DRCUME                                                 
         CLI   DEOONUM,X'2A'                                                    
         ...
         CLI   DEOONUM,X'2D'                                                    
         BNE   *+8                                                              
         OI    DROPTSO+1,DROPABSO    INDICATE ABSOLUTE VALUE WANTED             
*                                                                               
         B     DDNEXT                                                           
*                                                                               
         USING DESRD,R3                                                         
...
MSG8X    EQU   *                                                                
*                                                                               
         DC    AL1(ERRSECUR,MSG9X-MSG9,0)                                       
MSG9     DC    C'* ERROR * SECURITY LOCKOUT '                                   
MSG9X    EQU   *                                                                
*                                                                               
         DC    X'FF'                                                            
         EJECT                                                                  
...
DRONED   DSECT                                                                  
       ...
       ++INCLUDE FASECRETD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027DDDRONE   09/22/03'                                      
         END                                                                    
