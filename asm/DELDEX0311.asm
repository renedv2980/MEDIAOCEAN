*          DATA SET DELDEX0311 AT LEVEL 020 AS OF 01/02/04                      
*PHASE DELDEX3N DELDEX3B                                                        
*INCLUDE LOGIO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
DMXREC1  DS    0H                                                               
         ...
         CLI   1(R3),C'T'          RADIO ONLY                                   
         BNE   DMXOK                                                            
         CLI   2(R3),C'N'          ARB ONLY                                     
         BNE   DMXOK                                                            
         USING BSKEY,R3                                                         
         CLI   BSIND,2                                                          
         BNE   DMXM2                                                            
         CLC   BSBOOK,=X'98F4'     NOV/03                                       
         BNE   DMXOK                                                            
         CLC   BSSTAT(4),=C'KZTV'                                               
         BE    DMXREC2                                                          
         CLI   BSBTYP,C'C'                                                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020DELDEX031101/02/04'                                      
         END                                                                    
