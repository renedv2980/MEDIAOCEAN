*          DATA SET REREPAC02  AT LEVEL 004 AS OF 05/01/02                      
*PHASE REAC02A,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE DAYPAK                                                                 
...
INIT0040 EQU   *                                                                
         ...
         BE    INIT0100                                                         
         L     R2,=A(SKEY93T)                                                   
         CLC   AGYREP,=C'V3'       THIS A TEST RUN                              
         BE    INIT0100                                                         
         DC    H'0'                                                             
...
TABLIN10 LA    R0,ARRAYCT                                                       
         LA    R1,94               WAS '93, NOW STASRTING WITH '94              
         LA    RF,1                                                             
...
TABLIN40 LA    R0,ARRAYCT                                                       
         LA    R1,94               WAS '93, NOW NOT DOING 93                    
         LA    RF,1                                                             
...
CCON0098 ICM   R0,15,2(R6)                                                      
         ...
         DROP  R3                                                               
         SPACE                                                                  
CCON0100 OC    ELEM,ELEM           PUT NEW RECORD TO TAPE                       
...
CKAEL034 OC    RCONSTAM,RCONSTAM   IF ZERO DOLLARS                              
         BZ    CKAEL020             BYPASS OUT OF CONTRACT DATES ELEM           
         SPACE                                                                  
CKAEL036 LA    R0,12                                                            
         LA    R1,CONCTS                                                        
...
CKACT010 GET   INTAPE,ACTREC                                                    
         ...
         SPACE                                                                  
CKACT014 CLC   =C'V3',SVREPSTA     SEE IF TEST FILE                             
         BNE   CKACT020                                                         
...
* CK CTRS FOR MATCH, IF NOT, CREATE NEW CONTRACT TO BALANCE                     
         ...
         XC    ELEM,ELEM                                                        
         SPACE                                                                  
* CONVERT 94 TO BINARY  (SKIPPING 92, 93)                                       
         SPACE                                                                  
         LA    R0,12                                                            
         LA    R1,ACTRS+96+48+48                                                
         LA    RE,ELEM                                                          
CKACT100 ZAP   DUB,0(4,R1)                                                      
         CVB   RF,DUB                                                           
...
* FILL ARRAY WITH TOTALS FROM ACTUAL REC                                        
         SPACE                                                                  
* CONVERT 94 TO BINARY AND DOLLARS & CENTS                                      
         SPACE                                                                  
         LA    R0,12                                                            
         LA    R1,ACTRS+96+48+48                                                
         LA    RE,ARRAY                                                         
CKACT620 ZAP   DUB,0(4,R1)                                                      
         CVB   RF,DUB                                                           
         MH    RF,=H'100'          CONVERT DOLLARS TO DOLLARS/CENTS             
         STCM  RF,15,2(RE)                                                      
         LA    R1,4(,R1)                                                        
         ...
         BCT   R0,CKACT620                                                      
         SPACE                                                                  
* CONVERT 95 TO BINARY AND DOLLARS & CENTS                                      
* ACTUALLY, ONLY CONVERT TO CUTOFF DATE                                         
         SPACE                                                                  
         LH    R0,MONCT95                                                       
         LA    R1,ACTRS                                                         
...
TKACTUAL DC    PL7'0'              KATZ TOTALS                                  
         SPACE                                                                  
* 12 MON TABLE - 1-2 YR/MO OF SERVICE                                           
...
AGYREP   DS    CL2                                                              
MONCT95  DC    H'12'               MAY MAKE THIS SOFT                           
ELEM     DS    CL256                                                            
SWIREPS  DC    CL24'BFCREAKFKUK4  '                                             
...
* SKELETON KEY FOR 93 PRODUCTION                                                
         SPACE                                                                  
SKEY93   DC    X'0C00',C'BFR KACYAATEGAC  EGAC',X'03096769'                     
         DS    0H                                                               
* SKELETON KEY FOR 94 PRODUCTION                                                
         SPACE                                                                  
         DC    X'0C00',C'BFR KACYAATEGAC  EGAC',X'03096770'                     
         DS    0H                                                               
* SKELETON KEY FOR 95 PRODUCTION                                                
         SPACE                                                                  
         DC    X'0C00',C'BFR KACYAATEGAC  EGAC',X'03096771'                     
         DS    0H                                                               
...
*********************************************************************           
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004REREPAC02 05/01/02'                                      
         END                                                                    
