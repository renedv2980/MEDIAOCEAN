*          DATA SET DETVQ2     AT LEVEL 198 AS OF 08/23/00                      
*PHASE DETVQ2A                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE DEMTIME                                                                
*INCLUDE TIMVAL                                                                 
...
PARSTAB  DS    0C                                                               
         ...
         DC    C'HD',AL1(00,00,00)                                              
         DC    C'"1999-2000 TVQ#4, CARAT PROPRIET!'                             
*        DC    C'HD',AL1(00,00,00)                                              
...
*        DC    C'"1998-99 TVQ#3, CARAT PROPRIET!'                               
         ...
         DC    C'HD',AL1(00,00,00)                                              
         DC    C'"1998-99 TVQ#6, CARAT PROPRIET!'                               
         DC    C'HD',AL1(00,00,00)                                              
...
PROGBUF2 DS    120000C                                                          
       ...
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'198DETVQ2    08/23/00'                                      
         END                                                                    
