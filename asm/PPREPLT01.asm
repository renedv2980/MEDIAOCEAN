*          DATA SET PPREPLT01  AT LEVEL 001 AS OF 06/14/05                      
*PHASE PPLT01A                                                                  
         TITLE 'PPLT01 - PRINTPAK LABATT INTERFACE SPECS'                       
PPLT01   CSECT                                                                  
         SPACE 2                                                                
         FSPEC READ,BILLS                                                       
         SPACE 2                                                                
         SPROG 0,50                                                             
         PSPEC H1,1,MEDIA                                                       
         PSPEC H1,56,C'PRINTPAK LABATT INTERFACE'                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001PPREPLT01 06/14/05'                                      
         END                                                                    
