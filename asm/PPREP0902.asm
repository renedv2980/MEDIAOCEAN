*          DATA SET PPREP0902  AT LEVEL 120 AS OF 12/09/03                      
*PHASE PP0902A                                                                  
*INCLUDE MININAM                                                                
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
         TITLE 'PP0902 - PRINTPAK RESTORE BILLING'                              
*                                                                               
*        THIS PROGRAM WILL RESTORE BILLS AND BILL ELEMS FROM A TAPE             
*        TO THE LIVE FILE                                                       
*                                                                               
*        IF THE BILLED INSERTION DOES NOT EXIST - ERROR FLAG                    
*                                                                               
*        QOPT1  N = TEST RUN (FILE NOT MARKED)                                  
*                                                                               
*        QOPT2  Y = PDUMP FIRST 50 INSERTIONS                                   
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
PP0902   CSECT                                                                  
...
UBPUB    DS    CL15                                                             
         ...
         ORG                                                                    
         PRINT OFF                                                              
       ++INCLUDE PPNEWFILE         HAVE NEW DSECT FOR PPBILLREC                 
       ++INCLUDE PPREPWORK                                                      
       ++INCLUDE PPMODEQU                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'120PPREP0902 12/09/03'                                      
         END                                                                    
