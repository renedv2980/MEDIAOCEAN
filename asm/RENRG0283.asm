*          DATA SET RENRG0283  AT LEVEL 084 AS OF 05/01/02                      
*PHASE T81502A,*                                                                
...
* JUN07/00 (BG ) 83 FIX DUMP IN TSAR FOR TOP=                         *         
*                                                                     *         
...
*        SEE IF STILL HAVE TOTALS LINE TO PRINT                                 
         ...
         SPACE                                                                  
         XC    TSARCT,TSARCT       SET OFF CONTINUATION OF TOP N                
         SPACE                                                                  
         CLI   MODE,LISTRECS                                                    
         BNE   LREC0011                                                         
         SPACE                                                                  
...
LREC0144 EX    RE,LREX2            YES-TEST RECORD VALUE AGAINST FILTER         
         ...
         B     LREC0100                                                         
*                                                                               
LREC0150 CLC   LSTTYPE,0(R2)       HIGH-TEST LISTING THIS TYPE                  
...
*        B     EXIT                                                             
         SPACE 2                                                                
LREC0270 DS   0H                                                                
         CLI   ANYDATA,C'N'        WAS DATA FOUND FOR REQUEST                   
         BE    VKNODATA                                                         
         SPACE                                                                  
*        SEE IF STILL HAVE TOTALS LINE TO PRINT                                 
         SPACE                                                                  
...
LMON0276 MVC   KEY+16(2),2(RF)     INSERT REP CODE                              
         SPACE                                                                  
LMON0278 ZIC   R0,QSTART                                                        
         CLI   YRSW,C'P'           THIS PRIOR YEAR                              
         BNE   LMON0279                                                         
         BCTR  R0,0                                                             
*        CLI   QSTART,0            THIS 2000                                    
*        BNE   LMON0279                                                         
*        LA    R0,99                                                            
         SPACE                                                                  
LMON0279 EQU   *                                                                
...
*                                                                               
         ...
         SPACE                                                                  
         LR    RF,RA               CHECK PROFILE: SUPPRESS BUDGET?              
         AH    RF,=AL2(RRGPROFS-CONHEADH)                                       
         USING SVDSECT,RF                                                       
         TM    SVPGPBIT,X'10'      FOURTH BIT ON?                               
         BO    DR146                YES, DO COMPANY/OFFICE BUDGET               
         DROP  RF                                                               
         SPACE                                                                  
         CLI   QLIST,QLGRP         FOR GRP/SUB LIST ONLY                        
         BNE   DR150                                                            
...
*                                                                               
         ...
         USING SVDSECT,RF                                                       
         TM    SVPGPBIT,X'10'      FOURTH BIT ON?                               
         BO    DPRN0036             YES, DO COMPANY/OFFICE BUDGET               
         B     DPRN0044                                                         
         DROP  RF                                                               
         SPACE                                                                  
DPRN0036 DS   0H                                                                
         ...
         LA    R1,K3GRPTBL                                                      
         SPACE                                                                  
DPRN0041 CLC   AGENCY,2(R1)                                                     
         BE    DPRN0043                                                         
         LA    R1,4(,R1)                                                        
         BCT   R0,DPRN0041                                                      
DPRN0042 CLC   AGENCY,=C'K3'       AND KATZ (FOR NOW)                           
         BNE   DPRN0044                                                         
         SPACE                                                                  
DPRN0043 DS   0H                                                                
...
DPRN0044 DS   0H                                                                
         ...
         BZ    DPRN0050                                                         
         SPACE                                                                  
DPRN0046 EDIT  (R5),(09,48(R2)),FLOAT=-                                         
*                                                                               
DPRN0050 DS   0H                                                                
         GOTO1 =A(PCTCOMP),RR=RELO                                              
         BE    *+14                                                             
...
COBUD    NMOD1 0,**COBUD*                                                       
         ...
         BNE   COBUD040                                                         
         SPACE                                                                  
* IF ANOTHER REP STARTS USING KATZ GROUP/SUB, WE WILL BE IN TROUBLE             
         SPACE                                                                  
*        CLC   AGENCY,=C'K3'       SO WE DO THIS                                
*        BNE   COBUD040             OR DO WE CK ON ALL KATZ?                    
         SPACE                                                                  
         LA    R0,K3GRPCT                                                       
         LA    R1,K3GRPTBL         UNLESS KATZ, NO COMP BUDGETS                 
         SPACE                                                                  
...
* SET1TAB-SET2TAB-SET3TAB LIVE HERE FROM X'27E8' TO END OF SYSD X'3148'         
         SPACE                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'084RENRG0283 05/01/02'                                      
         END                                                                    
