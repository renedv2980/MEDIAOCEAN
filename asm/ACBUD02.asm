*          DATA SET ACBUD02    AT LEVEL 008 AS OF 08/05/08                      
*                                                                               
*PHASE T61002A,*                                                                
...
*                                                                               
         ...
         CLI   ACTION,NUM                                                       
         BNE   *+8                                                              
         MVI   ACBTKNO1+1,1        READ IN NUMBER SEQUENCE                      
         TM    FLAG,CONTINUE                                                    
         BNO   *+10                                                             
         MVC   KEY,FRMINITA                                                     
         MVI   COUNT,0                                                          
...
BT14     BASR  RE,RF                                                            
         ...
         CLI   DMCB+8,0                                                         
         BNE   ERRXIT                                                           
         LA    R6,ACBTKCOD-ACBTKEY                                              
         CLI   ACTION,NUM                                                       
         BNE   *+8                                                              
         LA    R6,ACBTKNO1-ACBTKEY                                              
         BCTR  R6,0                                                             
         EX    R6,*+8                                                           
         B     *+10                                                             
         CLC   KEYSAVE(0),ACBTKEY                                               
         BNE   BT40                END                                          
         BXLE  R3,R4,*+8                                                        
         B     BT45                SCREEN FULL                                  
         MVI   COUNT,C'Y'                                                       
...
BT84     GOTO1 (RF),ABUDREC        READ TYPE RECORD                             
         ...
         L     R7,ABUDREC                                                       
         MVC   KEYSAVE,ACBTKEY                                                  
*        LLC   R1,FLDH+5           SET NOT FOUND BIT IF CODE DOESN'T            
*        LA    R1,(ACBTKCOD-ACBTKEY-1)(,R1)      MATCH                          
*        EX    R1,*+8                                                           
*        B     *+10                                                             
*        CLC   ACBTKEY(0),KEY                                                   
*        BE    *+12                                                             
         CLC   ACBTKEY(ACBTKNO2-ACBTKEY),KEY                                    
         BE    *+12                                                             
         OI    DMCB+8,X'10'                                                     
         B     BT86                                                             
...
*                                                                               
         USING ACBCD,R6                                                         
         MVC   CRD,SPACES          OPTIONS - ACSTATUS BITS                      
         SR    RF,RF                                                            
         LA    RE,OPTAB                                                         
         LA    R1,CRD                                                           
         MVI   FLAG,0                                                           
         MVI   DUB,C'R'            SET FOR RECORD STATUS                        
         LA    R3,ACSTATUS                                                      
*                                                                               
BT103A   CLI   0(RE),X'FF'         END OF OPTIONS                               
         ...
         LA    RF,1(,RF)                                                        
*                                                                               
BT103D   LA    RE,L'OPTAB(,RE)                                                  
         B     BT103A                                                           
*                                                                               
BT103E   CLI   DUB,C'E'            TEST FINISHED ELEMENT                        
         BE    BT103F                                                           
         CLI   ACBCLEN,ACBCLNQ2    TEST NEW ELEMENT LENGTH                      
         BL    BT103F              NO,                                          
         MVI   FLAG,0                                                           
         MVI   DUB,C'E'            SET FOR ELEMENT STATUS                       
         LA    R3,ACBCSTAT                                                      
         LA    RE,OPTAB2                                                        
         B     BT103A                                                           
*                                                                               
...
*                                                                               
         USING ACBCD,R6                                                         
         XC    ACBCEL(ACBCLNQ2),ACBCEL                                          
         MVI   ACBCEL,ACBCELEQ                                                  
         MVI   ACBCLEN,ACBCLNQ2                                                 
         MVC   ACBCCOL1,FLD                                                     
         MVC   ACBCCOL2,SPACES                                                  
...
BT216B   CLI   0(RE),X'FF'         COMPARE LHS WITH OPTAB                       
         BNE   BT216C              NO MATCH                                     
         CLI   DUB,C'E'            TEST ALREADY DID ELEMENT LIST                
         BE    ERRXIT              YES,  IT'S AN ERROR                          
         LA    RE,OPTAB2           SET FOR ELEMENT TABLE                        
         LA    R3,ACBCSTAT                                                      
         MVI   DUB,C'E'                                                         
...
BT216C   EX    R1,*+8                                                           
         ...
         BE    BT216F              NO RHS REQUIRED                              
         CLC   11(10,RE),22(RF)                                                 
         BE    BT216F              FULL MATCH ON RHS IF REQUIRED                
*                                                                               
BT216E   LA    RE,L'OPTAB(,RE)                                                  
         B     BT216B                                                           
*                                                                               
BT216F   OC    0(1,R3),0(RE)      SET STATUS                                    
         BCT   R0,*+8                                                           
         B     BT218               END                                          
...
BT218    SR    R0,R0                                                            
         ...
         AR    R6,R0               R6=EOR                                       
*                                                                               
         LA    R3,BTYACC1H         ACC/CAC VALIDATION RULES                     
         LA    R5,BTYACCLH                                                      
         MVI   COUNT,0                                                          
*                                                                               
...
*                                                                               
         MVC   XTRAMESS,SPACES                                                  
*                                                                               
BT224    LLC   R0,0(,R3)           PROCESS CONTRA FLD                           
         AR    R3,R0                                                            
         GOTO1 AFVAL,(R3)                                                       
         BZ    ERRXIT                                                           
...
BT270    L     R7,ABUDREC                                                       
         MVC   KEY,ACBTKEY                                                      
         GOTO1 AWRITE,ABUDREC      TWO WRITES FOR AMENDING ACTIONS              
         BNE   ERRXIT                                                           
         L     R7,ABUDREC                                                       
         MVC   ACBTKNO1,ACBTKNO2                                                
         XC    ACBTKNO2,ACBTKNO2                                                
...
*                                  DISPLAY KEYWORDS (X OR X=Y)                  
         ...
         DC    X'FF'                                                            
*                                                                               
OPTAB2   DS    0CL21               SET STATUS IN ELEMENT                        
         DC    AL1(ACBCOFFC),CL20'OFFICE'                                       
         DC    X'FF'                                                            
         EJECT ,                                                                
* ACBUDDSECT                                                                    
         PRINT OFF                                                              
...
TWAD     DSECT                                                                  
       ...
       ++INCLUDE ACBUDFDD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008ACBUD02   08/05/08'                                      
         END                                                                    
