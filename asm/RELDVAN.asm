*          DATA SET RELDVAN    AT LEVEL 010 AS OF 05/01/02                      
*PHASE RELDVAN,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
DMXREC   DS    0H                                                               
         ...
         CLI   RCONKTYP,X'0C'                                                   
         BNE   DMXKEEP                                                          
         GOTO1 =V(HEXOUT),DMCB,RCONKCON,WORK,4                                  
         MVC   P+1(15),=C'CONTRACT FOUND:'                                      
         MVC   P+20(8),WORK                                                     
         GOTO1 VPRINTER                                                         
         LA    RF,WORK                                                          
         LA    RE,8                                                             
DMX0020  EQU   *                                                                
         CLI   0(RF),C'9'          CONTRACT CONTAINS VALUE > 9?                 
         BH    DMX0040             YES - PURGE IT                               
         CLI   0(RF),C'0'          CONTRACT CONTAINS VALUE < 0?                 
         BL    DMX0040             YES - PURGE IT                               
         LA    RF,1(RF)            NO  - BUMP TO NEXT POSITION                  
         BCT   RE,DMX0020          GO BACK FOR NEXT                             
         B     DMXKEEP                                                          
DMX0040  EQU   *                                                                
         MVC   P+1(22),=C'CONTRACT BEING PURGED:'                               
         MVC   P+25(08),WORK                                                    
         GOTO1 VPRINTER                                                         
         B     DMXPURGE                                                         
*                                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010RELDVAN   05/01/02'                                      
         END                                                                    
