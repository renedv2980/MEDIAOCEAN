*          DATA SET SPLDEXTAWD AT LEVEL 139 AS OF 08/24/00                      
*PHASE SPEXTAWD,+0                                                              
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
...
RECTYP1  DS    0H                  XX XX A/M CLT CLT                            
         ...
         BNE   DMXPURGE                                                         
         OC    3(2,R3),3(R3)       CLT                                          
         BZ    DMXPURGE            PURGE IF NO CLIENT                           
         LA    R5,3(R3)                                                         
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXKX               KEEP IF NOT IN LIST                          
         B     DMXPURGE                                                         
*                                                                               
...
RECTYP6  DS    0H                  XX A/M CLT CLT                               
         ...
         LA    R5,2(R3)                                                         
         BAS   RE,CKHEXCLT                                                      
         BE    DMXPURGE            KEEP IF NOT IN LIST                          
         B     DMXKX                                                            
*                                                                               
...
SPGENESTD      DSECT                                                            
       ++INCLUDE SPGENEST                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'139SPLDEXTAWD08/24/00'                                      
         END                                                                    
