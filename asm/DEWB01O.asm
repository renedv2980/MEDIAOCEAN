*          DATA SET DEWB01O    AT LEVEL 105 AS OF 10/23/08                      
*PHASE DEWB01OA                                                                 
*INCLUDE DEBKUPDT                                                               
         TITLE 'OUTPUT PHASE FOR DENN9501 NTI CNV'                              
DEWB01O  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         ...
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DEWB01O+4096,R7     R7=2ND BASE REGISTER                         
...
*                                                                               
         ...
         BNE   *+12                 THEN MERGE MKT BREAKS                       
         MVI   MERGE,C'Y'                                                       
         B     BLDKEYX                                                          
*                                                                               
         OC    AOKEY,AOKEY         DIFFERENT KEYS RELS LAST RECD 1ST            
...
*                                  BUILD NETWORK PROG RUN/TIME ELEM             
         ...
         OC    INTTNUM,INTTNUM     TELECAST RECORD?                             
         BZ    *+10                                                             
         MVC   NTTNUM,INTTNUM                                                   
...
BLDEL50  CLI   0(R5),0                                                          
         ...
         GOTO1 APUTEL,NTELEM                                                    
BLDEL60  LA    R5,7(R5)            NEXT DAY IN INTVAR                           
...
BLDDEMS  NTR1                                                                   
         ...
         MVC   SLSECT,25(RE)                                                    
         GOTO1 APUTEL,SLELEM                                                    
*                                  BUILD MARKET BREAK SPECIFIC INFO             
         LA    R6,TEMP                                                          
         USING MKBELEM,R6                                                       
         MVI   MKBCODE,MKBCODEQ                                                 
         MVI   MKBLEN,MKBLENQ                                                   
         MVC   MKBBRK,INTKEY+25                                                 
         MVC   MKBSEC,INTCOMSC                                                  
         GOTO1 APUTEL,MKBELEM                                                   
*                                  BUILD DEMO ELEMENTS                          
         LA    R5,DBLOCKA                                                       
         USING DBLOCKD,R5                                                       
         XC    DBLOCK,DBLOCK                                                    
...
BLDN60   MVC   PNPNUM,INTPNUM                                                   
         ...
         MVC   PRVPKBK,PNBOOK                                                   
*                                                                               
BLDN70   OC    0(2,RF),0(RF)       AUG/08 ADDED SOURCE TO BUFFER                
         BZ    BLDN75                                                           
         CLC   INTKSRC,2(RF)                                                    
         BNE   *+14                                                             
...
CREATE   NTR1                                                                   
         ...
         MVC   CHMEDIA,MEDIA       -N-                                          
         MVC   CHSRC,PREVSRC       -N-                                          
         MVC   CHOBOOK,SVPNO       ORIGINATING BOOK                             
         MVC   CHSTAT,SVSTA                                                     
         MVC   CHBTYP,SVBK                                                      
         MVC   CHDW,SVDAYWK                                                     
...
PREVSRC  DS    XL1                  PREVIOUS CORRECTION KEY                     
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'105DEWB01O   10/23/08'                                      
         END                                                                    
