*          DATA SET RERRGONLDS AT LEVEL 021 AS OF 05/01/02                      
*PHASE RERRGLDC,+0                                                              
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
GETREC10 CLI   TRACSRTO,C'Y'       TRACE OUT OF SORT                            
         ...
         MVC   P+10(80),SORTREC                                                 
         GOTO1 =V(PRINTER)                                                      
         GOTO1 =V(HEXOUT),DMCB,SORTREC,WORK,80,=C'SEP'                          
         MVC   P,SPACES                                                         
         MVC   P+10(80),WORK                                                    
         GOTO1 =V(PRINTER)                                                      
         MVC   P(9),=C'FROM SORT'                                               
...
*                                                                               
GETRECX  B     EXIT                                                             
NFLDS    EQU   15                  TOTAL # OF FLDS TO ADD (WAS 12, 8)           
         EJECT                                                                  
...
*                                                                               
         DS    0F                                                               
         DC    CL8'*REPTAB*'                                                    
REPTAB   DC    400XL(REPORTX-REPORTD)'00'                                       
         DC    X'FF'                                                            
         EJECT                                                                  
REPORTD  DSECT                                                                  
*                                                                               
...
REPORTX  EQU   *                                                                
       ...
       ++INCLUDE DDDPRINT                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021RERRGONLDS05/01/02'                                      
         END                                                                    
