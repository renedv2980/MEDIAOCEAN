*          DATA SET ACREPZD02A AT LEVEL 109 AS OF 01/05/00                      
**********************************************************************          
...
PROCMD5  MVI   FORCEHED,C'Y'       FORCE NEW PAGE FOR EVERY MODE                
         ...
         MVC   P(L'MDNAME),MDNAME                                               
*                                                                               
         CLC   MDNAME,=CL10'PROCHIST'                                           
         BNE   PROCMD6                                                          
         MVC   P+20(55),=CL55'ADTRANS POINTS TO 45 AT THIS LEVEL AND 44X        
                AT OTHERS'                                                      
         GOTO1 ACREPORT                                                         
         B     PROCMD7                                                          
*                                                                               
PROCMD6  CLC   MDNAME,=CL10'PROCSBAC'                                           
         BNE   *+10                                                             
         MVC   P+20(L'ADRSMSG),ADRSMSG                                          
         GOTO1 ACREPORT                                                         
PROCMD7  MVC   SVMDNM,MDNAME       SAVE MODE NAME                               
         BAS   RE,PRNTLINE                                                      
*                                                                               
...
************************************************88                              
         LA    R7,49(R2)           POINT TO FIRST ELEMENT                       
LOOP     CLI   0(R7),0                                                          
         BE    GTADRS20                                                         
         MVC   MSG,=CL10'ELEMENT'                                               
         ZIC   R6,1(R7)                                                         
         GOTO1 ADUMP,DMCB,(RC),(R7),(R6)                                        
         AR    R7,R6                                                            
         B     LOOP                                                             
************************************************88                              
         B     GTADRS20                                                         
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE DDBIGBOX                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'109ACREPZD02A01/05/00'                                      
         END                                                                    
