*          DATA SET FRFTAI1BWR AT LEVEL 006 AS OF 05/01/02                      
*PHASE FTPAI1WR,*,NOAUTO                                                        
**************************  use special panS procs                              
DVGCXASM START                                                                  
* /***START OF SPECIFICATIONS*****************************************/         
*               'DDSFTP.CCOL.AI1.XXXX.BWR'     western billing tape             
* /*                                                                 */         
...
*/*-----------------------------------------------------------------*/          
MVSDSN   DC    C'DDSFTP.CCOL.AI1.XXXX.BWR'     western billing tape             
         DS  0D                                                                 
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006FRFTAI1BWR05/01/02'                                      
         END                                                                    
