*          DATA SET SPTST00    AT LEVEL 140 AS OF 10/05/09                      
*PHASE T21F00A                                                                  
***********************************************************************         
*                                                                     *         
*                                                                     *         
...
*                   *** THIS MODULE IS DEAD ***                       *         
*                                                                     *         
* CONNECT TO SJR/S/SFM, RECORD TYPE DMTEST, ACTION REPORT.            *         
* THAT APPLICATION DOES EVERYTHING THIS ONE USED TO DO, AND MORE      *         
* (INCLUDING THE ABILITY TO RUN UNDER SPOOF, AND THEREFORE IDF).      *         
*                                                                     *         
* THE SOURCE MODULE IS SPSFM6D (SCREEN SCSFM3F).                      *         
*                                                                     *         
*                                                                     *         
*                                                                     *         
*                                                                     *         
...
*        ST    RE,DBEXTEND                                                      
         ...
         J     *+8                                                              
         ST    RE,DBEXTEND                                                      
         L     RE,=A(UIDLIST)      TEST USER ID PARAMETER                       
         A     RE,RELO                                                          
         J     *+8                                                              
         ST    RE,DBEXTEND                                                      
         CLC   DBFILE,=C'IUN'                                                   
...
* FAFACTS                                                                       
       ++INCLUDE FAFACTS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'140SPTST00   10/05/09'                                      
         END                                                                    
