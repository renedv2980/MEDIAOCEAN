*          DATA SET ACCLB10B   AT LEVEL 062 AS OF 12/22/99                      
*PHASE T62110B                                                                  
...
PRTN30   BAS   RE,PRTOUT           PRINT REVALUATION REPORT                     
         ...
         BNE   EXITL                                                            
*                                                                               
         L     RE,AGOPBLK          CLEAR SAVED GOBLOCK VALS                     
...
VALSEL   OI    OSINDS,OSIDAY                                                    
         ...
         B     VALYES              YES                                          
         SPACE 1                                                                
VALCLR   CLC   TLRNVAL,TLROVAL     TEST OLD=NEW                                 
         BE    EXITN               THEN NOTHING TO CLEAR                        
         MVC   TLRNVAL,TLROVAL     CLEAR - RESET TO OLD VALUES                  
         SP    OSTOTCHG,TLRNAMT                                                 
         MVC   TLRNAMT,TLROAMT                                                  
         AP    OSTOTCHG,TLRNAMT                                                 
         B     EXITY                                                            
...
VALYES   TM    TLRINDS,TLRIREV                                                  
         ...
         B     EXITN                                                            
         MVC   TLRNVAL,EURKRULE                                                 
         DROP  R2                                                               
*                                                                               
VALYES10 LA    R2,BOWORK1                                                       
         USING EURKBLKD,R2                                                      
         XC    0(EURKBLKL,R2),0(R2)                                             
         MVC   EURKCUFR,CSCPYCUR                                                
         MVC   EURKCUTO,CSBILCUR                                                
         ...
         ZAP   BODUB1,TLRCAMT                                                   
         GOTO1 VEUREKA,BODMCB,('INVERTQ+APPLYQ',EURKBLKD),BODUB1,BODUB2         
         DROP  R2                                                               
*                                                                               
         SP    OSTOTCHG,TLRNAMT                                                 
         ZAP   TLRNAMT,BODUB2                                                   
...
*                                                                               
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'062ACCLB10B  12/22/99'                                      
         END                                                                    
