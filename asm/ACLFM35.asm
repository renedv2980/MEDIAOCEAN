*          DATA SET ACLFM35    AT LEVEL 030 AS OF 05/01/02                      
*PHASE T60335A,+0                                                               
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE ADDAY                                                                  
*INCLUDE PERVERT                                                                
         TITLE 'ALLOCATE PERSONNEL MONTHLY SALARY DATA TO BUDGET FILE'          
T60335   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 AC35WKLN-AC35WRKD,*LFM35**,R9,R7,RR=R5                           
         LR    R8,RC                                                            
         USING AC35WRKD,R8                                                      
         L     RA,0(R1)                                                         
         USING T603FFD,RA                                                       
...
BLDKY57  OC    DISPTOEL,DISPTOEL                                                
         ...
         LA    R3,MSG10L                                                        
         B     ERRMSG                                                           
BLDKY58  CLC   LOGMSAL(6),=C'DELETE'                                            
         BNE   BLDKY55                                                          
         LA    R3,MSG11L                                                        
         B     ERRMSG                                                           
*                                                                               
...
*                                                                               
         CVD   R0,DUB              SAVE PACKED # OF MONTHS IN RANGE             
         ZAP   MONTHS,DUB+6(2)                                                  
*                                                                               
...
*                                                                               
         ...
         MVC   LOGCLTS,SPACES                                                   
         MVC   LOGCLTE,SPACES                                                   
         GOTO1 DATCON,DMCB,(1,MYBUDST),(9,LOGCLTS)                              
         GOTO1 DATCON,DMCB,(1,MYBUDED),(9,LOGCLTE)                              
         LA    R2,LOGACTH                                                       
         B     XIT                                                              
         EJECT                                                                  
*---------------------------------------------------------------------*         
...
*                                                                               
         CVD   R3,DUB              SAVE PACKED # OF MONTHS IN RANGE             
         ZAP   MONTHS,DUB+6(2)                                                  
         ZIC   R1,MYEND+1          GET PACKED END MONTH                         
         CH    R1,=H'10'           MONTHS 1 THRU 9   OK                         
         BL    *+8                                                              
         SH    R1,=H'6'            ADJ X'10'(OCT) IS NOW A X'0A'                
         CVD   R1,DUB                                                           
         ZAP   ENDMON(2),DUB+6(2)      END MONTH                                
*                                                                               
         CH    R0,=H'4'                                                         
         BL    *+8                                                              
         LA    R6,1(R6)            ROUND UP                                     
...
*                                                                               
         ...
         MVC   LOGSTRT,SPACES                                                   
         MVC   LOGEND,SPACES                                                    
         GOTO1 DATCON,DMCB,(1,MYSTART),(9,LOGSTRT)                              
         GOTO1 DATCON,DMCB,(1,MYEND),(9,LOGEND)                                 
         LA    R2,LOGACTH                                                       
         B     XIT                                                              
         EJECT                                                                  
*---------------------------------------------------------------------*         
...
*                                                                               
         BAS   RE,CLRFLDS                                                       
         TWAXC LOGMSALH            TURNS TRANSMIT BITS ON                       
...
D04      CLC   ACBSDGNO,BUDNUM     MATCH ON BUDGET NUMBER                       
         BNE   *+12                                                             
         TM    ACBSTA1,ACBSMON     MUST BE MONTHLY BUDGETS                      
         BO    D10                                                              
         BAS   RE,NEXTEL                                                        
         BE    D04                                                              
         B     D08                                                              
...
D10B     ZIC   R1,1(RF)                                                         
         ...
         BNE   D10B                                                             
         TM    ACBSTA1-ACBSALD(RF),ACBSMON     MUST BE MONTHLY ELEM             
         BNO   D10B                                                             
...
D11A     CLI   0(RF),X'5D'         ADVANCE TO FIRST 5D ELEMENT                  
         BNE   D11ANX                                                           
         TM    ACBSTA1-ACBSALD(RF),ACBSMON     MUST BE MONTHLY                  
         BNO   D11ANX                                                           
         CLC   ACBSDGNO-ACBSALD(L'ACBSDGNO,RF),BUDNUM                           
         BE    D11B                                                             
D11ANX   ZIC   R1,1(RF)                                                         
...
D20      LR    R1,R4               STORE FOR DISPLAY OPTIONS                    
         ...
         STC   R1,DISPTOEL                                                      
         DROP  R6                                                               
         ZAP   SVMSAL,ACBSMNLY     SAVE IN EVENT OF DELETE OPTION               
         ZAP   DUB,ACBSMNLY        MONTHLY SALARY                               
         LA    R2,LOGMSALH                                                      
         BAS   RE,NUMDIS                                                        
*                                                                               
...
*                                                                               
         ZAP   HOLDINC1,=P'0'                                                   
         ZAP   HOLDINC2,=P'0'                                                   
         OC    ACBSMON1,ACBSMON1                                                
         BZ    D50                 NO INCREASE DATA TO DISP                     
*                                                                               
D35      ZAP   DUB,ACBSINC1        INCREASE 1                                   
         LA    R2,LOGINC1H                                                      
         BAS   RE,NUMDIS2                                                       
*                                                                               
         LA    R0,12                                                            
         LA    R3,MONTBL                                                        
D37      CLC   ACBSMON1,3(R3)                                                   
         BE    D38                                                              
         LA    R3,6(R3)            NXT TBL ENT                                  
         BCT   R0,D37                                                           
         B     D50                                                              
*                                                                               
D38      ZAP   HOLDINC1,ACBSINC1   CALCULATE INCREASE 1                         
         ...
         BNL   *+10                                                             
         AP    DUB(2),=P'12'                                                    
         SP    DUB(2),4(2,R3)      NUMBER OF MONTHS OF RNG-STRT MON             
         MP    HOLDINC1,DUB(2)     AMOUNT                                       
*                                                                               
         ZAP   DUB,HOLDINC1                                                     
         LA    R2,LOGAMT1H                                                      
...
D45      ZAP   HOLDINC2,ACBSINC2   CALCULATE INCREASE 2                         
         ...
         BNL   *+10                                                             
         AP    DUB(2),=P'12'                                                    
         SP    DUB(2),4(2,R3)      NUMBER OF MONTHS OF RNG-STRT MONTH           
         MP    HOLDINC2,DUB(2)     AMOUNT                                       
*                                                                               
         ZAP   DUB,HOLDINC2                                                     
         LA    R2,LOGAMT2H                                                      
         BAS   RE,NUMDIS2          INCREASE 2                                   
...
BLDR10   CLC   ACBSDGNO,BUDNUM     FOR THIS BUDGET TYPE                         
         BNE   BLDR12                                                           
*        TM    ACBSTA1,ACBSMON     MUST BE MONTHLY                              
*        BNO   BLDR12                                                           
...
BLDR25   BAS   RE,BDGTPROC                                                      
         CLC   LOGMSAL(6),=C'DELETE' IF DELETE MODE                             
         BNE   BLDR26                                                           
         LA    RF,MYIO                                                          
         LA    RE,IO2                                                           
         LA    R1,IOLENQ                                                        
         ...
         ZAP   DUB,SVMSAL          REDISPLAY WEEKLY SALARY                      
         LA    R2,LOGMSALH                                                      
         BAS   RE,NUMDIS                                                        
...
BLDR30   GOTO1 DELEL,DMCB,(X'5D',IO2),(8,MYSTART)                               
         LA    R3,LOGMSALH         CLEAR 5D-5E ELEMENT INPUT                    
BLDR32   ZIC   R0,0(R3)                                                         
         CH    R0,=H'9'                                                         
         BE    XIT                                                              
         TM    1(R3),X'20'                                                      
...
ELVAL    NTR1                                                                   
         ...
         OI    ACBSTA1,ACBSMON     ELEMENT IS MONTHLY                           
         ZAP   ACBSMNLY,=P'0'                                                   
         ZAP   ACBSYRLY,=P'0'                                                   
         ZAP   ACBSINC1,=P'0'                                                   
         ZAP   ACBSINC2,=P'0'                                                   
...
*                                                                               
         ...
         B     BR62A                                                            
*                                                                               
ELV120   LA    R2,LOGMSALH         A(MONTHLY CURRENT SALARY INPUT)              
         GOTO1 ANY                                                              
*                                                                               
ELV130   CLC   LOGMSAL(6),=C'DELETE' IF DELETE MODE                             
         BNE   ELV140                                                           
         ZAP   ACBSMNLY,SVMSAL     SAVED SAL FROM DISP PASS TO EL FLD           
         B     BR03                                                             
*                                                                               
ELV140   GOTO1 IPTVAL,DMCB,(R2)    COMMON ROUTINE NUMERIC VAL                   
         CP    DUB+2(6),=P'9999900'                                             
         BH    INVERR                                                           
         ZAP   ACBSMNLY,DUB+4(4)   MONTHLY CURRENT SALARY                       
         ZAP   MNTHSAL,DUB+4(4)    MONTHLY CURRENT SALARY                       
*-------------------------------------------------------------------*           
*        VERIFY YEARLY SALARY INPUT MULTIPLY MONTHLY SALARY INPUT BY            
*        THE NUMBER OF MONTHS REPRESENTED BY MYSTART TO MYEND                   
*-------------------------------------------------------------------*           
BR03     ZAP   DUB,MONTHS          # OF MONTHS                                  
         ZAP   WORK(10),ACBSMNLY                                                
         GOTO1 CALCIT,DMCB,DUB+5,WORK,1,0                                       
         BZ    BR05A               GOOD CC                                      
         LA    R3,MSG8L                                                         
         B     ERRMSG                                                           
BR05A    ZAP   HOLDINC1,WORK+4(6)  MNLY SAL * MONS = YEARLY SALARY              
         ZAP   YEARSAL,HOLDINC1                                                 
*                                                                               
...
*                                                                               
         ...
         B     CALCERR                                                          
*                                                                               
BR08     ZAP   NMON1,=P'0'         INIT NMON1 AND 2 FIELDS                      
         ZAP   NMON2,=P'0'                                                      
         MVI   MON1,0                                                           
         MVI   MON2,0                                                           
         BAS   RE,CLRFLDS          CLEAR INCREASE FIELDS                        
*                                                                               
         SR    R0,R0               INDICATE 1ST MON EDIT                        
         LA    R2,LOGMON1H                                                      
         BAS   RE,MONVAL                                                        
         LTR   R0,RB                                                            
         LA    R2,LOGMON2H                                                      
         ...
         BNH   INVERR                                                           
*                                                                               
BR10     CP    NMON1,=P'0'          ANY INCREASE                                
         BNE   BR32                YES                                          
         ZAP   HOLDINC1,=P'0'                                                   
         B     BR61                                                             
*                                                                               
BR32     ZAP   MONINC1,HOLDINC1    SAVE MONTHLY INCREASES                       
         MP    MONINC1,=P'100'                                                  
         ZAP   MONINC2,HOLDINC2                                                 
         MP    MONINC2,=P'100'                                                  
*                                                                               
         MVC   ACBSMON1,MON1       INCREASE 1                                   
         ZAP   ACBSINC1,HOLDINC1+3(3)                                           
         CP    NMON2,=P'0'                                                      
         BE    BR50                NO 2ND INCREASE                              
         MVC   ACBSMON2,MON2       INCREASE 2                                   
         ZAP   ACBSINC2,HOLDINC2+3(3)                                           
*                                                                               
BR50     ZAP   WORK(10),ACBSINC1   CALCULATE INCREASE 1                         
         ZAP   FULL(3),NMON1                                                    
         GOTO1 CALCIT,DMCB,FULL,WORK,1,0       NMON * INC1                      
         BZ    BR50A               GOOD CC                                      
         LA    R3,MSG8L                                                         
         B     ERRMSG                                                           
BR50A    ZAP   HOLDINC1(6),WORK+4(6)                                            
*                                                                               
         OC    ACBSMON2,ACBSMON2   2ND INCREASE                                 
         BZ    BR60                NO                                           
BR53     ZAP   WORK(10),ACBSINC2   CALCULATE INCREASE 2                         
         ZAP   FULL(3),NMON2                                                    
         GOTO1 CALCIT,DMCB,FULL,WORK,1,0        MON2 * INC2                     
         BZ    BR53A               GOOD CC                                      
         LA    R3,MSG8L                                                         
         B     ERRMSG                                                           
...
BR61B    ZAP   ACBSBSAL,DUB+3(5)    BDG YRLY SAL TO REC                         
         ZAP   BYEARSAL,ACBSBSAL                                                
*                                                                               
         CLC   LOGMSAL(6),=C'DELETE' IN DELET MODE                              
         BE    BR62A               DON'T ADD                                    
...
BR100    CP    PCTTOT,=P'10000' FINAL ACCUM OF PCT INPUT MUST=                  
         ...
         EJECT                                                                  
*-----------------------------------------------------------*                   
*        CALCULATE MONTHLY SALARY FROM BUD '52' ELEMENT                         
*        (FILL SVMSAL)                                                          
*-----------------------------------------------------------*                   
BUDMSAL  NTR1                                                                   
         ZAP   SVMSAL,=P'0'                                                     
         ...
         BAS   RE,GETEL                                                         
         BNE   XIT                                                              
BUDM105  CLI   ACSALTYP,X'08'                                                   
         BE    BUDM120                                                          
BUDM110  BAS   RE,NEXTEL                                                        
         BE    BUDM105                                                          
         LA    R3,MSG2L                                                         
         LA    R2,LOGSTRTH                                                      
         B     ERRMSG                                                           
...
BUDM130  OC    ACSALEND,ACSALEND                                                
         ...
         B     BUDM110                                                          
*                                                                               
BUDM150  CLI   ACSALBAS,C'A'                                                    
         BE    *+6                                                              
         DC    H'0'                                                             
         AP    WRKMNLY,ACSALARY                                                 
         ZAP   HALF,=P'12'                                                      
         DP    WRKMNLY,HALF                                                     
         ZAP   SVMSAL,WRKMNLY(6)                                                
         B     XIT                                                              
         EJECT                                                                  
*---------------------------------------------------------------------*         
*        MONVAL-EDITS FOR MONTH AND INCREASE INPUT. STORES VALID                
*        MONTH AND NUMBER OF DAYS EFFECTED BY INCREASE IN PRG.                  
*        STORAGE FIELDS MON1 AND MON2, MDAY1 AND MDAY2. STORES INPUT            
*        MONTHLY INCREASE AMOUNTS IN HOLDINC1 AND HOLDINC2.                     
*        UPON ENTRY:                                                            
*        R0=0 FOR FIRST INCREASE FLDS NON-ZERO FOR 2ND                          
*        R2=CURRENT MONTH FIELD SCREEN HEADER                                   
*        WEEKS=NUMBER OF WEEKS REPRESENTING KEY INPUT DATE RNG.                 
*        TOTDAYS=NUMBER OF DAYS REPRESENTING KEY INPUT DATE RNG.                
*---------------------------------------------------------------------*         
MONVAL   NTR1                                                                   
         ZIC   R1,MNTHCNT          NUMBER OF MONTHS IN RANGE                    
         CVD   R1,DUB                                                           
         ZAP   MONTHS(2),DUB+6(2)      SAVE # OF MONTHS                         
*                                                                               
         ZIC   R1,MYEND+1          GET PACKED END MONTH                         
         CH    R1,=H'10'           MONTHS 1 THRU 9   OK                         
         BL    *+8                                                              
         ...
         ZAP   ENDMON(2),DUB+6(2)      END MONTH                                
*                                                                               
         CLI   5(R2),0             INPUT IN MON FLD                             
         BNE   MON10               YES                                          
MON05    ZIC   R1,0(R2)            INVALID IF INPUT IN REMAINING FLDS           
         AR    R2,R1                                                            
         CLI   5(R2),0                                                          
         BNE   INVERR                                                           
         LTR   R0,R0               1ST OR 2ND MONTH                             
         BZ    *+8                 1ST, CHK 2ND                                 
         B     XIT                                                              
         LA    R2,LOGMON2H                                                      
         CLI   5(R2),0                                                          
         BNE   INVERR                                                           
         LR    R0,RB                                                            
         B     MON05               GO CHK 2ND AMNT FLD                          
*                                                                               
MON10    LA    R3,MONTBL                                                        
MON20    CLC   0(3,R3),8(R2)                                                    
         BE    MON30                                                            
         LA    R3,6(R3)                                                         
         CLI   0(R3),X'FF'                                                      
         BE    INVERR                                                           
         B     MON20                                                            
*                                                                               
MON30    LA    R1,DATAB            TABLE OF YYMM IN DATE RANGE                  
         LA    R4,12                                                            
MON31    CLC   1(1,R1),3(R3)       IS THIS MONTH  IN TABLE                      
         BE    MON35                                                            
         LA    R1,2(R1)                                                         
         BCT   R4,MON31                                                         
         LA    R3,MSG16L                                                        
         B     ERRMSG                                                           
*                                                                               
MON35    ZAP   DUB(2),ENDMON       COUNT NUMBER OF MONTHS FOR INCREASE          
         CP    DUB(2),4(2,R3)                                                   
         BNL   *+10                                                             
         AP    DUB(2),=P'12'                                                    
         SP    DUB(2),4(2,R3)                                                   
*                                                                               
         ...
         BNZ   *+20                                                             
         MVC   MON1,3(R3)          STARTING MONTH NUMBER                        
         ZAP   NMON1,DUB(2)        NUMBER OF MONTHS                             
         B     *+16                                                             
         MVC   MON2,3(R3)                                                       
         ZAP   NMON2,DUB(2)                                                     
*                                                                               
         ...
         B     XIT                                                              
*                                                                               
MONTBL   DC    C'JAN',X'01',PL2'0'    CL3 MONTH                                 
         DC    C'FEB',X'02',PL2'1'    XL1 PWOS MONTH NUMBER                     
         DC    C'MAR',X'03',PL2'2'    PL2 # OF MONTHS NOT TO INCLUDE            
         DC    C'APR',X'04',PL2'3'                                              
         DC    C'MAY',X'05',PL2'4'                                              
         DC    C'JUN',X'06',PL2'5'                                              
         DC    C'JUL',X'07',PL2'6'                                              
         ...
         DC    C'SEP',X'09',PL2'8'                                              
         DC    C'OCT',X'10',PL2'9'                                              
         DC    C'NOV',X'11',PL2'10'                                             
         DC    C'DEC',X'12',PL2'11'                                             
         DC    X'FF'                                                            
         EJECT                                                                  
*--------------------------------------------------------------------*          
...
*                                                                               
DM20     NTR1                                                                   
         GOTO1 DATAMGR,DMCB,(DMINBTS,COMMAND),=C'ACCFIL',MYIO,MYIO              
         B     XIT                                                              
         EJECT                                                                  
*-------------------------------------------------------*                       
...
BREC21   OC    CLTCSTCD,CLTCSTCD   END OF TABLE                                 
         ...
         BE    BREC21A                                                          
         CLC   LOGMSAL(6),=C'DELETE'                                            
         BE    BREC21A                                                          
         BAS   RE,ELEM1D           ADD NEW BUDGET X'1D' ELEMENTS                
*                                                                               
...
BREC40A  CP    CLTPCAMT,=P'0'      NOT TO BE ADDED                              
         ...
         CLC   LOGMSAL(6),=C'DELETE'                                            
         BE    BREC40B                                                          
         BAS   RE,ELEM1D           ADD 1D BUDGET ELEMENTS                       
*                                                                               
...
CHKFOR1D NTR1                                                                   
         ...
         EJECT                                                                  
*---------------------------------------------------------------------*         
*        CALCULATE BUDGET AMOUNTS AND ADD 1D ELEMENTS                           
*---------------------------------------------------------------------*         
ELEM1D   NTR1                                                                   
*                                                                               
         ZAP   DUB(3),CLTPCT       PERCENT                                      
         ZAP   WORK(10),MNTHSAL    MONTHLY SALARY                               
         GOTO1 CALCIT,DMCB,DUB,WORK,1,1       PCT * MNTHLY SAL                  
         SRP   WORK(10),64-4,5     ROUND UP 4 POSITIONS                         
         ZAP   DUB(6),WORK(10)                                                  
*                                                                               
         ZAP   BUDTOT(8),=P'0'     KEEP RUNNING TOTAL BUDGETED                  
         LA    R1,DATAB                                                         
         LA    R3,EL1DTAB          INIT ELEM TABLE                              
         XC    EL1DTAB,EL1DTAB                                                  
         ZIC   R0,MNTHCNT                                                       
EL1D10   MVC   0(2,R3),0(R1)       FILL IN YYMM                                 
         OC    0(2,R3),0(R3)       ANY MONTH                                    
         BZ    *+16                                                             
         ZAP   2(8,R3),DUB(6)      BASE MONTHLY SAL                             
         AP    BUDTOT(8),DUB(6)   KEEP RUNNING TOTAL BUDGETED                   
         LA    R3,L'EL1DTAB(R3)                                                 
         LA    R1,2(R1)                                                         
         BCT   R0,EL1D10                                                        
*                                                                               
         OC    MON1,MON1           ANY MONTHLY INCREASES                        
         BZ    EL1D30                                                           
         ZAP   DUB(3),CLTPCT       PERCENT                                      
         ZAP   WORK(10),MONINC1    MONTHLY INCREASE                             
         GOTO1 CALCIT,DMCB,DUB,WORK,1,1       PCT * MNTHLY SAL                  
         SRP   WORK(10),64-4,5     ROUND UP 4 POSITIONS                         
*                                                                               
         ZAP   DUB(6),WORK(10)     MONTHLY INCREASE                             
         MVC   BYTE,MON1           MONTH INCREASE #1 STARTS                     
         BAS   RE,SUMSAL           ADD SAL INTO RIGHT MONTHS                    
*                                                                               
         OC    MON2,MON2                                                        
         BZ    EL1D30                                                           
         ZAP   DUB(3),CLTPCT       PERCENT                                      
         ZAP   WORK(10),MONINC2    MONTHLY INCREASE                             
         GOTO1 CALCIT,DMCB,DUB,WORK,1,1       PCT * MNTHLY SAL                  
         SRP   WORK(10),64-4,5     ROUND UP 4 POSITIONS                         
*                                                                               
         ZAP   DUB(6),WORK(10)     MONTHLY INCREASE                             
         MVC   BYTE,MON2           MONTH INCREASE #2 STARTS                     
         BAS   RE,SUMSAL           ADD SAL INTO RIGHT MONTHS                    
*                                                                               
EL1D30   ZAP   DUB(3),CLTPCT          PERCENT                                   
         ZAP   WORK(10),BYEARSAL      BUDGETED YEAR SAL                         
         GOTO1 CALCIT,DMCB,DUB,WORK,1,1       PCT * MNTHLY SAL                  
         SRP   WORK(10),64-4,5        ROUND UP 4 POSITIONS                      
*                                                                               
         CP    BUDTOT(8),WORK(10)    HAVE WE BUDGETED RIGHT TOTAL               
         BE    EL1D50                                                           
         CLI   BUDSW,1             DO ADJUSTMENT?                               
         BNE   EL1D32                                                           
         CLI   MNTHCNT,X'0C'                                                    
         BE    EL1D34                                                           
         B     EL1D50                                                           
EL1D32   CLC   MYSTART,MYBUDST     DO ROUNDING ONLY IF WE BUDGET                
         BNE   EL1D50              THE WHOLE SALARY PERIOD                      
         CLC   MYEND,MYBUDED                                                    
         BNE   EL1D50                                                           
*                                                                               
EL1D34   SP    BUDTOT(8),WORK(10)  ADJUST LAST ELEM                             
         LA    R3,EL1DTAB                                                       
         LR    R1,R3                FIND LAST ELEM                              
EL1D35   CLI   0(R3),0                                                          
         BE    EL1D36                                                           
         LR    R1,R3                R1 AT LAST ELEM                             
         LA    R3,L'EL1DTAB(R3)                                                 
         B     EL1D35                                                           
EL1D36   AP    2(8,R1),BUDTOT(8)    ADD THE DIFFERENCE                          
         CLI   BUDSW,1                                                          
         BNE   EL1D50                                                           
         AP    2(8,R1),=P'1'                                                    
*                                                                               
         USING ACBAD,R6                                                         
EL1D50   LA    R3,EL1DTAB          ADD ELEMS                                    
         LA    R6,MY1DEL                                                        
*                                                                               
EL1D52   CLI   0(R3),0             ANY ENTRY                                    
         BE    EL1DX                                                            
         CP    2(8,R3),=P'0'       DON'T ADD ZERO AMNTS                         
         BE    EL1D54                                                           
*                                                                               
         MVC   ACBAEL(2),=X'1D0C'  ELEMENT CODE/LENGTH                          
         MVC   ACBAMNTH,0(R3)      YR/MNTH                                      
         ZAP   ACBABUDG,2(8,R3)    AMOUNT                                       
*        MP    ACBABUDG,=P'100'                                                 
         GOTO1 ADDEL,DMCB,MYIO,MY1DEL                                           
EL1D54   LA    R3,L'EL1DTAB(R3)                                                 
         B     EL1D52                                                           
*                                                                               
EL1DX    B     XIT                                                              
         DROP  R6                                                               
         EJECT                                                                  
*---------------------------------------------------------------------*         
*        ADDS A MONTHLY INCREASE TO CORRECT MONTHS                              
*---------------------------------------------------------------------*         
SUMSAL   NTR1                      START MONTH IN BYTE                          
         LA    R3,EL1DTAB          AMOUNT IN DUB FOR 6                          
SUM10    CLI   0(R3),0                                                          
         BE    SUMX                                                             
         CLC   BYTE,1(R3)          ADD TO THIS MONTH?                           
         BE    SUM20                                                            
SUM15    LA    R3,L'EL1DTAB(R3)                                                 
         B     SUM10                                                            
*                                                                               
SUM20    AP    2(8,R3),DUB(6)                                                   
         AP    BUDTOT(8),DUB(6)   KEEP RUNNING TOTAL BUDGETED                   
         LA    R3,L'EL1DTAB(R3)                                                 
         CLI   0(R3),0                                                          
         BNE   SUM20                                                            
...
MSG6L    DC    AL1(L'MSG6)                                                      
MSG6     DC    C'ERROR-MONTHLY SALARY * MONTHS = '                              
MSG7L    DC    AL1(L'MSG7)                                                      
...
MSG23L   DC    AL1(L'MSG23)                                                     
MSG23    DC    C'RECORD IS AT MAXIMUM CAPACITY'                                 
         DS    0H                                                               
         EJECT                                                                  
         LTORG                                                                  
         EJECT                                                                  
...
HELLO    DS    V                                                                
PRELOC   DS    F                                                                
NMON2    DS    PL3                 # OF MONS REPED BY MON1 FLD                  
NMON1    DS    PL3                 # OF MONS REPED BY MON2 FLD                  
MON1     DS    C                   MON 1 IPT                                    
MON2     DS    C                   MON 2 IPT                                    
...
CLTPCT   DS    PL3                 PERCENTAGE VALUE                             
...
MONTHS   DS    PL2                 NUMBER OF MONTHS IN DATE RANGE               
ENDMON   DS    PL2                 PACKED END MONTH                             
...
*                                                                               
MNTHSAL  DS    PL6                 BASE MONTHLY SALARY                          
MONINC1  DS    PL6                 MONTHLY INCREASES                            
MONINC2  DS    PL6                                                              
YEARSAL  DS    PL8                 BASE YEARLY SALARY                           
BYEARSAL DS    PL8                 BUDGETED YEARLY TOTAL                        
BUDTOT   DS    PL8                 BUDGETED TOTAL ACCUM                         
*                                                                               
SVMSAL   DS    PL6                 WEEKLY SALARY FOR REDIS IN DLT MODE          
WEEKS    DS    PL2                 NUMBER OF WEEKS                              
BUDSW    DS    CL1                                                              
ENDVAL   DS    CL3                                                              
WRKMNLY  DS    PL8                                                              
SVYSAL   DS    PL8                 YEARLY SALARY FOR REDIS IN DLT MODE          
TSTDATE  DS    CL6                                                              
TSTDATP  DS    PL3                                                              
TSTDATV  DS    CL8                                                              
EL1DTAB  DS    13CL10                                                           
...
*FAFACTS                                                                        
       ...
       ++INCLUDE FAFACTS                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'030ACLFM35   05/01/02'                                      
         END                                                                    
