*          DATA SET SPLDEXTWH2 AT LEVEL 031 AS OF 05/09/00                      
*PHASE SPEXTWH2                                                                 
*INCLUDE HEXOUT                                                                 
         TITLE 'SPLDEXTWH2 - RESTORE BUYER CODES FOR BATES'                     
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC   DS    0H                                                               
         ...
         CLI   0(R6),X'06'                                                      
         BNE   DMXREC30                                                         
         CLC   1(2,R6),=C'BS'      <----- COMPARE AGENCY CODE                   
         BNE   DMXKEEP                                                          
...
*                                                                               
         ...
         XCEFL                                                                  
*                                                                               
         LA    RE,IO               COPY THE RECORD TO IOAREA                    
         LR    R0,R6                                                            
         XR    RF,RF                                                            
         ICM   RF,3,13(R6)                                                      
         LR    R1,RF                                                            
         MVCL  RE,R0                                                            
*                                                                               
         ICM   RF,3,13(R6)         DUMP OUT THE RECORD TO DATASET               
         AHI   RF,4                                                             
         STCM  RF,3,IOAREA                                                      
         LA    R3,IOAREA                                                        
         PUT   DUMPOUT,(R3)                                                     
...
BYRTABLE DS    0C                                                               
         DC    C'T',C'LED',XL2'0000'                                            
         DC    C'T',C'MLS',XL2'0000'                                            
         DC    C'T',C'PAO',XL2'0000'                                            
         DC    C'T',C'SGG',XL2'0000'                                            
         DC    X'FF'                                                            
*                                                                               
DUMPOUT  DCB   DDNAME=EXTRACT,DSORG=PS,MACRF=PM,RECFM=VB,BLKSIZE=4096, X        
               LRECL=4004,BUFNO=2                                               
*                                                                               
IOAREA   DS    XL2                                                              
         DS    XL2                                                              
...
BYRLNQ   EQU   *-BYRMD                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'031SPLDEXTWH205/09/00'                                      
         END                                                                    
