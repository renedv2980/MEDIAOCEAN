*          DATA SET REREPED02A AT LEVEL 023 AS OF 02/10/98                      
*PHASE REED02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
...
*                    MINATION                                      *            
*                                                                  *            
* SEP27/96 (BU ) --- MODIFY DATE/TIME RECEIVED TO TIME THIS        *            
*                    MODULE RUN.                                   *            
*                                                                  *            
* FEB10/98 (BU ) --- NEED TO UPDATE SELTEL SPLIT SITUATION         *            
*                                                                  *            
*                                                                  *            
*                                                                  *            
********************************************************************            
...
*                                  EOF --> MAIN0900                             
MAIN0040 DS    0H                                                               
****>>>  CLC   =C'WUPN',DKHDSTAT   SINGLE-STATION CHECK                         
...
*                                                                               
         GOTO1 DATCON,DMCB,(5,WORK),(0,PAHDDATE)                                
*                                                                               
...
*                                                                               
         ...
         STCM  R1,7,HHMMSS                                                      
         GOTO1 HEXOUT,DMCB,HHMMSS,PAHDTIME,2,=C'TOG'                            
*                                                                               
...
*                                                                               
*   NOTE:  AN ABORT AT THIS ADDRESS INDICATES THAT THE STATION IS               
*        NOT IN THE DARE STATION LIST.  DO THIS:                                
*        1.  SCAN THE DUMP LOOKING FOR *STUFF* (IT MAY CROSS A FORMAT           
*            BOUNDARY, AND YOU MAY HAVE TO LOOK AROUND A BIT)                   
*        2.  STATION MISSING IS IN NEXT SECTION, PRECEDED AND FOLLOWED          
*            BY THE LETTER 'T'                                                  
*        3.  SIGN ON TO SJR/C/SFM, DSTATION/ADD, AND ADD STATION TO             
*            THE APPROPRIATE COMPANY.                                           
*        4.  GET OPERATIONS TO RERUN THE JOB.                                   
*                                                                               
GCOM0040 EQU   *                                                                
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE CTGENSTAD                                                      
         ...
         SPACE 4                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023REREPED02A02/10/98'                                      
         END                                                                    
