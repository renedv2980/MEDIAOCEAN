*          DATA SET SPREP7402  AT LEVEL 023 AS OF 10/22/08                      
*PHASE SP7402A,*                                                                
*INCLUDE CONFUSE                                                                
         TITLE 'SP74 - USER PROFILE LISTING'                                    
SP7402   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**SP7402                                                       
...
*                                  FORMAT KEY                                   
PR18     CLI   QBOOK1,C' '         IS THERE CLT/OFF FILTER?                     
         BNH   *+14                NO, DISPLAY EVERYTHING                       
         CLC   CTUKCLT,QBOOK1      OTHERWISE FILTER                             
         BNE   PR4                                                              
*                                                                               
...
MYKEYSV  DS    CL44                                                             
         SPACE 1                                                                
* SPREPWORKD/SPREPMODES/CTGENFILE                                               
         PRINT OFF                                                              
       ++INCLUDE SPREPWORKD                                                     
       ++INCLUDE SPREPMODES                                                     
       ++INCLUDE CTGENFILE                                                      
       ++INCLUDE GEGENOFF                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023SPREP7402 10/22/08'                                      
         END                                                                    
