*          DATA SET DELMXPA    AT LEVEL 004 AS OF 05/08/17                      
...
* THIS EXIT IS A COPY OF DELMXP6 AND MODIFIED FOR 3AM START OF DAY              
*                                                                     *         
...
*                                                                               
         ...
         GOTOR ,DMCB,(1,DUB),BOUNDARY_QH,BYTE                                   
         L     RF,=V(HRTOQH3)                                                   
         BRAS  RE,CALL_DDS_SUBRTN                                               
*                                                                               
...
*                                                                               
         SPACE 2                                                                
         ORG   DELMXPA+(((*-DELMXPA)/256)+1)*256  FOR I-CACHE PIPELINE          
         SPACE 2                                                                
...
* INPUT RECORDS DSECT                                                           
       ...
       ++INCLUDE DELMDSECT                                                      
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004DELMXPA   05/08/17'                                      
         END                                                                    
