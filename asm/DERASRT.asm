*          DATA SET DERASRT    AT LEVEL 103 AS OF 03/21/16                      
...
*                                   DIGITAL STATIONS/BANDS                      
         MVC   P,SPACES                                                         
         MVC   P(39),=C'ARBITRON PPM: BYPASSED DIGITAL STATIONS'                
         GOTO1 =V(PRINTER)                                                      
         MVC   P(39),=C'-----------------------------------------'              
         GOTO1 =V(PRINTER)                                                      
         MVC   P,SPACES                                                         
...
DIGITAB  DS    100XL(DIGITABL)                                                  
         ...
         SPACE 2                                                                
SENDTO   DC    CL50' '                                                          
SUBJECT  DC    C'ARBITRON PPM: BYPASSED DIGITAL STATIONS'                       
SUBJJBID DS    CL8                                                              
         DC    C' '                                                             
SUBJJBNM DS    CL8                                                              
...
ANALOGS  DC    C'AM'                                                            
         ...
         DC    C'AA'                                                            
         DC    C'AA'                                                            
         DC    C'CM'         IHEART DO NOT TREAT AS DIGITAL                     
         DC    C'FF'               FM+FM                                        
         DC    C'  '               PUMM                                         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'103DERASRT   03/21/16'                                      
         END                                                                    
