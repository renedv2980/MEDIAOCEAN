*          DATA SET RECNT01S   AT LEVEL 122 AS OF 05/07/04                      
*PHASE T80201B,*                                                                
...
*                                                                               
CONA0015 DS    0H                CLEAR 'NEXT' FROM BUYNUM FIELD WHEN            
...
ADDC43   CLI   0(RF),C' '          AT THE END                                   
         ...
         B     ADDC43                                                           
ADDC45   BCTR  RF,0                                                             
         CLI   RF,C'P'             SKIP IF ALREADY A PRIMARY                    
         BE    ADDC90                                                           
         MVI   1(RF),C'P'                                                       
         B     ADDC90                                                           
*                                                                               
...
*                                  RETRIEVE THE STATION RECORD                  
         ...
         BO    ECON0020            YES - NO STATION CHECK                       
...
*                                                                               
         ...
         BZ    BUYB0005            YES, NEED TO DISPLAY CONTRACT HEADER         
**                                                                              
...
MONB     DS    0H                                                               
         ...
         B     EXIT                                                             
MONC     DS    0H                  COMBO MON SUPPORT                            
         GOTO1 =A(MONC00),RR=TWARELO1                                           
         B     EXIT                                                             
********************************************************************            
...
MONB20   DS    0H                                                               
         ...
         EJECT                                                                  
*                                                                               
MONC00   NTR1  BASE=*,LABEL=*      COMBO MON SUPPORT                            
         CLI   TWASCRN,X'E2'                                                    
         BE    MONC20                                                           
         MVI   BYTE,X'E2'                                                       
         BAS   R8,NEWSCRN                                                       
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'122RECNT01S  05/07/04'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
