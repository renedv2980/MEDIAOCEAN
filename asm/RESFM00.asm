*          DATA SET RESFM00    AT LEVEL 243 AS OF 04/23/09                      
*PHASE T81800C                                                                  
*INCLUDE UNBOOK                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE UNUPGR                                                                 
...
*                                                                 *             
* 11JUN03  (BU ) --- ROMEC(ROM EOP CODE) FACILITY                 *             
*                                                                 *             
* 29DEC03  (BU ) --- TAKEOVER: PRD/PP SCREEN FIELD PROTECT        *             
*                                                                 *             
* OCT1304  (BU ) --- LOCK OUT CODESWIT UNTIL REPAIRED             *             
*                                                                 *             
* OCT2504  (HQ ) --- RE-ACTIVATE CODESWITCH                       *             
*                                                                 *             
* JAN2506  (HQ ) --- REMOVE STATION CALL LETTER ALPHA RESTRICTION *             
*                                                                 *             
*  APR09   (SMY) --- NEW INVENTORY KEY AND COMMENT OUT TEXT       *             
*                      AS A VALID SFM RECORD SINCE RESFM0A        *             
*                      (SFM TEXT RECORD HANDLER) HAS NOT BEEN     *             
*                      MAINTAINED SINCE 1990 AND THE RERMP05      *             
*                      PHASE NOW HANDLES TEXT RECORDS             *             
*                                                                 *             
*                    *** END TOMBSTONE ***                        *             
*******************************************************************             
*                                                                               
...
AGAIN    MVI   GOAGAIN,C'N'                                                     
         BAS   RE,CALLGENC                                                      
*                                                                               
*   SCREEN HAS BEEN LOADED BY CALLGENC.  LOOK FOR/MODIFY TAKEOVER               
*        SCREEN TO PROTECT FIELDS.                                              
*                                                                               
         BAS   RE,TAKESCRN         CHECK TAKEOVER SCREEN                        
*                                                                               
...
TAKESCRN NTR1                                                                   
         ...
         BCTR  RE,0                -1 FOR EX                                    
         EX    RE,TSCR1020         COMPARE FOR 'TAKEOVER' BY LENGTH             
         BE    TSCR0020            =   'TAKEOVER'                               
         EX    RE,TSCR1021         COMPARE FOR 'TAKENET ' BY LENGTH             
         BE    TSCR0060            =   'TAKENET '                               
         B     TSCR0100            EXIT                                         
TSCR0020 EQU   *                                                                
         MVC   CTOHDS6+26(6),SPACES                                             
*                                  TAKEOVER: NO PRD PP                          
         LA    R1,CTONPRH          SET A(PRODUCT CODE)                          
         LA    R0,5                                                             
TSCR0030 EQU   *                                                                
         OI    1(R1),X'20'         TURN ON 'PROTECTED' FOR PRODUCT              
         FOUT  (R1)                                                             
         LR    R2,R1               BUMP TO POINT PERSON FIELD                   
         ZIC   RF,0(R1)                                                         
         AR    R2,RF                                                            
         OI    1(R2),X'20'         TURN ON 'PROTECTED' FOR P/P                  
         FOUT  (R2)                                                             
         LA    R1,CTOSEL1H-CTOSELH(R1)                                          
*                                  BUMP TO NEXT LINE                            
         BCT   R0,TSCR0030         GO BACK FOR NEXT                             
         B     TSCR0100            ALL LINES DONE: FINISHED                     
TSCR0060 EQU   *                                                                
         MVC   CTOHDS6+26(6),=C'PRD PP'                                         
         LA    R1,CTONPRH          SET A(PRODUCT CODE)                          
         LA    R0,5                                                             
TSCR0070 EQU   *                                                                
         NI    1(R1),X'FF'-X'20'   TURN OFF 'PROTECTED' FOR PRODUCT             
         FOUT  (R1)                                                             
         LR    R2,R1               BUMP TO POINT PERSON FIELD                   
         ZIC   RF,0(R1)                                                         
         AR    R2,RF                                                            
         NI    1(R2),X'FF'-X'20'   TURN OFF 'PROTECTED' FOR P/P                 
         FOUT  (R2)                                                             
         LA    R1,CTOSEL1H-CTOSELH(R1)                                          
*                                  BUMP TO NEXT LINE                            
         BCT   R0,TSCR0070         GO BACK FOR NEXT                             
         B     TSCR0100            ALL LINES DONE: FINISHED                     
TSCR0100 EQU   *                                                                
         XIT1                                                                   
TSCR1020 CLC   CONREC(0),TSCR20A   COMPARE BY LENGTH                            
TSCR20A  DC    CL8'TAKEOVER'                                                    
TSCR1021 CLC   CONREC(0),TSCR21A   COMPARE BY LENGTH                            
TSCR21A  DC    CL8'TAKENET '                                                    
         EJECT                                                                  
*                                                                               
...
*                                                                               
         ...
         CLI   0(R4),4                                                          
         BH    MYERR                                                            
* CALL LETTER COULD BE ALPHA+NUMERIC                                            
...
VINV90   MVC   RERROR,=AL2(NOTFOUND)                                            
         CLC   KEYSAVE(RINVKSTD-RINVKEY),KEY     SAME INVENTORY ITEM            
         BNE   MYERR                                                            
         OC    CBLOCK+3(3),CBLOCK+3 ANY DATE GIVEN                              
         BZ    *+14                                                             
         CLC   KEYSAVE(RINVKSPR-RINVKEY),KEY   SAME THRU START DATE ?           
         BNE   MYERR                                                            
         SPACE 1                                                                
         MVI   RDUPDATE,C'N'                                                    
         GOTO1 GETREC                                                           
...
VINV100  OC    CBLOCK+3(3),CBLOCK+3 ANY DATE GIVEN                              
         BNZ   MYERR                                                            
         LA    R6,KEY                                                           
         MVC   RINVKSPR(L'RINVKSPR),=X'FFFFFF'                                  
         MVI   RDUPDATE,C'N'                                                    
         GOTO1 HIGH                                                             
         B     VINV90                                                           
         DROP  R6                                                               
...
*                                  CL1 PHASE NUMBER FOR HELP SCREEN             
         SPACE 1                                                                
*****    DC    X'01',C'AHEADER ',AL1(16),X'0000'   REMOVED APR/09 SMY           
*****    DC    X'01',C'ADETAIL ',AL1(17),X'0000'   REMOVED APR/09 SMY           
...
*****    DC    X'01',C'TEXT    ',AL1(10),X'0000'   REMOVED APR/09 SMY           
         DC    X'01',C'MARKET  ',AL1(11),X'0000'                                
         DC    X'01',C'MPR     ',AL1(12),X'0000'                                
         DC    X'01',C'M2      ',AL1(13),X'0000'   (2 COPIES OF MPR)            
*****    DC    X'01',C'PHEADER ',AL1(14),X'0000'   REMOVED APR/09 SMY           
*****    DC    X'01',C'PDETAIL ',AL1(15),X'0000' REMOVED APR/09 SMY             
...
*        DC    X'01',C'GOALN   ',AL1(27),X'0000'                                
         ...
         DC    X'01',C'ROMEC   ',AL1(63),X'0000'   ROM EQUIV CODES              
         SPACE 2                                                                
...
*                                                                               
***      DC    X'03',AL1(63,03),X'8245000080',C'    '  ROM EQUIV CHANGE         
         DC    X'03',AL1(63,10),X'8245000080',C'    '  ROM EQUIV LIST           
***      DC    X'03',AL1(63,01),X'8245000080',C'    '  ROM EQUIV ADD            
         DC    X'FF'                                                            
RECACTLN EQU   *-RECACT                                                         
*                                                                               
...
AGYHDRD  DSECT                                                                  
       ...
       ++INCLUDE FLDIND                                                         
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'243RESFM00   04/23/09'                                      
         END                                                                    
