*          DATA SET RECNT59    AT LEVEL 024 AS OF 11/18/13                      
*PHASE T80259A                                                                  
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
         TITLE 'T80259 - RECNT59 - WIDE ORBIT EC BDE VERSION'                   
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT59 --- WIDE ORBIT CONTRACT INTERFACE                  *           
* ----------------------------------------------------------------- *           
* UPDATE HISTORY:                                                   *           
*                                                                   *           
...
T80259   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T80259*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
****>>>>                                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024RECNT59   11/18/13'                                      
         END                                                                    
