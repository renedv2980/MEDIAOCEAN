*          DATA SET RELDDPT    AT LEVEL 006 AS OF 05/01/02                      
*PHASE RELDDPT,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
*******************************************************************             
*                                                                 *             
*   FLAG PROPOSER ORDERS AS USING THE DAYPART MENU                *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
*                                                                               
         L     R5,AREC             POINT TO RECORD                              
         USING RCPRDPEL,R5                                                      
         MVI   ELCODE,RCPRDPEQ     GET DAYPART ELEMENT                          
         BAS   RE,GETEL                                                         
         BNE   DMXKEEP             UM? JUST SKIP IT                             
*                                                                               
...
*&&DO                                                                           
         ...
         ZIC   RF,1(R6)                                                         
         GOTO1 =V(HEXOUT),DMCB,(R6),P+30,(RF)                                   
         GOTO1 VPRINTER                                                         
*&&                                                                             
DMX100   DS    0H                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006RELDDPT   05/01/02'                                      
         END                                                                    
