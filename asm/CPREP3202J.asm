*          DATA SET CPREP3202J AT LEVEL 091 AS OF 05/01/02                      
*PHASE CP3202A                                                                  
*INCLUDE SORTER                                                                 
*INCLUDE EDITOR                                                                 
*INCLUDE DYNALLOC                                                               
...
*****FILTER OUT NON-BANK TARGETS******                                          
         ...
         B     EXIT                                                             
**************************************                                          
BK20B2   MVC   SRDEMO,CPKDEMO                                                   
         MVC   SRPRG,CPKPROG                                                    
         MVC   SRAFL,CPKAFFIL                                                   
*        CLC   CPKMKT,=AL2(880)    CONVERT SANTA CLARA                          
*        BNE   *+10                                                             
*        MVC   CPKMKT,=AL2(807)    TO SAN FRANSICO                              
         MVC   SRMKT,CPKMKT                                                     
         CLC   SRMKT,=AL2(601)                                                  
         BNE   *+10                                                             
         MVC   SRMKT,=AL2(511)                                                  
...
*                                                                               
         ...
         BCT   RF,BK20C            OTHERWISE CONTINUE SUMMATION                 
         B     PUTSORT             UNTIL END                                    
*                                                                               
...
PUTSORT1 DS    0H                                                               
         CLI   DATESW,1            IF NOT PROCESSING DATES                      
         BNE   EXIT                                                             
*                                                                               
         ...
         XC    SRDATA,SRDATA                                                    
         MVC   SRPNTW,=PL8'0'                                                   
         BCT   RF,BK20C            AND RETURN IF NEEDED                         
         B     EXIT                                                             
         SPACE 2                                                                
PSOK     ST    R9,SAVER9                                                        
*        CLC   QUESTOR(6),=C'ZTRACE'                                            
*        BNE   PSOK1                                                            
*        GOTO1 HEXOUT,DMCB,SRREC,P+1,54,0,0                                     
*        GOTO1 REPORT                                                           
         SPACE 2                                                                
PSOK1    GOTO1 =V(PSOK1C),DMCB,(RA)                                             
         L     R9,SAVER9                                                        
         BR    R9                                                               
         EJECT                                                                  
BK30     CLI   MODE,MKTFRST                                                     
         ...
         L     RE,ADMKTTAB                                                      
         LA    RF,1                                                             
BK302    CLC   CPKMKT,0(RE)        FIND MARKET NAME                             
         BE    BK304                                                            
         CLI   0(RE),X'FF'         END                                          
         BE    BK303                                                            
         AH    RE,WIDTHMKT                                                      
         ...
         B     BK302                                                            
BK303    LA    RF,240                                                           
BK304    STH   RF,MSEQ             SAVE THE SEQ NUMBER                          
         B     EXIT                                                             
EXIT     XMOD1 1                                                                
         EJECT                                                                  
* REFORMAT SORT KEY INTO STANDARD KEY                                           
RFMRKY   NTR1                                                                   
...
*                                                                               
RFMRKY2  ZIC   R1,1(RE)            GET LENGTH                                   
...
*                                                                               
         ...
         LA    RF,32*4(R5)                                                      
         LA    R9,QYRDATE                                                       
FILLQTR  MVC   0(2,R9),3(R5)       NOW FILL IN ACTUAL YEARS                     
         MVC   2(2,R9),3(RF)                                                    
         LA    R5,32(R5)                                                        
         LA    RF,32(RF)                                                        
         LA    R9,4(R9)                                                         
         BCT   R1,FILLQTR                                                       
*                                                                               
BK42     XC    HLD2REC,HLD2REC                                                  
         XC    HOLDREC,HOLDREC                                                  
         MVI   EOFSW,0                                                          
*                                                                               
*        CLC   QPROG,=C'34'                                                     
*        BNE   *+14                                                             
*        MVC   AGYNM,=CL34'ALL AGENCIES'                                        
*        MVI   RCSUBPRG,1                                                       
*                                                                               
         OC    TAPECNT,TAPECNT                                                  
         B     BK49                NOOP TO PRINT RECORD COUNTS                  
         MVC   P+10(19),=C'TAPE RECORDS OUTPUT'                                 
         EDIT  (B4,TAPECNT),(9,P)                                               
         GOTO1 REPORT                                                           
*                                                                               
BK49     CLI   ACTSW,1             ACTIVITY                                     
         BE    PR1                                                              
...
PR3      MVC   HLD2REC,0(RE)       ACCUMULATE DUPS                              
         ...
         ST    RE,ASRTREC                                                       
         BAS   RE,RFMRKY           REFORMAT INTO STANDARD KEY                   
*        GOTO1 HEXOUT,DMCB,HLD2REC,P+2,54                                       
*        GOTO1 REPORT                                                           
         OC    SRREC,SRREC                                                      
         BZ    PR1                                                              
         CLC   HLD2KEY,SRREC                                                    
...
PRX      DS    0H                                                               
*        CLC   QUESTOR(6),=C'ZTRACE'                                            
         CLC   SRMSEQ,=X'FFFF'     CROSS MARKET TOTAL                           
*        GOTO1 HEXOUT,DMCB,SRREC,P,54                                           
*        GOTO1 REPORT                                                           
PRX2     CLC   SRMSEQ,=X'FFFF'     CROSS MARKET TOTAL                           
         BNE   SD1                                                              
...
*        BE    *+14                                                             
         CLC   SRDPT,HLDDPT                                                     
         BNE   CPMDR                                                            
SD1A0    CLC   HIGROUP,SRRST       SET HIGEST RANK                              
         BH    *+10                                                             
         MVC   HIGROUP,SRRST                                                    
         CLI   DPTORDER,C'Y'                                                    
         BE    *+8                                                              
         ...
         BNE   CPMDR                                                            
         B     SD2                                                              
SD1A1    CLC   SRMKT,HLDMKT                                                     
         BNE   CPMDR                                                            
SD2      CLC   SRDEMO,HLDDEMO      SAME DEMO                                    
         BE    SD02                                                             
SD02     DS    0C                                                               
         LA    R8,WORK             BUILD MARKET TABLES                          
         XC    WORK,WORK                                                        
         USING MTABD,R8                                                         
         MVC   MTMSEQ,SRMSEQ                                                    
...
*              BYPASS BANK IF AGENCY NOT THERE                                  
         ...
         ST    R1,DMCB                                                          
         SPACE 2                                                                
SD02AA   GOTO1 ,DMCB,,MTAB,MTCNT,MTABLN,MTKLN,MTMAX                             
         CLI   DPTORDER,C'Y'                                                    
         BNE   SD02E                                                            
...
*                                                                               
         ...
         BNE   *+8                                                              
         L     RE,=A(AGYCAN)                                                    
SD2C     CLI   0(RE),X'FF'         END OF TABLE                                 
         BNE   *+6                                                              
         DC    H'0'                                                             
...
SD3      DS    0H                                                               
         ...
         A     RE,SRIMP                                                         
         ST    RE,DPDIMP                                                        
SD4      MVC   HOLDREC,SRREC                                                    
         B     PR1                                                              
         EJECT                                                                  
* PRINT CURRENT REPORT                                                          
CPMDR    CLI   DPTORDER,C'Y'                                                    
         BE    *+8                                                              
         ...
         MVI   PUTTSW,1                                                         
CPMDRA   CLI   DPTORDER,C'Y'       DETERMINE COLUMNS                            
         BNE   CPMDR1                                                           
         ...
         BNE   *+8                                                              
CPMDRB   CLI   PUTTSW,1            ONLY DO ON FIRST PASS                        
         BNE   CPMDRC                                                           
         CLI   QGRP+1,C'T'                                                      
         BNE   *+8                                                              
...
FIND2    LA    R1,1(R1)                                                         
         ...
         B     CPMDR2                                                           
*                                                                               
CPMDR1   LA    R9,46               SET NO. OF MARKETS ON PAGE                   
         ...
         L     R8,LHSTART                                                       
*                                                                               
CPMDR2   OC    0(2,R8),0(R8)       END OF LIST                                  
         BZ    RPTDONE             EXIT                                         
         ...
         BNL   CPMDR2A                                                          
         BAS   RE,GMNAM            GET MARKET NAME                              
         MVC   HLDDPT,MTDPT        SET DAYPART FOR DAYPART ORDER                
         MVC   CURRRPT,MTRPT                                                    
         BAS   RE,PRTLN            PRINT A LINE                                 
*                                                                               
CPMDR2A  AR    R8,R3               SET UP FOR RIGHT HAND SIDE                   
...
CPMDR3   GOTO1 REPORT                                                           
         ...
         LA    R8,MTABLN(R8)                                                    
         BCT   R9,CPMDR2           PRINT NEXT LINE                              
         L     R8,RHEND            NEXT PAGE                                    
         OC    0(2,R8),0(R8)                                                    
         BZ    RPTDONE                                                          
         B     CPMDRA              PRINT NEXT PAGE                              
         EJECT                                                                  
CPMCAR   MVC   CURRRPT,HLDRPT                                                   
         CLI   DATESW,1                                                         
         BE    CPMB2R                                                           
         L     R3,MTAB                                                          
         A     R3,=F'400000'                                                    
...
CPMCAR2  OC    0(2,R8),0(R8)                                                    
         ...
         MVI   P1,X'00'                                                         
         GOTO1 REPORT                                                           
CPMCAR3  XC    P1(132),P1                                                       
         XC    P2(132),P2                                                       
         LA    R8,MTABLN(R8)                                                    
         B     CPMCAR2                                                          
         EJECT                                                                  
RPTDONE  L     RE,MTAB             CLEAR FOR NEXT REPORT                        
         L     RF,=F'400000'                                                    
         XCEF                                                                   
         XC    MTCNT,MTCNT                                                      
         XC    HIGROUP,HIGROUP                                                  
...
PRL4A    EDIT  DIDSPT,(6,PLCSPOTS) PRINT THE SPOTS                              
         EDIT  DPDSPT,(5,PLASPOTS)                                              
*********************FOR TESTING ONLY*********************                      
*RL4A    EDIT  (P8,DIDPNTW),(8,PLCSPOTS) PRINT THE SPOTS                        
*        EDIT  DIDDOLE,(10,PLASPOTS)                                            
*        EDIT  DIDWGHT,(6,PLUNIV)                                               
**********************************************************                      
         ...
         EDIT  (RF),(4,PLAVRTG),1                                               
*                                                                               
PRL5     OC    DIDSPT,DIDSPT       ANY INDUSTRY SPOTS                           
         BZ    PRLX                                                             
...
PRLX     B     EXIT                                                             
         EJECT                                                                  
         USING BA1LINE,R7                                                       
BA1RPT   BAS   RE,GMNAM            GET MARKET NAME                              
...
*                                                                               
BA1RPT2  MVC   WEIGHT,DPDWGHT      PRINT THE CPP                                
         MVC   POINTS,DPDPNT                                                    
         MVC   POINTSW,DPDPNTW                                                  
         MVC   DOLLARE,DPDDOLE                                                  
         BAS   RE,CALCPP                                                        
...
TRNIDX4  MVC   DUB(4),0(R8)        CALCULATE INDEX                              
         MVC   DUB+4(4),0(R7)                                                   
         BAS   RE,CALIDX                                                        
...
*                                                                               
PRF4     EDIT  DIDUNIV,(5,PLUNIV)                                               
         EDIT  DIDSPT,(6,PLCSPOTS) PRINT THE SPOTS                              
*                                                                               
PRF5     OC    DIDSPT,DIDSPT       ANY INDUSTRY SPOTS                           
         BZ    PRFX                                                             
* CALCULATE INDUSTRY CPP                                                        
         MVC   WEIGHT,DIDWGHT                                                   
         MVC   POINTS,DIDPNT                                                    
...
GMNAM    NTR1                                                                   
         L     RE,ADMKTTAB         SET UP MARKET OR GROUP NAME                  
         MVC   CNMNAM,SPACES                                                    
         ...
         B     GMNAMX                                                           
         SPACE 1                                                                
GMNAM1   CLC   MTMKT,0(RE)         FIND MARKET NAME                             
         BE    GMNAM2                                                           
         CLI   0(RE),X'FF'                                                      
         BE    GMNAM3                                                           
         LA    RE,34(RE)                                                        
         B     GMNAM1                                                           
*                                                                               
GMNAM2   MVC   CNMNAM+4(24),6(RE)                                               
         MVC   DIDUNIV,=F'1'                                                    
         CLI   QMED,C'C'                                                        
         BE    *+8                                                              
         BAS   RE,RDUNIV                                                        
*                                                                               
GMNAM3   CLC   MTRST,=H'240'                                                    
         BE    GMNAMX                                                           
         EDIT  MTRST,(3,CNMNAM)                                                 
GMNAMX   B     EXIT                                                             
         SPACE 2                                                                
* GET THE DAYPART EXPANSIONS                                                    
GETDPT   ST    RF,SAVERF                                                        
         LA    RF,DPTNAM2                                                       
         CLI   DPTORDER,C'Y'                                                    
         BNE   *+8                                                              
         ...
         XC    CNDPT,CNDPT                                                      
*                                                                               
GETDPT2  CLC   HLDDPT,0(RF)        SCAN FOR CURRENT DAYPART                     
         BE    GETDPT6                                                          
         CLI   0(RF),X'FF'                                                      
         BNE   GETDPT4                                                          
         ...
         B     GETDPTX                                                          
*                                                                               
GETDPT4  LA    RF,15(RF)           TRY NEXT ENTRY                               
         CLI   DPTORDER,C'Y'                                                    
         BE    *+8                                                              
         LA    RF,10(RF)                                                        
         B     GETDPT2                                                          
*                                                                               
GETDPT6  MVC   CNDPT,1(RF)         SET NAME IN OUTPUT                           
         B     GETDPTX                                                          
         SPACE 2                                                                
GETDPTX  L     RF,SAVERF                                                        
         BR    RE                                                               
...
GETCLT2  CLC   QCLT(3),0(R1)                                                    
         ...
         BR    RE                                                               
         SPACE 1                                                                
GETCLT3  MVC   CLIENT,0(R1)                                                     
         MVC   CLTNM,3(R1)                                                      
         MVC   CLTOFF,23(R1)                                                    
         BR    RE                                                               
* GET THE DATA EXPANSIONS                                                       
GDTYP    ST    RF,SAVERF                                                        
         LA    RF,DTYPETAB                                                      
         XC    CNDTYP,CNDTYP                                                    
*                                                                               
GDTYP2   CLC   DATATYPE,0(RF)      SCAN FOR CURRENT DAYPART                     
         BE    GDTYP6                                                           
         CLI   0(RF),X'FF'                                                      
         BNE   GDTYP4                                                           
         ...
         B     GDTYPX                                                           
*                                                                               
GDTYP4   LA    RF,LNDTYPTB(RF)     TRY NEXT ENTRY                               
         B     GDTYP2                                                           
*                                                                               
GDTYP6   MVC   CNDTYP,1(RF)       SET NAME IN OUTPUT                            
*                                                                               
GDTYPX   ST    RF,ADTYPE                                                        
         L     RF,SAVERF                                                        
         BR    RE                                                               
         EJECT                                                                  
GETDEM   NTR1                      GET EXPANDED DEMO                            
         ...
         B     EXIT                                                             
         SPACE 2                                                                
GETTGT   NTR1                      GET EXPANDED TARGET                          
...
EDTCPP2  SR    RE,RE               PRINT DIME PRECISION                         
         ...
         B     EDTCPPX                                                          
*                                                                               
EDTCPP3  SR    RE,RE               PRINT DOLLAR PRECISION                       
         SLDA  RE,1                                                             
         D     RE,=F'10'                                                        
         A     RF,=F'1'                                                         
         SRA   RF,1                                                             
...
SUMGRP   NTR1                                                                   
         ...
         BZ    SUMGRPX                                                          
SUMGRP1  LA    RF,MTRECORD         MOVE SLOT TO SAVE AREA                       
         LR    RE,R8                                                            
         ...
         BNE   SUMGRP2A                                                         
SUMGRP2  LA    R7,MTIND            LOOK AT INDUSTRY TOTALS                      
         L     R1,DPDPNT                                                        
...
*                                                                               
SUMGRP2A MVC   MTMSEQ,=X'FFFF'     FORCE TO SORT AT END                         
         LA    RE,SUMCTRL          FIND GROUP FOR THIS MARKET                   
SUMGRP3  CLI   0(RE),X'FF'                                                      
         BNE   *+6                                                              
...
SUMGRP4  CLC   MTREN,HIGROUP                                                    
         ...
         BNE   SUMGRP6             DO NOT ADD IF INSERTED THIS TIME             
         ...
         L     R0,NOACUMS                                                       
         LA    R7,FLDCTRL                                                       
SUMGRP5  CLI   0(R7),C'P'          CHECK FOR PACKED ACCUMS                      
         BE    SUMGRP5P                                                         
         ...
         LA    R7,1(R7)                                                         
         BCT   R1,SUMGRP5                                                       
SUMGRP5A LA    R1,8                SET OR NEXT SLOT                             
         LA    R7,FLDCTRL                                                       
         BCT   R0,SUMGRP5                                                       
         B     SUMGRP6                                                          
*                                                                               
SUMGRP5P AP    0(8,R5),0(8,RE)     ADD UP PACKED ACCUMS                         
         LA    RE,8(RE)                                                         
         LA    R5,8(R5)                                                         
         LA    R7,1(R7)                                                         
         BCT   R1,SUMGRP5                                                       
         B     SUMGRP5A                                                         
         SPACE 2                                                                
SUMGRP6  L     RE,FULL             ADD UP BIG GROUPS                            
         ...
         B     SUMGRP4                                                          
*                                                                               
SUMGRP7  L     R8,SAVER8           RESTORE TABLE POINTER                        
         LA    R8,MTABLN(R8)                                                    
         BCT   R4,SUMGRP1                                                       
*                                                                               
SUMGRPX  B     EXIT                                                             
...
ONESPOT2 LA    R5,1(R5)                                                         
         ...
         BR    R9                                                               
*                                                                               
ONESPOTP CVD   R1,DUB              DIVIDE A PACKED FIELD                        
         ZAP   WORK(16),0(8,R7)                                                 
         MP    WORK(16),=P'10000'                                               
         DP    WORK(16),DUB                                                     
         ZAP   DUB,WORK(8)                                                      
...
PUTTAPEC CSECT                                                                  
         ...
         USING CPTM,R7                                                          
         MVC   DSNCP32+13(2),QAGY                                               
         GOTO1 =V(DYNALLOC),DMCB,DDCP32,DSNCP32                                 
         B     PT00                                                             
DDCP32   DC    CL8'OUT'                                                         
DSNCP32  DC    CL20'CPPTAPE.CP032XX1'                                           
PT00     OPEN  (OUT,(OUTPUT))                                                   
         XC    TAPECNT,TAPECNT                                                  
         L     R9,ADMKTTAB                                                      
PT01     CLI   0(R9),X'FF'         END OF MARKET TABLE                          
         BE    PT10                PUT OUT DAYPART TABLE                        
         ...
         ST    R1,TAPECNT                                                       
         LA    R9,34(R9)                                                        
         B     PT01                CONTINUE TILL END OF TABLE                   
         DROP  R7                                                               
         SPACE 2                                                                
...
PUTDISKC CSECT                                                                  
         ...
         BNE   PD30                                                             
         MVI   TAPEFRST,0                                                       
         L     R7,=A(IOT2)         POINT TO IO AREA                             
         USING CPDM,R7                                                          
         MVC   DSNCP33+13(2),QAGY                                               
         GOTO1 =V(DYNALLOC),DMCB,DDCP33,DSNCP33                                 
         B     PD00                                                             
DDCP33   DC    CL8'OUT2'                                                        
DSNCP33  DC    CL20'CPPTAPE.CP033XX1'                                           
PD00     OPEN  (OUT2,(OUTPUT))                                                  
         XC    TAPECNT,TAPECNT                                                  
         L     R9,ADMKTTAB                                                      
PD01     CLI   0(R9),X'FF'         END OF MARKET TABLE                          
         BE    PD10                PUT OUT DAYPART TABLE                        
         ...
         ST    R1,TAPECNT                                                       
         LA    R9,34(R9)                                                        
         B     PD01                CONTINUE TILL END OF TABLE                   
         DROP  R7                                                               
         SPACE 2                                                                
...
PD12     CLI   0(R9),X'FF'         END OF DAYPART TABLE                         
         ...
         SPACE 2                                                                
         USING CPDP,R7                                                          
PD20     L     R9,=A(RPTCAPS)      SEND PROGRAM TYPE TABLE                      
         LA    R0,6                LOOP FOR US                                  
         CLI   QMED,C'C'                                                        
         BNE   *+8                                                              
         LA    R0,9                LOOP FOR CANADA                              
         LA    R1,1                START THE PROGRAM COUNTER                    
PD22     MVI   CPDPID,C' '         CLEAR THE RECORD                             
...
PD30     CLI   REQSENT,C'Y'                                                     
         ...
         MVI   REQSENT,C'Y'                                                     
*                                                                               
PD31     L     R8,MTAB             SEND THE ENTIRE CPP TABLE                    
PD32     OC    0(2,R8),0(R8)                                                    
         BZ    PD40                                                             
         MVI   CPDCID,C' '         CLEAR THE RECORD                             
         MVC   CPDCID+1(CPDCLEN-1),CPDCID                                       
...
* SEND THE INDUSTRY DATA                                                        
         ...
         LA    R1,1(R1)                                                         
         ST    R1,TAPECNT                                                       
PD34     LA    R8,MTABLN(R8)                                                    
         B     PD32                CONTINUE TO END                              
         DROP  R7                                                               
PD40     XMOD1                                                                  
         LTORG                                                                  
***********************************************************************         
...
RPTSET   LA    R8,3(R7)            SET TO PROCESS CONTROLS                      
RPTSET1  CLI   0(R8),X'FF'         END OF ALL PROCESS LISTS                     
         BE    RPTSET2                                                          
         ...
         BE    RPTSET3             TRY NEXT REPORT                              
         LA    R8,1(R1,R8)         NEXT PROCESS (R1 HAS INC. LIST END)          
         B     RPTSET1             PROCESS CURRENT ROUTINE                      
*                                                                               
RPTSET2  MVC   SRRPT,2(R7)         SET REPORT CODE                              
         ...
         BNE   RPTSET3                                                          
RPTSET2A MVC   SAVSKY,SRREC        SAVE THE SORT KEY                            
         BAS   RE,RFMSKY           REFORMAT SORT KEY                            
         ...
         B     RPTSET3                                                          
         BNE   RPTSET3                                                          
         LA    R9,SUMCTRL          SUMMARY CONTROL TABLE                        
         MVI   RGROUPSW,1                                                       
*                                                                               
RPTSET2B CLC   SRRST,2(R9)         FIND FIRST GROUP                             
         BH    RPTSET2C                                                         
         CLI   0(R9),X'FF'                                                      
         BNE   RPTSET2D                                                         
         DC    H'0'                                                             
RPTSET2C LA    R9,4(R9)                                                         
         B     RPTSET2B                                                         
         SPACE 2                                                                
RPTSET2D MVC   SRRST,0(R9)         INITIAL SEQUENCE                             
         MVC   SRREN,2(R9)                                                      
...
RHEND    DS    F                                                                
TAPECNT  DS    F                                                                
RPTCID   DS    C                   CONTROL TABLE ID ( SEE PSOK1C )              
...
*-       DC    C'DF',C'A',AL1(08)                                               
         DC    C'DF',C' ',AL1(08)                                               
         DC    C'DF',C' ',AL1(08)                                               
         DC    C'HR',C' ',AL1(09)  HAL RAINEY 9/11/87                           
         DC    C'JW',C' ',AL1(10)                                               
         DC    C'KA',C' ',AL1(11)  IN JAN/91                                    
*-       DC    C'LC',C'A',AL1(12)                                               
         DC    C'LC',C' ',AL1(12)                                               
         DC    C'LM',C' ',AL1(13)  LOWE/MARSCHALK 4/12/90                       
         DC    C'NE',C' ',AL1(14)                                               
*-       DC    C'NW',C'A',AL1(15)                                               
         DC    C'NW',C' ',AL1(15)                                               
         DC    C'OM',C' ',AL1(16)                                               
         DC    C'QJ',C' ',AL1(17)                                               
         DC    C'RP',C'N',AL1(18)  RUBIN POSTAER (NSI ONLY 5/20/87)             
*-       DC    C'TR',C'A',AL1(19)                                               
         DC    C'TR',C' ',AL1(19)                                               
         DC    C'YN',C' ',AL1(20)  Y&R 9/11/87                                  
*        DC    C'AC',C'A',AL1(21)  OUT JAN/91                                   
*        DC    C'CA',C' ',AL1(24)  OUT 5/92                                     
*        DC    C'CO',C' ',AL1(04)                                               
*        DC    C'FC',C' ',AL1(08)                                               
*        DC    C'FM',C' ',AL1(00)                                               
*        DC    C'GA',C'A',AL1(32)  CHANGED FROM NSI 1/21/86                     
*        DC    C'HC',C' ',AL1(35)  HILL/HOLIDAY LA 10/1/89                      
*        DC    C'HE',C'N',AL1(25)  OUT JAN/91                                   
*        DC    C'HH',C' ',AL1(26)                                               
*        DC    C'JM',C'N',AL1(35)  JOHN MURRAY 9/11/87                          
*        DC    C'LE',C'N',AL1(35)  LORD EINSTIEN 1/3/89                         
*        DC    C'LG',C'N',AL1(35)                                               
*        DC    C'LH',C'A',AL1(11)  OUT DEC12/89                                 
*        DC    C'LM',C' ',AL1(13)  IN MAY7/90                                   
*        DC    C'MC',C' ',AL1(13)  OUT OCT21/88                                 
*        DC    C'MN',C'A',AL1(31)  IN  SEPT29/88                                
*        DC    C'MN',C'A',AL1(31)  OUT JAN/91                                   
*        DC    C'RR',C'A',AL1(28)                                               
*        DC    C'SC',C'N',AL1(17)                                               
*        DC    C'SH',C'A',AL1(11)  IN  DEC12/89                                 
*        DC    C'SS',C' ',AL1(18)                                               
*        DC    C'SW',C'N',AL1(16)                                               
*        DC    C'TB',C' ',AL1(00)                                               
*        DC    C'TK',C'N',AL1(31)  OUT SEPT29/88                                
*        DC    C'WE',C'N',AL1(07)                                               
*        DC    C'WL',C'A',AL1(20)                                               
         DC    C'99',C' ',AL1(21)                                               
         DC    X'FF'                                                            
...
SPORTST8 DC    AL2(SPORTEN8-SPORTST8+1),AL1(10)                                 
         ...
         DC    AL1(POSDPT),AL1(LENDPT),AL1(WEA)                                 
         DC    AL1(POSDPT),AL1(LENDPT),AL1(ELY)                                 
         DC    AL1(POSDPT),AL1(LENDPT),AL1(FRG)                                 
         DC    AL1(POSDPT),AL1(LENDPT),AL1(ACC)                                 
         DC    AL1(POSDPT),AL1(LENDPT),AL1(LTE)                                 
         DC    AL1(POSDPT),AL1(LENDPT),AL1(LLT)                                 
         DC    X'FF'                                                            
...
BA1DOL   DS    CL8                                                              
         SPACE 2                                                                
* BATES TREND REPORT LAYOUT                                                     
BA2LINE  DSECT                                                                  
BA2DPT   DS    CL17                DAYPART NAME                                 
         DS    CL1                                                              
BA2DESC  DS    CL5                                                              
         DS    CL3                                                              
BA2DATA  DS    0CL19               SLOTS FOR QUARTER DATA                       
BA2QY1   DS    CL6                                                              
         DS    CL1                                                              
BA2QY2   DS    CL6                                                              
         DS    CL1                                                              
...
EDBLOCK  DSECT                                                                  
       ...
       ++INCLUDE CPGENFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'091CPREP3202J05/01/02'                                      
         END                                                                    
