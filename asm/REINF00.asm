*          DATA SET REINF00    AT LEVEL 014 AS OF 02/21/03                      
*PHASE T80B00A,*                                                                
...
*                                                                   *           
* MAY30/02 (HQ ) ADD EMAIL ADDRESS OPTION FOR SALES ASSIT AND STA   *           
*                                                                   *           
*                ***  END TOMBSTONE  ***                            *           
*********************************************************************           
*                                                                               
...
*                                                                               
         ...
         BE    VOPT0020            YES - CHECK FOR STATION RECORD               
         CLI   OPT2BYTE,8          EMAIL ADDRESS OPTION?                        
         BE    VOPT0020            YES - CHECK FOR STATION RECORD               
         CLI   OPT2BYTE,26         UID DISPLAY OPTION?                          
         BE    VOPT0020            YES - CHECK FOR STATION RECORD               
...
VOPT0040 EQU   *                                                                
         ...
         CLI   OPTNBYTE,19                                                      
         BE    VOPT0060                                                         
         CLC   0(2,R6),=CL2'SA'      - SALES ASSISTANT                          
         BE    VOPT0060                                                         
*                                                                               
         CLI   4(R6),C','                                                       
         BNE   ANYERR                                                           
...
SAL10    TM    FLTRBYTE,X'EF'      ALLOW DIV FILTER                             
         ...
         BE    SAL20                                                            
         CLI   OPTNBYTE,25         EDI     OPTION ALLOWED                       
         BE    SAL30                                                            
         CLI   OPTNBYTE,0                                                       
         BNE   ERROPTN                                                          
SAL20    EQU   *                                                                
...
*                                                                               
         MVC   INFTITL(L'SALTTL),SALTTL                                         
         MVC   INFTITL+49(L'SALTTL3),SALTTL3                                    
         FOUT  INFTITLH                                                         
         B     CALLOVER                                                         
         EJECT                                                                  
...
*                                                                               
         CLI   OPTNBYTE,26         UID DISPLAY OPTION?                          
         BNE   STAT0038            YES                                          
         MVC   INFTITL+30(5),=C'*UID*'                                          
...
PTP10    TM    FLTRBYTE,X'FF'      NO EXTRA FILTERS                             
         ...
         BE    PTP10020            YES                                          
         CLI   OPTNBYTE,0          NO OTHER OPTIONS ALLOWED                     
         BNZ   ANYERR                                                           
         CLI   REPBYTE,0           REP NOT ALLOWED                              
         BNE   ERROPTN                                                          
*                                                                               
...
SASOPTN  NTR1                                                                   
         L     RF,ACOMFACS                                                      
         L     RF,CSCANNER-COMFACSD(RF) GET A(SCANNER)                          
         GOTO1 (RF),DMCB,INFOPTNH,(X'80',IOAREA1)                               
         CLI   DMCB+4,0                                                         
         BNE   *+6                                                              
         DC    H'0'                                                             
         LA    R6,IOAREA1                                                       
*                                                                               
         CLI   0(R6),2        ONLY ALLOW 'SA'                                   
         BNE   SASERR                                                           
         CLI   1(R6),0                                                          
         BNE   SASERR                                                           
         CLI   32(R6),0       PERMIT SA ONLY OPTION                             
         BNE   *+12                                                             
         CLI   64(R6),0                                                         
         BE    SASOPTNX                                                         
*                                                                               
SAS0010  EQU   *                                                                
         ...
         CLI   0(R6),4                                                          
         BNE   SASERR                                                           
         CLC   12(4,R6),=CL4'NAME'                                              
         BNE   *+12                                                             
         MVI   OPTNBYTE,1     SORT BY NAME                                      
         B     SAS0020                                                          
         CLC   12(4,R6),=CL4'CODE'                                              
         BNE   SASERR                                                           
*                                                                               
SAS0020  EQU   *                                                                
         LA    R6,32(R6)                                                        
...
*                                                                               
         ...
         BR    RE                                                               
*                                                                               
         CLC   0(5,R6),=C'EMAIL'   DOUBLE LINE EMAIL ADDRESS                    
         BNE   *+10                                                             
         MVI   OPT2BYTE,8          SET A SEPARATE OPT BYTE                      
         BR    RE                                                               
*                                                                               
         CLC   0(3,R6),=C'NET'                                                  
         BNE   *+10                                                             
...
*                                                                               
         ...
         BR    RE                                                               
*                                                                               
         CLC   0(3,R6),=C'EDI'     REDI DATA DISPLAY                            
         BNE   *+10                   FOR S/P AND P/P                           
         MVI   OPTNBYTE,25                                                      
         BR    RE                                                               
*                                                                               
         CLC   0(3,R6),=C'UID'     UNIQUE ID FOR STATIONS                       
         BNE   *+10                                                             
         MVI   OPTNBYTE,26                                                      
         BR    RE                                                               
*                                                                               
         LR    R0,RE                                                            
         CLC   0(2,R6),=C'SA'      SALES ASSISTANT                              
         BNE   TST0020                                                          
         BAS   RE,SASOPTN                                                       
         TM    DMCB+4,X'80'                                                     
         BNZ   ERROPTN1                                                         
...
LPTPTTL  EQU   *-PTPTTL                                                         
PTPTTL2  DC    C'CODE NAME                 TELEPHONE    '                       
         DC    C'REP OFF FAX  EDI  FAX #              '                         
LPTPTTL2 EQU   *-PTPTTL2                                                        
*                                                                               
...
* DDCOMFACS                                                                     
       ...
       ++INCLUDE REGLFILE                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014REINF00   02/21/03'                                      
         END                                                                    
