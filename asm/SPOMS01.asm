*          DATA SET SPOMS01    AT LEVEL 080 AS OF 07/08/08                      
*PHASE T23401A                                                                  
***********************************************************************         
*                                                                               
*  TITLE: T23401 - MAINTENANCE/LIST OF BUYERS                                   
*                                                                               
...
*  CALLS TO:    DATAMGR                                                         
*                                                                               
*  INPUTS: SCREENS SPOMSE1 (T234E1) -- MAINTENANCE                              
*                  SPOMSF1 (T234F1) -- LIST                                     
*                                                                               
...
*                                                                               
***********************************************************************         
T23401   TITLE 'SPOMS01 - MAINTENANCE OF BUYERS'                                
T23401   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T23401*,R7,RR=R3                                              
...
VK10     OC    BUYID,SPACES        BLANK PADDED                                 
         GOTO1 RCPACK,DMCB,(C'P',BUYID),(X'80',WORK)                            
         BNE   INVLFLD                                                          
         MVC   BYRKBYR,BUYID                                                    
*                                                                               
VKX      MVC   KEY,SVKEY                                                        
...
*                                                                               
       ...
       ++INCLUDE SPOMSFFD          (BASE SCREEN FOR SYSTEM)                     
         ORG   CONTAGH                                                          
       ++INCLUDE SPOMSF1D          (OUR MAINTENANCE SCREEN OVERLAY)             
         EJECT                                                                  
         ORG   CONTAGH                                                          
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'080SPOMS01   07/08/08'                                      
         END                                                                    
