*          DATA SET REROM00S   AT LEVEL 057 AS OF 04/02/03                      
*PHASE T83F00A,*                                                                
*INCLUDE RECUP                                                                  
*INCLUDE OUTDAY                                                                 
*INCLUDE REGENDAB                                                               
...
*                                                                               
         GOTO1 CALLOV,DMCB,0,X'D9083F22',0                                      
         MVC   VREDAR22,0(R1)      ESTABLISH REROM22 OVERLAY                    
*                                                                               
* MOVE OVERLAY 30 OUT OF CORE                                                   
*        GOTO1 CALLOV,DMCB,0,X'D9083F30',0                                      
*        MVC   VREDAR30,0(R1)      ESTABLISH REROM30 OVERLAY                    
* ROM DOES NOT CALL REDAR31, REDAR32                                            
*                                                                               
*        GOTO1 CALLOV,DMCB,0,X'D9083F31',0                                      
*        MVC   VREDAR31,0(R1)      ESTABLISH REROM31 OVERLAY                    
*                                                                               
*        GOTO1 CALLOV,DMCB,0,X'D9083F32',0                                      
*        MVC   VREDAR32,0(R1)      ESTABLISH REROM32 OVERLAY                    
*                                                                               
SYSXIT   DS    0H                                                               
         B     XIT                                                              
         EJECT                                                                  
...
*        DC    X'03',AL1(01,12),X'00300030C0',C'    '  ORDER     REPORT         
         ...
         DC    X'03',AL1(06,15),X'F822000081',C'    '  REVISION  RJ/AMD         
         DC    X'03',AL1(06,17),X'E822000081',C'    '  REVISION  DIFF           
...
****************************                                                    
       ...
       ++INCLUDE REDARPROF                                                      
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'057REROM00S  04/02/03'                                      
         END                                                                    
