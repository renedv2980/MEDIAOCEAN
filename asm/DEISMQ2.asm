*          DATA SET DEISMQ2    AT LEVEL 020 AS OF 05/01/02                      
*PHASE DEISMQ2A                                                                 
*INCLUDE HEXOUT                                                                 
*INCLUDE PDUMPER                                                                
*INCLUDE PRINT                                                                  
...
*                                                                               
         B     GETREC                                                           
         EJECT                                                                  
GOODBYE  LA    R2,CSQBCOMM_STRUCTURE                                            
...
QNAME        DC      CL48'FREDQM.TEST.QREMOTE'                                  
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020DEISMQ2   05/01/02'                                      
         END                                                                    
