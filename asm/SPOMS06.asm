*          DATA SET SPOMS06    AT LEVEL 079 AS OF 01/03/07                      
*PHASE T23406A                                                                  
***********************************************************************         
*                                                                               
*  TITLE: T23406 - MAINTENANCE/LIST OF STANDARD COMMENTS                        
*                                                                               
...
*  CALLS TO:    DATAMGR                                                         
*                                                                               
*  INPUTS: SCREENS SPOMSF6 (T234F6) -- MAINTENANCE                              
*                  SPOMSE6 (T234E6) -- LIST                                     
*                                                                               
...
*                                                                               
***********************************************************************         
T23406   TITLE 'SPOMS06 - MAINTENANCE OF STANDARD COMMENTS'                     
T23406   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T23406*,R7,RR=R3                                              
...
*                                                                               
       ...
       ++INCLUDE SPOMSFFD          (BASE SCREEN FOR SYSTEM)                     
         PRINT ON                                                               
         ORG   CONTAGH                                                          
       ++INCLUDE SPOMSF6D          (OUR MAINTENANCE SCREEN OVERLAY)             
         EJECT                                                                  
         ORG   CONTAGH                                                          
       ++INCLUDE SPOMSE6D          (OUR LIST SCREEN OVERLAY)                    
         EJECT                                                                  
       ++INCLUDE DDPERVALD                                                      
         EJECT                                                                  
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'079SPOMS06   01/03/07'                                      
         END                                                                    
