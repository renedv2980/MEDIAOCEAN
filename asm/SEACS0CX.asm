*          DATA SET SEACS0CX   AT LEVEL 012 AS OF 05/01/02                      
*PHASE TA0D0CA,*                                                                
*INCLUDE SCINKEY                                                                
...
GS020    LA    R1,IOCONFIL+IOSQ+IO1  ELSE NEXT LIST LINE                        
         ...
         BZ    GS020                                                            
*                                                                               
GSPWD    CLI   SELPWDSP,C' '       PASSWORD - FILTER ONLY IF IT                 
         ...
         EX    R1,*+8                                                           
         B     *+10                                                             
         CLC   SA0KCODE(0),SELPWD                                               
         BH    GSEND               (NO MORE RELEVENT RECORDS)                   
GSPWD1   GOTO1 ATXTFLT,APPARM,(SELPWDL,SELPWD),(L'SA0KCODE,SA0KCODE)            
...
DSPEF10  CLC   SAPEFEND,FFILL                                                   
         ...
         B     DS120                                                            
DSPEF20  GOTO1 VDATCON,APPARM,(2,SAPEFEND),(X'51',APWORK)                       
...
LISTDEF2 DS    CL8                 END EFFECTIVE DATE                           
         DS    CL1                                                              
LISTSYST DS    CL28                VALID SYSTEM NAMES LIST                      
...
LOCALX   EQU   *                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012SEACS0CX  05/01/02'                                      
         END                                                                    
