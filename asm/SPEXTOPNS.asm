*          DATA SET SPEXTOPNS  AT LEVEL 015 AS OF 05/01/02                      
*PHASE SPEXTOPT,*                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
...
TTRAFCT  DC    PL5'0',CL28'TOT TRAF CLOSED OUT'                                 
TRAFCTOP DC    PL5'0',CL28'TRAFFIC RECS OPENED'                                 
...
CLTHDRD   DSECT                                                                 
       ...
       ++INCLUDE SPNWSDTL                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015SPEXTOPNS 05/01/02'                                      
         END                                                                    
