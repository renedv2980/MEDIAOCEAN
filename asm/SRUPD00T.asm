*          DATA SET SRUPD00T   AT LEVEL 007 AS OF 08/25/00                      
*PHASE T10D00A                                                                  
...
*&&US*&& DC    C'A55',X'00',A(ACCEXIT)                                          
*&&US*&& DC    C'A56',X'00',A(ACCEXIT)                                          
         DC    H'0'                                                             
         EJECT                                                                  
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
ADDHOOK  NTR1                                                                   
         LA    R1,KEYTAB3          TABLE OF CHANGE EXITS                        
ADDHK1   L     RF,4(R1)                                                         
         A     RF,RELO                                                          
         CLC   UKSYSPRG,0(R1)                                                   
         BER   RF                  EXECUTE USER EXIT                            
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE CTGENFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007SRUPD00T  08/25/00'                                      
         END                                                                    
