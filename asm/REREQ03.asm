*          DATA SET REREQ03    AT LEVEL 122 AS OF 10/10/11                      
*PHASE T80703A,*                                                                
*INCLUDE HEXOUT                                                                 
...
*                                                                               
         ...
         FOUT  (R2)                                                             
*                                                                               
*   COMBINE COMBOS FIELD IS GONE.  OPTION IS NOW A KEYWORD IN NEW               
*        OPTIONS FIELD.                                                         
*                                                                               
***      LA    R2,RQSCMBOH                                                      
...
DISP0740 B     COMMGOOD            GOOD CC                                      
         EJECT                                                                  
*                                                                               
*   SET VALUES IN OPTION2 FIELD                                                 
*                                                                               
SETOPT2  NTR1                                                                   
         MVI   BYTE,0              CLEAR FLAG                                   
         LA    R2,RQSOPT2                                                       
         MVC   0(L'RQSOPT2,R2),SPACES         CLEAR THE FIELD                   
         CLC   RBUYATT1,SPACES     ATTRIBUTE 1 FILTER?                          
         BNH   SOP20020            NO                                           
         MVC   0(3,R2),=C'A1='     YES                                          
         MVC   3(2,R2),RBUYATT1                                                 
         MVI   5(R2),C','          INSERT SEPARATOR                             
         MVI   BYTE,1              SET FLAG                                     
         LA    R2,6(R2)            BUMP TO NEXT FIELD                           
SOP20020 EQU   *                                                                
         CLC   RBUYATT2,SPACES     ATTRIBUTE 2 FILTER?                          
         BNH   SOP20040            NO                                           
         MVC   0(3,R2),=C'A2='     YES                                          
         MVC   3(2,R2),RBUYATT2                                                 
         MVI   5(R2),C','          INSERT SEPARATOR                             
         ...
         LA    R2,6(R2)            BUMP TO NEXT FIELD                           
SOP20040 EQU   *                                                                
         CLC   RBUYCODE,SPACES     BUY CODE FILTER?                             
         BNH   SOP20060            NO                                           
         MVC   0(3,R2),=C'BC='     YES                                          
         MVC   3(3,R2),RBUYCODE                                                 
         MVI   6(R2),C','          INSERT SEPARATOR                             
         MVI   BYTE,1              SET FLAG                                     
         LA    R2,7(R2)            BUMP TO NEXT FIELD                           
SOP20060 EQU   *                                                                
         CLI   RCOMPNO,C' '        COMBINE COMBO?                               
         BNH   SOP20080            NO                                           
         MVC   0(3,R2),=C'CC='     YES                                          
         MVI   3(R2),C'Y'                                                       
         MVI   5(R2),C','          INSERT SEPARATOR                             
...
SOP20080 EQU   *                                                                
         CLI   BYTE,1              FLAG SET?                                    
         BE    SOP20100            YES - IGNORE BUY READER SETTING              
         CLI   RBUYCOD,C' '        NO  - IS BUY READER REQUESTED?               
         BNH   SOP20400            NO                                           
         MVC   0(3,R2),=C'RB='     YES                                          
         MVI   3(R2),C'Y'                                                       
         MVI   5(R2),C','          INSERT SEPARATOR                             
         LA    R2,5(R2)            BUMP TO NEXT FIELD                           
SOP20100 EQU   *                                                                
         CLC   RCOMPSP,=C'   '     COMP S/P CODE FILTER?                        
         BNH   SOP20400            NO                                           
         MVC   0(3,R2),=C'CP='     YES                                          
         MVC   3(3,R2),RCOMPSP     INSERT COMP S/P FILTER                       
         MVI   6(R2),C','          INSERT SEPARATOR                             
         LA    R2,7(R2)            BUMP TO NEXT FIELD                           
SOP20400 EQU   *                                                                
...
OPT6VAL  EQU   *                                                                
         ...
         SPACE                                                                  
BEST$OP  EQU   *                                                                
         MVC   8(1,R2),RBEST$OP    BEST DOLLAR OPTION                           
         B     OPTOK                                                            
         SPACE                                                                  
...
DEMOD    DSECT                                                                  
       ++INCLUDE DEDBLOCK                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'122REREQ03   10/10/11'                                      
         END                                                                    
