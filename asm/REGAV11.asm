*          DATA SET REGAV11    AT LEVEL 014 AS OF 05/01/02                      
*PHASE T81311A,+0                                                               
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLST                                                                
         TITLE 'T81311 - REPPAK FILE MAINT - DEMO MENU ADD/CHA/DIS/DEL'         
T81311   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T81311,RR=R5                                                   
         LA    R9,2048(RB)                                                      
         LA    R9,2048(R9)                                                      
         USING T81311+4096,R9                                                   
*                                                                               
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
         L     RA,ATWA                                                          
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014REGAV11   05/01/02'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
