*          DATA SET DELMTPI    AT LEVEL 020 AS OF 09/16/20                      
...
*                                                                               
         GET   IN1,(R4)                                                         
* LOCAL MONTHLIES IGNORE RECORDS WITH W_KFILETYPE = W_KFILETYPE_WEEKLY          
         CLI   W_KFILETYPE,W_KFILETYPE_WEEKLY                                   
         BNE   *+12                                                             
         MVI   BYPREAD,0                                                        
         B     OPENOK                                                           
*                                                                               
...
*                                                                               
         CLC   INTBOOK,=AL2(JUL_18) JUL18 WE WILL BE GETTING L+1 DATA           
***      CLC   INTBOOK,=AL2(MAY_16) FOR TEST DATA PURPOSE                       
         BNL   LMBTYP10                                                         
*                                                                               
...
*                                                                               
*                                                                               
LMBT00   CLI   W_KRSRVC,RSRVC_NHSI NHSI?                                        
         BNE   *+12                                                             
         MVI   LMBTKEY+1,C'H'                                                   
         B     LMBT01                                                           
*                                                                               
...
*                                                                               
         ...
         BNE   LMBT16X                                                          
*                                                                               
* SKIP PARENT ONLY STATIONS FOR IMPACT BOOKTYPES                                
         CLI   LMBTKEY+1,C'A'                                                   
         BE    SKIP                                                             
*                                                                               
         MVI   LMBTKEY+1,C'E'                                                   
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020DELMTPI   09/16/20'                                      
         END                                                                    
