*          DATA SET ACREPR302  AT LEVEL 078 AS OF 03/23/15                      
*PHASE ACR302A,+0                                                               
*INCLUDE SQUASHER                                                               
*INCLUDE SORTER                                                                 
*INCLUDE UNDERLIN                                                               
...
*                           N- N TIME                                *          
*                                                                    *          
*        OPTION 10          Y- SHOW DOLLARS (BASED ON SECURITY)      *          
*                           N- CENSOR DOLLARS (SECURITY)             *          
**********************************************************************          
...
*                                                                               
PRTAMNT  DS    0H                                                               
         CLI   QOPT10,C'N'         ARE THEY ALLOWED TO SEE $                    
         BER   RE                                                               
         LA    R4,P                                                             
         ZIC   R1,0(R2)                                                         
         AR    R4,R1                                                            
...
*        ACOFFALD                                                               
       ...
       ++INCLUDE ACOFFALD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'078ACREPR302 03/23/15'                                      
         END                                                                    
