*          DATA SET PRWRIHLP   AT LEVEL 061 AS OF 05/01/02                      
*          DATA SET PRWRIHLP   AT LEVEL 049 AS OF 11/01/94                      
*PHASE T40505B,* =*=*=*=*=*= PHASE B =*=*=*=*=*=*=*=*=*                         
*INCLUDE TWABLD                                                                 
*INCLUDE MENU                                                                   
*                                                                               
*               PRWRIHLP - BUILDS HELP MENU VIA DDMENU                          
         TITLE 'PRWRIHLP - BUILDS HELP MENU VIA DDMENU - INIT'                  
***********************************************************************         
*                                                                     *         
...
***********************************************************************         
         ...
         PRINT NOGEN                                                            
PRWRIHLP CSECT                                                                  
         NMOD1 HMWORKL,PRWRIHLP,RR=RE,CLEAR=YES                                 
*                                                                               
...
*                                                                               
         ...
         LA    R7,T405FFD(R7)      ADDRESS OF HELP SAVE AREA                    
...
*                                                                               
         MVC   HMWDMCB+4(4),=X'D9000A40'                                        
         GOTO1 VCALLOV,HMWDMCB,0                                                
         MVC   VDDVAL,HMWDMCB      A(PRVAL)                                     
*                                                                               
...
*                                                                               
         LA    R8,HMWVALTB         ESTABLISH RETURNED TABLE ENTRY               
         USING VLTABD,R8                                                        
*                                                                               
...
*                                                                               
         ...
         LA    R2,T405FFD(R2)      RELOCATE ADDRESS                             
*                                                                               
...
*                                                                               
         DROP  R8                                                               
*                                                                               
         LA    R8,HMWVALTB         ESTABLISH RETURNED DDVAL TABLE               
...
*                                                                               
*        ALL HELP MENUS HAVE BYTE 0 = BYTE 1 OF MASTER ICODE                    
*                                                                               
         CLC   HCBMTIC+1(1),HMWDTIC     SKIP IF THIS IS NOT HELP MENU           
         BNE   *+10                                                             
...
PRWRIHLPX DS   0H                                                               
         XIT1                                                                   
*                                                                               
         TITLE 'PRWRIHLP - DDVAL CONTROL BLOCK INIT - VALINIT'                  
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP  R5                                                               
*                                                                               
         TITLE 'PRWRIHLP - DDMENU INIT - MENUINIT'                              
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP  R6,R7,R8                                                         
*                                                                               
         TITLE 'PRWRIHLP - BUILD HELP MENUS - HMNHOOK'                          
***********************************************************************         
*                                                                     *         
...
*                                                                               
         TITLE 'PRWRIHLP - DISPLAY MENU TABLE ENTRY - HMHDISP'                  
***********************************************************************         
*                                                                     *         
...
HMHDISP  DS    0H                                                               
*                                                                               
         L     RF,=AL4(HMMENUSW-T405FFD)   DISPLACEMENT OF MENU SWITCH          
...
*                                                                               
         B     HMHOOKX                                                          
*                                                                               
         TITLE 'PRWRIHLP - VALIDATE SELECTION ENTRY - HMHVSEL'                  
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         BE    HMHVSSL                                                          
         CLI   0(RF),C'H'          CHECK FOR A HELP REQUEST                     
         BE    HMHVSHP                                                          
         LA    RF,1(RF)                                                         
         BCT   R0,*-20                                                          
*                                                                               
         B     HMHVSER1                                                         
*                                                                               
         TITLE 'PRWRIHLP - PROCESS A SELECTION - HMHVSSL'                       
***********************************************************************         
*                                                                     *         
...
*                                                                               
         LA    R2,1(RF,R2)         BUMP TO NEXT AVAILABLE SPACE                 
...
*                                                                               
         B     HMHVSELX                                                         
*                                                                               
         TITLE 'PRWRIHLP - PUT OUT HELP MESSAGE - HMHVSHP'                      
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP  R4                                                               
*                                                                               
         TITLE 'PRWRIHLP - PROCESS A SELECTION - HMHPROC'                       
***********************************************************************         
*                                                                     *         
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE   'PRWRIHLP DSECTS - HELPCB'                                     
*                                                                               
       ++INCLUDE PRWRIHLPCB                                                     
*                                                                               
         TITLE 'PRWRIHLP - WORKING STORAGE - HMWORK'                            
***********************************************************************         
*                                                                     *         
...
*                                                                               
         EJECT                                                                  
*                                                                               
HMWIO    DS    0XL400              IOAREA                                       
HMWVALTB DS    XL(HMWSEGS*256)     DDVAL  TABLE                                 
HMWSEGS  EQU   50                  # OF 256 BYTE SEGMENTS IN TABLE              
*                                                                               
HMWORKL  EQU   *-HMWORKD           WORKING STORAGE LENGTH                       
*                                                                               
         TITLE   'PRWRIHLP DSECTS - MENUBLK'                                    
***********************************************************************         
*                                                                     *         
...
*                                                                               
HMMENUTB DS    (18*1024-(*-T405FFD))XL1 DDMENU TABLE                            
*                                                                               
HMMENUSX EQU   *-1                 END OF SAVEAREA                              
*                                                                               
         TITLE   'PRWRIHLP DSECTS - VALTABD'                                    
*                                                                               
       ++INCLUDE PRVALTABD                                                      
*                                                                               
         EJECT                                                                  
...
* CTGENDIC                                                                      
       ...
       ++INCLUDE CTGENDIC                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'061PRWRIHLP  05/01/02'                                      
         END                                                                    
