*          DATA SET PPPUB00S   AT LEVEL 195 AS OF 05/01/02                      
*PHASE T40600A,+0                                                               
*INCLUDE NUMED                                                                  
*INCLUDE PUBVAL                                                                 
*INCLUDE SRCHCALL                                                               
...
CKPREM1  MVI   BSCR,X'06'                                                       
         B     PRTSCRN       VALIDATE                                           
*                                                                               
CKPDATE  LA    R3,DATERR           FORMAT= PR,1C,MMDD/YR                        
         CLI   5(R2),7                                                          
         BL    ERROR                                                            
         GOTO1 VDATVAL,DMCB,(0,14(R2)),WORK                                     
         OC    DMCB(4),DMCB                                                     
         BZ    ERROR                                                            
         GOTO1 VDATCON,DMCB,(0,WORK),(3,BDATE)                                  
         B     CKPREM1                                                          
*                                                                               
*                                                                               
*                                  DRD SCREEN                                   
...
*                                                                               
CKPUB    MVC   BMED,SAVEMED        RESTORE MEDIA                                
         MVC   OLNUM(1),3(R5)                                                   
         LA    R2,PBLPUBH                                                       
         LA    R2,PBLPUBH                                                       
         LA    R3,PUBERR                                                        
         ...
         B     PLIST                                                            
*                                                                               
CKPUB0   GOTO1 =V(PUBVAL),DMCB,(5(R2),PBLPUB),(0,KPUB),RR=RELO                  
...
*                                                                               
         EJECT                                                                  
VALCLT   MVC   BCLT,=3X'FF'                                                     
         CLC   0(3,R6),=C'ALL'                                                  
         BE    VALCLTX                                                          
         CLI   0(R6),C'*'           OFFICE                                      
         BNE   VALCLT2                                                          
         CLI   2(R6),0                                                          
         BNE   ERROR          MUST BNE *N                                       
         OC    T406FFD+6(2),T406FFD+6  CHK FOR LIMIT ACCESS                     
         BZ    VALCLT1                                                          
         CLI   T406FFD+6,C'*'      CHK FOR OFFICE LIMIT                         
         BE    CKOFFCO                                                          
         CLI   T406FFD+6,C'$'      CK FOR OFFICE LIST             L02           
         BNE   CKACCE                                             L02           
         MVC   PCLTOFF,1(R6)                                      L02           
         BAS   R5,CKACC                                           L02           
         B     VALCLT1                                            L02           
*                                                                               
CKOFFCO  CLC   T406FFD+7(1),1(R6)  THEN OFFICE CODES MUST MATCH                 
         BNE   CKACCE                                                           
VALCLT1  MVI   BCLT,X'FF'                                                       
         MVC   BCLT+1(1),1(R6)                                                  
         MVI   BCLT+2,C' '                                                      
         XC    BDIV,BDIV           MUST CLEAR BDIV FOR OFFICES                  
         B     VALCLTX                                                          
*                                                                               
VALCLT2  CLC   BCODE,=C'PAY'                                                    
...
CKACC    DS    0H                                                               
         ...
         LA    RF,SECURITY                                                      
         LA    R3,VDATAMGR                                                      
         GOTO1 (RF),DMCB,T406FFD,PCLTREC,(R3)                                   
         PRINT NOGEN                                                            
         BE    CLT4                                                             
...
DOREQ    DS    0H                                                               
         ...
         MVC   QAGY,AGYALPHA                                                    
         MVC   QMED,PBLMED                                                      
         GOTO1 =V(PUBVAL),DMCB,(PBLPUBH+5,PBLPUB),(X'01',QPUB),RR=RELO          
         MVC   QREQST(12),=C'ACCOUNTING  '                                      
         IF    QMED,NE,C'O',OR,AGYALPHA,NE,=C'ZZ',DOREQ2                        
...
*** PPPUBWRK                                                                    
       ...
       ++INCLUDE DDCOMFACS                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'195PPPUB00S  05/01/02'                                      
         END                                                                    
