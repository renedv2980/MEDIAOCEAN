*          DATA SET JHIGBK5    AT LEVEL 168 AS OF 10/12/00                      
*PHASE JHIGBK5                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE XSORT                                                                  
*INCLUDE SORTER                                                                 
...
SORTCARD DC    CL80'SORT FIELDS=(58,1,A,1,51,A),FORMAT=BI,WORK=1'               
         LTORG                                                                  
INTAB    DS    CL(BOOKDLQ)                                                      
******************************************************                          
...
*                                                                               
       ...
       ++INCLUDE DDDPRINT                                                       
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'168JHIGBK5   10/12/00'                                      
         END                                                                    
