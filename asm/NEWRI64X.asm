*          DATA SET NEWRI64X   AT LEVEL 021 AS OF 05/01/02                      
*PHASE T32064B,+0                                                               
*INCLUDE RECUP                                                                  
...
ED12     DS    0H                   *PKG GUARANTEE                              
         MVI   DOPAKG,0                                                         
         LA    R2,SPLPDMH           DEMO CATEGORY FOR PKG GUARANTEE             
         CLI   5(R2),0                                                          
         BE    ED13                                                             
         BAS   RE,DEMVALID                                                      
*        BAS   RE,TRAPIT                                                        
...
* - SET UP NETIO PARAMETERS                                                     
         ...
         LA    R1,UNTHOOK                         UNIT HOOK                     
         ST    R1,NBHOOK                                                        
RP10     NETGO NSNETIO,DMCB,NETBLOCK                                            
         CLI   NBMODE,NBREQLST                                                  
         BNE   RP10                                                             
         BAS   RE,RP30             CALCULATES CPM                               
         BAS   RE,WRTREP           WRITES REPORT                                
         CLI   SPLTST,C'N'         DID WE WRITE TO FILE                         
         BNE   XIT                 NO                                           
...
*                                                                               
         ...
         BNE   UNT12                                                            
         L     R1,NBACTUAL                    GET DOLLARS AND CENTS             
         CVD   R1,DUB                                                           
         AP    PKGCOST,DUB                                                      
...
UNT12    OC    PDEMVAL,PDEMVAL     DO WE HAVE SPECIFIC PKG DEMO                 
         BZ    UNT20               NO                                           
         LA    R1,NDDEMOS          YES/FIND MATCHING DEMO IN LIST               
         LA    RE,NDESTDEM                                                      
         ZIC   R0,NDNDEMOS                                                      
...
UNT17    ICM   R1,15,4(RE)         GET DEMO IMPS                                
         ...
         AP    PKGIMP,DUB                                                       
         B     UNT20B                                                           
UNT20    ICM   R1,15,NDESTDEM+4       GET DEMO IMPS FOR PACK GUARANTEE          
         MVC   SRTIMP1,NDESTDEM+4                                               
         CVD   R1,DUB                                                           
         AP    PKGIMP,DUB                                                       
...
CALCUL   NTR1                                                                   
         ...
         MP    PACKWRK,=P'1000000'     AGY CPM/TARG CPM=FACTOR(4DEC)            
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021NEWRI64X  05/01/02'                                      
         END                                                                    
