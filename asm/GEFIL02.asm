*          DATA SET GEFIL02    AT LEVEL 009 AS OF 10/27/20                      
*PHASE T00AB2C                                                                  
GEFIL02  TITLE 'NEW FILE - OBJECTS II'                                          
*---------------------------------------------------------------------*         
* USR  LVL DATE    TICKET     DESCRIPTION                             *         
* ---  --- ----    ------     -----------                             *         
* RKEJ 009 08JUL20 SPEC-46393 FIX ISSUE FOR PF13 KEY ON ALL SCREENS   *         
*---------------------------------------------------------------------*         
         PRINT NOGEN                                                            
GEFIL02  CSECT                                                                  
...
SCROLL04 CLI   GSFRP.FRPTYPE,FRPTMBAC                                           
         ...
         J     EXITOK                                                           
*                                                                               
SCROLL06 CLI   GSFRP.FRPTYPE,FRPTMLAS                                           
         JNE   EXITH                                                            
         GOTOX AGEN,RTPARM,OSCRN,SLAST                                          
         J     EXITOK                                                           
*                                                                               
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                     *         
* NTRY: P3 BYTE 0 = 0 - X'80' IGNORE SECURITY                         *         
*             1-3 = A(RECORD)                                         *         
*    OR P3 BYTE 0 = RECORD TYPE                                       *         
*             1-3 = 0 - X'80' IGNORE SECURITY                         *         
* EXIT: P3        = A(RECORD)                                         *         
***********************************************************************         
         SPACE 1                                                                
RTYTST   MVI   RTBITS,C'N'                                                      
         TM    RTPARMS3,X'80'                                                   
         BZ    *+8                                                              
         MVI   RTBITS,C'Y'                                                      
         NI    RTPARMS3,X'7F'                                                   
...
*                                                                               
         ...
         USING FRRRECD,R2                                                       
*                                                                               
RTYT02   ST    R2,RTPARMS3         SAVE A(RECORD) FOR CALLER                    
         LA    R3,FRRFIRST(R2)                                                  
         USING FRRELD,R3                                                        
         XR    RF,RF                                                            
*                                                                               
RTYT04   CLI   FRREL,0             GET RECORD ELEMENT                           
         BNE   *+6                                                              
         DC    H'0'                NO FRREL                                     
         CLI   FRREL,FRRELQ                                                     
         BE    RTYT06                                                           
         ...
         BXH   R3,RF,RTYT04                                                     
*                                                                               
RTYT06   CLI   RTBITS,C'Y'                                                      
         JE    EXITOK                                                           
*                                  TEST SECURITY SETTINGS                       
         TM    FRRINDS1,FRR1DDS    TEST DDS ONLY RECORD TYPE                    
         BZ    RTYT08              NO                                           
         TM    CUSTAT,CUSDDS       YES - TEST DDS TERMINAL                      
         JZ    EXITL                                                            
         J     EXITOK                                                           
*                                  TEST SECURITY SETTINGS                       
RTYT08   XC    RTHALF1,RTHALF1                                                  
         OC    RTHALF1(1),FRRSEC   OVERRIDE VALUE SET ON RECORD?                
         BNZ   *+10                YES                                          
         MVC   RTHALF1(1),FRRKREC                                               
         GOTOX ('TSTACS',AGROUTS),RTHALF1                                       
         JNE   EXITL               FAILED SECURITY                              
         J     EXITOK                                                           
         DROP  R2,R3                                                            
         EJECT                                                                  
***********************************************************************         
...
RTYS02   LA    R3,FRRFIRST(R2)     A(FIRST ELEMENT)                             
         ...
         XR    RF,RF                                                            
*                                                                               
RTYS04   CLI   FRREL,0             GET FRREL FROM RECORD                        
         BNE   *+6                                                              
         DC    H'0'                                                             
         CLI   FRREL,FRRELQ                                                     
         BE    RTYS06                                                           
         ...
         BXH   R3,RF,RTYS04                                                     
*                                                                               
RTYS06   IC    RF,FRRLN            SAVE CURRENT FRREL                           
         BCTR  RF,0                                                             
         MVC   GSFRREL(0),FRRELD                                                
         EX    RF,*-6                                                           
*                                                                               
         CLC   CSREC,FRRKREC       CHANGE OF RECORD?                            
         BE    RTYS08              NO                                           
*                                                                               
...
*                                                                               
         ...
         MVCL  RE,R0                                                            
*                                                                               
RTYS08   XC    CSRECNAM,CSRECNAM   TRANSLATE RECORD NAME                        
         MVC   CSREC,FRRKREC                                                    
         MVC   GSREC,FRRKREC                                                    
         MVI   CSRECNAM,DD#ESCL                                                 
         MVC   CSRECNAM+1(L'FRRDICT),FRRDICT                                    
         MVI   CSRECNAM+3,RECNAMLQ                                              
         ICM   R0,15,=C'SL  '                                                   
         ICM   R0,2,FRRKSYS                                                     
         GOTOX VDICTAT,RTPARM,(R0),CSRECNAM                                     
*                                                                               
...
DIR      USING NFITABD,RE                                                       
         ...
         BO    RTYS12              YES                                          
         TM    DIR.NFIINDS,NFIIVL  NO D/A - MUST BE V/L I/S                     
         BO    *+6                 IT IS                                        
         DC    H'0'                                                             
...
* P3 BYTE 2 = N/D                                                     *         
* P3 BYTE 3 = FF IF SELECT RECORDS TO BE ALLOWED                      *         
...
X        USING FRRRECD,IOKEY                                                    
         ...
         MVC   X.FRRKSYS,RTPARMS3                                               
         MVC   X.FRRKPRG,RTPARMS3+1                                             
*                                                                               
         L     R1,=AL4(XOGENDIR+XOHIGH+XIO1)                                    
         B     *+8                                                              
RTXV02   L     R1,=AL4(XOGENDIR+XOSEQ+XIO1)                                     
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    *+14                                                             
...
*                                                                               
         ...
         BE    RTXV04              SAME SYS/PRG                                 
         MVC   FVMSGNO,=AL2(GE$INREC)                                           
         MVC   FVXTRA,FVIFLD                                                    
         GOTOX ('SWCHFC',AGROUTS),=AL1(0)                                       
         J     EXITL                                                            
*                                                                               
RTXV04   NI    X.FRRKSTAT,FRRKLVAL TURN OFF ALL BUT MINIMUM INPUT LEN.          
         XR    RF,RF                                                            
         ICM   RF,1,X.FRRKSTAT                                                  
         BNZ   *+8                                                              
         LHI   RF,1                MINIMUM LENGTH DEFAULT IS 1                  
         CLM   RF,1,FVILEN                                                      
         BH    RTXV02              NOT ENOUGH CHARS INPUT FOR THIS ONE          
*                                                                               
         CLI   RTPARMS3+3,FF       SELECT TYPE WANTED?                          
         BNZ   *+12                YES                                          
         TM    X.FRRKIND1,FRR1SEL  SELECT TYPE TO BE IGNORED HERE               
         BO    RTXV02                                                           
*                                                                               
         XC    GCDUB1,GCDUB1                                                    
...
*                                                                               
         ...
         IC    RF,FVXLEN                                                        
         EX    RF,*+8                                                           
         BE    RTXV06              MATCH UPPERCASE NAME                         
         CLC   FVIFLD(0),GCDUB1                                                 
         EX    RF,*+8                                                           
         BE    RTXV06              MATCH LOWERCASE NAME                         
         CLC   FVIFLD(0),GCDUB2                                                 
         B     RTXV02                                                           
*                                                                               
RTXV06   L     R1,=AL4(XOGET+XOGENFIL+XIO1)                                     
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    *+6                                                              
         DC    H'0'                BAD RECORD ON GENDIR                         
*                                                                               
         GOTOX AGEN,RTPARM,ORTYPE,RTTST,(X'80',AIO1)                            
         BNE   RTXV02                                                           
...
RTYMCH   GOTOX ('SWCHFC',AGROUTS),=AL1(QSCON)                                   
         XC    PLRECB,PLRECB       RESET RECORD NUMBER BYTE                     
*                                                                               
X        USING FRRRECD,RTKEY                                                    
         XC    X.FRRKEY,X.FRRKEY   BUILD INITIAL KEY                            
         MVI   X.FRRKMIN,FRRKMINQ                                               
         MVI   X.FRRKTYP,FRRKTYPQ                                               
...
*                                                                               
X        USING FRRRECD,IOKEY                                                    
RTYM02   MVC   X.FRRKEY,RTKEY      GET SAVED KEY                                
         XR    RF,RF               SET NEXT RECORD NUMBER                       
         IC    RF,PLRECB                                                        
         LA    RF,1(RF)                                                         
         STC   RF,X.FRRKREC                                                     
*                                  READ FOR NEXT RECORD NUMBER ON FILE          
         L     R1,=AL4(XOGENDIR+XOHIGH+XIO1)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
         CLC   IOKEY(FRRKREC-FRRRECD),IOKEYSAV                                  
         BNE   RTYMNO              NO MORE FOR SYS/PRG                          
*                                                                               
         MVC   PLRECB,X.FRRKREC    SAVE NEXT RECORD NUMBER                      
         XR    R1,R1                                                            
         ICM   R1,8,X.FRRKSYS                                                   
         ICM   R1,4,X.FRRKPRG                                                   
         ICM   R1,2,X.FRRKREC                                                   
         GOTOX ('GETFRECD',AGROUTS),(R1)                                        
         BNE   RTYM02              NOTHING MATCHED FOR CONNECTED USER           
*                                                                               
         CLI   NSREC,O#ACT         CAME FROM ACTION HELP?                       
         BE    *+12                                                             
         CLI   NSREC,O#RTYP        CAME FROM RECORD HELP?                       
         BNE   RTYM04                                                           
         TM    NSSAV+(SXINDS1-SSAVD),SXISEL                                     
         BNZ   RTYM08              INCLUDE SELECT ONLY RECORDS                  
         B     RTYM06                                                           
*                                                                               
RTYM04   OC    RTPARMS3,RTPARMS3   INCLUDE SELECT ONLY RECORDS?                 
         BNZ   RTYM08              YES                                          
*                                                                               
RTYM06   TM    X.FRRKIND1,FRR1SEL  SELECT TYPE RECORD?                          
         BO    RTYM02              YES - IGNORE IT                              
*                                                                               
RTYM08   NI    X.FRRKSTAT,FRRKLVAL TURN OFF ALL BUT MINIMUM INPUT LEN.          
         XR    RF,RF                                                            
         ICM   RF,1,X.FRRKSTAT                                                  
         BNZ   *+8                                                              
         LHI   RF,1                MINIMUM LENGTH DEFAULT IS 1                  
...
*                                                                               
         ...
         GOTOX (RF),(R1),(R0),GCDUB2      TRANSLATE DICTIONARY LOWRCASE         
*                                                                               
         XR    RF,RF               MATCH LENGTH IS MAXIMUM OF 3                 
         IC    RF,FVILEN           (TO KEEP MEL HAPPY)                          
         CHI   RF,3                                                             
         BNH   *+8                                                              
         LA    RF,3                                                             
         CLM   RF,1,X.FRRKSTAT     UNLESS MUST ENTER MORE THAN 3 IS             
         BH    *+8                 SET ON RECORD RECORD ITSELF                  
         ICM   RF,1,X.FRRKSTAT                                                  
         BCTR  RF,0                                                             
         EX    RF,*+8                                                           
         BE    RTYM10              UPPERCASE MATCHED                            
         CLC   FVIFLD(0),GCDUB1                                                 
         EX    RF,*+8                                                           
         BE    RTYM10              LOWERCASE MATCHED                            
         CLC   FVIFLD(0),GCDUB2                                                 
         B     RTYM02              NO MATCH ON INPUT STRING                     
*                                                                               
RTYM10   L     R1,=AL4(XOGET+XOGENFIL+XIO1)                                     
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    *+6                                                              
         DC    H'0'                BAD RECORD ON GENDIR                         
*                                                                               
...
*                                                                               
         XC    PLRECB,PLRECB                                                    
         GOTOX ('SWCHFC',AGROUTS),=AL1(0)                                       
         J     EXITOK              MATCHED RECORD NAME OK                       
*                                                                               
RTYMNO   GOTOX ('SWCHFC',AGROUTS),=AL1(0)                                       
*                                                                               
         XC    RTHALF1,RTHALF1     MAKE SURE RTYPE HELP IS VALID                
         MVC   RTHALF1,=AL1(O#RTYP,A#LST)                                       
         GOTOX ('TSTACS',AGROUTS),RTHALF1                                       
         BE    *+14                                                             
         MVC   FVMSGNO,=AL2(GE$NOSEL)                                           
         J     EXITL               NO HELP AVAILABLE                            
*                                                                               
N        USING SSAVD,NSSAV                                                      
         MVI   N.SREC,O#RTYP       RECORD HELP IS IN GEFILREC                   
         MVI   N.SACT,A#LST                                                     
         OI    N.SNINDS1,SNISEL    MAKE SO WE SELECT FROM LIST                  
         XC    PLRECB,PLRECB                                                    
         GOTOX AGEN,RTPARM,OSES,SNTR                                            
         DC    H'0'                                                             
         DROP  N                                                                
...
RTRD02   CLI   FRREL,0                                                          
         ...
         BXH   R3,RF,RTRD02                                                     
*                                                                               
RTRD04   MVC   FVIFLD,BCSPACES     OUTPUT NAME INTO FVIFLD                      
         MVI   FVIFLD,DD#ESCL                                                   
         MVC   FVIFLD+1(L'FRRDICT),FRRDICT                                      
         MVI   FVIFLD+3,8                                                       
         ICM   R0,15,=C'SL  '                                                   
         ICM   R0,2,FRRKSYS                                                     
         GOTOX VDICTAT,RTPARM,(R0),FVIFLD                                       
         J     EXITOK                                                           
*                                                                               
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                               
         ICM   RF,15,BCAUTL                                                     
         TM    TSTAT6-UTLD(RF),TST6STRO+TST6STFU                                
         BZ    *+14                                                             
         MVC   FVMSGNO,=AL2(GE$NOSEL)                                           
         J     EXITL               STEREO                                       
*                                                                               
         ...
         GOTOX ('TSTACS',AGROUTS),RTHALF1                                       
         BE    *+14                ALLOWED TO ASK FOR HELP                      
         MVC   FVMSGNO,=AL2(GE$NOSEL)                                           
         J     EXITL                                                            
*                                                                               
N        USING SSAVD,NSSAV                                                      
         MVI   N.SREC,O#ACT    *** NTRSES INTO ACTION_HELP/LIST                 
         MVI   N.SACT,A#LST                                                     
         OI    N.SNINDS1,SNISEL    SET ACTION FIELD AS SELECT FOCUS             
         TM    BCINDS1,BCINREC     NEW RECORD?                                  
         BZ    *+14                NO                                           
         OI    N.SNINDS1,SNINEWR   YES - PRESERVE 'NEW' FLAG                    
         XC    CSACT,CSACT                                                      
         GOTOX AGEN,RTPARM,OSES,SNTR                                            
*                                                                               
ACTV04   GOTOX AGEN,RTPARM,OACT,AMCH,0                                          
         JNE   EXITL               NO MATCH ON NAME                             
*                                                                               
         GOTOX AGEN,RTPARM,OACT,ASET,AIO1                                       
         JL    EXITL                                                            
*                                                                               
         TM    BCINDS1,BCINACT     NEW ACTION - RESET LEVEL                     
         BZ    ACTV06                                                           
         CLI   N.SREC,O#ACT        UNLESS FROM ACTION_HELP                      
         BE    ACTV06                                                           
...
ACTV06   GOTOX AGEN,RTPARM,OACT,ADIS,AIO1                                       
         ...
         EJECT                                                                  
***********************************************************************         
* DISPLAY ACTION NAME INTO ACTION FIELD                               *         
***********************************************************************         
         SPACE 1                                                                
ACTDISC  XR    R3,R3                                                            
         ICM   R3,3,GSDSPACT       DISPLACEMENT CLEARED IF SELECT FOCUS         
...
*                                                                               
         XR    RF,RF                                                            
         IC    RF,FHLN             PICK UP FIELD LENGTH                         
         AHI   RF,-(FHDAD)                                                      
         TM    FHAT,FHATXH                                                      
         BZ    *+8                                                              
         AHI   RF,-(FHDAD)                                                      
         CHI   RF,L'CSACTNAM       FIELD IS LONGER THAN ACTION NAME?            
         BL    *+8                 NO                                           
         LHI   RF,L'CSACTNAM                                                    
         BCTR  RF,0                                                             
         MVC   FHDA(0),CSACTNAM    MOVE IN SAVED ACTION NAME                    
         EX    RF,*-6                                                           
         OI    FHOI,FHOITR                                                      
         OI    FHII,FHIIVA                                                      
         J     EXITOK                                                           
         ...
         EJECT                                                                  
***********************************************************************         
* TEST VALIDITY OF ACTION CODE                                        *         
*                                                                     *         
* NTRY: P3 BYTE 0 = 0 - X'80' IGNORE SECURITY                         *         
*             1-3 = A(RECORD)                                         *         
*    OR P3 BYTE 0 = ACTION NUMBER - X'80' IGNORE SECURITY             *         
*               3 = RECORD NUMBER (IF 0 USE CSREC)                    *         
* EXIT: P3        = A(RECORD)                                         *         
*       P4        = A(FRAELD)                                         *         
***********************************************************************         
         SPACE 1                                                                
ACTTEST  MVI   RTBITS,C'N'                                                      
         TM    RTPARMS3,X'80'                                                   
         BZ    *+8                                                              
         MVI   RTBITS,C'Y'                                                      
         NI    RTPARMS3,X'7F'                                                   
...
*                                                                               
         ...
         GOTOX ('SWCHFC',AGROUTS),=AL1(0)                                       
*                                                                               
         L     R2,AIO1             RECORD IS IN AIO1                            
         USING FRARECD,R2                                                       
ACTT02   LA    R3,FRAFIRST(R2)                                                  
         USING FRAELD,R3                                                        
         XR    RF,RF                                                            
*                                                                               
ACTT04   CLI   FRAEL,0             TRY TO FIND ACTION ELEMENT                   
         BNE   *+6                                                              
         DC    H'0'                                                             
         CLI   FRAEL,FRAELQ                                                     
         BE    *+12                                                             
         ...
         BXH   R3,RF,ACTT04                                                     
*                                                                               
         TM    FRAINDS1,FRA1DDS    DDS ONLY ACTION?                             
         BZ    ACTT06              NO                                           
         TM    CUSTAT,CUSDDS       DDS TERMINAL?                                
         JZ    EXITL               NO                                           
*&&US*&& J     ACTTOK                                                           
*                                                                               
ACTT06   CLI   RTBITS,C'Y'                                                      
         JE    EXITOK                                                           
*                                  TEST SECURITY SETTINGS                       
         XC    RTHALF1,RTHALF1     TEST RECORD SECURITY                         
         OC    RTHALF1+0(1),FRARSEC                                             
         BNZ   *+10                                                             
         MVC   RTHALF1+0(1),FRAKREC                                             
         OC    RTHALF1+1(1),FRAASEC                                             
         BNZ   *+10                                                             
         MVC   RTHALF1+1(1),FRAKACT                                             
         GOTOX ('TSTACS',AGROUTS),RTHALF1                                       
         JNE   EXITL               FAILED RECORD SECURITY TEST                  
*                                                                               
ACTTOK   STM   R2,R3,RTPARMS3      RETURN PARAMETERS                            
         J     EXITOK                                                           
         DROP  R2,R3                                                            
         EJECT                                                                  
***********************************************************************         
* SET CURRENT ACTION CODE VALUES                                      *         
*                                                                     *         
* NTRY: P3 BYTE 0 = 0                                                 *         
*             1-3 = A(ACTION RECORD)                                  *         
...
*                                                                               
         ...
         BE    ACTS10              ACTION UNCHANGED                             
*                                                                               
ACTS08   OI    BCINDS1,BCINACT     SET NEW ACTION                               
         XC    LSPFKLST,LSPFKLST   RESET PFK POINTERS                           
         XC    LSPFKNOW,LSPFKNOW                                                
*                                                                               
         CLC   RTBYTE1,GSFRAEL+(FRATYPE-FRAELD)                                 
         BE    ACTS10              NO CHANGE OF ACTION TYPE                     
*                                                                               
         XC    GSSCREEN,GSSCREEN   NEED TO REBUILD SCREEN                       
         XC    GCLASKEY,GCLASKEY   RESET LAST MATCHED KEY                       
         XC    LSLASKEY,LSLASKEY   RESET LAST MATCHED KEY                       
         TM    GCINDS2,GCIDONTR    DOING AN NTRSES?                             
         BO    *+10                                                             
         XC    GSRECKEY,GSRECKEY   RESET LAST MATCHED KEY                       
...
*                                                                               
ACTS10   MVC   CSACT,FRAKACT                                                    
         XC    CSACTNAM,CSACTNAM   SET ACTION NAME                              
         MVI   CSACTNAM,DD#ESCL                                                 
         MVC   CSACTNAM+1(L'FRADICT),GSFRA.FRADICT                              
         MVI   CSACTNAM+3,8                                                     
         ICM   R0,15,=C'SL  '                                                   
         ICM   R0,2,GCOVSYS                                                     
         GOTOX VDICTAT,RTPARM,(R0),CSACTNAM                                     
*                                                                               
...
*                                                                               
         ...
         SPACE 2                                                                
***********************************************************************         
* MATCH ON ACTION CODE NAME                                           *         
*                                                                     *         
* NTRY  DATA TO MATCH ON IS VALIDATED IN FVIFLD                       *         
* XIT   AIO1 HOLDS RECORD IF VALID NAME INPUT                         *         
***********************************************************************         
         SPACE 1                                                                
ACTMCH   XC    PLACTB,PLACTB                                                    
X        USING FRARECD,RTKEY       SET UP DEFAULT KEY                           
         XC    X.FRAKEY,X.FRAKEY                                                
         MVI   X.FRAKMIN,FRAKMINQ                                               
         MVI   X.FRAKTYP,FRAKTYPQ                                               
         MVC   X.FRAKSYS,GCOVSYS                                                
         MVC   X.FRAKPRG,GCPRGNO                                                
         MVC   X.FRAKREC,CSREC                                                  
         DROP  X                                                                
*                                                                               
X        USING FRARECD,IOKEY                                                    
ACTM02   GOTOX ('SWCHFC',AGROUTS),=AL1(QSCON)                                   
         MVC   X.FRAKEY,RTKEY                                                   
...
*                                                                               
         ...
         BNE   ACTMNO              NO MORE RECORDS FOR THIS PROGRAM             
*                                                                               
...
ACTM14   XR    RF,RF                                                            
         ...
         LHI   RF,1                MINIMUM LENGTH DEFAULT IS 1                  
         CLM   RF,1,FVILEN                                                      
         BH    ACTM02              NOT ENOUGH CHARS INPUT FOR THIS ONE          
*                                                                               
         XC    GCDUB1,GCDUB1                                                    
         MVI   GCDUB1,DD#ESCL      LEFT ALIGNED, LENGTH 8 FOR NAME              
         ...
         ICM   R0,15,=C'SU  '                                                   
         ICM   R0,2,GCOVSYS                                                     
         GOTOX VDICTAT,RTPARM,(R0),GCDUB1 TRANSLATE UPPERCASE NAME              
         ICM   R0,4,=C'L'                                                       
         GOTOX (RF),(R1),(R0),GCDUB2      TRANSLATE LOWERCASE NAME              
*                                                                               
         XR    RF,RF               TRY TO MATCH NAME                            
         IC    RF,FVILEN                                                        
         CLM   RF,1,=AL1(ALEN#Q)   LEN IS > THAN REQUIREMENT?                   
         BNH   *+8                 NO                                           
         LHI   RF,ALEN#Q           SET DEFAULT INPUT REQUIREMENT                
         BCTR  RF,0                                                             
         EX    RF,*+8                                                           
         BE    ACTM16              MATCH UPPERCASE NAME                         
         CLC   FVIFLD(0),GCDUB1                                                 
         EX    RF,*+8                                                           
         BE    ACTM16              MATCH LOWERCASE NAME                         
         CLC   FVIFLD(0),GCDUB2                                                 
         B     ACTM02                                                           
*                                                                               
ACTM16   GOTOX AGEN,RTPARM,OACT,ATST,AIO1                                       
         BNE   ACTM02              FAILED SECURITY TEST                         
         XC    PLACTB,PLACTB                                                    
         J     EXITOK                                                           
*                                                                               
ACTMNO   GOTOX ('SWCHFC',AGROUTS),=AL1(0)                                       
         MVC   RTHALF1,=AL1(O#ACT,A#LST)                                        
         GOTOX ('TSTACS',AGROUTS),RTHALF1                                       
         BE    *+14                HELP REQUEST VALID                           
         MVC   FVMSGNO,=AL2(GE$NOSEL)                                           
         J     EXITL                                                            
*                                                                               
         ICM   RF,15,BCAUTL                                                     
...
X        USING FRARECD,IOKEY                                                    
         ...
         MVI   X.FRAKMIN,FRAKMINQ                                               
         MVI   X.FRAKTYP,FRAKTYPQ                                               
         MVC   X.FRAKSYS,RTPARMS3+0                                             
         MVC   X.FRAKPRG,RTPARMS3+1                                             
         MVC   X.FRAKREC,RTPARMS3+2                                             
         L     R1,=AL4(XOGENDIR+XOHIGH+XIO1)                                    
         J     *+8                                                              
*                                                                               
...
ACXV06   L     R1,=AL4(XOGET+XOGENFIL+XIO1)                                     
         ...
         DC    H'0'                BAD RECORD ON GENDIR                         
*                                                                               
         GOTOX AGEN,RTPARM,OACT,ATST,(X'80',AIO1)                               
         BNE   ACXV02              FAILED SECURITY TEST                         
*                                                                               
         GOTOX AGEN,RTPARM,OACT,ATRDIS,AIO1                                     
...
*                                                                               
         DC    AL1(ACTPFM,0,0,ACTTST),AL4(PFMTST)                               
         DC    AL1(ACTPFM,0,0,ACT1ST),AL4(PFM1ST)                               
         DC    AL1(ACTPFM,0,0,ACTNTR),AL4(PFMNTR)                               
         DC    AL1(ACTPFM,0,0,0),AL4(PFM)                                       
         DC    AL1(ACTPFM,0,0,ACTXIT),AL4(PFMXIT)                               
*                                                                               
ACHTABX  DC    AL1(EOT)                                                         
         SPACE 2                                                                
         LTORG                                                                  
...
*                                                                               
         ...
         JL    EXITL               DISPLAY                                      
*                                                                               
         TM    GCINDS3,GCIDSMSG    EXIT NOW IF OVERLAY SET OWN DISPLAY          
         JO    DNTR06              MESSAGE                                      
         MVI   FVOMTYP,GTMINF                                                   
...
*                                                                               
DNTR06   OI    GCINDS2,GCIACTCP    SET ACTION COMPLETED                         
         J     EXITACT                                                          
         SPACE 2                                                                
         LTORG                                                                  
         SPACE 2                                                                
...
*                                                                               
         ...
         JL    EXITL                                                            
*                                                                               
DISX     TM    GCINDS3,GCIDSMSG    SKIP MSG IF OVERLAY SET OWN DISPLAY          
         JO    DISX2               MESSAGE                                      
         MVI   FVOMTYP,GTMINF                                                   
         MVC   FVMSGNO,=AL2(GI$RCDIS)                                           
         TM    GSRECSTA,X'80'      TEST RECORD DELETED                          
...
*                                                                               
         ...
         JL    EXITL                                                            
*                                                                               
         TM    GCINDS3,GCIDSMSG    OVERLAY SET OWN DISPLAY MESSAGE?             
         JO    EXITREC                                                          
         MVI   FVOMTYP,GTMINF      EXIT WITH 'ENTER CHANGES' MESSAGE            
         MVC   FVMSGNO,=AL2(GI$RDECH)                                           
*??      OI    GCINDS2,GCIACTCP                                                 
...
*        OI    GCINDS2,GCIACTCP    ??                                           
         J     EXITREC                                                          
*                                                                               
MNTX4    TM    GCINDS3,GCIDSMSG    EXIT NOW IF OVERLAY SET OWN DISPLAY          
         JO    EXITACT             MESSAGE                                      
         MVI   FVOMTYP,GTMINF      EXIT WITH 'RECORD CHANGED' MESSAGE           
         MVC   FVMSGNO,=AL2(GI$RCCHA)                                           
         J     EXITACT                                                          
         SPACE 2                                                                
         LTORG                                                                  
...
PFMTST   LR    R7,RF                                                            
         ...
         SPACE 2                                                                
***********************************************************************         
* PFM TO RECORD - FIRST TIME AFTER NTRSES                             *         
***********************************************************************         
         SPACE 1                                                                
         DS    0H                                                               
         USING *,R7                                                             
...
*                                                                               
         TM    PSSAV+SNINDS1-SSAVD,SNIPARMS                                     
         JO    PNTR02              NOT PASSING PARAMETERS                       
*                                                                               
         GOTOX AGEN,RTPARM,OKEY,KDIS,GSRECKEY                                   
         JL    EXITL                                                            
*                                                                               
PNTR02   GOTOX AGEN,RTPARM,OKEY,KVAL,GSRECKEY                                   
         JL    EXITL                                                            
*                                                                               
         L     RF,ACOM                                                          
         MVC   RTFULL,CGLOBBER-COMFACSD(RF)                                     
*                                                                               
         XC    BCWORK,BCWORK                                                    
         LA    R1,BCWORK                                                        
         USING GLPFMFIL,R1                                                      
         MVC   GLPFMFIL(L'GCFILNAM),GCFILNAM                                    
         MVC   GLPFMDA,GSRECDA                                                  
         CLC   GSRECDA,BCEFFS                                                   
         BNE   *+16                                                             
         XC    GLPFMDA,GLPFMDA                                                  
         MVC   GLPFMKEY,GSRECKEY                                                
*                                                                               
         L     RF,RTFULL                                                        
         GOTO1 (RF),RTPARM,=C'PUTD',BCWORK,54,GLPFMCDQ                          
*                                                                               
         L     R1,ASYSFAC                                                       
         L     R1,VSSB-SYSFACD(R1)                                              
         L     RF,SSBTKADR-SSBD(R1)                                             
         USING TCBD,RF                                                          
         XC    BCWORK,BCWORK                                                    
         LA    R1,BCWORK                                                        
         USING GLVXFRSY,R1                                                      
         MVC   GLVXFRSY,TCBLNSYS                                                
         CLC   =C'CTL',GLVXFRSY                                                 
         BNE   *+10                                                             
         MVC   GLVXFRSY,=C'CON'                                                 
         MVC   GLVXFRPR,TCBLNPRG                                                
         MVC   GLVXTOSY,TCBLNSYS                                                
         CLC   =C'CTL',GLVXTOSY                                                 
         BNE   *+10                                                             
         MVC   GLVXTOSY,=C'CON'                                                 
         MVC   GLVXTOPR,=CL3'PFM'  MOVE PFM                                     
         OI    GLVXFLG1,GLV1SEPS                                                
         DROP  RF,R1                                                            
*                                                                               
         L     RF,RTFULL                                                        
         GOTO1 (RF),RTPARM,=C'PUTD',BCWORK,GLVXLENQ,GLVXCTL                     
         MVI   FVOMTYP,GTMINF                                                   
         MVC   FVMSGNO,=AL2(GI$RCDIS)                                           
...
*                                                                               
         NI    GSINDSL1,FF-GSIXMNT TURN OFF MAINT SCREEN LOADED FLAG            
         TM    GSFRR.FRRINDS1,FRR1USC                                           
         JZ    PFM04               NOT USING SCREEN CODES                       
*                                                                               
         TM    BCINDS1,BCINACT     FIRST TIME?                                  
         JZ    PFM04               NO                                           
         TM    GSINDSL1,GSIXKEY                                                 
         ...
         J     EXITKEY             INVITE USER TO ENTER KEY                     
*                                                                               
PFM04    GOTOX AGEN,RTPARM,OKEY,KVAL,GSRECKEY                                   
         JL    EXITL                                                            
         OC    GSRECDA,GSRECDA     RECORD ON FILE?                              
         JNZ   *+14                YES                                          
         MVC   FVMSGNO,=AL2(FVFERNF)                                            
...
*                                                                               
X        USING FRPRECD,RTKEY                                                    
         GOTOX ('SWCHFC',AGROUTS),=AL1(QSCON)                                   
         XC    X.FRPKEY,X.FRPKEY   SET DEFAULT KEY                              
         MVI   X.FRPKMIN,FRPKMINQ  FOR CONNECTED COUNTRY AND                    
...
X        USING FRPRECD,IOKEY                                                    
         MVC   X.FRPKEY,RTKEY      READ PFKEY FOR NUMBER/CTRY/TEST              
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PKLST12                                                          
*                                                                               
PKLST02  MVC   X.FRPKEY,RTKEY      READ PFKEY FOR NUMBER/CTRY/LIVE              
...
*                                                                               
         ...
         BZ    PKLST04             NO                                           
         MVC   X.FRPKEY,RTKEY      READ PFKEY FOR NUMBER/HOST/TEST              
         MVI   X.FRPKCTRY,FF                                                    
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PKLST12                                                          
*                                                                               
PKLST04  MVC   X.FRPKEY,RTKEY      READ PFKEY FOR NUMBER/HOST/LIVE              
         MVI   X.FRPKCTRY,FF                                                    
         XC    X.FRPKTEST,X.FRPKTEST                                            
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
...
*                                                                               
         GOTOX ('SWCHFC',AGROUTS),=AL1(QSCON)                                   
         XC    X.FRPKEY,X.FRPKEY                                                
         MVC   X.FRPKEY(FRPKPFK-FRPRECD),RTKEY                                  
         MVC   X.FRPKPFK,RTBYTE1                                                
         L     R1,=AL4(XOGENDIR+XOHIGH+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)    READ HIGH FOR NEXT NUMBER                    
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
...
*                                                                               
         ...
         BZ    PKLST08                                                          
*                                                                               
         MVC   X.FRPKEY,RTKEY      READ NEXT PFKEY FOR CTRY/TEST                
         MVC   X.FRPKPFK,RTBYTE1                                                
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PKLST12                                                          
*                                                                               
PKLST08  MVC   X.FRPKEY,RTKEY      READ NEXT PFKEY FOR CTRY/LIVE                
         MVC   X.FRPKPFK,RTBYTE1                                                
         XC    X.FRPKTEST,X.FRPKTEST                                            
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
...
*                                                                               
         ...
         JZ    PKLST10             NO                                           
*                                                                               
         MVC   X.FRPKEY,RTKEY      READ NEXT PFKEY FOR HOST/TEST                
         MVC   X.FRPKPFK,RTBYTE1                                                
         MVI   X.FRPKCTRY,FF                                                    
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PKLST12                                                          
*                                                                               
PKLST10  MVC   X.FRPKEY,RTKEY      READ NEXT PFKEY FOR HOST/LIVE                
         MVC   X.FRPKPFK,RTBYTE1                                                
         MVI   X.FRPKCTRY,FF                                                    
         XC    X.FRPKTEST,X.FRPKTEST                                            
         L     R1,=AL4(XOGENDIR+XOREAD+XIO2)                                    
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PKLST12                                                          
         B     PKLST06             NO MATCH FOR THIS NUMBER - TRY NEXT          
*                                                                               
...
*                                                                               
         XR    R0,R0                                                            
         ICM   R0,3,LSLST#X                                                     
         CLI   CSACT,A#DIS          DISPLAY CAN'T ADD...                        
         BE    PKLST26A                                                         
         TM    LSSTAT2,LSSADD                                                   
         BZ    *+8                                                              
         AHI   R0,1                                                             
*                                                                               
PKLST26A CLM   R0,3,LSPAG#X                                                     
         JH    PKLST36                                                          
         J     PKLSTNO                                                          
*        CLC   LSPAG#X,LSLST#X                                                  
*        BNL   PKLSTNO                                                          
...
X        USING FSRRECD,RTKEY                                                    
         XC    X.FSRKEY,X.FSRKEY                                                
         MVI   X.FSRKMIN,FSRKMINQ                                               
         MVI   X.FSRKTYP,FSRKTYPQ                                               
         MVC   X.FSRKSYS,GCOVSYS                                                
         MVC   X.FSRKPRG,GCPRGNO                                                
         MVC   X.FSRKREC,CSREC                                                  
         MVC   X.FSRKCODE,GSSMCODE                                              
         MVI   X.FSRKPAGE,1                                                     
         MVC   X.FSRKCTRY,CUCTRY                                                
         XI    X.FSRKCTRY,FF                                                    
         MVI   X.FSRKSUB,FF                                                     
         MVC   X.FSRKTEST,ASTEST                                                
         DROP  X                                                                
*                                                                               
         OC    ASTEST,ASTEST                                                    
         JZ    PCNT02                                                           
*                                                                               
         USING FSRRECD,IOKEY                                                    
         MVC   FSRKEY,RTKEY        READ SCREEN FOR CTRY/TEST                    
         L     R1,=AL4(XOREAD+XOGENDIR)                                         
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PCNT06                                                           
*                                                                               
PCNT02   MVC   FSRKEY,RTKEY        READ SCREEN FOR CTRY/LIVE                    
...
*                                                                               
         ...
         BZ    PCNT04                                                           
*                                                                               
         MVC   FSRKEY,RTKEY        READ SCREEN FOR HOST/TEST                    
         MVI   FSRKCTRY,FF                                                      
         L     R1,=AL4(XOREAD+XOGENDIR)                                         
         GOTOX ('XIOC',AGROUTS)                                                 
         BE    PCNT06                                                           
*                                                                               
PCNT04   MVC   FSRKEY,RTKEY        READ SCREEN FOR HOST/LIVE                    
         MVI   FSRKCTRY,FF                                                      
         XC    FSRKTEST,FSRKTEST                                                
         L     R1,=AL4(XOREAD+XOGENDIR)                                         
         GOTOX ('XIOC',AGROUTS)                                                 
...
*                                                                               
         ...
         BE    PCNT14              YES - INCLUDE                                
         OC    FSRKTEST,FSRKTEST   LIVE SCREEN?                                 
         BZ    PCNT14              YES - INCLUDE                                
         B     PCNT08              NO - IGNORE                                  
*                                                                               
PCNT12   OC    FSRKTEST,FSRKTEST   TEST PHASE SCREEN?                           
         BNZ   PCNT08              YES - IGNORE                                 
         B     PCNT14              KEEP ALL LIVE SCREENS                        
*                                                                               
...
BPRECACT DS    XL2                                                              
BPKRECN  DS    XL1                                                              
RTKEY    DS    XL(L'FRRKEY)        SAVED RECORD/ACTION KEY                      
*                                                                               
RTWORKL  EQU   *-RTWORKD                                                        
         EJECT                                                                  
* GEFILWORK                                                                     
...
* FATCB                                                                         
       ...
       ++INCLUDE FATCB                                                          
         PRINT ON                                                               
GEFIL02  CSECT                                                                  
         ORG   GEFIL02+(((*-GEFIL02)/1024)+1)*1024                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009GEFIL02   10/27/20'                                      
         END                                                                    
