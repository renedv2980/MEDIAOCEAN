*          DATA SET RENFI04    AT LEVEL 005 AS OF 08/31/00                      
*          DATA SET RENFI04    AT LEVEL 004 AS OF 07/01/98                      
*&&      SET   NOP=N                                                            
*PHASE T83104A                                                                  
RENFI04  TITLE 'FILE ROUTINE PROGRAM LEVEL OBJECTS'                             
RENFI04  CSECT                                                                  
         PRINT NOGEN                                                            
         SPACE 1                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
         DS    0H                                                               
ROUT     NMOD1 RTWORKL,RENFI4**,R6,R7,RR=R3,CLEAR=YES                           
         USING RTWORKD,RC                                                       
         ST    R1,RTPARMA                                                       
         MVC   RTPARMS,0(R1)                                                    
         ST    R3,RTRELO                                                        
...
* RENFIWORK                                                                     
       ...
       ++INCLUDE RENFIWORK                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005RENFI04   08/31/00'                                      
         END                                                                    
