*          DATA SET REVIEW1D   AT LEVEL 020 AS OF 09/14/05                      
*PHASE T8171DA                                                                  
...
*                                                                               
         ...
         CLC   REKDDSCT(REKDRNK-REKDDSCT),REC.REKDDSCT                          
...
DLIN10   CLI   FRSTLINE,C'1'       FIRST LINE ONLY DISPLAYED?                   
         ...
         CLC   REC.REKDAGY,BCEFFS  ALL/ALL?                                     
         BNE   *+14                NO                                           
         CLC   REC.REKDADV,BCEFFS  DON'T SHOW SECOND 'ALL'                      
         BE    DLIN12                                                           
         GOTOX DOADV,BOPARM,AIO1                                                
         MVC   L1.L1ADV,BOWORK1                                                 
...
*                                                                               
         L     R4,AIO1                                                          
         CLC   REC.REKDAGY,BCEFFS  RANK - NO DISPLAY IF 'ALL'                   
         BNE   *+14                                                             
...
*                                                                               
DLIN18   GOTOX DOAGY,BOPARM,AIO1   ** AGENCY                                    
...
DLINX    CLI   FRSTLINE,C'1'       FIRST LINE OF PAIR DISPLAYED?                
         ...
         BE    EXITOK                                                           
         GOTOX DOADV,BOPARM,AIO1                                                
         MVC   L1.L1ADV,BOWORK1    SET AGENCY                                   
         B     EXITOK                                                           
         DROP  R2,REC                                                           
         EJECT                                                                  
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
FILTTAB  DC    AL2(00001),AL1(REKDGRP-REKDDSCT,L'REKDGRP)                       
         DC    AL2(00002),AL1(REKDSTN-REKDDSCT,L'REKDSTN)                       
         DC    AL2(00003),AL1(REKDOFF-REKDDSCT,L'REKDOFF)                       
         DC    AL2(00005),AL1(REKDRNK-REKDDSCT,L'REKDRNK)                       
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
FF       EQU   X'FF'                                                            
         SPACE 1                                                                
...
ADVAGY   DC    CL(L'L1ADV)'Agency/Advertiser'                                   
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020REVIEW1D  09/14/05'                                      
         END                                                                    
