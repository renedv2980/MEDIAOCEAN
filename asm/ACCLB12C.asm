*          DATA SET ACCLB12C   AT LEVEL 126 AS OF 08/23/00                      
*PHASE T62112C                                                                  
...
PROC16   GOTO1 VHELLO,BOPARM,(C'P',ACCMST),AIO1,INV.PTAELD                      
         CLI   12(R1),0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         DROP  INV                                                              
*                                                                               
PROC18   GOTO1 AIO,IOWRITE+IOACCMST+IO1                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         ZAP   MNET,BCPZERO                                                     
         GOTO1 MATCHNET,1                                                       
...
*                                                                               
         ...
         DROP  MCH                                                              
*                                                                               
         L     R3,AIO2             TEST ANY MORE ACTIVE PTAELS                  
...
PROC26   OI    MINDS,MIDEL         NO - DELETE RECORD                           
         ...
         DROP  R2                                                               
*                                                                               
PROC30   GOTO1 AIO,IOWRITE+IOACCMST+IO2                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         BAS   RE,CLRTOTS                                                       
*                                                                               
...
HDATA2   DS    CL08                                                             
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'126ACCLB12C  08/23/00'                                      
         END                                                                    
