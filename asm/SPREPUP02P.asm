*          DATA SET SPREPUP02P AT LEVEL 006 AS OF 02/03/04                      
*PHASE SPUP02PA                                                                 
SPUP02P  TITLE 'SPREPUP02P - PROBLEM REPORT'                                    
SPUP02   CSECT                                                                  
         DS    8192C                                                            
         ORG   *-8192                                                           
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         B     *+10                                                             
         MVC   0(0,R1),0(R4)                                                    
         LA    R1,1(RE,R1)         NEXT POSITION ON PRINT LINE                  
         MVI   0(R1),C' '                                                       
         LA    R1,1(R1)                                                         
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE CTGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006SPREPUP02P02/03/04'                                      
         END                                                                    
