*          DATA SET RECNT1E    AT LEVEL 003 AS OF 10/08/15                      
*PHASE T8021EA                                                                  
*INCLUDE RETIMVAL                                                               
*INCLUDE REDAYVAL                                                               
         TITLE 'T8021E - REPPAK BUY EDIT'                                       
*                                                                               
***********************************************************************         
*                                                                     *         
*     RECNT1E (T8021E) --- BUY, DAY/TIME, BUY LEN, EFF DATE EDIT      *         
*                                                                     *         
* ------------------------------------------------------------------- *         
*                                                                     *         
* 20AUG15 KWA BYPASS AM VALIDATION                                              
* 11OCT12 KWA MISSED DATE YEAR ADJUSTMENT                             *         
* 10MAY11 SKU FIX DEFAULT RATE VALIDATION (0323784N)                  *         
* 18SEP09 SKU ON-THE-FLY FIX FOR OPENED EPORT ORDERS W/ 0 SPOT STARTS *         
* 22MAR06 HQ  FIX BUMPNUM ERRONEOUSLY CLEAR "BUYLINE ADDED" FLAG BUG  *         
* 21SEP04 HQ  FIX +/- DATE/SPOTS ON BUY CREATION AGAIN                *         
* 19JUL04 HQ  FIX TARGET LINE THE SAME AS MISS LINE BUG               *         
* 21APR04 HQ  FIX +/- DATE/SPOTS ON BUY CREATION                      *         
* 01MAR04 BU  BUYCODES NOT MANDATORY FROM STATION SIDE                *         
* 12FEB04 BU  MAKE BUYCODE MANDATORY IF PROFILE SET                   *         
* 14NOV03 SKU DISALLOW MAKEGOOD TO TARGET CANCELLED BUYS              *         
* 30OCT03 HQ  PLAN PACKAGE FIX                                        *         
* 11SEP02 BU  PERMIT DELETION OF BUYLINE CODE                         *         
* 07JUN02 SKU DEMO RATING SUPPORT. INIT TRADE FLAG                    *         
* 05MAR02 SKU SUPPORT MAKEGOOD DATE RANGE PROCESSING                  *         
* 20SEP01 BU  BUYLINE CODE PROCESSING, RESTRUCTURE FOR ADDRESSING     *         
* 25JUL01 BU  NEW FIELDS ON SCREEN                                    *         
* 04JUN01 BU  DAILY PACING                                            *         
* 26JAN01 RHV PGM FIELD                                               *         
* 02OCT00 SKU BUG FIX: UPDATE TARGET MG BUY MOD CODE AND VERSION #    *         
* 10JUL00 SKU BUG FIX: SAVE ADDRESS OF NEWLY ADDED BUY TO TWA         *         
* 25MAY00 BU  BUYT ACTION REMOVED:  TRADE AT RATE ENTRY LEVEL         *         
* 19MAY00 BU  BUYT ACTION:  BUY TRADE                                 *         
* 13MAR00 SKU NEW ENTRY                                               *         
*                                                                     *         
*                                                                     *         
***********************************************************************         
*                                                                               
...
BUED0080 EQU   *                   FORCE BOP BEFORE BUYS ON NEW CONT.           
         ...
         CLC   BUYBACT(4),=C'BUYX' SKIP BOP CHECK FOR SPECIAL                   
...
BUED0180 DC    0H'0'                                                            
         ...
         SPACE 1                                                                
BUED0200 CLC   =C'CHA',BUYACT     CHANGE?                                       
         BE    CHGBUY                                                           
...
*                                                                               
         ...
         CR    R2,R3                                                            
         BL    *-14                                                             
         FOUT  BUYBNUMH,MYSPACES,8                                              
         NI    BUYBNUMH+4,X'DF'    TURN OFF VALID BITS IN CASE OF ERROR         
         B     DAYED                                                            
         EJECT                                                                  
*              CHANGE BUY                                                       
CHGBUY   DC    0H'0'                                                            
...
*                                                                               
         ...
         TITLE 'T8021E - REPPAK DAY-TIME FIELDS EDIT'                           
*              EDIT DAYS AND TIMES                                              
DAYED    EQU   *                                                                
         GOTO1 =A(DAYEDX),DMCB,(RC),RR=Y                                        
*                                  RELOCATE DAYED FOR ADDRESSABILITY            
         BZ    LENEDIT             NO ERROR FOUND                               
         L     R2,DUB              ERROR: RESET INDICATORS                      
         L     R3,DUB+4                                                         
         B     ERROR                                                            
*        NEED TO SET TRANSFERS ON RETURN                                        
*                                                                               
...
*                                                                               
* DEMO RATING VALUES EDIT                                                       
*                                                                               
DEMOEDT  DS    0H                                                               
         LA    R2,BUYDVALH                                                      
         TM    4(R2),X'20'                                                      
         BO    BUYCDEDT                                                         
         GOTO1 =A(DEMOEDIT),DMCB,(RC),RR=Y                                      
*                                                                               
         TITLE 'T8011E - REPPAK BUYLINE CODE EDIT'                              
*                                                                               
BUYCDEDT EQU   *                                                                
         GOTO1 =A(BUYCDX),DMCB,(RC),RR=Y                                        
         BZ    BUYC0020            NO ERROR FOUND                               
         L     R2,DUB              SET A(FIELD IN ERROR)                        
         L     R3,DUB+4            ERROR MESSAGE                                
         B     ERROR                                                            
BUYC0020 EQU   *                                                                
...
*        BZ    TEDIT20                                                          
         OC    RCONDRLK,RCONDRLK   MUST BE LINKED TO A DARE ORDER               
         BZ    TEDIT20                                                          
...
*                                                                               
         ...
         BZ    REDI0120            HAS $ NOW, MAKE SURE WE MOVE SPT/WK          
...
*                                  GET OLD MG ELEM                              
*                                                                               
* PROCESS FOLLOWING FOR CREDIT, CR=, ONLY                                       
*                                                                               
         CLC   =C'CR=',BUYCOM1                                                  
         BNE   COED0340                                                         
*                                                                               
...
*                                  CHECK SPOTS/PER/WEEK                         
         MVI   DMCB,X'03'          NEED TO CHECK INDIVISUAL 03                  
         MVI   BYTE,C'S'           FOR SPOT/WEEK CHANGES                        
         BASR  RE,RF                                                            
         CLI   BYTE,0                                                           
         BNE   MDAY0390                                                         
*                                                                               
         LA    R5,RBUYNW           AND ALSO NEED TO CHECK 01 ELEMENT            
         L     R6,AIO2             FOR SPOT/WEEK CHANGES                        
...
BUMP5    OI    TAREQ,1              T/A REQ IND                                 
         NI    RCONMODR,X'FF'-X'80' NO K HEADLINE CHANGE                        
         SPACE 1                                                                
...
DELB0240 EQU   *                                                                
         ...
         OI    BUYBACTH+6,X'40'    FORCE CURSOR TO ACTION                       
         L     RD,BASERD                                                        
...
*                                  MISSED DATE WITHIN ST/END DATES              
         ...
         CLC   RBUYDTNW,IOAREA+RBUYNW-RBUYREC                                   
*                                  03 ELT SPOTS = BUYLINE SPOTS?                
         BNE   MERG0900            NO  - FINISHED - EXIT                        
         NI    RBUYDTIN,X'FF'-X'01'                                             
...
*                                     (IN CASE IT CHANGES)                      
         ...
         LA    R6,IOAREA+34        VERIFY IT'S REALLY AN ELEMENT                
CRES0020 EQU   *                                                                
...
*                                                                               
         ...
         USING TWAWORK,R4                                                       
*                                                                               
         NI    TWAMGFLG,X'FF'-X'40' DEFAULT CALL BUCKET UPDATE IN 01            
*                                                                               
         GOTO1 =A(VALMGBUY),RR=RELO                                             
*                                                                               
         GOTO1 =A(INITTSAR),RR=RELO                                             
*                                                                               
         GOTO1 =A(GETBUYS),RR=RELO                                              
*                                                                               
         TM    TWAMGFLG,X'40'      MISSED DATES FOUND?                          
         BZ    MGPROCX             GONNA DO MY OWN BUCKET UPDATE?               
*                                                                               
         GOTO1 =A(VALMISS),RR=RELO                                              
*                                                                               
*        GOTO1 =A(UPDTVER),RR=RELO                                              
*                                                                               
...
MGPROCX  DS    0H                                                               
         ...
         EJECT                                                                  
*                                                                               
*   DAYED HAS BEEN RELOCATED TO PROVIDE ADDITIONAL ADDRESSABILITY               
*                                                                               
DAYEDX   NTR1  BASE=*,LABEL=*                                                   
         L     RC,0(R1)            RESET A(WORKSPACE)                           
*                                                                               
         LA    R2,BUYDAYSH                                                      
         TM    4(R2),X'20'         PREVIOUSLY VALID? (CHANGE)                   
         BO    DAYX0800            EXIT CC ZERO                                 
         OI    STAT2,X'80'         BUY CHANGED-UPDATE VER/MOD                   
...
DAYX0800 EQU   *                                                                
         ...
         B     DAYX0900                                                         
DAYXERR  EQU   *                                                                
         ST    R2,DUB              SET ERROR INDICATORS                         
         ST    R3,DUB+4                                                         
...
VCROSS   NTR1                                                                   
         ...
         BZ    VCROSS10                                                         
         LA    R2,BUYDAYSH                                                      
         B     VCROSERR            CANNOT CROSS CROSS DAY DEFAULT               
...
VCROSSX  DS    0H                                                               
         ...
         B     VCROSXIT                                                         
VCROSERR DS    0H                                                               
         ST    R2,DUB              SAVE ERROR INDICATORS                        
         ST    R3,DUB+4                                                         
         LTR   RB,RB               SET CC NOT ZERO                              
VCROSXIT EQU   *                                                                
         XIT1                                                                   
...
* DEMO RATING VALUES EDIT                                                       
***********************************************************************         
DEMOEDIT NMOD1 DEDITDX-DEDITD,*DEDIT*,CLEAR=YES                                 
         LR    R5,RC                                                            
         USING DEDITD,R5                                                        
         L     RC,0(R1)                                                         
*                                                                               
...
*        MVI   5(R2),1                                                          
*                                                                               
* CONVERT DISPLAYABLE DEMO CATEGORY TO 3-BYTE DEMO CODE                         
*                                                                               
DEMED10  DS    0H                                                               
         XC    BUYDCAT+7(3),BUYDCAT+7 REMOVE CHANGE INDICATORS                  
         MVI   BUYDCATH+5,7                                                     
         NI    BUYDCATH+1,X'FF'-X'20' REMOVE PROT BIT FOR DEMOVAL               
*                                                                               
         XC    DDEMOCAT,DDEMOCAT                                                
DEMBLKD  USING DBLOCKD,DDEMOIO                                                  
         XC    DEMBLKD.DBLOCK,DEMBLKD.DBLOCK                                    
         MVC   DEMBLKD.DBCOMFCS,ACOMFACS                                        
         MVI   DEMBLKD.DBSELMED,C'T'                                            
         MVC   DEMBLKD.DBFILE,=C'INV'                                           
         GOTO1 VDEMOVAL,DMCB,BUYDCATH,(1,DDEMOCAT),(C'Y',DDEMOIO)               
         OI    BUYDCATH+1,X'20'       RESET PROT BIT AFTER DEMOVAL              
         DROP  DEMBLKD                                                          
*                                                                               
         XC    DDEMELEM,DDEMELEM                                                
DEMOD    USING RBUYRDEL,DDEMELEM                                                
*                                                                               
         MVC   DEMOD.RBUYRDDM,=AL4(-1)                                          
         MVC   DEMOD.RBUYRD2M,=AL4(-1)                                          
*                                                                               
         LA    R6,RBUYREC                                                       
         MVI   ELCODE,X'0E'                                                     
         BAS   RE,GETEL                                                         
         ...
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVC   DEMOD.RBUYRDEL(0),RBUYRDEL                                       
         MVC   DEMOD.RBUYRD2M,RBUYRDDM                                          
         MVC   DEMOD.RBUYRDDM,=AL4(-1)                                          
*                                                                               
         GOTO1 VDELELEM,DMCB,(X'0E',RBUYREC)                                    
         B     DEMED30                                                          
*                                                                               
DEMED20  DS    0H                                                               
         CLI   5(R2),0             OPTIONAL                                     
...
*                                                                               
DEMED25  DS    0H                                                               
         MVI   DEMOD.RBUYRDCD,RBUYRDCQ                                          
         MVI   DEMOD.RBUYRDLN,L'RBUYRDCV+2                                      
*                                                                               
DEMED30  DS    0H                                                               
         MVC   DEMOD.RBUYRDCT,DDEMOCAT                                          
*                                                                               
         CLI   5(R2),0             OPTIONAL                                     
         BE    DEMED40                                                          
*                                                                               
         ...
         ZIC   R4,5(R2)                                                         
         GOTO1 CASHVAL,DMCB,(X'81',8(R2)),(X'80',(R4))                          
         CLI   DMCB,X'FF'                                                       
         BE    ERROR                                                            
         L     RF,DMCB+8                                                        
         SRL   RF,4                                                             
         STCM  RF,15,DEMOD.RBUYRDDM                                             
*                                                                               
DEMED40  DS    0H                                                               
         GOTO1 VADDELEM,DMCB,RBUYREC,DDEMELEM                                   
*                                                                               
DEMEDX   EQU   *                                                                
         XIT1                                                                   
         DROP  R6,DEMOD                                                         
...
DEDITDX  EQU   *                                                                
         EJECT                                                                  
*                                                                               
*   BUYCDX:  VALIDATE ANY BUYLINE CODE ENTRY                                    
*                                                                               
T8021E   CSECT                                                                  
...
BYCD0005 EQU   *                                                                
         ...
         BNE   BYCD0007            YES -                                        
         CLI   TWAACCS,C'$'        STATION?                                     
         BE    BYCD0007            YES - NO RESTRICTION                         
         TM    PROFILES+CNTBYCDB,CNTBYCDA                                       
         BNZ   BYCD0770            NO ENTRY, AND BUYCODE MANDATORY:             
*                                     RETURN WITH ERROR MESSAGE                 
*                                  SAVE BUYLINE CODE FROM ORIG ELEMENT          
*                                     AND DELETE ANY OLD BUYLINE CODE           
         GOTO1 VDELELEM,DMCB,(X'5F',RBUYREC)                                    
         B     BYCD0800            NO  - FINISHED EXIT CC ZERO                  
*                                  SAVE BUYLINE CODE FROM ORIG ELEMENT          
BYCD0007 EQU   *                                                                
...
*                                  ADD  NEW X'5F' ELEMENT                       
         ...
         DROP  R6                                                               
BYCD0770 EQU   *                                                                
         MVC   DUB+4(4),=F'989'    SET ERROR MESSAGE 'MANDATORY'                
         B     BYCD0790                                                         
BYCD0780 EQU   *                                                                
         MVC   DUB+4(4),=F'909'    SET ERROR MESSAGE 'UNRECOGNIZED'             
BYCD0790 EQU   *                                                                
         LTR   RB,RB               SET CC NOT ZERO                              
         ST    R2,DUB                                                           
         B     BYCD0900                                                         
...
***********************************************************************         
*                                                                               
* VALIDATE MAKEGOOD BUY REP TO SPOT TRANSFER RESTRICTIONS                       
*                                                                               
***********************************************************************         
VALMGBUY NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         LA    R6,RBUYREC                                                       
         MVI   ELCODE,X'08'                                                     
...
*                                  RBUYCOMB LESS HOB IS #SPOT                   
         ...
         B     VMGBUY20            R1 HAS PRODUCT(TOTAL SPTS)                   
*                                                                               
VMGBUY10 DS    0H                                                               
         LH    R1,RBUYTSPT                                                      
         LTR   R1,R1               IF NEGATIVE SKIP CHECK                       
         BM    VMGBUYX                                                          
VMGBUY20 CH    R1,=H'169'          MAX OF 169 SPOTS                             
         BNH   VMGBUYX                                                          
         LA    R2,BUYBACTH                                                      
         LA    R3,266                                                           
         B     ERROR                                                            
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* RETRIEVE OLD/NEW TARGETS BUYS TO TSAR BUFFER                                  
***********************************************************************         
GETBUYS  NTR1  BASE=*,LABEL=*                                                   
         LR    R4,RA                                                            
         AHI   R4,TWAWORKQ                                                      
         USING TWAWORK,R4                                                       
*                                                                               
TARGETD  USING RBUYREC,TSARREC+2                                                
*                                                                               
...
*        MVC   BUYD.RBUYKPLN,=3X'FF'   THERE COULD BE PLAN                      
*                                                                               
         GOTO1 VHIGH                                                            
*                                                                               
GBUY30   DS    0H                                                               
...
GBUY40   DS    0H                                                               
         MVI   UPDATE,C'Y'                                                      
         XCEFL TSARREC,1002                                                     
         GOTO1 VGETREC,DMCB,TSARREC+2                                           
*                                                                               
         GOTO1 =A(PUTBACK),RR=RELO REMOVE MAKEGOOD REFERENCE                    
*                                  ADD SPOTS BACK IN X'03'                      
GBUY50   DS    0H                                                               
         OI    TWAMGFLG,X'40'      DO MY OWN BUCKET UPDATE                      
*                                                                               
         MVI   TD.TSACTN,TSAADD    ADD RECORD TO TSAR BUFFER                    
         SR    R1,R1                                                            
         ICM   R1,3,TARGETD.RBUYLEN                                             
         AHI   R1,2                                                             
         STCM  R1,3,TSARREC                                                     
*                                                                               
         GOTO1 VTSAR,TSARBLK                                                    
...
GBUY60   DS    0H                                                               
         BAS   RE,NEXTEL                                                        
         BNE   GBUY70                                                           
         CLC   TARGETD.RBUYKLIN,RBUYMGLI                                        
         BE    GBUY60              SKIP IF SAME TARGET                          
         B     GBUY20                                                           
*                                                                               
...
GBUY103  DS    0H                                                               
         ...
         DROP  RF                                                               
*                                                                               
GBUY105  GOTO1 =A(PUTBACK),RR=RELO REMOVE MAKEGOOD REFERENCE                    
*                                  ADD SPOTS BACK IN X'03'                      
*                                                                               
GBUY110  DS    0H                                                               
         OI    TWAMGFLG,X'40'      DO MY OWN BUCKET UPDATE                      
...
GBUYX    DS    0H                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* PUT MAKEGOOD SPOTS BACK                                                       
* DELETE APPROPRIATE X'56' ELEMENTS FROM TARGET MISSED BUY RECORD               
* PUT THE SPOTS BACK IN X'03' ELEMENTS                                          
***********************************************************************         
PUTBACK  NTR1                                                                   
*                                                                               
...
PBACK10  DS    0H                                                               
         ...
         BAS   RE,GETEL                                                         
         BNE   PBACKX                                                           
TARGETD  USING RBYMGSEL,R6                                                      
*                                                                               
PBACK20  DS    0H                                                               
         CLC   TARGETD.RBYMGSLI,MGBUYD.RBUYKLIN                                 
         BNE   PBACK30                                                          
*                                                                               
         MVC   BSTRDATE,TARGETD.RBYMGSDT                                        
         MVC   BMSS#SPT,TARGETD.RBYMGSSP                                        
*                                                                               
         GOTO1 VRECUP,DMCB,(2,TSARREC+2),(R6),(R6)                              
*                                                                               
* MOVE SPOTS BACK FROM X'56' TO X'03'                                           
*                                                                               
         GOTO1 =A(BLDBGRID),DMCB,('BGKEEPSP',0),RR=RELO                         
*                                                                               
         GOTO1 =A(ADJSPTS),DMCB,(C'+',BUYGRID),RR=RELO                          
*                                                                               
         GOTO1 =A(REBLDBUY),DMCB,BUYGRID,RR=RELO                                
*                                                                               
         B     PBACK10                                                          
*                                                                               
PBACK30  DS    0H                                                               
...
PBACKX   DS    0H                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* VALIDATE MISSED DATES                                                         
* UPDATE TARGET BUY IN TSAR BY REMOVING SPOTS IN X'03' ELEMENT AND              
* ADDING MAKEGOOD REFERENCE ELEMENT X'56'                                       
***********************************************************************         
VALMISS  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
...
*                                                                               
         ...
         MVI   NUMRECS,0                                                        
         LA    R5,EL05BLK                                                       
BLOCKD   USING RBUYMGEL,R5                                                      
*                                                                               
         LA    R2,BUYMD1H                                                       
*                                                                               
VMISS10  DS    0H                                                               
         CLI   5(R2),0             USER CAN DELETE MAKEGOOD DATE OR             
         BNE   VMISS20                                                          
*                                                                               
VMISS15  DS    0H                                                               
         TM    4(R2),X'20'         DATA CHANGED?                                
         BO    *+8                                                              
         OI    MGFLAGS,MGMCODE     SET M MOD CODE FOR MAKEGOOD BUY              
*                                                                               
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
         ZIC   R0,0(R2)                                                         
...
VMISS20  DS    0H                                                               
         ...
         ZIC   R0,0(R3)                                                         
         AR    R3,R0                                                            
         CLI   5(R3),0             TARGET LINE NUMBER                           
         BE    VMISS15                                                          
*                                                                               
         MVI   BLOCKD.RBUYMGCD,X'05'                                            
         MVI   BLOCKD.RBUYMGLN,X'0A'                                            
         LR    RE,R2                                                            
         SR    RE,RA                                                            
         STCM  RE,7,RBUYMGLQ(R5)                                                
*                                                                               
* MISSED DATES                                                                  
*                                                                               
         TM    4(R2),X'20'         DATA CHANGED?                                
...
*                                                                               
         CLI   5(R2),8             MMMDD/YY?                                    
         JNE   VMISS26                                                          
         CLI   8+5(R2),C'/'        HAVE YEAR?                                   
         JNE   VMISS26                                                          
         GOTO1 DATVAL,DMCB,(0,8(R2)),DUB                                        
         OC    0(4,R1),0(R1)                                                    
         JZ    ERROR                                                            
         GOTO1 DATCON,DMCB,DUB,(3,BLOCKD.RBUYMGD1)                              
         CLC   BLOCKD.RBUYMGD1(3),RCONDATE                                      
         JL    ERROR                                                            
         CLC   BLOCKD.RBUYMGD1(3),RCONDATE+3                                    
         JH    ERROR                                                            
         J     VMISS40                                                          
*                                                                               
VMISS26  GOTO1 DATCON,DMCB,DUB,(3,BLOCKD.RBUYMGD1)                              
         MVC   BLOCKD.RBUYMGD1(1),RCONDATE CONTRACT START YEAR                  
         CLC   BLOCKD.RBUYMGD1+1(2),RCONDATE+1                                  
         BNL   VMISS30             DETERMINE YEAR TO USE                        
         CLC   BLOCKD.RBUYMGD1(1),RCONDATE+3                                    
         BE    ERROR               USE CONTRACT END YEAR                        
         MVC   BLOCKD.RBUYMGD1(1),RCONDATE+3                                    
*                                                                               
VMISS30  DS    0H                                                               
         CLI   0(R4),C'-'                                                       
         BNE   VMISS40                                                          
         ...
         BZ    VMISS36                                                          
         GOTO1 DATCON,DMCB,DUB,(3,BLOCKD.RBUYMGD2)                              
         MVC   BLOCKD.RBUYMGD2(1),RCONDATE CONTRACT START YEAR                  
         CLC   BLOCKD.RBUYMGD2+1(2),RCONDATE+1                                  
         BNL   VMISS38             DETERMINE YEAR TO USE                        
         CLC   BLOCKD.RBUYMGD2(1),RCONDATE+3                                    
         BE    ERROR               USE CONTRACT END YEAR                        
         MVC   BLOCKD.RBUYMGD2(1),RCONDATE+3                                    
*********************************                                               
         B     VMISS38                                                          
*                                                                               
VMISS36  DS    0H                                                               
...
*                                                                               
         LR    R6,R3                                                            
BUYD     USING RBUYDTEL,R6                                                      
         MVC   BLOCKD.RBUYMGD2,BUYD.RBUYDTED                                    
         DROP  BUYD                                                             
*                                                                               
         B     VMISS38                                                          
*                                                                               
...
*                                  NUMERIC WEEKS ENTERED                        
         ...
         MHI   R3,7                                                             
*                                                                               
         GOTO1 DATCON,DMCB,(3,BLOCKD.RBUYMGD1),WORK+20                          
         GOTO1 ADDAY,DMCB,WORK+20,WORK+20,(R3)                                  
         GOTO1 DATCON,DMCB,WORK+20,(3,BLOCKD.RBUYMGD2)                          
*                                                                               
...
*                                                                               
         ...
         DROP  BUYD                                                             
*                                                                               
         GOTO1 DATCON,DMCB,(3,BLOCKD.RBUYMGD2),WORK                             
         GOTO1 ADDAY,DMCB,WORK,WORK,(R3)                                        
         GOTO1 DATCON,DMCB,WORK,(3,BLOCKD.RBUYMGD2)                             
*                                                                               
VMISS38  DS    0H                                                               
         CLI   0(R4),C'A'          ALTERNATE WEEKS?                             
         BNE   VMISS40                                                          
         OI    BLOCKD.RBUYMGFG,X'80'                                            
*********************************                                               
*                                                                               
...
*                                                                               
         ZIC   RE,NUMRECS                                                       
         AHI   RE,1                NUMBER OF RECORDS FOR XSORT                  
         STC   RE,NUMRECS                                                       
         AHI   R5,EL05BLQ                                                       
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
...
VMISS45  DS    0H                                                               
         ...
         BNH   VMISS10                                                          
*                                                                               
         CLI   EL05BLK,0           ANY MISSED DATES?                            
         BE    VMISSX                                                           
*                                                                               
* SORT ELEMENTS SO LINE NUMBER AND DATES WILL BE IN SEQUENCE                    
*                                                                               
         ZIC   R3,NUMRECS                                                       
         GOTO1 XSORT,DMCB,EL05BLK,(R3),EL05BLQ,RBUYMGLQ,0                       
*                                                                               
         LA    R5,EL05BLK                                                       
         MVI   NUMRECS,1                                                        
*                                                                               
...
*                                                                               
VMISS50  DS    0H                  NOW READ NEXT UNTIL WE FIND TARGET           
         GOTO1 VTSAR,TSARBLK       MISSED BUY                                   
         TM    TD.TSERRS,TSEEOF                                                 
         BZ    *+6                                                              
         DC    H'0'                                                             
         CLC   TARGETD.RBUYREC(RBUYKPLN-RBUYKEY),KEY                            
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
VMISS60  DS    0H                                                               
         CLC   TARGETD.RBUYKLIN,BLOCKD.RBUYMGLI                                 
         BE    VMISS70                                                          
         XCEFL TSARREC,1002                                                     
...
*                                                                               
VMISS70  DS    0H                                                               
         GOTO1 =A(BLDBGRID),DMCB,0,RR=RELO                                      
*                                                                               
VMISS80  DS    0H                                                               
         GOTO1 =A(CHKMISS),RR=RELO                                              
         BNZ   ERROR                                                            
*                                                                               
         MVC   MISSDATE,BLOCKD.RBUYMGD1                                         
*                                                                               
VMISS83  DS    0H                                                               
         XC    ELEM,ELEM                                                        
MGSD     USING RBYMGSEL,ELEM                                                    
         ...
         MVC   MGSD.RBYMGSSP,BLOCKD.RBUYMGSP                                    
         DROP  MGSD                                                             
*                                                                               
         GOTO1 HELLO,DMCB,(C'P',=C'REPFILE'),(0,TSARREC+2),(0,ELEM)             
*                                                                               
         OC    BLOCKD.RBUYMGD2,BLOCKD.RBUYMGD2                                  
         BZ    VMISS85                                                          
         GOTO1 DATCON,DMCB,(3,MISSDATE),(0,WORK)                                
         LA    R3,7                                                             
         GOTO1 ADDAY,DMCB,WORK,WORK,(R3)                                        
         GOTO1 DATCON,DMCB,(0,WORK),(3,MISSDATE)                                
         CLC   MISSDATE,BLOCKD.RBUYMGD2                                         
         BNH   VMISS83                                                          
*                                                                               
VMISS85  DS    0H                                                               
         ZIC   RE,NUMRECS                                                       
         AHI   RE,1                                                             
         STC   RE,NUMRECS                                                       
         CLI   NUMRECS,15          MAX 15 MISSED DATES                          
         BH    VMISS90                                                          
*                                                                               
         AHI   R5,EL05BLQ                                                       
         CLI   0(R5),0                                                          
...
*                                                                               
VMISS90  DS    0H                                                               
         GOTO1 =A(REBLDBUY),DMCB,BUYGRID2,RR=RELO                               
*                                                                               
         TM    MGFLAGS,MGMCODE     MAKEGOOD BUY REFERENCE CHANGED?              
         BZ    VMISS100                                                         
         GOTO1 =A(MGADDCD2),DMCB,(C'E',0),RR=RELO                               
         GOTO1 =A(UPDTVER),RR=RELO                                              
*                                                                               
VMISS100 DS    0H                                                               
...
*                                                                               
         L     R5,0(R1)            ADDRESS OF BUY GRID TO BE REBUILD            
*                                                                               
         LA    R6,TSARREC+2                                                     
         MVI   ELCODE,X'02'                                                     
         BAS   RE,GETEL                                                         
...
*                                                                               
         GOTO1 HELLO,DMCB,(C'P',=C'REPFILE'),(0,TSARREC+2),            X        
               (0,WKD.RBUYDTEL)                                                 
*                                                                               
RBLD40   DS    0H                                                               
         AHI   R5,2                                                             
...
RBLDX    DS    0H                                                               
         ...
         EJECT                                                                  
**********************************************************************          
* THIS ROUTINE UPDATES THE MOD CODE IN THE TARGET MISSED OR THE                 
* MAKEGOOD BUY. THE BUY IS IN 'TSARREC+2'. IF APPROPRIATE, THE VERSION          
* NUMBER OF THE BUY IS ALSO INCREMENTED                                         
*                                                                               
* PARM 1 = CHANGE CODE TO USE                                                   
**********************************************************************          
MGADDCD2 NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         MVC   BYTE,DMCB                                                        
*                                                                               
...
MG2ADC10 DS    0H                  REP VERSION ADVANCED                         
         CLC   RCONSRV,BUYD.RBUYVER                                             
         BNE   MG2ADC15                                                         
         CLI   BYTE,C'M'                                                        
         BNE   MG2ADC40                                                         
         CLI   BUYD.RBUYCHGI,C'A'  SKIP IF ADDED THIS VERSION                   
         BE    MG2ADCX                                                          
         B     MG2ADC40                                                         
*                                                                               
MG2ADC15 DS    0H                                                               
...
MG2ADC30 MVC   BUYD.RBUYCHGD,TODAY                                              
         MVC   BUYD.RBUYCHGI(1),BYTE   MAKEGOOD CHANGE CODE                     
         MVI   BUYD.RBUYCHGI+1,C' '                                             
         B     MG2ADCX                                                          
*                                                                               
* BUY ALREADY CHANGED TODAY                                                     
MG2ADC40 DS    0H                                                               
         CLI   BUYD.RBUYCHGI,C' '                                               
         BNE   MG2ADC50                                                         
         MVC   BUYD.RBUYCHGI(1),BYTE                                            
         B     MG2ADCX                                                          
                                                                                
MG2ADC50 DS    0H                                                               
         CLI   BUYD.RBUYCHGI,C'*'                                               
         BE    MG2ADCX                                                          
         CLC   BUYD.RBUYCHGI(1),BYTE                                            
         BE    MG2ADCX                                                          
         CLI   BUYD.RBUYCHGI+1,C' '                                             
         BNE   MG2ADC60                                                         
         MVC   BUYD.RBUYCHGI+1(1),BYTE                                          
         B     MG2ADCX                                                          
                                                                                
MG2ADC60 DS    0H                                                               
         CLC   BUYD.RBUYCHGI+1(1),BYTE                                          
         BE    MG2ADCX                                                          
...
*                                                                               
* P1, BYTE 1 = X'80' : SKIP REMOVAL OF RESERVED SPOTS                           
*                                                                               
...
BBGRID40 DS    0H                  INCASE OF MULTIPLE EFFECTIVE DATES           
         ...
         BE    BBGRID10                                                         
*                                                                               
         MVC   BUYGRID2,BUYGRID    SAVE OFF A COPY OF THE VIRGIN                
*                                  BUY GRID                                     
         DROP  R6                                                               
*                                                                               
         TM    BGFLAGS,X'80'       REMOVE RESERVED SPOTS?                       
         BO    BBGRIDX                                                          
*                                                                               
* REMOVE RESERVED SPOTS FROM GRID                                               
*                                                                               
         LA    R6,TSARREC+6        CHECK OLD STYLE MAKEGOOD                     
         MVI   ELCODE,X'06'                                                     
         BAS   RE,GETEL                                                         
         BNE   BBGRID60                                                         
         USING RBUYMSEL,R6                                                      
...
* IF ERROR, R2=FIELD OFFSET FROM TWA, R3=ERROR#                                 
CHKMISS  NTR1  BASE=*,LABEL=*                                                   
MGBD     USING RBUYMGEL,R5                                                      
*                                                                               
         LA    R3,47               MISSED DATE INVALID FOR MISSED LINE          
         ZICM  R2,RBUYMGLQ(R5),3                                                
         LTR   R2,R2                                                            
         BNZ   *+6                                                              
         DC    H'0'                                                             
         AR    R2,RA                                                            
*                                                                               
         MVC   MGDATE,MGBD.RBUYMGD1                                             
*                                                                               
CHKM10   DS    0H                                                               
...
CHKM50   DS    0H                                                               
         MVC   BSTRDATE,MGDATE                                                  
         MVC   BMSS#SPT,MGBD.RBUYMGSP                                           
         GOTO1 =A(ADJSPTS),DMCB,(C'-',BUYGRID),RR=RELO                          
         BNZ   CHKM60                                                           
         GOTO1 =A(ADJSPTS),DMCB,(C'-',BUYGRID2),RR=RELO                         
         BZ    CHKM70                                                           
*                                                                               
CHKM60   DS    0H                                                               
         ZIC   R1,0(R2)                                                         
...
*                                                                               
CHKM70   DS    0H                                                               
         OC    MGBD.RBUYMGD2,MGBD.RBUYMGD2                                      
         BZ    CHKMYES                                                          
*                                                                               
         LA    R3,7                                                             
...
ADJSPTS  NTR1  BASE=*,LABEL=*                                                   
         MVC   MYWRK(1),0(R1)                                                   
         L     R2,0(R1)            RESET TO START OF GRID                       
         XC    ELEM,ELEM                                                        
         XC    WORK2,WORK2                                                      
         GOTO1 DATCON,DMCB,(3,GSTRDATE),(5,ELEM)                                
...
UV30     OI    RCONCONF,X'80'      NOT CONFIRMED                                
         ...
         EJECT                                                                  
*                                                                               
* DUMP UPDATED TARGET BUYS FROM TSAR TO FILE                                    
* ALSO UPDATE MAKEGOOD BUY                                                      
*                                                                               
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
* UPDATE TARGET BUY TO FILE IF CHANGED                                          
*                                                                               
DUMP10   DS    0H                                                               
         ...
         GOTO1 VGETREC,DMCB,IOAREA                                              
*                                                                               
OTARGETD USING RBUYREC,IOAREA                                                   
NTARGETD USING RBUYREC,TSARREC+2                                                
*                                                                               
         LA    R0,OTARGETD.RBUYREC                                              
         ZICM  R1,OTARGETD.RBUYLEN,2                                            
         LA    RE,NTARGETD.RBUYREC                                              
         ZICM  RF,NTARGETD.RBUYLEN,2                                            
*                                                                               
* USE THE LONGER OF THE TWO LENGTHS FOR COMPARE                                 
* SINCE HELLO ADDS A TERMINATING ZERO TO THE END OF THE RECORD, THE             
* RECORD LENGTH WILL BE INCREASED BY 1 EVEN THOUGH NO CHANGES TOOK              
* PLACE                                                                         
*                                                                               
         CR    R1,RF                                                            
         BH    DUMP15                                                           
...
DUMP15   DS    0H                                                               
         LR    RF,R1                                                            
*                                                                               
DUMP18   DS    0H                  NO DATA CHANGED, DO NOT UPDATE REC           
         CLCL  R0,RE                                                            
         BE    DUMP30              NO CHANGE, SKIP PUTREC                       
*                                                                               
DUMP20   DS    0H                                                               
*                                                                               
* REMOVE ORIGINAL TARGET BUY BUCKETS FROM THE CONTRACT RECORD                   
*                                                                               
         GOTO1 =A(BUCKUP),DMCB,(X'FF',IOAREA),RR=RELO                           
*                                                                               
* ADD CHANGED/NEW TARGET BUY BUCKETS TO THE CONTRACT RECORD                     
*                                                                               
...
DUMP30   DS    0H                                                               
         ...
         BE    DUMP10                                                           
*                                                                               
* UPDATE MAKEGOOD BUY AND WRITE TO FILE                                         
*                                                                               
DUMP35   DS    0H                                                               
         GOTO1 VDELELEM,DMCB,(5,RBUYREC)                                        
*                                                                               
         ...
         LA    R5,EL05BLK                                                       
BLOCKD   USING RBUYMGEL,R5                                                      
*                                  UPDATE FIRST TARGET BUY                      
         MVC   RBUYKMLN,BLOCKD.RBUYMGLI                                         
*                                                                               
DUMP40   DS    0H                  ADD MAKEGOOD REFERENCE X'05' ELEMS           
         CLI   0(R5),0                                                          
         BE    DUMP50                                                           
*                                                                               
         GOTO1 HELLO,DMCB,(C'P',=C'REPFILE'),(0,RBUYREC),(R5)                   
*                                                                               
         AHI   R5,EL05BLQ                                                       
         BCT   R4,DUMP40                                                        
*                                                                               
DUMP50   DS    0H                  FIRST TARGET MAY HAVE CHANGED                
         CLI   RBUYKMLN,0                                                       
         BNE   DUMP55                                                           
         MVC   RBUYKMLN,RBUYKLIN   NO LONGER A MAKEGOOD BUY                     
*                                  REMOVE ANY LEFTOVER MG= COMMENTS             
         GOTO1 HELLO,DMCB,(C'D',=C'REPFILE'),(X'04',RBUYREC),=C'MG=',0          
*                                                                               
DUMP55   DS    0H                                                               
         CLC   =C'BUY',BUYACT                                                   
         BE    DUMP65                                                           
*                                                                               
         ...
         GOTO1 VGETREC,DMCB,IOAREA                                              
*                                                                               
* IOAREA = OLD MAKEGOOD BUY                                                     
* RBUYREC = NEW MAKEGOO DBUY                                                    
*                                                                               
OMGBUYD  USING RBUYREC,IOAREA                                                   
*                                                                               
         CLI   OMGBUYD.RBUYDPT,0   DAYPART FIELD SHOULD BE                      
         BNE   *+8                 INITIALIZED TO A BLANK                       
         MVI   OMGBUYD.RBUYDPT,C' '                                             
*                                                                               
         CLC   OMGBUYD.RBUYLEN,RBUYLEN                                          
         BNE   DUMP60                                                           
*                                                                               
         LA    R0,OMGBUYD.RBUYREC                                               
         ZICM  R1,OMGBUYD.RBUYLEN,2                                             
         LA    RE,RBUYREC                                                       
         ZICM  RF,RBUYLEN,2                                                     
*                                                                               
         CLCL  R0,RE                                                            
...
*                                                                               
DUMP65   DS    0H                                                               
         GOTO1 =A(BUCKUP),DMCB,RBUYREC,RR=RELO                                  
*                                                                               
         CLC   =C'BUY',BUYACT                                                   
         BE    DUMP68                                                           
*                                                                               
* UPDATE MAKEGOOD BUY MOD CODE AND VERSION NUMBER                               
*                                                                               
         TM    MGFLAGS,MGMCODE     MAKEGOOD BUY REFERENCE CHANGED?              
         BZ    DUMP66                                                           
         GOTO1 VMOVEREC,DMCB,RBUYREC,TSARREC+2                                  
         GOTO1 =A(MGADDCD2),DMCB,(C'M',0),RR=RELO                               
         GOTO1 VMOVEREC,DMCB,TSARREC+2,RBUYREC                                  
*                                                                               
* CHECK IF KEY CHANGED                                                          
*                                                                               
DUMP66   DS    0H                                                               
         CLC   OMGBUYD.RBUYKEY(27),RBUYKEY                                      
         BE    DUMP90                                                           
*                                                                               
         MVC   KEY(27),IOAREA      KEY CHANGED, DELETE OLD MAKEGOOD BUY         
         GOTO1 VHIGH               ADD NEW MAKEGOOD BUY W/ CHANGED KEY          
         CLC   KEY(27),KEYSAVE                                                  
         BE    *+6                                                              
         DC    H'0'                                                             
         OI    KEY+27,X'80'+X'40'  MARK DELETED                                 
         GOTO1 VWRITE                                                           
         OI    OMGBUYD.RBUYCNTL,X'80'+X'40'                                     
         GOTO1 VPUTREC,DMCB,IOAREA                                              
*                                                                               
         MVC   KEY(27),RBUYREC                                                  
         OI    DMINBTS,X'08'                                                    
...
*                                                                               
         ...
         AHI   RF,TWAWORKQ                                                      
         USING TWAWORK,RF                                                       
         MVC   TWABADDR,KEY        SAVE OFF ADDR FOR LATER PROCESSING           
         B     DUMPX                                                            
         DROP  RF                                                               
*                                                                               
DUMP70   DS    0H                                                               
         NI    KEY+27,X'FF'-X'80'-X'40'                                         
         GOTO1 VWRITE                                                           
         OI    DMINBTS,X'08'                                                    
         MVI   UPDATE,C'Y'                                                      
         GOTO1 VGETREC,DMCB,IOAREA                                              
...
*                                                                               
         ...
         EJECT                                                                  
*                                                                               
*   BUYCODE UPDATES PASSIVE POINTERS FOR BUYLINE CODE ENTRY                     
*                                                                               
...
ACTION   DS    F                                                                
MGFLAGS  DS    X                                                                
MGMCODE  EQU   X'80'               MAKEGOOD BUY WAS SET TO MOD CODE M           
BGFLAGS  DS    X                                                                
BGKEEPSP EQU   X'80'                                                            
* X'80' = BUILD BUY GRID WITHOUT REMOVING CREDITS OR MAKEGOOD SPOTS             
LINECTR  DS    X                                                                
...
BUYGRID2 DS    XL(53*2)            COPY BUYGRID FOR TARGET MISSED BUY           
*                                                                               
...
EL05BLQ  EQU   RBUYMGLQ+3          THE EXTRA 3 BYTES IS THE A(INPUT)            
...
MGWORKX  EQU   *                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003RECNT1E   10/08/15'                                      
         END                                                                    
