*          DATA SET RESIN20    AT LEVEL 041 AS OF 05/01/02                      
*PHASE T80620C,*                                                                
...
*                                                                   *           
* 12MAY/99 (RHB) --- REVISED FLIGHT DATES                           *           
*                                                                   *           
*********************************************************************           
*                                                                               
T80620   CSECT                                                                  
...
*                                                                               
* DISPLAY K DATES                                                               
         GOTO1 (RFKFLT,VREPFACS),DMCB,(X'80',RCONREC),SINDTS+9,0,      +        
               RFBLOCK                                                          
*                                                                               
* GET COMMENTS                                                                  
         LA    R3,RCONELEM                                                      
...
YES4CAST SR    R1,R1                                                            
       ...
       ++INCLUDE RESINGEN                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'041RESIN20   05/01/02'                                      
         END                                                                    
