*          DATA SET SPREPFXYK3 AT LEVEL 058 AS OF 05/08/00                      
*PHASE SPFX02Y3                                                                 
...
FX2A     GOTO1 SEQ                                                              
*                                                                               
FX4A     CLC   KEY(3),KEYSAVE      SAME A-M/FCLT                                
         BNE   ENDREQ                                                           
         CLI   KEY+3,X'FF'                                                      
         BE    ENDREQ                                                           
         CLI   KEY+10,X'FF'                                                     
...
FX40     AP    DELCOUNT,=P'1'                                                   
         ...
         GOTO1 REPORT                                                           
*                                                                               
         CLI   MYFLAG,C'Y'         DID WE CHANGE RECORD ITSELF                  
         BNE   FX12                                                             
         L     R6,ADBUY                                                         
         OI    15(R6),X'80'                                                     
         GOTO1 PUTBUY                                                           
...
BUYRECD  DSECT                                                                  
       ...
       ++INCLUDE SPREPWORKD                                                     
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058SPREPFXYK305/08/00'                                      
         END                                                                    
