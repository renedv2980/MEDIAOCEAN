*          DATA SET DELMTPWO   AT LEVEL 053 AS OF 03/22/18                      
*PROCESS USING(WARN(15))                                                        
*PHASE DELMTWOA                                                                 
         TITLE 'DEMCON - LOCAL MONTHLIESTRUE WEEKLIES - OUTPUT PHASE'           
DELMTPO  CSECT                                                                  
         PRINT NOGEN                                                            
...
CNV14    LA    R6,THISKEY                                                       
         ...
         XC    THISKEY,THISKEY                                                  
* NEW LETS TRY TO SET DRHOME TO C'W'                                            
         MVI   DRHOME,C'w'                                                      
*                                                                               
         MVI   DRCODE,DRCODEQU                                                  
         MVC   DRMEDIA,MEDIA                                                    
...
CNV31A   LA    R5,DBLOCKA                                                       
         ...
         MVC   DBFILE,=C'TP '                                                   
***      MVC   DBSELMED,MEDIA                                                   
         MVI   DBSELMED,C'T'    SAME AS REGULAR NIELSEN                         
****     MVC   DBSELSRC,OUTSRC                                                  
         MVI   DBSELSRC,C'N'    SAME AS REGULAR NIELSEN                         
         MVC   DBSELBK,INTBOOK                                                  
         ST    RA,DBCOMFCS                                                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'053DELMTPWO  03/22/18'                                      
         END                                                                    
