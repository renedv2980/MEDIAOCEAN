*          DATA SET DECNVMG    AT LEVEL 028 AS OF 07/24/08                      
*PHASE DECNVMGA                                                                 
*INCLUDE DEBKUPDT                                                               
**********************************************************************          
* NTI/NSS MOVIEGOER OUTPUT PHASE                                                
* IPHASE: DEAW....                                                              
**********************************************************************          
         TITLE 'DEMCON - MOVIEGOER CONVERSION - OUTPUT PHASE'                   
DECNVMG  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 NADWRKX-NADWRKD,**NADOUT                                         
         USING NADWRKD,RC          RC=A(TEMP W/S)                               
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DECNVMG+4096,R7                                                  
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028DECNVMG   07/24/08'                                      
         END                                                                    
