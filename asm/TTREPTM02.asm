*          DATA SET TTREPTM02  AT LEVEL 015 AS OF 07/19/94                      
*PHASE ACTM02A,+0                                                               
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE PRNTBL                                                                 
...
***********************************************************************         
*        QOPT1 = E = PRINT ONLY THE ERROR REPORT                      *         
*                S = SERIOUS ERRORS                                   *         
...
*        QOPT6 = X = DON'T DELETE OLD CLUSTERS                                  
***********************************************************************         
         SPACE 2                                                                
***********************************************************************         
*                                                                     *         
...
JOBD7    CLI   TRNKREF,C' '        TEST TRANSACTION                             
         ...
         BH    JOBD3                                                            
         CLC   TRNKREF(2),=C'T0'   FOR BURSON SKIP BAD TRANSFERS                
         BNE   JOBD3                                                            
         ...
         BNE   JOBD3                                                            
         CLC   TRNKCUNT(2),PERSUL  WITH CONTRA OF 1R                            
         BNE   JOBD3                                                            
*                                                                               
...
*                                                                               
JOBD16   MVC   TMSCOFC,JOBOFC      OFFICE CODE                                  
...
*                                                                               
         ...
         ZAP   TIMTAMNT,TIMAMNT    TRANSACTION AMOUNT IS THE TAX                
         LA    R7,TMSINP                                                        
         B     JOBD31                                                           
*                                                                               
         USING SPAELD,R4                                                        
...
PTIM3    LA    R2,DIR                                                           
         ...
         BNE   XIT                                                              
         CLI   TRNKREF,C' '        TEST TRANSACTION                             
         BNH   PTIM3                                                            
...
PTIM7    CLI   0(R4),TRNELQ        TRANSACTION ELEMENT                          
         ...
         MVC   TMSXREF,TRNREF      REFERENCE                                    
         MVC   TMSCOFC,TRNOFFC     CLIENT OFFICE                                
         MVC   TIMOFF,TRNOFFC                                                   
         ZAP   TIMAMNT,TRNAMNT     AMOUNT                                       
         BAS   RE,NARR             GET NARRATIVE                                
         B     PTIM31                                                           
...
***********************************************************************         
         SPACE 1                                                                
         USING PRTELD,R4                                                        
*RTL     MVC   TIMLINE#,PRTLINE#   SAVE TMS LIME NUMBER                         
...
PUTBK    NTR1  ,                                                                
         ...
         CLI   QOPT6,C'X'          DELETE CLUSTERS                              
         BE    *+8                                                              
         BAS   RE,DELC             DELETE OLD UNNEEDED CLUSTERS                 
         BAS   RE,REVN             ADD REVISION NUMBERS                         
*                                                                               
         BAS   RE,DUPL             CHECK FOR DUPLICATE LINE NUMBERS             
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* MATCH REVERSED INPUT TYPE 49'S ON NEW CLUSTERS                      *         
***********************************************************************         
         SPACE 1                                                                
MATC     NTR1  ,                                                                
...
MATC03   LA    R2,ECDLNQ(R2)                                                    
         ...
         TM    ECDSTAT-ECD(R2),ECDSR49  TEST TYPE 49 REVERSAL                   
         BNO   MATC03                                                           
         TM    ECDSTAT-ECD(R2),ECDSM49  MATCHED 49                              
         BO    MATC03                                                           
         USING TIMELD,R7                                                        
...
MATC05   LA    R4,ECDLNQ(R4)                                                    
         CLI   0(R4),X'FF'                                                      
         BE    MATC03                                                           
         TM    ECDSTAT-ECD(R4),ECDSR49  TEST TYPE 49 REVERSAL                   
         BNO   MATC05                                                           
         TM    ECDSTAT-ECD(R4),ECDSM49  MATCHED 49                              
         BO    MATC05                                                           
         ...
         BNE   MATC05                                                           
         OI    ECDSTAT-ECD(R2),ECDSM49   FLAG BOTH AS USED                      
         OI    ECDSTAT-ECD(R4),ECDSM49                                          
         B     MATC03                                                           
         EJECT                                                                  
***********************************************************************         
...
MRGC03   LA    R2,ECDLNQ(R2)                                                    
         CLI   0(R2),X'FF'                                                      
         BE    XIT                                                              
         TM    ECDSTAT-ECD(R2),ECDSR49+ECDSM49  REVERSED/MATCHED 49             
         BO    MRGC03                                                           
         LA    R7,ECDINP-ECD(R2)   R7=NEW DATA                                  
         USING TIMELD,R7                                                        
...
DELC03   LA    R2,ECDLNQ(R2)                                                    
         ...
         BO    DELC03                                                           
         OI    ECDSTAT-ECD(R2),ECDSDEL  MARK IT DELETE                          
         LA    R7,ECDINP-ECD(R2)                                                
         USING TIMELD,R7                                                        
         MVI   TIMEL,X'00'                                                      
...
DUPL03   LA    R2,ECDLNQ(R2)                                                    
         ...
         B     *+8                                                              
*                                                                               
DUPL05   LA    R4,ECDLNQ(R4)                                                    
         CLI   0(R4),X'FF'                                                      
         BE    DUPL03                                                           
         TM    ECDSTAT-ECD(R4),ECDSKEP  TEST KEEP STATUS                        
         BNO   DUPL05                                                           
         USING TIMELD,R7                                                        
         LA    R7,ECDINP-ECD(R2)                                                
         LA    R6,ECDINP-ECD(R4)                                                
*                                                                               
         CLC   TIMLINE#,TIMLINE#-TIMELD(R6)    SAME LINE#                       
         BNE   DUPL05                                                           
*                                                                               
         MVI   TIMEL,X'00'                                                      
         BAS   RE,DMPEL            HEX OUT THE DATA TO BE DELETED               
...
PUTR03   L     R4,AIO1                                                          
         ...
         STCM  R3,3,0(RF)                                                       
         L     R2,ATAPEOUT                                                      
         PUT   (R2),(RF)           PUT OUT ACCFILE RECORD                       
*                                                                               
...
EDIT3    EDIT  (P8,(R4)),(8,0(R5)),2                                            
         ...
         BR    RE                                                               
*                                                                               
EDITT    SH    R5,=H'2'            TOTALS                                       
         LA    R2,L'XP(R5)                                                      
EDITT3   EDIT  (P8,(R4)),(10,0(R5)),2                                           
         LA    R4,8(R4)                                                         
         LA    R5,9(R5)                                                         
         LA    R2,9(R2)                                                         
         XR    R5,R2                                                            
...
ECDSUS   EQU   X'80'               ITEM MATCHED                                 
ECDSR49  EQU   X'40'               TYPE 49 MARKED AS REVERSED                   
ECDSM49  EQU   X'20'               TYPE 49 REVERSAL MATCHED IN TABLE            
ECDSKEP  EQU   X'08'               KEPT IT                                      
...
PLC1     DS    CL1                                                              
PLNME    DS    CL30                PERSON'S NAME                                
PLC2     DS    CL1                                                              
PLEND    DS    CL8                 WEEK ENDING DATE                             
PLC3     DS    CL1                                                              
PLPER    DS    CL35                PERSON ACCUMS                                
PLC4     DS    CL1                                                              
PLJOB    DS    CL26                JOB ACCUMS                                   
PLC5     DS    CL1                                                              
PLOUT    DS    CL35                OUTPUT ACCUMS                                
PLC6     DS    CL1                                                              
...
* DDMASTD                                                                       
       ...
       ++INCLUDE DDMASTD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015TTREPTM02 07/19/94'                                      
         END                                                                    
