*          DATA SET REWRI00    AT LEVEL 057 AS OF 04/20/16                      
...
*                                                                     *         
*                                                                     *         
*  23JUN00 (BU ) --- REACTIVATE 'TEST' VERSION                        *         
...
*=================== FIX THIS BAD EX TARGET !!! =======================         
* DEIS GUESSES THAT THERE SHOULD BE A "B *+10" BEFORE THE PACK.                 
*======================================================================         
         EX    RF,*+8                                                           
         PACK  DUB(2),0(0,R2)      CONVERT TO PWOS                              
         MVC   1(1,R1),DUB                                                      
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE DDPERVALD                                                      
         ...
         SPACE                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'057REWRI00   04/20/16'                                      
         END                                                                    
