*          DATA SET PUBCOPYG9  AT LEVEL 022 AS OF 08/12/02                      
*PHASE PUBCOPA                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
GET001   DS    0H                                                               
         ...
         CLC   REC+11(3),=C'CND'                                                
         BE    GET6                                                             
         CLC   REC+11(3),=C'QDC'  "ALL CLIENTS" ADDRESS ?                       
         BE    GET6                YES - COPY                                   
         B     GET                                                              
*                                                                               
GET002   DS    0H                                                               
...
PUBCNT   DC    PL5'0',CL20'PUB    COUNT'                                        
ADRCNT   DC    PL5'0',CL20'ADDRESS COUNT'                                       
ELMCNT   DC    PL5'0',CL20'ELM 71 COUNT'                                        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'022PUBCOPYG9 08/12/02'                                      
         END                                                                    
