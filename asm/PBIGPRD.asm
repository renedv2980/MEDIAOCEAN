*          DATA SET PBIGPRD    AT LEVEL 039 AS OF 05/01/02                      
*PHASE PBIGPRDA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
*                                                                               
         ...
         BE    BUY                                                              
         CLI   REC+3,X'02'         CLIENT HEADER                                
         BNE   PUTXX                                                            
*                                                                               
         OC    REC+192(2),REC+192   ANYTHING IN OFFICE +1&+2                    
         BZ    PUTXX                                                            
         XC    REC+192(2),REC+192         CLEAR OFFICE +1&+2                    
         AP    CLICNT,=P'1'                                                     
         CP    CLICNT,=P'50'                                                    
         BH    PUTXX                                                            
         BAS   RE,DMPREC                                                        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'039PBIGPRD   05/01/02'                                      
         END                                                                    
