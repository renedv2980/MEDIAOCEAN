*          DATA SET RCVSTRIP   AT LEVEL 012 AS OF 11/05/09                      
*&&      SET   DB=N,DB1=N                                                       
*PHASE RCVSTRPA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
...
PTWO02   BRAS  RE,GETFRSRT         GET A RECORD FROM THE SORT                   
         ...
         LA    R3,SRTREC                                                        
         PUT   TAPEOUT,(R3)        PUT THIS RECORD TO TAPE                      
         B     PTWO02              AND PROCESS                                  
*                                                                               
PTWO04   CLOSE TAPEOUT                                                          
         LTR   RF,RF                                                            
         BZ    *+6                                                              
         DC    H'0'                                                             
*                                                                               
...
TAPEIN   DCB   DDNAME=TAPEIN,DSORG=PS,MACRF=(GL),RECFM=VB,             +        
               BLKSIZE=23476,LRECL=8200,BUFNO=2,EODAD=SONEEND                   
*                                                                               
TEMPOUT  DCB   DDNAME=TEMPOUT,DSORG=PS,RECFM=VB,LRECL=8200,            +        
               BLKSIZE=8204,MACRF=(GM,PM),EODAD=STWOEND                         
*                                                                               
DEBUG    DCB   DDNAME=DEBUG,DSORG=PS,RECFM=VB,LRECL=8200,              +        
               BLKSIZE=8204,MACRF=(PM)                                          
*                                                                               
TAPEOUT  DCB   DDNAME=TAPEOUT,DSORG=PS,RECFM=VB,LRECL=8200,            +        
               BLKSIZE=8204,MACRF=(PM)                                          
         EJECT                                                                  
**********************************************************************          
...
SWORKL   EQU   *-SWORKD                                                         
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012RCVSTRIP  11/05/09'                                      
         END                                                                    
