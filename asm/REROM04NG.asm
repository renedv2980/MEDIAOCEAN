*          DATA SET REROM04NG  AT LEVEL 070 AS OF 04/03/03                      
*PHASE T83F04B                                                                  
*INCLUDE REREPDIF                                                               
*INCLUDE GETBROAD                                                               
*INCLUDE REDARTKO                                                               
...
*                                                                               
         ...
         DROP  RF                                                               
*                                                                               
         GOTO1 =A(SWAPHDRS),DMCB,DE9LHEDH,RR=RELO                               
...
*                                  LOAD SINGLE LINE SCREEN                      
         ...
         B     LR57                                                             
LR55     DS    0H                                                               
         GOTO1 CALLOV,DMCB,DE1TAGH,X'D9083FE3'                                  
...
*                                                                               
***      CLC   =X'30170004',KEY+20 PROCESS ONLY A SINGLE ORDER                  
***      BNE   *+6                                                              
***      DC    H'0'                                                             
*                                                                               
...
*                                                                               
         MVI   ONELINE,C'N'        SET SINGLE LINE DISPLAY TO 'NO'              
         LR    R4,RA               USE R2 TO COVER THE ENTRY                    
         AHI   R4,DARPROFS+12-CONHEADH                                          
*                                  SET TO A(DARE PROFILE)                       
         USING SVDSECT,R4                                                       
*                                                                               
*   ONLY SINGLE LINE DISPLAY WILL COME THROUGH THIS MODULE.                     
*                                                                               
***      TM    SVPGPBIT+DAR1LINB,DAR1LINA                                       
***      BZ    LRAD0020            NO  - USE ORIGINAL SCREEN FIELDS             
         MVI   ONELINE,C'Y'        SET SINGLE LINE DISPLAY TO 'YES'             
LRAD0020 EQU   *                                                                
         DROP  R4                                                               
*                                                                               
         CLI   MODE,PRINTREP       REPORT REQUEST?                              
...
* HQIU   DC    H'0'                BY ROM ACTIONS(OPEN,LINK...)                 
         GOTO1 GETREC              SHOULDN'T BE DELETED                         
         L     RF,AIO3                                                          
...
*                                                                               
         ...
         BZ    VK000020            YES - DON'T FAKE OUT                         
...
VK000020 EQU   *                                                                
         ...
         BNE   VK02                YES - CHECK OUT THE DATA                     
VK01     EQU   *                                                                
         LA    RF,0                                                             
...
VK02     DS    0H                                                               
         ...
         CLC   =C'CTR',DE1RQTR     COUNTER REQUEST?                             
         BE    VK05                YES - DON'T SAVE INPUT IN REPEATER           
...
VK04     DS    0H                                                               
         ...
         BE    VK05                YES - DON'T RESET WITH IT                    
         MVC   DE1RQTR,REQINIT     RESET INPUT FROM REPEATER                    
*                                                                               
VK05     DS    0H                                                               
...
*                                                                               
         ...
         B     VK190               GO AND STUFF INTO FILTER BUFFER              
*                                                                               
VK165    DS    0H                                                               
*                                                                               
...
HDRDA2   DS    XL4                                                              
PENDCF   DS    X                                                                
ONELINE  DS    X                   SINGLE LINE SCREEN INDICATOR                 
*                                                                               
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'070REROM04NG 04/03/03'                                      
         END                                                                    
