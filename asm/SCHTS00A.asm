*          DATA SET SCHTS00A   AT LEVEL 051 AS OF 05/01/02                      
*PHASE T31C00A,+0                                                               
*INCLUDE CLPACK                                                                 
*INCLUDE CLUNPK                                                                 
*INCLUDE MSPACK                                                                 
...
*        MVC   LSVTWA0,=X'0900'                                                 
         ...
         ST    R0,ASTARTSV                                                      
*                                                                               
         OI    GENSTAT3,MULTFILS   SO CAN USE STATION FILES TOO                 
*                                                                               
...
SYS6     CLC   =C'REP',CONREC      FOR REP RECS                                 
         ...
         BNE   SYS8                                                             
SYS7     MVC   LKEY,=H'17'         SET VALUES FOR STAFILE                       
         MVC   LSTATUS,=H'1'                                                    
         MVC   DATADISP,=H'23'                                                  
         XC    SYSFIL,SYSFIL                                                    
...
*                                                                               
         ...
         GOTO1 =V(MSPACK),DMCB,SMKT,STAKCALL,BMKTSTA,RR=RELO                    
         BAS   RE,RESET                                                         
         B     XIT                                                              
*                                                                               
...
RETURN   DS    0H                                                               
         ZIC   R3,CALLSP           GET STACK POINTER                            
         SH    R3,=H'3'            DECREMENT POINTER TO POP STACK               
         STC   R3,CALLSP                                                        
         LA    RF,CALLSTK(R3)                                                   
...
VTACC    NTR1                                                                   
         ...
         CLC   =C'CLIENT',CONREC                                                
         BE    TACC10                                                           
         CLC   =C'PRODUCT',CONREC                                               
         BNE   TACCX                                                            
*                                                                               
         CLC   =X'200F',AUTHCODE   PRODUCT DISPLAY AND LIST ONLY                
         BE    TACC20                                                           
         B     TACC15                                                           
TACC10   CLC   =X'400F',AUTHCODE   CLIENT DISPLAY AND LIST ONLY                 
         BE    TACC20                                                           
TACC15   CLC   =X'600F',AUTHCODE   CLIENT/PRODUCT DISPLAY AND LIST ONLY         
         BE    TACC20                                                           
         CLC   =X'F10F',AUTHCODE   CLIENT/PRODUCT DISPLAY ONLY                  
         BE    TACC30                                                           
         B     TACCX                                                            
*                                                                               
TACC20   DS    0H                  DISPLAY AND LIST ONLY                        
         CLC   =C'LIS',CONACT                                                   
         BE    TACCX                                                            
         CLC   =C'SEL',CONACT                                                   
         BNE   TACC30                                                           
         ...
         BNE   TACCX                                                            
TACC25   MVI   ERROR,INVACT                                                     
         LA    R2,CONACTH                                                       
         B     TRAPERR                                                          
TACC30   CLC   =C'DIS',CONACT      DISPLAY ONLY                                 
         BE    TACCX                                                            
...
*                                  CL2 CODE FOR EOD HANDLING                    
         ...
         DC    X'03',AL1(34,10),X'B4250000C0',C'    '           LIST            
         DC    X'FF'                                                            
         EJECT                                                                  
       ++INCLUDE DDSPOOLD                                                       
         EJECT                                                                  
