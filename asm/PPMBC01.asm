*          DATA SET PPMBC01    AT LEVEL 128 AS OF 07/09/14                      
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
* SMYE 04/14/10 FIX OLD AND ERRONEOUS COMPARE PACK INSTRUCTION                  
*               WHICH NOW CAUSES A LEVEL 8 ASEMBLER ERROR                       
*                                                                               
* SMYE 04/20/06 FIX BUG IN RECLOOP - ALLOW CHANGES TO FIELDS BEGINNING          
*               WITH * FOR ACTION CHA ONLY - FIELDS BEGINNING WITH *            
*               WILL CONTINUE TO BE "SKIPPED" ON ACTION MBC                     
*                                                                               
* KWAN 09/09/05 FIX PCHGIND5 INITIALIZATION CODE                                
*                                                                               
* SMYE 09/03/04 ADD WEB INSERTION ORDERS TO LASTIO DISPLAY                      
*                                                                               
* BOBY 11/14/03 FIX PROBLEM WITH CHANGING AC ON NET COSTS                       
*                                                                               
* KWAN 10/17/02 CU DISPLAY BUG (COLUMN IS NOT PROPERLY CLEARED)                 
*                                                                               
* KWAN 07/22/02 FIX MASTER/SUB CLIENT RECORD LOCKING BUG                        
*                                                                               
* KWAN 06/17/02 REDUCE PRG SIZE AND CODES FOR CU LOOK UP                        
*                                                                               
* SMYE 04/19/02 PUBEDIT NOW CORE-RESIDENT                                       
*                                                                               
* SMYE 12/20/01 NO LONGER ISSUE LOCKS + NO UNLOCKING                            
*                                                                               
* KWAN 09/07/01 PRD GRP FILTERING (SVPGRP)                                      
*                                                                               
* KWAN 08/14/01 EXTENSION DATE                                                  
*                                                                               
* KWAN 08/08/01 EXCLUDE FROM TRAFFIC ("TRAFFIC?")                               
*                                                                               
* KWAN 07/09/01 LEGAL WARNING CODES                                             
*                                                                               
* SMYE 05/01    ADD LOGIC FOR DATA LOCKING (SEE RECLOOP IN RECUPDT)             
*                                                                               
* BPLA 04/01    ANOTHER VALUE FOR MBPROF+0 -                                    
*               X= SUPPRESS COST + NOT RATE ACCESS                              
*                                                                               
* BPLA 01/01    DISPLAY OF SERIAL NUMBER                                        
*                                                                               
* SMYE 12/00    ADD LOGIC FOR CLIENT FROZEN-BY-DATE FEATURE                     
*                                                                               
* KWAN 06/00    ADD AIMPS (SIMILAR TO EIMPS WHICH IS SAME AS IMPS)              
*                                                                               
...
*                                                                               
* BPLA 09/99    CHANGES FOR RATE CHANGES                                        
...
*                                                                               
* SMYE 08/99    DISALLOW CHANGE OF COST2 FACTOR TO ZERO (AT CHKCH27)            
*                                                                               
* KWAN 06/99    UPDATE CHANGE ELEM (X'24') FOR CT, PV AND IMPS CHANGES          
*                                                                               
* KWAN 06/99    CHECK DOLSW IS C'0' (NO DOLLAR TYPE IS ENTERED)                 
*                                                                               
* BPLA 05/99    ACTIVATE IMPS FOR ALL AGYS                                      
*                                                                               
* KWAN 04/99    ADD CODES FOR IMPRESSION (LIMIT TO SJ ONLY)                     
*                                                                               
* SMYE 03/99    CALL TO GETINS CHANGED AT SCRND20 TO DISPLAY                    
*               (CONDITIONALLY) OPEN RATES COST                                 
*                                                                               
* SMYE 02/99    COST2 FACTOR ADDED TO CHANGEABLE DATA                           
*                                                                               
* SMYE 04/98    PROTECTED STATUS FOR TEST BUYS OF A "FROZEN" CLIENT             
*               PCLTSTAT SAVED AT SVCLPROF+30 FOR USE IN SCRND67                
*                                                                               
* BPLA 03/98    CHANGE FOR EXPANDED CONIO TO 6000 BYTES FROM 3000               
*                                                                               
* SMYE 03/98    IN CHKCHA IF PUB LIST PRESENT IN JOB RECORD CHECK               
*               TO VERIFY BUY PUB IS IN PUBLIST RECORD                          
*                                                                               
* BPLA 01/98    ESTIMATE FILTER MOVED AGAIN                                     
*                                                                               
* BPLA 01/98    BILLED AND PAID FILTERS ADDED                                   
...
RDBD     CLI   PVSW,1                                                           
         ...
         BNE   RDBH                                                             
RDBD5    BRAS  RE,CHKCHA                                                        
*                                                                               
         CLI   CHASW,0             "SPECIAL" MSG ERROR FOUND IN CHKCHA?         
...
RDBD5C   LTR   R3,R3                                                            
         ...
         B     ERROR                                                            
*                                                                               
RDBE     BRAS  RE,RECUPDT                                                       
         LTR   R3,R3                                                            
         BZ    RDBE2                                                            
         LR    R2,R6                                                            
         B     ERROR                                                            
*                                                                               
RDBE2    OC    SVLSTKEY,SVLSTKEY                                                
         BNZ   RDBF                                                             
...
*                                                                               
* TO PERMIT SUCESSIVE CHANGES TO THE SAME BUYS                                  
*                                                                               
         MVI   LACTION,C'D'                                                     
...
RDBH     MVC   KEY,SVLSTKEY        MOVE LAST KEY READ TO KEY.                   
         ...
         XC    SVDISC,SVDISC                                                    
         B     RDB09               BRANCH TO SEQ READING                        
*                                                                               
RDBUYS   DS    0H                                                               
         MVC   WORKCLT,SVCLT                                                    
         CLI   SVCLT,C'*'          CK FOR OFFICE                                
         BE    RDB03                                                            
         CLC   SVCLT,=C'ALL'                                                    
         BNE   RDB05                                                            
RDB03    XC    WORKCLT,WORKCLT                                                  
         BRAS  RE,GETNCLT          GET FIRST CLIENT                             
         OC    WORKCLT,WORKCLT                                                  
         BZ    RDBXX               NONE FOUND                                   
*                                                                               
RDB05    DS    0H                                                               
...
*                                                                               
         CLI   SVPUB+4,X'FF'       CK FOR ALL ZONES/EDTS                        
         BNE   *+8                                                              
...
RDB3     BRAS  RE,SEQ                                                           
*                                                                               
RDB4     OC    KEY+21(3),KEY+21    PASSIVE BUYS?                                
...
RDB5     CLC   SVPRD,=C'ALL'                                                    
         ...
         B     RDB2                                                             
*                                                                               
RDB6     CLI   DATESW,C'I'         IF DATESW IS I, CK INSERTION DATES           
         BNE   RDB61X                                                           
         CLC   KEY+16(3),SVSTRTB   CK DATES                                     
         BNL   RDB61A                                                           
...
RDB61X   CLC   SVEST,=C'ALL'                                                    
         ...
         B     RDB3                SEQ READ                                     
*                                                                               
RDB6A    OC    SVPGRP,SVPGRP       ANYTHING IN PRD GRP FILTER?                  
         BZ    *+12                                                             
         BRAS  RE,FLTPGRP          CK FOR PRD GRP FILTER                        
         BNE   RDB4                ALREADY SKIPPED TO NEXT CLT                  
*                                                                               
         MVC   SVLSTKEY,KEY        READ BUY RECORD                              
         BRAS  RE,GETREC                                                        
*                                                                               
         TM    KEY+25,X'80'        DELETED? (MAY GET IF SVIOSW IS ON)           
         BZ    RDB6A0                                                           
*                                                                               
         CLI   SVIOSW,0                                                         
         BE    RDB6A0              CODE BELOW IF SWITCH IS SET                  
*                                                                               
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'70'                                                     
         BRAS  RE,NXTELEM          WITH DATE EXISTS                             
         BNE   RDB6A0              BRANCH AND GET NEXT REC                      
         OC    2(3,R2),2(R2)       DATE FIELD IN '70' ELEM?                     
...
*                                                                               
RDB6A1X  DS    0H                                                               
         OC    SVREF,SVREF         CK REF NUMBER FILTER                         
         BZ    RDB6A2C             NONE, GO CHK FOR T/S STATUS FILTER           
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'83'                                                     
         BRAS  RE,NXTELEM                                                       
         BNE   RDB6A2                                                           
         CLI   SVREF,X'FF'         LOOKING FOR BUYS WITHOUT REF?                
         BE    RDB6T               SKIP IF HAS REF                              
         MVC   WORK(10),2(R2)                                                   
         OC    WORK(10),=CL10' '                                                
         CLC   SVREF,WORK          MATCHES REF FILTER?                          
         BE    RDB6A2C                                                          
         B     RDB6T               SKIP                                         
*                                                                               
* GET HERE IF THERE IS NO REF ELEM                                              
*                                                                               
RDB6A2   CLI   SVREF,X'FF'         LOOKING FOR BUYS WITHOUT REF?                
         BE    RDB6A2C                                                          
         B     RDB6T               SKIP                                         
*                                                                               
RDB6A2C  DS    0H                                                               
...
*                                                                               
RDB6A2E  CLI   SVTSTAT,C' '        LOOKING FOR BUYS WITH T/S STATUS?            
...
RDB6A4   CLI   DATASW,C'C'         SEE IF DOING CU=                             
         ...
         BE    RDB6T                                                            
*                                                                               
RDB6A5   OC    SVADC,SVADC         CK ADCODE FILTER                             
         BZ    RDB6B                                                            
         CLC   SVADC(6),=C'NONE  ' LOOKING FOR NO ADCODES?                      
         BNE   RDB6A6                                                           
         OC    PBDJOB,PBDJOB                                                    
         BZ    RDB6B                                                            
         CLC   PBDJOB,=6C' '                                                    
...
RDB6A6   MVC   WORK(6),SVADC                                                    
         ...
         BNE   RDB6T                                                            
*                                                                               
RDB6B    DS    0H                  CK SFH (SPECIAL FINANCIAL HANDLING)          
...
*                                                                               
RDB6C    OC    SVSTAT,SVSTAT       CK FOR STATUS FILTER                         
         BZ    RDB6C1                                                           
         CLI   SVSTAT,C'T'                                                      
         BNE   RDB6C0                                                           
         CLI   PBDBFD,C'T'                                                      
...
*                                                                               
RDB6C1   OC    SVPUBL,SVPUBL       CK PUB LIST FILTER                           
         BZ    RDB6C2                                                           
         CLC   PBDLIST,SVPUBL                                                   
         BNE   RDB6T               NO MATCH SKIP THIS BUY                       
*                                                                               
RDB6C2   CLI   SVNV,0              CK FOR LETTER FILTER                         
         BNE   RDB6C2C                                                          
...
RDB6C2C  LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'25'                                                     
         BRAS  RE,NXTELEM                                                       
         OC    2(3,R2),2(R2)       CK FOR PAY ELEM WITH DATE                    
...
RDB6C4   DS    0H                                                               
         ...
         CLI   1(R2),19            COMMENT LESS THAN 17 BYTES?                  
...
*                                                                               
         ...
         EX    R1,COMOUT                                                        
         BNE   RDB6T                                                            
         BE    RDB6C4X             CAN SKIP SPACE FILTER CK (NOT BOTH)          
*                                                                               
COMOUT   CLC   SVOUT2(0),WORK      EXECUTED                                     
*                                                                               
RDB6C4S  DS    0H                                                               
         OC    SVSPACE,SVSPACE     SPACE FILTER                                 
         BZ    RDB6C4X                                                          
*                                                                               
...
*                                                                               
         ...
         B     CKINCH                                                           
*                                                                               
SC1COMP  CLC   SVSPACE+1(0),PBYOSPC1                                            
UNTCOMP  CLC   SVSPACE+1(0),PBYOUNTS                                            
*                                                                               
CKINCH   CLI   PBDUIND,X'89'       INCHES WITH 2 DECIMALS?                      
...
RDB6C4S7 DS    0H                                                               
         LHI   R1,6                                                             
         CLI   SVSLEN,X'FF'        SPECIAL COMPARE LENGTH ENTERED?              
         BE    RDB6C4S8                                                         
...
RDB6C4Y  DS    0H                  HERE IF MATCHES FILTER                       
         CLI   SVSPACE,C'-'        NEGATIVE FILTER?                             
         BE    RDB6T                                                            
         B     RDB6C4X                                                          
*                                                                               
RDB6C4N  DS    0H                                                               
         CLI   SVSPACE,C'-'        NEAGTIVE FILTER?                             
         BE    RDB6C4X                                                          
         B     RDB6T                                                            
         DROP  R4                                                               
*                                                                               
RDB6C4X  DS    0H                                                               
         CLI   DATESW,C'I'         INSERTION DATE?                              
         BE    RDB6C8                                                           
*                                                                               
         CLI   DATESW,C'O'         ONSALE DATE?                                 
         BNE   RDB6D                                                            
         CLI   PRSW,1              CHK FOR PRIOR                                
         BE    RDB6C5                                                           
         CLC   PBDSDATE,SVSTRTB                                                 
         BL    RDB6T                                                            
RDB6C5   CLI   SUBSW,1             CK FOR SUBSEQUENT                            
         BE    RDB6C8                                                           
         CLC   PBDSDATE,SVENDB                                                  
         BH    RDB6T                                                            
RDB6C8   MVC   KEY,SVLSTKEY                                                     
         ...
         B     RDB7                                                             
*                                                                               
RDB6D    CLI   DATESW,C'C'         CLOSING DATE?                                
         BNE   RDB6F                                                            
         CLI   PRSW,1              CK FOR PRIOR                                 
         BE    RDB6D5                                                           
         CLC   PBDCDATE,SVSTRTB                                                 
         BL    RDB6T                                                            
*                                                                               
RDB6D5   CLI   SUBSW,1             CK FOR SUBSEQUENT                            
         BE    RDB6D8                                                           
         CLC   PBDCDATE,SVENDB                                                  
         BH    RDB6T                                                            
RDB6D8   MVC   KEY,SVLSTKEY                                                     
         ...
         B     RDB7                                                             
*                                                                               
RDB6F    CLI   DATESW,C'B'         BILLING DATE?                                
         BNE   RDB6G                                                            
         CLI   PRSW,1              CK DOING PRIOR                               
         BE    RDB6F5                                                           
         CLC   PBDBDATE,SVSTRTB                                                 
         BL    RDB6T                                                            
RDB6F5   CLI   SUBSW,1             CK DOING SUBSEQUENT                          
         BE    RDB6F8                                                           
         CLC   PBDBDATE,SVENDB                                                  
         BH    RDB6T                                                            
RDB6F8   MVC   KEY,SVLSTKEY                                                     
         ...
         B     RDB7                                                             
*                                                                               
RDB6G    CLI   DATESW,C'M'         MAT CLOSE DATE?                              
         BNE   RDB6H                                                            
         CLI   PRSW,1              CK DOING PRIOR                               
         BE    RDB6G5                                                           
         CLC   PBDMDATE,SVSTRTB                                                 
         BL    RDB6T                                                            
RDB6G5   CLI   SUBSW,1             CK DOING SUBSEQUENT                          
         BE    RDB6G8                                                           
         CLC   PBDMDATE,SVENDB                                                  
         BH    RDB6T                                                            
...
RDB6H    CLI   DATESW,C'P'         IF DATESW IS P CHECK PAYING DATES            
         ...
         BL    RDB6T                                                            
*                                                                               
RDB6H5   CLI   SUBSW,1             CK DOING SUBSEQUENT                          
         BE    RDB6H8                                                           
         CLC   PBDPDATE,SVENDB                                                  
         BH    RDB6T                                                            
...
RDB6I    CLI   DATESW,C'S'         IF DATESW IS S CHECK SHIP DATE               
         ...
         BL    RDB6T                                                            
*                                                                               
RDB6I5   CLI   SUBSW,1             CK DOING SUBSEQUENT                          
         BE    RDB6I8                                                           
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'86'        SHIP DATE ELEM                               
         BRAS  RE,NXTELEM                                                       
...
*                                                                               
RDB7     DS    0H                  ESTIMATE CHECK MOVED TO RDB4                 
         CLI   SVBILL,0            BILLED FILTER SET?                           
         BE    RDB7P                                                            
*                                                                               
RDB7B    DS    0H                                                               
         ...
         BNE   RDB7P                                                            
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'26'        X'26' (BILL) ELEM WITH DATE EXISTS?          
RDB7B2   BRAS  RE,NXTELEM                                                       
         BNE   RDB3                SKIP THIS BUY                                
         OC    5(3,R2),5(R2)                                                    
         BZ    RDB7B2              PASSING BILLING CHECK                        
         TM    10(R2),X'C0'        IGNORE REVERSALS AND REVERSED                
         BM    RDB7B2                                                           
         B     RDB7P               GO CK PAID FILTER                            
*                                                                               
* CK FOR TOTALLY BILLED (SVBILL = "T") COULD GO HERE                            
*                                                                               
RDB7P    DS    0H                                                               
         ...
         BNE   RDB8                                                             
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'25'        X'26' (BILL) ELEM WITH DATE EXISTS?          
RDB7P2   BRAS  RE,NXTELEM                                                       
         BNE   RDB3                SKIP THIS BUY                                
         OC    2(3,R2),2(R2)                                                    
         BZ    RDB7P2                                                           
*                                                                               
* CK FOR TOTALLY PAID (SVPAID = "T") COULD GO HERE                              
*                                                                               
RDB8     DS    0H                                                               
...
SETCCEQ  CR    RB,RB               EQUAL                                        
         J     *+6                                                              
SETCCNEQ LTR   RB,RB               NOT EQUAL (ERROR)                            
EXIT_X   XIT1                                                                   
X_R3     XIT1  REGS=(R3)                                                        
X_R3R4   XIT1  REGS=(R3,R4)                                                     
X_R3R6   XIT1  REGS=(R3,R6)                                                     
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
CHKCHA   NTR1                                                                   
         ...
         MVI   PUBDTTAB,X'FF'                                                   
*                                                                               
         MVC   COUNT,=H'16'        USED IN ASC                                  
         LA    R7,SVDISC                                                        
         LA    R6,MBCDT01H                                                      
         SR    R3,R3                                                            
*                                                                               
CHKLP1   OC    0(4,R7),0(R7)       DISC ADDRRESS?                               
         BZ    CHKXIT              IF NOT EXIT                                  
*                                                                               
         TM    1(R6),X'20'         HAS THE FIELD BEEN PROTECTED.                
         BO    CHKLP9              IF YES SKIP TO NEXT                          
*                                                                               
* SPECIAL CASES FOR IMPRESSION ELEMS                                            
*                                                                               
         CLI   DATASW,C'I'         EIMPS/IMPS?                                  
         BE    *+12                                                             
         CLI   DATASW,C'6'         AIMPS?                                       
         BNE   CHKLP1AH                                                         
*                                                                               
         CLC   =C'DEL',8(R6)       DELETING IMPRESSION ELEMS?                   
         BE    CHKLP9              IT'S OK TO DO SO                             
         CLI   ACTION,C'M'                                                      
         BNE   CHKLP1AH            NOT ACTION MBC                               
         CLI   5(R6),0                                                          
         BE    FLDERR              CANNOT DEL IMPS ELEMS BY BLANK-OUT           
*                                                                               
* END OF IMPRESSION ELEMS SPECIAL CASES                                         
*                                                                               
CHKLP1AH TM    4(R6),X'20'         HAS FIELD BEEN ALTERED?                      
...
CHKLP1B  DS    0H                                                               
         ...
         BNE   CHKLP2                                                           
*                                                                               
CHKLP1D  MVI   ELCODE,X'70'        CAN'T BE REMOVED IF '70' ELEM                
         BRAS  RE,NXTELEM          WITH DATE EXISTS                             
         BNE   CHKLP1K             CK FOR EIO ELEM                              
         OC    2(3,R2),2(R2)       DATE FIELD IN X'70' ELEM?                    
         BZ    CHKLP1K             CK FOR EIO ELEM                              
CHKLP1F  LA    R3,JOBERR1          ERROR - CAN'T REMOVE ADCODE                  
         B     CHKXIT              IF I/O PRINTED                               
*                                                                               
CHKLP1K  LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,PWIOELCQ     LOOK FOR EIO ELEM                            
         BRAS  RE,NXTELEM                                                       
...
*                                                                               
         ...
         USING PJOBREC,R4                                                       
*                                                                               
         OC    PJOBSTA,PJOBSTA     CK FOR START/END DATES                       
         BZ    CHKLP6C                                                          
...
CHKLP6C  OC    PJOBEND,PJOBEND                                                  
         ...
         B     CHKLP6E                                                          
*                                                                               
CHKLP6H  DS    0H                  CK FOR BUY PUB IN PUBLIST RECORD             
...
*                                                                               
         XC    MBCEMSG,MBCEMSG                                                  
         MVC   MBCEMSG(49),=C'** INVALID - NO RECORD FOUND FOR PUB LIST+        
               = *** **'                                                        
         MVC   MBCEMSG+43(3),PJOBPLIS                                           
         FOUT  MBCEMSGH                                                         
...
*                                                                               
CHKLP6T  BRAS  RE,SEQ              NEXT RECORD                                  
         CLC   KEY(10),KEYSAVE     SAME AGY/MED/RC/CLT/LIST?                    
         BE    CHKLP6N             YES - GET THE RECORD                         
*                                                                               
         XC    MBCEMSG,MBCEMSG                                                  
         MVC   MBCEMSG(48),=C'** INVALID - PUBLICATION NOT IN PUB LIST=+        
                *** **'                                                         
         MVC   MBCEMSG+42(3),KEYSAVE+7                                          
         FOUT  MBCEMSGH                                                         
         MVI   CHASW,C'P'          "SPECIAL" ERROR MESSAGE INDICATOR            
         B     CHKXIT                                                           
*                                                                               
...
*                                                                               
CHKLP7W  DS    0H                  CK AD SPACE VS BUY, SET WARNING IND          
...
CHKCH17  CLI   SVAPROF+24,C'B'     BOTH CLOSING AND MAT DATES REQUIRED          
         BE    CHKCH17M                                                         
         JIF   DATASW,EQ,C'4',AND,SVAPROF+24,EQ,C'R',CHKCH17M,JUMP=N            
         JIF   DATASW,EQ,C'5',AND,SVAPROF+24,EQ,C'M',CHKCH17M,JUMP=N            
*                                                                               
         CLI   5(R6),0             CHK FOR INPUT                                
         BE    CHKCH90             NOT REQUIRED                                 
*                                                                               
CHKCH17C XC    KEY,KEY             IF INPUT CAN'T PRECEED INS DATE              
         MVC   KEY+27(4),0(R7)                                                  
         BRAS  RE,GETREC                                                        
...
CHKCH25  CLI   DATASW,C'8'                                                      
         BNE   CHKCH27                                                          
         TM    4(R6),X'20'         PREVIOUSLY VALIFATED?                        
         BO    CHKCH90             IF NO BRANCH TO NEXT                         
         ZIC   R4,5(R6)                                                         
         LTR   R4,R4               ANY INPUTS?                                  
         BZ    CHKCH90                                                          
         ...
         LTR   R1,R1                                                            
         BM    FLDERR              CAN'T BE MINUS                               
         CLC   DMCB+5(3),=X'0186A0'                                             
         BNH   CHKCH90                                                          
         B     FLDERR              MAX IS 100.000                               
*                                                                               
CHKCH27  CLI   DATASW,C'B'         COST 2 FACTOR                                
         ...
         CLC   DMCB+4(4),=X'0098967F'                                           
         BNH   CHKCH90                                                          
         B     FLDERR              MAX IS 9.999999                              
*                                                                               
CHKCH30  CLI   DATASW,C'C'         CONTRACT UNITS                               
         ...
         BZ    CHKCH90                                                          
*                                                                               
         XC    KEY,KEY             MUST READ BUY TO CK PBDSPACE                 
         MVC   KEY+27(4),0(R7)                                                  
         BRAS  RE,GETREC                                                        
*                                                                               
         ...
         BNZ   FLDERR                                                           
*                                                                               
CHKCH35  CLC   DMCB+4(4),=X'00FFFFFF'                                           
         BNH   CHKCH90                                                          
         B     FLDERR              MAX IS 1677.7215                             
*                                                                               
CHKCH40  DS    0H                                                               
         BRAS  RE,CHKPDRI          CK PLANNED COST,DLC,RPT,IMPS                 
         CLI   BYTE3,0             DATASW IS NOT "P,D,T,I,6,V,K"?               
         BE    CHKCH48                                                          
         CLI   BYTE3,1             FIELD IS INVALID?                            
         BE    FLDERR                                                           
         CLI   BYTE3,2             NO ERROR FOUND OR NO INPUTS?                 
         BE    CHKCH90                                                          
         DC    H'0'                NO OTHER RETURN CODES                        
*                                                                               
CHKCH48  DS    0H                                                               
         CLI   DATASW,C'F'         FSI                                          
         BNE   CHKCH49                                                          
...
*                                                                               
         XC    KEY,KEY             MUST READ BUY                                
         MVC   KEY+27(4),0(R7)     TO CK LOOK-UP OF FSI                         
         BRAS  RE,GETREC                                                        
*                                                                               
         BRAS  RE,FINDFSI          THIS WILL BE SURE FSI CAN                    
         LA    R3,FSIERR                                                        
...
*                                                                               
         ...
         B     CHKCH90                                                          
*                                                                               
CHKCH52C BRAS  RE,EDTRTN                                                        
         LTR   R3,R3               CK FOR ERROR                                 
         BNZ   CHKXIT                                                           
         B     CHKCH90                                                          
*                                                                               
CHKCH80  DS    0H                                                               
         BRAS  RE,CHKLEGW          PASSES BACK BYTE3                            
         CLI   BYTE3,0             DATASW IS NOT HANDLED BY CHKLEGW?            
         BE    CHKCH81                                                          
         CLI   BYTE3,01            INVALID INPUT?                               
         BE    FLDERR                                                           
         CLI   BYTE3,02            INVALID DATE?                                
         BE    INVDATE                                                          
         CLI   BYTE3,03            EXDATE IS NOT ON/BEFORE INS DATE?            
         BE    EXDTERR                                                          
         CLI   BYTE3,99            NO ERROR FOUND OR NO INPUT?                  
         BE    CHKCH90                                                          
         DC    H'0'                NO OTHER RETURN CODES                        
*                                                                               
CHKCH81  DS    0H                                                               
         BRAS  RE,CHKNTRA          CK "TRAFFIC?" (PASSES BACK BYTE3)            
         CLI   BYTE3,0             DATASW IS NOT "Z"?                           
         BE    CHKCH82                                                          
         CLI   BYTE3,1             ERROR IN "TRAFFIC?" INPUTS?                  
         BE    FLDERR                                                           
         CLI   BYTE3,2             NO ERROR FOUND OR NO INPUTS?                 
         BE    CHKCH90                                                          
         DC    H'0'                NO OTHER RETURN CODES                        
*                                                                               
CHKCH82  DS    0H                  FUTURE USES                                  
*                                                                               
...
FLDERR   LA    R3,FLDINV                                                        
         B     CHKXIT                                                           
*                                                                               
INVDATE  LA    R3,DTEINV                                                        
         B     CHKXIT                                                           
*                                                                               
EXDTERR  LA    R3,8                EXDATE MUST BE ON/BEFORE INS DATE            
         B     CHKXIT                                                           
*                                                                               
RLOCKED  LA    R3,DATALOCK         RECORD IS LOCKED                             
         B     CHKXIT                                                           
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
GETNCLT  NTR1                      ROUTINE TO GET NEXT CLIENT                   
         XC    KEY,KEY                                                          
         MVC   KEY(2),AGYALPHA                                                  
         MVC   KEY+2(1),SVMED                                                   
         MVI   KEY+3,X'02'                                                      
...
*                                                                               
         ...
         LA    R2,PCLTREC+33       FIRST ELEM IS ALWAYS X'02'                   
         MVI   ELCODE,X'15'                                                     
         BRAS  RE,NXTELEM                                                       
         BNE   GETNC14                                                          
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FINDFSI  NTR1                      RETURNS FSI NUMBER IN DUB(6)                 
         ZAP   DUB(6),=P'0'                                                     
         XC    KEY,KEY                                                          
         MVC   KEY(3),PBUYREC                                                   
         MVI   KEY+3,X'27'                                                      
...
WARN     DS    CL1                                                              
*                                                                               
LKUPKEY  DS    XL16                KEY FOR CLT, CLT/PUB LOCK TESTING            
LOCKSW   DS    XL1                 "Y" = LOCK HAS BEEN TESTED AND SET           
*                                                                               
         EJECT                                                                  
*                                                                               
...
*                                                                               
         CLI   SVDLSW,0            PASS DELETED RECS WHEN DEL SW IS ON          
         JE    *+8                                                              
...
DATALOCK EQU   158                 DATA LOCKED FOR OFFLINE PROCESSING           
*                                                                               
         LTORG                                                                  
         DROP  RB                                                               
         EJECT                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FLTPGRP  NTR1  BASE=*,LABEL=*      CKING FOR PRD GRP FILTER                     
*                                                                               
         MVI   FLTPSW,0            INITIALIZE Y/N SWITCH                        
*                                                                               
         CLI   KEY+3,X'20'         BUY KEY?                                     
         BNE   *+14                                                             
         MVC   FLTPRD,KEY+07       GET PRD CODE                                 
         B     FLTP05                                                           
*                                                                               
         CLI   KEY+3,X'21'         PASSIVE BUY KEY?                             
         BNE   *+14                                                             
         MVC   FLTPRD,KEY+13       GET PRD CODE                                 
         B     FLTP05                                                           
*                                                                               
         DC    H'0'                BAD BUY KEY!                                 
*                                                                               
FLTP05   MVC   FLTPKEYS(64),KEY    SAVE KEY/KEYSAVE                             
         XC    KEY,KEY                                                          
         MVC   KEY(3),FLTPKEYS                                                  
         MVI   KEY+3,X'3B'                                                      
         MVC   KEY+4(3),FLTPKEYS+04                                             
         MVC   KEY+7(3),FLTPRD                                                  
         OC    KEY+7(6),=C'      ' SPACE FILL                                   
*                                                                               
         MVC   KEY+13(1),SVPGRP    ALPHA PORTION OF SCHEME CODE                 
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(14),KEYSAVE     CHECK THRU GROUP ID                          
         BNE   FLTPNO                                                           
         MVC   WORK(4),=C'      '  REUSE SPACES LITERAL                         
         LA    R1,4                                                             
*                                                                               
         LA    R2,SVPGRP+1         NUMERIC PORTION OF SCHEME CODE               
*                                                                               
         LA    R3,WORK                                                          
         MVC   WORK(5),=C'00000'                                                
...
FLTP50   DS    0H                                                               
         ...
         B     FLTPNO                                                           
*                                                                               
FLTP60   DS    0H                  ONLY GROUP ID IS ENTERED                     
*                                                                               
FLTPYES  MVI   FLTPSW,C'Y'         PROPER GROUP                                 
         MVC   KEY(32),FLTPKEYS                                                 
         GOTO1 HIGH                                                             
         MVC   KEYSAVE(32),FLTPKEYS+32                                          
         B     FLTPXIT                                                          
*                                                                               
FLTPNO   MVI   FLTPSW,C'N'         NOT IN GROUP                                 
         ...
         CLI   KEY+3,X'20'         BUY KEY?                                     
         BNE   *+12                                                             
         MVI   KEY+10,X'FF'        WILL SKIP TO NEXT CLIENT                     
         B     FLTPNO20                                                         
*                                                                               
         CLI   KEY+3,X'21'         PASSIVE BUY KEY?                             
         BNE   *+12                                                             
         MVI   KEY+16,X'FF'        WILL SKIP TO NEXT CLIENT                     
         B     FLTPNO20                                                         
*                                                                               
         DC    H'0'                BAD BUY KEY!                                 
*                                                                               
FLTPNO20 GOTO1 HIGH                                                             
*                                                                               
FLTPXIT  CLI   FLTPSW,C'Y'         SETS CC CODE                                 
         J     EXIT_X                                                           
*                                                                               
FLTPRD   DS    CL3                                                              
FLTPKEYS DS    CL64                                                             
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
CHKPDRI  NTR1  BASE=*,LABEL=*      PLANNED COST,DLC,RPT,IMPRESSION              
*                                                                               
         MVI   BYTE3,0                                                          
*                                                                               
         CLI   DATASW,C'P'         PLANNED COST?                                
         BNE   CKPDRI20                                                         
         TM    4(R6),X'20'         PREVIOUSLY MODIFIED?                         
         BO    CKPDRI90            IF NO BRANCH TO NEXT                         
         ZIC   R4,5(R6)                                                         
         LTR   R4,R4               ANY INPUTS?                                  
         BZ    CKPDRI90                                                         
         GOTO1 VCASHVAL,DMCB,(2,8(R6)),(R4)                                     
         CLI   DMCB,0                                                           
         BNE   CKPDRI85            INVALID FLD ERROR                            
         L     R1,DMCB+4                                                        
         LTR   R1,R1                                                            
         BM    CKPDRI85            INVALID FLD ERROR (CANNOT BE MINUS)          
         B     CKPDRI90                                                         
*                                                                               
CKPDRI20 DS    0H                                                               
         CLI   DATASW,C'D'         DLC?                                         
         BNE   CKPDRI40                                                         
         TM    4(R6),X'20'         PREVIOUSLY VALIDATED?                        
         BO    CKPDRI90                                                         
         ZIC   R4,5(R6)                                                         
         LTR   R4,R4               ANY INPUTS?                                  
         BZ    CKPDRI90                                                         
         ...
         BH    CKPDRI85            INVALID FLD ERROR                            
         CVD   R1,DUB                                                           
         DP    DUB,=P'100'                                                      
         CP    DUB+6(2),=P'0'      REMAINDER 0?                                 
         BNE   CKPDRI85            INVALID FLD ERROR                            
         B     CKPDRI90                                                         
*                                                                               
CKPDRI40 DS    0H                                                               
...
*                                                                               
CKPDRI60 DS    0H                                                               
         CLI   DATASW,C'I'         IMPRESSION? (ALSO ESTIMATED, EIMPS)          
         BE    CKPDRI65                                                         
         CLI   DATASW,C'6'         ACTUAL IMPRESSION? (AIMPS)                   
         BE    CKPDRI65                                                         
         CLI   DATASW,C'V'         PAGE VIEWS?                                  
         BE    CKPDRI65                                                         
         CLI   DATASW,C'K'         CLICK THRUS?                                 
         BNE   CKPDRI80            DATASW IS NOT "P,D,T,I,6,V,K"                
*                                                                               
CKPDRI65 DS    0H                                                               
         TM    4(R6),X'20'         PREVIOUSLY VALIDATED?                        
         BO    CKPDRI90                                                         
...
*                                                                               
         ...
         L     R1,DMCB+4                                                        
         LTR   R1,R1                                                            
         BM    CKPDRI85            INVALID FLD ERROR (NO NEGATIVES)             
*                                                                               
...
*                                                                               
         ...
         B     CKPDRI90                                                         
*                                                                               
CKPDRI80 MVI   BYTE3,0             DATASW IS NOT "P,D,T,I,6,V,K"                
         B     CHKPDRIX                                                         
*                                                                               
CKPDRI85 MVI   BYTE3,1             WILL BRANCH TO INVALID FLD ERROR             
         B     CHKPDRIX                                                         
*                                                                               
CKPDRI90 MVI   BYTE3,2             WILL BRANCH TO CHKCH90                       
*                                                                               
CHKPDRIX J     EXIT_X                                                           
*                                                                               
         LTORG                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
* THIS ROUTINE CHECKS FOLLOWING DATASW(S):      (NOTE: CAN ADD MORE)            
*                                                                               
* DATASW = W    LEGAL WARNINGS         X'94' ELEM (PLEGALWEL)                   
* DATASW = 9    EXTENSION DATE         X'96' ELEM (PEXDATEL )                   
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
CHKLEGW  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         MVI   BYTE3,0                                                          
         CLI   DATASW,C'W'         LEGAL WARNINGS?                              
         BNE   CHKEXDT             NO                                           
*                                                                               
         TM    4(R6),X'20'         PREVIOUSLY VLIDATED?                         
         BO    CHKLW90                                                          
         ZIC   R4,5(R6)                                                         
         LTR   R4,R4               ANY INPUTS?                                  
         BZ    CHKLW90                                                          
*                                                                               
         CHI   R4,3                CHECK IF "DEL" IS ENTERED                    
         BH    CHKLW30                                                          
         CLC   =C'DEL',8(R6)       DEL IS ENTERED?                              
         BE    CHKLW90                                                          
*                                                                               
CHKLW30  CHI   R4,5                MORE THAN 5 CHARS?                           
         BH    CHKLW85                                                          
         CHI   R4,4                NONE IS ENTERED?                             
         BNE   CHKLW35                                                          
         CLC   =C'NONE',8(R6)      X=NONE FOR LEGAL WARNING CODE?               
         BNE   CHKLW85                                                          
         B     CHKLW90                                                          
*                                                                               
CHKLW35  CLI   8(R6),C'A'                                                       
         BE    CHKLW40                                                          
         CLI   8(R6),C'B'                                                       
         BE    CHKLW40                                                          
         CLI   8(R6),C'C'                                                       
         ...
         BNE   CHKLW85                                                          
         CHI   R4,1                                                             
         BH    CHKLW85             ONLY 1 CHAR INPUT FOR "X"                    
         B     CHKLW90                                                          
*                                                                               
CHKLW40  CHI   R4,1                INPUT LENGTH IS ONE?                         
         BE    CHKLW90             YES, NO NEED TO CHK QUARTERLY CODE           
         CHI   R4,2                INPUT LENGTH IS TWO?                         
         BE    CHKLW50             YES, GO CHECK QUARTERLY CODE                 
         CLC   =C'NONE',9(R6)      X=NONE FOR QUARTERLY CODE?                   
         BNE   CHKLW85                                                          
         B     CHKLW90                                                          
*                                                                               
CHKLW50  CLI   9(R6),C'X'          X=NONE?                                      
         BE    CHKLW90                                                          
         CLI   9(R6),C'1'                                                       
         BL    CHKLW85             LOWER THAN CHAR 1 IS NO GOOD                 
         CLI   9(R6),C'4'                                                       
         BH    CHKLW85             HIGHER THAN CHAR 4 IS ALSO NO GOOD           
         B     CHKLW90                                                          
*                                                                               
CHKEXDT  DS    0H                  CHECK FOR EXTENSION DATE                     
         CLI   DATASW,C'9'         EXTENSION DATE?                              
         BNE   CHKEXDTX            NO                                           
*                                                                               
         TM    4(R6),X'20'         PREVIOUSLY VLIDATED?                         
         BO    CHKLW90                                                          
...
*                                                                               
         CHI   R4,4                                                             
         BNE   *+14                                                             
         CLC   =C'NONE',8(R6)      REMOVING EXTENSION DATE ELEM?                
         BE    CHKLW90                                                          
*                                                                               
         GOTO1 VDATVAL,DMCB,(0,8(R6)),WORK                                      
         OC    0(4,R1),0(R1)                                                    
         BZ    CHKLW86             INVALID DATE                                 
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY+27(4),0(R7)     FROM DISC ADDR GET BUY REC                   
         BRAS  RE,GETREC                                                        
*                                                                               
         GOTO1 VDATCON,DMCB,(0,WORK),(3,WORK+10)                                
         CLC   WORK+10(3),PBUYKDAT                                              
         BH    CHKLW87             INVALID DATE (HIGHER THAN INS DATE)          
         B     CHKLW90                                                          
*                                                                               
CHKEXDTX DS    0H                  END OF EXTENSION DATE                        
*                                                                               
         B     CHKLWX              OTHER DATASW IS NOT HANDLED HERE             
*                                                                               
CHKLW85  MVI   BYTE3,01            WILL BRANCH TO INVALID FLD ERROR             
         B     CHKLWX                                                           
*                                                                               
CHKLW86  MVI   BYTE3,02            WILL BRANCH TO INVALID DATE ERROR            
         B     CHKLWX                                                           
*                                                                               
CHKLW87  MVI   BYTE3,03            WILL BRANCH TO EXTENSION DATE ERR            
         B     CHKLWX                                                           
*                                                                               
CHKLW90  MVI   BYTE3,99            WILL BRANCH TO CHKCH90                       
*                                                                               
CHKLWX   J     EXIT_X                                                           
*                                                                               
         LTORG                                                                  
...
*                                                                               
         MVI   BYTE3,0                                                          
         CLI   DATASW,C'Z'         "TRAFFIC?"?                                  
         BNE   CHKNT80                                                          
*                                                                               
         TM    1(R6),X'20'         FIELD IS PROTECTED?                          
         BO    CHKNT90                                                          
         TM    4(R6),X'20'         PREVIOUSLY VLIDATED?                         
         BO    CHKNT90                                                          
*                                                                               
         CLI   5(R6),3             MORE THAN 3 CHARS?                           
         BH    CHKNT85             YES, INVALID                                 
*                                                                               
         CLI   5(R6),1             JUSY Y/N CHARACTER IS ENTERED?               
         BNE   CHKNT30                                                          
         CLI   8(R6),C'Y'                                                       
         BE    CHKNT90                                                          
         CLI   8(R6),C'N'                                                       
...
CHKNT30  CLI   5(R6),2                                                          
         BNE   CHKNT40                                                          
         CLC   =C'NO',8(R6)        "NO" IS ENTERED?                             
         BE    CHKNT90                                                          
         B     CHKNT85             INVALID                                      
*                                                                               
CHKNT40  CLI   5(R6),3                                                          
         BNE   CHKNT85                                                          
         CLC   =C'YES',8(R6)       "YES" IS ENTERED?                            
         BE    CHKNT90                                                          
         B     CHKNT85             INVALID                                      
*                                                                               
CHKNT80  MVI   BYTE3,0             DATASW IS NOT "Z"                            
         B     CHKNTX                                                           
*                                                                               
CHKNT85  MVI   BYTE3,1             WILL BRANCH TO INVALID FLD ERROR             
         B     CHKNTX                                                           
*                                                                               
CHKNT90  MVI   BYTE3,2             WILL BRANCH TO CHKCH90                       
*                                                                               
CHKNTX   J     EXIT_X                                                           
*                                                                               
         LTORG                                                                  
...
*                                                                               
         MVI   LOCKSW,0            CLEAR LOCK INDICATOR                         
*                                                                               
...
*                                                                               
         CLC   MBCACT(3),=C'CHA'   ACTION CHANGE (NOT MBC) ?                    
         BE    RECL00              YES - CONTINUE                               
*                                  ** BELOW INSTRUCTION ONLY FOR MBC            
         CLI   8(R6),C'*'          MEANS SKIP THIS BUY (MBC ONLY)               
         BE    RECUP90                                                          
*                                                                               
RECL00   DS    0H                                                               
*                                                                               
...
*                                                                               
TSTLOCK  DS    0H                                                               
         CLI   LOCKSW,C'Y'         LOCK ALREADY TESTED AND SET ?                
         BE    RECUP05             YES - SKIP PAST LOCK TESTING                 
*                                                                               
         L     RF,ACOMFACS                                                      
...
TSTLK4   XC    LKUPKEY,LKUPKEY                                                  
         ...
         BNE   TSTLK5              NO - TEST FOR ONE PUB LOCK                   
         XC    LOCKPUB,LOCKPUB     FOR LOCK ON ANY PUB FOR THIS MED/CLT         
*                                                                               
...
TSTLK6   GOTO1 (RF),DMCB,('LKTESTQ',LKUPKEY),ACOMFACS                           
         ...
         BE    TSTLK6                                                           
*                                                                               
         B     TSTLKOK             DO NOT ADD LOCK (12/20/01)                   
*                                                                               
         XC    LKUPKEY,LKUPKEY     ADD AN APPROPRIATE LOCK                      
         LA    R3,LKUPKEY                                                       
         USING LKKEYD,R3                                                        
         MVC   LOCKAGY,AGYALPHA                                                 
         ...
         XC    LOCKPUB,=4X'FF'     COMPLEMENT TO ELIMINATE X'00'                
         CLC   SVPUB(3),=C'ALL'    SEE IF DOING ALL PUBS                        
         BNE   TSTLK9              NO - LOCK ONE PUB ONLY                       
         XC    LOCKPUB,LOCKPUB     CLEAR PUB                                    
         MVC   LOCKRTY,=C'BC'      SET TO CLIENT LOCK FOR ALL PUBS              
*                                                                               
TSTLK9   GOTO1 (RF),DMCB,('LKLOCKQ',LKUPKEY),ACOMFACS                           
         CLI   4(R1),1             TEST LOCKED                                  
         BE    RLOCKED             RECORD LOCKED MESSAGE                        
         CLI   4(R1),2             TEST TABLE BUSY                              
         BE    TSTLK9                                                           
         CLI   4(R1),0             ANY OTHER ERROR  SEND                        
         BNE   RLOCKED             RECORD LOCKED MESSAGE                        
*                                                                               
TSTLKOK  DS    0H                  REC NOT LOCKED - OK TO CONTINUE              
         MVI   LOCKSW,C'Y'         INDICATE LOCK TESTED AND SET                 
         SR    R3,R3               CLEAR "ERROR" REG                            
         DROP  R3                                                               
*                                                                               
RECUP05  MVI   CHADTIND,0                                                       
         ...
         BNZ   RECUP08                                                          
         CLI   5(R6),0             CK FOR INPUT                                 
         BE    RECUP90             NO JOB, NO NEED TO WRITE BACK REC            
*                                                                               
         CLC   8(11,R6),=C'NONE       '                                         
         BE    RECUP90                                                          
*                                                                               
...
* FIND AND STORE FSI DATA ON JOB CHANGES                                        
*                                                                               
         BRAS  RE,FSILOOK                                                       
         MVC   PBDJOB,8(R6)                                                     
         OC    PBDJOB,=6C' '                                                    
...
RECUP10C CLI   8(R6),C'L'                                                       
         BE    *+6                                                              
         DC    H'0'                                                             
         OI    1(R6),X'20'         PROTECT FLD, NO MORE TEST                    
         OI    6(R6),X'80'         ALSO SET FLD STATUS CHANGE                   
*                                                                               
...
RECUP12  CLI   DATASW,C'L'         NV LETTER                                    
         ...
         OI    PBDLETR,X'01'                                                    
*                                                                               
RECUP12C CLC   SAVFLD,PBDLETR      CK FOR 'REAL' CHANGE                         
         BE    RECUP90             NONE                                         
...
RECUP14  CLI   DATASW,C'X'         SPECIAL FINANCIAL HANDLING (SFH)             
         ...
         OI    PBDSTAT,X'08'                                                    
*                                                                               
RECUP14C CLC   SAVFLD(1),PBDSTAT   CK FOR 'REAL' CHANGE                         
         BE    RECUP90             NONE                                         
         OI    CHADTIN4,X'80'      SFH STATUS CHANGE                            
         B     RECUP84             GO TO CHG ELEM (X'24') LOGIC                 
*                                                                               
* SKIPS X'24' ELEM LOGIC                                                        
*                                                                               
RECUP15  DS    0H                                                               
...
*                                                                               
RECUP16C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP16E                                                         
...
*                                                                               
         ...
         MVC   PTSHCDAT,BTODAY     SET TODAY AS LAST CHG IN OLD ELEM            
         MVC   PTSHPID,SVMBCPID    PERSONAL ID                                  
*                                                                               
...
RECUP16J XC    WORK(40),WORK                                                    
         ...
         MVC   WORK+PTSHPID-PTSHTEL(2),SVMBCPID                                 
         MVC   WORK+PTSHBID-PTSHTEL(3),=C'   '                                  
...
RECUP17  DS    0H                                                               
         ...
         MVC   SAVFLD(10),2(R2)                                                 
*                                                                               
RECUP17C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP17E                                                         
...
RECUP18  DS    0H                                                               
         ...
         MVC   SAVFLD(6),2(R2)                                                  
*                                                                               
RECUP18C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP18E                                                         
...
RECUP19  DS    0H                                                               
         ...
         DROP  R2                                                               
*                                                                               
RECUP19C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP19E                                                         
...
*                                                                               
         GOTO1 VRECUP,DMCB,(1,PBUYREC),(R2)                                     
         BRAS  RE,CLEAREND                                                      
         B     RECUP85             NOT RECUP84 SINCE NO X'24' ELEM CHG          
*                                                                               
RECUP19E DS    0H                                                               
         ZAP   DUB(6),=P'0'                                                     
         CLI   5(R6),1                                                          
...
RECUP25  DS    0H                                                               
         ...
         MVC   SAVFLD(5),2(R2)                                                  
*                                                                               
RECUP25C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP25E                                                         
...
*                                                                               
         B     RECUP58                                                          
*                                                                               
RECUP57C MVC   PBDACP,DUB+5        SAVE NEW AC                                  
*                                                                               
...
*                                                                               
         ...
         BNE   RECUP58D                                                         
*                                                                               
*        AC CHANGED FOR A NET BUY                                               
*                                                                               
*       'NET DOWN' OLD GROSS USING OLD AC                                       
*                                                                               
         CP    SAVFLD(3),=P'0'     SKIP IF OLD AC WAS ZERO                      
         BE    RECUP58B                                                         
*                                                                               
         ZAP   DUB,PBDCOS                                                       
         CVB   R1,DUB                                                           
...
RECUP58B DS    0H                                                               
*                                                                               
*       'NET UP' OLD NET USING NEW AC                                           
*                                                                               
         CP    PBDACP,=P'0'        SKIP IF NEW AC ZERO?                         
         BE    RECUP58D                                                         
*                                                                               
...
*                                                                               
RECUP60C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP60E                                                         
...
RECUP61  DS    0H                                                               
         ...
         MVC   SAVFLD(3),2(R2)                                                  
*                                                                               
RECUP61C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP61E                                                         
...
*                                                                               
RECUP62  DS    0H                                                               
         CLI   DATASW,C'I'         IMPRESSION (IMPS OR EIMPS)                   
         BE    RECUP62A                                                         
         CLI   DATASW,C'6'         ACTUAL IMPRESSION (AIMPS)                    
         BE    RECUP62A                                                         
         CLI   DATASW,C'V'         PAGE VIEWS                                   
...
RECUP62A DS    0H                                                               
         ...
         CLI   DATASW,C'I'         IMPRESSION (IMPS OR EIMPS)                   
         BE    RECUP62B                                                         
         MVI   ELCODE,X'93'        MUST BE ACTUAL IMPRESSION (AIMPS)            
*                                                                               
RECUP62B BRAS  RE,NXTELEM                                                       
         BNE   RECUP62C                                                         
         MVC   SAVFLD(5),2(R2)     PL5                                          
*                                                                               
RECUP62C CLI   5(R6),0             CK FOR INPUT                                 
         BNE   RECUP62E                                                         
...
* DELETE ELEMENT                                                                
*                                                                               
RPDEL50  OI    CHADTIN4,X'20'      CT,PV,IMPS/EIMPS,AIMPS CHANGED               
*                                                                               
         GOTO1 VRECUP,DMCB,(1,PBUYREC),(R2)                                     
         BRAS  RE,CLEAREND                                                      
         B     RECUP84                                                          
*                                                                               
RECUP62E DS    0H                                                               
         CLI   DATASW,C'I'         IMPRESSION (IMPS/EIMPS) ALLOW ZERO           
         BE    *+12                                                             
         CLI   DATASW,C'6'         ACTUAL IMPRESSION (AIMPS) ALLOW ZERO         
         BNE   *+14                                                             
         CLC   =C'DEL',8(R6)       SEE IF DELETING EIMPS OR AIMPS ELEMS         
...
*                                                                               
         ...
         BE    RECUP62D            GO REMOVE OLD ELEM (IF NECESSARY)            
*                                                                               
RECUP62F OC    SAVFLD(5),SAVFLD    SEE IF ELEMENT ALREADY EXISTED               
         BZ    RECUP62H            NO                                           
         CLC   SAVFLD(5),DUB+3                                                  
         BE    RECUP90             NO CHANGE                                    
         MVC   2(5,R2),DUB+3                                                    
*                                                                               
         OI    CHADTIN4,X'20'      CT,PV,IMPS/EIMPS,AIMPS CHANGED               
*                                                                               
         B     RECUP84                                                          
*                                                                               
RECUP62H LA    R2,PBUYREC+33                                                    
         ...
         BE    RECUP62I                                                         
         MVI   ELCODE,X'92'                                                     
         CLI   DATASW,C'I'         IMPRESSION (IMPS/EIMPS)                      
         BE    RECUP62I                                                         
         MVI   ELCODE,X'93'        MUST BE ACTUAL IMPRESSION (AIMPS)            
*                                                                               
RECUP62I BRAS  RE,NXTELEM                                                       
         BNE   RECUP62J                                                         
         DC    H'0'                THERE CAN'T BE AN ELEMENT NOW                
*                                                                               
...
*                                                                               
         ...
         CLI   DATASW,C'I'         IMPRESSION (IMPS/EIMPS)                      
         BE    RECUP62K                                                         
         MVC   WORK(2),=X'9307'    MUST BE ACTUAL IMPRESSION (AIMPS)            
*                                                                               
...
*                                                                               
         ...
         BE    RECUP63N                                                         
*                                                                               
* NON-NEWSPAPERS DATASW MUST BE $ SINCE OTHERS ARE DISALLOWED IN MBC00          
*                                                                               
         BRAS  RE,EDTRTM                                                        
*                                                                               
RECUP63E DS    0H                                                               
...
*                                                                               
         MVC   SAVFLD(5),PBDCOS    SAVE CHANGED COST & INDICATORS               
         MVC   SAVFLD+5(1),PBDCOSTY                                             
         MVC   SAVFLD+6(1),PBDCTYP                                              
         MVC   SAVFLD+7(1),PBDRLIND                                             
         MVC   SAVFLD+8(1),PBDCOSIN                                             
...
*                                                                               
         BRAS  RE,ASR                                                           
*                                                                               
         MVC   PBDCOS,SAVFLD       RESTORE CHANGED COST & INDICATORS            
         MVC   PBDCOSTY(1),SAVFLD+5                                             
...
*                                                                               
         B     RECUP84                                                          
*                                                                               
RECUP63N BRAS  RE,EDTRTN           NEWSPAPER RATE EDIT                          
         B     RECUP63E            REST SAME AS NON-NEWS                        
*                                                                               
RECUP63X DS    0H                                                               
         BRAS  RE,EDTLEGW          PASSES BACK BYTE3                            
         CLI   BYTE3,0             DATASW IS NOT HANDLED BY EDTLEGW?            
         BE    RECUP64                                                          
         CLI   BYTE3,1             FIELD IS IS CHANGED?                         
         BE    RECUP84                                                          
         CLI   BYTE3,2             ANY REAL CHANGES?                            
         BE    RECUP90                                                          
         DC    H'0'                NO OTHER RETURN CODES FROM EDTLEGW           
*                                                                               
RECUP64  DS    0H                                                               
         BRAS  RE,EDTNTRA          "TRAFFIC?" (PASSES BACK BYTE3)               
         CLI   BYTE3,0             DATASW IS NOT "Z"?                           
         BE    RECUP65                                                          
         CLI   BYTE3,1             PBDSTAT IS CHANGED (X'20' BIT)?              
         BE    RECUP84                                                          
         CLI   BYTE3,2             NO REAL CHANGE TO PBDSTAT?                   
         BE    RECUP90                                                          
         DC    H'0'                NO OTHER RETURN CODES FROM EDTNTRA           
*                                                                               
RECUP65  DS    0H                  FOR FUTURE USES                              
         DC    H'0'                INVALID DATASW                               
*                                                                               
RECUP84  BRAS  RE,UPREC                                                         
*                                                                               
RECUP85  BRAS  RE,CKEIOELM         CK EIO ELEM                                  
*                                                                               
         BRAS  RE,PUTREC                                                        
*                                                                               
         TM    CHADTIN2,X'08'      AD CODE IS CHANGED?                          
         BZ    *+8                                                              
...
CLEAREND ST    RE,FULL                                                          
         MVC   HALF,REC+25                                                      
         LH    RE,HALF             RECORD LENGTH                                
         LA    R0,REC                                                           
         AR    R0,RE               STARTING POINT TO BE CLEARED                 
         LHI   R1,4000                                                          
         SR    R1,RE               NUMBER OF BYTE(S) TO BE CLEARED              
         SR    RE,RE                                                            
         SR    RF,RF                                                            
...
*                                                                               
         LTORG                                                                  
         DROP  RB,R9               SECOND BASE REGISTER IN RECUPDT              
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
* THIS ROUTINE EDITS FOLLOWING DATASW(S):      (NOTE: CAN ADD MORE)             
*                                                                               
* DATASW = W    LEGAL WARNINGS         X'94' ELEM (PLEGALWEL)                   
* DATASW = 9    EXTENSION DATE         X'96' ELEM (PEXDATEL )                   
*                                                                               
* NOTE: ALL ERRORS ARE CHECKED IN CHKLEGW                                       
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTLEGW  NTR1  BASE=*,LABEL=*      BYTE3 WILL PASS RETURNED CONDITIONS          
*                                                                               
         MVI   BYTE3,0                                                          
         CLI   DATASW,C'W'         LEGAL WARNINGS?                              
         BNE   EDTEXDT                                                          
*                                                                               
         ...
         MVC   SAVFLD(2),2(R2)                                                  
*                                                                               
         CLI   5(R6),0             ANY INPUTS?                                  
         BNE   EDTLW20                                                          
EDTLW05  OC    SAVFLD(2),SAVFLD    ELEM EXIST?                                  
         BZ    EDTLW95             NO - THEN NO CHANGE                          
*                                                                               
         OI    CHADTIN4,X'08'      LEGAL WARNINGS HAS BEEN CHANGED              
*                                                                               
* REMOVE ELEMENT                                                                
*                                                                               
         GOTO1 VRECUP,DMCB,(1,PBUYREC),(R2)                                     
...
*                                                                               
EDTLW20  DS    0H                                                               
         CLC   =C'DEL',8(R6)       REMOVING LEGAL WARNING ELEM?                 
         BE    EDTLW05             GO REMOVE OLD ELEM (IF NECESSARY)            
*                                                                               
         XC    DUB,DUB                                                          
         CLC   =C'NONE',8(R6)      X=NONE, SUPPRESSING LEGAL WARNINGS?          
         BNE   *+12                                                             
         MVI   DUB,C'X'                                                         
         B     EDTLW25                                                          
*                                                                               
         CLI   5(R6),5             X=NONE, SUPPRESSING QUARTERLY?               
         BNE   *+18                                                             
         MVC   DUB(1),8(R6)                                                     
         MVI   DUB+1,C'X'                                                       
         B     EDTLW25                                                          
*                                                                               
         CLI   5(R6),1             ONLY LEGAL WARNING COMMENT CODE?             
         BNE   *+14                                                             
         MVC   DUB(1),8(R6)                                                     
         B     EDTLW25                                                          
*                                                                               
         CLI   5(R6),2             BOTH LW & QUARTERLY COMMENT CODES?           
         BNE   *+14                                                             
         MVC   DUB(2),8(R6)                                                     
         B     EDTLW25                                                          
         DC    H'0'                                                             
*                                                                               
EDTLW25  OC    SAVFLD(2),SAVFLD    ELEMENT ALREADY EXISTED?                     
         BZ    EDTLW30             NO                                           
         CLC   SAVFLD(2),DUB                                                    
         BE    EDTLW95             NO CHANGE                                    
*                                                                               
         MVC   2(2,R2),DUB                                                      
         OI    CHADTIN4,X'08'      LEGAL WARNINGS HAS BEEN CHANGED              
         B     EDTLW90                                                          
*                                                                               
EDTLW30  LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'94'                                                     
         BRAS  RE,NXTELEM                                                       
         BNE   *+6                                                              
         DC    H'0'                THERE CAN'T BE AN ELEMENT NOW                
*                                                                               
         XC    WORK(12),WORK                                                    
         MVC   WORK(2),=X'9404'    ELEMENT CODE AND LENGTH                      
         MVC   WORK+2(2),DUB       LW & QUARTERLY CODES                         
*                                                                               
         GOTO1 VRECUP,DMCB,(1,PBUYREC),WORK,(R2)                                
*                                                                               
         OI    CHADTIN4,X'08'      LEGAL WARNINGS HAS BEEN CHANGED              
         B     EDTLW90                                                          
*                                                                               
EDTEXDT  DS    0H                  EDITING EXTENSION DATE                       
         CLI   DATASW,C'9'         EXTENSION DATE?                              
         BNE   EDTEXDTX                                                         
*                                                                               
         XC    SAVFLD(3),SAVFLD                                                 
...
*                                                                               
         CLI   5(R6),0             ANY INPUTS?                                  
         BNE   EDTEXD20                                                         
EDTEXD10 OC    SAVFLD(3),SAVFLD    ELEM EXIST?                                  
         BZ    EDTLW95             NO - THEN NO CHANGE                          
*                                                                               
* REMOVE ELEMENT                                                                
*                                                                               
...
EDTEXD20 DS    0H                                                               
         CLC   =C'NONE',8(R6)      REMOVING EXTENSION DATE ELEM?                
         BE    EDTEXD10            GO REMOVE OLD ELEM (IF NECESSARY)            
*                                                                               
         XC    DUB,DUB                                                          
         GOTO1 VDATVAL,DMCB,(0,8(R6)),WORK                                      
         GOTO1 VDATCON,DMCB,(0,WORK),(3,DUB)                                    
*                                                                               
EDTEXD25 OC    SAVFLD(3),SAVFLD    ELEMENT ALREADY EXISTED?                     
         BZ    EDTEXD30            NO                                           
         CLC   DUB(3),SAVFLD                                                    
         BE    EDTLW95             NO 'REAL' CHANGE                             
*                                                                               
         MVC   2(3,R2),DUB                                                      
         B     EDTLW90                                                          
*                                                                               
EDTEXD30 LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'96'                                                     
         BRAS  RE,NXTELEM                                                       
         BNE   *+6                                                              
         DC    H'0'                THERE CAN'T BE AN ELEMENT NOW                
*                                                                               
         XC    WORK(12),WORK                                                    
         MVC   WORK(2),=X'9605'    ELEMENT CODE AND LENGTH                      
         MVC   WORK+2(3),DUB       EXTENSION DATE                               
*                                                                               
         GOTO1 VRECUP,DMCB,(1,PBUYREC),WORK,(R2)                                
         B     EDTLW90                                                          
*                                                                               
EDTEXDTX DS    0H                  END OF EXTENSION DATE                        
         B     EDTLWX                                                           
*                                                                               
EDTLW90  MVI   BYTE3,1             WILL BRANCH TO RECUP84                       
         B     EDTLWX                                                           
*                                                                               
EDTLW95  MVI   BYTE3,2             WILL BRANCH TO RECUP90                       
*                                                                               
EDTLWX   J     EXIT_X                                                           
*                                                                               
ELWCLR   DS    0H                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTNTRA  NTR1  BASE=*,LABEL=*      BYTE3 WILL PASS RETURNED CONDITIONS          
*                                                                               
         MVI   BYTE3,0                                                          
         CLI   DATASW,C'Z'         "TRAFFIC?"?                                  
         BNE   EDTNTX                                                           
...
*                                                                               
         CLI   8(R6),C'Y'                                                       
         BNE   EDTNT20                                                          
         TM    PBDSTAT,X'20'       "TRAFFIC?" IS YES?                           
         BZ    EDTNT95             NO REAL CHANGE                               
         NI    PBDSTAT,X'FF'-X'20' TURN BIT OFF                                 
         B     EDTNT90                                                          
*                                                                               
EDTNT20  CLI   8(R6),C'N'                                                       
         BNE   EDTNT40                                                          
         TM    PBDSTAT,X'20'       "TRAFFIC?" IS NO?                            
         BO    EDTNT95             NO REAL CHANGE                               
         OI    PBDSTAT,X'20'       TURN BIT ON                                  
         B     EDTNT90                                                          
*                                                                               
EDTNT40  DC    H'0'                NO OTHER VALID INPUTS                        
*                                                                               
         DROP  R2                                                               
*                                                                               
EDTNT90  MVI   BYTE3,1             WILL BRANCH TO RECUP84                       
         B     EDTNTX                                                           
*                                                                               
EDTNT95  MVI   BYTE3,2             WILL BRANCH TO RECUP90                       
*                                                                               
EDTNTX   J     EXIT_X                                                           
*                                                                               
         LTORG                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTRTM   NTR1  BASE=*,LABEL=*      SUBROUTINE TO EDIT MAGAZINE RATES            
*                                                                               
         LR    R2,R6               ADDRESS OF FIELD HEADER                      
...
*                                                                               
         ...
         BNE   EDTRXIT6                                                         
*                                                                               
         CP    PBDACP,=P'0'        GROSS UP COST, UNLESS NO AC                  
...
*                                                                               
SCRLOOP  OC    0(4,R7),0(R7)       CK FOR A DISC ADDRESS                        
         JZ    SCRNDX              IF NONE EXIT                                 
*                                                                               
...
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY+27(4),0(R7)     GETREC ASSUMES DISK ADDR IN KEY+27           
         BRAS  RE,GETREC                                                        
*                                                                               
         LA    RE,PBUYREC                                                       
         TM    27(RE),X'80'        CK IF RECORD IS DELETED                      
         BZ    SCRND1                                                           
         CLI   SVDLSW,C'D'                                                      
         BNE   SCRND1                                                           
         OI    1(R6),X'20'         PROTECT FIELD CHANGE                         
         OI    6(R6),X'20'         PROTECT FIELD CHANGE                         
         OI    6(R6),X'80'         TRANSMIT STATUS CHANGE                       
*                                                                               
SCRND1   DS    0H                                                               
*                                                                               
...
*                                                                               
         GOTO1 VPUBEDIT,DMCB,((R4),PBUYKPUB),12(R5)                             
*                                                                               
SCRND5D  MVC   HALF,PBUYKEST       ESTIMATE NUMBER                              
         ...
         CLI   DATASW,C'X'         SFH BUY?                                     
         BNE   SCRND5X             NO                                           
*                                                                               
         LA    R4,32(R5)           POINT R4 TO SPACE AFTER ESTIMATE             
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'25'        IF 25 (PAY) ELEM WITH DATE EXISTS            
SCRND5DL BRAS  RE,NXTELEM                                                       
         BNE   SCRND5K                                                          
         OC    2(3,R2),2(R2)                                                    
         BZ    SCRND5DL                                                         
...
SCRND5K  LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'26'        IF 26 (BILL) ELEM WITH DATE EXISTS           
SCRND5KL BRAS  RE,NXTELEM                                                       
         BNE   SCRND5X                                                          
         OC    5(3,R2),5(R2)                                                    
         BZ    SCRND5KL                                                         
         TM    10(R2),X'C0'        IGNORE REVERSALS AND REVERSED                
...
*                                                                               
SCRND5X  CLI   DATESW,C'O'         ON-SALE?                                     
         BNE   SCRND10                                                          
         OC    PBDSDATE,PBDSDATE                                                
         BZ    SCRND20                                                          
         GOTO1 VDATCON,DMCB,(3,PBDSDATE),(5,34(R5))                             
         B     SCRND20                                                          
*                                                                               
SCRND10  CLI   DATESW,C'B'         BILLABLE?                                    
         BNE   SCRND12                                                          
         GOTO1 VDATCON,DMCB,(3,PBDBDATE),(5,34(R5))                             
         B     SCRND20                                                          
*                                                                               
SCRND12  CLI   DATESW,C'P'         PAYABLE?                                     
         BNE   SCRND14                                                          
         GOTO1 VDATCON,DMCB,(3,PBDPDATE),(5,34(R5))                             
         B     SCRND20                                                          
*                                                                               
SCRND14  CLI   DATESW,C'C'         CLOSING?                                     
         BNE   SCRND15                                                          
         OC    PBDCDATE,PBDCDATE                                                
         BZ    SCRND20                                                          
         GOTO1 VDATCON,DMCB,(3,PBDCDATE),(5,34(R5))                             
         B     SCRND20                                                          
*                                                                               
SCRND15  CLI   DATESW,C'M'         MATERIALS CLOSING?                           
         ...
         BZ    SCRND20                                                          
         GOTO1 VDATCON,DMCB,(3,PBDMDATE),(5,34(R5))                             
         B     SCRND20                                                          
*                                                                               
SCRND15S CLI   DATESW,C'S'         SHIP DATE?                                   
         ...
         B     SCRND20                                                          
*                                                                               
SCRND16  GOTO1 VDATCON,DMCB,(3,PBUYKDAT),(5,34(R5))                             
         CLI   PBUYKLIN,1                                                       
         BNH   SCRND20                                                          
         MVI   42(R5),C'-'                                                      
...
*                                                                               
         LA    RE,PBUYREC                                                       
         TM    27(RE),X'80'                                                     
         BZ    SCRND20A            REC IS NOT DELETED                           
*                                                                               
         MVI   33(R5),C'D'         INDICATING DELETED (FRONT OF INS DT)         
*                                                                               
SCRND20A DS    0H                  GO TO GETINS BEFORE PPBYOUT                  
         LA    R4,PBUYREC+7                                                     
...
SCRND22C BRAS  RE,NXTELEM                                                       
         BNE   SCRND22F            GO TEST FOR X'71' WEB INS/ORDERS             
         OC    2(3,R2),2(R2)                                                    
         BZ    SCRND22C            NO INSERTION DATE, TRY NEXT X'70'            
         CLC   TEMP+2(3),2(R2)                                                  
         BH    SCRND22C            NOT LAST INSERTION DATE, NEXT X'70'          
         MVC   TEMP(11),0(R2)                                                   
         B     SCRND22C            CHECK NEXT X'70' UNTIL NO MORE               
*                                                                               
SCRND22F DS    0H                  TEST FOR X'71' WEB INS/ORDERS                
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'71'        WEB INSERTION ORDER ELEM CODE                
SCRND22H BRAS  RE,NXTELEM                                                       
         BNE   SCRND22M            NO MORE ELEMS                                
         OC    2(3,R2),2(R2)                                                    
         BZ    SCRND22H            NO INSERTION DATE, TRY NEXT X'71'            
         CLC   TEMP+2(3),2(R2)                                                  
         BH    SCRND22H            NOT LAST INSERTION DATE, NEXT X'71'          
         MVC   TEMP(11),0(R2)                                                   
         B     SCRND22H            CHECK NEXT X'71' UNTIL NO MORE               
*                                                                               
SCRND22M DS    0H                                                               
         OC    TEMP(11),TEMP                                                    
...
*                                                                               
         CLI   TEMP,X'71'          WEB INSERTION ORDER ELEM ?                   
         BE    SCRND22Q            YES - DIFFERENT NUMBER FORMATTING            
*                                  FORMAT NON-WEB INS/ORDER NUMBER              
...
*                                                                               
         ...
         OI    DUB+7,X'0F'                                                      
         UNPK  67(4,R5),DUB                                                     
         MVI   71(R5),C' '         DONE WITH REFERENCE NUMBER PART              
         CLI   TEMP+10,C'N'                                                     
         BNE   *+10                                                             
         MVC   72(3,R5),=C'NEW'                                                 
         CLI   TEMP+10,C'C'                                                     
         ...
         BNE   *+10                                                             
         MVC   72(3,R5),=C'CAN'                                                 
         B     SCRND22X            DONE WITH LAST INS/ORD                       
*                                                                               
SCRND22Q DS    0H                  FORMAT WEB INS/ORDER NUMBER                  
*                                                                               
         MVC   58(1,R5),SVMED      SET MEDIA                                    
*                                                                               
         SR    RF,RF                                                            
         IC    RF,TEMP+5           GET IO# YEAR                                 
         CVD   RF,DUB                                                           
         OI    DUB+7,X'0F'         FORCE SIGN                                   
         UNPK  59(2,R5),DUB        SET YEAR                                     
*                                                                               
         LA    RF,PBUYREC                                                       
         MVC   61(3,R5),4(RF)      SET CLIENT                                   
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,7,TEMP+6         GET SEQUENCE NUMBER                          
         CVD   RF,DUB                                                           
         OI    DUB+7,X'0F'         FORCE SIGN                                   
         UNPK  64(4,R5),DUB        SEQUENCE NUMBER                              
*                                                                               
         OC    TEMP+9(1),TEMP+9    SKIP IF NO REVISION NUMBER                   
         BZ    SCRND22X            DONE WITH LAST INS/ORD                       
*                                                                               
         MVI   68(R5),C'-'          SET DASH                                    
*                                                                               
         MVC   69(3,R5),=C'REV'     REVISION INDICATOR                          
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,TEMP+9         GET REVISION NUMBER                          
         CVD   RF,DUB                                                           
         OI    DUB+7,X'0F'         FORCE SIGN                                   
         UNPK  72(3,R5),DUB        SEQUENCE NUMBER                              
         B     SCRND22X            DONE                                         
*                                                                               
...
SCRND25  DS    0H                                                               
         ...
         BE    SCRND38             OMIT EVEN IF REQUESTED WITH $=               
         CLI   MBPROF+0,C'X'       SUPPRESSING COST?                            
         BE    SCRND38             OMIT EVEN IF REQUESTED WITH $=               
*                                                                               
         CLI   PBDCTYP,C'N'        BOUGTH WITH A NET RATE?                      
         BNE   *+8                                                              
...
SCRND39C BRAS  RE,NXTELEM          EXISTS, CAN'T CHANGE FROM                    
...
SCRND40  CLI   DATASW,C'A'         JOBCODE                                      
         BNE   SCRND45                                                          
*                                                                               
         TM    PBDSTAT,X'20'       "TRAFFIC?" BIT IS ON (NO TRAFFIC)?           
         BZ    SCRND45D                                                         
         OC    PBDJOB,PBDJOB       ADCODE PRESENT? (IT SHOULDN'T...)            
         BZ    *+14                                                             
         MVC   8(11,R6),=C'* ERROR!! *'                                         
         B     *+10                                                             
         MVC   8(11,R6),=C'* NO TRAF *'                                         
         OI    4(R6),X'20'         VALIDATED PREVIOUSLY                         
         B     SCRND45H                                                         
*                                                                               
SCRND45D MVC   8(6,R6),PBDJOB                                                   
         OI    4(R6),X'20'         VALIDATED PREVIOUSLY                         
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'35'        IF ELEM EXIST, NO ADD/DEL/CHG ADCODE         
         BRAS  RE,NXTELEM                                                       
         BNE   SCRND70                                                          
*                                                                               
SCRND45H OI    1(R6),X'20'         CHANGE FIELD TO PROTECTED                    
         OI    6(R6),X'80'         TRANSMIT STATUS CHANGE                       
         B     SCRND70                                                          
*                                                                               
...
SCRND47C CLI   DATASW,C'V'         PAGE VIEWS                                   
         ...
         BRAS  RE,NXTELEM                                                       
         BNE   SCRND70                                                          
         EDIT  (P5,2(R2)),(11,8(R6)),0,ALIGN=LEFT,ZERO=NOBLANK,        +        
               COMMAS=YES                                                       
         B     SCRND70                                                          
*                                                                               
SCRND47F CLI   DATASW,C'K'         CLICK THRUS                                  
         ...
         B     SCRND70                                                          
*                                                                               
SCRND47G CLI   DATASW,C'I'         IMPRESSION (IMPS/EIMPS)                      
         BNE   SCRND47T                                                         
         OI    4(R6),X'20'         VALIDATED PREVIOUSLY                         
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'92'                                                     
SCRND47K BRAS  RE,NXTELEM                                                       
         BNE   SCRND70                                                          
         EDIT  (P5,2(R2)),(11,8(R6)),0,ALIGN=LEFT,ZERO=NOBLANK,        +        
               COMMAS=YES                                                       
         B     SCRND70                                                          
*                                                                               
SCRND47T CLI   DATASW,C'6'         ACTUAL IMPRESSION (ACTUAL)                   
         BNE   SCRND48                                                          
         OI    4(R6),X'20'         VALIDATED PREVIOUSLY                         
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'93'                                                     
         B     SCRND47K            SAME AS IMPS                                 
*                                                                               
...
SCRND52B BRAS  RE,NXTELEM          DATE EXISTS, CAN'T CHANGE                    
...
SCRND54B BRAS  RE,NXTELEM          CAN'T CHANGE PAYING DATE                     
         BNE   SCRND70                                                          
         OC    2(3,R2),2(R2)                                                    
         BZ    SCRND54B                                                         
         OI    1(R6),X'20'         CHANGE FIELD TO PROTECTED                    
...
SCRND60  CLI   DATASW,C'7'                                                      
         BNE   SCRND65                                                          
         EDIT  (P2,PBDCD),(8,8(R6)),1,ALIGN=LEFT                                
...
SCRND65  CLI   DATASW,C'8'                                                      
         ...
         BNE   *+10                                                             
         ZAP   MYPK4,=P'100000'                                                 
         EDIT  (P4,MYPK4),(8,8(R6)),3,ALIGN=LEFT                                
...
*                                                                               
         ...
         BNE   SCRND67W            NOT FROZEN - GO SEE IF WSJ BUY               
         B     SC67FRZ             FROZEN FOR THIS MONTH ONLY                   
*                                                                               
SC67FORW CLC   PBUYKDAT(2),SVCLPROF+28                                          
         BL    SCRND67W            NOT FROZEN - GO SEE IF WSJ BUY               
         B     SC67FRZ             FROZEN FOR THIS MONTH & FORWARD              
*                                                                               
SC67PAST CLC   PBUYKDAT(2),SVCLPROF+28                                          
         BH    SCRND67W            NOT FROZEN - GO SEE IF WSJ BUY               
*                                                                               
SC67FRZ  DS    0H                                                               
...
*                                                                               
* BELOW CODE WILL PROTECT STATUS IF BUY IS BILLED,PAID,OR I/O'ED                
*                                                                               
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'70'                                                     
SCRND67C BRAS  RE,NXTELEM                                                       
         BNE   SCRND67D                                                         
         OC    2(3,R2),2(R2)                                                    
         BNZ   SCRND67P                                                         
         B     SCRND67C                                                         
...
SCRND67P DS    0H                                                               
*                                                                               
* PROTECT FIELD IF BILLED,PAID,INS ORDER OR WSJ BUY                             
*                                                                               
         OI    1(R6),X'20'         CHANGE FIELD TO PROTECTED                    
         OI    6(R6),X'80'         TRANSMIT STATUS CHANGE                       
         B     SCRND70                                                          
...
SCRND68  CLI   DATASW,C'C'         CONTRACT UNITS                               
         BNE   SCRND69                                                          
*                                                                               
         BRAS  RE,SCRCONUN         DISPLAY DEFAULT OR LOOKED UP CU              
*                                                                               
         MVI   8(R6),C'0'                                                       
...
SCRND69G CLI   DATASW,C'B'         COST 2 FACTOR                                
         ...
         BRAS  RE,NXTELEM                                                       
         BNE   SCRND70                                                          
         EDIT  (P5,2(R2)),(8,8(R6)),6,ALIGN=LEFT                                
         B     SCRND70                                                          
*                                                                               
...
SCRND69I CLI   PBUYKMED,C'N'       SEE IF NEWSPAPERS                            
         BNE   SCRND69K                                                         
         BRAS  RE,FMTRTN           TO FORMAT NEWSPAPER RATE ROUTINE             
...
*                                                                               
SCRND69K DS    0H                                                               
         BRAS  RE,FMTRTM           TO FORMAT NON-NEWSPAPER RATES                
...
SCRN69XX DS    0H                  END OF RATE DISPLAY                          
         BRAS  RE,SCRLEGW          WILL PROCESS LEGAL WARNINGS                  
         BE    SCRND70             LW PROCESSED, DONE                           
*                                                                               
         BRAS  RE,SCRNTRA          WILL PROCESS "TRAFFIC?"                      
         BE    SCRND70             "TRAFFIC?" PROCESSED, DONE                   
*                                                                               
         BRAS  RE,SCREXDT          WILL PROCESS EXTENSION DATE                  
         BE    SCRND70             EXDATE PROCESSED, DONE                       
*                                                                               
...
SCUPIXX  OI    1(R6),X'20'         PROTECT                                      
         ...
         B     SCRND70                                                          
*                                                                               
SCSERN   DS    0H                  SCREEN DISPLAY FOR SERIAL #                  
         CLI   DATASW,C'#'                                                      
         BNE   SCRNDERR                                                         
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'99'        SEARCH FOR UPLOAD ELEM                       
         BRAS  RE,NXTELEM                                                       
         BNE   SCSERN30            NO FOUND                                     
         USING PSERELED,R2                                                      
         EDIT  PSERNUM,(10,8(R6)),0,ALIGN=LEFT                                  
         B     SCSERNXX                                                         
         DROP  R2                                                               
*                                                                               
SCSERN30 MVC   8(4,R6),=C'NONE'    NO SERIAL # FOUND                            
*                                                                               
SCSERNXX OI    1(R6),X'20'         PROTECT                                      
         OI    6(R6),X'80'         TRANSMIT                                     
         B     SCRND70                                                          
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
SCRCONUN NTR1  BASE=*,LABEL=*      CU LOOK UP                                   
*                                                                               
         MVC   SVBUYCU,PBDCU       SAVE CU IN BUY RECORD                        
*                                                                               
         CLI   DATASW,C'C'         DISPLAYING CONTRACT UNITS?                   
         BE    SCRCU10                                                          
*                                                                               
* IN CASE TITLE IS CLEARED (DUE TO PROFILES ETC...)                             
*                                                                               
******** XC    MBCHD1+56(11),MBCHD1+56                                          
******** XC    MBCHD2+56(11),MBCHD2+56                                          
******** MVC   MBCHD1+56(11),=C'       COST'                                    
******** MVC   MBCHD2+56(11),=C'       ----'                                    
******** OI    MBCHD1H+6,X'80'                                                  
******** OI    MBCHD2H+6,X'80'                                                  
         B     SCRCUX              RESTORED TITLE AND NO CU DISPLAYED           
*                                                                               
SCRCU10  CLI   SVIOSW,C'Y'         DISPLAYING LASTIO?                           
         BE    SCRCUX              YES, CANNOT DISPLAY CU LOOK UP THEN          
*                                                                               
         CLC   MBCHD2+56(11),=C' DEFAULT CU'                                    
         BE    SCRCU30                                                          
         XC    MBCHD1+56(11),MBCHD1+56                                          
         XC    MBCHD2+56(11),MBCHD2+56                                          
         MVC   MBCHD1+56(11),=C' DEFAULT CU'                                    
         MVC   MBCHD2+56(11),=C' ----------'                                    
         OI    MBCHD1H+6,X'80'                                                  
         OI    MBCHD2H+6,X'80'                                                  
*                                                                               
SCRCU30  XC    64(11,R5),64(R5)    CLEAR FIELD FOR DEFAULT CU                   
*                                                                               
         OC    MBCCLT,=C'   '      SPACE PADDED CLIENT                          
         XC    KEY,KEY                                                          
         MVC   KEY(2),AGYALPHA                                                  
         MVC   KEY+2(1),MBCMDIA                                                 
         MVI   KEY+3,X'10'         CONTRACT RECORD CODE                         
         MVC   KEY+4(3),MBCCLT                                                  
         ...
         B     *+8                                                              
SCRCU35  BRAS  RE,SEQ                                                           
         CLC   KEYSAVE(13),KEY     SAME A/M/REC/CL/PUB?                         
         BNE   SCRCUX              NO CONTRACT FOUND                            
         MVC   AREC,ACONIO         READ INTO CONIO                              
         BRAS  RE,GETREC                                                        
...
*                                                                               
         XC    FULL,FULL                                                        
         XC    PBDCU,PBDCU         TO MAKE SURE CU IS LOOKED UP                 
         L     R2,ACONIO                                                        
         GOTO1 =V(PPGETCU),DMCB,PBUYREC,(R2),VDATAMGR,RR=RELO01                 
         CLI   DMCB,X'FF'                                                       
         JE    *+10                                                             
         MVC   FULL+1(3),DMCB+5    LAST 3 BYTES                                 
*                                                                               
         OC    FULL+1(3),FULL+1    LOOKED UP CU VALUE PRESENT?                  
         JZ    SCRCUX              NO, DONE DISPLAYING DEFAULT CU               
*                                                                               
         CLC   =X'000001',FULL+1    MEANS ZERO                                  
         JNE   *+14                                                             
         MVC   70(6,R5),=C'0.0000'                                              
         J     SCRCUX                                                           
*                                                                               
         EDIT  (B4,FULL),(9,66(R5)),4,ALIGN=RIGHT,ZERO=NOBLANK                  
*                                                                               
SCRCUX   MVC   PBDCU,SVBUYCU       RESTORE CU IN BUY RECORD                     
         J     EXIT_X                                                           
*                                                                               
SVBUYCU  DS    XL3                                                              
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
SCRLEGW  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         CLI   DATASW,C'W'         DISPLAYING LEGAL WARNINGS?                   
         BE    SCRLW10                                                          
*                                                                               
* IN CASE TITLE IS CLEARED (DUE TO PROFILES ETC...)                             
*                                                                               
...
******** OI    MBCHD1H+6,X'80'                                                  
******** OI    MBCHD2H+6,X'80'                                                  
         B     SCRLWERR            RESTORED TITLE AND NO LW DISPLAYED           
*                                                                               
SCRLW10  CLI   SVIOSW,C'Y'         DISPLAYING LASTIO?                           
         BE    SCRLW50             YES, CANNOT DISPLAY DEFAULT LW THEN          
*                                                                               
         CLC   MBCHD2+56(11),=C' DEFAULT LW'                                    
         BE    SCRLW30                                                          
         XC    MBCHD1+56(11),MBCHD1+56                                          
         XC    MBCHD2+56(11),MBCHD2+56                                          
         MVC   MBCHD1+56(11),=C' DEFAULT LW'                                    
         MVC   MBCHD2+56(11),=C' ----------'                                    
         OI    MBCHD1H+6,X'80'                                                  
         OI    MBCHD2H+6,X'80'                                                  
*                                                                               
SCRLW30  XC    KEY,KEY                                                          
         ...
         BE    SCRLW40                                                          
         MVC   64(11,R5),=C'** ERROR **'                                        
         B     SCRLW50                                                          
*                                                                               
SCRLW40  LA    R0,LWPRDREC                                                      
         LHI   R1,1000                                                          
         SR    RE,RE                                                            
         SR    RF,RF                                                            
         MVCL  R0,RE               SAME AS XCEF, ONLY SHORTER                   
*                                                                               
         ...
         ST    RE,AREC                                                          
*                                                                               
         XC    64(11,R5),64(R5)    CLEAR FIELD FOR DEFAULT LW & QU CODE         
*                                                                               
         LA    R2,LWPRDREC+33                                                   
...
*                                                                               
         CLI   LWINSDT,C'1'                                                     
         BNE   *+18                                                             
         MVC   73(1,R5),PPRDROTA+0                                              
         MVI   74(R5),C'1'                                                      
         B     SCRLW50                                                          
*                                                                               
         CLI   LWINSDT,C'2'                                                     
         BNE   *+18                                                             
         MVC   73(1,R5),PPRDROTA+1                                              
         MVI   74(R5),C'2'                                                      
         B     SCRLW50                                                          
*                                                                               
         CLI   LWINSDT,C'3'                                                     
         BNE   *+18                                                             
         MVC   73(1,R5),PPRDROTA+2                                              
         MVI   74(R5),C'3'                                                      
         B     SCRLW50                                                          
*                                                                               
         CLI   LWINSDT,C'4'                                                     
         BNE   *+18                                                             
         MVC   73(1,R5),PPRDROTA+3                                              
         MVI   74(R5),C'4'                                                      
         B     SCRLW50                                                          
*                                                                               
         DC    H'0'                NO OTHER QUARTER DIGITS!                     
         DROP  R2                                                               
*                                                                               
SCRLW50  XC    8(11,R6),8(R6)      CLEAR FIELD FOR LW & QU OVERRIDES            
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'94'        LEGAL WARNING ELEM CODE                      
         BRAS  RE,NXTELEM                                                       
         BNE   SCRLWX                                                           
         CLI   2(R2),C'X'          X=NONE, SUPPRESS LEGAL WARNINGS?             
         BE    SCRLW60                                                          
         MVC   8(1,R6),2(R2)       LEGAL WARNING COMMENT CODES                  
         CLI   3(R2),C'X'          X=NONE, SUPPRESS QUARTERLY?                  
         BE    *+14                                                             
         MVC   9(1,R6),3(R2)       LEGAL WARNING QUARTERLY CODES                
         B     SCRLWX                                                           
         MVC   9(4,R6),=C'NONE'                                                 
         B     SCRLWX                                                           
*                                                                               
SCRLW60  MVC   8(4,R6),=C'NONE'                                                 
*                                                                               
SCRLWX   J     SETCCEQ             EQUAL                                        
SCRLWERR J     SETCCNEQ            NOT EQUAL (ERROR)                            
*                                                                               
...
*                                                                               
LWPRDREC DS    1000C               RECORD AREA FOR PRODUCT                      
LWROTATE DS    CL4                 LW ROTATION CODES FROM PRD RECORD            
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
SCRNTRA  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         CLI   DATASW,C'Z'         DISPLAYING "TRAFFIC?"?                       
         BE    SCRNT10                                                          
*                                                                               
* IN CASE TITLE IS CLEARED (DUE TO PROFILES ETC...)                             
*                                                                               
...
******** OI    MBCHD1H+6,X'80'                                                  
******** OI    MBCHD2H+6,X'80'                                                  
         B     SCRNTERR            RESTORE TITLE, "TRAFFIC?" NOT DISP           
*                                                                               
SCRNT10  DS    0H                                                               
         LA    R2,PBUYREC+33                                                    
         CLI   0(R2),X'20'                                                      
...
*                                                                               
         USING PBDELEM,R2                                                       
         TM    PBDSTAT,X'20'       "TRAFFIC?" BIT IS ON?                        
         BO    *+14                                                             
         MVC   8(3,R6),=C'YES'                                                  
         B     SCRNT20                                                          
         MVC   8(2,R6),=C'NO'      NO TRAFFIC                                   
*                                                                               
SCRNT20  OC    PBDJOB,PBDJOB       AD CODE PRESENT?                             
         BZ    SCRNTX                                                           
         OI    1(R6),X'20'         AD CODE PRESENT, NO CHANGES ALLOWED          
         DROP  R2                                                               
*                                                                               
SCRNTX   J     SETCCEQ             EQUAL                                        
SCRNTERR J     SETCCNEQ            NOT EQUAL (ERROR)                            
*                                                                               
         LTORG                                                                  
         DROP  RB                                                               
         EJECT                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
SCREXDT  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         CLI   DATASW,C'9'         DISPLAYING EXTENSION DATE?                   
         BE    SCREXD10                                                         
*                                                                               
* IN CASE TITLE IS CLEARED (DUE TO PROFILES ETC...)                             
*                                                                               
...
******** OI    MBCHD1H+6,X'80'                                                  
******** OI    MBCHD2H+6,X'80'                                                  
         B     SCRXDERR            RESTORE TITLE, EXDATE NOT DISPLAYED          
*                                                                               
SCREXD10 DS    0H                                                               
         LA    R2,PBUYREC+33                                                    
...
*                                                                               
         MVC   8(6,R6),=C'EXDAY='                                               
         EDIT  (P2,2(R2)),(3,14(R6)),0,ALIGN=LEFT                               
         OI    1(R6),X'20'                                                      
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'96'        EXTENSION DATE ELEM CODE                     
         BRAS  RE,NXTELEM                                                       
         BNE   *+6                                                              
         DC    H'0'                CANNOT HAVE BOTH X'89' AND X'96'!!           
         B     SCREXDTX                                                         
*                                                                               
SCREXD20 LA    R2,PBUYREC+33                                                    
         MVI   ELCODE,X'96'        EXTENSION DATE ELEM CODE                     
         BRAS  RE,NXTELEM                                                       
         BNE   SCREXDTX                                                         
*                                                                               
         GOTO1 VDATCON,DMCB,(3,2(R2)),(5,8(R6))                                 
*                                                                               
SCREXDTX J     SETCCEQ             EQUAL                                        
SCRXDERR J     SETCCNEQ            NOT EQUAL (ERROR)                            
*                                                                               
         LTORG                                                                  
         DROP  RB                                                               
         EJECT                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTRTN   NTR1  BASE=*,LABEL=*      SUBROUTINE TO EDIT NEWSPAPER RATES           
*                                                                               
         LR    R2,R6               SET R2 TO FIELD HEADER                       
         SR    R3,R3               CLEAR ERROR REGISTER                         
*                                                                               
...
EDTNR10  DS    0H                                                               
         ...
         BH    EDTNRE1             MAYBE A TOTAL COST IS ENTERED                
*                                                                               
EDTNR10D ZAP   PBDCOS,DUB                                                       
*                                                                               
EDTRATX  BRAS  R9,CHKGRS                                                        
         CLC   PBDCOSIN,SAVFLD+8   PBDCOSIN CAN'T CHANGE                        
         BNE   EDTNRE1                                                          
         CLC   PBDCOSTY,SAVFLD+5   UNIT OR TOTAL RATE IND                       
         BNE   EDTNRE1             CAN'T CHANGE                                 
*                                                                               
* CODES ABOVE SHOULD INSURE THAT TOTAL RATES                                    
...
EDTRATXX J     X_R3                                                             
*                                                                               
CHKGRS   DS    0H                  CHECK GROSS NOT TOO LARGE                    
         CLI   PBDCOSTY,C'U'                                                    
         BNER  R9                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
* ROUTINE UPDATES/ADDS CHANGE ELEM AND BUY CHANGE INDICATORS                    
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
UPREC    NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         CLC   PBDDATE,BTODAY      SEE IF LAST CHA WAS TODAY                    
         BNE   UPREC64A                                                         
...
UPREC64E GOTO1 VDATCON,DMCB,(3,PBDDATE),(2,DUB)                                 
         ...
         MVI   ELCODE,X'24'                                                     
         LA    R2,PBUYREC+33                                                    
UPREC64G BRAS  RE,NXTELEM                                                       
         BE    UPRC64GC                                                         
*                                                                               
         OC    FULL,FULL           SEE IF ANYTHING THERE                        
         BZ    UPREC64O            GO ADD NEW ELEM                              
*                                                                               
         L     R2,FULL             POINT TO THE LAST '24' ELEM                  
         CLC   2(2,R2),DUB                                                      
         BNE   UPRC64GD                                                         
*                                                                               
         CLI   1(R2),PCHGNEWS      NEW ELEM LEN=11                              
         BE    UPRC64GA                                                         
         CLI   1(R2),PCHGNEWL      NEW ELEM LEN=23                              
         BE    UPRC64GB                                                         
         B     UPREC64G                                                         
*                                                                               
UPRC64GA DS    0H                                                               
         CLC   PCHGOLDS(2,R2),SVMBCPID    IS THIS SAME PERSON                   
         BE    UPRC64GF                                                         
         B     UPRC64GD                                                         
*                                                                               
UPRC64GB DS    0H                                                               
         CLC   PCHGOLDL(2,R2),SVMBCPID    IS THIS SAME PERSON                   
         BE    UPRC64GF                                                         
         B     UPRC64GD                                                         
*                                                                               
UPRC64GC DS    0H                                                               
         ST    R2,FULL                 SAVE LOCATION OF CHANGE ELEM             
         B     UPREC64G                                                         
*                                                                               
*                                                                               
UPRC64GD DS    0H                                                               
         ZIC   R0,1(R2)                 POINT R5 TO END OF REC                  
         AR    R2,R0                                                            
         B     UPREC64O                                                         
*                                                                               
UPRC64GF DS    0H                                                               
         USING PCHGELED,R2         CK FOR TODAY                                 
         OC    PCHGIND1,CHADTIND                                                
         OC    PCHGIND2,CHADTIN2                                                
         OC    PCHGIND3,CHADTIN3                                                
         OC    PCHGIND4,CHADTIN4                                                
         CLI   DATASW,C'7'         CD CHANGED?                                  
         BE    UPREC64H                                                         
         CLI   DATASW,C'8'         AC?                                          
         BE    UPREC64H                                                         
         ...
         B     UPREC64W                                                         
*                                                                               
UPREC64H CLC   GROSS(12),SVGROSS   GROSS,CD,AC CHANGED?                         
         BE    UPREC64W            NO THEN DONE                                 
*                                                                               
UPREC64N DS    0H                                                               
         CLI   PCHGLEN,PCHGNEWL    OLD $ ALREADY THERE?                         
         BE    UPREC64W                                                         
         DROP  R2                                                               
*                                                                               
...
*                                                                               
         ...
         MVC   PCHGPID,SVMBCPID                                                 
         MVC   PCHGIND5,BYTE                                                    
         DROP  R3                                                               
*                                                                               
         CLC   PBUYREC+25(2),=H'3975'                                           
         BNL   UPREC64W            CAN'T ADD ELEM, NOT ENOUGH ROOM              
*                                                                               
...
UPREC64P CLC   GROSS(12),SVGROSS   SEE IF $ CHANGED                             
         ...
         B     UPREC64R                                                         
*                                                                               
UPREC6PP LA    RE,PCHG_XSS         START OF EXTENSION FOR SHORT ELEM            
         USING PCHGEXT,RE                                                       
         MVC   PCHGPID,SVMBCPID                                                 
         MVC   PCHGIND5,BYTE                                                    
         DROP  RE                                                               
*                                                                               
UPREC64R CLC   PBUYREC+25(2),=H'3975'                                           
         BNL   UPREC64W            CAN'T ADD ELEM, NOT ENOUGH ROOM              
*                                                                               
...
UPRC64W2 CLI   DOLSW,C'3'          NET ORDERED                                  
         ...
         CVD   R4,MYDUB            NET=GROSS - AGENCY COMMISSION                
         L     R4,AGYCOM                                                        
         CVD   R4,DUB                                                           
         SP    MYDUB,DUB                                                        
         EDIT  (P8,MYDUB),(10,65(R5)),2,FLOAT=-                                 
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FSILOOK  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         LA    R2,PBUYREC+33       FIRST SEE IF REC ALREADY HAS FSI             
         MVI   ELCODE,X'82'        ELEM CODE                                    
         BRAS  RE,NXTELEM                                                       
         BE    FSIL05Z             IF SO THEN DONE                              
*                                                                               
         CLC   8(6,R6),=6C' '      ANY JOB?                                     
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
* SHOULD NEVER HAPPEN, SINCE MISSING AD IS CHECKED IN CHKCHA                    
*                                                                               
         MVC   AREC,AWRKREC                                                     
         BRAS  RE,GETREC                                                        
*                                                                               
...
*                                                                               
         BRAS  RE,INITHDR          FOR DIFFERENT HEADER TITLES                  
*                                                                               
         CLI   DATASW,C'A'                                                      
         BNE   SCRND02                                                          
...
SCRND0N  CLI   DATASW,C'K'         CLICK THRUS                                  
         ...
         B     SCRND0X                                                          
*                                                                               
SCRND0O  CLI   DATASW,C'I'         IMPRESSIONS (IMPS/EIMPS)                     
         BE    SCRND0OH                                                         
         CLI   DATASW,C'6'         ACTUAL IMPRESSIONS (AIMPS)                   
         BNE   SCRND0P                                                          
         MVC   MBCDAN1,=CL11'  ACTUAL   '                                       
         B     *+10                                                             
SCRND0OH MVC   MBCDAN1,=CL11' ESTIMATED '                                       
         MVC   MBCDAN2,=CL11'IMPRESSIONS'                                       
         B     SCRND0X                                                          
*                                                                               
SCRND0P  CLI   DATASW,C'X'         SFH (SPECIAL FINANCIAL HANDLING)             
         BNE   SCRND0R                                                          
...
*                                                                               
SCRND1A  DS    0H                                                               
         CLI   DATASW,C'#'         SERIAL NUMBER                                
         BNE   SCRND1B                                                          
         MVC   MBCDAN1,=CL11'SERIAL #'                                          
         MVC   MBCDAN2,=CL11'--------'                                          
         B     SCRND0X                                                          
*                                                                               
SCRND1B  BRAS  RE,SETFLDS          MORE OF THOSE LAST COLUMN FIELDS             
         BE    SCRND0X                                                          
*                                                                               
         DC    H'0'                INVALID DATASW                               
*                                                                               
...
*                                                                               
         CLI   DATASW,C'W'         LEGAL WARNING?                               
         BNE   SETFL10                                                          
         MVC   MBCDAN1,=CL11'LW OVERRIDE'                                       
         MVC   MBCDAN2,=CL11'-----------'                                       
         B     SETFLDSX                                                         
*                                                                               
SETFL10  DS    0H                                                               
...
SETFL11  DS    0H                                                               
         CLI   DATASW,C'9'         EXTENSION DATE?                              
         BNE   SETFL12                                                          
         MVC   MBCDAN1,=CL11'XTENSION DT'                                       
         MVC   MBCDAN2,=CL11'-----------'                                       
         B     SETFLDSX                                                         
*                                                                               
SETFL12  DS    0H                  FOR FUTURE USES                              
         B     SETFLERR                                                         
*                                                                               
SETFLDSX J     SETCCEQ             EQUAL                                        
SETFLERR J     SETCCNEQ            NOT EQUAL (ERROR)                            
*                                                                               
         LTORG                                                                  
         DROP  RB                                                               
         EJECT                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
INITHDR  NTR1  BASE=*,LABEL=*      HEADER MIGHT BE DIFFERENT                    
*                                                                               
         MVC   MBCHD1(L'IHDR1),IHDR1                                            
         MVC   MBCHD2(L'IHDR2),IHDR2                                            
         OI    MBCHD1H+6,X'80'                                                  
         OI    MBCHD2H+6,X'80'                                                  
*                                                                               
INITHDRX J     SETCCEQ             EQUAL                                        
INITHERR J     SETCCNEQ            NOT EQUAL (ERROR)                            
*                                                                               
IHDR1    DC    C'PRD PUBLICATION      EST  DATE        SPACE'                   
IHDR2    DC    C'--- -----------      ---  --------    -----'                   
*                                                                               
         LTORG                                                                  
         DROP  RB                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
ASC      NTR1  BASE=*,LABEL=*      AUTO SCHEDULE CHECKING                       
*                                                                               
...
ASCL1B   CLI   0(R1),X'FF'         END OF TABLE                                 
         BE    ASCL1D                                                           
         CLC   0(6,R1),KEY+7       CK PUB                                       
         BNE   ASCL1E                                                           
         CLC   6(3,R1),SAVBYDAT    CK DATE                                      
         BNE   ASCL1E                                                           
         ZIC   RE,9(R1)                                                         
*                                                                               
...
ASCL2C   DS    0H                                                               
         ...
         L     R6,ACONIO                                                        
         USING PCONRECD,R6                                                      
         CLC   PCONEND(3),SAVBYDAT                                              
         BL    ASCL2                                                            
         CLC   SAVBYDAT(3),PCONSTRT                                             
         BL    ASCL2                                                            
...
ASCL2X2  DS    0H                                                               
         ...
         BNE   ASCX                                                             
*                                                                               
* MUST CHECK IF SLIDING SCALE IF SO CLEAR R3 (ERROR) AND EXIT                   
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(1),SVMED                                                     
         ...
         MVI   KEY+9,X'81'                                                      
         BRAS  RE,HIGHPUB                                                       
ASCL2X4A CLC   KEY(7),KEYSAVE      CK THROUGH PUB NUMBER                        
...
*                                                                               
ASC50X   DS    0H                                                               
         L     RF,ACOMFACS         MUST SWITCH BACK                             
         L     RF,CSWITCH-COMFACSD(RF)                                          
         GOTO1 (RF),DMCB,=C'PRINT',0                                            
         CLI   4(R1),0                                                          
         BE    *+6                                                              
...
ASC60    DS    0H                  NON ADV PROCESSING                           
         ...
         MVC   WKPUB,SAVBYPUB                                                   
*                                                                               
         BRAS  RE,ASC400           FIRST CHECK FOR BUYS FOR THIS CLIENT         
         LTR   R3,R3               CK FOR ERROR                                 
         BNZ   ASCX                                                             
*                                                                               
...
*                                                                               
         CLI   SCONPRD,C'A'        CK FOR PRODUCT CONTRACT                      
         BL    *+10                                                             
...
ASC405   BRAS  RE,SEQ                                                           
*                                                                               
ASC406   CLC   KEY(11),KEYSAVE     CK AGY/MED/CLT/BASE PUB                      
         BNE   ASC400X                                                          
...
ASC406C  DS    0H                                                               
         ...
         BE    ASC408                                                           
*                                                                               
         OC    SCONMAXZ,SCONMAXZ   SEE IF CKING ACROSS ZONES/EDTS               
...
*                                                                               
         ...
         BNE   ASC420                                                           
         CP    PBDSHOW-PBUYREC(L'PBDSHOW,R6),=P'0'                              
         BNE   ASC420                                                           
*                                                                               
         LA    R2,33(R6)                                                        
         MVI   ELCODE,X'66'                                                     
         ...
         BE    ASC405                                                           
*                                                                               
         CLI   2(R2),C'#'          SEE IF TO BE IGNORED FOR ASC CK              
         BE    ASC405                                                           
*                                                                               
ASC420   LH    R4,ZECNT                                                         
         LA    R4,1(R4)                                                         
...
ASC430   LA    R3,CONMERR          CONTRACT MAX BUYS PER ISSUE REACHED          
         B     ASC400XX                                                         
*                                                                               
* HERE AT END OF BUY READING MUST STILL CHECK VS MAXIMUMS                       
* SINCE PUBCNT AND ZECNT MAY HAVE BEEN SET FROM PUBDTTAB                        
*                                                                               
ASC400X  DS    0H                                                               
         OC    SCONMAXZ,SCONMAXZ   SEE IF I HAVE A MAX ACROSS Z/E               
         BZ    ASC400X5                                                         
...
*                                                                               
FNDA5    DS    0H                                                               
         MVC   SVADVPUB,KEY+15     NEEDED TO READ ADVERTISER CONTRACT           
*                                                                               
FNDA9    DS    0H                                                               
         MVC   KEY(32),X                                                        
         J     X_R3                                                             
...
*                                                                               
COM10    DS    0H                                                               
         OC    SVPADJCS,SVPADJCS   CK FOR ADJACENCY CODES                       
...
*                                                                               
         L     RF,ACOMFACS         MUST SWITCH TO CONTROL                       
         L     RF,CSWITCH-COMFACSD(RF)                                          
         XC    DMCB(8),DMCB                                                     
         MVI   DMCB,X'0A'          CONTROL SYSTEM                               
         GOTO1 (RF),DMCB                                                        
...
COM45    DS    0H                                                               
         ...
         BE    COM48                                                            
*                                                                               
COM47    L     RF,ACOMFACS         MUST SWITCH BACK                             
         L     RF,CSWITCH-COMFACSD(RF)                                          
         GOTO1 (RF),DMCB,=C'PRINT',0                                            
         CLI   4(R1),0                                                          
         BE    *+6                                                              
...
COM60    DS    0H                  NON-ADV PROCESSING                           
         ...
         MVC   WKPUB,SAVBYPUB                                                   
*                                                                               
         BRAS  RE,COM400           FIRST CK FOR BUYS FOR THIS CLIENT            
         LTR   R3,R3                                                            
         BNZ   COMX                                                             
*                                                                               
...
*                                                                               
         XC    KEY,KEY             MUST SEARCH OTHER SLAVES                     
         MVC   KEY(2),AGYALPHA                                                  
         MVC   KEY+2(1),SVMED                                                   
         MVI   KEY+3,X'02'                                                      
         BRAS  RE,HIGH                                                          
...
* (READING X'A6' POINTERS) THAT HAVE A PPRDEXCL CODE THAT MATCHES               
* PROCESSING PRODUCT. IT THEN CHECKS FOR BUYS FOR THOSE PRODUCTS FOR            
* SAME PUB AND DATE, RETURNS AN ERROR IF ONE IS FOUND                           
*                                                                               
COM400   NTR1                                                                   
         L     R0,APRDTAB                                                       
         LH    R1,=Y(L'PRDTAB)                                                  
...
*                                                                               
         ...
         LA    R5,3                FOR BCT                                      
*                                                                               
         L     R6,APRDTAB          (SAVED FROM PRODUCT IN PPBUY01)              
*                                                                               
...
COM400S  BRAS  RE,SEQ                                                           
*                                                                               
COM400T  CLC   KEY(8),KEYSAVE      CK THROUGH CODE                              
         BNE   COM400U                                                          
...
COM405   BRAS  RE,SEQ                                                           
*                                                                               
COM406   CLC   KEY(16),KEYSAVE     CK AGY/MED/CLT/FULL PUB/PRD                  
         BE    COM408                                                           
...
COM408   CLC   KEY+16(3),SAVBYDAT  MUST MATCH DATES                             
         ...
         L     R6,AWRKREC                                                       
*                                                                               
         CLI   BYPROF+3,C'Y'       SKIPPING TEST BUY?                           
         BE    COM409                                                           
*                                                                               
         CLI   PBDBFD-PBUYREC(R6),C'T'                                          
         BE    COM405              TEST BUY                                     
...
*                                                                               
         CLI   2(R2),C'#'          SEE IF BUY IS TO BE IGNORED                  
...
*                                                                               
         MVC   AREC,AWRKREC                                                     
         BRAS  RE,GETREC           READ ESTIMATE INTO WRKREC                    
         LA    R0,REC              "RESTORE" AREC                               
         ST    R0,AREC                                                          
         L     R4,AWRKREC                                                       
         USING PESTREC,R4                                                       
...
*                                                                               
         XC    MBCEMSG,MBCEMSG                                                  
         MVC   MBCEMSG(56),=C'** INVALID - TEST ESTIMATE FOUND FOR ALLO+        
               CATED PRODUCT ='                                                 
         MVC   MBCEMSG+57(3),PESTKPRD                                           
         FOUT  MBCEMSGH                                                         
...
CKEIO20  LR    R2,RF                                                            
         ...
         BNE   CKEIO_X                                                          
         MVC   PWIOINSL,PBUYREC+24 SAVE INSERTION LINE NUMBER                   
*                                                                               
CKEIO_X  J     EXIT_X                                                           
*                                                                               
         LTORG                                                                  
...
*                                                                               
       ++INCLUDE PPBYOUTD                                                       
         EJECT                                                                  
*                                                                               
       ++INCLUDE PIUPLELEM         UPLOAD ID ELEM                               
         EJECT                                                                  
*                                                                               
       ++INCLUDE FALOCKUPD                                                      
         EJECT                                                                  
...
LOCKPUB  DS    XL4                 BASE PUB ONLY                                
         ...
         EJECT                                                                  
*                                                                               
       ++INCLUDE PPGENMATP         MATERIAL COMMENT PASSIVE                     
         EJECT                                                                  
*                                                                               
       ++INCLUDE PPGENBYIO         BUY EIO ELEM                                 
         EJECT                                                                  
*                                                                               
       ++INCLUDE PPMBCWRK          "END" IS DEFINED IN PPMBCWRK                 
         EJECT                                                                  
*                                                                               
         PRINT ON                                                               
*                                                                               
