*          DATA SET PUNCLOSD   AT LEVEL 007 AS OF 12/09/03                      
*PHASE PUNCLOSA PUNCLOSD                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PUNCLOSD- UNCLOSE DATA'                                         
*                                                                               
*              UNCLOSE DATA FROM AN OLD FILE                                    
*              OUTPUT IS UNCLOSED RECORDS ONLY                                  
*                                                                               
**********  NOTE  *************  NOTE  *************  NOTE  ***********         
...
*                                                                               
         PRINT NOGEN                                                            
PUNCLOSD CSECT                                                                  
         NBASE 0,PUNCLOSD,=V(REGSAVE)                                           
         SPACE 2                                                                
         LA    R6,PUNCLOSD+4095                                                 
         LA    R6,1(R6)                                                         
         USING PUNCLOSD+4096,R6                                                 
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007PUNCLOSD  12/09/03'                                      
         END                                                                    
