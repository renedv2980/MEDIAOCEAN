*          DATA SET REGAV00    AT LEVEL 055 AS OF 04/29/09                      
*PHASE T81300C                                                                  
*INCLUDE UNBOOK                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE UNUPGR                                                                 
...
* UPDATE HISTORY:                                                 *             
*                                                                 *             
* 04/28/09 (SMY)--->SUPPORT NEW INVENTORY KEY                     *             
*                                                                 *             
*                    **  END TOMBSTONE  **                        *             
*HERE**************************************************************             
*                                                                               
...
* SET UP CERTAIN ROUTINE ADDRESSES - CAN'T WAIT FOR GENCON                      
         ...
         SPACE 1                                                                
         OI    GENSTAT5,USERFPXT   SET EXTENDED SYMBOL FOR RLP                  
         SPACE 1                                                                
...
VINV90   MVC   RERROR,=AL2(NOTFOUND)                                            
         ...
         BZ    *+14                                                             
         CLC   KEYSAVE(RINVKSPR-RINVKEY),KEY     AND SAME DATE                  
         BNE   MYERR                                                            
         SPACE 1                                                                
         MVI   RDUPDATE,C'N'                                                    
         GOTO1 GETREC                                                           
...
*                                  GET FIRST RECORD                             
         XC    KEY+RINVKSTD-RINVKEY(12),KEY+RINVKSTD-RINVKEY                    
         MVC   RERROR,=AL2(NOTFOUND)                                            
         GOTO1 HIGH                                                             
*                                                                               
         CLC   KEY(RINVKINV-RINVKEY),KEYSAVE  COMPARE UP UNTIL STATION          
         BNE   GTINVERR                                                         
         CLI   WORK+17,0           WAS INV NUMBER INPUTTED                      
         BE    GTINVEX             NO JUST GET FIRST STATION RECORD             
*                                                                               
         CLC   KEY(RINVKSTD-RINVKEY),KEYSAVE  COMPARE UP TO EFFECT DATE         
         BNE   GTINVERR                                                         
*                                                                               
         CLI   WORK+RINVKSTD-RINVKEY,0    WAS EFFECTIVE DATE PASSED             
...
*                                                                               
         ...
         MVC   KEY(RINVKSTD-RINVKEY),WORK        RE LOAD ORIGINAL KEY           
GTINV40  GOTO1 HIGH                                                             
*                                                                               
GTINV60  DS    0H                                                               
         CLC   KEY(RINVKSTD-RINVKEY),WORK      HAVE WE PASSED OUR KEY           
         BNE   GTINV100                                                         
*                                           COMPARE EFFECTIVE DATES             
         CLC   KEY+RINVKSTD-RINVKEY(3),WORK+RINVKSTD-RINVKEY                    
         BH    GTINV100                                                         
         MVC   WORK+30(27),KEY     SAVE THIS KEY                                
         ZIC   RE,KEY+RINVKSTD-RINVKEY+2    BUMP EFFECTIVE DATE BY 1            
         LA    RE,1(RE)                                                         
         STCM  RE,1,KEY+23                                                      
         STCM  RE,1,KEY+RINVKSTD-RINVKEY+2                                      
*                                           CLEAR REST OF KEY                   
         XC    KEY+RINVKSPR-RINVKEY(9),KEY+RINVKSPR-RINVKEY                     
         B     GTINV40                                                          
*                                                                               
...
*                                  CL2 CODE FOR EOD HANDLING                    
         ...
         DC    X'03',AL1(07,12),X'D418000030',C'RFRF'  RDETAIL  REPORT          
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'055REGAV00   04/29/09'                                      
         END                                                                    
