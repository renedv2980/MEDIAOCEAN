*          DATA SET PPPBL00    AT LEVEL 065 AS OF 05/01/02                      
*PHASE T40A00A,+0                                                               
*INCLUDE PUBVAL                                                                 
*INCLUDE PUBEDIT                                                                
*        TITLE 'PPPBL00 - PUB LIST PROGRAM - BASE'                              
         TITLE 'PPPBL00 - PUB LIST PROGRAM - BASE'                              
T40A00   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 1670,T40A00                                                      
...
STRT     EQU   *                                                                
         ...
         CLI   5(R2),0                                                          
         BNZ   *+14                                                             
         XC    STRTNUM(8),STRTNUM  CLEAR PUB + NUM                              
         B     STRT4                                                            
         CLI   5(R2),4                                                          
         BL    STRT2                                                            
...
MORMSG   DC    C'TO CONTINUE DISPLAY, TYPE ''NEXT'' AND ENTER'                  
...
*                                                                               
       ++INCLUDE FLDIND                                                         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'065PPPBL00   05/01/02'                                      
         END                                                                    
         SPACE 3                                                                
