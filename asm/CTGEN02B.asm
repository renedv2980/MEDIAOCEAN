*          DATA SET CTGEN02B   AT LEVEL 025 AS OF 03/11/98                      
*PHASE TA0B02B                                                                  
...
*                                                                               
         GOTO1 GETID,CUUSER                                                     
*                                                                               
         WTO   '*FACPAK* BEFORE MQIO',MCSFLAG=HRDCPY                            
*                                                                               
         LA    RF,DDMQBHD_STRUC_1_LENQ                                          
         LA    RE,DDMQEXR_MSG_1_LENQ                                            
         AR    RF,RE                                                            
*                                                                               
         GOTO1 VMQIO,DMCB,=CL8'JOB',APWORK,(RF),ACOM                            
*                                                                               
         WTO   '*FACPAK* AFTER MQIO',MCSFLAG=HRDCPY                             
         B     VALRECY                                                          
*                                                                               
VALRECZ1 EQU   *                                                                
         GOTO1 AADDELS,CTOREC      UPDATE RECORD                                
...
*                                                                               
         ...
         BNE   GETSEL8                                                          
*                                                                               
GETSELJ  OC    SELFCH,SELFCH       FICHE CLASS FILTER                           
         BZ    GETSELI                                                          
         CLC   SELFCH,CTOUTFCH                                                  
         BNE   GETSEL8                                                          
*                                                                               
GETSELI  OC    SELCHR,SELCHR       3800 CHARCTERS FILTER                        
         ...
         BNE   GETSEL8                                                          
*                                                                               
GETSELL  OC    SELAFP,SELAFP       ADVANCED FUNCTIONS FILTER                    
         BZ    GETSELK                                                          
         ...
         BNE   GETSELK                                                          
         B     GETSEL8                                                          
GETSELL1 CLI   CTOUTFMN,0          NON AFP SELECT                               
         BNE   GETSEL8                                                          
         CLI   CTOUTPGN,0                                                       
         BNE   GETSEL8                                                          
*                                                                               
...
VMQIO    DS    A                                                                
*                                                                               
TODAYC   DS    CL10                TODAYS DATE COMPLEMENT COMPRESSED            
*                                                                               
...
LOCALX   EQU   *                                                                
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025CTGEN02B  03/11/98'                                      
         END                                                                    
