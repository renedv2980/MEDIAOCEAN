*          DATA SET RELDGRP    AT LEVEL 010 AS OF 05/01/02                      
*PHASE RELDGRP,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
...
*******************************************************************             
*                                                                 *             
*  FIX GROUP/SUBGROUP FOR TAKEOVER:  SELTEL                       *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
DMXREC   DS    0H                                                               
         ...
         CLI   RCONKTYP,X'0C'                                                   
         BNE   DMXKEEP                                                          
         CLC   =C'SZ',RCONKREP     SELTEL?                                      
         BNE   DMXKEEP             NO                                           
         CLC   =C'WWHO',RCONKSTA   WWHO?                                        
         BNE   DMXKEEP             NO                                           
         CLC   =C'TP',RCONKGRP     INCORRECT GROUP?                             
         BNE   DMXKEEP             NO                                           
*                                                                               
         MVC   RCONKGRP,=C'TY'     YES - RESET GROUP TO 'TY'                    
         MVC   RCONHDRD,RCONCREA   RESET HEADER CREATE DATE                     
*                                                                               
...
DMXR0020 EQU   *                                                                
         ...
         BNE   DMXR0060                                                         
DMXR0040 EQU   *                                                                
         MVC   4(2,R6),=X'C388'    SET DATE TO DEC8/97                          
         B     DMXR0020                                                         
DMXR0060 EQU   *                                                                
*                                                                               
         AP    SELCTR,=P'1'                                                     
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010RELDGRP   05/01/02'                                      
         END                                                                    
