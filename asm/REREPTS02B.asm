*          DATA SET REREPTS02B AT LEVEL 169 AS OF 02/08/00                      
*PHASE RETS02B,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH2                                                               
...
MAIN0280 EQU   *                                                                
         USING RBUYSPEL,R2                                                      
         CLI   RBUYSPL#,0          ANY SPOTPAK BUYLINE #?                       
         BNE   MAIN0220            YES - GO BACK FOR ANOTHER BUY                
...
*********************************************************************           
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'169REREPTS02B02/08/00'                                      
         END                                                                    
