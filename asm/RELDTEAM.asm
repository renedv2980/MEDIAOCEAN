*          DATA SET RELDTEAM   AT LEVEL 002 AS OF 05/01/02                      
*PHASE RELDTEAM,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
*******************************************************************             
*                                                                 *             
*          ALSO UPDATES TEAM CODES IN KH CONTRACTS                *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
*                                                                               
         USING RCONREC,R3                                                       
         CLI   RCONKTYP,X'0C'      CONTRACT                                     
         BNE   DMXKEEP                                                          
         CLC   RCONKREP,=C'KH'     UPDATE ALL TEAM CODE IN KH CONTRACTS         
         BNE   DMXKEEP             TO T ONLY                                    
         MVC   RCONTEM,=C'T '                                                   
         AP    CHANGE,=P'1'                                                     
         B     DMXKEEP                                                          
         DROP  R3                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002RELDTEAM  05/01/02'                                      
         END                                                                    
