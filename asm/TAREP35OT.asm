*          DATA SET TAREP35OT  AT LEVEL 239 AS OF 07/30/03                      
*PHASE T70335C,*                                                                
*                                                                               
...
*                                                                               
         ...
         USING TASOSEPI,R4                                                      
*                                                                               
SETEPI5  MVC   HALF,TASOEPI        GET AIR DATE FOI INFO                        
...
*                                                                               
ECREADN  DS    0H                                                               
**NO-OP**MVI   SORTERR,ERR10                                                    
*        LA    R0,TRECMAX                                                       
*        LA    R4,TRECTAB                                                       
*CREADN2 OC    0(9,R4),0(R4)                                                    
*        BZ    ECREADN4                                                         
*        LA    R4,23(R4)                                                        
*        BCT   R0,ECREADN2                                                      
*        DC    H'0'                                                             
*CREADN4 MVC   0(9,R4),TGSSN                                                    
*        MVC   9(3,R4),TGCAT                                                    
**NO-OP**MVC   12(5,R4),TGEPI                                                   
...
*&&UK                                                                           
         ...
         SPACE 1                                                                
SETA20   DS    0H                                                               
**NO-OP**BAL   RE,APPLY            HANDLE APPLIED CREDITS                       
...
SETA40   LA    RF,ACCPAYC          RF=A(RETRO PAY ACCUM IN SORT REC.)           
         ...
         SPACE 1                                                                
         TM    TROPTS,TRSOAPS      IF SOAPS                                     
         BO    *+8                 DON'T BOTHER WITH PNH                        
...
SETEACC9 LA    R2,EPINUMLN(R2)     PROCESS NEXT EPISODE                         
         LA    R3,ACCELNQ(R3)                                                   
         BCT   R0,SETEACC5                                                      
         B     YES                 CC EQUAL                                     
         EJECT                                                                  
...
NCHK20   MVC   AIO,=A(CHKIO)       SET I/O AREA TO A(CHECK RECORD)              
         ...
         BAS   RE,FIXBSSN          FIX BAD SSN'S                                
         BE    *+10                                                             
         MVC   TLCKSSN,TGSSN       SET CORRECTED SSN                            
         SPACE 1                                                                
...
NCHK60   TM    TROPTS2,TRSOPRES    IF SOAP RESIDUALS                            
         ...
         B     NCHK70                                                           
**NO-OP**BAL   RE,FTRACK           HANDLE CAST/FTRACK RECORD MAINT.             
         SPACE 1                                                                
...
ALLTOTS  NTR1                                                                   
         ...
         SPACE 3                                                                
ECERRS   NTR1                                                                   
         LA    R3,TRECTAB          IF ANY ERROR ECAST RECORDS                   
         OC    0(9,R3),0(R3)                                                    
         BZ    YES                                                              
...
PCTWRTAB DS    0C                  TABLE OF PERCENTAGES FOR WRI ROLES           
         ...
         SPACE 1                                                                
BADSSNTB DS    0CL18                                                            
         DC    CL9'092421911'      OLD SSN                                      
         DC    CL9'096421911'      NEW SSN                                      
         DC    CL9'595611965'      OLD SSN                                      
         DC    CL9'545611956'      NEW SSN                                      
         DC    CL9'202384085'      OLD SSN                                      
         DC    CL9'020384085'      NEW SSN                                      
         DC    CL9'227440410'      OLD SSN                                      
         DC    CL9'227440140'      NEW SSN                                      
         DC    CL9'053702592'      OLD SSN                                      
         DC    CL9'052702592'      NEW SSN                                      
         DC    X'FF'                                                            
         SPACE 1                                                                
         DS    0D                                                               
         DC    C'*INVIO**'                                                      
...
BLDAIR8  GOTO1 GETREC                                                           
         ...
         DC    H'0'                                                             
         USING TAEID,R4                                                         
         CLC   TAEIADT,=X'920101'                                               
         BL    BLDAIR2                                                          
         CLC   TAEIADT,=X'980331'                                               
         BH    BLDAIR2                                                          
...
* TAREPWORKD                                                                    
       ...
       ++INCLUDE TAREPWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'239TAREP35OT 07/30/03'                                      
         END                                                                    
