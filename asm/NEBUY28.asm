*          DATA SET NEBUY28    AT LEVEL 020 AS OF 05/17/18                      
*PHASE T31128B,+0                                                               
         TITLE 'NETPAK BUY PROGRAM - DEMO DIS/CHA OVERLAY IMP - T31128'         
T31128   CSECT                                                                  
         PRINT GEN                                                              
         NMOD1 0,*IDEMO**,RA,RR=RE                                              
         L     R9,0(R1)                                                         
         USING BUYWRKD,R9                                                       
         L     R8,ATWA                                                          
         USING TWAD,R8                                                          
...
DEM2     BAS   RE,GETUNIT          GET THE UNIT RECORD                          
         BRAS  RE,SAVGUAR          SAVE THE GUARANTEE FACTOR                    
...
DEM4     BAS   RE,DISHEAD          DISPLAY HEADLINE FIELDS                      
         ...
         BAS   RE,RESGUAR          RESTORE GUARANTEE FACTOR                     
         BAS   RE,DISGUAR          DISPLAY ANY GUARANTIES                       
         SPACE 2                                                                
...
GETUNIT  ST    RE,SAVEREG                                                       
         ...
         MVC   NBAIO,AIOAREA1                                                   
         OI    NBINDS6,NBI6XDEM    50 DEMO BLOCK                                
         MVI   FERN,NOTFOUND                                                    
...
*                                                                               
DISHEAD  NTR1                                                                   
         NI    DEMRATH+1,X'DF'     UN-PROTECT THE RATING FIELD                  
...
DIS2     CLI   0(R3),X'FF'         TEST FOR E-O-L                               
         ...
         B     DIS2                                                             
*                                                                               
DIS3     OI    DEMRATH+1,X'20'     PROTECT THE RATING FIELD                     
         B     DISX                                                             
         SPACE 2                                                                
...
***      EDIT  (R0),(6,(R2)),2,ALIGN=LEFT                                       
         ...
         LA    R2,1(R2)                                                         
*                                                                               
DISGUAR2 GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(X'B4',NBAIO),0                       
...
*                                                                               
         ...
         B     ED2                                                              
         SPACE                                                                  
EDX      OI    DEMRATH+1,X'20'     PROTECT THE RATING FIELD                     
         B     EXXMOD                                                           
         DROP  R4                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         L     RF,NBEXTEND                                                      
         USING NBXTNDD,RF                                                       
         MVC   DMCB+16,NBXCDNL     A(COMSCORE DEMO NAME LIST)                   
         DROP  RF                                                               
*                                                                               
DCAT3    XC    WORK,WORK                                                        
         GOTO1 VDEMOCON,DMCB,THREE,(10,WORK),(C'S',DBLOCK),ESTUSNS              
...
HO105    CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BE    HO120                                                            
*                                                                               
         TM    DEMFLAG,D2PRE       2 DECIMAL PRECISION?                         
         BZ    HO110                                                            
...
DISRATX  L     RE,SAVEREG                                                       
         BR    RE                                                               
         EJECT                                                                  
* SUB-ROUTINE TO DISPLAY ESTIMATED HOMES IMP'S                                  
*                                                                               
DISIMP   ST    RE,SAVEREG                                                       
         XC    OVERSTOR,OVERSTOR   CHECK NEW FORMAT                             
*                                                                               
         L     R0,HOMEIMP          OUTPUT VALUE                                 
*                                                                               
...
*                                                                               
         ...
         BE    DISI200                                                          
*                                                                               
DISI150  EDIT  (R0),(6,DEMEIHM),ALIGN=LEFT,ZERO=BLANK                           
         B     DISI300                                                          
*                                                                               
DISI200  MVI   OVERSTOR+2,C'H'                                                  
         EDIT  (R0),(8,DEMEIHM),1,ALIGN=LEFT,ZERO=BLANK                         
*                                                                               
DISI300  OI    DEMEIHMH+6,X'80'                                                 
         MVI   OVERSTOR+3,X'01'                                                 
         GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(X'DD',AIOAREA1),(5,OVERSTOR)         
         CLI   12(R1),0            TEST IF OVERRIDE FOUND                       
         BNE   DISIMPX             NO                                           
         MVC   DUB(8),DEMEIHM      INSERT A STAR BEFORE VALUE                   
         MVI   DEMEIHM,STAR                                                     
         MVC   DEMEIHM+1(7),DUB                                                 
         SPACE 1                                                                
DISIMPX  L     RE,SAVEREG                                                       
         BR    RE                                                               
*                                                                               
         EJECT                                                                  
...
*                                                                               
         XC    DUB2,DUB2                                                        
         CLI   THREE+2,0           COMSCORE?                                    
         JNE   DIS110                                                           
*                                                                               
         OC    NBEXTEND,NBEXTEND   GET COMSCORE DEMO NAME                       
         JZ    DIS110                                                           
         L     RF,NBEXTEND                                                      
         USING NBXTNDD,RF                                                       
         OC    NBXCDNL,NBXCDNL                                                  
...
*                                                                               
         ...
         MH    RE,=H'8'                                                         
         AR    RF,RE                                                            
         MVC   DUB2,0(RF)          SAVE NAME                                    
         DROP  RF                                                               
*                                                                               
*        MVC   DUB2,8(R2)          SAVE NAME                                    
*        OC    DUB2,SPACES                                                      
*                                                                               
DIS110   LA    R3,VALTAB           R3 POINTS TO VALUE TABLE                     
         USING VALTABD,R3                                                       
         SPACE                                                                  
...
*                                                                               
         ...
         BE    DS220                                                            
*                                                                               
DS210    EDIT  (R0),(6,8(R2)),ALIGN=LEFT,ZERO=BLANK                             
         B     DS300                                                            
*                                                                               
...
DS320    BAS   RE,ENCDUB                                                        
         ...
         MVC   DUB+1(7),0(RE)                                                   
*                                                                               
DS340    CLI   THREE+2,0           COMSCORE?                                    
         JNE   DS350                                                            
         CLI   ELCODE,NUOVDDQ      ESTIMATED?                                   
         JNE   *+8                                                              
         MVI   ELCODE,NUCOV1LQ                                                  
         CLI   ELCODE,NUOVDEQ      ACTUAL?                                      
         JNE   *+8                                                              
         MVI   ELCODE,NUCOV2LQ                                                  
*                                                                               
         MVI   BYTE,9              SEARCH LENGTH                                
         XC    TMP,TMP                                                          
         MVC   TMP(8),DUB2         SEARCH CATEGORY                              
         MVC   TMP+8(1),VALMOD     SEARCH MODIFIER                              
         GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(ELCODE,AIOAREA1),(BYTE,TMP)          
         B     DS355                                                            
*                                                                               
DS350    GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(ELCODE,AIOAREA1),(BYTE,DUB)          
DS355    CLI   12(R1),0                                                         
         BNE   DS400                                                            
...
*                                                                               
         ...
         L     R4,SAVEREG4                                                      
*                                                                               
*-CHECK FOR HOMES IMPRESSION OVERRIDE                                           
HOMOV100 MVI   IMPHMSW,0                                                        
         CLC   HOMEIMP,NEWEIHM     TEST FOR CHANGE                              
         BE    HOMOVERX            NO                                           
         XC    HOMEIMP,HOMEIMP                                                  
*                                                                               
         XC    OVERSTOR,OVERSTOR   DELETE NEW FORMATTED OVERRIDE ELEM           
...
*****    BNE   *+8                                                              
         MVI   OVERSTOR+2,C'H'                                                  
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'DD',AIOAREA1),(5,OVERSTOR)         
         MVI   OVERSTOR+2,C'T'                                                  
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'DD',AIOAREA1),(5,OVERSTOR)         
*        XC    OVERSTOR,OVERSTOR   DELETE NEW FORMATTED OVERRIDE ELEM           
*        MVI   OVERSTOR,C'V'       DELETE THE VPH OVERRIDES                     
*        GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'CD',AIOAREA1),(1,OVERSTOR)         
*                                                                               
*        GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(X'DD',NBAIO),0                       
*        CLI   12(R1),0            TEST IF DEMO GUARANTEE FOUND                 
*        BNE   HOMOV300                                                         
*        L     R3,12(R1)                                                        
*        B     HOMOV250                                                         
...
*HOMOV200ZIC   RE,1(R3)                                                         
*        AR    R3,RE                                                            
*HOMOV230CLI   0(R3),X'DD'                                                      
*        BNE   HOMOV300                                                         
*HOMOV250CLI   4(R3),C'V'                                                       
*        BNE   HOMOV200                                                         
*        MVC   DUB,2(R3)                                                        
*        GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'DD',AIOAREA1),(8,DUB)              
*        B     HOMOV230                                                         
*                                                                               
HOMOV300 CLI   NEWEIHM,X'FF'       TEST FOR ZERO OR NO INPUT                    
         BE    HOMOVERX            YES                                          
*                                                                               
         MVI   IMPHMSW,X'FF'       SET OVERRIDE HOMES IMP SW.                   
*                                                                               
         ST    R4,SAVEREG4                                                      
         XC    OVEREL,OVEREL                                                    
         LA    R4,OVEREL                                                        
         ...
         L     R4,SAVEREG4                                                      
*                                                                               
         MVC   HOMEIMP,NEWEIHM     UPDATE HOMEIMP                               
HOMOVERX L     RE,SAVEREG                                                       
         BR    RE                                                               
         DROP  R4                                                               
         EJECT                                                                  
...
OVER2    ZIC   R1,LINE                                                          
         ...
         MVC   ENCDEMO,THREE       DECODE HE DEMO                               
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)                                         
         LA    R3,VALTAB                                                        
         USING VALTABD,R3                                                       
         SPACE                                                                  
OVER4    CLI   0(R3),X'FF'         TEST FOR END OF TABLE                        
         BE    OVER8               YES                                          
         TM    VALOVCTL,X'40'      TEST IF OVERRIDE POSSIBLE                    
         BO    OVER7               NO                                           
         CLI   THREE+2,0           COMSCORE?                                    
         BE    OVER7                                                            
         SPACE                                                                  
...
*                                                                               
         ...
         BE    OVER7               SAME                                         
*                                                                               
OVER4F   CLI   VALOVER,X'DD'       TEST FOR ESTIMATED DEMO                      
         BNE   OVER4J              NO                                           
         CLI   VALMOD,C'T'         IS IT AN IMPRESSION                          
         BNE   OVER4G                                                           
         OC    0(4,R5),0(R5)       IS THERE A ZERO AMOUNT                       
         BZ    OVER7               BYPASS                                       
*                                                                               
OVER4G   L     RE,APACKREC                                                      
         USING NPRECD,RE                                                        
         TM    NPAKSTAT,X'80'      TEST FOR FROZEN PACKAGE                      
         BZ    OVER4J              NO                                           
         ...
         B     ERROR                                                            
*                                                                               
OVER4J   L     R2,0(R5)            GET NEW VALUE                                
...
*        BNE   OVER4K                                                           
         ...
         BNE   OVER4K                                                           
         MVI   DUB+2,C'H'          HUNDREDS OVERRIDE                            
OVER4K   CLI   THREE+1,USERMOD     TEST FOR USER DEMO                           
         BNE   OVER5                                                            
         ...
         LA    RE,USERNMS-7(R1)                                                 
         MVC   DUB(1),DUB+2        MOVE MODE INTO DUB                           
         CLI   DUB,C'H'            SEE IF HUNDREDS                              
         BNE   *+8                                                              
         MVI   DUB,C'T'            USER DEMOS ONLY IN THOUSANDS                 
         MVC   DUB+1(7),0(RE)      DATA IS MODIFIER/USER DEMO NAME              
         SPACE 1                                                                
OVER5    MVC   IMPHORT,DUB+2       STORE DEMO TYPE                              
         CLI   DUB+2,C'H'            SEE IF IMP                                 
         BE    *+12                                                             
         CLI   DUB+2,C'T'            SEE IF IMP                                 
         BNE   *+8                                                              
         MVI   DUB+2,C'H'                                                       
         BAS   RE,ENCDUB                                                        
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(BYTE,DUB)          
* IF IMP DELETE BOTH 'H" AND 'T' TYPE                                           
         CLI   DECDEMO+1,C'H'        SEE IF HUNDREDS                            
         BNE   OVER5B                                                           
         MVI   DUB+2,C'T'            MOVE IN THOUSANDS                          
         BAS   RE,ENCDUB                                                        
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(BYTE,DUB)          
OVER5B   MVC   DUB+2(1),IMPHORT    RESTORE DEMO TYPE                            
         CLI   THREE+1,USERMOD     TEST FOR USER DEMO                           
         BE    OVER5E                                                           
         TM    VALOVCTL,X'80'      TEST FOR ESTIMATED IMP                       
         BO    OVER5D                                                           
         ...
         B     OVER5C                                                           
*        MVI   DUB+2,C'V'                                                       
OVER5C   MVI   DUB+2,C'H'          HUNDREDS OVERRIDE                            
         BAS   RE,ENCDUB                                                        
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(BYTE,DUB)          
         MVI   DUB+2,C'T'          THOUSANDS OVERRIDE                           
         BAS   RE,ENCDUB                                                        
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(BYTE,DUB)          
OVER5D   MVC   DUB+2(1),VALMOD     RESTORE MODIFIER                             
         CLI   DUB+2,C'T'                                                       
         BNE   OVER6                                                            
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OVER6                                                            
         ...
         B     OVER6                                                            
*--USER DEMOS                                                                   
OVER5E   TM    VALOVCTL,X'80'      TEST FOR ESTIMATED IMP                       
         BO    OVER5G                                                           
         CLI   VALMOD,C'R'         TEST FOR RATING                              
         BNE   OVER6               NO                                           
         MVI   DUB,C'T'            DELETE THE IMPS                              
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OVER5F                                                           
         MVI   DUB,C'H'            DELETE THE IMPS                              
         B     OVER5F                                                           
*        MVI   DUB,C'V'            DELETE ESTIMATED VPH                         
OVER5F   GOTO1 VHELLO,(R1),,,,0                                                 
         B     OVER5H                                                           
OVER5G   MVI   DUB,C'R'            DELETE ESTIMATED RTG                         
         GOTO1 VHELLO,(R1),,,,0                                                 
         MVI   DUB,C'H'            DELETE ESTIMATED IMP                         
         GOTO1 VHELLO,(R1),,,,0                                                 
OVER5H   MVC   DUB(1),VALMOD       RESTORE MODIFIER                             
         CLI   DUB,C'T'                                                         
         BNE   OVER6                                                            
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OVER6                                                            
         MVI   DUB,C'H'            HUNDREDS OVERRIDE                            
         B     OVER6                                                            
*                                                                               
...
*                                                                               
         USING UDOVD,R4                                                         
OVER6A   MVC   UDOVEL,ELCODE                                                    
         MVI   UDOVLEN,14                                                       
         MVC   UDOVMOD,VALMOD      MODIFIER                                     
         MVC   UDOVNAM,DUB+1    USER DEMO NAME                                  
         STCM  R2,15,UDOVVAL                                                    
*                                                                               
OVER6C   L     R4,SAVEREG4                                                      
         BAS   RE,PUTEL                                                         
         CLI   VALOVER,X'DE'       TEST FOR ACTUAL                              
         BE    OVER6E                                                           
         CLI   THREE+1,USERMOD     TEST FOR USER DEMO                           
         BNE   OVER6G              YES                                          
*        CLI   VALMOD,C'T'         TEST FOR IMPRESSION                          
*        BNE   OVER6G                                                           
*        CLI   IMPHMSW,X'FF'       WAS IMPS HOMES OVERRIDEN                     
*        BE    OVER6G              YES, CALCULATE VPH'S LATER                   
*        BAS   RE,VPH                                                           
         BAS   RE,ERTG             CALCULATE THE ESTIMATE RTG                   
         B     OVER6G                                                           
*                                                                               
OVER6E   CLI   VALMOD,C'R'         TEST FOR RATING                              
         BNE   OVER6G                                                           
...
* ELEMENT FOR IT.                                                               
* AT ENTRY     R2 CONTAINS ESTIMATED IMPRESSION VALUE                           
*              THREE CONTAINS DEMO                                              
*              BYTE CONTAINS OVERRIDE RATING PRECISION FACTOR                   
*                                                                               
VPH      NTR1                                                                   
         LTR   R3,R2               IMPRESSION                                   
         BZ    VPHX                                                             
         SR    R2,R2                                                            
         OC    HOMEIMP,HOMEIMP                                                  
         BZ    VPHX                                                             
         L     R1,HOMEIMP          HOME IMPRESSION                              
*                                                                               
...
MSG2     MVC   BUYMSG+17(10),=C'DISPLAYED.'                                     
         ...
         OI    DEMEIMPH+6,X'01'    MAKE FIELD MODIFIED FOR RE-ENTRY             
         SPACE                                                                  
MSGX     LA    R2,BUYACTH                                                       
         ST    R2,FADDR                                                         
         L     RE,SAVEREG                                                       
...
*                                                                               
HOMTAB   DS    0XL5                                                             
         DC    AL1(0),AL3(HOMEUNIV-TEMPD),X'00'                                 
         DC    AL1(7),AL3(HOMERAT-TEMPD),X'01'                                  
         DC    AL1(23),AL3(HOMAIMP-TEMPD),X'82'                                 
         DC    AL1(32),AL3(HOMAUNIV-TEMPD),X'00'                                
         DC    X'FF'                                                            
         SPACE 2                                                                
...
VALTAB   DS    0XL13                                                            
         ...
         DC    X'00',X'CD',C'V',X'000040'                                       
*                                                                               
         DC    AL1(EIMPH),AL3(OLDEIMP-TEMPD),AL3(NEWEIMP-TEMPD)                 
         DC    X'DD',X'CD',C'T',X'020280'                                       
*                                                                               
         DC    AL1(EUNIH),AL3(OLDEUNI-TEMPD),AL3(0)                             
         DC    X'00',X'00',C'U',X'000040'                                       
*                                                                               
         DC    AL1(ERTGH),AL3(OLDERTG-TEMPD),AL3(0)                             
         DC    X'00',X'00',C'R',X'050540'                                       
*                                                                               
...
DEML8    XC    SVAREA,SVAREA       CLEAR SAVE DATA TO FORCE DIS NEXT            
         ...
         LA    R2,BUYACTH                                                       
         ST    R2,FADDR                                                         
         OI    DEMEIMPH+6,X'81'    MODIFY TO ALLOW RE-ENTRY AND XMIT            
...
GETVAL   MVC   AVALTAB,8(R1)       THE ADDRESS OF VALTAB                        
         ...
         MVC   NEWEVPH(LINES*4),OLDEVPH INITIALIZE NEW EST. IMPS                
         MVC   NEWEIMP(LINES*4),OLDEIMP INITIALIZE NEW EST. VPHS                
         SPACE                                                                  
GT100    ZIC   R1,LINE                                                          
         LA    R1,1(R1)                                                         
...
GH800    ST    R0,NEWARHM                                                       
*                                                                               
*-SET THE ESTIMATED HOMES IMPRESSION FIELD                                      
         LA    R2,DEMEIHMH                                                      
         GOTO1 VGETFLD                                                          
         CLI   FLDH+5,0            TEST FOR ANY INPUT                           
         BE    GH900               NO                                           
*                                                                               
         ...
         CLI   FLDH+5,1                                                         
         BNE   GH920                                                            
GH900    L     R0,=F'-1'           RESET OVERRIDE WITH REAL VALUES              
         B     GH1600                                                           
*                                                                               
GH920    ZIC   R1,FLDH+5           R1 CONTAINS FIELD LENGTH                     
         CLI   FLD,STAR            STRIP LEADING ASTERISK BEFORE SCAN           
         BNE   GH1000                                                           
*                                                                               
         SH    R1,=H'1'                                                         
         ...
         EX    R1,DUBMOVE                                                       
         SPACE 1                                                                
GH1000   SR    R0,R0               CLEAR R0 FOR NEW VALUE                       
         LA    R5,FLD              RE POINTS TO START OF FIELD                  
         LR    R2,R1               SAVE TOTAL LENGTH IN R2                      
         SPACE 1                                                                
GH1100   CLI   0(R5),PERIOD        TEST FOR DECIMAL POINT                       
         BE    GH1400                                                           
         CLI   0(R5),C'0'          VALIDATE FOR NUMERIC DATA                    
         BL    GETHOMR                                                          
         CLI   0(R5),C'9'                                                       
...
*                                                                               
         ...
         B     GH1600              SLOT INTO OUTPUT                             
         SPACE                                                                  
GH1400   CH    R1,=H'2'            ONLY 1 DIGIT AFTER POINT                     
         BNE   GETHOMR                                                          
         CLI   1(R5),C'0'          TEST FOR NUMBER AFTER POINT                  
         BL    GETHOMR                                                          
         CLI   1(R5),C'9'                                                       
...
*                                                                               
         ZIC   R1,FLDH+5                                                        
         SH    R1,=H'3'            HANDLE THE WHOLE NUMBER                      
         BM    GH1600              DECIMAL POINT STARTED FIELD                  
         EX    R1,*+8                                                           
         B     *+10                                                             
         PACK  DUB,FLD(0)                                                       
         CVB   RE,DUB                                                           
...
*                                                                               
*--RECALCULATE THE VPH'S IF ESTIMATED HOMES IMPS WERE CHANGED                   
HVPHCALC CLI   IMPHMSW,X'FF'       WAS HOMES OVERRIDEN                          
         BNE   HVPHEX              NO EXIT                                      
*                                                                               
HVPH100  GOTO1 VHELLO,DMCB,(C'G',FILAREA),(X'DD',NBAIO),0                       
         CLI   12(R1),0            TEST IF EST OVERRIDE FOUND                   
         BNE   HVPH400             NO                                           
         L     R3,12(R1)                                                        
         B     HVPH300                                                          
*                                                                               
HVPH200  ZIC   RE,1(R3)                                                         
         ...
         CLI   0(R3),X'DD'                                                      
         BNE   HVPH400                                                          
HVPH300  CLI   4(R3),C'T'                                                       
         BE    *+12                                                             
         CLI   4(R3),C'H'                                                       
         BNE   HVPH200                                                          
         CLI   5(R3),X'01'         CHECK FOR HOMES                              
         BE    HVPH200                                                          
         MVC   THREE(3),3(3)       DEMO CAT/MOD                                 
         L     R2,8(R3)                                                         
         BAS   RE,OVVPH                                                         
         B     HVPH200                                                          
*                                                                               
HVPH400  MVI   THREE+1,USERMOD                                                  
         GOTO1 VHELLO,DMCB,(C'G',FILAREA),(X'CD',NBAIO),0                       
         CLI   12(R1),0            TEST IF EST OVERRIDE USER FOUND              
         BNE   HVPHEX              NO EXIT                                      
         L     R3,12(R1)                                                        
         B     HVPH600                                                          
*                                                                               
HVPH500  ZIC   RE,1(R3)                                                         
         ...
         CLI   0(R3),X'CD'                                                      
         BNE   HVPHEX                                                           
HVPH600  CLI   2(R3),C'T'                                                       
         BE    *+12                                                             
         CLI   2(R3),C'H'                                                       
         BNE   HVPH500                                                          
         MVC   DUB,2(R3)           DEMO NAME                                    
         L     R2,10(R3)                                                        
         BAS   RE,OVVPH                                                         
         B     HVPH500                                                          
*                                                                               
...
*                                                                               
         ...
         STH   R3,NUOVVAL+2                                                     
         STCM  R3,15,NUOVVAL                                                    
         BAS   RE,OVSETPRE         SET OVERRIDE PRECISION FACTOR                
         B     OVVPH4                                                           
         SPACE                                                                  
         USING UDOVD,R4                                                         
OVVPH2   LTR   R3,R3               TEST FOR ZERO VPH                            
         BZ    OVVPHX              YES-EXIT                                     
         MVI   UDOVEL,X'CD'                                                     
         MVI   UDOVLEN,14                                                       
         MVI   UDOVMOD,C'V'                                                     
...
OVSETPRE NTR1                                                                   
         ...
         LA    RE,7                                                             
*                                                                               
OVSETP20 CLC   0(1,R5),4(R4)                                                    
         BE    OVSETP40                                                         
         LA    R5,2(R5)                                                         
         BCT   RE,OVSETP20                                                      
         DC    H'0'                                                             
OVSETP40 MVC   7(1,R4),1(R5)                                                    
         B     OVEXIT                                                           
         SPACE 2                                                                
* SUB-ROUTINE TO PUT AN OVERRIDE ELEMENT TO RECORD                              
*                                                                               
OVPUTEL  LR    R0,RE               SAVE RETURN POINT                            
         GOTO1 VHELLO,DMCB,(C'P',FILAREA),AIOAREA1,OVEREL,0                     
         CLI   12(R1),0            TEST IF OK                                   
         BE    OVPUTELX            YES                                          
         CLI   12(R1),5            TEST FOR RECORD OVERFLOW                     
         BE    *+6                                                              
...
*                                                                               
LOOKDEM  MVI   NBACTOPT,YES        RETURN ACTUAL VALUES                         
         ...
         EX    R1,*+8                                                           
         B     *+10                                                             
         MVC   XDDEMOS(0),ESTDEMSE                                              
*        MVC   XDWGTLST,ESTWLST    NOT CURRENTLY SUPPORTING WEIGTHS             
         MVC   XDUSRNMS,ESTUSNS                                                 
         MVC   USERNMS,ESTUSNS                                                  
         GOTO1 VNETVAL,DMCB,NETBLOCK                                            
         MVC   SVUSRUNV(16),XDUSRUNV                                            
         SPACE                                                                  
         SR    R0,R0                                                            
         LA    R1,ESTDEMSE                                                      
...
LOOK5A   LR    RE,R1               DISPLACEMENT INTO OUTPUT BLOCK               
         ...
         BE    LOOK6                                                            
         LA    RE,XDESTDEM(RE)     INDEX INTO TABLE                             
         LH    R3,0(RE)                                                         
         ST    R3,OLDEVPH(RF)                                                   
         LH    R3,2(RE)                                                         
         ST    R3,OLDERTG(RF)                                                   
         ...
         B     LOOK7                                                            
         SPACE                                                                  
LOOK6    LA    RE,XDACTDEM(RE)     INDEX INTO RETURNED VALUES                   
...
LOOK8    XC    XDDEMOS,XDDEMOS                                                  
         ...
         MVI   0(R1),X'FF'                                                      
*                                                                               
         LA    R5,XDDEMOS          ALTER MODIFIERS IN DEMO LIST TO              
         SR    R3,R3               LOOK UP UNIVERSES                            
LOOK9    CLI   1(R5),63            TEST FOR WEIGHTED DEMO                       
         BNE   *+14                NO                                           
         LPR   R3,R3               YES                                          
         STC   R3,WEIGHT           DISPLACEMENT TO WEIGHTED DEMO                
         B     *+6                                                              
*                                                                               
         BCTR  R3,0                                                             
         MVC   ENCDEMO,0(R5)                                                    
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)                                         
         MVI   DECDEMO+1,C'U'      SET MODIFIER TO UNIVERSE                     
         GOTO1 VENCDEC,DMCB,(1,DECDEMO)                                         
         MVC   0(3,R5),ENCDEMO                                                  
*                                                                               
         LA    R5,3(R5)                                                         
         CLI   0(R5),X'FF'         TEST FOR E-O-L                               
         BNE   LOOK9               NO                                           
*                                                                               
         L     RE,AIOAREA3                                                      
         LA    RE,XDBLKLEN(RE)                                                  
...
*                                                                               
         ...
         ZIC   R1,WEIGHT                                                        
         SLL   R1,2                                                             
         L     R0,XDACTWUN         PLACE WEIGHTED VALUE IN LIST                 
         ST    R0,HOMAUNIV(R1)                                                  
         SPACE                                                                  
...
IMPHMSW  DS    XL1                 =X'FF' HOMES IMPRESSION OVERIDDEN            
IMPHORT  DS    XL1                 DEMO TYPE                                    
*                                                                               
...
NEWEIMP  DS    (LINES)F            NEW ESTIMATED IMPRESSIONS                    
...
NEWEIHM  DS    F                   NEW ESTIMATED HOMES IMPRESSION               
*                                                                               
...
NETUNIVD DSECT                                                                  
       ...
       ++INCLUDE NETBLKXTND                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020NEBUY28   05/17/18'                                      
         END                                                                    
