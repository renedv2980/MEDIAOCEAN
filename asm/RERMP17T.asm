*          DATA SET RERMP17T   AT LEVEL 011 AS OF 05/01/02                      
*PHASE T81017A                                                                  
*INCLUDE BINSRCH2                                                               
...
ILT024   DS    0H                                                               
         ...
         BE    ILT100                                                           
*                                                                               
         XC    TEMPLT,TEMPLT       CLEAR AREA HOLDING ENTRY                     
*                                                                               
...
TSL010   DS    0H                  START OF LOOP                                
         ZICM  R0,DLSELH+5,(1)     ANY INPUT IN SELECT FIELD?                   
         BZ    TSL020               NOPE                                        
...
TSL016   DS    0H                  BUMP TO NEXT CHARACTER IN SEL FLD            
         LA    RF,1(RF)                                                         
         BCT   R0,TSL012                                                        
*                                                                               
...
TS2010   DS    0H                  START OF LOOP                                
         ZICM  R0,DEMSELH+5,(1)    ANY INPUT IN SELECT FIELD?                   
         BZ    TS2020               NOPE                                        
...
TS2016   DS    0H                  BUMP TO NEXT CHARACTER IN SEL FLD            
         LA    RF,1(RF)                                                         
         BCT   R0,TS2012                                                        
*                                                                               
         DS    0H                  THIS SELECT FIELD OK                         
...
SELPFTAB DS    0XL(L'SELPFSCD+L'SELPFVRT+L'SELPFPFK)   SELECT CODES             
SELPFSCD DS     CL1                                                             
SELPFVRT DS     AL1                                                             
SELPFPFK DS     AL1                                                             
         ORG   SELPFTAB                                                         
         DC    CL1'R',AL1(GSI#),AL1(02)    INV/ROVER                            
         DC    CL1'O',AL1(GSI#),AL1(03)    INV/DOVER                            
         DC    CL1'F',AL1(VSI#),AL1(00)    CHANGE FOOTNOTE                      
         DC    CL1'D',AL1(GSI#),AL1(04)    INV/TRKDEL                           
         DC    CL1'M',AL1(GIDM#),AL1(09)   INV/DEMOS                            
         DC    CL1'T',AL1(GSI#),AL1(10)    TEXT/ADD  <<<<<<<<<<<<<              
         DC    AL1(EOT)                                                         
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011RERMP17T  05/01/02'                                      
         END                                                                    
