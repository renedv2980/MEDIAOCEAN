*          DATA SET ACSCR07S   AT LEVEL 091 AS OF 05/24/00                      
*PHASE T60C07A,*                                                                
*INCLUDE LOADER                                                                 
...
*&&UK                                                                           
         ...
         BNE   IVALIPUT                                                         
*                                                                               
VALSEL54 MVC   RQCURCY,RUNRCU                                                   
*&&                                                                             
VALSEL55 GOTO1 VSCANNER,APPARM,RUNPERH,(2,BLOCK),SCNP3NEQ                       
         MVC   SVNAME,BLOCK+12                                                  
         MVC   INUSER,BLOCK+12                                                  
         CLI   APPARM+4,2                                                       
         BNE   *+10                                                             
         MVC   INUSER,BLOCK+44                                                  
*                                                                               
         MVI   RQFRPT,C' '         CLEAR FORMAT REPORT                          
...
GETSEL   LA    R2,IOKEY                                                         
         ...
         CLI   PTRELNRQ,0                                                       
         BE    GETSEL07                                                         
*MN      CLC   RESKEY+RESKFRML(1),PTRELNRQ        FINISHED REQUESTS?            
...
DISSEL05 L     R4,APPARM           R4=A(LIST/SELECT LINE)                       
         ...
         LA    R2,APRECKEY                                                      
*MN      CLI   RESKEY+RESKFRML,C' '          NO OVERNIGHT REQUESTS              
         CLC   RESKEY+RESKFRML(2),SPACES     NO OVERNIGHT REQUESTS              
         BE    DISSEL10                                                         
*MN      CLI   RESKEY+RESKFRML,0                                                
...
*                                                                               
         USING PTRELD,R1                                                        
DISSEL20 DS    0H                                                               
*MN      ZIC   R6,RESKEY+RESKFRML                REQUEST NUMBER                 
...
*&&US*&& MVI   ACQDRFOP,NO         DEFAULT TO EXCLUDE DRAFT ITEMS               
         MVI   PRTSTYLE,C'L'       DEFAULT TO LANDSCAPE                         
*                                                                               
         MVC   RESKEY,APRECKEY                                                  
*MN      CLI   RESKEY+RESKFRML,0                                                
*MN      BNE   *+8                                                              
*MN      MVI   RESKEY+RESKFRML,C' '                                             
         OC    RESKEY+RESKFRML(2),RESKEY+RESKFRML                               
         BNZ   *+10                                                             
...
PRCLST09 DS    0H                                                               
         ...
         BNE   PRCLST10            NO,  GOT ALL THE UNIT/LEDGERS                
...
*                                                                               
         ...
         CLI   APPARM,1                                                         
         BL    PRCLST12                                                         
         GOTO1 VOFFICE,APPARM,(C'R',AIOAREA1),(20,BLOCK)                        
         BNE   XIT                                                              
*        GOTO1 VALOFF,OFFFLDH                                                   
*                                                                               
...
PRCLST51 MVC   ACQAPPL(L'RESKFORM),RESKFORM                                     
         DROP  R2                                                               
*                                                                               
PRCLST52 CLC   STRDTE,SPACES       START DATE?                                  
         BNH   *+10                                                             
         MVC   ACQSTART,STRDTE                                                  
...
*                                                                               
         ...
         LA    RF,4                COUNT CARD                                   
*                                                                               
PRCLST54 CLC   0(L'ACQCARD1,RE),SPACES                                          
         BNE   PRCLST55                                                         
         SH    RE,=Y(L'ACQCARD1)                                                
         BCT   RF,PRCLST54                                                      
         B     PRCLST99            EXIT NO REQUEST DATA                         
*                                                                               
PRCLST55 MVI   REQFLAG,X'01'       SET AS LINKED REQUEST                        
         SH    RF,=H'01'                                                        
         BZ    PRCLST57                                                         
...
*                                                                               
PRCLST56 SH    RF,=H'01'           MARK CARDS 2-7 ONLY                          
         BZ    PRCLST57            IF ZERO NO MORE                              
         SH    RE,=Y(L'ACQCARD1)                                                
         MVI   ACQCONT2-ACQCARD2(RE),C'C'                                       
         B     PRCLST56                                                         
*                                                                               
PRCLST57 GOTO1 AFVAL,RUNOUTH                                                    
         TM    PRFFLAG,PRFDOWN     FORCE DOWNLOAD?                              
         BO    PRCLS57A            YES,  SKIP                                   
         CLC   AC@DOWN,FVIFLD                                                   
         BNE   PRCLST59                                                         
*                                                                               
PRCLS57A CLI   APGFLAG,YES                                                      
         BNE   PRCLST58                                                         
         MVI   ACQOPT7,YES                                                      
*                                                                               
PRCLST58 MVI   ACQOPT1,YES                                                      
...
*                                  YES,    DOWN-LOAD AND FORMAT REPORT          
         ...
         MVC   REQOUT,AC@DOWN                                                   
*                                                                               
PRCLST59 TM    INWHEN,MIXIOKO      OVER NIGHT?                                  
         BZ    PRCLST60                                                         
         ...
         B     PRCLST90                                                         
*                                                                               
PRCLST60 LA    R2,APELEM           BUILD SPOOK                                  
*                                                                               
         USING SPOOK,R2                                                         
         ...
         OI    SPOOKTY,X'10'                                                    
*                                                                               
PRCLST80 GOTO1 VREQTWA,APPARM,(5,(R5)),REQHEAD,VDMGR,ACOM,(R2)                  
...
*                                                                               
         ...
         MVC   XTRA_MSG+3,SCCOMMA                                               
         MVC   XTRA_MSG+4(6),=XL6'402020202020'                                 
         LA    R1,XTRA_MSG+4                                                    
         EDMK  XTRA_MSG+4,APDUB+5                                               
...
PRCACN05 DS    0H                  EXCLUDE       WAS ENTERED                    
         ...
         BE    PRCACN08            YES,   SKIP SOON TEST                        
...
PRCACN20 DS    0H                  VALIDATE    THE LIST                         
         GOTO1 VALLIST,APPARM,(LDGUSED,LDGSAVE),(FVILEN,FVIFLD),1               
*                                                                               
         LTR   RF,RF               VALID  LIST ?                                
         BNZ   IVALLIST            NO,    ERROR                                 
         CLI   RQFRPT,ONLY         FORMAT ONLY REPORT ?                         
         BE    PRCACN25            YES,   SKIP SOON TEST                        
***US*&& CLI   APACTN,ACTSOON      ARE    WE   SOONING                          
***US*&& BE    IVALSOON            YES,   ERROR                                 
*                                                                               
PRCACN25 DS    0H                                                               
...
*                                  CHECK  FOR  WILDCARD CHARACTER               
         ...
         BP    PRCACN40            YES,   SKIP VALIDATION                       
*                                  NO,    VALIDATE                              
PRCACN35 DS    0H                                                               
         LA    R6,IOKEY                                                         
         MVC   ACTKEY,SPACES                                                    
         ...
         BE    PRCACN45            ACCOUNT     OK                               
         B     PRCACNER            ERROR, INVALID ACCOUNT                       
         DROP  R6                                                               
*                                                                               
PRCACN40 DS    0H                                                               
         CLI   RQFRPT,ONLY         FORMAT ONLY REPORT ?                         
         BE    PRCACN45            YES,   SKIP SOON TEST                        
***US*&& CLI   APACTN,ACTSOON      ARE    WE   SOONING                          
***US*&& BE    IVALSOON            YES,   ERROR                                 
*                                                                               
PRCACN45 DS    0H                                                               
...
PRCACN50 DS    0H                  FOUND  "("                                   
         CLI   APGFLAG,YES         APG    FORMAT   ?                            
         BE    PRCACNER            YES,   INVALID  ACCOUNT                      
         MVC   RCAP#,0             TEMPORARILY SAY NO RECAP REQUESTED           
*                                                                               
PRCACN52 DS    0H                  FOUND  NULL                                  
         ...
         CLI   APPARM,1            ANY    DATA ?                                
         BNL   PRCACN55            YES,   SKIP                                  
         CLI   SOONVLUE,1          NO DATA                                      
         BH    PRCACNEX            IF > 1 THEN OK TO SOON OR OVERNIGHT          
         CLI   RQFRPT,ONLY         FORMAT ONLY REPORT ?                         
         BE    PRCACNEX            YES,   OKAY AS   IS                          
         CLI   APACTN,ACTSOON      ARE    WE   SOONING                          
         BE    IVALSOON            YES,   ERROR                                 
         B     PRCACNEX            NO,    OKAY AS  IS                           
*                                                                               
PRCACN55 DS    0H                                                               
         BE    PRCACN60            SINGLE ACCOUNT, SKIP                         
         CLI   RQFRPT,ONLY         FORMAT ONLY REPORT ?                         
         BE    PRCACN56            YES,   SKIP SOON TEST                        
***US*&& CLI   APACTN,ACTSOON      ARE    WE   SOONING                          
***US*&& BE    IVALSOON            YES,   ERROR                                 
*                                                                               
PRCACN56 DS    0H                                                               
         CLI   APPARM,2            +/-LIST     ?                                
         BNE   PRCACN65            NO,    INSERT   MULTIPLE DATA                
*                                  YES,   +/-LIST                               
         CLC   ACQUNT(2),SPACES    ANY    UNIT/LEDGER DATA ?                    
         BH    PRCACN57            YES,   SKIP                                  
         CLI   LDGUSED,0           ANY    UNIT/LEDGER LIST ?                    
         BNE   IVALMIS1            NO,    SHOULD NOT  HAPPEN                    
*                                                                               
PRCACN57 DS    0H                                                               
...
*                                  NO,    USE  THE  LEDGER                      
         MVC   LDGSAVE(LUNLG),ACQUNT                                            
*                                  VALIDATE    THE LIST                         
         GOTO1 VALLIST,APPARM,(LDGUSED,LDGSAVE),(FAKEFLDH+7,FAKEFLD),1          
*                                                                               
         LTR   RF,RF               VALID  LIST ?                                
         BNZ   IVALLIST            NO,    ERROR                                 
         B     PRCACN65            YES,   INSERT   +/-LIST                      
*                                                                               
PRCACN60 DS    0H                  SINGLE ACCOUNT                               
...
PRCACN70 DS    0H                                                               
         ...
         BE    PRCACN80            YES,   PROCESS  EXCLUDE                      
         EXMVC RF,0(RE),FAKEFLD    INSERT FIELD                                 
*&&DO                                                                           
         CLI   APPARM,1            SINGLE ACCOUNT ?                             
         BNE   PRCACN75            NO,    SKIP                                  
         CLI   RQFRPT,ONLY         FORMAT ONLY REPORT ?                         
         BE    PRCACN75            YES,   SKIP SOON TEST                        
         CLI   APACTN,ACTSOON      ARE    WE   SOONING                          
         BNE   PRCACN75            NO,    SKIP                                  
*                                                                               
*                                  CHECK  FOR  WILDCARD CHARACTER               
         GOTO1 WILDCARD,APPARM,ACQUNT,(1,LULACNT)                               
         LTR   RF,RF               ANY    WILDCARD CHARACTERS ?                 
         BM    PRCACNER            INVALID,    EXIT                             
         BZ    PRCACN75            NO,    SKIP                                  
*                                  YES,   FOUND WILDCARD CHARACTERS             
         B     IVALSOON            ERROR, INVALID  SOONING REQUEST              
*                                                                               
PRCACN75 DS    0H                                                               
*&&                                                                             
         B     PRCACNEX            EXIT                                         
...
PRCACN80 DS    0H                                                               
         CLI   RQFRPT,ONLY         FORMAT ONLY REPORT ?                         
         BE    PRCACN85            YES,   SKIP SOON TEST                        
**&US*&& CLI   APACTN,ACTSOON      ARE    WE   SOONING                          
**&US*&& BE    IVALSOON            YES,   ERROR                                 
*                                                                               
PRCACN85 DS    0H                                                               
...
FILLFLD  NMOD1 0,**FILL**                                                       
         ...
         SH    RF,=H'09'           MINUS FIELD HEADER                           
         TM    1(R4),FVAXTND       EXTENDED HEADER?                             
         BZ    *+8                                                              
         SH    RF,=H'08'           MINUS EXTENDED FIELD HEADER                  
...
CKRCP10  DS    0H                                                               
         LR    R1,R4               ->   RECORD                                  
         MVI   APELCODE,RPFELQ     GENERAL   PROFILE   DATA                     
         GOTO1 GETEL               GET  THE  ELEMENT                            
         BNE   CKRCPDWN            NONE,     NOT  DOWN-LOAD RECORD              
*                                            PROFILE   DATA                     
*                                                                               
         USING RPFELD,R1           MAP  PROFILE   DATA ELEMENT                  
         TM    RPFDNOPT,RPFDDOWN   FORCE     DOWN-LOAD ?                        
         BO    CKRCPDWN            YES, DOWN-LOAD INVALID   FOR  RECAP          
         B     CKRCPEX             EXIT OKAY                                    
         DROP  R1                                                               
*                                                                               
...
*                                       REPORT    TYPE                          
         ...
         B     CKRCPEX             RETURN                                       
*                                                                               
CKRCPDWN DS    0H                  RECAP     REQUEST   AND  DOWN-LOAD           
*                                            CONFLICT                           
...
*MN      ZIC   R3,RESKEY+RESKFRML           GET REQUEST NUMBER                  
         ZIC   R3,RESKEY+RESKFRML+1         GET REQUEST NUMBER                  
*MN      MVI   RESKEY+RESKFRML,C' '         ORIGINAL FORMAT KEY                 
...
TWAD     DSECT                                                                  
       ...
       ++INCLUDE ACSCRF5D                                                       
         ORG                                                                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'091ACSCR07S  05/24/00'                                      
         END                                                                    
