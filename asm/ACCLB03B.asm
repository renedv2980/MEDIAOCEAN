*          DATA SET ACCLB03B   AT LEVEL 063 AS OF 12/22/99                      
*PHASE T62103B                                                                  
...
*&&UK                                                                           
         CLI   CSACT,ACTZOO                                                     
         BNE   INIT02                                                           
         CLI   CUCTRY2,CTRYSCA     TEST SCANDINVIA                              
         BE    INIT02                                                           
         XC    REGWUWD,REGWUWD                                                  
         XC    REGWUCM,REGWUCM                                                  
         OI    REGWUCMH+FHATD,FHATPR                                            
         XC    REGWUHR,REGWUHR                                                  
         OI    REGWUHRH+FHATD,FHATPR                                            
*&&                                                                             
INIT02   CLI   ZISLST,0                                                         
         BNE   *+8                                                              
         OI    ZINDS,ZIDIS                                                      
...
RECOV02  CLI   BCPFKEY,PFK01       TEST FOR CLEAR PFKEY                         
         ...
         B     RECOVX                                                           
*                                                                               
RECOV04  DS    0H                  DELETE RECOVERY ELEMENT                      
         GOTO1 FINDPTA,=AL1(PTATWOFR)                                           
         GOTO1 ATOBCHA,BOPARM,ATRNREC,ZAPTAEL,0                                 
...
*        DC    H'0'                                                             
         ...
         BO    *+8                                                              
         LA    R0,CSEXCVAL                                                      
         GOTO1 APRORATA,BOPARM,ATRNREC,AGOPBLK,ACOM,(R0),LSPRATA,0              
...
*&&UK                                                                           
         GOTO1 APRORATA,BOPARM,ATRNREC,AGOPBLK,ACOM,(R0),LSPRATA,0              
         LA    RE,LSPRATA          SAVE PRIMARY AVAILABLE AMOUNTS               
         ZAP   BODUB1,PM$ANVBL-PRORATAD(L'PM$ANVBL,RE)                          
         ZAP   BODUB2,PM$ACVBL-PRORATAD(L'PM$ANVBL,RE)                          
         ZAP   BODUB3,PM$DSVBA-PRORATAD(L'PM$ANVBL,RE)                          
         MVC   BCWORK(L'CSCPYCUR),CSCPYCUR                                      
         MVC   BCWORK+L'CSCPYCUR(L'CSBILCUR),CSBILCUR                           
         GOTO1 VTOBACCO,BOPARM,('TOBAACVS',BCWORK),ATRNREC,ACOM,0,0             
         XR    R0,R0                                                            
         B     READ06                                                           
*&&                                                                             
READ04   LA    R0,CSEXCVAL                                                      
READ06   GOTO1 APRORATA,BOPARM,ATRNREC,AGOPBLK,ACOM,(R0),LSPRATA,0              
         LA    RE,LSPRATA          IF BILLING IN SECOND CURRENCY                
         CLC   CSCPYCUR,BCCPYSEC   SAVE PRIMARY AVAILABLE AMOUNTS               
         BNE   READ08                                                           
         ZAP   PM$FNVBL-PRORATAD(L'PM$FNVBL,RE),BODUB1                          
         ZAP   PM$FCVBL-PRORATAD(L'PM$FNVBL,RE),BODUB2                          
         ZAP   PM$DSVBF-PRORATAD(L'PM$FNVBL,RE),BODUB3                          
READ08   LA    RE,LSPRATAS                                                      
         LA    RF,PR$LNQ                                                        
         LA    R0,LSPRATA                                                       
         LR    R1,RF                                                            
...
WRITE36  NI    TRXSTA2,FF-(TRXSXFRP+TRXSWOFP+TRXSBILP)                          
         ...
         DROP  R3,R2                                                            
*                                                                               
WRITE38  TM    LSINDS2,LSTOBACC    TEST RECORD IS CONVERTED                     
         BNO   WRITE39                                                          
         NI    LSINDS2,FF-LSTOBACC                                              
*&&UK                                                                           
         MVC   BCWORK(L'CSCPYCUR),CSBILCUR                                      
         MVC   BCWORK+L'CSCPYCUR(L'CSBILCUR),CSCPYCUR                           
         GOTO1 VTOBACCO,BOPARM,('TOBAACVB',BCWORK),ATRNREC,ACOM,0,0             
*&&                                                                             
WRITE39  LH    R1,=Y(IOTRN)                                                     
...
PROSCR   NTR1  ,                                                                
         ...
         BZ    *+10                                                             
         OC    BOFULL1,=AL4(PROTREVP)                                           
         CLI   CSACT,ACTZWR        TEST WRITE-OFF RECOVERY                      
         BNE   *+10                                                             
         OC    BOFULL1,=AL4(PROTREC)                                            
         CP    PA$HOURS,BCPZERO    TEST ANY HOURS TO ALLOCATE                   
         BNE   PSCR02                                                           
         CLI   TRNTYPE,99          TEST EXTRA BILLING                           
         BE    PSCR02                                                           
         OC    BOFULL1,=AL4(PROTNOHR)                                           
*                                                                               
PSCR02   TM    TLXSTAT,TLXSHOUR    TEST HOURLY ITEM                             
         BO    PSCR04                                                           
         OC    BOFULL1,=AL4(PROTNHWC)                                           
*                                                                               
PSCR04   CLC   TRNKWORK,ORDWC      TEST AN ORDER                                
         BNE   *+16                                                             
         OC    BOFULL1,=AL4(PROTORD)                                            
         OC    CSMASK,=AL2(CSMORD)                                              
         CLI   TRNTYPE,99          TEST EXTRA BILLING                           
         BNE   *+16                                                             
         OC    BOFULL1,=AL4(PROTEXT)                                            
...
*                                                                               
PSCR08   OC    PROTCOND,PROTCOND                                                
         BZ    EXIT                                                             
         MVC   BOFULL2,BOFULL1     MATCH ON CONDITIONS                          
         NC    BOFULL2,PROTCOND                                                 
         BZ    PSCR14                                                           
*                                                                               
...
DISTYP   NTR1  ,                                                                
         ...
         MVI   BOBYTE1,0                                                        
         CLC   BCCPYSEC,CSBILCUR   TEST SECOND CURENCY                          
         BE    *+12                THEN SHOW CURRENCY                           
         TM    ZINDS,ZIAGYCUR                                                   
         BO    *+8                                                              
         OI    BOBYTE1,TYPIFC                                                   
         NC    BOBYTE1,TYPINDS                                                  
...
*&&UK                                                                           
         ...
         DROP  RF                                                               
         GOTO1 VEUREKA,BODMCB,('APPLYQ',BOWORK1),BOPL82,BOPL81                  
*&&                                                                             
...
DISALL   GOTO1 DISAMT,BOPARM,REGALNT,PP$AALLO,PP$FALLO                          
         ...
         SPACE 1                                                                
***********************************************************************         
* DISPLAY WRITE-UP (PENDING)                                          *         
***********************************************************************         
         SPACE 1                                                                
DISWUP   CLI   CUCTRY2,CTRYSCA                                                  
         BNE   EXIT                                                             
*&&UK                                                                           
         GOTO1 DISAMT,BOPARM,REGWUCM,PP$WUAMT,PP$WUAMT                          
         GOTO1 DISHRS,(R1),REGWUHR,PP$WUHRS                                     
         B     EXIT                                                             
*&&                                                                             
         SPACE 1                                                                
***********************************************************************         
...
*        DC    H'0'                                                             
*        MVC   ZAPTAEL,16(R1)                                                   
         GOTO1 ATOBCHA,BOPARM,ATRNREC,(R2),Z.PTAELD                             
         MVC   ZAPTAEL,12(R1)                                                   
*                                                                               
...
VALALL   TM    REGALNTH+FHIID,FHIIVA                                            
         BO    VALL10                                                           
*&&UK*&& NI    REGWUCMH+FHIID,FF-FHIIVA                                         
...
*        GOTO1 VHELLO,BOPARM,(C'D',ACCMST),('FF',ATRNREC),0                     
         GOTO1 ATOBCHA,BOPARM,ATRNREC,(R2),0                                    
...
*                                                                               
VXFAC10  DS    0H                                                               
         GOTO1 AVALXFR,BOPARM,ATRNREC,Z.PTAELD                                  
         BE    *+16                                                             
         LA    RF,REGXFWCH                                                      
         ST    RF,FVADDR                                                        
         B     EXITN                                                            
...
*&&                                                                             
         EJECT                                                                  
***********************************************************************         
* VALIDATE WRITE-UP LINE                                              *         
***********************************************************************         
         SPACE 1                                                                
VALWUP   CLI   CUCTRY2,CTRYSCA                                                  
         BNE   EXITY                                                            
*&&UK                                                                           
         ZAP   BODUB1,BCPZERO      SET ZERO AMOUNT                              
         CLI   REGWUCMH+FHILD,0    TEST COMMISSION INPUT                        
         BNE   VWUP01                                                           
         CLI   REGWUHRH+FHILD,0    NO COMM INPUT - TEST ANY HOURS               
         BNE   VWUP02              NO - LEAVE THIS PTAEL ALONE                  
         OI    REGWUCMH+FHIID,FHIIVA                                            
         OI    REGWUHRH+FHIID,FHIIVA                                            
         CP    PP$WUAMT,BCPZERO    TEST ANY WRITE-UP BEFORE                     
         BZ    EXITY               NO - FINE                                    
         ZAP   BODUB3,BCPZERO                                                   
         ZAP   BODUB4,BCPZERO                                                   
         B     VWUP12              ENSURE EXISTING WRITE-UP CLEARED             
*                                                                               
VWUP01   GOTO1 VALAMT,BOPARM,REGWUCMH,BODUB1                                    
         BNE   EXITN                                                            
VWUP02   OI    REGWUCMH+FHIID,FHIIVA                                            
         ZAP   BODUB4,BODUB1       SAVE WRITE-UP AMOUNT                         
         BZ    VWUP06                                                           
         BM    VWUP04              NEGATIVE WRITE-UP NOT ALLOWED                
         CP    PP$AALLO,BCPZERO    NON-ZERO WRITE-UP - CHECK ANY ALLOC          
         BNZ   VWUP06                                                           
VWUP04   MVC   FVMSGNO,=AL2(AE$ININP)                                           
         B     EXITN                                                            
VWUP06   ZAP   BODUB1,BCPZERO                                                   
         CLI   REGWUHRH+FHILD,0                                                 
         BE    VWUP08                                                           
         GOTO1 VALAMT,BOPARM,REGWUHRH,BODUB1                                    
         BNE   EXITN                                                            
         CP    BODUB1,=P'14000'    DON'T ALLOW MORE THAN THIS                   
         BH    *+14                                                             
         CP    BODUB1,=P'0'        DON'T ALLOW NEGATIVE HOURS                   
         BNL   VWUP08                                                           
         MVC   FVMSGNO,=AL2(AE$INVAM)                                           
         B     EXITN                                                            
VWUP08   OI    REGWUHRH+FHIID,FHIIVA                                            
         ZAP   BODUB3,BODUB1       SAVE INPUT WRITE-UP HOURS                    
         BZ    VWUP12                                                           
         CP    PP$AALLO,BCPZERO    NON-ZERO WRITE-UP - CHECK ANY ALLOC          
         BNZ   VWUP12                                                           
         MVC   FVMSGNO,=AL2(AE$ININP)                                           
         B     EXITN                                                            
*                                                                               
VWUP12   AP    BODUB1,BODUB4       BODUB1=COMMISSION + HOURS                    
         SR    R0,R0                                                            
         L     R3,ATRNREC                                                       
         LA    R3,TRNRFST-TRNRECD(R3)                                           
         USING PTAELD,R3                                                        
...
*                                                                               
         ...
         ZAP   PTAWUAMT,BODUB4     SET WRITE-UP COMMISSION AMOUNT               
         BZ    *+8                                                              
         OI    PTASTAT2,PTASWRUP   SET THIS ELEMENT HAS WRITE-UP                
         CVB   R0,BODUB3                                                        
         STCM  R0,3,PTAWUHRS       SET WRITE-UP HOURS                           
         OC    PTAWUHRS,PTAWUHRS                                                
         BZ    *+8                                                              
         OI    PTASTAT2,PTASWRUP   SET THIS ELEMENT HAS WRITE-UP                
         TM    PTASTAT2,PTASWRUP                                                
         BZ    VWUP16                                                           
*                                                                               
         CP    PTAWUAMT,BCPZERO    TEST COMMISSION INPUT                        
         BNE   VWUP15                                                           
         CP    PA$HOURS,BCPZERO    TEST ORIGINAL HOURS AVAILABLE                
         BNE   *+14                                                             
         MVC   FVMSGNO,=AL2(AE$INVAM)                                           
         B     EXITN                                                            
         ZAP   BODUB4,BODUB3       CALCULATE COMMISSION FROM HOURS              
         XC    BODUB3,BODUB3                                                    
         MP    BODUB3(16),PA$NET                                                
         DP    BODUB3(16),PA$HOURS                                              
         ZAP   PTAWUAMT,BODUB3                                                  
         B     VWUP16                                                           
*                                                                               
VWUP15   OC    PTAWUHRS,PTAWUHRS   TEST ANY HOURS INPUT                         
         BNZ   VWUP16              YES - FINE                                   
         CP    PA$HOURS,BCPZERO    TEST TIME POSTING                            
         BZ    VWUP16              NO                                           
         ZAP   BODUB3(16),PA$NET   SET HOURS FROM AMOUNT                        
         DP    BODUB3(16),PA$HOURS BODUB3=RATE                                  
         ZAP   BODUB1(16),PTAWUAMT                                              
         DP    BODUB1(16),BODUB3                                                
         CVB   R0,BODUB1                                                        
         STCM  R0,3,PTAWUHRS                                                    
*                                                                               
VWUP16   GOTO1 APRORATA,BOPARM,ATRNREC,AGOPBLK,ACOM,0,LSPRATA,0                 
         B     EXITY                                                            
*                                                                               
VWUP18   CP    BODUB1,BCPZERO      NO PTAEL - TEST ANY WRITE-UP                 
         BNE   EXITN               YES - THAT'S NOT ON!                         
         B     EXITY                                                            
*&&                                                                             
         EJECT                                                                  
***********************************************************************         
...
*&&                                                                             
*&&UK                                                                           
         DC    AL2(DISWUP-CLB03,VALWUP-CLB03)                                   
         DC    AL2(REGWUCMH-TWAD,REGWUHRH-TWAD)                                 
         DC    AL1(0)                                                           
         DC    AL1(ZUPDITRN+ZUPDIJOB)                                           
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
...
***********************************************************************         
         SPACE 1                                                                
PROTTABD DSECT                                                                  
PROTCOND DS    XL4                 PROTECT FIELDS BECAUSE ....                  
PROTORD  EQU   X'80000000'         ..... IS AN ORDER                            
PROTEXT  EQU   X'40000000'         ..... IS AN EXTRA BILLING ITEM               
PROTREC  EQU   X'20000000'         ..... IS THE ZOOMWR SCREEN                   
PROTREVP EQU   X'10000000'         ..... REVERSAL IS PENDING                    
PROTNOHR EQU   X'08000000'         ..... NO HOURS TO ALLOCATE                   
PROTFCON EQU   X'04000000'         ..... FCONTROL RECORD NOT SET TO W           
PROTNOCM EQU   X'02000000'         ..... ITEM IS NON-COMMISSIONABLE             
PROTHOUR EQU   X'01000000'         ..... ITEM IS ON TIME                        
PROTNONC EQU   X'00800000'         ..... BILLING TYPE IS NON-CLIENT             
PROTCUR  EQU   X'00400000'         ..... BILLING CURRENCY NOT AS ITEM           
PROTUNA  EQU   X'00200000'         ..... CANNOT MARK UNAUTH ITEM                
PROTWLST EQU   X'00100000'         ..... ZOOMED IN FROM WRONG LIST              
PROTRVAL EQU   X'00080000'         ..... ITEM REQUIRES REVALUING                
PROTNHWC EQU   X'00040000'         ..... NON-HOURLY WORKCODE                    
PROTNOWO EQU   X'00020000'         ..... SECURITY DISALLOWS WRITE-OFFS          
PROTNOXF EQU   X'00010000'         ..... SECURITY DISALLOWS TRANSFERS           
...
*&&UK*&& DC    AL4(PROTNHWC)                                                    
*&&UK*&& DC    AL2(REGWUHRH-TWAD,REGWUHRH-TWAD)                                 
         DC    AL4(PROTFCON)                                                    
         DC    AL2(REGNAR1H-TWAD,REGNAR2H-TWAD)                                 
         DC    AL4(PROTNONC+PROTUNA)                                            
         DC    AL2(REGALNTH-TWAD,REGALHRH-TWAD)                                 
*&&UK*&& DC    AL4(PROTORD)                                                     
*&&UK*&& DC    AL2(REGWUCMH-TWAD,REGWUHRH-TWAD)                                 
         DC    AL4(PROTNOWO)                                                    
         DC    AL2(REGWONTH-TWAD,REGWOACH-TWAD)                                 
         DC    AL4(PROTNOXF)                                                    
         DC    AL2(REGXFNTH-TWAD,REGXFSKH-TWAD)                                 
PRTZOOX  DS    AL4(EOT)                                                         
*                                                                               
PROTZWO  DS    0X                  * ZOOM WRITE-OFF *                           
         DC    AL4(PROTNOHR)                                                    
         DC    AL2(WOFHRSH-TWAD,WOFHRSH-TWAD)                                   
         DC    AL4(PROTORD+PROTEXT+PROTREVP+PROTCUR+PROTWLST+PROTRVAL)          
...
*&&US*&& DC    AL2(WOFNETH-TWAD,WOFANALH-TWAD)                                  
         DC    AL4(PROTNOHR)                                                    
         DC    AL2(WOFHRSH-TWAD,WOFHRSH-TWAD)                                   
         DC    AL4(PROTORD+PROTEXT+PROTREVP+PROTCUR+PROTWLST)                   
         DC    AL2(WOFNETH-TWAD,WOFNAR2H-TWAD)                                  
PROTZWRX DS    AL4(EOT)                                                         
         EJECT                                                                  
***********************************************************************         
...
SANALOFF DS    CL2                 ANALYSIS OFFICE CODE (US ONLY)               
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'063ACCLB03B  12/22/99'                                      
         END                                                                    
