*          DATA SET REREPTV02  AT LEVEL 019 AS OF 05/01/02                      
*PHASE RETV02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
*INCLUDE XSORT                                                                  
         TITLE 'REREPTV02 (RETV02) - NEW REP TV FILE EXTRACT/CREATION'          
*                                                                               
********************************************************************            
*                                                                  *            
*        REREPKH02 -- EXTRACTS AND CREATS A NEW FILE WITH REP      *            
*                      CODE TV FROM THE BLAIR FILE                 *            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
...
* CONTRACTS MUST FALL WITHIN 12/26/94-12/31/95                                  
                                                                                
         CLC   RCONDATE+3(3),=X'5E0C1A'                                         
         BL    CONT15                                                           
         CLC   RCONDATE(3),=X'5F0C1F'                                           
         BH    CONT15                                                           
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019REREPTV02 05/01/02'                                      
         END                                                                    
