*          DATA SET APGHFIBSJ  AT LEVEL 088 AS OF 05/01/02                      
*PHASE ACHFIBSJ,+0                                                              
...
*        DC    AL1(13,R1ROW2-R1RECD)                                            
*                                                                               
*        DC    AL1(16,R1ROW2-R1RECD)                                            
*        DC    AL1(17,R1ROW2-R1RECD)                                            
*        DC    AL1(18,R1ROW2-R1RECD)                                            
         DC    X'FF'                                                            
*                                                                               
...
*        ACGENBOTH                                                              
       ...
       ++INCLUDE ACGENBOTH                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'088APGHFIBSJ 05/01/02'                                      
         END                                                                    
