*          DATA SET REAURCD    AT LEVEL 113 AS OF 07/16/07                      
*PHASE REAURCDA,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
*INCLUDE HELEN                                                                  
*INCLUDE LOCKSPC                                                                
         TITLE 'REAURCD - REPPAK AVERAGE UNIT RATE FILE CREATE'                 
**********************************************************************          
*  HISTORY OF CHANGES                                                *          
**********************************************************************          
...
*                                                                    *          
*  16JUL07  (BU ) --- ATTEMPT TO RECREATE REAURCRA, THE 'NON-        *          
*                     PRODUCTION' VERSION BEING USED BY PMC, FOR     *          
*                     WHICH THE SOURCE CODE HAS BEEN LOST.  TO       *          
*                     ENSURE WE DON'T LOSE IT AGAIN, REAURCRA        *          
*                     IS BEING RENAMED REAURCD, AND ASSEMBLED AS     *          
*                     SUCH.  JCL WILL BE ADJUSTED TO CALL REAURCD,   *          
*                     AND THIS WILL BECOME AN ALTERNATE PRODUCTION   *          
*                     VERSION.                                       *          
*                                                                    *          
*                                                                    *          
*                                                                    *          
...
REAURCD  CSECT                                                                  
         ...
         ENTRY SSB                                                              
         PRINT NOGEN                                                            
         NBASE 0,REAURCD,VREGSAVE,R9,RA                                         
****     LA    RC,2048(RB)                                                      
****     LA    RC,2048(RC)                                                      
****     LA    RA,2048(RC)                                                      
****     LA    RA,2048(RA)                                                      
****     USING REAURCD+4096,RC,RA                                               
*                                                                               
         L     R8,=V(CPRINT)                                                    
         USING DPRINT,R8                                                        
*                                                                               
...
REBU0050 L     R6,AREC                                                          
         ...
         BAS   RE,GETEL                                                         
         BNE   REBU0010            NO X'02' ELEMENT: SKIP BUY                   
*                                                                               
*   NO X'02' INDICATES A BAD BUY RECORD ON FILE                                 
*                                                                               
         BAS   R5,CHKTIM                                                        
...
PSEUDO   CSECT                                                                  
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'113REAURCD   07/16/07'                                      
         END                                                                    
