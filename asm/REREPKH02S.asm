*          DATA SET REREPKH02S AT LEVEL 013 AS OF 05/01/02                      
*PHASE REKH02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
* CONTRACTS MUST FALL WITHIN 12/28/92-12/25/94                                  
                                                                                
         CLC   RCONDATE+3(3),=X'5C0C1C'                                         
         BL    CONT15                                                           
         CLC   RCONDATE(3),=X'5E0C19'                                           
         BH    CONT15                                                           
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013REREPKH02S05/01/02'                                      
         END                                                                    
