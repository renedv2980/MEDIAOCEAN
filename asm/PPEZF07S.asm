*          DATA SET PPEZF07S   AT LEVEL 088 AS OF 06/27/95                      
*PHASE T43007A,*                                                                
...
***********************************************************************         
*                                                                     *         
*        VRHINVL - LAST  FOR INVOICEPROCESSING                        *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
VRHINVL  DS    0H                                                               
...
*                                                                               
         ...
         NI    DIVCCDH+1,X'0C'        FORCE NORMAL INTENSITY                    
         B     DRHCCD1                                                          
*                                                                               
         OI    DIVCCDH+1,X'08'     FORCE HIGH   INTENSITY                       
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE CTGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'088PPEZF07S  06/27/95'                                      
         END                                                                    
