*          DATA SET SPTST00A   AT LEVEL 134 AS OF 05/01/02                      
*PHASE T21F00A,+0                                                               
*INCLUDE TWANG                                                                  
*INCLUDE DUMPOUT                                                                
...
VALDAY10 CLC   FLD(3),=C'VAR'                                                   
         ...
         B     EXIT                                                             
*                                                                               
         CLI   DBSELSRC,C'R'       ONLY FOR RADAR                               
         BNE   VALDAY11                                                         
         CLC   FLD(3),=C'MF*'                                                   
         BNE   *+12                                                             
         MVI   DUB,X'91'                                                        
...
*                                                                               
         MVI   IUNPRT,0                                                         
         XC    DEMOVALS(255),DEMOVALS                                           
         XC    DEMOVALS+255(225),DEMOVALS+255                                   
...
CNV60    DS    0H                                                               
         XC    DEMOVALS(255),DEMOVALS                                           
         XC    DEMOVALS+255(255),DEMOVALS+255                                   
...
INPTBL   DS    0XL11                                                            
         ...
         DC    AL1(1,1,L'DBBTYPE),X'00',AL3(0)                                  
...
* FAFACTS                                                                       
       ++INCLUDE FAFACTS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'134SPTST00A  05/01/02'                                      
         END                                                                    
