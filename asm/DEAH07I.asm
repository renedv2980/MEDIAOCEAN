*          DATA SET DEAH07I    AT LEVEL 068 AS OF 03/21/14                      
...
*                                                                               
         CLC   TAPEBK,=AL1(107,9)  USE THIS IPHASE FOR DATA STARTING            
         BNL   *+6                 SEP/07. USE DEAH9907 BEFORE SEP07            
         DC    H'0'                                                             
*                                                                               
         CLC   TAPEBK,=AL1(109,2)  USE THIS IPHASE FOR DATA BEFORE              
         BL    *+6                 FEB/09. USE DEAH09I AFTER FEB/09             
         DC    H'0'                                                             
*                                                                               
...
*        DDCOMFACS                                                              
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'068DEAH07I   03/21/14'                                      
         END                                                                    
