*          DATA SET ACCLB16B   AT LEVEL 249 AS OF 12/22/99                      
*PHASE T62116B                                                                  
...
*                                                                               
         ...
         BNE   EXITL               ERROR                                        
*                                                                               
         GOTO1 AVALBAT,BOPARM,(C'V',PBRECQ),BASREFH,BASMONH                     
         BNE   EXITL                                                            
*                                                                               
...
PFKRTN   LA    R0,C'D'                                                          
         ...
         BNE   *+8                                                              
         LA    R0,C'U'                                                          
         GOTO1 AVALBAT,BOPARM,((R0),PBRECQ),BASREFH,BASMONH                     
...
VALCLR   L     R2,AIO1             R2=A(TRANSACTION RECORD)                     
         USING TRNRECD,R2                                                       
VALC05   LA    R3,TRNRFST          R3=A(FIRST ELEMENT ON TRANSACTION)           
         USING PTAELD,R3                                                        
         XR    R0,R0                                                            
...
*                                                                               
         ...
         TM    PTASTAT1,PTASPEND   PENDING ACTIVITY?                            
         BNO   VALC20                                                           
         GOTO1 ATOBCHA,BOPARM,AIO1,PTAELD,0  DELETE ELEMENT                     
         B     VALC05              START LOOP AGAIN                             
*        MVI   PTAEL,FF                                                         
*        B     VALC20                                                           
*                                                                               
*ALC30   GOTO1 VHELLO,BOPARM,(C'D',ACCMST),('FF',AIO1),0                        
*        CLI   12(R1),0                                                         
*        BE    *+6                                                              
*        DC    H'0'                                                             
*                                                                               
...
*&&                                                                             
         LA    R0,CSEXCVAL                                                      
VALC32   GOTO1 APRORATA,BOPARM,AIO1,AGOPBLK,ACOM,(R0),LSPRATA,0                 
*                                                                               
         CP    PP$AWOFF,BCPZERO    DRAFT WRITE-OFFS?                            
         BNE   VALC60                                                           
         BAS   RE,GETTRX                                                        
...
* DDFH                                                                          
       ...
       ++INCLUDE DDFH                                                           
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'249ACCLB16B  12/22/99'                                      
         END                                                                    
