*          DATA SET REREPST0B6 AT LEVEL 053 AS OF 05/01/02                      
*PHASE REST02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
*                                     IS ALREADY ON NEW REP?                    
         ...
         B     NADV0120                                                         
NADV0020 EQU   *                                                                
         MVC   SAVOLDAD,RCONKADV                                                
         MVC   SAVNEWAD,4(RF)                                                   
         MVC   RCONKADV(4),4(RF)   OLD ADV -> NEW ADV                           
         CLC   =C'PHON',SAVNEWAD   BAD CODE?                                    
         BNE   NADV0120            NO                                           
         MVC   P+1(17),=C'POSSIBLE BAD ADV:'                                    
         MVC   P+19(4),SAVNEWAD                                                 
         MVI   P+23,C'/'                                                        
         MVC   P+24(4),SAVOLDAD                                                 
         GOTO1 HEXOUT,DMCB,RCONKCON,P+32,=C'TOG'                                
         GOTO1 REPORT                                                           
*                                                                               
NADV0120 EQU   *                                                                
         DROP  R6                                                               
...
CHKP0120 EQU   *                                                                
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'053REREPST0B605/01/02'                                      
         END                                                                    
