*          DATA SET NEWRI20    AT LEVEL 149 AS OF 02/26/20                      
*PHASE T32020E                                                                  
*INCLUDE NETSPB                                                                 
*INCLUDE NETCOM                                                                 
*INCLUDE GETBROAD                                                               
...
* ---- ----------  -------- ----------------------------------------- *         
* AKAT SPEC-22936  05/03/18 HONOR SOFT DATES FOR CONNECT BILLING      *         
* AKAT SPEC-7982   12/02/16 SAVE & RESTORE NBHUNOPT ON NETVALUE CALLS *         
***********************************************************************         
* AKAT  142 07/22/15  ALWAYS SET TMPCHK/TMPCHDT FROM CLS5CHK/CLS5CHDT *         
* ????  136 10/05/11  IN INIT1 TURN ON NBI3BPRD FOR BOTH ALL AND      *         
*                     SPECIFIC PRD TO PREVENT DOUBLING OF DOLLARS ON  *         
*                     MUTIPLE CALL TO ACCGEN IN NEWRIDRIVE            *         
***********************************************************************         
T32020   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T32020**                                                       
...
VKEY     CLI   ACTNUM,ACTLIST      TEST ACTION=LIST                             
         ...
         BNE   VKEYX                                                            
*                                                                               
VKEY0    BRAS  RE,RDPROF           CHK WR PROFILE                               
...
* DISPLAY RECORD                                                                
*                                                                               
DISP     BRAS  RE,RDPROF           READ AGENCY'S WR PROFILE                     
         CLI   WORK+18,C'Y'        TEST FILTER REQUIRED                         
         BNE   DISPX                                                            
...
AE2      MVI   NBQINIT,0           DO ALL VALIDATIONS EACH TIME                 
         ...
         BNE   AE200               NO - ONLY SUPPORT COMSCORE FOR WRI           
         LAY   R4,COMDLIST         160 BYTES FOR COMSCORE DEMO NAMES            
*                                                                               
         USING NBXTNDD,RF                                                       
AE200    OC    NBEXTEND,NBEXTEND                                                
         JZ    *+12                                                             
         L     RF,NBEXTEND         A(EXTEND BLOCK)                              
         ST    R4,NBXCDNL          A(COMSCORE DEMO NAME LIST)                   
         DROP  RF                                                               
...
*                                                                               
         CLC   =C'@DDS',SPLCLI     DDS SPECIAL                                  
         BNE   *+12                                                             
         CLI   TWAOFFC,C'*'        MUST BE DDS TERMINAL                         
         BNE   FILTERR                                                          
*                                                                               
...
*                                                                               
         ...
         BNE   AUTHERR                                                          
*                                                                               
         CLC   LSTCLT,=C'@DDS'      IF DDS SPECIAL                              
...
*        PRESSED IN REPORT MODE WHEN LISTING STORED REQ RECS?                   
         ...
         BE    EDERR                                                            
*                                                                               
         BRAS  RE,CHKWRDST            WRITING TO DATASET FOR WB FLIGHT          
*                                                                               
         LA    R2,SPLCLIH                                                       
...
VPK32    LA    R3,FLAVLIST                                                      
         ...
         BRAS  RE,BLDDIGI          BUILD DIGINET TABLE                          
*                                                                               
...
*                                                                               
         CLC   =C'CNCTBILL',SPLNAM CONNECT BILLING?                             
         BNE   VREC2CA             NO                                           
*                                                                               
VREC2CAA GOTO1 PERVAL,DMCB,(5(R2),8(R2)),(0,WORK)                               
*                                                                               
         TM    DMCB+4,X'03'        INVALID/NO INPUT?                            
         BNZ   VREC2CA             YES - LET NVSTRDAT GIVE THE ERROR            
*                                                                               
         LA    R1,WORK             R1 = WORK                                    
         USING PERVALD,R1          PERVAL DSECT                                 
*                                                                               
         CLI   PVALASSM,X'70'      FULL START DATE ONLY ENTERED?                
         BE    *+12                YES - SO CONTINUE                            
         CLI   PVALASSM,X'71'      YYMM START DATE ONLY ENTERED?                
         BNE   VREC2CA             NO - LET NVSTRDAT GIVE THE ERROR             
*                                                                               
         MVC   8(6,R2),PVALESTA    YYMMDD                                       
         MVC   14(2,R2),=CL2' '    FORCE SPACES INTO LAST 2 CHARS               
*                                                                               
         DROP  R1                  DROP PERVALD USING                           
*                                                                               
         GOTO1 DATCON,DMCB,(0,8(R2)),(10,8(R2))                                 
*                                                                               
         MVI   5(R2),8             INPUT LENGTH OF 8 (YY/MM/DD)                 
         OI    6(R2),X'80'         TRANSMIT THE FIELD                           
*                                                                               
         LA    R1,SPLRENDH         END DATE                                     
         CR    R1,R2               DID WE PROCESS THE END DATE ALREADY?         
         BE    *+10                YES                                          
         LR    R2,R1               NO - SET R2 TO END DATE                      
         B     VREC2CAA            VALIDATE END DATE                            
*                                                                               
         LA    R2,SPLRSTRH         POINT TO START DATE AND REVALIDATE           
*                                                                               
VREC2CA  NETGO NVSTRDAT,DMCB                                                    
**********************************************************                      
...
*                                                                               
         LA    RF,XDNTDMS          NON-TRAD DEMO NAME LIST                      
*                                                                               
         ...
         DROP  R1                                                               
*                                                                               
ED4XX    NETGO NVDEM,DMCB,DBLOCK,XDDEMBLK                                       
*                                                                               
...
*                                                                               
         ...
         BNE   *+8                 NO                                           
         OI    NBINDS9,NBI9CP2     YES - FLAG COMSCORE PASS 2                   
         CLI   MCCSPASS-MCEXTRA(RF),MCCSP001 COMSCORE PASS 1?                   
         BNE   REPS10              NO                                           
         OI    NBINDS9,NBI9CP1     YES - FLAG COMSCORE PASS 1                   
         NI    NDINDS1,X'FF'-ND1STAB   SKIP STATION BUCKET RECORDS              
         NI    NBINDS2,X'FF'-NBBILLRD  SKIP BILL RECORDS                        
         NI    NDRDBCEL,X'FF'-X'01'    SKIP BILL RECORDS                        
         NI    NDRDBCEL,X'FF'-X'02'    SKIP CHECK NUMBERS                       
         NI    NDRDBCEL,X'FF'-X'05'    SKIP BILL HEADERS                        
         NI    NDRDBCEL,X'FF'-X'10'    SKIP CHECK NUMBERS                       
         NI    NDRDBCEL,X'FF'-X'21'    SKIP CASH APPLIED DATA                   
         NI    NDCOLIND,X'FF'-X'80'    SKIP GOALS                               
         NI    NDCOLIND,X'FF'-X'01'    SKIP GOAL HISTORY                        
         NI    NDCOLIND,X'FF'-X'10'    SKIP BUDGET                              
         NI    NBVARIND,X'FF'-X'20'    SKIP INVOICES                            
*                                                                               
REPS10   L     R3,ASPOOLD                                                       
         USING SPOOLD,R3                                                        
         DROP  R3                                                               
...
*****    MVI   NDRDBCEL,0         ... TURN OFF UNTBILELEM / CHQ READ            
         ...
         MVI   NBACTOPT,0                                                       
         B     UNITEND                 .NO                                      
GT002    BRAS  RE,SETUNRD              .SET TO READ UNITS                       
...
*                                                                               
         ...
         TM    NBVTYPS,X'40'       LOWER CASE ?                                 
         BO    *+12                                                             
         OI    NBVTYPS,X'40'       TURN ON UPPER CASE                           
         OI    NBVTYPS3,X'08'      TURN ON MXM POD INDICATOR                    
         MVI   VTYPCNT,1           SET TO 1ST PASS                              
ENDVTYP  EQU   *                                                                
*                                                                               
*                                                                               
...
*                                                                               
*          DATA SET SPWRI01    AT LEVEL 094 AS OF 07/17/08                      
FILNAMD  DSECT                                                                  
...
*              FILTER UNITS                                                     
         SPACE 3                                                                
FILTUNIT NTR1                                                                   
         NI    NBINDS9,X'FF'-NBI9DIGI                                           
         L     R2,=A(DIGITAB)                                                   
         CLI   0(R2),0            DIGINETS REQUESTED?                           
         JE    INVFLT2                                                          
         CLI   0(R2),X'FF'                                                      
         JE    INVFLT2                                                          
*                                                                               
DIGIFLT  CLI   0(R2),X'FF'                                                      
         JE    INVFLT2                                                          
         CLC   NBACTNET,0(R2)      DIGINET NETWORK?                             
         JNE   *+12                                                             
         OI    NBINDS9,NBI9DIGI                                                 
         J     INVFLT2                                                          
         AHI   R2,L'NBACTNET                                                    
...
*                                                                               
         ...
         BE    EDENDX                                                           
         LA    R2,SPLFLTH          POINT ERROR MSG TO FILTER FIELD              
         CLC   =C'@DDS',SPLCLI     IF DDS SPECIAL                               
         BNE   EDEND05                                                          
         CLC   =C'LOL',SPLFLT      MUST HAVE PASSWORD                           
         BNE   FILTERR                                                          
         B     EDEND10                                                          
*                                                                               
EDEND05  CLC   =C'@OJX',SPLCLI     IF SPECIAL OM/JW CROSS AGY REPORT?           
         BNE   EDENDX                                                           
         CLC   =C'CMBO',SPLFLT     MUST HAVE PASSWORD                           
         BNE   FILTERR                                                          
*                                                                               
EDEND10  XC    SPLFLT,SPLFLT       OK,CLEAR IT                                  
...
*                                                                               
         ...
         GOTO1 ERREX2                                                           
*                                                                               
EDENDXC  BRAS  RE,COMSCORE         FLAG REQSML IF COMSCORE                      
*                                                                               
EDENDXX  B     XMOD                EXIT                                         
         EJECT                                                                  
...
SPGKYSV  DS    CL12                                                             
         LTORG                                                                  
*                                                                               
* BUILD TABLE OF DIGINET NETWORKS                                               
*                                                                               
BLDDIGI  NTR1  BASE=*,LABEL=*                                                   
         CLI   OFFLINE,C'Y'                                                     
         JNE   BLDDIGIX                                                         
         TM    NDOPTS1,NO1DIGIQ    DIGINET REQUEST?                             
         JZ    BLDDIGIX                                                         
*                                                                               
         L     R3,=A(DIGITAB)                                                   
         MVI   0(R3),X'FF'                                                      
*                                                                               
         ...
         MVI   STAKMED,C'N'                                                     
         L     R4,=A(MYIO)                                                      
         GOTO1 DATAMGR,DMCB,=CL8'DMRDHI',=C'STATION',KEY,(R4),0                 
         J     BDIGI4                                                           
*                                                                               
BDIGI2   GOTO1 DATAMGR,DMCB,=CL8'DMRSEQ',=C'STATION',KEY,(R4),0                 
*                                                                               
BDIGI4   CLC   KEY(2),0(R4)                                                     
         JNE   BLDDIGIX                                                         
         ...
         CLC   STAKCLT,=C'000'                                                  
         JNE   BDIGI2                                                           
         TM    SFLAG2,S2DIGIQ      NETWORK IS DIGINET?                          
         JZ    BDIGI2                                                           
*                                                                               
         MVC   0(L'NBACTNET,R3),STAKCALL  SAVE NETWORK IN TABLE                 
         AHI   R3,L'NBACTNET                                                    
         MVI   0(R3),X'FF'                                                      
         J     BDIGI2                                                           
*                                                                               
...
PUTLIT   NTR1  BASE=*,LABEL=*                                                   
         ...
         LTORG                                                                  
*                                                                               
RDPROF   NTR1  BASE=*,LABEL=*      YES-READ AGENCY'S WR PROFILE                 
         XC    WORK,WORK                                                        
         MVC   WORK(4),=C'S0WR'                                                 
         MVC   WORK+4(2),AGENCY                                                 
...
CHKWRDST NTR1  BASE=*,LABEL=*                                                   
         ...
         LA    R2,SPLOPTH                                                       
         MVI   BYTE,0                                                           
AE1AA    GOTO1 SCANNER,DMCB,(R2),(7,0(R3)),0                                    
         ZIC   R4,4(R1)                                                         
         LTR   R4,R4                                                            
         BZ    AE1AAAA                                                          
AE1AAA   CLC   =C'FILE',12(R3)    CHECK FOR FILE                                
         BNE   *+12                                                             
         OI    NDINDS1,ND1WB       SET FLAG                                     
         B     AE1AAAA                                                          
         LA    R3,32(R3)                                                        
         BCT   R4,AE1AAA                                                        
         CLI   BYTE,2                                                           
...
*                                                                               
         ...
         CLC   =C'WRITER',CONREC   WRITER REPORT?                               
         BNE   CSXIT               NO - DONE                                    
         CLI   NBDODEMS,C'Y'       REQUESTING DEMOS?                            
         BE    *+20                YES                                          
         CLI   REQSML,C'C'         REQSML ALREADY SET TO "C"?                   
         BNE   CSXIT               NO - LEAVE AS IS                             
         MVI   REQSML,0            IN CASE THEY USED THE "DEMOS=" OPT           
         B     CSXIT               NO - DONE                                    
         LAY   R5,COMDLIST         COMSCORE DEMO NAMES                          
         OC    0(160,R5),0(R5)     HAVE A COMSCORE DEMO IN THE LIST?            
         BZ    *+8                 NO                                           
...
*                                                                               
         ...
         NETGO NVSETSPT,DMCB       SET FOR SPOT READ                            
         MVC   SYSFIL,=C'SPTFILE ' SET TO SPTFILE                               
         MVC   SYSDIR,=C'SPTDIR  ' SET TO SPTDIR                                
*                                                                               
         LA    R5,KEY              R5 = ESTIMATE KEY                            
         USING ESTHDR,R5           ESTIMATE RECORD DSECT                        
         XC    KEY,KEY             CLEAR THE KEY                                
         MVC   EKEYAM,NBACTAM      A/M                                          
         CLC   NBSELCLI,=CL3'ALL'  ALL CLIENT REQUEST?                          
         BE    CS10                YES - LEAVE EKEYCLT AS NULLS                 
         OC    NBSELCLI,NBSELCLI   MULTI-CLIENT REQUEST?                        
         BZ    CS10                YES - LEAVE EKEYCLT AS NULLS                 
         MVC   EKEYCLT,NBACTCLI    SINGLE CLIENT REQUEST                        
*                                                                               
CS10     MVC   EKEYPRD,=C'POL'     POL EST HAVE THE SUPERSET OF DEMOS           
         MVC   EKEYEST,NBSELEST    ESTIMATE START                               
         CLI   EKEYEST,0           NBSELEST = 0?                                
         BH    *+8                 NO                                           
         MVI   EKEYEST,1           YES - FORCE ESTIMATE 1                       
*                                                                               
CS20     GOTO1 HIGH                READ HIGH                                    
*                                                                               
         CLC   EKEYAM,NBACTAM      SAME A/M?                                    
         BNE   CSXIT               NO - DONE                                    
*                                                                               
         CLC   NBSELCLI,=CL3'ALL'  ALL CLIENT REQUEST?                          
         BE    CS30                YES - ACCEPT ALL CLIENTS                     
         OC    NBSELCLI,NBSELCLI   MULTI-CLIENT REQUEST?                        
         BZ    CS30                YES - ACCEPT ALL CLIENTS                     
         CLC   EKEYCLT,NBACTCLI    SAME CLIENT CODE?                            
         BNE   CSXIT               NO - DONE                                    
*                                                                               
CS30     CLC   EKEYPRD,=C'POL'     POL PRODUCT?                                 
         BE    CS40                YES                                          
         BH    CS50                IF HIGH - FORCE NEXT CLIENT                  
         MVC   EKEYPRD,=C'POL'     NO - READ FOR POL PRODUCT                    
CS35     MVC   EKEYEST,NBSELEST    ESTIMATE START                               
         CLI   EKEYEST,0           NBSELEST = 0?                                
         BH    *+8                 NO                                           
         MVI   EKEYEST,1           YES - FORCE ESTIMATE 1                       
         XC    EKEY+8(5),EKEY+8    CLEAR KEY AFTER ESTIMATE                     
         B     CS20                READ HIGH FOR POL PRODUCT                    
*                                                                               
CS40     CLI   EKEYEST,0           HAVE AN ESTIMATE RECORD?                     
         BE    CS35                NO                                           
         CLI   NBSELEST,0          ACCEPT ANY ESTIMATE?                         
         BE    CS55                YES                                          
         CLC   EKEYEST,NBSELEST    ESTIMATE = ESTIMATE START?                   
         BE    CS55                YES                                          
         BH    CS45                IF HIGHER TEST FOR RANGE                     
         MVC   EKEYEST,NBSELEST    BUMP TO ESTIMATE START                       
         XC    EKEY+8(5),EKEY+8    CLEAR KEY AFTER ESTIMATE                     
         B     CS20                READ HIGH FOR NEXT ESTIMATE                  
*                                                                               
CS45     CLI   NBSELESE,0          PROCESSING ESTIMATE RANGE?                   
         BE    CS50                NO - FORCE NEXT CLIENT                       
         CLC   EKEYEST,NBSELESE    ESTIMATE <= ESTIMATE END?                    
         BNH   *+14                YES                                          
CS50     MVC   EKEY+4(9),XFF       NO - BUMP TO NEXT CLT                        
         B     CS20                READ HIGH FOR NEXT CLIENT                    
*                                                                               
CS55     OC    EKEY+8(5),EKEY+8    IS THIS AN ESTIMATE RECORD?                  
         BNZ   CS70                NO - FORCE NEXT ESTIMATE                     
*                                                                               
...
*                                                                               
         ...
         BL    CS70                NO                                           
         OC    ENONTDMS(200),ENONTDMS  HAVE ANY COMSCORE DEMOS?                 
         JNZ   *+14                                                             
         OC    ENONTDMS+200(200),ENONTDMS+200                                   
         JZ    CS70                                                             
         MVI   REQSML,C'C'         COMSCORE REQUEST                             
*                                                                               
CS60     TM    WHEN,X'20'          SOON REQUEST?                                
         BNZ   CSXIT               YES - DONE                                   
         OI    GENSTAT7,GES7COMS   FLAG OVERNIGHT COMSCORE                      
         B     CSXIT               YES - DONE                                   
*                                                                               
CS70     LA    R5,KEY              R5 = ESTIMATE KEY                            
...
MQRPTERR NTR1  BASE=*,LABEL=*                                                   
         L     R7,ATWA                                                          
         TM    NDINDS1,ND1WB        SEND OUTPUT TO FILE ?                       
...
***      GOTO1 AMQRPT,DMCB,(0,=C'OPEN'),(0,=C'MEDIACOMSFTP****'),,0             
         GOTO1 AMQRPT,DMCB,(0,=C'OPEN'),(0,SPLTITL),,0                          
         CLI   DMCB+8,0                                                         
         JE    XIT                                                              
         DCHO                                                                   
*                                                                               
...
* AUTHORIZED AGENCY TABLE - AGY / REQUEST ID / ADDRESS OF LIST                  
         DS    0F                                                               
AGYTABL  DC    CL4'MC',CL4'DDS',A(DDSLIST)    DDS SPECIAL                       
*                                                                               
         DC    CL4'AT',CL4'ATT',A(ATTLIST)                                      
...
*                                                                               
         ...
         MVI   NBVTYPS3,X'01'        CLEAR BUT LEAVE OVERRIDE                   
...
*                                    RELOOK OF DEMOS IN CALLS                   
         ...
         BE    VTYPX                                                            
         TM    HALF,X'40'          LOWER CASE?                                  
         BO    *+12                                                             
         OI    HALF,X'40'          TURN ON UPPER CASE                           
         OI    NBVTYPS3,X'08'      TURN ON MXM POD                              
...
*                                  YES                                          
         ...
         BRAS  RE,GETPRD1          RETURNS 1 BYTE PRODUCT IN BYTE               
         ZIC   R1,BYTE                                                          
         DC    H'0'                                                             
...
***      GOTO1 DATCON,DMCB,(5,0),(2,CHQDATE) TODAY FOR CHQDATE                  
         GOTO1 DATCON,DMCB,(3,BTODAY),(2,CHQDATE) TODAY FOR CHQDATE             
         MVC   CHQBNKDT,CHQDATE    SAME FOR BANK DATE                           
         MVC   CHQCLRDT,CHQDATE    SAME FOR CLEARANCE DATE                      
         MVI   CHQDFT,C'*'        FLAG AS DEFAULT DATE                          
...
*                                                                               
         ...
         BNE   GETCH100                                                         
*                                                                               
*  RIGHT CHECK ELEMENT - GET INVOICE # FROM UNIT X'18' ELEM                     
*                                                                               
         XC    UNITTINV(20),UNITTINV   CLEAR TIME/INTG UNIT INV #S              
         L     R1,NBAIO            GET UNIT REC                                 
         LA    R1,27(R1)           BUMP TO  X'01'                               
         CLI   0(R1),X'01'                                                      
         BE    *+6                                                              
         DC    H'0'                ?????                                        
GTINV18  ZIC   RE,1(R1)                                                         
         ...
         BL    GTINV18                                                          
         USING NUDTAEL,R1                                                       
         MVC   UNITTINV,NUDTINVN   TIME INVOICE #                               
         MVC   UNITIINV,NUDTIIVN   INTEGRATION INVOICE #                        
         DROP  R1                                                               
GTINV19  EQU   *                                                                
*                                                                               
*  HERE FILL IN BLOCK WITH CHECK DATA                                           
*  X'01'DATA OR X'03' AND X'05' DATA                                            
*                                                                               
*                                                                               
*                                  NO                                           
         XC    TEMPBLK(TMPBLKE),TEMPBLK     ONLY HAS X'01' ELEMENT              
         MVC   TMPCLRDT,CLSTCLRD      CLEARANCE                                 
         MVC   TMPREPTP,CLSTREPT                                                
         MVC   TMPREP,=C'DIR'                                                   
*                                                                               
         CLC   CLSTPYEE,=C'000'                                                 
         BE    *+10                                                             
         MVC   TMPREP,CLSTPYEE                                                  
*                                                                               
         CLI   CLST01LN,CL01ELLN        HAS 3 CHAR PROD?                        
         BNH   *+16                                                             
         MVC   TMPPRD,CLST3PR      3 CHARACTER PROD CODE                        
         MVC   TMPPRD2,CLST3PR2    3 CHARACTER PROD CODE                        
*                                                                               
         CLI   TMPPRD,0            NO 3 CHAR PROD CODE?                         
         BNE   TEMP10                                                           
*                                                                               
         CLI   CLSTPRD,0                                                        
         BE    TEMP10                                                           
...
TEMP10   DS    0H                                                               
*                                                                               
         MVC   TMPGRS,CLSTGRS      GROSS                                        
         MVC   TMPNET,CLSTNET      NET                                          
         MVC   TMPCHK,CLSTCHK      CHK NUMBER                                   
         MVC   TMPCHKSQ,CLSTCLSQ   CHK SEQ NUMBER                               
         MVC   TMPCHDT,CLSTCHDT    CHK DATE                                     
         MVC   TMPSTAT,CLSTSTAT    STATUS                                       
         MVC   TMPBKDT,CLSTBKDT    BANK CLEARED DATE                            
         MVC   TMPEST,CLSTEST      ESTIMATE IF PRESENT                          
*                                                                               
         TM    NUPAYCR,X'10'       IF CASH RECEIPT (CK)                         
         BNO   TEMP20                                                           
*                                                                               
         BRAS  RE,GTWRPRF             READ WR PROFILE                           
*                                                                               
         LAY   R1,WRPROF+13                                                     
         CLI   0(R1),C'Y'             SKIP IF NOT REPORTING CK'S                
         BNE   TEMP20                                                           
*                                                                               
         MVC   TMPCHK,=CL6'CHECK'     SET SPECIAL CHECK NUMBER                  
         MVC   TMPCHDT,NUPAYDAT       SET AS CLEARANCE DATE AS CHK DTE          
*                                                                               
TEMP20   DS    0H                                                               
*                                                                               
         TM    NBINDS8,NBI8CLIV   SKIP IF NOT REPORTING VDR INVOICES            
         BNO   TEMP30                                                           
*                                                                               
         TM    CLSTSTAT,X'02'      DOES  X'03' ELEMENT FOLLOW                   
         BO    CLST10              YES                                          
*                                                                               
TEMP30   DS    0H                                                               
*                                                                               
         CLI   TMPPRD,0            NO-ALL PRODS OK?                             
         BE    GC30                                                             
         CLC   NBSPLPR3,TMPPRD        NO-CHECK PRODUCT                          
         BE    GC30                                                             
         CLC   NBSPLPR3,TMPPRD2                                                 
         BE    GC30                                                             
         B     GC10                                                             
                                                                                
* CLRST HAS X'03' AND X'05' ELEMENTS                                            
CLST10   DS    0H                                                               
         MVC   TMPSTAT,CLSTSTAT    SET X'01' STATUS                             
         MVC   TMPCLRDT,CLSTCLRD   SET X'01' CLEARANCE                          
         DROP  RA                                                               
         ZIC   RE,1(RA)            BUMP TO X'03' ELEM                           
         AR    RA,RE                                                            
CLST12   CLI   0(RA),X'03'                                                      
         BE    *+6                                                              
         DC    H'0'                ???                                          
         USING CLSTEL03,RA                                                      
         MVC   TMPINVNO,CLS3INV      INVOICE NUMBER                             
         OC    UNITTINV,UNITTINV   UNIT INV #                                   
         BZ    CLST12D                                                          
         BRAS  RE,MTCHINV          IS THERE AN INVOICE MATCH ?                  
         DROP  RA                                                               
                                                                                
CLST12D  BRAS  RE,SVINVKEY                                                      
*                                                                               
*                                  BUMP TO X'05' ELEM                           
         ZIC   RE,1(RA)                                                         
         AR    RA,RE                                                            
         ...
         USING CLSTEL05,RA                                                      
*                                                                               
CLST15   CLI   NBSPLPR3,0          DEALING WITH CORRECT PROD ?                  
         BE    CLST16                                                           
         CLI   CLS5PRD1,0                                                       
         BNE   CLST15B                                                          
         CLI   CLS5PRD2,0                                                       
         BE    CLST16                                                           
CLST15B  MVC   FULL(3),NBSPLPR3                                                 
         MVI   FULL+3,C'N'                                                      
* IF COPYSPLIT UNIT ONLY THE 1ST PROD WILL HAVE BEEN                            
* CREATED ON THE CLEARST RECORD                                                 
         L     R4,NBAIO                                                         
         MVI   ELCODE,X'19'           PRODUCT ELEMENT                           
         USING NUPDED,R4                                                        
         BAS   RE,GETEL2                                                        
         BNE   CLST15D                                                          
         CLI   NUPDELEN,17          ARE THERE MORE THEN 2 PRODUCTS              
         BH    CLST15C                                                          
         TM    NUPDEIND,NUPDCSP     IS COPYSPLIT INDICATOR SET                  
         BZ    CLST15D                                                          
CLST15C  MVC   FULL(3),NUPDEPR      YES, COMPARE CLEARST TO 1ST PROD            
         MVI   FULL+3,C'Y'          SET COPYSPLIT INDICATOR                     
         DROP  R4                                                               
*                                                                               
CLST15D  CLI   FULL+3,C'Y'          IS THIS A COPYSPLIT                         
*        BE    CLST15E                                                          
         CLC   FULL(3),CLS5PRD1                                                 
         BE    CLST16                                                           
         CLC   FULL(3),CLS5PRD2                                                 
         BE    CLST16                                                           
         B     CLST27                                                           
*  COPYSPLIT MATCH LOGIC:                                                       
*  UNIT MUST MATCH 1ST PRODUCT ON CLEARST RECORD                                
*  CLEARST ELEMENT CAN ONLY HAVE 1 PRODUCT                                      
CLST15E  CLC   CLS5PRD2,=XL3'404040'  IS THERE A SECOND PRODUCT                 
         BH    CLST27                                                           
         CLC   FULL(3),CLS5PRD1                                                 
         BE    CLST16                                                           
         B     CLST27                                                           
*  FOR COPYSPLITS UNIT MUCH MATCH 1ST PRODUCT ON CLEARST                        
*                                                                               
CLST16   L     R4,ABELEM                                                        
         USING NUPAYD,R4                                                        
         MVC   TMPPRD,CLS5PRD1     3 CHARACTER PROD CODE                        
         CLI   FULL+3,C'Y'         IS THIS A COPYSPLIT                          
         BNE   *+10                                                             
         MVC   TMPPRD,NBSPLPR3     MOVE UNIT PRODUCT IN                         
         MVC   TMPPRD2,CLS5PRD2    3 CHARACTER PROD CODE                        
         MVC   TMPGRS,CLS5GRS      GROSS                                        
         MVC   TMPNET,CLS5NET      NET                                          
*                                                                               
***      OC    CLS5CHK,CLS5CHK     CHK NUMBER ?                                 
***      BZ    *+10                                                             
         MVC   TMPCHK,CLS5CHK      CHK NUMBER                                   
*                                                                               
***      OC    CLS5CHDT,CLS5CHDT                                                
***      BZ    *+10                                                             
         MVC   TMPCHDT,CLS5CHDT    CHK DATE                                     
****                                                                            
****     OC    CLS5STAT,CLS5STAT                                                
****     BZ    *+10                                                             
****     MVC   TMPSTAT,CLS5STAT    STATUS                                       
****                                                                            
****     OC    CLS5BKDT,CLS5BKDT                                                
****     BZ    *+10                                                             
****     MVC   TMPSTAT5,CLS5BKDT   BANK CLEARED DATE                            
****                                                                            
         OC    CLS5STAT,CLS5STAT                                                
         BZ    *+10                                                             
         MVC   TMPSTAT5,CLS5STAT   STATUS                                       
*                                                                               
         OC    CLS5BKDT,CLS5BKDT                                                
         BZ    *+10                                                             
         MVC   TMPBKDT,CLS5BKDT    BANK CLEARED DATE                            
*                                                                               
         CLI   CLS5EST,0                                                        
         BE    *+10                                                             
         MVC   TMPEST,CLS5EST      ESTIMATE                                     
*                                                                               
         TM    CLS5STAT,CLS5STAT_CK  IF CASH RECEIPT (CK)                       
         BNO   CLST20                                                           
*                                                                               
         BRAS  RE,GTWRPRF               READ WR PROFILE                         
*                                                                               
...
*                                                                               
         MVC   TMPCHK,=CL6'CHECK'       SET SPECIAL CHECK NUMBER                
         MVC   TMPCHDT,NUPAYDAT         SET CLEAR DATE AS CHK DTE               
*                                                                               
CLST20   DS    0H                                                               
*                                                                               
         B     GC30                                                             
...
CLST27   DS    0H                                                               
         ZIC   RE,1(RA)                                                         
         AR    RA,RE                                                            
         CLI   0(RA),X'03'         IF X'03' ELEM                                
         BE    CLST12              NO SKIP                                      
         CLI   0(RA),X'05'         IF X'05' ELEM                                
         BNE   GC10                NO SKIP                                      
         B     CLST15              YES-TRY WITH THIS ELEM                       
*                                                                               
...
*                                                                               
         ...
         BO    GC35                                                             
*                                                                               
         CLC   =C'VOID',TMPCHK    KEEP IF CHECK VOIDED                          
         BE    *+12                                                             
         CLI   TMPCHK,C' '        DROP UNIT IF CHECK PRESENT                    
         BH    GC35                                                             
*                                                                               
         OI    NBPPDOPT,NBPPDINQ   KEEP UNIT IN REPORT                          
GC35     B     GC10                GET NEXT PAY ELEMENT                         
*                                                                               
GC38     DS    0H                                                               
         MVC   CHQREPTP,TMPREPTP   REP TYPE                                     
         MVC   CHQREP,TMPREP       CLRST REP                                    
         MVC   CHQNUM,TMPCHK       CHECK NUMBER                                 
         MVC   CHQSEQN,TMPCHKSQ    CHECK SEQ NUMBER                             
         MVC   CHQINV,TMPINVNO     INVOICE NUMBER                               
         EDIT  (B1,TMPEST),CHQEST  ESTIMATE                                     
*                                                                               
...
*                                                                               
         MVI   CHQNUM+6,X'40'                                                   
*                                                                               
         CLI   0(RA),X'05'         DEALING WITH X'05' ELEM ?                    
         BNE   GC38D                                                            
*                                                                               
         TM    TMPSTAT5,X'80'      RECONCILED?                                  
         BNO   *+12                                                             
         MVI   CHQNUM+6,C'*'                                                    
         B     GC38F                                                            
*                                 DEALING WITH X'01' ELEMENT                    
GC38D    TM    TMPSTAT,X'80'      RECONCILED?                                   
         BNO   *+8                                                              
         MVI   CHQNUM+6,C'*'                                                    
*                                                                               
GC38F    MVC   CHQDATE,TMPCHDT     CHECK DATE                                   
*                                                                               
...
GC39     DS    0H                                                               
*                                                                               
         TM    NBINDS8,NBI8CBU     SKIP IF REPORTING CLRD/UNDISBURSED           
         BO    GC3901                                                           
*                                                                               
...
***      GOTO1 DATCON,DMCB,(5,0),(2,CHQDATE) TODAY FOR CHQDATE                  
         ...
         MVI   CHQBKDFT,C'*'      FLAG AS DEFAULT DATE                          
*                                                                               
         MVC   CHQCLRDT,TMPCLRDT   SET      CLEARANCE DATE                      
         MVC   CHQPRD,TMPPRD       PRODUCT                                      
         MVC   CHQPRD2,TMPPRD2     PRODUCT PARTNER                              
         B     GC41                                                             
*                                                                               
GC40     DS    0H                                                               
         MVC   CHQCLRDT,TMPCLRDT   SET      CLEARANCE DATE                      
...
*******  BNH   GC401               THS MUST BE OLD CODE? 6/09                   
*                                                                               
         MVC   CHQBNKDT,TMPBKDT    CHECK BANK CLEARANCE DATE                    
...
*                                                                               
         BRAS  RE,GTWR2PRF        READ WR2 PROFILE                              
         LAY   R1,WR2PROF         POINT TO WR2 PROFILE                          
         CLI   0(R1),C'Y'         CHK DAT INSTEAD OF LAST DAY OF MONTH?         
         BNE   GC402              NO                                            
         MVC   CHQBNKDT,CHQDATE   USE CHECK DATE                                
         MVC   CHQBKDFT,CHQDFT    COPY DEFAULT INDICATOR                        
         B     GC41               BANK DATE SET                                 
*                                                                               
GC402    GOTO1 DATCON,DMCB,(3,BTODAY),WORK    TODAY AS YYMMDD                   
         LHI   RF,-1                                                            
         ST    RF,DMCB+8                                                        
...
* SKIP CHECK                                                                    
         ...
         BE    SPLIT0                                                           
*                                                                               
SPLIT00  CLC   NBSPLPR3,CHQPRD     UNIT PRD MUST = ONE OF CHQ PRDS              
         BE    SPLIT0                                                           
         CLC   NBSPLPR3,CHQPRD2                                                 
...
*                                                                               
         CLC   NBPR1CL3,NBPR2CL3      DUPLICATE PROD?                           
         BNE   SPLIT02                                                          
         CLI   DUPFLAG,2           ARE WE ON 2ND PROD?                          
         BE    SPLIT05             YES                                          
SPLIT02  CLC   NBSPLPR3,NBPR1CL3                                                
...
*                                                                               
         CLI   15(R1),C'Y'         IF TODAY IS REFERENCE DATE                   
         BNE   GC46                                                             
*                                                                               
         GOTO1 DATCON,DMCB,(3,BTODAY),(0,WORK)  USE TODAY AS REFERENCE          
*                                                                               
GC46     DS    0H                                                               
*                                                                               
...
*******************************************************************             
GC53     DS    0H                                                               
         B     RNX    FOR NOW FOR NOW FOR NOW FOR NOW                           
*                                                                               
* READ INVOICE RECORD FOR INV DATE AND REP                                      
GC70     DS    0H                                                               
* MAKE SOEM TEMPORARY ROOM - MAY NOT NEED THIS READ AFTER ALL                   
*****    MVI   FULL,C'0'           PASS ZERO FOR MARKET                         
*****    MVC   FULL+1(3),FULL                                                   
*****    MVC   DUB(4),NBACTNET                                                  
*****    MVI   DUB+4,C'N'          N FOR NETWORK                                
*****    GOTO1 MSPACK,DMCB,FULL,DUB,WORK                                        
         MVC   FULL,WORK+2         SAVE 3 BYTE PACKED STATION                   
*                                                                               
         GOTO1 DATCON,DMCB,(2,NBACTDAT),(0,DUB)                                 
         MVC   DUB+4(2),=C'01'         1ST OF MONTH                             
         GOTO1 DATCON,(R1),(0,DUB),(2,WORK)                                     
         XC    WORK(2),=X'FFFF'     COMPLEMENT                                  
*                                                                               
RN51     DS    0H                                                               
         XC    KEY,KEY                                                          
         LA    R2,KEY                                                           
         ...
         MVC   SNVKSTA,FULL       PACKED STATION                                
         MVC   SNVKMOS,WORK       MOS COMPLEMEMNT                               
         MVC   SNVKINV,CHQINV                                                   
*                                                                               
RN52     MVC   FILENAME,=C'XSPDIR  '                                            
         GOTO1 HIGH                                                             
*                                                                               
RN54     CLC   SNVKEY(22),KEYSAVE   AGY/MD/CLT/STAT/MOS/INVOIVE NUMBER          
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
         L     R4,=A(MYIO)                                                      
         GOTO1 DATAMGR,DMCB,=C'GETREC',=C'XSPFIL  ',SNVDDA,(R4),MYDM            
*                                                                               
         DROP  R2                                                               
         USING SNVKEY,R4                                                        
         LA    R4,SNVELS-SNVKEY(R4)   BUMP TO START OF ELEMENTS                 
         CLI   0(R4),0                                                          
         B     RNX                                                              
RN60     CLI   0(R4),X'10'                                                      
         BE    RN65                                                             
         ...
         B     RN60                                                             
         USING SNVHDEL,R4                                                       
RN65     MVC   CHQINVDT,SNVHDIDT   INVOICE DATE                                 
*                                                                               
RNX      DS    0H                                                               
         DROP  R4                                                               
*                                                                               
** PASS TO DRIVER HERE                                                          
*                                                                               
         CLI   NBRDBELS,2          IS IT 2ND TIME THROUGH                       
         BE    *+8                                                              
         MVI   NBRDBELS,1          NO,SET IT AS FIRST                           
*                                                                               
         MVI   GLMODE,GLINPUT                                                   
         GOTO1 NDDRIVER,DMCB,(R6)                                               
*                                                                               
         ...
         BE    GCX                                                              
***************************************************************                 
*RN75     ZIC   RE,1(RA)            IF ANY MORE X'03'                           
*         AR    RA,RE               UNDER THIS X'01'                            
*         CLI   0(RA),X'05'         PASS THAT INVOICE # AND DOLLARS             
*         BE    RN75                                                            
*         CLI   0(RA),X'03'                                                     
*         BE    CLST12                                                          
*                                 ELSE GO GET NEXT PAY ELEMENT                  
***************************************************************                 
         XC    CHQNET,CHQNET                                                    
...
TMPNET   DS    XL4                                                              
TMPEST   DS    CL1                                                              
TMPCHK   DS    CL6                 CHK NUMBER                                   
TMPCHDT  DS    XL2                 CHK DATE                                     
TMPBKDT  DS    XL2                 BANK CLEARED DATE                            
TMPREPTP DS    CL1                 REP TYPE                                     
TMPREP   DS    CL3                 REP PAYEE                                    
TMPCHKSQ DS    CL1                 CHK SEQ NUMBER                               
         DS    CL6                                                              
TMPSTAT5 DS    XL1                 STATUS X'05' ELEM                            
TMPBLKE1 EQU   *-TEMPBLK                                                        
TMPINVNO DS    CL12                INVOICE NUMBER (X'03' ELEM)                  
TMPSTAT  DS    XL1                 STATUS X'01' ELEM                            
TMPCLRDT DS    XL2                 X'01' ELEM CLEARANCE DATE                    
TMPBLKE  EQU   *-TEMPBLK                                                        
*                                                                               
...
DOLSPLT  NTR1                                                                   
         ICM   RF,15,TMPGRS        FIRST COMPUTE FIRST SPLIT                    
...
* - GET NET AMOUNT                                                              
         ICM   RF,15,TMPNET        FIRST COMPUTE FIRST SPLIT                    
         LH    RE,HALF                                                          
         MR    RE,RE                                                            
         D     RE,=F'5000'                                                      
         LTR   RF,RF                                                            
...
INIT1    CLI   NDFLAVOR,C'E'       IF ESTIMATE FLAVOR                           
         ...
         BE    INIT2                                                            
* TURN ON BPRD MODE FOR BOTH PRD=ALL AND FOR SPECIFIC PRODUCT                   
* IN THIS MODE IF NBRDBELS=2, ACCGEN CALLS ARE SKIPPED IN NEWRIDRIVE            
* THIS PREVENTS DOUBLING OF ACTUAL COST,FOR EXAMPLE, WHEN PASSING               
* MULTIPLE CHQ NUBMERS (OR DOLLARS) TO DRIVER                                   
...
DOEDIT   NTR1  BASE=*,LABEL=*                                                   
         ...
         LA    R2,SPLESTH          EST                                          
         NETGO NVESTRNG,DMCB,0,XDDEMBLK   YES                                   
         LA    R2,SPLNETH          NET                                          
...
*                                                                               
         ...
         DROP  R1                                                               
*                                                                               
DEDIT10  NETGO NVDEM,DMCB,DBLOCK,XDDEMBLK   YES                                 
         XIT1                                                                   
         LTORG                                                                  
*                                                                               
                                                                                
*  MATCH INVOICE # ON UNIT  WITH X'03' ELEM ON CLRST REC                        
*                                                                               
MTCHINV  NTR1  BASE=*,LABEL=*                                                   
         USING CLSTEL03,RA                                                      
MTCHI05  CLC   UNITTINV,CLS3INV    NOTE UNITTINV=10CL/CLS3INV=12CL              
         BE    MTCHIXX                                                          
*                                  TRY WITHOUT DASHES                           
         XC    WORK(10),WORK                                                    
         LA    RF,10                                                            
...
CHKDASH  CLI   0(R1),C'-'                                                       
         ...
         BE    MTCHIXX                                                          
*                                                                               
         CLC   UNITIINV,CLS3INV    INTEGRATION MATCH ?                          
         BE    MTCHIXX                                                          
*                                  TRY WITHOUT DASHES                           
         XC    WORK(10),WORK                                                    
         LA    RF,10                                                            
...
MTCHI07  ZIC   R1,1(RA)                                                         
         ...
         BE    MTCHI07                                                          
         CLI   0(RA),X'03'                                                      
         BE    MTCHI05             TRY THIS X'03'                               
MTCHIX   XIT1                                                                   
*                                                                               
MTCHIXX  MVC   TMPINVNO,CLS3INV    SET MATCHED INVOICE #                        
         XIT1  REGS=(RA)                                                        
         LTORG                                                                  
*                                                                               
SVINVKEY NTR1  BASE=*,LABEL=*                                                   
* SET UP CHQINVKY FOR INVOICE HEADER READ IF NEEDED                             
         L     R1,=A(MYIO)                                                      
         USING CLSKEY,R1                                                        
         LR    R3,R1                                                            
         A     R3,=F'6000'                                                      
         USING BHBLOCK,R3                                                       
         MVC   CHQINVKY(3),CLSKAGMD          A/M,CLIENT                         
         MVC   CHQINVKY+3(3),CLSKSTA         STATION                            
         DROP  R1                                                               
*                                                                               
         GOTO1 DATCON,DMCB,(2,NBACTDAT),(0,DUB)                                 
         MVC   DUB+4(2),=C'01'                                                  
         GOTO1 DATCON,DMCB,(0,DUB),(2,WORK)                                     
         XC    WORK(2),=X'FFFF'    COMPLEMENT                                   
         MVC   CHQINVKY+6(2),WORK    DATE                                       
         MVC   CHQINVKY+10(10),TMPINVNO                                         
         XIT1                                                                   
         DROP  R3                                                               
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                               
GTWR2PRF NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         XC    GTWR2KY,GTWR2KY      INIT PROFILE KEY                            
         MVC   GTWR2SYS(2),=C'SW'   SYSTEM                                      
         MVC   GTWR2PID,=C'R2'      PROFILE ID                                  
         NI    GTWR2SYS,X'FF'-X'40' MAKE THE S LOWERCASE                        
         MVC   GTWR2AGY,AGENCY      AGENCY                                      
         MVI   GTWR2MED,C'N'        MEDIA                                       
         MVC   GTWR2CLT,NBCLICOD    CLIENT                                      
*                                                                               
         CLC   GTWR2KY,GTWR2KYS      SKIP IF KEY HASN'T CHANGED                 
         BE    GTWR2PX                                                          
*                                                                               
         GOTO1 GETPROF,DMCB,GTWR2KY,WR2PROF,DATAMGR                             
*                                                                               
GTWR2PX  XIT1                                                                   
*                                                                               
         LTORG                                                                  
...
*        KEY FOR WR2 PROFILE                                                    
*                                                                               
GTWR2KY  DS    XL16                PROFILE KEY                                  
         ORG   GTWR2KY                                                          
GTWR2SYS DS    CL1                 SYSTEM                                       
         DS    XL1                 NOT USED                                     
GTWR2PID DS    CL2                 PROFILE ID                                   
GTWR2AGY DS    CL2                 AGENCY                                       
GTWR2MED DS    CL1                 MEDIA                                        
GTWR2CLT DS    CL3                 CLIENT                                       
         ORG                                                                    
*                                                                               
GTWR2KYS DS    XL(L'GTWR2KY)       PROFILE KEY SAVEAREA                         
*                                                                               
WR2PROF  DS    CL16                WR2 PROFILE                                  
*                                                                               
         EJECT                                                                  
*                                                                               
...
*                                  MOS(2) + START(2) + END(2)                   
*                                                                               
DIGITAB  DS    CL400               TABLE OF DIGINET NETWORKS                    
*                                                                               
         DS    0D                                                               
         DC    CL8'*GLRXTN**'                                                   
...
STWRDLST DS    CL256                                                            
*PRGBUFF  DS    CL550                                                           
PRGBUFF  DS    CL1000              500 X 2 HOLDS PRD GROUP                      
XPRDMSK  DS    CL1600              400 X (1 BYTE BINARY + 3 CHAR CODE)          
         DS    CL400               NOW IT'S 500 PRODUCTS                        
         DS    0F                                                               
...
AMQRPT   DS    F                                                                
MQFILENM DS    CL44                                                             
UNITTINV DS    CL10                TIME INV# FROM X'18' ELEM                    
UNITIINV DS    CL10                INTG INV# FROM X'18' ELEM                    
*                                                                               
SVHUNOPT DS    CL1                                                              
*                                                                               
...
*                                                                               
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'149NEWRI20   02/26/20'                                      
         END                                                                    
