*          DATA SET REREP3F02  AT LEVEL 001 AS OF 03/27/09                      
*PHASE RE3F02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3F02 - REREP3F02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3F02 - RE3F02 - MEDIA OCEAN DEMO FEED - (FSSNY    )        *           
*                                                                   *           
*********************************************************************           
...
RE3F02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3F02,R7,R8,RR=RE                                    
*                                                                               
...
NUMDEMQ  EQU   (2*NUMCATQ)                                                      
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001REREP3F02 03/27/09'                                      
         END                                                                    
**  INSERT END  >>                                                              
