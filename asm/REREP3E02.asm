*          DATA SET REREP3E02  AT LEVEL 004 AS OF 02/06/09                      
*PHASE RE3E02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3E02 - REREP3E02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3E02 - RE3E02 - MEDIA OCEAN DEMO FEED - (EAGLE TV)         *           
*                                                                   *           
*********************************************************************           
...
*                                                                   *           
*   MAY22/06 (BU ) --- UNIVISION/HISPANIC VERSION                   *           
*                                                                   *           
*   AUG03/06 (BU ) --- EAGLE VERSION:                               *           
*                                                                   *           
*   AUG24/06 (BU ) --- OPTIONAL: "HEADERS ONLY" DOWNLOAD            *           
*                                                                   *           
*   OCT24/07 (BU ) --- CORRECT ASSEMBLER ERROR                      *           
*                                                                   *           
*   OCT25/07 (DE ) --- USE SOFT DEMOFILE OPEN LISTS                 *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
...
RE3E02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3E02,R7,R8,RR=RE                                    
*                                                                               
...
INIT0020 EQU   *                                                                
         ...
         B     INIT0040                                                         
INIT0022 EQU   *                                                                
         GOTOX LOADER,DMCB,=CL8'T00AA4B',0                                      
         B     INIT0040                                                         
*                                                                               
INIT0040 EQU   *                                                                
...
*                                                                               
INPBLOCK DC    X'29'               NUMSTAS:   41                                
*  FIRST                                                                        
         DC    CL05'LNCH '     WASHINGTON DC                                    
         DC    CL05'WJLA '     WASHINGTON DC                                    
         DC    CL05'WCCB '     CHARLOTTE NC                                     
         DC    CL05'KCCI '     DES MOINES IA                                    
         DC    CL05'KCRA '     SACRAMENTO CA                                    
         DC    CL05'KETV '     OMAHA NE                                         
         DC    CL05'KHBS '     FT SMITH AR                                      
         DC    CL05'KHOG '     FT SMITH AR                                      
         DC    CL05'KITV '     HONOLULU HI                                      
         DC    CL05'KMBC '     KANSAS CITY MO                                   
         DC    CL05'KOAT '     ALBUQUERQUE NM                                   
         DC    CL05'KOCO '     OKLAHOMA CITY OK                                 
         DC    CL05'KQCA '     SACRAMENTO CA                                    
         DC    CL05'KSBW '     SALINAS-MONT CA                                  
         DC    CL05'WAPT '     JACKSON MS                                       
         DC    CL05'WBAL '     BALTIMORE MD                                     
         DC    CL05'WCVB '     BOSTON MA                                        
         DC    CL05'WDSU '     NEW ORLEANS LA                                   
         DC    CL05'WESH '     ORLANDO FL                                       
         DC    CL05'WGAL '     LANCASTER PA                                     
         DC    CL05'WISN '     MILWAUKEE WI                                     
         DC    CL05'WLKY '     LOUISVILLE KY                                    
         DC    CL05'WLWT '     CINCINNATI OH                                    
         DC    CL05'WMTW '     PORTLAND ME                                      
         DC    CL05'WMUR '     MANCHESTER NH                                    
         DC    CL05'WPBF '     WEST PALM BCH FL                                 
         DC    CL05'WPTZ '     PLATTSBURGH                                      
         DC    CL05'WTAE '     PITTSBURGH PA                                    
         DC    CL05'WXII '     WINSTON-SALEM NC                                 
         DC    CL05'WYFF '     GREENVILLE NC                                    
         DC    CL05'NTNC '     NASHVILLE TN                                     
         DC    CL05'WTVF '     NASHVILLE TN                                     
         DC    CL05'KJRH '     TULSA OK                                         
         DC    CL05'KNXV '     PHOENIX AZ                                       
         DC    CL05'WEWS '     CLEVELAND OH                                     
         DC    CL05'WFTS '     TAMPA-ST PETE FL                                 
         DC    CL05'WXYZ '     DETROIT MI                                       
         DC    CL05'LCNN '     MEMPHIS TN                                       
         DC    CL05'NCTA '     MEMPHIS TN                                       
         DC    CL05'WREG '     MEMPHIS TN                                       
         DC    CL05'WTKR '     NORFOLK VA                                       
*  LAST                                                                         
*********************************************************************           
         DC    X'01'               NUMDPTS                                      
         DC    CL1'X'              DAYPARTS:  1                                 
...
NUMDEMQ  EQU   (2*NUMCATQ)                                                      
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004REREP3E02 02/06/09'                                      
         END                                                                    
**  INSERT END  >>                                                              
