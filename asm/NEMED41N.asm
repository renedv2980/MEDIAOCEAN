*          DATA SET NEMED41N   AT LEVEL 004 AS OF 12/21/98                      
*PHASE T31E41A,+0                                                               
*                                                                               
...
T31E41   CSECT                                                                  
         ...
         USING PASDATA,R7                                                       
         L     R6,ANETWS3          W/S TO BE PASSED FOR EST DEMO INFO           
         ST    R6,NBADEM                                                        
         USING NDDEMBLK,R6                                                      
         EJECT                                                                  
*************  INITIALIZE NETBLOCK*************                                 
...
*                                                                               
         ...
         NETGO NVEST,DMCB,UVLESTN,NDDEMBLK    AND FILL IN UNLESTN.              
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004NEMED41N  12/21/98'                                      
         END                                                                    
