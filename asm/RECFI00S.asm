*          DATA SET RECFI00S   AT LEVEL 013 AS OF 09/09/97                      
*PHASE T81200A                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         DROP  R4                                                               
*                                                                               
         GOTO1 ADATAMGR,DMCB,=C'DMRDHI',=C'CTFILE',WORK,IOAREA                  
...
GETCOMP  NTR1                                                                   
         ...
         PRINT GEN                                                              
         GOTO1 ADATAMGR,DMCB,=C'DMRDHI',=C'GENDIR',WORK,IOAREA                  
         PRINT NOGEN                                                            
         LA    R5,IOAREA                                                        
         CLC   WORK(25),0(R5)      CHECK THE KEY                                
...
GCOM0040 EQU   *                                                                
         ...
         GOTO1 ADATAMGR,DMCB,(0,=C'GETREC'),=C'GENFILE',(R2),IOAREA,   +        
               (0,DMWORK)                                                       
         LA    R2,IOAREA                                                        
...
*                                                                               
         ...
         OI    UKFLAG,X'80'                                                     
*                                                                               
         GOTO1 ADATAMGR,DMCB,DINDEX,WRKFILE,WRKRINDX,IOAREA2,ATIA               
...
*                                                                               
         ...
         MVC   4(4,R1),=C'REC '                                                 
         GOTO1 ADATAMGR,DMCB,RANDOM,WRKFILE,WRKRINDX,IOAREA2,ATIA               
         CLI   8(R1),0                        ...READ THE RECORD                
         BE    *+6                                                              
         DC    H'0'             DIE IF ERRORS (SHOULDN'T BE EOF EITHER)         
*                                                                               
         MVC   LINEDATA,IOAREA2+18    GET THE DATA FROM FILE                    
*                                                                               
         GOTO1 ADATAMGR,DMCB,=C'PROC',WRKFILE,WRKRINDX,IOAREA2,ATIA             
         CLI   8(R1),0                   ...CHANGE STATUS TO PROCESSED          
         BE    *+6                                                              
         DC    H'0'                                                             
         GOTO1 ADATAMGR,DMCB,DCLOSE,WRKFILE,0,IOAREA2,ATIA   CLOSE IT           
         B     EXIT                                                             
         EJECT                                                                  
*                                                                               
*                                                                               
...
GETUSID  NTR1                                                                   
         ...
         GOTO1 ADATAMGR,DMCB,=C'DMREAD',=C'CTFILE',KEY,IOAREA                   
         CLI   8(R1),0             FOUND?                                       
         BE    *+6                 YES                                          
         DC    H'0'                SHOULD HAVE BEEN THERE....                   
         LA    R6,IOAREA                                                        
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013RECFI00S  09/09/97'                                      
         END                                                                    
