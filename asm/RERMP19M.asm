*          DATA SET RERMP19M   AT LEVEL 021 AS OF 05/01/02                      
*PHASE T81019B                                                                  
...
*                                                                               
         ...
         MVC   IBLK+3(1),IKFRBTS     BOOKVAL BITS                               
         MVC   IBLK+4(1),IKBTYPE     BOOKTYPE                                   
         GOTO1 VGETKSRC,DMCB,(C'B',IBLK),WORK                                   
         CLI   DMCB+4,0            ANY ERRORS?                                  
         BNE   INVLFLD             INVALID FIELD                                
         MVC   IKKSRC,WORK+2       SET RINVKSRC                                 
...
BLD70    LA    R1,OVRNTY(R1)       SEARCH FOR NEXT OVERIDE                      
         ...
         DROP  R1                                                               
*                                                                               
BLD_ERRX MVI   OURINFCD,NODEMQ     NO DEMOS ON RECD NO OVR ALLOWED              
         B     NO_01                                                            
*                                                                               
...
EDTOV15I DS    0H                                                               
         MVI   INDEX,0                                                          
         CLI   2(R3),X'50'         INDEX ELEM?                                  
         BNE   *+8                                                              
         MVI   INDEX,C'Y'          YES INDEX PRESENT                            
*                                                                               
...
DSP04    BNE   DSP08               NO UPGD ON RECD                              
         ...
         BZ    *+8                                                              
         D     RE,=F'10'                                                        
         EDIT  (RF),(3,DOVMIN+4),ZERO=NOBLANK,ALIGN=LEFT                        
         DROP  R3                                                               
*                                                                               
DSP08    DS    0H                                                               
...
STI#     EQU   (R03_04-*)/4+1+R02#  SAVE (TABLES IN) TIA AREA                   
RTI#     EQU   (R03_05-*)/4+1+R02#  RESTORE (TABLES IN) TIA AREA                
...
R03_04   B     SAVETIA             SAVE (TABLES IN) TIA AREA                    
R03_05   B     RSTRTIA             RESTORE (TABLES IN) TIA AREA                 
...
*                                  PROCESS OVERRIDES                            
         ...
         STH   RE,MYDMCB                                                        
         MVC   MYDMCB+2(1),COL     SET CTGY   (MALE FOR NOW)                    
         MVI   GOSUBN,VCO#         VALIDATE 1ST COLUMN OF DEMOS                 
         GOTO1 AGOSUB                                                           
         BNE   VSC40                                                            
*                                                                               
         LA    RE,DOVRTG2H-DOVDEMOH FILL 2ND COLUMN DEMOS                       
         STH   RE,MYDMCB                                                        
         MVC   MYDMCB+2(1),COL+1   SET CTGY   (MALE FOR NOW)                    
...
*                                                                               
         LA    RE,DOVRTG3H-DOVDEMOH FILL 3RD COLUMN DEMOS                       
         STH   RE,MYDMCB                                                        
         MVC   MYDMCB+2(1),COL+2   SET CTGY   (MALE FOR NOW)                    
...
VCOL15   TM    4(R3),X80           ANY INPUT TO THIS FIELD?                     
         ...
         BE    VCOL60                                                           
*                                                                               
         CLI   INDEX,C'Y'          INDEX UPGRADE PRESENT?                       
         BNE   VCOL20                                                           
         ZIC   RE,0(R3)            YES                                          
         AR    RE,R3                                                            
         CLI   8(RE),C'c'          CORE OVERIDES NOT ALLOWED                    
         BE    VCOLIDX                                                          
         CLI   8(RE),C'!'                                                       
         BE    VCOLIDX                                                          
*                                                                               
VCOL20   XC    OVAL,OVAL           OVERIDE VALUE (X'FF'=CLR OVR)                
...
*                                                                               
VCOLIDX  ST    R3,DMCB                                                          
         MVI   OURINFCD,INDXQ      NO CORE OVRS W/INDEX UPT                     
         B     NO_03                                                            
         EJECT                                                                  
***********************************************************************         
...
BLK12    CLI   MYDMCB,2            REPLACE VALUES INTO BLANKED FLDS?            
         ...
         ZIC   R1,0(R3)            YES                                          
         AR    R1,R3                                                            
         CLI   8(R1),C'c'          CORE OVERIDES NOT ALLOWED                    
         BE    BLK40                                                            
         CLI   8(RE),C'!'                                                       
         BE    BLK40                                                            
*                                                                               
BLK16    MVC   ODEM,1(R4)          CLEAR FIELD/OVR                              
         MVI   OVAL,XFF                                                         
...
*                                                                               
INDX     DS    0H                                                               
         MVC   0(39,R1),=C'Index upgrade present: core changes n/a'             
         B     INFGTXT                                                          
*                                                                               
         EJECT                                                                  
...
DEMOUNV  DS    XL3                 UNV                                          
         DS    XL3                 BLANK                                        
DEMOLIST DS    61XL3               91 DEMO IN LIST FROM DEMOUT                  
         DS    XL1                                                              
DEMOLSTX EQU   *                                                                
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021RERMP19M  05/01/02'                                      
         END                                                                    
