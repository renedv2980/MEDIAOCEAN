*          DATA SET REAURUP    AT LEVEL 011 AS OF 07/07/14                      
*PHASE REAURUPB,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
*   INPUT        - DISPLAY ENTIRE RECORD, CONTRACT AND BUY         *            
*   INPUTCON     - DISPLAY ENTIRE RECORD, CONTRACT ONLY            *            
...
*                                                                               
         ...
         BE    INPU0120            SAME - OKAY                                  
         MVC   P+1(11),=C'KEY SOUGHT='                                          
         MVC   P+12(25),WORK                                                    
         GOTO1 =V(PRINTER)                                                      
         MVC   P+1(11),=C'KEY FOUND ='                                          
         MVC   P+12(25),0(R1)                                                   
         GOTO1 =V(PRINTER)                                                      
...
*   SPECIFIC CONTRACT TEST                                                      
         CLC   =X'00188297',23(R6) SPECIFIC CONTRACT?                           
         BNE   RECO0012            NO  - SKIP DISPLAY                           
*   SPECIFIC CONTRACT TEST END                                                  
*                                                                               
...
*                                                                               
CALC0180 MVI   WORK+5,C'N'         SET 'FIRST TIME' TO NO                       
...
SETCBUCS NTR1                                                                   
         XC    MTHTBL(250),MTHTBL                                               
         XC    MTHTBL+250(112),MTHTBL+250                                       
...
MTHTBL   DS    CL352               25 BROADCAST MONTH DATES+ENDING 0000         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011REAURUP   07/07/14'                                      
         END                                                                    
