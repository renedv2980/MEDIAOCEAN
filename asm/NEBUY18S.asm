*          DATA SET NEBUY18S   AT LEVEL 004 AS OF 05/01/02                      
*          DATA SET NEBUY18    AT LEVEL 141 AS OF 01/26/00                      
*PHASE T31118C,+0                                                               
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
...
*                                                                               
         OI    PUPCPMH+6,X'80'                                                  
         MVC   PUPCPM(48),=C'*** REQUEST CPM REPORT TO CORRECT CPM FACTX        
               OR ***'                                                          
         B     MAXIT                                                            
         SPACE                                                                  
...
*        EDIT  (R3),(7,PAKGCPM),2,ALIGN=LEFT                                    
         SPACE                                                                  
DIS15    CLI   DDS,YES             TEST FOR DDS TERMINAL                        
         BNE   DSXIT                                                            
         TM    MODE,DISPLAY                                                     
         B     DSXIT                                                            
*        BO    DSXIT                                                            
...
FILTR    LA    R2,PAKFILTH                                                      
         GOTO1 VGETFLD                                                          
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'08',APACKREC),(1,=C'K')            
         CLI   FLDH+5,0                                                         
         BE    GCPMR                                                            
...
*                                                                               
         ...
         MVC   WORK+3(6),FLD                                                    
         GOTO1 VHELLO,DMCB,(C'P',UNTFILE),APACKREC,WORK,0                       
...
REPRECD  DSECT                                                                  
       ++INCLUDE SPGENREP                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004NEBUY18S  05/01/02'                                      
         END                                                                    
