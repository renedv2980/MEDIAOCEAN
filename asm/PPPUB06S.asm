*          DATA SET PPPUB06S   AT LEVEL 043 AS OF 05/01/02                      
*PHASE T40606A,+0,NOAUTO                                                        
*                                                                               
***************  CHANGE LOG  ***************                                    
*                                                                               
*  SMYE  1/00      FIX BUG - CLEAR DISCOUNT LEVEL FIELDS BEFORE DISPLAY         
*                                                                               
...
CKCODE   EQU   *                                                                
         ...
         BL    NEXT60                                                           
         OI    PUBIND,X'10'        PREMIUM ELEMENT FOUND                        
...
NEXTLVL  SR    R0,R0                                                            
         ...
         EDIT  PACKED5,(10,8(R5)),5,ALIGN=LEFT,DROP=3                           
*                                                                               
PUTSIZE  DS    0H                                                               
         FOUT  (R5)                                                             
         BAS   RE,BUMPFLD                                                       
...
BCODE    DS    CL3                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'043PPPUB06S  05/01/02'                                      
         END                                                                    
