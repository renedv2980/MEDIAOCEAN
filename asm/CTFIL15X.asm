*          DATA SET CTFIL15X   AT LEVEL 002 AS OF 08/22/00                      
*&&      SET   NOP=N                                                            
*PHASE TA1315A                                                                  
...
***********************************************************************         
         SPACE 1                                                                
XITIN    NI    NSSAV+(SNINDS1-SSAVD),FF-SNIUSECR                                
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* LIST OBJECT                                                         *         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002CTFIL15X  08/22/00'                                      
         END                                                                    
