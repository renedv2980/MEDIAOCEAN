*          DATA SET RESUN01T   AT LEVEL 012 AS OF 05/01/02                      
*PHASE T81401A,*                                                                
...
* --------------------------------------------------------------- *             
*                                                                 *             
*  02JUN99 ROB - ATERNATE '9F' KEY FOR NBC HOME MKT ORDERS        *             
*                                                                 *             
*                                                                 *             
*                                                                 *             
*                                                                 *             
...
*                                                                               
         ...
         BE    VK08                                                             
         CLC   AGENCY,=C'UV'       FOR TESTING PURPOSES                         
         BE    VK08                                                             
         CLC   AGENCY,=C'NB'       NBC CONNECTED?                               
         BNE   VK10                NO - SKIP ADDITIONAL CHECK                   
*                                                                               
VK08     XC    DUB,DUB                                                          
         MVC   DUB(4),ACOMFACS                                                  
         MVC   DUB+4(2),AGENCY                                                  
...
PRORECS  DSECT                                                                  
       ...
       ++INCLUDE FAFACTS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012RESUN01T  05/01/02'                                      
         END                                                                    
