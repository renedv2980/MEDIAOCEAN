*          DATA SET RJSTAPE    AT LEVEL 002 AS OF 05/01/02                      
*          DATA SET PBIGPRD    AT LEVEL 037 AS OF 07/08/88                      
*PHASE ONLYSJR,*,NOAUTO                                                         
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'ONLYSJR CREATE A TAPE WITH ONLY SJR RECORDS'                    
*                                                                               
*              EXPANDS PRODUCT HEADER                                           
*              COPIES ALL RECORDS                                               
*                                                                               
ONLYSJR CSECT                                                                   
         NBASE 0,ONLYSJR,=V(REGSAVE)                                            
         SPACE 2                                                                
         LA    R6,ONLYSJR+4095                                                  
         LA    R6,1(R6)                                                         
         USING ONLYSJR+4096,R6                                                  
...
*                                                                               
         ...
         BE    EOF                                                              
         CLC   REC(2),=C'SJ'       ONLY PASS SJ RECORDS                         
         BNE   GET                                                              
         AP    CLICNT,=P'1'                                                     
         CP    CLICNT,=P'50'                                                    
         BH    PUTXX                                                            
...
BUY      DS    0H                                                               
         AP    PRDCNT,=P'1'                                                     
         CLI   REC+34,X'AA'  OLD ELEMENT COUNT                                  
         BE    OKOLD                                                            
         CLI   REC+34,X'C8'  MAY HAVE BEEN ADDED WHILE 02 WAS IN                
         BNE   CONTIN                                                           
         CLI   REC+26,X'E9'                                                     
         BNE   CONTIN                                                           
         XC    REC+203(30),REC+203    CLEAR NEW FIELDS                          
         B     PUTXX                                                            
CONTIN   AP    BADCNT,=P'1'                                                     
         CP    BADCNT,=P'50'                                                    
         BH    OKOLD                                                            
         MVC   P(28),=C'LENGTHS ARE BAD IN REC BELOW'                           
         BAS   RE,PRNT                                                          
         BAS   RE,DMPREC                                                        
OKOLD    DS    0H                                                               
         MVC   REC+33(2),=X'06C8' NEW ELEMENT LENGTH 200 WAS AA 170             
         MVI   REC+26,X'E9' NEW REC LEN IS 233                                  
         CP    PRDCNT,=P'50'                                                    
         BH    PUTXX                                                            
         BAS   RE,DMPREC                                                        
         B     PUTXX                                                            
...
PRDCNT   DC    PL5'0',CL20'PRODHD COUNT'                                        
BADCNT   DC    PL5'0',CL20'BAD PRODUCT COUNT'                                   
CLICNT   DC    PL5'0',CL20'CHANGED CLI COUNT'                                   
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002RJSTAPE   05/01/02'                                      
         END                                                                    
