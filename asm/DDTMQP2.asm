*          DATA SET DDTMQP2    AT LEVEL 046 AS OF 05/01/02                      
DDTMQP2  TITLE 'MQSERIES TEST PROGRAM - PUT MESSAGES TO QUEUE'                  
*PHASE DDTMQP2A                                                                 
***********************************************************************         
*                                                                     *         
* MODULE NAME    : DDTMQP2                                            *         
...
MAINPARM DS    0H                                                               
         ...
         MVI   MQMPMSG,X'40'                Space out first byte                
         MVC   MQMPMSG+1(L'MQMPMSG-1),MQMPMSG    and initialize                 
...
MQMPMSG  DS    CL80                         Data to put to queue                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'046DDTMQP2   05/01/02'                                      
         END                                                                    
