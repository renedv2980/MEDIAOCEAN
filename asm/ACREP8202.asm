*          DATA SET ACREP8202  AT LEVEL 045 AS OF 05/01/02                      
*PHASE AC8202A,+0                                                               
*INCLUDE ACLIST                                                                 
***********************************************************************         
*              PROFILES                                               *         
...
* 6      DETAIL TRANSACTION REPORTING                                           
...
*10      SAME PAGE FOR EMPLOYEEE TOTAL                                          
*11      INCLUDE/EXCLUDE/ONLY SHOW REVERSALS                                    
*                                                                     *         
...
***                                                                             
         ...
         CLI   PREVSHOW,C'Y'       INCLUDE REVERSALS?                           
         BE    TRNS3                                                            
         CLI   PREVSHOW,C'O'       SHOW ONLY REVERSALS?                         
         BNE   *+16                                                             
         TM    TRNSSTAT,X'20'                                                   
         BZ    EXIT                                                             
         B     TRNS3                                                            
         TM    TRNSSTAT,X'20'      ELSE EXCLUDE REVERSALS                       
         BO    EXIT                                                             
TRNS3    ZAP   BILLTOT,=P'0'       CLEAR TOTAL ACCUM                            
...
PPGEMP   DS    CL1                 SAME PAGE FOR EMPLOYEE TOTAL                 
PREVSHOW DS    CL1                 INCL/EXCL/SHOW ONLY REVERSALS(Y,N,O)         
...
* DDREPXTRAD                                                                    
       ...
       ++INCLUDE DDREPXTRAD                                                     
         ...
         BUFF  LINES=400,ROWS=1,COLUMNS=6,FLAVOR=PACKED,COMMENT=36,    X        
               KEYLIST=(16,A)                                                   
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045ACREP8202 05/01/02'                                      
         END                                                                    
