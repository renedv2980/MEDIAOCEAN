*          DATA SET SPNWS05    AT LEVEL 124 AS OF 01/30/08                      
*PHASE T20705A,*                                                                
...
BWS2     MVI   APBYTE,7                                                         
         ...
         BE    BWS4                YES-CALL BWS07                               
         MVI   APBYTE,X'0C'                                                     
         CLI   APACTN,ACTBYA       TEST FOR WORK BUYADD                         
         BNE   BWS6                YES-CALL BWS0C                               
*                                                                               
...
GETS6    CLI   TRECTYP,TRECUPD     TEST UPDATE RECORD                           
         BH    GETS6BUY            NO, COULD BE BUY RECORD                      
         CLC   TUCAMP,APBYTE       TEST CORRECT CAMPAIGN SEQ NUM                
         BNE   GETS7               NO-DONE                                      
GETS6DEL MVI   TSARACT,TSADEL      YES-DELETE IT                                
         GOTO1 ATSAR,TREC                                                       
         BE    GETS5               NEXT RECORD                                  
         DC    H'0'                                                             
*                                                                               
GETS6BUY CLI   TRECTYP,TRECBUY     TEST BUY RECORD                              
         BE    GETS6DEL            YES, DELETE THESE RECORDS TOO                
*                                                                               
...
*                                                                               
GETS7B   LA    R1,MINHI2           START READING DETAIL RECORDS                 
         B     GETS8+4                                                          
*                                                                               
...
GETS15C  MVC   TUDAYS,BWDDAYS                                                   
         ...
         B     GETS16                                                           
*                                                                               
GETS15D  BAS   RE,DTSEQ            DAY/TIME/STATION/DPTLEN SEQ                  
         B     *+8                                                              
*                                                                               
GETS15E  BAS   RE,DTSPCL           DAY/TIME (SPECIAL)                           
*                                                                               
...
GETS22   CLI   INORNK,INORNKS      SORT IN DPTLEN/STA/DAY/TIME SEQ              
         ...
         BE    GETS26                                                           
         CLI   INORNK,INORNKU      SORT IN DAY/TIME SPECIAL    SEQ              
         BE    GETS26                                                           
...
***  2 DECIMAL                                                                  
         ...
         BZ    GETS23                                                           
         CLI   ESTDEMS+1,C'R'      MAIN DEMO IS RATING?                         
         BE    GETS22G              - YUP                                       
         CLI   ESTDEMS+1,C'E'      MAIN DEMO IS E-RATING?                       
         BNE   GETS23               - NOPE, IT'S IMPRESSION                     
GETS22G  M     R0,=F'10'                                                        
***  2 DECIMAL                                                                  
GETS23   M     R0,=F'20'                                                        
         DR    R0,RE                                                            
...
*                                                                               
GETS26A  LA    R8,1(R8)            INCREMENT RECORD COUNT                       
*                                                                               
...
GETS29   TM    LFLAG,LPKGMAS       TEST PACKAGE MASTER                          
         BO    *+8                                                              
         BAS   RE,ACPTSDOL         NO-ACCUMULATE POINTS/DOLLARS                 
...
*                                                                               
GETS30D  BAS   RE,GOALS            GET GOALS FOR COMPANION                      
         BNE   GETS80                                                           
...
GETS31   TM    TWAINDS,TWAICCSW    SAVE N'RECORDS                               
         ...
         LA    R9,SSKCMTH                                                       
*                                                                               
GETS32   BAS   RE,GOALS            GET THE GOALS                                
         BNE   GETS80                                                           
...
*******                                                                         
         ...
         IC    RF,IOKEYSAV+12                                                   
         SR    RE,RF                                                            
         CHI   RE,2                SHOULDN'T BE MORE THAN 2 BECAUSE WE          
         BH    EPF4                CAN HAVE 2 EFFECTIVE COSTS                   
         MVC   APRECKEY+12(1),IOKEY+12                                          
*******                                                                         
GETS37   L     R3,AIOAREA2         SET MORE VALUES FOR ROOT                     
...
*                                                                               
         ...
         BNE   GETS80              NO-EXIT                                      
*                                                                               
         XC    APRECKEY+20(NMAXWKS),APRECKEY+20   CLEAR SCHEDULE LINE           
...
GETS40   LA    RF,SPWPERWK                                                      
         ...
         LA    RF,SPWPERWK(RF)                                                  
*                                                                               
GETS41   ZIC   RE,SPWELLN                                                       
         SHI   RE,SPWPERWK-SPWEL                                                
*                                                                               
         CHI   RE,NMAXWKS          DON'T WANT TO OVERWRITE APRECID              
         BNH   *+8                                                              
         LA    RE,NMAXWKS                                                       
*                                                                               
         BCTR  RE,0                                                             
...
*                                                                               
         CHI   RE,NMAXWKS          DON'T WANT TO OVERWRITE STUFF                
         BNH   *+8                    AFTER APRECKEY                            
         LA    RE,NMAXWKS                                                       
*                                                                               
         LA    RF,APRECKEY+20                                                   
         OI    0(RF),X'40'                                                      
...
*                                                                               
         CHI   R0,NMAXWKS          DON'T WANT TO OVERWRITE STUFF                
         BNH   *+8                     AFTER APRECKEY                           
         LA    R0,NMAXWKS                                                       
*                                                                               
         LA    RE,SVGLPTS          GOALS STUFF                                  
****                                                                            
...
*                                                                               
GETS52   LR    RE,R5               MARK WEEKS THAT ARE OUT OF DATE              
         AHI   RE,CMPDATSP-TWAD                                                 
*                                                                               
         XR    RF,RF               ADJUST RE WITH DISPLACEMENT FROM             
         ICM   RF,1,INOSTDTD         THE CAMPAIGN START DATE                    
         ...
         AR    RE,RF                                                            
*                                                                               
GETS53   LA    RF,APRECKEY+20      BOUNDS                                       
         LA    R0,NMAXWKS                                                       
*                                                                               
...
*                                                                               
         ...
         IC    RE,CMPDSTDT                                                      
GETS70A  SR    RF,RE                                                            
GETS71   CHI   RF,NMAXWKS          WILL LAST WEEK BE SHOWN?                     
         BH    GETS72              NO, CAN'T FIT IT ON THE SCREEN               
...
GETS76   DS    0H                                                               
         ...
         BH    GETS80               - NOPE, NO NEED FOR CHECK                   
*                                                                               
...
DTTAB    DC    X'02',AL2(0600),AL2(2000),AL1(4)  SA    6A-8P                    
         ...
         EJECT                                                                  
***********************************************************************         
* SET TSAR KEY FOR DAY/TIME SPECIAL      08/27/02 MHC                 *         
***********************************************************************         
         SPACE 1                                                                
DTSPCL   NTR1  ,                                                                
         MVI   TUSTCAMP,1          SET CAMPAIGN SEQ NUM = 1                     
         TM    TWAINDS,TWAICCSW    OR 2 FOR COMPANION CAMPAIGN                  
         BZ    *+8                                                              
         MVI   TUSTCAMP,2                                                       
         MVC   TUSTSEQ,BWDKELSQ    RECORD SEQUENCE                              
*                                                                               
DTS6     MVI   TUSTSEQ1,1          DAY CODE                                     
         CLI   BWDDAYS,X'40'       1=MONDAY                                     
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,2          2=TUESDAY                                    
         CLI   BWDDAYS,X'20'                                                    
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,3          3=WEDNESDAY                                  
         CLI   BWDDAYS,X'10'                                                    
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,4          4=THURSDAY                                   
         CLI   BWDDAYS,X'08'                                                    
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,5          5=FRIDAY                                     
         CLI   BWDDAYS,X'04'                                                    
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,6          6=SATURDAY                                   
         CLI   BWDDAYS,X'02'                                                    
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,7          7=SUNDAY                                     
         CLI   BWDDAYS,X'01'                                                    
         BE    DTS8                                                             
*                                                                               
         MVI   TUSTSEQ1,0          0=NON SINGLE DAY                             
*                                                                               
DTS8     MVC   TUSTDAYS,BWDDAYS    DAYS                                         
         XI    TUSTDAYS,FF         FLIP THE BITS FOR CORRECT ORDER              
         MVC   TUSTTIME,BWDTIMES                                                
         CLC   TUSTTIME(2),=H'459'   SEE IF TIME IS BEFORE 4:59 AM              
         BL    DTS9A               PROGRAM DOESN'T SPAN TO NEXT DAY             
         XR    R0,R0                                                            
         ICM   R0,3,TUSTTIME                                                    
         AHI   R0,2400             ADD 24 HOURS                                 
         STCM  R0,3,TUSTTIME                                                    
DTS9A    CLC   TUSTTIME+2(2),=H'459'   SEE IF TIME IS BEFORE 4:59 AM            
         BL    DTS9B               PROGRAM DOESN'T SPAN TO NEXT DAY             
         XR    R0,R0                                                            
         ICM   R0,3,TUSTTIME+2                                                  
         AHI   R0,2400             ADD 24 HOURS                                 
         STCM  R0,3,TUSTTIME+2                                                  
DTS9B    MVC   TUSTSTA,BWDSTA      STATION                                      
         MVC   TUSTDPT,BWDDPT      DAYPART                                      
         MVC   TUSTSLN,BWDSLN      LENGTH                                       
*                                                                               
DTSPCLX  B     EXIT                                                             
         DROP  R4                                                               
         EJECT                                                                  
...
GOAL18   LA    R4,1(R4)                                                         
         BCT   R0,GOAL4                                                         
*                                                                               
GOAL20   LA    R4,APELEM           ADD ANY MISSING MASTER DAYPARTS              
*                                  TO THE DAYPART LIST                          
GOAL22   CLI   0(R4),0                                                          
         BE    GOAL28                                                           
         LA    R8,APWORK                                                        
*                                                                               
GOAL24   CLI   0(R8),0             MASTER DAYPART IN THE LIST ALREADY?          
         BNE   GOAL25                                                           
         MVC   0(1,R8),0(R4)       NO, MOVE IT IN THEN                          
*                                                                               
*****    CLI   APROF7,C'C'                                                      
*****    BNE   GOAL26                                                           
         TM    APROFBTS,A00CANAD   CANADA?                                      
         BZ    GOAL26              NO, DON'T EXPAND MASTER DPT INTO THE         
*                                        SUBDPTS ON APPEND                      
         MVC   APDUB(1),0(R4)                                                   
         GOTO1 AGETDPT,APDUB                                                    
         LA    RF,L'DPTSUBS        AND MOVE IN ANY SUBS WE MISSED               
         LA    R1,DPTSUBS                                                       
*                                                                               
GOAL24A  CLI   0(R1),0             WE SHOULD HAVE AT LEAST ONE SUB              
         BE    GOAL26                                                           
         LA    RE,APWORK                                                        
*                                                                               
GOAL24B  CLI   0(RE),0                                                          
...
*                                                                               
         B     GOAL26                                                           
*                                                                               
GOAL25   CLC   0(1,R8),0(R4)       MASTER DAYPART ALREADY HERE?                 
         BE    GOAL26              THEN CHECK NEXT ONE                          
         LA    R8,1(R8)                                                         
         B     GOAL24                                                           
*                                                                               
GOAL26   LA    R4,1(R4)                                                         
...
APD4     ZIC   RE,SPWELLN          FOUND                                        
         ...
         BZ    APD10               YES                                          
         IC    R0,CMPNWKS          NO-ACCUMULATE TOTAL RATINGS BY WEEK          
         LA    R8,SPWPERWK         GRABBING ALL THE WEEKS                       
         LA    R9,SVACPTS                                                       
*                                                                               
APD6     SR    RF,RF                                                            
         ICM   RF,1,0(R8)                                                       
...
***  2 DECIMAL                                                                  
         TM    APROFBTS,A00TWODC   2 DECIMAL AGENCY?                            
         BZ    APD7                 - NOPE                                      
         CLI   ESTDEMS+1,C'R'      MAIN DEMO IS RATING?                         
         BE    APD6G                - YUP                                       
         CLI   ESTDEMS+1,C'E'      MAIN DEMO IS E-RATING?                       
         BNE   APD7                 - NOPE, IT'S IMPRESSION                     
APD6G    M     RE,=F'2'                                                         
         D     RE,=F'10'                                                        
         AHI   RF,1                                                             
         SRA   RF,1                                                             
***  2 DECIMAL                                                                  
APD7     TM    LFLAG2,LCAMP2       TEST COMPANION CAMPAIGN                      
         BZ    *+10                                                             
...
***********************************************************************         
         SPACE 1                                                                
DISSEL   BRAS  RE,DISSELRC                                                      
         BRAS  RE,REMVGLOB              WE NEED TO REMOVE GLOBBER?              
         B     EXIT                                                             
***********************************************************************         
...
VALSEL   MVC   IOKEY(13),APRECKEY  READ THE DETAIL RECORD                       
         ...
         MVC   FVADDR,APPARM                                                    
         B     VALSX                                                            
*************** NEED TO CHECK IF PRIMARY DEMO IS THERE! ***************         
         NI    LFLAG2,255-LF2ESTDM   RESET ESTIMATE DEMO FLAG                   
         L     R3,AIOAREA2                                                      
         USING BWDRECD,R3                                                       
         LA    R2,BWDEL            LOOK FOR DEMO ELEMENT AND PRIMARY!           
*                                                                               
VDEMCHK1 CLI   0(R2),0                                                          
         BNE   *+6                                                              
         DC    H'0'                                                             
         ...
         AR    R2,R0                                                            
         B     VDEMCHK1                                                         
*     WE NEED TO SEE IF WE HAVE THE MAIN DEMO FIRST!!                           
         XR    R0,R0                                                            
         IC    R0,1(R2)                                                         
         AR    R0,R2               SAVE NEXT ELEM ADDRESS FOR COMPARE           
         LA    R2,3(R2)                                                         
VDEMCHK5 CR    R0,R2               DID WE GET TO NEXT ELEM? (NO DEMO)           
         BH    VDEMCHK7            WE HAVE IT                                   
         OI    LFLAG2,LF2ESTDM     ESTIMATE HAS A NEW PRIMARY DEMO              
         B     VALS1                                                            
*                                                                               
VDEMCHK7 CLC   0(2,R2),ESTDEMS+1   WE HAVE THE MAIN DEMO?                       
         BE    VALS1                - YUP!!                                     
         LA    R2,L'DMODEMO(R2)     - NOPE, MOVE TO THE NEXT DEMO               
         B     VDEMCHK5                                                         
**  03/12/03  * NEED TO CHECK IF PRIMARY DEMO IS THERE! ***  MHC  *****         
*                                                                               
VALS1    MVC   COMATWAL,APPARM                                                  
...
*                                                                               
         L     R3,AIOAREA2                                                      
         LA    R1,BWDEL            CHECK FOR TRANSFER ELEMENT                   
         XR    R0,R0                                                            
ERASE00  CLI   0(R1),0                                                          
         BE    ERASE10                                                          
         ...
         B     ERASE00                                                          
*                                                                               
ERASE09  MVC   FVMSGNO,=AL2(FVNODEL)    ERASE PROHIBITED                        
         B     ERASEX                                                           
*                                                                               
ERASE10  GOTO1 AMIN,MINDEL                                                      
*                                                                               
...
*                                                                               
         GOTO1 AMIN,MINDEL                                                      
         B     ERASE20             READ ALL PACKAGE RECORDS                     
*                                                                               
ERASEX   B     EXIT                                                             
         EJECT                                                                  
***********************************************************************         
...
ACDSPL   EQU   GLDSPL+76+8+1+8                                                  
         ...
         EJECT                                                                  
***********************************************************************         
* DSECT FOR THE FOLLOWING TABLE IS TWAELEMD THAT IS IN DDTWABLD                 
***********************************************************************         
...
FLSCR6   MVC   2(2,R9),4(R2)       DAY NUMBER                                   
         LA    R8,4(R8)            NEXT POSITION ON THE CALENDAR LINES          
         LA    R9,4(R9)                                                         
*                                                                               
...
*                                                                               
         ...
         CR    R9,R0               WE'RE AT THE END OF FIELD?                   
         BNL   FLSCR10             YES                                          
         LA    R2,6(R2)            BUMP TO NEXT WEEK/DAY                        
         LA    R4,1(R8)            NO - CONTINUE                                
         B     FLSCR6                                                           
*                                                                               
...
***********************************************************************         
         SPACE 1                                                                
DISSELRC NTR1  BASE=*,LABEL=*                                                   
         L     R8,APPARM           A(TWA LINE)                                  
         ST    R8,COMATWAL                                                      
...
*                                                                               
         ...
         BZ    DISS1D              NO, USER ACTUALLY TYPE IN THE YEAR           
...
*                                                                               
DISS1B   GOTO1 VDATCON,APPARM,(3,APWORK),(2,INOSTDTE)                           
...
*                                                                               
         ...
         BNL   DISS1Z                                                           
DISS1ERR MVC   FVMSGNO,=AL2(FVOUTCAM)                                           
         LA    R1,BWSOPTH                                                       
         ST    R1,FVADDR                                                        
         B     DISSX               BELOW CAMP DATES, ERROR                      
*                                                                               
DISS1Z   CLI   0(R2),FF            NEXT DATE IS EOT?                            
         BE    DISS1ERR            THEN ERROR                                   
...
DISS2    MVC   INOSTDTE,0(R2)                                                   
         STC   R3,INOSTDTD                                                      
*                                                                               
DISS2G   LA    R3,APRECKEY                                                      
         ...
         B     DISSX                                                            
*                                                                               
DISS2M   L     R3,AIOAREA2         R3=A(RECORD)                                 
         CLI   BWDELLN,BWDELLNQ    ARE WE OLD STYLE BWDEL?                      
         BH    DISS2Z              NOPE                                         
         XC    APELEM,APELEM       DELETE OLD BWDEL                             
         MVC   APELEM(BWDELLNQ),BWDEL                                           
         GOTO1 ADELELS,(R3)                                                     
         MVI   APELEM+1,BWDELL2Q   USE THE NEW LENGTH                           
*                                                                               
         GOTO1 AADDELS,(R3)                                                     
*                                                                               
DISS2Z   CLI   APACTN,ACTSSK       TEST ACTION=SUPER-SKED                       
         BNE   DISS3G                                                           
*                                                                               
         USING SSKL1H,R8                                                        
         TM    LFLAG2,LF2BUYRV     DOING BUY REVISIONS?                         
         BZ    *+12                                                             
         OI    SSKSKDH+1,X'20'     PROTECT THE SCHEDULE                         
         B     *+8                                                              
         NI    SSKSKDH+1,X'FF'-X'20'  DON'T PROTECT THE SCHEDULE                
*                                                                               
         L     R8,COMATWAL                                                      
...
*                                                                               
         USING WRKL1H,R8                                                        
DISS3G   GOTO1 ADISPSEL            DISPLAY THE RECORD                           
         BNE   DISSX                                                            
         LA    R4,WRKLST                                                        
         DROP  R8                                                               
*                                                                               
         USING LIST1D,R4                                                        
DISS3M   CLI   APMODE,APMDISS2     TEST POST RECORD CHANGE DISPLAY MODE         
...
*                                                                               
         ...
         B     DISS7                                                            
*                                                                               
         TM    BWDINDS2,BWDINBR    LINKED WITH A NBR RECORD?                    
         BZ    *+12                                                             
         MVI   LIND,C'>'           YES                                          
         B     DISS7                                                            
*                                                                               
DISS3Z   SR    R0,R0               NO-LOOK FOR BUY TRANSFER ELEMENT             
         LA    R1,BWDEL                                                         
...
DISS4    CLI   0(R1),0                                                          
         BE    DISS7                                                            
         CLI   0(R1),DTRELCDQ      X'17' - DAILY TRANSFER ELEMENT?              
         BE    DISS5                                                            
         CLI   0(R1),COMELCDQ      X'06' - COMMENT LINE?                        
         BE    DISS5A                                                           
         CLI   0(R1),BTRELCDQ      X'07' - TRANSFER ELEMENT?                    
         BNE   DISS6                                                            
         CLI   CLTBWPRO+9,C'Y'                                                  
         BNE   DISS5                                                            
...
DISS5    MVI   LIND,C'*'           BUY TRANSFER - SHOW WITH A STAR              
         B     DISS7                                                            
*                                                                               
DISS5A   CLI   2(R1),5             WE ONLY HAVE 5 COMMENT LINES                 
         BNE   DISS6                                                            
         CLI   3(R1),C'^'          INDICATE LAST COMMENT BEGINS W/ C'^'         
         BNE   DISS6                 BUT C'*' WILL OVERRIDE                     
         MVI   LIND,C'!'                                                        
*                                                                               
DISS6    IC    R0,1(R1)                                                         
         AR    R1,R0                                                            
...
*                                                                               
         TM    LFLAG2,LF2BUYRV     DOING BUY REVISIONS?                         
         BZ    *+12                                                             
         OI    SKDSKDH+1,X'20'     PROTECT THE SCHEDULE                         
         B     *+8                                                              
         NI    SKDSKDH+1,X'FF'-X'20'  DON'T PROTECT THE SCHEDULE                
*                                                                               
         LA    R4,SKDLINEL(R4)                                                  
         BCT   R0,DISS10                                                        
*                                                                               
...
*                                                                               
         BCT   R2,DISS18                                                        
*                                                                               
DISS19   LA    R1,BWDEL            LOOK FOR SPOTS PER WEEK ELEMENT              
         SR    R0,R0                                                            
*                                                                               
DISS20   CLI   0(R1),0                                                          
         BE    DISS30                                                           
         ...
         B     DISS20                                                           
*                                                                               
         USING SPWEL,R1            FOUND-FORMAT SPOTS PER WEEK TO               
         ZIC   RF,SPWELLN                SCREEN                                 
         AR    RF,R1                                                            
         LR    R3,RF               SAVE FOR COMPARE LATER                       
         BCTR  RF,0                                                             
         ZIC   RE,CMPNWKS                                                       
         LA    RE,SPWPERWK-SPWEL-1(RE,R1)                                       
         CR    RE,RF                                                            
         BNL   *+6                                                              
         LR    RF,RE                                                            
         LA    RE,1                                                             
*                                                                               
         LA    R1,SPWPERWK                                                      
         ICM   R0,1,INOSTDTD       FROM THE START DATE                          
         BNZ   *+8                                                              
         IC    R0,CMPDSTDT                                                      
         AR    R1,R0                                                            
*                                                                               
         LR    R0,R1               DO WE CHANGE END FOR BXLE AS WELL?           
         AHI   R0,13               ALL WE CAN SHOW IF 14 WEEKS                  
         CR    RF,R0                                                            
         BNH   DISS21                                                           
         LR    RF,R0               SET NEW END BOUND FOR THE BXLE               
*                                                                               
DISS21   LA    R2,SKDSKD+1                                                      
         CLI   APACTN,ACTSSK                                                    
         BNE   *+8                                                              
         LA    R2,SSKSKD+1                                                      
         SR    R0,R0                                                            
*                                                                               
***  R3 IS THE END OF THE ELEMENT                                               
*                                                                               
DISS22   CR    R3,R1                                                            
         BE    DISSX               WE'RE DONE WITH ELEMENT                      
*                                                                               
         CLI   1(R2),C'X'                                                       
         BE    DISS24                                                           
         CLI   0(R1),0                                                          
...
*                                                                               
         ...
         MVI   CMPDSTDT,0          STDATE=  OVERRIDES PREV SCROLLING            
         TM    INOSTDTD,X'80'      YEAR WAS OMITTED?                            
         BZ    VPAR6D              NO, USER ACTUALLY TYPE IN THE YEAR           
         GOTO1 VDATCON,APPARM,(2,INOSTDTE),(3,APWORK)                           
*                                                                               
         CLC   CMPST(1),CMPND      CAMP DATES IN SAME YEAR?                     
         BNE   *+14                                                             
...
*                                                                               
         MVC   APWORK(1),CMPND       YES, COPY THE YEAR FROM CAMP END           
*                                                                               
VPAR6B   GOTO1 VDATCON,APPARM,(3,APWORK),(2,INOSTDTE)                           
         NI    INOSTDTD,X'FF'-X'80'                                             
*                                                                               
VPAR6D   LR    R2,R5                                                            
         AHI   R2,CMPDATSP-TWAD                                                 
...
*                                                                               
         CLC   INOSTDTE,0(R2)      MAKE SURE START DATE W/IN CAMP DATES         
         BNL   VPAR6G                                                           
VPAR6ERR MVC   FVMSGNO,=AL2(FVOUTCAM)                                           
         LA    R1,BWSOPTH                                                       
         ST    R1,FVADDR                                                        
         B     VPARX               BELOW CAMP DATES, ERROR                      
*                                                                               
VPAR6G   CLI   0(R2),FF            NEXT DATE IS EOT?                            
         BE    VPAR6ERR            THEN ERROR                                   
         CLC   INOSTDTE,2(R2)      START DATE SHOULD BE IN 1 OF THE WKS         
         BNH   VPAR6X                                                           
         AHI   R2,4                2 COMPRESSED DATES                           
         AHI   R3,1                                                             
...
VPAR7    LA    R2,IOKEY                                                         
         ...
         LA    R3,APRECKEY                                                      
         USING BWDKEY,R3                                                        
         OI    BWSKEYH+4,X'20'     SET PREVIOUSLY VALIDATED                     
         MVC   BWHKCAM,BCAM                                                     
...
*                                                                               
VPAR41   CLI   APACTN,ACTSEN       IS THE ACTION SEND??                         
         BE    VPAR42               - ABSOLUTELY NO NEED FOR THIS               
         L     R1,APFULL                                                        
...
*                                                                               
         LA    R1,BWHFSTEL                                                      
         XR    R0,R0                                                            
VPAR43A  CLI   0(R1),0             LOOK FOR INFO ELEMENT (X'06')                
         BE    VPAR43C             NEED TO ADD ONE THEN                         
         CLI   0(R1),INFELCDQ                                                   
         BE    VPAR43B                                                          
         IC    R0,1(R1)                                                         
         AR    R1,R0                                                            
...
*                                                                               
         USING INFELD,R1                                                        
VPAR43B  TM    INFFLAG1,IFF1BYRV   DOING BUY REVISIONS?                         
         BZ    *+8                                                              
         OI    LFLAG2,LF2BUYRV     YES                                          
         DROP  R1                                                               
VPAR43C  DS    0H                                                               
*                                                                               
...
DISPSEL  L     R3,AIOAREA2                                                      
         ...
         USING WRKL1H,R8                                                        
         CLI   APMODE,APMDISS2     TEST POST RECORD CHANGE DISPLAY MODE         
         BE    DSEL1Z               - YES, DON'T HAVE TO PROTECT FIELDS         
*                                                                               
         TM    LFLAG2,LF2BUYRV     DOING BUY REVISIONS?                         
         BZ    DSEL1                                                            
         OI    WRKRATH+1,X'20'     YES, PROTECT INPUT FIELDS                    
         OI    WRKDAYH+1,X'20'                                                  
         OI    WRKTIMH+1,X'20'                                                  
         OI    WRKCSTH+1,X'20'                                                  
         OI    WRKPRGH+1,X'20'                                                  
         B     DSEL1Z                                                           
DSEL1    NI    WRKRATH+1,X'FF'-X'20'  DON'T PROTECT INPUT FIELDS                
         NI    WRKDAYH+1,X'FF'-X'20'                                            
         NI    WRKTIMH+1,X'FF'-X'20'                                            
         NI    WRKCSTH+1,X'FF'-X'20'                                            
         NI    WRKPRGH+1,X'FF'-X'20'                                            
*                                                                               
DSEL1Z   XC    WRKDLM,WRKDLM                                                    
         OI    WRKDLMH+6,FVOXMT                                                 
         LA    R4,WRKLST                                                        
         USING LIST1D,R4                                                        
...
*                                                                               
***  NEED TO PAD WRKRAT WITH SPACES WHEN THE RATING IS 0                        
         MVC   WRKRAT,=C'      '                                                
         OI    WRKRATH+6,FVOXMT    TRANSMIT                                     
         OI    EBOPT,X'20'         ZERO IS NON-BLANK                            
...
DSEL22X  NI    EBOPT,X'FF'-X'20'   BACK TO BLANK FOR ZERO VALUE                 
*                                                                               
...
DSEL23   D     R0,APFULL                                                        
         ...
         MVI   EBSCIN,0                                                         
***  2 DECIMAL                                                                  
         CLC   APFULL,=F'1000000'    IS IT 10000 OR BIGGER?                     
         BL    DSEL23G                                                          
         MVI   EBDECS,0                                                         
         MVI   EBSCIN,X'82'                                                     
***  2 DECIMAL                                                                  
DSEL23G  LA    RF,WRKCPP                                                        
         ST    RF,EBAOUT                                                        
         MVI   EBLOUT,L'WRKCPP                                                  
         MVI   EBFLOAT,C'$'                                                     
...
*                                                                               
         TM    LFLAG2,LF2ESTDM     ESTIMATE HAS NEW PRIMARY DEMO?               
         BO    VSEL96               - YUP, ERROR!                               
*                                                                               
         B     VSEL6                                                            
*                                                                               
...
***  2 DECIMAL                                                                  
         ...
         OI    LFLAG2,LMDEMO2D     MAIN DEMO CATEGORY NEEDS 2 DECIMALS          
...
VSEL8G   CLI   APPARM,FF                                                        
         ...
         DROP  R2                                                               
***  2 DECIMAL                                                                  
         TM    LFLAG2,LMDEMO2D     WE DID 2 DECIMALS?                           
         BNO   VSEL9                - NOPE                                      
...
***      NI    APFULL,FF-DMODEMOV-DMODEM2D                                      
         NI    APFULL,FF-DMODEMOV   NEED TO KEEP THE DMODEM2D ON                
...
*                                                                               
         ...
         BE    VSEL30                                                           
         BRAS  RE,DEMUP            YES - DO THE UPGRADE                         
         BNE   VSELX                                                            
         L     R8,LADEMEL                                                       
         LA    R8,DMODEMO-DMOEL(R8)                                             
         LA    RE,LDEMVALS                                                      
...
***  2 DECIMAL                                                                  
         ...
         BZ    VSEL31               - NOPE                                      
         OC    INORTG,INORTG       OVERRIDING TARGET DEMO?                      
         BNZ   VSEL36               - YUP                                       
         CLI   ESTDEMS+1,C'R'      MAIN DEMO IS RATING?                         
         BE    VSEL30E              - YUP                                       
         CLI   ESTDEMS+1,C'E'      MAIN DEMO IS E-RATING?                       
         BNE   VSEL31               - NOPE, IT'S IMPRESSION                     
*                                                                               
VSEL30E  L     RF,LNEWRTG          YES - CALCULATE NEW ACTUAL POINTS            
...
VSEL32   CLI   0(R8),0                                                          
         ...
         B     VSEL32                                                           
*                                                                               
         LA    R2,SVACPTS          CHANGE IN RATING AFFECT ALL POINTS           
         ZIC   RF,CMPNWKS                                                       
         ZIC   R1,1(R8)                                                         
         SHI   R1,SPWPERWK-SPWEL                                                
         CR    R1,RF                                                            
         BNL   *+6                                                              
         LR    RF,R1                                                            
...
***  2 DECIMAL                                                                  
         ...
         L     R1,APPARM                                                        
***  2 DECIMAL                                                                  
VSEL39   GOTO1 AADDELS,BWDRECD                                                  
*                                                                               
VSEL40   TM    COMCHG,LDEMO+LPROG  DID USER CHANGE THE DEMO/PROGRAM?            
         BZ    VSEL41                                                           
         OC    LADEMEL,LADEMEL                                                  
         BNZ   VSEL40Z                                                          
         LA    R1,BWDEL                                                         
         ZIC   R0,1(R1)                                                         
         AR    R1,R0                                                            
VSEL40A  CLI   0(R1),0             END OF RECORD?                               
         BE    VSEL40Z             NO DEMO, LEAVE IT ALONE                      
         CLI   0(R1),DMOELCDQ      DEMO ELEMENT?                                
         BE    VSEL40N             YES                                          
         IC    R0,1(R1)                                                         
         AR    R1,R0                                                            
         B     VSEL40A                                                          
*                                                                               
VSEL40N  ST    R1,LADEMEL          STORE ADDRESS OF DEMO ELEMENT                
*                                                                               
VSEL40Z  GOTO1 APUTCMPR,APPARM,(X'C0',BWDDAYS),BWDTIMES,BWDSTA,        X        
               LADEMEL,BWDPROG     YES, CHANGE BOTH                             
*                                                                               
VSEL41   NI    LFLAG,FF-LDEMUP                                                  
         L     R2,COMATWAL                                                      
         USING WRKL1H,R2                                                        
...
*                                                                               
         ...
         CLI   LDEMS,FF            TEST UPGRADE NEEDED                          
         BE    VSEL70                                                           
         BRAS  RE,DEMUP            YES - DO THE UPGRADES                        
         BNE   VSELX                                                            
...
*                                                                               
VSEL72   XC    APDUB,APDUB         STORE EFFECTIVE DATES SO WE CAN SEE          
         TM    APRECID,RIEFFDT2      WHICH SPOTS' COSTS ARE AFFECTED            
         BZ    VSEL72B               GOING THRU CMPDATSP                        
***************                                                                 
* USING 2ND COST                                                                
***************                                                                 
         GOTO1 VDATCON,APPARM,(3,BWDEFDT2),(2,APDUB)                            
         ...
         BZ    VSEL72A                                                          
         GOTO1 VDATCON,APPARM,(3,BWDEFDT3),(2,APDUB+2)                          
VSEL72A  LA    RF,BWDCOST2                                                      
         B     VSEL73                                                           
*                                                                               
VSEL72B  TM    APRECID,RIEFFDT3                                                 
         BZ    VSEL72D                                                          
***************                                                                 
* USING 3RD COST                                                                
***************                                                                 
         GOTO1 VDATCON,APPARM,(3,BWDEFDT3),(2,APDUB)                            
         LA    RF,BWDCOST3                                                      
         B     VSEL73                                                           
***************                                                                 
* USING FIRST COST                                                              
***************                                                                 
VSEL72D  OC    BWDEFDT2,BWDEFDT2                                                
         BZ    VSEL72E                                                          
         GOTO1 VDATCON,APPARM,(3,BWDEFDT2),(2,APDUB+2)                          
VSEL72E  LA    RF,BWDCOST1                                                      
*                                                                               
...
VSEL74   CLI   0(R8),0                                                          
         ...
         B     VSEL74                                                           
*                                                                               
         ZIC   R4,1(R8)                   R4 IS THE # OF WEEKS AFFECTED         
         SHI   R4,SPWPERWK-SPWEL                                                
*                                                                               
         LA    R4,SPWPERWK-SPWEL(R4,R8)   R4 IS THE BOUNDARY CONDITION          
         ZIC   RF,CMPNWKS                                                       
...
*                                                                               
         ...
         AHI   R2,CMPDATSP-TWAD                                                 
***************                                                                 
* APDUB HAS THE COMPRESSED START/END EFFECTIVE DATES SET FROM VSEL72            
***************                                                                 
VSEL76   OC    APDUB(4),APDUB      ANY EFFECTIVE DATES?                         
         BZ    VSEL76M             NONE, AFFECTS ALL SPOTS                      
*                                                                               
         OC    APDUB(2),APDUB      ANY START EFFECTIVE DATE?                    
         BZ    VSEL76G             NONE, HAVE AN END DATE                       
*                                                                               
         CLC   2(2,R2),APDUB       ARE WE IN AN AFFECTED WEEK?                  
         BL    VSEL77              NO                                           
         OC    APDUB+2(2),APDUB+2                                               
         BZ    VSEL76M                 NO END DATE, HERE ON OUT                 
         CLC   0(2,R2),APDUB+2                                                  
         BNL   VSEL78                  WENT THRU ALL AFFECTED SPOTS             
         B     VSEL76M                                                          
* JUST AN END EFFECTIVE DATE                                                    
VSEL76G  CLC   0(2,R2),APDUB+2     ARE WE PAST END EFFECTIVE DATE?              
         BNL   VSEL78              YES, WENT THRU ALL AFFECTED SPOTS            
*                                                                               
VSEL76M  ZIC   RF,0(R8)                                                         
         SR    RE,RE                                                            
...
VSEL85   B     VSELX                                                            
*                                                                               
VSEL96   MVC   FVMSGNO,=AL2(FVDEMES)   ESTIMATE DEMOS CHANGED!!                 
         B     VSELX                                                            
*                                                                               
...
VALSKD   L     R3,AIOAREA2                                                      
         ...
         CLI   BWDELLN,BWDELLNQ    ARE WE OLD STYLE BWDEL?                      
         BH    VSKD1               NOPE                                         
         LR    R0,R1               SAVE THIS OTHERWISE A(SCHEDULE LINE)         
*                                       GET CLOBBERED                           
         XC    APELEM,APELEM       DELETE OLD BWDEL                             
         MVC   APELEM(BWDELLNQ),BWDEL                                           
         GOTO1 ADELELS,(R3)                                                     
         MVI   APELEM+1,BWDELL2Q   USE THE NEW LENGTH                           
         GOTO1 AADDELS,(R3)                                                     
         LR    R1,R0               RESTORE IT BACK                              
*                                                                               
VSKD1    MVC   LAACLINE,4(R1)                                                   
         MVI   LFLAG,0                                                          
         L     R1,0(R1)                                                         
         ST    R1,LASKDLN                                                       
*                                                                               
         ...
         XC    LNOSKED,LNOSKED     CLEAR OUT OUR SUBSET OF WEEKS                
*                                                                               
...
*                                                                               
         LA    R8,SPWPERWK         FROM WHAT IS IN RECORD                       
         AR    R8,RE                                                            
*                                                                               
VSKD34A  LA    RE,FVIFLD-1         BEGIN WITH FIRST WEEK                        
...
*                                                                               
         ...
         SR    R1,R1                                                            
         LA    RE,LNOSKED                                                       
         LA    RF,14               MAX # OF WEEKS TBAT CAN BE DISPLAYED         
*                                                                               
VSKD45   CLI   0(RE),0                                                          
         BE    *+6                                                              
         LR    R1,R8                                                            
...
*                                                                               
VSKD45A  CLI   CMPNWKS,14          DO WE NEED TO WORRY ABOUT BWDWKS2?           
         BH    *+12                                                             
         STCM  R0,3,BWDWKS         NO                                           
         B     VSKD46                                                           
***********************************                                             
...
*                                                                               
VSKD45X  MVC   BWDWKS,APDUB        SAVE IT INTO THE RECORD                      
         MVC   BWDWKS2(5),APDUB+2                                               
***********************************                                             
* END                                                                           
* BIT-WISE MANIPULATION TO STORE 14 BITS INTO SOMEWHERE OF 7 BYTES              
***********************************                                             
...
VSKD48A  XR    R0,R0                                                            
         IC    R0,1(R1)                                                         
         AR    R0,R1               SAVE NEXT ELEM ADDRESS FOR COMPARE           
*        LA    R1,3(R1)   (APFULL) THEY USING HARDCODE TO GET VALUE             
VSKD49   CR    R0,R1               DID WE GET TO NEXT ELEM?                     
         BL    VSKD98              ERROR - EST HDR DEMO CHANGED                 
*        BNE   *+6                  - NOPE                                      
*        DC    H'0'                 - YEAH, NO GOOD! (DIDN'T FIND DEMO)         
         CLC   3(2,R1),ESTDEMS+1   WE HAVE THE MAIN DEMO?                       
         BE    VSKD49A              - YUP!!                                     
         LA    R1,L'DMODEMO(R1)     - NOPE, MOVE TO THE NEXT DEMO               
         B     VSKD49                                                           
*                                                                               
**KD49A  MVI   APFULL,0                                                         
**       MVC   APFULL+1(3),DMODEMO+5-DMOEL(R1)    APFULL = DEMO VALUE           
VSKD49A  MVC   APDUB(8),DMODEMO-DMOEL(R1)   APDUB = DEMCAT + VALUE              
         OC    INORTG,INORTG       TEST FOR OVERRIDE TARGET DEMO                
         BZ    VSKD50                                                           
         ...
         BXLE  R1,RE,*-10                                                       
         B     VSKD50                                                           
***  WE'RE SAVING OFF THE 2D/OVERRIDE BITS FOR NOW                              
**       MVC   APFULL+1(3),5(R1)                                                
         MVC   APDUB(8),0(R1)      APDUB HAS THE DEMCAT AND VALUE               
*                                                                               
VSKD50   DS    0H                                                               
         MVC   APWORK(8),APDUB     APDUB GETS WIPED LATER                       
         MVI   APFULL,0                                                         
         MVC   APFULL+1(3),APWORK+5                                             
*                                                                               
VSKD51   TM    APRECID,RIEFFDT2    FIND THE COST (LFULL)                        
         BZ    *+14                                                             
         MVC   LFULL,BWDCOST2                                                   
         B     VSKD52                                                           
         TM    APRECID,RIEFFDT3                                                 
...
VSKD52   LA    R4,SPWPERWK         R4 = A(NEW SPOTS PER WEEK)                   
         SR    R0,R0               HAVE TO BASE OFF STDATE OPTION               
         ICM   R0,1,INOSTDTD                                                    
         BNZ   *+8                                                              
         IC    R0,CMPDSTDT                                                      
         AR    R4,R0                                                            
...
**       BE    VSKD54C              - YUP                                       
**       CLI   ESTDEMS+1,C'E'      MAIN DEMO IS E-RATING?                       
**       BNE   VSKD54E              - NOPE, IT'S IMPRESSION                     
         TM    APWORK+4,X'40'      IS THE VALUE IN 2 DECIMAL??                  
         BZ    VSKD54E              - NOPE                                      
         CLI   APWORK+1,C'R'       MAIN DEMO IS RATING?                         
         BE    VSKD54C              - YUP                                       
         CLI   APWORK+1,C'E'       MAIN DEMO IS E-RATING?                       
         BNE   VSKD54E              - NOPE, IT'S IMPRESSION                     
VSKD54C  M     R0,=F'2'                                                         
         D     R0,=F'10'                                                        
         AHI   R1,1                                                             
...
*                                                                               
VSKD57   L     R3,AIOAREA2                                                      
         OC    LAACLINE,LAACLINE   TEST FOR ACTUAL POINTS/DOLLARS LINE          
         BZ    VSKD58              ON THIS SCREEN                               
         GOTO1 CFMACPTS,APPARM,LAACLINE,SVGVA  YES-FORMAT ACTUAL POINTS         
         GOTO1 CFMACDOL,APPARM,LAACLINE,SVGVA      FORMAT ACTUAL DOLLS          
*                                                                               
VSKD58   GOTO1 ADELELS,BWDRECD     DELETE OLD ELEMENT IF ANY                    
*                                                                               
         L     R4,LREGSV                                                        
         ZIC   RE,SPWELLN          CAN'T JUST CHECK 14 WEEKS HERE               
         SHI   RE,SPWPERWK-SPWEL+1                                              
         EX    RE,*+8                                                           
         B     *+10                                                             
         OC    SPWPERWK(0),SPWPERWK  TEST FOR ANY SPOTS AT ALL                  
         BZ    VSKD90                                                           
*                                                                               
...
VSKD90   MVC   FVMSGNO,=AL2(FVFOK) OK EXIT                                      
         B     VSKDX                                                            
*                                                                               
VSKD98   MVC   FVMSGNO,=AL2(FVDEMES)   ERROR IS CHECKED AFTER GETTING           
         B     VSKDX                   ...OUT OF SUBROUTINE                     
*                                                                               
...
*****  CABLE/FUSION DATE LOOKUP                                                 
         ...
         XC    SPLKSTA,SPLKSTA                                                  
         MVC   SPLKSTA(3),BWDSTA+5   MOVE THE NETWORK IN                        
         USING SPLKXTD,RE                                                       
...
*****  CABLE/FUSION DATE LOOKUP                                                 
         ...
         B     GETP00G                                                          
*****  CABLE/FUSION DATE LOOKUP                                                 
GETP00E  MVC   SPUPSTA,BWDSTA                                                   
GETP00G  MVC   SPUPDAY,BWDDAYS                                                  
...
GETPRG4  CLI   QBOOKTYP,0                                                       
         ...
         B     GETPRG6                                                          
*                                                                               
GETPRG5  GOTO1 AGETBKTY,APPARM,(C'B',SPUPFBK+1),SPUPBTYP                        
GETPRG6  NI    SPUPFBK+1,X'FF'-BTYBITSQ                                         
*                                                                               
GETPRG7  CLI   LUPPUT,C'1'                                                      
         BNE   *+8                                                              
         MVI   SPUP2YRP,C'N'                                                    
         CLI   LUPPUT,C'2'                                                      
         BNE   *+8                                                              
...
***  2 DECIMAL  ***                                                             
GETPRG8  GOTO1 ASPDEMUP,APPARM,LDMUPBLK,LDEMS,LDEMVALS                          
         MVC   BWDPROG,BLANKS                                                   
         MVC   BWDPROG,SPUPPRG     SAVE PROGRAM NAME                            
*                                                                               
         B     COMMONX                                                          
         EJECT                                                                  
*&&                                                                             
...
***********************************                                             
         LA    R2,GACPTS           GO THROUGH ALL THE WEEKS TO GET TOTL         
         ZIC   R0,CMPNWKS                                                       
         SR    R3,R3               R3 = TOTAL POINTS FOR SCHEDULT               
...
*                                                                               
         ...
         MVI   EBSCIN,X'83'                                                     
*                                                                               
FACP60   GOTO1 VEDITOR,APPARM,EBLOCK     OVERALL TOTAL                          
*                                                                               
...
VALSLNS  NTR1  BASE=*,LABEL=*                                                   
         ...
         BZ    VSLN8                                                            
**       LA    RE,8(R8)                                                         
         LA    R3,8(R8)            REPLACING RE WITH R3                         
         LA    R2,1                                                             
         B     VSLN4                                                            
*                                                                               
VSLN2    CLI   1(R8),0                                                          
...
*****  CABLE/FUSION DATE LOOKUP                                                 
         ...
         B     DM12G                                                            
*****  CABLE/FUSION DATE LOOKUP                                                 
DM12E    MVC   SPUPSTA,BWDSTA                                                   
DM12G    MVC   SPUPDAY,BWDDAYS                                                  
         MVC   SPUPTIM,BWDTIMES                                                 
         MVC   SPUPFIL,LUPFIL                                                   
         MVC   SPUPSRC,CLTSRC                                                   
         MVC   SPUPFBK,LUPFRBK                                                  
...
*                                                                               
         ...
         B     DM13E                                                            
*                                                                               
DM13C    GOTO1 AGETBKTY,APPARM,(C'B',SPUPFBK+1),SPUPBTYP                        
DM13E    NI    SPUPFBK+1,X'FF'-BTYBITSQ                                         
*                                                                               
DM14     DS    0H                                                               
***  2 DECIMAL  ***                                                             
         TM    APROFBTS,A00TWODC   ARE WE DOING 2 DECIMALS?                     
...
LMDEMO2D EQU   X'04'               MAIN DEMO CATEGORY NEEDS 2 DECIMALS          
LF2ESTDM EQU   X'02'               ESTIMATE DEMOS CHANGED                       
LF2BUYRV EQU   X'01'               DOING BUY REVISIONS NOW                      
*                                                                               
LIND     DS    X                                                                
LPKGNUM  DS    X                                                                
LFSTLINE DS    X                                                                
...
* DDGLVXCTLD                                                                    
       ...
       ++INCLUDE DDGLVXCTLD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'124SPNWS05   01/30/08'                                      
         END                                                                    
