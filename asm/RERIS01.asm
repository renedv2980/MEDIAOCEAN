*          DATA SET RERIS01    AT LEVEL 092 AS OF 12/16/13                      
...
*                                                                   *           
* JUN12/03 (BU ) --- FIX PRIOR YEAR DATE CALCULATION FOR DAILY PACE *           
*                                                                   *           
* JAN30/04 (HQ ) --- FIX MARKET TABLE COUNTER                       *           
*                                                                   *           
* AUG23/10 (SMY) --- RCU (SCRIPT CONTRACT UPLOAD FILTERING)         *           
*                                                                   *           
* AUG15/13 (BOB) --- MAKEGOOD LISTS                                 *           
*                                                                   *           
*                                                                   *           
*                    **  END TOMBSTONE  **                          *           
*********************************************************************           
...
*                                                                               
         ...
         XC    LISTWOPS,LISTWOPS   LISTING FLAGS                                
         XC    LISTOOPS,LISTOOPS   LISTING FLAGS                                
         XC    LISTDOPS,LISTDOPS   LISTING FLAGS                                
...
*                                                                               
         ...
         XC    0(10,RE),0(RE)                                                   
         EJECT                                                                  
         CLC   RISDATE(5),=C'LISTO' CHECK FOR LISTO OPTION                      
         BNE   *+8                                                              
         MVI   LISTBYTE,LISTMKG       SET FOR VALIDATION ROUTINES               
*                                                                               
********************                                                            
* VALIDATE STATION *                                                            
********************                                                            
...
*                                                                               
         ...
         CLI   LISTBYTE,LISTMKG    DISALLOW FOR LISTO                           
         BE    VSLTMER1                                                         
         EJECT                                                                  
*---------------*                                                               
* VALIDATE TEAM *                                                               
...
VALSAL0  LA    R3,SLSERR                                                        
         XC    SVDVSLS,SVDVSLS     INIT SAVEAREA                                
         CLI   5(R2),0                                                          
         BNE   *+8                                                              
*****    BNE   *+16                                                             
*****    CLI   LISTBYTE,LISTMKG    REQUIRED FOR LISTO                           
*****    BE    VSLTMER1                                                         
         B     VALSAL2                                                          
*                                                                               
...
VALSAL6  EQU   *                                                                
***                                                                             
         CLI   LISTBYTE,LISTMKG    IF LISTO                                     
         BNE   VALSAL7                                                          
         CLC   RISSLS(2),=C'D='    CHECK FOR DEVELOPMENTL SALESPERSON           
         BNE   VALSAL7                                                          
*                                                                               
         CLI   5(R2),L'RDSPKSAL+2  TOO LONG?                                    
         BH    VSLTMER1            YES                                          
*                                                                               
         LA    R6,KEY                                                           
         USING RDSPKEY,R6                                                       
         ...
         MVI   RDSPKTYP,X'3A'                                                   
         MVC   RDSPKSAL,10(R2)                                                  
         OC    RDSPKSAL,=CL3' '    FORCE UPPERCASE                              
         MVC   RDSPKREP,REPALPHA                                                
*                                                                               
         GOTO1 HIGH                                                             
*                                                                               
         CLC   KEY(L'RDSPKEY),KEYSAVE                                           
         BNE   VSLTMER1            DEV. SALESPERSON NOT ON RECORD               
*                                                                               
         BRAS  RE,GETREC           READ IN SECORD                               
*                                                                               
         MVC   SVDVSLS,RDSPKSAL                                                 
*                                                                               
         L     R6,AIOAREA          FIND NAME ELEMENT                            
*                                                                               
         MVC   RISSLSN,RDSPNAME    DISPLAY NAME                                 
         LA    R4,RISSLSNH                                                      
         FOUT  (R4)                                                             
*                                                                               
VALSAL6A DS    0H                                                               
...
VALCD05  OI    RISCRTH+4,X'20'                                                  
         CLI   LISTBYTE,LISTMKG    SKIP IF LISTO                                
         BE    VALCDATX                                                         
*                                                                               
...
VCT12    MVC   TBLCTYP,8(R2)                                                    
         ...
         BNE   VCT12D                                                           
*                                                                               
         LAY   R1,CONSTTBL         ,,NEEDS FURTHER CHECKING                     
...
*                                                                               
         TM    VIEWS,X'17'         IF LIST$,LISTD,BUY$,LISTE                    
         BZ    VALALTX                                                          
         CLI   8(R2),C'E'          E -> B                                       
         BNE   VALALTX                                                          
         MVI   8(R2),C'B'                                                       
...
*                                                                               
         ...
         MVC   HALF,DMCB+10        SAVE NUMBER OF DAYS REMAINING                
*                                                                               
*   DAILY PACING REQUIRES THAT THE WEEK NUMBER NOT BE ADJUSTED.                 
*                                                                               
...
SUB10020 EQU   *                                                                
         ...
         AH    R2,HALF             ADD IN NUMBER OF DAYS REMAINING              
         BCTR  R2,0                BACK OFF 1 DAY                               
...
*                                                                               
         ...
         MVI   DLRS,0                                                           
         MVI   BYTE2,0                                                          
         MVI   LISTWOPS,0          INIT LISTO OPTIONS                           
         MVI   LISTOOPS,0          INIT LISTO OPTIONS                           
         MVI   LISTDOPS,0          INIT LISTO OPTIONS                           
         XC    NEXTBYTE,NEXTBYTE                                                
...
VALOP22  EQU   *                                                                
*                                                                               
*        CHECK FOR MAKEGOOD LISTS                                               
*                                                                               
         EX    R4,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'LISTO'                                             
         BNE   VALOPLON                                                         
*                                                                               
         MVI   LISTBYTE,LISTMKG    SET AS MKG LIST                              
         MVI   PFJUMP,4                                                         
*                                                                               
         LA    R3,32(R3)           BUMP TO NEXT SCANNED OBJECT                  
*                                                                               
VALOPLP  DS    0H                                                               
*                                                                               
         CLI   0(R3),0             DONE IF NO FURTHER OPTIONS                   
         BE    VALOPDN                                                          
*                                                                               
         LLC   RF,0(R3)            GET OPTION LENGTH                            
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'NEW'  LIST ONLY NEW     MKGS                       
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTONEW   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'DARE' LIST ONLY DARE    MKGS                       
         BNE   *+12                                                             
         MVI   LISTDOPS,LISTDDRE   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'-DARE' LIST ONLY NON DARE    MKGS                  
         BNE   *+12                                                             
         MVI   LISTDOPS,LISTDDRX   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
*        KEEP NEXT TWO BEFORE STAREV REPREV TESTS                               
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'REP' LIST ONLY MKGS CREATED BY REP                 
         BNE   *+12                                                             
         MVI   LISTWOPS,LISTWREP   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'STA' LIST ONLY MKGS CREATED BY STATION             
         BNE   *+12                                                             
         MVI   LISTWOPS,LISTWSTA   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'REV'  LIST ONLY REVISED MKGS                       
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTOREV   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'STAREV' LIST MKGS REVISED BY STATION               
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTOSRV   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'REPREV' LIST MKGS REVISED BY REP                   
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTORRV   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'APL' LIST ONLY APPLIED MKGS                        
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTOAPL   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'SELF' LIST ONLY SELF APPLIED MKGS                  
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTOSLF   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'REJ' LIST ONLY REJECTED MKGS                       
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTOREJ   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'CAN' LIST ONLY CANCELLED MKGS                      
         BNE   *+12                                                             
         MVI   LISTOOPS,LISTOCAN   SET OPTION                                   
         B     VALOPCN                                                          
*                                                                               
         B     VALOPNE             INVALID OPTION                               
*                                                                               
VALOPCN  DS    0H                                                               
*                                                                               
...
VALOP100 DS    0H                                                               
*                                                                               
         TM    VIEWS,X'01'+X'02'+X'08'+X'04'+X'10'                              
         BZ    VALOP102                                                         
*                                                                               
...
VALOP218 DS    0H                                                               
         EX    R4,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'RCU'  RCU CONTRACTS FILTER                         
         BNE   VALOP220                                                         
         CLI   1(R3),0             VALUE SET?                                   
         BNE   VALOPNE             YES - ERROR                                  
         TM    VIEWS,X'02'+X'10'   LISTD/LISTE OPTION ?                         
         BZ    VALOPNE             NO - ERROR                                   
*                                                                               
         OI    VIEWS3,X'10'                                                     
         B     VALOP300                                                         
...
VALOP220 DS    0H                                                               
         EX    R4,*+8                                                           
         B     *+10                                                             
         CLC   12(0,R3),=CL8'RCM'  RCM (MANUAL) CONTRACTS FILTER                
         BNE   VALOP222                                                         
         CLI   1(R3),0             VALUE SET?                                   
         BNE   VALOPNE             YES - ERROR                                  
         TM    VIEWS,X'02'+X'10'   LISTD/LISTE OPTION ?                         
...
*        PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'092RERIS01   12/16/13'                                      
         END                                                                    
