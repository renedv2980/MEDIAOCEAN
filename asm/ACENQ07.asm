*          DATA SET ACENQ07    AT LEVEL 087 AS OF 09/20/07                      
*PHASE T62007A                                                                  
***********************************************************************         
* THIS ATION WAS TURNED OFF ON JULY15/2005                            *         
* THIS BOOK IS NO LONGER IN USE                                       *         
***********************************************************************         
T62007   TITLE 'ACCOUNT ENQUIRY - RECEIVABLE'                                   
T62007   CSECT                                                                  
         PRINT NOGEN                                                            
         SPACE 1                                                                
         NMOD1 0,**ENQ7**,R5,R7,CLEAR=YES,RR=RE                                 
...
MAIN130  BAS   RE,ADDSRCE          DEAL WITH TOTAL AMOUNTS                      
         ...
         TM    RECVFLAG,SRCTOTQ    FIRST BILL FOR SOURCE?                       
         BZ    MAIN135                                                          
...
MAIN200  TM    TRNSTAT,TRNSDR      DEBIT?                                       
         BZ    MAIN210                                                          
         AP    OUTAMNT,0(L'TRNAMNT,RE) OUTSTANDING BILL AMOUNT                  
         B     MAIN220                                                          
MAIN210  SP    OUTAMNT,0(L'TRNAMNT,RE) SUBTRACT ANY PAYMENT                     
...
MAIN220  GOTO1 ANXTREC,NXTRMODE    RETURN NEXT RECORD                           
         ...
         B     MAINX                                                            
*                                                                               
MAIN230  CLC   TRNKCULA,ACNTKEY    RECORD BELONGS TO CORRECT ACCOUNT?           
         BE    MAIN60                                                           
...
*                                                                               
         ...
         MVI   RECVFLAG,0          CLEAR GENERAL FLAG                           
...
*                                                                               
         ...
         STC   R4,EAINPLEN         ACCOUNT ENTERED LENGTH                       
*                                                                               
         CLI   BASKEY,C'*'                                                      
         BNE   FSTD100                                                          
         CLI   BASKEY+1,C'S'                                                    
         ...
         CLI   BASKEY+2,C'R'                                                    
         BNE   FSTDERR                                                          
FSTD99   MVC   ENTERACC,BASKEY+1                                                
         AHI   R4,-3                                                            
         STC   R4,EAINPLEN         ACCOUNT ENTERED LENGTH                       
         B     FSTD101                                                          
*                                                                               
FSTD100  MVC   ENTERACC(L'SR),SR             RECEIVABLES                        
         MVC   ENTERACC+L'SR(L'ACTKACT),BASKEY                                  
FSTD101  GOTO1 VACSRCHC,DMCB,(4,BASKEYH),TWAD,(C'*',SR),ACOMFACS,(0,0)          
*                                 CHANGE COLUMN HEADINGS                        
         MVC   FVMSGNO,=AL2(EGIFMISS)                                           
         CHI   R4,0                 MAKE SURE SOMETHING'S THERE                 
         BNH   FSTDERR                                                          
         MVC   FVMSGNO,=AL2(EGIFLONG)                                           
         CLI   EAINPLEN,L'ACTKACT   ENSURE LENGTH NOT TOO LONG                  
         BH    FSTDERR                                                          
         GOTO1 AUNITLDG,ENTERACC   READ UNIT/LEDGER RECORDS                     
         BNE   FSTDERR                                                          
         MVC   UNILDG,ENTERACC     SAVE UNIT/LEDGER                             
*                                                                               
         ...
         MVC   ACTKEY,SPACES                                                    
         MVC   ACTKCPY,MYCO                                                     
         MVC   ACTKUNT(L'SR),ENTERACC                                           
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   ACTKACT(0),ENTERACC+2    SKIP U/L                                
...
*                                                                               
         ...
         CLC   SR,ENTERACC                  IF U/L SR SHOW SOURCE HEAD          
         BE    *+10                                                             
...
FSTD64   LA    R2,GRDDAT1H                                                      
         ...
         B     FSTD66                                                           
*                                                                               
FSTD65   GOTO1 ASCRNCLR,DISLINE                                                 
*                                                                               
         L     RF,ADISPFK                                                       
         BASR  RE,RF               DISPLAY PFKEY LINE                           
*                                                                               
FSTD66   GOTO1 AREADUP             READ UP FRONT FOR 2 CHAR OFF                 
         BNE   FSTDERR                                                          
*                                                                               
         LA    R2,BASOPTH          R2=A(OPTION SCREEN HEADER)                   
         ST    R2,FVADDR                                                        
...
*                                                                               
FILT20   TM    INTFLAG,NOTFSTQ     FIRST TRANSACTION?                           
         BO    FILT51                                                           
         ...
         BNE   FILTREJX                                                         
         B     FILT50                                                           
FILT30   CLI   OTYPEFI,NEGFILTR                                                 
         BE    FILTREJX                                                         
*                                                                               
FILT50   LA    R4,TRNRFST          R4=A(TRANSACTION ELEMENT)                    
         OC    ODUE,ODUE           OR FILTERING ON PAYMENT REFERENCE?           
         BZ    *+8                                                              
         OI    DUEFLAG,DUERQDQ     CHEQUE ELEMENT REQUIRED FLAG ON              
FILT51   OC    ODDATE,ODDATE       FILTERING ON DEPOSIT DATE?                   
         BNZ   FILT55                                                           
         OC    OPAYDATE,OPAYDATE   FILTERING ON PAYMENT DATE?                   
         BNZ   FILT55                                                           
         OC    OPAYREF,OPAYREF     OR FILTERING ON PAYMENT REFERENCE?           
         BZ    *+8                                                              
FILT55   OI    CHQFLAG,CHQRQDQ     CHEQUE ELEMENT REQUIRED FLAG ON              
...
FILT80   TM    TRNRSTAT,TRNSREVS   REVERSAL?                                    
         ...
         BE    FILTRJX2                                                         
         B     FILT85                                                           
FILT84   CLI   OREVERSE,C'O'                                                    
         BE    FILTRJX2                                                         
*                                                                               
FILT85   TM    INTFLAG,NOTFSTQ     FIRST TRANSACTION?                           
         BO    FILT60                                                           
...
FILT90   OI    OTHFLAG,OTHELEQ     OTHERS ELEMENT FOUND                         
         TM    INTFLAG,NOTFSTQ     FIRST TRANSACTION?                           
         BO    FILT60                                                           
...
FILT115  OC    ODUE,ODUE           FILTERING ON TRANSACTION DUE DATE?           
         BZ    FILT60                                                           
*        TM    INTFLAG,NOTFSTQ     FIRST TRANSACTION?                           
*        BO    FILT60                                                           
...
FILT116  TM    INTFLAG,NOTFSTQ     FIRST TRANSACTION?                           
         BO    FILT60                                                           
...
FILT117  CLI   RALTYPE,RALTALC                                                  
         ...
         BNE   FILTREJX                                                         
*                                                                               
FILT118  OC    OPAYDATE,OPAYDATE   FILTERING ON PAYMENT DATE?                   
         BZ    FILT119                                                          
         GOTO1 ADCOMP,DMCB,(L'RALADAT,RALADAT),OPAYDST,OPAYDEN,OPAYDFI          
         BNE   FILTREJX                                                         
*                                                                               
FILT119  OC    ODDATE,ODDATE       FILTERING ON DEPOSIT DATE?                   
         BZ    FILT119B                                                         
         GOTO1 ADCOMP,DMCB,(L'RALADEP,RALADEP),ODDATEST,ODDATEEN,      X        
               ODDATEFI                                                         
         BNE   FILTREJX                                                         
FILT119B OI    CHQFLAG,CHQELEQ     MATCHING CHQUE ELEMENT FOUND                 
         B     FILT60                                                           
         DROP  R4                                                               
*                                                                               
         USING FFTELD,R4           FREE FORM TEXT ELEMENT                       
FILT119A CLI   FFTTYPE,FFTTACUR    ASSOCIATED CURRENCY?                         
         BNE   FILT60                                                           
         ...
         DROP  R4                                                               
*                                                                               
FILT120  OC    OCURRYVL,OCURRYVL   CURRENCY CODE FILTER?                        
         BZ    FILT125                                                          
         ...
         BE    FILTREJX                                                         
         B     FILT125                                                          
FILT124  CLI   OCURRYFI,NEGFILTR   NEGATIVE FILTER?                             
         BNE   FILTREJX                                                         
*                                                                               
FILT125  TM    OTHFLAG,OTHRQDQ     IS OTHERS ELEMENT REQUIRED?                  
         BZ    FILT130                                                          
         TM    OTHFLAG,OTHELEQ     HAS OTHERS ELEMENT BEEN FOUND?               
         BZ    FILTREJX                                                         
*                                                                               
FILT130  LA    RF,TRNRFST          RF=A(TRANSACTION ELEMENT)                    
         ...
         BZ    FILTREJX                                                         
*                                                                               
FILT140  TM    DUEFLAG,DUERQDQ     IS DUE DATE ELEMENT REQUIRED?                
         BZ    FILTX                                                            
...
ADDT50   OI    RECVFLAG,SRCTOTQ    SWITCH ON SOURCE TOT REQUIRED                
*                                                                               
ADDTX    CR    RB,RB                                                            
         B     XIT                                                              
ADDTERRX LTR   RB,RB                                                            
...
XDETL140 CLI   SCITYPE,SCITCDSC    ALREADY DONE DISCOUNT                        
         ...
         CLC   SI,BASKEY                                                        
         BE    XDETL150                                                         
         CURED (P6,SCIAMNT),(L'UNSCNRHS,UNSCNRHS),0,ALIGN=LEFT,        X        
               MINUS=YES                                                        
         B     XDETL160                                                         
...
SRCET10  AP    0(L'ACCBILL1,R1),0(L'SRCEBIL1,RF) GET ACCOUNT TOTALS             
         ...
         BE    SRCETX                                                           
*                                                                               
         TM    RECVFLAG,SRCTOTQ    SOURCE TOTALS REQUIRED                       
         BZ    SRCETX                                                           
         NI    RECVFLAG,X'FF'-SRCTOTQ SWITCH OFF SOURCE TOT REQUIRED            
*                                                                               
...
*                                                                               
         TM    PCDRIVEN,PCGRIDQ                                                 
         BZ    *+14                                                             
         MVC   L'GRDDTE1(L'MX@ANDPR,R4),MX@ANDPR                                
         B     AGEX                                                             
         MVC   ENQDAT2H-ENQDAT1H(L'MX@ANDPR,R4),MX@ANDPR AND PRIOR              
         B     AGEX                                                             
*                                                                               
...
*                                                                               
         ...
         MVC   L'GRDDTE1(L'MX@ANDPR,R4),MX@ANDPR                                
         B     *+10                                                             
         MVC   ENQDAT2H-ENQDAT1H(L'MX@ANDPR,R4),MX@ANDPR                        
         B     AGE190                                                           
*                                                                               
...
GCTBL    DS    0F                                                               
*                                                                               
GCTCOL1  DC    AL1(GCT1LQ,91,L'MX@BLGSR,L'TSDCONT)      BILLING SOURCE          
         DC    AL2(MX@BLGSR-OVERWRKD,TSDCONT-TSARDATD)                          
         DC    AL1(GCTIOVER+GCTITOT,0,0,0)                                      
         DC    AL1(0,L'MX@ACCTS),AL2(MX@ACCTS-OVERWRKD)                         
         DC    C'SR'                                                            
GCT1LQ   EQU   *-GCTCOL1                                                        
*                                                                               
GCTCACC  DC    AL1(GCACCLQ,91,L'LC@CTRA,L'TSDCONT)      CONTRA ACCOUNT          
         DC    AL2(LC@CTRA-WORKD,TSDCONT-TSARDATD)                              
         DC    AL1(GCTITOT+GCTIXLDG,0,0,0)                                      
         DC    AL1(0,L'MX@ACCTS),AL2(MX@ACCTS-OVERWRKD)                         
         DC    C'SR'                                                            
GCACCLQ  EQU   *-GCTCACC                                                        
*                                                                               
GCT02    DC    AL1(GCT02LQ,02,L'MX@RSINO,L'TSDTREF)     BILL NUMBER             
         DC    AL2(MX@RSINO-OVERWRKD,TSDTREF-TSARDATD)                          
         DC    AL1(GCTIOVER,0,0,0)                                              
         DC    AL1(0,0,0,0)                                                     
GCT02LQ  EQU   *-GCT02                                                          
*                                                                               
GCTCOL3  DC    AL1(GCT3LQ,03,L'MX@RSBDT,1)             BILL DATE                
         DC    AL2(MX@RSBDT-OVERWRKD,TSDTDAT-TSARDATD)                          
         DC    AL1(GCTIOVER,0,GCTFDAT+GCTFRGHT,0)                               
         DC    AL1(0,0,0,0)                                                     
GCT3LQ   EQU   *-GCTCOL3                                                        
*                                                                               
GCTCOL4  DC    AL1(GCT4LQ,04,L'GRDDTES,L'TSDAMT1)       TRANS AMNT 1            
...
GCAMTOTQ EQU   20                                                               
*                                                                               
GCTPP    DC    AL1(GCTPPLQ,21,L'MX@PTYPD,L'TSDPAID)     PARTLY PAID             
         DC    AL2(MX@PTYPD-OVERWRKD,TSDPAID-TSARDATD)                          
         DC    AL1(GCTIOVER,0,0,0)                                              
         DC    AL1(0,0,0,0)                                                     
GCTPPLQ  EQU   *-GCTPP                                                          
*                                                                               
GCTACTD  DC    AL1(GACTLQ,30,L'MX@ACTYD,2)             ACTIVITY DATE            
         DC    AL2(MX@ACTYD-OVERWRKD,TSDACDAT-TSARDATD)                         
         DC    AL1(GCTIOVER,0,GCTFDAT+GCTFRGHT,0)                               
         DC    AL1(0,0,0,0)                                                     
GACTLQ   EQU   *-GCTACTD                                                        
*                                                                               
GCTDUED  DC    AL1(GDUELQ,31,L'MX@RSDUD,2)             DUE DATE                 
...
*                                                                               
GRDCONH  DS    CL15                CONTRA HEADING FOR GRIDS                     
...
ENTERACC DS    CL(L'TRNKULA)       KEY ENTERED + U/L AND - * (IF NEC)           
EAINPLEN DS    CL(L'FLDILEN)       LENGTH OF KEY ENTERED (ENTERACC)             
RECVFLAG DS    X                   RECV FLAG                                    
SRCTOTQ  EQU   1                   SOURCE TOTALS REQUIRED                       
...
OSSAVEX  DS    0H                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'087ACENQ07   09/20/07'                                      
         END                                                                    
