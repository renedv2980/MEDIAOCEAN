*          DATA SET RELDXDAR3  AT LEVEL 069 AS OF 09/05/18                      
...
* THIS EXTERN DOES THE OPPOSITE OF RELDXDAR2                                    
* - TMNY IS CHANGED TO TMNYBLD                                                  
* - LUNA IS CHANGED TO LUNABLD                                                  
* - POWER CODE IS CHANGED FROM TM TO QT                                         
* - AGENCY MEDIA CODE IS CHANGED FROM 41 TO 11                                  
* THIS EXTERN DOES THE OPPOSITE OF RELDXDAR2                                    
***********************************************************************         
*                                                                               
* PARAMETER LIST                                                                
...
*                                                                               
         ...
         GOTO1 VPRINTER                                                         
*                                                                               
         CLC   RDARSNDR,=CL10'LUNA'      ID OF SENDER                           
         BNE   DMXR010                                                          
         MVC   RDARSNDR,=CL10'LUNABLD'   CHANGE LUNABLD TO LUNA                 
         OI    MISCFLG1,MF1RCCHG                                                
DMXR010  CLC   RDARSNDR,=CL10'TMNY'                                             
         BNE   DMXR015                                                          
         MVC   RDARSNDR,=CL10'TMNYBLD'   CHANGE TMNYBLD TO TMNY                 
         OI    MISCFLG1,MF1RCCHG                                                
*                                                                               
DMXR015  CLC   RDARRCVR,=CL10'LUNA'      ID OF RECEIVER                         
         BNE   DMXR020                                                          
         MVC   RDARRCVR,=CL10'LUNABLD'   CHANGE LUNABLD TO LUNA                 
         OI    MISCFLG1,MF1RCCHG                                                
DMXR020  CLC   RDARRCVR,=CL10'TMNY'                                             
         BNE   DMXR030                                                          
         MVC   RDARRCVR,=CL10'TMNYBLD'   CHANGE TMNYBLD TO TMNY                 
         OI    MISCFLG1,MF1RCCHG                                                
*                                                                               
DMXR030  LA    R3,RDARRTS                RETURN TO SENDER INFO                  
         ...
         MVC   P(16),RDARRTS                                                    
         GOTO1 VPRINTER                                                         
         CLC   RTNPWRCD,=C'TM'           POWER CODE                             
         BNE   DMXR040                                                          
         MVC   RTNPWRCD,=C'QT'           CHANGE QT TO TM                        
         OI    MISCFLG1,MF1RCCHG                                                
*                                                                               
DMXR040  LA    R3,RDARRTS                RETURN TO SENDER INFO                  
         GOTO1 =V(HEXOUT),DMCB,RTNAGYMD,P,2                                     
         GOTO1 VPRINTER                                                         
         CLC   RTNAGYMD,=C'41'           AGENCY/MEDIA                           
         BNE   DMXR050                                                          
         MVC   RTNAGYMD,=C'11'           CHANGE 11 TO 41                        
         OI    MISCFLG1,MF1RCCHG                                                
         DROP  R3                                                               
*                                                                               
...
PLINEX   EQU   *-PLINED                                                         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'069RELDXDAR3 09/05/18'                                      
         END                                                                    
