*          DATA SET ACREPZR02  AT LEVEL 032 AS OF 08/16/00                      
*PHASE ACZR02A                                                                  
*INCLUDE ACRECTYP                                                               
*INCLUDE DECODE                                                                 
*INCLUDE HELEN                                                                  
...
OPTTAB   DS    0CL16                                                            
         ...
         DC    AL1(8),CL11'RECTYPE=   ',AL4(VRTY)                               
...
*                                                                               
VCNT     CLI   0(R4),C'N'           REPORT=N                                    
         BE    VOPTY                                                            
         CLI   0(R4),C'Y'           REPORT=Y                                    
         BNE   VOPTN                                                            
         OI    FILOPT,FILCNT                                                    
         B     VOPTY                                                            
*                                                                               
...
VRTY     L     R3,AIO1              RCVTYPE=XXX                                 
         ...
         BZ    VOPTN                                                            
         SR    R4,R4                                                            
         CLI   SCANRLN,3           MAX LENGTH OF 3                              
         BH    VOPTN                                                            
         L     RF,SCANRBV                                                       
         STC   RF,FLTRTYP                                                       
         OI    FILOPT,FILRCT       FILTER RECORD TYPE                           
         B     VOPTY                                                            
*                                                                               
...
*                                                                               
         ...
         BE    FLTRCV3                                                          
         MVC   BYTE,RCVRECTY                                                    
         NI    BYTE,TURNOFF-RCVRPTRQ                                            
         TM    RCVRECTY,RCVRPTRQ   POINTER ?                                    
         BZ    *+12                                                             
         TM    TYPE,TYPPTR                                                      
         BNO   XNO                                                              
         CLI   BYTE,RCVRCPYQ   COPY                                             
         BNE   *+12                                                             
         TM    TYPE,TYPCPY                                                      
         BNO   XNO                                                              
         CLI   BYTE,RCVRCHAQ   CHANGE                                           
         BNE   *+12                                                             
         TM    TYPE,TYPCHA                                                      
         BNO   XNO                                                              
         CLI   BYTE,RCVRADDQ   ADD                                              
         BNE   *+12                                                             
         TM    TYPE,TYPADD                                                      
         BNO   XNO                                                              
*                                                                               
...
COUNT00  NTR1  ,                                                                
         ...
         CLI   MODE,PROCRCVR       PROCESS A RECOVERY RECORD                    
         BE    COUNT50                                                          
         CLI   MODE,RUNFRST        PROCESS ACCTAPE OR RECOVERY TAPE             
         BE    COUNT50                                                          
         MVI   BYTE,X'FF'                                                       
         SR    R4,R4                                                            
         CLI   MODE,RUNLAST        PROCESS ACCTAPE OR RECOVERY TAPE             
         BNE   COUNTX                                                           
*                                                                               
COUNT50  GOTO1 ACLDDCNT,DMCB,(BYTE,(R4))                                        
*                                                                               
COUNTX   B     XIT                                                              
         EJECT                                                                  
***********************************************************************         
...
MAIN     NTR1  ,                                                                
         ...
         TM    FILOPT,FILRCT       FILTER RECORD TYPE                           
         BZ    MAIN10              NO                                           
         CLC   RECTYP,FLTRTYP                                                   
         BNE   MAIN10                                                           
         BAS   RE,PDMP1                                                         
...
*                                                                               
FLTRTYP  DS    XL1                 FILTER ON RECORD TYPE                        
*                                                                               
CARDIO   DS    CL80                                                             
*                                                                               
...
FILCNT   EQU   X'02'               RECORD COUNT OF ADDS                         
FILRCT   EQU   X'01'               FILTER RECORD TYPE                           
*                                                                               
...
* ACREPWORKD                                                                    
       ...
       ++INCLUDE ACREPWORKD                                                     
         PRINT  ON                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'032ACREPZR02 08/16/00'                                      
         END                                                                    
