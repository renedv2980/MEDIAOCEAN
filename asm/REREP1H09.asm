*          DATA SET REREP1H09  AT LEVEL 045 AS OF 05/01/02                      
*PHASE RE1H02C,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
*                                  CLEAR COUNTERS                               
         LA    RE,KEY                                                           
         XC    KEY,KEY                                                          
         MVI   KEY,X'12'           INSERT INV RECORD TYPE                       
...
*        GOTO1 REPORT                                                           
*   TEST END                                                                    
         CLC   KEY(12),KEYSAVE     SAME TYPE/REP?                               
         BNE   SW020400            NO  - FINISHED                               
         CLC   KEY+12(4),LASTSTAT  SAME STATION?                                
         BE    SW020050            YES -                                        
         BAS   RE,TOTALS           NO  - SHOW TOTALS                            
SW020050 EQU   *                                                                
...
RINVRECD DSECT                                                                  
       ++INCLUDE REGENINV                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045REREP1H09 05/01/02'                                      
         END                                                                    
