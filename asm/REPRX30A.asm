*          DATA SET REPRX30A   AT LEVEL 213 AS OF 10/02/00                      
*PHASE T81A30A                                                                  
*                                                                               
...
*                     (R2) IS INDEX FOR QTRS TAB, AND IS 1 LESS THAN            
         ...
         MVI   MYELCODE,RCUMOVEQ         OVERRIDE ELEMENT CODE                  
         BRAS  RE,GETEL                                                         
...
MKTHOOK  NTR1  BASE=*,LABEL=*                                                   
         L     RE,DB.DBAQUART                                                   
         CLC   DB.DBSELBK,=X'6402'    AFTER FEB 2000?                           
         BNL   MKTH02                 YES                                       
*                                                                               
         CLC   =X'17044C',2(RE)       USE M-SU 7A-1A                            
         BNE   MKTHX                                                            
         B     MKTH04                                                           
*                                                                               
MKTH02   DS    0H                                                               
         CLC   =X'170050',2(RE)       USE M-SU 6A-2A                            
         BNE   MKTHX                                                            
*                                                                               
MKTH04   DS    0H                                                               
...
*DEDEMFILE                                                                      
       ...
       ++INCLUDE DEDEMFILE                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'213REPRX30A  10/02/00'                                      
         END                                                                    
*                                                                               
