*          DATA SET TAREP56    AT LEVEL 003 AS OF 02/24/04                      
*PHASE T70356A                                                                  
...
GETSORT  NTR1                                                                   
         USING PRNTD,R3                                                         
*                                                                               
GET10    LA    R3,P                R3 = A(ADDRESS OF PRINT LINE)                
...
*                                                                               
         USING TLCMD,R4                                                         
         LA    R4,KEY              SEE IF DELETED INVOICE HAS                   
         XC    KEY,KEY             A TP-LEVEL COMMENT RECORD                    
         MVI   TLCMCD,TLCMCDQ                                                   
         MVC   TLCMAGY,SORTAGY                                                  
         MVI   TLCMTYP,TLCMTINV                                                 
         GOTO1 TINVCON,DMCB,SORTINV,TLCMINV,DATCON                              
         XC    TLCMINV,=6X'FF'                                                  
         MVI   TLCMLEV,TLCMTPC                                                  
         GOTO1 HIGH                                                             
...
GET20    BAS   RE,NEXTEL                                                        
         ...
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVC   PRNTAGY(0),TAXCCMNT                                              
         BAS   RE,PRINTIT                                                       
         B     GET20                                                            
         DROP  R4                                                               
*                                                                               
GET30    BAS   RE,PRINTIT          PRINT A BLANK LINE                           
         B     GET10                                                            
*                                                                               
...
* TAREPWORKD                                                                    
       ...
       ++INCLUDE TAREPWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003TAREP56   02/24/04'                                      
         END                                                                    
