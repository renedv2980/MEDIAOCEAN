*          DATA SET SPREPUP02U AT LEVEL 060 AS OF 02/13/04                      
*PHASE SPUP02UA                                                                 
*INCLUDE XSORT                                                                  
*INCLUDE PRNTBL                                                                 
*****************************************************************               
...
*                                                                               
*****************************************************************               
SPUP02U  TITLE 'SPREPUP02U - MULTI-AGENCY CABLE UPDATE'                         
SPUP02   CSECT                                                                  
         DS    8192C                                                            
         ORG   *-8192                                                           
         PRINT NOGEN                                                            
*                                  GOT 3 BASE REGISTERS                         
         NMOD1 0,SPUP02,R8,R7,RR=R3                                             
*                                                                               
...
NOMORE10 MVC   P(30),=CL30'NUMBER OF STATIONS ADDED: '                          
         ...
         EDIT  (P8,COUNTER2),(17,P2+30),ALIGN=LEFT,ZERO=NOBLANK                 
         MVC   P3(30),=CL30'NUMBER OF ADDRESSES ADDED: '                        
         EDIT  (P8,COUNTER3),(17,P3+30),ALIGN=LEFT,ZERO=NOBLANK                 
         MVC   P4(30),=CL30'NUMBER OF CABLE RECS ADDED: '                       
         EDIT  (P8,COUNTER4),(17,P4+30),ALIGN=LEFT,ZERO=NOBLANK                 
         MVC   P5(30),=CL30'NUMBER OF TRAFFICS ADDED: '                         
         EDIT  (P8,COUNTER5),(17,P5+30),ALIGN=LEFT,ZERO=NOBLANK                 
         GOTO1 REPORT                                                           
*                                                                               
...
*                                                                               
         ...
         B     PINFA400                                                         
*                                                                               
PINFA15  BAS   RE,SHWCBLST         YES, SHOW THE CABLE STATION                  
*                                                                               
...
*                                                                               
         MVC   PRVMRKT,SMKT                                                     
         CLI   SSYSDACT,X'FF'      DEACTIVATED ALREADY?                         
         BNE   PINFA115                                                         
         BAS   RE,DACTIVTD         YES, NO ACTIONS ALLOWED                      
         DROP  R6                                                               
*                                                                               
...
*                                                                               
         ...
         DROP  R6                                                               
*                                                                               
PINFA115 TM    ACTNFLG1,CDNTACTV   DEACTIVATE CABLE HEADEND?                    
         BZ    PINFA120                                                         
         TM    ACTNFLG1,CDNEWSYS                                                
         BNZ   PINFA120                                                         
         BAS   RE,DACTVATE         YES                                          
...
PINFA130 TM    ACTNFLG1,CDNETCHG+CDEXCLUS+CDSYSNAM+CDMSOINT+CDTPEADR            
         ...
         BZ    PINFA132                                                         
         BAS   RE,UPDSTATN         YES, UPDATE STATION RECORD                   
*                                                                               
         ...
         GOTO1 REPORT                                                           
*                                                                               
PINFA132 TM    ACTNFLG1,CDEXCLUS   EXCLUSITIVITY CHANGE                         
         BZ    PINFA134                                                         
         MVC   P+10(22),=CL22'CHANGING EXCLUSIVITY'                             
         GOTO1 REPORT                                                           
*                                                                               
PINFA134 TM    ACTNFLG1,CDSYSNAM   SYSTEM NAME CHANGE                           
         BZ    PINFA136                                                         
         MVC   P+10(20),=CL20'CHANGING SYSTEM NAME'                             
         GOTO1 REPORT                                                           
*                                                                               
PINFA136 TM    ACTNFLG2,CDEIXSTA   ELECTRONIC INVOICING CHANGE                  
         BZ    PINFA138                                                         
         MVC   P+10(29),=CL29'CHANGING ELECTRONIC INVOICING'                    
         GOTO1 REPORT                                                           
*                                                                               
PINFA138 TM    ACTNFLG1,CDTPEADR   ORDER DEADLINE CHANGE                        
         BZ    PINFA140                                                         
...
*                                                                               
         ...
         DROP  R6                                                               
*                                                                               
PINFS20  BAS   RE,SHWCBLST         SHOW THE CABLE STATION                       
*                                                                               
         BAS   RE,UPDSTATN                                                      
...
* NETWORK DATA                                                                  
*****                                                                           
PINFN00  BAS   RE,SETNTWRK         SET APPROPRIATE NETWORK BIT                  
         BE    PINFXIT                                                          
         BAS   RE,BADNTWRK                                                      
*                                                                               
PINFXIT  B     XIT                                                              
...
NSYS15   NI    BITFLAG2,X'FF'-B2ADDING                                          
         BAS   RE,MKSTATN                                                       
*****                                                                           
* PASSIVE STATION RECORD                                                        
*****                                                                           
NSYS20   MVC   NUMMRKT,AGYMKTNO    FOR THIS MARKET NUMBER                       
         BAS   RE,CKSTAPSV         PASSIVE STATION EXISTS?                      
         BE    NSYS25              YES                                          
         OI    BITFLAG2,B2ADDING   NO, ADD RECORD                               
         AP    COUNTER2,=P'1'                                                   
         B     *+8                                                              
NSYS25   NI    BITFLAG2,X'FF'-B2ADDING                                          
         BAS   RE,MKSTAPSV                                                      
*                                                                               
...
UPDADDRS NTR1                                                                   
         ...
         B     UADR20                                                           
*                                                                               
UADR10   L     R2,ADCURAGY                                                      
         USING AGYENTRY,R2                                                      
         CLC   =C'WI',AGYPOWCD     IS THIS WESTERN?                             
         BE    UADRX               YES, THEY DON'T WANT CHANGES TO ADDR         
         NI    BITFLAG2,X'FF'-B2ADDING                                          
UADR20   BAS   RE,MKSTAADD                                                      
*                                                                               
UADRX    B     XIT                                                              
*                                                                               
***********************************************************************         
...
*&&DO                                                                           
         CLC   PRVMRKT,NUMMRKT     SAME MARKET?                                 
         BE    USTAX               YES, SAME PASSIVE STATION RECORD             
*                                                                               
         BAS   RE,CKSTAPSV         NO, CHECK IF PASSIVE EXISTS                  
         BE    USTA30              YES, WRITE NEW PASSIVE TO RID DELETE         
         OI    BITFLAG2,B2ADDING   NO, ADD RECORD                               
         AP    COUNTER2,=P'1'                                                   
         B     *+8                                                              
USTA30   NI    BITFLAG2,X'FF'-B2ADDING                                          
         BAS   RE,MKSTAPSV                                                      
*                                                                               
         MVC   NUMMRKT,PRVMRKT     NOW DELETE OLD PASSIVE                       
         BAS   RE,CKSTAPSV                                                      
         BNE   USTAX                                                            
*                                                                               
         L     R6,AREC                                                          
         USING GENSTAD,R6                                                       
*                                                                               
         TM    SCNTL,X'80'         DELETED ALREADY?                             
         BNZ   USTAX               YES                                          
         OI    SCNTL,X'80'         NO, MARK THE RECORD FOR DELETION             
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(L'STAKEY),STAKEY                                             
*                                                                               
         GOTO1 MYTRACE,DMCB,AREC,20,                                   X        
               =CL21'DELETING PASSSIVE REC',21                                  
*                                                                               
         BAS   RE,STAWRT                                                        
         CLI   DMCB+8,0                                                         
         BE    *+6                                                              
...
*                                                                               
* ON EXIT:     NETWORKS            APPROPRIATE BIT FOR NETWORK IS SET           
***********************************************************************         
*                                                                               
SETNTWRK NTR1                                                                   
*****                                                                           
...
*****                                                                           
         L     R1,=A(NTWKCONV)     NETWORK CODE CONVERSION                      
*        LA    R1,NTWKCONV         NETWORK CODE CONVERSION                      
STNET05  CLI   0(R1),0             END OF TABLE?                                
         BE    STNET10                                                          
         CLC   IN_NWKCD,0(R1)                                                   
         BNE   *+14                                                             
         MVC   IN_NWKCD,4(R1)                                                   
...
* NON TOP 24                                                                    
         ...
         BZ    SHWC150                                                          
*                                                                               
SHWC60   LA    R3,WKCBLSEQ                                                      
         LA    RE,WKCBLSEQ+L'WKCBLSEQ                                           
         L     R4,ACABLTAB                                                      
*                                                                               
         OC    WKTOP24,WKTOP24                                                  
         BNZ   SHWC70                                                           
...
*                                                                               
         ...
         GOTO1 REPORT                                                           
*                                                                               
MKSTA13  TM    BITFLAG2,B2ADDING                                                
         BNZ   *+12                                                             
         TM    ACTNFLG1,CDSYSNAM                                                
         BZ    *+10                                                             
         MVC   SSYSNAME,IN_SYSNM                                                
*                                                                               
MKSTA14  TM    BITFLAG2,B2ADDING                                                
         BNZ   *+12                                                             
...
*                                                                               
         ...
         CLI   QOPT2,C'Y'                                                       
         BE    MKSTA18                                                          
         TM    ACTNFLG1,CDGRPCOD                                                
         BZ    *+10                                                             
MKSTA18  MVC   SGRPCD,=CL15'AMS'                                                
*                                                                               
...
MKSTA90  TM    ACTNFLG1,CDNEWSYS   ADDING THIS SYSTEM?                          
         ...
         BZ    MKSTA96             NO                                           
*                                                                               
MKSTA92  GOTO1 DATCON,DMCB,(5,0),(0,TODAYDTE)  OTHERWISE IT SHOULD BE           
         SR    R0,R0                                                            
MKSTA94  GOTO1 ADDAY,DMCB,TODAYDTE,TODAYDTE,1     3 BUS DAYS FROM TODAY         
...
CABLE10  DS    0H                                                               
         ...
         BNL   CABLE100                                                         
         CLC   0(2,R4),=XL2'0'                                                  
         BE    CABLE100            NO MORE CABLE SEQ TO BE ADDED                
*                                                                               
CABLE30  DS    0H                                                               
         CR    R5,R1                                                            
         BNL   CABLE40                                                          
...
*                                                                               
         TM    BITFLAG2,B2ADDING                                                
         BZ    *+10                                                             
         XC    0(CBLLNQ,R6),0(R6)  CLEAR THE RECORD FIRST IF ADDING             
*                                                                               
         MVI   CBLKTYPE,C'Y'                                                    
         MVI   CBLKMED,C'T'                                                     
         MVC   CBLKCALL,SVDHDEND                                                
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE CTGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'060SPREPUP02U02/13/04'                                      
         END                                                                    
