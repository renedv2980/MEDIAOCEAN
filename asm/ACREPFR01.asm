*          DATA SET ACREPFR01  AT LEVEL 011 AS OF 10/14/02                      
*PHASE ACFR01A                                                                  
...
*                                                                               
         ACDEF H10,107,CL28'---------M O N T H----------'                       
         ACDEF H11,109,CL27'SALARY       FINAL CHARGE '                         
         ACDEF H12,109,CL27'COSTS          FACTOR A   '                         
*                                                                               
         SPROG 8,9                                                              
         ACDEF H10,63,CL39'---------Y E A R  T O  D A T E---------'             
         ACDEF H11,63,CL39'PRD HRS     PRD HRS   ACTUAL     SALARY'             
         ACDEF H12,63,CL39'(GROUP)     (TOTAL)   --%---     COSTS '             
         ACDEF H10,105,CL28'-----MONTHLY ALLOCATION-----'                       
*                                                                               
         SPROG 9                                                                
         ACDEF H12,63,CL39'(*IND*)     (*ALL*)   --%---     COSTS '             
*                                                                               
         SPROG 6                                                                
         ACDEF H1,2,RUN                                                         
         ACDEF H1,112,PAGE                                                      
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011ACREPFR01 10/14/02'                                      
         END                                                                    
