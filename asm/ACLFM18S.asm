*          DATA SET ACLFM18S   AT LEVEL 051 AS OF 05/01/02                      
*PHASE T60318A,*                                                                
...
TOP2     MVC   LINCOUNT,DMCB+4     SAVE # OF ITEMS IN SCANBLK LINE              
         BAS   RE,CHKDUPLV         CHECK FOR REPEATING LEVEL                    
         BE    *+12                                                             
         MVI   ERROR,INVALID                                                    
         B     EXIT2                                                            
...
BADTYPE  DS    0H                  INVALID TYPE CHANGE                          
         ...
         EJECT                                                                  
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*         
* BUMP THROUGH SCANNER LINE AND CHECK FOR TWO LEVEL INDICATORS WITHOUT          
* ANY LIST CODES AFTER                                                          
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*         
*                                                                               
         USING SCAND,R4                                                         
CHKDUPLV NTR1                                                                   
*                                                                               
         NI    BIT,X'FF'-LEVELUSE                                               
         LA    R2,LOGLYN1H         R2 = A(1ST LIST DATA LYN).                   
*                                                                               
         LA    R4,SCANBLK                                                       
...
CHK20    CLI   SCLEN1,3            'LVL'                                        
         ...
         LTR   RB,RB                                                            
         B     CHKX                                                             
         OI    BIT,LEVELUSE        SET BIT THAT LEVEL IS THERE                  
         B     CHKNXT                                                           
*                                                                               
CHK30    NI    BIT,X'FF'-LEVELUSE                                               
*                                                                               
...
BIT      DS    XL1                                                              
LEVELUSE EQU   X'80'               USED TO CHECK FOR 2 LEVELS IN LIST           
         EJECT                                                                  
* ACLFMWORK                                                                     
         PRINT OFF                                                              
       ++INCLUDE ACLFMWORK                                                      
...
* DDCOMFACS                                                                     
       ...
       ++INCLUDE DDCOMFACS                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'051ACLFM18S  05/01/02'                                      
         END                                                                    
