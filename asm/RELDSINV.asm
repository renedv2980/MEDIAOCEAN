*          DATA SET RELDSINV   AT LEVEL 008 AS OF 05/01/02                      
*PHASE RELDSINV,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDSINV - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
* STRIP INVENTORY - OUTPUT TO ANOTHER REP                         *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
*                                                                               
         USING RINVREC,R3                                                       
         CLI   RINVKTYP,X'12'      INVENTORY                                    
         BNE   DMXPURGE                                                         
         CLC   RINVKREP,=C'CQ'     KATZ CONTINENTAL                             
         BNE   DMXREC20            NO  - CHECK AMERICAN                         
         CLC   =C'KBFXL',RINVKSTA  LOW-POWERED?                                 
         BE    DMXREC40            YES                                          
         CLC   =C'WICS1',RINVKSTA  SATELLITE?                                   
         BE    DMXREC40            YES                                          
         CLC   =C'WOI T',RINVKSTA  THREE LETTER?                                
         BE    DMXREC40            YES                                          
         CLC   =C'WLUK',RINVKSTA   GREEN BAY?                                   
         BE    DMXREC40            YES                                          
         CLC   =C'WBDC',RINVKSTA   GREEN BAY COMPETITIVE?                       
         BE    DMXREC40            YES                                          
         CLC   =C'WBAY',RINVKSTA   GREEN BAY COMPETITIVE?                       
         BE    DMXREC40            YES                                          
         CLC   =C'WFRV',RINVKSTA   GREEN BAY COMPETITIVE?                       
         BE    DMXREC40            YES                                          
         CLC   =C'WGBA',RINVKSTA   GREEN BAY COMPETITIVE?                       
         BE    DMXREC40            YES                                          
         B     DMXPURGE            NO  - DROP IT                                
DMXREC20 EQU   *                                                                
         CLC   RINVKREP,=C'AM'     KATZ AMERICAN                                
         BNE   DMXPURGE            NO  - DROP IT                                
         CLC   =C'WJLA',RINVKSTA   WASHINGTON, DC?                              
         BE    DMXREC40            YES                                          
         CLC   =C'WBDC',RINVKSTA   WASHINGTON COMPETITIVE?                      
         BE    DMXREC40            YES                                          
         CLC   =C'WDCA',RINVKSTA   WASHINGTON COMPETITIVE?                      
         BE    DMXREC40            YES                                          
         CLC   =C'WRC ',RINVKSTA   WASHINGTON COMPETITIVE?                      
         BE    DMXREC40            YES                                          
         CLC   =C'WTTG',RINVKSTA   WASHINGTON COMPETITIVE?                      
         BE    DMXREC40            YES                                          
         CLC   =C'WUSA',RINVKSTA   WASHINGTON COMPETITIVE?                      
         BE    DMXREC40            YES                                          
         B     DMXPURGE            NO  - DROP IT                                
DMXREC40 EQU   *                                                                
         OC    RINVKBK(2),RINVKBK  ANY INVENTORY OR RATIONALE NUMBER?           
         BZ    DMXREC80            NO  - ACCEPT THE RECORD                      
         CLI   RINVKSRC,X'FF'      YES - RATIONALE RECORD?                      
         BE    DMXREC80            YES - ACCEPT THE RECORD                      
         CLC   =X'610B',RINVKBK    NO  - INVENTORY PRE OCT 97?                  
         BL    DMXPURGE            YES - SKIP IT                                
DMXREC80 EQU   *                                                                
         MVC   RINVKREP,=C'B3'     SET TO EJOR OUTPUT                           
***      MVC   RINVKREP,=C'B4'     SET TO ROB  OUTPUT                           
         B     DMXKEEP             SEND TO OUTPUT                               
         DROP  R3                                                               
         EJECT                                                                  
*******************************************************************             
* END-OF-FILE LOGIC                                               *             
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008RELDSINV  05/01/02'                                      
         END                                                                    
