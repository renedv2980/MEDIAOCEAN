*          DATA SET RENRG02    AT LEVEL 137 AS OF 06/03/02                      
*PHASE T81502A                                                                  
...
* JAN05/01 (BG )114 FIX COMPANY BUDGETS FOR LIST                      *         
* MAR20/01 (BU )    ADD J0/DEDICATED RADIO TO COMBREPS TABLE          *         
* SEP25/01 (BU )    ADD WC/WEST SIDE RADIO TO COMBREPS TABLE          *         
* mar11/02 (HQ )    FIX GROUP SET AND L=OFF, L=STA BUG                *         
*                                                                     *         
*                                                                     *         
...
VKEY0480 CLI   0(R1),0             END OF TYPES                                 
         ...
         SPACE                                                                  
         CLC   ROKHD2TY,=AL1(QLGRP,QLOFF,0)                                     
         BE    VKEY0500            TEMP FIX, HQIU                               
...
LREC0142 LH    R1,2(RF)                                                         
         ...
         BE    LREC0160            YES -                                        
**       CLI   LSTTYPE,QLGRP       GROUP  LISTING?                              
**       BE    LREC0160            YES -  BREAK OUT BY GROUP                    
         B     LREC0200            NO                                           
LREC0143 EQU   *                                                                
         MVI   TRCTYPE,X'43'                                                    
         GOTO1 =A(TRACE),RR=RELO                                                
...
LREC0150 EQU   *                                                                
         ...
         GOTO1 =A(TRACE),RR=RELO                                                
         CLI   LSTTYPE,QLOFF       OFFICE LISTING?                              
         BE    LREC0153            YES - DON'T TEST HIGH FOR OFFICE             
LREC0152 EQU   *                                                                
         MVI   TRCTYPE,X'46'                                                    
         GOTO1 =A(TRACE),RR=RELO                                                
...
LREC0210 ZIC   R1,LSTDISP                                                       
         ...
         SPACE                                                                  
LREC0220 GOTO1 =A(LRTOTAL),RR=RELO TOTAL ALL THE MONTHS                         
         BNE   LREC0110            NO RECORDS FOUND                             
         SPACE                                                                  
**                                                                              
*   TEST                                                                        
**       CLI   OFFLINE,C'Y'        OFFLINE                                      
*        BNE   TEND0010            NO  - NO DISPLAY                             
*        ST    R1,SVR1A            SAVE R1                                      
*        ST    R3,SVR3A            SAVE R3                                      
*        ST    RF,SVRFA            SAVE RF                                      
*        L     R3,ASPOOLD                                                       
...
*        MVC   P,SPACES                                                         
*        MVC   P+1(5),=C'C220:'                                                 
*        GOTO1 HEXOUT,DMCB,SET1CDE,P+06,1,0,0                                   
*        GOTO1 SPOOL,DMCB,(R3)                                                  
*        DROP  R3                                                               
*        L     R1,SVR1A            RESET R1                                     
*        L     R3,SVR3A            RESET R3                                     
...
**                                                                              
         CLI   SET1CDE,0           USING SETS AS FILTERS                        
         BE    LREC0230             NO                                          
*THE FOLLOWING TWO BRANCH ARE TO FIX THE BUG WHERE GROUP SET                    
*WITH L=OFF, L=STA RETURNS UNFAVORABLE RESULT, 03/07/02, HQIU                   
         CLI   LSTTYPE,QLOFF       OFFICE LISTING?                              
         BE    LREC0230            YES -                                        
         CLI   LSTTYPE,QLSTA       STATION LISTING?                             
         BE    LREC0230            YES -                                        
         CLI   LSTTYPE,QLGRP       GROUP LISTING?                               
         BE    LREC0230            YES -                                        
...
*                                                                               
         ...
         BE    LREC0235             NO                                          
         SPACE                                                                  
         XC    ELEM,ELEM                   FIRST BYTE TAKEN FOR SORT            
         MVC   ELEM+1(4),TOTALS+4          CURR BILLING                         
         CLI   TOPTYPE,C'C'                                                     
         BE    LREC0231                                                         
         SPACE                                                                  
         MVC   ELEM+1(4),TOTALS            PRIOR BILLING                        
         CLI   TOPTYPE,C'P'                                                     
         BE    LREC0231                                                         
         SPACE                                                                  
         MVC   ELEM+1(4),TOTALS+8          PRIOR FINAL                          
         CLI   TOPTYPE,C'F'                                                     
         BE    LREC0231                                                         
         SPACE                                                                  
         MVC   ELEM+1(4),TOTALS+12         BUDGET                               
         CLI   TOPTYPE,C'B'                                                     
         BE    LREC0231                                                         
         DC    H'0'                                                             
         SPACE                                                                  
*                                     FOR SORTING PURPOSE (TOP N)               
LREC0231 EQU   *                      WE READ TSAR REC BACKWARD                 
         MVI   ELEM,X'FF'             POSITIVE NUMBER HAS X'FF' FRONT           
         TM    ELEM+1,X'80'           THIS A MINUS AMOUNT                       
         BZ    *+8                                                              
         MVI   ELEM,X'00'             NEGATIVE NUMBER HAS X'00' FRONT           
         OC    ELEM+1(4),ELEM+1       ZERO                                      
         BZ    LREC0250               YES, BYPASS                               
         SPACE                                                                  
         MVC   ELEM+5(24),KEYSAVE+6   KEY VALUES                                
         MVC   ELEM+29(24),TOTALS                                               
         MVC   ELEM+53(1),SVKEY+31    FIRST MONTH FOUND                         
         SPACE                                                                  
         LA    R2,TSARBLK                                                       
         USING TSARD,R2                                                         
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         CLC   WORK(5),ELEM         COMPARE LOWEST TO NEW                       
...
LREC0234 MVI   TSACTN,TSAADD                                                    
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         ICM   R1,15,ELEM+1        BUT FORCE 1 HIGHER AND TRY AGAIN             
         LA    R1,1(,R1)                                                        
         STCM  R1,15,ELEM+1                                                     
         B     LREC0234                                                         
         DROP  R2                                                               
...
LREC0236 DS   0H                                                                
         ...
         BNZ   LREC0237                                                         
*                                                                               
*   totals+16/20 = refresh values, possibly                                     
*                                                                               
...
* SET FOR TSAR RETRIEVE                                                         
         ...
         DC    H'0'                                                             
*                                                                               
         MVC   SVKEY+6(24),ELEM+5                                               
         MVC   SVKEY+31(1),ELEM+53       MONTH                                  
         MVC   TOTALS(24),ELEM+29                                               
*        MVC   TOTALS+8(2),TSRNUM  *TEST                                        
         ZIC   RE,LSTDISP                                                       
         AHI   RE,-6               SUBTRACT 6                                   
         LA    R1,ELEM+5(RE)                                                    
         MVC   LSTVAL,0(R1)                                                     
...
*                                                                               
         ...
         STC   R0,FULL                                                          
         SPACE                                                                  
VK0564   GOTO1 DATCON,DMCB,(3,FULL),(0,WORK)                                    
         SPACE                                                                  
...
*   TEST                                                                        
         ...
         SR    R0,R0               SET CC = ZERO FOR EXIT                       
         B     VK0599                                                           
VK0574   EQU   *                                                                
**                                                                              
*   TEST                                                                        
*        CLI   OFFLINE,C'Y'        OFFLINE                                      
*        BNE   TEND0210            NO  - NO DISPLAY                             
*        ST    R1,SVR1X            SAVE R1                                      
*        ST    R3,SVR3X            SAVE R3                                      
*        ST    RF,SVRFX            SAVE RF                                      
*        L     R3,ASPOOLD                                                       
...
*        DC    H'0'                                                             
         ...
         BE    LT020                                                            
         CLI   SET1CDE,0           USING SETS AS FILTERS?                       
         BE    LT900               NO  - EXIT WITH NO DATA                      
         OC    TOTALS(24),TOTALS   YES - ANY VALUES FOR SETS?                   
         BNZ   LT999               YES - EXIT WITH DATA FOUND                   
         B     LT900               NO  - EXIT WITH NO DATA                      
*                                                                               
LT040    EQU   *                                                                
         MVI   TRCTYPE,X'1D'                                                    
         GOTO1 =A(TRACE),RR=RELO                                                
         CLC   ROKDTLYM,QSTART     CHECK MON AGAINST START MON                  
...
**       MVI   TRCTYPE,X'1F'                                                    
**       GOTO1 =A(TRACE),RR=RELO                                                
         LTR   RB,RB               CC NE - NO RECORDS FOUND                     
         B     LTX                                                              
*                                                                               
LT999    EQU   *                                                                
         MVI   TRCTYPE,X'0E'                                                    
...
*                                                                               
         ...
         MVI   SBSTATN+4,C' '                                                   
         SPACE                                                                  
CKSEC10  MVC   SBOWNER(L'RRGOWN),RRGOWN                                         
         MVC   SBMARKET,RRGMKT                                                  
         MVC   SBREGION,RRGREG                                                  
*        MVC   SBSALES,RRGSAL                                                   
         MVC   SBBREAKS,SECBRK                                                  
         MVC   SBREPCDE,AGENCY                                                  
*                                                                               
         OC    SBSALES,SBSALES     ALREADY HAVE A SALESMAN FILTER?              
         BNZ   CKSEC20             YES - SKIP TEAM FILTERING                    
         OC    QTEAM,QTEAM         TEAM FILTER?                                 
         BZ    CKSEC20             NO                                           
         MVI   SBSALES,X'FF'       TEAM DESIGNATION                             
         MVC   SBSALES+1(2),QTEAM  PASS TEAM IN SALESMAN FIELD                  
*                                                                               
CKSEC20  DS    0H                                                               
         XC    DMCB(24),DMCB                                                    
*                                  ESTABLISH A(REPFACS)                         
...
*                                                                               
         LA    R2,RRGGRPH                                                       
         GOTOX (RFCKSEC,DMCB+16),DMCB,(R3),CONHEADH,0,RFBLOCK                   
         BNE   SECERR                                                           
         SPACE                                                                  
         MVI   BYTE,0                                                           
         B     CKSEC200                                                         
...
* KATZ REPS ADDED                                                               
         ...
         DC    CL2'J0'             DEDICATED     (KATZ RADIO)                   
         DC    CL2'WC'             WEST SIDE     (KATZ RADIO)                   
*                                                                               
         DC    X'00'                                                            
         LTORG                                                                  
         EJECT                                                                  
...
LMON0030 DS   0H                                                                
         ...
         SPACE                                                                  
         BAS   RE,CSETX            CK IF DONE, OR NEXT SET                      
...
* CHECK IF KEY CHANGE IS END, OR NEEDS NEXT SET MEMBER *                        
         SPACE                                                                  
***>>>   ORIGINAL CSETX ROUTINE                                                 
*          DATA SET RENRG02    AT LEVEL 115 AS OF 02/22/01                      
         SPACE                                                                  
CSETX    NMOD1 0,*CSETX**                                                       
         L     RC,SVRC             RESET A(WORKAREA)                            
         USING GEND,RC                                                          
         SPACE                                                                  
CSETX010 CLC   KEY(ROKDTLVL-ROKEY),KEYSAVE  TEST CORRECT RECORD TYPE            
         BNE   CSETXX                        NO, AT END                         
         SPACE                                                                  
         ...
         BNE   CSETXX               YES, GO DISPLAY IT                          
         SPACE                                                                  
CSETX014 LA    R2,KEY+3                                                         
         LA    R3,KEY+6                                                         
...
CSETX020 LA    R0,3                                                             
         ...
         AHI   RF,SET1TAB-SYSD                                                  
         SPACE                                                                  
CSETX030 CLC   0(1,R2),0(R1)       THIS A SET CODE                              
         BE    CSETX060                                                         
         LA    R1,L'SETCDE(,R1)                                                 
         LA    RF,L'SET1TAB(,RF)                                                
         BCT   R0,CSETX030                                                      
...
CSETX032 CLI   0(RF),0                                                          
         ...
         B     CSETX032                                                         
         SPACE                                                                  
CSETX034 CLI   0(R2),QLSTA         ON STATION                                   
         BNE   CSETX040                                                         
         ...
         SPACE                                                                  
CSETX036 CLC   0(7,R3),0(R1)       THIS STA TO COMBO TABLE                      
         BE    CSETX050                                                         
         BL    CSETX038                                                         
         LA    R1,7(,R1)                                                        
         OC    0(7,R1),0(R1)       END OF TABLE                                 
         BNZ   CSETX036                                                         
         B     CSETXNE             END OF LIST                                  
         SPACE                                                                  
CSETX038 MVC   0(7,R3),0(R1)                                                    
...
CSETX040 LH    R1,2(RF)                                                         
         ...
         ZIC   RE,1(RF)                                                         
         BCTR  RE,0                                                             
         EX    RE,CSETXCLS         TEST FILTER IS SET (COMP TO SPACES)          
         BH    *+6                                                              
         DC    H'0'                                                             
         SPACE                                                                  
         CLI   BYTE,0              FOUND SET YET                                
         BNE   CSETX046             YES                                         
         EX    RE,CSETXCL1         CK CHANGE IN NON-SET KEY                     
         BNE   CSETXX               YES, DONE                                   
         B     CSETX050                                                         
         SPACE                                                                  
CSETX046 EX    RE,CSETXCL1         CHANGE IN NON-SET FILTER                     
         BE    CSETX050                                                         
         BL    CSETX048                                                         
         SPACE                                                                  
*        NEED TO JUMP PREVIOUS SET TO NEXT ENTRY                                
         ...
         BNE   CSETXNE                                                          
         LM    R2,R3,DUB                                                        
         B     CSETX250            GO SET FOLLOWING KEYS                        
         SPACE                                                                  
CSETXCL1 CLC   0(0,R3),0(R1)                                                    
CSETXCLS CLC   0(0,R1),BLANKS                                                   
         SPACE                                                                  
CSETX048 EX    RE,CSETXMF          MOVE IN FILTER                               
         SPACE                                                                  
         XC    ROKDTLYM-ROKEY+KEY,ROKDTLYM-ROKEY+KEY                            
         SPACE                                                                  
CSETX050 LA    R2,1(,R2)                                                        
         ...
         BE    CSETX300                                                         
         B     CSETX020            CHECK NEXT FIELD                             
         SPACE                                                                  
CSETXMF  MVC   0(0,R3),0(R1)                                                    
         EJECT                                                                  
* CHECK SETS HERE                                                               
         SPACE                                                                  
CSETX060 LR    R4,R1                                                            
         ...
         SPACE                                                                  
CSETX090 CLI   0(R5),0             END OF TABLE                                 
         BNE   CSETX100             NO                                          
         SPACE                                                                  
...
CSETX096 DS   0H                                                                
         ...
         B     CSETX250            GO SET FOLLOWING KEYS                        
         SPACE                                                                  
CSETX100 CLI   0(R2),QLSTA         STATION COMPARE IS DIFFERENT                 
         BNE   CSETX120                                                         
...
CSETX104 CLC   ACTUAL,3(R5)                                                     
         ...
         B     CSETX140                                                         
         SPACE                                                                  
CSETX120 EX    R6,CSETXCL2         SEE IF A MATCH                               
         SPACE                                                                  
CSETX140 BE    CSETX150                                                         
         BL    CSETX200                                                         
         LA    R5,1(R5,R6)                                                      
         B     CSETX090                                                         
         SPACE                                                                  
CSETX150 DS   0H                                                                
         TM    SET1FLG-SET1CDE(R4),X'08'  EXCLUDE SET                           
         BO    CSETX160                    YES, BYPASS                          
         SPACE                                                                  
CSETX154 MVI   BYTE,1              INDICATE SET WAS FOUND                       
         B     CSETX050                                                         
         SPACE                                                                  
CSETX160 MVI   7(R3),X'FF'         FORCE TO NEXT ITEM                           
         B     CSETX250            GO SET REST OF FIELDS                        
         SPACE                                                                  
CSETXCL2 CLC   0(0,R3),0(R5)                                                    
         SPACE                                                                  
CSETX200 TM    SET1FLG-SET1CDE(R4),X'08'  EXCLUDE SET                           
         BO    CSETX154                                                         
         SPACE                                                                  
         EX    R6,CSETXMVC                                                      
         SPACE                                                                  
         ...
         B     CSETX250                                                         
         SPACE                                                                  
CSETX220 MVI   2(R1),C'M'                                                       
         B     CSETX250                                                         
         SPACE                                                                  
CSETX230 CLI   0(R2),QLCON         CONTRACT TYPE IS DIFFERENT                   
         BNE   CSETX250                                                         
         OI    1(R3),X'40'                                                      
         B     CSETX250                                                         
         SPACE                                                                  
CSETXMVC MVC   0(0,R3),0(R5)                                                    
         SPACE                                                                  
CSETX250 LA    R2,1(,R2)                                                        
         LA    R3,8(,R3)                                                        
         LA    R0,KEY+5                                                         
         ...
         CLI   0(R2),0                                                          
         BE    CSETX300                                                         
CSETX260 BAS   RE,SETD             GO SET THIS TO FIRST ENTRY                   
         B     CSETX250                                                         
         SPACE                                                                  
* NOW READ NEXT SET OF KEYS                                                     
         SPACE                                                                  
CSETX300 CLI   ROKDTLYM-ROKEY+KEY,X'FF'                                         
         BE    *+10                                                             
         XC    ROKDTLYM-ROKEY+KEY,ROKDTLYM-ROKEY+KEY                            
         SPACE                                                                  
         MVC   KEYSAVE,KEY                                                      
...
CSETM    NMOD1 0,*CSETM**                                                       
         ...
         SPACE                                                                  
CSETM010 EQU   *                                                                
         MVI   EXCLUDIT,C'N'       SET EXCLUDE FLAG 'OFF'                       
**                                                                              
*   TEST                                                                        
*        CLI   OFFLINE,C'Y'        OFFLINE                                      
*        BNE   TEND0030            NO  - NO DISPLAY                             
*        L     R3,ASPOOLD                                                       
*        USING SPOOLD,R3                                                        
*        MVC   P,SPACES                                                         
*        MVC   P+1(7),=C'CSET010'                                               
*        MVC   P+10(08),=C'LSTTYPE='                                            
*        MVC   P+18(1),LSTTYPE                                                  
*        MVC   P+20(05),=C'KEY+3'                                               
*        MVC   P+25(1),KEY+3                                                    
*        GOTO1 SPOOL,DMCB,(R3)                                                  
...
*        MVC   P+1(7),=C'KEYSAVE'                                               
*        MVC   P+23(3),KEYSAVE                                                  
*        GOTO1 HEXOUT,DMCB,KEYSAVE+3,P+27,3,0,0                                 
...
*        MVC   P+1(5),=C'C030:'                                                 
*        MVC   P+06(03),=C'R2='                                                 
*        GOTO1 HEXOUT,DMCB,0(R2),P+10,1,0,0                                     
*        MVC   P+18(03),=C'R1='                                                 
*        L     R6,SVR1                                                          
*        GOTO1 HEXOUT,DMCB,0(R6),P+22,1,0,0                                     
*        GOTO1 SPOOL,DMCB,(R3)                                                  
*        DROP  R3                                                               
*        L     R1,SVR1             RESET R1                                     
*        L     R3,SVR3             RESET R3                                     
...
*   TEST                                                                        
**                                                                              
         CLC   0(1,R2),0(R1)       THIS A SET CODE                              
         BE    CSETM060                                                         
         LA    R1,L'SETCDE(,R1)                                                 
         LA    RF,L'SET1TAB(,RF)                                                
         BCT   R0,CSETM030                                                      
...
*        USING SPOOLD,R3                                                        
*        MVC   P,SPACES                                                         
*        MVC   P+1(10),=C'C050: NEXT'                                           
*        GOTO1 HEXOUT,DMCB,0(R2),P+17,1,0,0                                     
*        CLC   DUB,SPACES                                                       
*        BNH   TEST1020                                                         
*        MVC   P+20(8),DUB                                                      
*        B     TEST1040                                                         
*EST1020 EQU   *                                                                
*        GOTO1 HEXOUT,DMCB,DUB,P+20,8,0,0                                       
*EST1040 EQU   *                                                                
*        GOTO1 SPOOL,DMCB,(R3)                                                  
*        DROP  R3                                                               
*        L     R1,SVR1             RESET R1                                     
...
*   TEST                                                                        
**                                                                              
         CLI   0(R2),QLSTA         STATION COMPARE IS DIFFERENT                 
         BNE   CSETM120                                                         
         CLC   0(3,R3),0(R5)       1ST 3 OF STATION                             
         BNE   CSETM140                                                         
         SPACE                                                                  
...
*   TEST                                                                        
*        CLI   OFFLINE,C'Y'        OFFLINE                                      
*        BNE   TEND0130            NO  - NO DISPLAY                             
*        MVC   DUB,0(R3)           SAVE COMPARE FIELD                           
*        ST    R1,SVR1             SAVE R1                                      
*        ST    R3,SVR3             SAVE R3                                      
*        ST    RF,SVRF             SAVE RF                                      
*        L     R3,ASPOOLD                                                       
...
*        MVC   P+1(5),=C'C150:'                                                 
**       MVC   P+06(06),=C'PSEQEQ'                                              
*        EDIT (1,SET1FLG-SET1CDE(R4)),(1,P+6),ZERO=NOBLANK                      
**       MVC   P+6(1),SET1FLG-SET1CDE(R4)                                       
*        GOTO1 SPOOL,DMCB,(R3)                                                  
*        DROP  R3                                                               
*        L     R1,SVR1             RESET R1                                     
*        L     R3,SVR3             RESET R3                                     
...
CSETM160 MVI   7(R3),X'FF'         FORCE TO NEXT ITEM                           
         MVI   EXCLUDIT,C'Y'       SET EXCLUDE FLAG 'ON'                        
...
*        MVC   P,SPACES                                                         
*        MVC   P+1(5),=C'SETS='                                                 
*        GOTO1 HEXOUT,DMCB,SETCDE,P+6,10,0,0                                    
*        GOTO1 SPOOL,DMCB,(R3)                                                  
*        DROP  R3                                                               
*        L     R1,SVR1             RESET R1                                     
*        L     R3,SVR3             RESET R3                                     
...
*   TEST                                                                        
**                                                                              
*   KEY TESTING HAS BEEN INCORRECT BECAUSE IT DIDN'T TAKE INTO                  
*        CONSIDERATION SETS WITHIN BREAK TESTING.  IF AN ITEM IS                
*        ACCEPTED AS A RESULT OF PARTICIPATING IN A SET, THE KEY                
*        OF THAT ITEM WILL BE DIFFERENT THAN THE PRECEDING KEY BY               
*        THE PORTION OF THE KEY REPRESENTED BY THE SET VALUE IN THE             
*        KEY.  ONCE ACCEPTED AS PART OF THE SET, THE KEY TESTING                
*        MUST REMOVE THE SET VALUE FROM THE COMPARISON.  THE 'SETCDE'           
*        TABLE DETAILS THE KEY TYPES WHICH ARE SETS, BUT THIS IS NOT            
*        POSITIONAL.  THE POSITION OF THE SET VALUE WITHIN THE RECORD           
*        MUST BE DETERMINED, AND THE VALUE NULLED.  AFTER THE TEST,             
*        THE ORIGINAL KEYS MUST BE RESTORED.                                    
*                                                                               
         MVC   KEY2,KEY            SAVE ORIGINAL KEY                            
         MVC   KEYSAVE2,KEYSAVE                                                 
*                                                                               
         ST    R1,SVR1             SAVE R1                                      
         ST    R3,SVR3             SAVE R3                                      
         LA    R1,SETCDE                                                        
         LA    R5,3                MAX OF THREE SET TYPES                       
CSETM305 EQU   *                                                                
         LA    R0,3                MAX OF THREE KEY TYPES                       
         LA    RE,0                CLEAR RE AS COUNTER ZERO RELATIVE            
         LA    R3,KEY+3            SET 1ST OF THREE KEYS                        
CSETM310 EQU   *                                                                
         CLI   0(R1),0             SET CODE = ZERO?                             
         BE    CSETM318            YES - NO MORE                                
         CLC   0(1,R1),0(R3)       SETCDE CODE VS RECORD FIELD TYPE             
         BE    CSETM315            FOUND                                        
         LA    R3,1(R3)            BUMP TO NEXT KEY TYPE                        
         LA    RE,1(RE)            INCREMENT FIELD COUNTER                      
         BCT   R0,CSETM310         GO BACK FOR NEXT FIELD                       
         LA    R1,1(R1)            BUMP TO NEXT ENTRY                           
         BCT   R5,CSETM305                                                      
         B     CSETM318            THIS SHOULDN'T HAPPEN                        
CSETM315 EQU   *                                                                
         SLL   RE,3                MULTIPLY COUNTER BY 8                        
         LA    R6,KEY+ROKDTLVL-ROKEY                                            
*                                  SET A(FIRST FIELD IN RECORD KEY)             
         AR    R6,RE               ADD DISPLACEMENT                             
         XC    0(8,R6),0(R6)       CLEAR THIS PORTION OF KEY                    
         LA    R6,KEYSAVE+ROKDTLVL-ROKEY                                        
*                                  SET A(FIRST FIELD IN RECORD KEY)             
         AR    R6,RE               ADD DISPLACEMENT                             
         XC    0(8,R6),0(R6)       CLEAR THIS PORTION OF KEY                    
         LA    R1,3(R1)            BUMP TO NEXT SET IN SETCDE                   
         B     CSETM305            CHECK NEXT SET                               
CSETM318 EQU   *                                                                
**                                                                              
*   TEST                                                                        
*        CLI   OFFLINE,C'Y'        OFFLINE                                      
*        BNE   TEND0180            NO  - NO DISPLAY                             
*        ST    R1,SVR1             SAVE R1                                      
*        ST    R3,SVR3             SAVE R3                                      
*        ST    RF,SVRF             SAVE RF                                      
*        L     R3,ASPOOLD                                                       
...
*                                  SAME KEY?                                    
         BNE   CSETM500            NO                                           
         MVC   KEY,KEY2            RESET KEY                                    
         MVC   KEYSAVE,KEYSAVE2                                                 
         CLI   EXCLUDIT,C'Y'       EXCLUDE FLAG = 'ON'?                         
         BE    CSETM010            YES - GO BACK AND PROCESS NEXT ITEM          
         B     CSETMEQ             NO  - GET OUT AND PROCESS DATA               
CSETM500 EQU   *                                                                
         MVC   KEY,KEY2            RESET KEY                                    
         MVC   KEYSAVE,KEYSAVE2                                                 
         B     CSETMNE                                                          
...
*                                                                               
*   this is the location at which the information passed down thru              
*        the refresh is saved.  the data is only saved as three                 
*        bytes, which truncates the total value, and, if the high               
*        order bit is on, further distorts the final value.                     
*                                                                               
         MVC   0(3,R1),17(R6)      SAVE BOOKED                                  
         CLI   16(R6),0            ANY HIGH-BYTE VALUE?                         
         BZ    DPRN0085            NO  - USE FIGURE AS ENTERED                  
         MVC   0(3,R1),=X'FFFFFF'  YES - SET TO FLAG INDICATOR                  
DPRN0085 EQU   *                                                                
         MVC   3(3,R1),21(R6)      SAVE BOOKED                                  
         CLI   20(R6),0            ANY HIGH-BYTE VALUE?                         
         BZ    DPRN0086            NO  - USE FIGURE AS ENTERED                  
         MVC   3(3,R1),=X'FFFFFF'  YES - SET TO FLAG INDICATOR                  
DPRN0086 EQU   *                                                                
         SPACE                                                                  
         CLI   QLIST,QLSTA                                                      
         BNE   DPRNX                                                            
...
COBUD020 CLC   0(2,R1),LSTVAL                                                   
         ...
         LA    R1,4(,R1)                                                        
         BCT   R0,COBUD020                                                      
         B     COBUD100            RESET FILES AND KEY                          
***      B     COBUDX                                                           
COBUD024 DS   0H                                                                
         MVC   KEY+16(2),2(R1)     GET REP CODE                                 
         B     COBUD044                                                         
...
TESTIT   B     TRC040                   YES, BYPASS DOLLAR EDITS                
         ...
         EDIT  (R0),(10,P+113),0,COMMAS=YES,FLOAT=-                             
         SPACE                                                                  
TRC040   DS   0H                                                                
*                                                                               
*   TEST                                                                        
...
TRCTABL  DC    X'01',CL10'01VKEY0500'                                           
         ...
         DC    X'0D',CL10'0DLREC0110'                                           
         DC    X'0E',CL10'0ELT999'                                              
         ...
         DC    X'1D',CL10'1DLT040'                                              
         DC    X'1E',CL10'1ELT020'                                              
         DC    X'1F',CL10'1FLT900'                                              
         DC    X'20',CL10'20LT225'                                              
         DC    X'21',CL10'21PRECSETM'                                           
         DC    X'40',CL10'40LR130'                                              
         DC    X'41',CL10'41LR142'                                              
         DC    X'43',CL10'43LR143'                                              
         DC    X'44',CL10'44LR144'                                              
         DC    X'45',CL10'45LR150'                                              
         DC    X'46',CL10'46LR152'                                              
         DC    X'47',CL10'47LR153'                                              
         DC    X'48',CL10'48LR154'                                              
         DC    X'49',CL10'49LR156'                                              
         DC    X'50',CL10'60LR160'                                              
