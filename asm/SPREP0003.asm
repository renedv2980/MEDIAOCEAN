*          DATA SET SPREP0003  AT LEVEL 030 AS OF 08/12/14                      
*PHASE SP0003B                                                                  
         TITLE 'SP0003 - TEST PROGRAM SUBCONTROLLER'                            
         PRINT NOGEN                                                            
SP0003   CSECT                                                                  
         NMOD1 0,SP0003                                                         
*                                                                               
...
*                                                                               
         ...
         GOTO1 GO                                                               
*                                                                               
NXTBUY2  CLI   MODE,REREAD         REREAD STATION                               
         BE    NXTBUY6                                                          
*                                                                               
         TM    RQOPTS,RQOPTS_CBHLAST  TEST WANT CBHLAST BREAK                   
         BZ    NXTSTA                                                           
         CLI   COUNTRY,C'C'          TEST CANADA                                
         BE    NXTSTA                                                           
         CLI   RQALPHA,C'Y'        TEST CABLE ALPHA SEQ REQUEST                 
         BNE   NXTSTA              NO                                           
         ICM   RE,15,SVSTLADR      POINT TO CURRENT LIST ENTRY                  
         BZ    NXTSTA              NONE                                         
* ENTRY IS PACKED STA(3)/X'00'/SYSCODE(4)/NETWORK(3)                            
         CLC   4(4,RE),16(RE)      TEST NEXT SAME SYSCODE                       
         BE    NXTSTA                                                           
NXTBUY4  MVI   MODE,CBHLAST        ELSE GIVE HDND LAST BREAK                    
         GOTO1 GO                                                               
         B     NXTSTA                                                           
*                                                                               
NXTBUY6  XC    KEY,KEY                                                          
...
*                                                                               
         ...
         BNE   NXTBUY8                                                          
         MVC   KEY+9(2),SVBUYKEY+9   RESTORE                                    
         B     NXTBUY60                                                         
*                                                                               
NXTBUY8  OC    SVSTLADR,SVSTLADR     TEST READING IN ALPHA SEQ                  
         BZ    NXTBUY60              NO                                         
         CLI   COUNTRY,C'C'          TEST CANADA                                
         BE    NXTBUY60                                                         
         CLI   KEY+6,X'E8'           TEST CABLE STATION                         
         BL    NXTBUY60                                                         
         TM    KEY+8,X'7F'         TEST CBLNET HAS BEEN RESET                   
         BNZ   NXTBUY60            NO                                           
* FIND FIRST ENTRY IN STALST FOR THIS HEADEND                                   
         L     R1,ADSTALST         START OF LIST                                
         L     RF,SVSTLADR         CURRENT ENTRY                                
         ICM   RF,7,0(RF)                                                       
         SRL   RF,7                DROP NETWORK                                 
*                                                                               
NXTBUY10 C     R1,SVSTLADR         SAME ENTRY                                   
         BE    NXTBUY12                                                         
         SR    RE,RE                                                            
         ICM   RE,7,0(R1)                                                       
         SRL   RE,7                                                             
         CR    RE,RF               SAME HEADEND                                 
         BE    NXTBUY12                                                         
         LA    R1,12(R1)           NEXT ENTRY                                   
         B     NXTBUY10                                                         
*                                                                               
NXTBUY12 ST    R1,SVSTLADR         SET START OF HEADEND                         
         MVC   KEY+6(3),0(R1)      SET STATION IN KEY                           
         XC    KEY+9(4),KEY+9                                                   
*                                                                               
NXTBUY60 GOTO1 FCFRSBUY                                                         
         B     NXTBUY                                                           
*                                                                               
...
EXIT     XMOD1 1                                                                
       ...
       ++INCLUDE SPREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'030SPREP0003 08/12/14'                                      
         END                                                                    
