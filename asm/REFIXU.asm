*          DATA SET REFIXU     AT LEVEL 019 AS OF 05/01/02                      
*          DATA SET REFIXU     AT LEVEL 017 AS OF 05/07/99                      
*PHASE REFIXUR,*,NOAUTO                                                         
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
*INCLUDE PRINTER                                                                
...
*                                                                               
         ...
         BNE   IN2                                                              
*                                                                               
         CLC   RINVKREP,=C'UV'     UNNY!                                        
         BNE   IN2                                                              
         CLC   RINVKSTA,=C'WLTVT'                                               
         BNE   IN2                                                              
         CLI   RINVKSRC,0          HEADERS ONLY                                 
         BNE   IN2                                                              
*                                                                               
ININV    DS    0H                                                               
...
*                                                                               
         LA    R6,FREC                                                          
         MVI   ELCODE,X'06'        CHECK IF ANY '06' ELEMENTS                   
         BAS   RE,GETEL                                                         
         BNE   *+8                                                              
         OI    MYFLAG,YES06                                                     
*                                                                               
...
*                                                                               
         LA    R6,RKEY                                                          
         MVI   ELCODE,X'06'        LOST '06' ELEMENTS?                          
         BAS   RE,GETEL                                                         
         BE    IN2                 NO                                           
*                                                                               
...
RECONWKC CSECT                                                                  
         DS    4000D                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019REFIXU    05/01/02'                                      
         END                                                                    
