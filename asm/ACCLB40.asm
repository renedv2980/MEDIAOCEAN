*          DATA SET ACCLB40    AT LEVEL 109 AS OF 01/06/00                      
*PHASE T62140A                                                                  
...
BDSC02   XR    RF,RF               OUTPUT PFKEY NUMBER                          
         ...
         LA    R2,3(R2)                                                         
*                                                                               
         TM    PFKINDS1,PFKIACTN   TEST DEFINATELY AN ACTION                    
         BO    BDSC03                                                           
         TM    PFKINDS1,PFKISCRL   TEST SCROLL PFKEY                            
         BNZ   BDSC06                                                           
         TM    PFKINDS1,PFKIAPPL+PFKIALTP TEST APPLICATION/ALTPFS               
         BNZ   BDSC08                                                           
*                                                                               
...
BDSC04   CLI   ACTTABD,EOT                                                      
         ...
         B     BDSC10                                                           
*                                                                               
BDSC06   TM    PFKINDS2,PFKIMAXN+PFKINPFX                                       
         BNZ   BDSC08                                                           
         MVI   0(R2),C'+'          OUTPUT DIRECTION IF REQUIRED                 
         TM    PFKINDS2,PFKIUPDN                                                
         BZ    *+8                                                              
         MVI   0(R2),C'-'                                                       
         LA    R2,1(R2)                                                         
*                                                                               
BDSC08   XR    RE,RE               OUTPUT SCROLL EXPRESSION                     
         ICM   RE,3,PFKSCRLL                                                    
         LA    RE,TWAD(RE)                                                      
*                                                                               
...
* NTRY: P1 BYTE 0 = 0                                                 *         
*             1-3 = A(COLUMN CHARACTER CODE)                          *         
* EXIT:  ACLMDATA = A(COLUMN DATA ENTRY)                              *         
...
SCLM04   ST    R2,ACLMHEAD                                                      
         ...
         B     ROUTE                                                            
*                                                                               
SCLM06   MVI   SCALL,SCALLQ                                                     
         B     SCLM10                                                           
*                                                                               
SCLM08   L     RF,0(R1)            SEARCH FOR CHARACTER CODE                    
         MVC   SCCHAR,0(RF)                                                     
         OI    SCCHAR,X'40'                                                     
         XC    ACLMDATA,ACLMDATA                                                
*                                                                               
SCLM10   ICM   R2,15,ACLMDATA                                                   
         BNZ   SCLM18                                                           
         ICM   R2,15,ACLMHEAD                                                   
         BNZ   *+6                                                              
         DC    H'0'                                                             
         ...
         USING CLMTABD,R2                                                       
*                                                                               
SCLM12   CLI   CLMTABD,EOT                                                      
         BE    SCLM20                                                           
         CLI   SCALL,SCALLQ                                                     
         BE    SCLM16                                                           
         CLI   SCCHAR,0            MATCH ON COLUMN CHARACTER IF REQ             
         BE    *+14                                                             
         CLC   CLMCHAR,SCCHAR                                                   
         BNE   SCLM18                                                           
         ...
         BE    SCLM18                                                           
*                                                                               
SCLM14   IC    RE,LSRECCOL         TEST COLUMN FITS ON SCREEN                   
         IC    RF,CLMFWDTH                                                      
         AR    RE,RF                                                            
         CLM   RE,1,=AL1(NUMCOLSQ+1)                                            
         BH    SCLM18                                                           
*                                                                               
         CLI   CLMSEC,0            TEST FIELD SECURITY                          
         BE    SCLM16                                                           
         GOTO1 AFLDSEC,CLMSEC                                                   
         BL    SCLM18                                                           
         BH    SETCLMR             COLUMN IS READ ONLY                          
*                                                                               
SCLM16   TM    CLMINDS1,CLMIPRO    TEST COLUMN ALWAYS PROTECTED                 
         BO    SETCLMR             COLUMN IS READ ONLY                          
         B     SETCLMY                                                          
*                                                                               
SCLM18   LA    R2,CLMDATAL(R2)     BUMP R2                                      
         B     SCLM12                                                           
*                                                                               
SCLM20   XR    RF,RF                                                            
...
SCCHAR   DS    CL1                 MATCH ON COLUMN CODE                         
...
NTRSES08 LTR   R3,R3                                                            
         BZ    NTRSES10                                                         
         LA    R0,LSDIS            CLEAR LSVALS (SOME OF IT) ??                 
         LA    R1,LSMIXLST-LSDIS                                                
         SR    RE,RE                                                            
         SR    RF,RF                                                            
         MVCL  R0,RE                                                            
*                                                                               
...
* CALL GETOPT                                                         *         
*                                                                     *         
* NTRY: P1 = A(JOB/WORK CODE KEY)                                     *         
***********************************************************************         
         SPACE 1                                                                
         USING GJWORKD,RC                                                       
GETOPT   DS    0H                                                               
         USING *,R8                                                             
         MVC   GJPARMS(GJPARML),0(R1)                                           
...
*&&UK                                                                           
         ...
         B     ROUTL                                                            
         DROP  R2                                                               
ATRN02   MVC   IOKEY,ATWORK        RESTORE CALLERS KEY                          
         L     R1,ATAR1                                                         
*&&                                                                             
         L     R2,ATATRN                                                        
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
ATRN04   MVC   ATEXCVAL,CSEXCVAL   COPY EXCHANGE RATE AND TRANSPOSE             
...
ALLREG04 CLI   PTALN,PTARLN2Q                                                   
         ...
         EXCHP ATDUB2,ATEXCVAL,DUB=ATDUB1,WRK=ATWORK                            
...
AVAL06   ZAP   ATNET,0(8,RF)       AMOUNT IS NET                                
         ...
         BNE   *+10                                                             
         AP    ATNET,PTANET                                                     
         BAS   RE,NETTOHRS         CALCULATE HOURS                              
*                                                                               
AVAL09   DS    0H                                                               
         SPACE 1                                                                
***********************************************************************         
...
AVAL22   CP    ATDUB1,ATAGYVBL     TEST NET EXCEEDS AVAILABLE                   
         ...
         BE    AVAL29                                                           
         ZAP   ATDUB2,PTARCOM                                                   
         EXCHP ATDUB2,CSEXCVAL,DUB=ATDUB1,WRK=ATWORK                            
         ZAP   PTARFCOM,ATDUB1                                                  
         ZAP   ATDUB2,ATNET                                                     
         EXCHP ATDUB2,CSEXCVAL,DUB=ATDUB1,WRK=ATWORK                            
         ZAP   ATNET,ATDUB1                                                     
...
*                                                                               
         ZAP   ATDUB2,PTANETF      CONVERT TO AGENCY CURRENCY                   
         EXCHP ATDUB2,ATEXCVAL,DUB=ATDUB1,WRK=ATWORK                            
         ZAP   PTANET,ATDUB1                                                    
         CP    PTANET,BCPZERO      TEST ZERO IN AGENCY CURRENCY                 
         BNE   AVAL39                                                           
...
AUPD04   ICM   RF,15,ATAPTA        TEST ELEMENT WAS ON RECORD                   
         ...
         CLC   PTAELD(0),0(RF)                                                  
         BE    ALLTRNX                                                          
         MVI   0(RF),FF            DELETE ORIGINAL ELEMENT                      
...
AUPD06   OI    LSINDS1,LSIUPREC    UPDATE ACTIVITY INFO                         
         ...
         MVC   PTAPERS,CUPASS                                                   
         GOTO1 VHELLO,BCPARM,(C'P',ACCMST),TRNRECD,PTAELD                       
         CLI   12(R1),0                                                         
         BE    AUPD07                                                           
         CLI   12(R1),X'05'         RECORD HAS BECOME TOO LONG?                 
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   FVMSGNO,=AL2(AE$RECTB)                                           
         B     ROUTL                                                            
*                                                                               
AUPD07   MVC   ATAPTA,16(R1)                                                    
...
AUPD10   XR    R0,R0               CALL PRORATA WITH UPDATED RECORD             
         ...
         BE    *+8                                                              
         LA    R0,CSEXCVAL                                                      
         GOTO1 VPRORATA,BCPARM,TRNRECD,AGOPBLK,ACOM,(R0),PRORATAD,0             
*                                                                               
...
*                                                                               
         ...
         BZ    GPTA20                                                           
         MVC   GPSEQN,0(RF)                                                     
         L     R3,GPATRN           FIND CURRENT PENDING RECOVERY                
...
GPTA10   ICM   R3,15,GPAUWOF                                                    
         ...
         OI    PTASTAT1,PTASPEND                                                
         MP    PTANET,PMINUS1      NEGATE NUMBERS                               
         MP    PTANETF,PMINUS1                                                  
         MP    PTACDSC,PMINUS1                                                  
         XR    RE,RE                                                            
         ICM   RE,3,PTAHOURS                                                    
         LCR   RE,RE                                                            
         STCM  RE,3,PTAHOURS                                                    
         GOTO1 VHELLO,BCPARM,(C'P',ACCMST),GPATRN,PTAELD                        
         CLI   12(R1),0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         L     R3,16(R1)           R3=A(INSERTED ELEMENT)                       
         XR    R0,R0               CALL PRORATA WITH UPDATED RECORD             
         CLC   CSCPYCUR,CSBILCUR                                                
         BE    *+8                                                              
         LA    R0,CSEXCVAL                                                      
         GOTO1 VPRORATA,BCPARM,GPATRN,AGOPBLK,ACOM,(R0),GPAPRB,0                
         B     GPTA50                                                           
*                                                                               
GPTA20   L     R3,GPATRN           FIND CURRENT PENDING RECOVERY                
         LA    R3,TRNRFST-TRNRECD(R3)                                           
         USING PTAELD,R3                                                        
         XR    RF,RF                                                            
GPTA22   CLI   PTAEL,0                                                          
...
GPTA30   L     R3,GPATRN                                                        
         ...
         USING PTAELD,R3                                                        
         XR    RF,RF                                                            
GPTA32   CLI   PTAEL,0             LOOK FOR EXISTING PTA ELEMENT                
         BE    GPTA40                                                           
         CLI   PTAEL,PTAELQ                                                     
         BNE   GPTA38                                                           
...
GPTA38   IC    RF,PTALN                                                         
         BXH   R3,RF,GPTA32                                                     
*                                                                               
GPTA40   GOTO1 AALLTRN,BCPARM,('PTATWOF',GPATRN),GPAPRB,0,0                     
         BE    *+6                                                              
         DC    H'0'                                                             
         L     R3,0(R1)            R3=A(NEW PTA ELEMENT)                        
*                                                                               
GPTA50   LA    R2,IOKEY            INITIALIZE PTA RECORD KEY                    
         USING PTARECD,R2                                                       
         XC    PTAKEY,PTAKEY                                                    
         MVI   PTAKTYP,PTAKTYPQ                                                 
         MVC   PTAKCPY,CUABIN                                                   
...
GPTA53   CLI   ANOEL,0                                                          
         ...
         DROP  RE                                                               
*                                                                               
GPTA54   L     R2,GPAPTA           CREATE PTA RECORD                            
...
*&&                                                                             
GPTA56   MVC   TRNMOS,BCTMON                                                    
         MVC   TRNOFFC,GPOFFICE                                                 
         LA    R0,PTARFST-PTARECD+1+TRNLN1Q                                     
         STCM  R0,3,PTARLEN                                                     
         DROP  RF                                                               
*                                                                               
GPTA60   L     R1,GPAR1            SAVE A(PTA ELEMENT)                          
         ST    R3,0(R1)                                                         
         CLI   GPWOFR,0                                                         
         BNE   *+8                                                              
...
WPTA12   TM    ACBSTAT,ACBSPERS                                                 
         ...
         B     ROUTL                                                            
*&&UK                                                                           
WPTA14   MVC   WPANC(L'ACCOST),ACCOST                                           
*        TM    BCCPYST5,CPYSNCST   TEST NEW COST SYSTEM IN USE                  
*        BZ    *+10                                                             
*        OC    WPSTAT,=AL2(WOPSNCST)                                            
*&&                                                                             
*&&US                                                                           
WPTA14   TM    BCCPYST5,CPYSNCST   TEST NEW COST SYSTEM IN USE                  
         BZ    WPTA15                                                           
...
*                                                                               
         ...
         DC    AL2(WOPSCOST,WOPSDEPT+WOPSNCST+WOPSINCM)                         
         DC    AL1(0,0,0)                                                       
         ...
         DC    AL2(WOPSCOST+WOPSDEPT,WOPSNCST+WOPSINCM)                         
         DC    AL1(0,0,0)                                                       
         DC    C'1P',AL1(WP#DPT,WP#ANC,0,0,0)                                   
...
SUPD08   OC    STPASUB,STPASUB     TEST BUILDING CURRENT LIST                   
         ...
         BP    SUPD02                                                           
*                                                                               
SUPD10   CLC   TX.TLNUM,CSPAG#LO   TEST RECORD ON CURRENT SCREEN                
         BL    *+14                                                             
...
BLDTRN18 CLI   TRNTYPE,POSTBILL                                                 
         ...
         MVI   DUELN,DUELNQ                                                     
         MVC   DUEDATE,LSUDUEDT    SET ORIGINAL/NEW DUE DATE                    
...
*                                                                               
         ...
         BNE   BLDTRN22            NO - DO NOT ADD TRANSACTIONS                 
         L     R3,AADTBLK                                                       
         ...
         DROP  R3                                                               
*                                                                               
BLDTRN22 TM    POSTIND2,TRNIUBKO   TEST DUMMY POSTING FOR BUCKETS               
...
*                                                                               
         ...
         B     BLDTRN26                                                         
BLDTRN24 TM    POSTSTA2,POSTNALQ   TEST ITEM SHOULD HAVE BEEN ALLOC             
         BNO   BLDTRN26                                                         
...
*&&US*&& MVI   BATKGRUP,TBAGPRDQ                                                
         ...
         ICM   RE,15,BHPABREF                                                   
         MVC   BATKREF(L'LSUBILMC),LSUBILMC-LSUBILRF(RE)                        
         MVC   BATKREF+L'LSUBILMC(L'LSUBILRF),0(RE)                             
         OC    BATKREF+L'LSUBILMC(L'LSUBILRF),BCSPACES                          
*                                                                               
...
*                                                                               
         ...
         BZ    ADDONOK             NO                                           
         PACK  BCFULL,BATKREF+3(3) INCREMENT NUMERIC PORTION                    
         AP    BCFULL,=P'1'                                                     
         OI    BCFULL+(L'BCFULL-1),X'0F'                                        
         ICM   RE,15,BHPABREF      SET NEW REF IN CALLERS AREA                  
         UNPK  1(L'LSUBILRF-1,RE),BCFULL                                        
         B     ADDO10              TRY AGAIN                                    
*                                                                               
...
BHPABREF DS    A                   A(REF/MOA/MOACHARS)                          
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'109ACCLB40   01/06/00'                                      
         END                                                                    
