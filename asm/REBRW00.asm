*          DATA SET REBRW00    AT LEVEL 073 AS OF 01/25/11                      
*PHASE T82200A                                                                  
*INCLUDE REGENWLD                                                               
...
* JAN24/11 SMY  ALWAYS SKIP DISABLED SALESPERSON RECORDS            *           
*                 (SEE *SMY* IN SALREC)                             *           
*                                                                   *           
*                                                                   *           
*                ***  END TOMBSTONE  ***                            *           
...
SAL040   DS    0H                                                               
         ...
         DROP  R4                                                               
         BAS   RE,GETREC                                                        
*SMY*    TM    OPTIONS,X'80'       CHECK SAL LEAVE DATE?                        
*SMY*    BZ    SAL045                                                           
...
IO2      DS    XL4096              4K IOAREA                                    
       ...
       ++INCLUDE REGLBRW                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'073REBRW00   01/25/11'                                      
         END                                                                    
