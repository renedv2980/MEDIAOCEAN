*          DATA SET DDMONSOONB AT LEVEL 037 AS OF 05/01/02                      
*PHASE MONSOONB MONSOONB                                                        
*INCLUDE BINSRCH2                                                               
*INCLUDE DATCON                                                                 
*INCLUDE DMDMGRL                                                                
*INCLUDE GETRET                                                                 
...
*INCLUDE SORTER                                                                 
*                                                                               
* REPLACE SPOOF WITH SPOOFIDF FOR DEIS TESTING.                                 
*                                                                               
*                                                                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
GJ148    DS    0H                                                               
         CLC   ATTCHPGM,=CL8'SPOOF'                                             
         BNE   GJ150                                                            
         MVC   ATTCHPGM,=CL8'SPOOFIDF'                                          
         MVC   CARD,SPACES                                                      
         MVC   CARD(12),=CL12'TEST=T00A30C'                                     
         PUT   SYSIN,CARD                                                       
         MVC   P(80),CARD                                                       
         GOTO1 =V(PRINTER)                                                      
*                                                                               
...
GJ151    B     GJ152                                                            
         MVC   CARD,SPACES                                                      
*         MVC   CARD(8),=C'DUMP=OS '  PRINT ENTIRE SYSM DUMP                    
...
TIOT     DSECT                                                                  
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'037DDMONSOONB05/01/02'                                      
         END                                                                    
