*          DATA SET DELMXP8    AT LEVEL 002 AS OF 07/27/15                      
...
* THIS EXIT IS A COPY OF DELMXP2 AND MODIFIED FOR 3AM START OF DAY              
*                                                                     *         
...
*                                                                               
         SPACE 2                                                                
         ORG   DELMXP8+(((*-DELMXP8)/256)+1)*256  FOR I-CACHE PIPELINE          
         SPACE 2                                                                
...
* INPUT RECORDS DSECT                                                           
       ++INCLUDE DELMDSECT                                                      
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002DELMXP8   07/27/15'                                      
         END                                                                    
