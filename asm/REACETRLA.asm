*          DATA SET REACETRLA  AT LEVEL 006 AS OF 05/01/02                      
*PHASE ACETRLA                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
...
*                                                                               
DATE5    GOTO1 =V(CARDS),DMCB,CARD,=C'RE00'                                     
         CLC   CARD(2),=C'/*'      TEST FOR END OF FILE                         
         BE    DATE10                                                           
         CLC   CARD(5),=C'DATE='                                                
         BNE   DATE5   GET DATE CARD'S DATE INTO COMPRESSED FORMAT              
...
PDATE    DS    CL17                                                             
         DS    CL22                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006REACETRLA 05/01/02'                                      
         END                                                                    
