*          DATA SET RELDBLM    AT LEVEL 014 AS OF 05/01/02                      
*PHASE RELDBLM,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
         TITLE 'RELDBLM - LOAD/DUMP MODEL EXTERNAL ROUTINE'                     
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
* FOR BL                                                          *             
* DELETE MAKEGOOD NO LONGER REPPED                                *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENMKG                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014RELDBLM   05/01/02'                                      
         END                                                                    
