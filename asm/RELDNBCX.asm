*          DATA SET RELDNBCX   AT LEVEL 004 AS OF 05/01/02                      
*PHASE RELDNBCX                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDNBCX - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
**********************************************************************          
* HISTORY OF CHANGES                                                 *          
* OCT05/98 (BU ) --- VERSION TO DELETE NBC AGENCY/ADV RECORDS        *          
*                                                                    *          
*                                                                    *          
*                                                                    *          
*                                                                    *          
...
*                                                                               
         CLC   =C'X?',0(R7)        NBC TEST FILE?                               
         BNE   DMXKEEP             NO                                           
*                                                                               
*   USE RCONREC FOR GENERAL TESTING                                             
*                                                                               
         L     R5,AREC             POINT TO RECORD                              
         USING RCONREC,R5                                                       
         CLI   RCONKTYP,X'0A'      AGENCY RECORD?                               
         BE    DMXPURGE            YES - DROP IT                                
         CLI   RCONKTYP,X'1A'      AGENCY2 RECORD?                              
         BE    DMXPURGE            YES - DROP IT                                
         CLI   RCONKTYP,X'08'      ADVERT RECORD?                               
         BE    DMXPURGE            YES - DROP IT                                
         B     DMXKEEP                                                          
*                                                                               
         DROP  R5                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004RELDNBCX  05/01/02'                                      
         END                                                                    
