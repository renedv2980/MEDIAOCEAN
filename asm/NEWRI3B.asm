*          DATA SET NEWRI3B    AT LEVEL 011 AS OF 05/01/02                      
*          DATA SET NEWRI3B    AT LEVEL 011 AS OF 01/29/99                      
...
POPT12   CLC   NBACTDAT,0(R4)                                                   
         ...
         BNH   POPT14                                                           
         LA    R4,4(R4)             BUMP MONLIST                                
         A     R3,=F'2700'          BUMP PRODTABLE                              
         BCT   R2,POPT12                                                        
         B     POPTX               COULD BE DATES OUTSIDE ESTIMATE              
POPT14   LA    R1,300              MAX NUMBER IN TABLE                          
...
POPT16   CLC   =C'POL',REQPRD                                                   
         ...
         BAS   RE,GETPRD                                                        
         B     POPTX                                                            
POPT16C  CLI   NBPRDNO,0           IS IT MULTIPROD?                             
         BE    POPT20              NO                                           
         LA    R1,3                YES/DO 3                                     
         LA    R2,NBPRDLST             LIST OF MULTIPRODS                       
POPT17   MVC   WORK(1),0(R2)                                                    
         BAS   RE,GETPRD               RETURNS PRDCODE TO R3                    
         LA    R2,1(R2)                BUMP PRDLIST                             
         LA    R3,3(R3)                BUMP OUTAREA                             
         BCT   R1,POPT17                                                        
         B     POPTX                                                            
POPT20   MVC   WORK(1),NBPRD                                                    
         BAS   RE,GETPRD                                                        
         CLI   NBPRD2,0                                                         
         BE    POPTX                                                            
         LA    R3,3(R3)                                                         
...
PRTOPTS  NTR1                                                                   
         ...
         BZ    POP10                                                            
         MVI   ISITHIT,0                                                        
         LA    R3,300              MAX NUM OF LINES DOWN PER PROG               
         LA    R5,DATETBL                                                       
POP1     ST    R5,DATPOINT                                                      
         L     R4,NUMMONS                                                       
POP2     CLI   0(R5),0                                                          
...
POP14    CLI   0(R5),0                                                          
         ...
         MVI   PLINUM,2                                                         
         CLI   6(R5),0             IS THERE A 3D PIGGY                          
         BE    POP16                                                            
         MVI   PLDATA+135,C'/'       YES/SET PIGGY MARK                         
         MVC   PLDATA+264(3),6(R5)       MOVE IN PIGGY                          
POP16    LA    R2,5(R2)                                                         
         A     R5,=F'2700'                                                      
         BCT   R4,POP14                                                         
         CLI   ISITHIT,1           DID WE PUT DATA TO PRINT LINE                
         BNE   POP17                                                            
         CLI   PLINUM,2            YES/DID WE FILL 2ND P LINE?                  
         BE    POP16C                  YES/GO PRINT IT                          
         MVI   PLINUM,2                NO/SO SET TO FILL/PRINT IT               
         B     POP17                                                            
POP16C   BAS   RE,WRITIT           WRITE  P LINE(S)                             
         MVI   ISITHIT,0           CLEAR PUT DATA TO P FLAG                     
         MVI   PLINUM,0            CLEAR PUT DATA TO 2DN LINE FLAG              
POP17    L     R5,DATPOINT                                                      
         LA    R5,9(R5)            BUMP PRODTBL                                 
         LA    R2,P                                                             
         CLI   PLINUM,2            ARE WE GOING TO FILL 2ND LINE?               
         BNE   *+8                 NO                                           
         LA    R2,132(R2)          YES                                          
         BCT   R3,POP12                                                         
*                                                                               
...
*                                                                               
         EJECT                                                                  
               LTORG                                                            
         SPACE 3                                                                
DATETBL  DS    CL10000             2CL DATE X 300 SLOTS X 16 COLUMNS            
PRODTBL  DS    CL10000             3CL PRODS X 3(PIGGY) X 300 X 16              
         DS    CL10000             CONTINUATION OF ABOVE TBL                    
         DS    CL10000             CONTINUATION OF ABOVE TBL                    
         DS    CL10000             CONTINUATION OF ABOVE TBL                    
         DS    CL5000              CONTINUATION OF ABOVE TBL                    
DATETBLE EQU   *-DATETBL                                                        
*                                                                               
TABLES   DS    0F                                                               
...
DEMBLK   DSECT                                                                  
       ...
       ++INCLUDE DEDBLOCK                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011NEWRI3B   05/01/02'                                      
         END                                                                    
