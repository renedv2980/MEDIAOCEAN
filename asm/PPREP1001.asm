*          DATA SET PPREP1001  AT LEVEL 027 AS OF 04/02/97                      
*PHASE PP1001A,+0                                                               
         TITLE 'PP1001 - PRINTPAK INVOICE LISTING SPECS'                        
PP1001   CSECT                                                                  
         PRINT NOGEN                                                            
         SPACE 2                                                                
         FSPEC READ,BILLS                                                       
         ...
         SPROG 0,50                                                             
         PSPEC H1,1,MEDIA                                                       
         PSPEC H1,55,C'PRINTPAK INVOICE LISTING'                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027PPREP1001 04/02/97'                                      
         END                                                                    
