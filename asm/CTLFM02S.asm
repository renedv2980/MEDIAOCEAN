*          DATA SET CTLFM02S   AT LEVEL 012 AS OF 05/01/02                      
*PHASE TA0202A,+0                                                               
*INCLUDE GETIDS                                                                 
*INCLUDE SCINKEY                                                                
...
KEYV3    XC    DMCB(20),DMCB       VALIDATE TERMINAL ID                         
         ...
         BNP   KEYV3A                                                           
         LA    R1,FLD(R1)          BUT WE MUST FILL WITH SPACES                 
         BCTR  RF,0                                                             
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   0(0,R1),SPACES      AND SKIP NORMAL VALIDATION                   
         MVC   CTTKLINE(8),FLD                                                  
         B     KEYV6                                                            
KEYV3A   GOTO1 ATERMVAL,DMCB,(X'40',FLDH)                                       
         TM    DMCB,X'C0'                                                       
...
KEYVD1   CLI   0(R5),0                                                          
         ...
         B     KEYVD1                                                           
         USING CTLUID,R5                                                        
         MVC   PASSLUID,CTLUIID    SAVE LUID OF MASTER TERM RECORD              
KEYVD2   MVC   CTTKPASS,FLD        MOVE PASSWORD TO KEY                         
         MVC   SVPSWRD,FLD                                                      
         MVI   PASSWORD,1                                                       
...
DISP2    CLI   0(R5),0                                                          
         ...
         BE    DISPTD                                                           
         CLI   0(R5),X'26'         TERMINAL LOGICAL UNIT ID                     
         BE    DISPLU                                                           
*                                                                               
...
DISPTD   TM    TERMINFO,X'80'      TEST IF PASSWORD INPUT                       
         ...
         ST    R5,ATRMEL                                                        
         B     DISP4                                                            
* DISPLAY LOGICAL UNIT ID IF WE ARE DISPLAYING IT                               
*                                                                               
DISPLU   TM    TERMINFO,X'80'      TEST IF PASSWORD INPUT                       
         BO    DISP4                                                            
         USING CTLUID,R5                                                        
         MVC   TRMLUID,CTLUIID                                                  
         B     DISP4                                                            
...
DATAV66  TM    TERMINFO,X'80'      TEST IF PASSWORD RECORD                      
         BZ    DATAV67                                                          
         MVI   TRMLUIDH+4,X'80'    SET NO LUID INPUT                            
         MVI   TRMLUIDH+5,0                                                     
         XC    TRMLUID,TRMLUID                                                  
         OC    PASSLUID,PASSLUID   TEST IF MASTER TERM HAD LUID                 
         BZ    DVLUID              NO                                           
         MVI   TRMLUIDH+5,8        YES SIMULATE INPUT OF LUID                   
         MVC   TRMLUID,PASSLUID                                                 
         B     DVLUID                                                           
*                                                                               
...
ATTBITS  DC    X'8040201008040201'                                              
         DROP  R5                                                               
         EJECT                                                                  
* VALIDATE AND BUILD A LOGICAL UNIT ID ELEMENT                                  
*                                                                               
DVLUID   GOTO1 AFVAL,TRMLUIDH      TEST IF LOGICAL UNIT ID INPUT                
         BNZ   DVLUID2             YES                                          
*                                                                               
...
DATALU1  TM    INLUIDF,X'80'       TEST TO DELETE OLD LUID (SVLUID)             
         ...
         MVC   DELKEY+CTTKPASS-CTTREC(10),SVPSWRD                               
         L     RF,=A(DELREC)       DELETE UNWANTED PASSIVE                      
         A     RF,MYRELO                                                        
         BASR  RE,RF                                                            
*                                                                               
...
NODETBLL EQU   4                                                                
         ...
         DC    C'DDG MAN LEE AGB NYT FFT HAM FRA         '                      
         EJECT                                                                  
...
* FASYSLSTD                                                                     
       ...
       ++INCLUDE FASYSLSTD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012CTLFM02S  05/01/02'                                      
         END                                                                    
