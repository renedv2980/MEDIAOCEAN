*          DATA SET RELDRTG    AT LEVEL 009 AS OF 05/01/02                      
*PHASE RELDRTG,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
*******************************************************************             
*                                                                 *             
*   SET RATING SERVICE TO N ON PROPOSER CONTRACTS                 *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
DMX10    DS    0H                                                               
         ...
         BAS   RE,GETEL                                                         
         BNE   DMXKEEP             ELEMENT NOT FOUND, CAN'T BE PROPOSER         
*                                                                               
         TM    RCONRF1,X'40'                                                    
         BZ    DMXKEEP             NOT A PROPOSER RECORD                        
*                                                                               
         L     R5,AREC             POINT TO RECORD                              
         USING RCONREC,R5                                                       
         OC    RCONRTGS,RCONRTGS   RATING SERICE SET?                           
         BNZ   DMXKEEP             YES - KEEP IT                                
*                                                                               
         MVI   RCONRTGS,C'N'                                                    
*                                                                               
         AP    CHANGE,=P'1'                                                     
*&&DO                                                                           
         ...
         GOTO1 =V(HEXOUT),DMCB,RCONRTGS,P+20,1                                  
         LA    RF,RCONCTGY-RCONELEM                                             
         GOTO1 =V(HEXOUT),DMCB,RCONELEM,P+30,(RF)                               
         GOTO1 VPRINTER                                                         
*&&                                                                             
DMX100   DS    0H                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009RELDRTG   05/01/02'                                      
         END                                                                    
