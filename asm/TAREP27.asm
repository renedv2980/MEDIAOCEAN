*          DATA SET TAREP27    AT LEVEL 041 AS OF 05/20/05                      
*PHASE T70327A,*                                                                
         TITLE 'T70327 - LABEL PRINTING'                                        
T70327   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 MYEND-MYSTART,T70327,R7                                          
         LR    RA,RC                                                            
         USING MYD,RA                                                           
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
...
*TAREPFFD                                                                       
       ...
       ++INCLUDE DDGENTWA                                                       
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'041TAREP27   05/20/05'                                      
         END                                                                    
