*          DATA SET RESTR04    AT LEVEL 019 AS OF 11/24/97                      
*PHASE T80E04A                                                                  
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(8,WORK),(6,SACPERI)                                 
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,SACPERI+7)                               
...
LR70     DS    0H                                                               
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,LSACPERI)                                
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,LSACPERI+7)                              
         DROP  R6                                                               
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019RESTR04   11/24/97'                                      
         END                                                                    
