*          DATA SET SPSFM92    AT LEVEL 184 AS OF 04/26/16                      
*PROCESS USING(WARN(15))                                                        
*PHASE T21792A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
*  TITLE:        T21792  -- OCOM MAINTENANCE AND LIST                 *         
*                                                                     *         
*  COMMENTS:                                                          *         
*                                                                     *         
...
*                                                                     *         
*  INPUTS:       SCREEN SCSFM47 (MAINT) & SCSFM48 (LIST)              *         
*                                                                     *         
*  OUTPUTS:                                                           *         
*                                                                     *         
*  REGISTERS:    R0 -- WORK                                           *         
...
*                                                                     *         
***********************************************************************         
T21792   TITLE 'SPSFM92 - COMMENTS'                                             
T21792   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T21792*,R7,RR=R3                                              
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
         L     RA,ATWA                                                          
...
********************************************************                        
       ...
       ++INCLUDE SPSFMFFD          (BASE SCREEN FOR SYSTEM)                     
         ORG   CONTAGH                                                          
       ++INCLUDE SCSFM47D          (OUR MAINTENANCE SCREEN OVERLAY)             
         EJECT                                                                  
         ORG   CONTAGH                                                          
       ++INCLUDE SCSFM48D          (OUR LIST SCREEN OVERLAY)                    
         EJECT                                                                  
...
*                                                                               
*UTHD    DSECT                                                                  
*ECRAGY  DS    XL2                 SECURITY AGENCY                              
*ASSWD   DS    XL2                 AUTHORIZATION NUMBER                         
*RSNLID  DS    CL8                 PERSONAL ID                                  
         EJECT                                                                  
       ++INCLUDE SPGENPRG                                                       
       ++INCLUDE DDBIGBOX                                                       
       ++INCLUDE FAFACTS                                                        
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'184SPSFM92   04/26/16'                                      
         END                                                                    
