*          DATA SET SPMAT00    AT LEVEL 051 AS OF 10/01/08                      
*PHASE T21500A                                                                  
*INCLUDE MEDGET                                                                 
*INCLUDE BINSRCH                                                                
         ...
         PRINT NOGEN                                                            
T21500   CSECT                                                                  
         NMODL MATWKL,T21500,R8,R7                                              
         USING GENOLD,RC                                                        
*                                                                               
         LHI   R0,TWAEND           COMMENTING -MAXFLMS TOO BIG                  
         CHI   R0,TWANOGO          MAKES THIS TEST FAIL                         
         BNH   *+6                                                              
         DC    H'0'                SAVED STORAGE IN TWA TOO BIG!                
*                                                                               
         BAS   RE,INITL                                                         
         USING T215FFD,RA                                                       
*                                                                               
         L     R4,16(R1)           A(COMFACS)                                   
         ST    R4,VCOMFACS                                                      
*                                                                               
         OI    ICSSRVH+1,X'01'     MODIFY SERVICE REQUEST FIELD                 
         OI    ICSSRVH+6,X'80'                                                  
*                                                                               
         L     RF,0(R1)            IF PFKEY NUMBER 3 PRESSED                    
         USING TIOBD,RF                                                         
         CLI   TIOBAID,12          WANT TO RETURN SOMEWHERE?                    
         BE    *+12                YES                                          
         CLI   TIOBAID,12+12       WANT TO RETURN SOMEWHERE?                    
         BNE   GOSTART             NO                                           
         OC    SVXFRINF,SVXFRINF   DID WE COME FROM SOMEWHERE?                  
         BZ    GOSTART             NO, JUST SIGNED INTO MATCH                   
*                                                                               
AUTORTN  DS    0H                                                               
         L     R6,VCOMFACS                                                      
         USING COMFACSD,R6                                                      
...
*                                                                               
         ...
         MVC   GLVXTOSY(6),SVXFRINF    BACK TO CALLER                           
...
*                                                                               
         ...
         XIT1                                                                   
*                                                                               
GOSTART  DS    0H                  GO TO START GETTING EXTRA STORAGE            
**       BAS   RE,START                                                         
         GOTO1 START,(RC)                                                       
         XIT1                                                                   
*                                                                               
...
*                                                                               
         SPACE 1                                                                
         DROP  RC                                                               
*START    NTR1  BASE=*,LABEL=*,WORK=(R4,500)  EXTRA WORK FOR IOABUY             
START    NMOD1 750,**START*                  EXTRA WORK FOR IOABUY              
         LR    R0,RC                                                            
         LR    RC,R1                                                            
         USING GENOLD,RC                                                        
         ST    R0,AIOABUY          SAVE BUY IOAREA ADDRESS                      
*                                                                               
         L     R4,VCOMFACS          A(COMFACS)                                  
...
*                                                                               
         ...
         TM    8(R1),X'10'         IF TRANSFER RECORD FOUND                     
         BNZ   STRT10              NOT FOUND                                    
*                                                                               
         USING  GLVXFRSY,R1                                                     
         LA     R1,WORK                                                         
*                                                                               
...
*                                                                               
         MVC   SVXFRINF,GLVXFRSY   SAVE CALLING SYSPRG                          
         DROP  R1                                                               
...
*                                                                               
         ...
         ST    RF,VBINSRCH                                                      
*                                                                               
**NOP    LH    RF,=Y(SECBLK-T215FFD)                                            
**NOP    AR    RF,RA                                                            
         LAY   RF,SECBLK                                                        
         ST    RF,ASECBLK                                                       
*                                                                               
         OC    T215FFD+4(2),T215FFD+4   TEST ON NEW SECURITY                    
         BNZ   *+14                                                             
         OC    T215FFD+6(2),T215FFD+6   OR HAVE LIMIT ACCESS                    
         BZ    START20                                                          
*                                                                               
         L     RF,VCOMFACS                                                      
         L     RF,CSECRET-COMFACSD(RF)                                          
         GOTO1 (RF),DMCB,('SECPINIT',ASECBLK),0,0                               
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
START20  LA    R9,IOAREA                                                        
         LA    R1,GENOLD                                                        
...
*                                                                               
         CLI   DMCB+8,X'FF'                                                     
         BE    DB1B                ERROR                                        
         MVC   BAGYMED,WORK        SAVE AGY MED BYTE                            
         MVC   ICSMEDN,WORK+1                                                   
...
DB8B     BAS   RE,GETREC                                                        
         ...
         BZ    *+8                                                              
         MVI   SVPWCLT,C'Y'                                                     
         MVC   SVOFFC,COFFICE      SAVE OFFICE                                  
         MVC   SVCACCS,CACCESS     SAVE LIMIT ACCESS                            
*                                                                               
...
*                                                                               
         ...
         MVI   INTCOPT,C'N'                                                     
*                                                                               
         MVI   B0AFFDEL,C'Y'       ALLOW PAID AFFID DELETES                     
         MVC   WORK(4),=C'S0B0'    CHECK B0 PROFILE                             
         GOTO1 (RF),(R1),,WORK+30                                               
         MVC   B0AFFDEL,WORK+34                                                 
*                                                                               
         MVC   WORK(4),=C'S0TI'    GET TRAFFIC PROFILE                          
...
DB8C2    DS    0H                                                               
         MVI   TAXOPT,C'Y'                                                      
*                                                                               
         TM    4(R2),X'20'         --> ALWAYS CALL OFFICER                      
         BO    DB8C4                                                            
         OI    CHSW,X'20'          --> BUT DON'T SET CHANGED SWITCH             
         XC    QPRD(6),QPRD                                                     
         NI    ICSHPRDH+4,X'DF'                                                 
         NI    ICSOPTH+4,X'DF'                                                  
*                                                                               
...
**NOP    CLI   SVPWCLT,C'Y'        ALWAYS DEFAULT TO USE ESTIMATE               
**NOP    BNE   DB9X                                                             
         CLI   5(R2),3             UNLESS IT IS THERE ALREADY                   
         BH    DB9X                                                             
         GOTO1 VGLOBBER,DMCB,=C'GETD',DUB,8,GLVSPEST                            
         CLI   8(R1),GLEGNF        ANY ESTIMATE PASSED                          
         BE    DB9X                NOPE                                         
...
DB14F    DS    0H                                                               
         ...
         MVC   0(3,RF),WORK+4                                                   
         CLI   WORK+7,C'-'         FORMAT POL/YES-EST?                          
         BE    *+12                YES                                          
         CLI   WORK+7,C'/'         FORMAT POL/YES-EST?                          
         BNE   DB16                NO                                           
         LA    R4,WORK+9           POINT TO EST+1                               
         B     *+8                                                              
*                                                                               
DB15A    DS    0H                  LOOK FOR ESTIMATE                            
         LA    R4,WORK+5           POINT TO EST+1                               
         LA    R3,ESTERR                                                        
         SR    RF,RF                                                            
*                                                                               
         BCTR  R4,0                                                             
         CLI   0(R4),C'0'          MAKE SURE EST IS NUMERIC                     
         BL    PERR                SO WE DONT DIE ON CVB                        
         CLI   0(R4),C'9'                                                       
         BH    PERR                                                             
         LA    R4,1(R4)            POINT TO EST+1                               
*                                                                               
         CLI   0(R4),C' '          HAVE AT LEAST 2-DIGIT EST?                   
         BH    DB15AA              -YES                                         
         CLI   1(R4),C' '          CANNOT HAVE AN IMBEDDED SPACE DUMMY!         
         BH    PERR                                                             
         B     DB15B               -NOPE, EST ONLY ONE DIGIT                    
*                                                                               
DB15AA   LA    RF,1(RF)            INCRIMENT RF FOR EX                          
         CLI   0(R4),C'0'          MAKE SURE EST IS NUMERIC                     
         BL    PERR                SO WE DONT DIE ON CVB                        
         CLI   0(R4),C'9'                                                       
         BH    PERR                                                             
         CLI   1(R4),C' '          HAVE A 3-DIGIT EST?                          
         BNH   DB15B               NOPE, EST IS TWO DIGITS                      
*                                                                               
         LA    RF,1(RF)                                                         
         CLI   1(R4),C'0'          MAKE SURE EST IS NUMERIC                     
         BL    PERR                SO WE DONT DIE ON CVB                        
         CLI   1(R4),C'9'                                                       
         BH    PERR                                                             
DB15B    DS    0H                                                               
...
*                                                                               
         ...
         GOTO1 VDATCON,(R1),DUB,(2,PREVWKP)                                     
*                                                                               
         CLI   PROGPROF+9,C'C'     USE CALENDAR MONTHS?                         
         BNE   DB28                NO                                           
***                                                                             
* CALENDAR MONTHS, RESET BSTART/BEND                                            
***                                                                             
         MVC   WORK(6),WORK+6      COPY DATE                                    
         MVC   WORK+4(2),=C'01'    WORK(6) CONTAINS 1ST OF THE MONTH            
*                                                                               
         MVC   WORK+10(2),=C'00'   SET DAY TO ZERO TO MAKE DATE INVALID         
         GOTO1 VGETDAY,DMCB,(X'80',WORK+6),(0,DUB)                              
         CLI   4(R1),0             DAYS IN MONTH SET                            
         BNE   *+6                 YES                                          
         DC    H'0'                NO - THEN YYMM IS INVALID                    
*                                                                               
         ZIC   R1,DMCB+4           R1 = NUM DAYS IN MONTH (WORK+8)              
         CVD   R1,DUB                                                           
         UNPK  WORK+10(2),DUB+6(2) CONVERT IT TO EBCIDIC                        
         OI    WORK+11,X'F0'       MAKE VALID EBCIDIC (NUMS = F0-F9)            
*                                                                               
...
*                                                                               
*----------------------------------------------------------------               
*        UPDATE PROFILES THAT HAVE EFFECTIVE DATES                              
*----------------------------------------------------------------               
*                                                                               
DB30     EQU   *                                                                
         OC    I2ZPROF+8(2),I2ZPROF+8    EFFECTIVE DATE FOR NEW LEEWAY          
         BZ    DB30A                                                            
         ZIC   R1,I2ZPROF+8                                                     
         ...
         BL    DB30X               YES THEN DON'T USE THIS LEEWAY               
         MVC   TIMOPT1+1(1),I2ZPROF+7  BEFORE AND AFTER USE NEW LEEWAY          
         MVC   TIMOPT2+1(1),I2ZPROF+7                                           
*                                                                               
DB30A    OC    I2ZPROF+8(2),I2ZPROF+8    EFFECTIVE DATE FOR NEW LEEWAY          
         BZ    DB30X                                                            
         ZIC   R1,I2ZPROF+8                                                     
         CLI   I2ZPROF+8,80          IF YEAR < 80 ADD 100 FOR CENTURY           
         BH    *+8                                                              
...
*                                                                               
         ...
         BE    DB30X               NO - THEN USE REG LEEWAY                     
...
*                                                                               
         ...
         MVC   STEKCLT,=X'FFFF'    CHECK FOR CLIENT ALL                         
         GOTO1 HIGH                                                             
         CLC   KEY(13),KEYSAVE                                                  
         BNE   DB42N8D                                                          
*                                                                               
DB42N5   MVC   STEQDSK,KEY+14                                                   
*                                                                               
DB42N6   DS    0H                                                               
...
DB92B    DS    0H                                                               
         ...
         BE    DB29D                                                            
         CLI   REQPROF+1,C'S'     TEST AUTO TA FOR SUCCESSFUL MATCHES           
         BNE   EXIT                                                             
         CLC   ICSMSG(L'GOODMSG),GOODMSG                                        
         BE    DB29D                                                            
         B     EXIT                                                             
...
*                                                                               
         ...
         USING T215FFD,RA                                                       
*                                                                               
         OC    T215FFD+6(2),T215FFD+6   TEST ANY LIMIT ACCESS                   
         JZ    COX                      NO                                      
*                                                                               
         XC    0(64,R4),0(R4)                                                   
         USING OFFICED,R4                                                       
