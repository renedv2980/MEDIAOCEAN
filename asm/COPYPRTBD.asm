*          DATA SET COPYPRTBD  AT LEVEL 045 AS OF 04/03/01                      
*PHASE COPYPRTA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
**********************************************************************          
**********************************************************************          
*   THIS PART WRITTEN ONLY TO COPY SOME RECORDS FROM JW TO H7                   
*                                                                               
         CLC   REC(2),=C'JW'                                                    
         BH    EOF                                                              
*                                                                               
         CLC   REC(3),=C'JWM'      J.WALTER    - MAGAZINES                      
         BE    JW10                                                             
         CLC   REC(3),=C'JWN'      J.WALTER    - NEWSPAPERS                     
         BE    JW10                                                             
         B     GET                                                              
*                                                                               
JW10     CLI   REC+3,X'07'         ESTIMATES                                    
         BE    EST                                                              
         B     GET                                                              
**********************************************************************          
**********************************************************************          
...
*                                                                               
         CLC   REC(3),=C'BDI'      BBDO        - INTERACTIVE                    
         BE    GET20                                                            
         CLC   REC(3),=C'BDM'      BBDO        - MAGAZINES                      
         BE    GET20                                                            
         CLC   REC(3),=C'BDN'      BBDO        - NEWSPAPERS                     
         BE    GET20                                                            
         CLC   REC(3),=C'BDO'      BBDO        - OUTDOOR                        
         BE    GET20                                                            
         CLC   REC(3),=C'BDS'      BBDO        - SUPPLEMENT                     
         BE    GET20                                                            
         CLC   REC(3),=C'BDT'      BBDO        - TRADE                          
         BE    GET20                                                            
         B     GET                                                              
*                                                                               
GET20    DS    0H                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045COPYPRTBD 04/03/01'                                      
         END                                                                    
