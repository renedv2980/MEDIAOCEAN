*          DATA SET REREPCT02  AT LEVEL 042 AS OF 05/01/02                      
*PHASE RECT02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
*                                                                  *            
* NOV17/95 (WSB) --- ORIGINAL CODING -- COUNTS THE NUMBER OF       *            
*                      RECORDS UNDER EACH REP                      *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
*                                                                               
...
GREC40   CLC   0(2,R5),=X'0000'    WAS THIS REP IN THE TABLE?                   
         BNE   GREC45              COULD STILL BE                               
         L     R3,NONREPS          NO                                           
         LA    R3,1(R3)            ADD TO COUNT OF RECS WITH NO REP REC         
         ST    R3,NONREPS                                                       
********     ADDED                                                              
         GOTO1 HEXOUT,DMCB,KEY,P+1,27                                           
         MVC   P+57(2),THISREP                                                  
         GOTO1 REPORT                                                           
         C     R3,=F'2000'                                                      
         BE    EXIT                                                             
...
GREC60   GOTO1 SEQDIR              CONTINUE WITH SAME RECORD TYPE               
         B     GREC20                                                           
*                                                                               
GRECNEXT LA    R4,2(R4)            LOOK FOR NEXT RECORD TYPE                    
         B     GREC10                                                           
*                                                                               
GRECX    B     EXIT                                                             
         EJECT                                                                  
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REGENREPA                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'042REREPCT02 05/01/02'                                      
         END                                                                    
