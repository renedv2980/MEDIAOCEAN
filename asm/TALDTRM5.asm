*          DATA SET TALDTRM5   AT LEVEL 003 AS OF 08/10/00                      
*PHASE TALDTR5A TALDTRM5                                                        
*INCLUDE SCANNER                                                                
...
DMXREC   DS    0H                                                               
         ...
         SPACE 1                                                                
         USING TLIND,R3                                                         
INVOICE  MVC   INV,TLININV                                                      
         XC    INV,=6X'FF'                                                      
         B     BOTH                                                             
         SPACE 1                                                                
         USING TLCKD,R3                                                         
CHECK    MVC   INV,TLCKINV                                                      
         SPACE 1                                                                
BOTH     CLI   INV+5,X'01'         LOOKING OF OLD DPS INVOICES                  
         BNE   DMXPURGE                                                         
         CLI   INV+2,X'07'         THAT START WITH JULY                         
         BNE   DMXPURGE                                                         
         B     DMXKEEP                                                          
         SPACE 1                                                                
INV      DS    CL6                                                              
...
*********INCLUDE TAGENFILE                                                      
       ...
       ++INCLUDE TAGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003TALDTRM5  08/10/00'                                      
         END                                                                    
