*          DATA SET DXUDBU     AT LEVEL 064 AS OF 01/22/01                      
*PHASE DXUDB                                                                    
*INCLUDE HEXOUT                                                                 
*INCLUDE DATCON                                                                 
*INCLUDE PRINT                                                                  
...
FDATOK   B     YES                                                              
         EJECT                                                                  
**********************************************************************          
* REFORMAT DATA FIELD TYPE FOR DB2                                   *          
**********************************************************************          
REFDATE  NTR1                                                                   
         CLI   FLDNULL,C'Y'                                                     
         BE    RDATOK                                                           
...
*                                                                               
         EXEC  SQL                                                     X        
               SELECT TABLENAME, INDEXNAME                             X        
               INTO   :THISTBNM, :THISNDXN                             X        
               FROM   DXCAUTH.RECORD                                   X        
               WHERE  RECORDID=:THISXID                                X        
               AND    COUNTRYCODE=:CUNTSQL                                      
*                                                                               
         BAS   RE,OUTCODE          GET SQL RETURN CODE                          
*                                                                               
         ST    RF,RETCODE          SAVE THE RETURN CODES                        
...
*                                                                               
         EXEC  SQL                                                     X        
               INSERT INTO DXCAUTH.EXTRACT VALUES                      X        
               (:HVXAGY,                                               X        
                :HVXSYS,                                               X        
                :HVXSUB,                                               X        
                :HVXDATE,                                              X        
...
*                                                                               
         EXEC  SQL                                                     X        
               INSERT INTO DXCAUTH.UPDATE VALUES                       X        
               (:HVXLOCN,                                              X        
                :HVXAUTH,                                              X        
                :HVXUDATE,                                             X        
                :HVXUTIME,                                             X        
...
*                                                                               
         EXEC  SQL                                                     X        
               ...
               WHERE  NAME=:THISNDXN                                   X        
               AND    TBNAME=:THISTBNM                                 X        
               AND    CREATOR=:THISAUTH                                         
*                                                                               
         BAS   RE,OUTCODE          GET SQL RETURN CODE                          
*                                                                               
         ST    RF,RETCODE          SAVE THE RETURN CODES                        
...
*                                                                               
         EXEC  SQL                                                     X        
               SELECT RECOVERYDATE, RECOVERYTIME, RECOVERYDA           X        
               INTO   :HVXRDATE, :HVXRTIME, :HVXRDA                    X        
               FROM   DXCAUTH.SOURCE                                   X        
               WHERE  AGENCYCODE=:HVXAGY                               X        
               AND    SYSTEM=:HVXSYS                                   X        
               AND    SUBSYSTEM=:HVXSUB                                         
*                                                                               
         BAS   RE,OUTCODE          GET SQL RETURN CODE                          
*                                                                               
         ST    RF,RETCODE          SAVE THE RETURN CODES                        
...
*                                                                               
         EXEC  SQL                                                     X        
               UPDATE DXCAUTH.SOURCE                                   X        
               SET    RECOVERYDATE=:HVXRDATE,                          X        
                      RECOVERYTIME=:HVXRTIME,                          X        
                      RECOVERYDA=:HVXRDA                               X        
               WHERE  AGENCYCODE=:HVXAGY                               X        
               AND    SYSTEM=:HVXSYS                                   X        
               AND    SUBSYSTEM=:HVXSUB                                         
...
CDSCLQ   EQU   *-COLDSCD                                                        
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'064DXUDBU    01/22/01'                                      
         END                                                                    
