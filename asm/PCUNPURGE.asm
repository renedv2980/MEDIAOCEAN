*          DATA SET PCUNPURGE  AT LEVEL 030 AS OF 05/01/02                      
*PHASE PCUNPRGA PCUNPRGE                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE PUBEDIT                                                                
*INCLUDE HEXOUT                                                                 
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PCUNPURGE - UNPURGE CONTRACTS'                                  
*                                                                               
*              UNPURGE DATA ON A OLD FILE                                       
*              COPIES ONLY UNPURGED RECORDS                                     
*                                                                               
PCUNPRGE CSECT                                                                  
         NBASE 0,PCUNPRGE,=V(REGSAVE)                                           
         SPACE 2                                                                
         LA    R6,PCUNPRGE+4095                                                 
         LA    R6,1(R6)                                                         
         USING PCUNPRGE+4096,R6                                                 
...
PRTREC   NTR1                                                                   
         ...
         USING PCONREC,R7                                                       
         MVC   P(3),REC                                                         
         GOTO1 =V(PUBEDIT),DMCB,REC+7,P+6                                       
         MVC   HALF,REC+13                                                      
         LH    R0,HALF                                                          
         CVD   R0,DUB                                                           
         OI    DUB+7,X'0F'                                                      
         UNPK  P+23(3),DUB                                                      
         GOTO1 =V(DATCON),DMCB,(3,PCONSDT),(5,P+30)                             
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'030PCUNPURGE 05/01/02'                                      
         END                                                                    
