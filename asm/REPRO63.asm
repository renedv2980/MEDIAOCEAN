*          DATA SET REPRO63    AT LEVEL 006 AS OF 06/25/97                      
*&&      SET   NOP=N                                                            
*PHASE T80A63A                                                                  
T80A63   TITLE 'REPRO63 - REP PROPOSALS WORK/ROTATION'                          
PRO63    CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,REPRO63*,R7,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
*                                                                               
         L     R8,AGWORK                                                        
...
*        EDIT  (R0),(8,0(R2)),1,ALIGN=LEFT,DUB=BODUB1,WRK=BOWORK1               
         EDIT  (R0),(8,0(R2)),1,DUB=BODUB1,WRK=BOWORK1                          
         AR    R2,R0                                                            
*&&DO                                                                           
         MVI   0(R2),C'/'                                                       
         LA    R2,1(R2)                                                         
...
**       EDIT  (R0),(8,0(R6)),1,ALIGN=LEFT,DUB=BODUB1,WRK=BOWORK1               
         EDIT  (R0),(8,0(R6)),1,DUB=BODUB1,WRK=BOWORK1                          
         AR    R6,R0                                                            
*&&DO                                                                           
         MVI   0(R6),C'/'                                                       
         LA    R6,1(R6)                                                         
...
NLST1    DS    0H                                                               
         ...
         BNH   NML20               NO, MAKE CONTROLLER ADD IT                   
*                                                                               
         ZIC   R5,DTMCNT                                                        
         MH    R5,=Y(L'RPRDYDTM)                                                
         LA    R5,SAVFTDT(R5)                                                   
*                                                                               
NML05    MVI   LINECNTR,1          YES, GET NEXT TIME LINE                      
         ZIC   R1,SEQCNT                                                        
         LA    R1,1(R1)                                                         
         STC   R1,SEQCNT                                                        
*                                                                               
         CLC   THISTIME+2(2),FUDGETIM+2                                         
         BNE   NML10                                                            
*                                                                               
         LA    R5,L'RPRDYDTM(R5)                                                
         ZIC   R1,DTMCNT                                                        
...
*                                                                               
         ...
         CLC   =C'CC',3(R5)                                                     
         BNE   *+10                                                             
         MVC   FUDGETIM+2(2),=H'200'                                            
*                                                                               
         CLC   FUDGETIM+2(2),=H'2400'                                           
         BNH   NML07                                                            
         ZICM  RE,FUDGETIM+2,2                                                  
         SH    RE,=H'2400'                                                      
         STCM  RE,3,FUDGETIM+2                                                  
*                                                                               
NML07    DS    0H                                                               
*                                                                               
RX       EQU   RE                  MINUTES                                      
RY       EQU   RF                  HOURS                                        
NML10    DS    0H                                                               
         MVC   THISTIME(2),THISTIME+2                                           
         SR    RY,RY                                                            
         MVC   BOHALF1,THISTIME                                                 
         LH    RY,BOHALF1                                                       
         LA    RY,30(RY)                                                        
         SR    RX,RX                                                            
         D     RX,=F'100'                                                       
         CH    RX,=H'60'           MORE THAN 60 MIN?                            
         BL    NML12               NO                                           
...
NML12    DS    0H                                                               
         ...
         CH    RX,=H'30'           GET EVEN DEMO BOUNDS                         
         BL    *+12                                                             
         LA    RX,30                                                            
         B     *+6                                                              
         SR    RX,RX                                                            
...
*                                                                               
         STH   RY,BOHALF1                                                       
         MVC   THISTIME+2(2),BOHALF1                                            
         CLC   FUDGETIM+2(2),FUDGETIM                                           
         BNL   NML18               NO                                           
         CLC   THISTIME+2(2),FUDGETIM                                           
         BH    NML20                                                            
NML18    CLC   THISTIME+2(2),FUDGETIM+2                                         
         BNH   NML20                                                            
         MVC   THISTIME+2(2),FUDGETIM+2                                         
*                                                                               
NML20    L     R6,ATLST                                                         
...
*                                                                               
         OC    TLRTIME+2(2),TLRTIME+2 FUDGE FOR MIDNIGHT                        
         BNZ   *+10                                                             
         MVC   TLRTIME+2(2),=H'2400'                                            
*                                                                               
...
*                                                                               
         CLI   GSSMCODE,C'J'                                                    
         BE    *+12                                                             
         MVI   GSSMCODE,C'J'       WORK/DEMO SCREEN                             
         B     SETMSCRX                                                         
         MVI   GSSMCODE,C'L'                                                    
*                                                                               
SETMSCRX B     EXITOK                                                           
...
* RECORD (PROTECTED PORTION)                                                    
         ...
         DC    AL2(00120),AL4(ROTDTA)    ROTATION RATING DATA                   
         DC    AL2(00121),AL4(RFTDTA)    ROTATION FOOTNOTE DATA                 
* BOOK FIELDS                                                                   
         DC    AL2(00018),AL4(LDTMDTA)   DAY/TIME                               
         DC    AL2(00061),AL4(LCPPDTA)   CPP                                    
         DC    AL2(00125),AL4(LRTGDTA)   BOOK #1'S RATING                       
         DC    AL2(00126),AL4(LRTGDTA)   BOOK #2'S RATING                       
         DC    AL2(00127),AL4(LRTGDTA)   BOOK #3'S RATING                       
         DC    AL2(00128),AL4(LRTGDTA)   BOOK #4'S RATING                       
         DC    AL2(00129),AL4(LRTGDTA)   BOOK #5'S RATING                       
         DC    AL2(00130),AL4(LRTGDTA)   BOOK #6'S RATING                       
         DC    AL2(00131),AL4(LRTGDTA)   BOOK #7'S RATING                       
         DC    AL2(EOT)                                                         
*                                                                               
KNOWTABD DSECT                                                                  
...
*                                                                               
*RMBOOKQ EQU   111                 FIELD NUMBER FOR PRIME BOOK                  
PRMBOOKQ EQU   125                 FIELD NUMBER FOR PRIME BOOK                  
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006REPRO63   06/25/97'                                      
         END                                                                    
