*          DATA SET ACCAP40S   AT LEVEL 102 AS OF 01/21/04                      
*PHASE T61D40A                                                                  
***********************************************************************         
...
*                                                                               
         ...
         BNE   MAIN11              MUST BE DISPLAY                              
         MVC   DISLINES(2),=X'0001'                                             
         B     MAIN12                                                           
MAIN11   BAS   RE,CLRNUMBS         CLEAR DISPLAYED LINES                        
MAIN12   OI    4(R2),X'20'         VALIDATED OPTIONS                            
*                                                                               
...
*                                                                               
         ...
         BNE   *+8                                                              
         OI    STATUS,NEWINPUT                                                  
*        CLI   ACTEQU,ACTDEL       ARE THEY DELETING?                           
*        BNE   *+16                                                             
*        OI    LINESTAT,LBDELETE   MARK LINE DELETED                            
*        OI    BCBYTE2,X'80'       SHOW THAT WE DELETED SOMETHING               
*        B     VR140                                                            
*                                                                               
         TM    STATUS,NEWINPUT                                                  
         BNO   VR800                                                            
...
*        TM    GFACTST6,X'40'      RUNNING UNDER SCRIPT UPLOAD                  
*        BNO   VR700                                                            
*        OC    SVTMPLN#,SVTMPLN#   PER EMAR/PCAS ALWAYS ADD THIS ELM            
*        BZ    VR700               REGARDLESS IF THERE IS A LINE#-4/01          
         SR    R1,R1                                                            
         IC    R1,1(R3)                                                         
         AR    R3,R1                                                            
         MVI   TIMEL,TIMELQ                                                     
...
CLIVAL20 MVC   SVSJACT,BCACCODE                                                 
         MVC   SVTASK,BCSPACES                                                  
*                                                                               
*&&UK*&& CLI   SVTYPE,TIMTCN       IF NON-BILLABLE TIME                         
*&&UK*&& BE    *+12                IGNORE SJ LOCK STATUS                        
*                                                                               
         TM    BCASTAT1,RSTSACIL   ACCOUNT LOCKED                               
         BO    EACCLOCK                                                         
...
GETC20   LA    R1,EXTBLK           NEW BILLING EXTENSION                        
         ...
         B     *+14                                                             
         CLC   GOBILCUR,BCCPYCUR   1ST CURRENCY BILLED                          
         BNE   GETCX                                                            
*                                                                               
...
*&&UK                                                                           
         ZAP   SVERATE,=P'0'       EURO CHARGE RATE                             
         ZAP   SVECRATE,=P'0'      EURO COST RATE                               
*                                                                               
...
*&&UK                                                                           
         ...
         BZ    VRATE80                                                          
         GOTO1 CASHVAL,DMCB,(X'80',DUB),(X'28',0)                               
         ORG   *-2                                                              
         LA    RE,CURCD2           PRIMARY -> 2ND CURRENCY                      
         TM    BCFLAG5,BCFLSEC     TEST IF 2ND CURRENCY BILLED                  
         BNZ   *+8                                                              
         LA    RE,CURCD1           2ND CURRENCY -> PRIMARY                      
         ST    RE,8(R1)                                                         
         BASR  RE,RF                                                            
         LA    RE,SVERATE                                                       
         LA    RF,SVRATE                                                        
...
VINC90   OC    FIELDLEN,FIELDLEN   IS FIELD ON SCREEN                           
         BNZ   ESIANLI                INVALID ANALYSIS ACCOUNT                  
...
*                                                                               
         ...
         B     CLRCH10                                                          
*                                                                               
*        CLI   ACTEQU,ACTDEL       DONT DELETE IF ANY LINES PROTECTED           
*        BNE   CLRCH10                                                          
*        TM    BCBYTE1,X'80'       ANY LINES PROTECTED?                         
*        BNO   CLRCH10                                                          
*        B     ERRNODEL                                                         
*                                                                               
CLRCH10  DS    0H                                                               
...
*                                                                               
         ...
         BNE   ROUTE                                                            
*        CLI   ACTEQU,ACTDEL       ALWAYS SHOW ON DELETE                        
*        BE    *+12                                                             
...
ERRINV   MVC   GERROR,=AL2(ACEINV)         INVALID INPUT FIELD                  
         B     ACCERRX                                                          
ERRINVHR MVC   GERROR,=AL2(ACEIVHRS)       INVALID HOURS                        
         B     ACCERRX                                                          
ERROVR   MVC   GERROR,=AL2(ACEOVRRD)       NO OVERRIDE ALLOWED                  
         B     ACCERRX                                                          
ERRINC   MVC   GERROR,=AL2(ACEINCAC)       INCOME ACCT MUST BE ENTERED          
         B     ACCERRX                                                          
ERRNOMAT MVC   GERROR,=AL2(ACENOOPT)       ENTRY DOES NOT MATCH OPTION          
         B     ACCERRX                                                          
ERRNODEL MVC   GERROR,=AL2(ACENODEL)       CANT DELETE-T/S HAS PROT LNS         
         B     ACCERRX                                                          
...
EACCLOCK MVC   GERROR,=AL2(ACEACTLK)       ACCOUNT IS LOCKED                    
         B     ACCERRX                                                          
EDUPTLN# MVC   GERROR,=AL2(ACEDUPLN)       DUPLICATE TEMPO LINE                 
         B     ACCERRX                                                          
...
ENATMS   MVC   GERROR,=AL2(ACENATMS)                                            
         B     ACCERRX                                                          
ESIANLM  MVC   GERROR,=AL2(ACESIANL)       MISSING ANALYSIS ACCOUNT             
         B     ACCERRX                                                          
ESIANLI  MVC   GERROR,=AL2(ACEIANAL)       INVALID ANALYSIS ACCOUNT             
         B     ACCERRX                                                          
...
EFATAL   MVC   GERROR,=AL2(ACEFATAL)       FATAL ERROR                          
         B     ACCERRX                                                          
ERROCAL  MVC   GERROR,=AL2(ACEOCAL)        DATE OUTSIDE PERMITTED CAL           
         B     ACCERRX                                                          
...
*                                                                               
         ...
         MVC   PRDENDTE,CALREND    PERIOD END DATE                              
         MVC   PRDNUM,CALRNUM                                                   
         MVC   PRDMON,CALRMTH                                                   
         MVC   SVYYMMDD,YYMMDD                                                  
...
GETL20   CLC   PRDSTDTE,LOCEND     MAKE SURE PERIOD START DATE IS               
         ...
         B     GETL10                                                           
*                                                                               
GETL30   MVC   SV1ROFFC,LOCOFF     SAVE OFF LOCATION OFFICE                     
         MVC   SV1RDPT,LOCDEPT     SAVE OFF LOCATION DEPARTMENT                 
         MVC   SV1RSDPT,LOCSUB     SAVE OFF LOCATION SUB-DEPART                 
         MVC   SV1RSTDT,LOCSTART   SAVE OFF LOCATION START DATE                 
         MVC   SV1RENDT,LOCEND     SAVE OFF LOCATION END (DEFAULT)              
*                                                                               
...
*                                                                               
         ...
         L     R2,ALINE1                                                        
*                                                                               
*ISPX20  CLI   ACTEQU,ACTDEL       IF ACTION = DELETE                           
*        BNE   DISPX30                                                          
*        CLI   PFKEY,PFUPDATE      AND NOT YET UPDATING                         
*        BE    DISPX30                                                          
*        MVC   GERROR,=Y(ACIRDISD) REC DISPL-HIT ENT TO DEL                     
*        CLI   BCBYTE2,X'80'       DID WE DELETE ANYTHING YET?                  
*        BNE   DRGERRX                                                          
*        MVC   GERROR,=Y(ACIRLDUP) LINES DELETED-PF6 TO UPD                     
*        B     DRGERRX                                                          
*                                                                               
...
*                                                                               
DISPX60  DS    0H                                                               
         CLI   PFKEY,PFUPDATE      JUST UPDATED RECORD                          
         BNE   DISPX70                                                          
         LA    R2,CHAPERH                                                       
...
*        BNE   *+10                                                             
*        MVC   GERROR,=Y(ACIRDEL)  RECORD DELETED                               
         B     DRGERRX                                                          
*                                                                               
...
*                                                                               
CALSTDTE DS    PL3                 CALENDAR START DATE                          
CALENDTE DS    PL3                 CALENDAR ENDING DATE                         
...
*                                                                               
SVDGRP   DS    CL1                 DEFAULT DIRECT GROUP ACCOUNT                 
*                                                                               
...
SV1RDTES DS    0PL6                SAVED AREA FOR LOC START/END DATES           
...
***********************************************************************         
       ...
       ++INCLUDE DDLANGEQUS                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'102ACCAP40S  01/21/04'                                      
         END                                                                    
