*          DATA SET ACREPR702  AT LEVEL 103 AS OF 03/23/15                      
*PHASE ACR702A,+0                                                               
*INCLUDE SQUASHER                                                               
*INCLUDE SORTER                                                                 
*INCLUDE UNDERLIN                                                               
...
*                                                                     *         
*        OPTION 10          SHOW DOLLARS ($) ***ACTUAL OPTION***      *         
*                           Y- ALLOWED TO SEE $                       *         
*                           N- BASED ON SECURITY CANT SEE $           *         
*                                                                     *         
*        PROFILE OPTIONS                                              *         
*                                                                     *         
...
*                                                                               
         USING SECTABD,R1                                                       
         LA    R1,SECTAB           SECURITY TABLE                               
PRTB60   CLI   0(R1),X'FF'         END OF TABLE                                 
         BNE   *+6                                                              
         DC    H'0'                ALL REPORTS SHOULD BE IN TABLE               
         CLC   RCSUBPRG,SECREP     MATCH ON THE REPORT FORMAT                   
         BE    *+12                                                             
         LA    R1,SECLNQ(R1)                                                    
         B     PRTB60                                                           
*                                                                               
         LA    R5,SECCOLS          BUMP INTO COLUMN LINE                        
PRTB70   TM    0(R5),X'80'         SHOULD THIS COLUMN BE SKIPED?                
         BNO   *+12                                                             
         CLI   QOPT10,C'N'         IS REQUESTOR ALLOWED TO SEE $                
         BE    *+8                 NO - SKIP PRINTING                           
         BAS   RE,PRTAMNT                                                       
         LA    R5,L'SECCOLS(R5)    BUMP TO NEXT COLUMN IN SECTAB                
...
*---------------------------------------------------------------------*         
         SPACE 1                                                                
SECTAB   DS    0H       SECURITY TO SEE $ IN COLUMNS                            
         DC    X'00',X'008000800000'       4 COLUMNS                            
         DC    X'01',X'008000800000'       4 COLUMNS                            
         DC    X'02',X'000000808000'       5 COLUMNS                            
         DC    X'03',X'000000000000'       4 COLUMNS                            
         DC    X'04',X'008000800080'       6 COLUMNS                            
         DC    X'05',X'000000000000'       6 COLUMNS                            
         DC    X'06',X'808080800000'       4 COLUMNS                            
         DC    X'FF'                                                            
*                                                                               
TABLE    DS    0C                                                               
...
REQTYPE  EQU   X'80'               REQUEST TOTAL BUFFALO RECORD                 
         EJECT                                                                  
*                                                                               
*              DSECT FOR SECURITY TABLE (SECTAB)                                
*                                                                               
SECTABD  DSECT                                                                  
SECREP   DS    XL1                 REPORT FORMAT BASED ON RCSUBPRG              
SECCOLS  DS    6XL1                COLUMNS - X'80' MEANS $ COLUMN               
SECLNQ   EQU   *-SECTABD           LENGTH OF SECURITY TABLE                     
*                                                                               
...
*        ACOFFALD                                                               
       ...
       ++INCLUDE ACOFFALD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'103ACREPR702 03/23/15'                                      
         END                                                                    
