*          DATA SET PPREPPH02  AT LEVEL 006 AS OF 01/08/13                      
*PHASE PPPH02A                                                                  
*INCLUDE GETUSER                                                                
*INCLUDE GETCOST                                                                
*INCLUDE DDUCOM                                                                 
*INCLUDE PPFMTINO                                                               
         TITLE 'PPPH02 - PHILIP MORRIS INTERFACE'                               
***************************************************************                 
***************************************************************                 
...
*        CHANGE LOG                                                             
*                                                                               
*   BPLA   01/08/2013   RELINK WITH NEW GETCOST (QST % CHG)                     
*                                                                               
...
*                                                                               
         ...
         LA    R7,PPPH02+4095                                                   
         LA    R7,1(R7)                                                         
         USING PPPH02+4096,R7     **NOTE USE OF R7 AS BASE REG*                 
*                                                                               
         CLI   MODE,RUNFRST                                                     
         BE    INITIAL                                                          
         CLI   MODE,REQFRST                                                     
...
FIRSTB   DS    0H                                                               
*                                                                               
         MVC   DYNDDN,=CL8'PPHTAPE'                                             
         MVC   DYNDSN,=CL20'PRTTAPE.PP0PHXX1'                                   
...
AGYTABL  EQU   3                                                                
         EJECT                                                                  
*                                                                               
PPHTAPE  DCB   DDNAME=PPHTAPE,DSORG=PS,RECFM=VB,LRECL=408,             X        
...
ERRSW    DS    CL1                                                              
RERRSW   DS    CL1          SOME ERROR REQUEST ENCOUNTERED                      
...
*                                                                               
       ...
       ++INCLUDE PTIFILED                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006PPREPPH02 01/08/13'                                      
         END                                                                    
