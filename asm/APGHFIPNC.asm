*          DATA SET APGHFIPNC  AT LEVEL 008 AS OF 05/01/02                      
*PHASE ACHFIPNZ,+0                                                              
*INCLUDE SQUASHER                                                               
         TITLE 'APG HOOK FOR PORTER NOVELLI EXPENSE DETAIL REPORT'              
ACHFIPNC CSECT                                                                  
         PRINT NOGEN                                                            
...
BUD      CLI   MODE,PROCBUD                                                     
         ...
         L     R4,APGIO                                                         
         LA    R4,56(R4)           ADD LENGTH OF NEW KEY                        
         MVI   ELCODE,X'1D'                                                     
         BAS   RE,FIRSTEL                                                       
         BNE   XIT                                                              
...
*        ACGENBOTH                                                              
       ...
       ++INCLUDE ACGENBOTH                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008APGHFIPNC 05/01/02'                                      
         END                                                                    
