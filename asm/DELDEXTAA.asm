*          DATA SET DELDEXTAA  AT LEVEL 006 AS OF 04/17/00                      
*PHASE DELDEXTA,+0                                                              
*INCLUDE LOGIO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'DELDEXT - SET DIRECTORY STATUS BYTE'                            
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC0  L     R3,AREC             POINT TO RECORD                              
         L     R4,VLDDEFN          POINT TO LOAD DEFINITION                     
         USING LDDEFND,R4                                                       
         L     R5,LDDDTFIS         POINT TO DIR ACC DTF                         
         USING ISDTF,R5                                                         
*                                                                               
         LH    RF,ISKEYLN                                                       
         AR    RF,R3                                                            
         ...
         BO    DMXPURGE                                                         
*                                                                               
*        CLI   ISFXNUM,X'2D'       NDEMDIR                                      
*        BNE   *+8                                                              
*        MVI   0(RF),2                                                          
*        CLI   ISFXNUM,X'3A'       ODEMDIR                                      
*        BNE   *+8                                                              
         MVI   0(RF),2                                                          
         B     DMXKEEP                                                          
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006DELDEXTAA 04/17/00'                                      
         END                                                                    
