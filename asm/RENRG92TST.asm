*          DATA SET RENRG92TST AT LEVEL 123 AS OF 05/01/02                      
*          DATA SET RENRG02    AT LEVEL 110 AS OF 08/10/00                      
...
*                                                                               
         ...
         BNE   VKEYH440            NO                                           
         CLC   =X'190421',ELEM     YES - GRP/CONTYPE ENTERED?                   
         BE    VKEYC440            YES                                          
...
VKEYA440 EQU   *                                                                
         ...
         B     VKEYH440                                                         
VKEYC440 EQU   *                                                                
         MVI   ELEM+2,0            CLEAR CONTYPE FROM KEY                       
         B     VKEYH440                                                         
VKEYH440 EQU   *                                                                
*                                                                               
...
* SET1TAB-SET2TAB-SET3TAB LIVE HERE FROM X'27E8' TO END OF SYSD X'3148'         
         SPACE                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'123RENRG92TST05/01/02'                                      
         END                                                                    
