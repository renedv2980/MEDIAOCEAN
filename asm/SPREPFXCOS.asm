*          DATA SET SPREPFXCOS AT LEVEL 085 AS OF 05/01/02                      
*                                                                               
***********************************************************************         
...
*                                                                               
         ...
         MVI   MSRKAM,X'C1'        WE ARE TESTING FOR SJ ONLY                   
...
*                                                                               
REQF30   MVC   XKEY,SVXKEY                                                      
         GOTO1 DATAMGR,DMCB,=C'DMRDHI',=C'XSPDIR',XKEY,XKEY,0                   
*                                                                               
         GOTO1 DATAMGR,DMCB,=C'GETREC',=C'XSPFIL',MSRDDA,AREC,DMWORK            
*                                                                               
         LA    R6,TEMPIO+42        BEGINNING OF FIRST ELEMENT                   
         USING MSRSTELD,R6                                                      
         CLI   0(R6),X'10'                                                      
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
         MVC   RECDATE,MSRSTDAT                                                 
         CLC   RECDATE,=6X'00'     NOT CLOSING RECORDS W/O A DATE               
         BE    REQF33                                                           
         CLC   RECDATE,=6X'40'                                                  
         BE    REQF33                                                           
*                                                                               
         CLC   RANGE,RECDATE       1 YR FROM ESTART ?<> RUN DATE                
         BL    REQF33              LONGER THAN 1 YEAR THEN CLOSE                
         MVI   CLSNUM,3                                                         
         B     REQF35                                                           
*                                                                               
...
*                                                                               
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         GOTO1 DATCON,DMCB,(2,4(R6)),(0,RECDATE)                                
         B     *+10                                                             
*                                                                               
REQF72   MVC   RECDATE,BGRSRDAT                                                 
         CLC   RECDATE,=6X'00'                                                  
         BE    REQF73                                                           
         CLC   RECDATE,=6X'40'                                                  
         BE    REQF73                                                           
*                                                                               
         CLC   RANGE,RECDATE       1 YR FROM ESTART ?<> RUN DATE                
         BL    REQF73              LONGER THAN 1 YEAR THEN CLOSE                
         MVI   CLSNUM,3                                                         
         B     REQF75                                                           
*                                                                               
...
*********************************************************************           
CLSTAT   DS    0H                                                               
         XC    RECDATE,RECDATE     DATES ARE NOT COMPARED IN STATUS,            
         XC    ESTDATE,ESTDATE     PGEST, BWS, CHILD-SPOT RECORDS.              
         XC    RANGE,RANGE                                                      
*                                                                               
         ST    R7,DELDARE                                                       
         SR    R7,R7                                                            
...
TEMPIO   DS    XL2000                                                           
       ...
       ++INCLUDE SPREPWORKD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'085SPREPFXCOS05/01/02'                                      
         END                                                                    
