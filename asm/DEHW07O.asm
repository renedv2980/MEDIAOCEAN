*          DATA SET DEHW07O    AT LEVEL 017 AS OF 09/30/15                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEHW07OA                                                                 
*-------------------------------------------------------------------*           
* NHTI -  HISPANIC WEEKLY TAPE - OUTPUT PHASE                                   
*                                                                               
...
QCNV6    OC    PREVKEY,PREVKEY                                                  
         ...
         CLC   PREVKEY+3(5),=C'HUT H'                                           
         BE    QCNV6A                                                           
         CLC   PREVKEY+3(5),=C'UUUUH'   SAVE HUT UNIVERSE                       
         BE    QCNV6A                                                           
         B     QCNV7                                                            
QCNV6A   BAS   RE,SVHUT                                                         
...
*                                                                               
BLDEL1   CLC   INTSTA(4),=C'UUUU'  UNIVERSE P-RECD?                             
...
BLDEL1A  XC    TEMP,TEMP           CLEAR ELEMENT AREA                           
         ...
         BE    BLDEL3                                                           
         CLC   =C'MFX',INTSTA      ALLOW OLD CALL LETTERS FOR 'MFX'             
         BE    BLDEL3                                                           
...
BLDEL2G  ICM   RF,15,ACOMFACS      CHECK IF NET IS BROADCAST                    
         ICM   RF,15,CDEMTABS-COMFACSD(RF)                                      
         GOTO1 (RF),DMCB,NEHGES    GET A(BROADCAST STATIONS TABLE)              
         ICM   RE,15,0(R1)         A(TABLE) RETURNED IN P1                      
         BNZ   *+6                                                              
         DC    H'0'                BAD TABLEID PASSED                           
         ICM   RF,15,4(R1)         L(TABLE) RETURNED IN P2                      
...
BLDEL3   DS    0H                                                               
         ...
         XC    0(NTLENEQ,R6),0(R6) CLEAR ELEMENT AREA                           
         MVI   NTCODE,NTCODEQU                                                  
         MVI   NTLEN,NTLENEQ                                                    
         MVC   NTSQH,INTSQH                                                     
         MVC   NTEQH,INTEQH                                                     
...
BLDEL27  LA    R5,DBLOCKA          BUILD DEMO ELEMENTS                          
         ...
         MVC   WORK+7(2),=X'5C01'  FORC BOOK TO JAN/92 TO USE OLD DISP          
******   MVC   WORK+7(2),=X'7304'  FORC BOOK TO JAN/92 TO USE OLD DISP          
...
BLDEL30  CLI   0(R1),0             ADD DEMO ELEMENTS TO RECORD                  
         BE    BLDEL35                                                          
         GOTO1 APUTEL,(R1)                                                      
         IC    R0,1(R1)                                                         
         AR    R1,R0                                                            
...
BLDEL35  MVC   PREVKEY,THISKEY     PUT RECORD TO TAPE & SAVE VALUES             
         MVC   PREVSQH,THISSQH                                                  
         MVC   PREVDW,THISDW                                                    
         B     CNVX                                                             
...
SVHUT    NTR1                                                                   
         ...
         CLC   PREVKEY+3(5),=C'UUUUH'   GET HOMES UNIV FROM RECD                
         BE    SVHUT10                                                          
...
GENN     NTR1                                                                   
         ...
         SRL   R1,4                                                             
         STC   R1,HALF                                                          
         L     R3,=A(DAYTAB)       DAYBITS TABLE. START AT MONDAY               
...
CNV46    GOTO1 APUTTAPE                                                         
         ...
         B     CNV390                 DON'T DO HUT SUMMARIES FOR NOW            
*                                                                               
...
PREVKEY  DC    XL20'00'            LAST TIME VALUES                             
PREVSQH  DC    X'00'                                                            
PREVDW   DC    X'00'                                                            
PREVDBIT DC    X'00'                                                            
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE DEDBEXTRAD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017DEHW07O   09/30/15'                                      
         END                                                                    
