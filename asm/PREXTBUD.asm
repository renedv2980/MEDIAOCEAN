*          DATA SET PREXTBUD   AT LEVEL 046 AS OF 05/01/02                      
*PHASE PREXTBUD,+0                                                              
*INCLUDE BINSRCH                                                                
*INCLUDE HEXOUT                                                                 
*INCLUDE RECUP                                                                  
...
DMXREC   DS    0H                                                               
         ...
         USING PBUDRECD,R3                                                      
*                                                                               
         CLI   3(R3),X'18'         SEE IF BUDGET REC                            
         BNE   DMXKEEP                                                          
*                                                                               
         CLI   4(R3),X'00'         NULL ?                                       
         BE    DMXR10              REPLACE WITH SPACES                          
         CLI   5(R3),X'00'         NULL ?                                       
         BE    DMXR10              REPLACE WITH SPACES                          
         CLI   6(R3),X'00'         NULL ?                                       
         BE    DMXR10              REPLACE WITH SPACES                          
         ...
         BE    DMXR10              REPLACE WITH SPACES                          
         CLI   9(R3),X'00'         NULL ?                                       
         BNE   DMXKEEP             NO - REC OK - LEAVE ALONE                    
*                                                                               
*****    CLC   4(3,R3),=C'BMO'     CHECK CLIENT                                 
*****    BE    DMXR10                                                           
DMXR10   DS    0H                                                               
         OC    PBUDKCLT(6),SPACES     FIX BAD CHARACTERS (NULLS)                
         AP    CHGCOUNT,=P'1'                                                   
         BAS   RE,DDSTRACE                                                      
         B     DMXKEEP                                                          
         EJECT                                                                  
...
*                                                                               
         GOTO1 =V(HEXOUT),DMCB,PBUDREC,HEXBLOCK,28,=C'SEP'                      
...
*DDDPRINT                                                                       
       ++INCLUDE DDDPRINT                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'046PREXTBUD  05/01/02'                                      
         END                                                                    
