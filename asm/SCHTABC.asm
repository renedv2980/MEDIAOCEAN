*          DATA SET SCHTABC    AT LEVEL 097 AS OF 05/01/02                      
*PHASE T81010A,+0                                                               
*INCLUDE BINSR31                                                                
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLST                                                                
...
*                                                                               
         ...
         BNE   MAIN20                                                           
         CLC   CONACT,=C'DLIST'    !!!!!! CHECK PROFILE SETTINGS HERE           
         BE    GODLIST                                                          
         B     LIST                                                             
*                                                                               
MAIN20   CLI   MODE,RECDEL         DELETE                                       
         BE    DEL                                                              
...
*                                                                               
*        BAS   RE,CLRSCRN                                                       
         GOTO1 =A(OVFLRTN),DMCB,(4,DUB),(RC),RR=RELO    (CLRSCRN)               
*                                                                               
*  EFFECTIVE DATE (KEY)                                                         
         LA    R2,INVEFF                                                        
         XC    0(L'INVEFF,R2),0(R2)                                             
...
LIST     GOTO1 =A(OVFLRTN),DMCB,(2,DUB),(RC),RR=RELO    (LIST)                  
         B     EXIT                                                             
*                                                                               
GODLIST  GOTO1 =A(OVFLRTN3),DMCB,(0,DUB),(RC),RR=RELO   (DLIST)                 
         B     EXIT                                                             
         EJECT                                                                  
****************************************************************                
****************************************************************                
...
*                                                                               
         ...
         GOTO1 HIGH                                                             
*                                                                               
DEL100   CLC   KEY(24),KEYSAVE     CHECK UP TO RECORD TYPE                      
         BNE   DEL200                                                           
         OI    MYFLAG,DOTRANS                                                   
...
VR05     DS    0H                                                               
         ...
         BE    EXIT                                                             
         MVC   STAHLD,0(RF)        PROCESS CURRENT STATION                      
*                                                                               
VR10     MVC   AIO,AIO2                                                         
         L     R6,AIO                                                           
         USING REINVREC,R6                                                      
...
****************************************************************                
         SPACE                                                                  
OVLIST   DS    0H                                                               
         CLI   ACTEQU,DLIST        ACTION DLIST?                                
         BNE   LR25                                                             
         GOTO1 =A(OVFLRTN3),DMCB,(0,DUB),(RC),RR=RELO2   (DLIST)                
         B     LREXT                                                            
*                                                                               
LR25     CLI   RETURNED,12         CAME BACK FROM MINV SCREEN                   
         BNE   LR50                                                             
         XC    KEY,KEY                                                          
         MVC   KEY,INVKEY                                                       
         XC    INVKEY,INVKEY                                                    
...
OPT45    CLC   =C'HIDE',12(R1)     HIDE CLOSED OUT INVENTORY?                   
         ...
         OI    OPTFLAG2,HIDE                                                    
*                                                                               
OPT50    TM    OPTFLAG,FILTLATE    FILTER BY LATEST DATE?                       
         BO    OPTIONX                                                          
         LA    R1,39(R1)           NEXT FILTER                                  
         BCT   R0,OPT20                                                         
...
*                                                                               
         ...
         BE    SELR34              YES                                          
         USING LLINED,RF                                                        
         MVC   INEFFTAB+1(4),LINVNUM   MOVE INV # INTO TABLE                    
         MVC   INEFFTAB+5(8),LEFFDTE    MOVE EFF DATE INTO TABLE                
         B     SELR40                                                           
*                                                                               
SELR34   DS    0H                  ACTION DLIST                                 
         USING DLLINED,RF                                                       
         MVC   INEFFTAB+1(4),DLINVNUM  MOVE INV # INTO TABLE                    
         MVC   INEFFTAB+5(8),DLEFFDTE  MOVE EFF DATE INTO TABLE                 
         B     SELR40                                                           
         DROP  RF                                                               
*                                                                               
SELR35   DS    0H                                                               
...
*                                                                               
SELM30   DS    0H                                                               
         CH    R6,=H'13'           MAX # OF RECS SELECTED IN INV/LIST           
         BNL   SELMX                                                            
*                                                                               
         LA    R6,1(R6)            INCREMENT COUNTER                            
...
*                                                                               
         ...
         BE    SELM34              YES                                          
         USING LLINED,RF                                                        
         MVC   0(4,R5),LINVNUM   MOVE INV # INTO TABLE                          
         MVC   4(8,R5),LEFFDTE    MOVE EFF DATE INTO TABLE                      
         LA    R5,12(R5)           NEXT ENTRY IN TABLE                          
         B     SELM40                                                           
*                                                                               
SELM34   DS    0H                  ACTION DLIST                                 
         USING DLLINED,RF                                                       
         MVC   0(4,R5),DLINVNUM   MOVE INV # INTO TABLE                         
         MVC   4(8,R5),DLEFFDTE   MOVE EFF DATE INTO TABLE                      
         LA    R5,12(R5)           NEXT ENTRY IN TABLE                          
         B     SELM40                                                           
         DROP  RF                                                               
*                                                                               
...
OV2REP   DC    CL8'REPFILE'                                                     
         EJECT                                                                  
********************************************************************            
OVFLRTN3 NMOD1 0,*RM10OV3*,RR=R5                                                
         LA    R9,2048(RB)                                                      
         LA    R9,2048(R9)                                                      
...
*                                                                               
         ...
         BNZ   DL200                                                            
*                                                                               
* !!!! BUILD AND SORT INVENTORY HEADER TABLE BY DAY/TIME                        
         GOTO1 =A(OVFLRTN4),DMCB,(0,DUB),(RC),RR=RELO4   (BLDTAB)               
*                                                                               
         L     R5,ATABLE                                                        
         ST    R5,ATABLPTR                                                      
*                                                                               
DL200    LA    RE,*+10             GET INTO 31 BIT MODE                         
         O     RE,=X'80000000'                                                  
         BSM   0,RE                                                             
         XC    KEY,KEY                                                          
*                                                                               
         ...
         MVC   HEADREC,0(R5)                                                    
         LA    R5,HEADREC                                                       
         ICM   RF,15,HEADADDR         A(RECORD)                                 
         STCM  RF,15,KEY+28                                                     
*                                                                               
         LA    RE,*+6              GET OUT OF 31 BIT MODE                       
         BSM   0,RE                                                             
*                                                                               
         MVC   AIO,AIO1                                                         
         L     R6,AIO                                                           
...
*--DATE FILTER                                                                  
         ...
         B     DL260                                                            
*--SINGLE DATE EDIT                                                             
DL240    CLC   DTEHLD2,RINVPEFF                                                 
         BH    DL600                                                            
*                                                                               
DL260    CLI   MODE,PRINTREP                                                    
         BE    DPR                 !!!!!!                                       
*                                                                               
         TM    OPTFLAG,PRIMARY     FILTER BY PRIMARY DAYPART?                   
         BO    DL265                                                            
...
*                                                                               
         ...
         BH    DL600                                                            
*                                                                               
DL271    TM    OPTFLAG,FILTDATE    FILTER BY DATES?                             
         BZ    DL278                                                            
         TM    OPTFLAG,FILTMIN     FILTER BY PRIOR DATES?                       
         BZ    DL272                                                            
         CLC   DATE1,0(R3)                                                      
         ...
         B     DL278                                                            
*                                                                               
DL272    TM    OPTFLAG,FILT2DAT    FILTER ON RANGE OF DATES?                    
         BO    DL274                                                            
         OC    2(2,R3),2(R3)       ANY END DATE FOR RECORD?                     
         BZ    DL278                                                            
         CLC   DATE1,0(R3)         > START DATE?                                
         ...
         B     DL278                                                            
*                                                                               
DL274    OC    2(2,R3),2(R3)       ANY SECOND DATE?                             
         BNZ   DL275                                                            
         CLC   DATE2,0(R3)         <= FIRST DATE IN RANGE?                      
         BL    DL600                                                            
         BE    DL278                                                            
         ...
         B     DL278                                                            
*                                                                               
DL275    CLC   DATE1,0(R3)         >= FIRST DATE IN RANGE?                      
         BL    DL276               YES                                          
         CLC   DATE1,2(R3)         <= SECOND DATE IN RANGE?                     
         BH    DL600               NO                                           
         B     DL278                                                            
*                                                                               
DL276    CLC   DATE2,2(R3)         >= SECOND DATE IN RANGE?                     
         BNL   DL278                                                            
         CLC   DATE2,0(R3)         >= FIRST DATE IN RANGE?                      
         BL    DL600                                                            
*                                                                               
DL278    LA    R4,DLEFFDTE                                                      
         GOTO1 DATCON,DMCB,(2,0(R3)),(5,0(R4))                                  
         CLI   2(R3),0                                                          
         BE    DL280                                                            
         MVI   8(R4),C'-'                                                       
         GOTO1 DATCON,DMCB,(2,2(R3)),(5,9(R4))                                  
*                                                                               
DL280    MVC   DLDPT,RINVDP         DAYPART                                     
*                                                                               
*  DAY/TIME                                                                     
         USING RIDTELEM,R4                                                      
         GOTO1 HELLO,DMCB,(C'G',OV3REP),(X'02',(R6)),0                          
         CLI   12(R1),0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         L     R4,12(R1)                                                        
*                                                                               
         GOTO1 UNDAY,DMCB,RIDTDAY,DLDYTIME           DAY                        
         LA    RE,17                                                            
         LA    R3,DLDYTIME                                                      
*                                                                               
DL320    CLI   0(R3),X'40'                                                      
...
*  PROGRAM                                                                      
         USING RIPGELEM,R4                                                      
         GOTO1 HELLO,DMCB,(C'G',OV3REP),(X'03',(R6)),0                          
         CLI   12(R1),0                                                         
         BNE   DL400                                                            
         L     R4,12(R1)                                                        
         ZIC   R1,RIPGLEN                                                       
         ...
         EX    R1,*+8                                                           
         B     DL400                                                            
         MVC   DLPROGRM(0),RIPGNAME                                             
*                                                                               
         SPACE                                                                  
DL400    TM    OPTFLAG,FILTLATE    FILTER ON LATEST DATE?                       
         BZ    DL500                                                            
         MVC   KEY,TEMPKEY                                                      
         MVC   SAVEKEY,KEY                                                      
*                                                                               
DL500    GOTO1 LISTMON                                                          
         GOTO1 HIGH                                                             
         B     DL600               GOTO READ SEQ                                
*                                                                               
DL600    DS    0H                  (LIKE READ SEQ)                              
         L     R5,ATABLPTR                                                      
         AH    R5,=H'09'           GET NEXT INV HEADER                          
         ST    R5,ATABLPTR                                                      
         B     DL200                                                            
*                                                                               
DLEXT    DS    0H                                                               
...
*                                                                               
         ...
         LA    R5,5                                                             
*                                                                               
DYP310   CLC   0(1,R3),DYPART      FOUND MATCH?                                 
         BE    DYP320              YES                                          
*                                                                               
         TM    OPTFLAG,FILTDYPT    FILTER BY DAYPART?                           
         BO    DYP315                                                           
*                                                                               
         ...
         BNZ   DYP3X                                                            
*                                                                               
DYP315   LA    R3,1(R3)            BUMP TO NEXT DAYPART IN RECORD               
         BCT   R5,DYP310                                                        
         B     DYP3X               NO MATCH FOUND                               
*                                                                               
DYP320   OI    DYPTFLAG,DYPTFND                                                 
*                                                                               
DYP3X    XIT1                                                                   
         EJECT                                                                  
* PRINTING THE LINE                                                             
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(2,2(R3)),(5,9(R2))                                  
*                                                                               
DPR80    MVC   DPRDAYPT(6),RINVDP  DAYPART                                      
*                                                                               
*  AVAIL DAY TIME                                                               
*                                                                               
*        OC    RINVPADY,RINVPADY                                                
...
*        LA    R2,PRAVDYTM                                                      
*                                                                               
*DPR120  CLI   0(R2),X'40'                                                      
*        BNH   DPR140                                                           
*        LA    R2,1(R2)                                                         
*        BCT   RE,DPR120                                                        
*        DC    H'0'                                                             
*DPR140  OC    RINVPATM,RINVPATM                                                
*        BZ    DPR220                                                           
*        MVI   0(R2),C'/'                                                       
*        GOTO1 UNTIME,DMCB,RINVPATM,(0,1(R2))  AVAIL TIME                       
*                                                                               
...
DPR220   LA    R4,P                                                             
         ...
         B     DPR300                                                           
         USING RIDTELEM,R3                                                      
DPR240   GOTO1 HELLO,DMCB,(C'G',OV3REP),(X'02',AIO),0                           
         CLI   12(R1),0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         L     R3,12(R1)                                                        
*                                                                               
DPR300   GOTO1 UNDAY,DMCB,RIDTDAY,DPRDYTIM          DAY                         
         LA    RE,20                                                            
         LA    R2,DPRDYTIM                                                      
*                                                                               
DPR320   CLI   0(R2),X'40'                                                      
         BNH   DPR340                                                           
         LA    R2,1(R2)                                                         
         BCT   RE,DPR320                                                        
         DC    H'0'                                                             
...
*                                                                               
         USING RIPGELEM,R3                                                      
DPR440   GOTO1 HELLO,DMCB,(C'G',OV3REP),(X'03',AIO),0                           
         CLI   12(R1),0                                                         
         BNE   DPR500                                                           
         L     R3,12(R1)                                                        
*                                                                               
DPR460   ZIC   R1,RIPGLEN                                                       
         S     R1,=F'3'                                                         
         EX    R1,*+8                                                           
         B     *+10                                                             
         MVC   DPRPGM(0),RIPGNAME                                               
         ZIC   RE,RIPGLEN                                                       
         AR    R3,RE                                                            
         CLI   0(R3),X'03'                                                      
         BNE   DPR500                                                           
...
*                                                                               
         USING RIAPELEM,R3                                                      
DPR540   GOTO1 HELLO,DMCB,(C'G',OV3REP),(X'04',AIO),0                           
         CLI   12(R1),0                                                         
         BNE   DPR600                                                           
         L     R3,12(R1)                                                        
*                                                                               
DPR560   MVC   DPRAVDAY,RIADAY                                                  
         MVC   DPRAVTIM,RIATIME                                                 
         ZIC   RE,RIAPLEN                                                       
         AR    R3,RE                                                            
         CLI   0(R3),X'04'                                                      
         BNE   DPR600                                                           
...
*                                                                               
         ...
         MVC   DPRINV,=C'INV#'                                                  
         MVC   DPRINV+132(4),=4C'-'                                             
         MVC   DPREFF+1(14),=C'EFFECTIVE DATE'                                  
         MVC   DPREFF+132(17),=17C'-'                                           
         MVC   DPRPGM+7(12),=C'PROGRAM NAME'                                    
         MVC   DPRPGM+132(27),=27C'-'                                           
         MVC   DPRDAYPT(7),=C'DAYPART'                                          
         MVC   DPRDAYPT+132(7),=7C'-'                                           
         MVC   DPRDYTIM+6(8),=C'DAY/TIME'                                       
         MVC   DPRDYTIM+132(20),=20C'-'                                         
         MVC   DPRAVDAY+1(9),=C'AVAIL DAY'                                      
         MVC   DPRAVDAY+132(11),=11C'-'                                         
         MVC   DPRAVTIM(10),=C'AVAIL TIME'                                      
         MVC   DPRAVTIM+132(11),=11C'-'                                         
*        MVC   PRAVDYTM+3(14),=C'AVAIL DAY/TIME'                                
*        MVC   PRAVDYTM+132(20),=20C'-'                                         
*        MVC   PRAVPROG+5(13),=C'AVAIL PROGRAM'                                 
*        MVC   PRAVPROG+132(24),=24C'-'                                         
...
RELO4    DS    F                                                                
*                                                                               
OV3ERRND GOTO1 ERREX                                                            
OV3ERR2  GOTO1 MYERROR                                                          
*                                                                               
...
OVBRNCH4 B     BLDTAB                                                           
****************************************************************                
*         BUILD AND SORT INVENTORY HEADERS BY DAY/TIME         *                
****************************************************************                
BLDTAB   DS    0H                                                               
* INITIALIZE TABLE                                                              
         L     R0,GETSIZE          R0 = SIZE OF STORAGE TO GET                  
         XC    ATABLE,ATABLE                                                    
...
*                                                                               
         ...
         DC    H'00'               ERROR                                        
*                                                                               
         ST    R1,ATABLE           A(TABLE IN CORETAB)                          
*                                                                               
         LA    R3,HEADREC          HEADER RECORD TO SORT INTO TABLE             
         USING HEADERD,R3          DSECT FOR TABLE                              
*                                                                               
         LA    R6,KEY                                                           
         USING RINVKEY,R6                                                       
         XC    KEY,KEY                                                          
...
*                                                                               
         ...
         BE    BT10                                                             
*                                                                               
         GOTO1 GETREC              GET INV HEADER RECORD                        
         L     RF,DMDSKADD         A(RECORD)                                    
         STCM  RF,15,HEADADDR                                                   
*                                                                               
         ...
         DC    H'00'                                                            
         L     R4,12(R1)                                                        
         USING RIDTELEM,R4         DAY TIME ELEMENT                             
*                                                                               
         MVC   TEMPDAY,RIDTDAY     DAY                                          
         BAS   RE,DAYBITS          GET CORRECT DAY BITS                         
         MVC   HEADDAY,DAYBIT      CORRECT DAY                                  
*                                                                               
         MVC   HEADTIME,RIDTTIME   TIME(MILITARY)                               
*                                                                               
...
*                                                                               
         ...
         GOTO1 =V(BINSRCH),BINPARAM,HEADREC,(R5),RR=RELO5                       
*                                                                               
         L     RF,BINCOUNT                                                      
         LA    RF,1(RF)                                                         
         ST    RF,BINCOUNT                                                      
...
*                                                                               
DB10     DS    0H                                                               
         CLI   0(R4),X'FF'         END OF DAY TABLE?                            
         BE    DB30                                                             
*                                                                               
         MVC   SVDAY,TEMPDAY                                                    
         NC    SVDAY,2(R4)                                                      
         BZ    DB20                NO                                           
*                                                                               
         OC    DAYBIT,1(R4)        TURN ON CORRECT DAY BIT                      
*                                                                               
DB20     LA    R4,L'DAYTAB(R4)                                                  
         MVC   SVDAY,TEMPDAY                                                    
         B     DB10                                                             
*                                                                               
DB30     OC    DAYBIT,DAYBIT       FOUND CORRECT BITS?                          
         BNZ   *+6                                                              
         DC    H'00'                                                            
*                                                                               
DAYBITSX B     OV4EXIT                                                          
****************************************************************                
         DS    0F                                                               
GETSIZE  DC    XL4'000186A0'       100,000 BYTES                                
*                                                                               
         DS    0D                                                               
BINPARAM DC    A(0)                A(RECORD TO BE FOUND OR ADDED)               
         DC    A(0)                A(TABLE)                                     
BINPCNT  DC    F'0'                NUMBER IF RECS IN TABLE                      
         DS    XL1                                                              
         DS    XL1                                                              
         DC    H'09'               LENGTH OF REC IN TABLE                       
         DC    AL1(0),AL3(3)       DISPLACEMENT OF KEY                          
BINPMAX  DC    A(100000,L'HEADREC)                                              
*                                                                               
DAYTAB   DS    0XL6                                                             
         DC    X'0',X'01',X'40',C'MON'                                          
         DC    X'0',X'02',X'20',C'TUE'                                          
         DC    X'0',X'04',X'10',C'WED'                                          
         DC    X'0',X'08',X'08',C'THU'                                          
         DC    X'0',X'10',X'04',C'FRI'                                          
         DC    X'0',X'20',X'02',C'SAT'                                          
         DC    X'0',X'40',X'01',C'SUN'                                          
         DC    X'FF'                                                            
*                                                                               
TEMPDAY  DS    XL1                                                              
SVDAY    DS    XL1                                                              
...
RELO5    DS    F                                                                
*                                                                               
OV4ERRND GOTO1 ERREX                                                            
OV4ERR2  GOTO1 MYERROR                                                          
*                                                                               
...
HEADER   DS    0XL9                                                             
HEADDAY  DS    XL1                 DAY                                          
HEADTIME DS    XL4                 TIME IN MILITARY                             
HEADADDR DS    XL4                 A(RECORD)                                    
********************************************************************            
PLINED   DSECT                                                                  
PRINVNUM DS    CL4                                                              
         DS    CL3                                                              
...
ATABLE   DS    F                   A(TABLE OF SORTED HEADER/DLIST)              
ATABLPTR DS    F                   A(POSITION IN TABLE)                         
*                                                                               
       ++INCLUDE RERMPWTWA                                                      
         EJECT                                                                  
REINVREC DSECT                                                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'097SCHTABC   05/01/02'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
