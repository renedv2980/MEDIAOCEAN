*          DATA SET GEFIL03    AT LEVEL 111 AS OF 08/10/11                      
*          DATA SET GEFIL03    AT LEVEL 109 AS OF 04/19/06                      
*PHASE T00AB3C                                                                  
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* PROCESS LIST - RETURN FROM XITSES                                   *         
***********************************************************************         
         SPACE 1                                                                
         DS    0H                                                               
         USING *,R6                                                             
...
PROCXIT  CLI   NSREC,O#FLTR        JUST BACK FROM FILTERING?                    
         BNE   PRCX02              NO                                           
         OC    LSINIKEY,LSINIKEY                                                
         BNZ   PRCX01                                                           
         NI    LSSTAT1,FF-LSSINIT                                               
         ICM   R6,15,=A(PROC)                                                   
         A     R6,LCRELO                                                        
*        AHI   R6,PROC02-PROC                                                   
         BR    R6                                                               
*                                                                               
PRCX01   GOTOX AGEN,RTPARM,OFILT,FDIS,LSINIKEY                                  
...
*                                                                               
         ...
         B     LISTNTR                                                          
*                                                                               
PRCX05   TM    N.SNINDS1,SNIUSECR  JUST BACK FROM A SELECT ACTION?              
         BZ    PRCXX               NO                                           
         MVC   LCBYTE,LSSCIND1                                                  
...
*                                                                               
         ...
         BL    PRCXX                                                            
*                                                                               
         TM    LSSTAT3,LS3RVAR     VARIABLE                                     
         BZ    PRCX05A             NO                                           
*                                                                               
         MVC   LCTEMPL,LSLINE#                                                  
         MVC   LCTEMPH,LSCURLIN                                                 
         GOTOX ASETPAG                                                          
         MVC   LSLINE#,LSPAG#1     DISPLAY PAGE AGAIN                           
         GOTOX ADISPAG                                                          
         MVC   LSLINE#,LCTEMPL                                                  
         MVC   LSCURLIN,LCTEMPH                                                 
*                                                                               
PRCX05A  OC    LSSCIND1,LCBYTE                                                  
...
*                                                                               
         ...
         GOTOX ADISLINE                                                         
*                                                                               
PRCX05B  CLI   GSFRP.FRPTYPE,FRPTQPL  USER PRESSED 'QUIT' PFKEY?                
         BNE   PRCX06               NO                                          
         LH    RF,LSCURLIN                                                      
         TM    LSSTAT3,LS3RVAR     VARIABLE                                     
         BZ    *+8                 NO                                           
...
*                                                                               
         ...
         B     SFRST10                                                          
*                                                                               
SFRST04  TM    LSSTAT1,LSSMAIN     MAINTENANCE LIST?                            
         BO    SFRST10             YES                                          
*                                                                               
...
*                                                                               
         ...
         BZ    SFRST10             NO                                           
         TM    LSSCIND2,LSSCIDLM   WANT TO REUSE DEF-CLM RECORD?                
         BZ    SFRST06             NO                                           
*                                                                               
         GOTOX ALST,RTPARM,OLIST,LDEFCLM                                        
         BL    EXITL                                                            
*                                                                               
SFRST06  GOTOX AINISCR             REBUILD SCREEN                               
*                                                                               
...
*                                                                               
         GOTOX AGEN,RTPARM,OKEY,KFDIS,LSINIKEY                                  
         GOTOX AGEN,RTPARM,ORECH,RFDIS,AIOREC                                   
*                                                                               
...
DEFCLM   LA    RE,LSFIXNUM         CLEAR COLUMN INFORMATION                     
         ...
         MVCL  RE,R0                                                            
*                                                                               
         GOTOX APRG,RTPARM,('GCBOVER',OLIST),LDEFCLM                            
...
DCLM02   CLI   0(R2),EOT           ANY COMBINATIONS LEFT TO TRY?                
         BE    DCLM22              NO - NEED TO SET A DEFAULT                   
*                                                                               
...
DCLM14   XC    K.FDRKEY,K.FDRKEY   GET FIELD RECORD FOR THIS COLUMN             
         MVI   K.FDRKMIN,FDRKMINQ                                               
         MVI   K.FDRKTYP,FDRKTYPQ                                               
         MVC   K.FDRKSYS,GCOVSYS                                                
         MVC   K.FDRKPRG,GCPRGNO                                                
         MVC   K.FDRKREC,CSREC                                                  
         MVC   K.FDRKNUM,FCRFNUM                                                
         MVC   K.FDRKCTRY,CUCTRY                                                
         XI    K.FDRKCTRY,X'FF'                                                 
         MVI   K.FDRKSUB,X'FF'                                                  
         MVC   K.FDRKTEST,ASTEST    TEST                                        
...
*                                                                               
         ...
         BXH   R1,RF,*-12                                                       
*                                                                               
         CLI   FDRSEC,0            FIELD SECURITY SET?                          
         BE    DCLM16              NO                                           
         GOTOX ('FLDSEC',AGROUTS),FDRSEC                                        
         BL    DCLM12                                                           
         DROP  R1,K                                                             
*                                                                               
DCLM16   CLI   FCRTYPE,FCRTFIX     FIXED                                        
         BNE   DCLM18              NO                                           
...
*                                                                               
DCLM18   CLI   FCRTYPE,FCRTVAR     VARIABLE?                                    
         BNE   DCLM20              NO                                           
         ...
         B     DCLM12              CONTINUE ITERATING RECORD                    
*                                                                               
DCLM20   CLI   FCRTYPE,FCRTVOK     VALID FOR DISPLAY                            
         ...
         B     DCLM12              CONTINUE ITERATING RECORD                    
*                                                                               
DCLM22   OC    LSFIXNUM,LSFIXNUM   COLUMNS SET UP?                              
         BNZ   DCLMX               YES                                          
         OC    LSVARNUM,LSVARNUM                                                
         BNZ   DCLMX               YES                                          
...
K        USING FDRRECD,IOKEY                                                    
         ...
         DC    H'0'                                                             
*                                                                               
DCLM24   GOTOX ('GETFLD',AGROUTS),RTPARM,GFRSEQ,AIO1                            
         BNE   DCLMX                                                            
*                                                                               
DCLM26   CLC   K.FDRKEY(FDRKNUM-FDRKEY),IOKEYSAV                                
         BNE   DCLMX                                                            
*                                                                               
         L     R2,AIO1                                                          
         LA    R2,FDRFIRST(R2)                                                  
...
SUBMCH   XC    LCACTB,LCACTB                                                    
*                                                                               
SBMCH02  XC    X.FRAKEY,X.FRAKEY   BUILD ACTION RECORD                          
...
*                                                                               
         ...
         BNE   SUBMCHN                                                          
*                                                                               
         MVC   LCACTB,X.FRAKACT    SAVE CURRENT ACTION                          
*                                                                               
         ICM   R1,8,X.FRAKSYS                                                   
         ICM   R1,4,X.FRAKPRG                                                   
         ICM   R1,2,X.FRAKREC                                                   
...
SBMCH04  CLI   FRAEL,FRAELQ                                                     
         ...
         DC    H'0'                                                             
*                                                                               
SBMCH06  TM    FRAINDS1,FRA1SUB    SUB-ACTION?                                  
         BZ    SBMCH02             NO                                           
*                                                                               
         XR    RF,RF                                                            
         ...
         CLM   RF,1,FVILEN                                                      
         BH    SBMCH02             NOT ENOUGH CHARS INPUT FOR THIS ONE          
*                                                                               
         MVC   LCWORK1,BCSPACES                                                 
         MVI   LCWORK1,GE#ESCL                                                  
         MVC   LCWORK1+1(L'FRADICT),FRADICT                                     
...
*                                                                               
         ...
         B     SBMCH02                                                          
*                                                                               
SBMCH08  GOTOX AGEN,RTPARM,OACT,ATST,AIO1                                       
         BNE   SBMCH02             ACTION IS NOT VALID                          
*                                                                               
         LA    RE,TWASESRA         RECORD/ACTION ALREADY USED?                  
         XR    RF,RF                                                            
         ICM   RF,1,TWASESNL       NEST LEVEL                                   
         BCT   RF,*+8                                                           
         B     SBMCH10             NO - SAFE TO USE RECORD/ACTION               
                                                                                
         CLC   FRANREC(2),0(RE)                                                 
         BE    SBMCH02             YES - DO NOT REUSE IT THEN                   
         LA    RE,L'TWASESRA(RE)                                                
         BCT   RF,*-14                                                          
*                                                                               
SBMCH10  MVC   LSSUBFRA,0(R2)      SAVE SUB-ACTION ELEMENT                      
*                                                                               
         ...
         BL    SBMCH02             ACTION IS NOT VALID                          
         B     EXITOK                                                           
*                                                                               
...
*                                                                               
CONT04   TM    LSSTAT1,LSSMAIN     MAINTENANCE LIST?                            
         BO    CONT05              YES, SCROLL FIELD IS FOR SCREEN              
         GOTOX AGEN2,RTPARM,OPAGE,PGVAL                                         
         LH    RF,GSDSPACT                                                      
         A     RF,ATWA                                                          
         ST    RF,FVADDR                                                        
*                                                                               
CONT05   GOTOX ASCRVAMT            VALIDATE VERTICAL SCROLL AMOUNT              
*                                                                               
...
*                                                                               
         ...
         BZ    *+8                                                              
         AHI   R1,20               MAKE SURE YOU HAVE ENOUGH                    
         GOTOX ABLDLST,(R1)        BUILD PAGE 1 AT LEAST                        
         BL    EXITL                                                            
*                                                                               
CONT08   MVI   MSTBLD,C'Y'                                                      
         TM    LSSTAT1,LSSMAIN     MAINTENANCE LIST?                            
         BZ    *+8                 YES                                          
         MVI   MSTBLD,C'N'         DON'T REBUILD HERE                           
*                                                                               
...
CONT12   CLI   GSFRP.FRPTYPE,FRPTLEFT  HORIZONTAL SCROLL REQUEST?               
         ...
         BZ    CONT16              NO                                           
*                                                                               
CONT14   GOTOX ASETPAG                                                          
         MVC   LSLINE#,LSPAG#1     RE-DISPLAY CURRENT PAGE                      
         GOTOX ADISPAG                                                          
         B     CONT20                                                           
*                                                                               
...
***********************************************************************         
         ...
         DS    0H                                                               
         USING *,R7                                                             
SCRDOWN  OC    LSLST#X,LSLST#X     TEST EMPTY LIST                              
         BZ    SCRDOWNX            YES, CAN'T SCROLL                            
         LTR   R3,R1               R3 = SCROLL AMOUNT                           
...
***********************************************************************         
         ...
         DS    0H                                                               
         USING *,R7                                                             
SCRUP    OC    LSLST#X,LSLST#X     TEST EMPTY LIST                              
         BZ    SCRUPX              YES, CAN'T SCROLL                            
         TM    LSSTAT3,LS3RVAR     SPECIAL VARIABLE LIST                        
         BZ    SCRUP02             NO                                           
...
***********************************************************************         
         ...
         DS    0H                                                               
         USING *,R7                                                             
SETPAG   TM    LSSTAT3,LS3RVAR+LS3RFIX                                          
         BNZ   SPAG02                                                           
         MVC   LSLINPAG,LSROWPAG                                                
*                                                                               
         TM    LSSTAT1,LSSMUROW    MULTIPLE LINES PER RECORD                    
         BO    *+12                YES                                          
...
*                                                                               
SPAG01   TM    LSSTAT1,LSSMULIN    MULTIPLE RECORDS PER LINE                    
         BZ    SPAG02                                                           
...
*                                                                               
SPAG02   TM    LSSTAT3,LS3RVAR     VARIABLE NUMBER OF LINES ON SCREEN?          
         BZ    SPAG12                                                           
         TM    LSLTIND1,LSLTISOL   TEST ANYTHING IN LIST                        
         BO    SPAG04                                                           
...
*                                                                               
         ...
         DROP  R2                                                               
*                                                                               
SPAG08   OC    LSLINPAG,LSLINPAG   SEE HOW MANY RECORDS ON THIS SCRREN          
         BNZ   *+6                                                              
         DC    H'0'                TOO MANY LINES ON THIS TSAR RECORD           
*                                                                               
SPAG12   MVC   LSNUMPAG,LSLINPAG   SET MAX. NO OF LINES ON PAGE                 
*                                                                               
         ...
         BZ    *+8                                                              
         AHI   R1,20               MAKE SURE YOU HAVE ENOUGH                    
         CH    R1,LSLST#X          TEST WITHIN LIST                             
         BL    SETPAGX                                                          
...
*                                                                               
         ...
         B     SETPAGX                                                          
*                                                                               
SPAG14   CLC   LSPAG#X,LSLST#X     TEST WITHIN LIST NOW                         
         BNH   SETPAGX                                                          
...
*                                                                               
SETPAGX  CLI   MSTBLD,C'N'         TEST SET MUST NOT REBUILD                    
         MVI   MSTBLD,C' '                                                      
         BE    EXIT                                                             
...
*                                                                               
         ...
         L     RF,ACLRLINE                                                      
*                                                                               
DISPAG06 GOTOX (RF),(R1)                                                        
         AH    R1,LSLINLEN                                                      
*                                                                               
         TM    FHAT-FHD(R1),FHATXH                                              
         BZ    DISPAG03                                                         
         XR    RE,RE                                                            
         IC    RE,FHLN-FHD(R1)     DON'T GO PAST PFKEY LINE!!!!                 
         AR    RE,R1                                                            
         AHI   RE,-(FHDAD)         RE=A(EXTENDED FIELD HEADER)                  
         CLI   0(RE),FD#PFK                                                     
         BE    *+8                                                              
DISPAG03 BCT   R0,DISPAG06                                                      
*                                                                               
...
*                                                                               
         ...
         BE    VALIN20                                                          
*                                                                               
VALIN17  CLI   CSREC,O#DIS         COLUMN LIST                                  
         BE    VALIN20                                                          
*                                                                               
         MVC   LCBYTE,GSFRR.FRRINDS1  SAVE RECORD INDICATORS                    
...
RLINE04  TM    LSLTIND1,LSLTISOL   TEST WAS ONLY RECORD IN LIST                 
         ...
         BE    RLINE06             (HOW CAN IT BE IF WE JUST DELETED?)          
         LR    R1,R2                                                            
         GOTOX ACLRLINE,(R1)       CLEAR LAST LINE                              
...
ISCR08   STH   RF,LSREQROW         SAVE NUMBER OF REQUIRED ROWS                 
         B     ISCR11                                                           
*                                                                               
ISCR10   TM    LSSTAT3,LS3RVAR     TEST SELF-DEFINING COUNT                     
         BZ    ISCR11              NO                                           
*                                                                               
         LH    R2,LSPAG#1          FIRST ON PAGE                                
         XC    GCFULL2,GCFULL2                                                  
*                                                                               
ISCR10A  STH   R2,LCHALF                                                        
         GOTOX AGETITEM,LCHALF     GET LIST LINE                                
*                                                                               
         L     RF,ATLST                                                         
         XR    RE,RE                                                            
...
*                                                                               
         ...
         BNZ   *+8                                                              
         LHI   RF,1                                                             
         STH   RF,LSREQROW         SAVE NUMBER OF REQUIRED ROWS                 
*                                                                               
ISCR11   GOTOX ABLDTOP             BUILD TOP OF SCREEN                          
         LH    RF,LSNUMHED                                                      
         MH    RF,LSCOLROW                                                      
         AH    RF,LSHEDAD          ALLOW FOR HEADLINES                          
         STH   RF,LSTTPAD          SET A(FIRST TOP TOTAL LINE)                  
*                                                                               
         LH    RE,LSTOTTOP                                                      
         MH    RE,LSCOLROW                                                      
         AR    RF,RE                                                            
...
*                                                                               
         ...
         XR    RF,RF                                                            
         XR    R2,R2               SAVE LAST SCREEN ADDRESS IN R3               
*                                                                               
BTOP04   ICM   RF,1,FHLN           END OF SCREEN?                               
         BZ    BTOP06                                                           
         CLC   FHAD,LCHALF         BUILD AREA START?                            
         BNL   BTOP06                                                           
         ICM   R2,3,FHAD           CURRENT SCREEN ADDRESS                       
         BXH   R4,RF,BTOP04                                                     
         DROP  R4                                                               
*                                                                               
...
*                                                                               
         AH    R2,LSCOLROW         SET R2 TO ADDRESS OF NEXT LINE               
         TM    LSSTAT1,LSSMAIN                                                  
         BZ    *+8                                                              
         ICM   R2,3,GSLSTTOP       OR ADDRESS OF BUILD BLOCK                    
*                                                                               
         SRDL  R2,32               SET DATA SCREEN ADDRESS OF HEADLINE          
         LH    RF,LSCOLROW                                                      
         DR    R2,RF                                                            
         MH    R3,LSCOLROW         R3 = A(1ST COLUMN OF TOP OF LIST)            
*                                                                               
         TM    LSSTAT2,LSSBDR      TEST BORDER WITH THIS LIST                   
         BZ    *+12                NO                                           
         STH   R3,LSBDRTOP                                                      
         AH    R3,LSCOLROW                                                      
         STH   R3,LSHEDAD          R3 = A(1ST HEADLINE)                         
*                                                                               
         XC    LS1STKEY,LS1STKEY   SET DEFAULT CURSOR POSITION                  
         OC    LS1STKEY,GSDSPACT                                                
         BNZ   *+10                                                             
         OC    LS1STKEY,GSDSPREC                                                
*                                                                               
BTOP07   L     R4,ATWA                                                          
         AH    R4,GSDSPOVR                                                      
         USING FHD,R4                                                           
...
BTOP10   TM    LSSTAT1,LSSMAIN     MAINTENANCE LIST?                            
         BZ    BLDTOPX             NO                                           
*                                                                               
         LA    R4,TWASCR           REMOVE ANY FIELDS WITHIN THE                 
         USING FHD,R4              BOUNDARY OF MAINT LIST AREA                  
         XR    RF,RF                                                            
BTOP12   ICM   RF,1,FHLN           EOS?                                         
         BZ    BLDTOPX             YES - EOL = EOS                              
         CLC   FHAD,GSLSTEND                                                    
         BNL   *+8                                                              
         BXH   R4,RF,BTOP12                                                     
*                                                                               
         ...
         BE    BLDTOPX             YES - DO NOTHING                             
*                                                                               
         ICM   RF,1,FHLN           FIND EOS                                     
         BZ    *+8                                                              
         BXH   R4,RF,*-8                                                        
*                                                                               
         LR    RF,R4                                                            
         SR    RF,RE               RF = L'SCREEN AFTER EOL                      
         LR    R1,RF                                                            
*                                                                               
         LR    R4,R0                                                            
...
***********************************************************************         
         SPACE 1                                                                
         USING *,R7                                                             
BLDBOT   MVC   LSBOTDSP,LSHEDDSP   INITIAL DISP. TO BOTTOM OF SCREEN            
*                                                                               
         TM    LSSTAT1,LSSMAIN     TEST MAINTENANCE SCREEN                      
         BO    BBOT02                                                           
         GOTOX AGEN,RTPARM,OSCRN,SLSTBOT ??                                     
*                                                                               
BBOT02   LH    R4,LSBOTDSP                                                      
         A     R4,ATWA                                                          
         USING FHD,R4                                                           
         CLI   FHD,0               TEST ANY BOTTOM OF SCREEN                    
         BNE   *+12                                                             
         LHI   RF,COLS#Q*ROWS#Q    NO BOTTOM - USE SIZE OF DATA SCREEN          
         B     BBOT04                                                           
*                                                                               
         XR    RE,RE                                                            
         ICM   RE,3,FHAD                                                        
         TM    LSSTAT1,LSSMAIN     MAINTENANCE SCREEN?                          
         BZ    *+12                NO                                           
         ICM   RE,3,GSLSTEND       YES - USE A(END OF MAINT SCREEN)             
         AH    RE,LSCOLROW                                                      
*                                                                               
         LH    R0,LSCOLROW                                                      
         SRDL  RE,32                                                            
         DR    RE,R0                                                            
         MH    RF,LSCOLROW         RF = A(END OF MAINT SCREEN)                  
*                                                                               
BBOT04   LH    RE,LSNUMFTL         CALCULATE SCREEN ADDRESSES                   
         MH    RE,LSCOLROW                                                      
         SR    RF,RE                                                            
         STH   RF,LSFOOAD          SET A(FOOTLINES)                             
*                                                                               
         LH    RE,LSTOTBOT         NOW ALLOW FOR TOTALS LINES AT BOTTOM         
         MH    RE,LSCOLROW                                                      
         SR    RF,RE                                                            
         STH   RF,LSTBTAD          SET A(BOTTOM TOTAL LINES)                    
         STH   RF,LSBOTAD          SET A(BOTTOM OF LIST)                        
*                                                                               
         TM    LSSTAT2,LSSSIZE     SIZING SCREEN?                               
         BZ    BBOT06              NO                                           
         OC    LSREQROW,LSREQROW   ANY ROW COUNT REQUESTED?                     
         BZ    BBOT06              NO                                           
*                                                                               
         LH    RF,LSLINAD          MAKE SURE IT WILL FIT                        
         LH    RE,LSREQROW                                                      
         MH    RE,LSCOLROW                                                      
         AH    RF,LSCOLROW                                                      
         AR    RF,RE                                                            
         CH    RF,LSBOTAD                                                       
         BH    BBOT06              NO IT WON'T                                  
*                                                                               
         STH   RF,LSFOOAD                                                       
         LH    RE,LSTOTBOT                                                      
         MH    RE,LSCOLROW                                                      
         ...
         STH   RF,LSBOTAD                                                       
*                                                                               
BBOT06   TM    LSSTAT2,LSSBDR      DOING A BORDER?                              
         BZ    BBOT08              NO                                           
         ...
         STH   RF,LSTBTAD                                                       
*                                                                               
BBOT08   LH    R0,LSNUMFTL         R0 = # FOOTLINES                             
         AH    R0,LSTOTBOT            + # BOTTOM TOTALS LINES                   
         BZ    BBOT12                                                           
*                                                                               
F        USING FHD,BSFOOT                                                       
...
*                                                                               
         ...
         STH   RE,LSFOODSP                                                      
*                                                                               
         LH    RF,LSFOOAD          SET BLDROW PARMS                             
         GOTOX ,RTPARM,(RF),FHD,BSFOOT                                          
*                                                                               
         L     RF,ABLDROW                                                       
BBOT10   LNR   RE,R0               SET HELP NUMBER                              
         STC   RE,0(R5)                                                         
...
BBOT12   TM    LSSTAT2,LSSBDR      TEST FOR BORDER                              
         BZ    BBOT14                                                           
         GOTOX ABORDER,RTPARM,FHD  DRAW IT                                      
         L     R4,0(R1)                                                         
*                                                                               
BBOT14   MVC   FHD(L'EOS),EOS                                                   
...
BSCR16   LHI   R4,1                                                             
         ...
         LH    R4,LSROWLIN                                                      
*                                                                               
         TM    LSSTAT3,LS3RVAR     TEST SELF-DEFINING COUNT                     
         BZ    BSCR18              NO                                           
*                                                                               
         L     R2,ATLST                                                         
         USING TLSTD,R2                                                         
*                                                                               
         LA    RE,TLREC            CLEAR TSAR RECORD BUFFER                     
         LHI   RF,L'TLREC                                                       
         XR    R1,R1                                                            
         MVCL  RE,R0                                                            
*                                                                               
         ...
         BZ    BSCR18                                                           
*                                                                               
         STCM  RF,3,TLNUM          GET TSAR RECORD                              
         AHI   RF,1                                                             
         STH   RF,LCHALF                                                        
*                                                                               
         GOTOX ('TSARIO',AGROUTS),TSAGET                                        
...
*                                                                               
         ...
         BH    BHED12                                                           
         MVC   H1.FHD(0),T1.FHD                                                 
         EX    R5,*-6              COPY TO TOP HEADLINE                         
         AR    R3,R5                                                            
         B     BHED18                                                           
*                                                                               
BHED12   DS    0H                  COPY TO BOTTOM HEADLINE                      
         MVC   H2.FHD(0),T1.FHD                                                 
         EX    R5,*-6              COPY TO BOTTOM HEADLINE                      
         ICM   RE,3,H2.FHAD                                                     
         SH    RE,LSCOLROW                                                      
         STCM  RE,3,H2.FHAD                                                     
         AR    R2,R5                                                            
         B     BHED18                                                           
*                                                                               
BHED14   DS    0H                  COPY HEADLINES 1 & 2                         
         MVC   H1.FHD(0),T1.FHD                                                 
         EX    R5,*-6              COPY HEADLINES 1 & 2                         
         AR    R3,R5                                                            
         MVC   H2.FHD(0),T2.FHD                                                 
         EX    R5,*-6                                                           
         AR    R2,R5                                                            
...
*                                                                               
         ...
         OI    FDRINDS1,FDR1PRO    VALID FOR READ ONLY                          
*                                                                               
ADLN03   XR    R0,R0               FLAG NEW ROW REQUEST UNPROCESSED             
ADLN04   XR    RE,RE                                                            
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'111GEFIL03   08/10/11'                                      
         END                                                                    
