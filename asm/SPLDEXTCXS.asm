*          DATA SET SPLDEXTCXS AT LEVEL 034 AS OF 05/12/00                      
*PHASE SPEXTCZ                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE RECUP                                                                  
...
TABINI10 DS    0H                                                               
         CLC   QSTART,SPACES                                                    
         BE    TABINI12                                                         
         GOTO1 LDATCON,DMCB,QSTART,(2,MVSTDATE)                                 
*                                                                               
TABINI12 CLC   QEND,SPACES                                                      
         BE    TABINI14                                                         
         GOTO1 LDATCON,DMCB,QEND,(2,MVNDDATE)                                   
*                                                                               
TABINI14 CLI   QOPT1,C'Y'          TEST FOR BUYS CONVERSION                     
         BNE   *+8                                                              
         MVI   MVBUYS,C'Y'                                                      
*                                                                               
...
*                                                                               
         ...
         BNE   HDRKEYCN                                                         
*                                                                               
         OC    EKEYPRD(9),EKEYPRD  KEEP IF CLIENT HEADER                        
         BNZ   HDRKEY10                                                         
*                                                                               
...
*                                                                               
         ...
         BNZ   HDRKEYCN                                                         
*                                                                               
         CLI   MVEST,C'Y'          DROP IF NOT MOVING PRODUCT HEADER            
         BE    HDRKEYCN                                                         
         B     HDRKEYFD                                                         
*                                                                               
HDRKEYCN DS    0H                                                               
...
*                                                                               
         ...
         BH    BUYPAYCN                                                         
*                                                                               
         OC    MVSTDATE,MVSTDATE   ANY START DATE                               
         BZ    BUYPAYL2                                                         
         CLC   RDATE,MVSTDATE                                                   
         ...
         B     BUYPAYLP                                                         
*                                                                               
BUYPAYL2 OC    MVNDDATE,MVNDDATE   ANY END DATE                                 
         BZ    BUYPAYL4                                                         
         CLC   RDATE,MVNDDATE                                                   
         BNH   BUYPAYL4                                                         
         MVI   PRTFLAG,C'E'                                                     
...
*                                                                               
         OC    MVSTDATE,MVSTDATE   SKIP IF NO DATE RANGE SPECIFIED              
         BNZ   *+14                                                             
         OC    MVNDDATE,MVNDDATE                                                
         BZ    GLELMDN                                                          
*                                                                               
...
*                                                                               
         ...
         B     GLELMLP                                                          
*                                                                               
GLELML2  OC    MVNDDATE,MVNDDATE   ANY END DATE                                 
         BZ    GLELML4                                                          
         CLC   GLWEEK,MVNDDATE                                                  
         BNH   GLELML4                                                          
         MVI   PRTFLAG,C'E'                                                     
...
*                                                                               
         L     R1,=A(FILEOUT)                                                   
         PUT   (1),RRLEN           WRITE TO OUTPUT FILE                         
*                                                                               
WRITEX   DS    0H                                                               
         XIT1                                                                   
*                                                                               
...
MVSTDATE DS    XL2                 START DATE                                   
MVNDDATE DS    XL2                 END DATE                                     
...
GOALRECD DSECT                                                                  
       ++INCLUDE SPGENGOAL                                                      
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034SPLDEXTCXS05/12/00'                                      
         END                                                                    
*                                                                               
