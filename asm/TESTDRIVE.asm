*          DATA SET TESTDRIVE  AT LEVEL 048 AS OF 05/01/02                      
*PHASE T7029EA,*                                                                
...
OUTLDT2  TM    GLARGS,X'40'                                                     
         ...
         CLI   MYLTYP,C'M'                IF THIS IS A MIDLINE                  
         BNE   XIT                                                              
         GOTO1 SQUASHER,DMCB,GLAOFLD,20   SQUASH THE DATA                       
         B     XIT                                                              
         EJECT                                                                  
*              CAST DETAILS                                                     
         SPACE 1                                                                
...
OUTUSDET DS    0H                                                               
         ...
         LA    R3,1(R3)                                                         
         SPACE 1                                                                
         CLI   10(R2),C'Y'         IF THIS IS FOR LIFT                          
         BNE   *+12                                                             
...
UDTLO1D  CLI   FORMAT,TAEPFQTR     IF FORMAT Q                                  
         ...
         LA    R3,4(R3)                                                         
         SPACE 1                                                                
UDTLO1X  LH    RF,3(R2)            N'USES PAID PREVIOUSLY                       
...
UDTLO8   CLI   13(R2),PROCAUTO                                                  
         ...
         SPACE 1                                                                
         GOTO1 SQUASHER,DMCB,BLOCK,50  SQUASH EVERYTHING TOGETHER               
         ZIC   R1,MYOLEN                                                        
         BCTR  R1,0                                                             
         EX    R1,*+8                                                           
         B     *+10                                                             
...
OUTTOTRQ DS    0H                  TURN THEM OFF                                
         NI    GLINDS,ALL-GLPALTOT-GLPALDET  TURN OFF ALL DTLS ALSO             
...
MUSICLIT DC    C'N',CL10'MUSIC NET ',CL20'MUSIC NET'                            
         ...
         DC    C'N',CL10'CSF       ',CL20'CONTRACT SERVICE FEE'                 
...
NETLIT   DC    C'N',CL10'NET        ',CL20'NET'                                 
         DC    C'N',CL10'AGY COMM  ',CL20'AGENCY COMMISSION'                    
...
* TASYSEQUS                                                                     
       ...
       ++INCLUDE TASYSEQUS                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'048TESTDRIVE 05/01/02'                                      
         END                                                                    
