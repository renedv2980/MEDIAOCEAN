*          DATA SET FRFTXXXTST AT LEVEL 010 AS OF 05/01/02                      
*PHASE FTPXXXTS,*,NOAUTO                                                        
***************************  use special panS procs                             
DVGCXASM START                                                                  
* /***START OF SPECIFICATIONS*****************************************/         
*              C'DDSFTP.FROE.XXX.XXXX.TST'    test transmission                 
* /*                                                                 */         
...
** TRANSFER PARAMETERS FOLLOW             PAGE 80                               
         ...
         MVC APLSNUID(4),=C'FROE'         REPORT USER-ID                        
...
*/*-----------------------------------------------------------------*/          
MVSDSN   DC    C'DDSFTP.FROE.XXX.XXXX.TST'     test file                        
         DS  0D                                                                 
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010FRFTXXXTST05/01/02'                                      
         END                                                                    
