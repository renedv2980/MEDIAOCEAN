*          DATA SET ACREPTT201 AT LEVEL 106 AS OF 08/07/02                      
*PHASE ACTT02A,*                                                                
*INCLUDE SORTER                                                                 
*INCLUDE DLFLD                                                                  
*INCLUDE CONVMOS                                                                
...
*                                                                               
         ...
         LA    R1,CPYTAB1                                                       
         ST    R1,ACPYTAB1         SET UP ADDRESS FOR CPYTAB1                   
*                                                                               
...
*                                                                               
         ...
         MVI   FCRDHIST,C'Y'                                                    
*                                                                               
         BAS   RE,BLDCPY           BUILD COMPANY TABLE                          
*                                                                               
...
*EQF20   CLC   ALPHAID,0(R1)       FOR LIMITED ACCESS                           
*        BE    REQF30                                                           
*        LA    R1,L'TRNTAB(R1)                                                  
*        BCT   R0,REQF20                                                        
*                                   ****HARDCODED FOR NOW********               
...
REQF30   L     R3,ACPYTAB          COMPANY TABLE                                
         MVI   QOPT9,C'Y'          DELETE BEFORE IT GOES LIVE                   
         CLI   QOPT9,C'Y'          ARE WE RUNNING OFF NEW TABLE?                
         BNE   *+8                                                              
         L     R3,ACPYTAB1                                                      
*                                                                               
         MVI   FOUNDIT,C'N'                                                     
...
REQLX    CLI   QOPT1,C'Y'          IF LIVE RUN - MARK T99 RECORD                
         BNE   REQLXX                                                           
         CLI   QOPT9,C'Y'          ONLY MARK IF READING RECS                    
         BNE   REQLXX                                                           
...
BLDCPY   NTR1                                                                   
         USING CPYTABD,R3                                                       
         L     R3,ACPYTAB1         WORK AREA FOR COMPANY TABLE                  
...
*                                                                               
         USING ADRELD,R2                                                        
BLDCPY40 MVC   CADDR,ADRLINE1      MOVE IN ALL 3 ADDRESSES                      
...
BLDCPY60 CLI   FFTTYPE,FFTTCNAM    NAME ELEMENT?                                
         ...
         B     BLDCPY25                                                         
*                                                                               
         CLI   FFTTYPE,FFTTTNNI    1099 TAX INFO                                
         BNE   BLDCPY25                                                         
...
*                                                                               
         ...
         MVC   TVNDCEM,=C'RAJIV.GUPTA@DONOVANDATA.COM'                          
*                                                                               
...
*        DC    C'*B'               READ TRANSACTIONS - NOT BUCKETS              
...
ACPYTAB1 DS    A                   A(COMPANY TABLE) USING GETMAIN               
CPYTABLN DS    F                   LENGTH OF AREA                               
...
CPYTAB1  DS    CL500               COMPANY TABLE                                
CPYTAB1Q EQU   *-CPYTAB1           LENGTH OF TABLE                              
*                                                                               
SRECA    DS    CL750                                                            
...
TVNDCEM  DS    CL20                VENDOR'S CONTACT'S E-MAIL ADDRESS            
         DS    CL(750-(*-TREC))                                                 
****     DS    CL375                                                            
TLENQ    EQU   (*-TREC)                                                         
         EJECT                                                                  
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE DDDLCB                                                         
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'106ACREPTT20108/07/02'                                      
         END                                                                    
