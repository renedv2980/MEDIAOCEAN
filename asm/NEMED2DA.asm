*          DATA SET NEMED2DA   AT LEVEL 019 AS OF 05/01/02                      
*PHASE T31E2DA,+0                                                               
*INCLUDE NETNET                                                                 
*INCLUDE SPBVAL                                                                 
*INCLUDE KHDUMMY                                                                
...
*                                                                               
*    *** NOTE NEMED2DA DATA SET  IS  TSTING/CHKING VERSION****                  
*                                                                               
...
NC05     OC    COFFICE,COFFICE                                                  
         ...
         GOTO1 =V(OFFOUT),DMCB,COFFICE,HEXOUT,(C'L',CLCLI+7)                    
...
DOBILL   TM    NUBILST,X'20'       SKIP UNBILLED                                
         ...
         DROP  R1                                                               
****     GOTO1 =V(PRNTBL),DMCB,=C'TIM',NUBILGRS,C'DUMP',4,=C'1D'                
...
NO       EQU   C'N'                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019NEMED2DA  05/01/02'                                      
         END                                                                    
