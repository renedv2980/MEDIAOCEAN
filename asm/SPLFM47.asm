*          DATA SET SPLFM47    AT LEVEL 069 AS OF 05/01/02                      
*PHASE T21947A                                                                  
         TITLE 'SPLFM47 - SHARE RECORDS'                                        
T21947   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T21947                                                         
         L     RC,0(R1)                                                         
...
FMT40    DS    0H                                                               
         ...
         ED    8(7,R2),SHRPCT                                                   
         FOUT  (R2)                                                             
         AP    PCTOTS,SHRPCT       ADD TO PCT TOTS                              
         SPACE                                                                  
         ZIC   R0,0(R2)                                                         
         AR    R2,R0               ACT-COL2                                     
         ZIC   R0,0(R2)                                                         
...
EDT20    LA    RE,REC                                                           
         ...
         XCEF                                                                   
         MVC   REC(13),SVKEY                                                    
         MVI   REC+14,29           LENGTH OF SHRREC WITHOUT 05 ELEM             
         MVC   SHRAGYA,AGYALPHA                                                 
         SPACE                                                                  
* BUILD THE 01 ELEMENT                                                          
         MVC   0(2,R3),=X'0105'                                                 
EDT20A   GOTO1 VDATCON,DMCB,(5,0),(3,SHRACDAT)       NEW ACT DATE               
         SPACE                                                                  
...
*                                                                               
       ...
       ++INCLUDE SPGENSHR                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'069SPLFM47   05/01/02'                                      
         END                                                                    
