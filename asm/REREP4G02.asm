*          DATA SET REREP4G02  AT LEVEL 132 AS OF 07/17/02                      
*PHASE RE4G02C,*                                                                
         TITLE 'RE4G02 - REREP4G02 - INTEREP INTERFACE TAPE'                    
**********************************************************************          
...
*                                                                   *           
* JUL13/95 (BU ) --- THIS IS A CLONE OF THE 37 REPORT FOR TYPE N    *           
*                    CONTRACTS.                                     *           
*                                                                   *           
...
POST220  EQU   *                                                                
         ...
         CLC   ENDDT(2),RCONBKYR-RCONBKEL(R3)                                   
         BNE   POST220                                                          
         ZICM  R0,RCONBKAM-RCONBKEL(R3),4                                       
         BNZ   POST230                                                          
         LA    R7,1                                                             
         B     POST220                                                          
POST230  EQU   *                                                                
...
CONCNT   DS    F                                                                
*                                                                               
VDEMOCON DS    A                   * NEW CODE FOR DEMOCON                       
*                                                                               
...
EOUT260  EQU   *                                                                
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'132REREP4G02 07/17/02'                                      
         END                                                                    
