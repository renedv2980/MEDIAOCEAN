*          DATA SET PCSPANKERA AT LEVEL 059 AS OF 05/01/02                      
*PHASE SPANKERB                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE CARDS                                                                  
*INCLUDE DMDMGRL                                                                
...
**************************************************************                  
*  MAY07/98 (BU ) --- ADD 0E/1F/46/47 RECORDS TO REP TABLE   *                  
**************************************************************                  
         SPACE 1                                                                
SPANKER  CSECT                                                                  
         PRINT NOGEN                                                            
...
VALOUTC  MVC   0(2,R2),=C'??'                                                   
         ...
         BE    VALOUTD             SO FEW USERS, IT'S NOT FATAL                 
         DROP  RE                                                               
         CLI   TESTOPT,C'Y'                                                     
         BNE   VALOUTX                                                          
VALOUTD  MVC   P(80),CARD                                                       
         GOTO1 VPRINTER                                                         
         B     VALOUT7                                                          
*                                                                               
VALOUTX  DS    0H                                                               
...
**       CLC   =X'2D024A',0(R4)                                                 
**       BNE   AC99NO                                                           
**       B     AC99YES             Y R SCRIBE RECORDS ONLY                      
**                                                                              
         CLI   0(R4),X'4A'         POSTAL Y&R                                   
         BNE   AC99NO                                                           
         CLI   1(R4),X'40'                                                      
...
ACFILT2  CLI   0(RE),X'FF'                                                      
         ...
         B     ACFILT2                                                          
*                                                                               
ACFILT4  CLC   =C'SJ',1(R4)        NO TRANS ON SJ                               
         BE    ACFILT6                                                          
         CLC   =C'2D',1(R4)        NO TRANS ON 2D                               
         BNE   AC99YES                                                          
ACFILT6  CLC   17(15,R4),SPACES                                                 
         BH    AC99NO                                                           
*                                                                               
...
PARMTAB  DS    0CL20                                                            
         ...
         DC    AL1(7),C'OUTPUT0=',AL3(VALOUT),AL1(35),7X'00'                    
...
SYSTAB   DS    0CL19                                                            
         ...
         DC    C'SPOTFILE',X'02',AL3(SPTDEFN)    ABNORMAL SPELLING              
         DC    AL2(13,13,24),X'00'                                              
         DC    C'SPTFILE ',X'02',AL3(SPTDEFN)     NORMAL SPELLING               
         DC    AL2(13,13,24),X'00'                                              
...
SPTDEFN  DS    0C                                                               
         ...
         DC    AL1(4,AGYL)                                                      
         DC    X'0D360D38',AL1(00,00),AL1(19),X'00',AL3(0)                      
         DC    AL1(2,AGYL)                                                      
...
XSPDEFN  DS    0C                                                               
         DC    X'00000000',AL1(00,00),AL1(01),X'40',AL3(0)                      
         DC    AL1(0,0)                                                         
         DC    X'0D0C0D0C',AL1(00,00),AL1(05),X'00',AL3(0)                      
         DC    AL1(2,AGYL)                                                      
         DC    X'0E030E05',AL1(00,00),AL1(02),X'00',AL3(0)                      
         DC    AL1(2,AGYL)                                                      
...
REPDEFN  DS    0C                                                               
         ...
         DC    AL1(20,AGYA)                                                     
         DC    X'430043FF',AL1(00,00),AL1(50),X'00',AL3(0)                      
         DC    AL1(07,AGYA)                                                     
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'059PCSPANKERA05/01/02'                                      
         END                                                                    
