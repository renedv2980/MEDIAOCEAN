*          DATA SET REAURCR    AT LEVEL 186 AS OF 02/05/07                      
*PHASE REAURCRA,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
*                                                                               
         ...
         LA    R3,MTHTBL                                                        
*                                                                               
*   FORMAT OF TABLE: (15 OCCURRENCES OF FOLLOWING)                              
...
**********************************************************************          
         ...
         B     REBU0160                                                         
*                                                                               
REBU0040 CLI   RBUYTYP,C' '        ANY PROGRAM TYPE?                            
         BE    REBU0050            NO                                           
...
REBU0070 LR    R3,R2               SAVE A(CURRENT SDD RECORD)                   
         MVC   BFDPT(2),0(R2)      SET DAYPART INTO BUFF RECORD                 
REBU0080 ZIC   R5,2(R2)            LOOP CONTROL: # TIME ELTS FOR DP             
         LA    R2,3(R2)            SET A(1ST TIME ELT OF DP)                    
REBU0090 ZIC   RE,0(R2)            SET DAY OF D/T STRING                        
...
REBU0120 LA    R2,5(R2)            BUMP TO NEXT SDD D/T STRING                  
...
*                                                                               
REBU0140 BAS   RE,NEXTEL           GET BUY'S NEXT D/T ELEMENT                   
...
BFSPACE  DS    CL2                 **WARNING:  THIS IS FOR ALIGNMENT            
...
*                                                                               
         ...
         B     *+8                                                              
*                                                                               
ADDA0010 BAS   RE,SEQBUFF          RETRIEVE NEXT BUFFALO RECORD                 
...
*                                                                               
         ...
         MVC   RAURLEN,=H'58'      SET RECORD LENGTH                            
         LA    R4,RAURCODE         A(DESCRIPTIVE ELEMENT)                       
         ZIC   RE,1(R4)            GET ELEMENT LENGTH (12 INITIALLY)            
         AR    R4,RE               SET A(NEXT ELEMENT)                          
*                                                                               
         USING RAURSCDT,R4                                                      
*                                                                               
...
ADDA0110 EQU   *                                                                
         ...
         BNZ   ADDA0010            DOESN'T FIT - ERROR MESSAGE PRINTED          
...
PSEUDO   NMOD1 0,*PSEU*                                                         
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'186REAURCR   02/05/07'                                      
         END                                                                    
