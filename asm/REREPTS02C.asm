*          DATA SET REREPTS02C AT LEVEL 002 AS OF 02/24/00                      
*PHASE RETS02C,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH2                                                               
...
*INCLUDE PERVERT                                                                
*INCLUDE XSORT                                                                  
         TITLE 'REREPTS02  (RETS02C) --- SWEEP FILES FOR CANCELS '              
*                                                                               
********************************************************************            
*                                                                  *            
*                                                                  *            
*        REREPTS02  -- SWEEP FILES FOR REP TO SPOT BUYLINE         *            
*                      CANCELS                                     *            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
...
*                                                                               
MAIN0260 EQU   *                                                                
         CLI   RBUYCHGI,C'C'       BUY DELETED?                                 
         BE    MAIN0280            YES - PROCESS                                
         CLI   RBUYCHGI+1,C'C'     BUY DELETED?                                 
         BNE   MAIN0220            NO  - READ NEXT                              
MAIN0280 EQU   *                                                                
         GOTO1 HEXOUT,DMCB,STARTKEY+12,P+1,4,=C'TOG'                            
         MVC   P+12(2),RBUYKREP                                                 
         L     RF,CONCTR2                                                       
         LA    RF,1(RF)                                                         
         ST    RF,CONCTR2                                                       
         EDIT  CONCTR2,(6,P+20)                                                 
         GOTO1 REPORT              PRINT CONTRACT NUMBER                        
         B     MAIN0060            GO BACK FOR NEXT CONTRACT                    
***>>>                                                                          
MAIN0800 EQU   *                                                                
...
*********************************************************************           
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002REREPTS02C02/24/00'                                      
         END                                                                    
