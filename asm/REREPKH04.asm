*          DATA SET REREPKH04  AT LEVEL 028 AS OF 05/01/02                      
*PHASE REKH02E,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
*INCLUDE XSORT                                                                  
         TITLE 'REREPKH04 (REKH02E) - NEW REP V5 FILE EXTRACT/CREATION'         
*                                                                               
********************************************************************            
*                                                                  *            
*        REREPKH02 -- EXTRACTS AND CREATES A NEW FILE WITH REP     *            
*                      CODE V5 FROM SELTEL INTERNATION             *            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
...
*                                                                               
         MVC   OLDREP,QRECORD+34   SAVE SOURCE REP CODE                         
         MVC   NEWREP,QRECORD+36   SAVE TARGET REP                              
         MVC   MASTREP,QRECORD+38  SAVE MASTER REP                              
...
REPRPROC NTR1                                                                   
         ...
         MVC   RREPKREP,NEWREP     NEW REP CODE                                 
...
AGY15    EQU   *                                                                
         ...
         BNE   AGY20                                                            
         CLC   KEY+25(2),MASTREP   MASTER REP?                                  
         ...
         CLI   QUESTOR+2,C'Y'                                                   
         BNE   AGY12                                                            
         CLC   AGYCTR,=F'50'       DISPLAY FIRST N AGENCY RECORDS               
         BH    AGY12                                                            
         MVC   P+1(8),=C'XX  AGY:'                                              
         MVC   P+1(2),=C'0A'                                                    
         CLI   KEYTYPE,X'0A'                                                    
...
ADV15    EQU   *                                                                
         ...
         BNE   ADV20               NO                                           
         CLC   KEY+25(2),MASTREP   MASTER REP CODE?                             
...
**       BH    CONT15                                                           
         ...
         CLI   QUESTOR+6,C'Y'                                                   
         BNE   CONT33                                                           
         CLC   CONCTR,=F'50'       DISPLAY FIRST N RECORDS                      
         BH    CONT33                                                           
         MVC   P+1(8),=C'CON REC:'                                              
         MVC   P+10(27),RCONKEY                                                 
         GOTO1 REPORT                                                           
...
BUY20    DS    0H                                                               
         ...
         CLI   QUESTOR+7,C'Y'                                                   
         BNE   BUY30                                                            
         CLC   BUYCTR,=F'50'       DISPLAY FIRST N BUY RECORDS                  
         BH    BUY30                                                            
         MVC   P+1(8),=C'BUY LNE:'                                              
         MVC   P+10(27),RBUYKEY                                                 
         GOTO1 REPORT                                                           
...
MASTREP  DC    CL2'K3'             MASTER REP CODE                              
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028REREPKH04 05/01/02'                                      
         END                                                                    
