*          DATA SET DDTRMORCP  AT LEVEL 145 AS OF 05/01/02                      
*PHASE DDTRMORC                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE CARDS                                                                  
         SPACE 1                                                                
         TITLE 'DDTRMORCP TEST COMPRESSION '                                    
         PRINT NOGEN                                                            
         EJECT                                                                  
COMP     CSECT                                                                  
         NBASE WORKX-WORKD,XXCOMPEX,R9,WORK=V(REGSAVE),CLEAR=YES                
         USING WORKD,RC                                                         
         ST    RD,SAVERD                                                        
*                                                                               
...
*                                                                               
         ...
         ICM   RF,15,20(R6)                                                     
         ICM   RE,15,16(R6)                                                     
         SR    RF,RE               RF = TOTAL ELAPSED TUS                       
         AH    RF,HALF             ADD IP QUEUE TIME                            
         EDIT  (RF),(6,ELAPSED),2                                               
*                                                                               
         MVC   FULL,12(R6)         SIN                                          
         GOTO1 =V(HEXOUT),DMCB,FULL,SIN,4                                       
         MVC   FULL,24(R6)                                                      
         GOTO1 =V(HEXOUT),DMCB,FULL,CPU,4                                       
         MVC   HALF,28(R6)                                                      
         GOTO1 =V(HEXOUT),DMCB,HALF,QUEUE,2                                     
         MVC   HALF,30(R6)                                                      
         GOTO1 =V(HEXOUT),DMCB,HALF,INPUT,2                                     
         MVC   HALF,32(R6)                                                      
         GOTO1 =V(HEXOUT),DMCB,HALF,OUTPUT,2                                    
         MVC   HALF,34(R6)                                                      
         GOTO1 =V(HEXOUT),DMCB,HALF,IOS,2                                       
         MVC   HALF,36(R6)                                                      
         GOTO1 =V(HEXOUT),DMCB,HALF,OVS,2                                       
         MVC   DATE,52(R6)                                                      
*                                                                               
         B     EXIT                                                             
         EJECT                                                                  
...
*FADSYSLSTD                                                                     
       ++INCLUDE FASYSLSTD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'145DDTRMORCP 05/01/02'                                      
         END                                                                    
