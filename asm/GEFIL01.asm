*          DATA SET GEFIL01    AT LEVEL 048 AS OF 08/10/11                      
*          DATA SET GEFIL01    AT LEVEL 045 AS OF 04/19/06                      
*&&      SET   NOP=N                                                            
*PHASE T00AB1C                                                                  
...
SCRTABL  DC    AL1(SKEY),AL1(0,0,0),AL4(SCRKEY)         1                       
         ...
         DC    AL1(SLAST),AL1(0,0,0),AL4(SCRLAST)      18                       
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
...
SKEY02   GOTOX AGEN,RTPARM,OSCRN,SMOD,('SOLDQ',FSRKPKEY)                        
         GOTOX (RF),(R1),OKEY,KFLD PROCESS 'KEY' FIELD IF ON SCREEN             
...
*                                                                               
SKEY06   GOTOX AGEN,RTPARM,OKEY,KFLD  PROCESS 'KEY' FIELD IF PRESENT            
...
*                                                                               
         ...
         SPACE 2                                                                
***********************************************************************         
* SCROLL MAINTENANCE SCREEN TO LAST PAGE                         * 18 *         
*                                                                ******         
*                                                                     *         
***********************************************************************         
         SPACE 1                                                                
SCRLAST  XR    R1,R1               INCREMENT PAGE NUMBER                        
SCRL10   IC    R1,GSSMPAGE                                                      
         AHI   R1,1                                                             
         STCM  R1,1,RTSPAG#                                                     
         STCM  R1,1,GSSMPAGE                                                    
         GOTOX SCRMNT,(R1)                                                      
...
*                                                                               
         MVC   M.FHD(0),R.FHD                                                   
         EX    RF,*-6              YES - ADD FIELD TO SCREEN                    
         AR    R3,RF                                                            
         B     SRES16                                                           
*                                                                               
...
*                                                                               
SRES14   MVC   M.FHD(0),C.FHD                                                   
         EX    RF,*-6              NO - ADD FIELD TO SCREEN                     
         AR    R2,RF                                                            
*                                                                               
...
*                                                                               
         ...
         GOTOX VHELLO,RTPARM,(C'G',=C'GENFIL'),('SPRELQ',(RF)),0                
         CLI   12(R1),0                                                         
...
*                                                                               
         ...
         XC    GSLSTEND,GSLSTEND                                                
         NI    GCINDS1,FF-GCIMLPRC SET MAINTENANCE LIST NOT PROCESSED           
*                                                                               
         GOTOX SCRSET,RTPARM,('RTSSISCR+RTSSIBLK',(R0)),(R2)                    
         BNE   SCRMNTH                                                          
*                                                                               
         ICM   RF,15,8(R1)         SAVE A(1ST NON-LIST INPUT FIELD)             
         BZ    *+12                                                             
         S     RF,ATWA                                                          
         STCM  RF,3,GS1STREC                                                    
         L     R2,4(R1)                                                         
...
*                                                                               
         ...
         OC    LS1STINP,LS1STINP                                                
         BZ    SMNT06              LIST HAS NO INPUT                            
         OC    GS1STREC,GS1STREC                                                
         BZ    *+14                NO NON-LIST INPUT FIELDS                     
         CLC   GS1STREC,LS1STINP                                                
         BL    SMNT06              NON-LIST I/P IS BEFORE LIST INPUT            
         MVC   GS1STREC,LS1STINP   LIST MUST BE FIRST INPUT FIELD               
*                                                                               
...
*                                                                               
         ...
         GOTOX  VHELLO,RTPARM,(C'G',=C'GENFIL'),('PNMELQ',(RF)),0               
         CLI    12(R1),0                                                        
         BNE    *+14                NO PAGE NAME                                
         L      RF,12(R1)                                                       
...
SSET16   IC    RE,EOL.FSRLN        ITERATE RECORD                               
         ...
         B     SSET14                                                           
*                                                                               
SSET18   MVI   FHIL,3              END OF LIST NOT YET SET                      
...
*                                                                               
         ...
         BO    KFDIS03             NO TAG                                       
         LR    R0,RF                                                            
         GOTOX AGEN,RTPARM,ODATA,DLHED,(RF),RTTAG                               
         BL    EXITL               ERROR ON DISPLAY OF TAG FIELD                
         LR    RF,R0                                                            
*                                                                               
KFDIS03  TM    FDRLVL-FDRELD(RF),FDRIKEY  KEY FIELD?                            
         BZ    KFDIS04             NO                                           
*                                                                               
...
*                                                                               
         TM    FDRINDS1,FDR1XTAG   TAG FIELD ASSOCIATED?                        
         BO    KFVAL03             NO                                           
         GOTOX AGEN,RTPARM,ODATA,DLHED,(R4),RTTAG                               
         BL    EXITL               ERROR ON DISPLAY OF TAG FIELD                
*                                                                               
KFVAL03  TM    GCINDS1,GCIPROT     RESET IF KEY CHANGES                         
         BO    KFVAL04             NO                                           
         TM    FVIXUS1,FVX1PRO     IS THIS KEY UNPROTECTED NORMALLY?            
         BO    KFVAL06             YES                                          
*                                                                               
...
VERBTAB  DC    AL1(DDIS),AL4(DTADIS)   DISPLAY                                  
         ...
         DC    AL1(DLHED),AL4(DTALHED) SET LIST SCREEN TAG FIELD                
...
*                                                                               
         ...
         SPACE 2                                                                
***********************************************************************         
* SET LIST SCREEN TAGS IF REQUIRED                                    *         
*                                                                     *         
* NTRY: P3 = SEQUENCE NUMBER                                          *         
*       P4 = TAG FIELD                                                *         
***********************************************************************         
...
*                                                                               
         XR    R0,R0                                                            
         ICM   R0,3,FDRNUM                                                      
         GOTOX APRG,RTPARM,('GCBOVER',ODATA),(R0),DLHED,(RF),FDRELD,   *        
               RTWORK                                                           
*                                                                               
         CLC   RTWORK,BCSPACES     WANT TO SET HEADLINE?                        
         BH    DLHED02                                                          
*                                                                               
         ...
         GOTOX VDICTAT,RTPARM,(RF),RTWORK                                       
*                                                                               
DLHED02  XR    RF,RF               MOVE IN THE HEADLINES                        
         ICM   RF,1,FDRTDEFL                                                    
         BZ    EXITOK                                                           
         BCTR  RF,0                                                             
         MVC   H.FHDA(0),RTWORK                                                 
...
SAVE     USING FLTELD,RTWORK3                                                   
         ...
         EX    RE,*-6              SAVE FLTEL IN RTWORK3                        
         DROP  RF                                                               
*                                                                               
         XR    RF,RF                                                            
         ICM   RF,1,SAVE.FLTCNT    NUMBER OF ITEMS IN THIS LIST                 
         BZ    EXIT                                                             
         MVC   FVIFLD,BCSPACES     CLEAR INPUT FIELD                            
         MVI   FVILEN,0            RESET INPUT LENGTH                           
         LA    R6,SAVE.FLTINFO                                                  
         USING FLTINFO,R6                                                       
         LA    R5,RTSCAN                                                        
         USING UNBLK,R5                                                         
...
DFDO08   XC    RTWORK4,RTWORK4     FILTERING ON A RANGE OF VALUES               
         ...
         EX    RF,*-6              MOVE IN FIXED PORTION OF DATA                
*                                                                               
         OI    RTFILT1,FDRF1NOT+FDRF1LT :- XXX- MEANS >=XXX                     
...
*                                                                               
         ...
         EX    RF,*-6              MOVE DATA INTO FLTIFLD                       
*                                                                               
         TM    RTFILT1,FDRF1NOT+FDRF1GT+FDRF1LT+FDRF1EQ                         
...
GRE02    CLI   0(RF),EOT                                                        
         BNE   *+6                                                              
         DC    H'0'                TABLES SET UP INCORRECTLY                    
         CLM   R0,1,NFINUM                                                      
         BE    GRE04                                                            
         AHI   RF,NFITABL                                                       
         B     GRE02                                                            
*                                                                               
GRE04    ST    RF,RTFILALT         SAVE A(ALTERNATIVE FILE ENTRY)               
*                                                                               
GRE06    NI    GCINDS1,FF-GCIRCSLR TURN OFF CHANGED FLAG FOR USER               
         L     RF,RTFILDIR         A(DIRECTORY ENTRY)                           
         XR    RE,RE                                                            
         IC    RE,NFIKEYL                                                       
         L     R3,AIOREC           A(RECORD AREA)                               
         USING GRECD,R3                                                         
         OI    GCINDS1,GCIFILE     SET READ A RECORD                            
*                                                                               
...
*                                                                               
         ...
         B     GRE18                                                            
*                                                                               
GRE08    CLC   GSRECDA,BCEFFS      IS THIS A CONTROL FILE SPECIAL?              
         BNE   GRE10               NO                                           
*                                                                               
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
GRE10    L     RF,RTFILREC         RECORD TABLE ENTRY                           
         TM    NFIINDS2,NFIIARC                                                 
         BZ    GRE16               NO ALTERNATIVE FILE                          
*                                                                               
         XR    R1,R1                                                            
         IC    R1,NFIADSP                                                       
         LA    R1,GSRECSTA(R1)     R1=A(BYTE TO CHECK FOR ALTERNATIVE)          
*                                                                               
         TM    NFIATST,NFIABOOL    BOOLEAN TEST?                                
         BZ    GRE12               NO                                           
         MVC   RTBYTE1,0(R1)                                                    
         NC    RTBYTE1,NFIABIT     ONLY TEST                                    
         CLC   RTBYTE1,NFIABIT                                                  
         BNE   GRE16                                                            
         L     RF,RTFILALT                                                      
         B     GRE16                                                            
*                                                                               
GRE12    TM    NFIATST,NFIAEQU     COMPARISON TEST?                             
         BZ    GRE14               NO                                           
         CLC   NFIABIT,0(R1)                                                    
         BNE   GRE16                                                            
         L     RF,RTFILALT                                                      
         B     GRE16                                                            
*                                                                               
GRE14    DC    H'0'                ADD EXTRA TEST TYPES HERE                    
*                                                                               
GRE16    XR    R1,R1                                                            
         IC    R1,NFINUM                                                        
         MHI   R1,256              MULTIPLY IT BY 256 FOR EQUATE                
         A     R1,=A(XIO11+XORDEL+XOGET)                                        
         AR    R1,R2               SEE IF LOCK OR NOT                           
*                                                                               
         L     RE,AIOREC           IS D/A IN AIOREC ALREADY?                    
         AHI   RE,-(L'IODA+L'IOWORK)                                            
         CLC   GSRECDA,0(RE)                                                    
         BE    *+10                                                             
         MVC   IODAOVER,GSRECDA                                                 
*                                                                               
         GOTOX ('XIO',AGROUTS),(R1)                                             
         TM    IOERR,IOEDSK                                                     
         BZ    GRE18                                                            
         DC    H'0'                                                             
*                                                                               
GRE18    MVC   RTRECACT,GSRECACT                                                
...
*                                                                               
         ...
         B     GETRECH                                                          
*                                                                               
GRE20    TM    GSFRR.FRRINDS1,FRR1UPDT                                          
...
RXX02    CLI   0(RF),EOT                                                        
         ...
         B     RXX02                                                            
*                                                                               
RXX04    ST    RF,RTFILALT         SAVE A(ALTERNATIVE FILE ENTRY)               
*                                                                               
RXX06    L     RE,RTPARMS4         A( A(RECORD) WHEREVER IT IS )                
...
*                                                                               
         ...
         B     RXX16                                                            
*                                                                               
RXX12    TM    NFIATST,NFIAEQU     COMPARISON TEST?                             
         BZ    RXX14               NO                                           
         CLC   NFIABIT,0(R1)                                                    
         BNE   RXX16                                                            
         L     RF,RTFILALT                                                      
         B     RXX16                                                            
*                                                                               
RXX14    DC    H'0'                ADD EXTRA TEST TYPES HERE                    
*                                                                               
RXX16    XR    R1,R1                                                            
         IC    R1,NFINUM                                                        
         MHI   R1,256              MULTIPLY IT BY 256 FOR EQUATE                
...
*                                                                               
SESNTR   NI    GSINDSG1,255-GSG1SMAX                                            
         CLI   TWASESNL,TWASESMX                                                
         BL    *+12                                                             
         OI    GSINDSG1,GSG1SMAX   ALREADY REACHED MAXIMUM NESTING              
         B     SESNX               LEVEL                                        
*                                                                               
         NI    GSINDSG1,255-GSG1SCMX                                            
         LH    R0,GSDSPSAV         CHECK SCREEN SIZE SMALL ENOUGH TO            
         A     R0,ATWA             BE SAVED                                     
         LR    R1,R0                                                            
         USING FHD,R1                                                           
         SR    RF,RF                                                            
         ICM   RF,1,FHLN           TEST END OF SCREEN                           
         BZ    *+8                                                              
         BXH   R1,RF,*-8                                                        
         SR    R1,R0                                                            
         CHI   R1,FESTWSVL                                                      
         BNH   *+12                                                             
         OI    GSINDSG1,GSG1SCMX   SCREEN SIZE EXCEEDED FOR NTRSES              
         B     SESNX                                                            
         DROP  R1                                                               
*                                                                               
         OI    GCINDS2,GCIDONTR    SET DOING AN NTRSES                          
...
FLRTABL  DC    AL1(FDIS),AL1(0,0,0),AL4(FLRDIS)                                 
         ...
         DC    AL1(FDOT),AL1(0,0,0),AL4(FLRDOT)                                 
...
FDOR04   XR    RE,RE                                                            
         ...
         SPACE 2                                                                
***********************************************************************         
* DO FILTERING FOR ALL FLTELS PRESENT IN TSAR                         *         
***********************************************************************         
         SPACE 1                                                                
FLRDOT   L     R5,AFLTELSV         WHERE FLTELS ARE IN MEMORY                   
         USING FLTELSV,R5                                                       
         LA    R5,FLTELSDT                                                      
         USING FLTELD,R5                                                        
*                                                                               
FDOT02   CLI   FLTEL,0             FINISHED PROCESSING FILTERS?                 
         BE    EXITOK              YES                                          
*                                                                               
         TM    FLTLVL,FLTLTSAR                                                  
         BZ    FDOT04                                                           
...
RTFILALT DS    A                   A(ALTERNATIVE SYSTEM FILE ENTRY)             
*                                                                               
RTHALF1  DS    H                                                                
RTHALF2  DS    H                                                                
RTHALF3  DS    H                                                                
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'048GEFIL01   08/10/11'                                      
         END                                                                    
