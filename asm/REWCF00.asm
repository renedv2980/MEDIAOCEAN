*          DATA SET REWCF00    AT LEVEL 047 AS OF 05/02/06                      
*PHASE T83A00C                                                                  
*INCLUDE TWABLD                                                                 
*INCLUDE UNBOOK                                                                 
*INCLUDE RECUP                                                                  
...
*MNFE                                                                           
*        SR    R4,R4             EXTEND FILTER TO 30 DAYS PRIOR FROM            
*        ICM   R4,3,FULL2        THE 14 THAT IS PASSED                          
*        SH    R4,=H'17'                                                        
*        STCM  R4,3,FULL2                                                       
*MNFE                                                                           
...
*MNFE                                                                           
*        MVC   HALF,FULL         SAVE TO COMPARE TO SENT ON DATE                
*        SR    R4,R4             EXTEND FILTER TO 30 DAYS PRIOR FROM            
*        ICM   R4,3,FULL         THE 14 THAT IS PASSED                          
*        SH    R4,=H'17'                                                        
*        STCM  R4,3,FULL                                                        
*MNFE                                                                           
...
*MNFE                                                                           
*        L     R8,AIOREC                                                        
*        MVI   ELCODE,X'1F'        GET DESCRIPTION ELEMENT                      
*        BAS   RE,GETEL                                                         
*        BNE   BCD0026                                                          
*        USING RCONXEL,R8                                                       
*        TM    RCONCONF,X'80'      IF CONFIRMED SKIP NEXT CHECKS                
*        BZ    BCD0026             CONFIRMED - REGULAR DATE FILTER              
*                                                                               
*        CLC   K.RCON8EFE,FULL     CHECK FOR FLIGHT OVERLAP                     
*        BL    BCD0025                                                          
*        B     BCD0026                                                          
...
*        BAS   RE,GETEL                                                         
*                                                                               
*        MVC   SOMHALF,RCONSRDT                                                 
*        CLC   RCONSRDT,RCONSSDT                                                
*        BH    *+10                                                             
*        MVC   SOMHALF,RCONSSDT                                                 
*                                                                               
*        CLC   SOMHALF,HALF        NOTCONFIRMED AND SENTONDATE                  
*        BL    BCD0100             PAST TWO WEEKS, SKIP IT                      
*        B     BCD0026A                                                         
*                                                                               
*        VANILLA DATE FILTERING                                                 
*CD0026  CLC   K.RCON8EFE,FULL     CHECK FOR FLIGHT OVERLAP                     
*        BL    BCD0100                                                          
*        CLC   K.RCON8EFS,FULL+2                                                
*        BH    BCD0100                                                          
*                                                                               
...
DCON285  OC    RBUYSEC,RBUYSEC                                                  
         BZ    DCON286                                                          
         CLC   RBUYSEC,SPACES                                                   
         BE    DCON286                                                          
         GOTO1 AADDDATA,DMCB,AFABLK,BUYSECTN,RBUYSEC,0                          
DCON286  OC    RBUYCLS,RBUYCLS                                                  
         BZ    DCON287                                                          
         CLC   RBUYCLS,SPACES                                                   
         BE    DCON287                                                          
...
DCON332  DS    0H                                                               
         ...
         BZ    DCON333                USE RBUYNW FROM '01' INSTEAD              
*                                                                               
...
*        MVC   WORK+100(20),=CL20'CREDIT FOR SPOT LINE'                         
*        ZIC   R3,1(R8)                                                         
*        SH    R3,=H'6'                                                         
*        EX    R3,*+8                                                           
*        B     *+10                                                             
...
*                                                                               
         CLC   RBYMGSLI,BYTE       CONSECUTIVE SAME LINE TEST                   
         BE    MGO130                                                           
         MVC   BYTE,RBYMGSLI                                                    
*&&                                                                             
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'047REWCF00   05/02/06'                                      
         END                                                                    
