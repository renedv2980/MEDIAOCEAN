*          DATA SET DEWB0023   AT LEVEL 007 AS OF 04/14/16                      
*PHASE DEWB023A                                                                 
         TITLE 'DEMO CONVERSION'                                                
DEWB0023 TITLE '- WB1 CONVERSION BEGUN 5/29/00'                                 
...
B0RTN    DS    0H                                                               
         USING B0REC,RC                                                         
         CLC   =C'TOTAL COMM ACTIVITY',B0REPORT                                 
         BE    *+6                                                              
...
*********************************************************************           
*                                                                               
*ALLIGN1  EQU   (((*-DEWB0023+4095)/4096)*4096)   ALLIGN AT 2000                
*         ORG   DEWB0023+ALLIGN1                                                
                                                                                
CNVRTN   NMOD1 0,**CNVW**,RA,RR=RE                                              
         USING DEMCOND,R8          R8 = DEMCNV GLOBAL WORK                      
         USING WORKD,R4            R4 = DEWB0023 WORK                           
*                                                                               
...
*ALLIGN2  EQU   (((*-DEWB0023+4095)/4096)*4096)   ALLIGN AT 1000 BNDRY          
*         ORG   DEWB0023+ALLIGN2                                                
WORKD    DS    0F                                                               
RELO     DS    A                                                                
...
K1797    DS    CL0004              NHWC6                                        
       ...
       ++INCLUDE DEDEMTABD                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007DEWB0023  04/14/16'                                      
         END                                                                    
