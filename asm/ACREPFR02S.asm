*          DATA SET ACREPFR02S AT LEVEL 040 AS OF 09/16/02                      
*PHASE ACFR02A                                                                  
*INCLUDE UNDERLIN                                                               
*INCLUDE ACSLRY                                                                 
*INCLUDE ACSALHST                                                               
...
*                                                                               
RUNL10   DS    0H                                                               
         MVC   MSG1,=CL10'TOTAL PER'                                            
         GOTO1 ADUMP,DMCB,(RC),(R2),TOTLEN                                      
*                                                                               
         LA    R2,TOTLEN(R2)                                                    
         BCT   R0,RUNL10                                                        
*                                                                               
RUNL99   GOTO1 WRAP            RETURN ACQUIRED STORAGE                          
         B     EXIT                                                             
         EJECT                                                                  
**********************************************************************          
...
RPT20    DS    0H                                                               
         ...
         MOVE  ((RF),(R1)),(RE)                                                 
RPT30    L     R5,ASRTREC                                                       
*        MVI   RCSUBPRG,0          ALWAYS SET BEFORE GOING TO CHKPER            
...
*        BRAS  RE,PCT              FIGURE OUT PCT OF TIME                       
         ...
         TM    SRSTAT,SRPRDHRS     WAS THIS PERSON ADJ?                         
         BZ    *+8                                                              
...
*        BRAS  RE,PCT              FIGURE OUT PCT OF TIME                       
         ...
         BASR  RE,RF               FIGURE OUT PCT OF TIME                       
*                                                                               
DUP120   BRAS  RE,CHKPER           CHECK IF PERSON HIT 1800 PROD HRS            
         TM    SRSTAT,SRPRDHRS     WAS THIS PERSON ADJ?                         
         BZ    *+8                                                              
...
CHKPER   NTR1  BASE=*,LABEL=*                                                   
         NI    FLAG2,X'FF'-FLGPRDHR   FLAG THAT HOURS WENT OVER 1800            
         USING BIND,RE                                                          
         L     RE,APERBUFF         R1=PERSON TABLE                              
         ICM   R0,15,BININ                                                      
         BZ    CHKPERX                                                          
...
*                                                                               
CHKPER20 CP    PERHRS,ADJHOURS     DID PERSON GO OVER 1800?                     
         BL    CHKPERX                                                          
         OI    SRSTAT,SRPRDHRS     SET FLAG TO SHOW PER EXCEEDED 1800           
         OI    FLAG2,FLGPRDHR      FLAG THAT HOURS WENT OVER 1800               
...
*                                                                               
DET60    TM    SRSTAT,SRPRDHRS                                                  
         BO    DET80                                                            
         LA    RE,SDYTHRS          YTD TOTAL 1C HOURS                           
...
*                                                                               
         LA    RE,=C'3A1B'         PERSONS IN 3A1B/4A1B AS FREELNCERS           
         CLC   =C'TMS',RQCLIENT    DIFFERENT CHARGE FACTOR FOR THEM             
         BE    *+8                                                              
         LA    RE,=C'4A1B'         IF LEXUS MARK PEOPLE IN 4A1B                 
         CLC   DPTCODE,0(RE)                                                    
         BNE   DET85                                                            
         MP    PACK16,=PL8'21250'   2.125 CHARGE FACTOR FOR FREELANCERS         
         B     *+10                                                             
*                                                                               
DET85    MP    PACK16,=PL8'22500'   2.25 CHARGE FACTOR                          
         SRP   PACK16,64-4,5       SHIFT AND ROUND                              
...
DET140   DS    0H                                                               
         ...
         BE    DET150                                                           
         BRAS  RE,OUTREC           UPDATE HEADLINES AND PRINT                   
DET150   LA    R6,SDLEQ(R6)        NEXT MONTH                                   
         BCT   R2,DET10                                                         
         J     COM2XIT                                                          
         EJECT                                                                  
**********************************************************************          
...
*                                                                               
HDUP20   DS    0H                                                               
*        TM    FLAG2,FLGPRDHR      ARE WE ON PROD REPT AND HRS > 1800           
*        BNO   HDUP30                                                           
*        MVC   XHEAD12+64(5),=C'*   *'       ADD NEW HEADING                    
*        MVC   XHEAD12+65(L'RQPROD),RQPROD   MOVE IN INDIVIDUAL PRD             
*        MVC   XHEAD12+74(5),=C'*ALL*'       MARK TOTAL COL AS *ALL*            
*                                                                               
HDUP30   CLI   RCSUBPRG,8          GROUP REPORT FOR ADJ PERSON                  
         BNL   HDUP40                                                           
         ...
         BE    HDUP50                                                           
*                                                                               
HDUP40   TM    FLAG2,FLGDUP        ARE WE RUNNING DUP REPORT?                   
         BO    HDUP50                                                           
*                                                                               
...
*                                                                               
         ...
         B     HDUP70                                                           
*                                                                               
HDUP50   MVC   XHEAD5(10),LLEVDNAM         DUP LOCATION PAGE                    
...
*                                                                               
HDUP60   MVC   XHEAD4+101(21),=C'*********************'                         
         MVC   XHEAD5+101(21),=C'** MULTI LOCATIONS **'                         
         MVC   XHEAD6+101(21),=C'*********************'                         
         B     HDUP80                                                           
*                                                                               
HDUP70   TM    FLAG,FLGGRP         ADDITIONAL GROUP REPORT-ADJ PERSON           
         BNO   HDUP80                                                           
         MVC   XHEAD4+101(21),=C'*********************'                         
...
*                                                                               
HDUP80   MVC   XHEAD1+46(35),=C'  T O Y O T A  F E E  R E P O R T  '            
         CLC   =C'LEX',RQCLIENT                                                 
         BNE   *+10                                                             
...
*                                                                               
         ...
         CLI   RCSUBPRG,3                                                       
         BNE   HDUPX                                                            
HDUP90   MVC   XHEAD5+70(L'MSGS),MSGS                                           
...
HDUP100  CLI   RCSUBPRG,6          RECAP REPORT                                 
         ...
         MVC   XHEAD4+22(L'SVGRPNM),SVGRPNM                                     
*                                                                               
HDUP110  CLI   RCSUBPRG,6          RECAP REPORT                                 
         BE    HDUP120                                                          
         MVC   XHEAD5(10),LLEVBNAM                                              
...
*                                                                               
*                                                                               
HDUP120  MVC   XHEAD1+53(24),=C'TOYOTA MOTOR SALES, INC.'                       
         CLC   =C'LEX',RQCLIENT                                                 
         BNE   *+10                                                             
...
*                                                                               
         DC    CL8'**PER*** '                                                   
         DC    AL2(APERBUFF-WORKD) STORED ADDR OF THE TABLE (PERD)              
...
*                                                                               
         DC    CL8'**TOT*** '                                                   
         DC    AL2(ATOTBUFF-WORKD) STORED ADDR OF THE TABLE (PERD)              
...
FLGPRDHR EQU   X'10'               PROD REPORT AND HOURS WENT OVER 1800         
FLGDUP   EQU   X'08'               FLAG TO SHOW DUP REPORT RUNNINT              
*                                                                               
...
TOTBKDSP EQU   *-TOTD                                                           
TOTBUK   DS    0C                                                               
TOTHRS   DS    PL6                 MONTHLY BUCKET - TOTAL HOURS                 
TOTBKQ   EQU   *-TOTBUK                                                         
TOTSAL   DS    PL6                 MONTHLY BUCKET - TOTAL SALARY                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'040ACREPFR02S09/16/02'                                      
         END                                                                    
