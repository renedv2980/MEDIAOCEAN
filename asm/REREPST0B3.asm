*          DATA SET REREPST0B3 AT LEVEL 138 AS OF 05/01/02                      
*PHASE REST02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
********************************************************************            
*                                                                  *            
*        REREPST02 -- EXTRACT UTS KTVX DATA                        *            
...
*                                                                               
****     GOTO1 PR43PROC,DMCB,(RC)  PROCESS PROPOSAL 43 RECORDS                  
*                                                                               
...
CONP0020 DS    0H                                                               
         ...
         MVI   RCONKTYP,X'0C'                                                   
         MVC   RCONKREP,OLDREP                                                  
         MVC   RCONKGRP(6),=C'T KTVX'                                           
*                                  ONLY PROCESS KTVX ORDERS                     
         GOTO1 HIGHDIR                                                          
         B     CONP0060                                                         
...
*   TEST END                                                                    
*                                                                               
         CLC   KEY(10),KEYSAVE     COMPARE CODE/REP/GRP/STA                     
         BNE   CONP0400                                                         
         CLC   =C'KTVX',KEY+6      SPECIAL STATION?                             
         BNE   CONP0400            NO  - FINISHED                               
*                                                                               
CONP0080 DS    0H                                                               
         GOTO1 GETRECRD                                                         
...
MKGD0040 DS    0H                                                               
         CLC   KEY(08),KEYSAVE                                                  
         BNE   MKGD0060                                                         
         CLC   =C'KTVX',KEY+10     SPECIAL STATION?                             
         BNE   MKGD0020            NO  - SKIP IT                                
...
INV0040  DS     0H                                                              
         CLC   KEY(12),KEYSAVE                                                  
         BNE   INV0060                                                          
         CLC   =C'KTVX',KEY+12     SPECIAL STATION?                             
         BNE   INV0020             NO  - SKIP IT                                
...
BUD0040  DS     0H                                                              
         CLC   KEY(18),KEYSAVE                                                  
         BNE   BUD0060                                                          
         CLC   =C'KTVX',KEY+20     SPECIAL STATION?                             
         BNE   BUD0020             NO  - SKIP IT                                
...
AVAL0060 EQU   *                                                                
         GOTO1 SEQDIR                                                           
AVAL0080 EQU   *                                                                
         CLC   KEY(23),KEYSAVE     COMPARE THROUGH CON #                        
...
PROP0060 EQU   *                                                                
         GOTO1 SEQDIR                                                           
PROP0080 EQU   *                                                                
         CLC   KEY(20),KEYSAVE     COMPARE THROUGH CONTRACT NUMBER              
...
EOP10080 EQU   *                                                                
         ...
         CLC   =C'KTVX',KEY+18     SPECIAL STATION?                             
         BNE   EOP10060            NO  - SKIP IT                                
...
EOP20080 EQU   *                                                                
         ...
         CLC   =C'KTVX',KEY+16     SPECIAL STATION?                             
         BNE   EOP20060            NO  - SKIP IT                                
...
EOP40080 EQU   *                                                                
         ...
         CLC   =C'KTVX',KEY+19     SPECIAL STATION?                             
         BNE   EOP40060            NO  - SKIP IT                                
...
SDD0080  EQU    *                                                               
         ...
         CLC   =C'KTVX',KEY+22     SPECIAL STATION?                             
         BNE   SDD0060             NO  - SKIP IT                                
...
COMM0080 EQU    *                                                               
         ...
         CLC   =C'KTVX',KEY+13     SPECIAL STATION?                             
         BNE   COMM0060            NO  - SKIP IT                                
...
D41S0080 EQU    *                                                               
         ...
         CLC   =C'KTVX',KEY+9      SPECIAL STATION?                             
         BNE   D41S0060            NO  - SKIP IT                                
...
P4310060 EQU    *                                                               
         GOTO1 SEQDIR                                                           
P4310080 EQU    *                                                               
         CLC   KEY(13),KEYSAVE     COMPARE THROUGH CON #                        
...
P4320060 EQU    *                                                               
         GOTO1 SEQDIR                                                           
P4320080 EQU    *                                                               
         CLC   KEY(21),KEYSAVE     COMPARE THROUGH CON #                        
...
CFCS0060 EQU    *                                                               
         GOTO1 SEQDIR                                                           
CFCS0080 EQU    *                                                               
         CLC   KEY(27),KEYSAVE     COMPARE WHOLE KEY                            
...
RECORD   DS    CL4100                                                           
       ...
       ++INCLUDE REREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'138REREPST0B305/01/02'                                      
         END                                                                    
