*          DATA SET RELDACTS   AT LEVEL 051 AS OF 05/01/02                      
*PHASE RELDACT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
...
*                                                                               
* LEV  42   BG SET UP FOR SEL TEL TEST (ED) FOR 9401 TO 9605                    
* LEV  47   BG ONLY CLOSE FOR JUN96, AND BYPASS ACC-BB CONTRACTS                
* LEV  49   BG CLOSE FOR ALL 96 FOR SZ                                          
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
DMXR10   DS    0H                  SELTEL ONLY                                  
         USING RSTAREC,R5                                                       
         CLC   =C'SZ',RSTAKREP     FOR SELTEL                                   
*        CLC   =C'ED',RSTAKREP     FOR TESTING                                  
*        BE    DMXR20                                                           
         BNE   DMXKEEP                                                          
*                                                                               
DMXR20   DS    0H                  MARK ALL STATION CLOSED THRU JUN/96          
         LA    R4,COUNTS                                                        
...
DMXR100  DS    0H                                                               
         USING RCONREC,R5                                                       
         CLC   =C'SZ',RCONKREP     FOR SELTEL                                   
*        CLC   =C'ED',RCONKREP     FOR TESTING                                  
*        BE    DMXR110                                                          
         BNE   DMXKEEP                                                          
*                                                                               
DMXR110  DS    0H                                                               
...
DMXR113  DS    0H                                                               
         AP    12(5,R4),=P'1'                                                   
*                                                                               
         CLC   =C'ACC-BB',RCONBUYR THIS A BACK BILLING CONTRACT                 
         BNE   *+14                                                             
         AP    BKBLCT,=P'1'                                                     
         B     DMXKEEP                                                          
*                                                                               
...
DC10     MVC   P+3(2),0(R5)                                                     
         ...
         BNE   DC10                                                             
*                                                                               
         MVC   P+3(28),=C'BACK BILL CONTRACTS BYPASSED'                         
         EDIT  (P5,BKBLCT),(7,P+32)                                             
         GOTO1 VPRINTER                                                         
*                                                                               
         B     DMXIT                                                            
         EJECT                                                                  
...
*        DC    CL2'ED',PL5'0',PL5'0',PL5'0',PL5'0',PL5'0'                       
         DC    CL2'SZ',PL5'0',PL5'0',PL5'0',PL5'0',PL5'0'                       
*        DC    CL2'S2',PL5'0',PL5'0',PL5'0',PL5'0',PL5'0'                       
         DC    X'FF'                                                            
BKBLCT   DC    PL5'0'                                                           
         EJECT                                                                  
         LTORG                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'051RELDACTS  05/01/02'                                      
         END                                                                    
