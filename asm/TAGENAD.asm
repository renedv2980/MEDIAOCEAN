*          DATA SET TAGENAD    AT LEVEL 029 AS OF 12/23/08                      
*PHASE T702ADA,*                                                                
         TITLE 'T702AD - GUARANTEE BALANCE REFRESH'                             
T702AD   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T702AD                                                         
         L     RC,0(R1)                                                         
...
VS       DS    0H                                                               
         ...
         CLI   SGTSSNH+5,0                                                      
         BE    MISSERR                                                          
         CLI   SGTSSNH+5,9         SSN ENTERED?                                 
         BE    VS01                                                             
         CLI   SGTSSNH+5,6         PID ENTERED?                                 
         BNE   INVERR                                                           
         MVC   TGPID,SGTSSN                                                     
         ...
         MVC   SGTSSN,TGSSN                                                     
         MVI   SGTSSNH+5,9                                                      
VS01     GOTO1 RECVAL,DMCB,TLW4CDQ,(X'08',(R2)),SGTSSNNH                        
         TM    TGSYSTAT,TASYSPID   USING PID#?                                  
         BZ    VS02                                                             
         GOTO1 SSNPACK,DMCB,TGSSN,TGPID                                         
         MVC   SGTSSN,SPACES                                                    
         MVC   SGTSSN(L'TGPID),TGPID                                            
         MVI   SGTSSNH+5,L'TGPID                                                
         OI    SGTSSNH+6,X'80'                                                  
*                                                                               
VS02     LA    R2,SGTCODEH         GRT CODE                                     
         CLI   5(R2),0                                                          
         BE    MISSERR                                                          
...
PR70     BAS   RE,GETGT            GET TLGT REC & TAGT ELEM                     
         ...
         L     R2,TAGTCRD          USE CREDIT AMOUNT                            
         CLC   TAGTUSE,=C'GRT'     IF THIS IS A GRT PAYMENT                     
         BNE   PR75                                                             
         L     R2,TAGTPAY          USE PAY AMOUNT                               
*                                                                               
PR75     TM    GUSTAT,TAGUSDES     IF THIS ISN'T A DESCENDING BALANCE           
         BO    PR80                                                             
         SR    R1,R2               SUBTRACT AMOUNT                              
         B     PR90                                                             
*                                                                               
PR80     AR    R1,R2               ELSE + THIS AMOUNT                           
*                                                                               
...
*                                                                               
         DS    0D                                                               
         DC    CL8'*DSKTAB*'                                                    
DSKTAB   DS    800XL4              TABLE OF 800 DISK ADDRESSES                  
DSKX     EQU   *                                                                
DSKLNQ   EQU   *-DSKTAB                                                         
         EJECT                                                                  
*DDGENTWA                          MUST BE RIGHT AFTER SCREENS                  
*DDPERVAL                                                                       
*DDSPOOLD                                                                       
*DDBIGBOX                                                                       
*DDSPLWORKD                                                                     
...
*TAREPWORKD                                                                     
       ...
       ++INCLUDE TAGENWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029TAGENAD   12/23/08'                                      
         END                                                                    
