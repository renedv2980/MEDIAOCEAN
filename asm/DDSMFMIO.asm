*          DATA SET DDSMFMIO   AT LEVEL 008 AS OF 11/24/15                      
*PHASE SMFMIOA                                                                  
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE CARDS                                                                  
*INCLUDE DATCON                                                                 
*                                                                               
         TITLE 'DDSFMMIO - ACTIVITY METRICS '                                   
         PRINT NOGEN                                                            
*                                                                               
TRACE    CSECT                                                                  
...
INIT020  ZAP   LINE,MAXLINE        FORCE NEW PAGE                               
         ...
         CLI   DETAIL,C'Y'                                                      
         BE    EXIT                                                             
         MVC   TITLET(TITLELQ),SPACES                                           
         MVC   TITLE2T(TITLELQ),SPACES                                          
         B     EXIT                                                             
...
*                                                                               
         ...
         CLI   SMFIRTY,METSMF                                                   
         BNE   MAIN010                                                          
         CLC   SMFISTY,=AL2(METSLOG)                                            
         BE    MAIN020                                                          
         CLC   SMFISTY,=AL2(METSCON)                                            
         BE    MAIN020                                                          
         CLC   SMFISTY,=AL2(METSTSK)                                            
         BNE   MAIN010                                                          
*                                                                               
MAIN020  GOTO1 DATCON,DMCB,(6,SMFIDTE),(2,SMFDATE)                              
*                                                                               
         BRAS  RE,FILTER                                                        
         BNE   MAIN010                                                          
*                                                                               
...
*                                                                               
         MVC   PAGY,METAGY                                                      
         GOTO1 HEXOUT,DMCB,METUIDN,PUIDN,2                                      
*                                                                               
         MVC   PSAGY,METSAGY                                                    
         MVC   PPAGY,METPAGY                                                    
         GOTO1 HEXOUT,DMCB,METPIDN,PPIDN,2                                      
*                                                                               
         CLI   SMFISTY+1,METSTSK                                                
         BE    PIT020                                                           
         MVC   PUID,METUID                                                      
         MVC   PPID,METPID                                                      
*                                                                               
PIT020   GOTO1 HEXOUT,DMCB,METSYS,PSYS,1                                        
*                                                                               
         GOTO1 HEXOUT,DMCB,METMFP,PMFP,1                                        
*                                                                               
         GOTO1 HEXOUT,DMCB,METXPT,PXPT,1                                        
*                                                                               
         CLI   METXPT,0                                                         
         BE    PIT030                                                           
*                                                                               
         EDIT  (B2,METXPP),PXPP,ALIGN=LEFT,ZERO=NOBLANK                         
*                                                                               
         LA    R2,PXPV                                                          
         LLC   R1,METXPV                                                        
         SRL   R1,4                                                             
         STC   R1,BYTE                                                          
         EDIT  (B1,BYTE),(2,(R2)),ALIGN=LEFT,ZERO=NOBLANK                       
         LA    R2,1(,R2)                                                        
         CLI   0(R2),C' '                                                       
         BNH   *+8                                                              
         LA    R2,1(,R2)                                                        
...
*                                                                               
         ...
         LA    R2,1(,R2)                                                        
*                                                                               
         EDIT  (B1,METXPV+1),(2,(R2)),ALIGN=LEFT,ZERO=NOBLANK                   
         LA    R2,1(,R2)                                                        
         CLI   0(R2),C' '                                                       
         BNH   *+8                                                              
         LA    R2,1(,R2)                                                        
         ...
         MVI   0(R2),C'.'                                                       
         LA    R2,1(,R2)                                                        
         EDIT  (B1,METXPV+2),(2,(R2)),ALIGN=LEFT,ZERO=NOBLANK                   
*                                                                               
PIT030   LA    R1,SYSLST+6                                                      
         ICM   R2,15,SYSLST+2                                                   
         USING SYSLSTD,R1                                                       
PIT040   CR    R1,R2                                                            
         BNL   PIT060                                                           
         ...
         LA    R1,SYSLLEN(0,R1)                                                 
         B     PIT040                                                           
PIT050   MVC   PDSYS(7),SYSLNAME                                                
         DROP  R1                                                               
*                                                                               
PIT060   MVC   PRDW,=Y(PREND+3,0)                                               
         MVI   PCTL,X'09'                                                       
         BRAS  RE,PRINTL                                                        
         MVC   PLINE,SPACES                                                     
*                                                                               
         CLI   HEXP,C'Y'                 HEX PRINT?                             
         BNE   PITX                      NO                                     
         ...
         MVC   PLINE(0),SMFDATA                                                 
*                                                                               
PIT080   MVC   PRDW,=Y(PREND+3,0)                                               
         MVI   PCTL,X'09'                                                       
         BRAS  RE,PRINTL                                                        
         MVC   PLINE,SPACES                                                     
*                                                                               
         MVC   PRDW,=Y(PREND+3,0)                                               
         MVI   PCTL,X'09'                                                       
         BRAS  RE,PRINTL                                                        
         MVC   PLINE,SPACES                                                     
*                                                                               
...
TITLET   DC    CL50'Date     Time     SMF  # Job Name StepName Job#  E'         
         DC    CL50' UID# AA SA PA PID# System  Sy Pg XT XPgm XVrsn   '         
         DC    CL32'  UID      PID                  '                           
TITLELQ  EQU   *-TITLE                                                          
*                                                                               
         DS    0H                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008DDSMFMIO  11/24/15'                                      
         END                                                                    
