*          DATA SET SRTTO00S   AT LEVEL 002 AS OF 08/22/00                      
*PHASE T12D00A                                                                  
*INCLUDE SQUASHER                                                               
...
DONED0   MVC   MSG(40),1(RE)       OUTPUT DISCONNECTED MESSAGE                  
         ...
         LA    RF,MSG                                                           
         AR    RF,R0                                                            
         MVC   0(8,RF),0(R1)       MOVE IN FACPAK NAME                          
         EJECT                                                                  
***********************************************************************         
* DISCONNECT ALL ACTIVE SESSIONS                                      *         
***********************************************************************         
         SPACE 1                                                                
DISC     SR    R5,R5               TEST IF CURRENT SESSION ACTIVE               
         IC    R5,TSESSION                                                      
         IC    RF,SSACBITS(R5)                                                  
         EX    RF,*+8                                                           
         B     *+8                                                              
...
* DDCOMFACS                                                                     
       ...
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002SRTTO00S  08/22/00'                                      
         END                                                                    
