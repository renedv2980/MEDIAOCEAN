*          DATA SET DEBBMWO    AT LEVEL 173 AS OF 05/01/02                      
*PHASE DEBBMWOA                                                                 
         TITLE 'DEMCON - TPT CONVERSION - OUTPUT PHASE'                         
DECNVTPT CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 TPTWRKX-TPTWRKD,**TPTCNV                                         
         USING TPTWRKD,RC,R4,R5    RC=A(W/S)                                    
...
**       LA    RE,PROGTAB                                                       
         ...
         DC    H'0'                                                             
         B     CNV3B                                                            
**V14C   MVC   0(L'PROGTAB,R6),INTPNAM                                          
CNV3C    MVC   PROGNM(L'INTPNAM),INTPNAM                                        
         MVC   PROGSTAT,INTSTA                                                  
         MVC   PROGDAY,INTDAY                                                   
         MVC   PROGSQH,INTSQH                                                   
         MVC   PROGEQH,INTEQH                                                   
...
* DDCOMFACS                                                                     
       ...
       ++INCLUDE DDCOMFACS                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'173DEBBMWO   05/01/02'                                      
         END                                                                    
