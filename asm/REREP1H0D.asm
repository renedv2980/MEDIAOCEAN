*          DATA SET REREP1H0D  AT LEVEL 019 AS OF 05/01/02                      
*PHASE RE1H02A,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
* UPDATE HISTORY                                                    *           
*                                                                   *           
* JUN24/96 (BU ) --- INITIAL ENTRY:  CLOSEOUT+CLEAR FIX             *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
...
MDTABLEN EQU   MDENTRYX-MDENTRY                                                 
         ...
         DC    AL1(REQLAST),AL3(TOTALS)   DISPLAY TOTALS                        
MODETABX EQU   *                                                                
...
*              SHOW CONTRACT DETAILS                                            
         EJECT                                                                  
*                                                                               
*   POST:  INSPECT X'04' ELEMENTS FOR DATE NOV04/96.                            
...
POST0010 EQU   *                                                                
         ...
         USING RCONSTEL,R2                                                      
         CLC   RCONSTWK,=X'C164'   NOV4/96?                                     
         BNE   POST0010            NO  - SKIP IT                                
         MVI   0(R2),X'FF'         YES - SET TO DELETE IT                       
         MVI   HELOFLAG,C'Y'                                                    
...
POST0020 EQU   *                                                                
         ...
         BNE   MODEEXIT                                                         
         LA    R2,RCONELEM         FIND X'02' ELEMENTS FOR RE16                 
POST0040 EQU   *                                                                
         ZIC   R1,1(R2)            GET ELEMENT LENGTH                           
         AR    R2,R1               BUMP TO NEXT ELEMENT                         
         CLI   0(R2),0             END OF RECORD?                               
         BE    POST0060            YES - NO X'02' ELEMENT                       
         CLI   0(R2),X'02'                                                      
         BNE   POST0040            NOT X'06' ELEMENT                            
         CLC   =C'CLOSED BY RE16',2(R2)                                         
*                                  'CLOSED' COMMENT?                            
         BNE   POST0040            NO                                           
         MVI   0(R2),X'FF'         YES - SET TO DELETE IT                       
         B     POST0040            GO BACK FOR NEXT ELEMENT                     
POST0060 EQU   *                                                                
...
*                                                                               
TOTALS   NTR1                                                                   
         MVI   FORCEHED,C'Y'       SET PAGE-CHANGE                              
         MVC   P+1(15),=C'CONTRACTS READ:'                                      
         EDIT  CONCTR,(10,P+25)                                                 
         GOTO1 REPORT                                                           
         MVC   P+1(18),=C'CONTRACTS CHANGED:'                                   
         EDIT  CONCHGS,(10,P+25)                                                
         GOTO1 REPORT                                                           
         XIT1                                                                   
         EJECT                                                                  
ALTHDR   EQU   *                                                                
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019REREP1H0D 05/01/02'                                      
         END                                                                    
