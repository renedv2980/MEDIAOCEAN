*          DATA SET SPSFM5A    AT LEVEL 079 AS OF 05/11/04                      
*PHASE T2175AA                                                                  
T2175A   TITLE 'SPSFM5A - PROFIT WITHIN BILL OVERLAY'                           
T2175A   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 NMODWRKL,*T2175A*,R7,R5,RR=RE                                    
...
MINIT05  LH    R1,0(RE)                                                         
         ...
         LH    R1,=Y(OPTABLES-T2175A)                                           
         A     R1,BASE1                                                         
         ST    R1,AOPTABLE         A(OPTION TABLES)                             
         LH    R1,=Y(COREQLST-T2175A)                                           
         A     R1,BASE1                                                         
         ST    R1,ACORQLST         A(CORE-RES EQUATES TABLE)                    
         LH    R1,=Y(ELDATTAB-T2175A)                                           
         A     R1,BASE1                                                         
...
*&&                                                                             
         ...
         MVC   C2BPFLN+13(9),PF12DC                                             
         LA    R0,PFTABLST         R0-->PF TABLES FROM LIST SCREEN              
                                                                                
MINIT20  DS    0H                                                               
         LA    R1,C2BMEDH          IN CASE OF ERROR,                            
         ...
         B     XIT                                                              
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL OVERLAY (VALKEY)'                  
***********************************************************************         
...
*                                                                               
         ...
         USING ESTHDRD,R6                                                       
         SR    R1,R1                                                            
         ICM   R1,15,ECOST2         GET COST2 FACTOR                            
         BZ    MPCTE                IF NONE, THEN ERROR                         
         ST    R1,OC2PCT           SAVE PW%                                     
         EDIT  (R1),(8,C2BPRCT),6,ZERO=NOBLANK,FLOAT=-                          
         OI    C2BPRCTH+6,X'80'     AND DISPLAY IT                              
         ...
         GOTO1 DATCON,DMCB,(X'10',ESDATE),(5,C2BESDT),0                         
         OI    C2BESDTH+6,X'80'                                                 
         PRINT OFF                                                              
*&&DO                                                                           
...
VLOPBUMP ZIC   R0,OPTLEN                                                        
         ...
         B     VLOP10A                                                          
*                                                                               
VALOPTX  MVC   SVOPTFLD,C2BOPTN    SAVE OPTIONS INPUTTED                        
         B     XIT                                                              
         DROP  R4                                                               
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL OVERLAY (VALREC)'                  
***********************************************************************         
*========================== VALIDATE RECORD ==========================*         
VR       DS    0H                                                               
...
VR10     DS    0H                  CHECK SKED PROJ PW% SECOND                   
         LA    R2,C2BPJC2H         R2-->PROJECTED PW%                           
...
*                                  CHECK SKED PROJ BILL TOTAL NEXT              
VR10A    LA    R2,C2BPJBLH         (R4 IS STILL @ SKED TOTALS ENTRY)            
         TM    (BSLTTLH+4-BSLDSECT)(R2),X80                                     
         BZ    VR20                                                             
...
*                                                                               
         LA    R2,C2BCC2H           R2-->1ST MONTH CURR PW%                     
         MVI   FULL,ATFMTTLQ+ATFBILAJ                                           
         MVI   FULL+1,ATFPWQ                                                    
         XC    FULL+2(2),FULL+2                                                 
         BAS   RE,VRMODFLG                                                      
*                                                                               
VR25     TM    BYTE,X40+20         WAS SKED PROJECTED STUFF CHANGE?             
         BNZ   VR40                 YES, DON'T CHECK MONTH PROJ STUFF           
*                                  CHECK MONTHLY PROJECTED PW%                  
         LA    R2,C2BPJC2H          R2-->1ST MONTH PROJ PW%                     
         MVI   FULL,ATFMTTLQ                                                    
         MVI   FULL+1,ATFPWQ                                                    
         XC    FULL+2(2),FULL+2                                                 
         BAS   RE,VRMODFLG                                                      
*                                  CHECK MONTHLY PROJECT BILLING TOTAL          
         LA    R2,C2BPJBLH          R2-->1ST MONTH PROJ BILLING TOTAL           
         MVI   FULL,ATFMTTLQ                                                    
         MVI   FULL+1,ATFPJBLQ                                                  
         XC    FULL+2(2),FULL+2                                                 
         BAS   RE,VRMODFLG                                                      
*                                  CHECK MONTHLY ADJ DR/CR                      
         LA    R2,C2BBILLH          R2-->1ST MONTH ADJ DR/CR                    
         MVI   FULL,ATFMTTLQ+ATFBILAJ                                           
         MVI   FULL+1,ATFDRCRQ                                                  
         XC    FULL+2(2),FULL+2                                                 
         BAS   RE,VRMODFLG                                                      
*                                                                               
VR40     BAS   RE,SAVEACTB         SAVE AWAY ACCUTAB IN CASE OF ERROR           
         EJECT                                                                  
         USING ACCUTABD,R4                                                      
*                                                                               
...
VR100    DS    0H                  SKED CURR PW%                                
         LA    R2,C2BCC2H+(BSLTTLH-BSLDSECT)                                    
...
VR200    DS    0H                  CHECK SKED PROJ PW%                          
         LA    R2,C2BPJC2H+(BSLTTLH-BSLDSECT)                                   
         BAS   RE,LOCSTTL                                                       
         LA    R4,ACCUTABQ(R4)     R4-->SKED TOTALS ENTRY                       
         TM    ATFLAG,ATFPWQ                                                    
         BZ    VR205                                                            
...
*                                                                               
VR205    DS    0H                                                               
         LA    R2,C2BPJBLH+(BSLTTLH-BSLDSECT)                                   
         BAS   RE,LOCSTTL                                                       
         LA    R4,ACCUTABQ(R4)     R4-->SKED TOTALS ENTRY                       
         TM    ATFLAG,ATFPJBLQ                                                  
         BZ    VR210                                                            
...
VR220    DS    0H                                                               
         LA    R2,C2BPJC2H(R3)     CHECK PROJECTED PW% FIRST                    
         TM    ATFLAG,ATFSTTLQ                                                  
         BO    VR260                                                            
         TM    ATFLAG,ATFMTTLQ+ATFBILAJ                                         
         BO    VR255                                                            
...
VR240    DS    0H                  CHECK MONTHLY DR/CR                          
         ...
         ICM   R0,15,ATCS2         MAKE SURE PROJ PW% IS W/IN RANGE             
         MVI   MYERRCD,ELOPWQ                                                   
         C     R0,=A(MINPWQ)                                                    
         BL    MYERROR                                                          
         MVI   MYERRCD,EHIPWQ                                                   
...
VR410    BNE   VR430                                                            
         USING C2STEL,R6                                                        
         LA    R4,PWTAB                                                         
         MVC   C2STFCTR,4(R4)      CURRENT COST2 FACTOR AS INPUT                
         DROP  R6                                                               
VR420    BRAS  RE,NEXTEL                                                        
         BE    VR410                                                            
*                                                                               
VR430    L     R6,AIO                                                           
         TM    ESTFLAG,EFOWPW      IF OOWR PW BILLING,                          
...
*                                                                               
         ...
         B     VR439                                                            
*                                                                               
VR435    MVI   GOSUBN,DOD#         UPDATE PWOOW ELEMENTS                        
         GOTO1 AGOSUB                                                           
*                                                                               
VR439    L     R0,AMYC2REC         KEEP A COPY OF THE C2 RECORD                 
         LA    R1,L'IO                                                          
         L     RE,AIO                                                           
         LR    RF,R1                                                            
         MVCL  R0,RE                                                            
*                                                                               
         L     R6,AIO                                                           
         GOTO1 HELLO,DMCB,(C'G',SYSFIL),('C2STCODQ',(R6)),0,0                   
         CLI   12(R1),X'06'                                                     
         BE    VR439A              NO ELEM ==> NO C2 INFO                       
         L     R6,DMCB+12                                                       
         USING C2STEL,R6                        MARKET LEVEL SHOULDN'T          
         XC    C2STLKC2(L'C2STLKC2*2),C2STLKC2    HAVE DOLLARS                  
         DROP  R6                                                               
*                                                                               
VR439A   GOTO1 PUTREC              PUT MKT-LEVEL RECORD BACK                    
*                                                                               
         L     R0,AMYC2REC         RESTORE THE C2 RECORD                        
         LA    R1,L'IO                                                          
         L     RE,AIO                                                           
         LR    RF,R1                                                            
         MVCL  RE,R0                                                            
...
*&&                                                                             
VR450B   CLC   PWKSTA,TEMPBSTA      YES, IS THIS THE PW RECD FOR IT?            
...
*                                                                               
VR486A   OI    STACFLG,STAFPRCQ    MARK ALL ENTRIES FOR STATION PRCSSED         
         MVI   GOSUBN,TSR_PUT#                                                  
         GOTO1 AGOSUB                                                           
         BE    *+6                                                              
         DC    H'0'                                                             
...
XCUERE   DS    0H                                                               
         ...
         B     MYERROR                                                          
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL OVERLAY (DISPREC)'                 
***********************************************************************         
*=========================== DISPLAY RECORD ==========================*         
DR       DS    0H                                                               
...
** CLT$ **                                                                      
*                                                                               
         LA    R2,C2BLCLTH         LOCKED  CLT$                                 
         LA    R3,C2BCCLTH         CURRENT CLT$                                 
         LA    R6,C2BDCLTH         DIFFERENCE                                   
         MVI   BYTE,C'C'                                                        
         BAS   RE,DBS                                                           
*                                                                               
** LOCKED & CURRENT PW% **                                                      
*                                                                               
DR30     LA    R2,C2BLC2H          LOCKED  PW%                                  
         LA    R3,C2BCC2H          CURRENT PW%                                  
         L     R4,AACCUTAB                                                      
...
*&&                                                                             
         ...
         BZ    DR35B                YEP                                         
*                                                                               
         XC    8(L'C2BM1,R3),8(R3) AT LEAST 1 SPOT & SUM<>0                     
...
*&&DO                                                                           
         ...
         BL    DR35B                                                            
*&&                                                                             
         EDIT  (R1),(8,8(R3)),6,ALIGN=LEFT,FLOAT=-                              
*                                                                               
...
*&&                                                                             
         L     R6,AMYC2REC                                                      
         TM    (PWGNFLG-PWRECD)(R6),PWGNBPLK  SKIP IF NEVER LOCKED BFOR         
         BZ    DR35C                                                            
...
*&&DO                                                                           
         ...
         BZ    DR35C                                                            
*&&                                                                             
         XC    8(L'C2BM1,R2),8(R2)  NEED TO EDIT PW%                            
...
DR35E    DS    0H                                                               
*                                                                               
DR35F    LA    R3,C2BCC2H          TOTAL CURRENT C2                             
         USING BSLDSECT,R3                                                      
         OI    BSLTTLH+6,X'80'                                                  
         MVC   BSLTTL(7),=C'**N/A**'                                            
*&&DO                                                                           
...
*&&DO                                                                           
         ...
         BL    DR35G                                                            
*&&                                                                             
         EDIT  (R1),(8,BSLTTL),6,ALIGN=LEFT                                     
         DROP  R3                                                               
*                                                                               
DR35G    LA    R2,C2BLC2H          TOTAL LOCKED PW%                             
         USING BSLDSECT,R2                                                      
         OI    BSLTTLH+6,X'80'                                                  
         MVC   BSLTTL(7),=C'**N/A**'                                            
*&&DO                                                                           
...
** WIM$ **                                                                      
*                                                                               
DR38     LA    R2,C2BLWIMH         LOCKED  WIM$                                 
         LA    R3,C2BCWIMH         CURRENT WIM$                                 
         LA    R6,C2BDWIMH         DIFFERENCE                                   
         MVI   BYTE,C'W'                                                        
         BAS   RE,DBS                                                           
*                                                                               
** MAKEGOODS **                                                                 
*                                                                               
*^^SUP   LA    R2,C2BMGINH         MAKEGOODS IN                                 
*^^SUP   LA    R3,C2BMGOTH         MAKEGOODS OUT                                
*^^SUP   LA    R6,C2BADJMH         COST ADJUSTMENTS                             
*^^SUP   MVI   BYTE,C'M'                                                        
*^^SUP   BAS   RE,DBS                                                           
*^^SUP   B     DR50                                                             
*                                                                               
...
DR51B    TM    ATFLAG,ATFUNPDQ     ANY SPOTS UNPAID IN MONTH/SKED?              
         ...
         BO    DR51BG                                                           
*                                                                               
         CLI   SPOTPROF+2,0        USING BROADCAST MONTHS?                      
         BE    DR51BF              YES                                          
         LA    RF,BRDWKTB2                                                      
         ZIC   RE,SPOTPROF+6       START MONTH                                  
DR51BA   CLI   0(RF),X'FF'         EOT?                                         
         BNE   *+6                                                              
         DC    H'0'                SHOULDN'T HAPPEN                             
         CLC   ATMSTART,2(RF)      IN THIS PERIOD?                              
         BL    DR51BB                                                           
         LA    RF,4(RF)            NO, CHECK NEXT PERIOD                        
         LA    RE,1(RE)                                                         
         B     DR51BA                                                           
*                                                                               
DR51BB   MVC   WORK(6),EEDATE      GET A COPY OF THE END DATE                   
         CVD   RE,DUB                                                           
         UNPK  WORK+2(2),DUB                                                    
         OI    WORK+3,X'F0'                                                     
         GOTO1 DATCON,DMCB,(0,WORK),(4,WORK+6),0                                
         MVC   MNTHINF,WORK+6                                                   
         B     DR51BG                                                           
*                                                                               
DR51BF   GOTO1 DATCON,DMCB,(2,ATMSTART),(0,MYDATE6),0                           
...
DR55     TM    ATFLAG,ATFSTTLQ     IF WE'RE AT THE SKED LINE                    
         ...
         LA    R6,C2BPJBLH+(BSLTTLH-BSLDSECT)  IN TOTALS COLUMN                 
         B     DR55B                                                            
...
DR57     DS    0H                                                               
         ...
         LA    R3,C2BPJC2H+(BSLTTLH-BSLDSECT)  POINT TO TOTALS COLUMN           
...
*&&                                                                             
         ...
         XC    8(L'C2BM1,R3),8(R3)                                              
         MVI   8(R3),C'0'                                                       
         ICM   R1,15,ATCS2+ACCUTABQ GET THE PROJ PW%                            
         BZ    DR57X                                                            
         MVC   8(7,R3),=C'*RANGE*'  ASSUME OUT-OF-RANGE                         
...
** PW UPDATE STATUS **                                                          
*                                                                               
DR60     OI    C2BC2STH+6,X'80'                                                 
         MVC   C2BC2ST,=CL8'LOCKED'                                             
         TM    LOCKFLAG,LKFFPLKQ                                                
         BO    *+10                                                             
         MVC   C2BC2ST,=CL8'UNLOCKED'                                           
                                                                                
         OI    C2BBYSTH+6,X'80'                                                 
         MVC   C2BBYST,=CL8'LOCKED'                                             
         TM    LOCKFLAG,LKFFLCKQ                                                
         BO    DR70                                                             
         MVC   C2BBYST,=CL8'UNLOCKED'                                           
*                                                                               
** CLT$ BILLED LINE **                                                          
*                                                                               
DR70     DS    0H                                                               
...
DR72     DS    0H                                                               
         ...
         BNO   *+12                                                             
         LA    R2,C2BCBILH+(BSLTTLH-BSLDSECT)   POINT TO TOTALS FIELD           
         B     DR74                                                             
         TM    ATFLAG,ATFMTTLQ+ATFBILAJ                                         
         BNO   DR76A                                                            
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* SET TO TOTAL VALUES FROM THE C2 ELEMENT IN THE PW REC                         
*                                                                               
* ON ENTRY:    (R4)                A(SCHEDULE TOTALS ENTRY)                     
***********************************************************************         
SETTOTLS NTR1                                                                   
         USING ACCUTABD,R4                                                      
         L     R6,AMYC2REC                                                      
         ...
         MVC   ATWLCK,C2STLK                                                    
*                                                                               
         MVC   ATLCS2+ACCUTABQ,C2STPCT                                          
         MVC   ATCS2+ACCUTABQ,C2STFCTR                                          
         MVC   ATCLCK+ACCUTABQ,C2STLKC2                                         
         MVC   ATWLCK+ACCUTABQ,C2STLK                                           
*                                                                               
SETTX    B     XIT                                                              
         DROP  R4,R6                                                            
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL OVERLAY'                           
***********************************************************************         
...
CHPRTMOD NTR1                                                                   
         LA    R2,C2BCC2H              START W/ CURRENT PW% LINE                
         LA    RF,(BSLTTLH-BSLDSECT)(R2)                                        
         LA    R0,C2BBILLH             DO ADJ DR/CR$ LINE NEXT                  
*                                                                               
...
MODSPW   NTR1                                                                   
         ...
         BNE   NO                   (TEMPC2 HAS NEW PW%)                        
         L     RF,TEMPC2                                                        
         STCM  RF,15,ATCS2          AND UPDATE SKED PW% IN ACCUTAB              
...
MODSPW10 TM    ATFLAG,ATFSTTLQ                                                  
         ...
         BO    MODSPW15                                                         
         STCM  RF,15,ATCS2         PUT NEW PW% INTO ACCUTAB                     
                                                                                
MODSPW15 LA    R4,ACCUTABQ(R4)                                                  
         B     MODSPW10                                                         
*                                                                               
MODSPW18 STCM  RF,15,ATCS2         PUT NEW PW% INTO ACCUTAB                     
*                                                                               
MODSPW20 B     YES                                                              
*                                                                               
** PROJECTED PW% **                                                             
...
MODSPW42 DS    0H                                                               
         MVC   ATCS2,TEMPC2        UPDATE MONTH PROJ PW%                        
         MVC   TEMPACB,ATACBUY                                                  
         MVC   TEMPTAX,ATTAX                                                    
         MVI   GOSUBN,C2BUY#                                                    
         GOTO1 AGOSUB                                                           
...
MODMPW   NTR1                                                                   
         ...
         BNE   NO                   (TEMPC2 HAS NEW PW%)                        
         L     RF,TEMPC2                                                        
         STCM  RF,15,ATCS2          AND UPDATE MNTH PW% IN ACCUTAB              
...
MODMPW30 DS    0H                  R4-->MNTH TTL, WHERE PROJ PW% IS             
         MVC   TEMPACB,ATACBUY                                                  
         MVC   TEMPTAX,ATTAX                                                    
         MVC   TEMPC2,ATCS2        ATCS2=PROJ PW%                               
         MVI   GOSUBN,C2BUY#                                                    
         GOTO1 AGOSUB                                                           
...
MODPFB   NTR1                                                                   
         ...
         MVI   GOSUBN,PWPW#                                                     
         GOTO1 AGOSUB                                                           
         MVC   ATCS2,TEMPC2         AND UPDATE ACCUTAB                          
                                                                                
         ICM   R1,15,ATCS2         MAKE SURE PROJ PW% IS W/IN RANGE             
         BZ    MODPFB20                                                         
         MVI   MYERRCD,ELOPWQ                                                   
         C     R1,=A(MINPWQ)                                                    
         BL    NO                                                               
...
GETPW    NTR1                                                                   
         ...
         ST    R0,TEMPC2           PW% IS GOOD                                  
         B     YES                                                              
         SPACE 2                                                                
         DROP  R4                                                               
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (MISC STUFF)'                      
***********************************************************************         
*======================== MISCELLANEOUS STUFF ========================*         
...
*&&                                                                             
         PRINT ON                                                               
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (LTORG && CONST)'                  
***********************************************************************         
*======================== LTORG AND CONSTANTS ========================*         
         LTORG                                                                  
         SPACE 2                                                                
...
UNPDMRK  DC    (L'C2BM1)C'*'                                                    
NSPTMRK  DC    (L'C2BM1)C'.'                                                    
PF12DC   DC    CL9'12=Return'                                                   
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN MAINTENANCE OVERLAY (TABLES)'           
***********************************************************************         
*=============================== TABLES ==============================*         
...
***********************************************************************         
         ...
         TITLE 'SPSFM5A - PW BILL (SUBR01)'                                     
***********************************************************************         
*======================== SUBROUTINE POOL ONE ========================*         
SUBR01Q  EQU   ((((*-T2175A)/4096)+1)*4096)                                     
...
NO_01    LTR   RC,RC                                                            
XIT_01   XIT1                                                                   
         TITLE 'SPSFM5A - PW BILL (SUBR01--BPK#)'                               
*---------------------------- BUILD PW KEY ---------------------------*         
*                                                                               
BPWKEY   DS    0H                                                               
         XC    KEY,KEY                                                          
PWK      USING PWRECD,KEY                                                       
         ...
         DROP  PWK                                                              
         B     XIT_01                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR01--GPR#)'                               
***********************************************************************         
* GET PW RECORD                                                                 
***********************************************************************         
GETPWREC DS    0H                                                               
...
*                                                                               
         ...
         BNE   GPR10                  NOPE, GO READ IT FROM FILE                
         XR    RF,RF                                                            
         ICM   RF,3,(PWLEN-PWRECD)(RE)                                          
         BNZ   *+6                                                              
         DC    H'0'                                                             
...
GPR10    L     R6,AIO                                                           
         ...
         GOTO1 GETREC                                                           
*                                                                               
         LR    R0,R6               COPY PW RECORD TO AMYC2REC                   
         XR    R1,R1                                                            
         ICM   R1,3,(PWLEN-PWRECD)(R6)                                          
         L     RE,AMYC2REC                                                      
         LHI   RF,LIOS                                                          
         MVCL  RE,R0                                                            
         XC    DUB,DUB             CONTAINS C2 LOCKED & WIM LOCKED              
***************                                                                 
* NEED TO LOOK FOR STATION LEVEL FOR LOCKIN VALUES                              
***************                                                                 
GPR20    GOTO1 SEQ                                                              
         ...
         B     GPR20                                                            
***************                                                                 
* DONE WITH THE STATION LEVEL RECORDS                                           
***************                                                                 
GPR40    L     R6,AMYC2REC         SAVE TOTAL LOCKED DOLLARS                    
         GOTO1 HELLO,DMCB,(C'G',SYSFIL),('C2STCODQ',(R6)),0,0                   
         CLI   12(R1),X'06'                                                     
         BE    GPR45               NO ELEM ==> NO C2 INFO                       
         L     R4,AACCUTAB                                                      
         USING ACCUTABD,R4                                                      
         L     R6,DMCB+12                                                       
         USING C2STEL,R6                                                        
...
GPR50    L     R6,AIO                                                           
         ...
         DC    H'0'                                                             
*                                                                               
         MVC   SKEDCGTX,PWGNGOAL   DIG OUT SOME VALUES                          
         MVC   SKEDGRP,PWGNGRP                                                  
         MVC   GLTXRATE,PWGNTAX                                                 
*                                                                               
         B     YES_01                                                           
         DROP  R6                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR01--GBB#)'                               
*------------------------- GET BUYS AND BILLS ------------------------*         
...
PBUY02A  CLI   0(R1),0             NONE, ADD ONE TO BUY                         
         ...
         AR    R1,R0                                                            
         B     PBUY02A                                                          
PBUY03   MVC   2(L'TEMPC2,R1),TEMPC2  CHANGE TO WHAT IS THE CURRENT C2          
         B     PBUY05                                                           
*                                                                               
PBUY04   XC    WORK,WORK                                                        
         LA    R1,WORK                                                          
...
PBUY08I  NI    SBEFLAG,XFF-SBE2COS     RESET SECOND COST FLAG                   
         OI    SBEFLAG,SBEA2COS                                                 
         GOTO1 ASPOTBUY,DMCB,SBLOCK                                             
         NI    SBEFLAG,XFF-SBEA2COS    RESET AFTER SECOND COST FLG              
*                                                                               
         OI    SBEFLAG,SBEWIPW                                                  
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* PROCESS THE BILL HEADER                                                       
***********************************************************************         
         USING BILLRECD,R6                                                      
PROCBLHD CLC   BLMKT,SPACES                                                     
         BE    *+14                                                             
         CLC   BLMKT,QMKT          IS IT THE RIGHT MARKET?                      
         BNE   PBHDX                NO, GO EXIT                                 
*                                                                               
*                                  FIND MONTH ENTRY W/IN ACCUTAB                
         MVC   STARTEND,ESDATE     JUST USE THE ESTIMATE'S START/END            
*                                                                               
*                                  USING EST STRT DATE AS TODAY'S DATE          
         GOTO1 DATCON,DMCB,(0,ESDATE),(3,MYDATE3),0                             
*                                                                               
         CLI   SPOTPROF+2,0        USING STANDARD BROADCAST MONTHS?             
         BE    PBHD50                                                           
         MVC   WORK(6),ESDATE      FIND START OF FISCAL YEAR                    
         ZIC   R1,SPOTPROF+6       OVERRIDE EST START DATE WITH THE             
         CVD   R1,DUB                 FISCAL MONTH/DAY #                        
         UNPK  WORK+2(2),DUB                                                    
         OI    WORK+3,X'F0'                                                     
         ZIC   R1,SPOTPROF+7                                                    
         CVD   R1,DUB                                                           
...
*                                                                               
         ...
         CLC   DMCB(1),SPOTPROF+8                                               
         BNH   PBHD10                                                           
         ZIC   RF,DMCB                                                          
         ZIC   RE,SPOTPROF+8                                                    
         SR    RE,RF                                                            
         ST    RE,DMCB+8                                                        
         GOTO1 ADDAY,DMCB,WORK,WORK+6,,0                                        
         MVC   WORK(6),WORK+6                                                   
*                                                                               
PBHD10   MVC   WORK+6(6),ESDATE+6  SET UP WORK FOR REQUEST TO MOBILE            
         MVI   BYTE,BRDWKQ-1       BYTE = MAX # OF WEEKS TO GENERATE            
         GOTO1 AMOBILE,DMCB,(BYTE,WORK),(SPOTPROF+2,BRDWKTB2),         +        
               MOBINPAD,SPOTPROF                                                
         MVC   BYTE,DMCB           SAVE THE NUMBER OF MONTHS                    
         GOTO1 DATCON,DMCB,(0,ESDATE),(2,HALF),0                                
*                                                                               
         LA    R1,1                NEED TO FIND MONTHS THAT ARE VALID           
         LA    RE,BRDWKTB2                                                      
PBHD20   CLM   R1,1,BYTE           CHECK FOR END CONDITIONS                     
         BH    PBHD80ER                                                         
         CLI   0(RE),X'FF'                                                      
         BE    PBHD80ER                                                         
         CLC   HALF,2(RE)          EST START DATE < END DATE OF MONTH?          
         BL    PBHD30              YES, WE FOUND THE VALID MONTHS               
         LA    RE,4(RE)                                                         
         LA    R1,1(R1)                                                         
         B     PBHD20                                                           
*                                                                               
PBHD30   ZIC   R0,SPOTPROF+6                                                    
         BCTR  R1,0                                                             
         AR    R1,R0                                                            
         STC   R1,HALF             VALID START MONTH #                          
*                                                                               
         ZIC   R0,SPOTPROF+6                                                    
         ZIC   R1,BYTE                                                          
         BCTR  R1,0                                                             
         AR    R1,R0                                                            
         STC   R1,HALF+1           VALID END MONTH #                            
*                                                                               
         CLC   HALF(1),HALF+1                                                   
         BNH   *+12                                                             
         AHI   R1,12                                                            
...
*                                                                               
         ...
         CLM   R1,1,HALF+1                                                      
         BNH   PBHD70                                                           
         B     PBHD80ER            THIS MONTH OUTSIDE BILLING MONTHS            
*                                                                               
PBHD35   CLC   MYDATE3+1(1),HALF+1                                              
         BNH   PBHD70                                                           
         B     PBHD80ER            THIS MONTH OUTSIDE BILLING MONTHS            
*                                                                               
PBHD50   TM    ESTFLAG,EFBILEST     IF THIS IS AN E ESTIMATE,                   
         BO    PBHD70                                                           
         MVC   WORK(2),BKEYYSRV    SET UP BINARY YEAR, MONTH                    
         MVI   WORK+2,1             DAY                                         
         GOTO1 DATCON,DMCB,(3,WORK),(0,MYDATE6),0                               
*                                                                               
PBHD60   GOTO1 AGETBROD,DMCB,(1,MYDATE6),STARTEND,AGETDAY,AADDAY                
*****                                                                           
         CLI   DMCB,X'FF'           ERROR FROM GETBROAD                         
         BNE   PBHD65                                                           
         CLC   =C'13',MYDATE6+2                                                 
         ...
         B     PBHD60                                                           
*****                                                                           
PBHD65   CLC   STARTEND(6),EEDATE     START DATE AFTER ESTIMATE END?            
         BNH   *+10                                                             
         MVC   STARTEND(12),ESDATE                                              
*                                                                               
         CLC   STARTEND(6),ESDATE     FORCE DATE TO START ON OR                 
...
PBHD70   DS    0H                                                               
         ...
         MVC   FULL+2(2),WORK+3    REMOVE HYPHEN FROM DATCON OUTPUT             
*****************************                                                   
*  ADJUST TO USE CORRECT MONTH IN CASE ESTIMATE SPANS INTO THE                  
*    MONTH AND IT IS NOT IN ACCUTAB                                             
*****************************                                                   
         LA    R3,BRDMTHTB                                                      
         USING BCSTTABD,R3                                                      
PBHD71   CLI   0(R3),XFF           END OF BROADCAST MONTH TABLE?                
         BNE   PBHD85               NO, GO CHECK THIS B'CST MONTH               
         CLI   SPOTPROF+2,0        USING BROADCAST MONTHS?                      
         BE    PBHD80ER            YES                                          
         LA    R3,BRDWKTB2                                                      
         CLC   FULL+2(2),BRDWKTB2                                               
         BL    PBHD80ER                                                         
PBHD72   CLI   0(R3),XFF                                                        
         BE    PBHD80ER                                                         
         CLC   FULL(2),0(R3)                                                    
         ...
         B     PBHD72                                                           
*                                                                               
PBHD78   MVC   FULL,0(R3)                                                       
         B     PBHD90                                                           
*                                                                               
PBHD80ER MVC   WORK+0(2),BKEYYSRV   YEP, GET YEAR/MONTH FOR ERROR MSG           
         MVI   WORK+2,0                                                         
         ...
         B     PBHDX                                                            
*                                                                               
PBHD85   CLC   BCSSTART(4),FULL    MATCH ON B'CST MTH START/END                 
         BE    *+12                                                             
         LA    R3,BCSTTABQ(R3)                                                  
         B     PBHD71                                                           
*                                                                               
...
PBHD95   CLI   0(R4),XFF                                                        
         ...
         CLC   ATMONTH(2),FULL                                                  
         BH    PBHD98                                                           
         CLC   ATMONTH+2(2),FULL+2                                              
         BNL   PBHD100                                                          
PBHD98   LA    R4,ACCUTABQ(R4)                                                  
         B     PBHD95                                                           
*                                                                               
PBHD100  DS    0H                                                               
         OI    ATFLAG2,ATF2ESTB     AUTOMATICALLY ESTIM BILLED                  
...
IOHKXIT  DS    0H                                                               
         XIT1                                                                   
         DROP  R2                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR01--FLK#)'                               
*--------------------------- FILL IN LOCKINS -------------------------*         
...
*                                                                               
FLKX     B     XIT_01                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR01--FDC#)'                               
*---------------------------- FILL IN DR/CR --------------------------*         
...
FDCX     DS    0H                                                               
         B     XIT_01                                                           
         DROP  R6                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR01--RUP#)'                               
*------------------------------ ROUNDING -----------------------------*         
...
ROUNDUP  DS    0H                                                               
         ...
         PRINT OFF                                                              
*&&DO                                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR01--SUM#)'                               
*------------------------- TOTAL UP SCHEDULE -------------------------*         
...
*&&DO                                                                           
         ...
         MVI   GOSUBN,PWPW#                                                     
         GOTO1 (RF)                                                             
         MVC   ATLCS2,TEMPC2        AND UPDATE ACCUTAB                          
         MVC   ATLCS2+ACCUTABQ,TEMPC2 PUT ON MNTH TOTALINE TOO                  
*&&                                                                             
...
*&&DO                                                                           
         ...
         GOTO1 (RF)                                                             
         MVC   ATLCS2,TEMPC2           AND UPDATE ACCUTAB                       
         MVC   ATLCS2+ACCUTABQ,TEMPC2  PUT IT IN SKED TOTALS LINE TOO           
*&&                                                                             
...
SUMUPX   B     XIT_01                                                           
         DROP  R4                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR01--UPT#)'                               
*--------------------------- UPDATE PW% TABLE ------------------------*         
...
UPT10    TM    ATFLAG,ATFSTTLQ     IF SCHED TOTALS ENTRY                        
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   4(4,R6),ATCS2       UPDATE PW TABLE                              
...
*&&                                                                             
         PRINT ON                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR01--LTORG && CONSTANTS)'                 
*-------------------------- LTORG & CONSTANTS ------------------------*         
         LTORG                                                                  
         SPACE 2                                                                
         TITLE 'SPSFM5A - PW BILL (SUBR01--MISC STUFF)'                         
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM5A - PW BILL (SUBR02)'                                     
***********************************************************************         
*======================== SUBROUTINE POOL TWO ========================*         
SUBR02Q  EQU   ((((*-T2175A)/4096)+1)*4096)                                     
...
NO_02    LTR   RC,RC                                                            
XIT_02   XIT1                                                                   
         TITLE 'SPSFM5A - PW BILL (SUBR02--CLS#)'                               
*---------------------------- CLEAR SCREEN ---------------------------*         
                                                                                
* Clears the months and total columns of screen                                 
                                                                                
CLRSCR   DS    0H                                                               
         LA    R2,C2BESDTH         R2-->"BEGINNING" OF SCREEN                   
         LA    R3,C2BPFLNH         R3-->"END" OF SCREEN                         
*                                                                               
...
*                                                                               
CLRSCRX  B     XIT_02                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR02--FMS#)'                               
*---------------------------- FORMAT SCREEN --------------------------*         
...
*                                                                               
         TM    ATFLAG,ATFSTTLQ     HIT THE TOTALS LINE?                         
         BO    FMT36               DONE WITH THE MONTHS                         
*                                                                               
         CLI   SPOTPROF+2,0        USING BROADCAST MONTHS?                      
         BE    FMT33               YES                                          
         LA    RF,BRDWKTB2                                                      
         ZIC   RE,SPOTPROF+6       START MONTH                                  
FMT32A   CLI   0(RF),X'FF'         EOT?                                         
         BNE   *+6                                                              
         DC    H'0'                SHOULDN'T HAPPEN                             
         CLC   ATMSTART,2(RF)      IN THIS PERIOD?                              
         BNH   FMT32X                                                           
         ...
         B     FMT32A                                                           
*                                                                               
FMT32X   MVC   WORK(6),EEDATE      GET A COPY OF THE END DATE                   
         CVD   RE,DUB                                                           
         UNPK  WORK+2(2),DUB                                                    
         OI    WORK+3,X'F0'                                                     
         GOTO1 DATCON,DMCB,(0,WORK),(4,WORK+6),0                                
         ...
         B     FMT33A                                                           
*                                                                               
FMT33    GOTO1 DATCON,DMCB,(2,ATMSTART),(0,MYDATE6),0                           
         GOTO1 AGETBROD,DMCB,(1,MYDATE6),STARTEND,AGETDAY,AADDAY                
         GOTO1 DATCON,DMCB,(0,STARTEND+6),(4,WORK),0                            
FMT33A   OI    6(R2),X'80'                                                      
         MVC   8(3,R2),WORK                                                     
...
FMT34    LA    R2,BSLMQ(R2)                                                     
         B     FMT32                                                            
*                                                                               
FMT36    LA    R2,C2BM1H           TOTALS (LAST) COLUMN                         
...
*                                                                               
         DS    0H                                                               
         LA    R2,C2BPJC2H         R2-->PROJECTED PW% LINE                      
         LA    RF,BSLTTLH          RF=END-OF-LOOP CONDITION                     
         LA    R3,C2BPJBLH         R3-->PROJECTED BILLING TOTAL LINE            
         L     R4,AACCUTAB                                                      
...
FMSBUMP  DS    0H                  BUMP POINTER TO ACCUTAB                      
         ...
         SPACE 2                                                                
         DROP  R2,R4                                                            
         TITLE 'SPSFM5A - PW BILL (SUBR02--S1D#)'                               
*-------------------------- SET 1ST DATA FIELD -----------------------*         
...
S1D30    DS    0H                                                               
         ...
         B     XIT_02                                                           
         DROP  R2                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR02--RFG#)'                               
...
ATF2OK1Q EQU   ATF2BILL+ATF2COVD                                                
         TITLE 'SPSFM5A - PW BILL (SUBR02--DDC#)'                               
*------------------------------- DR/CR $ -----------------------------*         
DODRCR   DS    0H                                                               
...
DDC40    DS    0H                                                               
         ...
         B     XIT_02                                                           
         DROP  R4,R6                                                            
         TITLE 'SPSFM5A - PW BILL (SUBR02--PDS#)'                               
*------------------------------ PAID SPOTS ---------------------------*         
...
PDSX     B     XIT_02                                                           
         DROP  R3                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR02--C2BUY# && PWPW#)'                    
*        At entry, TEMPAJB, TEMPACB, & TEMPC2                                   
*         has corresponding values into respective routines                     
                                                                                
*---------------------------- ADJUSTED BUYS --------------------------*         
*                                                                               
PWCBUY   DS    0H                                                               
         L     R2,AIO3             USE 3RD I/O FOR C2BLOCK                      
         XC    0(PWBLKL,R2),0(R2)                                               
         USING PWBLKD,R2                                                        
         MVI   PWACT,PWGETBUY                                                   
...
*                                                                               
PWCPW    DS    0H                                                               
         MVC   TEMPC2,OC2PCT       SET DEFAULT VALUE                            
...
PWCPWX   B     XIT_02                                                           
         DROP  R2                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR02--STI# && RTI#)'                       
*--------------------------- SAVE TIA TABLES -------------------------*         
...
*                                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR02--DCD#)'                               
*------------------------- DO CURRENT DOLLARS ------------------------*         
...
DCDX     DS    0H                                                               
         B     XIT_02                                                           
         DROP  R3,R4                                                            
         TITLE 'SPSFM5A - PW BILL (SUBR02--VWD#)'                               
...
VWDXN    DS    0H                                                               
         B     NO_02                                                            
         TITLE 'SPSFM5A - PW MAINTENANCE (SUBR02--SST#)'                        
...
SST039   EQU   *                                                                
         ...
         B     XIT_02                                                           
         DROP  R3,R5                                                            
         TITLE 'SPSFM5A - PW BILL (SUBR02--RFB#)'                               
*-------------------------- RE-FINAL BILLING -------------------------*         
...
RFBX     DS    0H                                                               
         ...
         B     XIT_02                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR02--DLM#)'                               
*-------------------------- DELETE ELEMENTS --------------------------*         
...
DLMX     DS    0H                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR02--UPT#)'                               
*--------------------------- UPDATE PW% TABLE ------------------------*         
...
UPTX     CLI   0(R6),XFF           BETTER BE AT EOTABLE OF PWTAB                
         ...
         B     XIT_02                                                           
         DROP  R4                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR02--LTORG && CONSTANTS)'                 
*-------------------------- LTORG & CONSTANTS ------------------------*         
         LTORG                                                                  
         SPACE 2                                                                
PERIOD   DC    C'PER'                                                           
ZEROES   DC    (L'C2BM1)CL1'0'                                                  
         SPACE 2                                                                
         TITLE 'SPSFM5A - PW BILL (SUBR02--MISC STUFF)'                         
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM5A - PW BILL (SUBR03)'                                     
***********************************************************************         
*======================= SUBROUTINE POOL THREE =======================*         
SUBR03Q  EQU   (((*-T2175A+X'0FFF')/X'1000')*X'1000')                           
...
NO_03    LTR   RC,RC                                                            
XIT_03   XIT1                                                                   
         TITLE 'SPSFM5A - PW BILL (SUBR03--CEDC#)'                              
...
CEDCXY   DS    0H                                                               
         B     YES_03                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR03--FXR#)'                               
*--------------------------- FIX PW RECORDS --------------------------*         
...
*****    MVC   C2STDATE,BCSSTART                                                
         GOTO1 HELLO,DMCB,(C'G',SYSFIL),('C2STCODQ',AIO),0,0                    
         CLI   DMCB+12,0                                                        
         BE    FXR115                                                           
...
FXRX     DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR03--SUM#)'                               
*------------------------- TOTAL UP SCHEDULE -------------------------*         
...
SUMUPX   B     XIT_03                                                           
         DROP  R4                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR03--DFR#)'                               
...
DFRXY    DS    0H                                                               
         B     YES_03                                                           
         DROP  R3,R6                                                            
         TITLE 'SPSFM5A - PW BILL (SUBR03--STW# && RTW#)'                       
*------------------------------ SAVE TWA -----------------------------*         
...
RSTRTWA  DS    0H                                                               
         ...
         B     XIT_03                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR03--MNI#)'                               
...
MNIX     DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR03--TSR_#''s)'                           
*--------------------------- TSAR INTERFACE --------------------------*         
         USING TSARD,R3                                                         
...
TSR_GO   DS    0H                                                               
         ...
         B     NO_03                                                            
         DROP  R3                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR03--FCO#)'                               
...
FCO022   DS    0H                                                               
         ...
         CLC   ATCS2,=X'80000000'  IF PW% HAS THIS VALUE,                       
         BNE   FCO026                                                           
...
*                                                                               
         DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR03--FOWP#)'                              
...
FILLOOWP DS    0H                                                               
         MVC   DATADISP,=Y(PWEL-PWFKEY)                                         
         L     R6,AMYC2REC         TURN ON "USE OOWR PAID$" FLAG                
         MVI   ELCODE,PWOOWCDQ                                                  
         BRAS  RE,GETEL3                                                        
*                                                                               
FOWP010A BNE   FOWP010X                                                         
*                                                                               
         USING PWOOWEL,R6                                                       
         L     R4,AACCUTAB                                                      
         USING ACCUTABD,R4                                                      
...
FOWPX    DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM5A - PW BILL (SUBR03--DOD#)'                               
...
DODX     DS    0H                                                               
         B     XIT_03                                                           
         DROP  R3,R4                                                            
         TITLE 'SPSFM5A - PW BILL (SUBR03--MISC STUFF)'                         
...
NEXTEL3  DS    0H                                                               
         ...
         TITLE 'SPSFM5A - PW BILL (SUBR03--LTORG && CONSTANTS)'                 
*-------------------------- LTORG & CONSTANTS ------------------------*         
         LTORG                                                                  
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM5A - PW BILL (SUBR04)'                                     
***********************************************************************         
*======================== SUBROUTINE POOL FOUR =======================*         
SUBR04Q  EQU   (((*-T2175A+X'0FFF')/X'1000')*X'1000')                           
...
R04#     EQU   (*-R04_00)/4+R03#                                                
         DC    H'0'                                                             
         TITLE 'SPSFM5A - PW BILL (SUBR04--GBT#)'                               
...
***      MVI   SPOTPROF+8,0            CLEAR IT TO GET B'CST MONTHS             
         GOTO1 AMOBILE,DMCB,(BRDWKQ-1,WORK),(SPOTPROF+2,(R2)),         +        
               MOBINPAD,SPOTPROF                                                
...
BLDBTABX MVI   0(R3),XFF           EOTABLE MARKER                               
         ...
         TITLE 'SPSFM5A - PW BILL (SUBR04--BPT#)'                               
*--------------------------- BUILD PW% TABLE -------------------------*         
...
*                                                                               
         ...
         XC    PWTAB,PWTAB                                                      
*                                                                               
         MVC   TEMPC2,OC2PCT       SET DEFAULT                                  
         L     R6,AIO               IN CASE NOT FOUND IN RECORD                 
         BRAS  RE,GETEL                                                         
         BNE   *+10                                                             
         USING C2STEL,R6                                                        
         MVC   TEMPC2,C2STFCTR      AND GET PW% FROM IT                         
         DROP  R6                                                               
*                                                                               
BPT10    MVC   0(4,R4),BCSSTART    DATE FOR PW TABLE                            
         MVC   4(4,R4),TEMPC2      PW%  FOR PW TABLE                            
         LA    R4,8(R4)            BUMP POINTER IN PWTAB                        
         AHI   R3,BCSTTABQ         BUMP POINTER IN BRDWKTAB/BRDMTHTB            
         CLI   0(R3),XFF                                                        
         BNE   BPT10                                                            
         DROP  R3                                                               
         ...
         MVI   0(R4),XFF                                                        
         J     XIT                                                              
         TITLE 'SPSFM5A - PW BILL (SUBR04--IAC#)'                               
...
*                                                                               
         LA    R3,BRDMTHTB         INITIALIZE TABLE POINTERS                    
         USING BCSTTABD,R3                                                      
         L     R4,AACCUTAB                                                      
         USING ACCUTABD,R4                                                      
         LA    R6,BRDWKTAB                                                      
...
IAC10B   MVC   ATMONTH,BCSSTART                                                 
         ...
         B     IAC10B                                                           
*                                                                               
IAC10C   XC    SDATE2,SDATE2         GET NEXT MONTH'S 1ST BDCST                 
...
*                                                                               
         ...
         B     IAC10                                                            
*                                                                               
IAC013   MVC   ATMONTH,BCSSTART    START-END DATES OF BRDCST MNTH               
...
*                                                                               
         ...
         BNE   IAC30                                                            
         USING C2STEL,R6                                                        
         MVC   TEMPLC2,C2STPCT     SAVE THE LOCKED C2 FACTOR                    
         MVC   TEMPC2,C2STFCTR          & CURRENT C2 FACTOR                     
         DROP  R6                                                               
*                                                                               
IAC30    L     R4,AACCUTAB                                                      
         LA    R6,PWTAB                                                         
...
*****    BO    IAC40D               THEN DON'T FILL IN PW% YET                  
         MVC   ATLCS2,TEMPLC2                                                   
         MVC   ATCS2,TEMPC2        MOVE IN  PW%, AND                            
         TM    ATFLAG,ATFMTTLQ     IF MONTHLY TOTALS ENTRY,                     
         BO    IAC40D               THEN DON'T FILL IN PW% YET                  
...
IAC40X   CLI   0(R6),XFF           BETTER BE AT EOTABLE OF PWTAB                
         ...
         DC    H'0'                                                             
***********************************                                             
* WE COME TO THE TOTALS FOR THE SCHEDULE                                        
***********************************                                             
IAC45    L     R6,AMYC2REC                                                      
         MVI   ELCODE,C2STCODQ                                                  
         MVC   DATADISP,=Y(PWEL-PWFKEY)                                         
...
IAC45A   BNE   IAC45X                                                           
         ...
         DROP  R6                                                               
*                                                                               
IAC45X   LA    R6,ACCUTABQ(R4)                                                  
IAC45XD  USING ACCUTABD,R6                                                      
         MVC   IAC45XD.ATLCS2,ATLCS2                                            
         MVC   IAC45XD.ATCS2,ATCS2                                              
         MVC   IAC45XD.ATCLCK,ATCLCK                                            
         MVC   IAC45XD.ATWLCK,ATWLCK                                            
         DROP  IAC45XD                                                          
*                                                                               
** SET OTHER FLAGS **                                                           
*                                                                               
...
IACX     DS    0H                                                               
         J     XIT                                                              
         DROP  R4                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR04--OKUPD#)'                             
*------------------------ OKAY TO UPDATE FILE? -----------------------*         
...
OKUPDXN  DS    0H                                                               
         J     NO                                                               
         TITLE 'SPSFM5A - PW BILL (SUBR04--MISC STUFF)'                         
*--------------------- SUBR04 MISCELLANEOUS STUFF --------------------*         
                                                                                
                                                                                
         TITLE 'SPSFM5A - PW BILL (SUBR04--LTORG && CONSTANTS)'                 
*-------------------------- LTORG & CONSTANTS ------------------------*         
         LTORG                                                                  
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM5A - PW BILL (SUBRXM)'                                     
***********************************************************************         
*==================== EXIT WITH MESSAGE ROUTINES =====================*         
                                                                                
* Exits which leave T2175A entirely and displays a message go through           
*  this routine.                                                                
                                                                                
*&&DO                                                                           
SUBRXMQ  EQU   ((((*-T2175A)/4096)+1)*4096)                                     
*&&                                                                             
SUBRXMQ  EQU   ((((*-T2175A)/X'100')+1)*X'100')                                 
                                                                                
         ORG   T2175A+SUBRXMQ                                                   
XMSGRTN  NMOD1 0,**5AXM**                                                       
         SR    RC,RC                                                            
         ICM   RC,7,1(R1)                                                       
         USING GEND,RC                                                          
         L     RA,ATWA                                                          
...
XIT_XM   XIT1                                                                   
         TITLE 'SPSFM5A - PW BILL (SUBRXM-ERR MSGS)'                            
*--------------------------- ERROR MESSAGES --------------------------*         
...
*                                                                               
OUTRNGE  LR    R3,R1                                                            
         MVC   0(22,R3),=C'CS2 not in range (0...'                              
         LA    R3,22(R3)                                                        
         L     RE,=A(MAXPWQ)                                                    
         EDIT  (RE),(8,0(R3)),6,ALIGN=LEFT                                      
         AR    R3,R0                                                            
         MVI   0(R3),C')'                                                       
...
*                                                                               
OUTRNG2  LR    R3,R1                                                            
         MVC   0(35,R3),=C'CLCOST makes CS2 out of range (0...'                 
         LA    R3,35(R3)                                                        
         L     RE,=A(MAXPWQ)                                                    
         EDIT  (RE),(8,0(R3)),6,ALIGN=LEFT                                      
         AR    R3,R0                                                            
...
ELOPW    DS    0H                                                               
         LR    R3,R1                                                            
         MVC   0(36,R3),=C'Value makes CS2 smaller than min (0)'                
         MVI   MYERRCD,0           DON'T FORCE USER TO HIT PF9                  
         B     ERREXIT                                                          
*                                                                               
NMDDCPW  DS    0H                                                               
...
ERREXIT  DS    0H                                                               
         ...
         GOTO1 AERREX                                                           
         B     XIT_XM                                                           
         TITLE 'SPSFM5A - PW BILL (SUBRXM-WRN MSGS)'                            
*-------------------------- WARNING MESSAGES -------------------------*         
...
WECST    DS    0H                                                               
         ...
         OI    C2BMEDH+6,X80+X01   FORCE KEY CHANGE FOR NEXT TIME               
         B     WRNEXIT                                                          
         EJECT                                                                  
...
WRNEXIT  DS    0H                                                               
         GOTO1 AERREX                                                           
         B     XIT_XM                                                           
         TITLE 'SPSFM5A - PW BILL (SUBRXM-INF MSGS)'                            
*---------------------------- INFO MESSAGES --------------------------*         
...
INFEXITX DS    0H                                                               
         GOTO1 AERREX                                                           
         B     XIT_XM                                                           
         TITLE 'SPSFM5A - PW BILL (SUBRXM--LTORG && CONSTANTS)'                 
*-------------------------- LTORG & CONSTANTS ------------------------*         
         LTORG                                                                  
                                                                                
                                                                                
         TITLE 'SPSFM5A - PW BILL (SUBRXM--MISC STUFF)'                         
*--------------------- SUBR03 MISCELLANEOUS STUFF --------------------*         
                                                                                
SUBRXML  EQU   *-XMSGRTN                                                        
         DS    0CL(4096-SUBRXML+1)                                              
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (MORE TABLES)'                     
***********************************************************************         
*======================== MORE T2175A's TABLE ========================*         
                                                                                
INIWRKTB DS    0XL(2+2+8)          TABLE FOR INITIALIZING WORK AREA             
         DC    AL2(SVACLABL-NMODWORK,ASVACTB-SYSD),CL8'*SVACTB*'                
         DC    AL2(MYPWLABL-NMODWORK,AMYC2REC-SYSD),CL8'*PWRECD*'               
...
*****    DC     AL1(C2STCODQ),AL1(C2STDATE-C2STEL),AL1(0,0)                     
         ...
         DROP  R8,R9,RA,RB,RC                                                   
         EJECT                                                                  
         TITLE 'SPSFM5A - PROFIT WITHIN BILL'                                   
***********************************************************************         
*========================== T2175A's EQUATES =========================*         
EOT      EQU   X'00'                                                            
X80      EQU   X'80'                                                            
...
X01      EQU   X'01'                                                            
XFF      EQU   X'FF'                                                            
LSTSCRNQ EQU   X'65'               C2/LIST SCREEN PHASE NUMBER                  
...
MINPWQ   EQU   0                   MIN CS2 = 0                                  
MAXPWQ   EQU   9999999             MAX CS2 = 9.999999                           
PWBLKL   EQU   PWBLKX-PWBLKD       L(C2BLOCK)                                   
PKYMKTL  EQU   PWKSTA-PWFKEY       L(PW KEY UNTIL & INCLUDING MKT)              
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (SPSFMWORKD)'                      
***********************************************************************         
*============================= SPSFMWORKD ============================*         
       ++INCLUDE SPSFMWORKD                                                     
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (TWA DSECTS)'                      
***********************************************************************         
*================================ TWA ================================*         
...
* SPSFM9AD                                                                      
       ...
       ++INCLUDE SPSFM66D                                                       
         ...
         DS    0CL(L'C2BOPTN-L'C2MOPTN+1)                                       
         DS    0CL(L'C2MOPTN-L'C2BOPTN+1)                                       
         EJECT                                                                  
*---------------------------- STORAGE AREA ---------------------------*         
...
* SPMSGEQUS                                                                     
       ...
       ++INCLUDE SPMSGEQUS                                                      
         PRINT ON                                                               
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (SPGEN DSECTS)'                    
***********************************************************************         
*============================ SPGEN DSECTS ===========================*         
...
*============================== PW BLOCK =============================*         
       ...
       ++INCLUDE SPPWBLOCK                                                      
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL OVERLAY (SYSD)'                    
***********************************************************************         
*========================== SAVED WORK AREA ==========================*         
...
AMYC2REC DS    A                   A(MY COST2 RECORD)                           
...
HOLDRF   DS    F                                                                
RELO     DS    F                                                                
TEMPLC2  DS    F                   TEMP STORAGE FOR PROFIT WITHIN               
TEMPC2   DS    F                   TEMP STORAGE FOR PROFIT WITHIN               
...
ATLCS2   DS    XL4                  LOCKED  PROFIT WITHIN %                     
ATCS2    DS    XL4                  CURRENT PROFIT WITHIN %                     
...
BSLLENQ  EQU   *-BSLDSECT                                                       
         DS    0CL(BSLLENQ-(C2BTTL+L'C2BTTL-C2BM1H)+1)                          
         DS    0CL((C2BTTL+L'C2BTTL-C2BM1H)-BSLLENQ+1)                          
BSLMQ    EQU   BSLLENQ/5                                                        
***********************************************************************         
...
*============================== SPOTTABD =============================*         
       ...
       ++INCLUDE SPOTTABD                                                       
         PRINT ON                                                               
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (NMOD WORK AREA)'                  
***********************************************************************         
*=========================== NMOD WORK AREA ==========================*         
NMODWORK DSECT                                                                  
*                                                                               
...
***********************************************************************         
         TITLE 'SPSFM5A - PROFIT WITHIN BILL (SPOT STRG AREA)'                  
***********************************************************************         
*========================== SPOT STORAGE AREA ========================*         
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'079SPSFM5A   05/11/04'                                      
         END                                                                    
