*          DATA SET ACREPTT97  AT LEVEL 047 AS OF 03/02/98                      
*PHASE ACTT02A,*                                                                
*INCLUDE SORTER                                                                 
*INCLUDE DLFLD                                                                  
*INCLUDE CONVMOS                                                                
...
REQF     DS    0H                                                               
         ...
         ZAP   INVCNT,=P'0'                                                     
*                                                                               
         MVC   SVCPHONE,SPACES     CLEAR AGENCY PHONE FIELD                     
...
DOAREC   NTR1                      CLEAR OUT RECORD AREA                        
         ...
         MVC   ACPHONE,SVCPHONE    PHONE NUMBER                                 
*                                                                               
...
LOOK80   STC   R0,D1CADNL          NUMBER OF ADDR LINES                         
         ...
         BAS   RE,FIXADDR                                                       
*                                                                               
         MVC   SVCPHONE,CPHONE     COMPANY PHONE NUMBER                         
         TM    DWNSTAT,DWNCMPY                                                  
         BO    LOOK90                                                           
...
*                                                                               
         ...
         DC    X'00'                                                            
         DC    CL33'ARNOLD COMMUNICATIONS'     COMPANY NAME                     
         DC    CL33'101 ARCH STREET'                                            
         DC    CL33'BOSTON, MA  02110'                                          
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'6177376804'    AGENCY PHONE NUMBER                          
*                                                                               
* AL - ANDERSON LEMBKE                                                          
*                                                                               
         DC    C'AL'               ALNY                                         
...
*                                                                               
         ...
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'2123719100'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'BC'               MDCH - RAPP, COLLINS, MARCOA                 
         DC    AL2(2105)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'362777652'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'3124544961'    AGENCY PHONE NUMBER                          
*                                                                               
...
*                                                                               
         ...
         DC    CL33'488 MADISON AVE. 4TH FLOOR'  3 X 33 ADDR LINES              
...
*                                                                               
         ...
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'2128272024'    AGENCY PHONE NUMBER                          
*                                                                               
...
*                                                                               
         ...
         DC    X'01'                                                            
         DC    CL33'BBDO SOUTH, INC.'                                           
         DC    CL33'3414 PEACHTREE ROAD NE'                                     
...
*                                                                               
         DC    C'CF'               CANYH                                        
         DC    AL2(6296)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133928393'        EIN                                          
         DC    X'00'                                                            
...
*                                                                               
         ...
         DC    X'00'                                                            
         DC    CL33'CORDIANT INDEPENDENT ADVERTISING'                           
...
*                                                                               
         ...
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'4159554345'    AGENCY PHONE NUMBER                          
*                                                                               
...
*                                                                               
         ...
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'2125924952'    AGENCY PHONE NUMBER                          
*                                                                               
* LP - LOWE DIRECT                                                              
*                                                                               
         DC    C'LP'               LOWE - LPNYD                                 
         ...
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'2124037740'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'LP'               LOWE - LPNYDT                                
...
*                                                                               
         ...
         DC    X'01'                                                            
         DC    CL33'DDB NEEDHAM CHICAGO, INC.'                                  
         DC    CL33'200 EAST RANDOLPH DRIVE'                                    
         DC    CL33'CHICAGO, IL  60601'                                         
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15' '             AGENCY PHONE NUMBER                          
*                                                                               
...
*                                                                               
         ...
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL15'6172957762'    AGENCY PHONE NUMBER                          
*                                                                               
...
SVCPHONE DS    CL15                SAVED AREA FOR AGENCY PHONE                  
*                                                                               
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE DDDLCB                                                         
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'047ACREPTT97 03/02/98'                                      
         END                                                                    
