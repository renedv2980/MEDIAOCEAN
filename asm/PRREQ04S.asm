*          DATA SET PRREQ04S   AT LEVEL 065 AS OF 05/01/02                      
*PHASE T41204A,+0                                                               
*INCLUDE SRCHCALL                                                               
         TITLE 'CHANGE LOG'                                                     
*                                                                               
...
ONEV2    LR    RA,R7                         SAVE ENTRY ADDR                    
         ...
         MVC   IFLD,4(R7)                                                       
         B     ONEVO                                                            
ONEV3    SH    R5,=H'4'                      SEARCH VALUE LIST(S)               
ONEV4    CLI   4(R7),C'*'                                                       
         BNE   ONEV5                                                            
...
*                                                                               
         CLC   RNUM,=C'AR'      SEE IF AOR CONTRACT REPORT                      
         BE    CONV2            CAN'T READ CONTRACT                             
*                                                                               
         CLI   RPUB+10,C'Z'      SEE IF DOING ALL EDITIONS                      
         BE    CONV2             BYPASS FILE READ                               
         GOTO1 AREAD,PLIST,C'PRT1'                                              
         CLC   FERN,=AL2(FE)                                                    
         BL    CONVO                                                            
         BH    CONV2                                                            
         MVC   FERN,=AL2(MISREC) NOT ON FILE                                    
         B     CONVO                                                            
CONV2    OI    FIND,X'04'        CONTRACT VALID NNN                             
*****                                                                           
         CLC   RNUM,=C'16'                                                      
         BNE   CONVO                                                            
         LA    R6,PRTREC+33                                                     
...
*NOP*    DC    AL1(27,48,0,62),C'ABCDKLNPRSVWXZ1234$MYGU'                       
         ...
         DC    AL1(06,105,0,63),C'NY'                                           
         DC    AL1(06,105,0,64),C' R'                                           
...
REPHDRD  DSECT                                                                  
       ++INCLUDE PREPREC                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'065PRREQ04S  05/01/02'                                      
         END                                                                    
