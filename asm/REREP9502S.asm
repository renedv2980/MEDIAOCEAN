*          DATA SET REREP9502S AT LEVEL 059 AS OF 05/01/02                      
...
POST0050 EQU   *                                                                
*                                                                               
         CLC   RCONDATE+3(3),SDATE CONTRACT END VS REQUEST START                
         BL    MODEEXIT            SKIP:  ENDS BEFORE REQUEST DATE              
         CLC   EDATE,RCONDATE      REQUEST END VS CONTRACT START                
...
*                                     SKIP IT                                   
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'059REREP9502S05/01/02'                                      
         END                                                                    
