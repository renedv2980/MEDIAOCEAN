*          DATA SET PUBCOPYSC  AT LEVEL 007 AS OF 05/01/02                      
*PHASE PUBCOPYS,*,NOAUTO                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
AGMLSTX  EQU   *-1                                                              
         DC    6X'00'                                                           
MCLTAB   DC    C'ICNEIKPMI2ERI2HUI2MEI2MHI2MRI2RCI2TBI2WU'                      
         DC    X'00'                                                            
*                                                                               
       ++INCLUDE PVALUES                                                        
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007PUBCOPYSC 05/01/02'                                      
         END                                                                    
