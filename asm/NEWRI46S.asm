*          DATA SET NEWRI46S   AT LEVEL 047 AS OF 05/01/02                      
*          DATA SET NEWRI46X   AT LEVEL 021 AS OF 02/06/92                      
*PHASE T32046A                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE DLFLD                                                                  
*INCLUDE PRINT                                                                  
...
*                                                                               
         ...
         MVC   BRDCODE,=C'PXZ'     FOR SJR                                      
         CLC   NBSELAGY,=C'SJ'                                                  
         BE    RP3                                                              
         MVC   AGYCODE,=C'03'      FOR DF                                       
         MVC   BRDCODE,=C'303'     FOR DF                                       
         CLC   NBSELAGY,=C'DF'                                                  
         BE    RP3                                                              
         MVC   AGYCODE,=C'04'                                                   
         MVC   BRDCODE,=C'304'                                                  
         CLC   NBSELAGY,=C'NW'      FOR NW                                      
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
RP3      GOTO1 DATCON,DMCB,(5,TODAT),(0,TODAT)         YYMMDD                   
...
RP10     NETGO NSNETIO,DMCB,NETBLOCK                                            
         ...
         GOTO1 DATCON,DMCB,(2,MONLIST),(0,RQCHARP)  GET REQUESTED PER           
*                                                                               
         CLC   RQCHARP+2(2),=C'12'    IF DECEMBER/BROADCAST MONTHS SO           
         BE    *+14                                                             
         CLC   RQCHARP+2(2),=C'06'  IF JUNE/BROADCAST                           
         BNE   RP20                                                             
         GOTO1 ADDAY,DMCB,RQCHARP,RQCHARP,F'8'     BUMP MONTH TO GET            
*                                                    FIRST HALF                 
...
*                                                                               
* - STANDARD ESTIMATE                                                           
DO60     GOTO1 =V(NETACC),DMCB,(28,NETACFLD),NETBLOCK       28=TIS              
         MVC   DUB,NETACFLD+1                                                   
         AP    0(8,R4),DUB                                                      
         LA    R5,DUB                                                           
         BAS   RE,DO99                                                          
...
*                                                                               
         ...
         BNE   PG90                                                             
         USING PGNETELM,R6                                                      
         MVC   BRANDSV,PGNETPB     SAVE BRAND                                   
*                                                                               
...
PG35     MVI   ELCODE,X'30'                                                     
         ...
         MVC   B4EVENT,PGNETEC                                                  
         MVC   B4MULTI,PGNETMB                                                  
*        GOTO1 =V(PRNTBL),DMCB,=C'F4IN',0(R6),C'DUMP',50,=C'1D'                 
...
PGBRAND  NTR1                                                                   
         ...
         BNE   PGB20                                                            
         USING PGNETELM,R6                                                      
         MVC   BRANDSV,PGNETPB     SET PG BRAND                                 
         OC    BRANDSV,PGNETPB                                                  
         BNZ   PGBX                                                             
...
TABLE    DS    CL20000                                                          
         ...
         DS    CL20000                                                          
*                                                                               
         BUFF  LINES=1,ROWS=1,COLUMNS=6,FLAVOR=PACKED,KEYLIST=(80,A)            
*                                                                               
         EJECT                                                                  
...
*                                                                               
         EJECT                                                                  
*                                                                               
BFREC    DS    0CL160              BUFFALO RECORD LAYOUT                        
BFKEY    DS    CL80                                                             
BFDATA1  DS    CL8                                                              
BFDATA2  DS    CL8                                                              
BFDATA3  DS    CL8                                                              
...
B4EVENT  DS    CL6                                                              
         DS    CL8                                                              
B4MULTI  DS    CL1                                                              
B4SPARE  DS    CL39                SPARE                                        
         DS    CL80                SPARE                                        
*                                                                               
         ORG   BFREC                                                            
B5D      DS    0CL160             F5 PNG RECORD                                 
B5ID     DS    CL2                                                              
B5CODE   DS    CL1                                                              
B5CHPER  DS    CL3                                                              
B5AGY    DS    CL2                                                              
...
B5EST    DS    CL4                                                              
B5SPR    DS    CL2                                                              
         DS    CL60                KEY FILLER FOR BUFFALO                       
B5MON1   DS    CL8                                                              
B5MON2   DS    CL8                                                              
B5MON3   DS    CL8                                                              
B5MON4   DS    CL8                                                              
...
B6DETBC  DS    CL3           PGBRAND                                            
         DS    CL57                FILLER FOR BUFFALLO KEY                      
B6MON1   DS    CL8                                                              
B6MON2   DS    CL8                                                              
B6MON3   DS    CL8                                                              
B6MON4   DS    CL8                                                              
...
F6PROD   DS    CL3                                                              
F6EST    DS    CL4                                                              
F6BSX    DS    CL2           DDS BRAND SUFFIX                                   
F6DETBC  DS    CL3           PGBRAND                                            
F6TXTE   EQU   *-F6ID                                                           
F6MON1   DS    CL9                                                              
F6MON2   DS    CL9                                                              
F6MON3   DS    CL9                                                              
...
CTBLENE  EQU   *-CCLT                                                           
       ...
       ++INCLUDE SPGENBILL                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'047NEWRI46S  05/01/02'                                      
         END                                                                    
