*          DATA SET CTGEN21    AT LEVEL 024 AS OF 05/01/02                      
*PHASE TA0B21A,*                                                                
*                                                                               
***********************************************************************         
*============================= UPDATE LOG ============================*         
...
* -------- --- ----   ------------------------------------------------*         
* May08/00 023 GLEE - Fix bug updating control message numbers        *         
*                                                                     *         
...
VR193B   DS    0H                  CONTROL MSG#2                                
         ...
         LA    RF,1(RF)                                                         
         BAS   RE,SKP40BIT                                                      
         ZICM  RE,BNDRY,(3)         MAKE BNDRY'S VALUE INTO A                   
         LNR   RE,RE                 32-BIT SIGNED NUMBER                       
         AR    RE,RF                                                            
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024CTGEN21   05/01/02'                                      
         END                                                                    
