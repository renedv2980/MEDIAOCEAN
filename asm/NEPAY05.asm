*          DATA SET NEPAY05    AT LEVEL 054 AS OF 11/20/17                      
*PHASE T31305A,+0                                                               
         TITLE 'NETPAK PAY PROGRAM - AUDIT TRAIL OVERLAY - T31305'              
T31305   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         BAS   RE,ADDLIN                                                        
*                                                                               
         BAS   RE,BILLSPEC         BILLED SPECIALS                              
*                                                                               
...
FBILL5A  CLI   0(RE),X'FF'         INVALID BILL TYPE                            
         BNE   *+6                                                              
         DC    H'0'                                                             
         CLC   NUBILTYP(1),0(RE)                                                
         BE    FBILL5B                                                          
         LA    RE,2(RE)                                                         
         B     FBILL5A                                                          
FBILL5B  MVC   BILTYP(1),1(RE)                                                  
*                                                                               
         MVC   BILPRD,NUBILPRD                                                  
         MVC   BILPRDA,NUBILPRC                                                 
         MVC   BILNUM,NUBILNUM                                                  
...
*                                                                               
         ...
         MVC   FLD+14(3),THREE                                                  
*                                                                               
FBILL10D OC    BILNUM,BILNUM       TEST FOR A BILL NUMBER                       
...
SPECCT80 BAS   RE,EDCOS1                                                        
         ...
         DROP  R4                                                               
         SPACE 2                                                                
* SUB-ROUTINE TO DISPLAY THE BILLED SPECIALS                                    
*                                                                               
BILLSPEC NTR1                                                                   
...
*                                                                               
         ...
         B     BILLSP20                                                         
         USING NUBILD,R4                                                        
BILLSP10 ZIC   RE,NUBILLEN                                                      
         AR    R4,RE                                                            
         CLI   NUBILEL,X'10'                                                    
         BE    BILLSP20                                                         
         B     BILLSP80                                                         
*                                                                               
BILLSP20 TM    NUBILST,UNBILL      TEST FOR UNBILLED ELEMENT                    
         BO    BILLSP10            YES-DO NOT ACCUM                             
         CLI   NUBILTYP,C'T'       TEST FOR TIME                                
         BE    BILLSP10            YES                                          
         CLI   NUBILTYP,C'I'       TEST FOR INTEGRATION                         
         BE    BILLSP10            YES                                          
*                                                                               
BILLSP40 ICM   RF,15,NUBILGRS                                                   
         AR    R0,RF               ADD TO ACCUMULATOR                           
         B     BILLSP10                                                         
*                                                                               
BILLSP80 BAS   RE,EDCOS1                                                        
         BAS   RE,ADDLIN                                                        
         B     EXXMOD                                                           
         DROP  R4                                                               
         SPACE 2                                                                
...
SORTTAB  DC    XL25'E301C902E403C204E205D606E707C508C109D30AC40BD80CFF'         
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'054NEPAY05   11/20/17'                                      
         END                                                                    
