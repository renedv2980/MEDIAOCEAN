*          DATA SET RELDTKO2   AT LEVEL 008 AS OF 05/01/02                      
*PHASE RELDTKO2,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
DMX0020  EQU   *                                                                
         ...
         BE    DMXKEEP             NOT IN TABLE:  KEEP IT                       
         CLC   RCONKREP,0(RF)      REP CODE IN TABLE?                           
         BE    DMX0040             YES - CHECK RECORD                           
         LA    RF,2(RF)            NO  - BUMP TO NEXT TABLE ENTRY               
         B     DMX0020             GO BACK FOR NEXT                             
REPTAB   DC    C'AQMGIFI2I8I9RMD4S1CNL7IB'                                      
         DC    X'0000'                                                          
DMX0040  EQU   *                                                                
         CLC   =X'0000',RCONTEM    TEAM CODE EMPTY?                             
         BNE   DMX0060             NO                                           
         MVC   RCONTEM,=C'R '      YES - SET TO 'RADIO/NONE'                    
         L     R5,AREC             POINT TO RECORD                              
         USING RCONREC,R5                                                       
         MVC   P(2),=C'TM'                                                      
         MVC   P+4(2),RCONKREP                                                  
         MVC   P+20(60),RCONELEM                                                
         GOTO1 =V(HEXOUT),DMCB,RCONKCON,P+08,4                                  
         GOTO1 VPRINTER                                                         
*                                                                               
DMX0060  EQU   *                                                                
         CLC   =C'IB',RCONKREP                                                  
         BNE   DMXKEEP                                                          
         CLI   RCONSAL,C'T'        TAKEOVER CONTRACT?                           
         BNE   DMXKEEP                                                          
         MVI   RCONTYPE,C'Z'       SET SPECIAL CONTRACT TYPE                    
         DROP  R5                                                               
*                                                                               
         AP    CHANGE,=P'1'                                                     
         L     R5,AREC             POINT TO RECORD                              
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008RELDTKO2  05/01/02'                                      
         END                                                                    
