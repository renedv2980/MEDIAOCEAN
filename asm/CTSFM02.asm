*          DATA SET CTSFM02    AT LEVEL 052 AS OF 05/01/02                      
*PHASE TA0A02A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
VK77     GOTO1 HIGH                                                             
         TM    MYFLAGS,PRGEQUAL    IF PROGRAM NAME ENTERED IS =XXX              
         BO    VKX                 SKIP PAGE NUMBER CHECK                       
         CLC   KEY(HV1KLENQ),KEYSAVE                                            
...
LSTTEXT  DS    CL25                                                             
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'052CTSFM02   05/01/02'                                      
         END                                                                    
