*          DATA SET SRWKZ03    AT LEVEL 003 AS OF 03/10/16                      
*PHASE T13B03A                                                                  
...
*                                                                               
         ...
         USING W_RECD,R5                                                        
         GOTO1 VDATAMGR,WKDMCB,(X'00',BUFFER),WRKZID,NDX,ACTREC,(R5)            
         CLI   8(R1),0                                                          
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   CIADDR,CIPASS                                                    
...
*FAUTL                                                                          
       ...
       ++INCLUDE FAUTL                                                          
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003SRWKZ03   03/10/16'                                      
         END                                                                    
