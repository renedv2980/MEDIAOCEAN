*          DATA SET ACBAT61B   AT LEVEL 054 AS OF 03/04/05                      
*PHASE T61B61BA                                                                 
...
ITECHA16 CLI   CSLSTCUR+2,45       HANDLE TYPE 45S DIFFERENTLY                  
         BE    ITECHA17                                                         
         CLI   CSLSTCUR+2,61       DITTO FOR TYPE 61                            
         BE    ITECHA17                                                         
         TM    CSBIND5,TYPIOVSS    TEST OVERLAY CAN CALL SUB-SCREEN             
         BZ    ITECHA24                                                         
ITECHA17 CLI   CSOLINE,0                                                        
         BE    ITECHA22                                                         
...
*                                                                               
         ...
         SR    R0,R0                                                            
*                                                                               
         TM    TBARESTA-TBARECD(R4),TBAESORD                                    
         BZ    ITEDEL36                                                         
         LA    R2,TBARFST          PROCESS ORDERS (MIXIUNDO)                    
         USING BIOELD,R2                                                        
ITEDEL32 CLI   BIOEL,0                                                          
         BE    ITEDEL36                                                         
         ...
         ICM   R1,8,=X'80'                                                      
         GOTOR AUPDORD,(R1)                                                     
ITEDEL34 IC    R0,BIOLN                                                         
         AR    R2,R0                                                            
         B     ITEDEL32                                                         
*                                                                               
ITEDEL36 LA    R2,TBARFST                                                       
         USING ASKELD,R2                                                        
ITEDEL38 CLI   ASKEL,0                                                          
         BE    ITEDEL56                                                         
...
*                                                                               
         USING GINELD,R2                                                        
ITEDEL42 CLI   GINEL,GINELQ        DELETE POSTINGS VIA GIN PASSIVES             
         BNE   ITEDEL43                                                         
         LA    R1,IOKEY                                                         
         USING GINPASD,R1                                                       
         XC    GINPKEY,GINPKEY                                                  
...
*                                                                               
         USING BIAELD,R2                                                        
ITEDEL43 CLI   BIAEL,BIAELQ        TEST ITEM AMOUNT ELEMENT                     
         BE    *+12                                                             
         ...
         B     ITEDEL54                                                         
*                                                                               
ITEDEL44 SP    LSTBTDRS,BIAAMT     'DEBITS'=TAX                                 
         B     ITEDEL54                                                         
*                                                                               
ITEDEL46 TM    TBARESTA,TBAESDAC   TEST DR/CR PAIR                              
         BZ    ITEDEL48                                                         
         ...
         B     ITEDEL54                                                         
*                                                                               
ITEDEL48 LA    RE,LSTBTCRS         ACCUMULATING TOTAL DRS/CRS                   
         TM    TBARESTA,TBAESIDR   TEST DEBIT ITEM                              
         BZ    *+14                                                             
         SP    LSTBCSHA,BIAAMT     UPDATE BATCH TOTAL                           
         LA    RE,LSTBTDRS                                                      
...
GENTRN   NMOD1 0,**GTRN**                                                       
         ...
         CLI   CSACT,ACTREV        TEST REVERSING                               
         BE    *+16                                                             
...
GENTRN16 ICM   RE,3,TRSPMOS        SAVE ORIGINAL MOS                            
         ...
         B     GENTRN20                                                         
GENTRN18 NI    TRSSTAT,RTRSBITS    REVERSE - CLEAR/PRESERVE BITS                
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE CTGENFILE                                                      
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'054ACBAT61B  03/04/05'                                      
         END                                                                    
