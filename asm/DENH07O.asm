*          DATA SET DENH07O    AT LEVEL 023 AS OF 02/02/09                      
*PHASE DENH07OA                                                                 
*--------------------------------------------------------------------*          
...
DENH07O  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 NADWRKX-NADWRKD,DENH07O,R7                                       
...
*        MVC   WORK+7(2),INTIBOOK  TO FORCE BOOK ON X'5E' ELEMENT               
         MVC   WORK+7(2),=X'5C01'  TO FORCE BOOK ON X'5E' ELEMENT               
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DDMONYREQU                                                     
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023DENH07O   02/02/09'                                      
         END                                                                    
