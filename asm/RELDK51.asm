*          DATA SET RELDK51    AT LEVEL 018 AS OF 05/01/02                      
*PHASE RELDK51,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
...
*******************************************************************             
*                                                                 *             
*  STRIP TYPE X'51' RECORDS FOR KATZ NATIONAL FROM DUMP TAPE      *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
DMXPURGE L     R1,APARM            PURGE RECORD EXIT                            
         MVI   0(R1),X'FF'                                                      
         AP    PURGE,=P'1'                                                      
         CLI   0(R3),X'FF'         ENTRY NOT IN LIST?                           
         BE    DMXIT               YES - DON'T TRY TO ADD                       
         AP    10(5,R3),=P'1'      INCREMENT SPECIFIC RECORD TYPE               
         B     DMXIT                                                            
         SPACE 2                                                                
...
*                                                                               
         MVC   HALF,RDARLEN                                                     
         LH    R8,HALF                                                          
         GOTO1 PRNTBL,DMCB,(6,(R6)),(R5),C'DUMP',(R8),=C'2D'                    
*                                                                               
         DROP  R5                                                               
*                                                                               
         B     DMXKEEP                                                          
DROPREC  EQU   *                                                                
*                                                                               
*   R5 -->  RECORD IN PROCESS, TO BE DROPPED                                    
*                                                                               
         LA    R3,CODES                                                         
*                                                                               
* GET DISPLACEMENT TO REP CODE IN RECORD                                        
DMXREC1  CLC   0(1,R5),8(R3)       RECORD TYPE TO TABLE                         
         BE    DMXPURGE            YES - PURGE AND ADD TO COUNT                 
         LA    R3,L'CODES(R3)      BUMP TO NEXT ENTRY                           
         CLI   0(R3),X'FF'         END OF LIST?                                 
         BNE   DMXREC1             NO  - GO BACK AND CHECK IT                   
         LA    R3,UNKNOWN          YES - SET ADDRESS TO 'UNKNOWN'               
         B     DMXPURGE            UNKNOWN REC - PURGE, NO COUNT                
         EJECT                                                                  
*******************************************************************             
* END-OF-FILE LOGIC                                               *             
*******************************************************************             
...
CODES    DS    0CL15                                                            
         ...
         DC    CL8'DARE X41',XL1'41',AL1(RDARKREP-RDARREC),PL5'0'               
         DC    CL8'DARE X51',XL1'51',AL1(RDARKREP-RDARREC),PL5'0'               
UNKNOWN  DC    CL8'UNKNOWN ',XL1'FB',AL1(RDARKREP-RDARREC),PL5'0'               
         DC    X'FF'                                                            
         EJECT                                                                  
...
RDARD    DSECT                                                                  
       ++INCLUDE REGENDAR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018RELDK51   05/01/02'                                      
         END                                                                    
