*          DATA SET PTXTRACT   AT LEVEL 111 AS OF 02/19/21                      
*PHASE QXTRACTA                                                                 
*INCLUDE DMUTLCT                                                                
*INCLUDE DMDMGRL                                                                
*INCLUDE PPBYOUT                                                                
...
*INCLUDE PPGETCON                                                               
*INCLUDE PPGETCU                                                                
*INCLUDE PTXROUTS                 XTRACT RECORD CREATION MODULE                 
*INCLUDE PTXCNVX                  CONVERSION ROUTINES FOR ALL ABOVE             
         TITLE 'PTXTRACT - EXTRACT PRINT SYSTEM FILE SQL DATA'                  
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         MVC   TYPECODE,SXDTTYP                                                 
*                                                                               
*SMY*    CLC   TYPECODE,=C'IDK'    IDESK REQUEST ?                              
*SMY*    JNE   *+8                 NO                                           
*SMY*    OI    DXFLAGS,DXFAAGY     SET "ALL AGENCIES" FLAG                      
*                                                                               
...
*                                                                               
         ...
         DC    V(PRIBUD)          BUDGET                                        
         DC    V(PRISTC)          STANDARD COLUMNS                              
         DC    V(PRIBFM)          BILL FORMULA                                  
*                                                                               
...
*                                                                               
         ...
         DC    CL3'STC',AL1(00,00,TYPSSUP,00,00)                                
         DC    AL4(LOADSTC,UPDTSTC)                                             
         DC    CL3'BFM',AL1(00,00,TYPSSUP,00,00)                                
         DC    AL4(LOADBFM,UPDTBFM)                                             
*                                                                               
         DC    X'FF'                                                            
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
GETIT07  DS    0H                                                               
         GOTO1 VDATAMGR,DMCB,(X'00',GETREC),GENFIL,PRIADDR,(R2),DMWORK          
         J     GETIT20                                                          
*                                                                               
GETIT10  DS    0H                                                               
...
*                                                                               
         ...
         DC    CL3'STC',AL1(0),AL4(LOADSTC) STANDARD COLUMNS                    
...
* * * * * * * * * * * * * * * * ** *** * * * * * * * * * * * * * * * *          
         GOTO1 VPRIBUYC,DMCB,(DXMODE,DXAXREC),(R2),(1,0),              X        
               (ROUTFLG,(R6)),(VERSION,MEDTABD)                                 
*                                                                               
*                                  GET NEXT UNCOMMITTED RECORD                  
LBUY04   DS    0H                                                               
         GOTO1 VPRIBUYC,DMCB,(DXMODE,DXAXREC),(R2),(2,0),(R6),MEDTABD           
         CLI   8(R1),X'FF'                                                      
...
*                                                                               
UPDTBUY5 DS    0H                                                               
         GOTO1 VPRIBUYC,DMCB,(DXMODE,DXAXREC),(R2),(2,0),(R6),(R8)              
         CLI   8(R1),X'FF'                                                      
...
UPDTBUY6 DS    0H                                                               
*                                                                               
         CLI   (PRIBYACT-PRIBYD)(RF),C'A'       IF ADD SKIP TO PUT              
         JE    UPDTBUY8                                                         
         MVI   (PRIBYACT-PRIBYD)(RF),C'D'                                       
         MVI   COPYFLAG,X'01'                                                   
         J     UPDTBUY8                                                         
*                                                                               
UPDTBUY7 DS    0H                                                               
...
INITBUY  NTR1  BASE=*,LABEL=*                                                   
         LA    R1,PRIBYDL          R1=L'CON RECORD (LONGEST)                    
         GOTO1 AINITALL                                                         
         J     YES                                                              
***********************************************************************         
*                                                                               
...
*                                                                               
************   DIRECTORY ONLY REC - ACCLOAD ROUTINE WILL SKIP GETREC            
*SMY*    MVC   PRIADDR,27(R2)                                                   
...
*                                                                               
         ...
         BRAS  RE,GETMED           R8=A(MEDIA TABLE ENTRY)                      
*        CLI   PCOLKMED,C'A'       ONLY MEDIA FOR CUSTOM COLUMNS                
*        JE    UPDTCCC2                                                         
         GOTO1 AFILTCCC                                                         
         JNE   YES                                                              
         GOTO1 AINITCCC                                                         
...
*                                                                               
         LRL   RE,VUTL                                                          
         MVI   4(RE),X'0A'         CONTROL                                      
         MVI   PRIPFLG,X'61'       GCOLKRCD, INDICATES GENDIR/GENFIL            
*                                                                               
LSTC01   LA    R2,IOKEY            SET KEY TO READ FIRST RECORD                 
         USING GCOLRECD,R2                                                      
         XC    GCOLKEY,GCOLKEY                                                  
         MVC   GCOLKRID,=AL3(GCOLKRIQ) RECORD ID ON GEN FILE                    
         MVI   GCOLKMED,C'A'       CUSTOM COL REC MEDIA ALWAYS "A"              
         MVI   GCOLKRCD,X'61'      RECORD CODE                                  
*                                                                               
         L     R2,DXARECB                                                       
         GOTO1 AREADHI                                                          
         JNE   LSTCNO                                                           
*                                                                               
LSTC02   TM    DMCB+8,X'80'        ALL DONE IF EOF                              
         JO    LSTCYES                                                          
         CLC   IOKEY(GCOLKCOD-GCOLKEY),0(R2)                                    
         JNE   LSTCYES             ALL DONE IF RECORD NOT X'00D701C161'         
*                                                                               
         MVC   PRIADDR,GCOLDDA-GCOLKEY(R2)                                      
         GOTO1 AACCLOAD,DMCB,VPRISTCC,AINITSTC,AFILTSTC,MEDTABD                 
         JNE   LSTCNO                                                           
*                                                                               
         CLC   IOKEY(GCOLKCOD-GCOLKEY),0(R2)                                    
         JNE   LSTCYES             ALL DONE IF RECORD NOT X'00D701C161'         
*                                                                               
         ...
         J     LSTCYES                                                          
*                                                                               
LSTCYES  SR    RB,RB               SET CC FOR YES                               
LSTCNO   LTR   RB,RB               SET CC FOR NO                                
*                                                                               
         MVI   PRIPFLG,X'00'                                                    
         LRL   RE,VUTL                                                          
         MVC   4(1,RE),DXSENUM                                                  
...
*                                                                               
         ...
         EJECT                                                                  
*---------------------------------------------------------------------*         
* UPDATE STANDARD COLUMN RECORD                                                 
* THESE RECORDS LIVE ON GEN FILE, AND CANNOT BE UPDATED                         
*---------------------------------------------------------------------*         
UPDTSTC  BR    RE                                                               
*                                                                               
*---------------------------------------------------------------------*         
* FILTER STANDARD COLUMN RECORD AT R2                                           
*---------------------------------------------------------------------*         
FILTSTC  NTR1  BASE=*,LABEL=*                                                   
         USING GCOLRECD,R2                                                      
         CLC   =X'00D701C161',0(R2)                                             
         JNE   NO                                                               
         J     YES                                                              
*                                                                               
         LTORG                                                                  
         DROP  R2                                                               
*---------------------------------------------------------------------*         
* INITIALISE STANDARD COLUMN RECORD                                             
*---------------------------------------------------------------------*         
...
LOADBFM  NTR1  BASE=*,LABEL=*                                                   
         BRAS  RE,LOADINIT                                                      
*                                                                               
LBFM01   LA    R2,IOKEY            SET KEY TO READ FIRST RECORD                 
         USING PBFREC,R2                                                        
         CLI   MEDTCODE,C'A'                                                    
         JE    YES                                                              
         XC    PBFKEY,PBFKEY                                                    
         MVC   PBFKAGY,PRIALPHA                                                 
         MVC   PBFKMED,MEDTCODE                                                 
...
*                                                                               
         MVC   PRIADDR,27(R2)                                                   
         GOTO1 AACCLOAD,DMCB,VPRIBFML,AINITBFM,AFILTBFM,MEDTABD                 
         JNE   NO                                                               
*                                                                               
         CLC   IOKEY(2),0(R2)                                                   
         JNE   YES                 ALL DONE IF TYPE CHANGES                     
*                                                                               
         CLI   IOKEY+3,PBFKTYPQ                                                 
         JNE   LBFM03                                                           
*                                                                               
         OC    MAXIOS,MAXIOS       EXIT IF MAXIMUM IOS EXCEEDED                 
         JNZ   LBFM02                                                           
...
UPDTBFM  NTR1  BASE=*,LABEL=*                                                   
         ...
         GOTO1 AFILTBFM                                                         
         JNE   YES                                                              
         OI    PTXPFLG1,KILLQ+MULTIQ                                            
         MVI   ELCOUNT,0                                                        
*                                                                               
UPDTBF10 GOTO1 AINITBFM                                                         
         GOTO1 AACCUPDT,DMCB,VPRIBFML,0,(R8)                                    
         TM    PTXPFLG1,MULTIQ                                                  
         J     UPDTBF10                                                         
*                                                                               
         J     YES                                                              
*                                                                               
         ...
         EJECT                                                                  
*---------------------------------------------------------------------*         
* FILTER BFM RECORD AT R2                                             *         
*---------------------------------------------------------------------*         
FILTBFM  NTR1  BASE=*,LABEL=*                                                   
         USING PBFREC,R2                                                        
         CLI   PBFKTYPE,PBFKTYPQ                                                
         JNE   NO                                                               
         TM    DXFLAGS,DXFAAGY     "ALL AGENCIES" ?                             
         JO    YES                 YES                                          
         CLC   PBFKAGY,PRIALPHA    PRIALPHA OK?                                 
         JNE   NO                                                               
         J     YES                                                              
*                                                                               
         LTORG                                                                  
         DROP  R2                                                               
*---------------------------------------------------------------------*         
* INITIALISE BFM RECORD                                                         
*---------------------------------------------------------------------*         
INITBFM  NTR1  BASE=*,LABEL=*                                                   
         LA    R1,PRIBFDL          R1=L'RECORD (LONGEST)                        
         GOTO1 AINITALL                                                         
         J     YES                                                              
         LTORG                                                                  
         EJECT                                                                  
...
FILTPUBR NTR1  BASE=*,LABEL=*                                                   
         ...
         CLC   PUBKAGY,PRIALPHA    PRIALPHA OK?                                 
         JNE   NO                                                               
*NOP*    TM    PUBKEY+25,X'01'     SKIP IF PASSIVE POINTER                      
*NOP*    JO    NO                                                               
         J     YES                                                              
*                                                                               
         LTORG                                                                  
...
*                                                                               
         CLI   PRIPFLG,X'61'       GCOLKRCD, INDICATES GENDIR/GENFIL            
         JE    ALOA10                                                           
*                                                                               
...
*                                                                               
ALOA10   DS    0H                                                               
         GOTO1 VDATAMGR,DMCB,DMRSEQ,GENDIR,IOKEY,(R2),DMWORK                    
         J     YES                                                              
*                                                                               
...
LOADINIT DS    0H                                                               
         ...
         MVI   PRIPFLG,00                                                       
*                                                                               
* SET VARIOUS PTXPARM FLAGS TO ZERO                                             
         MVI   PTXPFLG1,0                                                       
         MVI   ELCOUNT,0                                                        
*                                                                               
         LARL  R8,MEDTAB                                                        
...
* PUBKIDQ  EQU   X'81'               PRINT PUB RECORD ID (PUBRECD)              
* LTLKIDQ  EQU   X'85'              PUB SUPPLEMENTAL RECORD ID(LTLRECD)         
* GCOLKRCD EQU   X'61'             STD. COLUMN RECORD (GENDIR/GENFIL)           
*                                                                               
FLAGMED  DS    XL1                                                              
...
*                                                                               
       ++INCLUDE PTXPARM           PTXTRACT-PTXROUTS PARM BLOCK                 
*                                                                               
UCOMCLT  DS    500X                                                             
*                                                                               
...
VPTXCNVX DS    V                                                                
*                                                                               
VPRIAGYC DS    V          MEDIA/AGENCY                                          
VPRICNTC DS    V          CLIENT                                                
VPRIDIVC DS    V          DIVISION                                              
VPRIPRDC DS    V          PRODUCT                                               
VPRIESTC DS    V          ESTIMATE                                              
VPRIPUBC DS    V          PUB                                                   
VPRICONC DS    V          CONTRACT                                              
VPRIREPC DS    V          REP                                                   
VPRIJOBC DS    V          JOB                                                   
VPRIBUYC DS    V          BUY                                                   
VPRIPGDC DS    V          PUB GROUP DEFINITION                                  
VPRIPBGC DS    V          PUB GROUP                                             
VPRIPGPC DS    V          PUB GROUP PUB                                         
VPRICCCC DS    V          CUSTOM COLUMN                                         
VPRICGDC DS    V          CLIENT GROUP DEFINITION                               
VPRICLGC DS    V          CLIENT GROUP                                          
VPRICLCC DS    V          CLIENT GROUP CLIENT                                   
VPRIGDPC DS    V          PRODUCT GROUP DEFINITION                              
VPRIGGPC DS    V          PRODUCT GROUP                                         
VPRIGPPC DS    V          PRODUCT GROUP PRODUCT                                 
VPRIREGC DS    V          REGION                                                
VPRIDSTC DS    V          DISTRICT                                              
VPRIPDAC DS    V          PUB DISTRICT ASSIGNMENT                               
VPRIACGC DS    V          ADDITIONAL CHARGE                                     
VPRIUCMC DS    V          UCOMM (USER COMMENT)                                  
VPRIBUDC DS    V          BUDGET                                                
VPRISTCC DS    V          STANDARD COLUMNS                                      
VPRIBFML DS    V          BILL FORMULA                                          
...
ALOADDIV DS    A          DIVISION                                              
ALOADPRD DS    A          PRODUCT                                               
ALOADEST DS    A          ESTIMATE                                              
ALOADPUB DS    A          PUB                                                   
ALOADCON DS    A          CONTRACT                                              
ALOADREP DS    A          REP                                                   
ALOADJOB DS    A          JOB                                                   
ALOADBUY DS    A          BUY                                                   
ALOADPGD DS    A          PUB GROUP DEFINITION                                  
ALOADPBG DS    A          PUB GROUP                                             
ALOADPGP DS    A          PUB GROUP PUB                                         
ALOADCCC DS    A          CUSTOM COLUMN                                         
ALOADCGD DS    V          CLIENT GROUP DEFINITION                               
ALOADCLG DS    V          CLIENT GROUP                                          
ALOADCLC DS    V          CLIENT GROUP CLIENT                                   
ALOADGDP DS    V          PRODUCT GROUP DEFINITION                              
ALOADGGP DS    V          PRODUCT GROUP                                         
ALOADGPP DS    V          PRODUCT GROUP PRODUCT                                 
ALOADREG DS    V          REGION                                                
ALOADDST DS    V          DISTRICT                                              
ALOADPDA DS    V          PUB DISTRICT ASSIGNMENT                               
ALOADACG DS    V          ADDITIONAL CHARGE                                     
ALOADUCM DS    V          UCOMM (USER COMMENT)                                  
ALOADBUD DS    V          BUDGET                                                
ALOADSTC DS    V          STANDARD COLUMNS                                      
ALOADBFM DS    V          BILL FORMULA                                          
         DS    CL8                 UPDATE ROUTINES                              
AUPDTAGY DS    A          MEDIA/AGENCY                                          
AUPDTCNT DS    A          CLIENT                                                
AUPDTDIV DS    A          DIVISION                                              
AUPDTPRD DS    A          PRODUCT                                               
AUPDTEST DS    A          ESTIMATE                                              
AUPDTPUB DS    A          PUB                                                   
AUPDTCON DS    A          CONTRACT                                              
AUPDTREP DS    A          REP                                                   
AUPDTJOB DS    A          JOB                                                   
AUPDTBUY DS    A          BUY                                                   
AUPDTPGD DS    A          PUB GROUP DEFINITION                                  
AUPDTPBG DS    A          PUB GROUP                                             
AUPDTPGP DS    A          PUB GROUP PUB                                         
AUPDTCCC DS    A          CUSTOM COLUMN                                         
AUPDTCGD DS    V          CLIENT GROUP DEFINITION                               
AUPDTCLG DS    V          CLIENT GROUP                                          
AUPDTCLC DS    V          CLIENT GROUP CLIENT                                   
AUPDTGDP DS    V          PRODUCT GROUP DEFINITION                              
AUPDTGGP DS    V          PRODUCT GROUP                                         
AUPDTGPP DS    V          PRODUCT GROUP PRODUCT                                 
AUPDTREG DS    V          REGION                                                
AUPDTDST DS    V          DISTRICT                                              
AUPDTPDA DS    V          PUB DISTRICT ASSIGNMENT                               
AUPDTACG DS    V          ADDITIONAL CHARGE                                     
AUPDTUCM DS    V          UCOMM (USER COMMENT)                                  
AUPDTBUD DS    V          BUDGET                                                
AUPDTSTC DS    V          STANDARD COLUMNS                                      
AUPDTBFM DS    V          BILL FORMULA                                          
         DS    CL8                 FILTER ROUTINES                              
AFILTAGY DS    A          MEDIA/AGENCY                                          
AFILTCNT DS    A          CLIENT                                                
AFILTDIV DS    A          DIVISION                                              
AFILTPRD DS    A          PRODUCT                                               
AFILTEST DS    A          ESTIMATE                                              
AFILTPUB DS    A          PUB                                                   
AFILTCON DS    A          CONTRACT                                              
AFILTREP DS    A          REP                                                   
AFILTJOB DS    A          JOB                                                   
AFILTBUY DS    A          BUY                                                   
AFILTPGD DS    A          PUB GROUP DEFINITION                                  
AFILTPBG DS    A          PUB GROUP                                             
AFILTPGP DS    A          PUB GROUP PUB                                         
AFILTCCC DS    A          CUSTOM COLUMN                                         
AFILTCGD DS    V          CLIENT GROUP DEFINITION                               
AFILTCLG DS    V          CLIENT GROUP                                          
AFILTCLC DS    V          CLIENT GROUP CLIENT                                   
AFILTGDP DS    V          PRODUCT GROUP DEFINITION                              
AFILTGGP DS    V          PRODUCT GROUP                                         
AFILTGPP DS    V          PRODUCT GROUP PRODUCT                                 
AFILTREG DS    V          REGION                                                
AFILTDST DS    V          DISTRICT                                              
AFILTPDA DS    V          PUB DISTRICT ASSIGNMENT                               
AFILTACG DS    V          ADDITIONAL CHARGE                                     
AFILTUCM DS    V          UCOMM (USER COMMENT)                                  
AFILTBUD DS    V          BUDGET                                                
AFILTSTC DS    V          STANDARD COLUMNS                                      
AFILTBFM DS    V          BILL FORMULA                                          
         DS    CL8                 INITIALISATION ROUTINES                      
AINITALL DS    A                   GENERAL INITIALISATION                       
AINITAGY DS    A          MEDIA/AGENCY                                          
AINITCNT DS    A          CLIENT                                                
AINITDIV DS    A          DIVISION                                              
AINITPRD DS    A          PRODUCT                                               
AINITEST DS    A          ESTIMATE                                              
AINITPUB DS    A          PUB                                                   
AINITCON DS    A          CONTRACT                                              
AINITREP DS    A          REP                                                   
AINITJOB DS    A          JOB                                                   
AINITBUY DS    A          BUY                                                   
AINITPGD DS    A          PUB GROUP DEFINITION                                  
AINITPBG DS    A          PUB GROUP                                             
AINITPGP DS    A          PUB GROUP PUB                                         
AINITCCC DS    A          CUSTOM COLUMN                                         
AINITCGD DS    V          CLIENT GROUP DEFINITION                               
AINITCLG DS    V          CLIENT GROUP                                          
AINITCLC DS    V          CLIENT GROUP CLIENT                                   
AINITGDP DS    V          PRODUCT GROUP DEFINITION                              
AINITGGP DS    V          PRODUCT GROUP                                         
AINITGPP DS    V          PRODUCT GROUP PRODUCT                                 
AINITREG DS    V          REGION                                                
AINITDST DS    V          DISTRICT                                              
AINITPDA DS    V          PUB DISTRICT ASSIGNMENT                               
AINITACG DS    V          ADDITIONAL CHARGE                                     
AINITUCM DS    V          UCOMM (USER COMMENT)                                  
AINITBUD DS    V          BUDGET                                                
AINITSTC DS    V          STANDARD COLUMNS                                      
AINITBFM DS    V          BILL FORMULA                                          
*                                                                               
DMOPEN   DS    CL7                                                              
DMREAD   DS    CL7                                                              
DMRSEQ   DS    CL7                                                              
...
* DMGREQUS                                                                      
       ...
       ++INCLUDE PRGENFILE                                                      
*                                                                               
*      ++INCLUDE PUCOMREC SPEC-45902 PUCOMREC IS INCLUDED IN PRGENFILE          
         PRINT OFF                                                              
         PRINT ON                                                               
* FACTRYEQUS                                                                    
         PRINT OFF                                                              
...
* FASSBOFF                                                                      
       ++INCLUDE FASSBOFF                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'111PTXTRACT  02/19/21'                                      
         END                                                                    
