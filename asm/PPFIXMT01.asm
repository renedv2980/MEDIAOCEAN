*          DATA SET PPFIXMT01  AT LEVEL 034 AS OF 09/08/04                      
*PHASE PPFM01A                                                                  
         TITLE 'PPFM01 - PRTFIX SPECS'                                          
PPFM01   CSECT                                                                  
         PRINT NOGEN                                                            
*                                                                               
         FSPEC UPDATE,PRTDIR                                                    
...
*                                                                               
         SPROG 02                                                               
         PSPEC H1,52,C'PRINTPAK PRTFILE MATCH RESEQUENCING'                     
         PSPEC H2,52,C'-----------------------------------'                     
         PSPEC H1,1,MEDIA                                                       
         PSPEC H1,98,AGYNAME                                                    
         PSPEC H2,98,AGYADD                                                     
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034PPFIXMT01 09/08/04'                                      
         END                                                                    
