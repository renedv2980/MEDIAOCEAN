*          DATA SET RECNT7F    AT LEVEL 044 AS OF 03/27/17                      
*PHASE T8027FA                                                                  
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
         TITLE 'T8027F - RECNT7F - WIDE ORBIT EC BDE VERSION'                   
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT7F --- WIDE ORBIT CONTRACT INTERFACE                  *           
* ----------------------------------------------------------------- *           
* UPDATE HISTORY:                                                   *           
*                                                                   *           
...
*                                                                   *           
* NOV12/01 (BU ) --- SEND AS CLASS ' ' NOT 'G'                      *           
*                                                                   *           
* JAN30/02 (BU ) --- REVERT TO CLASS 'G'                            *           
*                                                                   *           
* JUL22/02 (BU ) --- SEND AS CLASS ' ' AS MARKETRON TEST.           *           
*                                                                   *           
* OCT30/02 (BU ) --- REVERT TO CLASS 'G'                            *           
*                                                                   *           
* APR06/05 (BU ) --- GENERIC: DON'T ACCESS EOP RECS                 *           
*                                                                   *           
* MAY17/05 (BU ) --- FIX COMMENT FOR TAKEOVERS                      *           
*                                                                   *           
* SEP09/05 (BU ) --- RSTAOPTC X'20' = SEND 6-CHAR AGY-OFFICE        *           
*                                                                   *           
* FEB26/07 (BU ) --- 'NONE' / 'VARIOUS' BUYLINES                    *           
*                                                                   *           
* MAY01/13 (KWA) --- USE RSTSAID WHEN EC FROM STATION TOOLKIT       *           
*                                                                   *           
* NOV13/13 (KWA) --- DUMP WHEN SUBLINE EXCEEDS 26 (REC03SL#)        *           
*                                                                   *           
* SEP30/14 (YYUN)--- RETURN ERROR WHEN SUBLINE EXCEEDED, NO DUMP    *           
*                                                                   *           
* MAR27/17 (SKUI)--- SPEC-11644: USE SIGNON FROM STATION RECORD FOR *           
*                    EDICT RECORD IN CASE OF WIDE ORBIT FORMAT      *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
*                                                                               
T8027F   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T8027F*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
* DON'T USE 'HALF' IN NEXT SUBROUTINE (USING TO STORE STATION OPTION)           
         ...
         B     MN090               ALWAYS SKIP CODE TEST                        
*                                                                               
*   CLEAR EOPRECS AREA, DON'T CALL READ ROUTINE FOR GENERIC EC                  
*&&DO                                                                           
...
*                                                                               
*    SET FLIGHT DATES OF ORDER                                                  
*                                                                               
*    INSERT START DATE                                                          
*                                                                               
         GOTO1 DATCON,DMCB,(3,RCONDATE),(X'20',HOLDDATE)                        
         MVC   REC01FST(4),HOLDDATE+2 INSERT MM/DD                              
         MVC   REC01FST+4(2),HOLDDATE INSERT YY                                 
*                                                                               
*    INSERT END   DATE                                                          
*                                                                               
         GOTO1 DATCON,DMCB,(3,RCONDATE+3),(X'20',HOLDDATE)                      
         MVC   REC01FEN(4),HOLDDATE+2 INSERT MM/DD                              
         MVC   REC01FEN+4(2),HOLDDATE INSERT YY                                 
*                                                                               
...
*                                                                               
         ...
         TM    HALF+1,X'20'        SEND 6-CHAR AGENCY-OFFICE?                   
         BNO   BLD10240            NO                                           
         MVC   EOPAGY(6),RCONKAGY  SET DDS CODE AS AGENCY-OFFICE                
BLD10240 EQU   *                                                                
...
BLD10350 EQU   *                                                                
         ...
         DROP  R6                                                               
BLD10360 EQU   *                                                                
         MVI   REC01OTP,C'5'       DEFAULT ORDER TYPE                           
...
BLD10470 EQU   *                                                                
         ...
         BNO   BLD10475            NO                                           
         CLI   REC01OTP,C'5'       YES - DEFAULT SET AS CASH?                   
         BNE   BLD10475            NO                                           
         MVI   REC01OTP,C'1'       YES - RESET TO TRADE                         
         DROP  R6                                                               
BLD10475 EQU   *                                                                
*                                                                               
...
*                                  INSERT CONTRACT NUMBER                       
         ...
         MVC   REC02TYP,=C'01'     RECORD TYPE INDICATOR                        
*                                                                               
...
BLD20060 EQU   *                                                                
         CLI   2(R6),X'FF'         ELIMINATE SORT CHAR FOR TKOS                 
         BNE   BLD20070            NOT TAKEOVER                                 
         MVI   2(R6),C' '          REPLACE WITH SPACE                           
BLD20070 EQU   *                                                                
...
BLD30240 EQU   *                                                                
         ...
         CHI   RF,SUBLINLQ                                                      
         JL    BLD30260                                                         
         LA    R3,1036             SET "TOO MANY EFF DATES" ERROR               
         LA    R2,CONCNUMH                                                      
         J     ERROR                                                            
SUBLINES DC    C'ABCDEFGHIJKLMNOPQRSTUVWXYZ'                                    
SUBLINLQ EQU   *-SUBLINES                                                       
BLD30260 EQU   *                                                                
         LA    RE,SUBLINES                                                      
         AR    RE,RF                                                            
...
DYTIME   NTR1                                                                   
         ...
         CLC   =C'NON',4(R6)       START TIME = NONE?                           
         BE    DYTEXT              YES -  ZEROS FOR START/END TIMES             
         CLC   =C'VAR',4(R6)       START TIME = VARIOUS?                        
         BE    DYTEXT              YES -  ZEROS FOR START/END TIMES             
...
DTEINFO  NTR1                                                                   
         ...
         BZ    DINF0005            NO                                           
         MVC   ZEROSPTS,RBUYDTNW   YES - SET IINDICATOR TO 'NOT ZERO'           
DINF0005 EQU   *                                                                
...
*                                                                               
SVSENDID DS    CL(L'RSTASID)       SAVE SEND ID                                 
SVSTAP8  DS    CL1                 SAVE PROFILE 8                               
*                                                                               
LOCALEND EQU   *                                                                
         EJECT                                                                  
CREDITD  DSECT                                                                  
...
*                                                                               
*   FINAL POSITION OF 01 RECORD WILL ALWAYS CONTAIN A DATE, WHICH               
*        MUST NOT BE CHANGED.  THEREFORE, THE '*' IS SKIPPED FOR                
*        THIS RECORD.                                                           
*                                                                               
         CLC   =C'0101',REC01ID    01 HEADER RECORD?                            
         BE    PREC0040            YES - NO '*' NEEDED.                         
*                                                                               
...
*                                                                               
         ...
         XC    SVSENDID,SVSENDID   RETURN SEND ID                               
         XC    SVSTAP8,SVSTAP8     ADDITIONAL PROFILE 8                         
*                                                                               
         USING RSTAREC,R6                                                       
         MVC   SVSTAP8,RSTAP8                                                   
         DROP  R6                                                               
*                                                                               
         MVI   ELCODE,X'06'        VALID SIGN ON ID ELEMENT CODE                
         BAS   RE,GETEL                                                         
         JNE   GSTA20                                                           
         USING RSTASOEL,R6                                                      
         MVC   SVSENDID,RSTASID                                                 
         DROP  R6                                                               
*                                                                               
*                                                                               
GSTA20   DS    0H                                                               
...
****>>>  MVI   HALF,C'N'           SET TO OFF ORIGINALLY                        
         MVI   HALF,0              SET TO OFF ORIGINALLY                        
         LA    R6,RSTAREC          STATION RECORD                               
...
*                                                                               
         ...
         MVC   HALF+1(1),RSTAOPTC  USING HALF FOR TEMP STORAGE OF OPT           
         DROP  R6                                                               
*                                                                               
GSTA55   EQU   *                                                                
...
*                                                                               
         ...
         AH    RF,=Y(TWAWORKQ)     4K                                           
         USING TWAWORK,RF                                                       
         CLC   =C'LIN',TWAGENCP    STATION TOOLKIT?                             
         JE    FINDID10                                                         
         CLI   SVSTAP8,C'Y'        ARE WE GOING TO WIDE ORBIT?                  
         BNE   FINDIDX                                                          
*                                                                               
FINDID10 DS    0H                                                               
         MVC   SENDID,SVSENDID     USE SAVED SEND ID IN STATION RECORD          
         DROP  RF                                                               
...
*                                                                               
EDICT01  DS    0H                                                               
         MVC   CTIKNUM,SVSENDID    USE SAVED SEND ID IN STATION RECORD          
         DROP  RF,R6                                                            
*                                                                               
EDICT02  DS    0H                                                               
...
****>>>>                                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'044RECNT7F   03/27/17'                                      
         END                                                                    
