*          DATA SET RERES0CS   AT LEVEL 021 AS OF 05/01/02                      
*PHASE T8190CA,*                                                                
*INCLUDE UPOUT                                                                  
*INCLUDE KHDUMMY                                                                
...
********************************************************************            
*                                                                  *            
*     GET PARENT REP FROM REP RECORD FOR X'12' AND X'92' LOOKUP.   *            
...
VBKNBKE  DS    0H                  FROM DIFFERENCE BK MUST BE IN LIST           
         MVC   CONHEAD(L'NODFRBK),NODFRBK                                       
         B     MYEND                                                            
*                                                                               
VBKNBK2E DS    0H                  BOTH FROM AND TO BOOKS MUST BE IN            
         MVC   CONHEAD(L'NODFRBK2),NODFRBK2    RANGE                            
         B     MYEND                                                            
*                                                                               
...
*                                                                               
         ...
         USING RINVKEY,R6                                                       
*                                                                               
         MVI   RINVKTYP,X'12'      SET INVENTORY RECORD TYPE                    
...
*                                                                               
         ...
         XC    KEY,KEY                                                          
*                                                                               
         MVI   RIDPKTYP,X'92'      SET PASSIVE PTR ID                           
...
RANGLOOP DS    0H                                                               
*                                                                               
         CLC   RINVKEY(RINVKSRC-RINVKEY),KEYSAVE                                
         BNE   RANGDONE            DONE ON CHANGE IN INV HEADER                 
*                                                                               
         CLI   RINVKSRC,C'Z'       SKIP AVAIL RECORDS                           
         BE    RANGCONT                                                         
*                                                                               
         CLI   RINVKSRC,X'FF'      DONE IF RATIONALE RECORDS REACHED            
         BE    RANGDONE                                                         
*                                                                               
...
*                                                                               
         MVC   GSIKSRC,RINVKSRC    SET KSRC                                     
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'K',GSRCIN),GSRCOUT                              
         CLI   DMCB+4,0            CHECK FOR ERRORS                             
         BNE   RNGX                                                             
*                                                                               
         CLC   SVSOURCE,GSORSVC    MUST BE SAME RATING SERVICE                  
         BNE   RANGCONT                                                         
         CLC   BOOKS+3(1),GSOBKTYP  MUST BE SAME BOOKTYPE                       
         BNE   RANGCONT                                                         
...
RANGE20  CLI   RINVKSRC,C'R'          IF AN EST BOOK,                           
         BNE   RANGE40                                                          
         ...
         B     RANGE50                                                          
*                                                                               
RANGE40  CLC   BOOKS+1(2),RINVKBK     ELSE,                                     
...
*                                                                               
         ...
         MVC   GSIBITS,0(R2)       SET BOOKVAL BITS                             
         MVC   GSIBKTYP,3(R2)      SET BOOKTYPE                                 
*                                                                               
GTBPCTX  DS    0H                                                               
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'B',GSRCIN),GSRCOUT                              
         ...
         DC    H'0'                                                             
*                                                                               
         MVC   RINVKSRC,GSOKSRC    SET KSRC                                     
         MVC   RINVKBK,1(R2)       SET BOOK                                     
*                                                                               
         GOTO1 HIGH                READ DIRECTORY POINTER                       
*                                                                               
MAS192   CLC   RINVKEY(RINVKSRC-RINVKEY),KEYSAVE  DONE ON INV # CHANGE          
         BNE   GTBCONT                                                          
*                                                                               
         CLC   KEY+24(3),KEYSAVE+24     SAME SOURCE AND BOOK                    
         BE    MAS200                                                           
*                                                                               
...
*                                                                               
         ...
         BE    MAS240                                                           
*                                                                               
         MVC   KEY(24),KEYSAVE     MAKE IT LOOK LIKE WE                         
         MVC   KEY+24(1),4(R2)     READ FILE TO GET RECORD                      
         MVC   KEY+25(2),1(R2)                                                  
         MVC   KEY+28(4),5(R2)     BUT REALLY USE SAVED DISK ADDRESS            
*                                                                               
MAS202   DS    0H                                                               
*                                                                               
         OI    DMINBTS,X'08'       SET PASS DELETED RECORDS                     
...
*                                                                               
         ...
         MVC   GSIKSRC,RINVKSRC-RINVKEY(RF)    SET KSRC                         
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'K',GSRCIN),GSRCOUT                              
         CLI   DMCB+4,0            CHECK FOR ERRORS                             
...
*                                                                               
MAS206   GOTO1 =A(BOOKSQ),RR=RELO  FORMAT BOOK NAME                             
*                                                                               
...
*                                                                               
         ...
         MVI   RINVKSTA+4,C'T'                                                  
*                                                                               
         MVC   RINVKSRC,OPTION     SET SOURCE                                   
         B     *+8                                                              
MAS310   MVI   RINVKSRC,X'FF'      FOR OPTION I                                 
*                                                                               
...
MASRATLP DS    0H                                                               
*                                                                               
         CLC   KEY(25),KEYSAVE     DONE ON CHANGE OF SOURCE                     
         BNE   MASRATDN                                                         
*                                                                               
...
*                                                                               
         ...
         MVC   GSIBITS,RINVFBKT    SET BOOKVAL BITS                             
         MVC   GSIBKTYP,RINVFBTP   SET BOOKTYPE                                 
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'B',GSRCIN),GSRCOUT                              
         CLI   DMCB+4,0            CHECK FOR ERRORS                             
         BE    *+6                                                              
...
*                                                                               
         ...
         BNE   RAT70                                                            
*                                                                               
         CLC   GSOBITS,0(R4)       AND BOOKVAL BITS                             
         BNE   RAT70                                                            
*                                                                               
         CLC   GSOBKTYP,3(R4)      AND BOOK TYPE                                
         BNE   RAT70                                                            
*                                                                               
...
*                                                                               
         CLI   RINVFRBT,C' '       PRINT BOOKTYPE IF PRESENT                    
         BNH   *+22                                                             
         MVI   6(R5),C'('                                                       
         MVC   7(1,R5),RINVFRBT                                                 
         MVI   8(R5),C')'                                                       
...
*DDGLVXCTLD                                                                     
       ...
       ++INCLUDE DDGLVXCTLD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021RERES0CS  05/01/02'                                      
         END                                                                    
