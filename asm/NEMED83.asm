*          DATA SET NEMED83    AT LEVEL 005 AS OF 02/03/09                      
*          DATA SET NEMED83    AT LEVEL 172 AS OF 02/07/91                      
*PHASE T31E83A,*                                                                
*INCLUDE BINSRCH2                                                               
...
T31E83   CSECT                                                                  
         ...
         ST    R6,NBADEM                                                        
         ST    R2,RELO                                                          
         L     R1,=A(PRODGRP)          PROD GROUP FOR NENETGOAL                 
         A     R1,RELO                                                          
         ST    R1,NBADRPRG                                                      
         EJECT                                                                  
*HIPO******************************************************************         
...
*                                  BUT NOT FOR PFB                              
         ...
         MVI   NBSPLPRN,0          SET BY NETGOAL - BAD NEWS!!!                 
         SPACE                                                                  
...
NDBLK    DSECT                                                                  
       ...
       ++INCLUDE DEDBLOCK                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005NEMED83   02/03/09'                                      
         END                                                                    
