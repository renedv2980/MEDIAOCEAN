*          DATA SET ACCAP01    AT LEVEL 016 AS OF 02/19/13                      
*PHASE T61D01C                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE COVAIL                                                                 
*INCLUDE ACRAPPER                                                               
...
* FPEA LVL 011 - <1038775> INCREASE TABLE SIZE TO ALLOW SIX FULL PAGES*         
* TKLU LVL 012 - <LO01-3917> FIX FILTER MISMATCH BUG                  *         
* JFOS LVL 014 - <BR16402L> DEFEND AGAINST 0 L'PAYCODE IN UPTAB       *         
* TKLU 015 05SEP08 <BR12933D> INCREASE PAY CODE TABLE BY 1 TO 256     *         
* MPEN 016 17JUL09 <LO01-8967> RELINK FOR BIGGER COBLOCK              *         
***********************************************************************         
...
*                                  SET RST FILTERS INTO KEY STATUS              
         MVC   ACTRSAF1(L'PEFILTS),PEFILTS                                      
*                                                                               
         LA    R3,PEBLK                                                         
         LA    R4,PELOCS                                                        
         USING PELOCS,R4                                                        
...
UPD25    XC    WORK,WORK                                                        
         SR    R1,R1                                                            
         ICM   R1,1,DSPCODEH+5     LENGTH OF PAYCODE                            
         BZ    UPD30                                                            
         BCTR  R1,0                                                             
...
MAXCOUNT EQU   83                  MAX NUMBER OF TABLE ENTRIES                  
*                                                                               
       ++INCLUDE DDGENTWA                                                       
         EJECT                                                                  
*                                                                               
...
ELNAME   DS    CL8                                                              
*LEMBLK  DS    75CL(ELLEN)                                                      
ELEMBLK  DS    (MAXCOUNT)CL(ELLEN)                                              
ELEMLNQ  EQU   *-ELNAME                                                         
*                                                                               
...
PELOCNQ  EQU   *-PELOCS                                                         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016ACCAP01   02/19/13'                                      
         END                                                                    
