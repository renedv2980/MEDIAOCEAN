*          DATA SET RESFM05    AT LEVEL 027 AS OF 08/09/17                      
*PHASE T81805C                                                                  
*INCLUDE BINSRCH                                                                
...
* UPDATE HISTORY:                                                    *          
*                                                                    *          
* 08AUG17  (KWA) --- CHECK FOR 0, 5 AND 7 FOR NO DAY ERROR (NODAYER) *          
*                                                                    *          
* ???????  (???) --- HISTORY LOST                                    *          
*                                                                    *          
...
***                                                                             
         ...
         ZIC   R1,0(R3)                                                         
         BAS   RE,FINDDAY                                                       
         MVC   CONHEAD+4(15),=C'TIME NOT CONSECTIVE'                            
         MVC   WORK+5(2),1(R3)                                                  
         SR    RE,RE               AM TIMES BEFORE 6AM ARE UPDATED              
         CLC   =H'2400',WORK+3                                                  
         BNL   *+16                                                             
...
VR900    ZIC   R1,WORK             MAKE SURE LAST DAY FRIDAY                    
         LA    R1,1(R1)                                                         
         CLI   WORK,0              SUMMARY DAYPART?                             
         JE    VR900X                                                           
         CLI   WORK,7              IF SAT-SUN, SUNDAY?                          
         JE    VR900X                                                           
         CLI   WORK,5              IF MON-FRI, FRIDAY?                          
         JE    VR900X                                                           
*                                                                               
         J     NODAYER                                                          
*                                                                               
...
NXELMN   DS    XL1                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027RESFM05   08/09/17'                                      
         END                                                                    
