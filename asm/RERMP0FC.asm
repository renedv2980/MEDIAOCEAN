*          DATA SET RERMP0FC   AT LEVEL 009 AS OF 05/15/97                      
*PHASE T8100FC                                                                  
...
* -------- --- ----   ------------------------------------------------*         
* May15/97 009 GLEE - Made version "C" a generic search into INV file *         
*                                                                     *         
...
*                                                                               
         ...
         EJECT                                                                  
*                                                                               
** PUT SEARCH/LOOK-UP PARAMETERS HERE **                                        
*                                                                               
         LA    R6,KEY                                                           
         USING RINVREC,R6                                                       
...
*                                                                               
*** CONTINUE TO CHECK RECORD **                                                 
*                                                                               
         DS    0H                  LOOK FOR "PROGRAM ADJUSTMENT"                
         L     R3,AIO                                                           
         MVI   ELCODE,X'CD'                                                     
         BAS   RE,GETEL                                                         
         ...
         USING RINVCEL,R3                                                       
         CLC   RINVCODE,=C'PA'      PROGRAM ADJUSTMENT OKAY                     
         BNE   PR062                                                            
         DROP  R3                                                               
         EJECT                                                                  
*                                                                               
...
HEDSPECS SSPEC H1,1,C'INVENTORY FILE-FIX'                                       
         ...
         SSPEC H1,95,AGYNAME                                                    
         SSPEC H2,95,AGYADD                                                     
         SSPEC H4,01,C'TRACKS WITH CODE OF "PA" IN  ??  FILE'                   
         SSPEC H4,95,RUN                                                        
         SSPEC H5,95,REPORT                                                     
         SSPEC H5,112,PAGE                                                      
         DC    X'00'                                                            
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009RERMP0FC  05/15/97'                                      
         END                                                                    
