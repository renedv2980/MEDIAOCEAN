*          DATA SET CTGEN23    AT LEVEL 025 AS OF 02/18/15                      
...
GEN23    CSECT                                                                  
         ...
         USING (TWAD,TWAD+3072),R5 R5=A(TWA)                                    
...
DISS010  CLI   0(R3),0             Last index                                   
         ...
         CHI   R1,251              Count too big have to die here               
         BNE   *+6                                                              
         DC    H'0'                                                             
...
PRTREP   CLI   APACTN,ACTUPD       Update is COMPILE for Scripts                
         ...
         SPACE 1                                                                
         L     R9,AREP                                                          
         LA    R2,IOKEY            A(THIS KEY)                                  
         USING CTJREC,R2                                                        
         MVC   REPCMP,CTJKID                                                    
         LA    R0,L'CTJKID                                                      
         LA    RF,CTJKID+L'CTJKID-1                                             
         CLI   0(RF),C' '                                                       
         BH    *+10                                                             
         BCTR  RF,0                                                             
         BCT   R0,*-10                                                          
         ...
         B     FIRST                                                            
*                                                                               
TOP      MVC   IOKEY,APRECKEY                                                   
         LA    R2,IOKEY            A(THIS KEY)                                  
         XR    RF,RF                                                            
         IC    RF,CTJKID+L'CTJKID-1                                             
         LA    RF,1(RF)                                                         
         STC   RF,CTJKID+L'CTJKID-1                                             
         MVI   CTJKSUB,0           require master record                        
         GOTO1 AIO,IOHI+IOCONFIL+IO1                                            
         L     R2,AIOAREA1                                                      
         CLC   IOKEYSAV(2),CTJKEY  same book type?                              
         BNE   PRTREPX             no - done then                               
         XR    RF,RF                                                            
         IC    RF,REPLEN                                                        
         EX    RF,*+8                                                           
         BNE   PRTREPX             end of comparison                            
         CLC   REPCMP(0),CTJKID                                                 
*                                                                               
         MVC   APRECKEY,CTJKEY     save current key                             
...
*                                                                               
         SPACE 1                                                                
FIRST    MVC   FVMSGNO,=AL2(FVFNOTV) Field Not Valid                            
         L     R2,AIOAREA1         A(This Record)                               
         USING CTJREC,R2                                                        
         LA    R3,APELEM                                                        
         USING CTDSCD,R3                                                        
...
MAXMEM   EQU   250                                                              
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025CTGEN23   02/18/15'                                      
         END                                                                    
