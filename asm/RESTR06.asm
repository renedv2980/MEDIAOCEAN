*          DATA SET RESTR06    AT LEVEL 027 AS OF 05/01/02                      
*PHASE T80E06A                                                                  
...
HOOK10   DS    0H                                                               
         ...
         ZAP   WORK+8(4),=P'0'                                                  
         MVO   WORK+8(4),ENDDT     CHANGE TO PACK WITH SIGN                     
         ZAP   WORK+4(4),=P'999999'                                             
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,H7+22)                                   
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027RESTR06   05/01/02'                                      
         END                                                                    
