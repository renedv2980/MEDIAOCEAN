*          DATA SET NEMED0BT   AT LEVEL 003 AS OF 05/01/02                      
*          DATA SET NEMED0B    AT LEVEL 019 AS OF 06/04/85                      
*PHASE T31E0BA,+0                                                               
*                                                                               
...
*                                                                               
         EJECT                                                                  
OVERD    DSECT                                                                  
       ++INCLUDE NERWBLOCKT           ***NOTE THIS "T" ALSO                     
       ++INCLUDE NETDEMOT                                                       
       ++INCLUDE DEDBLOCK                                                       
       ++INCLUDE NEACCTBLK                                                      
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003NEMED0BT  05/01/02'                                      
         END                                                                    
