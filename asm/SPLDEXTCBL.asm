*          DATA SET SPLDEXTCBL AT LEVEL 152 AS OF 06/02/98                      
*PHASE SPEXTCBL                                                                 
*INCLUDE BINSRCH2                                                               
...
**************************************************************                  
* BPOO            ***** NOTE *******                         *                  
*        DO NOT DELETE BY ALL MEANS.  CABLE CONVERSION RUN ON*                  
*                                     MAY 9, 1998            *                  
**************************************************************                  
*                                                                               
* PARAMETER LIST                                                                
...
* BUILD ARGS AND CALL BINSRCH                                                   
         ...
         STC   R7,NETNUM                                                        
*                                                                               
         OC    NETNUM,NETNUM        IF NET=0 JUST KEEP IT AND EXIT              
         BZ    GETSTAX                                                          
...
NBUYRECD  DSECT                                                                 
       ++INCLUDE SPNWSHDR                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'152SPLDEXTCBL06/02/98'                                      
         END                                                                    
