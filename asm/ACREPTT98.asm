*          DATA SET ACREPTT98  AT LEVEL 071 AS OF 09/10/99                      
*PHASE ACTT02A,*                                                                
*INCLUDE SORTER                                                                 
*INCLUDE DLFLD                                                                  
*INCLUDE CONVMOS                                                                
...
PBREC40  MVC   WORK2,SPACES                                                     
         ...
         OI    STATUS,STATNEG                                                   
PBREC50  PACK  WORK(5),BAMT7(12)   NON EMPLOYEE COMPENSATION                    
         ZAP   AMOUNT,WORK(5)                                                   
         B     PBREC70                                                          
*                                                                               
PBREC60  ZAP   AMOUNT,=P'0'                                                     
         PACK  WORK(5),BAMT1(12)   RENT                                         
         AP    AMOUNT,WORK(5)                                                   
         AP    BTOT1,WORK(5)                                                    
         PACK  WORK(5),BAMT3(12)   PRIZES                                       
         AP    AMOUNT,WORK(5)                                                   
         AP    BTOT3,WORK(5)                                                    
         PACK  WORK(5),BAMT6(12)   MEDICAL                                      
         AP    AMOUNT,WORK(5)                                                   
         AP    BTOT6,WORK(5)                                                    
         PACK  WORK(5),BAMT7(12)   NON EMPLOYEE COMPENSATION                    
         AP    AMOUNT,WORK(5)                                                   
         AP    BTOT7,WORK(5)                                                    
         AP    BTOTALS,AMOUNT                                                   
PBREC70  EDIT  (P8,AMOUNT),(10,PRBAMT),2,COMMAS=NO                              
*                                                                               
         USING SRCED,R4                                                         
         LA    R4,BSRCLIST                                                      
         USING PRBRECD,R6                                                       
...
*                                                                               
         ZAP   AMOUNT,=P'0'                                                     
         PACK  WORK(8),CAMT1(16)   RENT                                         
         AP    AMOUNT,WORK(8)                                                   
         PACK  WORK(8),CAMT3(16)   PRIZES                                       
         AP    AMOUNT,WORK(8)                                                   
         PACK  WORK(8),CAMT6(16)   MEDICAL                                      
         AP    AMOUNT,WORK(8)                                                   
         PACK  WORK(8),CAMT7(16)   NON EMPLOYEE COMPENSATION                    
         AP    AMOUNT,WORK(8)                                                   
...
*                                                                               
         ...
         DC    C'08548'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'043016107'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33'ARNOLD COMMUNICATIONS, INC.'   COMPANY NAME                 
         DC    CL33'101 HUNGTINGTON AVENUE, 23RD FL'                            
         DC    CL33'BOSTON, MA  02199'                                          
         DC    CL33' '                                                          
...
*                                                                               
         ...
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'DOROTHY FREDA' AGENCY CONTACT NAME                          
         DC    CL15'2125907400'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'BC'               MDCH - RAPP, COLLINS, MARCOA                 
         DC    AL2(2105)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'364053944'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
...
*                                                                               
         ...
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'363698267'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'GLENDA FRIESEN'       AGENCY CONTACT NAME                   
         DC    CL15'6123733021'           AGENCY PHONE NUMBER                   
*                                                                               
         DC    C'BC'               MDTS - JAN/98                                
         DC    AL2(6232)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133922303'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33'TEAM SOUTH'    COMPANY NAME                                 
...
*                                                                               
         ...
         DC    C'35D71'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'382964249'        EIN#/TIN#                                    
         DC    X'01'                                                            
         ...
         DC    CL15'2128272019'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'BD'               BBDO CHICAGO-BDCH                            
         DC    AL2(1049)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'35D71'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'223045170'        EIN#/TIN#                                    
...
*                                                                               
         ...
         DC    CL15'2128272019'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'BD'               BDA/BBDO -BDNAT - CHANGED 12/96              
         DC    AL2(3504)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'35D71'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'581597648'        EIN#/TIN#                                    
         DC    X'01'                                                            
         DC    CL33'BBDO SOUTH'                                                 
...
* BS - BATES USA                                                                
*                                                                               
         DC    C'BS'               BSNY - BACKER SPEILVOGEL BATES INC.          
         DC    AL2(0294)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19N35'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'132993871'        EIN#/TIN#                                    
         DC    X'01'                                                            
...
*                                                                               
         ...
         DC    C'08K07'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'411267291'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         ...
         DC    C'24642'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'132749326'        EIN                                          
         DC    X'00'                                                            
...
*                                                                               
         ...
         DC    C'24754'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133082893'        EIN                                          
         DC    X'00'                                                            
...
*                                                                               
         ...
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'LORNA SHERLAND'       AGENCY CONTACT NAME                   
         DC    CL15'9146745849'           AGENCY PHONE NUMBER                   
*                                                                               
...
*                                                                               
         ...
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'KEVIN MCEVOY'         AGENCY CONTACT NAME                   
         DC    CL15'2126553210'           AGENCY PHONE NUMBER                   
*                                                                               
* D9 - DEUTSCH, INC.                                                            
*                                                                               
         DC    C'D9'               DTNYC - DEUTSCH, INC.                        
         DC    AL2(6789)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'132649664'        EIN                                          
         DC    X'00'                                                            
         DC    CL33'DEUTSCH, INC'  COMPANY NAME                                 
         DC    CL33'215 PARK AVENUE SOUTH'        3 X 33 ADDR LINES             
         DC    CL33'NEW YORK, NY  10003'                                        
         DC    CL33' '                                                          
         DC    CL100' '                                                         
...
*                                                                               
         DC    C'D9'               DTLA - DEUTSCH LA, INC.                      
         DC    AL2(6488)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'954545404'        EIN                                          
         DC    X'00'                                                            
         DC    CL33'DEUTSCH LA, INC'  COMPANY NAME                              
         DC    CL33'5340 ALLA ROAD'              3 X 33 ADDR LINES              
         DC    CL33'LOS ANGELES, CA  90066'                                     
         DC    CL33' '                                                          
         DC    CL100' '                                                         
         DC    CL40'RICHARD BRYAN'        AGENCY CONTACT NAME                   
         DC    CL15'2129957546'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'D9'               DTED - DEUTSCH, INC.                         
         DC    AL2(6647)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133777133'        EIN                                          
         DC    X'00'                                                            
         DC    CL33'MR. EDITORIAL, INC'          COMPANY NAME                   
         DC    CL33'215 PARK AVENUE SOUTH'       3 X 33 ADDR LINES              
         DC    CL33'NEW YORK, NY  10003'                                        
         DC    CL33' '                                                          
         DC    CL100' '                                                         
         ...
         DC    CL15'2129957546'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'D9'               DTJO - DEUTSCH, INC.                         
         DC    AL2(6648)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133506227'        EIN                                          
         DC    X'00'                                                            
         DC    CL33'JONES FILMS, INC'            COMPANY NAME                   
         DC    CL33'215 PARK AVENUE SOUTH'       3 X 33 ADDR LINES              
         DC    CL33'NEW YORK, NY  10003'                                        
         DC    CL33' '                                                          
         DC    CL100' '                                                         
         ...
         DC    CL15'2129957546'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'D9'               DTDNY - DEUTSCH, INC.                        
         DC    AL2(6649)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133592947'        EIN                                          
         DC    X'00'                                                            
         DC    CL33'DEUTSCH DIRECT, INC'         COMPANY NAME                   
         DC    CL33'215 PARK AVENUE SOUTH'       3 X 33 ADDR LINES              
         DC    CL33'NEW YORK, NY  10003'                                        
         DC    CL33' '                                                          
         DC    CL100' '                                                         
...
*                                                                               
         ...
         DC    C'35E66'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133712950'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         ...
         DC    C'35E65'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'135033900'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         ...
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'DAVID C. CARROLL'      AGENCY CONTACT NAME                  
         DC    CL15'3129237900'    AGENCY PHONE NUMBER                          
*                                                                               
* DW - SAATCHI AND SAATCHI NORTH AMERICA INC.                                   
*                                                                               
         DC    C'DW'               SAATCHI SAATCHI DFS, INC. - DWNYC            
         DC    AL2(1659)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'35D73'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133341336'        EIN                                          
         DC    X'01'                                                            
         ...
         DC    CL33' '             3 X 33 ADDR LINES                            
         DC    CL100' '                                                         
         DC    CL40'KAREN GREENFIELD'     AGENCY CONTACT NAME                   
...
*                                                                               
         ...
         DC    CL15' '             AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'DW'               DWKLMB - ADDED 12/97                         
         DC    AL2(4456)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133862182'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33'BESTMED, INC.'                                              
         DC    CL33'375 HUDSON STREET, 10TH FLOOR'                              
         DC    CL33'NEW YORK, NY  10014'                                        
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'DAVID HALPERN'        AGENCY CONTACT NAME                   
...
*                                                                               
         DC    C'DW'               DWKLE - ADDED 12/97                          
         DC    AL2(6455)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133939793'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33'DESSGROUP INC.'                                             
...
*                                                                               
         DC    C'DW'               DWCL - ADDED JAN/98                          
         DC    AL2(6457)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133920076'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33'SAATCHI && SAATCHI INDEPENDENT ADV'                         
         DC    CL33'D/B/A CLIFF FREEMAN AND PARTNERS'                           
         DC    CL33'375 HUDSON STREET'                                          
         DC    CL33'NEW YORK, NY  10014'                                        
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'KAREN GREENFIELD'     AGENCY CONTACT NAME                   
         DC    CL15'2124632303'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'DW'               DWKLF - ADDED DEC/98                         
         DC    AL2(6894)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133965952'        EIN#/TIN#                                    
         DC    X'00'                                                            
         DC    CL33'EVOLUTION HEALTH INITIATIVE, INC'                           
         DC    CL33'100 WOOD AVENUE SOUTH-SUITE 121'                            
...
*                                                                               
         ...
         DC    C'19981'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133016062'        EIN#/TIN#                                    
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
...
*                                                                               
         DC    C'HR'               HAL RINEY & PARTNERS (87) - HRSF             
         DC    AL2(0000)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'39482'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'942973839'                                                     
         DC    X'01'                                                            
...
*                                                                               
         ...
         DC    C'19984'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133016052'                                                     
         DC    X'01'                                                            
...
*                                                                               
         ...
         DC    C'19868'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133169392'        TIN/EIN #                                    
...
*                                                                               
         DC    C'KP'               KPSF-KALLIR, PHILIPS ROSS INC                
         DC    AL2(4589)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19868'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'942554387'        TIN/EIN #                                    
         DC    X'00'                                                            
...
*                                                                               
         ...
         DC    CL15'2128568830'           AGENCY PHONE NUMBER                   
*                                                                               
         DC    C'KP'               KPGM-KALLIR, PHILIPS ROSS INC                
         DC    AL2(4770)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19868'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'232722341'        TIN/EIN#                                     
         DC    X'00'                                                            
         ...
         DC    CL15'2128568830'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'KP'               KPKT - ADDED 12/97                           
         DC    AL2(6203)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19868'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133921221'        TIN/EIN#                                     
         DC    X'00'                                                            
         DC    CL33'KETCHUM HEALTHCARE COMMUNICATIONS'                          
         DC    CL33'292 MADISON AVENUE'                                         
         DC    CL33'NEW YORK, NY  10017'                                        
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40' '             AGENCY CONTACT NAME                          
...
*                                                                               
         ...
         DC    C'133832066'                                                     
         DC    X'00'                                                            
         DC    CL33'LEAGAS DELANEY'                 COMPANY NAME                
         DC    CL33'1527 STOCKTON STREET'           ADDRESS                     
         DC    CL33'SAN FRANCISCO, CA  94133'                                   
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40' '             AGENCY CONTACT NAME                          
         DC    CL15' '             AGENCY PHONE NUMBER                          
...
*                                                                               
         ...
         DC    CL15'2124037488'    AGENCY PHONE NUMBER                          
*                                                                               
* LP - LOWE DIRECT                                                              
*                                                                               
         DC    C'LP'               LOWE - LPNYD                                 
...
*                                                                               
         ...
         DC    AL2(0000)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19A05'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'131938691'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         ...
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40' '                    AGENCY CONTACT NAME                   
         DC    CL15'2122517700'           AGENCY PHONE NUMBER                   
*                                                                               
...
*                                                                               
         DC    C'NE'               DNNYA - DDB NEEDHAM WORLDWIDE                
         DC    AL2(1314)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19E33'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133355855'        TIN/EIN #                                    
         DC    X'01'                                                            
         DC    CL33'DDB NEEDHAM WORLDWIDE, INC.'                                
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'ANDY KEREKES'  AGENCY CONTACT NAME                          
         DC    CL15'2124153170'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'NE'               DNCHC - DDB NEEDHAM WORLDWIDE                
         DC    AL2(3839)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19E33'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'363711029'        TIN/EIN#                                     
         DC    X'01'                                                            
         DC    CL33'DDB NEEDHAM CHICAGO'                                        
         ...
         DC    CL15'2124153170'    AGENCY PHONE NUMBER                          
*                                                                               
         DC    C'NE'               DNGBA - DDB NEEDHAM WORLDWIDE INC.           
         DC    AL2(6812)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'132941459'        TIN/EIN#                                     
         DC    X'01'                                                            
         DC    CL33'GRIFFIN BACAL INC.'                                         
         DC    CL33'437 MADISON AVE - 12TH FLR'                                 
         DC    CL33'NEW YORK, NY  10022'                                        
         DC    CL33'ATTN: LEONARD RAMAUTAR'                                     
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
...
*                                                                               
         ...
         DC    C'19579'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'230376910'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         ...
         DC    C'19M97'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133710114'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         ...
         DC    C'19939'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'132555496'                                                     
         DC    X'01'                                                            
         ...
         DC    CL40' '             AGENCY CONTACT NAME                          
         DC    CL15'2122375693'    AGENCY PHONE NUMBER                          
*                                                                               
...
*                                                                               
         DC    C'OD'               ODRCO-OGILVY MATHER(DIRECT RESPONSE)         
...
*                                                                               
         ...
         DC    CL9'581707469'                                                   
         DC    X'00'                                                            
         DC    CL33'DONINO WHITE, AND PARTNERS'     COMPANY NAME                
         DC    CL33' '                                                          
         DC    CL33' '                                                          
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'ELISA TAMMAEUS'       AGENCY CONTACT NAME                   
...
*                                                                               
         ...
         DC    CL33' '                                                          
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'BEVERLY WALTER'       AGENCY CONTACT NAME                   
         DC    CL15'2124153690'           AGENCY PHONE NUMBER                   
*                                                                               
* PN - PORTER NOVELLI INC.                                                      
*                                                                               
         DC    C'PN'               PORTER NOVELLI- NY (DOREMUS) PNNY            
         DC    AL2(1513)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'35D68'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133461427'                                                     
         DC    X'01'                                                            
         DC    CL33' '                                                          
         DC    CL33' '                       3 X 33 ADDR LINES                  
...
*                                                                               
         DC    C'QJ'               QJBO-INGALLS, QUINN & JOHNSON                
         DC    AL2(0656)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'00000'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'043041769'        EIN#/TIN#                                    
         DC    X'01'                                                            
         DC    CL33'INGALLS'                                                    
...
*                                                                               
         ...
         DC    C'32P33'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'311441282'                                                     
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         DC    C'SJ'               SJR TEST                                     
         DC    AL2(0000)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'77777'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'99SJRTEST'                                                     
         DC    X'01'               DOWNLOADING                                  
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
...
*                                                                               
         DC    C'WD'               WDPO - WIEDEN & KENNEDY                      
         DC    AL2(0000)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'29A70'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'930832855'        EIN#/TIN#                                    
         DC    X'01'                                                            
         DC    CL33' '             COMPANY NAME                                 
         DC    CL99' '             3 X 33 ADDR LINES                            
         DC    CL100' '            OFFICE LIST (SPACES - NO LIST)               
         DC    CL40'PATTY OTTAWAY'        AGENCY CONTACT NAME                   
         DC    CL15'5034143717'    AGENCY PHONE NUMBER                          
*                                                                               
* WW - WUNDERMAN WORLDWIDE INC.                                                 
*                                                                               
         DC    C'WW'               WWSFS - WUNDERMAN WORLDWIDE INC.             
         DC    AL2(3364)           ORIGIN (DEFAULT IS PRINC ID)                 
         DC    C'19728'            TRANSMITTER#(00000 USE DDS#)-TCC             
         DC    C'133493149'        EIN#/TIN#                                    
         DC    X'01'                                                            
...
* YN - BM/YR/SFS                                                                
*                                                                               
         DC    C'YN'               YNRO - YOUNG & RUBICAM INC.INC.              
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE DDDLCB                                                         
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'071ACREPTT98 09/10/99'                                      
         END                                                                    
