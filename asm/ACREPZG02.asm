*          DATA SET ACREPZG02  AT LEVEL 009 AS OF 09/17/14                      
***********************************************************************         
...
RUNLST50 MVI   RCSUBPRG,5          SET FOR PRINTOUT 6 - TOTALS                  
         ...
         BAS   RE,PRTTOT                                                        
*                                                                               
         CLI   QOPT2,C'T'          SJ RECORD TAPE OPEN?                         
         BNE   *+12                                                             
         L     R3,AOUTFIL                                                       
...
*                                                                               
         CLC   AGNAGY,=C'BS'        CHECK IF AGENCY IS BS                       
...
BLDCTF   NTR1                                                                   
         MVC   HEADNM,SPACES                                                    
         MVC   HEADNM(27),=C'ZENITH CONTROL FILE RECORDS'                       
         LA    R4,XP                                                            
...
BIN10    OC    0(2,R5),0(R5)       CHECK IF ANYTHING IN LIST                    
         ...
         B     BIN10                                                            
BIN20    MVC   0(2,R5),SVMEDLS     UPDATE MEDIA LIST                            
...
*                                                                               
         TM    OPTN,OPTSYS                                                      
         BNO   *+10                                                             
         MVC   XHEAD2+76(L'SYSNAME),SYSNAME        SYSTEM NAME                  
*                                                                               
...
BXHK20   DS    0H                                                               
         ...
         BNE   BXHK30                                                           
*                                                                               
         MVC   XHEAD2+44(L'HEADNM),HEADNM          SYSTEM NAME                  
*                                                                               
         MVC   BOXCOLS(165),XSPACES                                             
         MVC   BOXROWS,XSPACES                                                  
         MVI   BOXROWS+3,C'T'                                                   
...
PACTNAM  DS    CL20                AGENCY CLIENT NAME                           
         DS    CL5                                                              
PBSCNT   DS    CL10                BS COUNT                                     
         DS    CL2                                                              
PBTCNT   DS    CL10                BT COUNT                                     
         DS    CL2                                                              
...
P3AGY    DS    CL2                 AGENCY CODE                                  
         DS    CL3                                                              
P3ACMD   DS    CL15                ACC   MEDIA LIST                             
         DS    CL2                                                              
P3SPMD   DS    CL15                SPOT  MEDIA LIST                             
         DS    CL2                                                              
P3PTMD   DS    CL15                PRINT MEDIA LIST                             
         DS    CL2                                                              
P3NTMD   DS    CL15                NET   MEDIA LIST                             
         DS    CL2                                                              
...
* ACBIGPRINTD                                                                   
       ...
       ++INCLUDE DDREPXTRAD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009ACREPZG02 09/17/14'                                      
         END                                                                    
