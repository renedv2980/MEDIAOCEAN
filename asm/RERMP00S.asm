*          DATA SET RERMP00S   AT LEVEL 125 AS OF 10/21/03                      
*PHASE T81000A,*                                                                
*INCLUDE UNBOOK                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE UNUPGR                                                                 
...
*                                  SET SYSTEM DEPENDENT VALUES                  
         ...
         BE    SYS60               YES                                          
         LHI   R1,(XTRANS-T81000)  RECORD/ACTION XTRANS                         
         A     R1,SYSRB                                                         
         MVI   1(R1),X'00'         NO  - TURN OFF 'XTRANS' ACCESS               
SYS60    EQU   *                                                                
         SPACE 1                                                                
...
BDUP     DS    0H                                                               
         ...
         CLI   RINVKTYP,X'12'      MAKE SURE IT'S AN INVENTORY KEY              
         BNE   BDUPX                                                            
...
GETINVN  XC    WORK,WORK                                                        
         ...
         GOTO1 HIGH                                                             
*                                                                               
GTINV10  CLC   KEY(17),KEYSAVE     COMPARE UP UNTIL STATION                     
         BNE   GTINVERR                                                         
...
GTINV260 CLC   KEY(21),WORK        HAVE WE PASSED OUR KEY                       
         ...
         CLI   KEY+24,0            SAVE KEY IF INVENTORY HEADER,                
         BNE   *+10                 OTHERWISE DON'T                             
         MVC   WORK+30(27),KEY     SAVE THIS KEY                                
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'125RERMP00S  10/21/03'                                      
         END                                                                    
