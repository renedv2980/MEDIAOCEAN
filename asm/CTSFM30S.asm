*          DATA SET CTSFM30S   AT LEVEL 013 AS OF 05/01/02                      
*PHASE TA0A30A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
...
*/CLIENT ELEMENT/                                                               
         ...
         LA    R2,MNTCLTH            PT TO FIRST CLIENT HEADER                  
...
*                                                                               
VR30     ZIC   R1,0(R2)              LENTH OF CLIENT FIELD                      
         AR    R2,R1                 BUMP TO START-DATE FIELD                   
         GOTO1 ANY                   START-DATE REQUIRED                        
         GOTO1 DATVAL,DMCB,(0,8(R2)),TMPDATE                                    
         CLI   CLTSTR,C'0'           VALID DATE?                                
         BE    ERRINVL               PRINT INVALID DATE FORMAT MSG              
         GOTO1 DATCON,DMCB,TMPDATE,(3,CLTSTR)    SAVE AS BINARY                 
*                                                                               
         ZIC   R1,0(R2)              LENTH OF START FIELD                       
         AR    R2,R1                 BUMP TO END DATE FIELD                     
         CLI   5(R2),0               END-DATE ENTERED?                          
         BE    VR40                  NO                                         
         GOTO1 DATVAL,DMCB,(0,8(R2)),TMPDATE                                    
         CLI   CLTEND,C'0'           VALID DATE?                                
         BE    ERRINVL               PRINT INVALID DATE FORMAT MSG              
         GOTO1 DATCON,DMCB,TMPDATE,(3,CLTEND)    SAVE AS BINARY                 
*                                                                               
VR40     MVI   ELCODE,CLTELQ         PUT CLIENT ELEMENT CODE INTO ELEM          
         ...
         GOTO1 ADDELEM               ADD CLIENT ELEMENT                         
*                                                                               
         ZIC   R1,0(R2)              LENGTH OF END DATE FIELD                   
...
*GET AGY ELEMENT                                                                
         ...
         DROP  R6                                                               
*                                                                               
         LA    R2,MNTCLTH            PT TO FIRST CLIENT FIELD                   
...
*                                                                               
DR20     BNE   DRX                   DONE PROCESSING CLIENT ELEM?               
         MVC   8(3,R2),CLTAGY        PRINT CLIENT AGY CODE                      
         OC    CLTADV,CLTADV                                                    
         BZ    DR25                                                             
...
*                                                                               
         ZIC   R1,0(R2)              LENGTH OF CLT FIELD                        
         AR    R2,R1                 BUMP TO START DATE FIELD                   
         GOTO1 DATCON,DMCB,(3,CLTSTR),(8,8(R2))                                 
*                                                                               
         ZIC   R1,0(R2)              LENGTH OF START DATE FIELD                 
         AR    R2,R1                 BUMP TO END DATE FIELD                     
         OC    CLTEND,CLTEND         IS THERE AN END DATE?                      
         BZ    DR30                  NO, DON'T CALL DATCON                      
         GOTO1 DATCON,DMCB,(3,CLTEND),(8,8(R2))                                 
*                                                                               
DR30     ZIC   R1,0(R2)              BUMP TO NEXT (CLT) FIELD                   
         AR    R2,R1                                                            
...
TMPDATE  DS    CL6                 TEMPORARILY SAVE DATE FROM DATVAL            
...
LISTAGY  DS    CL2                 AGENCY                                       
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013CTSFM30S  05/01/02'                                      
         END                                                                    
