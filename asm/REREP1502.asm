*          DATA SET REREP1502  AT LEVEL 149 AS OF 12/07/07                      
*PHASE RE1502A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE DATCON                                                                 
...
* MAR15/99 (SKU) --- UPDATE TO SUPPORT ENTIRE X'51' ORDER RECORDS   *           
* JUL18/07 (SKU) --- I'M STILL DOING THIS STUFF, SKIP XML ORDERS    *           
* DEC27/07 (SKU) --- CHANGE TO ADD COPY TO RECOVERY OUTPUT          *           
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
******************************************************************              
DUMPFILE NTR1                                                                   
         CLC   =C'TEST',QUESTOR    IF TEST RUN, DON'T DUMP THE FILE             
         BE    DUMPX                                                            
         OPEN  (INDISK2,(INPUT))                                                
...
SSBOFFD  DSECT                                                                  
       ...
       ++INCLUDE DDMASTD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'149REREP1502 12/07/07'                                      
         END                                                                    
