*          DATA SET RECNT64    AT LEVEL 015 AS OF 11/18/13                      
*          DATA SET RECNT64    AT LEVEL 099 AS OF 04/28/97                      
*PHASE T80264A                                                                  
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
         TITLE 'T80264 - RECNT64 - BIAS EC'                                     
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT64 --- BIAS ELECTRONIC CONTRACT INTERFACE             *           
* ----------------------------------------------------------------- *           
* UPDATE HISTORY:                                                   *           
*                                                                   *           
...
*                                                                   *           
* JUL37/00 (BU ) --- NEW FORMAT FOR COMPETITIVE RECORD              *           
*                                                                   *           
...
*                                                                   *           
* OCT09/01 (BU ) --- PASS 'FB' (FSSNY) THROUGH AS 'UT' INSTEAD      *           
*                                                                   *           
* NOV01/01 (BU ) --- SKIP SPORTS BUYS                               *           
*                                                                   *           
...
T80264   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T80264*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
BLD10040 EQU   *                                                                
         ...
         BNE   BLD10060            NO                                           
         MVC   REC01RP,=C'HR'      YES - OVERRIDE VALUE                         
BLD10060 EQU   *                                                                
...
BLD10071 EQU   *                                                                
         ...
         BNE   BLD10080            NO                                           
         MVC   REC01RP,=C'PT'      YES - OVERRIDE VALUE                         
BLD10080 EQU   *                                                                
         CLC   REPALPHA,=C'AM'     KATZ?                                        
         BNE   BLD10100            NO                                           
         MVC   REC01RP,=C'KZ'      YES - OVERRIDE VALUE                         
BLD10100 EQU   *                                                                
...
BLD10140 EQU   *                                                                
         ...
         BNE   BLD10160            NO                                           
         MVC   REC01RP,=C'NW'      YES - OVERRIDE VALUE                         
BLD10160 EQU   *                                                                
         CLC   REPALPHA,=C'JB'     FOX LOCAL STATION?                           
         BNE   BLD10170            NO                                           
         MVC   REC01RP,=C'NW'      YES - OVERRIDE VALUE                         
BLD10170 EQU   *                                                                
         CLC   REPALPHA,=C'FB'     FOX STATION SALES?                           
         BNE   BLD10180            NO                                           
         MVC   REC01RP,=C'UT'      YES - OVERRIDE VALUE                         
BLD10180 EQU   *                                                                
         CLC   REPALPHA,=C'B3'     EJOR TEST?                                   
         BNE   BLD10200            NO                                           
         MVC   REC01RP,=C'**'      YES - OVERRIDE VALUE                         
BLD10200 EQU   *                                                                
*                                                                               
...
*                                                                               
         MVC   REC01EST,RCONXEST   MOVE EXPANDED ESTIMATE                       
         OC    RCONXEST,RCONXEST                                                
         BNZ   *+10                                                             
         MVC   REC01EST,RCONIEST   MOVE ESTIMATE                                
*                                     ALPHA: LEFT JUSTIFY                       
         OC    REC01EST,SPACES     SET ANY BINARY ZERO TO SPACE                 
         DROP  R6                                                               
BLD10360 EQU   *                                                                
...
SETRF01A EQU   *                                                                
         CLC   REPALPHA,=C'FB'     FOX STATION SALES?                           
         BNE   SETRG01A            NO                                           
         MVC   REC01REP+2(2),=C'UT'   YES - OVERRIDE VALUE                      
SETRG01A EQU   *                                                                
         XIT1                                                                   
         EJECT                                                                  
*********************************************************************           
...
*                                                                               
         ...
         CLC   REPALPHA,=C'SZ'     SELTEL?                                      
         BNE   BLD20002            NO                                           
         MVC   REC02REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
BLD20002 EQU   *                                                                
         CLC   REPALPHA,=C'46'     SELTEL/LOCAL                                 
         BNE   BLD20003            NO                                           
         MVC   REC02REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
...
BLD30060 EQU   *                                                                
         ...
         CLC   REPALPHA,=C'SZ'     SELTEL?                                      
         BNE   BLD30098            NO                                           
         MVC   REC03REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
BLD30098 EQU   *                                                                
         CLC   REPALPHA,=C'46'     SELTEL/LOCAL?                                
         BNE   BLD30099            NO                                           
         MVC   REC03REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
...
*                                  INSERT CONTRACT NUMBER                       
         ...
         MVI   REC03MBD,C' '       SPACE ALL MG DATES/TIMES                     
         MVC   REC03MBD+1(23),REC03MBD                                          
...
BLD30240 EQU   *                                                                
         ...
         CHI   RF,SUBLINLQ                                                      
         JL    *+6                                                              
         DC    H'0'                DUMP WHEN SUBLINE EXCEEDS 26                 
         B     BLD30260                                                         
...
BLD30360 EQU   *                                                                
         ...
         MVI   REC03MBD,C' '       CLEAR DATES/TIMES                            
         MVC   REC03MBD+1(23),REC03MBD                                          
...
BLD04REC NTR1                                                                   
         ...
         CLC   REPALPHA,=C'SZ'     SELTEL?                                      
         BNE   BLD40002            NO                                           
         MVC   REC04REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
BLD40002 EQU   *                                                                
         CLC   REPALPHA,=C'46'     SELTEL/LOCAL?                                
         BNE   BLD40003            NO                                           
         MVC   REC04REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
...
BLD50020 EQU   *                                                                
         ...
         CLC   REPALPHA,=C'SZ'     SELTEL?                                      
         BNE   BLD50002            NO                                           
         MVC   REC05REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
BLD50002 EQU   *                                                                
         CLC   REPALPHA,=C'46'     SELTEL/LOCAL?                                
         BNE   BLD50003            NO                                           
         MVC   REC05REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
...
***>>>   CLC   =C'0106',REC06ID    COMPETITIVE RECORD?                          
***>>>   BE    PREC0060            YES - PUT OUT DIFFERENT LENGTH               
PREC0040 EQU   *                                                                
         MVC   P(110),0(R4)                                                     
*                                                                               
         GOTO1 SPOOL,DMCB,(R8)                                                  
...
***      CLC   0(110,R4),SPACES    IS LINE ALL SPACES?                          
***      BE    PREC0045            NO                                           
***      OC    0(110,R4),0(R4)                                                  
***      BNZ   PREC0050                                                         
PREC0045 EQU   *                                                                
*                                  PUT OUT FINAL NON-SPACE                      
*                                     IN ALL CASES!                             
         MVI   109(R4),C'*'        YES - PUT OUT FINAL NON-SPACE                
PREC0050 EQU   *                                                                
...
***>>>   GOTO1 SPOOL,DMCB,(R8)                                                  
*                                                                               
***>>>   LA    R4,115(R4)          BUMP TO SECOND HALF OF RECORD                
***>>>   BCT   R2,PREC0060         DO SECOND HALF OF RECORD                     
***>>>   B     PREC0080                                                         
PREC0080 EQU   *                                                                
         XIT1                                                                   
         EJECT                                                                  
...
BLD06REC NMOD1 0,*BL06*                                                         
         ...
         CLC   REPALPHA,=C'SZ'     SELTEL?                                      
         BNE   BLD60020            NO                                           
         MVC   REC06REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
BLD60020 EQU   *                                                                
         CLC   REPALPHA,=C'46'     SELTEL/LOCAL?                                
         BNE   BLD60021            NO                                           
         MVC   REC06REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
...
BLD10REC NMOD1 0,*B10R*                                                         
         ...
         CLC   REPALPHA,=C'SZ'     SELTEL?                                      
         BNE   BL100002            NO                                           
         MVC   REC10REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
BL100002 EQU   *                                                                
         CLC   REPALPHA,=C'46'     SELTEL/LOCAL?                                
         BNE   BL100003            NO                                           
         MVC   REC10REP+2(2),=C'HR'  YES - OVERRIDE VALUE                       
...
****>>>>                                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015RECNT64   11/18/13'                                      
         END                                                                    
