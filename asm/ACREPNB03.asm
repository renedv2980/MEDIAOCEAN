*          DATA SET ACREPNB03  AT LEVEL 022 AS OF 12/21/14                      
*PHASE ACNB03C                                                                  
...
BFMT     NTR1  LABEL=*,WORK=(R7,FWSLNQ)                                         
         ...
         LARL  RF,SOFTAB2                                                       
         MVI   2(RF),0             INITIALIZE SPECIAL TABLE                     
         LA    RF,L'SOFTAB(RF)                                                  
         CLI   0(RF),EOT                                                        
         JNE   *-12                                                             
...
BA02     SR    R0,R0                                                            
         ICM   R0,1,ADRNUM                                                      
         JZ    GETPDX              NO ADDRESS LINES, JUST AN ELEMENT            
         LA    RE,ADRADD1                                                       
         CHI   R0,5                                                             
         JNE   BA03                                                             
         MVI   SOFTBIL+2,X'80'                                                  
...
PONB3    LARL  RF,SOFTAB2          WNCH & WNCHB USE SPECIAL TABLE               
         CLC   ORIGINUM,=X'3579'                                                
         JE    GETPDX                                                           
         CLC   ORIGINUM,=X'357A'                                                
         JE    GETPDX                                                           
...
SOFTCOL  MVI   BFMLEFT,0           CLEAR COLUMN                                 
         ...
         LARL  RF,SOFTAB2          WNCH & WNCHB USE SPECIAL TABLE               
         CLC   ORIGINUM,=X'3579'                                                
         JE    SOFTCOL1                                                         
         CLC   ORIGINUM,=X'357A'                                                
         JE    SOFTCOL1                                                         
...
* ENTRY IN A21F TABLE CHANGED FOR WNCH & WNCHB TO USE PDPGH1A BECAUSE           
* DISPLACEMENT AND POSITION OF PRINT ON BILLS DIFFERS                           
*                                                                               
GETBF    MVC   WNCH_B+5(2),=AL2(PDPGH1A-GENB)    SPECIAL CASE                   
         CLC   ORIGINUM,=X'3579'                                                
         JE    GETBF00                                                          
         CLC   ORIGINUM,=X'357A'                                                
         JE    GETBF00                                                          
         MVC   WNCH_B+5(2),=AL2(PDPGH1-GENB)     DEFAULT                        
                                                                                
GETBF00  LARL  RF,BFTAB            LOCATE BFTAB ENTRY - RETURN IN RF            
...
WNCH_B   DC    AL1(GTTXQ),AL1(CONTQ,0),AL2(0,PDPGH1-GENB)                       
...
PDPGH1   DS    0X                                   PAGE HEADER                 
         ...
         DC    AL1(EOT)                                                         
         EJECT                                                                  
* SPECIAL TABLE FOR WNCH & WNCHB                                                
* PRINT ON BILLS STARTS IN A DIFFERENT POSITION FOR THESE ID'S                  
*                                                                               
PDPGH1A  DS    0X                                   PAGE HEADER                 
         DC    AL1(1,2,9,1,0,0)                     'BILL DATE'                 
         DC    AL1(0,0)                                                         
         DC    AL1(0)                                                           
         DC    AL1(L'DD@BILDT),AL2(DD@BILDT-DICD)                               
...
BLHFLAG1 DS    XL(L'BFTFLAG1)      Format flags                                 
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'022ACREPNB03 12/21/14'                                      
         END                                                                    
