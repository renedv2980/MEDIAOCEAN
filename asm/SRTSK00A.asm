*          DATA SET SRTSK00A   AT LEVEL 007 AS OF 05/01/02                      
*          DATA SET SRTSK00    AT LEVEL 005 AS OF 07/06/98                      
*PHASE T15200A                                                                  
...
*                                                                               
         ...
         XR    R2,R2                                                            
         ICM   R2,7,TCBIOCNT       ANY IO'S ?                                   
         BZ    TIMER               NO - DONT PRINT                              
         EDIT  (R2),(5,SCDIO)                                                   
*                                                                               
         ICM   R2,15,TCBLIOC        ANY IO'S ?                                  
         BZ    TIMER               NO - DONT PRINT                              
         EDIT  (R2),(5,SCDTIMER-1)                                              
         B     CPUTIME                                                          
*                                                                               
...
SQUASH2  LA    R4,1(,R4)           POINT TO NEXT SOURCE BYTE                    
         ...
         BR    RE                                                               
         EJECT                                                                  
ERR1     MVC   SRVMSG+15(L'MSG1),MSG1                                           
         B     ERRX                                                             
ERR2     MVC   SRVMSG+15(L'MSG2),MSG2                                           
         B     ERRX                                                             
ERR3     MVC   SRVMSG+15(L'MSG3),MSG3                                           
         B     ERRX                                                             
ERR4     MVC   SRVMSG+15(L'MSG4),MSG4                                           
         B     ERRX                                                             
ERR5     MVC   SRVMSG+15(L'MSG5),MSG5                                           
         B     ERRX                                                             
*                                                                               
...
*&&                                                                             
         DC    X'FF'                                                            
*                                                                               
MSG0     DC    C'(XXXX) CURRENT INPUT QLEN = NNNNN'                             
...
*&&                                                                             
*&&US                                                                           
MINTAB   DC    C'AD1',AL1(10)      MINIMUM TASK VALUE                           
         DC    C'AD2',AL1(10)                                                   
         DC    C'AD3',AL1(10)                                                   
         DC    C'AD4',AL1(10)                                                   
         DC    C'AD5',AL1(8)                                                    
         DC    C'AD6',AL1(8)                                                    
         DC    C'AD7',AL1(10)                                                   
         DC    C'REA',AL1(8)       FACREPA                                      
         DC    C'REB',AL1(8)       FACREPB                                      
         DC    C'REC',AL1(8)       FACREPC                                      
         DC    C'MEL',AL1(3)       FACMEL                                       
         DC    C'TST',AL1(3)       FACTEST                                      
         DC    C'DAE',AL1(3)       FACDARE                                      
         DC    C'FRD',AL1(3)       FACFRED                                      
         DC    C'Y2K',AL1(3)       FACY2K                                       
         DC    C'   ',AL1(10)      DEFAULT IF NOT IN TABLE                      
*&&                                                                             
         EJECT                                                                  
*              DSECT TO COVER W/S                                               
*                                                                               
...
SCDCPU   DS    CL5                 TOTAL CPU                                    
         DS    C                                                                
SCDTIMER DS    CL4                 TIMER INTERRUPTS                             
         DS    C                                                                
...
* FAUTL                                                                         
       ...
       ++INCLUDE FAUTL                                                          
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007SRTSK00A  05/01/02'                                      
         END                                                                    
