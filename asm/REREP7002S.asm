*          DATA SET REREP7002S AT LEVEL 141 AS OF 07/11/02                      
*PHASE RE7002A,*                                                                
*INCLUDE SORTER                                                                 
*INCLUDE REGENSTC                                                               
*INCLUDE PRINT                                                                  
...
ALLQSB15 EQU   *                                                                
         ...
         BNE   ALLQSB60            NO, IGNORE OPTION - UNRECOGNIZED             
*                                                                               
*   TEST                                                                        
         CLC   =C'PRINTIT',QUESTOR DISPLAY INPUT?                               
         BNE   TEST0020            NO                                           
...
DET142   EQU   *                                                                
         ...
         DROP  R6                                                               
*                                                                               
* LINE 14- LIABILITY COMMENT                                                    
         MVC   P+2(9),=C'LIABILITY'                                             
         OC    RSTALIAB,RSTALIAB   IS THERE AN X'08'                            
         BZ    DET144Z                                                          
...
PRTFONE  NTR1                                                                   
         ...
         CLC   RSTAFNFO,SPACES                                                  
         BE    *+16                                                             
         MVC   PSECOND+3(11),=C'FORMER REP='                                    
         MVC   PSECOND+14(L'RSTAFNFO),RSTAFNFO                                  
         CLC   RSTAFNNE,SPACES                                                  
         BE    EXIT                                                             
         MVC   PSECOND+28(L'RSTAFNNE),RSTAFNNE                                  
         DROP  R6                                                               
         B     EXIT                                                             
         EJECT                                                                  
*******************************************************************             
...
PCOMSTA4 DS    CL7                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'141REREP7002S07/11/02'                                      
         END                                                                    
