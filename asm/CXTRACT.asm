*          DATA SET CXTRACT    AT LEVEL 139 AS OF 02/16/12                      
*PHASE CXTRACTA                                                                 
*INCLUDE DMUTLCT                                                                
*INCLUDE DMDMGRL                                                                
*INCLUDE CXSAGC                                                                 
...
GENINIT  NTR1  ,                                                                
         ...
         USING SXDTABD,R4                                                       
         XC    AENCKEY,AENCKEY                                                  
         MVC   VERSION,SXDTVER     SAVE VERSION                                 
...
GINI020  CLI   SXDTSUB,X'01'                                                    
         ...
         CLI   SXDTSUB,X'05'                                                    
         BE    GINI060                                                          
         CLI   SXDTSUB,X'D1'       XML1                                         
         BE    GINI060                                                          
         CLI   SXDTSUB,X'D2'       XML2                                         
         BE    GINI060                                                          
         DC    H'0'                                                             
*                                                                               
GINI030  L     RE,=A(SECTAB)                                                    
         STCM  RE,15,ASUBTAB                                                    
         B     GINI100                                                          
GINI040  L     RE,=A(SECTAB)                                                    
         STCM  RE,15,ASUBTAB                                                    
         B     GINI100                                                          
GINI050  L     RE,=A(PRETAB)                                                    
         STCM  RE,15,ASUBTAB                                                    
         B     GINI100                                                          
GINI060  L     RE,=A(TEMTAB)                                                    
         STCM  RE,15,ASUBTAB                                                    
         B     GINI100                                                          
GINI070  L     RE,=A(SECTAB)                                                    
         STCM  RE,15,ASUBTAB                                                    
         B     GINI100                                                          
*                                                                               
GINI100  EQU   *                                                                
...
POPEN02  BAS   RE,INSAGTAB           ALPHA ID TABLE                             
...
*                                                                               
         SAM31                                                                  
         L     R3,CXSAGUT                                                       
         L     R4,=A(AGUTLNQ*AGUTMAX)                                           
         FREEMAIN RU,A=(3),LV=(4)                                               
*                                                                               
         SAM24                                                                  
         XC    CXSAGUT,CXSAGUT                                                  
         XC    CXSAGUTX,CXSAGUTX                                                
         B     PCLOOK                                                           
*                                                                               
PCLONO   B     NO                                                               
PCLOOK   B     YES                                                              
...
LOADSEC  NTR1                                                                   
         ...
         BNE   LSECNO                                                           
         BAS   RE,LOADSAU          ACCESS CONTROLS AT USERID LEVEL              
         BNE   LSECNO                                                           
         BAS   RE,LOADSAB          ACCESS CONTROLS AT USERID/GROUP LEV          
         BNE   LSECNO                                                           
         BAS   RE,LOADSFA          FIELD CONTROLS AT AGENCY LEVEL               
         BNE   LSECNO                                                           
         BAS   RE,LOADSFG          FIELD CONTROLS AT GROUP LEVEL                
         BNE   LSECNO                                                           
         BAS   RE,LOADSFU          FIELD CONTROLS AT USERID LEVEL               
         BNE   LSECNO                                                           
         BAS   RE,LOADSFB          FIELD CONTROLS AT USERID/GROUP LEVEL         
         BNE   LSECNO                                                           
         BAS   RE,LOADSOA          OPTION CONTROLS AT AGENCY LEVEL              
         BNE   LSECNO                                                           
         BAS   RE,LOADSOG          OPTION CONTROLS AT GROUP LEVEL               
         BNE   LSECNO                                                           
         BAS   RE,LOADSOU          OPTION CONTROLS AT USERID LEVEL              
         BNE   LSECNO                                                           
         BAS   RE,LOADSOB          OPTION CONTROLS AT USERID/GROUP LEV.         
         BNE   LSECNO                                                           
         BAS   RE,LOADSEF          PERSON PASSWORD EFFECTIVE DATE               
         BNE   LSECNO                                                           
         B     LSECOK                                                           
*                                                                               
LSECNO   B     NO                                                               
...
*                                                                               
LSPE012  EQU   *                                                                
         CLI   VERSION,2           ALL FUTURE PERSON IDS VERSION >= 2           
         BNL   LSPE014                                                          
         MVC   PIDSAVE,SAPEPID                                                  
         CLC   SAPEDEF,TODAYC                                                   
         BNL   LSPE020                                                          
...
*                                  HERE FOR VERSION >= 2                        
LSPE030  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSPE2C,VCXSPE2X,INITSPE,0                          
         BNE   LSPENO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSPEOK                                                           
         B     LSPE010                                                          
...
LSALOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD USERID LEVEL ACCESS AUTHSORISATIONS                            *         
***********************************************************************         
         SPACE 1                                                                
LOADSAU  NTR1                                                                   
*                                                                               
         CLI   VERSION,2           ONLY IF VERSION >= 2                         
         BL    LSAUOK                                                           
*                                                                               
         MVC   MAXIOS,DXMAXREC                                                  
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSAU010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSAUOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
*                                  ALL DONE IF RECORD TYPE CHANGES              
         CLC   SAASKEY(SAASOVPG-SAASKEY),IOKEY                                  
         BNE   LSAUOK                                                           
*                                  READ USERID LEVEL ONLY                       
         OC    SAASAGN,SAASAGN                                                  
         BNZ   LSAU012                                                          
         OC    SAASUID,SAASUID                                                  
         BNZ   LSAU020                                                          
*                                                                               
LSAU012  MVC   IOKEY(L'SAASKEY),0(R2)                                           
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSAU010                                                          
*                                                                               
LSAU020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSAUC,VCXSAUX,INITSAU,0                            
         BNE   LSAUNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSAUOK                                                           
         B     LSAU010                                                          
...
LSAUOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD GROUP/USERID LEVEL ACCESS AUTHSORISATIONS                      *         
***********************************************************************         
         SPACE 1                                                                
LOADSAB  NTR1                                                                   
*                                                                               
...
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSAB010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSABOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
...
*                                  READ USERID/GROUP LEVEL ONLY                 
         ...
         B     LSAB020                                                          
*                                                                               
LSAB012  MVC   IOKEY(L'SAASKEY),0(R2)                                           
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSAB010                                                          
*                                                                               
LSAB020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSABC,VCXSABX,INITSAB,0                            
         BNE   LSABNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSABOK                                                           
         B     LSAB010                                                          
...
LSFGOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD FIELD CONTROL USERID LEVEL RECORDS                             *         
***********************************************************************         
         SPACE 1                                                                
LOADSFU  NTR1                                                                   
*                                                                               
...
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSFU010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSFUOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
...
*                                  READ USERID LEVEL ONLY                       
         ...
         BNZ   LSFU020                                                          
*                                                                               
LSFU012  MVC   IOKEY(L'SAFCKEY),0(R2)                                           
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSFU010                                                          
*                                                                               
LSFU020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSFUC,VCXSFUX,INITSFU,0                            
         BNE   LSFUNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSFUOK                                                           
         B     LSFU010                                                          
...
LSFUOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD FIELD CONTROL USERID/GROUP LEVEL RECORDS                       *         
***********************************************************************         
         SPACE 1                                                                
LOADSFB  NTR1                                                                   
*                                                                               
...
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSFB010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSFBOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
...
*                                  READ USERID/GROUP LEVEL ONLY                 
         ...
         B     LSFB020                                                          
*                                                                               
LSFB012  MVC   IOKEY(L'SAFCKEY),0(R2)                                           
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSFB010                                                          
*                                                                               
LSFB020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSFBC,VCXSFBX,INITSFB,0                            
         BNE   LSFBNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSFBOK                                                           
         B     LSFB010                                                          
...
LSOGOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD OPTION CONTROL USERID LEVEL RECORDS                            *         
***********************************************************************         
         SPACE 1                                                                
LOADSOU  NTR1                                                                   
*                                                                               
...
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSOU010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSOUOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
...
*                                  READ USERID LEVEL ONLY                       
         ...
         BNZ   LSOU020                                                          
*                                                                               
LSOU012  MVC   IOKEY(L'SAOCKEY),0(R2)                                           
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSOU010                                                          
*                                                                               
LSOU020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSOUC,VCXSOUX,INITSOU,0                            
         BNE   LSOUNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSOUOK                                                           
         B     LSOU010                                                          
...
LSOUOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD OPTION CONTROL USERID/GROUP LEVEL RECORDS                      *         
***********************************************************************         
         SPACE 1                                                                
LOADSOB  NTR1                                                                   
*                                                                               
...
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSOB010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSOBOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
...
*                                  READ USERID/GROUP LEVEL ONLY                 
         ...
         B     LSOB020                                                          
*                                                                               
LSOB012  MVC   IOKEY(L'SAOCKEY),0(R2)                                           
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSOB010                                                          
*                                                                               
LSOB020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSOBC,VCXSOBX,INITSOB,0                            
         BNE   LSOBNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSOBOK                                                           
         B     LSOB010                                                          
...
LSOBOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* LOAD PERSON PASSWORD EFFECTIVE DATE RECORDS                         *         
***********************************************************************         
         SPACE 1                                                                
LOADSEF  NTR1  ,                                                                
*                                                                               
         CLI   VERSION,3           ONLY IF VERSION >= 3                         
         BL    LSEFOK                                                           
*                                                                               
         MVC   MAXIOS,DXMAXREC                                                  
*                                                                               
         ...
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IOKEY,(R2)                   
*                                                                               
LSEF010  TM    8(R1),X'80'         ALL DONE IF EOF                              
         BO    LSEFOK                                                           
         TM    8(R1),X'7D'         DIE IF DISK ERROR                            
         BZ    *+6                                                              
         DC    H'0'                                                             
*                                  ALL DONE IF RECORD TYPE CHANGES              
         CLC   SA0KEY(SA0KEYS-SA0KEY),IOKEY OR AGENCY                           
         BNE   LSEFOK                                                           
         OC    SA0KEYS(SA0KNUM-SA0KEYS),SA0KEYS MUST BE PERS NUM KEY            
         BNZ   LSEFOK              NO-WE ARE DONE                               
*                                                                               
         CLI   SA0STAT,X'20'       TEST IF LOCKED                               
         BE    LSEF012                                                          
         CLI   SA0STAT,X'40'       TEST NEW PERSON PASSWORD                     
         BNE   LSEF012                                                          
         BAS   RE,FILTPWH          FILTER RECORD FOR SAPWH ELEMENT              
         BE    LSEF020             YES-IT HAS ONE                               
*                                                                               
LSEF012  MVC   IOKEY(L'SA0KEY),0(R2)                                            
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IOKEY,(R2)                   
         B     LSEF010                                                          
*                                                                               
LSEF020  EQU   *                                                                
         GOTO1 CXLOAD,DMCB,VCXSEFC,VCXSEFX,INITSEF,0                            
         BNE   LSEFNO                                                           
         OC    MAXIOS,MAXIOS       EXIT IF MAXIOS EXCEEDED                      
         BZ    LSEFOK                                                           
         B     LSEF010                                                          
...
LSEFOK   B     YES                                                              
         ...
         SPACE 2                                                                
***********************************************************************         
* FILTER ON PRESENCE OF PASSWORD HISTORY ELEMENT                      *         
* ON ENTRY, R2=A(SA0REC)                                              *         
* ON EXIT, CC=EQ FOR SAPWH ELEMENT PRESENT, CC=NEQ FOR NONE           *         
***********************************************************************         
        SPACE 1                                                                 
FILTPWH  NTR1  ,                                                                
         USING SA0REC,R2                                                        
...
UALL010  CLI   0(R3),0             EXIT IF END OF TABLE                         
         BE    UALLOK                                                           
         CLI   RECVHDR+L'RECVHDR,0      UNKNOWN REC TYPE                        
         BE    UALLOK                   SKIP THIS ONE                           
...
***********************************************************************         
         SPACE 1                                                                
UPDTSPW  NTR1                                                                   
         CLI   VERSION,2           IGNORE FOR VERSION >= 2                      
         BNL   USPWOK                                                           
*                                  SET A(PERSON PASSWORD RECORD) FROM           
         LA    R2,RECVHDR+L'RECVHDR  RECOVERY RECORD BUFFER                     
         USING SA0REC,R2                                                        
...
*                                                                               
         CLI   VERSION,2                                                        
         BNL   USPE012             ALL FUTURE PERSON IDS VERSION > = 2          
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                  IGNORE IF OLD PIDS                           
         CLC   0(SAPEDEF-SAPEREC,R4),0(R2)                                      
         BNE   USPEOK                                                           
*YOU STILL WANT THE CHANGE REGARDLESS THE EFF DATE                              
*        CLC   SAPEDEF-SAPEREC(L'SAPEDEF,R2),TODAYC                             
*        BH    USPEOK                                                           
         B     USPE020                                                          
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
USPE010  EQU   *                                                                
         GOTO1 CXUPDT,DMCB,VCXSPEC,VCXSPEX,INITSPE                              
         BNE   USPENO                                                           
         B     USPEOK                                                           
*                                  VERSION >= 2                                 
USPE020  EQU   *                                                                
         GOTO1 CXUPDT,DMCB,VCXSPE2C,VCXSPE2X,INITSPE                            
         BNE   USPENO                                                           
         B     USPEOK                                                           
*                                                                               
USPENO   B     NO                                                               
...
USALOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE USERID LEVEL ACCESS RECORD                                   *         
***********************************************************************         
         SPACE 1                                                                
UPDTSAU  NTR1                                                                   
*                                                                               
...
*                                  READ USERID LEVEL ONLY                       
         ...
         BZ    USAUOK                                                           
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
         GOTO1 CXUPDT,DMCB,VCXSAUC,VCXSAUX,INITSAU                              
         BNE   USAUNO                                                           
         B     USAUOK                                                           
*                                                                               
USAUNO   B     NO                                                               
USAUOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE USERID/GROUP LEVEL ACCESS RECORD                             *         
***********************************************************************         
         SPACE 1                                                                
UPDTSAB  NTR1                                                                   
*                                                                               
...
*                                  READ USERID/GROUP LEVEL ONLY                 
         ...
         BZ    USABOK                                                           
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
         GOTO1 CXUPDT,DMCB,VCXSABC,VCXSABX,INITSAB                              
         BNE   USABNO                                                           
         B     USABOK                                                           
*                                                                               
USABNO   B     NO                                                               
...
USFGOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE FIELD CONTROL USERID LEVEL RECORDS                           *         
***********************************************************************         
         SPACE 1                                                                
UPDTSFU  NTR1                                                                   
*                                                                               
...
*                                  READ USERID LEVEL ONLY                       
         ...
         BZ    USFUOK                                                           
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
         GOTO1 CXUPDT,DMCB,VCXSFUC,VCXSFUX,INITSFU                              
         BNE   USFUNO                                                           
         B     USFUOK                                                           
*                                                                               
USFUNO   B     NO                                                               
USFUOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE FIELD CONTROL USERID/GROUP LEVEL RECORDS                     *         
***********************************************************************         
         SPACE 1                                                                
UPDTSFB  NTR1                                                                   
*                                                                               
...
*                                  READ USERID/GROUP LEVEL ONLY                 
         ...
         BZ    USFBOK                                                           
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
         GOTO1 CXUPDT,DMCB,VCXSFBC,VCXSFBX,INITSFB                              
         BNE   USFBNO                                                           
         B     USFBOK                                                           
*                                                                               
USFBNO   B     NO                                                               
...
USOGOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE OPTION CONTROL USERID LEVEL RECORDS                          *         
***********************************************************************         
         SPACE 1                                                                
UPDTSOU  NTR1                                                                   
*                                                                               
...
*                                  READ USERID LEVEL ONLY                       
         ...
         BZ    USOUOK                                                           
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
         GOTO1 CXUPDT,DMCB,VCXSOUC,VCXSOUX,INITSOU                              
         BNE   USOUNO                                                           
         B     USOUOK                                                           
*                                                                               
USOUNO   B     NO                                                               
USOUOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE OPTION CONTROL USERID/GROUP LEVEL RECORDS                    *         
***********************************************************************         
         SPACE 1                                                                
UPDTSOB  NTR1                                                                   
*                                                                               
...
*                                  READ USERID LEVEL ONLY                       
         ...
         BZ    USOBOK                                                           
*                                  TRANSFER RECORD DATA TO EXTRACT FILE         
         GOTO1 CXUPDT,DMCB,VCXSOBC,VCXSOBX,INITSOB                              
         BNE   USOBNO                                                           
         B     USOBOK                                                           
*                                                                               
USOBNO   B     NO                                                               
USOBOK   B     YES                                                              
         ...
         EJECT                                                                  
***********************************************************************         
* UPDATE PERSON PASSWORD EFFECTIVE DATE RECORDS                       *         
***********************************************************************         
         SPACE 1                                                                
UPDTSEF  NTR1  ,                                                                
*                                                                               
...
*                                  SET A(FCONTROL RECORD) FROM                  
         LA    R2,RECVHDR+L'RECVHDR  RECOVERY RECORD BUFFER                     
         USING SA0REC,R2                                                        
         CLI   SA0KTYP,SA0KTYPQ    FILTER ON RECORD TYPE                        
         BNE   USEFOK                                                           
*                                                                               
         CLC   SA0KAGY,AGENCYID    FILTER ON AGENCY ALPHA ID                    
         BNE   USEFOK                                                           
*                                                                               
         OC    SA0KEYS(SA0KNUM-SA0KEYS),SA0KEYS                                 
         BNZ   USEFOK              ONLY PERSON NUMBER RECORDS                   
*                                                                               
         OC    SA0KNUM,SA0KNUM     TEST FOR A PERSON NUMBER                     
         BZ    USEFOK                                                           
*                                                                               
         CLI   SA0STAT,X'20'       ONLY FOR UNLOCKED RECORDS                    
         BE    USEFOK                                                           
         CLI   SA0STAT,X'40'       AND NEW SECURITY RECORDS                     
         BNE   USEFOK                                                           
         BAS   RE,FILTPWH          AND RECORD HAS PASS HIST ELEMENT             
         BNE   USEFOK                                                           
*                                                                               
         GOTO1 CXUPDT,DMCB,VCXSEFC,VCXSEFX,INITSEF                              
         BE    USEFOK                                                           
         B     USEFNO                                                           
*                                                                               
USEFNO   B     NO                                                               
...
INITSAL  NTR1                                                                   
         ...
         SPACE 1                                                                
***********************************************************************         
* INITIALISE USERID LEVEL ACCESS RECORD                               *         
***********************************************************************         
         SPACE 1                                                                
INITSAU  NTR1                                                                   
         LA    R1,CXSAUDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
* INITIALISE USERID/GROUP LEVEL ACCESS RECORD                         *         
***********************************************************************         
         SPACE 1                                                                
INITSAB  NTR1                                                                   
         LA    R1,CXSABDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
...
INITSFG  NTR1                                                                   
         ...
         SPACE 1                                                                
***********************************************************************         
* INITIALISE FIELD CONTROL USERID LEVEL RECORD                        *         
***********************************************************************         
         SPACE 1                                                                
INITSFU  NTR1                                                                   
         LA    R1,CXSFUDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
* INITIALISE FIELD CONTROL USERID/GROUP LEVEL RECORD                  *         
***********************************************************************         
         SPACE 1                                                                
INITSFB  NTR1                                                                   
         LA    R1,CXSFBDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
...
INITSOG  NTR1                                                                   
         ...
         SPACE 1                                                                
***********************************************************************         
* INITIALISE OPTION CONTROL USERID LEVEL RECORD                       *         
***********************************************************************         
         SPACE 1                                                                
INITSOU  NTR1                                                                   
         LA    R1,CXSOUDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
* INITIALISE OPTION CONTROL USERID/GROUP LEVEL RECORD                 *         
***********************************************************************         
         SPACE 1                                                                
INITSOB  NTR1                                                                   
         LA    R1,CXSOBDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
* INITIALISE PERSON PASSWORD EFFECTIVE DATE RECORD                    *         
***********************************************************************         
         SPACE 1                                                                
INITSEF  NTR1                                                                   
         LA    R1,CXSEFDL          R1=L'RECORD                                  
         BAS   RE,INITALL                                                       
         B     YES                                                              
         SPACE 1                                                                
***********************************************************************         
...
*                                  CALL RECORD EXTRACT ROUTINE                  
         GOTO1 (R3),DMCB,DXAXREC,(R2),AENCKEY,AGYBIN,ADXBLOCK                   
...
*                                  CONVERT RECORD TO SQL BUFFER                 
         GOTO1 (R4),DMCB,DXAXREC,DXASQLB,0,ADXBLOCK                             
*                                                                               
...
***********************************************************************         
INAGUTAB NTR1                                                                   
         ICM   R1,15,CXSAGUT       START OF TABLE                               
         BNZ   IAGU01                                                           
*                                                                               
         L     R0,=A(AGUTLNQ*AGUTMAX)                                           
         LR    R4,R0               SAVE OFF SIZE                                
         GETMAIN RU,LV=(0),LOC=(ANY,ANY),BNDRY=PAGE                             
         LTR   RF,RF                                                            
         BZ    *+6                                                              
         DC    H'0'                                                             
         ST    R1,CXSAGUT          SAVE START OF TABLE                          
         AR    R4,R1               POINT TO END OF TABLE                        
         ST    R4,CXSAGUTX                                                      
*                                                                               
         USING AGUTABD,R4                                                       
IAGU01   SAM31                                                                  
         LR    R4,R1                                                            
         LR    R0,R4               CLEAR TABLE DOWN                             
         L     R1,=A(AGUTLNQ*AGUTMAX)                                           
         XR    RF,RF                                                            
         MVCL  R0,RE               (BNDRY=PAGE FORCES CLEAR)                    
*                                                                               
         USING SXDTABD,R5                                                       
         L     R5,DXSTPTR          R5=A(EXTRACT SYSTEM TABLE ENTRY)             
*                                  NOW FILL IN ALL NEEDFUL VALUES               
IAGU02   C     R5,DXSTEPTR         R5 = A(END OF TABLE)                         
         BE    IAGU04              YES                                          
         CLI   SXDTSUB,X'01'                                                    
         BNE   IAGU03                                                           
         MVC   AGUAGYID,SXDTAGY                                                 
         MVC   AGUSAGID,SXDTAGY                                                 
         MVC   AGUEYE,=C'AGY*'                                                  
         A     R4,CXSAGLNQ         NEXT IN OUR TABLE                            
IAGU03   AHI   R5,SXDTABL          NEXT IN DXTRACT MASTER TABLE                 
         B     IAGU02                                                           
                                                                                
***********************************************************************         
* WE HAVE A BLANK CXSAGUT FILLED OUT WITH THE AGENCY ID                         
* NOW READ THE FILE TO SEE THE USER IDS THAT MATCH FOR EACH                     
***********************************************************************         
         USING CTIKEY,R2           TO EXTRACT ASSOCIATED AGENCIES               
IAGU04   LA    R2,IO               READ USER ID RECORD                          
         XC    CTIKEY,CTIKEY                                                    
         MVI   CTIKTYP,CTIKTYPQ                                                 
         MVI   CTIKID,X'40'                                                     
         MVC   IOKEY(L'CTIKEY),IO                                               
         SAM24                                                                  
         GOTO1 VDATAMGR,DMCB,(X'00',DMRDHI),CTFILE,IO,IO                        
         CLI   8(R1),0                                                          
         BE    IAGU08                                                           
...
*                                                                               
IAGU06   SAM24                                                                  
         MVC   IO(L'CTIKEY),IOKEY                                               
         GOTO1 VDATAMGR,DMCB,(X'00',DMRSEQ),CTFILE,IO,IO                        
         CLI   8(R1),0                                                          
         BE    IAGU08                                                           
         DC    H'00'                                                            
*                                                                               
IAGU08   CLI   CTIKTYP,CTIKTYPQ    STILL HAVE AN ID RECORD?                     
         BNE   IAGUOK              NO                                           
         MVC   IOKEY(L'CTIKEY),CTIKEY                                           
*                                                                               
         BRAS  RE,GETUAGY          GET AND SET USERID AGENCY ALPHA ID           
         BNE   IAGU06              NO ALPHA ID (06 ELEMENT)                     
*                                                                               
         SAM31                                                                  
         L     R4,CXSAGUT          R4=A(AGENCY USERID ACCESS TABLE)             
IAGU10   OC    AGUAGYID,AGUAGYID                                                
         BZ    IAGU06              END OF TABLE - GET NEXT RECORD               
*                                                                               
         MVC   AGENCYID,AGUAGYID   SET FOR CHKSAGY                              
         GOTO1 CHKSAGY,USERAGY                                                  
         BNE   IAGU18              NO MATCH - NEXT ROW                          
*                                                                               
         LA    R6,AGUUID           FIND FIRST FREE ENTRY FOR THIS ROW           
X        USING AGUUID,R6                                                        
         LHI   R0,AGUIMAX                                                       
IAGU12   OC    X.AGUUID,X.AGUUID   SLOT EMPTY?                                  
         BZ    IAGU14              YES                                          
         AHI   R6,AGUULNQ                                                       
         BCT   R0,IAGU12           NEXT SLOT IN THIS ROW                        
         DC    H'0'                                                             
*                                                                               
IAGU14   MVC   X.AGUUID,CTIKID     SET ID                                       
         MVI   X.AGUVAL,C'N'                                                    
*                                                                               
         LA    R3,CTIDATA          NOW GET USERID NUMBER                        
         XR    RF,RF                                                            
IAGU16   CLI   0(R3),0                                                          
         BNE   *+6                                                              
         DC    H'00'                                                            
         CLI   0(R3),CTDSCELQ      X'02'                                        
         BE    *+12                                                             
         IC    RF,1(R3)                                                         
         BXH   R3,RF,IAGU16                                                     
         MVC   X.AGUUIN,2(R3)      SET USERID NUMBER                            
         DROP  X                                                                
*                                                                               
IAGU18   A     R4,CXSAGLNQ         NEXT TABLE                                   
         C     R4,CXSAGUTX                                                      
         BL    IAGU10                                                           
         DC    H'0'                OVERFLOW                                     
*                                                                               
...
GAGYOK   B     YES                                                              
         EJECT                                                                  
***********************************************************************         
* CHECK AGENCY ALPHA IN MASTER SECURITY AGENCYID LIST                 *         
...
NO       LTR   RC,RC               RETURN CC NOT EQUAL                          
         ...
         LTORG                                                                  
         EJECT                                                                  
CXSAGUT  DC    A(0)                START OF TABLE                               
CXSAGUTX DC    A(0)                END  OF TABLE                                
CXSAGLNQ DC    A(AGUTLNQ)          SIZE OF ONE TABLE                            
*                                                                               
...
ACTIVITY DC    CL1'Y'                                                           
         EJECT                                                                  
* FIELDS BEYOND THIS POINT DO NOT NEED TO BE COVERED BY A BASE REGISTER         
*                                                                               
         DS    0D                                                               
         DC    C'**SSB***'                                                      
* ++INCLUDE FASSBOFF                                                            
...
SECTAB   DS    0CL16                                                            
         ...
         DC    AL1(10),AL1(SAASTYPQ)                                            
         DC    CL3'AGU',C'   ',AL4(LOADSAU),AL4(UPDTSAU)                        
         DC    AL1(11),AL1(SAASTYPQ)                                            
         DC    CL3'AGB',C'   ',AL4(LOADSAB),AL4(UPDTSAB)                        
         DC    AL1(12),AL1(SAFCTYPQ)                                            
         DC    CL3'FCA',C'   ',AL4(LOADSFA),AL4(UPDTSFA)                        
         DC    AL1(13),AL1(SAFCTYPQ)                                            
         DC    CL3'FCG',C'   ',AL4(LOADSFG),AL4(UPDTSFG)                        
         DC    AL1(14),AL1(SAFCTYPQ)                                            
         DC    CL3'FCU',C'   ',AL4(LOADSFU),AL4(UPDTSFU)                        
         DC    AL1(15),AL1(SAFCTYPQ)                                            
         DC    CL3'FCB',C'   ',AL4(LOADSFB),AL4(UPDTSFB)                        
         DC    AL1(16),AL1(SAOCTYPQ)                                            
         DC    CL3'OCA',C'   ',AL4(LOADSOA),AL4(UPDTSOA)                        
         DC    AL1(17),AL1(SAOCTYPQ)                                            
         DC    CL3'OCG',C'   ',AL4(LOADSOG),AL4(UPDTSOG)                        
         DC    AL1(18),AL1(SAOCTYPQ)                                            
         DC    CL3'OCU',C'   ',AL4(LOADSOU),AL4(UPDTSOU)                        
         DC    AL1(19),AL1(SAOCTYPQ)                                            
         DC    CL3'OCB',C'   ',AL4(LOADSOB),AL4(UPDTSOB)                        
         DC    AL1(20),AL1(SA0KTYPQ)                                            
         DC    CL3'PPE',C'   ',AL4(LOADSEF),AL4(UPDTSEF)                        
         DC    AL1(21),AL1(SA0KTYPQ)                                            
...
CXSSAGT  CSECT                     MASTER SECURITY AGENCY ID TABLE              
         DC    (SAGTMAX*(SAGTLEN))X'00'                                         
CXSSAGTX EQU   *                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'139CXTRACT   02/16/12'                                      
         END                                                                    
