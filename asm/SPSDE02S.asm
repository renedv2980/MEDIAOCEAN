*          DATA SET SPSDE02S   AT LEVEL 014 AS OF 05/11/04                      
*PHASE T23102C                                                                  
...
*                                                                               
DWNA38   BAS   RE,SND07H                 DOWNLOAD AUTH MARKET DETAILS           
         BNE   NEXIT                                                            
*                                                                               
...
*                                                                               
         ...
         GOTO1 HIGH                                                             
         CLC   KEY(AUTKREV-AUTKEY),KEYSAVE                                      
         BNE   R06H60                    GET NEXT TSAR RECORD                   
**>      BE    *+6                                                              
**>      DC    H'0'                                                             
         L     R6,AIO1                                                          
         ST    R6,AIO                                                           
...
*                                  AND SEND ANOTHER REV 0                       
         ...
         BAS   RE,SENDD                                                         
*                                                                               
S08H18   BAS   RE,SND02H           08 HEADER, MIMMICK 02 HDR                    
*                                                                               
         USING AUTKEY,R6                                                        
S08H19   L     R6,AIO                                                           
         MVC   KEY,SVAUKEY                                                      
...
* IF SO, DELETE ALL STATUS ELEMENTS                                             
         USING AUTRECD,R6                                                       
REVMKT20 L     R6,AIO                                                           
         TM    OVMFLAG1,MKTCANLD         IS MARKET CANCELLED?                   
         BNO   REVMKT50                  NO                                     
...
REVMKT50 TM    SVFLAG1,F1CANMK           CANCEL MARKETS?                        
         ...
         MVI   ELCDHI,MSTACMSQ           EXCEPT FOR CANCELLED                   
         BRAS  RE,DELEL                                                         
*                                                                               
         XC    BLOCK,BLOCK                                                      
         LA    R3,BLOCK                                                         
...
GOLRECD  DSECT                                                                  
       ++INCLUDE SPGENGOAL                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014SPSDE02S  05/11/04'                                      
         END                                                                    
