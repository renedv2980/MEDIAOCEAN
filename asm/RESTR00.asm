*          DATA SET RESTR00    AT LEVEL 029 AS OF 03/16/05                      
*PHASE T80E00A,*                                                                
*INCLUDE UNBOOK                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE UNUPGR                                                                 
...
*                                                                 *             
* NOV24/97 (JRD) --- Y2000 JULIAN DATES                           *             
*                    **  END TOMBSTONE  **                        *             
*HERE**************************************************************             
T80E00   CSECT                                                                  
         PRINT NOGEN                                                            
...
* OUTPUT - WORK(3) HAS START DATE JULIAN PWOS 9'S COMPLEMENT                    
*          WORK+3(3) HAS END DATE JULIAN PWOS 9'S COMPLEMENT                    
***********************************************************************         
VPER     DS    0H                                                               
         XC    BLOCK(256),BLOCK                                                 
...
*                                                                               
         ...
         BZ    VPERNO                                                           
         MVC   WORK+14(2),=C'01'   SET TO 1ST OF MONTH                          
         GOTO1 DATCON,DMCB,(0,WORK+10),(19,WORK)      START DATE                
*                                                                               
* VALIDATE END DATE                                                             
...
*                                                                               
         ...
         OC    DMCB(4),DMCB        ERROR?                                       
         BZ    VPERNO                                                           
         MVC   WORK+20(2),=C'01'   SET TO 1ST OF MONTH                          
         GOTO1 DATCON,DMCB,(0,WORK+16),(19,WORK+3)     END DATE                 
...
DBLOCKD  DSECT                                                                  
       ++INCLUDE DEDBLOCK                                                       
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029RESTR00   03/16/05'                                      
         END                                                                    
