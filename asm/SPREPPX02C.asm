*          DATA SET SPREPPX02C AT LEVEL 018 AS OF 05/01/02                      
*PHASE SPPX02C,+0,NOAUTO                                                        
         TITLE 'SPREPPX02 - MEDIA PLANNING AGENCY SPOT EXTRACT'                 
         PRINT NOGEN                                                            
*                                                                               
*                                                                               
*        QOPT1   B=BBM,N=NSI/CSI (FILTER FOR MULTI-CLIENT RUNS)                 
...
**********************************************************************          
*                                                                               
*    CANADIAN VERSION OF PLANNING EXTRACT - CLONED FROM US PROGRAM              
*                                                                               
*    MAIN DIFFERENCES-                                                          
*                                                                               
*    1) BASE DEMO IS V2+ NOT HOMES                                              
*    2) RATING SERVICE MARKETS NOT USED, AGENCY MKT #'S USED INSTEAD            
*    3) NO MARKET POPS AVAILABLE, SO NO ALL-CANADA DCF'S POSSIBLE.              
*    4) MARKET TABLE IS BUILT DIRECTLY FROM AGENCY MKT FILE                     
*                                                                               
*    NOTE- A LOT OF CODE IS LEFT IN PLACE EVEN THOUGH IT MAY NOT BE             
*          STRICTLY NEEDED, JUST TO PRESERVE THE PROGRAM STRUCTURE              
*                                                                               
**********************************************************************          
SPPX02   CSECT                                                                  
...
*                                                                               
         OC    AMKTTAB,AMKTTAB     UNLESS HAVE ALREADY INITIALIZED              
         BNZ   REQF52              MARKET TABLE                                 
*                                  SET MARKET TABLE BINSRCH PARS                
         SR    R0,R0                                                            
         L     R1,=A(MKTTAB)                                                    
         SR    R2,R2                                                            
         LA    R3,MKLEN                                                         
...
ESTF2F   DS    0H                                                               
         ...
         USING PTBUFFD,R4                                                       
*                                                                               
         CLI   PTDEMO+2,127        FIRST DEMO MUST BE V2+                       
         BE    ESTF3                                                            
         MVC   P(33),=C'** FIRST DEMO IN MENU MUST BE V2+ **'                   
         GOTO1 REPORT                                                           
         GOTO1 AENDREQ                                                          
*                                                                               
ESTF3    DS    0H                                                               
...
*                                  ----------------                             
ESTF21   DS    0H                                                               
****     NOTE- CODE HERE TO BUILD MARKET TABLE                                  
****           AND SET MARKET/DEMO POPULATIONS                                  
****           HAS BEEN REMOVED. THE TABLE IS BUILD MARKET                      
****           BY MARKET AT MKTF AND THE POPS ARE LEFT AT ZERO.                 
*                                                                               
*                                  GET DEMO NAMES                               
ESTF24   DS    0H                                                               
         L     R2,NADEMS                                                        
...
*                                                                               
         LA    R1,DNAMES                                                        
         CLC   1(5,R1),=C'TOTAL'   CHANGE 'TOTAL' TO V2+                        
         BNE   *+10                                                             
         MVC   1(5,R1),=C'V2+  '                                                
ESTF25   DS    0H                                                               
...
STAL     DS    0H                                                               
         ...
         SPACE 2                                                                
*        MARKET FIRST                                                           
*        NOTE- IN CANADIAN VERSION, ADD MKT TO MKTTAB                           
*                                                                               
MKTF     DS    0H                                                               
         LA    RE,MW                                                            
         LA    RF,L'MW                                                          
         ...
         BNE   MKTF4                                                            
*                                                                               
         USING MKTTABD,R6          SET NEW MARKET DATA                          
         MVC   MKNAM,SPACES                                                     
         MVC   MKNAM(24),MKTNM                                                  
*                                                                               
         L     R6,AMKTTAB          AND SET EOL                                  
         LA    RF,MKLEN                                                         
         MH    RF,MKTCNT+2                                                      
         AR    RF,R6                                                            
         MVI   0(RF),X'FF'                                                      
...
DRVIN6B  DS    0H                                                               
         ...
         BNL   DRVIN8                                                           
         MVC   QTRNO,0(R2)                                                      
         LA    R3,1                START WITH DEM 1 (SKIP BASE)                 
*                                                                               
DRVIN7   DS    0H                                                               
         STC   R3,DEMNO                                                         
         MVI   GLMODE,GLINPUT                                                   
...
*                                                                               
         ...
         BL    DRVIN7              NOTE- DONT COUNT BASE                        
*                                                                               
DRVIN8   DS    0H                                                               
...
DLHEND   DS    0H                  END DATE                                     
         ...
         B     EXIT                                                             
*                                                                               
DLHNDEM  DS    0H                  NUMBER OF DEMOS (EXCLUDING BASE)             
         L     R1,NADEMS                                                        
         BCTR  R1,R0                                                            
         STC   R1,0(R3)                                                         
         B     EXIT                                                             
...
PRB6D    DS    0H                                                               
         ...
         LA    R4,1              **NOTE-DOES ONLY TOTAL QTR                     
*                                                                               
PRB8     DS    0H                                                               
         CH    R4,=Y(NQTRS-1)                                                   
         BH    PRB9                                                             
...
*                                                                               
PRBX     DS    0H                                                               
         B     EXIT              **PATCH TO PRINT MKT TRACE                     
*                                                                               
         L     R6,SVADMKT                                                       
         GOTO1 HEXOUT,DMCB,0(R6),P,MKLEN,=C'N'                                  
         B     EXIT                                                             
*                                                                               
         EJECT                                                                  
...
*                                                                               
         L     R0,MKDPIMP                                                       
         A     R0,MEDBY1       BASE IMPS - UNEQUIVALENCED                       
         ST    R0,MKDPIMP                                                       
...
MKDPSPT  DS    F                   SPOTS                                        
MKDPCST  DS    F                   COST                                         
MKDPIMP  DS    F                   BASE IMPS                                    
MKDPGRPS DS    XL(4*NDEMS)         GRPS - BASE FIRST                            
...
DBLKD    DSECT                                                                  
       ...
       ++INCLUDE DDLOGOD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018SPREPPX02C05/01/02'                                      
         END                                                                    
