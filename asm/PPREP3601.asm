*          DATA SET PPREP3601  AT LEVEL 019 AS OF 07/18/16                      
*PHASE PP3601A                                                                  
         TITLE 'PP3601  VENDOR SUMMARY SPECS'                                   
PP3601   CSECT                                                                  
         FSPEC READ,BUYS                                                        
         FSPEC GET,PUBS                                                         
         RSPEC REQUEST,REPORT                                                   
         RSPEC REQUEST,SUMMARY                                                  
         SPROG 0,1,2,3,4,5,10,11,12,13                                          
         PSPEC H1,1,MEDIANAME                                                   
         PSPEC H1,47,C'VENDOR SUMMARY'                                          
         PSPEC H1,76,AGYNAME                                                    
...
*                                                                               
         DC    C'REQLST='                                                       
         DC    X'0102040708090A0B0C0D0E0F13181400'                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019PPREP3601 07/18/16'                                      
         END                                                                    
