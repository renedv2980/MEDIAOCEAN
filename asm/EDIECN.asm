*          DATA SET EDIECN     AT LEVEL 035 AS OF 08/07/19                      
*PHASE EDIECNSB                                                                 
*INCLUDE ADDAY                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE DATCON                                                                 
...
SFX02    BRAS  RE,GETNXTL          GET NEXT LINE INTO R / RLEN                  
         BNE   SFX70               End of MQ message if not equal               
*                                                                               
...
*                                                                               
         ...
         MVC   ECNACC,DESTECNN     USE ECN ACC NUMBER                           
...
*                                                                               
         MVC   USERIDOV,USERID                                                  
*                                                                               
SFX08    L     R3,AMSGOUT          FIRST BUILD HEADER INFO FOR ECN              
         MVC   0(7,R3),=CL7'SIGNON '                                            
         MVC   7(8,R3),ECNACC                                                   
         MVI   15(R3),C' '                                                      
         AHI   R3,16                                                            
*                                                                               
...
*                                  CHECK THE 1ST DEST                           
         ...
         MVI   HDR+34,C'W'         SET WIDE REPORT                              
*                                                                               
SFX10    CLI   DEBUG,YES           DEBUG FORCES ALL TO REDILIST MQTEST          
         BNE   SFX12                                                            
...
*                                                                               
         ...
         B     SFX24                                                            
*                                                                               
SFX13    MVI   LONGFXPG,NO         ASSUME FAX PAGES AREN'T "LONG"               
         CLC   =C'FXKEY=',DSTAEDST IS DESTINATION A FAX RECORD KEY?             
         BE    SFX14                                                            
         CLC   =C'FXKYL=',DSTAEDST (FOR "LONG" FAX PAGES)                       
         BNE   SFX16                                                            
         MVI   LONGFXPG,YES        ECN MUST GENERATE "LONG" PAGES               
*                                                                               
...
SFX18    MVI   DSTTYPE,EDFDSTMQ    ASSUME IT'S A MAILBOX NUMBER                 
         ...
         BH    SFX20               NO - REDILIST NAME                           
         CLI   DSTAEDST,C'0'                                                    
         BNL   SFX24               YES - MAILBOX NUMBER                         
*                                                                               
SFX20    MVI   DSTTYPE,EDFDSTRQ    IT'S A REDILIST NAME                         
...
*                                                                               
         ...
         B     SFX24                                                            
*                                                                               
SFX22    OI    DSTAEFLG,DSTAEFJQ   FLAG THIS DEST AS JUNK                       
         B     SFX45               NEXT DEST                                    
*                                                                               
SFX24    CLI   SENDDLNS,YES        DO WE WANT DELIVERY NOTIFICATIONS?           
         BNE   SFX26                                                            
...
*                                                                               
         ...
         B     SFX34                                                            
*                                                                               
SFX27    L     RF,ATSTIDS          TABLE OF DDS TEST USERIDS                    
SFX28    CLI   0(RF),X'FF'                                                      
         BE    SFX28A                                                           
         CLC   USERID,0(RF)                                                     
         BE    SFX28E                                                           
...
SFX28B   CLI   0(RF),X'FF'                                                      
         ...
         B     SFX28B                                                           
*                                                                               
SFX28E   CLI   HDR+34,C'W'         WIDE REPORT?                                 
         BE    SFX28W                                                           
         MVC   00(04,R3),=C'FAX '  DDS USERID: USE OUR FAX NUMBER               
         MVC   04(11,R3),10(RF)                                                 
         AHI   R3,15                                                            
         B     SFX34                                                            
*                                                                               
SFX28W   MVC   00(05,R3),=C'FAXW ' DDS USERID: USE OUR FAX NUMBER               
         MVC   05(11,R3),10(RF)                                                 
         AHI   R3,16                                                            
         B     SFX34                                                            
*                                                                               
SFX30    MVC   00(25,R3),DSTAEDST  DESTINATION                                  
         LA    RF,25(R3)                                                        
         LHI   R0,25                                                            
SFX32    CLI   0(RF),C'.'          REPLACE . BY - (ECN CAN'T HANDLE)            
         BNE   *+8                                                              
         MVI   0(RF),C'-'                                                       
         BCTR  RF,0                                                             
         BCT   R0,SFX32                                                         
...
*                                                                               
         ...
         OC    TRNLEN,TRNLEN       TRN CARD INPUT?                              
         BZ    *+10                NO                                           
         MVC   0(1,R3),TRN+6       1 CHAR SYSTEM CODE                           
         AHI   R3,1                                                             
*                                                                               
* LOOK FOR MORE DESTINATIONS                                                    
*                                                                               
SFX45    TM    DSTAEFLG,DSTAEFJQ   JUNK DEST?                                   
         BO    SFX46               YES                                          
...
*                                                                               
*        Move in rest of MQ message into buffer                                 
*                                                                               
SFX55    BRAS  RE,GETNXTL          GET NEXT LINE INTO R / RLEN                  
         BNE   SFX70               End of MQ message                            
         CLI   SKIPBXF,YES                                                      
         BE    SFX55                                                            
         ...
         B     SFX55                                                            
*                                                                               
SFX56    LR    RF,R3               MAKE SURE WE CAN FIT MORE DATA               
         AH    RF,RLEN                                                          
...
SFX65    CLI   R,X'19'             TRIPLE SPACE                                 
         ...
         BRAS  RE,ADDCRLF                                                       
*                                                                               
SFX68    CLI   R,X'11'             DOUBLE SPACE                                 
         BNE   SFX55                                                            
         BRAS  RE,ADDCRLF                                                       
         B     SFX55                                                            
*                                                                               
SFX70    CLI   GOTDATA,YES         EMPTY FAX?                                   
         BNE   NODATA              YES - SKIP THIS                              
*                                                                               
         MVC   0(4,R3),=CL4'MMMM'  END OF MESSAGE BLOCK                         
         AHI   R3,4                                                             
         BRAS  RE,ADDCRLF                                                       
         BRAS  RE,LINESUP                                                       
*                                                                               
...
*                                                                               
         ...
         B     EXITOK                                                           
*                                                                               
TOOJREP  WTO   'EDIECN - TOO MANY JUNK REPORTS, PLEASE RECYCLE THIS JOB+        
               .'                                                               
         DC    H'0'                                                             
*                                                                               
CANTSEND GOTO1 VLOGIO,DMCB,X'FF000001',=C'EDIECN - Error sending to ENC+        
               - Transmissions suspended, please check'                         
         ABEND 701                                                              
*                                                                               
TOOBIG   GOTO1 VLOGIO,DMCB,X'FF000001',=C'EDIECN - Report is too big to+        
...
*                                                                               
         ...
         S     R0,AMSGIN                                                        
         C     R0,DATALEN          Length of full message                       
         BNL   EXITL               End of message                               
*                                                                               
...
*                                                                               
         ...
         MVCL  R0,RE                                                            
*                                                                               
         CLI   HDR+34,C'L'         TREAT LANDSCAPE/WIDE THE SAME                
         BNE   *+8                   UNTIL ECN IS READY, YYUN,3/17/08           
         MVI   HDR+34,C'W'                                                      
*                                                                               
         B     EXITR7              CONTINUE                                     
         DROP  R7                                                               
...
*                                                                               
         ...
         MVC   DESTECNN,EDIECNN    ECN ACC NUMBER                               
...
QMGRQ    DC    CL48'MQ7Q'                                                       
*                                                                               
QINPUTA  DC    CL48'DDS.ECNFAX.ADV.LOCALQ'                                      
QINPUTR  DC    CL48'DDS.ECNFAX.REP.LOCALQ'                                      
QINPUTT  DC    CL48'DDS.ECNFAX.TST.LOCALQ'                                      
QINPUTQ  DC    CL48'DDS.ECNFAX.FQA.LOCALQ'                                      
*                                                                               
QOUTPUTA DC    CL48'ECNFAX.ADV.QUEUE'                                           
QOUTPUTR DC    CL48'ECNFAX.REP.QUEUE'                                           
QOUTPUTT DC    CL48'ECNFAX.TST.QUEUE'                                           
QOUTPUTQ DC    CL48'ECNFAX.FQA.QUEUE'                                           
*                                                                               
QLOGA    DC    CL48'MQ1P.ECNFAX.ADV.ALIASQ'                                     
QLOGR    DC    CL48'MQ1P.ECNFAX.REP.ALIASQ'                                     
QLOGT    DC    CL48'DDS.EDICT.STATUS.QUEUE'                                     
QLOGQ    DC    CL48'DDS.EDICT.STATUS.QUEUE'                                     
*QLOGQ    DC    CL48'DDS.EDICTQ.ETI.TEST.QUEUE'                                 
*QLOGT    DC    CL48'DDS.EDICTT.ETI.TEST.QUEUE'                                 
         EJECT                                                                  
***********************************************************************         
...
DRTEST   DC    AL1(NO)                                                          
DEBUG    DC    AL1(NO)                                                          
SENDDLNS DC    AL1(YES)            'Y' IF WE WANT DLNS FROM ECN                 
...
SMSG30   DC    CL50'XECN -- Transmissions suspended (MQ issue)     '            
...
AGYNAME  DS    CL33                                                             
AGYADDR  DS    CL33                                                             
ECNDATA  DS    XL21                ECN-SPECIFIC TRANSFER DATA                   
...
DESTECNN DS    CL8                 ADV ECN MAILBOX NUMBER                       
...
* IHAPSA                                                                        
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035EDIECN    08/07/19'                                      
         END                                                                    
