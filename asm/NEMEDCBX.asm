*          DATA SET NEMEDCBX   AT LEVEL 025 AS OF 05/01/02                      
*          DATA SET NEMEDCB    AT LEVEL 030 AS OF 11/24/99                      
*PHASE T31ECBA,*                                                                
*INCLUDE CLUNPK                                                                 
*INCLUDE NETNET                                                                 
*INCLUDE COVAIL                                                                 
...
*                              VALIDATED IN EDIT MODULE                         
         GOTO1 =A(CHKPU),DMCB,(RC)             SKIP THIS CLIENT?                
         BNE   LR10                            NO                               
         CLC   =C'ALL',NBSELCLI               .. YES/IF CLI NOT=ALL             
         BNE   EXIT                           .. EXIT                           
...
*                                  CHK PU PROFILE SAYS SKIP CLIENT?             
         ...
         BNE   *+12                                                             
         MVI   NBFUNCT,NBFNXCLT    FIND NEXT CLT                                
         B     LR10                                                             
********************************************************************            
...
NET100   SR    R3,R3              ADD NET BILLED TO CLIENT TOTS                 
         ...
         BAS   RE,GETEL                                                         
         BNE   NET101                                                           
NET100B  TM    NUBILST,X'F0'       REVERSED/UNBILLED?                           
...
*        GET STORAGE FOR DISK ADDRESSES                                         
         ...
         AHI   R3,-4                                                            
         AHI   RE,4                                                             
         ST    RE,ADISKSV          ADDRESS OF DISK SAVE AREA                    
         XCEF  (RE),(R3)                                                        
**********************************                                              
...
*8       EDIT  (P8,16(R2)),(15,66(R3)),2,MINUS=YES UNTBILL2                     
*****                                                                           
...
*                                                                               
         ...
         L     R3,DATAMGR                                                       
         GOTO1 GETPROF,DMCB,KEY,WORK,(R3)                                       
         CLI   WORK+3,C'Y'         SKIP THIS CLIENT?                            
         BNE   CHKPUX                                                           
...
BILLRECD DSECT                                                                  
       ...
       ++INCLUDE NEGENPACK                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025NEMEDCBX  05/01/02'                                      
         END                                                                    
