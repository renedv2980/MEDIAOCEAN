*          DATA SET CTCONVJIM  AT LEVEL 112 AS OF 05/01/02                      
*PHASE CONVJIM                                                                  
*INCLUDE DMDMGRL                                                                
*INCLUDE DMUTLCT                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE HEXOUT                                                                 
*INCLUDE GETFACT                                                                
         TITLE 'CONVJIM - JOMU TEST CONTROL FILE OFFLINE PROGRAM'               
CONVJIM  CSECT                                                                  
         PRINT NOGEN                                                            
...
CONV26   MVC   IDNUM,2(R3)                                                      
         ...
         BE    CONV20A                                                          
         MVI   PRIFLAG,1                                                        
         MVC   P+20(19),=C'AUTH NUMBER MISSING'                                 
         B     CONV20B                                                          
CONV20A  MVC   P+20(17),=C'AUTH NUMBER FOUND'                                   
CONV20B  GOTO1 VHEXOUT,PARM,IDNUM,P+42,2,=C'TOG'                                
*                                                                               
...
WORKC    CSECT                     ** WORKING STORAGE POOL **                   
         DS    (64*1024)X                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'112CTCONVJIM 05/01/02'                                      
         END                                                                    
