*          DATA SET CTXCT00    AT LEVEL 001 AS OF 03/07/08                      
*PHASE TA0700A                                                                  
         TITLE 'CTXCT00 - TRANSFER CONTROL PROGRAM'                             
CTXCT    CSECT                                                                  
         PRINT NOGEN                                                            
...
OK0      LA    R1,=CL60'TEST COMPLETE - FIRST XCTL ELEMENT SHOWN'               
         B     OKX                                                              
OK1      LA    R1,=CL60'CON/XCT RETURNED FROM PER/XCT - ORIGINAL'               
         B     OKX                                                              
OK2      LA    R1,=CL60'CON/XCT WAS CALLED BY PER/XCT'                          
         B     OKX                                                              
OK3      LA    R1,=CL60'CON/XCT RETURNED FROM PER/XCT - RETURNED'               
         B     OKX                                                              
OK4      LA    R1,=CL60'CON/XCT CALLED PER/XCT'                                 
         B     OKX                                                              
OK5      LA    R1,=CL60'CON/XCT RETURNING TO PER/XCT'                           
         B     OKX                                                              
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001CTXCT00   03/07/08'                                      
         END                                                                    
