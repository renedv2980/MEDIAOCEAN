*          DATA SET SPREPLO02  AT LEVEL 018 AS OF 01/20/15                      
*PHASE SPLO02A                                                                  
*INCLUDE SPBVAL                                                                 
*INCLUDE SPFMTINO                                                               
*INCLUDE BINSRCH2                                                               
...
*INCLUDE GETUSER                                                                
*                                                                               
         TITLE 'SPLO02 - CHANGE LOG'                                            
*                                                                               
*                                                                               
         TITLE 'SPLO02 - SPOTPAK L''OREAL INTERFACE'                            
*                                                                               
*                                                                               
...
*                                                                               
         ...
         USING BILLREC,RF                                                       
*                                                                               
*        CHECK BELOW REMOVED OCT12/10 BY THEIR REQUEST                          
*                                                                               
**NO-OP  TM    BILSTAT,BSTMANQ     ONLY PROCESS MANUAL BILLS                    
**NO-OP  BNO   EXIT                                                             
*                                                                               
         CLC   BKEYINV,LOWINV                                                   
         BL    EXIT                                                             
...
*                                                                               
         ...
         MVC    PPGIDATE+2(4),WORK+4   MMDD                                     
         MVC    PPGIDATE(2),WORK+2   YY  (LAST PART OF YYYY)                    
*                                                                               
...
*                                                                               
*                                                                               
*        SKIP CHECK FOR PO# - BY THEIR REQUEST OCT12/10                         
*        SKIP CHECK FOR LINE ITEM # - BY THEIR REQUEST OCT12/10                 
*        TICKET # 0294538N                                                      
*                                                                               
         B      POST4         SKIP EST USER CHECKS                              
*                                                                               
         CLC    PPGEU1,SPACES                                                   
         BH     POST2                                                           
         MVC    P+3(43),=C'*** ESTIMATE USER1 INCORRECT OR MISSING ***'         
...
*                                                                               
         GOTO1 VGETUSER,DMCB,(C'S',ADCLT),(C'E',ADEST),(0,EEUSER1),(0,EX        
               EUSER2)                                                          
*                                                                               
*        SKIP CHECK FOR PO# - BY THEIR REQUEST OCT12/10                         
*        SKIP CHECK FOR LINE ITEM # - BY THEIR REQUEST OCT12/10                 
*        TICKET # 0294538N                                                      
*                                                                               
**NO-OP  CLC   EEUSER1(4),=C'PO #'                                              
**NO-OP  BE    *+8                                                              
**NO-OP  OI    ERRORSW,X'01'                                                    
**NO-OP  CLC   EEUSER1+21(4),SPACES                                             
**NO-OP  BH    *+8                                                              
**NO-OP  OI    ERRORSW,X'01'                                                    
*                                                                               
**NO-OP  CLC   EEUSER2(11),=C'LINE ITEM #'                                      
**NO-OP  BE    *+8                                                              
**NO-OP  OI    ERRORSW,X'02'                                                    
**NO-OP  CLC   EEUSER2+21(4),SPACES                                             
**NO-OP  BH    *+8                                                              
**NO-OP  OI    ERRORSW,X'02'                                                    
*                                                                               
PRB05    DS    0H                                                               
...
*                                                                               
         MVC   HEAD1+59(24),=C'NETPAK L''OREAL INTERFACE'                       
         MVC   HEAD2+59(24),=C'------------------------'                        
*                                                                               
         CLI   NETPAKSW,C'Y'                                                    
         BE    PRNT1                                                            
*                                                                               
*                                                                               
         MVC   HEAD1+58(27),=C'SPOTPAK L''OREAL INTERFACE  '                    
         MVC   HEAD2+58(27),=C'-------------------------   '                    
*                                                                               
PRNT1    DS    0H                                                               
         MVI   RCSUBPRG,0                                                       
...
BLRDATD  EQU   BLRDAT-BLINE                                                     
       ...
       ++INCLUDE SPREPWORKD                                                     
         ORG   QAREA+49                                                         
QINVNO1  DS    CL4                 START INVOICE NUMBER                         
QINVNO2  DS    CL4                 END INVOICE NUMBER                           
         ORG                                                                    
         EJECT                                                                  
CLTHDRD  DSECT                                                                  
       ++INCLUDE SPGENCLT                                                       
...
*                                                                               
       ++INCLUDE DDOFFICED                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018SPREPLO02 01/20/15'                                      
         END                                                                    
