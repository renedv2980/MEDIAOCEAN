*          DATA SET SPREPFXAN4 AT LEVEL 002 AS OF 01/04/00                      
*PHASE SPFX025                                                                  
         TITLE 'SPFX02 - LOOK FOR BUYS WITH BAD REGEL DATE'                     
SPFX02   CSECT                                                                  
         DS    4096C                                                            
         ORG   *-4096                                                           
         PRINT NOGEN                                                            
...
PB12     IC    R0,1(R6)                                                         
         ...
         B     PB10                                                             
*                                                                               
PB20     TM    3(R6),X'1F'         BAD DAY IN COMPRESSED DATE?                  
         BNZ   PB12                                                             
         BAS   RE,PRTBUY                                                        
*                                                                               
PBX      B     EXIT                                                             
...
*                                                                               
       ...
       ++INCLUDE SPREPWORKD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002SPREPFXAN401/04/00'                                      
         END                                                                    
