*          DATA SET ACCLB44B   AT LEVEL 058 AS OF 12/23/99                      
*PHASE T62144B                                                                  
*&&      SET   NOP=N                                                            
...
POST04   DS    0H                                                               
         ...
         CLI   FHILD(RF),0                                                      
         BNE   POST05                                                           
POST04A  XC    PBTYPES,TYPTYPES    NO - TURN OFF BIT                            
         B     POST08                                                           
*                                                                               
POST05   OC    PBACURS,PBACURS                                                  
         BNZ   *+10                                                             
         MVC   PBACURS,PBAREFH                                                  
         ...
         BNE   POSTN                                                            
*                                                                               
POST06   CLI   PBMODE,PBVALQ       TEST ONLY VALIDATING                         
         BE    POST08                                                           
         ...
         BO    POST07              (MAY BE ADVANCE ONLY BILL)                   
         MVC   FVMSGNO,=AL2(AE$YHDAY)                                           
         MVC   FVADDR,PBAREFH                                                   
         B     POSTN                                                            
*                                                                               
POST07   CLI   TYPTYPES,PBBILQ                                                  
         BE    POST08                                                           
...
*                                                                               
         ...
         BO    POST10              YES - JOURNAL OPENED IN ACCLB1F              
         GOTO1 AOPNJRN             OPEN JOURNAL                                 
         BNE   POSTN                                                            
*                                                                               
POST10   L     R2,ATYPLST          CALL UPDATE ROUTINE(S)                       
         USING TYPLSTD,R2                                                       
POST12   MVC   BCBYTE1,TYPTYPES                                                 
         NC    BCBYTE1,PBTYPES                                                  
         BZ    POST28                                                           
         XR    R3,R3                                                            
         LH    R3,TYPPBLK                                                       
...
*                                                                               
         ...
         LA    R4,PBMNTHS                                                       
         USING PBMNTHSD,R4                                                      
POST16   CLC   PBMREF(L'PBMREF+L'PBMMP),PBREF                                   
         BE    POST18                                                           
         GOTO1 AADDOBH,BCPARM,(TYPBTYP,PBMREF),0                                
POST18   LA    R4,PBMNTHSL(R4)                                                  
         BCT   R0,POST16                                                        
         B     POST28                                                           
         DROP  R4                                                               
*                                  SPECIAL CODE FOR US W/OS AND RECS.           
POST20   LA    RE,PBIWOFC          ADD BATCH HEADER FOR COST                    
         CLI   TYPTYPES,PBRECQ                                                  
         BNE   *+8                                                              
         LA    RE,PBIRECC                                                       
         EX    RE,*+8                                                           
         ...
         GOTO1 AADDOBH,BCPARM,(TYPBTYP,PBREF),0                                 
*                                                                               
POST24   LA    RE,PBIWOFT          ADD BATCH HEADER FOR TIME                    
         CLI   TYPTYPES,PBRECQ                                                  
         BNE   *+8                                                              
         LA    RE,PBIRECT                                                       
         EX    RE,*+8                                                           
...
*                                                                               
POST28   LA    R2,TYPLSTL(R2)                                                   
         CLI   TYPLSTD,EOT                                                      
         BNE   POST12                                                           
         DROP  R2,R3                                                            
*                                                                               
POST30   GOTO1 ACLOJRN             CLOSE JOURNAL                                
         BNE   POSTN                                                            
*                                                                               
         TM    PBTYPES,PBBILQ      TEST BILLING                                 
         BZ    POST32                                                           
...
*                                                                               
         ...
         DC    H'0'                                                             
         L     RE,BCPARM+16                                                     
POST34   MVC   GDADATE,BCTODAYP    SET NEW LAST BILLED DATE                     
         DROP  RE                                                               
*                                                                               
...
*                                                                               
         ...
         XR    R1,R1                                                            
         MVCL  RE,R0                                                            
         LA    RF,O#BILPRT         OLD STYLE BILL PRINTING                      
         TM    BCINDS1,BCPCBILL    TEST BEDRECD FOUND                           
*        BO    POSTY                                                            
         BNO   *+8                                                              
         LA    RF,OC#BEPRT         LOAD UP NEW PRINTING PHASE                   
         GOTO1 VCOLY,BODMCB,((RF),0),0,0                                        
         L     RF,0(R1)                                                         
...
* ACCLBCOLS                                                                     
       ++INCLUDE ACCLBCOLS                                                      
         SPACE 1                                                                
CLB44    CSECT                     ALLOW EASIER RE-LOAD OF PHASE                
         ORG   CLB44+(((*-CLB44)/512)+1)*512                                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058ACCLB44B  12/23/99'                                      
         END                                                                    
