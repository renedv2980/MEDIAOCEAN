*          DATA SET SPSFM6C    AT LEVEL 029 AS OF 05/12/10                      
*PHASE T2176CA                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
*  TITLE:        T2176C  -- BILL FORMULA RECORDS MAINTENANCE          *         
*                                                                     *         
...
*                                                                     *         
*  INPUTS:       SCREENS SCSFM4E(MAINT), AND SCSFM4F(LIST)            *         
*                                                                     *         
...
*                                                                               
         ...
         USING  BFKEY,R6                                                        
*                                                                               
         MVC   BYTE,BFKAGYMD         ISOLATE MEDIA CODE                         
         NI    BYTE,X'0F'                                                       
...
DK55     DS    0H                                                               
         EDIT  (B2,BFKMKT),(4,BFRMKT),FILL=0                                    
         MVI   BFRMKTH+5,4                                                      
         OI    BFRMKTH+4,X'08'                                                  
         OI    BFRMKTH+6,X'80'                                                  
*                                                                               
...
*                                                                               
LR30     OC    BFKMGR,BFKMGR                                                    
         BNZ   *+14                                                             
         MVC   LSTMKT,=C'ALL '                                                  
         B     LR40                                                             
                                                                                
         EDIT  (B2,BFKMKT),(4,LSTMKT),FILL=0                                    
*                                                                               
*                                                                               
LR40     L     R6,AIO                                                           
         MVI   ELCODE,BFRCDELQ                                                  
...
CLTHDRD  DSECT                                                                  
       ...
       ++INCLUDE DDPERVALD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029SPSFM6C   05/12/10'                                      
         END                                                                    
