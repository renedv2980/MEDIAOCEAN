*          DATA SET REREP3402  AT LEVEL 161 AS OF 05/01/02                      
*          DATA SET REREP3402  AT LEVEL 153 AS OF 05/03/00                      
*PHASE RE3402B,*                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
...
*                                                                   *           
* DEC28/00 (SKU) --- EXPAND OFFICE LIST TABLE SPACE SOMEMORE        *           
*                     ***  END TOMBSTONE  ***                     *             
*******************************************************************             
*                                                                               
RE3402   CSECT                                                                  
...
MASTD    DSECT                                                                  
       ...
       ++INCLUDE REGENREQ3                                                      
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'161REREP3402 05/01/02'                                      
         END                                                                    
