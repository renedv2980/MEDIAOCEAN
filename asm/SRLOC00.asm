*          DATA SET SRLOC00    AT LEVEL 016 AS OF 03/02/18                      
*PHASE T15C00A                                                                  
         PRINT NOGEN                                                            
...
LOCDISP  NTR1  ,                                                                
         ...
         EJECT                                                                  
***********************************************************************         
* DISPLAY ENTRIES FROM DATASPACE                                      *         
* NTRY: BYTE   = TYPE (SOON/LOCKET)                                   *         
***********************************************************************         
         SPACE 1                                                                
TABNTRY  NTR1  ,                                                                
         LA    R3,SRVSACTH                                                      
...
*                                                                               
         ...
         LA    R2,UPDTABS                                                       
*                                                                               
DSP      USING UPDTABD,R6                                                       
LCL      USING UPDTABD,R2                                                       
TBD02    LAM   AR0,ARF,ARZERO      OVERKILL - BETTER SAFE THAN SORRY            
         LAM   AR6,AR6,ALET                                                     
         SAC   512                                                              
*                                                                               
         CLC   BYTE,DSP.UPDTABT    SEE IF OUR KIND OF ENTRY                     
         BNE   TBD14               NO                                           
*                                                                               
         LH    R1,COUNT                                                         
         AHI   R1,1                                                             
         STH   R1,COUNT                                                         
*                                                                               
         CLC   COUNT,SVSEQ         REACHED OUR START POINT YET?                 
         BL    TBD14               NO                                           
*                                                                               
         LA    R1,SRVXXXH          WILL THIS ONE FIT ON THE SCREEN?             
         CR    R3,R1                                                            
         BE    TBD16               NO MORE ROOM                                 
*                                                                               
         MVC   LCL.UPDTABT(UPDTABL),DSP.UPDTABT                                 
         SAC   0                                                                
         LAM   AR6,AR6,ARZERO      FROM NOW ON USE LOCAL COPY                   
*                                                                               
...
*                                                                               
         USING USRLINE,R3                                                       
         CLI   BYTE,UPDTLQ     *** LOCKET TYPE LOCK?                            
         BNE   TBD06               NO                                           
*                                                                               
         LA    R0,LCL.UPDLDATE                                                  
...
*                                                                               
         ...
         IC    RF,LCL.UPDLFAC                                                   
*                                                                               
         L     RE,ASSB             GET A(FACIDTAB) FROM SSB                     
...
*                                                                               
         USING FACLINE,R3                                                       
TBD06    CLI   BYTE,UPDTSQ     *** SOON TYPE ENTRY?                             
         BNE   TBD10               NO                                           
*                                                                               
         CURED COUNT,(3,FLNUM),0,ALIGN=LEFT                                     
*                                                                               
         CLC   SAVUSER,LCL.UPDUSR                                               
         MVC   SAVUSER,LCL.UPDUSR                                               
         BE    TBD08               SAME USER AS LAST TIME                       
*                                                                               
         BRAS  RE,GETUSR                                                        
         MVC   FLUSERID,USERID     DISPLAY USER ID                              
*                                                                               
TBD08    MVC   FLREPID(3),LCL.UPDRID   DISPLAY REPORT ID                        
         MVI   FLREPID+3,C','                                                   
         CURED LCL.UPDSEQ,(5,FLREPID+3),0,ALIGN=LEFT,ZERO=NOBLANK               
         CURED LCL.UPDCHAIN,(2,FLQUEUE),0                                       
         ...
         B     TBD12                                                            
*                                                                               
TBD10    DC    H'0'                WHAT KIND OF ENTRY ARE YOU THEN?             
*                                                                               
TBD12    AHI   R3,L'RLINE          NEXT LINE                                    
         AHI   R2,UPDTABL                                                       
*                                                                               
TBD14    BXLE  R6,R4,TBD02         NEXT                                         
         XC    SVSEQ,SVSEQ                                                      
         OC    COUNT,COUNT         NOTHING TO DISPLAY                           
         BZ    ERR8                                                             
         XC    COUNT,COUNT                                                      
         MVC   INFONUM,INFO2       ALL LOCK ENTRIES DISPLAYED                   
         B     TBD18                                                            
*                                                                               
TBD16    MVC   INFONUM,INFO4       SET 'ENTER FOR NEXT' MESSAGE                 
*                                                                               
TBD18    CLI   BYTE,UPDTSQ                                                      
         BNE   *+10                                                             
         MVC   INFONUM,INFO1       SET INFO MSG                                 
*                                                                               
         SAC   0                   MAKE SURE WE EXIT CLEAN                      
         LAM   AR0,ARF,ARZERO                                                   
         MVC   SVSEQ,COUNT                                                      
         B     EXITOK                                                           
         DROP  R3,LCL,DSP                                                       
...
LKQBIT   NTR1  ,                                                                
         ...
         SLL   R2,6                                                             
         SAC   512                                                              
         MVC   BYTE,DSPUSER-DMSPACED(R2)                                        
         SAC   0                                                                
         LAM   AR2,AR2,ARZERO                                                   
*                                                                               
         CLI   BYTE,X'FF'          THIS IS X'FF' IF LOCKING INHIBITED           
         BE    EXITL                                                            
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
...
TABLOCK  NTR1  ,                                                                
         ...
         GOTO1 ALOCKSPC,DUB        LOCK TABLE                                   
         LAM   AR0,ARF,ARZERO      DON'T TRUST LOCKSPC                          
*                                                                               
         MVI   LKFLAG,C'Y'         FLAG THAT I LOCKED TABLE                     
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
* FREE TABLE                                                          *         
***********************************************************************         
         SPACE 1                                                                
TABFREE  NTR1  ,                                                                
         CLI   LKFLAG,C'Y'         FLAG THAT I LOCKED TABLE                     
         BNE   EXITOK                                                           
*                                                                               
         XC    DUB,DUB                                                          
         MVC   DUB(4),=AL4(DTLOCKET)                                            
         MVI   DUB,X'10'                                                        
         GOTO1 ALOCKSPC,DUB        FREE TABLE                                   
         LAM   AR0,ARF,ARZERO      DON'T TRUST LOCKSPC                          
*                                                                               
         MVI   LKFLAG,C'N'         FLAG THAT I UNLOCKED TABLE                   
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
         ...
         DROP  RF                                                               
*                                                                               
INIT02   LAM   AR0,ARF,ARZERO      DSPACE UPDATE TABLE                          
         LAM   AR2,AR2,ALET                                                     
         ICM   R2,15,=AL4(DTLOCKET)                                             
         N     R2,=XL4'00000FFF'                                                
         SLL   R2,6                                                             
...
*                                                                               
         ...
         STCM  R1,7,TODAY                                                       
*                                                                               
         GOTO1 ADMGR,DMCB,(0,=CL8'FILTAB'),0                                    
         MVC   AFILTAB,DMCB+4                                                   
*                                                                               
         B     EXITOK                                                           
         EJECT                                                                  
...
ARZERO   DC    16F'0'                                                           
         EJECT                                                                  
*                                                                               
* R2 EXPECTED TO ADDRESS UPDTAB ENTRY                                           
TRACEUNL NTR1  BASE=*,LABEL=*                                                   
         USING UPDTABD,R2                                                       
*                                                                               
         MVC   MSG,SPACES                                                       
         LA    R3,MSG                                                           
...
*                                                                               
         ...
         MVC   0(L'TCBSYM,R3),TCBSYM-TCBD(R1)                                   
         LA    R3,L'TCBSYM+1(R3)                                                
*                                                                               
         MVC   0(12,R3),=CL12'REMOVED LOCK'                                     
         LA    R3,12+1(R3)                                                      
*                                                                               
         MVC   LKSYSSE,UPDLTSE                                                  
         BRAS  RE,GETSYS           GET SYSTEM NAME                              
         MVC   0(L'LKSYSN,R3),LKSYSN                                            
         LA    R3,L'LKSYSN+1(R3)                                                
*                                                                               
         MVC   0(L'UPDLTAG,R3),UPDLTAG                                          
         LA    R3,L'UPDLTAG+1(R3)                                               
*                                                                               
         MVC   0(L'UPDLTYP,R3),UPDLTYP                                          
         LA    R3,L'UPDLTYP+1(R3)                                               
*                                                                               
         MVC   0(L'UPDLKEY,R3),UPDLKEY                                          
         OC    0(L'UPDLKEY,R3),SPACES                                           
         LA    R3,L'UPDLKEY+1(R3)                                               
*                                                                               
         LA    R0,MSG                                                           
         SR    R3,R0                                                            
*                                                                               
         GOTO1 ATICTOC,DUB,C'SSET' SUSPEND TIMERS                               
         GOTO1 ADMOD000,DMCB,AWCTYPE,MSG,(R3),C'LVL1'                           
...
KEY      DS    XL25                                                             
*                                                                               
COUNT    DS    H                   USED AS A COUNTER                            
COUNT1   DS    H                   USED AS A COUNTER                            
*                                                                               
...
SVSEQ    DS    H                   SEQ NUM FOR SCROLLING                        
PREVCTK  DS    CL25                PREVIOUS LAST KEY DISPLAYED                  
PREVSEQ  DS    H                   PREVIOUS SEQ NUM FOR SCROLLING               
SAVEDL   EQU   *-SAVEDSTR                                                       
         EJECT                                                                  
***********************************************************************         
...
* FACIDTABD                                                                     
       ...
       ++INCLUDE FACIDTABD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016SRLOC00   03/02/18'                                      
         END                                                                    
