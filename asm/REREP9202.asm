*          DATA SET REREP9202  AT LEVEL 056 AS OF 04/22/15                      
*PHASE RE9202A,*                                                                
*INCLUDE SORTER                                                                 
...
PC315    BAS   RE,DOAGYSUB                                                      
         BAS   RE,DOREPSUB                                                      
         MVI   FORCEHED,C'Y'                                                    
         MVC   PAGE,=X'0001'       START PG COUNT OVER FOR NEW REP              
         BAS   RE,LOCALREP                                                      
         B     PC350                                                            
*                                                                               
PC320    DS    0H                                                               
...
*                                                                               
       ...
       ++INCLUDE REPFACSQ                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'056REREP9202 04/22/15'                                      
         END                                                                    
