*          DATA SET NEPUP24    AT LEVEL 023 AS OF 05/01/02                      
*          DATA SET NEPUP24    AT LEVEL 009 AS OF 07/11/90                      
*PHASE T32224A,*                                                                
...
*                                                                               
         ...
         MVC   0(34,R2),=C'***ERROR TOO MANY PLANS 115=MAX***'                  
         GOTO1 SPOOL,DMCB,(R8)                                                  
...
PH2B     CLI   DEMNMSV,0           IS IT FIRST PLAN                             
         BNE   PH2C                NO                                           
         CLI   OVERIDE,C'Y'        YES/..IS DEMO OVERRIDE ON                    
         BE    PH2C                    ..YES                                    
         MVC   DEMNMSV,NDEMOS          ..NO/SAVE 1ST PLAN'S DEMOS               
         MVC   DEMOSV,DEMOS                                                     
         MVC   TRGNMSV,TARGNAME                                                 
         BAS   RE,DEMONM           PUTS DEMO NAMES INTO DEMNAMES                
         B     PUPX                                                             
PH2C     MVC   NDEMOS,DEMNMSV      NO/SO SET SAVED DEMOS                        
         MVC   DEMOS,DEMOSV                                                     
...
*                                                                               
         ...
         LA    R2,DEMOSV                                                        
         ZIC   R5,DEMNMSV                                                       
PST3C    MVC   LENGTH,REQLEN                                                    
PST4     LA    R4,DEMOSV           MATCH CURRENT DEMO AGAINST DEM LIST          
         ZIC   R0,DEMNMSV                                                       
PST5     LA    R3,40(R3)                                                        
         CLC   0(3,R4),0(R2)       IS IT A MATCH                                
         BE    PST8                                                             
         LA    R4,3(R4)                                                         
         BCT   R0,PST5                                                          
         B     PST10               DEMO NOT IN DEMOSV LIST                      
*                                                                               
PST8     MVC   GDDEMO,0(R2)                                                     
*PST8     MVC   GDDEMO,2(R2)                                                    
         GOTO1 VGETDEM                                                          
         L     R1,GDEGRP           GRPS                                         
         A     R1,QGRPS                                                         
         ST    R1,QGRPS                                                         
*****    GOTO1 =V(PRNTBL),DMCB,=C'ADJP',PLANADJP,C'DUMP',4,=C'1D'               
         L     R1,GDEIMP           IMPS                                         
         A     R1,QIMPS                                                         
         ST    R1,QIMPS                                                         
PST10    LA    R2,3(R2)            BUMP DEMO                                    
         L     R3,AQUARTER         RESET TO START OF QUARTER                    
         BCT   R5,PST4                                                          
PSTX     B     XIT                                                              
         EJECT                                                                  
*                                                                               
...
HOOK     NTR1                                                                   
         ...
         MVC   WORK(40),TITLE                                                   
         B     *+10                                                             
HOOK1    MVC   WORK(40),=CL40'DEMO SUMMARY BY QUARTER'                          
         SPACE 1                                                                
HOOK2    GOTO1 CENTER,DMCB,WORK,40                                              
         ...
         CLI   N2PROF,0                                                         
         BNE   *+10                                                             
         MVC   WORK(40),=CL40'(RAW EQUIVALENCY)'                                
         CLI   N2PROF,30                                                        
         BNE   *+10                                                             
         MVC   WORK(40),=CL40'(30 SEC EQUIVALENCY)'                             
         CLI   N2PROF,60                                                        
         BNE   *+10                                                             
         MVC   WORK(40),=CL40'(60 SEC EQUIVALENCY)'                             
...
TITLE    DS    CL40                                                             
QTITLE   DS    CL1                                                              
PLANSAVE DS    CL2300               FOR 115 PLANS OF 20CL EACH                  
         DS    0F                                                               
...
*                                                                               
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023NEPUP24   05/01/02'                                      
         END                                                                    
