*          DATA SET PPREPIN01  AT LEVEL 001 AS OF 03/05/14                      
*PHASE PPIN01A,+0                                                               
         TITLE 'PPIN01 - PRINTPAK NISSAN SPECS'                                 
PPIN01   CSECT                                                                  
         PRINT NOGEN                                                            
         SPACE 2                                                                
         FSPEC READ,BILLS                                                       
         ...
         SPROG 0,50                                                             
         PSPEC H1,1,MEDIA                                                       
         PSPEC H1,55,C'PRINTPAK NISSAN INTERFACE'                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001PPREPIN01 03/05/14'                                      
         END                                                                    
