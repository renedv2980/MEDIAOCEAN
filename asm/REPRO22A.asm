*          DATA SET REPRO22A   AT LEVEL 024 AS OF 05/01/02                      
*&&      SET   NOP=N                                                            
*PHASE T80A22A                                                                  
...
******************************                                                  
DTADD    EQU   C'A'                ADD DATA SCREEN                              
*TADD    EQU   C'X'                ADD DATA SCREEN                              
...
*--------------------------*                                                    
         GOTO1 =A(ADDPTRS),BODMCB,AIO1,AIO2,MYDSKA,RR=BORELO                    
*                                                                               
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
         CLC   CCONTEM,BCSPACES                                                 
         BNH   DISSALX                                                          
*                                                                               
         MVI   FVIFLD+L'CCONSAL,C'/'                                            
         MVC   FVIFLD+L'CCONSAL+1(L'CCONTEM),CCONTEM                            
*                                                                               
DISSALX  B     EXITOK                                                           
***********************************************************************         
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* DATA OBJECT FOR READY TO BUILD                                                
*                                                                               
* R1 HOLDS EQUATED VERB                                                         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                           
***********************************************************************         
RTBDTA   DS    0H                                                               
         LA    RF,RTBTBL           TABLE OF KNOWN VERBS                         
         B     ITER                ITERATE TABLE                                
*                                                                               
RTBTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISRTB)                                 
         DC    AL1(DVAL),AL1(0,0,0),AL4(VALRTB)                                 
         DC    AL1(EOT)                                                         
***********************************************************************         
* DISPLAY READY TO BUILD                                                        
***********************************************************************         
DISRTB   DS    0H                                                               
         MVI   FVIFLD,C'N'                                                      
         TM    SAVSARF1,X'02'                                                   
...
*                                                                               
VALSAL1  DS    0H                                                               
         GOTO1 VSCANNER,BODMCB,FVIHDR,(1,BOWORK1),C',=,/'                       
         CLI   4(R1),1                                                          
         BNE   INVSALX                                                          
         CLI   BOWORK1,3           TOO LONG?                                    
         BH    INVSALX             YES                                          
*                                                                               
         OC    BOWORK1+12(L'RSALKSAL),BCSPACES   UPPERCASE                      
         LA    RE,IOKEY                                                         
         USING RSALKEY,RE                                                       
         XC    IOKEY(L'RSALKEY),IOKEY                                           
         MVI   RSALKTYP,X'06'                                                   
         MVC   RSALKREP,CUAALF                                                  
         MVC   RSALKSAL,BOWORK1+12                                              
         DROP  RE                                                               
*                                                                               
         ICM   R1,15,=AL4(XIO4+XOREPDIR+XOHIGH)                                 
         GOTOX ('XIO',AGROUTS)                                                  
...
*                                                                               
         MVC   CCONSAL,BOWORK1+12                                               
*                                                                               
         CLI   BOWORK1+1,0         OVERRIDE TEAM?                               
         BE    VALSALX                                                          
*                                                                               
         OC    BOWORK1+22(L'RTEMKTEM),BCSPACES   UPPERCASE                      
         LA    RE,IOKEY                                                         
         USING RTEMKEY,RE                                                       
         XC    IOKEY(L'RTEMKEY),IOKEY                                           
         MVI   RTEMKTYP,X'05'                                                   
         MVC   RTEMKREP,CUAALF                                                  
         MVC   RTEMKTEM,BOWORK1+22                                              
         DROP  RE                                                               
*                                                                               
         ICM   R1,15,=AL4(XIO4+XOREPDIR+XOHIGH)                                 
         GOTOX ('XIO',AGROUTS)                                                  
...
*                                                                               
         ...
         BNE   INVSALX             TEAM NOT ON RECORD                           
*                                                                               
         MVC   CCONTEM,BOWORK1+22                                               
*                                                                               
VALSALX  B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
...
* RECORD (INPUT) PORTION  ADD/CHA/DIS                                           
         ...
         DC    AL2(00053),AL4(RTBDTA)    READY TO BUILD                         
*                                                                               
...
* DDFLDHDR                                                                      
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024REPRO22A  05/01/02'                                      
         END                                                                    
