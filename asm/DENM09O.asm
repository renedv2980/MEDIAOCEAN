*          DATA SET DENM09O    AT LEVEL 030 AS OF 10/15/12                      
...
* OPHASE: DENM09O                                                               
**********************************************************************          
         TITLE 'DEMCON - MOVIEGOER CONVERSION - OUTPUT PHASE'                   
DENM09O  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 NADWRKX-NADWRKD,DENM09O                                          
         USING NADWRKD,RC          RC=A(TEMP W/S)                               
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DENM09O+4096,R7                                                  
...
PUTTAPE  NTR1                                                                   
*                                                                               
         L     RE,AOREC            OUTPUT RECORD                                
         MVC   DUB1(5),OPRINT      SAVE CURRENT OPRINT OPTION                   
         CLC   =C'UUUUN',4+3(RE)   UNIVERSE RECORD? (4 FOR RDW)                 
         BNE   *+10                                                             
         MVC   OPRINT(5),=X'010000FFFF'  YES: FORCE PRNTBL TRACE                
*                                                                               
         GOTO1 APUTTAPE                                                         
*                                                                               
         MVC   OPRINT(5),DUB1      RESTORE OPRINT OPTION                        
*                                                                               
         TM    FLAGS1,CREATE_NETCTREC   NETCTREC=Y                              
         BNO   PUTTAPEX                                                         
*                                                                               
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'030DENM09O   10/15/12'                                      
         END                                                                    
