*          DATA SET PUNCLOSX   AT LEVEL 007 AS OF 05/01/02                      
*PHASE PUNCLOSX               NOTE PUNCLOSX - NOT PUNCLOSA                      
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PUNCLOSA- UNCLOSE DATA'                                         
*                                                                               
*              UNCLOSE DATA FROM AN OLD FILE                                    
*              OUTPUT IS UNCLOSED RECORDS ONLY (SEE BELOW NOTE)                 
*                                                                               
**********  NOTE  *** 07/2001 *  NOTE  *** 07/2001 *  NOTE  ***********         
*      THIS VERSION WILL ONLY COPY AGENCY CODE WI (WESTERN)           *         
*        IT UNCLOSES EST'S, EST BKTS, BUYS, AND BILLS                 *         
*        AND COPIES EVERYTHING ELSE FOR WESTERN "AS IS"               *         
***********************************************************************         
*                                                                               
**********  NOTE  *************  NOTE  *************  NOTE  ***********         
*      FOR DUMPING RECORDS FOR TESTING, ALL INSTRUCTIONS MARKED       *         
*       *DMP* MUST BE "RE-ACTIVATED" AND THIS PROGRAM RELINKED        *         
*                SEE ALSO ** NOTE ** AT PUTREC3                       *         
***********************************************************************         
*                                                                               
         PRINT NOGEN                                                            
PUNCLOSE CSECT                                                                  
...
BILL     DS    0H                                                               
         ...
         LA    RF,1(RF)                                                         
         ST    RF,ETBILLS                                                       
*                   DUMP FOR TESTING BELOW  ********                            
         AP    DMPCNT,=P'1'                                                     
         CP    DMPCNT,=P'100'                                                   
         BH    BILLTST                                                          
         MVC   P+10(14),=C'*** BEFORE ***'                                      
         BAS   RE,PRNT                                                          
         BAS   RE,DMPREC                                                        
*                   DUMP FOR TESTING ABOVE  ********                            
BILLTST  LA    R3,REC                                                           
         USING PBILLREC,R3                                                      
         CLI   PBILLEL+1,X'46'     ELEM LENGTH GT 70 ?                          
         BH    BILLNEW             YES - "NEW" BILLREC                          
*                       USE LOGIC BELOW FOR "OLD" (SHORTER) BILLREC             
         ZAP   DUB,PBILLGRS(5)                                                  
         CVB   RF,DUB                                                           
         A     RF,ETBILGRS                                                      
         ST    RF,ETBILGRS                                                      
*****    SP    DUB,PBILLBIL                                                     
         ...
         ZAP   DUB,PBILLGRS(5)                                                  
*****    SP    DUB,PBILLNET                                                     
         SP    DUB,PBILLGRS+10(5)                                               
         CVB   RF,DUB                                                           
         SR    RF,R0                                                            
         A     RF,ETBILAC                                                       
         ST    RF,ETBILAC                                                       
         B     BILLOUT                                                          
*                       USE LOGIC ABOVE FOR "OLD" (SHORTER) BILLREC             
BILLNEW  DS    0H                                                               
         ZAP   DUB,PBILLGRS                                                     
         CVB   RF,DUB                                                           
         A     RF,ETBILGRS                                                      
...
*                                                                               
         LA    R5,REC-4                                                         
         LA    R2,35           KL OF 31 + 4 FOR VAR REC LENGTH "HEADER"         
...
*                                                                               
*                              ***  DUMP RECORDS FOR TESTING BELOW  ***         
*DMP*    CP    INCNT,=P'25'                                                     
*DMP*    BH    XIT                                                              
*DMP*    MVC   P+10(14),=C'*** BEFORE ***'                                      
*DMP*    BAS   RE,PRNT                                                          
*DMP*    BAS   RE,DMPREC                                                        
*                              ***  DUMP RECORDS FOR TESTING ABOVE  ***         
*                                                                               
         B     XIT                                                              
*                                                                               
GETRNXTA DS    0H                                                               
         AP    DIRIN,=P'1'                                                      
*                                                                               
*               ***  DUMP DIRECTORY ONLY RECORDS FOR TESTING BELOW  ***         
*DMP*    CP    DIRIN,=P'25'                                                     
*DMP*    BH    XIT                                                              
*DMP*    MVC   P+75(10),=C'* BEFORE *'                                          
*DMP*    BAS   RE,DMPKEY                                                        
*DMP*    BAS   RE,PRNT                                                          
*               ***  DUMP DIRECTORY ONLY RECORDS FOR TESTING ABOVE  ***         
*                                                                               
         B     XIT                                                              
         SPACE 3                                                                
PUTREC   NTR1                                                                   
...
*                                                                               
***********************************************************************         
*  **NOTE**   TO "ACTIVATE" THE FOLLOWING "AFTER" DUMPS, TEMPORARILY  *         
*                COMMENT OUT THE BRANCH TO XIT IMMEDIATELY BELOW      *         
         B     XIT                                                    *         
***********************************************************************         
*               ***  DUMP DIRECTORY ONLY RECORDS FOR TESTING BELOW  ***         
         CP    OUTCNT,=P'25'                                                    
         ...
         BH    XIT                 NO                                           
*                                                                               
PUTREC3P MVC   P+75(10),=C'* AFTER  *'                                          
         BAS   RE,DMPKEY                                                        
         BAS   RE,PRNT                                                          
*               ***  DUMP DIRECTORY ONLY RECORDS FOR TESTING ABOVE  ***         
*                                                                               
*                              ***  DUMP RECORDS FOR TESTING BELOW  ***         
PUTREC4  CP    OUTCNT,=P'25'                                                    
         BH    XIT                                                              
*                                                                               
PUTREC5  MVC   P+10(14),=C'*** AFTER  ***'                                      
         BAS   RE,PRNT                                                          
         BAS   RE,DMPREC                                                        
         B     XIT                                                              
*                              ***  DUMP RECORDS FOR TESTING ABOVE  ***         
...
*                                                                               
ESTTAB   CSECT                                                                  
         DS    18000CL56           ROOM FOR 18000 ESTS                          
         DC    X'0000'                                                          
*                                                                               
LKTAB    CSECT                                                                  
         DS    200CL11             ROOM FOR 200 CARDS                           
         DC    X'0000'                                                          
*                                                                               
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007PUNCLOSX  05/01/02'                                      
         END                                                                    
