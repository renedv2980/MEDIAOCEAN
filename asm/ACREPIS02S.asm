*          DATA SET ACREPIS02S AT LEVEL 028 AS OF 05/01/02                      
*PHASE ACIS02A                                                                  
*INCLUDE SORTER                                                                 
*INCLUDE CHOPPER                                                                
*INCLUDE SQUASHER                                                               
...
PTRN20   L     R6,ASRTREC              R6 COVERS SORT RECORD                    
         XC    0(L'SRTINFO,R6),0(R6)  CLEAR OUR SORT AREA                       
         USING ACKEYD,R3                                                        
...
TAPE01   DCB   DSORG=PS,                                               X        
               ...
               LRECL=500                                                        
*                                                                               
DSPARM   DC    CL20'ACCTAPE.AC0ISIR1'                                           
         EJECT                                                                  
*---------------------------------------------------------------------*         
...
*                                                                               
       ...
       ++INCLUDE DDSYSELD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028ACREPIS02S05/01/02'                                      
         END                                                                    
