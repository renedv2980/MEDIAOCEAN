*          DATA SET CTLFM1AS   AT LEVEL 098 AS OF 05/01/02                      
*PHASE TA021AB,+0                                                               
*                                                                               
*PROGRAM LOGIC:                                                                 
...
*                                                                               
         ...
         DS    0H                      BUILD LIST OF MARKETS IN 'BUFF'          
         GOTO1 VSUBR01,DMCB,('BLDMKE',(R9)),(RC)                                
         CLI   FERN,X'FF'                                                       
...
*****    CLI   0(R5),35                                                         
*****    BH    DSPMK17             TOO MANY IO READS???                         
         GOTO1 VSUBR02,DMCB,('GETALPHE',(R9)),(RC)                              
         DS    0H                                                               
DSPMK17  LA    R4,8(R4)            NEXT SCANTBL SLOT                            
         LA    R6,1(R6)                                                         
         LA    R8,2(R8)                                                         
...
GETALP20 DS    0H                  FILTER THRU CTFILE FOR ALPHA MKT             
         ...
         B     GETALP30                                                         
*                                                                               
GETALP25 GOTO1 VDATAMR,DMCB,=C'DMRSEQ',=C'CTFILE ',(R6),(R6)                    
         B     GETALP30                                                         
*                                                                               
...
*NTI                                                                            
         ...
         DC    AL2(215),C'TCAR  '  TOTAL COMMERCIAL ACTIVIY REPORT              
*                                                                               
*CABLE                                                                          
...
*                                                                               
*NHT CABLE                                                                      
         DC    AL2(510),C'NHTCBL'  <--CABLE NHTI                                
*                                                                               
         DC    X'FFFF',XL6'FF'                                                  
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'098CTLFM1AS  05/01/02'                                      
         END                                                                    
