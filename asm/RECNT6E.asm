*          DATA SET RECNT6E    AT LEVEL 252 AS OF 06/21/04                      
*PHASE T8026EA,*                                                                
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
*INCLUDE DAYUNPK                                                                
         TITLE 'T8026E - RECNT6E - ENTERPRISE EC'                               
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT6E --- ENTERPRISE ELECTRONIC CONTRACT INTERFACE       *           
*********************************************************************           
* UPDATE HISTORY:                                                   *           
*                                                                   *           
...
T8026E   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T8026E*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
*                                  SEND SPECIAL PRINT LINE                      
         GOTO1 SPOOL,DMCB,(R8)                                                  
*                                                                               
         CLI   BYTE2,C'Z'          TRAFFIC FORMAT FORCED TO 'Z'?                
         BE    EDICT30             YES                                          
*                                                                               
...
VUPVAL   DS    V                                                                
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'252RECNT6E   06/21/04'                                      
         END                                                                    
