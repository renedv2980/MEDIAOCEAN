*          DATA SET DDEDIBDER  AT LEVEL 005 AS OF 03/25/04                      
*PHASE EDIBDERA                                                                 
*INCLUDE ADDAY                                                                  
*INCLUDE BINSR31                                                                
*INCLUDE CARDS                                                                  
...
*                                                                     *         
***********************************************************************         
         TITLE 'DDEDIBDER -- RECEIVE BDE NOTIFICATIONS VIA MQSERIES'            
         MACRO                                                                  
&NAME    PRNT  &A,&PRINT=                                                       
&NAME    DS    0H                                                               
         AIF   (T'&A EQ 'O').NOMOVE                                             
...
*                                                                               
         ...
         MVC   EDICTADD,BDREDADD   A(ROUTINE TO ADD EDICT RECORDS)              
...
*                                                                               
         ...
         MVC   DCBDDNAM-IHADCB(8,RF),=C'BERTRACE'  DDNAME=BERTRACE              
*                                                                               
         MVC   TITLE(33),=C'EDICT: RECEIVING SUBTASK FROM BDE'                  
...
*                                                                               
         ...
         BE    CHKBX                                                            
*                                                                               
         BRAS  RE,DAREFAX          ADD DLNFAX/ERRFAX REC TO EDICT FILE          
         B     CHKBX                                                            
*                                                                               
...
*                                                                               
         MVC   HALF,EDFPQUID                                                    
         BRAS  RE,GETUID           GET ALPHA USERID NAME                        
*                                                                               
         L     R3,=A(NEWEDREC)                                                  
...
*                                                                               
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   RDFXTID,=C'ERRFAX'  BUILD FAX ERROR NOTIFICATION                 
*                                                                               
DFX10    MVC   RDFXORDR,EDFAPPL+23 ORDER NUMBER                                 
         MVC   RDFXFRID,SPACES                                                  
...
*                                                                               
DFX20    MVC   RDFXDATE,WORK       ADJUSTED DATE (YYMMDD)                       
...
* NTRY: HALF = 2 BYTE USER ID NUM                                               
* XTRY: USERID = 10 BYTE ALPHA USER NAME                                        
*                                                                               
...
EDICTADD DS    A                   A(ROUTINE TO ADD EDICT RECORDS)              
...
EDICTREC DS    CL256               EDICT RECORD                                 
NEWEDREC DS    CL256               DARE FAX DLN/ERR EDICT RECORD                
*                                                                               
         DC    C'***FIELD***'                                                   
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE CTGENFILE                                                      
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005DDEDIBDER 03/25/04'                                      
         END                                                                    
