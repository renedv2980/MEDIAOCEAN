*          DATA SET ACCLB11B   AT LEVEL 040 AS OF 12/22/99                      
*PHASE T62111B                                                                  
CLB11    TITLE '- BILL PROGRAM - MATCH 1 LIST'                                  
CLB11    CSECT                                                                  
         PRINT NOGEN                                                            
...
***********************************************************************         
         SPACE 1                                                                
SCRFRST  DS    0H                                                               
         CLC   CSBILCUR,CSCPYCUR   TEST BILLING IN COMPANY CURR                 
         BE    SFRST02                                                          
         MVC   CSBILCUR,CSCPYCUR   NO - SET SO IT IS (EURO REASONS)             
...
DISCLM   L     R2,AIO1                                                          
         ...
         SPACE 1                                                                
***********************************************************************         
* DISPLAY WORKCODE (FIRST TIME ROUTINE)                               *         
***********************************************************************         
         SPACE 1                                                                
DISWC    DS    0H                                                               
         TM    TLMINDS,TLMISEC     CONVERT RECORD IF SECONDARY CURRENCY         
         BZ    DISWC02                                                          
         MVC   BOWORK1(L'CSCPYCUR),CSCPYCUR                                     
         MVC   BOWORK1+L'CSCPYCUR(L'TLMCUR),TLMCUR                              
         GOTO1 VTOBACCO,BCPARM,('TOBAACVS',BOWORK1),TRNRECD,ACOM,0,0            
DISWC02  DS    0H                                                               
         BAS   RE,SETMAT           COPIES PTAELD TO MPTAELD                     
...
***********************************************************************         
         SPACE 1                                                                
DISNET   TM    TLMINDS,TLMICPY+TLMISEC                                          
         BNZ   DISNETA                                                          
...
***********************************************************************         
         SPACE 1                                                                
DISCOM   TM    TLMINDS,TLMICPY+TLMISEC                                          
         BNZ   DISCOMA                                                          
...
***********************************************************************         
         SPACE 1                                                                
DISEXC   TM    TLMINDS,TLMICPY+TLMISEC                                          
         BNZ   EXIT                                                             
         ZAP   BODUB1,BCPZERO                                                   
         MVO   BODUB1,TLMXEXC                                                   
...
*                                                                               
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'040ACCLB11B  12/22/99'                                      
         END                                                                    
