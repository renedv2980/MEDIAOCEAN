*          DATA SET DEISMQ     AT LEVEL 012 AS OF 05/01/02                      
*PHASE DEISMQA                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE PDUMPER                                                                
...
READCARD GOTO1 =V(CARDS),DMCB,CARD,=C'RE00'                                     
         ...
         BE    GOODBYE                                                          
*                                                                               
         LA    RF,CARD+79          POINT TO LAST CHARACTER IN CARD              
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   BUFFER(0),CARD      MOVE DATA TO MQ BUFFER AREA                  
*                                                                               
...
*                                                                               
QMGRNAME     DC      CL48'MQ5P'                                                 
QNAME        DC      CL48'DARE.TEST.INPUTQ'                                     
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012DEISMQ    05/01/02'                                      
         END                                                                    
