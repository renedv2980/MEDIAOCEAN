*          DATA SET CTCONVTVI  AT LEVEL 146 AS OF 11/04/99                      
*PHASE CONVTVI                                                                  
*INCLUDE DMDMGRL                                                                
*INCLUDE DMUTLCT                                                                
*INCLUDE PRINT                                                                  
...
CONV14   GOTO1 VDATAMGR,DMCB       GET FIRST/NEXT RECORD                        
         LA    R0,DMRSEQ                                                        
         ST    R0,DMCB                                                          
         OI    DMCB,X'80'      SET READ FOR UPDATE TO IGNORE BUFFER             
         CLI   8(R1),0                                                          
         BE    *+14                                                             
         TM    8(R1),X'80'                                                      
         BNZ   CONV300                                                          
...
CONV004  EQU   *                                                                
         ...
         CLC   CTTKTID(5),=CL5'KATZ0'                                           
         BE    CONV008                                                          
**NOP         CLC   CTTKTID(2),=CL2'SZ'                                         
**NOP         BE    CONV008                                                     
         B     CONV200                                                          
CONV006  EQU   *                                                                
         ...
         CLI   1(R3),10                                                         
         BNE   CONV200                                                          
         CLC   2(5,R3),=CL5'KATZ0'                                              
         BE    CONV008                                                          
**NOP         CLC   2(2,R3),=CL2'SZ'                                            
**NOP         BE    CONV008                                                     
         B     CONV200                                                          
*                                                                               
CONV008  EQU   *                                                                
...
CONV042  EQU   *                                                                
         ...
         MVI   CTIDLEN,12                                                       
         MVC   CTID(10),0(R4)                                                   
         GOTO1 VHELLO,PARM,(C'P',CTFILE),((R2)),WORK,=C'ADD=CODE'               
         CLI   12(R1),0                                                         
         BE    *+6                                                              
         DC    H'00'                                                            
...
WORKC    CSECT                     ** WORKING STORAGE POOL **                   
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'146CTCONVTVI 11/04/99'                                      
         END                                                                    
