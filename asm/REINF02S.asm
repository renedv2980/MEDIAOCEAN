*          DATA SET REINF02S   AT LEVEL 029 AS OF 05/01/02                      
*PHASE T80B02A,*                                                                
...
TER60    DS    0H                                                               
         ...
         DROP  R2                                                               
         EJECT                                                                  
PRD10    CLI   OPTNBYTE,8                                                       
         BNE   PRD10A                                                           
         LA    R4,PRD44            DISPLAY RTN: POINT PERSON,ETC                
         B     PRD11A                                                           
PRD10A   CLI   OPTNBYTE,9                                                       
         BNE   PRD10B                                                           
         LA    R4,PRD50            DISPLAY RTN: SPOT                            
         B     PRD11A                                                           
PRD10B   CLI   OPTNBYTE,16         DISPLAY: AG/OFF FLIGHT DATES                 
         BNE   PRD11                                                            
         LA    R4,PRD60            DISPLAY RTN: SPOT                            
         B     PRD11A                                                           
PRD11    LA    R4,PRD40            DISPLAY RTN: REGULAR PRODUCT                 
*                                                                               
PRD11A   LA    R1,KEYTAB                                                        
         CLI   NEXTBYTE,1                                                       
         BE    PRD12                                                            
...
PRD20    EQU   *                                                                
         ...
         BNE   SETDONE                                                          
*                                                                               
PRD22    CLC   ADVFLTR,ALL                                                      
         BE    PRD30                                                            
         CLC   ADVFLTR,KEY+18                                                   
         BNE   PRD20                                                            
*                                                                               
PRD30    CLC   KEY+22(3),INFSTRT                                                
         BL    PRD20                                                            
*                                                                               
         CLI   REPBYTE,1                                                        
         BE    PRD32                                                            
...
*                                                                               
         ...
         MVI   ELCODE,2                                                         
         BAS   RE,GETEL                                                         
         BNE   PRD20               NO ELEMENT - SKIP RECORD                     
         CLC   PPFLTR,22(R6)       CHECK POINT PERSON                           
         BNE   PRD20               NOT FOUND - SKIP RECORD                      
PRD36    CLC   NETFLTR,SPACES      NETWORK CONT FILTER?                         
         BE    PRD38               NO                                           
...
PRD44    MVC   L8APRD1,RPRDKPRD                                                 
         ...
         MVI   ELCODE,2                                                         
         BAS   RE,GETEL                                                         
         BNE   PRD44A              SHOULDN'T HAPPEN                             
         MVC   L8APNT1,22(R6)                                                   
         MVC   L8ADESC1,2(R6)                                                   
PRD44A   LA    R4,PRD46                                                         
         B     PRD20                                                            
*                                                                               
PRD46    MVC   L8APRD2,RPRDKPRD                                                 
...
PRD50    MVC   L8BPRD,RPRDKPRD                                                  
         ...
         MVI   ELCODE,2                                                         
         BAS   RE,GETEL                                                         
         BNE   PRD53               SHOULDN'T HAPPEN                             
         MVC   L8BPNT,22(R6)                                                    
         MVC   L8BDESC,2(R6)                                                    
PRD53    LA    R6,RPRDREC                                                       
         MVI   ELCODE,3                                                         
         BAS   RE,GETEL                                                         
         BNE   PRD55               SHOULDN'T HAPPEN                             
         MVC   L8BSPCLT,2(R6)                                                   
         MVC   L8BSPPRD,5(R6)                                                   
...
POIN0140 CLC   KEY(27),KEYSAVE                                                  
         ...
         B     POIN0140                                                         
*                                                                               
POIN0160 BAS   RE,GETREC           READ IN RECORD                               
         MVC   L17SNAME,RSALNAME   SALESPERSON NAME                             
*                                                                               
POIN0180 MVC   KEY,SAVEKEY         REESTABLISH SEQ ORDER                        
         BAS   RE,HIGH                                                          
*                                                                               
*- POINT TO NEXT SCREEN LINE                                                    
POIN0200 FOUT  (R2)                TRANSMIT THIS LINE                           
         ZIC   R5,0(R2)                                                         
         LA    R2,0(R2,R5)                                                      
POIN0220 EQU   *                                                                
         BAS   RE,CLRLINE                                                       
...
DEMOD    DSECT                                                                  
       ++INCLUDE DEDBLOCK                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029REINF02S  05/01/02'                                      
         END                                                                    
