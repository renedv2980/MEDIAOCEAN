*          DATA SET CTMAD0CA   AT LEVEL 099 AS OF 05/01/02                      
*PHASE TA0C0CA,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE REGETIUN                                                               
*INCLUDE TIMVAL                                                                 
...
*                                                                               
         ...
         GOTO1 CALLOV,DMCB,0                                                    
         MVC   VDEFINE,DMCB        FIND CORE ADDR OF DEFINE                     
*                                                                               
GNAM0002 LA    R4,PROGNAMA         A(1ST NAME)                                  
...
GNAM0016 EQU   *                                                                
         ...
         USING DEMOD,R6                                                         
         PRINT GEN                                                              
         GOTO1 VDEFINE,DMCB,=C'PROGRAM',DBLOCK,(R4),RR=RELO                     
         PRINT NOGEN                                                            
*                                                                               
         DROP  R6                                                               
*                                                                               
...
*  DDCOMFACS: ADDRESS ROUTINE DSECT                                             
       ++INCLUDE DDCOMFACS                                                      
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'099CTMAD0CA  05/01/02'                                      
         END                                                                    
