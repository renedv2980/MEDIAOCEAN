*          DATA SET SPSFM36    AT LEVEL 014 AS OF 05/01/02                      
*PHASE T21736A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
*  TITLE: SPSFM36<==>T21736 USERFIELD HEADER LISTING.                 *         
*                                                                     *         
...
*  CALLS TO:                                                          *         
*                                                                     *         
*  INPUTS: SCREENS SPSFMB1 (T217B1) -- LISTING                        *         
*                                                                     *         
...
*                                                                               
VK20     LA    R2,USLCLNTH                                                      
         GOTO1 CLPACK,DMCB,CLNT,MYBCLT                                          
         CLI   0(R1),0                                                          
         LA    R2,USLCLNTH                                                      
         BNE   SLERR2              INVALID CLIENT                               
*                                                                               
*---------------------------- BUILD KEY ------------------------------*         
*                                                                               
...
*LISTKEY                                                                        
*                                                                               
LK       L     R4,AIO              SAVE KEY OF RECORD IN IOA                    
         MVC   MYSVKEY,0(R4)       SET KEY OF LAST SELECTED RECORD              
         B     EXIT                                                             
         EJECT                                                                  
*                                                                               
*============================== TESTSEL ==============================*         
...
*                                                                               
         ...
         BNE   XTESTSEL                                                         
*                                                                               
TESTSEL1 LA    R2,USLSELH          R2-->FIRST SELECT FIELD.                     
         LA    RF,USLTAGH          RF-->LAST FIELD.                             
*                                                                               
...
LR60     MVC   LSTMEDI,1(R3)                             MEDIA.                 
         GOTO1 CLUNPK,DMCB,(CPROF+6,CKEYCLT),LSTCLNT     CLIENT.                
*                                                                               
         OC    CPU1,CPU1                                                        
         BZ    LR70                                                             
         MVC   LSTDSC1,CPU1                                                     
...
ERREXGO  GOTO1 ERREX                                                            
*                                                                               
SLERR2   MVC   CONHEAD,BLANKS                                                   
         MVC   CONHEAD(L'SLERR2MS),SLERR2MS                                     
         OI    CONHEADH+6,X'80'                                                 
         GOTO1 ERREX2                                                           
*                                                                               
...
SLERR2MS DC    C'** ERROR ** INVALID CLIENT'                                    
***********************************************************************         
         EJECT                                                                  
***********************************************************************         
*=========================== MISCELLANEOUS ===========================*         
...
*                                                                               
         ORG   CONTAGH                                                          
       ++INCLUDE SPSFMB1D          DSECT FOR RECORD LISTING.                    
**********************************************************************          
         EJECT                                                                  
**********************************************************************          
*========================= SPSFM WORK AREA ==========================*          
...
*                                                                               
         ORG   SYSSPARE                                                         
*                                                                               
** STORAGE USED BY SPSFM35 AS WELL                                              
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014SPSFM36   05/01/02'                                      
         END                                                                    
