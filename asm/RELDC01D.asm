*          DATA SET RELDC01D   AT LEVEL 005 AS OF 05/11/02                      
*PHASE RELDC01D,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE RECUP                                                                  
*INCLUDE HEXOUT                                                                 
         TITLE 'RELDC01D - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC   DS    0H                                                               
         ...
         USING RCONREC,R5                                                       
*                                                                               
         CLC   RCONKTYP(2),=X'0C1D'                                             
         BNE   DMXKEEP             NOT BAD KEY                                  
*                                                                               
         MVC   P+1(27),RCONKEY                                                  
*                                                                               
         GOTO1 VPRINTER                                                         
*                                                                               
         B     DMXPURGE            BAD CONTRACT: DROP IT                        
*                                                                               
         EJECT                                                                  
*******************************************************************             
* END-OF-FILE LOGIC                                               *             
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005RELDC01D  05/11/02'                                      
         END                                                                    
