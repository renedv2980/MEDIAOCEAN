*          DATA SET FRFTAI1BWI AT LEVEL 007 AS OF 05/01/02                      
*PHASE FTPAI1WI,*,NOAUTO                                                        
***************************  use special panS procs                             
DVGCXASM START                                                                  
* /***START OF SPECIFICATIONS*****************************************/         
*              C'DDSFTP.CCOL.AI1.XXXX.BWI'     western billing tape             
* /*                                                                 */         
...
*/*-----------------------------------------------------------------*/          
MVSDSN   DC    C'DDSFTP.CCOL.AI1.XXXX.BWI'     western billing tape             
         DS  0D                                                                 
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007FRFTAI1BWI05/01/02'                                      
         END                                                                    
