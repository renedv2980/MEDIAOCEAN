*          DATA SET ACREPCM02  AT LEVEL 036 AS OF 12/11/09                      
*PHASE ACCM02A,+0                                                               
*INCLUDE ACSLRY                                                                 
*INCLUDE ACSALHST                                                               
*INCLUDE DATVAL                                                                 
...
*                                                                               
         ...
         OC    RSTART,RSTART                                                    
         BNZ   REQF22A                                                          
*                                        SOMETHING NOT RIGHT W/ AGY CAL         
REQF22   TM    CALBYTE,CALOK             DID WE FIND AT LEAST 1 WEEK            
         BO    REQF22A                   THAT MATCHED THE REQUEST?              
         OI    CALBYTE,AGYCALN           SET BIT FOR BAD AGY CAL                
         MVC   SVFRSTWK,FIRSTWK          TRY READING AGY CAL AGAIN              
         MVC   SVLSTWK,LASTWK            W/O THE CAL PERIOD REQUEST             
         MVC   FIRSTWK,=C'01'            USE THE DEFAULTS INSTEAD               
         LA    R1,WEEKMAX                                                       
         CVD   R1,DUB                                                           
         OI    DUB+7,X'0F'                                                      
         UNPK  LASTWK,DUB                                                       
         MVI   CALENDAR,C'N'             SET TO NOT USING CALENDAR REC          
         BAS   RE,BLDCAL                 GO BUILD CALENDAR TABLE                
         MVC   FIRSTWK,SVFRSTWK    RESTORE PERIOD RANGE IF EXISTS               
         MVC   LASTWK,SVLSTWK                                                   
REQF22A  MVC   START,RSTART                                                     
...
*DC                                                                             
         CLC   AWEEKTAB,AWEEKTB2   OFFICE LVL CALENDAR FOUND?                   
         BE    LVA10               YES                                          
         TM    CALBYTE,AGYCALN     NO-IS THE AGY LEVEL CAL BAD?                 
         BZ    LVA10               NO SO OK TO USE IT                           
         MVI   FCRDACC,C'N'                                                     
         MVI   FCRDTRNS,C'N'                                                    
         MVI   FCRDTIME,C'N'                                                    
         MVC   P+1(35),=CL35'************* E R R O R ***********'               
         MVC   PSECOND+1(35),=CL35'*AGY CALENDAR DOES NOT FIT REQUEST*'         
         GOTO1 ACREPORT                                                         
         B     XIT                                                              
*DC                                                                             
LVA10    OC    START,START          USE RANGE START IF NO QSTART                
         BNZ   XIT                                                              
         MVC   START,RSTART                                                     
         MVC   END,REND                                                         
         B     XIT                                                              
...
BLDW01   L     RE,AWEEKTAB         RECEIVING FIELD                              
         LH    RF,=Y(L'WEEKTB1)    RECEIVING FIELD LENGTH                       
         SR    R1,R1                                                            
         SR    R0,R0                                                            
         MVCL  RE,R0                                                            
...
*                                                                               
         ...
         BH    BLDC10                                                           
         OI    WKSTAT1,WKRQST                 MARK WEEK WITHIN REQUEST          
         OI    CALBYTE,CALOK       FOUND AT LEAST 1 WEEK THAT WORKS             
         CLC   FIRSTNBR,SPACES                                                  
         BNE   BLDC09                                                           
         MVC   FIRSTNBR,WKNUM                                                   
         MVC   RSTART,WKST2                   SAVE RANGE DATES FOR              
...
*                                                                               
WEEKMAX  EQU   90                  MAX NUMBER OF WEEKS                          
DHEDMAX  EQU   350                 MAX DEPT HEADS                               
EMPNUM   EQU   5000                MAX 1R HIGHER LEVELS                         
*                                                                               
         EJECT                                                                  
*************************************************************                   
...
SVFRSTWK DS    CL2                 SAVED 1ST WEEK # (DEFAULT)                   
LASTWK   DS    CL2                 LAST WEEK NUMBER (DEFAULT)                   
SVLSTWK  DS    CL2                 SAVED LAST WEEK 3 (DEFAULT)                  
HOURS    DS    PL6                 WORK HOURS                                   
STATUS   DS    CL(L'STACODE)       STATUS CODE TO PRINT                         
CALBYTE  DS    XL1                                                              
CALOK    EQU   X'80'               AGY LEVEL CAL FITS REQUEST                   
AGYCALN  EQU   X'40'               AGY LEVEL CAL DOES NOT FIT REQUEST           
*                                                                               
...
*ACQD                                                                           
       ...
       ++INCLUDE ACQD                                                           
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'036ACREPCM02 12/11/09'                                      
         END                                                                    
