*          DATA SET REREP7902X AT LEVEL 158 AS OF 10/28/96                      
*PHASE RE7902A,+0                                                               
***********************************************************************         
*  LIST CLASS BY CATEGORY WITH OPTION TO SHOW ADVERTISER *                      
***********************************************************************         
* HISTORY:                                                            *         
*                                                                     *         
* 23JUL96 (SPE) --- ORIGINAL ENTRY                                    *         
*                                                                     *         
* 25OCT96 (BU ) --- FIX MASTER/SUBSIDIARY SITUATION                   *         
*                                                                     *         
*                                                                     *         
*                          ** END TOMBSTONE **                        *         
***********************************************************************         
...
ADVR0020 EQU   *                                                                
         GOTO1 DATAMGR,DMCB,=C'DMRSEQ',=C'REPDIR',KEYSAVE,KEY,0                 
ADVR0040 EQU   *                                                                
         CLI   KEY,X'08'           ADVERTISER RECORD?                           
         BNE   SORTIN              NO  - FINISHED ADVERT EXTRACT                
*                                                                               
         L     RE,VXADDR                                                        
         USING VXADDRD,RE                                                       
         L     R4,VXSREP                                                        
...
*                                                                               
         USING RSREPD,R4                                                        
*                                                                               
         CLI   SUBREPIN,C'Y'       IS THIS A SUBSIDIARY REQUEST?                
         BNE   ADVR0060            NO  - USE RCREPFL                            
*                                                                               
*   TEST                                                                        
*        MVC   P+1(3),SUBREPIN                                                  
*        GOTO1 REPORT                                                           
*   TEST END                                                                    
*                                                                               
         CLC   KEY+25(2),SUBMASTR  YES - USE SUB'S MASTER REP                   
         BNE   ADVR0020            NO  - GET ANOTHER ADV REC                    
*                                                                               
         B     ADVR0080                                                         
*                                                                               
ADVR0060 EQU   *                                                                
...
IOAREA   DS    CL1000                                                           
       ...
       ++INCLUDE REXADDRD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'158REREP7902X10/28/96'                                      
         END                                                                    
