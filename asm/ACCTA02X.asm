*          DATA SET ACCTA02X   AT LEVEL 004 AS OF 05/01/02                      
*PHASE T61E02A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ZAP   WORK2(10),CTGNPAY            EST DOLLARS = NET PAY*COST%         
         MP    WORK2(10),CTGCPCT                                                
         SRP   WORK2(10),64-4,5                                                 
         EDIT  (P10,WORK2),(11,CLDOLL),2,MINUS=YES                              
         AP    ACCDOLL,WORK2(10)                                                
*                                                                               
         MP    WORK2(10),=P'10000'                                              
         DP    WORK2(10),CTGGCI             EST GCI% = EST DOLLARS/GCI          
...
*                                                                               
       ...
       ++INCLUDE SPGENCTA                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004ACCTA02X  05/01/02'                                      
         END                                                                    
