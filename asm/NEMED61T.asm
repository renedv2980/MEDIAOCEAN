*          DATA SET NEMED61T   AT LEVEL 002 AS OF 05/01/02                      
*          DATA SET NEMED61    AT LEVEL 083 AS OF 02/11/99                      
*PHASE T31E61A,+0                                                               
*INCLUDE BINSRCH2                                                               
...
DOMFACSD DSECT                                                                  
       ...
       ++INCLUDE DDCOMFACS                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002NEMED61T  05/01/02'                                      
         END                                                                    
