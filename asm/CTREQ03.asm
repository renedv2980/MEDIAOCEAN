*          DATA SET CTREQ03    AT LEVEL 002 AS OF 08/04/15                      
*PHASE TA0403A                                                                  
...
IDNAV5   MVI   KEY,C'F'                                                         
         ...
         B     IDNAVX                                                           
*                                                                               
IDNAV6   EQU   *                   GO FOR USERID RECORD                         
         XC    KEY,KEY                                                          
         MVI   KEY,C'I'                                                         
         MVC   KEY+15(10),IFLD                                                  
         GOTO1 ARFIL                                                            
         ...
         BL    IDNAVX              DISK ERROR                                   
         BE    IDNAV7              NOT FOUND                                    
         OI    FIND,X'20'          ?? WHATS THIS ABOUT ??                       
         B     IDNAVX                                                           
*                                                                               
IDNAV7   MVI   FERN,13             RECORD NOT ON FILE                           
         B     IDNAVX                                                           
*                                                                               
...
LINEVO   EQU   *                                                                
         XIT1                                                                   
         EJECT                                                                  
REPTVAL  NTR1                      REPORT VALIDATION                            
         GOTO1 AINITV                                                           
         CLI   FIND,1                                                           
         BNE   REPTVE              REPORT MISSING OR INVALID                    
         XC    TEMP(7),TEMP                                                     
         SR    R1,R1                                                            
         IC    R1,IFLDH+5                                                       
         LA    RE,IFLD                                                          
REPTV2   CLI   0(RE),C'1'          REPORTS 1-7 VALID                            
         BL    REPTVE                                                           
         CLI   0(RE),C'7'                                                       
         BH    REPTVE                                                           
         PACK  DUB,0(1,RE)                                                      
         CVB   RF,DUB                                                           
         LA    RF,TEMP-1(RF)                                                    
         CLI   0(RF),0             TEST FOR DUPLICATE REPORT ID                 
         BNE   REPTVE                                                           
         MVI   0(RF),1                                                          
         LA    RE,1(RE)                                                         
         BCT   R1,REPTV2                                                        
         ...
         B     REPTX                                                            
*                                                                               
REPTVE   MVI   FERN,2              LINE INVALID                                 
REPTX    B     EXIT                                                             
         EJECT                                                                  
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002CTREQ03   08/04/15'                                      
         END                                                                    
