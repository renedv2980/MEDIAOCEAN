*          DATA SET ACBAT1F    AT LEVEL 020 AS OF 05/01/02                      
*PHASE T61B1FA                                                                  
         TITLE 'SCHLITZ BILLING INPUT'                                          
T61B1F   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 PROGDX-PROGD,*BAT1F*,R8,CLEAR=YES                                
         USING PROGD,RC                                                         
         L     R9,4(R1)                                                         
         USING GWS,R9                                                           
         USING TWAD,RA                                                          
...
RT28     DS    0H                                                               
         ...
         MVI   ERRNUM,1                                                         
         CLI   5(R3),0                                                          
         BNE   *+10                MUST HAVE AN OUTLET CODE                     
         LR    R2,R3                                                            
         B     ERROR                                                            
         MVC   BILLOVER,8(R3)                                                   
         OC    BILLOVER,SPACES                                                  
...
RT34     ZAP   DIV,SAVECASH                                                     
         ...
         B     RT56                                                             
         SPACE 3                                                                
*&&UK                              SUSPENDED FOR NOW                            
RT38     DS    0H                  DISTRIBUTE BILL TO ALL OUTLETS               
         ZIC   RF,KEY+8            IN THIS MARKET                               
         LA    RF,1(RF)                                                         
         STC   RF,KEY+8                                                         
         MVC   SAVEKEY,KEYSAVE                                                  
         BAS   RE,HIGH                                                          
RT40     CLC   SAVEKEY(8),KEY      SAME REGION/MARKET                           
         BNE   RT56                                                             
         SPACE 1                                                                
...
RT64     LA    RE,DLDSNARR                                                      
         ...
         USING DLPOSTD,R7                                                       
         MVC   DLPSEL(2),=X'6A71'                                               
         MVC   DLPSCRAC(1),COMPANY                                              
         MVC   DLPSCRAC+1(2),=C'3S'                                             
...
RT70     IC    RE,DLPSLEN                                                       
         ...
         LA    R7,IOAREA+2                                                      
         USING DLDESCD,R7                                                       
         MVC   DLDSREF(5),BILLACC  REGION MARKET TO REFERENCE                   
         MVI   DLDSREF+5,C' '                                                   
         L     R7,FULL                                                          
         USING DLPOSTD,R7                                                       
         SPACE 2                                                                
...
*              DDFLDIND                                                         
       ...
       ++INCLUDE DDFLDIND                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020ACBAT1F   05/01/02'                                      
         END                                                                    
