*          DATA SET PPPUB0CS   AT LEVEL 012 AS OF 05/01/02                      
*PHASE T4060CA,+0,NOAUTO                                                        
         TITLE 'CHANGE LOG'                                                     
*                                                                               
...
*****    BAS   RE,GETPUB                                                        
*****    XC    PUBAREC(250),PUBAREC     CLEAR PUB RECORD AREA                   
...
*                                                                               
*****    BAS   RE,MOVE             CANNOT USE - WORK ONLY 48 BYTES              
*****    MVC   PUBAOEAD,WORK                                                    
         MVC   WORK60,SPACES                                                    
         ZIC   R1,5(R2)            INPUT DATA LENGTH                            
         BCTR  R1,0                                                             
...
*                                  NO - RECORD EXISTS                           
         ...
         BAS   RE,PUTPUB           REWRITE "EMPTY" RECORD                       
         MVI   KEY+25,X'FF'                                                     
...
*                                                                               
*****    CLC   AGYALPHA,=C'SJ'        NOW ONLY FOR SJR                          
*****    BNE   PUTVX                                                            
*                                                                               
         LA    R6,ADRLIS1                                                       
         LA    R5,ADRLIS1                                                       
*****    LA    R4,PUBAREC+33                                                    
*****PUTV2    BAS   RE,VNEXTEL                                                  
         LA    R4,KEY                                                           
         XC    KEY,KEY                                                          
         MVC   PUBAKMED,BMED            MEDIA                                   
         MVC   PUBAKPUB(6),BPUB         PUB                                     
...
PUTV4    CLI   0(R5),X'FF'                                                      
         ...
         LA    R5,2(R5)                                                         
*                                                                               
PUTV6    LA    RE,77(R6)           SEE IF I HAVE 3 MORE BYTES                   
...
BCODE    DS    CL3                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012PPPUB0CS  05/01/02'                                      
         END                                                                    
