*          DATA SET SRDSPUB02B AT LEVEL 023 AS OF 02/18/99                      
*PHASE PPSD02B,+0,NOAUTO           NOTE "B" APPENDED TO PHASE NAME              
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE SORTER                                                                 
         TITLE 'PPSD02 - CREATE GENFILE SRDS PUB RECORDS (FLAT FILE)'           
*                                                                               
*      *********  PROGRAM SORTS ISSUE RECORDS ON INPUT  *********               
*                                                                               
...
PPSD02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,PPSD02,R9,R7      NOTE R9 AS SECOND BASE                       
*                                       R7 AS THIRD  BASE                       
         L     RA,0(R1)                                                         
         USING PPWORKD,RA                                                       
         L     RC,PPFILEC                                                       
...
RUNF     DS    0H                                                               
*                                  CLEAR ACCUMULATORS                           
         LA    R0,COUNTNUM         NUMBER OF 4-BYTE PACKED COUNTERS             
         LA    RE,COUNTS           START OF 4-BYTE PACKED COUNTERS              
RUNFCLR  ZAP   0(4,RE),=P'0'                                                    
         LA    RE,4(RE)                                                         
         BCT   R0,RUNFCLR                                                       
         XC    MAXI,MAXI           SIZE OF LARGEST "MAIN" RECORD                
*                                                                               
         B     EXIT                                                             
*                                                                               
...
*                                                                               
**********************************************************************          
***      SORT ISSUREC ("MID"(ISPNUM),"SEQUENCE NUMBER"(ISSEQN),                 
***              "DATE TIME SEQUENCE"(ISDTSEQ))                                 
**********************************************************************          
*                                                                               
...
*                                                                               
         LA    R5,ISSUREC                                                       
         USING ISSUE,R5                                                         
IRSORT   MVI   WORK,C'I'           READ ISSUE RECORD                            
         GOTO1 =A(GETSREC)                                                      
         CLI   ISSUREC,X'FF'       ANY MORE ISSUE RECORDS ?                     
         BE    IRSEND              NO - SORTING DONE                            
*                          MAKE SURE SORT FIELDS ARE RIGHT-JUSTIFIED            
         MVC   WORK(10),SPACES     SPACE-FILL "WORK" FIELD                      
         LA    R0,10               LUP COUNTER                                  
         LA    R3,WORK+9           END OF "WORK" FIELD                          
         LA    R4,ISSEQN+9         END OF INPUT FIELD                           
IRS20    CLI   0(R4),C' '          ANY "ENTRY" ?                                
         BNH   IRS30               NO                                           
         MVC   0(1,R3),0(R4)       YES - MOVE                                   
         BCTR  R3,0                MOVE LEFT 1 (OUTPUT)                         
IRS30    BCTR  R4,0                MOVE LEFT 1 (INPUT)                          
         BCT   R0,IRS20            NEXT CHARACTER                               
         MVC   ISSEQN(10),WORK     REPLACE CONVERTED FIELD                      
*                                                                               
         MVC   WORK(10),SPACES     SPACE-FILL "WORK" FIELD                      
         LA    R0,10               LUP COUNTER                                  
         LA    R3,WORK+9           END OF "WORK" FIELD                          
         LA    R4,ISDTSEQ+9        END OF INPUT FIELD                           
IRS40    CLI   0(R4),C' '          ANY "ENTRY" ?                                
         BNH   IRS50               NO                                           
         MVC   0(1,R3),0(R4)       YES - MOVE                                   
         BCTR  R3,0                MOVE LEFT 1 (OUTPUT)                         
IRS50    BCTR  R4,0                MOVE LEFT 1 (INPUT)                          
         BCT   R0,IRS40            NEXT CHARACTER                               
         MVC   ISDTSEQ(10),WORK    REPLACE CONVERTED FIELD                      
*                                                                               
         GOTO1 =V(SORTER),DMCB,=C'PUT',ISSUREC       RECORD TO SORT             
*                                                                               
         B     IRSORT              NEXT RECORD                                  
*                                                                               
SORTCARD DC    CL80'SORT FIELDS=(1,9,A,150,12,A),FORMAT=BI,WORK=1'              
RECCARD  DC    CL80'RECORD TYPE=F,LENGTH=165'                                   
*                                                                               
IRSEND   XC    ISSUREC(22),ISSUREC                                              
*                                                                               
         DROP  R5                                                               
*                                                                               
**********************************************************************          
...
MAINP60  XC    GKEY,GKEY                                                        
         ...
         MVC   GKEYSAVE,GKEY                                                    
*                                                                               
         AP    CNT00,=P'1'         NO OF MAIN SIZE RECORDS WRITTEN              
*                                                                               
*    *****************************************************************          
...
*******************************************************                         
*         IF ADDRESS LINES 1 AND/OR 2 ARE BLANK       *                         
*         SHIFT ADDRESS LINES 2 AND/OR 3 "UP"         *                         
*******************************************************                         
         CLC   GPUBRAL1,SPACES                                                  
         BH    MAINP82                                                          
         MVC   GPUBRAL1,GPUBRAL2                                                
         MVC   GPUBRAL2,GPUBRAL3                                                
         MVC   GPUBRAL3,SPACES                                                  
         CLC   GPUBRAL1,SPACES                                                  
         BH    MAINP82                                                          
         MVC   GPUBRAL1,GPUBRAL2                                                
         MVC   GPUBRAL2,SPACES                                                  
MAINP82  CLC   GPUBRAL2,SPACES                                                  
         BH    MAINP95                                                          
         MVC   GPUBRAL2,GPUBRAL3                                                
         MVC   GPUBRAL3,SPACES                                                  
         DROP  R5,R6                                                            
*                                  ADD THE ELEMENT                              
MAINP95  GOTO1 =V(HELLO),DMCB,(C'P',SYSFIL),PCONREC,ELEM,0                      
         CLI   DMCB+12,0                                                        
...
*                                                                               
         ...
         B     DIMEP62             YES - TEST FOR DUPLICATE                     
...
*                                                                               
DIMEP62  DS    0H                  TEST FOR DUPLICATE SIZE-CODE                 
         MVI   ELCODE,GPUBAEQU     X'20' ELEMENT CODE                           
         LA    R2,PCONREC+42       POINT TO FIRST ELEMENT                       
DIMEP65  BAS   RE,NEXTEL           LOOK FOR DIMENSION ELEMENT                   
         BNE   DIMEP70             NOT FOUND - ADD ELEMENT                      
         CLC   GPUBACD,2(R2)       SAME SIZE CODE ?                             
         BE    DIMEP94             YES - PRINT AND SKIP RECORD                  
         B     DIMEP65             LOOK FOR ANOTHER DIME ELEM                   
*                                                                               
         DROP  R5,R6                                                            
*                                                                               
...
BLEEP35  BAS   RE,NEXTEL           LOOK FOR DIMENSION ELEMENT                   
         ...
         CLC   GPUBBCD,2(R2)       SAME SIZE CODE ?                             
...
*                                                                               
         ...
         BE    BLEEP90             YES - PRINT AND SKIP RECORD                  
*                                                                               
*                                  TEST FOR DUPLICATE SIZE-CODE                 
         MVI   ELCODE,GPUBBEQU     X'30' ELEMENT CODE                           
         LA    R2,PCONREC+42       POINT TO FIRST ELEMENT                       
BLEEP65  BAS   RE,NEXTEL           LOOK FOR BLEED AD DIMENSION ELEMENT          
         BNE   BLEEP70             NOT FOUND - ADD ELEMENT                      
         CLC   GPUBBCD,2(R2)       SAME SIZE CODE ?                             
         BE    BLEEP94             YES - PRINT AND SKIP RECORD                  
         B     BLEEP65             LOOK FOR ANOTHER BLEED ELEM                  
*                                                                               
         DROP  R5,R6                                                            
*                                  ADD THE ELEMENT                              
BLEEP70  GOTO1 =V(HELLO),DMCB,(C'P',SYSFIL),PCONREC,ELEM,0                      
         CLI   DMCB+12,0                                                        
...
*                                                                               
         ...
         CLI   GPUBFCD,C'1'        LESS THAN 1 ?                                
         BL    SAFEP92             YES - PRINT AND SKIP RECORD                  
         CLI   GPUBFCD,C'6'        GREATER THAN 6 ?                             
         BH    SAFEP92             YES - PRINT AND SKIP RECORD                  
...
*                                                                               
*                               TEST FOR DUPLICATE SAFETY CODE                  
         MVI   ELCODE,GPUBFEQU     X'42' ELEMENT CODE                           
         LA    R2,PCONREC+42       POINT TO FIRST ELEMENT                       
SAFEP65  BAS   RE,NEXTEL           LOOK FOR SAFETY ELEMENT                      
         BNE   SAFEP70             NOT FOUND - ADD ELEMENT                      
         CLC   GPUBFCD,2(R2)       SAME SAFETY CODE ?                           
         BE    SAFEP94             YES - PRINT AND SKIP RECORD                  
         B     SAFEP65             LOOK FOR ANOTHER DIME ELEM                   
*                                                                               
         DROP  R5,R6                                                            
*                                                                               
SAFEP70  DS    0H                  ADD THE ELEMENT                              
         GOTO1 =V(HELLO),DMCB,(C'P',SYSFIL),PCONREC,ELEM,0                      
         CLI   DMCB+12,0                                                        
...
SAFEP90  DS    0H                                                               
         MVC   P+7(9),=C'BAD FRAC*'                                             
         B     SAFEPRT                                                          
SAFEP92  MVC   P+7(9),=C'*NOT 1-6*'                                             
         B     SAFEPRT                                                          
SAFEP94  MVC   P+7(9),=C'DUP CODE*'                                             
SAFEPRT  OC    SAFEREC(50),SPACES                                               
         MVC   P+18(50),SAFEREC                                                 
         MVC   PSECOND+4(50),PUBNMSAV       PUBLICATION NAME                    
         BAS   RE,RPRT             PRINT RECORD                                 
         AP    SAFESKP,=P'1'                                                    
...
ISSUP10  DS    0H                  ISSUE DATE ELEMENT                           
         ...
         BE    ISSUP30             PROCESS THIS RECORD                          
*                            LOW - ERROR FLAG (PRINT) AND SKIP RECORD           
         AP    ISSUSKP,=P'1'                                                    
         CLI   QOPT4,C'Y'          PRINT ALL ERROR MESSAGES ?                   
...
*                                                                               
*                                  ADD THE ELEMENT                              
ISSUP80  GOTO1 =V(HELLO),DMCB,(C'P',SYSFIL),PCONREC,ELEM,=C'ADD=END'            
         CLI   DMCB+12,0                                                        
...
*                                                                               
ISSUPGET DS    0H                                                               
*NOP*    MVI   WORK,C'I'           READ ISSUE RECORD                            
*NOP*    GOTO1 =A(GETSREC)                                                      
*                                                                               
         GOTO1 =V(SORTER),DMCB,=C'GET'                                          
         ICM   RE,15,4(R1)                                                      
         BZ    ISSUPFIN            EOF                                          
         AP    ISSUSRT,=P'1'       NO OF SORTED ISSUE RECS READ                 
         MVC   ISSUREC,0(RE)       PUT SORTED REC IN ISSUE REC                  
*                                                                               
         B     ISSUP10                                                          
*                                                                               
ISSUPFIN DS    0H                                                               
         MVI   ISSUREC,X'FF'       NO MORE SORTED ISSUE RECORDS                 
*                                                                               
ISSUPEND DS    0H                  CHECK FOR OUTPUT                             
         CLI   PCONREC+42,0        ANY ELEMENTS ADDED ?                         
*NOP*    BNH   DIGIPROC            NO - CHECK DIGITAL DATA RECORDS              
         BNH   MAINP               NO                                           
         AP    CNT01,=P'1'         NO OF ISSUE SIZE RECORDS WRITTEN             
...
*                                                                               
         ...
         LH    R1,HALF                                                          
         CLI   PCONREC+26,0        MAIN RECORD ?                                
         BNE   POP10               NO                                           
         CH    R1,MAXI                                                          
         BNH   POP10                                                            
         STH   R1,MAXI             NEW MAXIMUM LENGTH                           
         MVC   MAXINUM,PCONREC+14  NUMBER OF LONGEST RECORD                     
POP10    LA    R1,4(R1)            TOTAL LENGTH OF RECORD                       
         STCM  R1,3,PCONREC-4                                                   
*                                                                               
         AP    WRTCNT,=P'1'        RECORDS TO BE WRITTEN                        
*                          ********  DUMP LARGEST KNOWN RECORD                  
*NOP*    B     POP20       *NOP* THIS BRANCH TO SHOW LONG REC                   
         CLC   =C'B053899',PCONREC+14                                           
         BNE   POP20                                                            
         MVC   P(14),=C'** LONG REC **'                                         
         BAS   RE,RPRT                                                          
         BAS   RE,DMPREC                                                        
*                                                                               
POP20    CLI   RCWRITE,C'N'        WRITE RECORD ?                               
         BE    POP44               NO                                           
******************  TESTING BELOW  ****************************                 
         CP    OUTCNT,=P'199'      200 RECORDS WRITTEN ?                        
         BH    POP44               YES - DON'T WRITE MORE                       
         AP    OUTCNT,=P'1'                                                     
******************  TESTING ABOVE  ****************************                 
         PUT   OUT,PCONREC-4                                                    
         AP    PUTCNT,=P'1'        RECORDS PHSICALLY WRITTEN                    
*                                                                               
...
DMPREC   NTR1                                                                   
         ...
         LH    R2,HALF                                                          
         LA    R2,4(R2)            LENGTH INCLUDING 4-BYTE SIZE FIELD           
         LA    R3,0(R5,R2)                                                      
DMPREC2  DS    0H                                                               
         LR    R4,R3                                                            
         SR    R4,R5                                                            
...
***                                I/O ROUTINES                                 
GETSREC  CSECT                                                                  
         NMOD1 0,GETSREC           NOTE: DO NOT USE R9 OR R7 IN THIS            
         USING PPWORKD,RA                CSECT - THEY ARE NEEDED TO             
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDM)           READ MAIN (PUB NAME) RECORDS                *         
***********************************************************************         
GETMAIN  DS    0H                                                               
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDH)           READ HEAD (ADDRESS) RECORDS                 *         
***********************************************************************         
GETHEAD  DS    0H                                                               
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDF)      READ TITLE (CLASSIFICATION TITLE) RECORDS        *         
***********************************************************************         
GETTITL  DS    0H                                                               
...
*                                                                               
***********************************************************************         
*    (PRT.PPSDC)        READ CORP (CORPORATE OWNER) RECORDS           *         
***********************************************************************         
GETCORP  DS    0H                                                               
         CLI   CORPREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDP)          READ PERSON (PERSONNEL DATA) RECORDS         *         
***********************************************************************         
GETPERS  DS    0H                                                               
         CLI   PERSREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*    (PRT.PPSDT)       READ SHIP (SHIPPING ADDRESS) RECORDS           *         
***********************************************************************         
GETSHIP  DS    0H                                                               
         CLI   SHIPREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDD)        READ DIMENS (AD SIZE DIMENSIONS) RECORDS       *         
***********************************************************************         
GETDIME  DS    0H                                                               
         CLI   DIMEREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*    (PRT.PPSDB)    READ BLEED (BLEED AD SIZE DIMENSIONS) RECORDS     *         
***********************************************************************         
GETBLEE  DS    0H                                                               
         CLI   BLEEREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDE)     READ MECH (MECHANICAL DATA) RECORDS               *         
***********************************************************************         
GETMECH  DS    0H                                                               
         CLI   MECHREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDS)     READ SAFETY (SAFETY DIMENSIONS) RECORDS           *         
***********************************************************************         
GETSAFE  DS    0H                                                               
         CLI   SAFEREC,X'FF'       NO MORE RECORDS ?                            
         BE    GETEXIT                                                          
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDR)       READ PRINTD (PRINT DATA) RECORDS                *         
***********************************************************************         
GETPRIN  DS    0H                                                               
...
*                                                                               
***********************************************************************         
*   (PRT.PPSDI)       READ ISSUE (ISSUE DATES) RECORDS                *         
***********************************************************************         
GETISSU  DS    0H                                                               
...
*                                                                               
***********************************************************************         
*    (PRT.PPSDG)     READ DIGITAL (DIGITAL INFORMATION) RECORDS       *         
***********************************************************************         
GETDIGI  DS    0H                                                               
...
MAXI     DS    H                   LARGEST MAIN RECORD SIZE                     
MAXINUM  DS    CL10                LARGEST MAIN RECORD TYPE & MID NO.           
*                                                                               
LASTMAIN DS    CL9                                                              
LASTHEAD DS    CL9                                                              
LASTTITL DS    CL9                                                              
...
DIGICNT  DS    PL4                                                              
DIGISKP  DS    PL4                                                              
OUTCNT   DS    PL4                 RECORDS TO WRITE (LIMIT COUNT)               
WRTCNT   DS    PL4        RECORDS WHICH WOULD BE WRITTEN (IF NO LIMIT)          
*                                                                               
*                     *** NOTE ***  ADD ADDITIONAL COUNTERS ONLY BELOW          
PUTCNT   DS    PL4                 RECORDS PHYSICALLY WRITTEN                   
CNT00    DS    PL4                 MAIN SIZE RECORDS                            
CNT01    DS    PL4                 ISSUE SIZE RECORDS                           
CNT02    DS    PL4                 DIGITAL SIZE RECORDS                         
DUMPCNT  DS    PL4                                                              
ISSUNUM  DS    PL4                                                              
ISSULNG  DS    PL4                                                              
ISSUMNY  DS    PL4                                                              
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023SRDSPUB02B02/18/99'                                      
         END                                                                    
