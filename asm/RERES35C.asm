*          DATA SET RERES35C   AT LEVEL 114 AS OF 05/01/02                      
*PHASE T81935C,*                                                                
*INCLUDE KHDUMMY                                                                
...
*                                                                               
         ...
         MVI   RFTCUBBS,X'48'      UPGRADE SHR BOOK SOURCE                      
         LA    RF,UPGRADE                                                       
         ST    RF,RFTCUPGA                                                      
*                                                                               
...
DRECX    DS    0H                                                               
         B     XIT                 ALL DONE                                     
UPGRADE  DC    X'050E800003D75F056002000000000000'                              
*                                                                               
         EJECT                                                                  
       ++INCLUDE RESVCTAB                                                       
         EJECT                                                                  
...
*                                                                               
       ...
       ++INCLUDE DDGLVXCTLD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'114RERES35C  05/01/02'                                      
         END                                                                    
