*          DATA SET RESFM1AA   AT LEVEL 205 AS OF 03/23/00                      
*PHASE T8181AA,*                                                                
...
VREC100  DS    0H                                                               
         ...
         BE    VREC105             NO CHANGE                                    
         L     R6,AIO2             REPSEC RECORD                                
***>     CLI   SUBSCRN,X'70'       PRG SCREEN                                   
***>     BE    VREC102                                                          
         BAS   RE,DISCODES         DISPLAY SUBSCREEN                            
         B     XIT                 DON'T UPDATE ON THIS PASS                    
VREC102  DS    0H                                                               
***>     GOTO1 =A(DISPGMS),RR=Y                                                 
         B     XIT                                                              
*                                                                               
VREC105  DS    0H                                                               
         CLI   SUBSCRN,X'70'       PROGRAM SECURITY?                            
         BNE   VREC110             NO - PROCEED                                 
***>     GOTO1 =A(VALPGMS),RR=Y    YES - HANDLE PRG VALIDATION                  
         B     VREC500             WRITE RECORD                                 
*                                                                               
...
*                                                                               
DREC150  DS    0H                                                               
***>     GOTO1 =A(DISPGMS),RR=Y    DISPLAY PGM SECURITY                         
*                                                                               
DREC160  DS    0H                                                               
...
*&&DO                                                                           
         CSECT                                                                  
**********************************************************************          
* VALPGMS - HANDLE VALIDATION OF PROGRAM SECURITY SCREEN                        
**********************************************************************          
VALPGMS  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
*                                  DELETE EXISTING ELEMENTS                     
         GOTO1 HELLO,DMCB,(C'D',=C'REPFIL'),(X'70',AIO2),0,0                    
         TM    12(R1),X'FF'-X'06'                                               
         BZ    *+6                                                              
         DC    H'0'                                                             
*                                                                               
         LA    R2,SC6S01H          1ST SECURITY FIELD                           
         LA    R3,PRGTAB           PROGRAM TABLE                                
*                                                                               
VPGM040  DS    0H                  VALIDATE SECURITY LEVEL                      
         XC    WORK,WORK                                                        
         MVC   WORK(12),8(R2)                                                   
         OC    WORK(12),SPACES                                                  
         CLC   WORK(12),SPACES                                                  
         BE    VPGM200             DEFAULT TO UNRESTRICTED                      
*                                                                               
         LA    R4,SECTAB                                                        
         MVI   ERROR,INVALID                                                    
VPGM100  CLI   0(R4),X'FF'         END OF TAB, NO MATCH?                        
         BE    ERREND                                                           
         MVC   WORK+12(12),0(R4)                                                
         OC    WORK+12(12),SPACES                                               
         ZIC   R1,5(R2)                                                         
         LTR   R1,R1                                                            
         BNZ   *+8                                                              
         LA    R1,12                                                            
...
*                                                                               
VPGM110  DS    0H                                                               
         CLI   12(R4),0            UNRESTRICTED ACCESS?                         
         BE    VPGM200             DEFAULT CASE - NO ELEM                       
*                                  BUILD PGM SECURITY ELEM FOR PAR REC          
         XC    ELEM,ELEM                                                        
         LA    R6,ELEM                                                          
         USING RSECPGEL,R6                                                      
         MVI   RSECPGCD,X'70'                                                   
         MVI   RSECPGLN,RSECPGLQ                                                
         MVC   RSECPPGM,15(R3)                                                  
         MVC   RSECPACT,18(R3)                                                  
         MVC   RSECPSEC,12(R4)                                                  
         GOTO1 HELLO,DMCB,(C'P',=C'REPFIL'),AIO2,ELEM,0                         
...
*                                                                               
         LA    R3,L'PRGTAB(R3)                                                  
         CLI   0(R3),X'FF'         END OF PGMS?                                 
         BE    VPGMX                                                            
         LA    R2,SC6S02H-SC6S01H(R2) NEXT FLD IN SAME COLUMN                   
         LA    RF,SC6S24H                                                       
         CR    R2,RF                                                            
         BNH   VPGM040                                                          
*                                                                               
         LA    R2,SC6S13H          START 2ND COLUMN                             
         B     VPGM040                                                          
*                                                                               
VPGMX    XIT1                                                                   
         LTORG                                                                  
**********************************************************************          
* DISPGMS - HANDLE DISPLAY OF PROGRAM SECURITY SCREEN                           
**********************************************************************          
DISPGMS  NTR1  BASE=*,LABEL=*                                                   
         GOTO1 CALLOV,DMCB,(X'A6',SC3LAST),0  PGM SEC SCREEN                    
         CLI   DMCB+4,X'FF'                                                     
         BNE   *+6                                                              
         DC    H'0'                                                             
         BAS   RE,DISPF12          DISP PF12 LABEL (WHEN APPROPRIATE)           
*                                                                               
         LA    R2,SC6P01H          1ST PROGRAM FIELD                            
         LA    R3,PRGTAB           PROGRAM TABLE                                
*                                                                               
DPGM040  DS    0H                                                               
         MVC   8(15,R2),0(R3)      PGM NAME TO SCREEN                           
         OI    6(R2),X'80'                                                      
         ZIC   R1,0(R2)                                                         
         AR    R2,R1               NOW TO CORRESPONDING SEC FIELD               
*                                                                               
         LA    R4,SECTAB           RESET PTR TO SEC TABLE                       
*                                                                               
         LTR   R6,R6               HAVE A SEC RECORD?                           
         BZ    DPGM120             NO                                           
*                                                                               
         GOTO1 HELLO,DMCB,(C'G',=C'REPFIL'),(X'70',AIO2),(6,15(R3)),0           
         CLI   12(R1),0            GOT IT?                                      
         BE    DPGM100             YES                                          
         TM    12(R1),X'06'        NOT FOUND?                                   
         BO    DPGM120             DEFAULT CASE                                 
         DC    H'0'                                                             
*                                                                               
DPGM100  DS    0H                  FIND SECURITY LEVEL IN TABLE                 
         ICM   R6,15,12(R1)        A(70 ELEM)                                   
         USING RSECPGEL,R6                                                      
DPGM110  DS    0H                                                               
         CLI   0(R4),X'FF'                                                      
         BNE   *+6                                                              
         DC    H'0'                SEC LEVEL NOT IN TABLE                       
         CLC   RSECPSEC,12(R4)     MATCH?                                       
         BE    *+12                                                             
         LA    R4,L'SECTAB(R4)                                                  
         B     DPGM110                                                          
*                                                                               
DPGM120  DS    0H                                                               
         MVC   8(12,R2),0(R4)      SEC DESCRIPTION TO SCREEN                    
         OI    6(R2),X'80'                                                      
...
*                                                                               
         ...
         CLI   0(R3),X'FF'         END OF PGMS?                                 
         BE    DPGMX                                                            
         ZIC   R1,0(R2)            NEXT PGM FIELD                               
         AR    R2,R1                                                            
         LA    R2,SC6P02H-SC6P13H(R2) NEXT FLD IN SAME COLUMN                   
         LA    RF,SC6P24H                                                       
         CR    R2,RF                                                            
         BNH   DPGM040                                                          
*                                                                               
         LA    R2,SC6P13H          START 2ND COLUMN                             
         NI    SC6LA1H+1,X'FF'-X'04'                                            
         OI    SC6LA1H+6,X'80'                                                  
         NI    SC6LA2H+1,X'FF'-X'04'                                            
         OI    SC6LA2H+6,X'80'                                                  
         NI    SC6LA3H+1,X'FF'-X'04'                                            
         OI    SC6LA3H+6,X'80'                                                  
         NI    SC6LA4H+1,X'FF'-X'04'                                            
         OI    SC6LA4H+6,X'80'                                                  
         B     DPGM040                                                          
*                                                                               
DPGMX    XIT1                                                                   
...
*&&                                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'205RESFM1AA  03/23/00'                                      
         END                                                                    
