*          DATA SET REREPDAC   AT LEVEL 086 AS OF 11/28/16                      
...
COMDATE  DS    XL2                 TODAY'S DATE - COMPRESSED                    
         SPACE 2                                                                
SORTCARD DC    CL80'SORT FIELDS=(1,8,A),FORMAT=BI'                              
...
PRISKLIT DS    CL40                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'086REREPDAC  11/28/16'                                      
         END                                                                    
