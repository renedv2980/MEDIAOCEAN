*          DATA SET PREXTPUB   AT LEVEL 054 AS OF 05/10/99                      
*PHASE PREXTPUB,+0                                                              
*INCLUDE BINSRCH                                                                
*INCLUDE HEXOUT                                                                 
*INCLUDE RECUP                                                                  
...
*                                                                               
         ...
         BAS   RE,NEXTEL                                                        
         BE    *+14                                                             
         AP    NOX20CNT,=P'1'      NO PRODUCTION ELEM COUNTER                   
         B     DMXKEEP                                                          
*                                                                               
         USING PUBGENEL,R6                                                      
*                                                                               
...
*                                                                               
         ...
         GOTO1 VPRINTER                                                         
         BAS   R4,BLANKLN                                                       
         MVC   P(43),=C'# OF RECORD(S) MISSING PRODUCTION ELEMENT: '            
         EDIT  (P4,NOX20CNT),(9,P+43),COMMAS=YES                                
         GOTO1 VPRINTER                                                         
         BAS   R4,BLANKLN                                                       
*                                                                               
         B     DMXIT                                                            
...
*DDDPRINT                                                                       
       ++INCLUDE DDDPRINT                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'054PREXTPUB  05/10/99'                                      
         END                                                                    
