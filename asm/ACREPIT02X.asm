*          DATA SET ACREPIT02X AT LEVEL 032 AS OF 05/01/02                      
*PHASE ACIT02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*                                                                               
...
REQI030  MVC   USERCHG(2),=C'JI'                                                
         ...
         BE    *+12                                                             
         CLI   RCCOMPFL,X'B3'      IS THIS OANYA                                
         BNE   REQX                NO                                           
...
VENTAB   DS    0CL15                                                            
         ...
         DC    HL2'2330',C'0000500050808'  OANYA - OGILVY AND MATHER            
...
JBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE ACJOBBERD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'032ACREPIT02X05/01/02'                                      
         END                                                                    
