*          DATA SET REREPBB02  AT LEVEL 209 AS OF 08/31/00                      
*          DATA SET REREPBB02  AT LEVEL 208 AS OF 09/14/99                      
*PHASE REBB02A                                                                  
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH2                                                               
...
*                                  STATION                                      
         DC    X'1',AL2(RCONTYPE-RCONREC),X'00',C' ',AL1(1),X'00'               
*                                  CONTYPE                                      
...
LDAT0020 EQU   *                                                                
         ...
         STCM  RF,15,WORK2+6                                                    
*                                                                               
         XC    WORK,WORK           RESOLVE BUCKET ACTIVITY DATE                 
         MVC   WORK(2),WORK2+2     Y/M                                          
         MVI   WORK+2,15           D                                            
         GOTO1 DATCON,DMCB,(3,WORK),(0,WORK+3)  YYMMDD                          
         GOTO1 ADDAY,DMCB,WORK+3,WORK+9,30      +30 DAYS                        
         GOTO1 GETBROAD,DMCB,WORK+9,WORK+15,GETDAY,ADDAY                        
         CLC   WORK+11(2),WORK+17  SAME CAL MONTH?                              
         BE    LDAT0030                                                         
         GOTO1 ADDAY,DMCB,WORK+15,WORK+15,7 NO - NEXT WEEK                      
LDAT0030 DS    0H                                                               
         GOTO1 DATCON,DMCB,(0,WORK+15),(2,WORK2+4)                              
*                                                                               
...
*********************************************************************           
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'209REREPBB02 08/31/00'                                      
         END                                                                    
