*          DATA SET SPSFM74    AT LEVEL 042 AS OF 10/21/09                      
*PHASE T21774A                                                                  
***********************************************************************         
*                                                                     *         
*  TITLE:        SPSFM74 -- DARE FLIGHT RECORDS                       *         
*                                                                     *         
*  INPUTS:       SCREENS SCSFM30 (MAINTENANCE)                        *         
*                        SCSFM31 (LIST)                               *         
*  OUTPUTS:                                                           *         
*                                                                     *         
*  REGISTERS:    R0 -- WORK                                           *         
...
*                                                                     *         
***********************************************************************         
T21774   TITLE 'SPSFM74 - DARE FLIGHTS'                                         
***********************************************************************         
*============================= UPDATE LOG ============================*         
...
INVLFLD  MVI   ERROR,INVALID                                                    
         B     MYERREX                                                          
*                                                                               
INVLDATE MVI   ERROR,INVDATE       INVALID DATE                                 
         B     MYERREX                                                          
*                                                                               
CANTCHNG MVI   ERROR,70            MAY NOT CHANGE THIS FIELD                    
         B     MYERREX                                                          
*                                                                               
INVLESTM MVI   ERROR,71            INVALID ESTIMATE                             
         B     MYERREX                                                          
*                                                                               
DATRNERR MVI   ERROR,97            DATE IS OUTSIDE OF ESIMATE RANGE.            
         B     MYERREX                                                          
*                                                                               
SEQERR   MVI   ERROR,194           DATES MUST BE IN SEQUENCE                    
         B     MYERREX                                                          
*                                                                               
MISSEDAT MVI   ERROR,206           ORDERS EXISTS, END DATE IS REQUIRED          
         B     MYERREX                                                          
*                                                                               
B41STFLT MVI   ERROR,207           END DATE MUST BE BEFORE 1ST FLIGHT           
         B     MYERREX                                                          
*                                                                               
POLERR   MVI   ERROR,252           PRODUCT MUST BE POL                          
         B     MYERREX                                                          
*                                                                               
SKIPERR  MVI   ERROR,253           CANNOT SKIP THIS FIELD                       
         B     MYERREX                                                          
*                                                                               
PRDAAAER MVI   ERROR,254           PRODUCT AAA DOES NOT EXIST                   
         B     MYERREX                                                          
*                                                                               
CANTADDF MVC   ERRNUM,=AL2(259)    CANNOT ADD THIS FLIGHT RECORD!               
*                                                                               
TWOBYTER DS    0H                                                               
         ...
         MVC   GTMSGNO,ERRNUM                                                   
         MVI   GTMTYP,GTMERR                                                    
         MVI   GTMSYS,23           USING SSYTEM 23 ERROR HERE                   
         MVC   AIO,AIO1                                                         
         GOTO1 ERREX                                                            
*                                                                               
CURSERRX MVI   ERROR,REQFIELD                                                   
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE SPSFMFFD          (BASE SCREEN FOR SYSTEM)                     
         EJECT                                                                  
         ORG   CONTAGH                                                          
       ++INCLUDE SCSFM30D          (OUR MAINTENANCE SCREEN)                     
         EJECT                                                                  
         ORG   CONTAGH                                                          
       ++INCLUDE SCSFM31D          (OUR LIST SCREEN)                            
         EJECT                                                                  
       ++INCLUDE DDGENTWA                                                       
         EJECT                                                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'042SPSFM74   10/21/09'                                      
         END                                                                    
