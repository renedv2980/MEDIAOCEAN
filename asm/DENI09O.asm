*          DATA SET DENI09O    AT LEVEL 058 AS OF 02/22/18                      
*PROCESS USING(WARN(15))                                                        
*PHASE DENI09OA                                                                 
*INCLUDE DEBKUPDT                                                               
         TITLE 'OUTPUT PHASE (VARIOUS) WEEKLY SYNDICATION CONVERSION'           
DENI09O  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         ...
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DENI09O+4096,R7     R7=2ND BASE REGISTER                         
...
SVDA     DS    CL4                                                              
SVSTATUS DS    C                                                                
SORTCARD DC    C'SORT FIELDS=(5,20,A,BI) '                                      
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058DENI09O   02/22/18'                                      
         END                                                                    
