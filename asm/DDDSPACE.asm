*          DATA SET DDDSPACE   AT LEVEL 006 AS OF 05/01/02                      
*PHASE DDDSPACE                                                                 
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
*                                                                               
         ...
         LA    R4,15(R2)                                                        
         ST    R4,DUB+4                                                         
         GOTO1 =V(HEXOUT),DMCB,DUB,LONG,L'DUB,0                                 
         MVC   PLINE+02(8),LONG+00                                              
         MVI   PLINE+10,C'-'                                                    
         MVC   PLINE+11(8),LONG+08                                              
*                                                                               
         GOTO1 =V(HEXOUT),DMCB,HEX,NUM,L'HEX,0                                  
*                                                                               
         MVC   PLINE+20(8),NUM+00                                               
         MVC   PLINE+29(8),NUM+08                                               
         MVC   PLINE+38(8),NUM+16                                               
         MVC   PLINE+47(8),NUM+24                                               
         MVC   PLINE+56(8),NUM+32                                               
         MVC   PLINE+65(8),NUM+40                                               
         MVC   PLINE+74(8),NUM+48                                               
         MVC   PLINE+83(8),NUM+56                                               
*                                                                               
         TR    HEX,TRTAB                                                        
         MVC   PLINE+93(32),HEX                                                 
         BAS   RE,PRINTL                                                        
...
* FASCTTAB                                                                      
       ...
       ++INCLUDE FASCTTAB                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006DDDSPACE  05/01/02'                                      
         END                                                                    
