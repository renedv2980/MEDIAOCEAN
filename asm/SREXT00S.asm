*          DATA SET SREXT00S   AT LEVEL 004 AS OF 05/01/02                      
*PHASE T10A00A                                                                  
*INCLUDE BUPPER                                                                 
*&&UK                                                                           
*INCLUDE MEWS                                                                   
...
EXT10    TM    SRJOBSTA,SRJOBUPD   TEST EXTRACT UPDATE PENDING                  
         ...
         MVC   CIA,SRJOBCIA        SAVE REPORT C/I ADDRESS                      
...
EXT14    LA    R3,SRUPDQ-SRSD      SEARCH UPDATE Q FOR ENTRY                    
         ...
         LA    R0,SRUPDMAX                                                      
*                                                                               
EXT16    CLC   SRUPDCIA,CIA        LOCATE UPDATE Q ENTRY FOR REPORT             
         BE    EXT18                                                            
...
UPDWORKL EQU   *-UPDWORKD                                                       
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004SREXT00S  05/01/02'                                      
         END                                                                    
