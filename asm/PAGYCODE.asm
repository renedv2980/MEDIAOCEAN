*          DATA SET PAGYCODE   AT LEVEL 033 AS OF 05/01/02                      
*PHASE PAGYCODA PAGYCODE                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PAGYCODE - CHANGE AGENCY CODE'                                  
         PRINT NOGEN                                                            
*                                                                               
...
*                                                                               
PAGYCODE CSECT                                                                  
         NBASE 0,PAGYCODE,=V(REGSAVE)                                           
         SPACE 2                                                                
         LA    R6,PAGYCODE+4095                                                 
         LA    R6,1(R6)                                                         
         USING PAGYCODE+4096,R6                                                 
...
CHANGCNT DC    PL5'0',CL20'CHANGED RECORD COUNT'                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'033PAGYCODE  05/01/02'                                      
         END                                                                    
