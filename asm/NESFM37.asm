*          DATA SET NESFM37    AT LEVEL 018 AS OF 11/09/05                      
*          DATA SET SPTRA2F    AT LEVEL 004 AS OF 06/24/98                      
*PHASE T31C37A,*                                                                
         TITLE 'T31C37 NETWORK TRAFFIC SUPPLIER RECORD DISPLAY, CHANGE,X        
                AND LIST'                                                       
***********************************************************************         
...
VR110    LA    RF,L'FAXN(RF)       POINT TO THE NUMBER                          
         MVI   0(RF),C' '                                                       
         SPACE                                                                  
         LA    RF,1(RF)                                                         
         ...
         SPACE                                                                  
         GOTO1 ADDELEM                                                          
* CHECK IF WHOLE NUMBER INPUTTED OR NOT INPUTTED                                
         OC    TSUPNOA,TSUPNOA                                                  
         BZ    VR130                                                            
*  NUMBER INPUTTED CHECK REST OF FIELDS                                         
         OC    TSUPNOE,TSUPNOE                                                  
         BZ    MISSERR                                                          
         OC    TSUPNON,TSUPNON                                                  
         BZ    MISSERR                                                          
         B     VR150                                                            
*                                                                               
*  NUMBER NOT INPUTTED CHECK REST OF FIELDS                                     
VR130    OC    TSUPNOE,TSUPNOE                                                  
         BNZ   MISSERR                                                          
         OC    TSUPNON,TSUPNON                                                  
         BNZ   MISSERR                                                          
         SPACE                                                                  
...
*        SPACE                                                                  
*        MVC   TRANET,TSUPKNET     DISPLAY NETWORK                              
*        MVC   TRAPRG,TSUPKPRG             PROGRAM                              
DK10     MVC   TRATSUP,TSUPKTS             OFFICE NUMBER                        
         SPACE                                                                  
*        OI    TRACLTH+6,X'80'                                                  
...
LR20     GOTO1 SEQ                 DO READ SEQUENTIAL                           
         SPACE                                                                  
LR22     LA    R4,KEY                                                           
         CLC   KEY(2),MYSVKEY      AT END OF THIS AGENCY/MEDIA                  
         BNE   EXIT                YES                                          
         SPACE                                                                  
...
LRR      LA    R5,P                PRINT LINE ADDRESS                           
         ...
         USING TSUPDSEL,R6                                                      
         SPACE                                                                  
         MVC   PDESC,TSUPDESC      PRINT DESCRIPTION                            
         DROP  R6                                                               
         SPACE                                                                  
LRR10    L     R6,AIO                                                           
         MVI   ELCODE,X'10'                                                     
...
SVPREFIX DS    CL1                                                              
         SPACE                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018NESFM37   11/09/05'                                      
         END                                                                    
