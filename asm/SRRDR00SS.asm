*          DATA SET SRRDR00SS  AT LEVEL 104 AS OF 12/04/03                      
*PHASE T16200C                                                                  
*INCLUDE XSORT                                                                  
*INCLUDE REREPDIF                                                               
*INCLUDE GETBROAD                                                               
...
*                                                                               
         ...
         BNE   SRRD0060            NO  - SKIP IT, DON'T RESET IT                
...
*                                  CONVERT AND STORE NUMBER PER WEEK            
         CVB   RF,DUB                                                           
         STCM  RF,1,RDARBUWK      INSERT NUMBER PER WEEK                        
...
*                                                                               
         ...
         BE    AGYT0060                                                         
         PRINT GEN                                                              
*        GOTO1 SNDERROR,DMCB,301   NO  - SEND ERROR MESSAGE                     
...
AGYT0060 EQU   *                                                                
         ...
         BE    AGYT0100            YES                                          
*        GOTO1 SNDERROR,DMCB,302   NO  - SEND ERROR MESSAGE                     
         GOTO1 =A(SNDERROR),DMCB,302,RR=RELO                                    
AGYT0100 EQU   *                                                                
         BAS   RE,RECWRITE         OUTPUT THE RECORD                            
*                                                                               
*                                  RECORD AUDIT TRAIL                           
         GOTO1 =A(AUDTRAIL),RR=RELO                                             
         CLI   OLDMEDI,C'R'        SKIP COMPARE/PASSIVE PTR FOR NONROM          
         BNE   AGYTX                                                            
         GOTOR COMPARE                                                          
...
*                                                                               
         ...
         MVC   RMKGKSTA,MOAPQSTA   INSERT STATION                               
...
*                                                                               
         ...
         MVC   RMKGKREP,POWERCDE   INSERT REP ID                                
         MVC   RMKGKOFF,MGOFF      INSERT OFFICE CODE                           
         MVC   RMKGKSTA,MORJQSTA   INSERT STATION                               
         CLI   RMKGKSTA+4,C'T'     TV STATION?                                  
         BNE   MGRJ0050            NO                                           
         MVI   RMKGKSTA+4,C' '     YES - SPACE-FILL MEDIA                       
MGRJ0050 EQU   *                                                                
...
*                                                                               
         DS    0F                  ALIGNMENT                                    
RECTABLE EQU   *                                                                
         DC    CL6'AGYHDR',XL1'01,00',AL4(AGYHDR)                               
LRECTAB  EQU   *-RECTABLE          SIZE OF ENTRY                                
         DC    CL6'AGYDS1',XL1'01,00',AL4(AGYDS1)                               
         DC    CL6'AGYDS2',XL1'01,00',AL4(AGYDS2)                               
         DC    CL6'AGYDS3',XL1'01,00',AL4(AGYDS3)                               
         DC    CL6'AGYDS4',XL1'01,00',AL4(AGYDS4)                               
         DC    CL6'AGYDS5',XL1'01,00',AL4(AGYDS5)                               
         DC    CL6'AGYEDI',XL1'01,00',AL4(AGYEDI)                               
         DC    CL6'AGYSTD',XL1'02,00',AL4(AGYSTD)                               
         DC    CL6'AGYCOM',XL1'03,00',AL4(AGYCOM)                               
         DC    CL6'BUYHDR',XL1'04,00',AL4(BUYHDR)                               
         DC    CL6'BUYDEM',XL1'04,00',AL4(BUYDEM)                               
         DC    CL6'BUYORB',XL1'05,00',AL4(BUYORB)                               
         DC    CL6'BUYCOM',XL1'06,00',AL4(BUYCOM)                               
         DC    CL6'BUYDTL',XL1'07,00',AL4(BUYDTL)                               
         DC    CL6'AGYTLR',XL1'08,00',AL4(AGYTLR)                               
         DC    CL6'AGYCAN',XL1'09,00',AL4(AGYCAN)                               
         DC    CL6'AGYHIA',XL1'10,00',AL4(AGYHIA)                               
         DC    CL6'MKGAPP',XL1'11,00',AL4(MKGAPP)                               
         DC    CL6'MKGREJ',XL1'12,00',AL4(MKGREJ)                               
         DC    CL6'MKGRCM',XL1'12,00',AL4(MKGRCM)                               
*                                                                               
...
*                                                                               
         DC    CL6'VARHDR',XL1'13,00',AL4(AGYHDR)                               
         DC    CL6'VARDS1',XL1'13,00',AL4(AGYDS1)                               
         DC    CL6'VARDS2',XL1'13,00',AL4(AGYDS2)                               
         DC    CL6'VARDS3',XL1'13,00',AL4(AGYDS3)                               
         DC    CL6'VARDS4',XL1'13,00',AL4(AGYDS4)                               
         DC    CL6'VAREDI',XL1'13,00',AL4(AGYEDI)                               
         DC    CL6'VARSTD',XL1'14,00',AL4(AGYSTD)                               
         DC    CL6'VARCOM',XL1'15,00',AL4(AGYCOM)                               
         DC    CL6'VARTLR',XL1'16,00',AL4(AGYTLR)                               
         DC    CL6'VARCAN',XL1'17,00',AL4(AGYCAN)                               
         DC    CL6'VARHIA',XL1'18,00',AL4(AGYHIA)                               
*                                                                               
         DC    CL6'VARPRD',XL1'19,00',AL4(VARPRD)                               
*                                                                               
...
ADDPPSON NTR1  BASE=*,LABEL=*                                                   
         ...
         BNE   ADDPPX              NO                                           
         CLI   RDARMEDI,C'R'                                                    
         BNE   ADDPPX              HARD CODE AN 0A POINT PERSON ELT             
*                                                                               
...
*                                                                               
         ...
         GOTO1 VADDAY,DMCB,ROCFDATE,ROCFDATE,F'1'                               
*                                                                               
CONF60   DS    0H                                                               
         ICM   R1,15,WORK                                                       
...
*                                                                               
         BAS   RE,DELETOLD         DELETE EXISTING RECORDS                      
...
AHDR0047 GOTO1 VHEXOUT,DMCB,RDARREP#,PAHDRPCN,4                                 
         ...
         DROP  R6                                                               
*                                                                               
AHDR0050 DS    0H                  BAD CONTRACT, CLEAR AND CONTINUE             
         XC    RDARREP#,RDARREP#                                                
         B     AHDR0047                                                         
***********************************************************************         
...
AHDRX    DS    0H                                                               
         B     EXIT                                                             
*                                                                               
AHDR0500 PACK  DUB(8),PAHDQEST(0)  PACK BY LENGTH                               
*                                                                               
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
ACAN0100 DS    0H                                                               
         CLI   RDARMEDI,C'R'       REBUILD KEYS FOR RADIO ONLY                  
         BE    ACAN0110                                                         
...
*                                                                               
         ...
         GOTO1 VADDAY,DMCB,MDNTDATE,MDNTDATE,F'1'                               
*                                                                               
...
*                                                                               
         ...
         BL    DOMOK20                                                          
         SP    WORK(4),=P'240000'  YES, BUMP TO NEXT DAY AND ADJUST             
         GOTO1 VADDAY,DMCB,MOCFDATE,MOCFDATE,F'1'                               
*                                                                               
DOMOK20  DS    0H                                                               
         ICM   R1,15,WORK                                                       
         SRL   R1,12               SHIFT OFF SECONDS AND SIGN                   
...
RSALRECD DSECT                                                                  
       ++INCLUDE REGENSAL                                                       
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'104SRRDR00SS 12/04/03'                                      
         END                                                                    
