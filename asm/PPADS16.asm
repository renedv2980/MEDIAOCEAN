*          DATA SET PPADS16    AT LEVEL 005 AS OF 02/12/99                      
*PHASE T40B16A,*                                                                
*INCLUDE BINSRCH2                                                               
*        TITLE 'PPADS16 - MISC. NOTES'                                          
         TITLE 'PPADS16 - MISC. NOTES - HISTORY'                                
**********************************************************************          
*                                                                    *          
*        PPADS16 (T40B16) --- MISC. NOTES                            *          
*                                                                    *          
* ------------------------------------------------------------------ *          
* UPDATE HISTORY:                                                    *          
*                                                                    *          
...
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - VALMODE'                                
**********************************************************************          
*                                                                    *          
*        PPADS16 (T40B16) --- MISC. NOTES                            *          
*                                                                    *          
...
*                                                                               
         LA    R2,NTETITH          TITLE - NOT REQUIRED                         
*                                                                               
...
*                                                                               
         ...
         B     VKNEWX                                                           
*                                                                               
         TM    NTETYPH+4,X'80'     IF PUB TYPE INPUT THIS TIME                  
         BO    *+8                                                              
         TM    NTETITH+4,X'80'     IF TITLE    INPUT THIS TIME                  
         BNO   VKNEWX                                                           
*                                                                               
...
BUMPU    ZIC   RF,0(R2)            BUMP TO NEXT UNPROTECTED FIELD               
         ...
         BR    RE                                                               
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - GETEL'                                  
***********************************************************************         
*                                                                     *         
*        GETEL MACRO                                                  *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - LINSET'                                 
**********************************************************************          
*                                                                    *          
*   LINUP INTERFACE                                                  *          
...
*                                                                               
         CLI   NTESCRL,C'P'        CHECK FOR PAGE SCROLL                        
         JE    *+8                                                              
         CLI   NTESCRL,X'97'         LOWERCASE 'P'                              
         JNE   *+8                                                              
         MVI   LUSCROLL,LUPAGEQ                                                 
*                                                                               
         CLI   NTESCRL,C'H'        CHECK FOR HALF PAGE SCROLL                   
         JE    *+8                                                              
         CLI   NTESCRL,X'88'            LOWERCASE 'H'                           
         JNE   *+8                                                              
         MVI   LUSCROLL,LUHALFQ                                                 
*                                                                               
         TM    NTESCRLH+4,X'08'    SKIP IF NOT A NUMERIC FIELD                  
         JNO   LS051                                                            
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,NTESCRLH+5     FIELD INPUT LENGTH                           
         JZ    LS051               NO ENTRY                                     
*                                                                               
         ...
         EX    RF,8(RE)                                                         
         B     *+10                                                             
         PACK  DUB,NTESCRL(0)      CONVERT SCROLL AMOUNT TO NUMBER              
*                                                                               
         CVB   RF,DUB                                                           
...
*                                                                               
         ...
         LA    R1,NTEMOR1H         POINT TO FIRST MORE FIELD                    
*                                                                               
...
*                                                                               
         ...
         MVC   FLD(2),=C'<<'                                                    
*                                                                               
         MVC   NTEMOR1,FLD         DISPLAY IT                                   
         OI    NTEMOR1H+6,FOUTTRN  TRANSMIT FIELD                               
*                                                                               
LSLOW    DS    0H                                                               
*                                                                               
         MVC   FLD,SPACES          INIT WORK OUTPUT AREA                        
         LA    R1,NTEMORLH         POINT TO LAST MORE FIELD                     
*                                                                               
         TM    LUSTAT,LUCLEARQ     CLEAR LOWER MORE FIELD IF SCREEN             
         JO    LSLOWOUT              CLEARED                                    
*                                                                               
...
LSLOWOUT DS    0H                                                               
*                                                                               
         MVC   NTEMORL,FLD         DISPLAY IT                                   
         OI    NTEMORLH+6,FOUTTRN  TRANSMIT FIELD                               
*                                                                               
LSMORX   DS    0X                                                               
*                                                                               
LSX      DS    0H                                                               
...
*                                                                               
         ...
         SPACE 2                                                                
*                                  LINES IN WINDOW                              
NLINS    EQU   ((NTENTLH-NTENT1H)/(NTENT2H-NTENT1H))+1                          
*                                                                               
         LTORG                                                                  
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - LINHOOK'                                
**********************************************************************          
*                                                                    *          
...
*                                                                               
         DC    H'0'                INVALID MODE                                 
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - LHVAL'                                  
**********************************************************************          
*                                                                    *          
...
*                                                                               
         DROP  R2                                                               
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - LHDIS'                                  
**********************************************************************          
*                                                                    *          
...
LHDISX   DS    0H                                                               
         B     LHOOKX                                                           
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - LHMORE'                                 
**********************************************************************          
*                                                                    *          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PPADS16 - BUILD TABLE OF ELEMENTS ON FILE - LSBLDTAB'           
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         MVI   ELCODE,GPUBNEQU     SET NOTES ELEMENT ID                         
         BRAS  RE,GETEL            FIND FIRST NOTE                              
*                                                                               
LSBTLOOP DS    0H                                                               
*                                                                               
         USING GPUBND,R6           ESTABLISH NOTES ELEMENT                      
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         IC    RF,GPUBNLN          ELEMENT LENGTH                               
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         BASR  RE,0                ESTABLISH WHERE WE ARE                       
         EX    RF,8(RE)                                                         
         J     *+10                                                             
         MVC   ELTELEM(0),GPUBND   ADD ELEMENT TO TABLE                         
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PPADS16 - BUILD TABLE OF ELEMENTS ON FILE - LHSRCH'             
***********************************************************************         
*                                                                     *         
...
*                                                                               
         TITLE 'PPADS16 - MISC. NOTES - LHDISLIN'                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,GPUBNLN        ELEMENT LENGTH                               
         AHI   RF,-(GPUBNCOM-GPUBND)  TEXT LENGTH                               
...
*                                                                               
         ...
         EX    RF,8(RE)                                                         
         J     *+10                                                             
         MVC   FLDDATA(0),GPUBNCOM  MOVE LINE OF TEXT TO SCREEN                 
*                                                                               
LHDTXTX  DS    0H                                                               
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PPADS16 - TEXT POSTING - DSECTS'                                
***********************************************************************         
*                                                                     *         
*        HIDDEN DSECTS                                                *         
*                                                                     *         
...
*                                                                               
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005PPADS16   02/12/99'                                      
         END                                                                    
