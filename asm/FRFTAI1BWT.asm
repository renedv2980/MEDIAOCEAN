*          DATA SET FRFTAI1BWT AT LEVEL 008 AS OF 05/01/02                      
*PHASE FTPAI1WT,*,NOAUTO                                                        
****************************  use special panS procs                            
DVGCXASM START                                                                  
* /***START OF SPECIFICATIONS*****************************************/         
*              C'DDSFTP.CCOL.AI1.XXXX.BWT'     western billing tape             
* /*                                                                 */         
...
*/*-----------------------------------------------------------------*/          
MVSDSN   DC    C'DDSFTP.CCOL.AI1.XXXX.BWT'     western billing tape             
         DS  0D                                                                 
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008FRFTAI1BWT05/01/02'                                      
         END                                                                    
