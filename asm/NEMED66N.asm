*          DATA SET NEMED66N   AT LEVEL 005 AS OF 06/26/06                      
*PHASE T31E66A,+0                                                               
...
*         MVI   CLPSLASH,C'/'                                                   
PL1      MVC   CLPROD,NBPR1CL3                                                  
         CLI   NBPRD2,0            CK IF A PIGGY                                
         BE    PL2                                                              
         MVC   CLPROD2,NBPR2CL3                                                 
         MVI   CLPSLASH,C'/'                                                    
*                                                                               
PL2      BAS   RE,NEXTLIN                                                       
*                                                                               
         LA    R3,FAKELINE                                                      
         BRAS  RE,CPPTOTS           SET UP CPP LINE IN CASE NEEDED              
*                                                                               
         L     R4,ATWA                                                          
         USING T31EFFD,R4                                                       
...
*                                                                               
         ...
         BRAS  RE,CPPTOTS           SET UP CPP VALUES IN CASE NEEDED            
...
*                                                                               
         ...
         LA    R4,TOTTOTL                                                       
         BRAS  RE,CPPTOTS          FILL IN COST-PER-POINT LINE                  
...
*        SPGENCLT                                                               
       ...
       ++INCLUDE FAFACTS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005NEMED66N  06/26/06'                                      
         END                                                                    
