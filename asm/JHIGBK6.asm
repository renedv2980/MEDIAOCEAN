*          DATA SET JHIGBK6    AT LEVEL 198 AS OF 10/13/00                      
*PHASE JHIGBK6                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE XSORT                                                                  
*INCLUDE SORTER                                                                 
...
SKIP     STC   R9,BFLAGS                 COVER TYPE AND DISCOUNT                
         GOTO1 =V(SORTER),DMCB,=C'PUT',0(R3)                                    
         B     GET                       GET NEXT CARD                          
*                                                                               
SORT     DS    0H                                                               
         CLOSE FIL1                                                             
         ...
         OPEN  FIL2                                                             
         GOTO1 =V(SORTER),DMCB,SCARD2,RECCARD                                   
SORT1    GET   FIL2,IOAREA                                                      
         GOTO1 =V(SORTER),DMCB,=C'PUT',IOAREA                                   
         B     SORT1                                                            
EOD      BAS   RE,HEADING                PRINT HEADING                          
         CLOSE FIL2                                                             
SORT2    GOTO1 =V(SORTER),DMCB,=C'GET'   GET FIRST SORTED REC                   
         ICM   R3,15,4(R1)                                                      
         BZ    END                                                              
*                                                                               
PRINT    DS    0H                                                               
...
SKIPADD  EDIT  (R9),(10,P+118),2,FLOAT=$,COMMAS=YES,ALIGN=RIGHT                 
         ...
         GOTO1 =V(SORTER),DMCB,=C'GET'   GET NEXT SORTED REC                    
         ICM   R4,15,4(R1)                                                      
         BNZ   PRINT2                                                           
END      GOTO1 =V(SORTER),DMCB,=C'END'   END SORTER                             
         BAS   RE,SUBTOTA                                                       
...
GETRANK  NTR1                                                                   
         ...
         MVC   PREVRANK,BRANK                                                   
         AHI   R5,1                                                             
LOOP     GOTO1 =V(SORTER),DMCB,=C'GET'                                          
         ICM   R3,15,4(R1)                                                      
         BZ    OUT                                                              
         CLC   PREVCOST,BCOST                                                   
         BNE   ELSE                                                             
...
FIL2     DCB   DSORG=PS,RECFM=FB,MACRF=(GM,PM),BLKSIZE=610,LRECL=61,   X        
               DDNAME=JHIGTEMP,EODAD=EOD                                        
DUB      DS    D                                                                
OUTP     DS    D                                                                
DMCB     DS    6F                                                               
FULL     DS    F                                                                
...
SORTCARD DC    CL80'SORT FIELDS=(56,2,D),FORMAT=BI,WORK=1'                      
SCARD2   DC    CL80'SORT FIELDS=(58,1,A,1,51,A),FORMAT=BI,WORK=1'               
         LTORG                                                                  
INTAB    DS    CL(BOOKDLQ)                                                      
******************************************************                          
...
*                                                                               
       ...
       ++INCLUDE DDDPRINT                                                       
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'198JHIGBK6   10/13/00'                                      
         END                                                                    
