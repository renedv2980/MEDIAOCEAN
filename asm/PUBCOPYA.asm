*          DATA SET PUBCOPYA   AT LEVEL 032 AS OF 06/24/04                      
*PHASE PUBCOPYA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
******                                                                          
******   THIS PROGRAM IS TO BE USED WHEN COPYING ALL PUB RECS FROM              
...
* TESTING ******************************************************                
*                                                                               
         MVC   REC+7(2),=C'PH'     CHANGE AGENCY CODE                           
*                                                                               
GET6     DS    0H                                                               
         MVI   DMPSW,C'Y'                                                       
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'032PUBCOPYA  06/24/04'                                      
         END                                                                    
