*          DATA SET SCHOLDEXTQ AT LEVEL 129 AS OF 05/01/02                      
*PHASE SCHOEXTQ,*                                                               
*INCLUDE LOGIO                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
...
PVXREC   DS    0H                                                               
         ...
         USING PMKEY,R3                                                         
         CLC   PMCODE(3),=C'QNN'   QNN                                          
         BH    PVXDONE                                                          
         BNE   PVXPURGE                                                         
*                                                                               
         CLC   PMBOOK,=X'6325'     BOOK BETWEEN 6325                            
         BL    PVXPURGE                           ~                             
         CLC   PMBOOK,=X'6412'                  6412                            
         BH    PVXPURGE                                                         
*                                                                               
         CLC   PMSTAT,=C'WB  S'    STATION = 'WB  S'                            
         BNE   PVXPURGE                                                         
*                                                                               
         CLI   PMBTYP,C'V'         BOOK TYPE V OR                               
         BE    *+12                                                             
         CLI   PMBTYP,C'W'         BOOK TYPE W ONLY                             
         BNE   PVXPURGE                                                         
*                                                                               
*        B     PVXKEEP             THIS LINE IS FOR BACKUP B4 CHANGE            
*                                                                               
         LA    R2,KEYTAB                                                        
QREC05   CLI   0(R2),X'FF'                                                      
         BE    PVXKEEP                                                          
         CLC   PMPNUM,0(R2)                                                     
         BE    QREC10              FOUND A MATCH                                
         LA    R2,L'KEYTAB(R2)                                                  
         B     QREC05                                                           
*                                                                               
QREC10   MVC   PMPNUM,2(R2)        SUBSTITUTING                                 
         LA    R4,PMDATA           FIND THE ELEMENT AND CHANGE                  
         USING PHELEM,R4                                                        
QREC15   CLI   0(R4),X'20'                                                      
         ...
         B     QREC15                                                           
*                                                                               
QREC20   MVC   PHPNUM,2(R2)        CHANGE THE PHPNUM IN X'20' ELEM              
         B     PVXKEEP                                                          
*                                                                               
         EJECT                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'129SCHOLDEXTQ05/01/02'                                      
         END                                                                    
