*          DATA SET YYUNVOLS   AT LEVEL 001 AS OF 05/01/01                      
*PHASE YYUNVOLS                                                                 
*INCLUDE CARDS                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE DMDMGRL                                                                
       ++INCLUDE DMGREQUS                                                       
         TITLE 'YYUNVOLS - GET VOLSEQ AND DEVICE # FOR A DSN'                   
         PRINT NOGEN                                                            
YYUNVOLS CSECT                                                                  
         NBASE 0,YYUNVOLS,=A(R13CHAIN),R9                                       
*                                                                               
         ENTRY SSB                                                              
         ENTRY UTL                                                              
*                                                                               
...
*                                                                               
         ...
         MHI   R8,L'TABLE                                                       
         LA    R8,TABLE(R8)                                                     
         MVC   TABIDN,CHAN+1       INPUT DEVICE NUMBER                          
...
*                                                                               
         ...
         UCBLOOK VOLSER=VOL,UCBPTR=UCBPTR,DYNAMIC=YES,PIN,             +        
               TEXT=TEXTLOOK,PTOKEN=PTOKLOOK                                    
         LTR   RF,RF                                                            
         BZ    PROB                                                             
         OI    ERROR,X'80'                                                      
         MVI   BYTE,X'80'         THIS FC3??? VOLSEQ IS NOT DEFINED             
...
*                                                                               
         ...
         MVC   TABODN,CHAN+1       OUTPUT DEVICE NUMBER                         
...
TABNXT   CH    R2,TABCNT                                                        
         ...
         MVC   P+12(L'TABOVS),TABOVS                                            
         MVC   P+19(L'TABODN),TABODN                                            
         MVC   P+30(L'TABFIL),TABFIL                                            
         GOTO1 =V(PRINTER)                                                      
         AHI   R2,1                                                             
         AHI   R8,L'TABLE                                                       
         B     TABNXT                                                           
...
*                                                                               
OPMSG1   DC   C'FLASH COPY VOLSER FC3XXX FOR VOLUME VVVVVV ASSOCIATED W+        
...
TABODN   DS    CL3                 OUTPUT DEVICE#                               
TABIVS   DS    CL6                 INPUT VOLSER                                 
TABIDN   DS    CL3                 INPUT DEVICE#                                
*                                                                               
         EJECT                                                                  
*DMDTFPH                                                                        
       ++INCLUDE DMDTFPH                                                        
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         IEFUCBOB   DEVCLAS=DA                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001YYUNVOLS  05/01/01'                                      
         END                                                                    
