*          DATA SET NENETPUP   AT LEVEL 014 AS OF 05/08/02                      
*          DATA SET NENETPUP   AT LEVEL 016 AS OF 05/10/00                      
*PHASE T00A55A,+0                                                               
*INCLUDE NETINTG                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
...
NETPUP   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 PUPWRKX-PUPWRK,**NTPP**,RR=R2,CLEAR=YES                          
         USING NETPUP,RB,R8                                                     
         LA    R8,2048(RB)                                                      
         LA    R8,2048(R8)                                                      
         USING MYD,RC                                                           
...
EXTPLAN  NTR1                                                                   
         ...
         MVC   NPACTCLI,NPLKCLT    2 BYTE CLIENT                                
...
*                                                                               
         ...
         LA    R1,NADUNIVS         YES/BUILD+SAVE ELEMS IN NADUNIVS             
         USING OVERAREA,R1                                                      
EXTPL150 MVC   0(2,R1),=X'DD0C'                                                 
...
*                                                                               
         ...
         LA    RF,OVERLENE                                                      
         XCEF                                                                   
         MVC   OVERAREA(L'NADUNIVS),NADUNIVS     NAD UNIVERSES                  
*                                                                               
         MVC   PREL(3),=X'350902'                                               
*                                                                               
         USING NPUBD,R6                                                         
...
*                                                                               
         ...
         LA    R1,OVERAREA                                                      
         USING OVERAREA,R1                                                      
         LA    RE,20               BUMP PAST UNIV NADS                          
         CLI   0(R1),0                                                          
         BE    E12DM1                                                           
         LA    R1,12(R1)                                                        
         BCT   RE,*-12                                                          
         CLI   0(R1),0             MUST BE AT END OF UNIV NADS                  
         BE    *+6                                                              
         DC    H'0'                SHOULD NOT HAPPEN                            
*                                                                               
E12DM1   LA    R0,6                (MAX 6)                                      
         SPACE 1                                                                
E12DM2   OC    0(2,R3),0(R3)                                                    
         ...
         BE    E12DM3                                                           
         MVC   OVERDEMO(1),0(R2)               SET CATEGORY                     
         MVI   OVERFLG,X'80'                                                    
         DROP  R1                                                               
E12DM3   LA    R1,12(R1)                                                        
         SPACE 1                                                                
...
E12DM13  BAS   RE,NEXTEL                                                        
         ...
         SR    R4,R4                                                            
         D     R4,=F'5'                                                         
         LR    R4,R5               SET # OF NAD DEMOS IN R4                     
         LA    R1,OVERAREA                                                      
...
*                                                                               
***      GET ADDRESSABILITY LATER  (WE MAY NOT NEED THIS EVER)                  
...
SETDB    NTR1                                                                   
         ...
         ST    R1,DBAQUART                                                      
*  SET FOR TVQ LOOKUP                                                           
         LR    R1,RC               GET ADDRESSABILITY TO DBEXTEND               
         AHI   R1,(DBEXTEND-PUPWRK)                                             
         XC    0(L'DBEXTEND,R1),0(R1)                                           
         CLI   GOTUTYPE,1                                                       
         BNE   SETDB10                                                          
         MVC   BTUEXT,=C'UFIL'                                                  
         MVC   BTUEX2,BTUDB+4                                                   
         LA    RE,BTUEXT                                                        
**       ST    RE,DBEXTEND                                                      
         ST    RE,0(R1)            SET ADDR IN DBEXTEND                         
...
EXTBLOCK NTR1                                                                   
         ...
         MVC   NBACTDP,NPUPDPT     SET OLD DAYPART FIELD                        
*          DATA SET NEMEDGEN   AT LEVEL 019 AS OF 03/28/01                      
         LA    R2,WORK                                                          
         USING NDPTHDR,R2                                                       
         XC    WORK,WORK                                                        
         MVC   NDPTKTYP,=XL2'0D07'                                              
         MVC   NDPTAGM,NBACTAM                                                  
         CLI   NPUPDPT,127            CHECK CLIENT LEVEL DAYPART                
         BH    *+10                                                             
         MVC   NDPTCLT,NPACTCLI                                                 
         MVC   NDPTDPTE,NPUPDPT                                                 
         MVC   WORK+100(20),WORK                                                
         GOTO1 NBDM,DMCB,=C'DMRDHI',=C'UNTDIR  ',WORK,WORK,0                    
         CLC   WORK(6),WORK+100                                                 
         BE    *+6                                                              
         DC    H'0'                DAYPART CRASH!                               
         MVC   NBACTNDP,NDPTDPTA    NEW 2 CHAR DAYPART                          
         MVC   NBDPNAM(8),NDPTDES     DESCRIPTION                               
         MVC   NBDPNAM2(6),NDPTDES+8   DESCRIPTION                              
...
PBEL     DS    CL7                 BOOK ELEMENT                                 
         SPACE 1                                                                
OVERAREA DS    0CL1                40 OVERRIDE ELEMS FOR NAD DEMOS              
*                                  + 10 OVERRIDES + EOR                         
OVEREL   DS    0CL12               OVERRIDE ELEMENT                             
         DS    CL2                 X'DD0C'                                      
         DS    CL1                 X'00'                                        
OVERDEMO DS    CL3                 CATEGORY/DEMO/MODIFIER                       
OVERFLG  DS    CL1                 X'80'=NAD DEMO                               
OVERPREC DS    CL1                 PRECISION                                    
OVERAMNT DS    CL4                                                              
         DS    CL592                                                            
OVERLENE EQU   *-OVERAREA                                                       
*                                                                               
NADUNIVS DS    CL240                                                            
         SPACE 2                                                                
*  TVQ BLOCK AREA                                                               
...
NDBLK    DSECT                                                                  
       ++INCLUDE NETDEMOT                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014NENETPUP  05/08/02'                                      
         END                                                                    
