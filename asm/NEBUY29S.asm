*          DATA SET NEBUY29S   AT LEVEL 006 AS OF 05/01/02                      
*          DATA SET NEBUY29    AT LEVEL 066 AS OF 10/29/99                      
*PHASE T31129C,+0                                                               
...
*                                                                               
         ZIC   R1,FULL+1                                                        
         LA    R1,1(R1)                                                         
         STCM  R1,1,FULL+1         GET NEXT PRODUCT                             
         BCT   R4,DFEDC250                                                      
         SH    R3,=H'1'            GET TO PREVIOUS FIELD                        
         MVI   0(R3),X'40'         NO DASH FOR LAST PRODUCT                     
         MVI   NBPRD,0                                                          
...
*            INPVALS CONTAINS INPUT DEMO VALUES                                 
*                                                                               
OVERDEM  NMOD1 0,**OVDM**                                                       
         LA    RC,2048(RB)         RC IS THIRD BASE REGISTER                    
         LA    RC,2048(RC)                                                      
         USING OVERDEM+4096,RC                                                  
         LM    R2,R3,0(R1)         R2=A(DEMO LIST), R3=A(DEMO VALUES)           
         L     R5,12(R1)           R5=A(UNIVERSES)                              
         ZIC   R0,0(R1)            GET COUNT OF DEMOS                           
         LR    RF,R0               SAVE COUNT IN RF                             
...
OV240    CLI   DEMTYPE,C'E'                                                     
         ...
         SPACE 1                                                                
OV300    GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(ELCODE,AIOAREA1),(LFIL,DUB)         
         MVC   DUB2,DUB                                                         
         CLI   1(R2),USERMOD       TEST FOR USER DEMO                           
         BE    OV360                                                            
         CLI   3(R2),C'R'          TEST FOR RATING                              
         ...
         BNE   OV400               YES                                          
         B     OV400                                                            
         CLI   3(R2),C'H'          TEST FOR ESTIMATED IMP                       
         BE    OV305               NO                                           
         CLI   3(R2),C'T'          TEST FOR ESTIMATED IMP                       
         BNE   OV400               NO                                           
...
*                                                                               
         ...
         BNE   OV440                                                            
         MVI   NUOVMOD,C'H'                                                     
OV440    BAS   RE,SETOVPRE         SET DEMO PRECISION                           
         MVC   BYTE,NUOVPRE        BYTE CONTAINS PRECISION                      
         CLC   0(4,R4),=F'-2'      TEST FOR ZERO VALUE                          
         BE    OV600                                                            
         MVC   NUOVVAL(4),0(R4)                                                 
...
OV620    CLI   1(R2),USERMOD                                                    
         ...
         B     OV700                                                            
*                                                                               
OV640    CLI   3(R2),C'R'          TEST FOR RATING OVERRIDE                     
         BE    OV650                                                            
         CLI   DEMTYPE,C'E'                                                     
*        BNE   OV700                                                            
...
NETUNIVD DSECT                                                                  
       ++INCLUDE NETUNIVD                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006NEBUY29S  05/01/02'                                      
         END                                                                    
