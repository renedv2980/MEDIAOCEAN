*          DATA SET TZIHDATG   AT LEVEL 181 AS OF 09/26/00                      
*PHASE TZIHDATG                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE  CARDS                                                                 
*INCLUDE KHDUMMY                                                                
...
READP10   DS    0H                  ASSUMING R2 POINTS TO IO                    
          ...
          AHI   R5,1                                                            
          BCT   R4,READP10                                                      
          B     READNEQX            IF COUNTER EXCEEDS 10, INVALID INPT         
EREADP10  DS    0H                                                              
...
GETVAL10  DS    0H                  GET TO EQUAL SIGN                           
          ...
          B     GETVNEQX            NO '=' SIGN - THAT'S AN ERROR               
GETVAL20  DS    0H                                                              
...
GETVAL30  CLI   0(R5),C' '          WORK IS INITIALIZED TO SPACES, SO           
          ...
          BL    GETVNEQX            NON-DIGITS ARE UNACCEPTABLE                 
          CLI   0(R5),C'9'                                                      
          BH    GETVNEQX                                                        
...
*               R4 IS USED                                                      
          ...
          BNE   INSNEQX                  IT'S BEING READ IN SECOND TIME         
...
*                                                                               
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'181TZIHDATG  09/26/00'                                      
         END                                                                    
