*          DATA SET SPNWS12A   AT LEVEL 151 AS OF 07/17/02                      
*PHASE T20712A,*                                                                
...
*                                                                               
         ...
         BL    FSTRX                                                            
         BE    FSTR10                                                           
         MVC   TREUPG,SVUPINP      NONE - EDIT UPGRADE EXPRESSION               
         OI    TREUPGH+6,FVOXMT                                                 
*                                                                               
...
DISR17   TM    TREUPGH+FVIIND-FVIHDR,FVIVAL    TEST UPGRADE CHANGED             
         ...
         XC    LAODTEL,LAODTEL                                                  
*                                                                               
DISR18   MVC   TREUPG,CMPUPIN            DISPLAY CAMPAIGN UPGRADE               
         OI    TREUPGH+6,FVOXMT                                                 
*                                                                               
...
DISR22   TM    TREBK1H+FVIIND-FVIHDR,FVIVAL    TEST ANY BOOK CHANGES            
         ...
         B     DISR25                                                           
*                                                                               
DISR24   OI    TREBK1H+FVIIND-FVIHDR,FVIVAL                                     
         OI    TREBK2H+FVIIND-FVIHDR,FVIVAL                                     
         OI    TREBK3H+FVIIND-FVIHDR,FVIVAL                                     
         OI    TREBK4H+FVIIND-FVIHDR,FVIVAL                                     
...
* FATIOB                                                                        
       ...
       ++INCLUDE FATIOB                                                         
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'151SPNWS12A  07/17/02'                                      
         END                                                                    
