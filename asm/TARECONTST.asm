*          DATA SET TARECONTST AT LEVEL 011 AS OF 05/01/02                      
*PHASE TARCTSTA                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE PRINTER                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE SORTER                                                                 
*INCLUDE PRNTBL                                                                 
         TITLE 'TARECONTST - TALDIR/TALFIL RECONSTRUCT TEST PROGRAM'            
TARECON  CSECT                                                                  
         PRINT NOGEN                                                            
...
IN2      LA    R0,RECVHDR-4                                                     
         GET   RECVIN,(0)                                                       
*                                                                               
         CLI   RFILTY,QTALFIL      TEST TALFIL                                  
*******  BE    *+12                                                             
*******  CLI   RFILTY,QCHKFIL        OR CHKFIL                                  
         BNE   IN2                                                              
*                                                                               
         SR    R1,R1                                                            
         ICM   R1,3,RECVHDR-4                                                   
...
*********PUT   FILEOUT,(0)                                                      
         ...
         SPACE 3                                                                
SOONTST  NTR1                                                                   
STST2    CLI   NEXTREC,X'FF'                                                    
         BE    STST10                                                           
         CLI   SOONSW,C'Y'         IF LAST RECORD WAS FROM SOON                 
         BNE   STST10                                                           
         CLC   SOONKEY,NOLDKEY     AND KEY HASN'T CHANGED                       
         BNE   STST10                                                           
         CLI   RAG-RLEN(R3),X'FE'  THEN IF THIS ISN'T FROM SOON                 
         BE    STST10                                                           
         AP    BADCHG,=P'1'        ADD TO BAD COUNT                             
         LH    RF,0(R3)                                                         
         GOTO1 =V(PRNTBL),DMCB,=C'BAD CHANGE',(R3),C'DUMP',(RF),=C'2D'          
         ...
         B     STST2                                                            
*                                                                               
STST10   MVI   SOONSW,C'N'                                                      
         CLI   NEXTREC,X'FF'                                                    
         BE    STSTX                                                            
         CLI   RAG-RLEN(R3),X'FE'  IF THIS RECORD FROM SOON                     
         BNE   STSTX                                                            
         MVC   SOONKEY,NOLDKEY     SAVE SOON KEY                                
         MVI   SOONSW,C'Y'         SET HAVE SOON KEY                            
         AP    SOONCNT,=P'1'       ADD TO COUNT                                 
*                                                                               
STSTX    XIT1  REGS=(R3)                                                        
         EJECT                                                                  
ENDIN    CLOSE (FILEIN,)                                                        
...
*                                                                               
         MVC   LINE,=PL2'75'                                                    
         MVC   TITLE(30),=C'TALDIR/TALFIL RECONSTRUCT TEST'                     
*                                                                               
         LA    R3,CNTRS                                                         
         LA    R4,18                                                            
         LA    R5,CNTRSX                                                        
...
SOONCNT  DC    PL4'0',CL14'SOON RECORDS'                                        
BADCHG   DC    PL4'0',CL14'BAD CHANGES'                                         
CNTRSX   EQU   *-1                                                              
*                                                                               
         EJECT                                                                  
DUB      DS    D                                                                
...
QTALFIL  EQU   X'72'               TALFIL NUMBER FROM DMFILES                   
QCHKFIL  EQU   X'76'               CHKFIL NUMBER FROM DMFILES                   
SOONSW   DC    C'N'                                                             
SOONKEY  DS    CL32                                                             
         LTORG                                                                  
         EJECT                                                                  
...
RECONWKC CSECT                                                                  
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011TARECONTST05/01/02'                                      
         END                                                                    
