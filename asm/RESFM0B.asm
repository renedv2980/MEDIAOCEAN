*          DATA SET RESFM0B    AT LEVEL 061 AS OF 11/21/02                      
*PHASE T8180BA,*                                                                
...
*                                                                 *             
* NOV21/02 (BU ) --->PASSIVE POINTER FOR BROWSE                   *             
*                                                                 *             
*                    ***  END TOMBSTONE  ***                      *             
*******************************************************************             
*                                                                               
...
XADD     DS    0H                                                               
         ...
         BAS   RE,PPADD                                                         
         BAS   RE,PPAFKEY          PROCESS SECONDARY PASSIVE POINTER            
         B     XIT                                                              
         EJECT                                                                  
****************************************************************                
****************************************************************                
...
*                                                                               
         ...
         L     R6,AIO                                                           
         USING RMKTREC,R6                                                       
         MVC   OLDMKTNM,RMKTNAME   SAVE ORIGINAL MARKET NAME                    
         DROP  R6                                                               
         MVI   ELCODE,X'02'                                                     
         BAS   RE,GETEL                                                         
         B     D30                                                              
...
PD20     MVC   RMKTSSTA,0(R3)                                                   
         ...
         EJECT                                                                  
*                                                                               
*   PROCESS SECONDARY PASSIVE POINTER                                           
*                                                                               
PPAFKEY  NTR1                                                                   
         XC    KEY,KEY             CLEAR KEY                                    
         LA    R5,KEY                                                           
         USING RMKT2TYP,R5                                                      
         MVI   RMKT2TYP,X'AF'      BUILD SECOND PASSIVE                         
         MVC   RMKT2REP,AGENCY     INSERT REP                                   
         MVC   RMKT2NAM,OLDMKTNM   INSERT OLD MARKET NAME                       
         MVC   RMKT2MKT,MKT        INSERT MARKET CODE                           
         OI    DMINBTS,X'08'       PASS DELETES                                 
         GOTO1 HIGH                RETRIEVE OLD MARKET NAME                     
         CLC   KEY(27),KEYSAVE     KEY FOUND?                                   
         BNE   PPAF0100            NO  - NOTHING TO DELETE                      
         TM    KEY+27,X'80'        ALREADY DELETED?                             
         BO    PPAF0100            YES                                          
         OI    KEY+27,X'80'        DELETE IT                                    
         GOTO1 WRITE                                                            
PPAF0100 EQU   *                                                                
         SPACE 1                                                                
         XC    KEY,KEY             CLEAR KEY                                    
         ...
         MVI   RMKT2TYP,X'AF'       BUILD SECOND PASSIVE                        
         MVC   RMKT2REP,AGENCY     INSERT REP                                   
         MVC   RMKT2NAM,SVMKTNAM   INSERT MARKET NAME                           
         MVC   RMKT2MKT,MKT        INSERT MARKET CODE                           
         SPACE 1                                                                
PPAF0120 EQU   *                                                                
         SPACE 1                                                                
...
*  DDFLDIND                                                                     
       ++INCLUDE DDFLDIND                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'061RESFM0B   11/21/02'                                      
         END                                                                    
