*          DATA SET SRIND00S   AT LEVEL 065 AS OF 05/01/02                      
*PHASE T16500A                                                                  
*&&      SET   SF=Y,TT=N                                                        
         TITLE '$INDFILE - 3270 STRUCTURED FIELD TRANSMISSIONS'                 
***********************************************************************         
***********************************************************************         
** NOTE :  THIS PROGRAM HAS ABSOLUTELY NO SECURTIY !!!!!!!!  **********         
***********************************************************************         
***********************************************************************         
         PRINT NOGEN                                                            
INDFILE  CSECT                                                                  
...
* SBA XX YY INDFILE GET SBA XX YY SEQNUM.GARBAGE SBA ...           *           
*-------------------------------------------------------------------*           
         SPACE 1                                                                
         SR    R1,R1                                                            
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'065SRIND00S  05/01/02'                                      
         END                                                                    
