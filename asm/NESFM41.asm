*          DATA SET NESFM41    AT LEVEL 039 AS OF 03/16/16                      
...
*                                                                               
         ...
         EJECT                                                                  
*                                                                               
DR40     DS    0H                  CLEAR DISPLAY LINES                          
         LA    R2,SFMLISTH                                                      
DR50     OC    8(72,R2),8(R2)                                                   
         BZ    DR60                                                             
         XC    8(72,R2),8(R2)                                                   
         OI    6(R2),X'80'         XMIT                                         
DR60     SR    R0,R0                                                            
...
*--DISPLAY PIDS                                                                 
         ...
         LA    R1,SFMSCM6H                                                      
*                                                                               
DR80     CR    R2,R1               DONE WITH THE FIELDS?                        
         BH    DR100                - YUP, WE'RE DONE                           
...
DR120    GOTO1 MYSEQ                                                            
*                                                                               
DR130    CLC   KEY(PRGKGRP-PRGKEY),KEYSAVE  TEST SAME THRU GRP ID               
         BNE   DRX                                                              
*                                                                               
...
LR35     DS    0H                                                               
         ...
         DC    H'0'                                                             
*                                                                               
         GOTO1 CLUNPK,DMCB,PRGKCLT,PLCLI                                        
         MVC   PLGRPID,PRGKID                                                   
         MVC   PLLEV1,PRGBK1                                                    
         MVC   PLLEV2,PRGBK2                                                    
         CLI   MODE,PRINTREP                                                    
