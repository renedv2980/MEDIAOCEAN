*          DATA SET DDBOOKVALA AT LEVEL 044 AS OF 06/28/00                      
*PHASE T00A00B,+0                                                               
         SPACE 1                                                                
*                                                                               
* 27JUN00 SUPPORT RADAR                                                         
...
*              SCAN AND VALIDATE                                                
         SPACE 3                                                                
         MVC   PARAS+8(4),=C',=,('                                              
         GOTO1 SCANNER,PARAS,(R2),(20,BLOCK)                                    
         ZIC   R5,PARAS+4                                                       
         LTR   R5,R5                                                            
         BZ    XIT                                                              
         LA    R6,BLOCK                                                         
...
* NOTE: LOWEST YEAR SUPPORTED IN YEAR 2K CONVERSION IS 2027                     
         ...
         BZ    *+12                                                             
         CH    R1,=H'27'             AND C'27', INCLUSIVE,                      
         BH    *+8                                                              
         AH    R1,=H'100'            MAKE IT A 2000 YEAR                        
...
BOOKDL   EQU   *-BOOKD                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'044DDBOOKVALA06/28/00'                                      
         END                                                                    
