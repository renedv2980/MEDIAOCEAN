*          DATA SET REREP7802S AT LEVEL 060 AS OF 09/26/02                      
*PHASE RE7802C,+0                                                               
*INCLUDE XSORT                                                                  
***********************************************************************         
* HISTORY LOST                                                                  
...
SALE0080 EQU   *                                                                
         ...
         BZ    SALE0090            NO                                           
         GOTO1 DATCON,DMCB,(3,RSALLEAV),(5,P+102)                               
SALE0090 EQU   *                                                                
...
SALE0390 MVC   SVOFF,83(R2)                                                     
         ...
         MVC   4(83,R2),SVLINE                                                  
         MVC   86(30,R2),SVLINE+86 MOVE LAST PORTION OF LINE                    
...
***>     GOTO1 REPORT                                                           
         ...
         BCT   R3,SALE0400                                                      
*                                                                               
SALE0410 MVC   P(LSALNTRY),SPACES  CLEAR PRINT LINE                             
*                                                                               
...
PRTLINE  EQU   *                                                                
         ...
         TM    MYFLAG,PRNOFF                                                    
         BZ    PRT0010                                                          
         USING PRINLIN2,TEMPLINE   ALIGN DIFFENT FOR OFFICE FILTER              
...
PRT0010  EQU   *                                                                
         TM    MYFLAG,PRNNAME                                                   
         BZ    OUT                                                              
         USING PRINLIN3,TEMPLINE   ALIGN DIFFENT FOR OFFICE FILTER              
         XC    TEMPLINE,TEMPLINE                                                
...
LOCAL020 DS    0H                                                               
         XC    DWNBUFF,DWNBUFF                                                  
         MVC   DWNBUFF+00(03),P+3                                               
         MVC   DWNBUFF+03(20),P+16                                              
         MVC   DWNBUFF+23(12),P+38                                              
         MVC   DWNBUFF+35(02),P+54                                              
         MVC   DWNBUFF+37(21),P+59                                              
         MVC   DWNBUFF+58(02),P+83                                              
         MVC   DWNBUFF+60(12),P+88                                              
         MVC   DWNBUFF+72(08),P+102                                             
         MVC   DWNBUFF+80(03),P+113                                             
         XC    P,P                                                              
...
*                                                                               
LOCA2040 DS    0H                                                               
         MVC   DWNBUFF+00(32),0(R4)                                             
         MVC   DWNBUFF+32(20),0(R5)                                             
         MVC   DWNBUFF+52(50),0(R6)                                             
         MVC   DWNBUFF+102(03),0(R7)                                            
         XC    P,P                                                              
         MVC   P(L'DWNBUFF),DWNBUFF                                             
*                                                                               
         MVI   LINE,1              NEVER PAGE BREAK                             
...
MTRACDM8 DS    C                                                                
       ...
       ++INCLUDE RGENIO                                                         
         EJECT                                                                  
SVOFF    DS    CL2                 OFFICE                                       
SVLINE   DS    CL(LSALNTRY)        TEMP FOR RE-ARRANGING PRINT LINE             
CNT      DS    F                                                                
PRT      DS    F                                                                
RELO     DS    A                                                                
AIOAREA  DS    A                                                                
...
DWNBUFF  DS    CL83                DOWNLOAD LINE BUFFER                         
ELCODE   DS    XL1                                                              
SVINIT   DS    CL3                                                              
MYFLAG   DS    XL1                                                              
...
*                                                                               
LSALNTRY EQU   120                 LENGTH OF SALESMAN TABLE ENTRY               
*                                                                               
...
PSALEML  DS    CL32                                                             
         DS    CL2                                                              
PSASEMNM DS    CL20           ALIGN WITH TEL NUM                                
         DS    CL3                                                              
PSASEAML DS    CL50                                                             
         DS    CL2                                                              
PSASEMFL DS    CL3                                                              
...
PSALEML2 DS    CL35                                                             
         DS    CL2                                                              
PSASEMN2 DS    CL20           ALIGN WITH TEL NUM                                
         DS    CL3                                                              
PSASEAM2 DS    CL46                                                             
         DS    CL2                                                              
PSASEMF2 DS    CL3                                                              
...
GENSAL2  DSECT                                                                  
       ++INCLUDE REGENSAL2                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'060REREP7802S09/26/02'                                      
         END                                                                    
