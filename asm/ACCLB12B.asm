*          DATA SET ACCLB12B   AT LEVEL 153 AS OF 12/22/99                      
*PHASE T62112B                                                                  
CLB12    TITLE '- BILL PROGRAM - MATCH 2 LIST'                                  
CLB12    CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         GOTO1 POSTINIT                                                         
*                                                                               
         L     R1,AIOMCH           TEST MATCH RECORD STILL IN IOMCH             
         CLI   TRNKCCPY-TRNKEY(R1),C' '                                         
         BNE   *+8                                                              
         BAS   RE,GETMTC           NO - (GETOPT MUST HAVE BEEN CALLED)          
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
         BAS   RE,TSPOST           ADD/UPDATE ANY POSTING TSAR RECORDS          
*                                                                               
...
PROC18   L     R1,=A(IOINV)                                                     
         ...
         B     PROC12                                                           
*                                                                               
PROC20   BAS   RE,POST             MAKE POSTINGS FROM POSTING BUFFER            
*                                                                               
         TM    MINDS,MIDRAFT       TEST DRAFT ONLY                              
         BO    PROCX                                                            
*                                                                               
         MVC   TLNUM,CSPSRECN      UPDATE TSAR RECORDS                          
PROC22   ICM   RE,3,TLNUM                                                       
         LA    RE,1(RE)                                                         
         STCM  RE,3,TLNUM                                                       
         CLC   TLNUM,CSHIRECN                                                   
         BH    PROC30                                                           
         ...
         B     PROC22                                                           
*                                                                               
PROC30   ZAP   SVNETTA,SVNETAA     NEW TOTALS=AMOUNT AVAILABLE                  
         ZAP   SVNETTB,SVNETAB                                                  
         ZAP   SVCOMTA,SVCOMAA                                                  
         ZAP   SVCOMTB,SVCOMAB                                                  
...
PROC34   IC    RF,PTALN                                                         
         ...
         DROP  R3                                                               
*                                                                               
PROC36   OI    MINDS,MIDEL         NO - DELETE RECORD                           
         L     R2,AIOMCH                                                        
         USING TRNRECD,R2                                                       
...
PROC42   IC    R0,1(RE)                                                         
         ...
         B     PROC42                                                           
*                                                                               
PROC44   SR    RF,RF               PICK UP DRAFT COUNT                          
         ...
         B     PROC42                                                           
*                                                                               
PROC46   SR    RF,RF               PICK UP ADVANCE COUNT                        
         ...
         B     PROC42                                                           
*                                                                               
PROC48   GOTO1 AIO,IOWRITE+IOACCMST+IO2                                         
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
PROCX    LA    RF,BASACTH                                                       
...
TSPOST20 XC    SKULACT,SKULACT     CLEAR INCOME SUSPENSE ACCOUNT                
         ...
         BE    TSPOST24                                                         
         CLI   TRNTYPE,34          TRANSFERRED HERE FROM ANOTHER JOB            
         BNE   TSPOST22                                                         
         CLC   UL1R,TRNKULC        TEST STARTED LIFE AS A TIMESHEET             
         BE    TSPOST24                                                         
         CLC   UL1P,TRNKULC                                                     
         BE    TSPOST24                                                         
         B     TSPOST40                                                         
TSPOST22 CLI   TRNTYPE,8                                                        
         BNE   TSPOST40                                                         
         CLC   ULSK,TRNKULC                                                     
         BNE   TSPOST40                                                         
         MVC   SKULACT,TRNKULC                                                  
...
NAMTABN  EQU   15                                                               
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'153ACCLB12B  12/22/99'                                      
         END                                                                    
