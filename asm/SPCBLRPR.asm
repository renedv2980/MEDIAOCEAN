*          DATA SET SPCBLRPR   AT LEVEL 029 AS OF 06/08/20                      
*PHASE SPCBLRPR,*                                                               
*INCLUDE DMDMGRL                                                                
*INCLUDE HELEN                                                                  
*INCLUDE HELLO                                                                  
...
*INCLUDE STXITER                                                                
*INCLUDE SORTER                                                                 
SPCBLRPR TITLE 'SPCBLRPR - COMBINES SYSTEMS AND NETWORKS INTO ONE FILE'         
SPCBLRPR CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 0,SPCBLRPR,=V(REGSAVE),R9                                        
*                                                                               
         USING DPRINT,RA                                                        
         L     RA,=V(CPRINT)                                                    
*                                                                               
...
*                                                                               
         CLI   LINETYPE,C'S'                                                    
         BNE   CSLNX                                                            
         MVI   OPUTDATA+5,C'0'     PUT ACTION DATA W/ CODE OF "!"               
         MVC   OPUTDATA+7(4),=C'"!" '                                           
         MVC   OPUTLGTH,=H'15'                                                  
*                                                                               
         LA    R8,OPUTLINE                                                      
...
*                                                                               
       ...
       ++INCLUDE DDDPRINT                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029SPCBLRPR  06/08/20'                                      
         END                                                                    
