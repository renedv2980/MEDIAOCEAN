*          DATA SET REVIEW20   AT LEVEL 016 AS OF 09/28/05                      
*          DATA SET REVIEW20   AT LEVEL 012 AS OF 11/19/99                      
*PHASE T81720A                                                                  
VIEW20   TITLE 'K0 REPORT FOR VIEWER'                                           
VIEW20   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,REVIEW20,R7,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
         L     R8,AGWORK                                                        
         USING GWORKD,R8                                                        
...
***********************************************************************         
         SPACE 1                                                                
DISGRP   MVC   FVIFLD(L'REK0GRP),FLTIFLD                                        
         B     EXITOK                                                           
         SPACE 1                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
DOFQTR   OC    REK0TOT,REK0TOT                                                  
         BZ    FLTXX               NOT A TOTAL LINE                             
*                                                                               
         CLC   REK0PRD+1(1),FLTIFLD                                             
         BL    FLTXL                                                            
         BE    FLTXE                                                            
         BH    FLTXH                                                            
         DROP  R2                                                               
...
*                                                                               
         XC    SVOFF,SVOFF                                                      
*                                                                               
         MVC   IOKEY,REK0KEY       SET CURRENT RECORD INTO IO1                  
...
*                                                                               
         MVC   IOKEY,0(R4)         SET KEY IN IOKEY                             
         CLC   REK0KEY(REK0RNK-REK0KEY),REC.REK0KEY                             
...
*                                                                               
DLIN04   L     R4,AIO1                                                          
         CLC   SVOFF,REC.REK0OFF   OFFICE CHANGE?                               
         BE    DLIN08              YES                                          
*                                                                               
         CLC   REC.REK0OFF,BCEFFS  RANK - IGNORE IF 'ALL'                       
         BE    DLIN06                                                           
         ICM   RF,15,REC.REK0RNK                                                
         CURED (RF),(4,L1.L1RANK),0,DMCB=BOPARM,ALIGN=LEFT                      
*                                                                               
DLIN06   GOTOX DOOFF,BOPARM,REC.REK0KEY                                         
         MVC   L1.L1OFF,BOWORK1                                                 
*                                                                               
DLIN08   MVC   SVOFF,REC.REK0OFF                                                
         GOTOX DOLINE,BOPARM,FVIFLD,REC.REK0KEY                                 
         MVC   LSLASKEY,0(R4)                                                   
*                                                                               
DLINX    B     EXITOK                                                           
         DROP  R2                                                               
...
GETDATE  NTR1  ,                                                                
         XC    IOKEY,IOKEY                                                      
X        USING REK0KEY,IOKEY                                                    
         L     RF,AIOREC                                                        
         USING REK0KEY,RF                                                       
         MVC   X.REK0RPT,=AL2(REK0RPTQ)                                         
         MVC   X.REK0REP,CUAALF                                                 
...
*                                                                               
         ...
         B     EXITOK                                                           
*                                                                               
         MVC   BOWORK1(L'REK0OFF),REK0OFF                                       
*                                                                               
X        USING ROFFRECD,IOKEY                                                   
         MVI   X.ROFFKTYP,X'04'                                                 
         MVC   X.ROFFKREP,CUAALF                                                
         MVC   X.ROFFKOFF,REK0OFF                                               
...
*                                                                               
         L     RF,AIO4                                                          
         USING ROFFRECD,RF                                                      
         MVC   BOWORK1+L'REK0OFF+1(L'ROFFNAME),ROFFNAME                         
         B     EXITOK                                                           
         DROP  R2,RF                                                            
         EJECT                                                                  
***********************************************************************         
...
*                               ** PERIOD IS YYMM BINARY                        
         ...
         CLI   REK0PRD+1,X'0D'      IF MM IS 'OD' THIS IS A YRLY TOTAL          
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         MVC   L1PED(L'ALL),ALL                                                 
         CLI   REK0PRD+1,FF         IF MM IS 'FF' PUT OUT 'ALL'                 
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         ...
         MVI   L1PED+2,C'4'                                                     
*                                                                               
DOL00    OC    REK0TOT,REK0TOT      IF SET THIS IS SUB-TOTAL LINE               
         BNZ   DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         XR    RF,RF                                                            
...
SCRL02   MVC   0(L'GROUP,R4),GROUP                                              
         MVI   L'GROUP(R4),C'='                                                 
         LA    R4,L'GROUP+1(R4)                                                 
         MVC   0(L'REK0GRP,R4),REK0GRP                                          
         CLC   REK0GRP,BCSPACES   IS THIS FOR ALL GROUPS?                       
         BH    SCRL04             NO                                            
         MVC   0(L'ALL,R4),ALL                                                  
         LA    R4,L'ALL(R4)                                                     
         B     *+8                                                              
SCRL04   LA    R4,L'REK0GRP(R4)                                                 
         MVI   0(R4),C','                                                       
         LA    R4,1(R4)                                                         
*                               ** STATION FILTER                               
...
NLST02   L     RF,AIOREC           I/S RETURNS INTO RECORD BUFFER               
         CLC   0(REK0GRP-REK0KEY,RF),LSINIKEY                                   
         BNE   EXITL               MAKE SURE SAME REPORT/REP                    
*                                                                               
         CLC   =C'DATES=',REK0STN-REK0KEY(RF)                                   
         BE    NLST                                                             
*                                                                               
...
FF       EQU   X'FF'                                                            
         SPACE 1                                                                
FILTTAB  DC    AL2(00001),AL1(REK0GRP-REK0DSCT,L'REK0GRP)                       
         DC    AL2(00002),AL1(REK0STN-REK0DSCT,L'REK0STN)                       
         DC    AL2(00005),AL1(REK0RNK-REK0DSCT,L'REK0RNK)                       
         DC    AL2(00003),AL1(REK0OFF-REK0DSCT,L'REK0OFF)                       
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016REVIEW20  09/28/05'                                      
         END                                                                    
