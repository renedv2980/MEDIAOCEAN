*          DATA SET REWCF11S   AT LEVEL 001 AS OF 07/19/02                      
*PHASE T83A11A                                                                  
...
*                                                                               
         ...
         LA    R3,RCONSPST         POINT TO MINI ELEMENT                        
         LA    R3,L'RCONSPST+L'RCONSPAM(R3) SKIP FIRST                          
*                                                                               
DSPL70   DS    0H                                                               
         GOTO1 AADDDATA,DMCB,AFABLK,WKSSPLST,0(R3),0                            
         TM    RCONSPES,X'04'                                                   
         BO    DSPL72                                                           
         GOTO1 AADDDATA,DMCB,AFABLK,WKSSPL$$,5(R3),0                            
         B     DSPL74                                                           
DSPL72   DS    0H                                                               
         GOTO1 AADDDATA,DMCB,AFABLK,WKSSPLPC,5(R3),0                            
*                                                                               
DSPL74   DS    0H                                                               
         LA    R3,9(R3)            BUMP TO NEXT STATION                         
         BCT   R5,DSPL70                                                        
         DROP  R6                                                               
*                                                                               
DSPL80   DS    0H                                                               
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001REWCF11S  07/19/02'                                      
         END                                                                    
