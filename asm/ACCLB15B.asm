*          DATA SET ACCLB15B   AT LEVEL 144 AS OF 12/22/99                      
*PHASE T62115B                                                                  
...
*                                                                               
         ...
         BNE   EXITL               ERROR                                        
*                                                                               
         GOTO1 AVALBAT,BOPARM,(C'V',PBXFRQ),BASREFH,BASMONH                     
         BNE   EXITL                                                            
*                                                                               
         CLC   SFLTOPS,LSOPS                                                    
         BE    EXITY                                                            
...
PFKRTN   LA    R0,C'D'                                                          
         ...
         BNE   *+8                                                              
         LA    R0,C'U'                                                          
         GOTO1 AVALBAT,BOPARM,((R0),PBXFRQ),BASREFH,BASMONH                     
...
VALYES02 LA    RF,PM$ANVBL                                                      
         ...
         BE    VALYES04                                                         
         LA    RF,PM$FNVBL                                                      
VALYES04 GOTO1 XFRTRN,BOPARM,('PTATTRFT',AIO1),('PTASCASH',LSPRATA),   *        
               (RF),0                                                           
         BNE   EXITN                                                            
         B     EXITY                                                            
*                                                                               
VALCLR   TM    TLXPEND,TLXPXFR                                                  
         ...
         GOTO1 ATOBCHA,BOPARM,AIO1,(RF),0                                       
         B     EXITY                                                            
*        L     RF,0(R1)            DELETE TRANSFER ELEMENT                      
*        MVI   0(RF),FF                                                         
...
VALX40   XR    RF,RF                                                            
         ...
         BE    VALX42                                                           
         CLC   BCCPYSEC,CSBILCUR   TEST IF AGENCY CURRENCY                      
         BE    VALX42                                                           
         ZAP   BODUB2,PM$FNVBL     FOREIGN NET AVAILABLE                        
VALX42   XC    BODUB1,BODUB1                                                    
...
VOVR80   CLI   PTALN,PTATLN2Q      TEST LONG ELEMENT                            
         BE    VOVR90                                                           
         XC    BOELEM,BOELEM                                                    
         GOTO1 ATOBCHA,BODMCB,AIO1,(X'80',PTAELD),0,BOELEM                      
*        SR    RE,RE                                                            
*        IC    RE,PTALN                                                         
*        BCTR  RE,0                                                             
*        EX    RE,*+4                                                           
...
*        DC    H'0'                                                             
*        L     R3,BODMCB+16                                                     
         GOTO1 ATOBCHA,BODMCB,AIO1,0,BOELEM                                     
         L     R3,12(R1)                                                        
...
VALLAST  TM    LSINDS1,LSICLMIN+LSIUPREC                                        
         ...
         BE    VALL10                                                           
*                                                                               
         GOTO1 AVALXFR,BOPARM,TRNRECD,PTAELD                                    
         BE    VALL02                                                           
         GOTO1 AFNDCLM,BOPARM,=AL1(XFR#TFT)                                     
         BE    VALL01                                                           
         GOTO1 (RF),(R1),=AL1(PRO#XAMT)                                         
VALL01   MVC   FVADDR,0(R1)                                                     
         B     EXITN                                                            
*                                                                               
VALL02   CLC   PTATWRK,TRNKWORK    WC/JOB/COMMSTAT/SKACC MUST CHANGE            
         BNE   VALL10                                                           
         CLC   PTATJOB,TRNKACT                                                  
         BNE   VALL10                                                           
         LA    RE,X'10'            SET BO                                       
...
VALL10   OI    LSINDS1,LSIUPREC                                                 
         ...
         CP    PTANET,BCPZERO                                                   
         BNE   VALLX                                                            
         GOTO1 ATOBCHA,BODMCB,AIO1,PTAELD,0                                     
...
***********************************************************************         
         SPACE 1                                                                
DISCMNX  NI    FVIHDR+FHATD,FF-FHATHI                                           
         CP    PP$AXFER,BCPZERO                                                 
         BZ    EXITN                                                            
         ZAP   MYBIGDUB,PP$AXFER                                                
         SRP   MYBIGDUB,2,0                                                     
         L     RE,AGOPBLK                                                       
         MP    MYBIGDUB,GOAGYCOM-GOBLOCK(L'GOAGYCOM,RE)                         
         SRP   MYBIGDUB,64-8,5                                                  
         ZAP   BODUB1,MYBIGDUB                                                  
         GOTO1 AEDTAMT,BOPARM,BODUB1,0                                          
         OI    FVIHDR+FHATD,FHATHI                                              
         B     EXIT                                                             
         EJECT                                                                  
***********************************************************************         
...
SETC20   L     R3,ACLMTAB                                                       
         AH    R3,LINCLM                                                        
         USING CLMTABD,R3                                                       
         CLC   CLMCODE,=AL2(PRO#COM)  COMMISSION COLUMN                         
         BNE   SETC15                                                           
...
* DDFH                                                                          
       ...
       ++INCLUDE DDFH                                                           
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'144ACCLB15B  12/22/99'                                      
         END                                                                    
