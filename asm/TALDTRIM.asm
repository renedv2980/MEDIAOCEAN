*          DATA SET TALDTRIM   AT LEVEL 024 AS OF 05/01/02                      
*PHASE TALDTRIA TALDTRIM                                                        
*INCLUDE SCANNER                                                                
...
INIT8    CLC   12(3,R2),=C'ID '    ID=NNN ALLOWED                               
         ...
         B     INITNXT                                                          
         SPACE 1                                                                
INIT10   CLC   12(6,R2),=C'INCAGY' INCLUDE AGENCY                               
         BNE   INIT12                                                           
         MVC   INCAGY,22(R2)                                                    
         B     INITNXT                                                          
         SPACE 1                                                                
INIT12   CLC   12(6,R2),=C'EXCAGY' EXCLUDE AGENCY                               
         BNE   INIT14                                                           
         MVC   EXCAGY,22(R2)                                                    
         B     INITNXT                                                          
         SPACE 1                                                                
...
TRIM6    ZIC   R2,1(R1)            DISPLACEMENT TO AGENCY FIELD                 
         ...
         CLI   INCAGY,0            INCLUDE AGENCY FEATURE                       
         BE    TRIM8                                                            
         CLC   0(6,R2),INCAGY                                                   
         BE    DMXKEEP                                                          
         B     DMXPURGE                                                         
         SPACE 1                                                                
TRIM8    CLI   EXCAGY,0            EXCLUDE AGENCY FEATURE                       
         BE    DMXKEEP                                                          
         CLC   0(6,R2),EXCAGY                                                   
         BE    DMXPURGE                                                         
         B     DMXKEEP                                                          
...
TRIMLIST DS    0F                                                               
         ...
         DC    AL1(TLCACDQ),AL1(0),C'Y ',CL8'CA'                                
         DC    AL1(TLPGCDQ),AL1(0),C'Y ',CL8'PG'                                
         DC    AL1(TLANCDQ),AL1(0),C'Y ',CL8'AN'                                
         DC    AL1(TLEMCDQ),AL1(0),C'Y ',CL8'EM'                                
         DC    AL1(TLW4CDQ),AL1(0),C'Y ',CL8'W4'                                
         DC    AL1(TLPHCDQ),AL1(0),C'Y ',CL8'PH'                                
         DC    AL1(TLGUCDQ),AL1(0),C'Y ',CL8'GU'                                
         DC    AL1(TLDUCDQ),AL1(0),C'Y ',CL8'DU'                                
         DC    AL1(TLLNCDQ),AL1(0),C'Y ',CL8'LN'                                
         DC    AL1(TLGTCDQ),AL1(0),C'Y ',CL8'GT'                                
         DC    AL1(TLLOCDQ),AL1(0),C'Y ',CL8'LO'                                
         DC    AL1(TLBACDQ),AL1(0),C'Y ',CL8'BA'                                
         DC    AL1(TLOFCDQ),AL1(0),C'Y ',CL8'OF'                                
         DC    AL1(TLW2CDQ),AL1(0),C'Y ',CL8'W2'                                
         SPACE 1                                                                
         ...
         DC    AL1(TLCTCDQ),AL1(TLCTAGY-TLCTD),C'Y ',CL8'CL'                    
...
*********INCLUDE TAGENFILE                                                      
       ...
       ++INCLUDE TAGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024TALDTRIM  05/01/02'                                      
         END                                                                    
