*          DATA SET TZIHBKSF   AT LEVEL 174 AS OF 10/06/00                      
*PHASE TZIHBKSF                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE KHDUMMY                                                                
*INCLUDE PDUMPER                                                                
...
*SORT BY DESCENDING WHOLESALE COST                                              
         GOTO1 =V(XSORT),DMCB,(C'N',STORAGE),(R3),RECLEN,L'BCOST,      +        
               BCOST-BOOKD                                                      
         LA    R2,STORAGE          BEGINNING OF THE TABLE                       
         LA    R4,1                RANK COUNTER                                 
MAINRNK  DS    0H                                                               
         CLI   BAUTHOR,X'FF'                                                    
         BE    EMAINRNK                                                         
         STC   R4,BRANK                                                         
...
*                                                                               
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'174TZIHBKSF  10/06/00'                                      
         END                                                                    
