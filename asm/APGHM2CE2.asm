*          DATA SET APGHM2CE2  AT LEVEL 008 AS OF 10/16/95                      
*PHASE ACHM2CE2,+0                                                              
         TITLE 'CME CONTRA FILTER REQUESTING'                                   
ACHM2CE2 CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**ACHK**,R8                                                    
         L     RA,0(R1)                                                         
...
*---------------------------------------------------------------------*         
HOOKSORT DS    0H                                                               
         CLI   QOPT3,C' '          IF BLANK THEN NO FILTERING REQUESTED         
         BE    XIT                                                              
...
*        ACGENBOTH                                                              
       ...
       ++INCLUDE ACGENBOTH                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008APGHM2CE2 10/16/95'                                      
         END                                                                    
