*          DATA SET SCHTB00X   AT LEVEL 022 AS OF 05/01/02                      
...
*                                                                               
         DC    CL6'STEADD'         STEWARD ADD                                  
         DC    X'06',AL1(UPLOAD),X'44',X'FA'                                    
         DC    AL1(0)              INDICATORS                                   
         DC    AL1(NOEDIT),XL2'00' CLIENT                                       
         DC    AL1(NOEDIT),XL2'00'                                              
         DC    AL1(NOEDIT),XL4'00'                                              
         ...
         DC    CL22'STEWARD ADD'                                                
*                                                                               
         DC    CL6'STECHA'         STEWARD MAINT                                
         DC    X'06',AL1(UPLOAD),X'45',X'00'                                    
         DC    AL1(0)              INDICATORS                                   
         DC    AL1(NOEDIT),XL2'00' CLIENT                                       
         DC    AL1(NOEDIT),XL2'00'                                              
         DC    AL1(NOEDIT),XL4'00'                                              
...
* FALOCKETD                                                                     
       ++INCLUDE FALOCKETD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'022SCHTB00X  05/01/02'                                      
         END                                                                    
