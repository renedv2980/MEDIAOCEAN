*          DATA SET REREP3K02  AT LEVEL 067 AS OF 03/28/11                      
*PHASE RE3K02C,*                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE QSORT                                                                  
...
* KZDATEAM                                                                      
* KZATTEAM                                                                      
         TITLE 'RE3K02 - REREP3K02 - KATZ INTERFACE TAPE'                       
**********************************************************************          
...
*********************************************************************           
*                                                                   *           
*   REREP3K02 - RE3K02 - KATZ ACCOUNTING TAPE                       *           
*                                                                   *           
*********************************************************************           
*                                                                   *           
...
* UPDATE HISTORY:                                                   *           
*                                                                   *           
* OCT19/95 (BG ) --- INITIAL ENTRY (COPY OF 37)                     *           
*                                                                   *           
* JAN29/96 (BG ) 003 ADD SENTRY - S3 DIV M  & ADD CONTROL RECS (NOP)*           
*                                                                   *           
* FEB01/96 (BG ) 5/6 FIX MISSING ADV CODE, ALLOW SENTRY (S3) REP    *           
*                                                                   *           
* MAR05/96 (BG ) 16  ADD KZXXTEAM CODES, PRT TOTALS AFTER EACH TYPE *           
*                                                                   *           
* MAY23/96 (BG ) 17  FORCE ASAT DATE IF NOT ENTERED                 *           
*                                                                   *           
* JUN05/96 (BG ) 18  ADD MASTER REP MR FOR AM, CQ, NK               *           
*                                                                   *           
* AUG02/96 (BG ) 19  SEND OFF SE AS 065, EXCEPT SZ/S2 GET 061       *           
*                                                                   *           
* AUG09/96 (BG ) 20 FIX SENDING ALL SALESPEOPLE                     *           
*                                                                   *           
* SEP27/96 (BG ) 21 ADD K6 (D)                                      *           
*                                                                   *           
* OCT16/96 (BG ) 22 ADD PRODUCT RECORDS                             *           
*                                                                   *           
* NOV14/96 (BG ) 23 ADD LTORG TO INIT                               *           
*                                                                   *           
* APR30/97 (BU ) 24 ADD LOW POWER -L STATION                        *           
*                                                                   *           
* MAY01/97 (BU ) 25 USE BEST DOLLAR FIGURES, NOT ORDERED            *           
*                                                                   *           
* MAY21/97 (BG ) 26 ADD AGY/OFF TO TAPE                             *           
*                                                                   *           
* MAY21/97 (BU ) 27 UPGRADE FOR YR 2000                             *           
*                                                                   *           
* JUN23/97 (BU ) 28 ADD DCT TO REC 1, ADD FLDS TO PROD REC          *           
*                                                                   *           
* JAN25/98 (JRD) --- 4K CONTRACTS                                   *           
*                                                                   *           
* SEP01/98 (BU ) --- SOFTEN 'NO AGENCY FOUND IN PROD REC' ERROR     *           
*                                                                   *           
* MAR03/00 (BU ) --- EXPAND OUTPUT RECORD TO INCLUDE PRODUCT DATA   *           
*                    ** USES REGENKTPA **                           *           
*                    ** USES REREP3K03A **                          *           
*                                                                   *           
* JAN10/02 (BU ) --- ADD COMP S/P DATA OVER MASTER CONTRACT NUMBER  *           
*                                                                   *           
* JUN06/02 (BU ) --- FIX FOR DAILY PACING                           *           
*                                                                   *           
* NOV14/06 (BU ) --- ADD 'STATION/OFFICE' FILTERING FOR MO          *           
*                                                                   *           
* MAY03/07 (BU ) --- REMOVE 'STATION/OFFICE' FILTERING FOR MO       *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
*                                                                               
...
*&&DO                                                                           
         MVC   P+1(12),=C'STA-OFF SET:'                                         
         MVC   P+13(32),0(RE)                                                   
         GOTO1 HEXOUT,DMCB,ASTNAREA,P+48,4,=C'TOG'                              
         GOTO1 REPORT                                                           
*&&                                                                             
         BAS   RE,REPPROFL                                                      
*                                                                               
         BAS   RE,STATABL                                                       
*                                  LOAD STATION/OFFICE FILTER TABLE             
         OPEN  (INTFILA,OUTPUT)                                                 
         LTR   RF,RF                                                            
         BZ    INITGOOD                                                         
         DC    H'0'                                                             
...
*                                                                               
         ...
         MVI   RSTAKTYP,X'02'                                                   
         MVC   RSTAKREP,RCREPFL    INSERT REP CODE                              
         SPACE                                                                  
         GOTO1 HIGH                                                             
         B     STAB0040                                                         
STAB0020 DS   0H                                                                
         LA    R6,KEY              RESET TO PROCESS KEY                         
         GOTO1 SEQ                                                              
STAB0040 DS   0H                                                                
         CLI   KEY,X'02'           STATION RECORD?                              
         BNE   STAB0100            NO  - FINISHED                               
         CLC   KEY+20(2),RCREPFL   SAME REP?                                    
         BNE   STAB0100            NO  - FINISHED                               
         DROP  R6                                                               
STAB0080 EQU   *                                                                
         GOTO1 GETSTAT                                                          
...
*&&                                                                             
         LA    R6,RSTAREC                                                       
         MVI   BYTE,X'2D'          LOOK FOR STATION BY OFFICE ELT               
         BAS   RE,GETEL                                                         
         BNE   STAB0020            NOT FOUND - SKIP THIS RECORD                 
*&&DO                                                                           
*   TEST                                                                        
         MVC   P+1(08),=C'2D FOUND'                                             
         MVC   P+9(27),RSTAKEY                                                  
         GOTO1 REPORT                                                           
*   TEST                                                                        
*&&                                                                             
EX       USING RSTAOFEL,R6                                                      
*                                                                               
...
*                                                                               
         ...
         USING DSTATD,R1                                                        
*                                                                               
         CLC   =X'FFFFFF',DSTACALL TABLE FULL?                                  
         BNE   STAB0085                                                         
         DC    H'0'                YES                                          
*                                  INCREASE '#STANTRY'                          
...
*                                                                               
         ...
         LA    R2,DSTAOFFS         SET A(1ST STA OFFICE IN TABLE)               
         LA    R3,EX.RSTAOFFC      SET A(1ST STA RECORD OFFICE)                 
STAB0090 EQU   *                                                                
         MVC   0(2,R2),0(R3)                                                    
         LA    R2,2(R2)            BUMP RECEIVING TABLE                         
...
STAB0100 EQU   *                                                                
*                                                                               
*   REQUEST HAS NOT BEEN READ AT THIS POINT                                     
*                                                                               
***      CLI   QUESTOR+1,C'Y'      CHECK FOR PRINT                              
***      BNE   STAB0200            NO PRINT - GO BACK FOR NEXT                  
*&&DO                                                                           
*   TEST                                                                        
         MVC   P+1(18),=C'DISP STATABL'                                         
         L     RE,ASTNAREA                                                      
         LA    RF,8                                                             
         SR    RE,RF                                                            
         MVC   P+13(32),0(RE)                                                   
...
STAB0120 EQU   *                                                                
         ...
         OC    0(16,R1),0(R1)      ANYTHING IN SLOT?                            
         BZ    STAB0200            NO  - FINISHED                               
         EDIT  (R2),(4,P+1)                                                     
         MVC   P+12(37),0(R1)      DISPLAY STA, 1ST 16 OFFCS                    
         GOTO1 REPORT                                                           
         LA    R1,100(R1)          BUMP TO NEXT TABLE SLOT                      
         B     STAB0120            GO BACK FOR NEXT                             
*&&                                                                             
STAB0200 EQU   *                                                                
*                                                                               
         XIT1                                                                   
...
POST     NTR1                                                                   
*                                                                               
*   STATION / OFFICE FILTERING IS REMOVED.  MO CANNOT CONVERT                   
*        ALL ORDERS AT THE PRESENT TIME.  PLAN IS TO SEND COMPLETE              
*        FILE CREATED BY THIS PROGRAM TO MO FOR SUBSEQUENT                      
*        FILTERING.                                                             
*&&DO                                                                           
         BAS   RE,STAOFLTR         FILTER STATION / OFFICE                      
         BZ    POST001             NOT CONVERTED:  PROCESS IT                   
*   TEST                                                                        
         MVC   P+1(10),=C'CONVERTED:'                                           
         MVC   P+12(27),RCONKEY                                                 
         MVC   P+40(27),KEY                                                     
         GOTO1 REPORT                                                           
*   TEST END                                                                    
         B     POST300             INDICATES 'CONVERTED' - SKIP IT              
*&&                                                                             
*                                                                               
POST001  EQU   *                                                                
         L     R1,CONCNT                                                        
...
*                                                                               
*   NOTE:  THIS PROGRAM IS ONLY USED BY KATZ.                                   
...
*&&DO                                                                           
*   TEST 1                                                                      
         MVC   P+1(10),=C'TAB COUNT:'                                           
         EDIT  STATABCT,(2,P+12),FILL=0                                         
         MVC   P+16(27),RCONKEY                                                 
         GOTO1 REPORT                                                           
*   TEST 1 END                                                                  
*&&                                                                             
         L     R4,STATABCT         ANY TABLE ENTRIES?                           
         BZ    STOF0900            NO  - LOAD OKAY                              
         L     R2,ASTNAREA         SET A(STATION OFFICE TABLE)                  
**       CLC   STATABCT,2          MORE THAN ONE ENTRY IN TABLE?                
**       BL    STOF0100            NO                                           
         GOTO1 =V(BINSRCH),DMCB,RCONKSTA,(R2),(R4),100,5,(R4)                   
         CLI   DMCB,0              RECORD FOUND?                                
         BNE   STOF0880            NO  - NO CONVERTED OFFICES                   
*                                                                               
         L     R2,DMCB             YES - SET A(RECORD FOUND)                    
*&&DO                                                                           
*   TEST 2                                                                      
         MVC   P+1(10),=C'STA FOUND:'                                           
         MVC   P+16(50),0(R2)                                                   
         GOTO1 REPORT                                                           
*   TEST 2 END                                                                  
*&&                                                                             
         LA    R2,5(R2)            BUMP TO OFFICE LIST                          
         LA    R0,40               SET MAX LOOP                                 
STOF0040 EQU   *                                                                
         CLC   0(2,R2),SPACES      ANYTHING IN SLOT?                            
         BNH   STOF0900            NO  - OFFICE OF ORDER NOT FOUND              
         CLC   0(2,R2),RCONKOFF    YES - OFFICE = OFFICE OF ORDER?              
         BE    STOF0920            YES - OFFICE CONVERTED: SKIP ORDER           
         LA    R2,2(R2)            NO  - BUMP TO NEXT OFFICE                    
         BCT   R0,STOF0040         GO BACK FOR NEXT OFFICE                      
         B     STOF0900            NOT FOUND IN LIST                            
STOF0880 EQU   *                                                                
*&&DO                                                                           
*   TEST 3                                                                      
         MVC   P+1(10),=C'NO STATION'                                           
         MVC   P+16(27),RCONKEY                                                 
         GOTO1 REPORT                                                           
...
*                                                                               
         SPACE                                                                  
         CLOSE (INTFILA,LEAVE)            CLOSE KATZ FILE                       
         SPACE                                                                  
         OPEN  (INTFILB,OUTPUT)                                                 
         LTR   RF,RF                                                            
         BZ    *+6                                                              
...
RUND22   BAS   RE,GETAGY                                                        
         ...
         BNE   RUND26                                                           
         BAS   RE,GETAGY                                                        
         MVC   KZKZAGEQ,RAGY2EQU    KATZ EQUIV AGENCY                           
         B     RUND26                                                           
         SPACE                                                                  
RUND24   DS    0H                                                               
         MVC   KZKZAGEQ,KZDDSAGY    KATZ EQUIV AGENCY                           
RUND26   DS    0H                                                               
         PUT   INTFILB,WRK                                                      
         L     R1,TAGYCTR                                                       
         LA    R1,1(,R1)                                                        
...
RUND54   BAS   RE,GETADV                                                        
         MVI   KZRECTP3,C'3'                                                    
         MVC   KZDDSADV,KEY+21                                                  
         MVC   KZKZADEQ,RADVKATZ    KATZ EQUIV AGENCY                           
...
****>>   LA    R4,KZTPREC          A(KATZ TAPE RECORD)                          
         LA    RF,144                                                           
...
READS26  XC    KEY,KEY            BUILD KEY FOR AGENCY                          
         ...
         BNE   READS28                                                          
         BAS   RE,GETAGY                                                        
         MVC   6(4,R3),RAGY2EQU    KATZ EQUIV AGENCY                            
READS28  DS    0H                                                               
         LA    R2,SALTABCT                                                      
         L     R3,=A(SALTABLE)                                                  
...
*&&                                                                             
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'067REREP3K02 03/28/11'                                      
         END                                                                    
