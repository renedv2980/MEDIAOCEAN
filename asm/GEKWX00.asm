*          DATA SET GEKWX00    AT LEVEL 066 AS OF 09/06/02                      
*PHASE TF2000A,*                                                                
...
*                                                                   *           
* 28MAY96 (SKU) --- 'HARD-CODE' FOR KATZ TV (DIE DIE DIE)           *           
*                                                                   *           
* 07APR97 (BU ) --- 'HARD-CODE' FOR FOX NETWORK (TELL ME ABOUT IT)  *           
*                                                                   *           
* 23JUL98 (BU ) --- 'HARD-CODE' FOR ALLNY/CBSRNY(THE BEAT GOES ON)  *           
*                                                                   *           
* 24JUL98 (BU ) --- ADD REP-CODE TESTS FOR TCHN ASSIGNMENT          *           
*                                                                   *           
* 10DEC98 (RHV) --- ALLOW RETENTION=KEEP                            *           
*                                                                   *           
* 26JUN01 (SKU) --- 'HARD-CODE' FOR FOX STATION SALES               *           
*                                                                   *           
* 06SEP02 (BU ) --- 'HARD-CODE' FOR RALPH'S TEST RMRNY              *           
*                     ***  END TOMBSTONE  ***                       *           
*********************************************************************           
         PRINT NOGEN                                                            
KWX00    CSECT                                                                  
...
*                                                                               
         ...
         BE    CHKI0023            YES                                          
         CLC   =H'6047',TWAUSRID   UNAT USER?                                   
         BE    CHKI0023            YES                                          
         CLC   =H'1452',TWAUSRID   TELNY USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'1678',TWAUSRID   TMNHB USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'1453',TWAUSRID   TELLA USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'1455',TWAUSRID   TELCH USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'1790',TWAUSRID   TELDA USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'3590',TWAUSRID   TELSA USER?                                  
         BE    CHKI0023            YES                                          
         ...
         BE    CHKI0023            YES                                          
         CLC   =H'5893',TWAUSRID   ALLNY USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'10195',TWAUSRID  RMRNY USER?                                  
         BE    CHKI0023            YES                                          
         CLC   =H'6521',TWAUSRID   CBSRNY USER?                                 
         BE    CHKI0023            YES                                          
         CLC   =H'4947',TWAUSRID   CCRNY USER?                                  
         BE    CHKI0023            YES                                          
*                                                                               
         CLC   TWAUSRID,=H'7885'   CUMLNY USER?                                 
         BL    IRCHK010            YES                                          
         CLC   TWAUSRID,=H'7899'   ALL OF CUMULUS                               
         BNH   CHKI0023            YES                                          
*                                                                               
IRCHK010 EQU   *                                                                
         CLC   =C'XN',TWAAGY       OR STATIONS WITH TELEMUNDO ID                
         BE    CHKI0023            YES                                          
         LA    RF,IRCOMPS                                                       
IRCHK020 EQU   *                                                                
         CLI   0(RF),0             END OF TABLE?                                
         BE    IRCHK080            YES - NOT FOUND                              
         CLC   0(2,RF),TWAAGY      AGENCY IN TABLE?                             
         BE    CHKI0023            YES - INTEREP COMPANY                        
         LA    RF,2(RF)            NO  - BUMP TO NEXT ENTRY                     
         B     IRCHK020            GO BACK FOR NEXT                             
*                                                                               
IRCOMPS  DC    C'AQMGIFI2I8I9RMD4S1CNL7IB'                                      
         DC    X'0000'             DELIMITER                                    
*                                                                               
IRCHK080 EQU   *                                                                
         ...
         BE    CHKI0025            YES                                          
* KATZ TV USER                                                                  
         CLC   =H'5077',TWAUSRID   KCONY USER? REP5                             
         BE    CHKI0025            YES                                          
         CLC   =H'5075',TWAUSRID   KNANY USER? REP5                             
         BE    CHKI0025            YES                                          
         CLC   =H'5073',TWAUSRID   KAMNY USER? REP5                             
         BE    CHKI0025            YES                                          
         CLC   =H'5089',TWAUSRID   KTVNY USER? REP5                             
         BE    CHKI0025            YES                                          
         CLC   =H'6614',TWAUSRID   KTVNY USER? REP5                             
         BE    CHKI0025            YES                                          
         CLC   =C'CQ',TWAAGY       OR STATIONS WITH KATZ ALPHA ID               
         BE    CHKI0025            YES                                          
         CLC   =C'NK',TWAAGY       OR STATIONS WITH KATZ ALPHA ID               
         BE    CHKI0025            YES                                          
         CLC   =C'AM',TWAAGY       OR STATIONS WITH KATZ ALPHA ID               
         BE    CHKI0025            YES                                          
         CLC   =C'MR',TWAAGY       OR STATIONS WITH KATZ ALPHA ID               
         BE    CHKI0025            YES                                          
         CLC   =C'NP',TWAAGY       OR STATIONS WITH NPTV ALPHA ID               
         BE    CHKI0025            YES                                          
*                                                                               
...
*                                                                               
         ...
         BE    CHKI0035            YES                                          
         CLC   =H'6264',TWAUSRID   FOXTV USER? REP8                             
         BE    CHKI0035            YES                                          
         CLC   =C'FN',TWAAGY       OR STATIONS WITH FN ALPHA ID                 
         BE    CHKI0035            YES                                          
         CLC   =H'9559',TWAUSRID   FOXTV USER? REP8                             
         BE    CHKI0035            YES                                          
         CLC   =C'FB',TWAAGY       OR STATIONS WITH FB ALPHA ID                 
         BE    CHKI0035            YES                                          
         B     CHKI0040            NO                                           
*                                                                               
CHKI0020 EQU   *                                                                
...
CHKNUM   NTR1                                                                   
         ...
         SPACE 3                                                                
*                                                                               
CHKRET   NTR1                      VALIDATE RETENTION ARGUMENT                  
         LM    R2,R3,0(R1)         R2=A(SCANNER ENTRY), R3=A(OUTPUT)            
         MVI   FERN,68                                                          
         CLI   SAVMODE,FORMAT                                                   
         BE    ERRXIT              NO RETENTION CHANGE FOR FORMATS              
*&&DO                                                                           
         CLC   =C'KEEP',22(R2)                                                  
         BNE   CHKRET10                                                         
         MVC   0(2,R3),=X'FFFF'                                                 
...
PARUSER  DC    AL1(PARUSX-*),CL9'USER     ',AL2(ADDS-GWS),AL4(CHKADDS)          
         DC    AL1(AUT,0)                                                       
PARUSX   DS    0H                                                               
PARRET   DC    AL1(PARRTX-*),CL9'RETENTION',AL2(NUM-GWS),AL4(CHKRET)            
         DC    AL1(BOO,0)                                                       
PARRTX   DS    0H                                                               
...
* FAFACTS                                                                       
       ...
       ++INCLUDE FAFACTS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'066GEKWX00   09/06/02'                                      
         END                                                                    
