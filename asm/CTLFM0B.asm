*          DATA SET CTLFM0B    AT LEVEL 029 AS OF 01/17/03                      
*PHASE TA020BB,+0                                                               
...
*&&DO                                                                           
         ...
         STC   R1,CTBKYM+1                                                      
*&&                                                                             
         CLC   CTBKYM,CTBDATA+2    CANT BE LARGER THAN LAST ACT. DATE           
         BH    EIIF                                                             
         MVI   CTBKEL,CTBKELEQ                                                  
         MVI   CTBKLN,CTBKLNEQ                                                  
*                                  MAKE SURE WE ARE NOT DUPLICATING             
         LA    R1,CTBDATA          POINT TO THE FIRST ELEMENT                   
DATAV9A  CLI   0(R1),X'01'         ACTIVITY ELEMENT?                            
         BNE   DATAV9B                                                          
         ZIC   RE,1(R1)            BUMP PAST X'01'                              
         AR    R1,RE                                                            
         B     DATAV9A                                                          
DATAV9B  CLI   0(R1),X'02'         X'02' ELEMENTS?                              
         BNE   DATAV9X                                                          
         CLI   1(R1),CTBKLNEQ      LATEST BOOK ELEMENT?                         
         BNE   DATAV9C                                                          
         CLC   TEMP(CTBKYM-CTBKEL),0(R1)                                        
         BNE   DATAV9C             SAME SOURCE AND MEDIA?                       
         LA    RE,LINSRCH                                                       
         ST    RE,FADR                                                          
         B     EDUP                                                             
*                                  RETURN INVALID, SHOULD JUST CHG DATE         
DATAV9C  ZIC   RE,1(R1)            BUMP PAST X'02'                              
         AR    R1,RE                                                            
         B     DATAV9A                                                          
*                                                                               
DATAV9X  GOTO1 APUTEL                                                           
         BZ    EXIT                                                             
*                                                                               
...
* CTLFMERRS                                                                     
       ++INCLUDE CTLFMERRS                                                      
EDUP     MVI   FERN,61             DUPLICATE ENTRY                              
         B     EXIT                                                             
         EJECT                                                                  
*              LITERALS ETC.                                                    
*                                                                               
...
* CTLFMF4D                                                                      
       ++INCLUDE CTLFMF4D                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029CTLFM0B   01/17/03'                                      
         END                                                                    
