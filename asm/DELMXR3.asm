*          DATA SET DELMXR3    AT LEVEL 003 AS OF 05/08/17                      
...
*INCLUDE LMTIME2                                                                
***********************************************************************         
*THIS EXIT IS A COPY OF DELMXR1 AND MODIFIED FOR 3AM START OF DAY               
*                                                                     *         
...
*                                                                               
         ...
         BRAS  RE,CALL_DDS_SUBRTN                                               
*                                                                               
         CLI   QHR,X'60'           12A-245A MINUS A DAY                         
         BNL   QH10                BASED OF 3A START DAY                        
         CLI   QHR,X'54'                                                        
         BL    QH10                                                             
...
*                                                                               
         ...
         BRAS  RE,CALL_DDS_SUBRTN                                               
*                                                                               
         CLI   SQHR,X'54'          12A-245A MINUS A DAY BASE ON 3A              
         BL    PL15                                                             
         LHI   R4,-1                                                            
...
*                                                                               
PL15     DS    0H                                                               
         CLI   EQHR,X'54'          12A-245A MINUS A DAY BASE ON 3A              
         BL    PL17                                                             
** NEWEST CODE 07/22 TO SEE IF THE DAY FOR 3A-5A CAN BE ADJUST BACK             
** TO BE SAME AS 12A-3A                                                         
         LHI   R4,-1                                                            
...
*                                                                               
         ...
         LTORG                                                                  
         EJECT                                                                  
         ORG   DELMXR3+(((*-DELMXR3)/256)+1)*256  FOR I-CACHE PIPELINE          
         SPACE 2                                                                
...
*                                                                               
       ...
       ++INCLUDE DELMDSECT                                                      
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003DELMXR3   05/08/17'                                      
         END                                                                    
