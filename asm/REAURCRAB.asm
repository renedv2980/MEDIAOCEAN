*          DATA SET REAURCRAB  AT LEVEL 117 AS OF 05/01/02                      
*PHASE REAURCRB,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
*                                                                               
         ...
         SH    RF,=H'3'            BACK UP THREE YEARS                          
         STC   RF,AGO3YRS                                                       
*                                                                               
*   TEST AGO DATE                                                               
**       MVC   AGO3YRS,=X'630101'                                               
*   TEST AGO DATE END                                                           
*                                                                               
         BAS   R5,GETMONDT                                                      
*                                                                               
...
REBU0028 EQU   *                                                                
         ...
         BE    REBU002A            YES - SKIP IT                                
         CLI   RBUYCHGI+1,C'C'     CANCELLED RECORD?                            
         BNE   REBU002F            NO  - PROCESS IT                             
REBU002A EQU   *                                                                
*                                                                               
*   TEST PRINT                                                                  
         MVC   P+1(13),=C'XCLD BUYLINE:'                                        
         GOTO1 =V(HEXOUT),DMCB,RBUYKCON,P+16,4,=C'TOG'                          
         EDIT  RBUYKLIN,(3,P+28)                                                
         GOTO1 =V(PRINTER)                                                      
*   TEST PRINT END                                                              
*                                                                               
         B     REBU0010            SKIP RECORD                                  
REBU002F EQU   *                                                                
**********************************************************************          
...
*   SPECIAL CONTRACT TEST                                                       
         CLC   RBUYKCON,=X'85980669'                                            
         BNE   REBU0030                                                         
*                                                                               
*   TEST PRINT                                                                  
         MVC   P+1(08),=C'RBUYELEM'                                             
         MVC   P+9(64),RBUYELEM                                                 
         GOTO1 =V(PRINTER)                                                      
*   TEST PRINT END                                                              
*                                                                               
...
PSEUDO   NMOD1 0,*PSEU*                                                         
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'117REAURCRAB 05/01/02'                                      
         END                                                                    
