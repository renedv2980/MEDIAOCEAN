*          DATA SET DELMXP5    AT LEVEL 010 AS OF 05/08/17                      
...
*                                                                     *         
* IT CALCULATES THE INDIVIDUAL DAY "NORMAL" AVERAGE IF THERE ARE      *         
* QUARTER HOURS BOTH INSIDE AND OUTSIDE OF THE "NORMAL" BOUNDARIES.   *         
*                                                                     *         
...
**********************************************************************          
*                                                                               
* INPUT:  ALL QUARTER HOURS OF PROGRAMS THAT HAVE A "NORMAL" START AND          
* -----   END TIME. THE QH RECORDS HAVE A FLAG THAT SAYS WHETHER OR             
*         NOT THE QUARTER HOUR FALLS WITHIN THE "NORMAL" BOUNDARIES.            
*         THE RECORDS ARE SORTED SO THAT ALL THE QHS THAT FALL INSIDE           
*         THE "NORMAL" BOUNDARIES COME BEFORE THE QHS THAT FALL OUTSIDE         
*         THE BOUNDARIES.                                                       
*                                                                               
* OUTPUT: FOR PROGRAMS THAT HAVE QUARTER HOURS THAT FALL BOTH INSIDE            
* ------  AND OUTSIDE THE "NORMAL" BOUNDARIES, CREATE A "NORMAL"                
*         AVERAGE BY AVERAGING TOGETHER THE QUARTER HOURS THAT FALL             
...
*                                                                               
         USING LMDSECT,R3                                                       
*                                                                               
MAIN20   CLC   W_KDTYPE,PREV_KDTYPE        CHANGE IN DATA TYPE                  
         BNE   NEW_NOR                                                          
...
*                                                                               
         ...
         BNE   ADDTOAVG              NO. ADD RECD TO AVERAGE                    
...
*                                                                               
         ...
         BE    ADDTOAVG              YES. ADD RECD TO AVG                       
*                                                                               
         MVI   SKIP_FLAG,YESQ        NO. THIS IS A RECD OUTSIDE BNDRS           
...
*                                                                               
***********************************************************************         
* COMPUTE AND RELEASE THE AVERAGE RECORD FOR THE PREVIOUS "NORMAL".             
*                                                                               
...
* DERIVE THE DETAILED "REPORT" END QUARTER HOUR                                 
         BAS   RE,DREPETIM                                                      
*                                                                               
         B     ADDREC              RELEASE "NORMAL" AVERAGE                     
*                                                                               
***********************************************************************         
* DFSORT ACTIONS                                                                
***********************************************************************         
...
*                                                                               
         SPACE 2                                                                
         ORG   DELMXP5+(((*-DELMXP5)/256)+1)*256  FOR I-CACHE PIPELINE          
         SPACE 2                                                                
...
*                                                                               
HPSBUFF  DS    (NTDEMSQ)D'0'  BUFFER FOR MARKET TOTALS   (22 DEMOS)             
...
* INPUT RECORDS DSECT                                                           
       ...
       ++INCLUDE DELMDSECT                                                      
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010DELMXP5   05/08/17'                                      
         END                                                                    
