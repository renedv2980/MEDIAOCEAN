*          DATA SET REBAS02A   AT LEVEL 075 AS OF 05/01/02                      
*PHASE T82402A,*                                                                
*INCLUDE NUMVAL                                                                 
*INCLUDE REGENDRB                                                               
*                                                                               
...
FN100    GOTO1 ADDELEM                                                          
         ...
         SPACE 2                                                                
*                                                                               
*  R3 POINTS TO "REPENTRY" FIELD                                                
*                                                                               
VERIREP  NTR1                                                                   
         XC    REP,REP                                                          
VERI10   GOTO1 =V(REGENDRB),DMCB,(REPMEDIA,REP),(X'80',REPENTRY),      *        
               ACOMFACS,RR=YES                                                  
         TM    8(R1),X'80'      IF NO RECORD FOUND, INVALID REP                 
         BNZ   FNNO                                                             
         CLC   8(3,R2),0(R3)    CORRECT REP?                                    
         BE    FNYES             YES                                            
         TM    8(R1),X'40'       NO, CHECK "NO MORE RECORDS" FLAG               
         BZ    VERI10           IF FLAG OFF, REPEAT LOOP                        
         B     FNNO              ELSE, INVALID REP                              
         SPACE 1                                                                
*                                                                               
FNYES    SR    RC,RC                                                            
FNNO     LTR   RC,RC                                                            
...
*                                                                               
REPENTRY DS    CL25                REPIDS TABLE RPLACEMENT                      
REPMEDIA DS    CL1                 REP MEDIA TYPE                               
REP      DS    CL3                 REP CODE (FOR LOOKUP)                        
*                                                                               
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'075REBAS02A  05/01/02'                                      
         END                                                                    
