*          DATA SET REREPTS02A AT LEVEL 003 AS OF 02/02/00                      
*PHASE RETS02A,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH2                                                               
...
*                                                                  *            
* FEB02/00 (BU ) --- RESEQUENCE SORT KEY                           *            
*                                                                  *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
MAIN0280 EQU   *                                                                
         ...
         OC    SBUYLN#,SBUYLN#     ANY VALUE?                                   
         BNZ   MAIN0290            YES                                          
         MVI   SBUYLN#,X'FF'       NO  - SET TO HIGH VALUE                      
MAIN0290 EQU   *                                                                
...
*********************************************************************           
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003REREPTS02A02/02/00'                                      
         END                                                                    
