*          DATA SET RESFM21A   AT LEVEL 005 AS OF 08/09/96                      
*PHASE T81821A,*                                                                
...
*                                                                    *          
* 09AUG96  (BU ) --- EXPAND DAY 'RA' TO ALLOW 200 ENTRIES            *          
*                                                                    *          
*                                                                    *          
*                                                                    *          
*                                                                    *          
...
*                                                                               
         ...
         CLC   =C'RA',REPORT       DAY = RA?                                    
         BNE   OA20                NO                                           
         LA    R3,200              YES - PERMIT 200 RECORDS                     
OA20     EQU   *                                                                
...
OVDEL    DS    0H                                                               
         ...
         CLC   =C'RA',REPORT       DAY = 'RA'?                                  
         BNE   OV10                NO                                           
         LA    R3,200              YES - ALLOW LARGER NUMBER                    
...
*RESFMWORKD                                                                     
       ...
       ++INCLUDE RESFMWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005RESFM21A  08/09/96'                                      
         END                                                                    
