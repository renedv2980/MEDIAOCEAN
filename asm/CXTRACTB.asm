*          DATA SET CXTRACTB   AT LEVEL 119 AS OF 09/03/03                      
*PHASE CXTRACTA                                                                 
*INCLUDE DMUTLCT                                                                
*INCLUDE DMDMGRL                                                                
*INCLUDE CXSAGC                                                                 
...
USPE010  GOTO1 CXUPDT,DMCB,VCXSPEC,VCXSPEX,INITSPE                              
         ...
         B     USPEOK                                                           
*                                  VERSION >= 2                                 
USPE020  GOTO1 CXUPDT,DMCB,VCXSPE2C,VCXSPE2X,INITSPE                            
         BNE   USPENO                                                           
         B     USPEOK                                                           
*                                                                               
USPENO   B     NO                                                               
...
INAGUTAB NTR1                                                                   
         ...
         USING AGUTABD,R4                                                       
         LR    R0,R4               CLEAR ENTIRE TABLE                           
         ICM   R1,15,=AL4(CXSAGUTX-CXSAGUT)                                     
         XR    RF,RF                                                            
         MVCL  R0,RE                                                            
*                                  NOW FILL IN ALL NEEDFUL VALUES               
IAGU02   C     R5,DXSTEPTR                                                      
         BE    IAGU04                                                           
         CLI   SXDTSUB,X'01'                                                    
         BNE   IAGU03                                                           
         MVC   AGUAGYID,SXDTAGY                                                 
         MVC   AGUSAGID,SXDTAGY                                                 
         AHI   R4,AGUTLEN          NEXT IN OUR TABLE                            
*                                                                               
...
IAGU16   CLI   0(R3),0                                                          
         ...
         DROP  X                                                                
*                                                                               
IAGU18   AHI   R4,AGUTLEN          NEXT ROW                                     
         C     R4,=A(CXSAGUTX)                                                  
         BL    IAGU10                                                           
         DC    H'0'                OVERFLOW                                     
*                                                                               
...
CXSSAGTX EQU   *                                                                
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'119CXTRACTB  09/03/03'                                      
         END                                                                    
