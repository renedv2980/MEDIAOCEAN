*          DATA SET NESFM3B    AT LEVEL 052 AS OF 02/06/06                      
*PHASE T31C3BA                                                                  
***********************************************************************         
*                                                                               
*  TITLE: NESFM3B - T31C3B BILL FORMULA RECORDS MAINTENANCE                     
*                                                                               
*  CALLED FROM: SFM CONTROLLER (T31C00), WHICH CALLS                            
*               GEGENCON (T00A30) WHICH CALLS THIS.                             
*                                                                               
*  INPUTS: SCREENS SPSFM9F (T31C9F) -- MAINTENANCE SCREEN                       
*                                                                               
...
*                                                                               
*   NOTE- ACTUALLY FOR THIS NETPAK CLONE OF THE SPOT PHASE                      
*         MGR/MKT HAVE BEEN DISABLED. THE SCREEN FIELDS HAVE BEEN               
*         PROTECTED AND SOME BYPASSING CODE ADDED. IT SHOULD BE                 
*         PRETTY EASY TO RESTORE IT IF NEEDED.                                  
*                                                                               
***********************************************************************         
T31C3B   TITLE 'NESFM3B - BILL FORMULA RECORDS MAINTENANCE OVERLAY'             
T31C3B   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T31C3B*,R7                                                    
         L     RC,0(R1)                                                         
...
VKMED00  LA    R2,BILMEDH                                                       
         BAS   RE,VSUBMED          VALIDATE SUBMEDIA TYPE                       
*                                                                               
...
*                                                                               
VR40     LA    R2,LINMKTH                                                       
         TM    1(R2),X'20'          IF PRTOECTED, SKIP                          
         BZ    VR41                                                             
         MVC   QMKT,SPACES                                                      
         B     VR46                                                             
*                                                                               
...
VR106    DS    0H                                                               
         XC    BMKT,BMKT                                                        
         B     VR107          **** NOOP MARKET EDIT FOR NETPAK                  
         CLC   =C'ALL',LINMKT                                                   
         BE    VR107                                                            
         LA    R2,LINMKTH                                                       
         GOTO1 VALIMKT                                                          
...
*                                                                               
         CLC   BFSUBMED,SUBMED     SAME SUBMEDIA?                               
         BNE   LR100SQ                                                          
*                                                                               
         MVI   BILMED,C'N'                                                      
         CLI   BFSUBMED,0                                                       
...
*                                                                               
LR216    DS    0H                                                               
         TM    LINMKTH+1,X'20'     IF PROTECTED, SKIP                           
         BNZ   LR220                                                            
         OC    BFKMGR,BFKMGR                                                    
         BNZ   LR218                                                            
         MVC   LINMKT(3),=C'ALL'                                                
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'052NESFM3B   02/06/06'                                      
         END                                                                    
