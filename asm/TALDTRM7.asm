*          DATA SET TALDTRM7   AT LEVEL 004 AS OF 05/01/02                      
*PHASE TALDTR7A TALDTRM7                                                        
*INCLUDE SCANNER                                                                
         TITLE 'TALDTRm7 - TALENT LOAD/DUMP MODEL EXTERNAL ROUTINE'             
* PARAMETER LIST                                                                
*                                                                               
...
TRIMLIST DS    0F                                                               
         ...
         SPACE 1                                                                
         DC    AL1(TLAYCDQ),AL1(0),C'Y ',CL8'AY'                                
         DC    AL1(TLATCDQ),AL1(0),C'Y ',CL8'AT'                                
...
*********INCLUDE TAGENFILE                                                      
       ...
       ++INCLUDE TAGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004TALDTRM7  05/01/02'                                      
         END                                                                    
