*          DATA SET NEWRI52N   AT LEVEL 035 AS OF 01/07/08                      
...
UPL45    L     R2,NBAIO                                                         
         ...
         BNE   UPL50                                                            
         USING NPK2D,R2                                                         
         MVC   WMALLOC,NPAKMPRD    3 CHAR CODE                                  
*                                                                               
UPL50    MVI   FTERMFLG,1                     OPTIONAL FIELDS                   
         LA    R2,SPLDEMH                     DEMOS                             
         CLI   5(R2),0                                                          
         BE    UPL70                                                            
...
RP65     L     R2,NBAIO                                                         
         ...
         BNE   RP70                                                             
         USING NPK2D,R2                                                         
         MVC   WMALLOC,NPAKMPRD    3 CHAR PROD                                  
*                                                                               
...
*                                                                               
       ...
       ++INCLUDE DDDLCB                                                         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035NEWRI52N  01/07/08'                                      
         END                                                                    
