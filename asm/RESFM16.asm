*          DATA SET RESFM16    AT LEVEL 236 AS OF 11/14/03                      
*PHASE T81816A,*                                                                
...
*                                                                               
         ...
         BNE   PS150               NO                                           
         GOTO1 =A(PUTCOMBO),DMCB,(RC),RR=RELO                                   
         B     PS150                                                            
*                                                                               
PS100    EQU   *                                                                
*** NEW                                                                         
...
GETMKT   NTR1  BASE=*,LABEL=*                                                   
         ...
         ZIC   R1,5(RF)                                                         
         LA    RE,5                SUBTRACT L(MKT= + 1 FOR EX)                  
         SR    R1,RE                                                            
         EX    R1,GETM0020                                                      
         B     GETM0040                                                         
GETM0020 MVC   KEY+23(0),AUCSTA+4  INSERT CODE BY LENGTH                        
GETM0040 EQU   *                                                                
         MVI   RDUPDATE,C'N'                                                    
*                                                                               
*                                                                               
...
BCMB0040 EQU   *                                                                
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'236RESFM16   11/14/03'                                      
         END                                                                    
