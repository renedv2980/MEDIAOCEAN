*          DATA SET ACREPFU02  AT LEVEL 016 AS OF 04/28/15                      
*PHASE ACFU02A                                                                  
*INCLUDE DATVAL                                                                 
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
...
*        USING IHADCB,R2                                                        
         ...
         LA    R1,INFKY-INFD+1       DISP. TO KEY                               
         CVD   R1,DUB                                                           
         OI    DUB+7,X'0F'                                                      
...
*                                                                               
         LA    R0,5                SET NUMBER OF FILTERS                        
         LA    R4,RSTFILT1         START AT THE FIRST                           
*                                                                               
         CLI   0(R4),X'40'         MUST BE A BLANK OR BETTER                    
         BNL   *+8                                                              
         MVI   0(R4),X'40'                                                      
         LA    R4,1(R4)                                                         
         BCT   R0,*-16                                                          
*                                                                               
         USING ACTRECD,R2                                                       
         MVC   ACTRSAF1,RSTFILT1   MOVE FROM THE CORRECTED FILTERS              
...
PROD5    CLI   LEVEL,12            LOWEST LEVEL ONLY                            
         BNE   PROD7                                                            
         CLI   QOPT4,C'Y'          ARE WE REQUIRING CBS JOB?                    
         BNE   PROD7                                                            
...
* DDMASTD                                                                       
       ...
       ++INCLUDE DDMASTD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016ACREPFU02 04/28/15'                                      
         END                                                                    
