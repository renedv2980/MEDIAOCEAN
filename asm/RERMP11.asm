*          DATA SET RERMP11    AT LEVEL 229 AS OF 08/06/09                      
*PHASE T81011C,+0                                                               
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLSTB                                                               
...
VK440    LA    R2,MTREFFH                                                       
*                                                                               
         LA    R5,RINVKSTD-RINVKEY LENGTH OF KEY CHECK (WITHOUT DATE)           
*                                                                               
         CLI   5(R2),0                                                          
         BE    VK560                                                            
*                                                                               
         LA    R5,L'RINVKSTD(R5)   LENGTH OF KEY CHECK (WITH DATE)              
*                                                                               
         MVI   ERROR,INVALID                                                    
*                                                                               
         XC    DTEHLD,DTEHLD                                                    
...
DKEY20   LA    R2,MTRPROGH                                                      
         MVC   MTRPROG,SPACES      CLEAR PROGRAM FIELD                          
         MVI   5(R2),L'MTRPROG     SET LENGTH                                   
         OI    6(R2),X'80'         TRANSMIT                                     
*                                                                               
         USING RIPGELEM,R4                                                      
         PRINT GEN                                                              
...
*&&                                                                             
         ...
         LA    RF,MHDTTAB          ASSUME MULTI HUTS                            
                                                                                
         OC    0(5,RF),0(RF)       IF TABLE EMPTY                               
         BZ    *+12                   USE DAY/TIMES TABLE                       
         CLI   0(RF),X'FF'         OR EOT                                       
         BNE   *+8                                                              
...
DATAR6AC DS    0H                                                               
         ...
         CLI   5(RF),X'FF'         ANY MORE DAY/TIME IN TABLE?                  
         BE    *+8                                                              
         CLI   5(RF),0             ANY MORE DAY/TIME IN TABLE?                  
         BE    DATAR6AF             NOPE                                        
*                                   YES, THERE ARE MULTIPLE DAY/TIMES           
...
*                                                                               
         ...
         MVC   RINVKQLF,INVTOBK    BOOKVAL BITS                                 
...
*                                                                               
         ...
         BZ    DATAR18A                                                         
         BAS   RE,BLD09            YES,BLD MULTI-HUT DAY TIME ELEMENTS          
***>>    B     *+8                                                              
DATAR18A BAS   RE,BLDCE            NO,BUILD CE DAY TIME ELEMENTS                
*                                                                               
         SPACE                                                                  
...
*                                                                               
*        RE-BUILD DEMO DY/YM LIST FROM X'09'S                                   
*                                                                               
         LA    R3,INVDYTIM                                                      
         USING DBXTLD,R3                                                        
*                                                                               
...
DAYTIM6  BCTR  R7,0                NOW I EXPECT TO FIND A TIME FIELD            
         ...
         SPACE 1                                                                
DAYTIM8  GOTO1 TIMVAL,DMCB,((R5),12(R3)),DUB+4                                  
         CLI   DMCB,X'FF'                                                       
...
LENVALS  EQU   NUMVALS*4                                                        
       ...
       ++INCLUDE REBKLSTD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'229RERMP11   08/06/09'                                      
         END                                                                    
