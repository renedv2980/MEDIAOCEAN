*          DATA SET NEWRI56Z   AT LEVEL 002 AS OF 05/01/02                      
...
*****************************************************                           
*  OPTIONS:  THIS APPLICATION DELETES PROGRAM RECS                              
*            EITHER BY SPECIFIC PRGCOD+ENDATE OR BY                             
*            ENDATE ALONE.                                                      
*                                                                               
*                                                                               
*******************************************************                         
...
REP40    CLC   KEY(5),KEYSAVE      AGY/CLI/MKTNUMBER                            
         BNE   REPX                                                             
         CLI   SPLPRGH+5,0                                                      
         BE    *+14                                                             
         CLC   KEY(11),KEYSAVE       AGY//CLI ETC + PROGCODE                    
         BNE   REPX                                                             
...
*                                                                               
       ...
       ++INCLUDE NEWRICAD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002NEWRI56Z  05/01/02'                                      
         END                                                                    
