*          DATA SET STEXTBSN   AT LEVEL 004 AS OF 09/17/93                      
*PHASE STEXTBS,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
         TITLE 'DMLDEXT - LOAD/DUMP MODEL EXTERNAL ROUTINE'                     
* SPOT7 CREATE NEW ML4 STATION RECORDS FROM ML3                                 
* SEP17/93                                                                      
         SPACE                                                                  
*                                                                               
* PARAMETER LIST                                                                
...
*        BNE   DMXPURGE                                                         
         ...
         AP    TSTACT,=P'1'                                                     
         SPACE                                                                  
         CLC   STAKCLT,=C'ML3'     IS THIS ML3                                  
         BNE   DMXPURGE                                                         
         SPACE                                                                  
         AP    TSTANEW,=P'1'                                                    
         MVC   STAKCLT,=C'ML4'     MAKE IT ML4                                  
         SPACE                                                                  
         BC    0,DMXKEEP                                                        
         MVI   *-3,X'F0'                                                        
         LA    R4,=CL20'STA NEW CLT'                                            
         B     PRT                                                              
         SPACE                                                                  
         DROP  R3                                                               
         SPACE                                                                  
...
TSTANEW  DC    PL5'0',CL28'TOT STAS NEW CLT-ML4'                                
...
MKTRECD   DSECT                                                                 
       ++INCLUDE SPGENMKT                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004STEXTBSN  09/17/93'                                      
         END                                                                    
