*          DATA SET SPLDEXTYK1 AT LEVEL 124 AS OF 07/12/00                      
*PHASE SPEXTYK1,+0                                                              
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
...
RECTYP1  DS    0H                  XX XX A/M CLT CLT                            
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE1  NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP2  DS    0H                  XX XX A/M                                    
         ...
         CLI   BYTE,X'10'          YN = X'10'                                   
         BNE   DMXPURGE                                                         
         NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP3  DS    0H                  XX XX A/M XX CLT CLT                         
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE3  NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP4  DS    0H                  XX XX AGY AGY                                
         CLC   2(2,R3),=C'YN'      AGY=YN                                       
         BNE   DMXPURGE                                                         
         MVC   2(2,R3),=C'UY'      CHANGE TO 'UY'                               
         B     DMXKX                                                            
*                                                                               
RECTYP5  DS    0H                  XX XX A/M 5XX'S CLT CLT                      
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE5  NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP6  DS    0H                  XX A/M CLT CLT                               
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE6  NI    1(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    1(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP7  DS    0H                  A/M CLT CLT                                  
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE7  NI    0(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    0(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP8  DS    0H                  AGY ?????                                    
...
RECTYP11 DS    0H                  XX XX XX AGY AGY XX CLT CLT CLT              
         ...
         BAS   RE,CKCHARCL                                                      
         BNE   DMXPURGE                                                         
CHANGE11 MVC   3(2,R3),=C'UY'      CHANGE YN FOR UY                             
         B     DMXKX                                                            
*                                                                               
RECTYP12 DS    0H                  XX AGY AGY XX CLT CLT CLT                    
         ...
         BAS   RE,CKCHARCL                                                      
         BNE   DMXPURGE                                                         
CHANGE12 MVC   1(2,R3),=C'UY'      CHANGE YN FOR UY                             
         B     DMXKX                                                            
*                                                                               
RECTYP13 DS    0H                  XX A/M XX XX XX CLT CLT                      
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE13 NI    1(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    1(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP14 DS    0H                  8XX'S A/M CLT CLT                            
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE14 NI    8(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    8(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
...
RECTYP17 DS    0H                  XX XX A/M XX XX XX CLT CLT                   
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE17 NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP18 DS    0H                  XX XX XX XX A/M                              
         ...
         CLI   BYTE,X'10'          YN = X'10'                                   
         BNE   DMXPURGE                                                         
         NI    4(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    4(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP19 DS    0H                  XX XX A/M 4XX'S CLT CLT                      
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE19 NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP20 DS    0H                  XX XX XX XX A/M CLT CLT                      
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE20 NI    4(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    4(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
...
RECTYP22 DS    0H                  XX XX A/M XX XX CLT CLT                      
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE22 NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP23 DS    0H                  XX XX A/M CLT CLT CLT                        
         ...
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE                                                         
CHANGE23 NI    2(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    2(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
RECTYP24 DS    0H                  0C A/M                                       
         ...
         CLI   BYTE,X'10'          YN = X'10'                                   
         BNE   DMXPURGE                                                         
         NI    1(R3),X'0F'         CHNG AGY CODE FROM X'10' TO X'D0'            
         OI    1(R3),X'D0'                                                      
         B     DMXKX                                                            
*                                                                               
*                                                                               
DMXKX    DS    0H                  CHANGE AGY TO UY                             
*        GOTO1 =V(HEXOUT),DMCB,0(R3),P,12                                       
*        GOTO1 VPRINTER                                                         
         CLC   =C'YN',20(R3)       CHANGE AGY TO UY                             
         BNE   *+10                                                             
         MVC   20(2,R3),=C'UY'                                                  
         B     DMXKEEP                                                          
*                                                                               
...
***                                                                             
*                                                                               
CLTTBLX  DS    0H                  TABLE OF CLIENT CODES WHICH WE LEAVE         
         DC    X'D1E1D1FFD241D24FBE46BE55'                                      
         DC    X'FFFF'                                                          
*                                                                               
CLTTBLC  DS    0H                                                               
         DC    C'UPBUP USBUSPPSGPSV'                                            
         DC    X'FF'                                                            
*                                                                               
*                                                                               
         LTORG                                                                  
...
SPGENESTD      DSECT                                                            
       ++INCLUDE SPGENEST                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'124SPLDEXTYK107/12/00'                                      
         END                                                                    
