*          DATA SET REWRI21T   AT LEVEL 242 AS OF 05/01/02                      
...
*                                                                               
         ...
         B     TRAPERR                                                          
*                                                                               
VR82     LA    R2,AURFILTH         VALIDATE FILTERS                             
         GOTO1 VALFILT                                                          
*                                                                               
...
PREP1    CLC   KEY(22),KEYSAVE     SAME AGY?                                    
         BNE   PREP3               NO                                           
         CLI   RSTAKSTA+4,C' '     TV STATION?                                  
         BE    *+12                YES                                          
         CLI   RSTAKSTA+4,C'T'     TV STATION?                                  
         BNE   PREP2               NO  - SKIP THIS STATION                      
         MVC   STSTA,RSTAKSTA      YES - SAVE STATION CALLS                     
...
PREP2    OC    REFSTA,REFSTA       STATION FILTER ENTERED?                      
         BNZ   PREP3               YES - PROCESS SINGLE STATION                 
         GOTO1 SEQ                 NO  - GET NEXT STATION                       
         B     PREP1               GO BACK FOR NEXT                             
         DROP  R3                                                               
*                                                                               
PREP3    MVI   0(R3),X'FF'         SET STATION DELIMITER EOT                    
*                                                                               
PREPSATL DS    0H                  IF DOING SATELLITES, DO 2 PASSES             
*                                                                               
...
*                                                                               
PREP5    XC    RFTRETRN,RFTRETRN                                                
         MVC   RFTCREP,AGENCY                                                   
         L     RF,ATHISSTA                                                      
         USING STATABD,RF                                                       
         MVC   RFTCSTAT(4),STSTA                                                
         MVI   RFTCSTAT+4,C' '                                                  
         DROP  RF                                                               
*                                                                               
...
*                                                                               
         LA    R5,SCANBLK                                                       
PREP10   MVC   RFTCINV,12(R5)                                                   
         XC    RFTCINVL,RFTCINVL                                                
         CLI   1(R5),0                                                          
         BE    *+10                                                             
         MVC   RFTCINVL,22(R5)                                                  
PREP15   GOTO1 REFETCH,DMCB,FETCHBLK                                            
         LA    R5,32(R5)                                                        
         BCT   R3,PREP10                                                        
*                                                                               
...
*                                                                               
PREP30   OC    CONDEMO,CONDEMO     CONTRACT DEMOS REQ'D?                        
         BNZ   PREP30F              YES - ALWAYS NEED GETREC                    
         OC    REFPRD,REFPRD       ANY PRODUCT FILTER?                          
         BNZ   PREP30F              YES                                         
         OI    RIPSTAT,RIPNOGR      NO  - DON'T NEED GETREC                     
*                                                                               
PREP30F  EQU   *                                                                
         GOTO1 =V(REPIO),DMCB,REPIOBLK                                          
         TM    RIPSTAT,RIPRQERR                                                 
         BZ    *+6                                                              
         DC    H'0'                                                             
         TM    RIPSTAT,RIPENDF                                                  
...
* FILTER ON CONTRACT DEMO (IF REQUESTED)                                        
         ...
         BAS   RE,GETEL                                                         
         BNE   PREP30              NO SAR ELEM - SKIP BUY                       
         USING RSARXEL,R6                                                       
         TM    CONDEMO,X'40'       PRIMARY DEMO CHECK                           
         BZ    PREP34               NO - ANY MENTION IS OK                      
         TM    PROFILES+0,X'10'    PRIMARY DEMO REQUIRED?                       
         BNZ   PREP32               YES - FIND IT                               
         ...
         B     PREP38                                                           
*                                                                               
PREP32   LA    R1,RSARXDEM                                                      
         LA    R0,8                                                             
         TM    0(R1),X'40'         PRIMARY DEMO CHECK                           
         BO    *+16                                                             
         LA    R1,3(R1)                                                         
         BCT   R0,*-12                                                          
         B     PREP30              SKIP IF NO PRIMARY DEMO FOUND                
         CLC   CONDEMO,0(R1)       PRIMARY DEMO                                 
         BNE   PREP30                                                           
         B     PREP38                                                           
*                                                                               
PREP34   LA    R1,RSARXDEM                                                      
         LA    R0,8                                                             
PREP36   MVC   WORK(3),0(R1)                                                    
         NI    WORK,X'FF'-X'40'    TURN OFF PRIMARY (IF ON)                     
         CLC   CONDEMO,WORK        THIS DEMO?                                   
         BE    PREP38                                                           
         LA    R1,3(R1)                                                         
         BCT   R0,PREP36                                                        
         B     PREP30              SKIP IF NO DEMO MATCH                        
         DROP  R6                                                               
*                                                                               
PREP38   L     R5,ACONTAB                                                       
...
*                                                                               
         ...
         MVI   ELCODE,X'12'                                                     
         BAS   RE,GETEL                                                         
         BNE   PREP30              NO SAR ELEM - LEAVE DEMO BLANK               
         USING RSARXEL,R6                                                       
         MVC   4(3,R5),RSARXDEM    DEFAULT FIRST DEMO                           
         TM    PROFILES+0,X'10'    PRIMARY DEMO REQUIRED?                       
         BZ    PREP30               NO - USE FIRST DEMO                         
         LA    R1,RSARXDEM                                                      
         LA    R0,8                                                             
*                                                                               
         TM    0(R1),X'40'         PRIMARY DEMO CHECK                           
         ...
         LA    R1,3(R1)                                                         
         BCT   R0,*-12                                                          
         B     PREP30              LEAVE FIRST IF NO PRIMARY FOUND              
*                                                                               
         MVC   4(3,R5),0(R1)       PRIMARY DEMO                                 
         B     PREP30                                                           
         DROP  R6                                                               
*                                                                               
PREP40   XC    DMCB(24),DMCB                                                    
         L     RF,ACONTAB                                                       
...
*                                                                               
         ...
         MVI   KEY,X'0B'                                                        
         MVC   KEY+16(2),AGENCY                                                 
PREP90   MVC   KEY+18(4),0(R2)                                                  
         GOTO1 HIGH                                                             
         B     PREP110                                                          
PREP100  GOTO1 SEQ                                                              
PREP110  CLC   KEY(22),KEYSAVE                                                  
         BNE   PREP200                                                          
...
*                                                                               
PREP200  LA    R2,8(R2)                                                         
         BCT   R0,PREP90           NEXT K                                       
*                                                                               
PREP210  L     RF,ATHISSTA                                                      
         LA    RF,STATABLN(RF)                                                  
         ST    RF,ATHISSTA                                                      
         CLI   0(RF),X'FF'         EOT?                                         
         BE    PREP300              YES                                         
...
PREP300  EQU   *                                                                
*                                                                               
PREPSATC DS    0H                  CONTINUE IF SATELLITE PASS NEEDED            
*                                                                               
...
*                                                                               
         ...
         DROP  R4                                                               
*                                                                               
PREPX    BAS   RE,FREETAB          FREE UP STORAGE                              
         B     XIT                                                              
         SPACE 2                                                                
         EJECT                                                                  
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
FETCHOOK NTR1                                                                   
         LA    R5,FETCHBLK         ADDRESS FETCH BLOCK                          
         USING RFTBLKD,R5                                                       
*                                                                               
*   TEST DAYPART                                                                
...
FREETAB  NTR1                                                                   
         ...
         ST    R2,DMCB+8                                                        
         GOTO1 =V(COVAIL),DMCB,C'FREE',AINVTAB                                  
FREEX    B     XIT                                                              
*                                                                               
...
***********************************************************************         
         SPACE 1                                                                
DRIVINIT NTR1  ,                                                                
         GOTO1 CALLOV,DMCB,(X'61',0),0    LOAD DPG PHASE                        
         CLI   4(R1),X'FF'                                                      
         BNE   *+6                                                              
         DC    H'0'                                                             
         MVC   ADPGPROG,0(R1)                                                   
...
***>>>                                                                          
         ...
         GOTO1 DATCON,DMCB,(5,TESTWORK),(0,TODAYDAT)                            
         L     R3,ASPOOLD                                                       
         USING SPOOLD,R3                                                        
         MVC   P(08),=C'"AURHDR"'                                               
         LA    RE,P+9                                                           
...
PRNT0100 EQU   *                                                                
***>>>                                                                          
         TM    FLAGS,FLNOPRT       SKIP THIS PRINT LINE?                        
         BZ    DRHOOKX              NO                                          
         NI    FLAGS,X'FF'-FLNOPRT    RESET FLAG                                
         MVI   GLHOOK,GLDONT                                                    
         L     RE,GLAP1                                                         
         LA    R0,4                                                             
         MVC   0(198,RE),BLANKS                                                 
...
ANYSPOTS OC    0(4,R2),0(R2)       ANY SPOTS?                                   
         BNZR  RE                   YES                                         
         OI    FLAGS,FLNOPRT        NO - DON'T PRINT                            
         SR    R0,R0                                                            
         LTR   R0,R0                                                            
         BR    RE                                                               
*                                                                               
...
STATABSZ EQU   1000*STATABLN        ROOM FOR 1000 STA'S                         
...
STARECD  DSECT                                                                  
       ...
       ++INCLUDE REPIOBLK                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'242REWRI21T  05/01/02'                                      
         END                                                                    
