*          DATA SET NEBUY16S   AT LEVEL 098 AS OF 05/01/02                      
*PHASE T31116A,+0                                                               
...
*                                                                               
         ...
         BNE   CP400               NO-NEXT RECORD                               
*                                                                               
         CLC   NBACTDAT,STADATE    FILTER ON FIRST DATE                         
...
CP620    CLI   0(R2),X'12'                                                      
         ...
         BNE   *+6                                                              
         LR    RF,R2               SAVE IF MAKEGOOD ONLY                        
         IC    R0,1(R2)                                                         
         AR    R2,R0                                                            
         B     CP600                                                            
         SPACE                                                                  
...
*        OI    COPYESH+1,X'20'     MAKE FIELD PROTECTED                         
         ...
         MVC   8(3,R2),=C'YES'     XMIT 'YES' IN COPY                           
         OI    6(R2),X'81'         MODIFIED NEXT TIME                           
         MVC   BUYMSG(40),=C'50 RECORDS COPIED HIT ENTER TO CONTINUE'           
         XC    CNTUNITS,CNTUNITS                                                
         MVI   FULLREAD,C'N'                                                    
         B     COPYX                                                            
         SPACE                                                                  
...
BD120    MVC   NUPRD,NPAKMAST      USE PACKAGE MASTER ALLOCATION                
         ...
         DROP  RE                                                               
*                                                                               
BD140    CLI   ALTRAF,C'Y'         COPY TRAFFIC TO NEW UNITS                    
         BE    BD160                                                            
*                                                                               
...
ELEM     DS    CL50                ELEMENT BUILD AREA                           
...
*  DDOFFICED                                                                    
       ++INCLUDE DDOFFICED                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'098NEBUY16S  05/01/02'                                      
         END                                                                    
