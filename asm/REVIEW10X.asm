*          DATA SET REVIEW10X  AT LEVEL 006 AS OF 08/31/00                      
*          DATA SET REVIEW10X  AT LEVEL 005 AS OF 02/13/97                      
*PHASE T81710A                                                                  
...
*        DC    CL8'????',CL1'?',CL8'???????',X'12'                              
RPOTAB   DC    C'K3',CL40'Station Office Advertiser Summary Ranked'             
...
* This fucking report is in and out more than John Holmes...                    
         ...
         DC    C'K7',CL40'Category Billing Report'                              
...
RPOTABKH DC    C'K3',CL40'Station Office Advertiser Summary Ranked'             
         ...
         DC    X'00'                                                            
*                                                                               
RPOTABMR DC    C'K7',CL40'Category Billing Report'                              
         DC    CL8'Yrly',CL1'A',CL8'Alpha',X'17'                                
         DC    C'K9',CL40'Office/Station Ranker'                                
         DC    CL8'Yrly',CL1'Q',CL8'PriFin',X'19'                               
         DC    C'K0',CL40'Station Office Ranker'                                
...
TLLNQ    EQU   *-TLSTD                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006REVIEW10X 08/31/00'                                      
         END                                                                    
