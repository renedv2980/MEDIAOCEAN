*          DATA SET SPREPNC02  AT LEVEL 010 AS OF 10/25/19                      
*PHASE SPNC02A                                                                  
*INCLUDE PRNTBL                                                                 
***********************************************************************         
* ORIGINALLY SPREPUP02N, CONVERTED TO SPREPNC02 TO BE A REAL REPORT             
***********************************************************************         
SPNC02   TITLE 'SPREPNC02 - LOAD CABLE FILE FOR NEW AGENCY'                     
SPNC02   CSECT                                                                  
         DS    8192C                                                            
         ORG   *-8192                                                           
         PRINT NOGEN                                                            
*                                                                               
         NMOD1 0,SPNC02,R8,R7                                                   
*                                                                               
         L     RA,0(R1)                                                         
         USING SPWORKD,RA,R9                                                    
         LA    R9,2048(RA)                                                      
...
NOMORE10 MVC   P(30),=CL30'NUMBER OF STATIONS ADDED: '                          
         ...
         EDIT  (P8,COUNTER3),(17,P4+30),ALIGN=LEFT                              
         MVC   P5(30),=CL30'NUMBER OF CABLE RECS ADDED: '                       
         EDIT  (P8,COUNTER4),(17,P5+30),ALIGN=LEFT                              
         MVC   P6(30),=CL30'NUMBER OF TRAFFICS ADDED: '                         
         EDIT  (P8,COUNTER5),(17,P6+30),ALIGN=LEFT                              
         GOTO1 REPORT                                                           
*                                                                               
*        CLOSE FILEOUT                                                          
         MVI   MODE,REQLAST                                                     
...
*                                                                               
         ...
         BE    FINF20                                                           
*                                                                               
         MVC   P(26),=C'!! LINE THAT BEGINS WITH: '     INVALID CODE            
         L     R1,AINPTLIN                                                      
         AHI   R1,4                                                             
         MVC   P+28(10),0(R1)                                                   
         MVC   P+43(12),=C'HAS AN ERROR'                                        
         GOTO1 REPORT                                                           
         B     FINFNO                                                           
*****                                                                           
* ACTION DATA                                                                   
...
PINFA10  NI    BITFLAG2,X'FF'-B2ADDING                                          
         BAS   RE,MKSTAPSV                                                      
*                                                                               
         BAS   RE,CKSTAKPS              ADD OR UPDATE K PASSIVE RECORD          
         BE    PINFA15                                                          
         OI    BITFLAG2,B2ADDK                                                  
         AP    COUNTER6,=P'1'                                                   
         B     *+8                                                              
PINFA15  NI    BITFLAG2,X'FF'-B2ADDK                                            
         BAS   RE,MKSTAKPS                                                      
*                                                                               
...
UPDSTATN NTR1                                                                   
         ...
         BNE   USTA40                                                           
         NI    BITFLAG2,X'FF'-B2ADDING  NOT ADDING, WHY IS THIS A               
         MVC   P+5(28),=C'!! NOT A NEW SYSCODE 9999 !!'                         
         MVC   P+26(4),SVDHDEND                                                 
         MVI   LINE,1                                                           
         GOTO1 REPORT                                                           
*                                                                               
         L     R6,AREC                   NEW AGENCY? MAYBE NEVER GOT            
         USING GENSTAD,R6                CABLE UPDATES, USES CABLE = N          
*                                                                               
* APPEND NEW CBLSEQ (WKCBLSEQ) TO OLD CBLSEQ (SCBLSEQ) BUT ALSO CHECK           
* FOR DUPS AS WE DON'T WANT 2 TRAVEL CHANNELS (TTC) IN SCBLSEQ THEN             
* MOVE ENTIRE OLD CBLSEQ TO NEW CBLSEQ (WKCBLSEQ) AS BOTH ROUTINES              
* MKSTATN & CABLENW CLEARS AREC'S SCBL24 AND SCBLSEQ                            
*                                                                               
*  MERGE THE TOP 24 BY OR'ING THE BITS OLD AND NEW                              
         OC    SCBL24,WKTOP24                                                   
*                                                                               
         LA    RE,WKCBLSEQ                                                      
         LA    RF,WKCBLSEQ+L'WKCBLSEQ                                           
*                                                                               
USTA10   LA    R1,SCBLSEQ                                                       
         LA    R0,SCBLLKUP         A(BYTE AFTER SCBLSEQ)                        
USTA15   OC    0(2,R1),0(R1)       WE CAN INSERT HERE?                          
         BZ    USTA20              YES                                          
*                                                                               
         CLC   0(2,RE),0(R1)       WE HAVE A DUPLICATE?                         
         JE    USTA30              YES, WE DON'T WANT DUPS                      
         LA    R1,2(R1)            NO, SOME OTHER NETWORK                       
         CR    R1,R0               STILL HAVE ROOM FOR MORE NETWORKS?           
         JNL   USTA50              NO, SHOW THEM ON THE REPORT                  
         J     USTA15              YES                                          
*                                                                               
USTA20   MVC   0(2,R1),0(RE)       APPEND THIS NETWORK TO THE EOL               
*                                                                               
USTA30   LA    RE,2(RE)            RE=A(NEXT NETWORK IN NEW CBLSEQ)             
         CR    RE,RF               MAKE SURE WE DON'T GO BEYOND EOL             
         JH    USTA35              IF SO, WE'RE DONE MERGING                    
*                                                                               
         OC    0(2,RE),0(RE)       ANYMORE NETWORKS IN NEW CBLSEQ?              
         JNZ   USTA10              YES                                          
*                                                                               
USTA35   MVC   WKCBLSEQ,SCBLSEQ    MOVE MERGED CBLSEQ TO NEW CBLSEQ             
         J     USTA45                                                           
USTA40   OI    BITFLAG2,B2ADDING   ADD RECORD                                   
         AP    COUNTER1,=P'1'                                                   
USTA45   BAS   RE,MKSTATN                                                       
         J     USTAX                                                            
*                                                                               
* CAN'T INSERT ANYMORE NETWORKS FROM 0(RE) INTO CBLSEQ                          
USTA50   GOTO1 LEFTOVER,DMCB,(RE)                                               
         B     USTA35              PUT OUT WHAT WE DO HAVE                      
*                                                                               
USTAX    B     XIT                                                              
         DROP  R6                                                               
         EJECT                                                                  
...
*                                                                               
* ON ENTRY:    PARAM 1             A(NETWORK ENTRY IN WKCBLSEQ)                 
*              AREC                CABLE MASTER RECORD                          
***********************************************************************         
LEFTOVER NTR1                                                                   
         L     R2,DMCB                                                          
*                                                                               
         ...
         MVC   P+19(L'STAKCALL),STAKCALL                                        
         MVC   P+25(38),=CL38'HAS AN INVALID # OF NETWORKS (MAX 127)'           
         MVI   LINE,1                                                           
         GOTO1 REPORT                                                           
*                                                                               
         MVC   P+12(37),=CL37'COULD NOT ADD THE FOLLOWING NETWORKS:'            
         MVI   LINE,1                                                           
         GOTO1 REPORT                                                           
*                                                                               
LFTOVR10 LA    R3,P+2                                                           
* WE KNOW THE FIRST ENTRY COULD NOT BE ADDED                                    
LFTOVR20 L     RF,ACABLTAB                                                      
         LLC   R5,5(RF)            R5 = L'TABLE ENTRY LENGTH                    
* FOLLOWING 2 LINES ARE FROM DDSTAPACK                                          
         LA    R4,X'7F'            IN CASE THE TABLE IS INITIALIZED             
         NR    R5,R4               TURN OFF THE X'80' BIT IN THE LENGTH         
         XR    R4,R4               [R4,R5] WILL BE DISPL INTO CABLETAB          
*                                                                               
         XR    RE,RE                                                            
         ICM   RE,3,0(R2)          RE = NTH ENTRY IN CABLETAB                   
         BCTR  RE,0                                                             
         MR    R4,RE                                                            
         AR    RF,R5               RF = A(NETWORK ENTRY IN CABLETAB)            
*                                                                               
         MVC   0(4,R3),7(RF)       SHOW THE 4 CHAR NCC NETWORK CODE             
         MVI   4(R3),C','                                                       
*                                                                               
         LR    RF,R2               LET'S SEE IF WE NEED THE COMMA               
         LA    RF,2(RF)                                                         
         LA    R0,WKCBLSEQ+L'WKCBLSEQ                                           
         CR    RF,R0              ANY NETWORKS AFTER THIS ONE?                  
         JNL   LFTOVR23           NO MORE                                       
         OC    0(2,RF),0(RF)                                                    
         JNZ   LFTOVR26           STILL HAVE MORE AFTER THIS ONE                
LFTOVR23 MVI   4(R3),C' '         GET RID OF THE COMMA                          
*                                                                               
LFTOVR26 LA    R3,5(R3)                                                         
         LA    R0,P+131                                                         
         CR    R3,R0                                                            
...
LFTOVR30 LA    R2,2(R2)                                                         
         LA    R0,WKCBLSEQ+L'WKCBLSEQ                                           
         CR    R2,R0              ANY MORE LEFTOVER?                            
         JNL   LFTOVRX            NO MORE                                       
         OC    0(2,R2),0(R2)                                                    
         JZ    LFTOVRX                                                          
*                                                                               
LFTOVR40 LA    R1,SCBLSEQ                                                       
         LA    R0,SCBLLKUP         A(BYTE AFTER SCBLSEQ)                        
LFTOVR45 CLC   0(2,RE),0(R1)       WE HAVE A DUPLICATE?                         
         JE    LFTOVR30            YES, WE DON'T TO SHOW DUPS                   
         LA    R1,2(R1)            NO, SOME OTHER NETWORK                       
         CR    R1,R0               STILL HAVE MORE NETWORKS?                    
         JNL   LFTOVR20            NO, SHOW THEM ON THE REPORT                  
         J     LFTOVR45            YES                                          
*                                                                               
LFTOVRX  MVI   LINE,1                                                           
         GOTO1 REPORT                                                           
...
*        BNL   CABLE40             NOT FOUND OR END OF LIST REACHED?            
         BNL   CABLE100            NOT FOUND OR END OF LIST REACHED?            
         CLC   =XL2'0',0(R5)                                                    
         BE    CABLE40                                                          
         CLC   0(2,R5),0(R4)                                                    
...
CKSTAKPS NTR1                                                                   
         ...
         MVC   STKKAGY,AGENCY      AGENCY POWER CODE                            
...
*&&DO                                                                           
*****                                                                           
*   NO LONGER NEED THIS AS T00A9E WILL CONTAIN THE 4 CHAR NCC NTWK              
*****                                                                           
...
*                                                                               
         CLC   IN_NWKCD,7(RF)      CHECK ALL 4 BYTES                            
         BE    STNET30             YES                                          
*                                                                               
         AH    RF,CBLTABLN         NO, CHECK NEXT ENTRY                         
         B     STNET20                                                          
*                                                                               
STNET30  DS    0H                                                               
...
STNET52  CLC   0(2,RE),=XL2'0'                                                  
         ...
         B     STNETYES                                                         
*                                                                               
STNET55  AH    R3,CBLTABLN         NEXT ITEM IN CABLE NETWORK TABLE             
         B     STNET45                                                          
*                                                                               
...
ELEM     DS    CL128                                                            
*                                                                               
* TZIH 03/30/05 - NEW SPCBLLIST INCLUDES BOTH NCC AND DDS CODES NOW             
* NO NEED TO USE EQUIVALENCE TABLE AND OLD CABLE LIST ANYMORE                   
...
*SPGENANMK                                                                      
       ...
       ++INCLUDE SPGENANMK                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010SPREPNC02 10/25/19'                                      
         END                                                                    
