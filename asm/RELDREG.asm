*          DATA SET RELDREG    AT LEVEL 242 AS OF 05/01/02                      
*PHASE RELDREG,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDREG - LOAD/DUMP MODEL EXTERNAL ROUTINE'                     
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*  CHANGE REGION REC EXTRA DATA TO SPARE                          *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
DMXREC   DS    0H                                                               
         ...
         USING RREGREC,R5                                                       
         CLI   RREGKTYP,X'03'      MUST BE REGION REC                           
         BNE   DMXKEEP                                                          
         XC    RREGPROF+L'RREGPROF(18),RREGPROF+L'RREGPROF                      
         AP    CHANGE,=P'1'                                                     
         B     DMXKEEP                                                          
         DROP  R5                                                               
         EJECT                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENALLD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'242RELDREG   05/01/02'                                      
         END                                                                    
