*          DATA SET PPBUY10    AT LEVEL 140 AS OF 06/02/20                      
*PHASE T41110A                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
         TITLE 'PPBUY10 - INTERACTIVE BUY/CHA/DEL'                              
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
...
*                                                                               
* KWAN 11/30/11 ADJUST ZZZ ALLOCATION FROM AD RECORD FOR ADBUYER                
*                                                                               
...
*                 IN "FREE" BUYS                                                
*                                                                               
* KWAN 10/21/09 FREE INSERTION, RATE CHANGED INDICATOR ADJUSTMENT               
*                                                                               
...
*                                                                               
* KWAN 10/17/06 INTERACTIVE PLANNED COST                                        
*                                                                               
...
*                                                                               
* KWAN 09/28/05 DEL MAT= REPEAT PASSIVE FOR DEL, INS DATE CHG & AD CHG          
*                                                                               
...
*                                                                               
* KWAN 04/06/04 DISALLOW BUY DELETION FOR INSERTIONS WITH INVOICE DATA          
*                                                                               
* KWAN 02/09/04 ADBUYER CUSTOM COLUMN UPLOAD                                    
*                                                                               
* KWAN 01/15/04 GST AND PST BUG FIX FOR ACTION CHANGE                           
*                                                                               
* KWAN 09/10/03 INVOICE MATCHING STATUSES ELEM FOR AB 2.0                       
*                                                                               
* KWAN 03/11/03 FIX PST VALIDATION ROUTINE (NTR1 IS MISSING)                    
*                                                                               
* KWAN 03/05/03 FIX COMMENTS VALIDATION                                         
*                                                                               
* YKAP 09/10/02 ISS= ISSUE NAME                                                 
*                                                                               
* KWAN 10/02/02 ADBUYER DRAFT INS, PBDCDATE & PBDMDATE NOT REQUIRED             
*                                                                               
...
*                                                                               
* KWAN 12/10/01 KEYWORDS FOR ACTUAL AND ESTIMATED CPM (ACPM & ECPM)             
*                                                                               
* KWAN 11/13/01 ADBUYER - USE T41118 TO PROCESS OPTIONAL DATA FIELDS            
*                                                                               
* KWAN 09/26/01 ADD/CHG SPACE DESCRIPTION (USE STD SPC DESP REC, X'5A')         
*                                                                               
* KWAN 08/16/01 "NO TRAFFIC" OVERRIDES (PBDSTAT BIT IS X'20')                   
*                                                                               
* KWAN 06/20/01 LEGAL WARNINGS (NEW OPTIONAL DATA AND ELEM, X'94')              
*                                                                               
...
*                                                                               
* KWAN 02/15/00 PRD EXCLUSION FOR LIST BUYS                                     
*                                                                               
* KWAN 02/08/00 FIX D2=NONE PROBLEM ON A NEW BUY (EDTCD2)                       
*                                                                               
* KWAN 01/20/00 NO RATE CHANGES AND BUY DELETIONS FOR FULLY                     
...
*                                                                               
* BPLA 05/99    CHANGES FOR COST2 AND COMENT CHANGES TO DELETED                 
*               INSERTIONS                                                      
*                                                                               
...
*                                                                               
* BPLA 12/98    COPY OF PPBUY10 AT LEVEL 8 MADE 12/3/98                         
*               CHANGES FOR INTERACTIVE LIST BUYING                             
*                                                                               
* BPLA 4/98     CHANGES FOR FROZEN CLIENTS                                      
*                                                                               
* BPLA 3/98     SFH FEATURE LIVE FOR ALL AGENCIES                               
*                                                                               
* BPLA 2/3/98   COPY OF PPBUY11 LEVEL 255 MADE 2/3/98                           
*                                                                               
...
*                                                                               
* BPLA 5/97     CHANGE TO EDTCDT AND EDTCSHDT TO ACCOMDATE NEW DATCON           
*                                                                               
...
T41110   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 WORK10X-WORK10D,T41110,RR=RE,CLEAR=YES                           
*                                                                               
         LR    R9,RC                                                            
         USING WORK10D,R9          R9 = A(GLOBAL STORAGE)                       
*                                                                               
         BASR  R8,0                                                             
         AHI   R8,GLOBALS-*                                                     
...
*                                                                               
         ...
         J     ERROR                                                            
*                                                                               
MAIN_30  CLI   SVSCRN,X'F2'                                                     
         BNL   GO_BUY                                                           
*                                                                               
         CLI   SVSCRN,X'EA'        LIST SCREEN                                  
         BE    GO_BUYL                                                          
         CLI   SVSCRN,X'EB'        LIST SCREEN - ZZZ                            
         BE    GO_BUYL                                                          
         DC    H'0'                                                             
         EJECT                                                                  
*                                                                               
...
*                                                                               
         ...
         BE    CHG                                                              
*                                                                               
         BRAS  RE,BEXCL            CK PRD EXCLUSION                             
         JNE   EXIT                                                             
         BRAS  RE,EDIODAT                                                       
...
*                                                                               
         BRAS  RE,MUP              UPDATE UPLOAD MINIO REC W/O LINE #           
         BRAS  RE,ADDLINE                                                       
         BRAS  RE,MUP              UPDATE UPLOAD MINIO REC W/ LINE #            
...
CHGX     MVC   NEWREC(25),REC      MOVE KEY TO NEWREC FOR FMTINS                
         CLI   SVSCRN,X'F2'                                                     
         BNL   BUY_X                                                            
         CLI   SVSCRN,X'EA'        LIST BUYING                                  
         BE    BUYLX                                                            
         CLI   SVSCRN,X'EB'        LIST BUYING                                  
         BE    BUYLX                                                            
*                                                                               
         DC    H'0'                                                             
         EJECT                                                                  
...
*                                                                               
         ...
         MVC   0(3,R7),BUYNM+1                                                  
*                                                                               
DELPID   GOTOR VT41103,DMCB,(RC),(RA),DELINS_Q                                  
*                                                                               
...
FMTDTES  LR    R0,RE                                                            
         ...
         CLI   5(R2),0                                                          
         JNE   FMTDTES2                                                         
         OC    PBDCDATE,PBDCDATE   HAVE ON-SALE DATE?                           
         JZ    FMTDTES2                                                         
         GOTO1 VDATCON,DMCB,(3,PBDCDATE),(7,8(R2))                              
         FOUT  (R2)                                                             
         OI    4(R2),X'20'         VALIDATED                                    
FMTDTES2 BRAS  RE,BUMPFLD          POINT TO MATERIALS CLOSING DATE              
         CLI   5(R2),0                                                          
         JNE   FMTDTESX                                                         
         OC    PBDMDATE,PBDMDATE   HAVE MATERIALS CLOSING DATE?                 
         JZ    FMTDTESX                                                         
...
LMTDTES  LR    R0,RE               FORMAT DATES ON LIST SCR                     
         L     R2,TRADDR                                                        
         LHI   RF,6                                                             
         BRAS  RE,BUMPFLDS         TO MATERIALS CLOSING DATE                    
         CLI   5(R2),0                                                          
         JNE   LMTDTES2                                                         
...
EDTJOB2  CLC   =C'NONE',8(R2)                                                   
         ...
         LA    R3,JOBERR4                                                       
         J     ERROR                                                            
EDTJOB4  GOTO1 VT41103,DMCB,(RC),(RA),EDTADCDQ                                  
         LR    RE,R0                                                            
         J     TESTERR                                                          
*                                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         CLI   SVSCRN,X'EC'                                                     
         BL    ALLDONE2            (SCREENS X'EA' AND X'EB')                    
         LA    R2,BUYPBH           PUT CURSOR TO PUB                            
         B     EXIT                                                             
*                                                                               
...
P_BL40   OC    PBDMDATE,PBDMDATE                                                
         ...
         BE    P_BL_ER2                                                         
         CLI   SVAGPROF+24,C'B'    BOTH REQUIRED?                               
         BE    P_BL_ER2                                                         
*                                                                               
P_BL_X   J     SETCCEQ                                                          
*                                                                               
...
P_CHG34H LA    R7,60(R7)                                                        
         BCT   R4,P_CHG34                                                       
*                                                                               
P_CHG40  TM    PBUYCNTL-NEWREC+REC,X'80'  SKIP IF NOT DELETED                   
         BZ    *+14                                                             
...
*                                                                               
         ...
         BE    POL1_20                                                          
         CLC   8(L'PJOBALO,R2),SPACES                                           
         JH    POL1_14                                                          
         MVC   8(L'PJOBALO,R2),PJOBALO-PJOBREC(R4)                              
         LHI   RE,L'PJOBALO                                                     
         LA    RF,((PJOBALO-PJOBREC)+(L'PJOBALO-1))(R4)                         
         CLI   0(RF),C' '                                                       
         JH    *+12                                                             
         BCTR  RE,0                                                             
         BCTR  RF,0                                                             
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTRTM   NTR1  BASE=*,LABEL=*      EDIT INTERACTIVE RATES                       
*                                                                               
         LA    R3,INVRTERR                                                      
         BRAS  RE,BUMPFLD                                                       
*                                                                               
...
*                                                                               
         ...
         ZAP   DUB,PBDCOS                                                       
         CVB   R1,DUB                                                           
         CLI   PBDCTYP,C'N'        NET INPUT (DISPLAY AS NET)?                  
         BE    *+12                                                             
...
FMTRTM4  EDIT  (R1),(9,X+1),2,ALIGN=LEFT,FLOAT=-                                
         LA    R1,X+1                                                           
         CLI   PBDCOSIN,C' '       DEFAULT COST TYPE?                           
         BE    FMTRTM6                                                          
         BCTR  R1,0                                                             
         MVC   0(1,R1),PBDCOSIN                                                 
*                                                                               
FMTRTM6  CLI   PBDCTYP,C'N'        DISPLAY AS NET?                              
         ...
         MVC   0(1,R1),PBDCTYP                                                  
*                                                                               
FMTRTM9  TM    PBDRLIND,X'08'      FROZEN?                                      
         BZ    *+10                                                             
         BCTR  R1,R0                                                            
         MVI   0(R1),C'*'                                                       
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FIXREC   NTR1  BASE=*,LABEL=*      MOVE ELEMS FROM NEWREC TO REC                
*                                                                               
         LA    R5,NEWREC+33                                                     
FIXREC05 BRAS  RE,NXTELEM                                                       
         BNE   FIXRECX                                                          
*                                                                               
         CLI   ELCODE,X'86'        SHIP DATE ELEM?                              
         BNE   *+18                                                             
         CLC   2(3,R5),=3X'FF'     SPECIAL DELETION CODE?                       
         BE    FIXREC25                                                         
         B     FIXREC10                                                         
*                                                                               
         ...
         B     FIXREC10                                                         
*                                                                               
         CLI   ELCODE,X'83'        REF ELEM?                                    
         BE    FIXR05H                                                          
         CLI   ELCODE,X'94'        LEGAL WARNINGS ELEM?                         
         BE    FIXR05H                                                          
         CLI   ELCODE,X'A0'        ESTIMATED CPM ELEM?                          
         BE    FIXR05H                                                          
         CLI   ELCODE,X'A1'        ACTUAL CPM ELEM?                             
         BE    FIXR05H                                                          
         CLI   ELCODE,X'98'        SITE LOCATION ELEM?                          
         BE    FIXR05H                                                          
         CLI   ELCODE,X'A6'        ISSUE NAME?                                  
         BNE   FIXR05U                                                          
*                                                                               
FIXR05H  CLI   2(R5),X'FF'         DELETION CODE PRESENT?                       
         BE    FIXREC25                                                         
         B     FIXREC10                                                         
*                                                                               
         USING PBFSIELD,R5                                                      
FIXR05U  CLI   ELCODE,X'82'                                                     
         BNE   *+16                                                             
         CLI   PBFSI,C'X'                                                       
         BE    FIXREC25                                                         
         B     FIXREC10                                                         
...
FIXERR1  LA    R3,MAXSERR          ELEM MAXIMUM LENGTH ERROR                    
         B     FIXRERR                                                          
*                                                                               
FIXERR2  LA    R3,RECFMINV         RECORD FORMAT IS INVALID                     
         L     R2,TRADDR                                                        
         LA    RF,8                                                             
...
CKR20    GOTO1 VGETINS,DMCB,REC,PVALUES,REC+7                                   
         ...
         BE    CKR30                                                            
*                                                                               
         J     CKRXX               DON'T CHECK FOR CANDA ANYMORE                
*                                                                               
...
EDTCOM1A ST    R2,FULL             CURRENT FLD POINTER                          
         ...
         BR    RF                                                               
*                                                                               
EDTCM1   CLC   =C'COM=',8(R2)                                                   
         JE    FLDINV              COM= ONLY FOR IC=                            
         CLC   =C'IB=COM=',8(R2)                                                
         JE    FLDINV              NO COM= FOR IB=                              
*                                                                               
...
EDTCOMAA ZIC   R1,5(R2)                                                         
         CHI   R1,40+4             MAX OF 40 CHARS FOR SRC REACHED?             
         JH    FLDINV                                                           
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTORATE DS    0H                  EDIT OPEN RATE OVERRIDE                      
         LA    R3,INVERR                                                        
...
EDTOR8D  XC    X(15),X                                                          
         ...
         JNE   EDTOR8G                                                          
         MVC   PORCOS,PBDCOS                                                    
         MVI   PORCOSTY,C'C'       SO PPBUY03 WILL SET CONTRACT VALUES          
         J     EDTOR10                                                          
*                                                                               
EDTOR8G  ZAP   PORCOS,DUB                                                       
         LTR   R0,R0               IF OPEN RATE IS FREE, PBDCOS MUST            
         JNZ   EDTOR9              ALSO BE FREE  (=.00001)                      
         ZAP   PORCOS,=P'1'                                                     
         CP    PBDCOS,=P'1'                                                     
         JE    EDTOR9                                                           
         LA    R3,INVRTERR                                                      
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTCSHDT DS    0H                  EDIT SHIP DATE, EXT DATE                     
         LA    R4,8+3(R2)          POINT TO INPUT                               
         LA    R3,INVERR                                                        
         XC    WORK(20),WORK                                                    
         ZIC   R5,5(R2)                                                         
         AHI   R5,-3               ADJUST INPUT LENGTH (FOR SD=)                
         JP    EDTSHP4                                                          
EDTSHP3  L     R1,TRADDR                                                        
         CLI   8(R1),C'B'          BUYING?                                      
...
EDTCU    DS    0H                  EDIT CONTRACT UNITS                          
         ...
         JE    ERROR                                                            
         C     RF,=F'1'            CANNOT INPUT .0001 SINCE 0 IS                
         JE    ERROR               CARRIED AS X'000001'                         
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTCAC   DS    0H                  EDIT AGENCY COMMISSION                       
         LHI   R3,NOFRZCER         NO FINANCIAL CHANGES TO FRZ CLIENT           
         BRAS  RE,CKCLTFRZ         CLIENT FROZEN OPTION FOUND?                  
         JNE   ERROR                                                            
         CLI   PBDCOSIN,C'S'                                                    
...
EDTSREP  BRAS  RE,EDTSR                                                         
         ...
         J     NEXTD                                                            
*                                                                               
EDTLW    MVI   WORK,X'94'          LEGAL WARNINGS ELEM CODE                     
         BRAS  RE,CHKLW                                                         
         JNE   EXIT                                                             
         J     NEXTD                                                            
*                                                                               
EDTTRAFF BRAS  RE,CHKNTRA          NO TRAFFIC                                   
         ...
         J     NEXTD                                                            
*                                                                               
EDTSITEL BRAS  RE,CHKSITEL         SITE LOCATION                                
         JNE   EXIT                                                             
         J     NEXTD                                                            
*                                                                               
EDTICONT DS    0H                  INTERNET CONTRACT                            
         LA    R3,CICONERR         CANNOT EDIT INTERNET CONTRACT CODE           
         J     ERROR                                                            
         J     NEXTD                                                            
*                                                                               
EDTACPM  MVI   WORK,X'A1'          ACTUAL CPM ELEM CODE                         
EDTCPMS  BRAS  RE,CKCPMS                                                        
         JNE   EXIT                                                             
         J     NEXTD                                                            
*                                                                               
EDTECPM  MVI   WORK,X'A0'          ESTIMATED CPM ELEM CODE                      
         J     EDTCPMS                                                          
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
...
EDTCIODT LA    R4,PBDIODAT                                                      
         ...
         MVI   BYTE,0                                                           
*                                                                               
EDTCDT   GOTO1 VDATVAL,DMCB,(BYTE,0(R5)),WORK                                   
         OC    0(4,R1),0(R1)                                                    
         JZ    ERROR                                                            
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTCD2   DS    0H                  2ND INSERTION DATE                           
...
*        NI    CHGIND1,X'FD'       CLEAR FLAG COMMENT WAS NOT CHANGED           
         OC    FULL,FULL                                                        
...
******** DC    AL1(02),CL7'LW=    ',AL4(EDTLW)                                  
         ...
         DC    AL1(04),CL7'ACPM=  ',AL4(EDTACPM)                                
         DC    AL1(04),CL7'ECPM=  ',AL4(EDTECPM)                                
         DC    AL1(04),CL7'SITE=  ',AL4(EDTSITEL)                               
         DC    AL1(04),CL7'ICON=  ',AL4(EDTICONT)                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
CKCPMS   NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         LA    R4,13(R2)           POINT TO INPUT (8+5)                         
         LA    R3,INVERR           ERR MSG                                      
         ZIC   R5,5(R2)                                                         
         AHI   R5,-5               MINUS 5 BYTES ANNOTATION                     
         XC    DUB,DUB             FOR WORKING STORAGE                          
*                                                                               
         CHI   R5,0                                                             
         BE    CCPMS10             INPUT IS ZERO                                
         BH    CCPMS30             INPUT PRESENT, GO CHECK IT                   
         B     CCPMSERR            NEGATIVE INPUT LENGTH, ERROR                 
*                                                                               
...
*                                                                               
CCPMS30  GOTOR VCASHVAL,DMCB,(2,(R4)),(R5)                                      
         CLI   0(R1),X'FF'                                                      
         BE    CCPMSERR                                                         
         L     R0,4(R1)                                                         
         CVD   R0,DUB                                                           
         ...
         BH    CCPMSERR                                                         
*                                                                               
CCPMS60  CLI   WORK,X'A0'          ESTIMATED CPM?                               
         BE    CCPMS65                                                          
         CLI   WORK,X'A1'          ACTUAL CPM?                                  
         BE    CCPMS65                                                          
         DC    H'0'                NO OTHER ELEM CODE GOES HERE YET             
*                                                                               
CCPMS65  LA    R5,NEWREC+33        START BUILDING ELEMENT                       
         MVC   ELCODE,WORK                                                      
         BRAS  RE,NXTELEM                                                       
         BE    CCPMSERR            CAN'T ALREADY HAVE ELEM                      
*                                                                               
         XC    WORK+1(10),WORK+1                                                
         MVI   WORK+1,9            ELEMENT LENGTH                               
*                                                                               
         CLI   DUB+1,X'FF'         SPECIAL CODE PRESENT?                        
         BE    *+14                                                             
         ZAP   WORK+2(5),DUB       CPM VALUE IN PACKED FORMAT                   
         B     *+10                                                             
         MVC   WORK+2(1),DUB+1     MOVE IN DELETION CODE                        
*                                                                               
         GOTO1 VRECUP,DMCB,(1,NEWREC),WORK,(R5)                                 
*                                                                               
CCPMSX   J     SETCCEQ             EQUAL                                        
*                                                                               
CCPMSERR J     ERROR                                                            
*                                                                               
         DROP  RB                                                               
...
*                                                                               
         LA    R4,13(R2)           POINT TO INPUT (8+5, SITE=)                  
         LA    R3,INVERR           ERR MSG                                      
         ZIC   R5,5(R2)                                                         
         AHI   R5,-5               MINUS 5 BYTES ANNOTATION                     
         XC    DUB,DUB                                                          
*                                                                               
         CHI   R5,0                                                             
         BE    CSITL10             INPUT IS ZERO                                
         BH    CSITL30             INPUT PRESENT, GO CHECK IT                   
         B     CSITLERR            NEGATIVE INPUT LENGTH, ERROR                 
*                                                                               
CSITL10  MVI   DUB+1,X'FF'         SPECIAL DELETE CODE                          
         L     RE,TRADDR                                                        
         CLI   8(RE),C'B'          ADDING EMPTY ELEM ON NEW BUY?                
         BE    CSITLERR                                                         
         B     CSITL60             MUST BE REMOVING ELEM THEN                   
*                                                                               
CSITL30  CHI   R5,20               GREATER THAN MAX OF 20?                      
         BH    CSITLERR                                                         
*                                                                               
CSITL60  MVI   WORK+0,X'98'        SITE LOCATION ELEM CODE                      
         MVI   WORK+1,22           ELEM LENGTH                                  
         MVC   WORK+2(20),=20C' '                                               
         CHI   R5,0                                                             
         BE    CSITL70                                                          
         BCTR  R5,0                                                             
         EX    R5,*+8                                                           
         B     *+10                                                             
         MVC   WORK+2(0),0(R4)     GET SITE LOCATION FROM INPUT                 
*                                                                               
CSITL70  LA    R5,NEWREC+33        START BUILDING ELEMENT                       
         MVI   ELCODE,X'98'        SITE LOCATION ELEM CODE                      
         BRAS  RE,NXTELEM                                                       
         BE    CSITLERR            CAN'T ALREADY HAVE ELEM                      
*                                                                               
         CLI   DUB+1,X'FF'         SPECIAL CODE PRESENT?                        
         BNE   *+8                                                              
         MVI   WORK+2,X'FF'        MOVE IN DELETION CODE                        
...
*                                                                               
         ...
         BH    CKPSTERR            MAX IS ONE PROVINCE                          
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTFSI   NTR1  BASE=*,LABEL=*      EDIT FREE STANDING INSERT                    
*                                                                               
         LA    R4,8+5(R2)          POINT TO INPUT                               
         LA    R3,INVERR                                                        
         ZIC   R5,5(R2)                                                         
...
*                                                                               
         ...
         LA    R3,WKELEM                                                        
         USING PIOELEM,R3                                                       
         LA    R5,14(R2)           GET PAST MANIO= OVERHEAD                     
         LA    R4,WKELEM+60                                                     
EDTMN3   CLI   0(R5),C','          DELIMITED BY ,                               
         ...
         B     EDTMN3                                                           
*                                                                               
EDTMN5   GOTO1 VDATVAL,DMCB,(0,WKELEM+60),WORK                                  
         OC    0(4,R1),0(R1)                                                    
         BZ    EDTMANE3            IO DATE INVALID                              
*                                                                               
         GOTO1 VDATCON,(R1),(0,WORK),(3,PIODATE)                                
*                                                                               
EDTMN10  LA    R5,1(R5)            GET PAST C',' TO EDIT IO NUMBER              
         SR    R1,R1                                                            
         XC    WKELEM+60(5),WKELEM+60                                           
         LA    R4,WKELEM+60                                                     
EDTMN15  CLI   0(R5),C','                                                       
...
EDTMN55  BRAS  RE,NXTELEM                                                       
         BNE   EDTMN60                                                          
         OC    2(3,R5),2(R5)       IO WITH DATE?                                
         BNZ   EDTMN55                                                          
         MVC   0(50,R5),WKELEM     MOVE IN MANUAL IO                            
         B     EDTMN70                                                          
*                                                                               
EDTMN60  GOTO1 VRECUP,DMCB,(1,0(R4)),WKELEM,(R5)                                
         B     EDTMANX                                                          
*                                                                               
...
*                                                                               
         ...
         BNE   *+14                                                             
         CP    DUB,=P'999'         MAX IS 999 FOR EXDAYS                        
         JH    ERROR                                                            
         B     EDTPAC10                                                         
*                                                                               
EDTPAC07 ZAP   DUB,=P'0'           RESET NEGATIVE TO ZERO                       
         CLI   WORK,X'92'          IMPS OR EIMPS ALLOWS ZERO                    
         BE    EDTPAC10                                                         
         CLI   WORK,X'93'          AIMPS ALLOWS ZERO ALSO                       
         BE    EDTPAC10                                                         
         J     ERROR               OTHER NEGATIVE VALUES ARE INVALID            
*                                                                               
...
*                                                                               
         ...
         B     EDTPAC25                                                         
EDTPAC24 MVC   WORK+12(2),DUB+6    PACKED NUMBER (PL2)                          
...
*                                                                               
         ...
         OC    UPID,=CL8' '                                                     
         MVI   UPLSW,C'Y'                                                       
         STCM  R2,15,UPCURSOR      SAVE ADDRESS OF OPTIONAL DATA LINE           
*                                                                               
         J     SETCCEQ                                                          
         DROP  RB                                                               
         EJECT                                                                  
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'140PPBUY10   06/02/20'                                      
         END                                                                    
