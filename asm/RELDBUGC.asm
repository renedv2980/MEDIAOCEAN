*          DATA SET RELDBUGC   AT LEVEL 008 AS OF 05/01/02                      
*PHASE RELDBUGC,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
*                                                                               
         AP    COUNT,=P'1'                                                      
*                                                                               
         MVC   P+60(70),RBUYCMNT                                                
*                                                                               
         L     R5,AREC             POINT TO RECORD                              
         USING RBUYREC,R5                                                       
         GOTO1 =V(HEXOUT),DMCB,RBUYKEY,P,27                                     
         GOTO1 VPRINTER                                                         
*                                                                               
DMX100   DS    0H                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008RELDBUGC  05/01/02'                                      
         END                                                                    
