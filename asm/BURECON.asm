*          DATA SET BURECON    AT LEVEL 004 AS OF 06/07/11                      
*PHASE BURECONA                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE PRINTER                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE SORTER                                                                 
*INCLUDE PRNTBL                                                                 
         TITLE 'BURECON - BUDFIL RECONSTRUCT PROGRAM'                           
BURECON  CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 0,BURECON,=V(REGSAVE)                                            
*                                                                               
         L     RC,=A(RECONWKC)                                                  
         USING RECONWK,RC                                                       
*                                                                               
...
*                                                                               
         MVC   LINE,=PL2'75'                                                    
         MVC   TITLE(25),=C'BUDDIR/BUDFIL RECONSTRUCT'                          
*                                                                               
         LA    R3,CNTRS                                                         
         LA    R4,18                                                            
         LA    R5,CNTRSX                                                        
...
RECONWKC CSECT                                                                  
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004BURECON   06/07/11'                                      
         END                                                                    
