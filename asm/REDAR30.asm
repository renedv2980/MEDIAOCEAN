*          DATA SET REDAR30    AT LEVEL 191 AS OF 05/09/13                      
*PHASE T80F30A                                                                  
*INCLUDE REGENPBY                                                               
...
* UPDATE HISTORY:                                                     *         
*                                                                     *         
* 09MAY13 KWA BUMP UP LISTAREA FOR REGENDB                            *         
* 13FEB12 SKU SKIP LOCAL MARKET CHECK FOR FOXLOC                      *         
* 02SEP09 KUI FIX TOTAL SPOT/$ DISPLAY FOR ESPERANTO XML ORDERS       *         
* 22OCT07 SKU SKIP LOCAL MARKET CHECK FOR CBS                         *         
* 20AUG04 HQ  NEW FORMAT ALONG WITH NEW REVISION RELEASE              *         
...
LBUYCMMT DS    CL71                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'191REDAR30   05/09/13'                                      
         END                                                                    
