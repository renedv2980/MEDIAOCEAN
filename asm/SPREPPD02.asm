*          DATA SET SPREPPD02  AT LEVEL 045 AS OF 05/11/05                      
*PHASE SPPD02A                                                                  
*INCLUDE TSCAN                                                                  
         TITLE 'SPREPPD02 - MASTER SPOT DCF EXTRACT'                            
         PRINT NOGEN                                                            
*                                                                               
*                                                                               
...
SP126E   DS    0H                                                               
         ...
         BC    0,SP126G            NOOP SKIP IF NO DATA                         
*                                                                               
...
*                                                                               
*              **NOTE -MARKET AUDIENCE IS DERIVED HERE FROM                     
*                      RATING AND UNIVERSE. THE AUDIENCE DEMO                   
*                      IS NOT USED BECAUSE OF LACK OF PRECISION.                
*                      RATINGS ALONE ARE NOT USED BECAUSE OF NEED               
*                      TO GET U.S. TOTALS.                                      
*                                                                               
         ZIC   RF,DPTNO                                                         
         BCTR  RF,R0                                                            
...
BMK4     DS    0H                                                               
         ...
         STCM  R0,3,MKNUM                                                       
*                                                                               
         OC    BMKT,BMKT           IF MARKET IN REQ                             
         BZ    *+14                                                             
         CLC   MKNUM,BMKT          SKIP HIGHERN REQ                             
         BH    BMK4                                                             
*                                                                               
         MVC   MKNAM,MSRNAM                                                     
         MVC   MKTZ,MSRTZ                                                       
...
SVSDEMS  NTR1                                                                   
         ...
         GOTO1 (RF),DMCB,=C'PROG+',ADBLOCK,WORK+1                               
         CLC   WORK+1(7),=C'OFF AIR'   SKIP                                     
         BE    SVDX                                                             
...
CLTHDRD  DSECT                                                                  
       ++INCLUDE SPGENCLT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045SPREPPD02 05/11/05'                                      
         END                                                                    
