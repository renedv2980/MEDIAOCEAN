*          DATA SET NEBUY41    AT LEVEL 008 AS OF 03/03/20                      
*PHASE T31141C,+0                                                               
*INCLUDE RECUP                                                                  
*INCLUDE CLPACK                                                                 
         TITLE 'T31141 - BUY CABLE TRANSFER 2'                                  
***********************************************************************         
*  ID  LVL   DATE    TICKET            COMMENTS                       *         
* ---- --- ------- ------------ --------------------------------------*         
* JSAY 007 09DEC19 <SPEC-39994> ALLOW UNITS TO USE THE COS2 FACTOR    *         
*                               FROM THE PACKAGE                      *         
* VGUP 007 23DEC19 <SPEC-36941> ADDED MIRROR CODE Q AND R                       
***********************************************************************         
T31141   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T31141*,RA,RR=RE                                              
         LA    RC,2048(RA)                                                      
         LA    RC,2048(RC)                                                      
         USING T31141+8192,RC                                                   
...
*--SEE IF PROGRAM ALREADY EXISTS THAT MEETS                                     
*--THE QUALIFICATIONS FOR UNITS TO BE ADDED                                     
*--IF FOUND THEN EXIT, IF NONE FOUND THEN                                       
...
*                                                                               
         CLI   TWLSTLIN,X'FF'      ADD A NEW RECORD                             
         BE    ADDPR300                                                         
*                                                                               
         MVI   TWLSTLIN,0                                                       
*                                                                               
...
*                                                                               
         ...
         B     ADDPR040                                                         
*                                                                               
ADDPR020 GOTO1 AIO,DMCB,SPT+DIR+SEQ                                             
*                                                                               
ADDPR040 CLC   KEY(8),KEYSAVE                                                   
         BNE   ADDPR300                                                         
*                                                                               
...
*                                                                               
         ...
         BNE   ADDPR080                                                         
         B     ADDPR100            YES VALID PROGRAM RECORD FOUND               
*                                                                               
ADDPR080 CLI   TWPRINPC,C'Y'       WAS PROGRAM CODE INPUTTED                    
         BE    ADDPR500            ERROR NO MATCH WITH PROGRAM RECORD           
...
*        GOTO1 VDATCON,DMCB,(0,DUB),(2,NUKPDATE)                                
*-READ UNIT 84 KEY GET HIGHEST LINE NUMBER                                      
*-IF GREATER THEN 192 NOT ENOUGH ROOM ON THE PROGRAM                            
*-TO ADD THE UNITS. AND A NEW PROGRAM RECORD WILL                               
*-BE CREATED.                                                                   
ADDPR160 GOTO1 AIO,DMCB,UNT+DIR+HIGH                                            
         B     ADDPR200                                                         
ADDPR180 GOTO1 AIO,DMCB,UNT+DIR+SEQ                                             
ADDPR200 CLC   KEY(17),KEYSAVE                                                  
         BNE   ADDPR240                                                         
         MVC   TWLSTLIN,KEY+17                                                  
         B     ADDPR180                                                         
*                                                                               
*-IF LAST LINE COUNT IS GREATER THEN 191 THERE                                  
*-IS NO ROOM IN THIS PROGRAM FOR ANY MORE UNITS                                 
*-AND ANOTHER PROGRAM CHECK MUST BE DONE.                                       
ADDPR240 CLI   TWLSTLIN,191                                                     
         BNH   ADDPRX                                                           
         MVI   TWLSTLIN,0                                                       
         CLI   TWPRINPC,C'Y'       WAS PROGRAM CODE INPUTTED                    
         BE    ADDPR500            ERROR UNITS CANT FIT ON PROGRAM              
         SPACE 4                                                                
         DROP  R3                                                               
*                                                                               
*--BUILD A NEW PROGRAM RECORD                                                   
ADDPR300 L     R3,AIOAREA2                                                      
         XCEF  (R3),2000                                                        
         USING NPGRECD,R3                                                       
*                                                                               
...
ADDPR500 L     RE,UPACURUN         ADDRESS OF UNIT                              
         USING NUNTD,RE                                                         
...
*                                                                               
         B     WRITEX                                                           
*                                                                               
WRITE110 MVC   TWDSKADR(4),KEY+21                                               
...
SAVEDRD  DS    A                   RD UPON ENTRY TO OVERLAY                     
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008NEBUY41   03/03/20'                                      
         END                                                                    
