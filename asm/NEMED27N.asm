*          DATA SET NEMED27N   AT LEVEL 028 AS OF 09/17/07                      
*PHASE T31E27A,+0                                                               
*INCLUDE GETBROAD                                                               
...
*                                                                               
**8      MVC   SRTPTYPE,NBPOSTYP        ,,FOR HISPANIC                          
         MVC   SRTPTYPE,NBSURVEY        ,,FOR HISPANIC                          
         MVC   SRTSDROT,NBSDROT         ,,                                      
...
*                                                                               
       ...
       ++INCLUDE FASSB                                                          
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028NEMED27N  09/17/07'                                      
         END                                                                    
