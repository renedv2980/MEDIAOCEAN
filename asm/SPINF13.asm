*          DATA SET SPINF13    AT LEVEL 021 AS OF 05/30/07                      
*PHASE T21A13A                                                                  
...
*                                                                               
         ...
         CLI   LOCKSW,1                                                         
         BNE   *+10                                                             
         MVC   FLDDATA+60(11),=C'LOCK PERIOD'                                   
         CLI   HOLDSW,1                                                         
         BNE   *+10                                                             
         MVC   FLDDATA+60(11),=C'LOCK PERIOD'                                   
         CLI   MGSW,1                                                           
         ...
         CLI   LOCKSW,1            LOCKED ESTS?                                 
         BNE   *+10                NO - SO CONTINUE                             
         MVC   FLDDATA+60(11),DASH ELSE - MOVE OUT DASHES                       
         CLI   HOLDSW,1            HELD ESTS?                                   
         BNE   *+10                NO - SO CONTINUE                             
         MVC   FLDDATA+60(11),DASH ELSE - MOVE OUT DASHES                       
         CLI   MGSW,1                                                           
         BNE   *+10                                                             
...
F37      DS    0H                                                               
*                                                                               
         CLI   LOCKSW,1            LOCKED ESTS REQUESTED?                       
         BE    F38                 YES - SO CONTINUE                            
*                                                                               
         CLI   HOLDSW,1            HELD ESTS REQUESTED?                         
         BNE   F39                 NO - SO CONTINUE                             
*                                                                               
F38      EQU   *                                                                
*                                                                               
         OC    ELOCKYM,ELOCKYM     LOCK PERIOD?                                 
         BZ    F39                 NO - SO CONTINUE                             
*                                                                               
         MVC   WORK(L'ELOCKYM),ELOCKYM     MOVE YM TO WORK                      
         NI    WORK+1,X'FF'-X'80'-X'40'    TURN OFF FLAG BITS                   
         GOTO1 VDATCON,DMCB,(3,WORK),(6,FLDDATA+62)                             
         TM    ELOCKMON,X'80'                                                   
         BNO   *+8                                                              
         MVI   FLDDATA+68,C'-'             TEST IF PRIOR                        
         TM    ELOCKMON,X'40'                                                   
         BNO   *+8                                                              
         MVI   FLDDATA+68,C'+'             TEST IF SUBSEQUENT                   
*                                                                               
F39      EQU   *                                                                
*                                                                               
...
FRMTUSER LA    R2,SINHDRH                                                       
         ...
         MVC   FLDDATA+1(17),=C'CODE PRODUCT NAME'                              
         MVC   FLDDATA+31(8),=C'ESTIMATE'                                       
         BAS   RE,GETCLTU        READ CLIENT FOR USER DEFS                      
         MVC   FLDDATA+40(20),CUSER                                             
         FOUT  (R2)                                                             
         LA    R2,LINLEN(R2)                                                    
         MVC   FLDDATA+1(17),DASH                                               
         MVI   FLDDATA+5,C' '                                                   
         MVC   FLDDATA+31(8),DASH                                               
         MVC   FLDDATA+40(20),DASH                                              
*                                                                               
...
*                                                                               
         ...
         L     R5,AREC                                                          
*                                                                               
* WE NEED TO TEST FOR LOCK/HOLD HERE TO HAVE THE DATE IN THE RECORD             
*                                                                               
         CLI   LOCKSW,1            LOCKED ESTS?                                 
         BNE   EFILT100            NO - SO CONTINUE                             
         TM    13(R5),X'08'        ELSE - IS EST LOCKED?                        
         BO    EFILT100            YES - SO CONTINUE                            
         OC    ELOCKYM,ELOCKYM     ELSE - LOCK DATE SET?                        
         BZ    GESEQ               NO - SO GET NEXT KEY                         
*                                                                               
EFILT100 EQU   *                                                                
*                                                                               
         CLI   HOLDSW,1            HELD ESTS?                                   
         BNE   EFILT200            NO - SO CONTINUE                             
         TM    13(R5),X'0C'        ELSE - IS EST HELD?                          
         BO    EFILT200            YES - SO CONTINUE                            
         OC    ELOCKYM,ELOCKYM     ELSE - IS LOCK DATE SET?                     
         BZ    GESEQ               NO - SO GET NEXT KEY                         
*                                                                               
EFILT200 EQU   *                                                                
*                                                                               
...
*                                                                               
         ...
         GOTO1 GETREC                                                           
         LA    R1,CEU1                                                          
         CLI   USERSW,1            SET R1 TO CORRECT USERDATA FIELD             
         BE    *+8                 NO                                           
         LA    R1,CEU2                                                          
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE DDCOMFACS                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021SPINF13   05/30/07'                                      
         END                                                                    
