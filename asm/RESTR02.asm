*          DATA SET RESTR02    AT LEVEL 024 AS OF 11/25/97                      
*PHASE T80E02A                                                                  
...
VK50     CLC   KEY(RSTRKEND-RSTRKEY),KEYSAVE                                    
         BNE   VK100                                                            
         CLC   STARTDT,K.RSTRKEND  CAN'T OVERLAP                                
         BE    INVLDOVL                                                         
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(8,WORK),(6,SATPERI)                                 
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,SATPERI+7)                               
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024RESTR02   11/25/97'                                      
         END                                                                    
