*          DATA SET SPNWS00W   AT LEVEL 192 AS OF 07/17/02                      
*PHASE T20700A,*                                                                
*INCLUDE EQVRD                                                                  
*INCLUDE GETPROF                                                                
*INCLUDE DPTRD                                                                  
...
*                                                                               
         L     R1,ACRELO                                                        
****     L     RE,=V(RECUP)        COMMENTED OUT BECAUSE WE NOW                 
****     AR    RE,R1                  GET IT FROM SYSPARMS                      
****     ST    RE,VRECUP                                                        
         L     RE,=V(EQVRD)                                                     
         AR    RE,R1                                                            
         ST    RE,VEQVRD                                                        
...
*                                                                               
NWS50    TM    TWATAMFL,TWAFRTAM   FROM TV AVAIL MANAGER?                       
         BZ    NWS60                                                            
NWS55    STCM  RD,15,TWAB4GNL      A WAY FOR OVERLAYS TO EXIT GENERAL           
...
*                                                                               
         L     RF,ACPARMA                                                       
         L     RF,16(RF)           CALL FAWSSVR TO SAVE CLST BUFFER             
...
*                                                                               
         ...
         LA    R1,ACWORK                                                        
         USING FAWSSVRD,R1                                                      
         MVC   FAWSTOKN,=CL4'CLST'                                              
         MVI   FAWSACTN,FAWSUSVE   TO SAVE BTWMN TRANSACTIONS                   
         LHI   R0,1024             SAVE OFF AIOAREA1                            
         STH   R0,FAWSLEN                                                       
         MVC   FAWSADR,AIOAREA1                                                 
         GOTO1 (RF),(R1)                                                        
         CLI   FAWSRTN,0                                                        
         BE    *+6                                                              
         DC    H'0'                                                             
...
***********************************************************************         
         SPACE 1                                                                
ACTION   CLI   INACT,ACTMKT        MSPILL ACTION ONLY VALID FOR CANADA          
         BNE   *+12                                                             
         CLI   CUDMED,C'C'                                                      
         BNE   ACT9                                                             
...
PROCKEY  DS    0H                  AFTER KEY PRE-VALIDATION                     
         ...
         BO    PROCK2                                                           
         MVC   INFPWD,C' '         YES-THEN SET DEFAULT PASSWORD                
...
***********************************************************************         
         SPACE 1                                                                
VALBYR   MVI   FVMINL,1            REQUIRED FIELD                               
         MVI   FVMAXL,L'QBYR                                                    
         GOTO1 AFVAL                                                            
         BNE   VALBYRX                                                          
...
*                                                                               
         ...
         XC    CMPDATSP,CMPDATSP                                                
         XC    CMPDATSD,CMPDATSD                                                
         GOTO1 VDATCON,RPARM,(3,CMPST),RWORK                                    
*                                                                               
         TM    CAMOPT,CAMOWKS      TEST NON-CONTIGUOUS FLIGHT WEEKS             
         BO    EXTCAM6             YES                                          
         TM    CAMOPT,CAMODLY      NO-TEST DAILY SCHEDULE                       
         BZ    EXTCAM16            NO                                           
         MVC   CMPDATSD(6),RWORK   YES-BUILD LIST OF DAYS                       
         BAS   RE,GETMON                                                        
...
EXTCAM6  TM    CAMOPT,CAMODLY      NON-CONTIGUOUS WEEKS - TEST DAILY            
         BO    *+14                                                             
         MVC   CMPDATSP(L'CAMWKS),CAMWKS  NO                                    
         B     EXTCAM14                                                         
         LA    R3,CAMWKS           YES-BUILD LIST OF DAYS                       
         LA    R4,CMPDATSP                                                      
         LA    R5,2                                                             
*                                                                               
...
EXTCAM12 LA    R3,4(R3)                                                         
         ...
         BCT   R5,EXTCAM8                                                       
*                                                                               
EXTCAM14 LA    R4,CMPDATSP         COUNT N'WEEKS OR DAYS                        
         SR    RE,RE                                                            
         OC    0(4,R4),0(R4)                                                    
         BZ    *+16                                                             
         LA    R4,4(R4)                                                         
         ...
         GOTO1 (RF),(R1),(2,CMPDATSP),(0,RWORK)                                 
         MVC   CMPDATSD(6),RWORK                                                
         BAS   RE,GETMON                                                        
         MVC   CMPFLSTM,RWORK+6                                                 
         GOTO1 (RF),(R1),CMPFLSTM,(2,CMPSTMNP)                                  
         MVC   CMPNDMNP,CMPSTMNP                                                
         GOTO1 (RF),(R1),(3,CMPST),(0,RWORK)                                    
         BAS   RE,GETMON                                                        
         MVC   CMPSTMON,RWORK+6                                                 
         B     EXTCAM18                                                         
*                                                                               
EXTCAM16 GOTO1 VDATCON,RPARM,(3,CMPST),(0,RWORK)     BUILD LISTS OF             
         ...
         GOTO1 VMOBILE,(R1),(14,RWORK),(5,CMPDATSP),RPARM+16,RWORK2             
         MVC   CMPNWKS,RPARM       NUMBER OF WEEKS                              
         GOTO1 VDATCON,RPARM,(2,CMPDATSP),(0,CMPSTMON)  START MONDAY            
         MVC   CMPSTMNP,CMPDATSP   START MONDAY PACKED                          
         MVC   CMPNDMNP,CMPDATSP   END MONDAY PACKED                            
         MVC   CMPDATSD(6),RWORK   START DATE                                   
*                                                                               
EXTCAM18 LA    R3,CMPDATSD+6                                                    
         LA    R4,CMPDATSP+4                                                    
*                                                                               
...
*                                                                               
         ...
         B     VALMED9                                                          
*                                                                               
VALMED0A CLI   FVIFLD,C'R'         RADIO IS ALLOWED FOR FOLLOWING               
...
***********************************************************************         
         SPACE 1                                                                
VALCLT   GOTO1 =A(VALICLT),RR=ACRELO                                            
         B     ROUTSX                                                           
***********************************************************************         
...
*        CC=NOT EQUAL ON ERROR WITH FVMSGNO SET TO ERROR NUMBER       *         
***********************************************************************         
VALEST   GOTO1 =A(VALIEST),RR=ACRELO                                            
         B     ROUTSX                                                           
***********************************************************************         
...
GETEST1  MVC   RDUB(L'BEST),0(R1)                                               
         ...
         OI    ESTIND,ESTICS2                                                   
*                                                                               
GETEST1A BAS   RE,GETESTIN                                                      
*                                                                               
         TM    CLTIND2,CLTIEST     TEST CAMP AND EST DATES MUST MATCH           
         BZ    GETEST2                                                          
         GOTO1 VDATCON,RPARM,(3,CMPST),RWORK   YES-                             
...
*                                                                               
VALDPL2  CLI   FVILEN,2            VALIDATE THE SPOT LENGTH                     
         BE    VALDPL92                                                         
         ZIC   RE,FVILEN                                                        
         BCTR  RE,0                                                             
         BCTR  RE,0                                                             
...
VALDPLX  B     ROUTSX                                                           
         SPACE 2                                                                
SLNTAB   DS    0XL1                                                             
         DC    AL1(5,10,15,20,30,40,45,50,60,75,90,105,120,150),AL1(0)          
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
         ...
         CLI   RWORK+16,C'O'       OLYMPIC BOOK TYPE?                           
         BNE   *+8                                                              
         OI    APWORK+9+1,X'80'    SET X'80' ON IN MONTH                        
*                                                                               
         CLI   4(R1),1             TEST 2 OR MORE BOOKS                         
         BNH   VALUPX                                                           
         CLI   4(R1),4                                                          
         BH    VALUPB9                                                          
         BCTR  RF,0                                                             
...
*                                                                     *         
* EXIT - CC=EQ IF ADJACENCY CODE VALID AND ADJCODE IS SET             *         
...
VALADJ   CLI   CLTPROF+9,C'0'      TEST CLIENT ALLOWED ADJACENCY CODE           
         ...
         B     VALADJX                                                          
*                                                                               
VALADJ2  MVC   ADJCODE,0(R1)       TEST VALID ALPHA                             
         CLI   1(R1),C' '                                                       
         BH    VALADJ9                                                          
...
VALADJ4  CLI   0(R1),C'*'                                                       
         BE    *+14                                                             
         CLC   ADJCODE,0(R1)       MATCH I FILTER IS GOOD                       
         BE    VALADJX                                                          
         LA    R1,1(R1)                                                         
         BCT   R0,VALADJ4                                                       
         B     VALADJ9                                                          
...
VALADJ6  CLI   0(R1),C'*'                                                       
         BE    *+14                                                             
         CLC   ADJCODE,0(R1)       MATCH X FILTER IS BAD                        
         BE    VALADJ9                                                          
         LA    R1,1(R1)                                                         
         BCT   R0,VALADJ6                                                       
         B     VALADJX                                                          
...
DBLD48   OC    LUPGRD(8),LUPGRD    TEST FOR UPGRADE EXPRESSION                  
         ...
         BAS   RE,DEMUP            YES - DO THE DEMO UPGRADES                   
...
XFR32    LA    RE,RIO              A(LIST OF OVERRIDE DEMO ELS)                 
         ...
         GOTO1 ADELELS,BWDRECD                                                  
         BAS   RE,DEMUP            DO UPGRADES AND ADD DEMO ELEMENT             
         ZIC   R4,BWDSEQ                                                        
...
*                 IOAREA4+08(56) = DOLLARS BY WEEK (14X4)             *         
*                 IOAREA4+64(56) = POINTS  BY WEEK (14X4)             *         
*          CC=NOT EQUAL ON ERROR WITH FVMSGNO SET TO ERROR NUMBER     *         
***********************************************************************         
         SPACE 1                                                                
...
*                                                                               
         TM    SPUPFBK+1,X'80'     DO WE HAVE OLYMPIC BOOK TYPE?                
         BZ    *+12                                                             
...
*                                                                               
         ...
         MVI   SPUP2YRR,C'Y'                                                    
*                                                                               
         GOTO1 ASPDEMUP,RPARM,RWORK4,RWORK2,RWORK3     CALL SPDEMUP             
*                                                                               
...
DEMU10   SR    R1,R4               LENGTH OF DEMO ELEMENT                       
         ...
         BNH   DEMUX                                                            
         STC   R1,DMOELLN                                                       
         GOTO1 ADDELSC,BWDRECD     ADD DEMO ELEMENT                             
*                                                                               
DEMUX    B     EXIT                                                             
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
         ...
         DROP  R1                                                               
*                                                                               
         LA    R2,BWSPWD           COUNT HOW MANY BYTES IN PASSWD               
...
*                                                                               
         LA    RF,DETIDH           ID OR CODE FIELDS?                           
         CR    R2,RF                                                            
         BE    FTAM50                                                           
         LA    RF,DETCODH                                                       
         CR    R2,RF                                                            
...
*                                                                               
         ...
         MVC   FAWSTOKN,=CL4'CLST'                                              
         MVI   FAWSACTN,FAWSASVE                                                
         LHI   R0,1024             SAVE OFF WHAT IS IN AIOAREA1                 
         STH   R0,FAWSLEN                                                       
         MVC   FAWSADR,AIOAREA1                                                 
         GOTO1 (RF),(R1)                                                        
         CLI   FAWSRTN,0                                                        
         ...
         DC    H'0'                                                             
*                                                                               
         XC    ACWORK,ACWORK       NOW RESTORE SECRET AREA                      
         LA    R1,ACWORK                                                        
         USING FAWSSVRD,R1                                                      
         MVC   FAWSTOKN,=CL4'CLST'                                              
         MVI   FAWSACTN,FAWSURST                                                
...
*&&DO                                                                           
         ...
         LHI   R0,1024             SAVE OFF THE SECRET AREA                     
         STH   R0,FAWSLEN                                                       
         MVC   FAWSADR,AIOAREA1                                                 
         GOTO1 (RF),(R1)                                                        
         CLI   FAWSRTN,0                                                        
         ...
         DC    H'0'                                                             
*&&                                                                             
         XC    ACWORK,ACWORK       NOW PULL DATA BACK FOR AIOAREA1              
         LA    R1,ACWORK                                                        
         USING FAWSSVRD,R1                                                      
         MVC   FAWSTOKN,=CL4'CLST'                                              
         MVI   FAWSACTN,FAWSARST                                                
...
LD540    OC    0(2,R5),0(R5)       TEST VALUE PRESENT                           
         ...
         BNH   LD542                                                            
         NI    1(R5),X'FF'-X'80'   CAN'T HAVE OLYMPIC HERE                      
         BAS   RE,EDITBK                                                        
         B     LD544                                                            
*                                                                               
LD542    SR    R0,R0                                                            
...
EDITBK   NTR1                                                                   
         MVC   APDUB(2),0(R5)                                                   
         MVI   APDUB+2,1                                                        
         NI    APDUB+1,X'7F'          TURN OFF OLYM EXCL                        
...
*                                                                               
         ...
         BZ    SPDEMUP1                                                         
         CLC   CMPST,=X'5E031C'    YES-DON'T FORCE NSI FOR CAMPAIGNS            
         BNL   SPDEMUP1            THAT START BEFORE 3/28/94                    
         MVI   SPUPSRC,C'A'        AND MAKE SURE SRC=ARB                        
         B     SPDEMUPG                                                         
*                                                                               
SPDEMUP1 MVI   SPUPSRC,C'N'        FORCE SERVICE TO NSI                         
...
*                 IOAREA3+00(04) = TOTAL GOAL DOLLARS                 *         
*                 IOAREA3+04(04) = TOTAL GOAL POINTS                  *         
*                 IOAREA3+08(56) = GOAL DOLLARS BY WEEK (14X4)        *         
*                 IOAREA3+64(56) = GOAL POINTS  BY WEEK (14X4)        *         
*        CC=NOT EQUAL ON ERROR WITH FVMSGNO SET TO ERROR NUMBER       *         
*                                                                     *         
...
*                                                                               
         MVC   GKEYMKT,BMKT                                                     
         MVC   GKEYEST,BEST                                                     
         CLI   0(R5),0             TEST ANY MORE DAYPARTS                       
         BE    GETG27                                                           
         MVC   GKEYDPT,0(R5)                                                    
         MVI   GKEYSLN,0                                                        
*                                                                               
...
GETG4    GOTO1 AIO                                                              
         ...
         BE    GETG28                                                           
         CLC   GKEYPRD,IOKEYSAV+GKEYPRD-GKEY        TEST NEW PRODUCT            
         BE    GETG5                                                            
...
*                                                                               
GETG5    CLC   GKEY(GKEYSLN-GKEY),IOKEYSAV                                      
         BNE   GETG26                                                           
         ...
         BNL   GETG26                                                           
         B     GETG6                                                            
         CLI   CMPPRD1,0                 EQUAL-TEST PIGGYBACK                   
         BNE   GETG8                                                            
...
GETG6    LA    R1,DIRSQ            READ SEQUENTIAL                              
         B     GETG4                                                            
*                                                                               
GETG7    CLC   GKEY(10),IOKEYSAV                                                
         BNE   GETG25                                                           
*                                                                               
         OC    ACWORK(L'CAMIDRNM),ACWORK  ANY IDR BUYER NAME?                   
         BZ    GETG7A                                                           
         TM    GKEYAGY,X'40'       YES, THEN THIS BIT SHOULD BE ON              
         BZ    GETG6               IT ISN'T ON, READ NEXT GOAL RECORD           
         B     GETG7X                                                           
*                                                                               
GETG7A   TM    GKEYAGY,X'40'       NO IDR BUYER, THIS BIT SHOULDN'T BE          
...
GETG10   ZIC   R0,1(R4)                                                         
         ...
         BH    GETG10                                                           
         B     GETG12                                                           
         CLC   GLWEEK,CMPDATSP+2   YES-TEST WEEK FALLS WITHIN ONE OF            
...
GETG20   L     RE,RDUB             ACCUMULATE GOAL DOLLARS                      
         ...
         LA    RE,64(R3)           ACCUMULATE GOAL POINTS BY WEEK               
         LA    RF,CMPDATSP                                                      
         TM    CMPOPTS,CAMOWKS     TEST NON-CONTIGUOUS FLIGHT WEEKS             
         BZ    GETG22                                                           
...
GETG25   CLI   CMPPGRPN,0          FINISHED WITH RECORD-TEST PRD=POL            
         ...
         B     GETG4                                                            
*                                                                               
GETG26   LA    R5,1(R5)            NEXT DAYPART                                 
         B     GETG2                                                            
*                                                                               
...
PHASES   DS    0X                  ** LOADED CORERES PHASES **                  
         ...
         EJECT                                                                  
* SPNWSWRK                                                                      
       ++INCLUDE SPNWSWRK           <<=== GOMSPACK, GOMSUNPK                    
TWAD     DSECT                                                                  
         ORG   BWSTABH                                                          
       ++INCLUDE SPNWSFCD                                                       
         EJECT                                                                  
...
* DDGLVXCTLD                                                                    
       ...
       ++INCLUDE FASECRETD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'192SPNWS00W  07/17/02'                                      
         END                                                                    
