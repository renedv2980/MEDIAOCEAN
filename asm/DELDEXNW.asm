*          DATA SET DELDEXNW   AT LEVEL 069 AS OF 05/01/02                      
*PHASE DELDEX97,+0                                                              
*INCLUDE LOGIO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*******************************************************************             
* DELETES  ALL DATA BUT 1997-1998                                               
*******************************************************************             
...
*                                                                               
********************************************************************            
         MVC   STBK,=X'6100'       PULL OFF: 97-98                              
         MVC   ENDBK,=X'62FF'                                                   
*                                                                               
         MVC   STXORBK,STBK                                                     
         MVC   ENXORBK,ENDBK                                                    
...
DMX_A    CLI   0(R3),C'A'          'A' - RECDS?                                 
         BE    DMXKILL             NO BOOK IN KEY, GET RID OF IT                
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'069DELDEXNW  05/01/02'                                      
         END                                                                    
