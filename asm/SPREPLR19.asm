*          DATA SET SPREPLR19  AT LEVEL 022 AS OF 05/01/02                      
...
SPLS2    GOTO1 DATAMGR,DMCB,=C'DMRSEQ',=C'PAVDIR ',SVSPLKEY,SPLKEY              
         CLI   8(R1),0             READ OK?                                     
         BNE   EXIT1               EOF                                          
SPLS6    CLC   PNCODE(3),=C'NNN'                                                
         BNE   EXIT1                                                            
         CLI   PNSTAT+4,C'S'                                                    
         BNE   SPLS2                                                            
         CLC   PRVKEY(PNDW-PNKEY),PNKEY                                         
         BE    SPLS8                                                            
         LA    RE,PROGBUF                                                       
         L     RF,=F'6000'                                                      
         XCEF                                                                   
         MVC   PRVKEY,PNKEY                                                     
         SPACE 1                                                                
SPLS8    LA    R7,SVSPLKEY                                                      
         USING PKKEY,R7                                                         
         LA    RE,PROGBUF                                                       
SPLS8A   OC    0(2,RE),0(RE)                                                    
         BZ    SPLS8B                                                           
         CLC   PNPNUM,0(RE)                                                     
         BE    SPLS2                                                            
         LA    RE,2(RE)                                                         
         B     SPLS8A                                                           
         SPACE 2                                                                
SPLS8B   MVC   0(2,RE),PNPNUM                                                   
         MVC   PKKEY(3),=C'KNN'                                                 
         MVC   PKPNUM+1(2),PNPNUM                                               
         MVI   PKPNUM,0                                                         
         MVC   PKBOOK,PNBOOK                                                    
         MVC   PKSTA(5),PNSTAT                                                  
         MVC   PKBTYP,PNBTYP                                                    
...
PSBOOKS  DS    CL80                                                             
       ...
       ++INCLUDE SPREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'022SPREPLR19 05/01/02'                                      
         END                                                                    
