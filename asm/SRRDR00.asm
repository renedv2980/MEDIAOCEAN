*          DATA SET SRRDR00    AT LEVEL 003 AS OF 09/17/12                      
*PHASE T16200A                                                                  
*INCLUDE XSORT                                                                  
*INCLUDE REREPDIF                                                               
*INCLUDE GETBROAD                                                               
...
*INCLUDE REGENDHT                                                               
         PRINT NOGEN                                                            
         TITLE '$RDR (T16200) -- REP DARE INTERFACE'                            
**********************************************************************          
...
* HISTORY OF CHANGES                                                 *          
**********************************************************************          
* MAY19/94 (BU ) --- ORIGINAL ENTRY                                  *          
*                                                                    *          
* AUG02/94 (BU ) --- SOFT/HARD DELETE FOR 'DELETED' RECORDS          *          
*                                                                    *          
* DEC09/94 (BU ) --- AGENCY REJECT FOR 'NOTDARE'                     *          
*                                                                    *          
* DEC21/94 (BU ) --- SET WEEKLY/DAILY FLAG IN BUY DETAILS            *          
*                                                                    *          
* JAN11/95 (BU ) --- INCORPORATE ROUTING CODE FOR 'NOTDARE'          *          
*                                                                    *          
* JAN26/95 (BU ) --- ACCEPT TOTAL BUY COMMENT: DON'T TRUNCATE        *          
*                                                                    *          
* APR25/95 (BU ) --- NEW CALC FOR FLIGHT START DATE.  HIATUS COMMTS. *          
*                                                                    *          
* MAY11/95 (BU ) --- PUT ERROR MESSAGES INTO PROCESSING              *          
*                                                                    *          
* MAY19/95 (BU ) --- SKIP ALL BUT 'DAR' IN CORETABLE, X'FF' USED     *          
*                    ENTRIES                                         *          
*                                                                    *          
* OCT18/95 (BU ) --- ADD MKGAPP/MKGREJ ACTIONS                       *          
*                                                                    *          
* DEC08/95 (SKU) --- REVAMP DARE MAKEGOOD AUDIT ELEMENT              *          
*                                                                    *          
* DEC14/95 (SKU) --- NEW ADJUSTMENT FOR DDS TIME                     *          
*                                                                    *          
* DEC27/95 (SKU) --- ADD THMS TIME ROUTINE FOR MAKEGOOD AUDIT TRAIL  *          
*                                                                    *          
* DEC29/95 (SKU) --- FIX NOTDARE BUG NOT WRITING RECORD BACK         *          
*                                                                    *          
* FEB15/96 (BU ) --- ADD EDI ELEMENT INSERTION                       *          
*                                                                    *          
* FEB15/96 (WH ) --- SWITCH TO CTL IF ERROR 2 WHEN SWITCHING TO REP  *          
*                                                                    *          
* AUG15/96 (SKU) --- FIX MAKEGOOD REJECT COMMENT LENGTH ERROR        *          
*                                                                    *          
* OCT23/96 (SKU) --- SUPPORT CALL LETTER SWITCHING                   *          
*                    SUPPORT ERRORS                                  *          
*                                                                    *          
* JAN17/97 (SKU) --- AUDIT TRAIL ELEMENTS NEED VERSION# CHECKS       *          
*                                                                    *          
* FEB27/97 (SKU) --- SUPPORT POL/BRAND ORDERS                        *          
*                                                                    *          
* AUG21/97 (SKU) --- DARE AGENCY REVISION SUPPORT                    *          
*                                                                    *          
* DEC30/97 (SKU) --- DARE REVISION CAN HAVE BLANK FIRST AIR DATE     *          
*                                                                    *          
* FEB13/97 (SKU) --- SEND ERROR IF APPROVAL AND RECALL/CANCEL CROSS  *          
*                    FOR MAKEGOODS                                   *          
*                                                                    *          
* FEB24/98 (SKU) --- UPGRADE CONTRACT SIZE TO 6000 BYTES. 3972 WILL  *          
*                    BE THE ACTUAL LIMIT. ALSO FIX REVCAN BUG        *          
*                                                                    *          
* MAR27/98 (SKU) --- SUPPORT REVISION CANCELLED FLAG                 *          
*                                                                    *          
* APR16/98 (SKU) --- SUPPORT AGENCY BUY DEMO VALUES                  *          
*                                                                    *          
* JUL30/98 (SKU) --- ADD STATIN CALL LETTERS TO X'AD' KEY            *          
*                                                                    *          
* AUG18/98 (SKU) --- X'AD' CALL LETTER BAND BUG FIX                  *          
*                                                                    *          
* NOV16/00 (SKU) --- ACCOMMODATE DATATREK ORDER PROCESSING           *          
*                                                                    *          
* DEC07/00 (SKU) --- FIX MAKEGOOD REJECTION COMMENT BUG              *          
*                                                                    *          
* MAR14/00 (SKU) --- SORT BUYORB ENTRIES BY START DAY                *          
*                                                                    *          
* APR20/01 (SKU) --- AGYCAN: NEED TO CLEAR LAST CHAR OF STATION      *          
*                                                                    *          
* OCT11/01 (SKU) --- ADD AUDIT TRAIL HISTORY                         *          
*                                                                    *          
* NOV27/01 (SKU) --- IGNORE AGENCY ROUTING OFFICE IN AGYHDR ROUTINE  *          
*                                                                    *          
* FEB06/02 (SKU) --- AGYCAN TRIGGERS ERROR IF ORDER NOT FOUND        *          
*                    AGENCY MAKEGOOD APPROVAL INVALID IF REP RECALLS *          
*                    FIX SNDERROR BUG                                *          
*                                                                    *          
* APR03/02 (SKU) --- FIX UNDELETE BUG                                *          
*                                                                    *          
* JUN18/02 (SKU) --- SAVE OFF COPY OF ORDER                          *          
*                                                                    *          
* SEP27/02 (SKU) --- IF ORDER RESEND IS MISSING CONTRACT NUMBER      *          
*                    PRESERVE CONTRACT NUMBER FROM CURRENT COPY      *          
*                                                                    *          
* NOV14/02 (SKU) --- RADIO EDI SUPPORT                               *          
*                                                                    *          
* APR10/03 (SKU) --- SKIP COMPARISON LOGIC IF REVNEW                 *          
*                                                                    *          
* MAY12/03 (SKU) --- ADD BUG TRAPPING                                *          
*                    MAKEGOOD SELF-APPLY SUPPORT                     *          
*                                                                    *          
* DEC04/03 (SKU) --- STRICTER CHECK FOR CON# IN AGYHDR               *          
*                                                                    *          
* JAN30/04 (HQ ) --- SPLIT LINES ON CONFLICT END DATE                *          
*                                                                    *          
* MAR30/04 (HQ ) --- KEEP AMEND STATUS IF ORDER TURNS INTO MATCH     *          
*                                                                    *          
* MAY10/04 (SKU) --- XML SUPPORT                                     *          
*                                                                    *          
* MAY20/04 (SKU) --- MAKE SR ONE RUN PER ORDER                       *          
*                                                                    *          
* MAY26/04 (HQ ) --- GENERATE DARE PASSIVE KEYS FOR TV AS WELL       *          
*                                                                    *          
* JUN03/04 (SKU) --- XML EMAIL SUPPORT                               *          
*                                                                    *          
* JUN28/04 (SKU) --- REMOVE UID SUPPORT                              *          
*                    DISABLE VARIOUS/BRAND ORDERS                    *          
*                                                                    *          
* AUG18/04 (SKU) --- TEMPORARILY DISABLED UNLESS IN FACMEL           *          
*                                                                    *          
* AUG25/04 (HQ ) --- TAKE OUT RADIO PASSIVE KEY CHECK IN AGYCAN      *          
*                    DELETE PASSIVES IN AGYCAN                       *          
*                                                                    *          
* DEC22/04 (SKU) --- MARK PROCESSED EDI REPORTS TO PRIRET INSTEAD    *          
*                    OF PRINTED TO RECALCULATE EXPIRATION DATE/TIME  *          
*                                                                    *          
* FEB02/05 (SKU) --- FIX XML DUPLICATE ORDER ERROR                   *          
*                                                                    *          
* FEB28/05 (SKU) --- FIX XML EMAIL BUG                               *          
*                                                                    *          
* JUN07/05 (SKU) --- FOR XML ONLY, RENUMBER AGENCY BUY NUMBERS       *          
*                    CHANGE SUB ID FROM DAR TO XML FOR XML OK MSGS   *          
*                                                                    *          
* MAY24/06 (SKU) --- SEND A COPY OF THE DARE ORDER EDI TO MO FOR     *          
*                    EAGLE (ETV)                                     *          
*                                                                    *          
* NOV28/06 (SKU) --- IF EDI COPY TOO BIG, DON'T SEND COPY TO MO      *          
*                                                                    *          
* JUL31/07 (SKU) --- ADD HAWORTH INCOMING CONTRACT NUMBER WITH A     *          
*                    MILLION IF RECIEVING REP IS B1 AND CONTRACT     *          
*                    NUMBER IS LESS THAN A MILLION                   *          
*                                                                    *          
* NOV06/08 (SKU) --- FOR EPORT/XML ORDERS:                           *          
*                      SKIP AGYTLR $/SPOT CHECK                      *          
*                      SKIP EMAIL BACK TO AGENCY                     *          
*                                                                    *          
* JUN10/09 (KUI) --- SKIP CONVERTING EST NUMBER IF NON-NUMERIC       *          
*                                                                    *          
* AUG31/09 (KUI) --- PROCESS SPACE PADDED EST NUMBER                 *          
*                                                                    *          
* SEP08/09 (KUI) --- CALCULATE $/SPT TOTALS FOR XML ORDERS           *          
*                                                                    *          
* SEP22/09 (KUI) --- FOR EPORT XML ORDERS, SKIP 0 SPOT WEEKS         *          
*                                                                    *          
* DEC07/10 (RCRI)--- LEVEL BACK TO LAST CHG. GET FACIDTAB FROM SSB   *          
*                                                                    *          
* MAR15/10 (KUI) --- FIX ADDAY TO SHOW PRINTABLE CHARACTERS          *          
*                                                                    *          
* MAR25/10 (KUI) --- FIX SELF APPLY TO CHECK APPROVAL VERSION#       *          
*                    SAVE OFF ORDER ROTATION START DAY               *          
*                                                                    *          
* FEB02/11 (KUI) --- SEND ERROR 928 FOR AGYCAN IF ORDER NOT FOUND    *          
*                                                                    *          
* SEP10/12 (KUI) --- CHANGE MKGAPP/REJ TO USE CONTRACT'S STATION     *          
*                    CALLS INSTEAD OF THE ONE IN THE EDI AS THE EDI  *          
*                    ONE CAN BE INCORRECT DUE TO STATION SWAPS       *          
*                                                                    *          
*                    ***  END TOMBSTONE  ***                         *          
**********************************************************************          
*                                                                    *          
* NOTE: SERVICE REQUEST CHANGED TO PROCESS ONLY ONE EDI ENTRY PER    *          
*       CALL. SR IS INITIALLY CALLED BY SRTIM00 (AS WELL AS EVERY    *          
*       TIMER POP). AFTER ONE EDI ENTRY IS PROCESSED, IT CHECKS TO   *          
*       SEE IF ANY MORE EDI (DAR REPORTS) ENTRIES WAITING TO BE      *          
*       PROCESSED. IF THERE ARE PENDING ENTRIES, IT WILL SET A FLAG  *          
*       FOR FATASKER TO CALL SRRDR00 AGAIN BEFORE EXITING.           *          
*                                                                    *          
*       NOTE THAT FATASKER ALSO ENSURES THAT ONLY ONE INSTANCE OF    *          
*       THIS PROGRAM IS RUNNING.                                     *          
**********************************************************************          
SRRDR00  CSECT                                                                  
         NMODL WORKX-WORKD,*$DR*,R8,RR=R3                                       
         USING WORKD,RC                                                         
         ST    R3,RELO                                                          
*                                                                               
* INITIALIZATION                                                                
...
*                                                                               
         L     RE,VSSB                                                          
         USING SSBD,RE                                                          
         NI    SSBDARFL,X'FF'-SSBDRRPQ   SO TASKER DOESN'T CALL AGAIN           
*                                                                               
*        BAS   RE,LOADTABL         **TEMPORARY**                                
*                                     SET UP 'CORE' TABLE FROM SCREEN           
* WHEN CORE TABLE AVAILABLE, SET UP ADDRESSING TO IT HERE.  THEN                
*      DETERMINE IF CORETABLE IS SET UP TO CORRESPOND TO DSECT                  
*      DREPTABL.  IF NOT, ADJUST DSECT TO MATCH.                                
*                                                                               
*        LA    R2,WORKTABL         A(TEMPORARY 'CORE' TABLE)                    
*                                                                               
         L     R2,SSBDARPQ                                                      
         DROP  RE                                                               
*                                                                               
         ZICM  R4,0(R2),2          SET UP BILL BXLE                             
         L     R5,2(R2)                                                         
         LA    R2,6(R2)                                                         
*                                  FIRST PASS                                   
         NI    DARFLAGS,X'FF'-DFINLOOP                                          
*                                                                               
SRRD0020 EQU   *                                                                
*                                                                               
...
*                                                                               
         ...
         XCEFL                                                                  
*                                                                               
         CLC   0(2,R2),=X'0000'    ANYTHING IN TABLE?                           
         BE    SRRD0900            NO  - FINISHED....                           
         CLC   =C'DAR',2(R2)       DARE REPORT?                                 
         BNE   SRRD0070            NO  - SKIP IT, DON'T RESET IT                
*                                                                               
         TM    DARFLAGS,DFINLOOP   2ND PASS?                                    
         BZ    SRRD0025                                                         
*                                                                               
         L     RE,VSSB                                                          
         USING SSBD,RE                                                          
         OI    SSBDARFL,SSBDRRPQ   ASK TASKER TO CALL ME AGAIN                  
         DROP  RE                                                               
*                                                                               
         B     SRRD0900            EXIT!!                                       
*                                                                               
SRRD0025 EQU   *                                                                
         ...
         BE    SRRD0030                                                         
         CLC   LASTAGY,=X'0966'    EJOR REPORT?                                 
         MVC   LASTAGY,=X'0000'                                                 
         BNE   SRRD0050            NO, SKIP AND TRY NEXT TIME                   
         GOTO1 RETRVREP,DMCB,(R2)  GET THE REPORT FROM PRINT QUEUE              
         BNE   SRRD0050                                                         
         BAS   RE,UPDATDAR         MARK REPORT AS PRINTED IF LASTAGY=0          
         B     SRRD0050                                                         
*                                                                               
SRRD0030 GOTO1 RETRVREP,DMCB,(R2)  GET THE REPORT FROM PRINT QUEUE              
         BNE   SRRD0050            RECORD NOT FOUND                             
SRRD0040 EQU   *                                                                
         BAS   RE,UPDATDAR         MARK REPORT AS PRINTED IF LASTAGY=0          
*                                                                               
SRRD0050 EQU   *                                                                
         MVI   0(R2),X'FF'         CLEAR THE ENTRY                              
         MVC   1(7,R2),0(R2)                                                    
******   XC    0(8,R2),0(R2)       CLEAR IT FOR NEXT TIME                       
SRRD0060 EQU   *                                                                
*&&XX                                                                           
         OI    DARFLAGS,DFINLOOP   FLAG WE ARE ABOUT TO DO 2ND PASS             
*&&                                                                             
SRRD0070 EQU   *                                                                
         GOTO1 VDATAMGR,DMCB,(0,=C'COMMIT'),0  COMMIT                           
         BXLE  R2,R4,SRRD0020      GO BACK AND CHECK NEXT LINE                  
SRRD0900 EQU   *                                                                
         B     EXIT                                                             
         EJECT                                                                  
*                                                                               
...
*                                                                               
         ...
         MVI   EMAILFLG,EMFOK                                                   
*                                                                               
         OC    LASTAGY,LASTAGY     AGENCY CLEARED OUT?                          
         BZ    UPDA0900            YES, MARK REPORT AS PRINTED                  
*                                                                               
UPDA0040 EQU   *                                                                
         XC    R,R                                                              
...
UPDA0120 EQU   *                                                                
         ...
         BNZ   UPDA0950                                                         
*                                                                               
         TM    MQFLAGS,X'80'       ARE WE MQ'ING EDI TO MO?                     
         BZ    UPDA0040                                                         
*                                                                               
...
*                                                                               
         ...
         CLC   LASTAGY,0(R2)       AGENCY PREVIOUSLY SEEN?                      
         BE    CTRL0400            YES - DON'T DO IT AGAIN                      
         OC    LASTAGY,LASTAGY     FIRST PASS?                                  
         BZ    CTRL0040            YES - DON'T SWITCH TO CONTROL                
*                                     ALREADY THERE                             
         GOTO1 VSWITCH,DMCB,(X'0A',X'FFFFFFFF'),0                               
CTRL0040 EQU   *                                                                
         MVC   LASTAGY,0(R2)       SAVE NEW AGENCY                              
         L     R3,AUTL                                                          
         MVI   4(R3),X'0A'         SET UTL SE TO CTFILE                         
         XC    WORK,WORK                                                        
         MVI   WORK,C'I'           FIND CONTROL FILE ID RECORD                  
**TEST** MVC   WORK+23(2),=X'0966' INSERT ID NUMBER FOR EJOR!!!!                
         MVC   WORK+23(2),0(R2)    INSERT ID NUMBER FROM TABLE!!                
*                                                                               
CTRL0080 EQU   *                                                                
*                                                                               
         GOTO1 VDATAMGR,DMCB,(0,=C'DMRDHI'),=C'CTFILE',WORK,IOAREA              
...
RSALRECD DSECT                                                                  
       ...
       ++INCLUDE FACIDTABD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003SRRDR00   09/17/12'                                      
         END                                                                    
