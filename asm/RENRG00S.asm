*          DATA SET RENRG00S   AT LEVEL 052 AS OF 05/01/02                      
...
* HANDLE RETURNS FROM BROWSE WITH THIS CALL *                                   
         L     RF,SYSPARMS                                                      
         L     RF,16(RF)           COMFACS                                      
         GOTO1 =V(REBROWSE),DMCB,(RF),SYSRD,0,RR=Y                              
*                                                                               
INIT010  DS    0H                                                               
         L     R2,8(R9)            A(SYSLIST)                                   
         L     RF,4(R2)            A(CALLOV)                                    
...
*                                                                               
         L     RF,SYSPARMS                                                      
         L     RF,16(RF)           COMFACS                                      
         GOTO1 =V(REBROWSE),DMCB,(RF),SYSRD,(R2),0,(0,C' ADV'),0,RR=Y           
         DC    H'0'           BROWSE SHOULD HAVE TAKEN IT FROM HERE             
*        OI    6(R2),X'40'+X'80'   CURSOR HERE ON RETURN                        
*        GOTO1 =A(GOOBR),DMCB,(RC),C'ADV ',(5,9(R2)),0,RR=Y                     
*        DC    H'0'           BROWSE SHOULD HAVE TAKEN IT FROM HERE             
*                                                                               
VADV30   CLI   5(R2),4                                                          
         BH    ADVERR                                                           
...
*                                                                               
         ...
         L     RF,SYSPARMS                                                      
         L     RF,16(RF)           COMFACS                                      
         GOTO1 =V(REBROWSE),DMCB,(RF),SYSRD,(R2),0,(X'80',C' AGY'),0,  +        
               RR=Y                                                             
         DC    H'0'           BROWSE SHOULD HAVE TAKEN IT FROM HERE             
*        OI    6(R2),X'40'+X'80'   CURSOR HERE ON RETURN                        
*        GOTO1 =A(GOOBR),DMCB,(RC),C'AGY ',(5,9(R2)),(X'80',0),RR=Y             
*        DC    H'0'           BROWSE SHOULD HAVE TAKEN IT FROM HERE             
*                                                                               
VAGY30   DS    0H                                                               
         CLI   5(R2),6                                                          
...
*                                                                               
         ...
         L     RF,CGLOBBER                                                      
         DROP  RF                                                               
         GOTO1 (RF),DMCB,=C'PUTD',ELEM,GLBRWLNQ,GLRBRWSE                        
         CLI   8(R1),0                                                          
         BE    *+6                                                              
         DC    H'0'                                                             
         DROP  R2                                                               
...
RSETRECD DSECT                                                                  
       ...
       ++INCLUDE REGENSET                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'052RENRG00S  05/01/02'                                      
         END                                                                    
