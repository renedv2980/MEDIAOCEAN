*          DATA SET DECAVNI    AT LEVEL 005 AS OF 03/19/15                      
*PHASE DECAVNIA                                                                 
*---------------------------------------------------------------------*         
...
P1RTN    DS    0H                  P1 AND P2 RECORDS HAVE SAME FORMAT           
         ...
         BNE   P1R40                                                            
         GOTO1 =V(HKPROC),RR=RELO  SLOT UNIVERSE 001-020                        
         MVI   BYPREAD,0                                                        
         B     READ20                                                           
*                                                                               
P1R40    GOTO1 =V(IKPROC),RR=RELO  2ND P-REC: SLOT UNIVERSES 021-040            
...
P2RTN    DS    0H                                                               
         ...
         CLC   P2DEMGRP,=C'001'    DEMOGRAPHIC GROUP                            
         BNE   P2R40                                                            
         GOTO1 =V(HKPROC),RR=RELO                                               
         MVI   BYPREAD,0                                                        
         B     READ20                                                           
*                                                                               
P2R40    GOTO1 =V(IKPROC),RR=RELO  INTAB COUNTS 021-040                         
         MVI   INTRTYP,C'P'                                                     
         MVI   INTMEDIA,X'95'      COMM AVG HAS LOWER CASE 'N'                  
         MVC   INTBOOK,BOOK1                                                    
         MVC   INTIBOOK,IBOOK1                                                  
...
C6R01B   CLC   C6TOTDUR,=C'000000' ARE TOTAL FIELDS ON THIS RECORD              
         ...
         MVC   C6STA(L'SVC6),SVC6  IF NOT - RESTORE FROM A PREVIOUS C6          
...
C6R10    XC    PVALS(PVALSL),PVALS                                              
         GOTO1 VNTIPRG,DMCB,=C'LKUP',(0,VBITMAP1),C6NUM,RR=RELO                 
...
*                                                                               
         ...
         B     P6R40               BUILD KEY                                    
P6R10    GOTO1 =V(BKPROC),RR=RELO  DEMOS 021-040                                
         B     P6RX                RELEASE RECD                                 
*                                                                               
P6R20    CLC   P6DEMGRP,=C'001'    PROGRAM PUTS                                 
         ...
         B     P6R40               BUILD KEY                                    
P6R30    GOTO1 =V(DKPROC),RR=RELO  PRG PUTS DEMOS: 021-040                      
         B     P6RX                RELEASE RECD                                 
         EJECT                                                                  
**********************************************************************          
...
CNVRTN   NMOD1 0,**CNVW**,RA,RR=RE                                              
         ...
         USING WORKD,R4            R4 = DECAVNI WORK                            
*                                                                               
...
NUMCATS  EQU   38                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005DECAVNI   03/19/15'                                      
         END                                                                    
