*          DATA SET PUBPREM    AT LEVEL 051 AS OF 05/01/02                      
*PHASE PUBPREMA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PUBPREM- PREMIUM CHARGE NOW 6 BYTE(IT WAS 5)'                   
*                                                                               
*              PREMIUM CHARGE NOW 6 BYTE(IT WAS 5)                              
*                                                                               
PUBPREM  CSECT                                                                  
         NBASE 0,PUBPREM,=V(REGSAVE)                                            
         SPACE 2                                                                
         LA    R6,PUBPREM+4095                                                  
         LA    R6,1(R6)                                                         
         USING PUBPREM+4096,R6                                                  
...
*                                                                               
         ...
         BE    PUB                                                              
         B     PUT                 COPY LITTLE PUBRECS                          
*                                                                               
         SPACE 3                                                                
PUB      DS    0H                                                               
*        CLC   REC(9),=X'D5000002000000E2D1'                                    
*        BNE   *+6                                                              
*        DC    H'0'                                                             
         LA    R2,REC+33                                                        
PUB4     CLI   0(R2),X'00'                                                      
...
PUB5     DS    0H                                                               
*        USING PUBPT,R2                                                         
*        MVC   MYHOLDER,PUBPTBCH                                                
*        XC    PUBPTBCH,PUBPTBCH                                                
*        MVC   PUBPTBCH+1,MYHOLDER                                              
*        BAS   RE,DMPREC                                                        
*        B     PUB4                                                             
*        DROP  R2                                                               
*                                                                               
...
*                                                                               
         ...
         GOTO1 =V(HEXOUT),DMCB,(R5),P+01,(R2),=C'N'                             
*                                                                               
         MVC   WORK(ELEMLEN),0(R5)                                              
         TR    WORK(ELEMLEN),TRTAB                                              
         MVC   P+75(ELEMLEN),WORK                                               
         BAS   RE,PRNT                                                          
         B     XIT                                                              
GETREC   NTR1                                                                   
         GET   IN,REC-4                                                         
...
OLDCNT   DC    PL5'0',CL20'NO NAME ELEM COUNT'    ADD 12/28/87                  
NEWCNT   DC    PL5'0',CL20'NEW  61 ELEM COUNT'    ADD 12/28/87                  
...
*&&                                                                             
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'051PUBPREM   05/01/02'                                      
         END                                                                    
