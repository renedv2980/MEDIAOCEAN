*          DATA SET DETCR0101  AT LEVEL 008 AS OF 03/18/15                      
*PHASE DETCR11A                                                                 
         TITLE 'DEMO CONVERSION'                                                
DETCR011 TITLE '- TCAR CONVERSION BEGUN 3/12/01'                                
...
READ41A  CLI   0(R5),X'FF'                                                      
         ...
         MVC   SVVCR,VWTVCR                                                     
*                                                                               
READ45   CLI   BOOKTYPE,C'T'       TEST BOOKTYPE                                
         BE    READ50                                                           
         B     READ20              ONLY DO VCR FOR TCAR                         
...
B0RTN    DS    0H                                                               
         USING B0REC,RC                                                         
         CLC   =C'TOTAL COMMERCIAL ACTIVITY',B0REPORT                           
         BE    *+6                                                              
         DC    H'0'                UNKNOWN FILE TYPE                            
*                                                                               
         MVC   TAPEMKT,=H'216' SET FOR TCAR                                     
...
*                                                                               
         ...
         DROP  R1                                                               
*                                                                               
P4RX20   MVC   INTKEY+23(2),INTPNUM   FOR PROPER SORT OF P'S AND Q'S            
         MVC   INTKEY+25(1),GAASW                                               
         B     EXIT                                                             
         EJECT                                                                  
*********************************************************************           
...
*********************************************************************           
*                                                                               
*ALLIGN1  EQU   (((*-DETCR011+4095)/4096)*4096)   ALLIGN AT 2000                
*         ORG   DETCR011+ALLIGN1                                                
                                                                                
CNVRTN   NMOD1 0,**CNVW**,RA,RR=RE                                              
         USING DEMCOND,R8          R8 = DEMCNV GLOBAL WORK                      
         USING WORKD,R4            R4 = DETCR011 WORK                           
*                                                                               
...
*ALLIGN2  EQU   (((*-DETCR011+4095)/4096)*4096)   ALLIGN AT 1000 BNDRY          
*         ORG   DETCR011+ALLIGN2                                                
WORKD    DS    0F                                                               
RELO     DS    A                                                                
...
K1797    DS    CL0004              NHWC6                                        
       ...
       ++INCLUDE DEDEMTABD                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008DETCR0101 03/18/15'                                      
         END                                                                    
