*          DATA SET REREP1H0J  AT LEVEL 061 AS OF 05/01/02                      
*PHASE RE1H02C,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
* ----------------------------------------------------------------- *           
* UPDATE HISTORY                                                    *           
*  SEP04/96 (BU ) --- KEY VS RECORD SWEEP                           *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
...
*                                                                               
         LA    RE,KEY                                                           
         XC    KEY,KEY                                                          
         MVI   KEY,X'01'           INSERT 1ST RECORD TYPE                       
...
*   TEST END                                                                    
*                                                                               
         CLC   KEY(27),RSALREC     COMPARE KEY AND RECORD                       
         BE    SW020020            OKAY - GO BACK FOR NEXT                      
         MVC   P+1(27),KEY                                                      
         MVC   P+32(27),RSALREC                                                 
         GOTO1 REPORT                                                           
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'061REREP1H0J 05/01/02'                                      
         END                                                                    
