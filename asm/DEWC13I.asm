*          DATA SET DEWC13I    AT LEVEL 058 AS OF 10/29/15                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEWC13IA                                                                 
         TITLE 'DEMO CONVERSION'                                                
***********************************************************************         
* THIS VERSION REPLACES DEWC09I BEGINNING WITH DATA FOR 8/27/12.                
* THE CHANGES ARE TO STORE THE AA DATA IN THE OLD GAA BREAKS 183 AND            
* 185. IF DATA PRIOR TO 8/27/12 NEEDS TO BE REPROCESSED, USE THE OLD            
* VERSION OF THE INPUT PHASE: DEWC09I.                                          
***********************************************************************         
DEWC13I TITLE '- WB1 COMMERCIAL (ACM) CONVERSION'                               
...
READ41A  CLI   0(R5),X'FF'                                                      
         ...
         MVC   SVVCR,VWTVCR                                                     
*&&DO                                                                           
* AS OF 8/27/12 WE ARE LOADING THE AA DATA, SINCE GAA IS NO LONGER              
* AVAILABLE. THE AA DATA HAS NON-VCR DATA, BUT WE WON'T BE LOADING IT.          
* DON'T NEED TO SEND AN EMAIL ANYMORE, JUST SKIP THE NON-VCT/I.E.               
* BOOKTYPE W.                                                                   
         CLI   SVVCR,C'1'          ANY NON-VCR DATA FOUND?                      
         BNE   *+8                                                              
         MVI   WBTYPFLG,C'Y'       YES. SEND EMAIL ABOUT BOOKTYPE 'W'           
*&&                                                                             
*                                                                               
...
MORET    DS    0H                                                               
*                                                                               
         CLI   WBTYPFLG,C'Y'       ANY DATA FOR BOOKTYPE 'W'?                   
         BNE   ENDJOB                                                           
...
WBTYPFLG DC    C'N'              ASSUME NO DATA FOR BOOKTYPE 'W'                
*                                                                               
WARNMSG1 DC    C'AUTONOTE*BPOON,DEISN: DATA FOR BOOKTYPE W WAS FOUND ON+        
                THE COMMERCIAL TCAR WB1 FILE'                                   
...
* *****************************                                                 
         LTORG                                                                  
*****                                                                           
* GAA BREAKS ARE NO LONGER AVAILABLE STARTING WITH 8/27/2012.                   
* STARTING WITH THIS DATE, THE AA BREAKS ARE STORED IN THE OLD GAA              
* BREAKS 183 AND 185.                                                           
*****                                                                           
AUDTYPE  DS    0XL2                                                             
*        DC    C'1',AL1(181)    AA        - AVAILABLE BUT NOT SUPPORTED         
*        DC    C'2',AL1(182)    GAA       - N/A STARTING 8/27/12                
*        DC    C'3',AL1(183)    GSA       - N/A                                 
         DC    C'4',AL1(183)    MULTI-BARTER AA                                 
***      DC    C'5',AL1(183)    MULTI-BARTER GAA - N/A STARTING 8/27/12         
         DC    C'6',AL1(185)    TPA AA                                          
***      DC    C'7',AL1(185)    TPA GAA   - N/A STARTING 8/27/12                
         DC    X'FF'                                                            
*                                                                               
         SPACE 4                                                                
**********************************************                                  
...
CNVRTN   NMOD1 0,**CNVW**                                                       
         ...
         USING WORKD,R4            R4 = DEWC13I WORK                            
*                                                                               
...
JDSCT    DSECT                                                                  
J0000    DS    0C                                                               
         ORG   *+0203              DISPLACEMENT TO DEMOS ON NIELSEN REC         
...
ZDSCT    DSECT                                                                  
       ...
       ++INCLUDE DEDEMTABD                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058DEWC13I   10/29/15'                                      
         END                                                                    
