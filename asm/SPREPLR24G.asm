*          DATA SET SPREPLR24G AT LEVEL 011 AS OF 05/01/02                      
...
SPLR8    MVC   PRVSTAT,SBSTAT                                                   
         CLC   SBKMKT(2),=X'0000'  IF SPILL MARKET IS 0                         
         BNE   SPLR7A                                                           
SPLR8A   CLC   NPRVSTAT,NBSTAT                                                  
         BNE   SPLR9                                                            
SPLR8B   BAS   RE,GETNSI                                                        
...
SPLR9    MVC   NPRVSTAT,NBSTAT                                                  
         CLC   NBKMKT(2),=X'0000'  IF SPILL MARKET IS 0                         
         BNE   SPLR8B                                                           
...
*                                                                               
         MVC   P+15(5),NBSTAT                                                   
         EDIT  (2,NBKMKT),(3,P+21),ZERO=NOBLANK                                 
         EDIT  (2,NBRMKT),(3,P+25),ZERO=NOBLANK                                 
         CLC   SBSTAT,NBSTAT                                                    
         BNE   NOTEQ_RP                                                         
         MVC   P(5),SBSTAT                                                      
         EDIT  (2,SBKMKT),(3,P+6),ZERO=NOBLANK                                  
         EDIT  (2,SBRMKT),(3,P+10),ZERO=NOBLANK                                 
NOTEQ_RP GOTO1 REPORT                                                           
         CLC   SBSTAT,NBSTAT                                                    
         BE    SPLR7                                                            
         B     SPLR8A                                                           
*                                                                               
...
NBNDXDA  DS    XL4                                                              
       ...
       ++INCLUDE SPREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011SPREPLR24G05/01/02'                                      
         END                                                                    
