*          DATA SET ACREP3102  AT LEVEL 010 AS OF 05/02/16                      
...
*  WAS PROMOTED USING THE SRCE LIBCODE VIA MR# 046747.      *                   
*                                                           *                   
...
AC102    ZIC   R1,1(,R2)                                                        
         ...
         BE    AC111                                                            
         CLI   0(R2),FFTELQ        FREE FORM ELEMENT X'DB'                      
         BE    AC111A                                                           
         CLI   0(R2),DUEELQ        DUE DATE ELEMENT X'61'                       
         BE    AC111B                                                           
         B     AC102                                                            
...
AC111A   DS    0H                                                               
         ...
         MVC   0(5,R3),=C'DOC#='                                                
         LA    R3,5(R3)                                                         
         ZIC   R1,FFTDLEN             GET LENGTH OF INVOICE #                   
         BCTR  R1,0                                                             
         EX    R1,*+4                                                           
         MVC   0(0,R3),FFTDATA        GET INVOICE NUMBER                        
         AHI   R1,1                                                             
         LA    R3,1(R1,R3)                                                      
         B     AC102                                                            
*                                                                               
...
AC111B   DS    0H                                                               
         MVC   0(4,R3),=C'DUE='                                                 
         LA    R3,4(R3)                                                         
         GOTO1 DATCON,DMCB,(2,DUEDATE),(21,0(R3))  MMMDD/YYYY                   
         LA    R3,10(R3)                                                        
         B     AC102                                                            
*                                  DISPLAY TAX INFO                             
...
AC172    MVC   PAGE,=H'1'                                                       
         ...
         GOTO1 LOGIO,DMCB,1,(30,P)                                              
         MVC   P(30),SPACES                                                     
         ZAP   DOUBLE,FORMACCS+24(8)                                            
         AP    DOUBLE,FORMACCS                                                  
         SP    DOUBLE,FORMACCS+8(8)                                             
         LA    R2,DOUBLE                                                        
         BAS   RE,LOGED                                                         
...
PRNTTRN2 L     R3,ADPRNTBC                                                      
         ...
         ZAP   FORMACCS+24(8),0(8,R2)                                           
         SP    FORMACCS+24(8),8(8,R2)                                           
         MVI   FORMSW,C'B'                                                      
         BAS   RE,FORMACC                                                       
*                                                                               
...
PRNTTRNG L     R4,AMONACC                                                       
         L     R2,ADACCSTA                                                      
         ZAP   FORMACCS+24(8),MACMABAL                                          
         CP    FORMACCS+24(8),=P'0' NO BALFWD IF ZERO                           
         BE    PRNTTRP2                                                         
...
PRNTTRP2 ZAP   FORMACCS+24(8),MACMABAL                                          
...
PRNTANLG B     EXIT                                                             
         EJECT ,                                                                
*---------------------------------------------------------------------*         
*        PRINT BBF FOR ANALYSIS CODE SUMMARY/CONTRA-ACCOUNT SUMMARY             
*---------------------------------------------------------------------*         
PRTBBF   NTR1                                                                   
         CP    LDGBLFWD,=P'0'      NO LEDGER B/F IF ZERO                        
         BE    PBBF10                                                           
...
*                                                                               
         ...
         BAS   RE,REPORT                                                        
*                                                                               
PBBF10   MVC   P+24(23),=C'BALANCE CARRIED FORWARD'                             
         CLI   PRTSW,C'N'                                                       
         BE    *+10                                                             
         MVC   P+24(23),=C'TOTAL CARRIED FORWARD  '                             
         ZAP   FORMACCS+24(8),LDGBLFWD                                          
...
EDIT1    NTR1                                                                   
         ZAP   THISNUM,DUB                                                      
         CURED (P8,THISNUM),(15,THISWORK),2,CR=YES,ZERO=BLANK                   
         MVI   THISWORK+15,C' '                                                 
         B     EDITOUT                                                          
*                                                                               
EDIT2    NTR1                                                                   
         ZAP   THISNUM,DUB                                                      
         CURED (P8,THISNUM),(15,THISWORK),2,MINUS=YES,ZERO=BLANK                
         MVI   THISWORK+15,C' '                                                 
         B     EDITOUT                                                          
*                                                                               
EDIT3    NTR1                                                                   
...
*                                                                               
         ...
         LA    R3,P+111            MAKE SURE MINUS SIGN                         
...
* ACCATKIND                                                                     
       ...
       ++INCLUDE ACCATKIND                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010ACREP3102 05/02/16'                                      
         END                                                                    
