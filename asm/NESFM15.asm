*          DATA SET NESFM15    AT LEVEL 079 AS OF 10/31/05                      
*PHASE T31C15A                                                                  
...
VK       DS    0H                                                               
         ...
         MVC   MYWORK+4(4),QNET                                                 
         MVI   MYWORK+8,C'N'                                                    
         GOTO1 VMSPACK,DMCB,MYWORK,MYWORK+4,MYWORK+10                           
...
DK       DS    0H                                                               
         ...
         GOTO1 VMSUNPK,DMCB,MYWORK,MYWORK+5,MYWORK+10                           
...
DOELEM   DS    0H                                                               
         ...
         GOTO1 (RF),DMCB,(R2),(2,PSNTAB),(0,PSNSEPS)                            
         CLI   DMCB+8,0                                                         
         BE    *+12                                                             
         MVI   ERROR,INVALID                                                    
         B     TRAPERR                                                          
         CLI   DMCB+4,2            NEED EXACTLY 2 COMPONENTS                    
         BE    *+12                                                             
         MVI   ERROR,MISSING                                                    
         B     TRAPERR                                                          
*                                                                               
         LA    R4,PSNTAB           PARSNIP TABLE                                
         USING PSND,R4                                                          
*                                                                               
         XC    ELEM,ELEM                                                        
         MVI   ELEM,X'02'                                                       
...
VR5      DS    0H                                                               
         MVC   NINDPRD,MYWORK                                                   
*                                                                               
         LA    R4,PSNL(R4)               GET INDEX (PARSNIP VALUE)              
*                                                                               
         TM    CNTRL,NINDCBRP      IF BRP'S DO DIFFERENT VALIDATION             
         BO    VR6                                                              
*                                  FOR BTI'S                                    
         TM    PSNSTAT,PSNNUMQ     MUST BE NUMERIC                              
         BO    *+12                                                             
         MVI   ERROR,NOTNUM                                                     
         B     TRAPERR                                                          
*                                                                               
         L     R0,PSNNUM           NUMERIC VALUE                                
         MVI   ERROR,INVALID                                                    
         C     R0,=F'255'                                                       
         BH    TRAPERR                                                          
         STC   R0,NINDIND                                                       
...
VR6      DS    0H                  FOR BRP'S                                    
         ZIC   R0,PSNLEN                                                        
         GOTO1 CASHVAL,DMCB,(1,PSNCOMP),(R0)                                    
         CLI   DMCB,0              TEST OK                                      
         BE    *+12                                                             
         MVI   ERROR,NOTNUM                                                     
         B     TRAPERR                                                          
...
VR9      DS    0H                                                               
         ...
         BNH   VR10                                                             
         CLI   5(R2),0             SKIP EMPTY SCREEN FIELDS                     
         BH    DOELEM                                                           
         B     VR9                                                              
*                                                                               
VR10     DS    0H                                                               
...
PROGREC  NTR1                                                                   
         ...
         B     EXIT                                                             
*                                                                               
PSNSEPS  DS    0X                  PARSNIP SEPARATORS                           
         DC    AL1(1),C'/'                                                      
         DC    AL1(1),C','                                                      
         DC    AL1(1),C','                                                      
         DC    AL1(1),C','                                                      
...
*                                                                               
         ...
         BO    DR11                                                             
*                                                                               
         EDIT  (B1,NINDIND),(4,1(R3)),ALIGN=LEFT                                
         B     DR12                                                             
*                                                                               
DR11     DS    0H                                                               
         EDIT  (B2,NINDBRP),(5,1(R3)),1,ALIGN=LEFT                              
*                                                                               
DR12     DS    0H                                                               
         FOUT  (R2)                                                             
         ZIC   R0,0(R2)                                                         
...
INDXREC  DSECT                                                                  
       ++INCLUDE NEGENIND                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'079NESFM15   10/31/05'                                      
         END                                                                    
