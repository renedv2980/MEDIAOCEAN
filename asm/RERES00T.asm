*          DATA SET RERES00T   AT LEVEL 008 AS OF 05/01/02                      
*PHASE T81900B,*                                                                
*INCLUDE GETKSRC                                                                
*INCLUDE KHDUMMY                                                                
...
STAT30   DS    0H                  NETWROK FILE STATION VALIDATION              
         ...
         MVI   DBSELSTA+3,C' '                                                  
*                                                                               
STAT32   CLC   SVSOURCE,C'D'       IF NAD PUT A 'PN' IN STAT+4                  
         BNE   STAT35                                                           
...
*                                   OV  RP                                      
         ...
         DC    X'03',AL1(08,12),X'F707000778',C'STST'    TITLES REPORT          
...
*                                   OV  RP                                      
         ...
         DC    X'03',AL1(07,12),X'F606000678',C'SDSD' DEMO MENU REPORT          
         DC    X'03',AL1(08,12),X'FD0D000D78',C'STST'    TITLES REPORT          
         DC    X'03',AL1(09,12),X'F808000978',C'SXSX'    MPR    REPORT          
         DC    X'03',AL1(09,12),X'F808000918',C'SXSX'    MPR - 2 COPIES         
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008RERES00T  05/01/02'                                      
         END                                                                    
