*          DATA SET RELD5S     AT LEVEL 017 AS OF 05/01/02                      
*PHASE RELD5S,*                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
*INCLUDE RECUP                                                                  
*INCLUDE HEXOUT                                                                 
         TITLE 'RELD5S - LOAD/DUMP MODEL EXTERNAL ROUTINE'                      
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*  NBC TEST FILE CONTRACT RECORD PURGE                            *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017RELD5S    05/01/02'                                      
         END                                                                    
