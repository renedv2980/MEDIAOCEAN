*          DATA SET ACLDXKEP   AT LEVEL 046 AS OF 09/02/99                      
*PHASE ACLDXKEP                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HELLO                                                                  
...
DMXREC   DS    0H                                                               
         ...
         USING TRNRECD,R4                                                       
DMXREC05 L     R4,AREC                                                          
         CLI   TRNKCPY,X'CD'       BE VERY CAREFUL                              
         BNE   DMXKEEP                                                          
         CLC   TRNKUNT(2),=CL2'SX'                                              
         BNE   DMXKEEP                                                          
*                                                                               
DMXREC30 DS    0H                                                               
         ...
         TM    TRNRSTAT,X'80'                                                   
         BZ    DMXKEEP                                                          
         TM    TRNRSTAT,X'40'      DRAFT                                        
         BO    DMXKEEP                                                          
         NI    TRNRSTAT,X'FF'-X'80'                                             
         BAS   RE,DMPGET           PRINT IT                                     
         LA    R4,TRNRFST                                                       
         USING TRNELD,R4                                                        
         CLI   TRNEL,X'44'                                                      
...
DMXEOF   DS    0H                                                               
         ...
         EDIT  (P8,TOTDR),(14,P+30)                                             
         EDIT  (P8,TOTCR),(14,P+55)                                             
         GOTO1 VPRINTER                                                         
         B     EXIT                                                             
         EJECT                                                                  
***********************************************************************         
...
* ACRECEQUS                                                                     
       ...
       ++INCLUDE ACRECEQUS                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'046ACLDXKEP  09/02/99'                                      
         END                                                                    
