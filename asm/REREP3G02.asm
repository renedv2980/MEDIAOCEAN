*          DATA SET REREP3G02  AT LEVEL 160 AS OF 02/13/03                      
*          DATA SET REREP3G02  AT LEVEL 109 AS OF 07/17/97                      
*PHASE RE3G02C,*                                                                
         TITLE 'RE3G02 - REREP3G02 - INTEREP INTERFACE TAPE'                    
**********************************************************************          
...
*                                                                   *           
* DEC08/97 (BU ) --- ADD 'TERRITORY' DATA TO FILE                   *           
*                                                                   *           
* JAN26/98 (JRD) --- 4K CONTRACTS                                   *           
*                                                                   *           
* JAN30/02 (BU ) --- CHECK RER IN 2F ELEMENT                        *           
*                                                                   *           
* MAR19/02 (BU ) --- ADD BOOKTYPE TO OUTPUT                         *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
...
**       MVC   ASATDT,MONACT+2                                                  
         MVC   ASATDT,COMPDT       SET AS-AT DATE TO ORIG AS-AT                 
*                                                                               
INIT20   EQU   *                                                                
...
*                                                                               
         LA    R1,RCONELEM         LOOK FOR EXTENDED DESCRIPTION ELEM?          
         SR    R0,R0                                                            
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(0,TTRANDT),(X'20',TTRANDT)                          
         MVC   TTYPE(2),SPACES                                                  
...
POST20   ICM   R0,1,1(R1)                                                       
         ...
         MVC   TDEMO,SPACES                                                     
         BNE   POST20                                                           
         CLI   RCONBBKT-RCONBPEL(R1),X'40'                                      
*                                       ANY BOOK TYPE ENTERED?                  
         BNH   POST25                   NO                                      
         MVC   TBLKHISP,RCONBBKT-RCONBPEL(R1)                                   
*                                       YES - MOVE TO RECORD                    
POST25   EQU   *                                                                
...
POST100  EQU   *                                                                
***>>>                                                                          
         LA    R1,RCONELEM         LOOK FOR EASI ELEMENT                        
         SR    R0,R0                                                            
POST105  ICM   R0,1,1(R1)          GET ELEMENT LENGTH                           
         BZ    POST0120            ZERO LENGTH - FINISHED                       
         AR    R1,R0                                                            
         CLI   0(R1),0             END OF RECORD?                               
         BE    POST0120            YES                                          
         CLI   0(R1),X'A2'         EASI CODE ELEMENT?                           
         BNE   POST105             NO  - GO BACK FOR NEXT                       
         USING RCONIEL,R1                                                       
*                                                                               
         MVC   TESTIMAT,RCONXEST   DEFAULT USING EXPANDED EST #                 
*                                                                               
         OC    TESTIMAT,SPACES     REPLACE BINARY ZEROS                         
         CLC   TESTIMAT,SPACES     ANY VALUE IN EXTENDED FIELD?                 
         BNE   POST0120            YES - USE IT                                 
         MVC   TESTIMAT(L'RCONIEST),RCONIEST                                    
*                                  NO  - USE ORIGINAL FORMAT                    
         OC    TESTIMAT,SPACES     REPLACE BINARY ZEROS                         
         DROP  R1                                                               
POST0120 EQU   *                                                                
*                                                                               
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(0,BRDDTS+6),(X'20',BRDDTS+6)                        
...
TBLKHISP DS    CL01           +184 BOOK TYPE FLAG                               
TESTIMAT DS    CL10           +185 ESTIMATE NUMBER                              
         DS    CL04           +195 SPARE                                        
...
RPTDGOOD EQU   *                                                                
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'160REREP3G02 02/13/03'                                      
         END                                                                    
