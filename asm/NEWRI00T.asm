*          DATA SET NEWRI00T   AT LEVEL 017 AS OF 05/01/02                      
*          DATA SET NEWRI00    AT LEVEL 063 AS OF 11/05/99                      
*PHASE T32000A                                                                  
*INCLUDE GETPROF                                                                
*INCLUDE KHDUMMY                                                                
...
T32000   CSECT                                                                  
         PRINT GEN                                                              
         NMOD1 LENWORK,**T32000,RR=R2,CLEAR=YES                                 
         PRINT NOGEN                                                            
         ST    R2,RELO                                                          
         LR    R6,R1                                                            
         L     RA,4(R6)          ATWA                                           
         ...
         USING GEND,RC                                                          
         LA    R9,IO                                                            
         AH    R9,=Y(LENIOAS)      2X3000 BYTE I/O AREAS+8 BYTES                
         USING NETSYSD,R9                                                       
         ST    R6,SYSPARMS                                                      
...
*                                  SET SYSTEM DEPENDENT VALUES                  
         ...
         MVI   MAXIOS,NIOS         USES 2 I/O AREA                              
         MVI   NTWA,1              N'SAVE STORAGE                               
         MVC   SIZEIO,=AL4(LIOS)   EACH I/O IS 3000 BYTES                       
...
***->    DC    X'03',AL1(13,12),X'E222002338',C'N5WN'   N5-PROD GOALS           
...
*              DDCOMFACS                                                        
       ...
       ++INCLUDE DDGENTWA                                                       
         PRINT ON                                                               
* SPACE TAKEN BY NEWRI00                                                        
*                                                                               
LENSPOOL EQU   SPOOLEND-SPOOLD       SPOOLD                                     
LENGEND  EQU   IO-GEND               GEND                                       
LENSYSD  EQU   NETSYSDX-NETSYSD      NETSYSD                                    
LENIOAS  EQU   NIOS*(LIOS+8)         IO AREAS                                   
LENNTBLK EQU   NBBLKEND-NETBLOCK     NETBLOCK                                   
LENDRVBK EQU   NDBLKX-NEDRVBLK       DRIVEBLOCK                                 
LENDRGEN EQU   DRINFEND-DRGEN        DRONEBLOCK                                 
LENSTLST EQU   2008               STATION LIST                                  
LENNBIO  EQU   1008               NETBLOCK IO                                   
NNBIO    EQU   7                  4 NETBLOCK I/O AREAS (ANETWS1 ETC)            
*                                 BUT WE NEED EXTRA BYTES SINCE SOME            
*                                 APPS USE MORE THAN THE 4K OF WS               
LENNBIOS EQU   NNBIO*LENNBIO      LENGTH OF ALL NETBLOCK IO AREAS               
*                                                                               
LENWORK  EQU   LENSPOOL+LENGEND+LENSYSD+LENIOAS+LENNTBLK+LENDRVBK+LENDR*        
               GEN+LENSTLST+LENNBIOS                                            
*                                                                               
NIOS     EQU   2                   2 IO AREAS                                   
LIOS     EQU   3000                3000 BYTE IO AREA                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017NEWRI00T  05/01/02'                                      
         END                                                                    
