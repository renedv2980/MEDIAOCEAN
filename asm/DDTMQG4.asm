*          DATA SET DDTMQG4    AT LEVEL 070 AS OF 05/01/02                      
DDTMQG4  TITLE 'MQSERIES TEST PROGRAM - BROWSE ONE MESSAGE'                     
*PHASE DDTMQG4A                                                                 
***********************************************************************         
*                                                                     *         
* MODULE NAME    : DDTMQG2                                            *         
...
WRITEREP DS    0H                                                               
         ...
         BCT   R8,*+8                                                           
         B     NEXTMSG                      GET THE NEXT MESSAGE                
         MVC   REP1_MSG,MSGCLEAR            Clear the message                   
         LA    R3,80(R3)                                                        
         SH    R5,=H'80'                                                        
         BP    WLIN010                                                          
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'070DDTMQG4   05/01/02'                                      
         END                                                                    
