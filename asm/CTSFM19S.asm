*          DATA SET CTSFM19S   AT LEVEL 038 AS OF 05/01/02                      
*PHASE TA0A19A                                                                  
*INCLUDE DECODE                                                                 
*                                                                               
***********************************************************************         
...
*  CALLS TO:    DATAMGR                                               *         
*                                                                     *         
*  INPUTS: SCREENS CTSFMDF (TA0ACA) -- MAINTENANCE                    *         
*                  CTSFMCF (TA0ADA) -- LIST                           *         
...
LR40     CLI   CTFXKTYP,CTFXEQU    X'09'                                        
         ...
         BNE   EXIT                                                             
*                                                                               
         CLI   SFMFAXC+5,0         FAX CODE ENTERED                             
         BE    *+14                                                             
         CLC   CTFXCODE,FAXCD      IF SO, TEST KEY MATCH                        
         BL    LR60                                                             
*                                                                               
...
*                                                                               
PR30     LA    R3,1                INITIALIZE COUNT OF LINES TO 1               
*                                                                               
         L     R4,AIO                                                           
         LA    R6,CTFX1EL          A(FIRST ELEMENT)                             
         USING CTFXMSG,R6                                                       
...
HEDSPECS SSPEC H1,1,AGYNAME                                                     
         ...
         SSPEC H2,121,PAGE                                                      
         SSPEC H7,2,C'CODE'                                                     
         SSPEC H7,10,C'FAX NUMBER'                                              
         SSPEC H7,27,C'ATTENTION/TELEPHONE'                                     
         SSPEC H7,53,C'COMMENTS'                                                
         DC    X'00'                                                            
         EJECT                                                                  
*                                                                               
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'038CTSFM19S  05/01/02'                                      
         END                                                                    
