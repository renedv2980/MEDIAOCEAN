*          DATA SET NEPUP21    AT LEVEL 007 AS OF 05/01/02                      
*          DATA SET NEPUP21    AT LEVEL 036 AS OF 03/11/99                      
...
*                                  SET NEW FIELD LENGTH                         
         LA    R1,8                MAX DPT NAME                                 
         LA    R2,15(R2)           BUMP TO END OF NAME                          
VREC1    CLI   0(R2),X'40'                                                      
         BH    VREC1B                                                           
         BCTR  R1,0                                                             
         BCTR  R2,0                                                             
...
VREC1B   CHI   R1,1                                                             
         BL    VREC1C              SKIP IT                                      
         STC   R1,PUPDPTH+5        SET NEW INPUT LENGTH                         
VREC1C   EQU   *                                                                
*                                                                               
         SPACE 1                                                                
         LA    R2,PUPPLANH         PLAN                                         
...
RQ16     LTR   R1,R1                                                            
         ...
         AH    R1,=H'1'                                                         
         SRA   R1,1                                                             
         EDIT  (R1),(7,0(R4)),FLOAT=$                                           
         SPACE 1                                                                
RQ17     EDIT  (4,0(R2)),(8,8(R4)),1                                            
         B     XIT                                                              
         EJECT                                                                  
...
DETTIMPS DS    F                                                                
       ...
       ++INCLUDE SPGENPROGA                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007NEPUP21   05/01/02'                                      
         END                                                                    
