*          DATA SET SPNWS20    AT LEVEL 137 AS OF 02/27/07                      
*PHASE T20720C,*                                                                
*INCLUDE KHDUMMY                                                                
...
********                                                                        
RDREC530 TM    OPTSW,COLONS       ONLY WANT TRANSFER LOCKOUTS?                  
         BZ    RDREC533                                                         
         TM    BWDINDS,BWDITRLK   DO WE HAVE A TRANSFER LOCKOUT?                
         BZ    RDREC560           ONLY WANT TRANSFER LOCKOUTS                   
********                                                                        
RDREC533 BAS   RE,GETRTG                                                        
...
*                                                                               
         USING SPWEL,R1                                                         
SKED14   LA    R2,SPWPERWK        POINT TO 1ST WEEK WE'RE REPORTING ON          
****     XR    RE,RE                                                            
****     IC    RE,INOSTDTD                                                      
****     AR    R2,RE                                                            
*                                                                               
...
****     AR    RE,R0                                                            
*                                                                               
         ZIC   R0,CMPNWKS         N'WEEKS = N'WEEKS IN CAMPAIGN                 
****     XR    RF,RF                                                            
****     IC    RF,INOSTDTD                                                      
****     SR    R0,RF                                                            
*                                                                               
         IC    RF,SPWELLN         N'WEEKS IN ELEMENT, WHICHEVER IS LESS         
...
****     SR    RF,R1                                                            
*                                                                               
         CR    R0,RF               MORE WEEKS THAN SPW ELEMENT HAS?             
         BNH   *+6                                                              
         LR    R0,RF                                                            
*&&DO                                                                           
...
***  2 DECIMAL                                                                  
         ST    R1,APPARM                                                        
         MVI   APPARM,C'N'         WE WANT DETAIL RECORD                        
...
*============================*                                                  
       ...
       ++INCLUDE FAFACTS                                                        
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'137SPNWS20   02/27/07'                                      
         END                                                                    
