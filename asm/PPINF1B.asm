*          DATA SET PPINF1B    AT LEVEL 020 AS OF 05/01/02                      
*PHASE T41A1BA,+0,NOAUTO       NOTE: "A" PHASE                                  
*                                                                               
* KWAN 05/99    CORRECT FILTER ERROR DISPLAY                                    
*                                                                               
         TITLE 'T41A1B   PRINTPAK  INFO  REGIONS'                               
T41A1B   CSECT                                                                  
         NMOD1 0,T41A1B                                                         
         USING FLDHDRD,R2                                                       
         L     RC,0(R1)                                                         
...
*                                                                               
         ...
         MVC   FLDDATA+1(16),=C'REGION CODE/NAME'                               
         MVC   FLDDATA+27(16),FLDDATA+1                                         
         MVC   FLDDATA+53(16),FLDDATA+1                                         
         FOUT  (R2)                                                             
         LA    R2,LINLEN(R2)                                                    
         MVC   FLDDATA+1(16),DASH                                               
         MVC   FLDDATA+27(16),DASH                                              
         MVC   FLDDATA+53(16),DASH                                              
         FOUT  (R2)                                                             
         LA    R2,LINLEN(R2)                                                    
         LA    R2,LINLEN(R2)                                                    
*                                                                               
