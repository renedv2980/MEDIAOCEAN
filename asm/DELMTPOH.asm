*          DATA SET DELMTPOH   AT LEVEL 056 AS OF 10/01/13                      
...
***********************************************************************         
         EJECT                                                                  
***********************************************************************         
*================TEMPORARY HUT/PUT BOOK TYPE CONVERSION===============*         
                                                                                
* CONVERTS REGULAR HUT/PUT BOOKTYPES INTO THEIR CORRESPNDING                    
* TEMPORARY BOOKTYPES                                                           
                                                                                
CNVBKTYP NTR1                                                                   
         LA    R3,CNVBKTAB                                                      
CNVBK20  CLI   0(R3),X'FF'         END OF TABLE                                 
         BE    CNVBKX                                                           
         CLC   INTBTYP,0(R3)                                                    
         BE    CNVBK30                                                          
         LA    R3,2(R3)                                                         
         B     CNVBK20                                                          
CNVBK30  MVC   INTBTYP,1(R3)       MOVE IN NEW HUT/PUT BOOK                     
*                                                                               
CNVBKX   DS    0H                                                               
         B     CNVX                                                             
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'056DELMTPOH  10/01/13'                                      
         END                                                                    
