*          DATA SET DEND10I    AT LEVEL 090 AS OF 07/30/20                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEND10IA                                                                 
         TITLE 'DEMO CONVERSION'                                                
DEND10I TITLE '- DEMO CONVERSION - NTI DAILIES'                                 
...
*                                                                               
         LA    RF,IN1              A(DCB)                                       
         L     R0,AIOERR           A(COMMON I/O ERROR ROUTINE)                  
         ST    R0,DCBSYNAD-IHADCB(,RF)  SAVE A(SYNAD ROUTINE) IN DCB            
*                                                                               
         OPEN  (IN1,(INPUT))                                                    
...
MISTOK   CLI   PASSDAY2,1          SECOND PASS                                  
         BNE   MISTOK1                                                          
         CLC   MISEQ,=C'02'        ALWAYS PROCESS INTAB RECORD EVEN             
         BE    MISTOK1             2ND PASS                                     
         CLC   MISTART,SVB0SD2                                                  
         BH    READ20                                                           
MISTOK1  DS    0C                                                               
...
PASSOK   DS    0C                                                               
*&&DO                                                                           
**  CREATE TEST DATE FOR FUTURE DATE BPOO                                       
         CLC   =C'160204',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160908'                                            
         CLC   =C'160205',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160909'                                            
         CLC   =C'160206',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160910'                                            
         CLC   =C'160207',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160911'                                            
         CLC   =C'160208',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160912'                                            
         CLC   =C'160209',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160913'                                            
         CLC   =C'160210',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160914'                                            
         CLC   =C'160211',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160915'                                            
         CLC   =C'160212',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160916'                                            
         CLC   =C'160213',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160917'                                            
         CLC   =C'160214',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160918'                                            
         CLC   =C'160215',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160919'                                            
         CLC   =C'160216',B0END+1                                               
         BNE   *+10                                                             
         MVC   B0END+1(6),=C'160920'                                            
*&&                                                                             
...
D4R03    DS    0H                                                               
         ...
         STC   R0,HALF             ***TEMP***                                   
*&&DO                                                                           
* TEST DATE FOR FUTURE DATE                                                     
*                                                                               
         CLC   =C'160204',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160908'                                            
         CLC   =C'160205',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160909'                                            
         CLC   =C'160206',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160910'                                            
         CLC   =C'160207',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160911'                                            
         CLC   =C'160208',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160912'                                            
         CLC   =C'160209',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160913'                                            
         CLC   =C'160210',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160914'                                            
         CLC   =C'160211',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160915'                                            
         CLC   =C'160212',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160916'                                            
         CLC   =C'160213',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160917'                                            
         CLC   =C'160214',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160918'                                            
         CLC   =C'160215',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160919'                                            
         CLC   =C'160216',D4END+1                                               
         BNE   *+10                                                             
         MVC   D4END+1(6),=C'160920'                                            
*&&                                                                             
...
*                                                                               
         ...
         CLI   D4DPT,C' '          FIRST CHAR. OF DAYPART IS VALID?             
         JNH   *+2                 NO: DATA MAY HAVE BEEN SHIFTED...            
*                                  ...TO THE RIGHT DUE TO UTF-8 CHARS.          
*                                  (SEE ITMF-48177 FOR MORE DETAILS)            
         MVC   PDPT2,D4DPT                                                      
...
*                                                                               
         ...
         ST    RE,VPHINT                                                        
*                                                                               
         MVC   SVPHACTD,VPHACTD                                                 
*                                                                               
*!!!     CLI   PASSDAY2,1          REMOVED (ITMF-11823)                         
*!!!     BNE   P4RX10                                                           
         BAS   RE,ANYINTAB                                                      
         BE    P4RX10                                                           
         L     RE,INTABADR                                                      
         MVC   VPHACTD,INTABDAY-INTABD(RE)  USE THE LATEST DAYS INTAB           
*                                                                               
P4RX10   GOTO1 VCALVPH,CALVPH                                                   
         MVC   VPHACTD,SVPHACTD    RESTORE                                      
         L     R7,AIREC                                                         
         USING K0000,R7                                                         
...
*                                                                               
ANYINTAB NTR1                                                                   
         LA    R6,CALVPH           SET CALVPH FIELDS                            
         USING CALVPHD,R6                                                       
         L     R2,VPHINT                                                        
         USING INTABD,R2                                                        
         XCEF                                                                   
ANYITB1  OC    INTABDAT,INTABDAT   END OF TABLE                                 
         BZ    ANYITBNO            NO INTAB FOR THIS DAY                        
         ZIC   RE,INTABDAY                                                      
         EX    RE,*+8                                                           
         B     *+8                                                              
         TM    VPHACTD,0           ** EXECUTED DAY CHECK**                      
         BO    ANYITBYS            OK                                           
ANYITB2  LA    R2,4+38*4(R2)       NO - CHECK THE NEXT ONE                      
         B     ANYITB1                                                          
ANYITBYS CR    RB,RB                                                            
         B     EXIT                                                             
ANYITBNO CR    RE,RB                                                            
...
GTIME7   DS    0H                                                               
         ...
         SR    R1,R1                                                            
*                                                                               
**GTIM10   CLI   0(R7),0       THIS LOOKS LIKE A BUG BECAUSE 6AM-00             
GTIM10   CLC   0(2,R7),=X'0000'                                                 
...
* THE FOLLOWING APPLIES TO NEW TOTAL DAY FORMAT                                 
         DC    CL12'MON LIVE    ',X'40'                                         
         DC    CL12'TUE LIVE    ',X'20'                                         
         DC    CL12'WED LIVE    ',X'10'                                         
         DC    CL12'THU LIVE    ',X'08'                                         
         DC    CL12'FRI LIVE    ',X'04'                                         
         DC    CL12'SAT LIVE    ',X'02'                                         
         DC    CL12'SUN LIVE    ',X'01'                                         
         DC    CL12'MON LIVE +SD',X'40'                                         
         DC    CL12'TUE LIVE +SD',X'20'                                         
         DC    CL12'WED LIVE +SD',X'10'                                         
         DC    CL12'THU LIVE +SD',X'08'                                         
         DC    CL12'FRI LIVE +SD',X'04'                                         
         DC    CL12'SAT LIVE +SD',X'02'                                         
         DC    CL12'SUN LIVE +SD',X'01'                                         
         DC    CL12'MON LIVE +3 ',X'40'                                         
         DC    CL12'TUE LIVE +3 ',X'20'                                         
         DC    CL12'WED LIVE +3 ',X'10'                                         
         DC    CL12'THU LIVE +3 ',X'08'                                         
         DC    CL12'FRI LIVE +3 ',X'04'                                         
         DC    CL12'SAT LIVE +3 ',X'02'                                         
         DC    CL12'SUN LIVE +3 ',X'01'                                         
         DC    CL12'MON LIVE +7 ',X'40'                                         
         DC    CL12'TUE LIVE +7 ',X'20'                                         
         DC    CL12'WED LIVE +7 ',X'10'                                         
         DC    CL12'THU LIVE +7 ',X'08'                                         
         DC    CL12'FRI LIVE +7 ',X'04'                                         
         DC    CL12'SAT LIVE +7 ',X'02'                                         
         DC    CL12'SUN LIVE +7 ',X'01'                                         
*                                                                               
         DC    X'FF'                                                            
*                                                                               
...
* DDCOMFACS                                                                     
       ...
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'090DEND10I   07/30/20'                                      
         END                                                                    
