*          DATA SET NEWRI1A    AT LEVEL 009 AS OF 05/01/02                      
*PHASE T3201AA                                                                  
         TITLE 'T3201A - EDIT FOR PRE-BUY REPORT 1 (BBDO)'                      
T3201A   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**OVED**,RR=R2                                                 
         L     RC,0(R1)                                                         
...
OPT10    CLC   12(3,R3),=C'PFB'    PFB OPTION                                   
         ...
         B     OPTNEXT                                                          
         SPACE 1                                                                
OPT12    CLC   12(3,R3),=C'ACT'    ACTUAL SCHEDULE OPTION                       
         BNE   OPT14                                                            
         MVI   ACTOPT,C'2'                                                      
         B     OPTNEXT                                                          
         SPACE 1                                                                
OPT14    CLC   12(3,R3),=C'V2 '    V2 IS ACT SCHED EST DEMOS                    
         BNE   OPT16                                                            
         MVI   ACTOPT,C'2'                                                      
         B     OPTNEXT                                                          
         SPACE 1                                                                
OPT16    CLC   12(3,R3),=C'V3 '    V3 IS ACT SCHED ACT DEMOS                    
         B     OPT18               *** V3 NOT ALLOWED NOW                       
         BNE   OPT18                                                            
         MVI   ACTOPT,C'3'                                                      
         B     OPTNEXT                                                          
         SPACE 1                                                                
...
*              OVERLAY SCREEN                                                   
       ...
       ++INCLUDE NEWRIFAD                                                       
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009NEWRI1A   05/01/02'                                      
         END                                                                    
