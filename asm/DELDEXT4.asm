*          DATA SET DELDEXT4   AT LEVEL 041 AS OF 11/19/98                      
*PHASE DELDEXT4,+0                                                              
*INCLUDE LOGIO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
DMX_A    CLI   0(R3),C'A'          'A' - RECDS?                                 
         BE    DMXSV               DON'T HAVE BOOK, KEEP THEM ALL               
*                                                                               
...
DMX_X    DS    0H                                                               
         B     DMXSV                                                            
*                                                                               
DMXKL    DS    0H                  DELETE RECORD                                
         B     DMXPURGE            DON'T PUT RECD ON THIS DEMFILE               
*                                                                               
DMXSV    L     R1,0(R2)            ADD RECD TO NEW DEMFILE                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'041DELDEXT4  11/19/98'                                      
         END                                                                    
