*          DATA SET DXESSVER   AT LEVEL 068 AS OF 03/09/03                      
...
APPCOPEN NTR1                                                                   
         ...
         MVC   APPCDATA+8(8),=CL8'HOSTESST'                                     
*        MVC   APPCDATA+8(8),=CL8'DMLO900V'                                     
         MVC   APPCDATA+16(8),=CL8'DDSLU62 '                                    
         MVC   APPCDATA+24(8),=CL8'ESSLUSND'                                    
...
*                                                                               
         ...
         MVC   ESSXLUID,=C'D1LOTS0V'                                            
         MVC   ESSXTPNA,=C'ESSLUSND'                                            
         MVC   ESSXVER,=C'VV'                                                   
         MVC   ESSXLEV,=C'LL'                                                   
