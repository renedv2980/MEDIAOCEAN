*          DATA SET NESFM40    AT LEVEL 051 AS OF 07/17/12                      
*PHASE T31C40A                                                                  
***********************************************************************         
*                                                                               
...
VK05     DS    0H                                                               
         GOTO1 VALICLT                                                          
*                                                                               
         MVC   QCLT,SFMCLT         GET CLIENT CODE                              
         OC    QCLT,SPACES                                                      
...
*                                                                               
VK08     DS    0H                                                               
         CLI   8(R2),C'N'          CAN'T HAVE A GROUP WITH N                    
         BE    INVLFLD                                                          
*                                                                               
         MVC   PRGKID,SFMID                                                     
         MVI   IDFILTER,C'Y'                                                    
...
*                                                                               
         ...
         GOTO1 CLUNPK,DMCB,(WORK2,PRGKCLT),SFMCLT                               
...
*                                                                               
         ...
         MVC   9(6,R6),PGRP4                                                    
         MVC   15(15,R6),PGRP6                                                  
         LA    RF,10               MAX 10 CLIENTS                               
*                                                                               
XU14     DS    0H                                                               
         XC    GROUP,GROUP                                                      
         LA    R1,GROUP            BUILD TABLE OF PGROUPS TO REMOVE             
         MVI   0(R1),X'FF'                                                      
*                                                                               
XU15     CLC   0(1,R6),SAVEKEY+5   IF PROD ALREADY ASSIGNED TO ANOTHER          
         BNE   XU17                GRP WITH SAME SCHEME, MOVE PROD              
         MVC   0(3,R1),0(R6)       TO THIS SCHEME                               
         XC    0(3,R6),0(R6)       CLEAR THIS FROM PGROUPTAB FOR REC            
         AHI   R1,3                                                             
         MVI   0(R1),X'FF'                                                      
         B     XU17                                                             
*                                                                               
...
XU18     DS    0H                                                               
         XC    TEMPTAB,TEMPTAB                                                  
         LA    R6,ELEM             COLLAPSE TABLE, REMOVE BLANK ENTRIES         
         LA    R1,TEMPTAB          AND ADD NEW PGROUP                           
         LA    RF,10                                                            
*                                                                               
XU18A    OC    0(3,R6),0(R6)                                                    
         BZ    *+14                                                             
         MVC   0(3,R1),0(R6)                                                    
         AHI   R1,3                                                             
*                                                                               
         ...
         BCT   RF,XU18A                                                         
*                                                                               
         LA    R1,TEMPTAB          FIND FIRST AVAILABLE ENTRY TO ADD            
         LA    RF,10               NEW PRD INTO GROUP TAB IN PRD REC            
*                                                                               
XU18B    OC    0(3,R1),0(R1)                                                    
         BZ    XU18C                                                            
         AHI   R1,3                                                             
         BCT   RF,XU18B                                                         
         B     PFULLERR            CLIENT FULL, NO ROOM TO ADD                  
*                                                                               
XU18C    MVC   0(3,R1),SAVEKEY+5   MOVE IN NEW PGROUP                           
*                                                                               
         XC    ELEM,ELEM                                                        
         MVC   ELEM(L'TEMPTAB),TEMPTAB                                          
*                                                                               
XU19     MVC   PGRP1(9),ELEM       RESTORE PGROUP ASSGNS                        
         MVC   PGRP4(6),ELEM+9     RESTORE PGROUP ASSGNS                        
         MVC   PGRP6(15),ELEM+15   RESTORE PGROUP ASSGNS                        
...
XU25     DS    0H                                                               
         LA    R4,GROUP                                                         
XU26     CLI   0(R4),X'FF'         ARE WE MOVING THE PRD FROM ONE GROUP         
         BE    XU30                TO ANOTHER?                                  
*                                                                               
         ...
         MVC   PRGPAGMD,SAVEKEY+2                                               
         MVC   PRGPCLT,SAVEKEY+3                                                
         MVC   PRGPID(3),0(R4)     MOVE IN GROUP                                
...
*                                  SEE IF ON FILE                               
         ...
         DC    H'0'                                                             
*                                                                               
XU27     AHI   R4,3                BUMP TO NEXT ENTRY IN GROUP TAB              
         B     XU26                                                             
*                                                                               
...
XD10     DS    0H                  VALIDATE PRD ON FILE                         
         ...
         MVC   PRGPID(3),SAVEKEY+5 GROUP ID                                     
*                                                                               
         NI    DMINBTS,X'FF'-X'08' DO NOT READ DELETED PASSIVES                 
         GOTO1 HIGH                                                             
*                                                                               
...
LR12     OC    SFMID,SFMID         FILTER ON ID???                              
         ...
         BE    LR13                                                             
*                                                                               
         TM    MYFLAG,FRSTLR       FIRST TIME THOURGH?                          
         BO    LR13                                                             
*                                                                               
...
*&&DO                                                                           
         ...
         GOTO1 VLMTDACC                                                         
*&&                                                                             
         GOTO1 VLMTDACC,DMCB,PRGKAGMD,PRGKCLT                                   
         CLI   DMCB+4,X'FF'                                                     
         BNE   LR14A                                                            
*                                                                               
         L     R3,AIO                                                           
...
*                                                                               
         MVC   LISTAR,SPACES                                                    
         GOTO1 CLUNPK,DMCB,(WORK2,PRGKCLT),PLCLT                                
...
PR14     DS    0H                                                               
         BAS   RE,CLT0J            CONVERT 0/J CLIENT CODE                      
*                                                                               
         GOTO1 CLUNPK,DMCB,(WORK2,PRGKCLT),H2+60                                
         MVC   H3+60(1),PRGKID                                                  
*                                                                               
PR15     DS    0H                                                               
         GOTO1 GETREC                                                           
...
SECURITY NTR1                                                                   
         ...
         BE    SEC35                                                            
         MVI   TERMINFO,C'Y'                                                    
         GOTO1 GETFACT,DMCB,0      GET TERMINAL INFO                            
         L     R1,DMCB                                                          
         USING FACTSD,R1                                                        
*                                                                               
...
SEC60    DS    0H                                                               
         ...
         BE    INVLACT                                                          
         B     SECEX                                                            
SEC80    CLI   ACTNUM,ACTDIS                                                    
         BE    SECEX                                                            
         CLI   ACTNUM,ACTREP                                                    
         BNE   INVLACT                                                          
*                                                                               
SECEX    MVC   DATADISP,=H'24'     RESET DATADISP FOR SPOT FILE                 
         B     EXIT                                                             
         EJECT                                                                  
*                                                                               
TRAPERR  GOTO1 ERREX                                                            
...
CLT0J    NTR1                                                                   
         ...
         USING CLTRECD,R6                                                       
*                                                                               
         MVC   CKEYAM,MYKEYSV+2    AGY/MD                                       
         MVC   CKEYCLT,MYKEYSV+3   CLIENT                                       
*                                                                               
         GOTO1 HIGH                                                             
         GOTO1 GETREC                                                           
*                                                                               
...
*                                                                               
         LA    RE,KEY                                                           
         USING PRGRECD,RE                                                       
         CLC   KEY(2),=X'0D01'     RECNUM IS 34, MUST BE CLIENT GROUP           
         BE    *+6                                                              
         DC    H'0'                                                             
         XC    PRGKGRP,PRGKGRP                                                  
         DROP  RE                                                               
...
SVRLINE  DS    CL132                                                            
MYFLAG   DS    XL1                                                              
FRSTLR   EQU   X'01'               FIRST TIME THROUGH LIST                      
         DS    0D                                                               
MYDMWRK  DS    CL96                                                             
TERMINFO DS    C                   Y/N                                          
MYKEYSV  DS    XL48                                                             
