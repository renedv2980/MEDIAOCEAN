*          DATA SET RELDBUGA   AT LEVEL 253 AS OF 05/01/02                      
*PHASE RELDBUG,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
*                                                                               
         ...
         USING RCONSEND,R5                                                      
*                                                                               
         CLI   RCONSNLN,RCONSN2Q                                                
         BNE   DMXKEEP                                                          
         OC    RCONS2D1(9),RCONS2D1                                             
         BZ    DMXKEEP                                                          
         DROP  R5                                                               
*                                                                               
         L     R5,AREC             POINT TO RECORD                              
         USING RCONREC,R5                                                       
         MVC   P(2),RCONKREP                                                    
         GOTO1 =V(HEXOUT),DMCB,RCONKCON,P+8,4                                   
         GOTO1 VPRINTER                                                         
*                                                                               
DMX100   DS    0H                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'253RELDBUGA  05/01/02'                                      
         END                                                                    
