*          DATA SET RECNT78    AT LEVEL 224 AS OF 10/02/03                      
*PHASE T80278A,*                                                                
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
*INCLUDE DAYUNPK                                                                
         TITLE 'T80278 - RECNT78 - JDS/2000 EC CHANGES'                         
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT78 --- JDS/2000 ELECTRONIC CONTRACT INTERFACE         *           
* ----------------------------------------------------------------- *           
* UPDATE HISTORY:                                                   *           
*                                                                   *           
...
*                                                                   *           
* 12MAY99 (JRD) --- EC CHANGE VERSION                               *           
*                                                                   *           
* 03JAN00 (BU ) --- MODIFY CREDIT PROCESSING                        *           
*                                                                   *           
* 23FEB00 (BU ) --- FIX MAKEGOOD PROCESSING                         *           
*                                                                   *           
* 11AUG00 (BU ) --- SET 'LOCAL' ACCORDING TO NEW MODELS             *           
*                                                                   *           
* SEP2700 (BU ) --- UPDATE MAKEGOOD SWITCH FLAGS                    *           
*                                                                   *           
* NOV20/00 (BU ) --- TRADE/AGENCY PROCESSING                        *           
*                                                                   *           
* MAR01/01 (BU ) --- ENCODA ROUTING                                 *           
*                                                                   *           
* APR05/01 (BU ) --- TRADE FLAG SETTING                             *           
*                                                                   *           
* MAY04/01 (BU ) --- PROGRAM NAME ADJUSTMENT OF COMMENTS            *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
...
T80278   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T80278*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
*                                                                               
         ...
         BNZ   EXXMOD                                                           
*                                                                               
         GOTO1 =A(PQOPENA),DMCB,(RC),(R8),STAOPTS,RR=YES                        
*                                  OPEN PRINT QUEUE                             
*                                  PASS IN A(STAOPTS) FOR ENCODA                
         TM    STAOPTS,X'10'       ENCODA ROUTING?                              
         BNO   MN100               NO                                           
         GOTO1 =A(EDICT),DMCB,(RC),(R8),RR=YES                                  
*                                  YES - CREATE EDICT HEADER CARDS              
*                                                                               
...
*                                                                               
         ...
         MVC   RC201TRD,RCONCJTF   INSERT TRADE FLAG                            
BLD10105 EQU   *                                                                
...
*                                                                               
BLD10140 EQU   *                                                                
*****    MVC   RC201EIX,SPACES     AGENCY ADV/PRD  NOT USED AT DDS              
*                                                                               
         PRINT GEN                                                              
...
*                                                                               
         MVI   RC203BIL,C' '       DEFAULT TO REGULAR BUY                       
         CLC   RBUYKMLN,RBUYKLIN   MASTER/DETAIL LINE SAME?                     
         BE    BLD30080            YES - REGULAR BUY                            
         MVI   RC203BIL,C'K'       SET MAKEGOOD FLAG                            
         OC    MGSPOTS,MGSPOTS     ANY SPOTS MISSED?                            
         BNZ   BLD30080            YES  -                                       
         MVI   RC203BIL,C'P'       SET ADDITION LINE IN SET                     
         EDIT  (B1,FIRSTMG),RC203MLN,FILL=0                                     
         MVC   RC203MKD,FIRSTMGD                                                
         B     BLD30090                                                         
*                                                                               
...
BLD30090 EQU   *                                                                
*                                                                               
         XC    MGSPOTS,MGSPOTS     CLEAR NUMBER OF SPOTS IN MG                  
*                                                                               
...
***                                                                             
*** NEW SPEC CALLS FOR ALWAYS SENDING 0                                         
***                                                                             
...
DTEINFO  NTR1                                                                   
         ...
         L     RE,TLSPOTS                                                       
         AR    RE,RF                                                            
         CLI   RC203BIL,C' '       REGULAR BUYLINE?                             
         BNE   DINF0004            NO  - MG OR REPLACEMENT - DON'T ADD          
...
DINF0004 EQU   *                                                                
         ...
         AR    RF,R1                                                            
         CLI   RC203BIL,C' '       REGULAR BUYLINE?                             
         BNE   DINF0006            NO  - MG OR REPLACEMENT - DON'T ADD          
         ST    RF,TOTALAMT                                                      
DINF0006 EQU   *                                                                
...
CHKD0040 EQU   *                                                                
*                                                                               
*   ALTERNATING WEEKS ARE NOT CHECKED FOR:  THIS CODE IS DEACTIVATED            
*                                                                               
...
CHKD0100 EQU   *                                                                
         ...
         AR    RE,RF                                                            
         CLI   RC203BIL,C' '       REGULAR BUYLINE?                             
         BNE   CHKD0104            NO  - MG OR REPLACEMENT - DON'T ADD          
         ST    RE,TLSPOTS                                                       
CHKD0104 EQU   *                                                                
         SR    R0,R0               USE SPOTS TO CALCULATE $$                    
         MVC   FULL,RBUYCOS        RATE FOR LINE                                
         ...
         AR    RF,R1                                                            
         CLI   RC203BIL,C' '       REGULAR BUYLINE?                             
         BNE   CHKD0106            NO  - MG OR REPLACEMENT - DON'T ADD          
         ST    RF,TOTALAMT                                                      
CHKD0106 EQU   *                                                                
         ZIC   RF,SVSPTSWK                                                      
         ZIC   R1,SPOTSWK                                                       
...
SAV203ID DS    CL22                FIRST 21 BYTES OF 103 REC                    
*                                     ID/REP/CON#/BUYLINE #                     
...
PRINTREC NTR1  BASE=*,LABEL=*                                                   
         ...
         CLC   =C'0203',RC203ID    BUY RECORD?                                  
         BNE   PREC0010            NO                                           
         OC    MGCOUNTR,MGCOUNTR   0203 = MAKEGOOD RECORD?                      
         BZ    PREC0010            NO                                           
         MVC   SAV203ID,RC203ID    YES - SAVE FIRST 22 BYTES                    
*                                                                               
*   TEST DUMP                                                                   
...
*--------------------------------------------------------------------           
*                                                                               
*   THIS ROUTINE BUILDS THE 207 RECORD FROM THE MAKEGOODS ENTERED               
*      BY THE CYCLEMKG ROUTINE                                                  
*                                                                               
*--------------------------------------------------------------------           
BLD07REC NMOD1 0,*BLD7*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         MVI   RC207REC,C' '       SPACE FILL THE RECORD                        
         MVC   RC207REC+1(RC207LEN-1),RC207REC                                  
         MVC   RC207REC(22),SAV203ID                                            
*                                  INSERT FIRST 21 BYTES FROM BUY REC           
         MVC   RC207REC(4),=C'0207'                                             
*                                  REPLACE RECORD ID                            
...
BLD70040 EQU   *                                                                
         ...
         MVI   RC207MCN,C'0'       SET 'ALL MISSED IN THIS RECORD'              
         C     R5,=F'17'           MORE THAN ONE RECORD REMAINING?              
         BNH   BLD70060            NO                                           
         MVI   RC207MCN,C'1'       YES - SET 'ANOTHER 107 FOLLOWS'              
BLD70060 EQU   *                                                                
...
*                                                                               
         ...
         TM    0(R7),X'10'         ENCODA ROUTING?                              
         BNO   VPQ25               NO                                           
         MVI   PLCLASS,C'G'        YES - CLASS G                                
VPQ25    EQU   *                                                                
         SPACE 1                                                                
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'224RECNT78   10/02/03'                                      
         END                                                                    
