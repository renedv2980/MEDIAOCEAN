*          DATA SET PRREQ00S   AT LEVEL 085 AS OF 06/21/99                      
*PHASE T41200A,+0                                                               
         TITLE 'CHANGE LOG'                                                     
*                                                                               
...
RT41     DC    AL1(RT41X-*+3,41,0)                                              
         ...
         DC    X'7905400107'          O Y=ACTIVE CLTS/PRDS ONLY                 
...
*OLD*    DC    X'028F060181'          O CLI=ALL/XXX/*N/&N                       
...
RT105    DC    AL1(RT105X-*+3,105,0)                                            
         ...
         DC    X'0204060181'            CLI=XXX                                 
         DC    X'100826'                STRD,ENDD=YYMMDD                        
         DC    X'CD05350181'          O START INVOICE#=NNNN                     
         DC    X'CE05390181'          O END INVOICE#=NNNN                       
         DC    X'39043F0181'            TEST RUN=Y,N                            
...
*                                                                               
       ...
       ++INCLUDE FAGETTXTD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'085PRREQ00S  06/21/99'                                      
         END                                                                    
