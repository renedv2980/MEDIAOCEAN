*          DATA SET REREP1H0E  AT LEVEL 030 AS OF 05/01/02                      
*PHASE RE1H02C,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
         TITLE 'REREP1H0E  - SALESPERSON KEY SWEEP     '                        
*********************************************************************           
*                                                                   *           
*        REREP1H0E   --- S/P SWEEP                                  *           
*                                                                   *           
...
*                                                                               
MDENTRY  EQU   *                                                                
         DC    AL1(REQFRST),AL3(SPSWP)   S/P SWEEP                              
*                                                                               
MDENTRYX EQU   *                                                                
...
*                                                                               
         ...
         MVI   KEY,X'AC'           REQUEST CONTRACT RECORD                      
         MVC   KEY+1(2),=C'IB'     SET FOR ABCRNY                               
...
CONY0030 EQU   *                                                                
**       GOTO1 GREC                                                             
         MVC   WORK(2),KEY+8       RESET KEY                                    
         MVC   WORK+2(1),KEY+7                                                  
**       CLC   =C'TK',WORK         'TAKEOVER' S/P?                              
**       BNE   CONY0010            NO  - DON'T DISPLAY                          
         CLI   KEY+8,C'T'          'TAKEOVER' S/P?                              
         BNE   CONY0010            NO                                           
         MVC   P+1(09),=C'TKO S/P :'                                            
         GOTO1 HEXOUT,DMCB,KEY+23,P+12,4,=C'TOG'                                
         MVC   P+24(3),WORK                                                     
         MVC   P+29(2),KEY+1       DISPLAY REP                                  
CONY0040 EQU   *                                                                
         GOTO1 REPORT                                                           
         L     RF,CHGCOUNT         INCREMENT COUNTER                            
         LA    RF,1(RF)                                                         
         ST    RF,CHGCOUNT                                                      
...
CONY0800 EQU   *                                                                
         ...
         GOTO1 REPORT                                                           
         MVC   P+1(11),=C'TKO S/P #S:'                                          
         EDIT  CHGCOUNT,(10,P+15)   DISPLAY TOTAL  COUNTER                      
         GOTO1 REPORT                                                           
         TIME  DEC                 RETRIEVE TIME: R0 AS HH:MM:SS:TT             
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'030REREP1H0E 05/01/02'                                      
         END                                                                    
