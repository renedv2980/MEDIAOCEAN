*          DATA SET ACREP8002S AT LEVEL 009 AS OF 05/01/02                      
*PHASE AC8002A,+0                                                               
         TITLE 'LIST REPORT'                                                    
AC8002   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         MVI   FORCEHED,C'Y'                                                    
         MVC   PAGE,=H'1'                                                       
         CLI   QOPT7,C'Y'          REQUEST FOR ALL COMPANIES                    
         BNE   EXIT                NO                                           
...
LST50    DS    0H                                                               
         L     RF,=F'600'                                                       
         GOTO1 CHOPPER,DMCB,LISTWRK,(30,CHOPAR),20,C'LEN=',(RF)                 
         L     R3,DMCB+8                                                        
         LA    R2,CHOPAR                                                        
...
LST60    CLI   MODE,RUNLAST                                                     
         ...
         CLI   QOPT7,C'Y'          IF REQUESTING MULTUPLE COMPANIES             
         BNE   EXIT                                                             
...
*        ACMASTD                                                                
       ...
       ++INCLUDE ACMASTD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009ACREP8002S05/01/02'                                      
         END                                                                    
