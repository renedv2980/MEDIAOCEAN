*          DATA SET SPREPR502  AT LEVEL 006 AS OF 05/01/02                      
*PHASE SPR502A,*                                                                
*INCLUDE COVAIL                                                                 
*INCLUDE DATVAL                                                                 
*INCLUDE HELLO                                                                  
...
RMYN0012 EQU   *                                                                
         ...
         CLC   QOPT3(2),0(RF)      REP IN REQUEST IN TABLE?                     
         BE    RMYN0014            YES                                          
         LA    RF,LREPTAB(RF)      NO  - BUMP TO NEXT SLOT                      
         B     RMYN0012            GO BACK FOR NEXT                             
RMYN0014 EQU   *                                                                
...
HEADIN   DC    X'00'                                                            
GOTDATA  DC    X'00'                                                            
REPTAB   DC    C'BL',X'11'         BLAIR                                        
LREPTAB  EQU   *-REPTAB                                                         
         DC    C'PV',X'61'         PETRY                                        
         DC    C'FN',X'81'         FOX                                          
         DC    C'K3',X'62'         KATZ RADIO                                   
         DC    C'IR',X'B2'         INTEREP                                      
         DC    C'V8',X'41'         PMC SPOT FILE                                
         DC    X'0000'             DELIMITER                                    
...
STAHDRD  DSECT                                                                  
       ...
       ++INCLUDE SPREPPTBUF                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006SPREPR502 05/01/02'                                      
         END                                                                    
