*          DATA SET RELFM05B   AT LEVEL 067 AS OF 05/01/02                      
*PHASE T80405A,+0                                                               
*INCLUDE REBKLST                                                                
...
*                                                                  *            
* MAR12/96 (SKU) --- SET REC2 TO REC2K TO AVOID RECORD OVERFLOW    *            
*                    ***  END TOMBSTONE  ***                       *            
********************************************************************            
T80405   CSECT                                                                  
         PRINT NOGEN                                                            
...
CHKDATE  NTR1                                                                   
         ...
         MVC   KEY(21),RINVREC                                                  
         LA    R4,REC2K                                                         
         ST    R4,AIOAREA          SET IOAREA FOR REC2K                         
         BAS   RE,HIGH                                                          
         B     INV230                                                           
         SPACE 1                                                                
INV210   BAS   RE,SEQ                                                           
...
ENDOLD   NTR1                                                                   
         ...
         SPACE 1                                                                
         LA    R4,REC2K            LOOK FOR ONE WITH NO END                     
         ST    R4,AIOAREA                                                       
         XC    KEY,KEY                                                          
         MVC   KEY(21),REC                                                      
         BAS   RE,HIGH                                                          
...
DATAR10  EQU   *                                                                
         ...
         SPACE                                                                  
DATAR12  EQU   *                                                                
         LA    R8,REC2K            REC2K+400 CONTAINS INVLIST                   
         LA    R8,400(R8)                                                       
         ST    R8,INVLIST                                                       
         LA    R8,WORK3                                                         
...
DATAR18  DS    0H                                                               
         ...
         GOTO1 VADDELEM,DMCB,(R4),WORK                                          
         SPACE                                                                  
         XC    REC2K(200),REC2K    BUILD TRANSFER FROM ELEMENT                  
         LA    RE,REC2K            SO DEMUP WILL HAVE FROM SRC/BOOK             
         USING RINVFREL,RE                                                      
         MVI   RINVFRCD,X'03'                                                   
         MVC   RINVFRST,DEMSTA                                                  
         MVC   RINVFRBK,INVSRC                                                  
...
FLPUT    TM    KEY+27,X'80'                                                     
         ...
         LA    RE,REC2K                                                         
         ST    RE,AIOAREA                                                       
         BAS   RE,GETREC           GET OLD RECORD IN REC2K                      
         SPACE 1                                                                
...
RINVD    DSECT                                                                  
       ...
       ++INCLUDE FATWA                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'067RELFM05B  05/01/02'                                      
         END                                                                    
