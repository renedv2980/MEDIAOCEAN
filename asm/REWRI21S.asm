*          DATA SET REWRI21S   AT LEVEL 250 AS OF 05/01/02                      
...
PREP1    CLC   KEY(22),KEYSAVE     SAME AGY?                                    
         ...
         BNE   PREP1C              NO  - PUT OUT RADIO STATION                  
...
STARECD  DSECT                                                                  
       ...
       ++INCLUDE REPIOBLK                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'250REWRI21S  05/01/02'                                      
         END                                                                    
