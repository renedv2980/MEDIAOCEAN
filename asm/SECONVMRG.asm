*          DATA SET SECONVMRG  AT LEVEL 016 AS OF 03/25/15                      
*PHASE SECMRGA                                                                  
*INCLUDE DMDMGRL                                                                
*INCLUDE DMUTLCT                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE CARDS                                                                  
*INCLUDE SORTER                                                                 
         TITLE 'SECMRG - SECURITY SYSTEM MERGE TWO AGENCIES INTO ONE'           
SECMRG   CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE WORKX-WORKD,**SECM**,RA,R8,WORK=A(WORKC),CLEAR=YES               
...
*                                                                               
         BAS   RE,BLDTABLE         READ CTFILE AND BUILD PASSWORD TABLE         
         BNE   MERR                  EXIT IF ERROR                              
*                                                                               
...
*                                                                               
         ZAP   LINE,=P'99'                                                      
         MVC   P,SPACES                                                         
         MVC   P(40),=CL40'OTHER DUPLICATED RECORDS'                            
         GOTO1 VPRINTER                                                         
         GOTO1 VPRINTER                                                         
*                                                                               
...
READCTFL NTR1  ,                                                                
         ZAP   LINE,=P'99'                                                      
         MVC   P,SPACES                                                         
         MVC   P(80),=CL80'SECURITY RECORD MERGE REPORT PASS 2'                 
         GOTO1 VPRINTER                                                         
         GOTO1 VPRINTER                                                         
*                                                                               
         MVI   WORK+00,C'N'        OPEN CONTROL FILE                            
...
CONVAS   EQU   *                                                                
         ...
         OC    SAASUID,SAASUID                                                  
         BNZ   CONV100                                                          
         MVC   P+30(20),=CL20'DROPPED'                                          
         GOTO1 VHEXOUT,PARM,(R2),P+40,25,=C'TOG'                                
         GOTO1 VPRINTER                                                         
         MVC   P,SPACES                                                         
         B     CONV14                                                           
*                                                                               
...
*        GOTO1 VPRINTER                                                         
         ...
         BE    CONV100                                                          
         MVC   P,SPACES                                                         
         MVC   P(40),=CL40'PERSON ID DUPLICATED:'                               
         MVC   P+22(2),SRCAGY1                                                  
...
CVPE010  EQU   *                                                                
         ...
         MVC   PIDSAVE,SAPEPID                                                  
         BAS   RE,GETPER                                                        
CVPE012  CLC   OFFSAVE,=CL2'ZE'                                                 
         BE    CVPE020                                                          
*&&US                                                                           
*        CLC   SAPEPID,=CL8'ACIAR   '                                           
*        BE    CVPE020                                                          
         CLC   SAPEPID,=CL8'DDS     '                                           
         BE    CVPE020                                                          
         CLC   SAPEPID,=CL8'DDSDDNY '                                           
         BE    CVPE020                                                          
*        CLC   SAPEPID,=CL8'DHUE    '                                           
*        BE    CVPE020                                                          
*        CLC   SAPEPID,=CL8'TEVER   '                                           
*        BE    CVPE020                                                          
         CLC   SAPEPID,=CL8'TESTDDNY'                                           
         BE    CVPE020                                                          
*&&                                                                             
*&&UK                                                                           
         CLC   SAPEPID,=CL8'DDSDDLO '                                           
         BE    CVPE020                                                          
         CLC   SAPEPID,=CL8'JOMUD3  '                                           
         BE    CVPE020                                                          
         CLC   SAPEPID,=CL8'JOMUNEW1'                                           
         BE    CVPE020                                                          
         CLC   SAPEPID,=CL8'JOMU1   '                                           
         BE    CVPE020                                                          
*&&                                                                             
         BAS   RE,LOADPID                                                       
         MVC   P,SPACES                                                         
...
CONVAG2  EQU   *                                                                
         ...
         OC    SAAGAGR,SAAGAGR                                                  
         BNZ   CONVAG3                                                          
         MVC   P+24(40),=CL40'MASTER GROUP RECORD DROPPED'                      
         GOTO1 VPRINTER                                                         
         B     CONV14                                                           
CONVAG3  EQU   *                                                                
*&&US                                                                           
         CLC   SAAGAGR,=CL8'SECMGR  '                                           
         BNE   *+10                                                             
         MVC   SAAGAGR,=CL8'BSECMGR '                                           
*&&                                                                             
*&&UK                                                                           
         CLC   SAAGAGR,=CL8'SECMGR  '                                           
         BNE   *+10                                                             
         ...
         CLC   SAAGAGR,=CL8'01      '                                           
         BNE   *+10                                                             
         MVC   SAAGAGR,=CL8'01D3    '                                           
*&&                                                                             
         MVC   P+30(10),=CL10'COPIED'                                           
         MVC   P+44(8),SAAGAGR                                                  
         GOTO1 VPRINTER                                                         
         MVC   SAAGAGY,SRCAGY1                                                  
         B     CONV100                                                          
...
CONVLA   EQU   *                                                                
         ...
         CLC   SALAAGY,MRGAGY1                                                  
         BE    CONVLA2                                                          
CONVLA1  GOTO1 VHEXOUT,PARM,(R2),P+24,25,=C'TOG'                                
         GOTO1 VPRINTER                                                         
         B     CONV100                                                          
CONVLA2  EQU   *                                                                
         BAS   RE,PUTSORT                                                       
         OC    SALAAGR,SALAAGR                                                  
         BZ    CONVLA3                                                          
         MVC   P+24(40),=CL40'MASTER LACCESS RECORD DROPPED'                    
         GOTO1 VPRINTER                                                         
         B     CONV14                                                           
CONVLA3  GOTO1 VHEXOUT,PARM,(R2),P+24,25,=C'TOG'                                
         GOTO1 VPRINTER                                                         
         MVC   SALAAGY,SRCAGY1                                                  
         B     CONV100                                                          
*                                                                               
...
CONVAP   EQU   *                                                                
         ...
         CLC   SAAPAGY,MRGAGY1                                                  
         BE    CONVAP2                                                          
CONVAP1  GOTO1 VHEXOUT,PARM,(R2),P+24,25,=C'TOG'                                
         GOTO1 VPRINTER                                                         
         B     CONV100                                                          
CONVAP2  EQU   *                                                                
         BAS   RE,PUTSORT                                                       
         OC    SAAPAGR,SAAPAGR                                                  
         BZ    CONVAP1                                                          
         MVC   P+24(20),=CL20'MASTER RECORD DROPPED'                            
         GOTO1 VPRINTER                                                         
         B     CONV14                                                           
CONVAP3  GOTO1 VHEXOUT,PARM,(R2),P+24,25,=C'TOG'                                
         GOTO1 VPRINTER                                                         
         MVC   SAAPAGY,SRCAGY1                                                  
         B     CONV100                                                          
*                                                                               
...
CONVAU1  EQU   *                                                                
         ...
         BZ    CONVAU3                                                          
         DC    H'0'                                                             
CONVAU2  MVC   P(20),=CL20'PASSWORD # RECORD: '                                 
         MVC   P+20(2),SA0KAGY                                                  
         CLC   SA0KAGY,MRGAGY1                                                  
         BE    CONVAU2A                                                         
         SR    RF,RF                                                            
...
*        GOTO1 VPRINTER                                                         
         ...
         BE    CONVAU2B                                                         
         MVC   P,SPACES                                                         
         MVC   P(40),=CL40'PASSWORD # PERSON DROPPED:'                          
         MVC   P+32(2),MRGAGY1                                                  
...
CONVAU2B EQU   *                                                                
         MVC   P,SPACES                                                         
         MVC   P(40),=CL40'PASSWORD # COPIED:'                                  
         MVC   P+32(2),MRGAGY1                                                  
         MVC   P+36(L'SAPEPID),PIDSAVE                                          
         GOTO1 VPRINTER                                                         
         B     CONV100                                                          
CONVAU3  MVC   P(20),=CL20'PASSWORD RECORD: '                                   
         MVC   P+20(2),SA0KAGY                                                  
         GOTO1 VHEXOUT,PARM,(R2),P+24,25,=C'TOG'                                
*        GOTO1 VPRINTER                                                         
         CLC   SA0KAGY,SRCAGY1                                                  
...
CONVAU32 EQU   *                                                                
         ...
         BE    CONVAU33                                                         
         MVC   P,SPACES                                                         
         MVC   P(40),=CL40'PASSWORD CODE PERSON DROPPED:'                       
         MVC   P+32(2),MRGAGY1                                                  
         MVC   P+36(L'SAPEPID),PIDSAVE                                          
         MVC   P+46(L'SA0KCODE),SA0KCODE                                        
         GOTO1 VPRINTER                                                         
         B     CONV14                                                           
CONVAU33 EQU   *                                                                
         MVC   P,SPACES                                                         
         MVC   P(40),=CL40'PASSWORD CODE COPIED:'                               
         MVC   P+32(2),MRGAGY1                                                  
         MVC   P+36(L'SAPEPID),PIDSAVE                                          
         MVC   P+46(L'SA0KCODE),SA0KCODE                                        
         GOTO1 VPRINTER                                                         
         B     CONV100                                                          
CONVAU4  MVC   P(20),=CL20'OLD AUTH RECORD: '                                   
         MVC   P+20(2),SA0KAGY                                                  
         GOTO1 VHEXOUT,PARM,(R2),P+24,25,=C'TOG'                                
         GOTO1 VPRINTER                                                         
         CLC   SA0KAGY,SRCAGY1                                                  
...
WORKC    CSECT                     ** WORKING STORAGE POOL 1 **                 
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016SECONVMRG 03/25/15'                                      
         END                                                                    
