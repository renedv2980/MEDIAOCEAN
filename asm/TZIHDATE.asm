*          DATA SET TZIHDATE   AT LEVEL 167 AS OF 09/25/00                      
*PHASE TZIHDATE                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE  CARDS                                                                 
*INCLUDE KHDUMMY                                                                
...
EPLOOP    DS    0H                                                              
*                                                                               
*OLD      CLC   VALUES(4),=F'0'     SEE IF ALL VALUES HAVE BEEN                 
          CLC   YEAR1,=F'0'         SEE IF ALL VALUES HAVE BEEN                 
          BE    ERROR               READ IN                                     
*OLD      CLC   VALUES+(4),=F'0'                                                
          CLC   DAY1,=F'0'                                                      
          BE    ERROR                                                           
*OLD      CLC   VALUES+12(4),=F'0'                                              
          CLC   YEAR2,=F'0'                                                     
          BE    ERROR                                                           
*OLD      CLC   VALUES+8(4),=F'0'                                               
          CLC   DAY2,=F'0'                                                      
          BE    ERROR                                                           
*                                                                               
          LA    R3,P                                                            
...
*                                                                               
*OLD      EDIT  VALUES+4,(4,P)                                                  
          EDIT  DAY1,(4,P)                                                      
          MVI   P+5,X'61'           INSERT SLASH                                
*OLD      EDIT  VALUES,(4,P+6),ALIGN=LEFT                                       
          EDIT  YEAR1,(4,P+6),ALIGN=LEFT                                        
*OLD      EDIT  VALUES+12,(4,P+13)                                              
          EDIT  DAY2,(4,P+13)                                                   
          MVI   P+17,X'61'          INSERT SLASH                                
*OLD      EDIT  VALUES+8,(4,P+18),ALIGN=LEFT                                    
          EDIT  YEAR2,(4,P+18),ALIGN=LEFT                                       
          L     RF,=V(PRINTER)                                                  
          BASR  RE,RF                                                           
*                                                                               
*OLD      MVC   FULL,VALUES         MOVE YEAR1,DAY1 INTO FULL,FULL2             
          MVC   FULL,YEAR1          MOVE YEAR1,DAY1 INTO FULL,FULL2             
*OLD      MVC   FULL2,VALUES+4                                                  
          MVC   FULL2,DAY1                                                      
          BAS   RE,CONVDAT          CONVERT DATE                                
          EDIT  FULL2,(2,OD1)                                                   
*OLD      EDIT  VALUES,(4,OY1),ALIGN=LEFT                                       
          EDIT  YEAR1,(4,OY1),ALIGN=LEFT                                        
          MVI   OSL1,C'/'                                                       
          MVC   OM1,WORK2                                                       
*                                                                               
*OLD      MVC   FULL,VALUES+8       MOVE YEAR1,DAY1 INTO FULL,FULL2             
          MVC   FULL,YEAR2          MOVE YEAR1,DAY1 INTO FULL,FULL2             
*OLD      MVC   FULL2,VALUES+12                                                 
          MVC   FULL2,DAY2                                                      
          BAS   RE,CONVDAT          CONVERT DATE                                
          EDIT  FULL2,(2,OD2)                                                   
*OLD      EDIT  VALUES+8,(4,OY2),ALIGN=LEFT                                     
          EDIT  YEAR2,(4,OY2),ALIGN=LEFT                                        
          MVI   OSL2,C'/'                                                       
          MVC   OM2,WORK2                                                       
*                                                                               
*OLD      MVC   FULL,VALUES+8                                                   
          MVC   FULL,YEAR2                                                      
*OLD      MVC   FULL2,VALUES+12                                                 
          MVC   FULL2,DAY2                                                      
...
*               R4,R5,R6 ARE USED                                               
          ...
          LA    R6,6                CHARACTER COUNTER                           
TOEQ      DS    0H                  GET TO EQUAL SIGN                           
          CLI   0(R5),C'='                                                      
          BE    EQ                                                              
          AHI   R5,1                                                            
          BCT   R6,TOEQ             IF MORE THAN 6 CHARACTERS READ, BUT         
          B     ERROR               NO '=' SIGN - THAT'S AN ERROR               
EQ        DS    0H                                                              
          AHI   R5,1                NOW R5 POINTS TO FIRST VALUE BYTE           
CMP       CLI   0(R5),C' '          WORK IS INITIALIZED TO SPACES, SO           
...
*                                                                               
          ...
          BNZ   NLEAP               IF DIVISIBLE, HAVE TO CHECK FOR 100         
          SR    R4,R4               LOAD YEAR NUMBER INTO R4,R5 AGAIN           
          L     R5,FULL                                                         
          LA    R6,100              DIVIDE BY 100                               
          DR    R4,R6                                                           
          LTR   R4,R4                                                           
          BZ    NLEAP               DIVISIBLE BY 100 - NOT LEAP                 
LEAP      DS    0H                                                              
          MVC   FULL,=F'366'                                                    
          B     ENDAYS                                                          
NLEAP     DS    0H                                                              
...
*                                                                               
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'167TZIHDATE  09/25/00'                                      
         END                                                                    
