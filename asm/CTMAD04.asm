*          DATA SET CTMAD04    AT LEVEL 049 AS OF 12/12/18                      
...
*  WAS PROMOTED USING THE SRCE LIBCODE VIA MR# 049348.      *                   
*                                                           *                   
...
*                                  R6 = A(FIRST SECTION LEAD ELEMENT)           
...
NEWDEMS  DS    16XL4               20 DEMOS                                     
OLDDEMS  DS    21XL4               20 DEMOS                                     
         EJECT                                                                  
* DEDBLOCK                                                                      
       ++INCLUDE DEDBLOCK                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'049CTMAD04   12/12/18'                                      
         END                                                                    
