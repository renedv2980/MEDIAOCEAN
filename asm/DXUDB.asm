*          DATA SET DXUDB      AT LEVEL 164 AS OF 09/05/02                      
*PHASE DXUDB                                                                    
*INCLUDE HEXOUT                                                                 
*INCLUDE DATCON                                                                 
*INCLUDE PRINT                                                                  
...
*        MEND                                                                   
         ENTRY DSNHLI                                                           
         NMOD1 WRKX-WRKD,**DXUDB*,RA,R9,R8,CLEAR=YES                            
         USING WRKD,RC                                                          
         L     R7,=A(DXUDBC)                                                    
         USING DXUDBC,R7                                                        
*                                                                               
...
*                                                                               
VINPERR5 EQU   *                                                                
         MVC   P(80),=CL80'COLUMNS SHOULD BE: '                                 
...
PDELOK   B     YES                                                              
         ...
         EJECT                                                                  
**********************************************************************          
* PROCESS SQL SELECT ACTION                                          *          
**********************************************************************          
PROCSEL  NTR1                                                                   
         BAS   RE,CLRSTMT                                                       
         L     R3,=A(STMTBUFF)                                                  
         LA    R3,2(R3)                                                         
         MVC   0(40,R3),=CL40'SELECT * FROM '                                   
         LA    R3,14(R3)                                                        
         ICM   R4,15,=AL4(STMTBLEN)                                             
         SHI   R4,14                                                            
         GOTO1 LOADTEXT,PARM,TABFNAME,L'TABFNAME,(R3),(R4)                      
...
**********************************************************************          
BLDCDSC  NTR1                                                                   
         MVC   P(80),=CL80'PROCESSING RECORD ID: '                              
...
*                                                                               
         ...
         BNE   ICAFERR1                                                         
*                                                                               
         MVC   P(80),=CL80'AFTER CONNECT TO DB2'                                
         GOTO1 DXUPRTL                                                          
         SPACE 1                                                                
*                                  OPEN DB2                                     
OPENREQ  DS    0H                                                               
...
*                                                                               
         ...
         BNE   ICAFERR2                                                         
*                                                                               
         MVC   P(80),=CL80'AFTER OPEN DB2 PLAN FOR DXUDB'                       
         GOTO1 DXUPRTL                                                          
*                                                                               
         B     ICAFOK                                                           
*                                                                               
...
**********************************************************************          
PSQLERR  NTR1                                                                   
         MVC   P(80),=CL80'SQL ERROR - RETURN CODE: HEX'                        
...
* FLDTYPE - SQL FIELD TYPE CODE                                      *          
**********************************************************************          
MERGEFLD NTR1                                                                   
         CLC   FLDTYPE,=YL2(484)  TEST FOR DECIMAL TYPE CODE                    
         BNE   MFLDOK                                                           
         OC    FLDLEN,FLDLEN                                                    
         BZ    MFLDOK                                                           
         L     R4,=A(WSSQLD)                                                    
         ...
         SR    RE,RE                                                            
         SR    R1,R1                                                            
         IC    RE,SQLLEN         LENGTH DECIMAL                                 
         IC    R1,SQLLEN+1       SCALE OF DECIMAL                               
         ICM   R5,15,SQLDATA     A(PACKED DECIMAL DATA)                         
*                                                                               
         MVC   MFINWORK,=CL16'0000000000000000'                                 
         MVC   MFOUWORK,=CL16'0000000000000000'                                 
         MVC   MFOUPW,=PL16'0'                                                  
         MVC   MFINPW,=PL16'0'                                                  
*                                                                               
         SR    RE,RE                                                            
...
*                                                                               
         ...
         BZ    *+8                                                              
         LA    RE,1(RE)                                                         
         ICM   RF,15,SQLDATA     A(PACKED DECIMAL DATA)                         
         AR    RF,RE                                                            
         BCTR  RF,0                                                             
         LA    R2,MFOUPW                                                        
         LA    R1,MFOUPW                                                        
...
MFLD034  EQU   *                                                                
*                                                                               
         AP    MFOUPW(16),MFINPW(16)                                            
*                                                                               
         UNPK  MFOUWORK(16),MFOUPW(16)                                          
*                                                                               
         MVC   BYTE,MFOUWORK+15                                                 
         NI    BYTE,X'F0'                                                       
         OI    MFOUWORK+15,X'F0'                                                
         SR    R1,R1                                                            
         LA    R1,L'MFOUWORK                                                    
...
*                                                                               
         GOTO1 DXUPRTL                                                          
         MVC   P(80),=CL80'SQL ERROR CODE: '                                    
         MVC   P+16(8),RCOUT                                                    
         GOTO1 DXUPRTL                                                          
*                                                                               
         MVC   P(80),=CL80'<<START OF SQLCA ERROR MESSAGE>>'                    
         GOTO1 DXUPRTL                                                          
         LA    R2,MESSAGE1                                                      
         SR    R3,R3                                                            
         ICM   R3,3,MESSAGEL                                                    
...
PMSG010  EQU   *                                                                
         ...
         BH    PMSG010                                                          
PMSG020  EQU   *                                                                
         MVC   P(80),=CL80'<<END OF SQLCA ERROR MESSAGE>>'                      
         GOTO1 DXUPRTL                                                          
*                                                                               
         XIT1                                                                   
         EJECT                                                                  
...
PRNTXREC NTR1                                                                   
         ...
         ICM   R2,3,0(R3)                                                       
         GOTO1 DXUPRTL                                                          
         MVC   P(80),=CL80'<<DXUDB INPUT RECORD REPORT>>'                       
         GOTO1 DXUPRTL                                                          
         MVC   P(80),=CL80'DXUDB INPUT RECORD LENGTH='                          
...
PRNTSTMT NTR1                                                                   
         ...
         ICM   R2,3,0(R3)                                                       
         GOTO1 DXUPRTL                                                          
         MVC   P(80),=CL80'<<DXUDB SQL STATEMENT REPORT>>'                      
         GOTO1 DXUPRTL                                                          
         MVC   P(80),=CL80'SQL STATEMENT LENGTH='                               
...
BADSSYS  DS    0H                  BAD DB2 SUB SYSTEM NAME IN OPEN              
         MVC   P(80),=CL80'DB2 SUB SYSTEM NAME IS INVALID'                      
         GOTO1 DXUPRTL                                                          
         B     ENDCCODE           WE ARE DONE. GO TO END OF CHEKCOD             
*        ********************* HUNT FOR 200 ***********************             
...
WASSAT   DS    0H                                                               
         MVC   P(80),=CL80'NON ZERO DB2 RETCODE=        /'                      
...
GETXID   NTR1  BASE=*                                                           
         ...
         USING STMTBUFF,R2                                                      
         BAS   RE,CLRSTMT                                                       
*        MVC   2(7,R2),=CL7'SELECT '                                            
*        MVC   9(15,R2),=CL15'FOR FETCH      '                                  
*        MVC   24(21,R2),=CL21'TABLENAME, INDEXNAME '                           
*        MVC   45(20,R2),=CL20'FROM DXCAUTH.RECORD '                            
*        MVC   65(17,R2),=CL17'WHERE RECORDID=? '                               
*        MVC   82(17,R2),=CL18'AND COUNTRYCODE=?'                               
         MVC   2(28,R2),=CL28'SELECT TABLENAME, INDEXNAME '                     
         MVC   30(20,R2),=CL20'FROM DXCAUTH.RECORD '                            
         MVC   50(17,R2),=CL17'WHERE RECORDID=? '                               
         MVC   67(25,R2),=CL25'AND COUNTRYCODE=?        '                       
         MVC   92(14,R2),=CL14'FOR FETCH ONLY'                                  
         LA    RF,106                                                           
         STCM  RF,3,STMTBUFF                                                    
         L     R3,=A(WSSQL)                                                     
         USING SQLDSECT,R3                                                      
...
GROW020  EQU   *                                                                
         MVC   SQLCODE,ZERO        CLEAR SQLCODE FOR ERROR CHECKING             
*                                                                               
         EXEC  SQL DECLARE CGROW CURSOR FOR STMTGROW                            
         CLC   SQLCODE,ZERO                                                     
         BNE   GROWERR2                                                         
*                                                                               
         EXEC  SQL PREPARE STMTGROW FROM :STMTBUFF                              
         CLC   SQLCODE,ZERO                                                     
         BNE   GROWERR3                                                         
*                                                                               
         EXEC  SQL DESCRIBE STMTGROW INTO :WSSQLD                               
         CLC   SQLCODE,ZERO                                                     
         BNE   GROWERR5                                                         
*                                                                               
         LH    RF,SQLD                                                          
...
GROW110  EQU   *                                                                
         ...
         BZ    GROW120                                                          
         SR    RE,RE                                                            
         CLC   SQLTYPE,=YL2(484)  TEST FOR DECIMAL TYPE CODE                    
         BNE   GROW112                                                          
         IC    RE,SQLLEN                                                        
         SRL   RE,1                                                             
         TM    SQLLEN,X'01'                                                     
...
*                                                                               
         ...
         BNE   GROWERR4                                                         
*                                                                               
         EXEC  SQL FETCH CGROW USING DESCRIPTOR :WSSQLD                         
*                                                                               
         BAS   RE,OUTCODE          GET SQL RETURN CODE                          
*                                                                               
         ST    RF,RETCODE          SAVE THE RETURN CODES                        
...
*                                                                               
         ...
         BNE   GROWERR1                                                         
*                                                                               
         EXEC  SQL CLOSE CGROW                                                  
         B     GROWOK                                                           
*                                                                               
GROWERR1 EQU   *                                                                
         EXEC  SQL CLOSE CGROW                                                  
         MVC   P(80),=CL80'GETROW ERROR 1'                                      
         GOTO1 DXUPRTL                                                          
         BAS   RE,PSQLERR                                                       
         BAS   RE,CALLTIAR                                                      
         BAS   RE,PRNTMSG                                                       
...
*        MVC   2(7,R2),=CL7'SELECT '                                            
*        MVC   9(15,R2),=CL15'FOR FETCH      '                                  
*        MVC   24(32,R2),=CL32'COLCOUNT FROM SYSIBM.SYSINDEXES '                
*        MVC   56(13,R2),=CL13'WHERE NAME=? '                                   
*        MVC   69(13,R2),=CL13'AND TBNAME=? '                                   
*        MVC   82(13,R2),=CL13'AND CREATOR=?'                                   
         MVC   2(39,R2),=CL39'SELECT COLCOUNT FROM SYSIBM.SYSINDEXES '          
         MVC   41(13,R2),=CL13'WHERE NAME=? '                                   
         MVC   54(13,R2),=CL13'AND TBNAME=? '                                   
         MVC   67(26,R2),=CL26'AND CREATOR=?             '                      
         MVC   93(14,R2),=CL14'FOR FETCH ONLY'                                  
         LA    RF,107                                                           
         STCM  RF,3,STMTBUFF                                                    
*                                                                               
         L     R3,=A(WSSQL)                                                     
...
GETXRC   NTR1                                                                   
         ...
         BAS   RE,CLRSTMT                                                       
         MVC   2(7,R2),=CL7'SELECT '                                            
   MVC 9(39,R2),=CL39'RECOVERYDATE, RECOVERYTIME, RECOVERYDA '                  
         MVC   48(20,R2),=CL20'FROM DXCAUTH.SOURCE '                            
         MVC   68(19,R2),=CL19'WHERE AGENCYCODE=? '                             
         MVC   87(13,R2),=CL13'AND SYSTEM=? '                                   
         MVC   101(16,R2),=CL16'AND SUBSYSTEM=? '                               
         MVC   116(14,R2),=CL14'FOR FETCH ONLY'                                 
         LA    RF,129                                                           
         STCM  RF,3,STMTBUFF                                                    
         L     R3,=A(WSSQL)                                                     
         USING SQLDSECT,R3                                                      
...
MERGEFLG DS    C                   MERGE CHANGE FIELDS FLAG                     
*                                                                               
...
*                                                                               
MFINWORK DS    CL16                MERGE FIELD INPUT WORK                       
MFOUWORK DS    CL16                MERGE FIELD OUTPUT WORK                      
MFINPW   DS    PL16                MERGE FIELD INPUT PACKED WORK                
MFOUPW   DS    PL16                MERGE FIELD OUTPUT PACKED WORK               
MFNEGFLG DS    CL1                 MERGE FIELD NEGATIVE FLAG                    
*                                                                               
...
*                                                                               
         CSECT                                                                  
         DS    0D                                                               
DATASQL  DS    CL4000              SQL DESCRIPTOR DATA AREA                     
*                                                                               
         CSECT                                                                  
         DS    0D                                                               
...
CDSCLQ   EQU   *-COLDSCD                                                        
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'164DXUDB     09/05/02'                                      
         END                                                                    
