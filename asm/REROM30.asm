*          DATA SET REROM30    AT LEVEL 203 AS OF 02/17/04                      
*PHASE T83F30B                                                                  
*INCLUDE REGENPBY                                                               
         TITLE 'T83F30 - REROM30 - DARE DRAFT REPORT'                           
***********************************************************************         
*                                                                     *         
*  REROM30 (T83F30) --- DARE DRAFT REPORT                             *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
* 10SEP03 HQ  CHANGE REPORT HEADER                                              
* 24DEC02 HQ  EXTRA HEADLINE FOR REDI                                 *         
* 18DEC02 SKU REDI SUPPORT                                            *         
...
PR60     DS    0H                                                               
         GOTOR PRPAGE1             ROUTINE STRIPPED FROM REROM24                
*&&DO                                                                           
...
*                                                                               
         GOTO1 VREGENDB,DMCB,(BYTE,PRBUYKEY),(32,LISTAREA),            X        
...
*                                                                               
PR185    DS    0H                                                               
         XC    H7(L'HEAD7),H7      BUY PRINTING DONE, CLEAR BUY HEADING         
         XC    H8(L'HEAD8),H8                                                   
...
*                                                                               
PRRJCM35 DS    0H                                                               
         MVC   P(36),=C'*** AGENCY COMMENTS FOLLOW ORDER ***'                   
         BAS   RE,PRINT                                                         
*                                                                               
PRRJCM40 DS    0H                                                               
...
PRTCON   NTR1                                                                   
* FIELD HEADINGS                                                                
         MVC   H7+PRRLBL-PRALBL(20),=C'---REP--- CONTRACT#:'                    
         MVC   H8+PRRLBL-PRALBL(6),=C'AGENCY'                                   
         MVC   H8+PRRLBL-PRALBL(11),=C'BUYER'                                   
         MVC   H9+50(3),=C'ADV'                                                 
         MVC   H9+50(7),=C'PRODUCT'                                             
         MVC   H10+50(3),=C'STA'                                                
         MVC   H10+50(7),=C'SALPRSN'                                            
         MVC   H11+50(5),=C'DATES'                                              
         MVC   H11+50(7),=C'DAYPART'                                            
         MVC   H12+50(3),=C'LEN'                                                
         MVC   H12+50(5),=C'DEMOS'                                              
         MVC   H13+50(4),=C'EST#'                                               
...
* CONTRACT NUMBER                                                               
         ZAP   WORK(5),=P'0'                                                    
         MVO   WORK(5),CCONKNUM                                                 
         EDIT  (P5,WORK),(8,H7+49),ALIGN=LEFT                                   
                                                                                
* DISPLAY AGENCY + AGENCY EXPANSION                                             
         MVC   H8+6(L'CCONKAGY),CCONKAGY                                        
         CLC   CCONKAOF,SPACES     OFFICE?                                      
         BE    PK10                                                             
         LA    RE,H8+6                                                          
         MVI   H8+10,C' '                                                       
...
PK10     DS    0H                                                               
         MVC   H8+15(20),EAGYNAM1                                               
                                                                                
* BUYER                                                                         
         MVC   H8+58(20),ECONBUYR                                               
                                                                                
* ADV                                                                           
         MVC   H9+6(4),CCONKADV                                                 
         MVC   H9+15(20),EADVNAME                                               
                                                                                
* PRODUCT                                                                       
         MVC   H9+58(3),CCONPRD                                                 
         OC    CCONPRD,CCONPRD                                                  
         BZ    *+14                                                             
         MVC   H9+62(20),EPRDNAME                                               
         B     *+10                                                             
         MVC   H9+58(20),EPRDNAME                                               
...
PK18     DS    0H                                                               
         ...
         MVC   H10+15(20),EMKTNAME                                              
                                                                                
* SALESPERSON                                                                   
         MVC   H10+58(3),CCONSAL                                                
         MVC   H10+62(2),CCONKOFF                                               
         MVC   H10+65(20),ESALNAME                                              
                                                                                
* START AND END DATES                                                           
         MVC   H11+6(17),ECONDATE                                               
         CLC   RTKODATE,CCONDAT                                                 
         BL    PK19                                                             
         GOTO1 DATCON,DMCB,(3,RTKODATE),(5,H11+6)                               
*                                                                               
* DAYPART                                                                       
PK19     DS    0H                                                               
...
PK80     CLI   1(R4),C'T'          FUDGE FOR DEMOCON                            
         ...
         GOTO1 DEMOCON,DMCB,(6,MYWORK),(9,H12+58),(0,DBLOCKD)                   
         DROP  R6                                                               
                                                                                
* ESTIMATE                                                                      
         MVC   H13+6(4),CCONIEST                                                
         CLC   CCONIEST,SPACES                                                  
         BNE   *+10                                                             
         MVC   H13+6(10),CCONXEST                                               
...
PRTREJCT NTR1                                                                   
         ...
         CLI   RDARBSTS,C'M'                                                    
         BNE   PRTREJ05                                                         
         MVC   P+4(22),=C'REP AMEND COMMENT:    '                               
*                                                                               
PRTREJ05 DS    0H                                                               
         BAS   RE,PRINT                                                         
*                                                                               
...
CTOTX    DS    0H                                                               
         ...
         XIT1                                                                   
*********************************************************************           
* GETSTAT : RETRIEVE THE STATUS OF THE ROM ORDER                                
*           LIFTED FROM REROM24                                                 
*********************************************************************           
...
GSTA0500 DS    0H                                                               
         ...
         LA    RF,DARPTR1                                                       
         CR    R1,RF                                                            
         BNL   GSTAX               NO NEED TO CHECK -S FLAG                     
*                                                                               
         TM    RDARFLG1,X'40'      -S?                                          
         BZ    GSTAX                                                            
*                                                                               
...
COMPCON  DS    CL4                 CONTRACT #(9/REV/COMP)                       
*                                                                               
*                                                                               
...
IMWORKQ  EQU   *-IMWORKD                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'203REROM30   02/17/04'                                      
         END                                                                    
