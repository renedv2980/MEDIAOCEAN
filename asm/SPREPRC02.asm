*          DATA SET SPREPRC02  AT LEVEL 015 AS OF 07/28/20                      
*PHASE SPRC02A                                                                  
*INCLUDE XSORT                                                                  
*INCLUDE PRNTBL                                                                 
***********************************************************************         
* A COPY OF SPREPUC02, BUT SPECIALLY TO HANDLE REPURPOSE                        
***********************************************************************         
SPRC02   TITLE 'SPREPRC02 - MULTI-AGENCY CABLE REPURPOSE'                       
SPRC02   CSECT                                                                  
         DS    8192C                                                            
         ORG   *-8192                                                           
         PRINT NOGEN                                                            
*                                  GOT 3 BASE REGISTERS                         
         NMOD1 0,SPRC02,R8,R7,RR=R3                                             
*                                                                               
         LR    RC,RB               SET UP MY WORK AREA                          
         AH    RC,=Y(SPRCWRKD-SPRC02)                                           
         USING SPRCWRKD,RC                                                      
*                                                                               
         L     RA,0(R1)                                                         
         USING SPWORKD,RA,R9                                                    
...
*                                                                               
         LARL  R6,RPURPLST                                                      
         LARL  R4,RPRPLSTX                                                      
         OPEN  (FILRPURP,INPUT)    OPEN UP REPURP FILE FOR LIST                 
RDREPURP XCEFL INPTLINE,4004       CLEAR THE INPUT LINE                         
         GET   FILRPURP,INPTLINE                                                
*                                                                               
         LA    R2,INPTDATA                                                      
         MVC   0(L'RPURPLST,R6),0(R2)  4 CHAR SYSCODE, LEADING 0'S              
         LA    R6,L'RPURPLST(R6)                                                
         CR    R6,R4                                                            
         JL    RDREPURP            OUT OF SPACE, INCREASE MAXRPURP              
         DC    H'0'                                                             
*                                                                               
ENDRPURP CLOSE FILRPURP            CLOSE REPURP FILE                            
*                                                                               
         CLI   QOPT4,C'Y'           SHOW REPURPS?                               
         JNE   ENDRPR10                                                         
         LARL  R6,RPURPLST                                                      
         LARL  R4,RPRPLSTX                                                      
ENDRPR00 OC    0(L'RPURPLST,R6),0(R6)                                           
         JZ    ENDRPR10                                                         
         MVC   P(4),0(R6)                                                       
         MVI   LINE,1                                                           
         GOTO1 REPORT                                                           
         ...
         J     ENDRPR00                                                         
*                                                                               
ENDRPR10 OPEN  (FILEIN,INPUT)      OPEN UP INPUT FILE FOR USE                   
*                                                                               
         ZAP   COUNTER1,=P'0'                                                   
         ZAP   COUNTER3,=P'0'                                                   
         ZAP   COUNTER4,=P'0'                                                   
...
PINFA112 MVC   PRVMRKT,SMKT                                                     
         ...
         BZ    PINFA126            NO                                           
*                                                                               
*** CHECK IF SYSCODE IS IN THE RPURPLST                                         
         LARL  RE,RPURPLST                                                      
         LARL  RF,RPRPLSTX                                                      
PINFA115 OC    0(L'RPURPLST,RE),0(RE)                                           
         JZ    PINFA120                                                         
         CLC   0(L'RPURPLST,RE),SVDHDEND                                        
         JE    PINFA123                                                         
         LA    RE,L'RPURPLST(RE)                                                
         CR    RE,RF                                                            
         JL    PINFA115                                                         
*                                                                               
PINFA120 BAS   RE,NOTINLST                                                      
         J     PINFA400                                                         
*** CHECK IF SYSCODE IS IN THE RPURPLST                                         
*                                                                               
PINFA123 DS    0H                                                               
****                                                                            
* THE COMMENTED CODE SHOULD NOT MATTER ANYMORE AS WE KNOW THE SYSCODE           
* HAS NO BUYS ON SPECTRA DS                                                     
*&&DO                                                                           
...
*                                  REPURPOSE DOES THE WHOLE THING               
         ...
         B     PINFA130                                                         
*                                                                               
PINFA126 CLI   SSYSDACT,X'FF'      DEACTIVATED ALREADY?                         
         BNE   PINFA130                                                         
         BAS   RE,DACTIVTD         YES, NO ACTIONS ALLOWED                      
         DROP  R6                                                               
*                                                                               
...
*                                                                               
         ...
         DROP  R6                                                               
*                                                                               
PINFA130 TM    ACTNFLG1,CDNTACTV   DEACTIVATE CABLE HEADEND?                    
         BZ    PINFA135                                                         
         TM    ACTNFLG1,CDNEWSYS                                                
         BNZ   PINFA135                                                         
         BAS   RE,DACTVATE         YES                                          
         ...
         B     PINFA180                                                         
*                                                                               
PINFA135 TM    ACTNFLG1,CDPAYADR   PAYABLE ADDRESS UPDATE?                      
         BZ    PINFA140                                                         
         BAS   RE,UPDADDRS         YES, UPDATE ADDRESS RECORD                   
         MVC   P+10(24),=CL24'CHANGING PAYABLE ADDRESS'                         
         GOTO1 REPORT                                                           
*                                  CHANGE TO STATION RECORD?                    
PINFA140 TM    ACTNFLG1,CDNETCHG+CDEXCLUS+CDSYSNAM+CDMSOINT+CDTPEADR            
         BNZ   PINFA143                                                         
         TM    ACTNFLG2,CDEIXSTA   ELECTRONIC INVOICING?                        
         BZ    PINFA146                                                         
PINFA143 BAS   RE,UPDSTATN         YES, UPDATE STATION RECORD                   
*                                                                               
         ...
         GOTO1 REPORT                                                           
*                                                                               
PINFA146 TM    ACTNFLG1,CDEXCLUS   EXCLUSITIVITY CHANGE                         
         BZ    PINFA150                                                         
         MVC   P+10(22),=CL22'CHANGING EXCLUSIVITY'                             
         GOTO1 REPORT                                                           
*                                                                               
PINFA150 TM    ACTNFLG1,CDSYSNAM   SYSTEM NAME CHANGE                           
         BZ    PINFA155                                                         
         MVC   P+10(20),=CL20'CHANGING SYSTEM NAME'                             
         GOTO1 REPORT                                                           
*                                                                               
PINFA155 TM    ACTNFLG2,CDEIXSTA   ELECTRONIC INVOICING CHANGE                  
         BZ    PINFA160                                                         
         MVC   P+10(29),=CL29'CHANGING ELECTRONIC INVOICING'                    
         GOTO1 REPORT                                                           
*                                                                               
PINFA160 TM    ACTNFLG1,CDTPEADR   ORDER DEADLINE CHANGE                        
         BZ    PINFA165                                                         
         MVC   P+10(24),=CL24'CHANGING ORDER DEADLINE'                          
         GOTO1 REPORT                                                           
*                                                                               
PINFA165 TM    ACTNFLG1,CDMSOINT   MSO AND INTERCONNECT NAME CHANGE?            
         BZ    PINFA170                                                         
...
*****                                                                           
PINFA200 DS    0H                                                               
         TM    ACTNFLG1,CDNEWSYS   ADDING THE SYSTEM?                           
         JNZ   PINFA250            YES                                          
         TM    ACTNFLG2,CDREPURP   REPURPOSING SYSCODE??                        
         JNZ   PINFA210            YES, TREAT IT AS ADDING A NEW SYSTEM         
         BAS   RE,NOSYSTEM         NO, NO SUCH SYSTEM                           
         B     PINFA400                                                         
*                                                                               
PINFA210 OI    ACTNFLG1,CDNEWSYS                                                
PINFA250 BAS   RE,NEWSYSTM         YES                                          
...
*                                                                               
NOTINLST DS    0H                                                               
         MVC   P+30(40),=CL40'!!!SYSCODE NOT IN REPURPOSE LIST!!!'              
         B     BADMSGS                                                          
*                                                                               
NOREPURP DS    0H                                                               
...
*                                                                               
         ...
         BE    CSTA10              YES, PASS IT BACK SO WE CAN RECREATE         
         CLI   DMCB+8,0                                                         
         JNE   *+2                                                              
*                                                                               
CSTA10   CLC   KEY(STAKEYLN),0(R6)                                              
...
*                                                                               
         CLI   QOPT1,C'Y'                                                       
         JNE   MKKPS13                                                          
         MVC   P(10),=CL10'  KEYSAVE:'                                          
         MVC   P+10(L'STAKEY),KEYSAVE                                           
         GOTO1 REPORT                                                           
         MVC   P(10),=CL10'      KEY:'                                          
         MVC   P+10(L'STAKEY),KEY                                               
         GOTO1 REPORT                                                           
*                                                                               
MKKPS13  CLC   KEY(L'STAKEY),KEYSAVE   "K" PASSIVE ALREADY THERE?               
         JNE   MKKPS15                                                          
         MVC   P(27),=C'SKIPPED K PASSIVE FOR: '                                
         MVC   P+27(4),SVDHDEND                                                 
         MVC   P+35(8),=C'NEW MKT='                                             
         EDIT  (B2,BMKT),(4,P+43),FILL=0                                        
         GOTO1 REPORT                                                           
*                                                                               
MKKPS15  BAS   RE,STAADD           YES                                          
         B     *+8                                                              
*                                                                               
...
***********************************************************************         
* VARIABLES AND STUFF                                                           
* KEEP THESE ACTIONS IN PLACE BECAUSE IT IS USED TO TRANVERSE THROUGH           
* THE BITS IN CODEFLG1 AND CODEFLG2.                                            
* TO COMMENT IT OUT, CHANGE THE AL1  TO  AL1(0)                                 
***********************************************************************         
CODTABLE DS    0XL2                                                             
         DC    C'D',AL1(0)             NEW SYSTEM                               
         DC    C'E',AL1(0)             PAYABLE ADDRESS CHANGE                   
         DC    C'F',AL1(0)             NETWORK CHANGE                           
         DC    C'G',AL1(0)             EXCLUSIVITY CHANGE                       
         DC    C'H',AL1(0)             SYSTEM NAME CHANGE                       
         DC    C'I',AL1(0)             MSO AND INTERCONNECT CHANGE              
         DC    C'J',AL1(0)             TAPE ADDRESS CHANGE                      
         DC    C'X',AL1(0)             SYSTEM DEACTIVATED                       
* FOR THE SECOND ACTION BYTE                                                    
         DC    C'B',AL1(0)             GROUP CODE CHANGE                        
         DC    C'K',AL1(0)             ELECTRONIC INVOICING STATION             
         DC    C'!',AL1(CDREPURP)      REPURPOSE (OVERWRITE)                    
         DC    X'00'                                                            
*                                                                               
YES      SR    RC,RC                                                            
NO       LTR   RC,RC                                                            
...
*                                                                               
         LTORG                                                                  
*                                                                               
FILRPURP DCB   DDNAME=CBLRPURP,MACRF=GM,DSORG=PS,RECFM=VB,             +        
               BLKSIZE=4096,LRECL=4004,EODAD=ENDRPURP                           
*                                                                               
FILEIN   DCB   DDNAME=CBLTEST,MACRF=GM,DSORG=PS,RECFM=VB,              +        
               BLKSIZE=4096,LRECL=4004,EODAD=NOMORE                             
*                                                                               
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE CTGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015SPREPRC02 07/28/20'                                      
         END                                                                    
