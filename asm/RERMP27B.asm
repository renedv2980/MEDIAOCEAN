*          DATA SET RERMP27B   AT LEVEL 234 AS OF 04/24/00                      
*PHASE T81027B                                                                  
*INCLUDE REGETKSRC                                                              
*INCLUDE RECUP                                                                  
...
*                                                                               
         ...
         BE    PR096                                                            
         CLI   RINVKSRC,X'00'      HEADER RECORD?                               
         BE    PR070                                                            
         CLI   RINVKSRC,X'FF'      RATIONALE RECORD?                            
         BE    PR070                                                            
...
*                                                                               
         ...
         XC    IBLOCK,IBLOCK                                                    
         XC    OBLOCK,OBLOCK                                                    
         MVC   IBLOCK+2(1),RINVKSRC                                             
         GOTO1 VGETKSRC,DMCB,(C'K',IBLOCK),OBLOCK                               
         CLI   DMCB+4,0          NO ERRORS?                                     
         BE    *+6                                                              
         DC    H'00'                                                            
*                                                                               
...
*                                                                               
PR065    CLC   0(1,RF),OBLOCK+4    SAME BOOKTYPE?                               
         BE    PR070                                                            
...
*                                                                               
         L     RF,ASVCTAB                                                       
PR092C   CLI   0(RF),XFF            IF END OF "KEY SOURCE" TABLE,               
         BE    PR092X                RECORD IS NOT A TRACK--PASS                
         CLC   RINVKSRC,2(RF)       IF KEY SOURCE IS FOUND,                     
         BE    PR055                 RECORD IS A TRACK--FAIL                    
         LA    RF,L'SVCLST(RF)                                                  
         B     PR092C                                                           
PR092X   EQU   *                                                                
*                                                                               
         ...
         CLI   RINVKSRC,XFF         TEST IF TEXT/RATIONALE RECORD               
         BE    PR055                 IT IS--FAIL                                
*                                                                               
...
PR200    DS    0H                                                               
         CLI   COUNTER,0           FOUND ANY "FROM" ENTRIES                     
         BE    PR440                                                            
*                                                                               
...
*                                                                               
PR260    DS    0H                  "FROM" ENTRY > "TO" RECORD                   
*                                                                               
         B     PR215                GET NEXT RECORD FROM FILE                   
         DROP  R4                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         LA    R2,1(R2,R1)                                                      
*                                                                               
         CLI   FTKSRC,0            CHECK IF "TO" RECORD IS A HEADER,            
         BE    PR360                                                            
...
PR440    DS    0H                                                               
         MVC   PLSTATUS,=CL16'NOT  COPIED   - '                                 
         MVC   PLCOMMNT,=CL23'NO FROM HEADERS FOUND'                            
*                                                                               
...
*                                                                               
CR02     DS    0H                                                               
         CLI   FTKSRC,C'M'          MASTER RECORD?                              
         BE    CR05                                                             
         CLI   FTKSRC,C'S'          STATION RECORD?                             
         BE    CR05                                                             
...
*                                                                               
         ...
         XC    OBLOCK,OBLOCK                                                    
         MVC   IBLOCK+2(1),FTKSRC                                               
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'K',IBLOCK),OBLOCK                               
*                                                                               
         OC    OBLOCK+4(1),OBLOCK+4      ANY BOOKTYPE?                          
         BZ    TBK029                                                           
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'234RERMP27B  04/24/00'                                      
         END                                                                    
