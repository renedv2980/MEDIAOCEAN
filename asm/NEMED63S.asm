*          DATA SET NEMED63S   AT LEVEL 049 AS OF 05/01/02                      
*PHASE T31E63A,+0                                                               
...
*                                                                               
         L     R3,AIO                                                           
         USING NPGKEY,R3                                                        
         MVC   P(6),NPGKPROG       PROGRAM CODE                                 
         CLI   ELEM93,C'Y'                                                      
         BNE   FORM0                                                            
         MVI   P1+33,C'*'          ***TEMP***                                   
         GOTO1 DATCON,DMCB,(2,NPG2STD),(8,P1+24) START DATE                     
FORM0    GOTO1 DATCON,DMCB,(2,NPGKEND),(8,P2+24) END DATE                       
         DROP  R3                                                               
*                                                                               
         MVC   P+7(16),NPGNAME     PROGRAM NAME                                 
         GOTO1 UNDAY,DMCB,NPGDAY,P2+7 DAY                                       
         DS    0H                                                               
         CLI   NPGROT,0                                                         
         BE    SKIPUND                                                          
         GOTO1 UNDAY,DMCB,NPGROT,P3+7 DAY                                       
         DS    0H                                                               
SKIPUND  GOTO1 UNTIME,DMCB,NPGTIME,P2+11 TIME                                   
         DS    0H                                                               
         EDIT  (2,NPGSHARE),(4,P3+24),1 SHR OR RTG                              
         MVI   P3+28,C'R'                                                       
         TM    NPGSTAT,X'80'                                                    
         BO    *+10                                                             
         MVC   P3+26(4),SPACES                                                  
         OC    NPGCOST,NPGCOST                                                  
         BZ    FORM1                                                            
         EDIT  (4,NPGCOST),(8,P4+24),ALIGN=LEFT,FLOAT=$ COST                    
         SPACE 2                                                                
FORM1    XC    FULL,FULL                                                        
         MVC   FULL+2(2),NPGPPNO                                                
         EDIT  (4,FULL),(5,P3+32),ZERO=BLANK NTI CODE                           
         CLI   ELEM93,C'Y'                                                      
         BNE   *+10                                                             
         MVC   P4+33(1),NPG2DYP    DAYPART                                      
...
FORM3    MVI   SPACING,2                                                        
         ...
         L     R3,AIO                                                           
         L     R5,=F'450'          MAX NUMBER OF STATIONS                       
...
NETNAME  DS    CL4                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'049NEMED63S  05/01/02'                                      
         END                                                                    
