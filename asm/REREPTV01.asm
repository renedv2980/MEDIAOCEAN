*          DATA SET REREPTV01  AT LEVEL 010 AS OF 11/16/95                      
*PHASE RETV01A,*                                                                
         TITLE 'SPECS FOR NEW REP FILE EXTRACT/CREATION'                        
*                                                                               
*- REREPTV01 -- PHASE RETV01 -- SPECS MODULE FOR REP EXTRACT/CREATION           
*                                                                               
*  MOD LOG                                                                      
*  -------                                                                      
*  10/04/94 SKU NEW                                                             
...
RETV01   CSECT                                                                  
         ...
         SPROG 2                                                                
         ASPEC H1,2,RUN                                                         
         ASPEC H1,39,C'REP TV FILE EXTRACT FACILITY'                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010REREPTV01 11/16/95'                                      
         END                                                                    
