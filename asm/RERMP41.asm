*          DATA SET RERMP41    AT LEVEL 026 AS OF 04/02/14                      
...
* -------- --- ----   ------------------------------------------------*         
* JUN09/09     BOBY - DROP DECIMAL FROM DISPLAY OF LARGE DEMOS        *         
*                                                                     *         
* APR20/09     SKUI - SUPPORT NEW INVENTORY KEY                       *         
*                                                                     *         
* MAY15/08 XXX SKUI - 2-CHAR BOOKTYPE SUPPORT                         *         
*                                                                     *         
* Sep30/03 xxx buhr - change MFX DUPLICATE error message return       *         
*                     when NO BOOKS                                   *         
*                                                                     *         
* Sep29/03 xxx JDON - fix zic of QLFKYTBQ from OS                     *         
*                     and goto1 with equates to al1                   *         
*                                                                     *         
...
*                                                                               
         ...
         BZ    INVLFLD                                                          
*                                                                               
*   FORMERLY BRANCHED TO 'VK059' -> MFX DUPLICATE MESSAGE                       
*                                                                               
         STC   R1,5(R2)                                                         
         BCTR  R1,0                                                             
...
VK045    DS    0H                                                               
         XC    DUB,DUB                                                          
         GOTO1 BOOKVAL,DMCB,(R2),(=AL1(MXTKLNTY),WORK),(C'B',SCANNER), X        
               DUB,(C'C',ACOMFACS)                                              
         CLI   DMCB+4,0            IF INVALID,                                  
         BNE   VK045X                                                           
                                                                                
         DS    0H                   TRY DEFAULT TO NSI                          
         GOTO1 (RF),DMCB,(C'N',(R2)),(=AL1(MXTKLNTY),WORK),            X        
               (C'B',SCANNER),DUB                                               
         CLI   DMCB+4,0                                                         
         BE    INVLFLD                                                          
VK045X   EQU   *                                                                
...
*                                                                               
         ...
         LA    R6,MDTDIIVK                                                      
*                                                                               
         MVC   TMPRSR,(RINVKRSR-RINVKEY)(R6)                                    
         MVC   TMPQLF,(RINVKQLF-RINVKEY)(R6)                                    
         MVC   TMPBTYP,(RINVKBTP-RINVKEY)(R6)                                   
*                                                                               
******   MVI   GOSUBN,RKS#                                                      
...
TRSLTBK  DS    0H                                                               
         ...
         MVC   WORK,SPACES         INITIALIZATION                               
         LA    R2,WORK                                                          
...
*                                                                               
         CLI   DUB+1,0             FORMAT BOOK VALUE                            
         BNE   TBK035              SKIP IF MONTH PRESENT                        
*                                                                               
         MVC   0(2,R2),=C'ST'       BOOK IS EST/YR                              
         LA    R2,2(R2)                                                         
         ZIC   R1,DUB                                                           
...
*                                                                               
         ...
         LA    R2,6(R2)            BUMP OUTPUT POINTER                          
*                                                                               
TBK039   EQU   *                                                                
*                                                                               
         DS    0H                  FORMAT BOOKTYPE                              
         CLI   TMPBTYP,0           SKIP IF NO BOOKTYPE                          
         BE    TBK049                                                           
*                                                                               
...
*                                                                               
         ...
         XC    TMPKBK,TMPKBK                                                    
*                                                                               
         MVI   GOSUBN,BIK#         BUILD SKELETON INV KEY                       
         GOTO1 AGOSUB                                                           
                                                                                
*                                                                               
         GOTO1 HIGH                READ FOR FIRST TRACK/HEADER                  
         B     BTL025                                                           
...
*                                                                               
BTL025   DS    0H                                                               
         CLC   KEY(IKYSTDL),KEYSAVE MATCH ON EFFECTIVE DATE                     
         BNE   BTL200                                                           
                                                                                
         DS    0H                  DECIPHER KEY SOURCE                          
INVKEYD  USING RINVKEY,KEY                                                      
*                                                                               
         MVC   TMPFRBTS,INVKEYD.RINVKQLF                                        
         MVC   TMPBTYP,INVKEYD.RINVKBTP                                         
*                                                                               
         MVI   GOSUBN,RKS#                                                      
         GOTO1 AGOSUB                                                           
*                                                                               
         CLI   INVKEYD.RINVKRSR,C'N'                                            
...
*                                                                               
         ...
         MVC   BINTKSRC,TMPRSR       BINKEY: RATING SERVICE                     
...
*                                                                               
         ...
         MVC   TMPQLF,BINTKTQK     TRACK QUALIFIER                              
         MVC   TMPQLFK,BINTKTQK    TRACK QUALIFIER                              
         MVC   TMPFRBTS,BINTKTQK   TRACK BOOKVAL BITS                           
...
*   TMPBTYP  = book type.                                                       
* At exit,                                                                      
*   TMPRSR  = RATING SOURCE                                                     
*   TMPQLFY  = QUALIFIER EXTERNAL                                               
*   TMPBTYP = BOOK TYPE                                                         
*   CC SET TO EQUAL IF FOUND,                                                   
...
*                                                                               
         ...
         BNE   GKSXN                                                            
*                                                                               
         MVC   TMPRSR,GKSOPARM+(GKSPRSVC-GKSPARMD)                              
         MVC   TMPQLFY,GKSOPARM+(GKSPQLFY-GKSPARMD)                             
         MVC   TMPQLFK,TMPFRBTS                                                 
         MVC   TMPQLF,TMPFRBTS                                                  
*                                                                               
         B     GKSXY                                                            
...
*   TMPQLF    = internal key code for qualifier.                                
...
*                                                                               
         ...
         USING GKSPARMD,R3                                                      
*                                                                               
         MVC   TMPRSR,GKSPRSVC      RETURN: RATING SOURCE                       
         MVC   TMPSRC(1),GKSPRSVC   RETURN: RATING SERVICE                      
         MVC   TMPQLFY,GKSPQLFY     RETURN: TRACK QUALIFIER                     
         MVC   TMPQLFK,TMPFRBTS     RETURN: TRACK QUALIFIER                     
         MVC   TMPQLF,TMPFRBTS      RETURN: TRACK QUALIFIER                     
*                                                                               
         DROP  R3                                                               
*                                                                               
         B     RKSXY               ALL DONE                                     
...
*                                                                               
         ...
         LA    RF,8(RF)                                                         
         STC   RF,MYFLDH+0                                                      
         GOTO1 BOOKVAL,DMCB,(GKSPRSVC,MYFLD),(1,DUB),SCANNER,0,        X        
               (C'C',ACOMFACS)                                                  
         CLI   DMCB+4,1                                                         
         BNE   RKSXN                                                            
...
CPRT086P EQU   *                                                                
         ...
         SR    R0,R0                                                            
         EX    0,0(RF)             SET FIELD PROTECTION                         
...
DSPLYCOL DS    0H                                                               
*                                                                               
         USING MDPLYTBD,R4         ESTABLISH MSTER DISPLAY TBL ENTRY            
*                                                                               
         OC    MDTDIIVK,MDTDIIVK   SKIP IF ENTRY EMPTY                          
         BZ    DCOLX                                                            
*                                                                               
*** DISPLAY TRACK LABEL ***                                                     
*                                                                               
         TM    MDTFLAG,MDTFNEW     DIFFERENT TRACK FROM BEFORE?                 
         BZ    DCOLTLX              NO                                          
*                                  DISPLACE TO CORRECT COLUMN HEADER            
         SR    R0,R0                                                            
         LA    R2,IDMCOLHH         POINT TO FIRST COLUMN                        
         ZICM  R1,CNTTRK,(3)       COLUMN NUMBER                                
         BZ    DCOLTL02                                                         
*                                                                               
         IC    R0,0(R2)                                                         
         AR    R2,R0                                                            
...
*                                                                               
DCOLTL02 EQU   *                                                                
*                                  GET DISPLAYABLE SRC,BOOK                     
         LA    R6,MDTDIIVK         POINT TO INV KEY FOR COLUMN                  
         USING RINVKEY,R6          ESTABLISH INV KEY                            
*                                                                               
         MVC   TMPFRBTS,RINVKQLF   INTERNAL BOOKVAL BITS                        
         MVC   TMPBTYP,RINVKBTP    BOOK TYPE                                    
         MVC   TMPBOOK,RINVKBK     BOOK                                         
*                                                                               
         DROP  R6                                                               
*                                                                               
...
DCOLDVE1 DS    0H                    EDIT W/ 1 DECIMAL PLACE                    
         C     R1,=F'99999'        IF DISPLAY > 6 CHS                           
         BNH   DCOLDVE2                                                         
*                                                                               
         CVD   R1,DUB              CVD                                          
         SRP   DUB,64-1,5          ROUND TO INTEGER                             
         CVB   R1,DUB              CVB                                          
         B     DCOLDVE0                                                         
*                                                                               
DCOLDVE2 DS    0H                                                               
...
BTR066   DS    0H                  ELEM NOT FOUND IN ORIG RECD                  
         ...
         MVC   TMPRSR,RINVKRSR     GET RATING SOURCE                            
         MVC   TMPQLF,RINVKQLF     GET QUALIFIER                                
         MVC   TMPBTYP,RINVKBTP    GET BOOKTYPE                                 
         MVI   GOSUBN,RKS#                                                      
         GOTO1 AGOSUB               TMPQLFY HAS QUALIFIER                       
...
*                                                                               
         DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'RERMP41 - INVENTORY DEMOS (SUBR03--MNI#)'                       
...
TMPQLF   DS    CL1                  "      "     "  QUALIFIER INTERNAL          
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'026RERMP41   04/02/14'                                      
         END                                                                    
