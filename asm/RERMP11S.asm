*          DATA SET RERMP11S   AT LEVEL 205 AS OF 05/01/02                      
*PHASE T81011A,+0                                                               
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLSTB                                                               
...
T81011   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T81011,RR=R5                                                   
         LA    R9,2048(RB)                                                      
         LA    R9,2048(R9)                                                      
         USING T81011+4096,R9                                                   
*                                                                               
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
         L     RA,ATWA                                                          
...
REPDIR   DC    C'REPDIR  '         HELLO FILE NAME                              
         LTORG                                                                  
         EJECT                                                                  
         PRINT GEN                                                              
PLINED   DSECT                                                                  
...
LENVALS  EQU   NUMVALS*4                                                        
       ...
       ++INCLUDE REBKLSTD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'205RERMP11S  05/01/02'                                      
         END                                                                    
