*          DATA SET DENN09O    AT LEVEL 053 AS OF 05/28/15                      
*PHASE DENN09OC                                                                 
*INCLUDE DEBKUPDT                                                               
         TITLE 'OUTPUT PHASE FOR DENN0138 NTI CNV'                              
DENN09O  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         NMOD1 NTIWRKX-NTIWRKD,*DENN09O                                         
         USING NTIWRKD,RC          RC=A(TEMP W/S)                               
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING  DENN09O+4096,R7    R7=2ND BASE REGISTER                         
...
* DEDBEXTRAD                                                                    
       ...
       ++INCLUDE DBUPARMSD                                                      
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'053DENN09O   05/28/15'                                      
         END                                                                    
