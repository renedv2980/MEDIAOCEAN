*          DATA SET PPREPXD02  AT LEVEL 004 AS OF 05/01/02                      
*PHASE PPXD02A,*         DAILY FILE TRANSFER                                    
*INCLUDE SORTER                                                                 
*INCLUDE CONFID                                                                 
         SPACE 2                                                                
*===========================================================*                   
...
*===========================================================*                   
         TITLE 'PPXK02 - JWT FILE DATA TRANSFER'                                
PPXD02   CSECT                                                                  
********************************************************************            
         SPACE 3                                                                
PPXK02   CSECT                                                                  
...
*                                                                               
         OPEN  (FILEIN,(INPUT))                                                 
         BAS   RE,READRECS         READ RECORDS                                 
***                                                                             
DOSORTR  GOTO1 =V(SORTER),DMCB,SORTCARD,RECCARD                                 
         B     EXIT                                                             
*                                                                               
...
NUMOFTAP DC    X'03'                                                            
         EJECT                                                                  
READRECS NTR1 ** READ RECORDS ***                                               
         GET FILEIN,WORK                                                        
* AGEYTAB CONTAINS THE FOLLOWING                                                
*                *  SUPER AGENCY CODE ON RECOVERY TAPE                          
*                º    * MEDIA                                      *            
*                º    º       * CLIENT CODE                        *            
*                º    º       º      * SUPER AGENCY ON ADVERTISER  *            
*                º    º       º      º       * CLIENT ON ADV       *            
*                º    º       º      º       º         * RECORDS   *            
*                º    º       º      º       º         º TO BE     *            
*               +0   +2      +3     +6      +8       +11 INCLUDED  *            
*                º    º       º      º       º         º           *            
*                V    V       V      V       V         V           *            
AGENYTAB DC    C'JW',C'M',CL3'CLT',C'JW',CL3'NEW',XL16'0720'                    
AGENYTLN EQU   *-AGENYTAB                                                       
         DC    X'FF'                                                            
         EJECT                                                                  
*===============================================================*               
* CLTFRST PROCESSING                                            *               
...
XK30     DS    0H                                                               
         ...
         SPACE 1                                                                
*==========================================================*                    
* READ XXX CLIENT HEADER ON JWT FILE                       *                    
...
STEQACN  DS    CL5                                                              
         ORG                                                                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004PPREPXD02 05/01/02'                                      
         END                                                                    
