*          DATA SET REREP1002  AT LEVEL 166 AS OF 10/25/13                      
*PHASE RE1002A                                                                  
*INCLUDE OUTDAY                                                                 
*INCLUDE RECUP                                                                  
*INCLUDE REGENBUF                                                               
...
*                                                                   *           
* 18MAY05 SKU ADD COMFACS TO REGENPBY CALL                          *           
*             SUPPRESS BUY AUTO-COMMENT IN REGENPBY                 *           
*                                                                   *           
* 22APR09 SKU SUPPORT NEW INVENTORY KEY                             *           
*                                                                   *           
* 04MAY11 SKU SUPPORT FORCED OCM NON-DISCRIMINATION CLAUSE          *           
*             CHANGE X'FF' EMBEDDED BY REGENPBY TO X'00' DUE TO     *           
*             ARCHIVAL ISSUES                                       *           
*                                                                   *           
* 25OCT13 SKU FIX ARCHIVE PRINTING ISSUE WITH BUCKET                *           
*             COMMENTED OUT VARIOUS OBSELETE COMBO ROUTINES         *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
*                                                                               
...
*                                                                               
         L     RE,ABUCKS                                                        
         LA    RF,BUCKSLQ          CLEAR BUCKET AREA                            
         XCEF                                                                   
*                                                                               
* LOOKUP CONTRACT REC                                                           
*                                                                               
...
KCMT60   DS    0H                                                               
         BAS   RE,PRTREP                                                        
         GOTO1 =A(PSTCMT),DMCB,(3,=C'SC=*'),(RC),(RA),(R9),RR=Y                 
         DROP  R6                                                               
         EJECT                                                                  
*********************************************************************           
* AGENCY COMMENTS                                                               
...
*                                                                               
BUCKS    DS    120H                     CASH BUCKETS AREA                       
BUCKSLQ  EQU   *-BUCKS                  LENGTH OF BUCKETS                       
TBUCKS   DS    120H                     TRADE BUCKETS AREA                      
GRAND    DS    120H                     COMBO CASH GRAND TOTAL AREA             
TGRAND   DS    120H                     COMBO TRADE GRAND TOTAL AREA            
TEMPBUCK DS    120H                     TEMPORARY BUCKET AREA                   
*                                                                               
...
STAOPT5  EQU   X'40'               PRINT BUYLINE DEMO VALS ON CONTRACT          
...
BPRT10   TM    RBUYCNTL,X'80'      DELETED?                                     
         ...
         BE    BPRT70                                                           
*                                                                               
*        BUILD BUCKETS FROM BUYS TO CHECK CONTRACT BKTS - INCLUDE GRPS          
*                                                                               
         MVC   WORK(4),GETBROAD                                                 
         MVC   WORK+4(4),GETDAY                                                 
         MVC   WORK+8(4),ADDAY                                                  
...
*                                                                               
         GOTOX (RFGENBUC,VREPFACS),DMCB,RBUYREC,BLOCK,(X'40',WORK)              
*                                                                               
...
BPRT15   EQU   *                                                                
*                                                                               
         CLC   BLOCK(2),=H'2'      SKIP IF NONE                                 
         BE    BPRT70                                                           
*                                                                               
         LA    R8,BLOCK+2          1ST BUY BUCKET                               
         LH    R3,BLOCK                                                         
         LA    R3,BLOCK-1(R3)      END OF BUCKETS                               
*                                                                               
BPRT20   DS    0H                                                               
*                                                                               
         L     R6,ABUCKS           POINT TO ACCUMULATOR AREA                    
*                                                                               
         TM    RBUYFLG2,X'02'      TRADE BUY?                                   
         BZ    *+8                                                              
         L     R6,ATBUCKS          USE TRADE BUCKET AREA                        
*                                                                               
         LR    R2,R6               SAVE START OF ACCUMULATORS                   
*                                                                               
         LH    R1,0(R6)                                                         
         LA    R5,0(R1,R6)         END OF ACCUMULATORS                          
*                                                                               
         AHI   R5,-1               END OF ACCUMULATORS FOR BXLE                 
*                                                                               
         LA    R6,2(R6)            POINT TO FIRST ACCUMULATOR                   
*                                                                               
         B     BPRT60                                                           
*                                                                               
BPRT30   DS    0H                                                               
*                                                                               
         LLC   R4,1(R6)            LENGTH OF FIRST ACCUMULATOR                  
         BXLE  R6,R4,BPRT60        NEXT TOTAL BUCKET                            
*                                                                               
BPRT40   XC    4(2,R8),4(R8)       CLEAR MONDAY DATE IN BUCKET                  
*                                                                               
*        ADD BUY DATA TO ACCUMULATORS                                           
*                                                                               
         GOTO1 RECUP,DMCB,(X'FF',(R2)),(R8),(R6)                                
*                                                                               
BPRT50   DS    0H                                                               
*                                                                               
         LLC   RF,1(R8)            BUCKET LENGTH                                
         LA    R8,0(RF,R8)         NEXT BUCKET                                  
*                                                                               
         CR    R8,R3               CONTINUE IF END NOT REACHED                  
         BNH   BPRT20                                                           
*                                                                               
         B     BPRT70              NO MORE BUY BUCKETS                          
*                                                                               
...
*                                                                               
         ...
         MVC   6(8,R6),DUB                                                      
*                                                                               
         CLI   1(R8),14            SKIP IF NO GRPS IN ELEMENT                   
         BNH   BPRT65                                                           
*                                                                               
         ICM   RF,15,14(R6)        ADD TO TOTAL GRPS                            
         ICM   RE,15,14(R8)                                                     
         AR    RF,RE                                                            
         STCM  RF,15,14(R6)                                                     
*                                                                               
...
BPRT70   MVC   WORK(4),OUTDAY      PASS ROUTINE ADDRESSES IN WORK               
         ...
         MVC   WORK+20(4),VDEMOCON                                              
*                                                                               
         L     RF,ADCONLST                                                      
         USING ADCONSD,RF                                                       
         MVC   DMCB+20(4),VCOMFACS    A(COMFACS)                                
         DROP  RF                                                               
*                                                                               
...
*                                                                               
BPRT75   EQU   *                                                                
         GOTO1 REGENPBY,DMCB,(SVKVER,RBUYREC),(32,BLOCK),WORK,RCONREC, >        
               PROFILES                                                         
...
BPRT110  CH    R6,=H'1'                                                         
         ...
         MVC   P,SPACES                                                         
*                                                                               
* CHECK IF REGENPBY INSERTED A X'FF' AND CHANGE IT TO A BLANK                   
* AS IT IS CAUSING ARCHIVE PROBLEMS                                             
*                                                                               
         USING PD,R2                                                            
         CLI   PDAY,X'FF'                                                       
         BNE   *+8                                                              
...
*                                                                               
         L     R5,ABUCKS           POINT TO BUCKETS                             
         LH    R3,0(R5)            POINT TO END OF BUCKETS                      
         LA    R3,0(R5,R3)                                                      
         AHI   R3,-1                                                            
*                                                                               
         LA    R5,2(R5)            POINT TO FIRST BUCKET                        
         B     BPRT205                                                          
*                                                                               
BPRT200  DS    0H                                                               
*                                                                               
         LLC   RF,1(R5)            LENGTH OF BUCKETS                            
         LA    R5,0(RF,R5)         NEXT BUCKET                                  
*                                                                               
BPRT205  DS    0H                                                               
*                                                                               
         CR    R5,R3               DONE IF END OF BUCKETS REACHED               
         BNH   *+8                                                              
         B     BPRT210                                                          
*                                                                               
         OC    6(4,R5),6(R5)       IF NO DOLLARS?                               
         BNZ   BPRT200                                                          
*                                     DELETE BUCKET                             
         GOTO1 RECUP,DMCB,(X'FF',ABUCKS),(R5),(R5)                              
*                                                                               
         L     R1,ABUCKS           RESET BUCKET END                             
         LH    R3,0(R1)                                                         
         LA    R3,0(R1,R3)                                                      
         BCTR  R3,0                                                             
*                                  R5 POINTS TO BUCKET AFTER ZERO BKT           
         B     BPRT205                                                          
*                                                                               
...
*                                                                               
         ...
         L     R3,=A(TEMPBUCK)                                                  
         A     R3,RELO                                                          
         MVC   0(240,R3),0(R4) TEMP GRAND TOTAL BUFFER                          
         L     R4,ATBUCKS                                                       
...
*              BUCKET ELEMENTS AR NO LONGER THE SAME,                           
*              CONTRACT BUCKETS LACK GRPS BUCKET                                
*              THUS WE NEED TO CHECK EACH ELEMENT SEPARATELY                    
*                                                                               
BPRT245  EQU   *                                                                
*******                                                                         
*******  L     R1,ABUCKS                                                        
...
*******  BE    BPRT250                                                          
*                                                                               
         L     R1,ABUCKS           POINT TO BUY    BUCKETS                      
         LA    R6,2(R1)            POINT TO FIRST BUY      BKT ELM              
*                                                                               
         LA    R4,BLOCK+402        POINT TO FIRST CONTRACT BKT ELM              
*                                                                               
BPRTBKLP DS    0H                                                               
*                                                                               
         CLI   0(R4),0             BOTH BKT ELM MUST HIT END TOGETHER           
         BNE   *+16                                                             
         CLI   0(R6),0                                                          
         BNE   BPRTBKER                                                         
         B     BPRTBKDN            ELSE ALL OKAY                                
*                                                                               
         LLC   RF,1(R4)            CONTRACT BKT LENGTH                          
         SHI   RF,2                SKIP ID AND LENGTH BYTES                     
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         CLC   2(0,R4),2(R6)       BKT ELMS MUST MATCH THRU SPOTS               
*                                                                               
         BNE   BPRTBKER                                                         
*                                                                               
BPRTBKCN DS    0H                                                               
*                                                                               
         LA    R4,3(RF,R4)         NET CONTRACT BUCKET ELM                      
         LLC   RF,1(R6)                                                         
         LA    R6,0(RF,R6)         NEXT BUY     BUCKET ELM                      
*                                                                               
         B     BPRTBKLP                                                         
*                                                                               
BPRTBKDN DS    0H                                                               
*                                                                               
         B     BPRT250             CONTRACT AND BUY BUCKETS MATCH               
*                                                                               
BPRTBKER DS    0H                                                               
*                                                                               
* BUCKETS OUT OF SYNC                                                           
...
*                                                                               
         ...
         L     R4,VCOMFACS                                                      
         DROP  RF                                                               
         LA    R4,CGETTXT-COMFACSD(R4)                                          
         GOTO1 =V(REGENSTC),DMCB,(2,(R6)),(R3),DATAMGR,RCONREC,(R4),   +        
               RR=Y                                                             
...
HL55     DS    0H                                                               
         ...
         BAS   RE,GETEL                                                         
         BNE   HL60                                                             
         CLI   RSTAP5,C'Y'         PRINT DEMO VALUES OPTION                     
         BNE   HL60                                                             
         OI    SOPTIONS,STAOPT5                                                 
         DROP  R6                                                               
*                                                                               
...
READ0055 EQU   *                                                                
         MVC   RAGYNAM2,SPACES                                                  
         MVC   RAGYNAM2(20),=C'**AGY NOT ON FILE** '                            
         B     READ0080                                                         
READ0060 EQU   *                                                                
...
*                                                                               
         MVC   0(240,R2),0(R3)     LOAD TEMPORARY WORK SPACE                    
*                                                                               
...
*                                                                               
         ...
         LLC   R8,1(R6)            BUCKET LENGTH                                
         LA    R6,0(R8,R6)         NEXT SET OF BUCKETS                          
*                                                                               
         B     TOTO0010                                                         
*                                                                               
TOTO0030 EQU   *                                                                
*                                                                               
         ...
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   0(0,R6),0(R1)      RUN OUT STA IN PROGRESS                       
*                                                                               
         LA    R1,1(R4,R1)                                                      
         LA    R6,1(R4,R6)                                                      
*                                                                               
...
*                                                                               
         ...
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   0(0,R6),0(R2)      RUN OUT STA IN PROGRESS                       
*                                                                               
         LA    R2,1(R4,R2)                                                      
         LA    R6,1(R4,R6)                                                      
*                                                                               
...
*                                                                               
         ...
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   0(04,R6),0(R1)      RUN OUT STA IN PROGRESS                      
*                                                                               
         LA    R1,1(R4,R1)                                                      
         LA    R6,1(R4,R6)                                                      
         B     TOTO0060                                                         
...
TOTO0100 EQU   *                                                                
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'166REREP1002 10/25/13'                                      
         END                                                                    
