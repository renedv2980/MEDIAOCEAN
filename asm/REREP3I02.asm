*          DATA SET REREP3I02  AT LEVEL 162 AS OF 02/18/03                      
*          DATA SET REREP3I02  AT LEVEL 109 AS OF 07/17/97                      
*PHASE RE3I02A,*                                                                
         TITLE 'RE3I02 - REREP3I02 - KATZ INTERFACE TAPE'                       
**********************************************************************          
...
*********************************************************************           
*                                                                   *           
*   REREP3I02 - RE3I02 - KATZ TAPE: CLEAR CHANNEL VERSION           *           
*                                                                   *           
*********************************************************************           
*                                                                   *           
...
* UPDATE HISTORY:                                                   *           
*                                                                   *           
* JAN09/01 (BU ) --- INITIAL ENTRY (FROM 3H02)                      *           
*                                                                   *           
...
RTOTLIST DC    AL4(ABSGROS),AL4(RTOTABGR)                                       
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'162REREP3I02 02/18/03'                                      
         END                                                                    
