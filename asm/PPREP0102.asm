*          DATA SET PPREP0102  AT LEVEL 038 AS OF 02/23/15                      
*PHASE PP0102A                                                                  
*                                                                               
         TITLE 'PP0102 - CHANGE LOG'                                            
*                                                                               
* BPLA 02/15    BUG FIXES TO COMMENT + CLIENT PURGES                            
*               APPARENTLY INTRODUCED IN 2001                                   
*                                                                               
* SMYE 12/06    PREVENT PURGING OF BASE PUBS (PROFILE CONDITIONED)              
*                                                                               
* BPLA 07/02    CHANGE FOR BIGGER CONTRACTS AND BUYS                            
*                                                                               
* KWAN 05/01/01 CHECK FOR NESTED COMMENTS IN I/OCOM AND CONCOM                  
*                                                                               
* KWAN 04/11/01 PURGE CLT/PRD/PUB GROUP RECORDS (SEE QOPT1)                     
*                                                                               
* SMYE  06/00   FIX MINOR BUG IN PKINVM (MATCH RECORD KEY PRINTING)             
*                                                                               
* BPLA  05/00   WHEN DOING A ONE PUB REQUEST - BE SURE PUB EXISTS FIRST         
*                                                                               
* SMYE  04/00   CHANGES FOR NEW ENLARGED PPNEWFILE                              
*                                                                               
...
*                               EVEN IF QOPT2 = A                               
*                                                                               
*                               WHEN PURGING GRP/DEF RECORDS, THIS OPT          
*                               WILL PRINT KEY IN HEX                           
*                                                                               
...
*                                                                               
*        QOPT6  FOR COMMENT PURGE (QOPT1=C)                                     
*               C = TO DELETE COMMENT ELEMS FROM CONTRACTS RECS                 
*                   ALSO FROM CONTRACT COMMENT RECS (CONCOM)                    
*               J = TO DELETE COMMENT ELEMS FROM JOB RECS                       
*                   ALSO FROM I/O COMMENT RECS (I/OCOM)                         
*               P = TO DELETE COMMENT ELEMS FROM PRODUCT RECS                   
*               E = TO DELETE COMMENT ELEMS FROM ESTIMATE RECS                  
*               B = TO DELETE COMMENT ELEMS FROM BUY RECS                       
*               R = TO DELETE COMMENT ELEMS FROM AOR RECS                       
*               U = TO DELETE COMMENT ELEMS FROM USERP RECS                     
*               L = TO DELETE COMMENT ELEMS FROM PUBLICATIONRECS                
*                                                                               
*               A= FROM ALL OF THE ABOVE RECORDS                                
*                                                                               
...
*  PRD GROUP (E) - QPUB+2=SCHEME CODE (QCLIENT MUST ALSO BE ENTERED)            
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
PP0102   CSECT                                                                  
...
*                                                                               
         L     RF,PPWORK2C                                                      
         USING PPWORK2D,RF                                                      
         MVC   ACONIO1,ACONIO      ACONIO=PCONREC ADDRESS IN PPNEWFILE          
         DROP  RF                                                               
*                                                                               
         L     RC,PPFILEC                                                       
         LA    R9,1(RC)                                                         
...
*                                                                               
         CLI   QOPT7,C'T'                                                       
         BNE   *+8                                                              
         MVI   RCWRITE,C'N'        SET TO NO IF QOPT7=T (TEST)                  
*                                                                               
* DEFINITION/GROUP RECORDS ARE NOT USED BY ANY OTHER RECORDS                    
* DEFGRP ROUTINE DEALS WITH THOSE RECORDS                                       
*                                                                               
         CLI   QOPT1,C'D'          CLT DEFINITION/GROUP?                        
         BE    CKQ40                                                            
         CLI   QOPT1,C'E'          PRD DEFINITION/GROUP?                        
         BE    CKQ40                                                            
         CLI   QOPT1,C'F'          PUB DEFINITION/GROUP?                        
         BNE   CKQ50                                                            
CKQ40    GOTO1 =A(DEFGRP)          DEF/GRP RECORD PURGES CSECT                  
         B     EXIT                                                             
*                                                                               
* SEE IF ONE RECORD REQUESTED, IF SO SET QOPT2 TO "P"                           
...
*                                                                               
         ...
         CLI   QOPT1,C'H'                                                       
         BE    HDRS                CLIENT HDRS                                  
         CLI   QOPT1,C'S'          CLEARANCE STATUS RECS PURGE ONLY?            
         BE    HDRS                                                             
         CLI   QOPT1,C'L'                                                       
...
EXIT     DS    0H                                                               
         XIT1                                                                   
*                                                                               
ACONIO1  DS    F                   ADDRESS OF PCONREC                           
*                                                                               
         EJECT                                                                  
CHKONE   DS    0H                                                               
...
COMMENTS DS    0H                                                               
         MVI   RCSUBPRG,40                                                      
*                                                                               
         XC    BSPARS,BSPARS       SET BSPARS                                   
         L     RF,ABSTAB                                                        
         ST    RF,BSPARS+4                                                      
         LA    RF,7                L'REC                                        
         ST    RF,BSPARS+12                                                     
         LA    RF,6                DISPLACEMENT OF KEY INTO RECORD              
         ST    RF,BSPARS+16                                                     
         L     RF,=A(BSTAB7)                                                    
         ST    RF,BSPARS+20        MAX NUMB OF REC IN TAB (400000/7)            
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(3),PAGYKAGY                                                  
         MVI   KEY+3,X'40'                                                      
...
CM2B     DS    0H                                                               
         ...
         BNE   CM4                                                              
         B     CM3                 ADD COMMENT NUMBER TO BTAB                   
*                                                                               
CM2D     L     RF,ALISREC                                                       
         ST    RF,AREC                                                          
         CLI   QOPT2,C'A'          ALL COMMENT?                                 
         BE    CM3                 YES                                          
         CLI   QOPT2,C'G'          PURGEABLE ONLY?                              
         BE    CM3                 YES                                          
         GOTO1 GETPRT                                                           
...
CM3      DS    0H                                                               
         XC    DOUBLE,DOUBLE                                                    
         MVC   DOUBLE(6),KEY+4     COMMENT NUMBER                               
*                                                                               
         GOTO1 BINSRCH,BSPARS,(1,DOUBLE)                                        
         OC    BSPARS+1(3),BSPARS+1                                             
         BNZ   CM2                                                              
...
CM6B     DS    0H                                                               
         ...
         BNE   CM7                                                              
         MVI   WRTREC,0                                                         
         L     RF,ACONIO1          ADDRESS OF PCONREC                           
         ST    RF,AREC                                                          
         GOTO1 GETPRT                                                           
         L     R2,ACONIO1                                                       
         LA    R2,33(R2)                                                        
...
CM6D     BAS   RE,NEXTEL                                                        
         BE    CM6D5                                                            
         CLI   WRTREC,C'Y'         MUST WRITE BACK CONTRACT?                    
         BNE   CM6                                                              
         GOTO1 PUTPRT                                                           
...
CM7B     DS    0H                                                               
         ...
         L     R2,ACONIO1                                                       
         LA    R2,33(R2)                                                        
         MVI   ELCODE1,X'66'       STANDARD COMMENT ELEM                        
         CLI   0(R2),X'66'                                                      
         BE    CM7D5                                                            
CM7D     BAS   RE,NEXTEL                                                        
         BE    CM7D5                                                            
...
CM8B     DS    0H                                                               
         ...
         GOTO1 GETPRT                                                           
         LA    R2,PCLTREC+33                                                    
         MVI   ELCODE1,X'10'       FIRST CHECK FOR CONTRACT STD COMM            
CM8D     BAS   RE,NEXTEL                                                        
         BNE   CM8D5                                                            
*                                                                               
         MVC   DOUBLE(6),2(R2)                                                  
...
CM8D5    LA    R2,PCLTREC+33                                                    
         MVI   ELCODE1,X'11'       THEN CHECK FOR I/O STD COMM                  
CM8D8    BAS   RE,NEXTEL                                                        
...
CM8F     DS    0H                                                               
         ...
         B     CM8X                                                             
*                                                                               
CM8X     CLI   ELCODE1,X'10'       SEE IF SEARCHING FOR CONTRACT COMM           
         BE    CM8D                YES                                          
...
CM25     CLI   KEYSAVE+3,X'20'     SEE IF I JUST FINISHED BUYS                  
         ...
         LA    R0,PBUYREC                                                       
         ST    R0,AREC                                                          
         MVI   ELCODE1,X'67'       IC= COMMENTS                                 
         B     CM12C                                                            
*                                                                               
CM25D    CLI   ELCODE1,X'67'       SEE IF I JUST DID IC= COMMENTS               
         BE    CM25E               NO THEN DONE - DO NEXT RECORD                
         MVI   ELCODE1,X'67'       MUST RESET ELCODE1                           
         B     CM14                FOR NEXT RECORD                              
*                                                                               
CM25E    MVI   ELCODE1,X'68'       NO - TRY FOR X'68' ELEMS                     
         B     CM15                                                             
*                                                                               
...
COMDEL   NTR1                                                                   
         MVI   WRTREC,C'Y'                                                      
         L     R4,ACONIO1          ADDRESS OF PCONREC                           
         GOTO1 RECUP,DMCB,(1,(R4)),0(R2),0                                      
*                                                                               
         MVC   HALF,25(R4)         CLEAR END OF RECORD                          
         LH    R1,HALF                                                          
         L     RE,ACONIO1                                                       
         LR    RF,RE                                                            
         AR    RE,R1                                                            
         ...
         XCEF                                                                   
*                                                                               
         LA    R2,33(R4)           MUST RESET R2 TO BEGINNING OF RECORD         
*                                                                               
COMDELX  DS    0H                                                               
         XIT1  REGS=(R2)                                                        
*                                                                               
...
COMDELPE NTR1                                                                   
         MVI   WRTREC,C'Y'                                                      
*                                                                               
         CHI   R4,1                3RD COMMENT ?                                
         BNE   *+14                                                             
         XC    0(7,R3),0(R3)       DELETE LAST COMMENT                          
         B     COMOUT                                                           
*                                                                               
         CHI   R4,2                2ND COMMENT ?                                
         BNE   *+20                                                             
...
COMDELJX DS    0H                                                               
         XIT1  REGS=(R2)                                                        
*NOP*    L     RE,COMDELJ-4        RETURN                                       
*NOP*    L     R6,TEMPR6           RESTORE R6 AND                               
*NOP*    L     R3,TEMPR3           R3                                           
*NOP*    BR    RE                                                               
*                                                                               
         EJECT                                                                  
...
*                                                                               
         LA    R2,PCLTREC+33                                                    
         MVI   ELCODE1,X'30'       DRD CLIENT ELEMENT                           
         BAS   RE,NEXTEL                                                        
...
LSTS2D   CLI   QOPT2,C'A'                                                       
         ...
         BE    LSTS3                                                            
*                                                                               
*NOP*    LA    RF,PCONREC          READ INTO CONREC                             
         L     RF,ACONIO1          READ INTO CONREC                             
         ST    RF,AREC                                                          
         GOTO1 GETPRT                                                           
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
* CHECKING I/OCOM AND CONCOM COMMENT RECORDS, TO SEE IF NESTED COMMENTS         
* ARE USED, IF THEY ARE USED, THEN THEY MUST BE DELETED FROM BTAB               
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
CKICCOM  NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         MVI   COMMNTSW,0          INITIALIZE COMMENT SWTICH                    
         LA    RE,COMWKREC                                                      
         LA    RF,COMWKRQ                                                       
         XCEF                                                                   
*                                                                               
CKICC05  XC    KEY,KEY                                                          
         MVC   KEY(3),PAGYKAGY                                                  
         MVI   KEY+3,X'42'         I/O COMMENTS                                 
         CLI   COMMNTSW,C'C'       CONTRACT COMMENTS?                           
         BNE   *+8                                                              
         MVI   KEY+3,X'44'         CON COMMENTS                                 
         GOTO1 HIGH                                                             
         B     CKICC20                                                          
*                                                                               
CKICC10  CLI   WRTREC,C'Y'         SEE IF MUST WRITE BACK RECORD                
         BNE   CKICC15                                                          
         GOTO1 PUTPRT                                                           
         MVI   WRTREC,0            RESET SWITCH                                 
*                                                                               
CKICC15  GOTO1 SEQ                                                              
*                                                                               
CKICC20  CLC   KEY(4),KEYSAVE                                                   
         BNE   CKICC90                                                          
         LA    RF,COMWKREC                                                      
         ST    RF,AREC                                                          
         GOTO1 GETPRT                                                           
         ...
         CLC   0(1,R2),ELCODE1                                                  
         BE    CKICC30                                                          
CKICC25  BAS   RE,CNEXTEL                                                       
         BNE   CKICC10             TRY NEXT RECORD                              
*                                                                               
CKICC30  SR    R6,R6                                                            
         IC    R6,1(R2)                                                         
         LA    R6,0(R2,R6)         END OF COMMENT ELEM                          
         LA    R3,2(R2)            PASS ELEM CODE AND LENGTH                    
*                                                                               
CKICC40  CLC   0(4,R3),=C'COM='                                                 
         BNE   CKICC25             TRY NEXT ELEM                                
         LA    R3,4(R3)                                                         
         LR    R4,R3                                                            
CKICC50  CLC   0(1,R3),ELCODE1                                                  
         BE    CKICC60                                                          
         CLI   0(R3),C','                                                       
         BE    CKICC60                                                          
         CR    R6,R3               END OF ELEM?                                 
...
*                                                                               
CKICC60  DS    0H                                                               
         LR    R5,R4               R5 POINTS TO BEGINNING OF DATA               
         SR    R4,R3               BEGINNING MINUS END                          
         LCR   R4,R4               COMPLIMENT (SHOULD BE POSITIVE)              
         BNP   CKICC70             BAD LENGTH, TRY NEXT COM= OR ELEM            
         CHI   R4,6                                                             
         BNH   *+8                                                              
         LA    R4,6                                                             
         MVC   DUB,SPACES                                                       
         ...
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   0(0,R1),0(R5)       RIGHT ALIGNED AND SPACE PADDED               
*                                                                               
         MVC   COMDUB,SPACES       NEEDED FOR COMPARISON LATER                  
         EX    R4,*+8                                                           
         B     *+10                                                             
         MVC   COMDUB,0(R5)        LEFT ALIGNED AND SPACE PADDED                
*                                                                               
         MVI   DUB+6,0                                                          
         MVI   BSPARS,0            SET FOR EXACT LOOK UP                        
         GOTO1 BINSRCH,BSPARS,DUB                                               
         CLI   BSPARS,1            FOUND IN BIN TABLE?                          
         BE    CKICC68             NO                                           
*                                                                               
         L     RF,BSPARS                                                        
         MVI   6(RF),X'FF'         DO NOT PURGE STANDARD COMMENT REC            
         CLI   QOPT6,C'J'          I/OCOM?                                      
         BE    CKICC67                                                          
         CLI   QOPT6,C'C'          CONCOM?                                      
         BE    CKICC67                                                          
         CLI   QOPT6,C'A'          DEL ALL NESTED COMMENTS?                     
         BNE   CKICC67D                                                         
         MVI   6(RF),0             OK TO PURGE STANDARD COMMENT REC             
CKICC67  BAS   RE,ICCOMDEL                                                      
         CLI   FOUND,C'N'                                                       
         BE    CKICC67D                                                         
         MVC   PSECOND+19(24),=C'*NESTED COMMENT DELETED*'                      
CKICC67D GOTO1 =A(PRNTKEY)                                                      
         B     CKICC70                                                          
*                                                                               
CKICC68  CLI   QOPT2,C'G'          PURGEABLE ONLY?                              
         BE    CKICC68D                                                         
         CLI   QOPT2,C'A'          ALL RECORD TYPES?                            
         BNE   CKICC70                                                          
*                                                                               
CKICC68D OC    DUB(6),DUB          COMMENT NUMBER?                              
         BZ    CKICC70                                                          
         CLI   QOPT6,C'A'          ANY NESTED COMMENTS?                         
         BE    CKICC68H                                                         
         CLI   QOPT6,C'J'          I/OCOM?                                      
         BE    CKICC68H                                                         
         CLI   QOPT6,C'C'          CONCOM?                                      
         BNE   CKICC68M                                                         
CKICC68H BAS   RE,ICCOMDEL                                                      
         CLI   FOUND,C'N'                                                       
         BE    CKICC68M                                                         
         MVC   PSECOND+19(24),=C'*NESTED COMMENT DELETED*'                      
CKICC68M MVI   MISSSW,C'Y'                                                      
         GOTO1 =A(PRNTKEY)                                                      
         MVI   MISSSW,C'N'                                                      
*                                                                               
CKICC70  LA    R3,1(R3)                                                         
         CR    R3,R6                                                            
         BNL   CKICC25             TRY NEXT ELEM                                
         B     CKICC40             TRY NEXT POSSIBLE COM=                       
*                                                                               
CKICC90  CLI   COMMNTSW,C'C'       ALL COMMENTS CHECKED?                        
         BE    CKICCX                                                           
         MVI   COMMNTSW,C'C'       NOW DO CONTRACT COMMENT                      
         B     CKICC05                                                          
*                                                                               
CKICCX   XIT1                                                                   
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
ICCOMDEL DS    0H                  R2 MUST BE POINTING TO ELEM                  
         ST    RE,COMSVRE                                                       
         ST    R6,TEMPR6           SAVE R6 (USED IN OUTTER LOOP)                
         ST    R3,TEMPR3           SAVE R3 (USED IN OUTTER LOOP)                
         MVI   WRTREC,C'Y'                                                      
         MVI   FOUND,C'N'                                                       
         XC    TEMPELEM,TEMPELEM   LONG ENOUGH FOR MAX OF 70 BYTES ELEM         
*                                                                               
         ZIC   R6,1(R2)            ELEM LENGTH                                  
         BCTR  R6,0                                                             
         EX    R6,*+8                                                           
         B     *+10                                                             
         MVC   TEMPELEM(0),0(R2)   SAVE ELEM                                    
*                                                                               
         LA    R3,TEMPELEM         POINT TO ELEM                                
         LA    R3,2(R3)                                                         
         LR    R1,R3                                                            
ICC30    LA    R3,4(R3)            POINT TO ACTUAL COMMENT                      
         LR    R5,R3                                                            
         SR    R6,R6               COMPUTES LEN OF THIS COMMENT                 
ICC40    LA    R5,1(R5)            BUMP TO NEXT CHAR                            
         LA    R6,1(R6)            INCREMENT CHAR COUNT                         
         CLI   0(R5),C','                                                       
         BE    ICC50                                                            
         CLI   0(R5),0             END OF ELEM?                                 
         BNE   ICC40                                                            
*                                                                               
ICC50    BCTR  R6,0                R4 ALREADY SUBTRACTED BY ONE                 
         CR    R6,R4               LENGTH OF COMMENT CODE SAME?                 
         BNE   ICC65                                                            
*                                                                               
         EX    R4,*+8              LENGTH OF COMMENT                            
         B     *+10                                                             
         CLC   0(0,R3),COMDUB      COMMENT CODE MATCH?                          
         BNE   ICC65                                                            
*                                                                               
         MVI   FOUND,C'Y'                                                       
         LA    R5,TEMPELEM         POINT TO TEMP ELEM                           
         LA    R3,1(R4,R3)         END OF COMMENT                               
         LA    R4,6(R4)            L'OF ENTIRE COMMENT (COM=+ ',' + 1)          
         CLI   0(R3),C','                                                       
         BNE   ICC60                                                            
...
*                                                                               
         ...
         MVC   0(0,R1),0(R3)                                                    
*                                                                               
ICC60    ZIC   R6,1(R5)            LENGHT OF OLD ELEM                           
         SR    R6,R4                                                            
         STCM  R6,1,1(R5)          LENGTH OF NEW ELEM                           
         B     ICC70                                                            
*                                                                               
ICC65    LA    R3,1(R3)                                                         
         CLI   0(R3),0             END OF RECORD?                               
         ...
         BNE   ICC65                                                            
         LR    R1,R3                                                            
         LA    R3,1(R3)            POINT TO NEXT COM=                           
         B     ICC30                                                            
*                                                                               
ICC70    GOTO1 RECUP,DMCB,(1,COMWKREC),0(R2),0                                  
*                                                                               
         CLI   1(R5),2             ANY DATA IN ELEM TO BE ADDED?                
         BNH   ICC75               NO                                           
*                                                                               
         GOTO1 RECUP,DMCB,(1,COMWKREC),TEMPELEM,0(R2),0                         
*                                                                               
ICC75    MVC   HALF,COMWKREC+25    GET LENGTH OF RECORD                         
         LA    RE,COMWKREC         POINT TO BEGINNING OF RECORD                 
         LA    RF,COMWKRQ          LENGTH OF RECORD AREA READ INTO              
         AH    RE,HALF             POINT TO END OF RECORD                       
         SH    RF,HALF             NUMBER OF BYTES TO BE CLEARED                
         XCEF                                                                   
*                                                                               
         LA    R2,COMWKREC+33      REDIRECT R2 TO FIRST ELEM                    
         L     RE,COMSVRE          RETURN ADDRESS                               
         L     R6,TEMPR6           RESTORE R6                                   
         L     R3,TEMPR3           RESTORE R3                                   
         BR    RE                                                               
*                                                                               
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
COMMNTSW DS    CL1                 COMMENT SWITCH                               
COMSVRE  DS    F                                                                
COMDUB   DS    D                                                                
*                                                                               
COMWKREC DS    1200C               RECORD AREA                                  
COMWKRQ  EQU   *-COMWKREC                                                       
*                                                                               
         LTORG                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
*        DEFINITION AND GROUP RECORD PURGES                                     
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
DEFGRP   CSECT                                                                  
...
*                                                                               
         ...
         USING PPFILED,RC,R9                                                    
*                                                                               
         ZAP   DPGCNT,=P'0'        DEFINITION RECORDS PURGED COUNTER            
         ZAP   GPGCNT,=P'0'        GROUP RECORDS PURGED COUNTER                 
         ZAP   DGTCNT,=P'0'        TOTAL RECORDS PURGED COUNTER                 
*                                                                               
         ZAP   G3ACCNT,=P'0'       GRP PASSIVE POINTERS (3A,3B,3C)              
         ZAP   G3DFCNT,=P'0'       GRP PASSIVE POINTERS (3D,3E,3F)              
*                                                                               
         MVI   DEFMPSW,0           "MARKED FOR PURGE" PURGES SW                 
         MVI   DGPPPSW,0           DEF/GRP PASSIVE POINTER PURGES SW            
*                                                                               
         CLI   QOPT2,C'G'          PURGE ALL RECS THAT CAN BE PURGED?           
         BNE   *+8                                                              
         MVI   QOPT2,C'A'          SAME AS PURGING ALL                          
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(2),PAGYKAGY     AGENCY                                       
         MVC   KEY+2(1),PAGYKMED   MEDIA                                        
         MVC   KEY+7(1),QPUB+2     SCHEME CODE TO BE LOOKED UP                  
*                                                                               
         CLI   KEY+7,C' '          MAKE SURE IT'S NOT NULL OR SPACE             
         BH    *+6                                                              
         DC    H'0'                BAD SCHEME CODE!                             
*                                                                               
         CLI   QOPT1,C'D'          CLT DEFINITION/GROUP?                        
         BNE   *+8                                                              
         MVI   KEY+3,X'34'         CLT DEF/GRP RECORD CODE                      
         CLI   QOPT1,C'E'          PRD DEFINITION/GROUP?                        
         BNE   *+14                                                             
         MVI   KEY+3,X'35'         PRD DEF/GRP RECORD CODE                      
         MVC   KEY+4(3),QCLIENT    PRD GROUP REC NEEDS CLIENT CODE              
         CLI   QOPT1,C'F'          PUB DEFINITION/GROUP?                        
         BNE   *+8                                                              
         MVI   KEY+3,X'36'         PUB DEF/GRP RECORD CODE                      
*                                                                               
         CLI   KEY+3,0                                                          
         BNE   *+6                                                              
...
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(7),KEYSAVE      COMPARE UP TO GROUP ID                       
         BNE   DEFGR90                                                          
DEFGR45  CLC   KEY+7(1),QPUB+2     STILL SAME SCHEME CODE?                      
         BNE   DEFGR90                                                          
*                                                                               
         CLI   QOPT2,C'A'          PURGE ALL DEF/GRP REC CAN BE PURGED?         
         BE    DEFGR48             YES                                          
*                                                                               
         CLI   QOPT2,C'P'          PURGING THOSE MARKED "*PURGE"?               
         BE    *+6                                                              
         DC    H'0'                INVALID PURGE OPTION IS ENTERED              
*                                                                               
         OC    KEY+8(2),KEY+8      DEFINITION RECORD?                           
         BZ    DEFGR45M            YES, CHECK IF MARKED FOR PURGE               
         CLI   DEFMPSW,C'Y'        NEED TO PURGE GROUP RECORD AS WELL?          
         BNE   DEFGR80             NO, NEXT REC                                 
         B     DEFGR48             GO PURGE GROUP RECORD                        
*                                                                               
DEFGR45M MVI   DEFMPSW,0           RESET SWITCH                                 
         LA    RF,PBUYREC          TEMPORARY USE OF BUYREC FOR GRP REC          
         ST    RF,AREC                                                          
         GOTO1 GETPRT                                                           
         L     R6,AREC                                                          
         LA    R6,33(R6)           POINT TO FIRST ELEM                          
         CLI   0(R6),X'10'         BREAK DESCRIPTION ELEM?                      
         BE    *+6                                                              
         DC    H'0'                BAD DEFINITION RECORD!                       
         CLC   2(6,R6),=C'*PURGE'  MARKED FOR PURGE?                            
         BE    DEFGR45P                                                         
         CLC   2(7,R6),=C'**PURGE'                                              
         BE    DEFGR45P                                                         
         CLC   2(8,R6),=C'***PURGE'                                             
         BNE   DEFGR80             NOT MARKED FOR PURGE, NEXT RECORD            
*                                                                               
DEFGR45P MVI   DEFMPSW,C'Y'        DEFINITION IS MARKED FOR PURGE               
*                                                                               
DEFGR48  MVC   RTYPEGD,=C'DEF'                                                  
         OC    KEY+8(2),KEY+8      ANYTHING IN GROUP CODE?                      
         BZ    DEFGR50                                                          
         AP    GPGCNT,=P'1'        GRP RECORD COUNTED                           
         MVC   RTYPEGD,=C'GRP'                                                  
         B     *+10                                                             
DEFGR50  AP    DPGCNT,=P'1'        DEF RECORD COUNTED                           
*                                                                               
         AP    DGTCNT,=P'1'        TOTAL RECORD COUNTED                         
*                                                                               
         CLI   KEY+3,X'34'         CLT DEF/GRP?                                 
         BNE   *+10                                                             
         MVC   P(03),=C'CLT'                                                    
         CLI   KEY+3,X'35'         PRD DEF/GRP?                                 
         BNE   *+10                                                             
         MVC   P(03),=C'PRD'                                                    
         CLI   KEY+3,X'36'         PUB DEF/GRP?                                 
         BNE   *+10                                                             
         MVC   P(03),=C'PUB'                                                    
         MVC   P+04(3),RTYPEGD                                                  
         MVC   P+30(06),=C'PURGED'                                              
         BAS   R6,DGPRINT                                                       
*                                                                               
         CLI   QOPT4,C'Y'          TO PRINT KEYS IN HEX?                        
         BNE   DEFGR55                                                          
         MVC   P+05(05),=C'KEY: '                                               
         MVC   P+10(25),KEY                                                     
         GOTO1 HEXOUT,DMCB,KEY,P+40,25                                          
         BAS   R6,DGPRINT                                                       
*                                                                               
DEFGR55  CLI   RCWRITE,C'Y'        WRITE TO FILE?                               
         BNE   DEFGR60                                                          
         OI    KEY+25,X'80'        FLAG FOR DELETION                            
         GOTO1 WRT                                                              
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
DEFGR60  CLI   DGPPPSW,C'Y'        ALREADY PURGED PASSIVE POINTERS?             
         BE    DEFGR80             YES, NEXT RECORD                             
         MVC   SVDGKEY,KEY         SAVE DEF/GRP KEY                             
         XC    KEY+3(29),KEY+3     LEAVE AGY/MED                                
         CLI   QOPT1,C'D'          CLT GROUP?                                   
         BNE   *+8                                                              
         MVI   KEY+3,X'3A'         CLT GRP RECORD CODE                          
         CLI   QOPT1,C'E'          PRD GROUP?                                   
         BNE   *+14                                                             
         MVI   KEY+3,X'3B'         PRD GRP RECORD CODE                          
         MVC   KEY+4(3),QCLIENT    PRD GROUP REC NEEDS CLIENT CODE              
         CLI   QOPT1,C'F'          PUB GROUP?                                   
         BNE   *+8                                                              
         MVI   KEY+3,X'3C'         PUB GRP RECORD CODE                          
*                                                                               
         MVC   KEYSAVE,KEY                                                      
         GOTO1 HIGH                                                             
DEFGR60D CLC   KEY(7),KEYSAVE      COMPARE UP TO CLIENT                         
         BNE   DEFGR65                                                          
         CLC   KEY+13(1),QPUB+2    STILL SAME SCHEME CODE?                      
         BE    DEFGR60M                                                         
DEFGR60H GOTO1 SEQ                                                              
         B     DEFGR60D                                                         
*                                                                               
DEFGR60M AP    G3ACCNT,=P'1'       GRP RECORD (3A,3B,3C) COUNTED                
         CLI   QOPT4,C'Y'          TO PRINT KEYS IN HEX?                        
         BNE   DEFGR63                                                          
         MVC   P+05(05),=C'KEY: '                                               
         MVC   P+10(25),KEY                                                     
         GOTO1 HEXOUT,DMCB,KEY,P+40,25                                          
         BAS   R6,DGPRINT                                                       
DEFGR63  CLI   RCWRITE,C'Y'        WRITE TO FILE?                               
         BNE   DEFGR63X                                                         
         OI    KEY+25,X'80'        FLAG FOR DELETION                            
         GOTO1 WRT                                                              
DEFGR63X B     DEFGR60H                                                         
*                                                                               
DEFGR65  MVC   KEY(L'SVDGKEY),SVDGKEY                                           
         XC    KEY+3(29),KEY+3     LEAVE AGY/MED                                
         CLI   QOPT1,C'D'          CLT GROUP?                                   
         BNE   *+8                                                              
         MVI   KEY+3,X'3D'         CLT GRP RECORD CODE                          
         CLI   QOPT1,C'E'          PRD GROUP?                                   
         BNE   *+14                                                             
         MVI   KEY+3,X'3E'         PRD GRP RECORD CODE                          
         MVC   KEY+4(3),QCLIENT    PRD GROUP REC NEEDS CLIENT CODE              
         CLI   QOPT1,C'F'          PUB GROUP?                                   
         BNE   *+8                                                              
         MVI   KEY+3,X'3F'         PUB GRP RECORD CODE                          
*                                                                               
         MVC   KEYSAVE,KEY                                                      
         GOTO1 HIGH                                                             
DEFGR65D CLC   KEY(7),KEYSAVE      COMPARE UP TO CLIENT                         
         BNE   DEFGR70                                                          
         CLC   KEY+07(1),QPUB+2    STILL SAME SCHEME CODE?                      
         BE    DEFGR65M                                                         
DEFGR65H GOTO1 SEQ                                                              
         B     DEFGR65D                                                         
*                                                                               
DEFGR65M AP    G3DFCNT,=P'1'       GRP RECORD (3D,3E,3F) COUNTED                
         CLI   QOPT4,C'Y'          TO PRINT KEYS IN HEX?                        
         BNE   DEFGR68                                                          
         MVC   P+05(05),=C'KEY: '                                               
         MVC   P+10(25),KEY                                                     
         GOTO1 HEXOUT,DMCB,KEY,P+40,25                                          
         BAS   R6,DGPRINT                                                       
DEFGR68  CLI   RCWRITE,C'Y'        WRITE TO FILE?                               
         BNE   DEFGR68X                                                         
         OI    KEY+25,X'80'        FLAG FOR DELETION                            
         GOTO1 WRT                                                              
DEFGR68X B     DEFGR65H                                                         
*                                                                               
DEFGR70  XC    KEY,KEY                                                          
         MVC   KEY(L'SVDGKEY),SVDGKEY                                           
         MVC   KEYSAVE(25),KEY                                                  
         GOTO1 HIGH                                                             
         CLC   KEY(25),KEYSAVE                                                  
         BE    *+6                                                              
         DC    H'0'                WRONG RECORD BEING RESTORED!                 
*                                                                               
         MVI   DGPPPSW,C'Y'        PASSIVE POINTERS HAVE BEEN PURGED            
*                                                                               
DEFGR80  GOTO1 SEQ                                                              
         B     DEFGR45                                                          
*                                                                               
DEFGR90  DS    0H                                                               
         MVI   FORCEHED,C'Y'                                                    
         MVC   P(22),=C'RECORD PURGING SUMMARY'                                 
         BAS   R6,DGPRINT                                                       
         MVC   P(22),=C'----------------------'                                 
         BAS   R6,DGPRINT                                                       
         BAS   R6,DGPRINT          SKIP A LINE                                  
*                                                                               
         CLI   QOPT2,C'P'                                                       
         BNE   DEFGR95                                                          
         MVC   P+00(42),=C'NOTE: ONLY THOSE DEFINITION RECORDS MARKED'          
         MVC   P+42(19),=C' "*PURGE" IS PURGED'                                 
         BAS   R6,DGPRINT                                                       
         BAS   R6,DGPRINT          SKIP A LINE                                  
*                                                                               
DEFGR95  MVC   P(19),=C'DEF RECORD PURGED: '                                    
         EDIT  (P8,DPGCNT),(12,P+45),0,COMMAS=YES,ZERO=NOBLANK                  
         BAS   R6,DGPRINT                                                       
         BAS   R6,DGPRINT          SKIP A LINE                                  
*                                                                               
         MVC   P(19),=C'GRP RECORD PURGED: '                                    
         EDIT  (P8,GPGCNT),(12,P+45),0,COMMAS=YES,ZERO=NOBLANK                  
         BAS   R6,DGPRINT                                                       
         BAS   R6,DGPRINT          SKIP A LINE                                  
*                                                                               
         MVC   P(40),=C'PASSIVE GRP POINTERS (3A,3B,3C) PURGED: '               
         EDIT  (P8,G3ACCNT),(12,P+45),0,COMMAS=YES,ZERO=NOBLANK                 
         BAS   R6,DGPRINT                                                       
         BAS   R6,DGPRINT          SKIP A LINE                                  
*                                                                               
         MVC   P(40),=C'PASSIVE GRP POINTERS (3D,3E,3F) PURGED: '               
         EDIT  (P8,G3DFCNT),(12,P+45),0,COMMAS=YES,ZERO=NOBLANK                 
         BAS   R6,DGPRINT                                                       
         BAS   R6,DGPRINT          SKIP A LINE                                  
*                                                                               
         MVC   P(39),=C'TOTAL DEFINITION/GROUP RECORDS PURGED: '                
         EDIT  (P8,DGTCNT),(12,P+45),0,COMMAS=YES,ZERO=NOBLANK                  
         BAS   R6,DGPRINT                                                       
*                                                                               
DEFGRPX  XIT1                                                                   
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
DGPRINT  DS    0H                  PRINTING TITLE                               
         MVC   HEAD3,SPACES                                                     
         MVC   HEAD3(41),=C'** DEF/GRP RECORD PURGE FOR SCHEME CODE "'          
         MVC   HEAD3+41(1),QPUB+2                                               
         MVC   HEAD3+42(4),=C'" **'                                             
         MVC   HEAD4,SPACES                                                     
         MVC   HEAD4+03(07),=C'-------'                                         
...
*                                                                               
SVDGKEY DS    CL25                                                              
RTYPEGD DS    CL3                  RECORD TPYE (GRP OR DEF)                     
DEFMPSW DS    CL1                  DEFINITION REC MARKED FOR PURGE SW           
DGPPPSW DS    CL1                  DEF/GRP PASSIVE POINTER PURGE SW             
*                                                                               
WKDGDUB DS    PL8                  DEF/GRP WORK DUB                             
*                                                                               
DPGCNT  DS    PL8                  DEF RECORD PURGED COUNTER                    
GPGCNT  DS    PL8                  GRP RECORD PURGED COUNTER                    
DGTCNT  DS    PL8                  TOTAL RECORDS COUNTED                        
*                                                                               
G3ACCNT DS    PL8                  GRP PASSIVE PRT RECORDS (3A,3B,3C)           
G3DFCNT DS    PL8                  GRP PASSIVE PRT RECORDS (3D,3E,3F)           
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
         LTORG                                                                  
...
*                                  GET PB PROFILE                               
         XC    SYSPROF,SYSPROF                                                  
         XC    PROFKEY,PROFKEY                                                  
         MVC   PROFKEY(4),=C'P0PB'                                              
         MVC   PROFKEY+4(3),QAGENCY      AGY/MED                                
...
PB3      DS    0H                                                               
         ...
         DC    H'0'                                                             
*                                                                               
         CLI   SYSPROF,C'Y'        BASE PUB REQUIRED ?                          
         BNE   PB3G                NO - CONTINUE                                
         OC    PUBKZON(2),PUBKZON  ANY ZONE OR EDITION ?                        
         BNZ   PB3G                YES - NOT A BASE PUB                         
*                       SEE IF THIS BASE PUB HAS ANY ZONES/EDITIONS             
         MVC   PUBKEYSV,KEY        SAVE FOR RESTORE                             
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(1),PUBKMED                                                   
         MVC   KEY+1(4),PUBKPUB                                                 
         ...
         MVI   KEY+9,X'81'                                                      
*                                                                               
         GOTO1 HIGHPUB             LOOK FOR RECORD                              
         CLC   KEY(10),KEYSAVE     FOUND?                                       
         BE    *+6                                                              
         DC    H'0'                MUST BE THERE                                
*                                                                               
         MVI   KEY+6,1          SET FOR NEXT PUB NUM HIGHER THAN BASE           
*                                                                               
         GOTO1 HIGHPUB             LOOK FOR RECORD                              
         CLC   KEY(05),KEYSAVE     SAME MEDIA AND BASE PUB NUMBER ?             
         BH    PB3C                NO - RESTORE SEQUENCE                        
         CLC   KEY+7(2),PUBKAGY    SAME AGENCY ?                                
         BNE   PB3C                NO - RESTORE SEQUENCE                        
*                       SET TABLE ENTRY TO PREVENT PURGING OF BASE PUB          
         L     RF,BSPARS                                                        
         MVI   7(RF),X'FF'         SET FOR NO PURGE                             
*                                                                               
PB3C     DS    0H                                                               
         CLI   KEY+1,X'99'         HIGHEST X'81' PUB NUM IS 99999999            
         BH    PB4                   DONE - NO MORE X'81' PUBS                  
*                                                                               
...
PB9D     DS    0H                                                               
         ...
         BNE   PB10                                                             
*                                                                               
         LA    RF,PBUYREC          READ INTO BUYREC AREA                        
         ST    RF,AREC                                                          
         GOTO1 GETPRT                                                           
         LA    R2,PBUYREC+33                                                    
         MVI   ELCODE1,X'20'       LIST PUB ELEMENT                             
         CLI   0(R2),X'20'                                                      
         BE    PB9H                                                             
PB9F     BAS   RE,NEXTEL                                                        
...
*                                                                               
         ...
         B     PK1X                                                             
*                                                                               
* SPECIAL FOR PROCESSING PURGEABLE RECORDS ONLY                                 
*                                                                               
PK1      DS    0H                                                               
...
PK1X     CLI   KEY+1,C'A'                                                       
         ...
         BE    PKNVT                                                            
         CLI   KEY+3,X'42'         I/OCOM RECS (USES SAME CODE AS NVT)          
         BE    PKNVT                                                            
         CLI   KEY+3,X'44'         CONCOM RECS (USES SAME CODE AS NVT)          
         BE    PKNVT                                                            
...
*                                                                               
         ...
         CLC   PKFLAG,=C'NVT'                                                   
         BE    PKNVT090                                                         
         CLC   PKFLAG,=C'IOC'      I/OCOM?                                      
         BE    PKNVT090                                                         
         CLC   PKFLAG,=C'CCM'      CONCOM?                                      
         BE    PKNVT090                                                         
         MVC   P,SPACES                                                         
         BAS   RE,RPRT             SKIP A LINE                                  
         B     *+8                                                              
PKNVT010 MVI   FORCEHED,C'Y'                                                    
         ...
         B     PKNVT030                                                         
*                                                                               
PKNVT020 MVC   P+00(03),=C'REC'    IT GOT TO BE I/OCOM OR CONCOM                
         MVC   P+08(03),=C'CLT'                                                 
         BAS   RE,RPRT                                                          
         MVC   P+00(06),=C'------'                                              
         MVC   P+08(03),=C'---'                                                 
         BAS   RE,RPRT                                                          
*                                                                               
PKNVT030 CLI   KEY+3,X'41'                                                      
         BNE   *+10                                                             
         MVC   PKFLAG,=C'NVT'      SET FLAG TO NVTEXT REC TYPE                  
         CLI   KEY+3,X'42'                                                      
         BNE   *+10                                                             
         MVC   PKFLAG,=C'IOC'      SET FLAG TO I/OCOM REC TYPE                  
         CLI   KEY+3,X'44'                                                      
         BNE   *+10                                                             
         MVC   PKFLAG,=C'CCM'      SET FLAG TO CONCOM REC TYPE                  
*                                                                               
PKNVT090 DS    0H                                                               
         MVC   PSECOND,SVPLINE     RESTORING 2ND P LINE                         
*                                                                               
         ...
         BNE   PKNVT095                                                         
         MVC   P(3),=C'NVT'                                                     
         MVC   P+5(3),KEY+4        GET CLIENT                                   
         B     PK2                                                              
*                                                                               
PKNVT095 MVC   P(6),=C'I/OCOM'                                                  
         CLI   KEY+3,X'42'         I/OCOM REC?                                  
         BE    *+10                                                             
         MVC   P(6),=C'CONCOM'                                                  
*                                                                               
         ...
         B     PK2                                                              
*                                                                               
         CLI   KEY+4,X'FF'         OFFICES?                                     
         BNE   *+18                                                             
         MVI   P+8,C'*'                                                         
         MVC   P+9(2),KEY+5        OFFICE CODE                                  
         B     PK2                                                              
*                                                                               
         MVC   P+8(3),KEY+4        CLIENT CODE                                  
         B     PK2                                                              
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
...
*                                                                               
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'038PPREP0102 02/23/15'                                      
         END                                                                    
