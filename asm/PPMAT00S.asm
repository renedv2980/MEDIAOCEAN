*          DATA SET PPMAT00S   AT LEVEL 062 AS OF 08/02/02                      
*PHASE T40200A                                                                  
*INCLUDE PUBVAL                                                                 
*INCLUDE PUBEDIT                                                                
*INCLUDE PUBFLOAT                                                               
...
BMPT4    ZIC   R1,0(R2)                                                         
         ...
         B     YES                                                              
         EJECT                                                                  
VAGY     B     XIT                 GET AGY REC IN MEDIA VALIDATION              
         SPACE 2                                                                
* VALIDATE MEDIA CODE *                                                         
         SPACE 1                                                                
...
VGETFLD4 LR    RE,R1               GET FLD LENGTH-1 IN R3                       
         ...
         BH    GTNOTNUM                                                         
*NOP*    MVC   WORK(6),=6X'F0'     TEST FOR NUMERIC FIELD                       
         MVC   WORK(8),=8X'F0'     TEST FOR NUMERIC FIELD (8 DIGITS)            
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVZ   WORK(0),8(R2)                                                    
*NOP*    CLC   WORK(6),=6X'F0'                                                  
...
LOCKPUB  DS    XL4                 BASE PUB ONLY                                
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'062PPMAT00S  08/02/02'                                      
         END                                                                    
