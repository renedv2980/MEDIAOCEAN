*          DATA SET DELDEXTST  AT LEVEL 063 AS OF 05/01/02                      
*PHASE DELDETST,+0                                                              
*INCLUDE LOGIO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*******************************************************************             
* DELETES  ALL DATA PRIOR TO 96  (OUTPUT IS NEW DEMFILN)                        
*******************************************************************             
...
*                                                                               
********************************************************************            
         MVC   STBK,=X'5B00'       PULL OFF: 91-96                              
         MVC   ENDBK,=X'600B'                                                   
*                                                                               
         MVC   STXORBK,STBK                                                     
         MVC   ENXORBK,ENDBK                                                    
...
DMX_A    CLI   0(R3),C'A'          'A' - RECDS?                                 
         BE    DMXSAVE             NO BOOK IN KEY, GET RID OF IT                
*                                                                               
...
*                                                                               
         ...
         BNE   DMXPURGE                                                         
*                                                                               
         L     R1,0(R2)            ADD RECD TO NEW DEMFILE                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'063DELDEXTST 05/01/02'                                      
         END                                                                    
