*          DATA SET CTLFM0CA   AT LEVEL 007 AS OF 07/06/92                      
*PHASE TA020CA                     **PHASE CHANGED TO -A                        
*INCLUDE EXPRESS                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
...
DISPDSC  SR    R6,R6                                                            
         ...
         B     DISP4                                                            
         EJECT                                                                  
* DISPLAY POST EDIT ELEMENT                                                     
*                                                                               
DISPPE   SR    R6,R6                                                            
         MVC   FLDPEDT(1),2(R5)                                                 
         LA    R6,1                                                             
         STC   R6,FLDPEDTH+7        SET LENGTH =1                               
         OI    FLDPEDTH+6,X'80'     AND TRANSMIT                                
         B     DISP4                                                            
         EJECT                                                                  
...
DATAV2   MVI   TEMP,X'01'          IF CHANGE DELETE ACTIVITY/DESC               
         ...
         MVI   TEMP,X'02'                                                       
         GOTO1 ADELEL                                                           
         MVI   TEMP,X'71'          IF CHANGE DELETE POST EDIT ELEM              
         GOTO1 ADELEL                                                           
...
DATAV4   LA    R1,FLDDSCH                                                       
         GOTO1 AFVAL                                                            
         BZ    DATAV5              OPTIONAL INPUT FIELD                         
         SR    R5,R5                                                            
         IC    R5,FLDH+5                                                        
         BCTR  R5,0                                                             
         XC    TEMP,TEMP                                                        
         ...
         GOTO1 APUTEL                                                           
         BZ    EXIT                                                             
*                                  BUILD POST EDIT ELEMENT                      
DATAV5   LA    R1,FLDPEDTH                                                      
         GOTO1 AFVAL                                                            
         BZ    DATAV6              OPTIONAL INPUT FIELD                         
         XC    TEMP,TEMP                                                        
         MVC   TEMP+2(1),FLD       Y/N VALUE                                    
         MVI   TEMP+1,X'08'        FIXED LENGTH OF 8                            
         MVI   TEMP,X'71'          CODE                                         
         GOTO1 APUTEL                                                           
         BZ    EXIT                                                             
...
* FASYSLSTD                                                                     
       ...
       ++INCLUDE FASYSLSTD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007CTLFM0CA  07/06/92'                                      
         END                                                                    
