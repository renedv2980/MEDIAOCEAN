*          DATA SET RESFM15    AT LEVEL 087 AS OF 05/01/02                      
*PHASE T81815A,*                                                                
...
VK52     EQU   *                                                                
         GOTO1 VALISTA             MEDIA IS IN WORK+4 ON EXIT                   
*                                                                               
*** DON'T ALLOW FM OR AM, COMBO ONLY!!!                                         
*                                                                               
         MVC   CONHEAD+10(L'COMBONLY),COMBONLY                                  
         CLI   WORK+4,C'C'         IS IT A COMBO?                               
         BNE   MYEND               NO, ERROR                                    
***                                                                             
         MVC   STATN,WORK                                                       
         MVI   RDUPDATE,C'N'                                                    
...
*                                                                               
         ...
         LA    RE,AUCSTAH          GET LENGTH OF INPUT                          
         ZIC   RF,5(RE)                                                         
...
COMBONLY DC    C'ONLY COMBO STATIONS ALLOWED'                                   
         EJECT                                                                  
...
*TVB TABLE                                                                      
       ++INCLUDE RETVBTAB                                                       
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'087RESFM15   05/01/02'                                      
         END                                                                    
