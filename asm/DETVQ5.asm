*          DATA SET DETVQ5     AT LEVEL 247 AS OF 02/23/07                      
*PHASE DETVQ5A                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE DATCON                                                                 
*INCLUDE PRINT                                                                  
...
***********************************************************************         
* THE PROGRAM PROCESSES THE 18 INPUT FILES IN THIS ORDER:             *         
* 1 - ADULTS PRIMETIME          INA1                                  *         
* 2 - ADULTS CHILDREN           INA2                                  *         
* 3 - ADULTS DAYTIME            INA3                                  *         
* 4 - ADULTS NEWS               INA4                                  *         
* 5 - ADULTS SPORTS             INA5                                  *         
* 6 - ADULTS LATE NIGHT         INA6                                  *         
* 7 - MEN PRIMETIME             INM1                                  *         
* 8 - MEN CHILDREN              INM2                                  *         
* 9 - MEN DAYTIME               INM3                                  *         
* 10- MEN NEWS                  INM4                                  *         
* 11- MEN SPORTS                INM5                                  *         
* 12- MEN LATE NIGHT            INM6                                  *         
* 13- WOMEN PRIMETIME           INW1                                  *         
* 14- WOMEN CHILDREN            INW2                                  *         
* 15- WOMEN DAYTIME             INW3                                  *         
* 16- WOMEN NEWS                INW4                                  *         
* 17- WOMEN SPORTS              INW5                                  *         
* 18- WOMEN LATE NIGHT          INW6                                  *         
***********************************************************************         
DETVQ    CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 500,DETVQ,=V(REGSAVE),R6,R7                                      
*                                                                               
         L     RA,=V(CPRINT)                                                    
         USING DPRINT,RA                                                        
*                                                                               
...
*                                                                               
         ...
         XCEF                                                                   
*                                                                               
         MVI   RETCODE,RETOK       INITIALIZA RETURN CODE TO OK                 
*                                                                               
...
ENDJOB   DS    0C                                                               
         B     CLSE                                                             
CLSE     CLI   FILESW,18           18 FILES IN TOTAL                            
         BE    CLSE2                                                            
         ZIC   RE,FILESW                                                        
         LA    RE,1(RE)                                                         
         STC   RE,FILESW                                                        
...
NETTAB   DS    0CL(L'TVQNET+L'DDSNET)                                           
         ...
         DC    CL8'CBS     ',CL4'CBS '                                          
         DC    CL8'FOX     ',CL4'FOX '                                          
         DC    CL8'MY NET  ',CL4'MNT '                                          
         DC    CL8'NBC     ',CL4'NBC '                                          
         DC    CL8'NICK    ',CL4'NICK'                                          
         DC    CL8'SYN     ',CL4'SYN '                                          
         DC    CL8'UPN     ',CL4'UPN '                                          
         DC    CL8'ION     ',CL4'ION '                                          
         DC    CL8'THE WB  ',CL4'WB  '                                          
         DC    X'FF'                                                            
*                                                                               
         DS    F                                                                
DPTSTAB  DC    AL1(DPRIME),C'PRI',A(PRIME)       DAYPARTS TABLE                 
         DC    AL1(DCHILD),C'KID',A(KID)                                        
...
RADULTS  DC    AL1(RADULTSE-*)                                                  
         ...
         DC    AL1(TQNTI)                                                       
         DC    AL1(TQDPT)                                                       
         DC    AL1(ISAMP,TSAMP,FSAMP)                                           
         DC    AL1(IV0611,TV0611,FV0611)                                        
         DC    AL1(IV1217,TV1217,FV1217)                                        
         DC    AL1(IV0617,TV0617,FV0617)                                        
...
PRTABD   DSECT                     DSECT TO COVER TABLE OF PROGRAMS             
                                                                                
       ++INCLUDE DDDPRINT                                                       
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'247DETVQ5    02/23/07'                                      
         END                                                                    
