*          DATA SET REVIEW13   AT LEVEL 006 AS OF 09/21/05                      
*          DATA SET REVIEW13   AT LEVEL 004 AS OF 11/19/99                      
*          DATA SET REVIEW13   AT LEVEL 027 AS OF 11/08/96                      
*PHASE T81713A                                                                  
VIEW13   TITLE 'K3 REPORT FOR VIEWER'                                           
VIEW13   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,REVIEW13,R7,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
         L     R8,AGWORK                                                        
         USING GWORKD,R8                                                        
...
***********************************************************************         
         SPACE 1                                                                
DISGRP   MVC   FVIFLD(L'REK3GRP),FLTIFLD                                        
         B     EXITOK                                                           
         SPACE 1                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
DOFQTR   OC    REK3TOT,REK3TOT                                                  
         BZ    FLTXX               NOT A TOTAL LINE                             
*                                                                               
         CLC   REK3PRD+1(1),FLTIFLD                                             
         BL    FLTXL                                                            
         BE    FLTXE                                                            
         BH    FLTXH                                                            
         DROP  R2                                                               
...
DLIN00   LH    R1,LSROWREP                                                      
         ...
         BH    DLIN02                                                           
*                                                                               
         MVC   IOKEY,REK3KEY       SET CURRENT RECORD INTO IO2                  
...
*                                                                               
         ...
         CLC   REK3DSCT(REK3RNK-REK3DSCT),REC.REK3DSCT                          
...
*                                                                               
         ...
         CLC   REK3ADAG-REK3KEY(L'REK3ADAG,RF),REC.REK3ADAG                     
         BNE   DLIN10              YES                                          
*                                                                               
...
DLIN10   CLI   FRSTLINE,C'1'       FIRST LINE ONLY DISPLAYED?                   
         ...
         CLC   REC.REK3ADV,BCEFFS  ALL/ALL?                                     
         BNE   *+14                NO                                           
         CLC   REC.REK3AGY,BCEFFS  DON'T SHOW SECOND 'ALL'                      
         BE    DLIN12                                                           
         GOTOX DOAGY,BOPARM,AIO1                                                
         MVC   L1.L2AGY,BOWORK1                                                 
...
*                                                                               
         L     R4,AIO1                                                          
         CLC   REC.REK3AGY,BCEFFS  RANK - NO DISPLAY IF 'ALL'                   
         BNE   *+14                                                             
         CLC   REC.REK3ADV,BCEFFS                                               
         BE    DLIN18                                                           
*                                                                               
         XR    RF,RF                                                            
         ICM   RF,15,REC.REK3RNK                                                
         CURED (RF),(4,L1.L1RANK),0,DMCB=BOPARM,ALIGN=LEFT                      
*                                                                               
DLIN18   GOTOX DOADV,BOPARM,AIO1   ** ADVERTISER                                
         MVC   L1.L1ADV,BOWORK1                                                 
         MVI   FRSTLINE,C'1'       SET DISPLAYED LINE 1                         
*                                                                               
DLIN20   GOTOX DOLINE,BOPARM,FVIFLD,(R4)                                        
         L     R4,AIO2                                                          
         MVC   LSLASKEY,0(R4)      SAVE THIS KEY                                
         B     EXITOK                                                           
*                                                                               
...
GETDATE  NTR1  ,                                                                
         XC    IOKEY,IOKEY                                                      
X        USING REK3KEY,IOKEY                                                    
         L     RF,AIOREC                                                        
         USING REK3KEY,RF                                                       
         MVC   X.REK3RPT,=AL2(REK3RPTQ)                                         
         MVC   X.REK3REP,CUAALF                                                 
...
X        USING RAGYRECD,IOKEY                                                   
         MVI   X.RAGYKTYP,X'0A'                                                 
         MVC   X.RAGYKAGY,REK3AGY                                               
         MVC   X.RAGYKAOF,REK3AGY+L'RAGYKAGY                                    
...
*                               ** PERIOD IS YYMM BINARY                        
         ...
         CLI   REK3PRD+1,X'0D'      IF MM IS 'OD' THIS IS A YRLY TOTAL          
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         MVC   L1PED(L'ALL),ALL                                                 
         CLI   REK3PRD+1,FF         IF MM IS 'FF' PUT OUT 'ALL'                 
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         ...
         MVI   L1PED+2,C'4'                                                     
*                                                                               
DOL00    OC    REK3TOT,REK3TOT      IF SET THIS IS SUB-TOTAL LINE               
         BNZ   DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         XR    RF,RF                                                            
...
DOL06    IC    RE,R3PBILN                                                       
         ...
         B     DOL04                                                            
*                                                                               
         LA    R1,L'L1PRIFIN       WIDTH OF COLUMN FOR RIGHT ALIGN              
         SR    R1,RE                                                            
         LA    R1,L1PRIFIN(R1)                                                  
         BCTR  RE,0                                                             
         EX    RE,*+4                                                           
...
DOL08    IC    RE,R3CBILN                                                       
         ...
         B     DOL04                                                            
*                                                                               
         LA    R1,L'L1CURFIN       WIDTH OF COLUMN FOR RIGHT ALIGN              
         SR    R1,RE                                                            
         LA    R1,L1CURFIN(R1)                                                  
         BCTR  RE,0                                                             
         EX    RE,*+4                                                           
...
DOL10    IC    RE,R3PSHLN                                                       
         ...
         B     DOL04                                                            
*                                                                               
         LA    R1,L'L1PRISHR       WIDTH OF COLUMN FOR RIGHT ALIGN              
         SR    R1,RE                                                            
         LA    R1,L1PRISHR(R1)                                                  
         BCTR  RE,0                                                             
         EX    RE,*+4                                                           
...
DOL12    IC    RE,R3CSHLN                                                       
         ...
         B     DOL04                                                            
*                                                                               
         LA    R1,L'L1CURSHR       WIDTH OF COLUMN FOR RIGHT ALIGN              
         SR    R1,RE                                                            
         LA    R1,L1CURSHR(R1)                                                  
         BCTR  RE,0                                                             
         EX    RE,*+4                                                           
...
DOL14    IC    RE,R3PCTLN                                                       
         ...
         B     DOL04                                                            
*                                                                               
         LA    R1,L'L1PCT          WIDTH OF COLUMN FOR RIGHT ALIGN              
         SR    R1,RE                                                            
         LA    R1,L1PCT(R1)                                                     
         BCTR  RE,0                                                             
         EX    RE,*+4                                                           
...
*                                                                               
         L     R2,AIO1                                                          
         USING REK3KEY,R2                                                       
         TM    LSLTIND1,LSLTIBLD   STARTED LIST BUILD?                          
         BZ    EXITOK              NO                                           
*                                                                               
         LA    R4,FVIFLD                                                        
         MVC   FVIFLD,BCSPACES                                                  
...
SCRL02   MVC   0(L'GROUP,R4),GROUP                                              
         MVI   L'GROUP(R4),C'='                                                 
         LA    R4,L'GROUP+1(R4)                                                 
         MVC   0(L'REK3GRP,R4),REK3GRP                                          
         CLC   REK3GRP,BCSPACES   IS THIS FOR ALL GROUPS?                       
         BH    SCRL04             NO                                            
         MVC   0(L'ALL,R4),ALL                                                  
         LA    R4,L'ALL(R4)                                                     
         B     *+8                                                              
SCRL04   LA    R4,L'REK3GRP(R4)                                                 
         MVI   0(R4),C','                                                       
         LA    R4,1(R4)                                                         
*                               ** STATION FILTER                               
...
*                               ** OFFICE FILTER                                
         ...
         MVI   L'OFFICE(R4),C'='                                                
         LA    R4,L'OFFICE+1(R4)                                                
         MVC   0(L'REK3OFF,R4),REK3OFF                                          
         CLC   REK3OFF,BCEFFS     IS THIS FOR ALL OFFICES?                      
         BNE   *+10               NO                                            
         MVC   0(L'ALL,R4),ALL                                                  
*                                                                               
...
NLST02   L     RF,AIOREC           I/S RETURNS INTO RECORD BUFFER               
         CLC   0(REK3GRP-REK3KEY,RF),0(R2)                                      
         BNE   EXITL               MAKE SURE SAME REPORT/REP                    
*                                                                               
         CLC   =C'DATES=',REK3STN-REK3KEY(RF)                                   
         BE    NLST                                                             
*                                                                               
...
FF       EQU   X'FF'                                                            
         SPACE 1                                                                
FILTTAB  DC    AL2(00001),AL1(REK3GRP-REK3DSCT,L'REK3GRP)                       
         DC    AL2(00002),AL1(REK3STN-REK3DSCT,L'REK3STN)                       
         DC    AL2(00003),AL1(REK3OFF-REK3DSCT,L'REK3OFF)                       
         DC    AL2(00005),AL1(REK3RNK-REK3DSCT,L'REK3RNK)                       
         DC    AL2(EOT)                                                         
*                                                                               
MEDTAB   DC    CL2'TV'                                                          
         DC    CL2'AM'                                                          
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006REVIEW13  09/21/05'                                      
         END                                                                    
