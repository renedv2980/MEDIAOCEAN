*          DATA SET DETR12I    AT LEVEL 004 AS OF 01/02/19                      
*PROCESS USING(WARN(15))                                                        
*PHASE DETR12IA                                                                 
         TITLE 'TRITON RADIO CONVERSION IPHASE'                                 
**********************************************************************          
* THIS MODULE WAS COPIED FROM THE ARBITRON IPHASE DERA08I. SOME CODE            
...
RA000    DS    0H                  COPYRIGHT RECORD                             
         USING PADSECT,R4                                                       
* BEN 10/1/2018 WE SHOULD RESET EVEYTIME WHEN PROCESSING NEW FILE               
*                                                                               
         MVI   RLSIFLG,0                                                        
         L     RE,ASTALIST                                                      
         L     RF,=A(STALISTL)     CLEAR STATION LIST                           
         XCEF                                                                   
* RESET CAL LETTER TABLE EVERYTIME PROCESSING NEW FILE                          
         LHI   R0,MXCLCS                                                        
         L     RE,ACLCTAB                                                       
         L     RF,=A(CLCTABL)     CLEAR STATION LIST                            
         XCEF                                                                   
*                                                                               
         DS    0H                                                               
         BAS   RE,CNVPERID                                                      
...
*                                                                               
         ...
         CLI   PJSTTN,C' '         LEFT ALIGN 3-CHARACTER STATIONS              
         BNE   *+14                                                             
         MVC   CURRSTA(3),PJSTTN+1                                              
         MVI   CURRSTA+3,C' '                                                   
*                                                                               
*&&DO                                                                           
...
*&&                                                                             
         MVI   CURRSTA+4,C'S'     TRITON DATA WILL BE LOADED AS BAND S          
...
CNVRP027 DS    0H                                                               
         ...
         B     CNVRP027                                                         
*&&DO                                                                           
* PPM TABLE ONLY APPLIES TO ARBITRON                                            
         L     RF,ACOMFACS                                                      
...
CNVRP035 CLC   CURRBOOK,PPMSTRTP                                                
         ...
         MVC   SAMPLEBT,2(R3)                                                   
         B     CNVRPX                                                           
****CNVRP040 LA    R2,PPMTABQ(R2)                                               
CNVRP040 AR    R2,R0                                                            
         B     CNVRP028                                                         
*&&                                                                             
CNVRP050 MVC   SAMPLEBT,3(R3)                                                   
         CLI   HOLIDAY,1           HOLIDAY BOOK                                 
         BNE   CNVRPX                                                           
*&&DO                                                                           
         CLI   SAMPLEBT,0                                                       
         BE    *+6                                                              
         DC    H'0'                NOT EXPECTING ANYTHING BUT BTYPE 0           
         MVI   SAMPLEBT,C'D'                                                    
*&&                                                                             
         CLI   SAMPLEBT,0                                                       
         BNE   *+12                                                             
...
GETBTYP2 CLC   0(2,RE),=C'AR'      USE THE SAME MARKT TABLE AS ARBITRON         
         BE    GETBTYP4                                                         
...
*                                                                               
         DROP  R2                                                               
***********************************************************************         
         TITLE 'CONVERSION INITIALIZATION'                                      
***********************************************************************         
*======================= INITIALIZATION ==============================*         
DERAINIT NTR1                                                                   
...
***********************************************************************         
         ...
         TITLE 'TRITON DEMO CONVERSION (CLEAR DEMO VALUE MATRIX)'               
***********************************************************************         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (GET DEMO NUMBER && QUALIT+        
               ATIVE CATEGORY NUMBER)'                                          
***********************************************************************         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (SEED DEMO VALUE)'                 
***********************************************************************         
*========================== SEED DEMO VALUE ==========================*         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (EXTRACT DEMO VALUE)'              
***********************************************************************         
*========================= EXTRACT DEMO VALUE ========================*         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (BUILD INTERIM RECORD)'            
***********************************************************************         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (RELEASE INTERIM RECORD)'          
***********************************************************************         
...
EXIT     XMOD1 1                                                                
XIT      XIT1                                                                   
         TITLE 'TRITON RADIO DEMO CONVERSION (LTORG && CONSTANTS)'              
***********************************************************************         
*========================= LTORG & CONSTANTS =========================*         
         LTORG                                                                  
         EJECT                                                                  
...
**********************************************************************          
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION ("SAVED" STORAGE)'                 
***********************************************************************         
*========================== "SAVED" STORAGE ==========================*         
...
**********************************************************************          
         DROP  R8,RA,RB,RC                                                      
         TITLE 'TRITON RADIO DEMO CONVERSION (EQUATES)'                         
***********************************************************************         
*============================== EQUATES ==============================*         
...
***********************************************************************         
         TITLE 'TRITON RADIO DEMO CONVERSION (TABLES)'                          
***********************************************************************         
*=============================== TABLES ==============================*         
...
ESUBJ    DS    0CL70               EMAIL SUBJECT                                
         DC    AL2(ESUBJEQU)                                                    
         DC    H'0'                                                             
         DC    C'SUBJECT=TRITON MARKETS LOADED FOR: '                           
ESUBJBK  DS    0CL9                                                             
ESUBJSN  DC    CL6' '                                                           
ESUBJSL  DC    C' '                                                             
ESUBJYR  DC    CL2' '                                                           
...
DISPTAB  DS    0XL(1+3+1+2)                                                     
         DC     C'B',AL3(RTYPGOTB-DETR12I),C'L',AL2(ARTYPGOT-LOCWORKD)          
         DC     C'B',AL3(SAMBTTAB-DETR12I),C'L',AL2(ASAMBTTB-LOCWORKD)          
         DC     C'B',AL3(RPTDSPTB-DETR12I),C'L',AL2(ARPTDSPT-LOCWORKD)          
         DC     C'B',AL3(PERDSPTB-DETR12I),C'L',AL2(APERDSPT-LOCWORKD)          
         DC     C'B',AL3(MKTDSPTB-DETR12I),C'L',AL2(AMKTDSPT-LOCWORKD)          
         DC     C'B',AL3(STNDSPTB-DETR12I),C'L',AL2(ASTNDSPT-LOCWORKD)          
         DC     C'B',AL3(DPTDSPTB-DETR12I),C'L',AL2(ADPTDSPT-LOCWORKD)          
         DC     C'B',AL3(BOOKEQ-DETR12I),C'L',AL2(ABOOKEQ-LOCWORKD)             
         DC     C'B',AL3(DEMODEFN-DETR12I),C'L',AL2(ADEMODEF-LOCWORKD)          
         DC     C'B',AL3(QCATDEFN-DETR12I),C'L',AL2(AQCATDEF-LOCWORKD)          
         DC     C'B',AL3(DEMQCTAB-DETR12I),C'L',AL2(ADEMQCTB-LOCWORKD)          
         DC     C'B',AL3(CVDSPTAB-DETR12I),C'L',AL2(ACVDSPTB-LOCWORKD)          
         DC     C'B',AL3(DPTTAB-DETR12I),C'L',AL2(ADPTTAB-LOCWORKD)             
         DC     C'B',AL3(UPCASETB-DETR12I),C'L',AL2(AUPCSETB-LOCWORKD)          
         DC     C'B',AL3(UNIVS-DETR12I),C'L',AL2(AUNIVS-LOCWORKD)               
         DC     C'B',AL3(STALIST-DETR12I),C'L',AL2(ASTALIST-LOCWORKD)           
         DC     C'B',AL3(CLCTAB-DETR12I),C'L',AL2(ACLCTAB-LOCWORKD)             
         DC     C'B',AL3(SCITAB-DETR12I),C'L',AL2(ASCITAB-LOCWORKD)             
         DC     C'B',AL3(DVMATRIX-DETR12I),C'L',AL2(ADVMATRX-LOCWORKD)          
         DC     C'B',AL3(PREVREC-DETR12I),C'L',AL2(APREC-LOCWORKD)              
         DC     C'B',AL3(SVSREC-DETR12I),C'L',AL2(ASVSREC-LOCWORKD)             
         DC     C'B',AL3(SVSREC2-DETR12I),C'L',AL2(ASVSREC2-LOCWORKD)           
DISPTABQ EQU   ((*-DISPTAB)/(L'DISPTAB))                                        
         EJECT                                                                  
RTYPGOTB DS    0XL(1+2)            RECORD TYPE PROCESS-ROUTINE DSPLCMNT         
         DC     C'A',AL2(RA000-DETR12I)                                         
         DC     C'D',AL2(RD000-DETR12I)                                         
         DC     C'G',AL2(RG000-DETR12I)                                         
         DC     C'H',AL2(RH000-DETR12I)                                         
         DC     C'J',AL2(RJ000-DETR12I)                                         
         DC     C'M',AL2(RM000-DETR12I)                                         
         DC     C'P',AL2(RP000-DETR12I)                                         
         DC     C'S',AL2(RS000-DETR12I)                                         
         DC     C'V',AL2(RV000-DETR12I)                                         
         DC    AL1(EOT)                                                         
...
*   SEE  DPTTABD  FOR DESCRIPTION                                               
         ...
         ORG   DETR12I+((((*-DETR12I)+X'000F')/X'0010')*X'0010')                
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (DEDEMCNVD)'                       
***********************************************************************         
*============================= DEDEMCNVD =============================*         
       ++INCLUDE DEDEMCNVD                                                      
***********************************************************************         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (DEINTD)'                          
***********************************************************************         
*=============================== DEINTD ==============================*         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (INTERIM RECORD)'                  
***********************************************************************         
*=========================== INTERIM RECORD ==========================*         
CDSCT    DSECT                                                                  
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (DEDEMFILE)'                       
***********************************************************************         
*============================= DEDEMFILE =============================*         
         PRINT OFF                                                              
       ++INCLUDE DEDEMFILE                                                      
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (LOCAL WORK AREA)'                 
***********************************************************************         
*========================== LOCAL WORK AREA ==========================*         
...
***********************************************************************         
         ...
         TITLE 'TRITON RADIO DEMO CONVERSION (OTHER DSECTS)'                    
***********************************************************************         
*============================ OTHER DSECTS ===========================*         
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004DETR12I   01/02/19'                                      
         END                                                                    
