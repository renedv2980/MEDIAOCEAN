*          DATA SET PRSFM32    AT LEVEL 178 AS OF 03/16/09                      
*PHASE T41C32A                                                                  
*INCLUDE SRCHCALL                                                               
*INCLUDE PUBEDIT                                                                
*INCLUDE NUMED                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE PPBROWSE                                                               
*        TITLE 'T41C32 AGENCY CONTACT LIST RECORDS'                             
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS'                             
***********************************************************************         
*                                                                     *         
*         CHANGE LOG                                                  *         
...
*                                                                               
* SMYE  07/05    ADD SUPPRESS COST FIELD (CCALSUP) AND MODIFY LIST              
*                  FUNCTION DISPLAY/FILTERING AND DISPLAY KEY FUNCTION          
*                                                                               
* BOBY  04/04    BIG BANG                                                       
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - INIT'                      
***********************************************************************         
*                                                                     *         
*        INITIALISATION                                               *         
*                                                                     *         
...
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - ANAL'                      
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - VK'                        
***********************************************************************         
*                                                                     *         
*        VALIDATE KEY                                                 *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R4,KEY                                                           
         USING CCARECD,R4          ESTABLISH AGENCY CONTACT LIST KEY            
*                                                                               
         MVC   CCAKAGY,AGENCY      AGENCY                                       
         MVC   CCAKMED,QMED        MEDIA                                        
         MVI   CCAKRCD,CCAKRCDQ    RECORD TYPE                                  
         MVC   CCAKCLT,QCLT        CLIENT                                       
         MVC   CCAKPRD,QPRD        PRODUCT                                      
         MVC   CCAKPUB,BPUB        PUB                                          
*                                                                               
* * * * * * * * BELOW NOT IN USE A/O 03/13/09 * * * * * * * * * * * * *         
******   MVC   CCAKPID,QPID        USER ID                                      
* * * * * * * * ABOVE NOT IN USE A/O 03/13/09 * * * * * * * * * * * * *         
*                                                                               
         MVC   ORIGKEY,KEY         SAVE THIS KEY (USE WITH LIST)                
*                                                                               
         CLC   TWAKEYSV(L'CCAKEY),KEY    CHECK FOR NEWKEY                       
         BE    *+8                                                              
         MVI   NEWKEY,C'Y'                                                      
*                                                                               
         B     VKX                                                              
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - VKL'                       
***********************************************************************         
*                                                                     *         
*        VALIDATE LIST KEY                                            *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - MYPUBVAL'                  
***********************************************************************         
*                                                                     *         
*        VALIDATE PUB FIELD                                           *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - DK'                        
***********************************************************************         
*                                                                     *         
*        DISPLAY KEY                                                  *         
*                                                                     *         
...
*                                                                               
         XC    SCRMED,SCRMED                                                    
         MVC   SCRMED(L'CCAKMED),CCAKMED   MEDIA                                
         MVI   SCRMEDH+5,L'CCAKMED SET INPUT LENGTH                             
...
*                                                                               
         XC    SCRCLT,SCRCLT                                                    
         MVC   SCRCLT(L'CCAKCLT),CCAKCLT      CLIENT                            
         MVI   SCRCLTH+5,L'CCAKCLT SET INPUT LENGTH                             
*                                                                               
...
*                                                                               
         CLC   CCAKCLT,=X'FFFFFF'  IF ALL CLIENTS                               
         BNE   DKCLTX                                                           
*                                                                               
         MVC   CLTNM,SPACES                                                     
         MVC   SCRCLT(3),=C'ALL'                                                
...
*                                                                               
         XC    SCRPRD,SCRPRD                                                    
         MVC   SCRPRD(L'CCAKPRD),CCAKPRD      PRODUCT                           
         MVI   SCRPRDH+5,L'CCAKPRD SET INPUT LENGTH                             
*                                                                               
...
*                                                                               
         CLC   CCAKPRD,=X'FFFFFF'  IF ALL PRODUCTS                              
         BNE   DKPRDX                                                           
*                                                                               
         MVC   PRDNM,SPACES                                                     
         MVC   SCRPRD(3),=C'ALL'                                                
...
*                                                                               
         OC    CCAKPUB,CCAKPUB     SKIP IF NO PUB                               
         BZ    DKPUBX                                                           
*                                                                               
         CLI   CCAKPUB,X'FF'       "ALL" PUBS ?                                 
         BNE   DKPUBED             NO                                           
         MVC   SCRPUB(3),=C'ALL'                                                
...
*                                                                               
DKPUBED  DS    0H                                                               
         GOTO1 =V(PUBEDIT),DMCB,CCAKPUB,(C'S',SCRPUB),RR=RELO                   
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - VR'                        
***********************************************************************         
*                                                                     *         
*        VALIDATE RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R3,SVEBASE                                                       
         USING CCAEBASD,R3         ESTABLISH BASE ADDRESS ELEMENT               
*                                                                               
         MVI   CCAEBCDE,CCAEBIDQ   SET ELEMENT CODE                             
         MVI   CCAEBLEN,CCAEBLQ    SET basic ELEMENT LENGTH                     
*                                                                               
...
*                                                                               
         ...
         BNO   *+8                                                              
         OI    SVACH1,CCAAEBCH        EBASE CHANGED                             
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   CCAEBASE(0),0(R1)   SAVE DOMAIN NAME                             
*                                                                               
         LR    R0,RF               SAVE EXECUTE LENGTH                          
*                                                                               
         AHI   RF,CCAEBLQ+1        CALCULATE TRUE ELM LENGTH                    
         STC   RF,CCAEBLEN         SET ELEMENT LENGTH                           
*                                                                               
...
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),CCAEBASE RE-DISPLAY INPUT                             
*                                                                               
...
*                                                                               
         ...
         USING CCAEBASD,R3         ESTABLISH E-BASE ELEMENT                     
*                                                                               
         L     R6,AIO1             GET RECORD ADDRESS                           
         ST    R6,DMCB             PASS TO RECUP                                
         MVI   DMCB,X'FE'          INDICATE SPECIAL SYSTEM                      
*                                                                               
         LA    R6,CCAFIRST-CCAREC(R6)    POINT TO FIRST ELEMENT IN REC          
         GOTO1 VRECUP,DMCB,,(R3),(C'R',(R6)),=AL2(33,25,4000) ADD ELM           
*                                                                               
VREBAS30 DS    0H                                                               
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - DR'                        
***********************************************************************         
*                                                                     *         
*        DISPLAY  RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         USING CCAEBASD,R6         ESTABLISH AS E-MAIL BASE ELEMENT             
*                                                                               
         LA    R2,SCRBASH          POINT TO FIELD ON SCREEN                     
         USING FLDHDRD,R2          ESTABLISH BASIC FIELD                        
*                                                                               
...
*                                                                               
         MVI   ELCODE,CCAEBIDQ     LOOK FOR E-BASE ELM                          
         BRAS  RE,GETEL            FIND IN RECORD                               
         BNE   DREBASOK            SKIP IF NONE FOUND                           
*                                                                               
         SR    RF,RF                                                            
         IC    RF,CCAEBLEN         GET ELEMENT LENGTH                           
         SHI   RF,CCAEBLQ          SUBTRACT BASIC ELM LENGTH                    
         BNP   DREBASOK                                                         
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),CCAEBASE    DISPLAY E-MAIL BASE                       
*                                                                               
DREBASOK DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - RDEL'                      
***********************************************************************         
*                                                                     *         
*        DELETE   RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R3,SVACTELM                                                      
         USING CCAACTHD,R3         ESTABLISH ACTIVITY ELM                       
*                                                                               
         MVI   CCAACDE,CCAAIDQ     SET ELEMENT CODE                             
         MVI   CCAALEN,CCAACTLQ    SET ELEMENT LENGTH                           
*                                                                               
         GOTO1 DATCON,DUB,(5,0),(3,CCAADTE) SET TODAY'S DATE                    
*                                                                               
         MVC   CCAAPID,SVPID       SET CHANGER'S PID                            
         MVC   CCAASCID,SVSCID     SET CHANGER'S SECURITY PID                   
*                                                                               
         OI    SVACH1,CCAADEL      SET RECORD DELETED                           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - RR'                        
***********************************************************************         
*                                                                     *         
*        RESTORE  RECORD                                              *         
*                                                                     *         
...
*        ADD ACTIVITY ELEMENT                                                   
*                                                                               
         OI    SVACH1,CCAARES      SET RECORD RESTORED                          
*                                                                               
         BRAS  RE,ACTPUT           ADD ACTIVITY ELEMENT                         
*                                                                               
RRX      DS    0H                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - LR'                        
***********************************************************************         
*                                                                     *         
*        LIST RECRDS                                                  *         
*                                                                     *         
...
*                                                                               
         MVC   CCAKAGY,AGENCY      AGENCY                                       
         MVC   CCAKMED,QMED        MEDIA CODE                                   
         MVI   CCAKRCD,CCAKRCDQ    TYPE                                         
*                                                                               
         MVC   CCAKCLT,QCLT           CLIENT                                    
*                                                                               
         MVC   CCAKPRD,QPRD           PRODUCT                                   
...
*                                                                               
         TM    CCADCNTL,CCACDELQ   SKIP DELETED RECORDS                         
         BO    LRCONT2                                                          
*                                                                               
         CLC   CCAKEY(CCAKCLT-CCAKEY),KEYSAVE  DONE AT END OF MEDIA             
         BNE   LRDONE                                                           
*                                                                               
         CLC   CCAKAGY,AGENCY      FILTER ON AGENCY                             
         BNE   LRCONT2                                                          
*                                                                               
         CLI   CCAKRCD,CCAKRCDQ    FILTER ON RECORD CODE                        
         BNE   LRCONT2                                                          
*                                                                               
...
*                                                                               
         ...
         BNZ   LRPUBW              YES                                          
*                                                                               
         CLC   CCAKPBCD,BPUB       FILTER ON BASE PUB ONLY                      
         BE    LRPUBX                                                           
*                                                                               
LRPUBW   DS    0H                                                               
*                                                                               
         CLC   CCAKPUB,BPUB        FILTER ON WHOLE PUB                          
         BNE   LRCONT2                                                          
*                                                                               
LRPUBX   DS    0H                                                               
*                                                                               
...
*        DISPLAY CLIENT                                                         
*                                                                               
         MVC   LCLT,CCAKCLT        CLIENT                                       
*                                                                               
         CLC   CCAKCLT,=X'FFFFFF'                                               
         BNE   *+10                                                             
         MVC   LCLT,=C'ALL'                                                     
*                                                                               
*        DISPLAY PRODUCT                                                        
*                                                                               
         MVC   LPRD,CCAKPRD        PRODUCT                                      
*                                                                               
         CLC   CCAKPRD,=X'FFFFFF'                                               
         BNE   *+10                                                             
         MVC   LPRD,=C'ALL'                                                     
*                                                                               
...
*                                                                               
LRPRDX4  DS    0H                                                               
         GOTO1 =V(PUBEDIT),DMCB,CCAKPUB,(C'S',LPUB),RR=RELO                     
*                                                                               
         MVC   MYPUB,CCAKPUB                                                    
*                                                                               
         BRAS  RE,MYVPUB                                                        
...
*                                                                               
         USING CCAEBASD,R6         ESTABLISH DOMAIN ELEMENT                     
*                                                                               
         SR    RF,RF                                                            
         IC    RF,CCAEBLEN         GET ELEMENT LENGTH                           
         SHI   RF,CCAEBLQ          SUBTRACT BASIC ELM LENGTH                    
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SAVEBASE(0),CCAEBASE    DISPLAY E-MAIL BASE                      
*                                                                               
LREBASOK DS    0H                                                               
*                                                                               
...
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,CCALIDQ      LOOK FOR LIST ELMS                           
...
*                                                                               
         MVC   PCNAME,CCALNAME     PRINT CONTACT NAME                           
*                                                                               
...
LRFAX    DS    0H                                                               
*                                                                               
         CLI   CCALTYPE,0          SKIP IF NOT FAX NUMBER                       
         BE    *+8                                                              
         CLI   CCALTYPE,C'F'       SKIP IF NOT FAX NUMBER                       
         BNE   LRFAXN                                                           
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,CCALLEN        GET FAX# LENGTH                              
         SHI   RF,CCALSTLQ         DECREMENT BY BASIC LENGTH                    
*                                                                               
         LA    R1,CCALADDR         START OF FAX #                               
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         IC    RF,CCALLEN          GET ELEMENT LENGTH                           
         SHI   RF,CCALSTLQ         DECREMENT BY BASIC LENGTH                    
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   PCADDR(0),CCALADDR  DISPLAY ADDRESS                              
*                                                                               
         CLI   CCALTYPE,C'E'       SKIP IF NOT AN E-MAIL                        
         BNE   LRADRX                                                           
*                                                                               
...
*                                                                               
         CLI   CCALSUP,C'Y'        IF W/O COSTS VERSION                         
         BNE   *+10                                                             
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - MYVPUB'                    
***********************************************************************         
*                                                                     *         
*        GET PUB NAME                                                 *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - MYVCLT'                    
***********************************************************************         
*                                                                     *         
*        GET CLIENT NAME                                              *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - PR'                        
***********************************************************************         
*                                                                     *         
*        PRINT REPORT                                                 *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - HOOK'                      
***********************************************************************         
*                                                                     *         
*        HEADLINE ROUTINES                                            *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - LINSET'                    
**********************************************************************          
*   LINUP INTERFACE                                                  *          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - LINHOOK'                   
**********************************************************************          
*                                                                    *          
...
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,CCALIDQ      LIST ENTRY ELEMENT                           
         USING CCALSTD,R6          ESTABLISH LIST ELEMENT                       
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,CCALLEN        ELEMENT LENGTH                               
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   ELTELEM(0),CCALELM  SAVE LIST ELEMENT                            
*                                                                               
...
*                                                                               
         ...
         USING CCALSTD,R3          ESTABLISH STANDARD CONTRACT UNIT ELM         
*                                                                               
...
*                                                                               
         LA    R4,WRKELTAB         SET TO BUILD TABLE ELEMENT                   
*                                                                               
         MVI   CCALCDE,CCALIDQ     SET ELEMENT CODE                             
         MVI   CCALLEN,CCALSTLQ    SET BASIC ELEMENT LENGTH                     
         MVC   CCALNAME,FLDDATA    SAVE CONTACT NAME                            
*                                                                               
         TM    FLDIIND,FINPTHIS    IF FIELD INPUT THIS TIME                     
         BNO   *+8                                                              
         OI    SVACH1,CCAALSCH        LIST CHANGED                              
*                                                                               
LHVNAMOK DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         ...
         BZ    LHVTYPOK                                                         
*                                                                               
         MVI   CCALTYPE,C'E'       ASSUME THIS IS AN E-MAIL ADDRESS             
*                                                                               
...
*                                                                               
         ...
         BNE   LHVTYPNV                                                         
*                                                                               
         MVC   CCALTYPE,FLDDATA    SAVE ADDRESS TYPE                            
*                                                                               
LHVTYP10 DS    0H                                                               
*                                                                               
         TWAXC (R2),(R2)           CLEAR FIELD                                  
*                                                                               
         CLI   CCALTYPE,C'E'       EXPAND CODE LETTER                           
         BNE   *+14                                                             
         MVC   FLDDATA(L'LHVTYPEM),LHVTYPEM                                     
         B     LHVTYPOK                                                         
*                                                                               
         CLI   CCALTYPE,C'F'       EXPAND CODE LETTER                           
         BNE   *+10                                                             
...
LHVTYPX  DS    0H                                                               
*                                                                               
         TITLE 'PRSFM32 - VALIDATE SUPPRESS COST FIELD - LHVSUP'                
***********************************************************************         
*                                                                     *         
*        ROUTINE TO VALIDATE SUPPRESS COST FIELD                      *         
*              C'Y' - SET CCVLSUP TO Y                                *         
*  NO ENTRY OR C'N' - CLEAR CCALSUP                                   *         
...
LHVSUP   DS    0H                                                               
*                                                                               
         MVI   CCALSUP,0           CLEAR SUPPRESS COST FIELD                    
*                                                                               
...
*                                                                               
         ...
         BNE   LHVTYPNV                                                         
*                                                                               
         MVI   CCALSUP,C'Y'        SET SUPPRESS COST FIELD                      
         CLI   FLDDATA,C'N'        C'N' ?                                       
         BNE   LHVSUPOK                                                         
         MVI   CCALSUP,0           CLEAR SUPPRESS COST FIELD                    
*                                                                               
...
LHVFAX   DS    0H                                                               
*                                                                               
         CLI   CCALTYPE,C'F'       SKIP IF NOT A FAX NUMBER                     
         BNE   LHVFAXN                                                          
*                                                                               
...
*                                                                               
         ...
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVC   CCALADDR(0),WORK    SAVE FAX NUMBER                              
         ST    RE,FULL             SAVE RE                                      
*                                                                               
         SR    RF,RF                                                            
         IC    RF,CCALLEN          BUMP ELEMENT LENGTH                          
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   CCALADDR(0),FLDDATA    SAVE E-MAIL ADDRESS                       
*                                                                               
         AHI   RF,CCALSTLQ+1       CALCULATE ELEMENT LENGTH                     
         STC   RF,CCALLEN          NEW ELEMENT LENGTH                           
*                                                                               
LHVADDFD DS    0H                                                               
*                                                                               
         TM    FLDIIND,FINPTHIS    IF FIELD INPUT THIS TIME                     
...
*                                                                               
         ...
         MVC   ELTELEM,CCALELM     SET NEW ELEM IN TABLE                        
*                                  SET NEW ELTLAST                              
         ICM   R1,15,BSPNOR        NUMBER OF ENTRIES                            
         BZ    *+10                                                             
         BCTR  R1,R0                                                            
...
LHDNAM   DS    0H                                                               
*                                                                               
         MVC   FLDDATA(L'CCALNAME),CCALNAME  DISPLAY CONTACT NAME               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BZ    LHDTYPX                                                          
*                                                                               
         MVC   FLDDATA(L'CCALTYPE),CCALTYPE  DISPLAY ADDRESS TYPE               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
*                                                                               
...
*                                                                               
         ...
         BZ    LHDSUPX                                                          
*                                                                               
         MVC   FLDDATA(L'CCALSUP),CCALSUP    DISPLAY (Y OR NULL)                
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BNE   LHDFAXN                                                          
*                                                                               
         MVC   FLDDATA(3),CCALADDR AREA CODE                                    
         MVI   FLDDATA+3,C'-'                                                   
         MVC   FLDDATA+4(3),CCALADDR+3 EXCHANGE                                 
         MVI   FLDDATA+7,C'-'                                                   
         MVC   FLDDATA+8(4),CCALADDR+6 NUMBER                                   
*                                                                               
         B     LHDADR99                                                         
*                                                                               
LHDFAXN  DS    0H                                                               
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),CCALADDR  DISPLAY ADDRESS                             
*                                                                               
LHDADR99 DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         USING CCALSTD,R6          ESTABLISH LIST ELEMENT                       
*                                                                               
         CLI   CCALCDE,0           DONE IF EOR REACHED                          
         BE    LSWTDELD                                                         
*                                                                               
         CLI   CCALCDE,CCAEBIDQ    DELETE IF E-BASE ELEMENT                     
         BE    *+8                                                              
         CLI   CCALCDE,CCALIDQ     DELETE IF LIST ELEMENT                       
         BNE   LSWTDELC                                                         
*                                                                               
...
*                                                                               
         LA    R6,CCAFIRST-CCAREC(R6)    POINT TO FIRST ELEMENT IN REC          
         GOTO1 (RF),(R1),,(R3),(C'R',(R6)),=AL2(33,25,4000)   ADD ELEM          
*                                                                               
...
*                                                                               
         ...
         USING CCALSTD,R3          ESTABLISH LIST ELEMENT                       
*                                                                               
         CLI   CCALLEN,0           GET ELEMENT LENGTH                           
...
*                                                                               
         ...
         BNE   *+8                                                              
         OI    SVACH1,CCAAADD         SET RECORD ADDED                          
*                                                                               
*        ADD ACTIVITY ELEMENT                                                   
*                                                                               
         BRAS  RE,ACTPUT                                                        
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE 'PRSFM31 - AGENCY CONTACT E-ADDRESS - ACTPUT'                    
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         MVC   CCAASCID,SVSCID     SET CHANGER'S SECURITY PID                   
*                                                                               
         MVC   CCAACHGS,SVACHGS    SET ACTIVITY INDICATORS                      
*                                                                               
         L     R6,AIO              POINT TO RECORD FOR DISPLAY                  
         ST    R6,DMCB             PASS TO RECUP                                
         MVI   DMCB,X'FE'          INDICATE SPECIAL SYSTEM                      
...
*                                                                               
         MVI   ELCODE,CCAAIDQ      LOOK FOR ACTIVITY ELM                        
         BRAS  RE,GETEL            FIND IN RECORD                               
*                                                                               
ACTPUTLP DS    0H                                                               
*                                                                               
...
*                                                                               
         CLC   CCAAPID,CCAAPID-CCAAELM(R6)  IF SAME PERSON                      
         BNE   ACTPUTCN                                                         
         CLC   CCAASCID,CCAASCID-CCAAELM(R6) IF SAME SCID                       
         BNE   ACTPUTCN                                                         
         CLC   CCAADTE,CCAADTE-CCAAELM(R6)  AND DATE                            
         BNE   ACTPUTCN                                                         
*                                                                               
         OC    CCAACHGS-CCAAELM(L'CCAACHGS,R6),SVACHGS UPDATE CHANGES           
*                                                                               
...
ACTPUTDN DS    0H                                                               
*                                                                               
         GOTO1 VRECUP,DMCB,,(R3),(C'R',(R6)),=AL2(33,25,4000)  ADD ELEM         
*                                                                               
         CLI   DMCB+8,0            ONLY ERROR CAN BE NO ROOM IN REC             
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM32 - SFM AGENCY CONTACT LIST - ACTLMT'                     
***********************************************************************         
*                                                                     *         
...
*                                                                               
         MVI   ELCODE,CCAAIDQ      LOOK FOR ACTIVITY ELEM                       
         BRAS  RE,GETEL            FIND IN RECORD                               
...
*                                                                               
ACTLMTDD DS    0H                                                               
         GOTO1 VRECUP,DMCB,,(R6),0,=AL2(33,25,4000)    DELETE ELEMENT           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM32 - SFM AGENCY CONTACT LIST - PIDGET'                     
***********************************************************************         
*                                                                     *         
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE 'T41C32 AGENCY CONTACT LIST RECORDS - DSPFLD'                    
***********************************************************************         
*                                                                     *         
...
HEDSPECS DS    0H                                                               
         SPROG 0,1                                                              
         PSPEC H1,51,C'EIO AGENCY CONTACT LIST REPORT'                          
         PSPEC H2,51,C'-----------------------------'                           
         PSPEC H1,95,AGYNAME                                                    
         PSPEC H2,95,AGYADD                                                     
         PSPEC H4,95,RUN                                                        
...
*                                                                               
CCAKSAVE DS    XL(L'CCAKEY)        KEY SAVEAREA                                 
SVEBASE  DS    XL(CCAEBLQ)         E-MAIL ELM SAVEAREA                          
SVACTELM DS    XL(CCAACTLQ)        ACTIVITY ELM SAVEAREA                        
...
ELTMAX   EQU   (3900/125)-1       MAX NUMBER OF ELEMENTS IN TABLE               
*                                                                               
...
ELTELEM  DS    CL(CCALSTLQ+79)     CONTACT ELEMENT                              
ELTABL   EQU   *-ELTABD            ENTRY LENGTH                                 
*                                                                               
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'178PRSFM32   03/16/09'                                      
         END                                                                    
