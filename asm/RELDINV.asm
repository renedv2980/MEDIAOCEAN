*          DATA SET RELDINV    AT LEVEL 006 AS OF 05/01/02                      
*PHASE RELDINV,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
*                                                                               
         ...
         BNE   DMXKEEP                                                          
         CLC   RINVKREP,=C'CV'     ABC                                          
         BNE   DMXKEEP                                                          
         CLC   =C'KGO T',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'KTRKT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'KYW T',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WCAUT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WPHLT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WPSGT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WPVIT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WTXFT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WLS T',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WTVDT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'WTVGT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         CLC   =C'KABCT',RINVKSTA                                               
         BE    DMXPURGE                                                         
         B     DMXKEEP                                                          
         DROP  R3                                                               
         EJECT                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006RELDINV   05/01/02'                                      
         END                                                                    
