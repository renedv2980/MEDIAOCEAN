*          DATA SET REWRI01S   AT LEVEL 003 AS OF 05/01/02                      
*          DATA SET REWRI01    AT LEVEL 008 AS OF 10/25/94                      
*PHASE T82101A,*                                                                
...
*                                                                     *         
*  LEV 00    MONDA/90                                                 *         
*  LEV 09    ADD ADVERTISER AND POINT PERSON KEYWORDS                 *         
***********************************************************************         
         TITLE 'T82101 - REP WRITER APPLICATION'                                
T82101   CSECT                                                                  
         PRINT NOGEN                                                            
...
READRECS DS    XL1                                                              
       ++INCLUDE DDGENTWA                                                       
         SPACE                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003REWRI01S  05/01/02'                                      
         END                                                                    
