*          DATA SET PPMBC00S   AT LEVEL 045 AS OF 05/01/02                      
*PHASE T41800A                                                                  
*INCLUDE PUBVAL                                                                 
*INCLUDE PUBFLOAT                                                               
*INCLUDE SRCHCALL                                                               
...
*                                                                               
* BPLA  9/99     CHANGES FOR RATE CHANGES - SEE **RATES**                       
*                COPY OF PPMBC00/6 MADE 9/24/99                                 
*       10/99    ACCEPT ON-SALE AND CLOSING DATES FOR                           
*                NEWSPAPERS                                                     
*                                                                               
* KWAN  06/99    SET DOLSW TO C'0' IF DOLLAR TYPE IS NOT ENTERED                
*                                                                               
* BPLA   6/99    ADD IMPS TO DISPLAY OF AVAILABLE DATA                          
*                                                                               
* KWAN  4/99     NEW DATASW FOR IMPRESSION (DATASW=C'I')                        
*                                                                               
* SMYE  3/99     ADD LOGIC TO SET COST2SW FOR GETINS AT EDTO6V                  
*                                                                               
* SMYE  2/99     ADD COST 2 FACTOR (DATASW=C'B')                                
*                                                                               
* SMYE  4/98     SAVE PCLTSTAT AT SVCLPROF+30 ("FROZEN" CLIENT INDIC.)          
*                                                                               
* BPLA  3/98     CHANGE FOR EXPANDED CONIO (USED BY GETADVC)                    
*                CONIO IN PPMBCWRK EXPANDED TO 6000 BYTES                       
*                                                                               
* BPLA  2/98     ALLOW WESTERN ID TO ONLY DISPLAY T/S STATUS                    
*                                                                               
* BPLA  1/98     ALLOW SJR TO CHANGE TEARSHEET STATUS                           
*                (I.E. NO LONGER TREAT AS A WESTERN AGENCY)                     
*                MX ADDED TO WESTERN AGENCY CHECK                               
*                                                                               
* BPLA  1/98     ADD BILLED AND PAID FILTERS                                    
*                SJR CHECKS REMOVED                                             
*                                                                               
...
*                                                                               
* BPLA 12/96     ADD CLIENT GROUP SECURITY                                      
*                                                                               
* BPLA 12/96     REMOVE SJR RESTRICTION FOR PAGEVIEWS AND CLICKTHRUS            
*                                                                               
* BPLA 11/96     REMOVE LIMIT ACCESS CHECKS FOR LAST HALF                       
*                BYTE - THEY DO NOT WORK FOR SOME REASON                        
*                                                                               
* BPLA 10/96     ADD LOGIC FOR PAGEVIEWS AND CLICKTHRUS (WEBSITES)              
*                ONLY ALLOWED FOR SJR (AT EDTO14L)                              
*                                                                               
* BPLA 8/96      EXPAND NMOD AND CONIO (IN PPMBCWRK)                            
*                3000 BYTES FROM 2000 BYTES                                     
*                SINCE CONIO IS ALSO USED BY GETADVC                            
*                                                                               
* BPLA 12/95     CHANGE T/S STATUS DISPLAY (DATASW=C'E') AND                    
*                T/S STATUS FILTER (SVTSTAT)                                    
*                                                                               
* BPLA 7/95      ADD WILD CARD (*) TO SPACE FILTERING                           
*                                                                               
* BPLA 6/95      SHIP DATE DATA AND DATE CHANGES                                
*                                                                               
* BPLA 6/95      SPACE FILTERING - SPACE=XXXX IN DATA FIELD                     
*                SAVED IN SVSPACE.                                              
*                CAN'T ENTER BOTH OUTSPACE2 AND SPACE FILTERS                   
*                                                                               
* BPLA 3/95      NEW FEATURE WITH AC - ACNET TO GROSS-UP NET FOR                
*                BUYS ENTERED WITH A NET RATE WHEN AC WAS ZERO                  
*                AND NOW ISN'T AND NET DOWN GROSS IF AC WAS NOT                 
*                ZERO AND NOW IS                                                
*                PBDCTYP = N FOR BUYS ENTERED WITH NET RATE                     
*                NOW DISPLAYED ON SCREEN                                        
*                ACNET ONLY DISPLAYS BUYS ENTERED WITH A NET RATE               
*                                                                               
* BPLA 1/95   READ BY PROFILE - NEEDED FOR COMPETITIVE BRAND CHECKING           
*                                                                               
* BPLA 7/94      ADD RPT TO DATA DISPLAY TABLE                                  
*                                                                               
* BPLA 6/94      RPT CHANGES                                                    
*                                                                               
* BPLA 1/94      ALLOW REFERENCE NUMBERS FOR SJR AND JWT (ALL MEDIAS)           
*                                                                               
* BPLA 7/6/93    OUTSPC2 OPTION/FILTER FOR OUTDOOR                              
*                                                                               
* BPLA 4/21/93   NO LIMIT ACCESS CHECK FOR DLC,FSI OR REF                       
*                DOESN'T WORK SINCE LIMIT ACCESS DEFAULTS TO                    
*                X'000F' FOR SOME REASON                                        
*                                                                               
* BPLA 2/2/93    REFERNCE NUMBER CHANGES                                        
*                                                                               
* BPLA 12/10/92  FSI CHANGES                                                    
*                                                                               
* BPLA 6/8/92    CHANGE DEC TO DLC                                              
*                                                                               
* BPLA 5/12/92   CHANGES FOR DEC DIS/CHA                                        
*                                                                               
* BPLA 3/6/92    CHANGES FOR AUTOMATIC SCHEDULE CHECKING                        
*                                                                               
* BPLA 10/9/91   DATA LIMIT ACCESS CHANGED FROM NO DISPLAY/CHA TO               
*                DISPLAY ONLY                                                   
* BPLA 8/23/91   NAME SEARCH CODE ADDED                                         
*                                                                               
* BPLA 8/21/91   ADD CODE FOR PUBLIST FILTER (L=XXXX IN PUB)                    
*                RE-ALLOW INPUT OF CONU FOR CONTRACT UNITS (EDTO6F)             
*                ADD CODE FOR PLANNED COST                                      
*                                                                               
* BPLA 7/25/91   ADD FUNCTION LIMIT ACCESS AND MB PROFILE COST                  
* TO 8/2/91      SUPPRESSION AND PUB NAME DISPLAY?                              
*                                                                               
* BPLA 4/26/91   SET OFF X'80' IN DMINBTS (NO READ FOR UPDATE)                  
*                LOCKER TABLE WAS GETTING FULL WITH RECORDS READ                
*                BUT NOT NEEDED FOR UPDATE                                      
*                                                                               
* ROSA 2/5/90    PERFORM OFFICE LIST SECURITY                       L02         
*                                                                               
* ROSA  7/20/89  CHANGE THE ORDER OF CDISCOUNT CONSTANT SO THAT     L01         
*                AN ENTRY OF 'CD' WILL BE FOR CASH DISCOUNT INSTEAD L01         
*                OF CLOSING DATE.  ALSO ADD SCD AND SCLOSE OPTION FOR01         
*                CLOSING DATES                                      L01         
*                                                                   L01         
...
*                                                                               
         ...
         BNE   MBCGLB10              CHECK GLOBBER AREA                         
*                                                                               
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
         GOTO1 =A(FILSCR),DMCB,(RC),RR=RELO FILL IN SCREEN FROM GLOBBER         
*                                                                               
MBCGLBX  DS    0H                                                               
*                                                                               
         EJECT                                                                  
*                                  FIRST CHECK FOR ? IN DATA                    
         LA    R2,MBCDATH                                                       
...
*                                                                               
         ...
         BNE   EDTCL30                                                          
         BRAS  RE,TRAFFACC         CK FOR CLIENT TRAFFIC LIMIT ACCESS           
         CLI   BYTE3,1             CLT TRAFFIC OFFICE CODE NOT FOUND?           
         BE    EDTCL30             YES, SO USE PCLTOFF FOR LIMIT ACC            
         CLI   BYTE3,2             FAILED LIMIT ACCESS CHECKING?                
         BE    ACCE                YES, DISPLAY ERROR MSG                       
         CLI   BYTE3,3             GROUP CODE (SCHEME CODE) DETECTED?           
         BE    ACCGRP              YES, GO CHECK FOR GROUP LIMIT ACC            
         CLI   BYTE3,99            LIMIT ACCESS CHECKED AND PASSED?             
         BE    ACCX                YES                                          
         DC    H'0'                NO OTHER RETURN CODES!                       
*                                                                               
EDTCL30  CLI   6(RA),C'$'                                                       
         BNE   ACCCHK                                                           
         BAS   RE,PPCLIVER         TEST OFFICE SECURITY                         
         BE    ACCX                                                             
         BNE   ACCE                                                             
*                                                                               
ACCCHK   OC    6(2,RA),6(RA)       CHK FOR LIMIT ACCESS                         
         BZ    ACCX                                                             
         CLI   6(RA),C'*'          CHK FOR OFFICE LIMIT ACCESS                  
         BNE   ACC2                                                             
*                                                                               
         CLI   7(RA),C'A'          SEE IF ALPHA                                 
         BL    ACCO                NO - MUST BE OFFICE                          
         CLI   7(RA),C'Z'                                                       
         BH    ACCO                                                             
         ...
         CLI   8(RA),C'9'                                                       
         BH    ACCO                                                             
ACCGRP   BAS   RE,VALGROUP        MUST BE CLIENT GROUP SECURITY                 
         BNE   ACCE               ACCESS DENIED                                 
         B     ACCX               ACCESS O.K.                                   
*                                                                               
ACCO     DS    0H                                                               
         CLI   PCLTOFF+2,C'*'      TO IGNORE CHK                                
         BE    ACCX                                                             
         CLC   PCLTOFF(1),7(RA)    OFFICE MUST MATCH                            
         BE    ACCX                                                             
ACCE     LA    R3,ACCERR           NOT AUTHORIZED                               
         B     ERROR                                                            
*                                                                               
ACC2     CLC   6(3,RA),SVCLT                                                    
         BNE   ACCE                                                             
*                                                                               
ACCX     DS    0H                                                               
...
*                                                                               
         XC    SVCLPROF+27(3),SVCLPROF+27  SET FOR NOT FROZEN WITH DATE         
*                                                                               
...
EDTST4   OI    MBCEDDEH+4,X'20'                                                 
         B     EDTST10                                                          
*                                                                               
EDTST5   GOTO1 VDATVAL,DMCB,(0,8(R2)),SVSTRT     FIRST CHK FOR MMDDYY           
         OC    DMCB(4),DMCB                                                     
         BNZ   EDTST7                                                           
*                                                IF ERROR TRY MMYY              
...
EDTEND   DS    0H                  EDIT END DATE                                
         ...
         B     ERROR                                                            
*                                                                               
EDTEND5  GOTO1 VDATVAL,DMCB,(0,8(R2)),SVEND     TRY FOR MMMDD/YY                
         OC    DMCB(4),DMCB                                                     
         BNZ   EDTEND10                                                         
*                                      IF ERROR - TRY MMM/YY                    
...
EDTO6BX  MVC   SVSFH,22(R6)                                                     
         B     EDTO14                                                           
*                                                                               
*                                    CHECK FOR VARIOUS ALLOWABLE                
*                                    SPELLINGS OF TEARSHEET                     
*                                                                               
...
EDTO6L   DS    0H                 SEE IF SPACE FILTER ENTERED                   
         ...
         BE    EDTO6L2                                                          
         MVC   SVSPACE,=CL18' '                                                 
         MVC   SVSPACE+1(17),22(R6)  IF NOT NEGATIVE - USE SVSPACE+1            
         B     EDTO6L2                                                          
*                                                                               
...
*                                                                               
EDTO6Q   DS    0H                                                               
         CLC   12(6,R6),=C'BILLED'    CHECK FOR BILLED FILTERS                  
         BNE   EDTO6Q2                                                          
         CLI   0(R6),6                                                          
         BNE   OPTERR                                                           
***      CLI   SVBILL,C'T'     NO-OPED                                          
***      BE    EDTO6QX         NO-OPED                                          
         MVI   SVBILL,C'B'                                                      
         B     EDTO6QX                                                          
*                                                                               
...
**                                                                              
**       CLC   12(7,R6),=C'TBILLED' CHECK FOR TOTALLY BILLED FILTER             
**       BNE   EDTO6Q4                                                          
**       CLI   0(R6),7                                                          
**       BNE   OPTERR                                                           
**       MVI   SVBILL,C'T'                                                      
**       B     EDTO6QX                                                          
*                                                                               
EDTO6Q4  CLC   12(4,R6),=C'PAID'    CHECK FOR PAID FILTERS                      
         BNE   EDTO6Q6                                                          
         CLI   0(R6),4                                                          
         BNE   OPTERR                                                           
***      CLI   SVPAID,C'T'   NO-OPED                                            
***      BE    EDTO6QX       NO-OPED                                            
         MVI   SVPAID,C'P'                                                      
         B     EDTO6QX                                                          
*                                                                               
EDTO6Q6  DS    0H            NO-OP TOTALLY PAID FILTER NOR NOW                  
         B     EDTO6R                                                           
**                                                                              
**       CLC   12(5,R6),=C'TPAID' CHECK FOR TOTALLY PAID FILTER                 
**       BNE   OPTERR                                                           
**       CLI   0(R6),5                                                          
**       BNE   OPTERR                                                           
**       MVI   SVPAID,C'T'                                                      
*                                                                               
EDTO6QX  CLI   1(R6),0             CHECK FOR SECOND FIELD                       
         BNE   OPTERR    NONE ALLOWED FOR BILLED/PAID FILTERS                   
         B     EDTO14                                                           
*                                                                               
...
*                                                                               
         MVI   OUT2OPT,C'Y'                                                     
         CLI   1(R6),0         CHK FOR FILTER INPUT IN SECOND FIELD             
         BE    EDTO14                                                           
         CLI   1(R6),10                                                         
         BH    OPTERR                                                           
*                         IF SECOND FIELD ENTERED THIS IS A FILTER              
...
*                                                                               
*                                                                               
EDTO6T   DS    0H                  CHECKING KEYWORD FOR LAST INS ORDER          
*                                                                               
...
*                                                                               
*                                                                               
EDTO6X   CLI   1(R6),0             CHK FOR NO SECOND FIELD                      
*                                  OK IF JUST INPUTTING DATA TYPE               
         BE    EDTO10                                                           
         LA    R3,TAB1                                                          
         LA    R1,DOLSW                                                         
         CLI   12(R6),C'$'                                                      
...
EDTO9C   MVC   0(1,R1),9(R3)       SAVE CODE                                    
         CLC   22(4,R6),=C'ACNET'                                               
         BNE   *+8                                                              
         MVI   GNOPT,C'Y'    TO GROSS-UP BUYS BOUGHT WITH NET RATES             
*                                                                               
...
EDTO14D  OC    SVSFH,SVSFH         SEE IF SFH STATUS FILTER SET                 
         ...
         MVI   DATASW,C'X'         SET FOR SFH (SPECIAL FINANCIAL               
*                                               HANDLING) DISPLAY               
...
EDTO14P  CLI   SVMED,C'N'                                                       
         BNE   EDTO14Q                                                          
*                                                                               
         B     EDTO16   ALLOW CLOSING AND ON-SALE DATE FOR NEWSPAPERS           
*                                                                               
         CLI   DATASW,C'4'                                                      
...
EDTA1    LA    R2,MBCACTH                                                       
         ...
         CLI   FULL,0                                                           
         BE    EDTX                                                             
         B     ACTINV              SOME DATA FIELD OTHER THAN FIRST             
*                                  WAS CHANGED                                  
*                                                                               
EDTA2    LA    R3,ACTTAB                                                        
         ZIC   R5,5(R2)                                                         
...
*                                                                               
         ...
         B     EDTA5X                                                           
*                                                                               
*                                  ACTION NOT DISPLAY  - CHECK                  
*                                  FOR DATA TYPE LIMIT ACCESS                   
EDTA5X   LA    R3,ACCTAB                                                        
EDTA6    CLI   0(R3),X'FF'                                                      
         BNE   *+6                                                              
         ...
         B     EDTA6                                                            
*                                                                               
EDTA7    DS    0H                  CHECK FOR FUNCTION LIMIT ACCESS              
...
EDTX     CLI   ACTION,C'C'                                                      
         ...
         BAS   RE,CLRSCN                                                        
*                                                                               
EDTX1    DS    0H                  GOTO 01 PHASE TO PROCESS DATA                
         CLI   SVSTRT,0                                                         
         BE    EDTX5                                                            
...
MULTICHA NTR1                                                                   
*                FOR MULTICHANGES                                               
*                FIND FIRST UNPROTECTED FIELD AND SAVE ITS INPUT                
...
*                                  SETS FULL TO 1 ON ERROR                      
         ...
         LA    R6,16                                                            
*                                                                               
*                               SET FIRST DATA FIELD IN ALL OTHERS              
*                               SO T41801 WILL ACT AS IF CHANGE WAS             
*                               MADE TO EVERY FIELD                             
*                                                                               
MULTIC3  OC    0(4,R7),0(R7)                                                    
         ...
         CLI   8(R5),C'*'                                                       
         BE    MULTIC8                                                          
         LTR   R4,R4            SEE IF I HAVE FOUND FIRST UNPROT FLD            
         BNZ   MULTIC6                                                          
...
MULTIC6  CLI   8(R5),C'*'        MEANS DON'T CHANGE THIS BUY                    
         ...
         BO    MULTICE           YES -ERROR - ONLY FIRST FIELD CAN BE           
         NI    4(R5),X'DF'       SET TO ALTERED                                 
         MVC   5(1,R5),5(R4)     LENGTH OF FIRST UNPROTECTED FLD                
         MVC   8(L'MBCDT01,R5),8(R4)  FIRST UNPROTECTED FLD                     
         FOUT  (R5)                                                             
*                                                                               
MULTIC8  LA    R7,4(R7)                                                         
         LA    R5,LDISP(R5)                                                     
...
*                                                                               
         EJECT                                                                  
*                                                                               
HEAD1    DC    CL67'PRD PUBLICATION      EST  DATE        SPACE        X        
                           COST'                                                
HEAD2    DC    CL67'--- -----------      ---  --------    -----        X        
                           ----'                                                
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
* DOTED MEANS IT HAS BEEN USED ALREADY                                          
*                                                                               
...
*                                                                               
         DC    CL9'FSI      ',C'F' FSI (FREE STANDING INSERTS)                  
*                                  NOT FOR OUTDOOR                              
*                                                                               
...
*                                                                               
         GOTO1 (RF),DMCB,=C'GETF',MBCMDIAH,,GLVPRMD    MEDIA                    
         GOTO1 (RF),(R1),,MBCCLTH,,GLVPRCLT            CLIENT                   
         GOTO1 (RF),(R1),,MBCPRDH,,GLVPRPRD            PRODUCT                  
         GOTO1 (RF),(R1),,MBCESTH,,GLVPREST            ESTIMATE                 
         GOTO1 (RF),(R1),,MBCPUBH,,GLVPRPUB            PUB                      
         GOTO1 (RF),(R1),=C'GETD',TEMP,12,GLVPRPER     PERIOD                   
*                                                                               
         GOTO1 VDATCON,DMCB,TEMP,(17,MBCSTDE)     START DATE                    
         MVI   MBCSTDEH+4,0          KILL INPUT INDICATORS                      
         MVI   MBCSTDEH+5,8          SET DATA LENGTH                            
*                                                                               
         GOTO1 VDATCON,DMCB,TEMP+6,(17,MBCEDDE) END DATE                        
         MVI   MBCEDDEH+4,0          KILL INPUT INDICATORS                      
         MVI   MBCEDDEH+5,8          SET DATA LENGTH                            
*                                                                               
         GOTO1 VGLOBBER,DMCB,=C'GETF',MBCDATH,,GLVPRDTA                         
*                                                                               
         MVC   MBCACT(7),=C'DISPLAY' DEFAULT TO DISPLAY                         
...
*                                                                               
         GOTO1 VGLOBBER,DMCB,=C'DELE'       DELETE FROM GLOBBER                 
*                                                                               
...
CKPG99   MVI   BYTE3,99                                                         
*                                                                               
CKPGRPX  XIT1  REGS=(R2,R3)        ERROR MSG AND CURSOR POSITION                
*                                                                               
         LTORG                                                                  
         EJECT                                                                  
*                                                                               
...
LEGWHDRX XIT1                                                                   
*                                                                               
LWHEAD1  DC    CL67'PRD PUBLICATION      EST  DATE        SPACE        X        
                     DEFAULT LW'                                                
LWHEAD2  DC    CL67'--- -----------      ---  --------    -----        X        
                     ----------'                                                
*                                                                               
...
*                                                                               
         MVI   BYTE3,0             FOR RETURN CODES                             
         MVI   TRCTOCD,0           CLIENT TRAFFIC OFFICE CODE                   
*                                                                               
         LA    R6,PCLTREC+33                                                    
         MVI   ELCODE,X'50'        CLIENT TRAFFIC OFFICE ELEM CODE              
         BAS   RE,TRNXTEL                                                       
         BNE   TRACC90             NO CLIENT TRAFFIC OFFICE CODE ELEM           
         MVC   TRCTOCD,2(R6)                                                    
*                                                                               
         CLI   6(RA),C'$'          CLT TRAFFIC OFFICE LIST LIMIT ACC?           
         BNE   *+16                                                             
         BAS   RE,TRCLIOL          TEST OFFICE SECURITY                         
         BE    TRACC99             CHECKED AND PASSED                           
         BNE   TRACC91             NOT AUTHORIZED                               
*                                                                               
         CLI   6(RA),C'*'          CLT TRAFFIC OFFICE LIMIT ACCESS?             
         BNE   TRACC50                                                          
         CLI   7(RA),C'A'          SEE IF ALPHA                                 
         BL    TRACC30             NO - MUST BE OFFICE                          
         CLI   7(RA),C'Z'                                                       
         BH    TRACC30                                                          
         CLI   8(RA),C'0'          SEE IF 3RD BYTE IS NUMERIC                   
         BL    TRACC30                                                          
         ...
         BH    TRACC30                                                          
*                                                                               
         B     TRACC92             LIMIT ACCESS IS GROUP (SCHEME CODE)          
*                                                                               
TRACC30  DS    0H                                                               
         CLC   TRCTOCD,7(RA)       OFFICE MATCH?                                
         BE    TRACC99             YES, CHECKED AND PASSED SECURITY             
         B     TRACC92                                                          
*                                                                               
TRACC50  CLC   6(3,RA),SVCLT       CLIENT SPECIFIC?                             
         BE    TRACC99             YES, CHECKED AND PASSED SECURITY             
         B     TRACC91                                                          
*                                                                               
TRACC90  MVI   BYTE3,1             NO CLIENT TRAFFIC OFFIC CODE FOUND           
         B     TRACCX                                                           
*                                                                               
TRACC91  MVI   BYTE3,2             NOT AUTHORIZED                               
         B     TRACCX                                                           
*                                                                               
TRACC92  MVI   BYTE3,3             LIMIT ACCESS IS GROUP (SCHEME CODE)          
         B     TRACCX                                                           
*                                                                               
TRACC99  MVI   BYTE3,99            LIMITE ACCESS IS CHECKED AND PASSED          
*                                                                               
TRACCX   XIT1                                                                   
*                                                                               
*                                                                               
*                                                                               
TRCLIOL  NTR1                      CLIENT TRAFFIC OFFICE LIST CHECK             
         XC    DMCB(12),DMCB                                                    
...
*                                                                               
       ++INCLUDE PPMBCWRK                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045PPMBC00S  05/01/02'                                      
         END                                                                    
         EJECT                                                                  
*                                                                               
