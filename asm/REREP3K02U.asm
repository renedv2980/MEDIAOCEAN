*          DATA SET REREP3K02U AT LEVEL 040 AS OF 11/02/00                      
*PHASE RE3K02A,*                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE QSORT                                                                  
...
*                                                                   *           
* NOV02/00 (BU ) --- ORIGINAL VERSION LEVEL 039 AS OF 10/31/99      *           
*                    CORRECTION OF BINARY ZERO OUTPUT               *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
...
*                                                                               
         ...
         OC    STAMKTNM,SPACES     SET SPACES OVER BINARY ZERO                  
*                                                                               
         LA    R1,RSTAELEM                                                      
         SR    R0,R0                                                            
...
*                                                                               
         ...
         EDIT  (P6,TDOLLARS),(17,P+20),2,ZERO=NOBLANK,COMMAS=YES                
         GOTO1 REPORT                                                           
*                                                                               
RPTDGOOD EQU   *                                                                
         SR    R0,R0                                                            
...
WRK      DS    CL128              LENGTH OF RECORD TO BE WRITTEN                
         DC    C'*AGYTAB*'                                                      
...
KZTPRECD DSECT                                                                  
       ++INCLUDE REGENKTP                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'040REREP3K02U11/02/00'                                      
         END                                                                    
