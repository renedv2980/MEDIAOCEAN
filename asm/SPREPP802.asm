*          DATA SET SPREPP802  AT LEVEL 136 AS OF 05/01/02                      
*PHASE SPP802A                                                                  
...
*        QOPT4   Y=UPDATE NPA NUMBER FILE, T=TRACE TAPE ALSO                    
...
SP100    DS    0H                                                               
         ...
         CLI   UPDTOPT,C'N'          TEST UPDATING NPTSAV                       
         BE    SP101                                                            
         OPEN  (NPTSAVOP,(OUTPUT))                                              
*                                                                               
SP101    DS    0H                                                               
         MVI   FORCEHED,C'Y'                                                    
         CLI   UPDTOPT,C'N'        IF UPDATING NPTSAV, SKIP DRIVER              
         BNE   SP120F                                                           
*                                                                               
...
*                                                                               
SP138    DS    0H                                                               
         CLI   UPDTOPT,C'N'        TEST UPDATING NPTSAVE                        
         BNE   SP140               YES, SKIP                                    
*                                  DRIVER OUTPUT PHASE                          
         MVI   GLMODE,GLOUTPUT                                                  
         GOTO1 ADRIVER,DMCB,(RC)                                                
...
PGMNUM   DS    0H                                                               
         ...
         BE    *+10                                                             
         MVC   0(4,R3),=C'0000'     SET 'ALL' PGMS                              
         B     EXIT                                                             
*                                                                               
...
GP4      DS    0H                                                               
         GET   NPMFIL,NPMREC                                                    
         CLI   UPDTOPT,C'T'        TEST TO TRACE TAPE                           
         BNE   GP5                                                              
         GOTO1 HEXOUT,DMCB,NPMREC,P,65,=C'N'                                    
         GOTO1 REPORT                                                           
*                                                                               
GP5      DS    0H                                                               
...
*                                                                               
GP6      DS    0H                                                               
         CLC   NPMPGMNO,=C'0000'   SHOULD BE NO PROGRAM 0000                    
         BNE   GP6B                                                             
         MVC   NPMPGMNO,=C'ZZZZ'   THIS WILL LET US KNOW                        
         MVC   P(22),=C'**PROGRAM 0000 FOUND**'                                 
         GOTO1 REPORT                                                           
*                                                                               
GP6B     DS    0H                                                               
...
*                                                                               
         ...
         MVC   NPTNUM,PGNUM                                                     
*                                                                               
         CLI   UPDTOPT,C'N'       IF UPDATING PGM FILE                          
         BE    SVP21                                                            
...
SVP21C   DS    0H                                                               
         ...
         MVC   PGNAM,NPTNAM        AND NAME                                     
*                                                                               
SVP21D   DS    0H                                                               
*                                                                               
         CLI   UPDTOPT,C'N'        IF UPDATING, TRACE PGM DATA                  
         BE    SVP50                                                            
*                                                                               
         MVC   P(4),PGNET                                                       
         MVC   P+5(3),PGDPT                                                     
         ...
         MVC   P+23(27),PGNAM                                                   
*                                                                               
         MVC   P+53(2),PGSQH       START QTR HR                                 
         PACK  DUB,PGSQH           DISPLAY IN READABLE FORM                     
         CVB   R1,DUB                                                           
         BCTR  R1,R0                                                            
         SR    R0,R0                                                            
         D     R0,=F'4'                                                         
...
*                                  NOT NEW, TEST CHANGES                        
         ...
         BE    SVP41               YES- DONT TEST CHANGED                       
         CLC   NPTDPT,PGDPT                                                     
         BE    SVP41                                                            
...
*                                                                               
PUTPGM   NTR1                                                                   
         CLI   UPDTOPT,C'N'        SKIP IF UPDATING PGM FILE                    
         BNE   PUTPX                                                            
         L     R4,AMKTTAB                                                       
         USING MKTTABD,R4                                                       
...
*                                                                               
DEMLST   DS    0X                                                               
*        DC    X'00',C'T',AL1(145)   V18+  (NEW BASIS DEMO) **NO-OP**           
...
*                                                                               
         SPACE 2                                                                
DNAMES   DS    0X                                                               
*        DC    CL5'V18+ '          **NO-OP ALTERNATE BASE DEMO **               
         DC    CL5'HOMES'                                                       
         DC    CL5'WWORK'                                                       
         DC    CL5'W18+ '                                                       
         DC    CL5'W1834'                                                       
...
CLTHDRD  DSECT                                                                  
       ++INCLUDE SPGENCLT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'136SPREPP802 05/01/02'                                      
         END                                                                    
