*          DATA SET RERES0EB   AT LEVEL 142 AS OF 05/01/02                      
*PHASE T8190EB,*                                                                
*INCLUDE UPOUT                                                                  
*INCLUDE KHDUMMY                                                                
...
*                                                                               
         ...
         BE    PPFK                                                             
         CLI   MODE,VALKEY         HANDLE PF KEYS                               
         BE    VKEY                                                             
...
*                                                                               
         ...
         BE    RANGDONE                                                         
         CLI   RINVKSRC,C'Z'       DONE IF RDETAIL RECORDS REACHED              
         BE    RANGDONE                                                         
*                                                                               
...
*                                                                               
         ...
         MVC   KEY+24(1),4(R5)     READ FILE TO GET RECORD                      
         MVC   KEY+25(2),1(R5)                                                  
...
*                                                                               
         MVC   SAVEKEY,KEY                                                      
         XC    KEY+24(3),KEY+24    GET HEADER AGAIN                             
         GOTO1 HIGH                                                             
         GOTO1 GETREC                                                           
         MVC   HDRKEY,KEY                                                       
*                                                                               
...
BLDR50   XC    KEY,KEY             BUILD RDETAIL RECORD KEY                     
         MVC   KEY(24),HDRKEY                                                   
         MVI   KEY+24,C'Z'         RDETAIL TYPE RECORD                          
         MVC   KEY+25(1),SVEQUNUM  UNIQUE EQUATE NUM FROM X'06'                 
*                                                                               
         L     RF,ASVQTR           YEAR/QTR TABLE                               
         MVC   KEY+26(1),0(RF)       YEAR TO LOOK FOR                           
*                                                                               
         GOTO1 HIGH                                                             
...
*                                                                               
         ...
         ST    R3,ABUFF                                                         
*                                                                               
         BAS   RE,BUFFFULL         CHECK IF PAGE IS FULL                        
         B     PRTR10                                                           
*                                                                               
PRTRATEX DS    0H                                                               
         XIT1                                                                   
...
*RERMPPROF                                                                      
       ...
       ++INCLUDE RERMPPROF                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'142RERES0EB  05/01/02'                                      
         END                                                                    
