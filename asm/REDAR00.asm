*          DATA SET REDAR00    AT LEVEL 042 AS OF 11/06/13                      
*PHASE T80F00A,*                                                                
*INCLUDE RECUP                                                                  
*INCLUDE OUTDAY                                                                 
*INCLUDE REGENDAB                                                               
...
* --------------------------------------------------------------- *             
*******************************************************************             
* NOTE: SOME VALUES ARE BEING SAVED AT THE END OF THE TWA SCREEN  *             
* AT CONHEADH+3500. ALSO, DARPROFS IS SAVED AT CONHEADH+3508 BUT  *             
* ONLY THE FIRST 12 BYTES ARE PRESERVED SINCE GENCON USES         *             
* CONHEADH+3520...BEWARE !!                                       *             
*******************************************************************             
* UPDATE HISTORY:                                                 *             
* ================================================================*             
* JUL10/13 SKU CHANGE 6U TO USE NEW DIFFERENCE                    *             
* MAR04/13 SKU CHANGE NP TO USE NEW DIFFERENCE                    *             
* JUN26/12 SKU CHANGE B1 TO USE NEW DIFFERENCE                    *             
* FEB15/12 SKU CHANGE FF TO USE NEW DIFFERENCE                    *             
* DEC15/11 SKU CHANGE CV TO USE NEW DIFFERENCE                    *             
* AUG18/11 SKU CHANGE UV TO USE NEW DIFFERENCE                    *             
* APR10/09 SKU CHANGE KH TO USE OLD DIFFERENCE                    *             
* SEP16/04 SKU MAKE XML AWARE                                     *             
* SEP02/04 HQ  FIX OFFICE LIMIT FOR KATZ                          *             
* AUG20/04 HQ  ONE-LINE INBOX LIVE                                *             
* JUN21/04 HQ  USE TEMPSTOR 3,4 INSTEAD OF 2,3                    *             
* NOV24/03 HQ  BUG FIX: CLEAR SYSSPARE FOR MGGROUP/SELECT         *             
* OCT01/03 BU  USE 'E1' SCREEN FOR INBOX, RATHER THAN 'F0'        *             
* SEP26/03 HQ  BUG FIX: VALIDATE MAKEGOOD SCREEN BEFORE MOVE INFO *             
* SEP24/03 BU  SAVE DARE PROFILE AS WELL AS CONTRACT              *             
* JUN10/03 BU  SAVE BASERD FOR QUICK EXIT                         *             
...
DAR20    MVC   DMCB+7(1),0(R2)                                                  
         ...
         BCT   R0,DAR20                                                         
*                                                                               
         CLI   PFKEY,12            SKIP IF NOT PFKEY 12                         
         BNE   DAR25                                                            
         CLC   =C'LIST',CONACT     AND NOT ACTION LIST                          
         BNE   DAR25                                                            
*                                                                               
         LAY   R4,CONHEADH+3500                                                 
         CLC   =C'RIS',3(R4)                                                    
         BE    DAR23                                                            
         CLC   =C'CON',3(R4)                                                    
         BNE   DAR25                                                            
*                                                                               
DAR23    DS    0H                                                               
         LA    R3,WORK             ESTABLISH SAVED TRANSFER BLOCK               
         USING GLVXFRSY,R3                                                      
*                                                                               
         XC    WORK,WORK                                                        
*                                                                               
         ...
         MVC   GLVXTOPR,3(R4)      LAST CALLER PROG                             
         MVC   GLVXSESR,7(R4)      RETURN TO CALLER'S SESSION ID                
...
*                                                                               
         ...
         USING COMFACSD,R4                                                      
*                                                                               
         GOTO1 CGLOBBER,DMCB,=C'PUTD',GLVXFRSY,24,GLVXCTL                       
*                                                                               
         CLI   DMCB+8,0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
...
DAR30    DS    0H                  EXPECTING REC/ACT ORDER/LIST                 
         ...
         BCTR  R1,0                                                             
*&&DO                                                                           
* HARD CODING FOR "BUY" COMPARE WITH "BUYER"                                    
         CLI   CONREC,C'B'                                                      
         BNE   DAR35                                                            
         TM    CONRECH+1,X'01'     MODIFIED?                                    
         BZ    DAR35                                                            
         MVC   CONREC(5),=C'BUYER' FORCE B/BU/BUY TO BUYER                      
*        CHI   R1,2                THREE CHARACTERS?                            
*        BNH   DAR50                                                            
*                                                                               
* END OF HARD CODING                                                            
*&&                                                                             
DAR35    DS    0H                                                               
         EX    R1,DAR40            LOOK FOR MAKEGOOD GROUP                      
         BE    DAR110                                                           
         EX    R1,DAR41            LOOK FOR CAMPAIGN                            
         BE    DAR110                                                           
         EX    R1,DAR42            LOOK FOR BUYER                               
         BE    DAR110                                                           
         EX    R1,DAR43            LOOK FOR FLIGHT                              
         BE    DAR110                                                           
         EX    R1,DAR44            LOOK FOR SENTDATE                            
         BE    DAR110                                                           
         EX    R1,DAR45            LOOK FOR TODO                                
         BE    DAR110                                                           
         EX    R1,DAR46            LOOK FOR UNDO                                
         BE    DAR110                                                           
         B     DAR50                                                            
DAR40    CLC   CONREC(0),=C'MGGROUP'                                            
DAR41    CLC   CONREC(0),=C'CAMPAIGN'                                           
DAR42    CLC   CONREC(0),=C'BUYER'                                              
DAR43    CLC   CONREC(0),=C'FLIGHT'                                             
DAR44    CLC   CONREC(0),=C'SENTDATE'                                           
DAR45    CLC   CONREC(0),=C'TODO    '                                           
DAR46    CLC   CONREC(0),=C'UNDO    '                                           
...
DAR185   DS    0H                  SAME FOR MAKEGOOD                            
         ...
         CLC   =C'LIS',CONACT                                                   
         BNE   DAR250                                                           
         CLC   =C'SZ',AGENCY       FORCE LIMIT EVERY TIME FOR KATZ              
         BE    DAR186                                                           
         CLC   =C'CQ',AGENCY                                                    
         BE    DAR186                                                           
         CLC   =C'AM',AGENCY                                                    
         BE    DAR186                                                           
*                                                                               
         CLI   DE1OFFH+5,0         AND FIRST TIME                               
         BNE   DAR200                                                           
*        TM    DE1OFFH+4,X'20'     FORCE OFFICE LIMIT ACCESS                    
*        BO    DAR200                                                           
*                                                                               
DAR186   DS    0H                                                               
         CLC   =C'O=',TWAACCS                                                   
         BNE   DAR200                                                           
         MVC   DE1OFF(2),TWAACCS+2    IN THE OFFICE SCRN FIELD                  
*                                                                               
...
*                                                                               
DAR200   DS    0H                                                               
         CLI   TWASCR,X'E1'        IS ONE-LINE INBOX LOADED?                    
         BNE   DAR202              NO                                           
...
*                                                                               
         GOTO1 CALLOV,DMCB,0,X'D9080F24',0                                      
         MVC   VREDAR24,0(R1)      ESTABLISH REDAR24 OVERLAY                    
...
*                                                                               
         ...
         USING GLVXFRSY,R3                                                      
*                                                                               
* HACK TO SAVE OFF GLOBBER INFO IN TWA SO WE CAN RETURN TO CALLER               
*                                                                               
         LAY   R4,CONHEADH+3500                                                 
         MVC   0(3,R4),GLVXFRSY    SAVE OFF CALLER SYSTEM                       
         MVC   3(3,R4),GLVXFRPR    SAVE OFF CALLER PROGRAM                      
         MVC   6(1,R4),GLVXFLG1    SAVE OFF CALLER FLAGS                        
         MVC   7(1,R4),GLVXSESR    SAVE OFF CALLER SESSION ID                   
*                                                                               
         XC    CONREC,CONREC                                                    
...
*                                                                               
SETP060  MVC   SVPGPBIT(8),2(RE)   SAVE CONTRACT PROFS IN TWA.                  
         B     SETP055             NOW LOOK FOR DARE PROFILE                    
*                                                                               
SETP070  MVC   SVDGPBIT(8),2(RE)   SAVE DARE PROFS IN TWA.                      
*SETP070  MVC   SV2GPBIT(8),2(RE)   SAVE DARE PROFS IN TWA.                     
*                                                                               
SETP100  EQU   *                                                                
* HQ     TM    SVDGPBIT+DAR1LINB,DAR1LINA                                       
*        TM    SV2GPBIT+DAR1LINB,DAR1LINA                                       
*                                  USE SINGLE LINE IN-BOX?                      
* HQ     BZ    SETP120             NO                                           
*                                                                               
*   TURN OFF TV DOUBLE LINE ORDER LIST SELECTIONS                               
*                                                                               
...
SETP110  EQU   *                                                                
         ...
         B     SETP160             NOW SET TO SINGLE LINE                       
*                                                                               
*   TURN OFF SINGLE LINE LIST SELECTIONS                                        
*                                                                               
SETP120  EQU   *                                                                
...
*        BNE   CHKR100                                                          
*                                                                               
         CLC   =C'SZ',AGENCY       KATZ WILL ALWAYS GO TO NEW REVISION          
         BE    CHKR150                                                          
         CLC   =C'CQ',AGENCY                                                    
         BE    CHKR150                                                          
         CLC   =C'AM',AGENCY                                                    
...
*                                                                               
         ...
         AHI   R4,DARPROFS-CONHEADH                                             
         USING SVDSECT,R4                                                       
         TM    DMISFLGX,X'04'      USE OLD SPOT BASED DIFF SCRN?                
         BZ    CHKR150                                                          
*        NI    DMISFLGX,X'FF'-X'04'                                             
         DROP  R4                                                               
*                                                                               
CHKR100  DS    0H                                                               
         LA    RF,NEWREV           DISABLE NEW REVISION                         
         LA    R0,NEWREV#                                                       
         B     CHKR200                                                          
*                                                                               
CHKR150  DS    0H                                                               
*                                                                               
         LA    RF,OLDREV           DISABLE OLD REVISION                         
         LA    R0,OLDREV#                                                       
*                                                                               
CHKR200  EQU   *                                                                
         MVI   1(RF),X'FF'         OVERWRITE RECORD NUMBER                      
         LA    RF,RECACTL(RF)      BUMP TO NEXT ENTRY                           
         BCT   R0,CHKR200          OVERWRITE RECORD NUMBER                      
*                                                                               
CHKRX    DS    0H                                                               
         B     XIT                                                              
*&&DO                                                                           
* EVERYBODY WILL GO TO NEW REVISION REGARDLESS OF THE OFFICE PROFILE            
*=====================================================================          
...
*                                                                               
         ...
         BZ    CON19B                                                           
         OI    CCONFLAG,CCONXML    SET XML FLAG                                 
         DROP  R6                                                               
...
*                                                                               
         ...
         BE    INIT30                                                           
*                                                                               
         CLC   CONREC(7),=C'MGGROUP'                                            
         BNE   INIT15              ALWAYS CLEAR FOR MGGROUP SELECT              
         CLI   BYTE,MYACTSEL                                                    
         BNE   INIT15                                                           
         CLI   SVACT,ACTLIST       IF COMING FROM THE MGGROUP/LIST SCR          
         BE    INIT20                                                           
*                                                                               
INIT15   DS    0H                                                               
...
*                                                                               
         CLC   CONREC,=C'ORDER   ' HARD CODING TO CORRECTLY                     
         BE    RPROG04                                                          
         CLC   CONREC,=C'FLIGHT  ' HARD CODING TO CORRECTLY                     
         BE    RPROG04                                                          
         CLC   CONREC,=C'SENTDATE' HARD CODING TO CORRECTLY                     
         BE    RPROG04                                                          
         CLC   CONREC,=C'BUYER   ' HARD CODING TO CORRECTLY                     
         BE    RPROG04                                                          
         CLC   CONREC,=C'CAMPAIGN' HARD CODING TO CORRECTLY                     
         BNE   RPROG05                                                          
RPROG04  DS    0H                                                               
         CLC   CONACT,=C'LIST    ' SET UP SCREEN NUMBER FOR STEREO              
         BNE   RPROG05                                                          
         CLI   TWASCR,X'FE'        FE = TWO LINE INBOX                          
         BE    RPROG10                                                          
         MVI   TIOBCNT,X'E6'       FORCE ONE LINE INBOX SCREEN TO E6            
         DROP  R4                                                               
*                                                                               
RPROG05  DS    0H                                                               
         CLI   TWASCR,X'FD'                                                     
...
*                                  CL2 CODE FOR EOD HANDLING                    
         SPACE 1                                                                
*                                                                               
*   FOLLOWING SECTION IS TABLE ENTRY FOR TWO-LINE INBOX.                        
*                                                                               
RECACT2  EQU   *                                                                
...
RECACT2# EQU   (*-RECACT2)/RECACTL                                              
         SPACE 1                                                                
*                                                                               
*   FOLLOWING SECTION IS TABLE ENTRY FOR ONE-LINE INBOX.                        
*                                                                               
RECACT3  DC    X'03',AL1(01,10),X'E104000080',C'    '  ORDER LIST TV            
RECACTL  EQU   *-RECACT3                                                        
         DC    X'03',AL1(01,13),X'E104000081',C'    '  ORDER SEL  TV            
         DC    X'03',AL1(01,12),X'E104000460',C'RURU'  DARE LIST REPORT         
         DC    X'03',AL1(08,10),X'E104000080',C'    '  CAMPAIGN LIST            
         DC    X'03',AL1(08,13),X'E104000081',C'    '  CAMPAIGN SEL             
         DC    X'03',AL1(08,12),X'E104000460',C'RURU'  DARE LIST REPORT         
         DC    X'03',AL1(09,10),X'E104000080',C'    '  BUYER LIST               
         DC    X'03',AL1(09,13),X'E104000081',C'    '  BUYER SEL                
         DC    X'03',AL1(09,12),X'E104000460',C'RURU'  DARE LIST REPORT         
         DC    X'03',AL1(10,10),X'E104000080',C'    '  FLIGHT LIST              
         DC    X'03',AL1(10,13),X'E104000081',C'    '  FLIGHT SEL               
         DC    X'03',AL1(10,12),X'E104000460',C'RURU'  DARE LIST REPORT         
         DC    X'03',AL1(11,10),X'E104000080',C'    '  SENTDATE LIST            
         DC    X'03',AL1(11,13),X'E104000081',C'    '  SENTDATE SEL             
         DC    X'03',AL1(11,12),X'E104000460',C'RURU'  DARE LIST REPORT         
...
*======================================================================         
* SPECIAL FOR NEW DIFFERENCE SCREEN                                             
OLDREV   DS    0H                                                               
         DC    X'03',AL1(06,15),X'F822000081',C'    '  REVISION  REJECT         
         DC    X'03',AL1(06,17),X'E822000081',C'    '  REVISION  OP/RJ          
OLDREV#  EQU   (*-OLDREV)/RECACTL                                               
*                                                                               
NEWREV   DS    0H                                                               
         DC    X'03',AL1(06,15),X'F824000081',C'    '  REVISION  REJECT         
         DC    X'03',AL1(06,17),X'EB24000081',C'    '  REVISION  OP/RJ          
NEWREV#  EQU   (*-NEWREV)/RECACTL                                               
*======================================================================         
*                                                                               
*        DC    X'03',AL1(06,15),X'F824000081',C'    '  REVISION  REJECT         
*        DC    X'03',AL1(06,17),X'EB24000081',C'    '  REVISION  OP/RJ          
...
*                                                                               
* INBOX BULK PRINT OPTION -                                                     
*                                                                               
         DC    X'03',AL1(12,12),X'E704000460',C'RERE'  DAO PRINT REPORT         
         DC    X'FF'                                                            
         EJECT                                                                  
         LTORG                                                                  
         EJECT                                                                  
...
************                                                                    
       ...
       ++INCLUDE REDARF2D          MAKEGOOD LIST SCREEN                         
         ORG   CONTAGH                                                          
       ++INCLUDE REDARE7D          TODO REPORT SCREEN                           
**********************************************                                  
...
****************************                                                    
       ...
       ++INCLUDE DDGLVXCTLD                                                     
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'042REDAR00   11/06/13'                                      
         END                                                                    
