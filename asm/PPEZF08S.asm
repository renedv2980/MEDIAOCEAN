*          DATA SET PPEZF08S   AT LEVEL 043 AS OF 05/01/02                      
*PHASE T43008A,*                                                                
*INCLUDE BINSRCH2                                                               
...
***********************************************************************         
         SPACE 2                                                                
         DS    0D                                                               
VPFKEY   NMOD1 0,**#VPFKY                                                       
*                                                                               
         L     RC,SVRC             RE-ESTABLISH WORKING STORAGE                 
         USING GEND,RC                                                          
*                                                                               
...
*                                                                               
         ...
         USING GLVXFRSY,R1                                                      
*                                                                               
         MVC   GLVXFRSY,=C'PRT'    FROM THE PRINT SYSTEM                        
         MVC   GLVXFRPR,=C'EPI'    EPIC  PROGRAM                                
         MVC   GLVXTOSY,=C'PRT'    TO THE PRINT SYSTEM                          
...
***********************************************************************         
         SPACE 2                                                                
LSWRHOOK NMOD1 0,LSWRHOOK                                                       
*                                                                               
         L     RC,SVRC             RESTORE WORKING STORAGE POINTER              
         USING GEND,RC                                                          
*                                                                               
...
LSWRSPTP DS    0H                                                               
*                                                                               
         CLI   EZSPRCOM,C'Y'       SKIP IF A COMBO SUMMARY                      
         BE    LSWRSPTX                                                         
*                                                                               
         ...
         STCM  RF,3,INSCTR                                                      
*                                                                               
         CLM   RF,3,ELTSEQ         SET SEQUENCE NUMBER IN TABLE ELEMENT         
...
*                                                                               
         MVC   EZSPCVPR,EZSPCVPR-EZSPFRST+ELTELEM  REPLACE PRODUCT              
         MVC   EZSPCVES,EZSPCVES-EZSPFRST+ELTELEM  REPLACE ESTIMATE             
*                                                                               
         DROP  RF                                                               
*                                                                               
         GOTO1 DATAMGR,DMCB,=C'WRITE',EPICWK,CURWKIXD,AIO2,WRKFBUFA             
...
*                                                                               
         ...
         BE    LSBHSPTX                                                         
*                                                                               
         XC    ELTABD(256),ELTABD    INIT ENTRY                                 
         XC    ELTABD+256(ELTABL-256),ELTABD+256                                
*                                                                               
...
*                                                                               
         ...
         MVC   ELTELEM(256),EZSPFRST    ADD INSERT DETAILS TO TABLE             
         MVC   ELTELEM+256(L'ELTELEM-256),EZSPFRST+256                          
*                                                                               
         ICM   R0,15,BSPNOR                                                     
...
*                                                                               
         ...
         BZ    LHDTSQNX                                                         
*                                                                               
         EDIT  INSCTR,(3,DTLTSQN),ALIGN=LEFT   DISPLAY TOTAL #                  
*                                                                               
LHDTSQNX DS    0H                                                               
*                                                                               
...
*                                  DEFAULT TO ESTIMATE OVERRIDE                 
         CLC   EZSPCVES,SPACES     SKIP IF SPACE FILLED                         
         BE    LHDECD0                                                          
*                                                                               
...
*                                                                               
         ...
         BZ    LHDINSX                                                          
*                                                                               
         EDIT  EZSPBICS,(5,DTLINS),ALIGN=LEFT   SET NUMBER OF INCHES            
*                                                                               
LHDINSX DS     0H                                                               
*                                                                               
...
*                                                                               
         ...
         XC    WRKELTAB+256(L'WRKELTAB-256),WRKELTAB+256                        
*                                                                               
...
*                                                                               
         L     RF,BSPAREC          POINT TO FOUND ELEMENT                       
*                                                                               
         MVC   WRKELTAB(256),0(RF)      COPY OLD ELEMENT                        
         MVC   WRKELTAB+256(L'WRKELTAB-256),256(RF)                             
*                                                                               
LHVL10   DS    0H                                                               
*                                                                               
         LA    R3,ELTELEM          INITIALIZE ELEMENT                           
         USING EZSPFRST,R3         ESTABLISH PZ DETAIL ELEMENT                  
*                                                                               
...
*                                                                               
         ...
         BH    LHVEPRLN                                                         
*                                                                               
         XC    EZSPCVPR,EZSPCVPR   INIT CONVERTED PRODUCT CODE                  
*                                                                               
...
****                                                                            
****     MVC   DTLPCD(3),EZSPLPRC     USE DETAIL LOOKED UP PRODUCT              
****                                                                            
...
*                                                                               
         GOTO1 VALIPRD                                                          
*                                                                               
         MVC   EZSPCVPR,WORK       SAVE PRODUCT CODE                            
*                                                                               
...
*                                                                               
         NI    DTLPCDH+1,X'FF'-X'0C'   TURN OFF HIGHLIGHTING                    
*                                                                               
****     CLC   EZSPCVPR,EZSPLPRC   IF THIS IS NEW PRODUCT                       
****     BE    LHVPRDX1                                                         
         CLC   =C'***',EZIHCVPR-EZIHFRST+SVINVHDR  SKIP IF VARIOUS PROD         
         BE    LHVPRDX0                                                         
         CLC   EZSPCVPR,EZIHCVPR-EZIHFRST+SVINVHDR                              
         BE    LHVPRDX1                                                         
         CLC   EZIHCVPR-EZIHFRST+SVINVHDR,SPACES  SKIP IF HAVE PROD             
         BH    LHVPRDX0                                                         
         CLC   EZSPCVPR,EZIHLPRC-EZIHFRST+SVINVHDR                              
         BE    LHVPRDX1                                                         
*                                                                               
LHVPRDX0 DS    0H                                                               
*                                                                               
...
LHVPRDX1 DS    0H                                                               
*                                                                               
         XC    EZSPCVPR,EZSPCVPR   NOT AN OVERRIDE                              
*                                                                               
LHVPRDX2 DS    0H                                                               
*                                                                               
...
*                                                                               
         ...
         BH    LHVESTLN                                                         
*                                                                               
         XC    EZSPCVES,EZSPCVES   INIT CONVERTED ESTIMATE CODE                 
*                                                                               
...
*                                                                               
         ...
         BL    LHVESTDT                                                         
*                                                                               
         CLC   EZSPDATE,SPACES     SKIP IF NO INSERTION DATE                    
         BNH   LHVEST99                                                         
*                                                                               
         CLC   PESTST,EZSPDATE     INSERT DATE IN ESTIMATE PERIOD               
         BH    LHVESTDT                                                         
         CLC   PESTEND,EZSPDATE                                                 
         BL    LHVESTDT                                                         
*                                                                               
LHVEST99 DS    0H                                                               
*                                                                               
...
*                                                                               
         MVC   EZSPCVES,PESTKEST   SAVE ESTIMATE NUMBER                         
*                                                                               
LHVESTOK DS    0H                                                               
*                                                                               
LHVESTX  DS    0H                                                               
*                                                                               
         NI    DTLECDH+1,X'FF'-X'0C'   TURN OFF HIGHLIGHTING                    
*                                                                               
         CLC   EZSPCVES,EZIHCVES-EZIHFRST+SVINVHDR IF NEW ESTIMATE              
         BE    LHVESTX1                                                         
*                                                                               
         OI    DTLECDH+1,X'08'        HIGHLIGHT FIELD                           
         B     LHVESTX2                                                         
...
LHVESTX1 DS    0H                                                               
*                                                                               
         XC    EZSPCVES,EZSPCVES   NOT AN OVERRIDE                              
*                                                                               
LHVESTX2 DS    0H                                                               
*                                                                               
...
*                                                                               
         MVC   EZSPCVPR-EZSPFRST+ELTELEM,EZSPCVPR   PRODUCT CODE                
         MVC   EZSPCVES-EZSPFRST+ELTELEM,EZSPCVES   ESTIMATE NUMBER             
         MVC   EZSPLPRN-EZSPFRST+ELTELEM,EZSPLPRN   PRODUCT NAME                
         MVC   EZSPLPRC-EZSPFRST+ELTELEM,EZSPLPRC   PRODUCT CODE                
*                                                                               
*        SET NEW ELTLAST                                                        
*                                                                               
...
ELTMAX   EQU   50                  MAX NUMBER OF ELEMENTS IN TABLE              
*                                                                               
...
ELTELEM  DS    XL(EZSPDLEN)        PZBLOCK INSERTION DETAILS                    
...
* PPGENPZ                                                                       
       ...
       ++INCLUDE PPGENPZ                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'043PPEZF08S  05/01/02'                                      
         END                                                                    
