*          DATA SET SCHO9907   AT LEVEL 045 AS OF 05/01/02                      
*PHASE DESCHOSD,                                                                
*********************************************************************           
* NHTI -  HISPANIC TAPE AND GEN'L MKT AFFILIATES TAPE                           
* IPHASE: DESCHOSD                                                              
* OPHASE: DECNVH95                                                              
*********************************************************************           
         TITLE 'DEMO CONVERSION - NTHI HISPANIC MIT FMT'                        
DESCHOSD CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,DESCHOSD,RA,R3,R4,RR=RE                                        
...
OPTN     CLI   400(RC),C'A'                                                     
         ...
         CLI   400(RC),C'B'                                                     
         BE    OPTOK                                                            
         CLI   400(RC),C'0'        OPTNL FLAGS '0'-'9' VALID                    
         BL    RDTEST                                                           
         CLI   400(RC),C'9'                                                     
         BH    RDTEST                                                           
OPTOK    DS    0H                                                               
...
RDR      DS    0H                                                               
         ...
         MVC   TAPEMKT,=H'500'     REGULAR NTHI TAPE                            
         CLC   =C'NHTI AUDIENCE ESTIMATES',RDRRPT                               
         BE    RDR5                                                             
*                                                                               
         MVI   TAPETYP,C'T'        SPECIAL TAPE: TIME PERIODS ONLY              
         CLC   =C'NTI HUT/PUT SPECIAL UNIVISION REPORT',RDRRPT                  
         BE    RDR5                                                             
*                                                                               
         MVI   TAPETYP,C'A'        SPECIAL TAPE: AFFILIATES-PRGMS ONLY          
         MVC   TAPEMKT,=H'501'                                                  
         CLC   =C'NHTI GEN''L MKT ESTIMATES',RDRRPT                             
         BE    RDR5                                                             
...
*                                                                               
RLHLF25  MVC   MKTBRK,=AL2(COUSA)  TOTAL SAMPLE ONLY                            
         MVI   INTBTYP,X'00'                                                    
         XC    INTPNUM,INTPNUM                                                  
         MVC   INTPNUM+1(1),INTSQH    1/4 HR ID                                 
...
RLHLF30  CLI   WKSFLG,C'N'                                                      
         ...
         MVC   INTIBOOK,TAPEBK                                                  
         B     BLDKEY              OUTPUT THE 1/2HR RECD                        
*                                                                               
RELHLFX  DS    0H                                                               
...
*                                                                               
         ...
         LA    RE,1(RE)                                                         
         STC   RE,RELSLOT                                                       
         B     BLDKEY              OUTPUT THE STATION GROUP RECDS (P)           
         EJECT                                                                  
* *********************************************************************         
...
*                                                                               
         ...
         B     RLGSUM5                                                          
*                                                                               
RLGSUM5  B     BLDKEY              RELEASE HUT RECORD                           
*                                                                               
...
NMKTS    EQU   10                  INCLUDES TOTAL SAMPLE=000                    
         EJECT                                                                  
**********************************************************************          
...
*                                 LANGUAGE                                      
CRSPASP  EQU   511                 PREDOMINANTLY SPANISH SPEAKING               
CRENGSP  EQU   512                 PREDOMINANTLY ENGLISH SPEAKING               
CRBILSP  EQU   513                 BILINGUAL                                    
*                                                                               
         SPACE 2                                                                
...
*                                 PRESENCE OF NON-ADULTS                        
CINAU18  EQU   1                   ANY UNDER 18                                 
CINAU12  EQU   2                   ANY UNDER 12                                 
CINAU06  EQU   3                   ANY UNDER 6                                  
CINAU03  EQU   4                   ANY UNDER 3                                  
CINA611  EQU   5                   ANY 6-11                                     
CINA1217 EQU   6                   ANY 12-17                                    
*                                 LANGUAGE                                      
CISPASP  EQU   7                   PREDOMITDNATELY SPANISH SPEAKING             
CIENGSP  EQU   8                   PREDOMITDNATELY ENGLISH SPEAKING             
CIBILSP  EQU   9                   BILINGUAL                                    
*                                                                               
         SPACE 2                                                                
...
*                                 LANGUAGE                                      
COSPASP  EQU   05                  PREDOMITDNATELY SPANISH SPEAKING             
COENGSP  EQU   06                  PREDOMITDNATELY ENGLISH SPEAKING             
COBILSP  EQU   07                  BILINGUAL                                    
*                                                                               
         EJECT                                                                  
...
*                                 LANGUAGE                                      
         DC    AL2(CRSPASP,CISPASP) PREDOMITDNATELY SPANISH SPEAKING            
         DC    AL2(CRENGSP,CIENGSP) PREDOMITDNATELY ENGLISH SPEAKING            
         DC    AL2(CRBILSP,CIBILSP) BILLINGUAL                                  
         DC    X'FFFF',X'FFFF'                                                  
         SPACE 2                                                                
...
*                                 LANGUAGE                                      
         DC    AL2(CISPASP,COSPASP),X'00' SPANISH SPEAKING                      
         DC    AL2(CIENGSP,COENGSP),X'00' ENGLISH SPEAKING                      
         DC    AL2(CIBILSP,COBILSP),X'00' BILLINGUAL                            
         DC    X'FFFF',X'FFFF',X'FF'                                            
         EJECT                                                                  
*                                                                               
* TABLE OF NETWORK AFFILIATES CALL LETTERS AND MKT NUMBERS                      
NETTAB   DS    0CL7                          NEW DEFN  AS OF 7/99               
         DC    AL2(03),CL3'PBS',AL2(500)                                        
         DC    AL2(04),CL3'PPY',AL2(500)     PREMIUM PAY                        
         DC    AL2(10),CL3'AFA',AL2(502)     ABC: GEN'L MKT TAPE                
         DC    AL2(11),CL3'AFC',AL2(502)     CBS: GEN'L MKT TAPE                
         DC    AL2(12),CL3'AFN',AL2(502)     NBC: GEN'L MKT TAPE                
         DC    AL2(15),CL3'AGT',AL2(500)                                        
         DC    AL2(16),CL3'AGU',AL2(500)                                        
         DC    AL2(17),CL3'AGH',AL2(500)                                        
         DC    AL2(21),CL3'AFF',AL2(502)     FOX: GENL MKT (INCL CBL)           
         DC    AL2(24),CL3'ONA',AL2(500)     OTHER ENG LANG NET AFF             
         DC    AL2(26),CL3'TNA',AL2(500)     TOTAL ENG LANG NET AFF             
         DC    AL2(30),CL3'EIN',AL2(500)     ENG LANG INDEP BROADCAST           
         DC    AL2(31),CL3'ACX',AL2(500)     AD SUP CBL EXCL SP LNG CBL         
         DC    AL2(32),CL3'OCX',AL2(500)     OTHER CBL EXCL SP LNG CBL          
         DC    AL2(33),CL3'SCN',AL2(500)     SP LANG CABLE NETS                 
         DC    AL2(34),CL3'SIN',AL2(500)     SP LANG INDEPENDENTS               
*                                                                               
*>>>COMMENT OUT AFTER SEP99!!!                                                  
*        DC    AL2(03),CL3'PBS',AL2(500)                                        
*        DC    AL2(04),CL3'PAY',AL2(500)                                        
*        DC    AL2(06),CL3'AFF',AL2(502)     FOX: GEN'L MKT TAPE                
*        DC    AL2(08),CL3'SUP',AL2(500)                                        
*        DC    AL2(10),CL3'AFA',AL2(502)     ABC: GEN'L MKT TAPE                
*        DC    AL2(11),CL3'AFC',AL2(502)     CBS: GEN'L MKT TAPE                
*        DC    AL2(12),CL3'AFN',AL2(502)     NBC: GEN'L MKT TAPE                
*        DC    AL2(13),CL3'AGD',AL2(500)                                        
*        DC    AL2(15),CL3'AGT',AL2(500)                                        
*        DC    AL2(16),CL3'AGU',AL2(500)                                        
*        DC    AL2(17),CL3'AGH',AL2(500)                                        
*        DC    AL2(18),CL3'XIN',AL2(500)                                        
*        DC    AL2(19),CL3'CAE',AL2(500)                                        
...
*        DEDEMCNVD                                                              
       ++INCLUDE DEDEMCNVD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045SCHO9907  05/01/02'                                      
         END                                                                    
