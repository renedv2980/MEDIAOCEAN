*          DATA SET UTILUBILL  AT LEVEL 248 AS OF 04/09/03                      
*PHASE T32070C                                                                  
*INCLUDE CLUNPK                                                                 
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
...
*******************************************************************             
*  OPTIONS:                                                                     
*  NUBIL       - OPTTYPE=X'80' BUILD NEW 'OE06' RECORDS                         
*                                                                               
*******************************************************************             
T32070   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'248UTILUBILL 04/09/03'                                      
         END                                                                    
