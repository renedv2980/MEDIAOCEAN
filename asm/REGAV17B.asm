*          DATA SET REGAV17B   AT LEVEL 091 AS OF 05/01/02                      
*PHASE T81317B,+0                                                               
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLST                                                                
...
VK75     DS    0H                                                               
         ...
         CLI   ACTNUM,ACTLIST                                                   
         BNE   VK100                                                            
         BAS   RE,SELRLIST         CHECK IF ANY SELECTED                        
*                                                                               
         CLI   CCONEFF,0           ANYONE SELECTED?                             
         BE    VK100                                                            
         MVI   MYSCRNUM,X'E5'                                                   
         MVI   PFKEY,5                                                          
         GOTO1 VPFCALL                                                          
...
****************************************************************                
SELRLIST NTR1                                                                   
         LA    R2,LINSELH          1ST SELECT FIELD IN LIST                     
         LA    R3,15               MAX # IN LIST                                
         SR    R6,R6               COUNTER = # OF R                             
*                                                                               
SELR10   DS    0H                                                               
...
*                                                                               
         CLC   =C'X+',8(R2)        MARK ALL FROM THIS POINT ON?                 
         BNE   SELR25                                                           
*                                                                               
...
*                                                                               
SELR27   DS    0H                                                               
         CLI   0(R5),C'X'          RECORD SELECTED BY 'R'                       
         BE    SELR30              YES                                          
*                                                                               
...
*                                                                               
         ...
         BAS   RE,NEXTFLD                                                       
*                                                                               
         MVC   CCONEFF,8(R2)       SAVE AWAY CODE                               
         B     SELR40                                                           
*                                                                               
SELR35   BAS   RE,NEXTFLD                                                       
*                                                                               
SELR40   BAS   RE,NEXTFLD          NEXT SELECT FIELD                            
         BCT   R3,SELR10                                                        
*                                                                               
SELRX    DS    0H                                                               
         B     EXIT                                                             
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'091REGAV17B  05/01/02'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
