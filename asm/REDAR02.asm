*          DATA SET REDAR02    AT LEVEL 178 AS OF 02/13/03                      
*PHASE T80F02B                                                                  
*INCLUDE REREPDIF                                                               
*INCLUDE GETBROAD                                                               
*INCLUDE REDARTKO                                                               
...
*                                                                     *         
* 08FEB03 (SKU) TEMP VERSION TO TRAP INCORRECT OFFICE LIST BUG        *         
* 12FEB03 (BU ) ADD REPORT PRINT FIX                                  *         
*                                                                     *         
*                                                                     *         
*               ***  END TOMBSTONE  ***                               *         
***********************************************************************         
...
*                                  MOVE 2ND PART OF LINE UP 7 CHARS             
         ...
         B     LR480                                                            
LR460    DS    0H                                                               
         CLI   TWAOFFC,C'*'        DDS TERMINAL, SKIP TRAP                      
         BE    LR470                                                            
         CLI   DE1HDLNH+5,0        ANY CON # ENTERED?                           
         BNE   LR470                                                            
         CLI   DE1OFFH+5,0         FILTER ON OFFICE?                            
...
*                                                                               
         L     RF,AIO                                                           
         USING RDARREC,RF                                                       
         CLC   DE1OFF(2),RDARKAOF  OFFICES MUST MATCH                           
         BE    *+6                                                              
         DC    H'0'                DIE, DIE, DIE!!                              
         DROP  RF                                                               
*                                                                               
...
*                                                                               
         GOTO1 (RFGENDTR,REPFACS),DMCB,(X'41',ACOMFACS),AIO3,AIO,      X        
               AIO2                                                             
*                                                                               
         GOTOR REDILNK               RADIO EDI LINKING(AIO IS MODIFIED          
*                                    IN THIS ROUTINE)                           
         GOTOR DTTMSTMP              STAMP LINK DATE/TIME                       
         GOTOR PREBOOK               MARK PREBOOK                               
*                                                                               
         L     R6,AIO                                                           
         USING RDARREC,R6                                                       
...
MF4STACF EQU   X'04'               ORDER BECAME A STACF WHEN LINKED             
HDRDA2   DS    XL4                                                              
PENDCF   DS    X                                                                
*                                                                               
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'178REDAR02   02/13/03'                                      
         END                                                                    
