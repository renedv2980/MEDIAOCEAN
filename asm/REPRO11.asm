*          DATA SET REPRO11    AT LEVEL 020 AS OF 06/28/00                      
*&&      SET   NOP=N                                                            
*PHASE T80A11C                                                                  
...
VALCON   DS    0H                                                               
         ...
         BNE   VALCON0             NO                                           
         CLI   CSACT,A#ADD         PRO/ADD?                                     
         BNE   VALCON0                                                          
         MVC   FVMSGNO,=AL2(519)   YES - ADDS NOT ALLOWED                       
         B     EXITL                                                            
*                                                                               
...
* DDGLVXCTLD                                                                    
       ...
       ++INCLUDE DDGLVXCTLD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020REPRO11   06/28/00'                                      
         END                                                                    
