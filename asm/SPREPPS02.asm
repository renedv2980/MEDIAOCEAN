*          DATA SET SPREPPS02  AT LEVEL 027 AS OF 05/11/05                      
*PHASE SPPS02A                                                                  
*INCLUDE TSCAN                                                                  
         TITLE 'SPREPPS02 - MASTER SPILL EXTRACT '                              
         PRINT NOGEN                                                            
*                                                                               
*                                                                               
...
*        QOPT6   (QOPT5+1) Y=USE LOWER THRESHOLD (ARB ONLY)                     
*                                                                               
SPPS02   CSECT                                                                  
         NMOD1 0,SPPS02,RR=R5                                                   
*                                                                               
         L     R9,0(R1)                                                         
         LA    RA,2048(R9)                                                      
         LA    RA,2048(RA)                                                      
...
SP126D   DS    0H                                                               
         ...
         BE    SP126H                                                           
         LA    RF,STNADI           SET ORIGINATING MKT                          
         CLI   SRCE,C'A'                                                        
         BE    *+8                                                              
         LA    RF,STNDMA                                                        
         MVC   WORK(3),0(RF)                                                    
         ...
         STH   R0,ORIGMKT                                                       
*                                                                               
         OC    BMKT,BMKT           TEST SINGLE MKT REQ                          
         BZ    *+14                                                             
         CLC   BMKT,ORIGMKT                                                     
         BNE   SP126H                                                           
*                                  GET ORIG MARKET NAME                         
         MVC   ORIGNAM,MKNAM                                                    
         CLC   ORIGMKT,MKNUM       TEST 'SPILL INTO SELF'                       
         BE    SP126E6                                                          
*                                                                               
         LA    R2,X                                                             
         XC    X,X                                                              
         MVC   MKNUM,ORIGMKT                                                    
         GOTO1 BINSRCH,MKTPARS,X                                                
         CLI   0(R1),1                                                          
         BNE   SP126E                                                           
         MVC   ORIGNAM,SPACES                                                   
         MVC   ORIGNAM(4),=C'****'    MKT NOT FOUND                             
         B     SP126E4                                                          
*                                                                               
SP126E   DS    0H                                                               
         L     R2,0(R1)                                                         
         MVI   MKSPIL,C'Y'         SET IS A MKT THAT SPILLS                     
         MVC   ORIGNAM,MKNAM                                                    
*                                                                               
SP126E4  DS    0H                                                               
         L     R2,SVADMKT          RESTORE CURRENT POINTER                      
*                                                                               
SP126E6  DS    0H                                                               
         GOTO1 =A(DPTDEM)                                                       
*                                                                               
...
BMSLST   NTR1                                                                   
         ...
         BNL   BMSLX                                                            
         CLI   MLSTAT,C'V'         ALWAYS SKIP CABLE                            
         BE    BMSLX                                                            
         CLC   MLSTAT(4),=C'WTBS'  AND WTBS                                     
         BE    BMSLX                                                            
         CLI   MLBTYP,0            IGNORE SPECIAL SURVEYS                       
         BE    BMSL4                                                            
         CLI   QOPT5+1,C'Y'        UNLESS LOWER THRESHOLD                       
         BNE   BMSLX                                                            
*                                                                               
BMSL4    DS    0H                                                               
         L     R3,ANXTMSL                                                       
...
DH030    MVC   GLAROUT,8(R1)                                                    
         ...
         SPACE 2                                                                
ROUTLIST DS    0F                                                               
         DC    C'MKTNUMO ',A(MKTNUMO)                                           
         DC    C'MKTNUMS ',A(MKTNUMS)                                           
         DC    C'MKTNAMO ',A(MKTNAMO)                                           
         DC    C'MKTNAMS ',A(MKTNAMS)                                           
         DC    C'STATID  ',A(STATID)                                            
         DC    C'DPTIPR  ',A(DPTIPR)                                            
         DC    C'DPTIPQ  ',A(DPTIPQ)                                            
         ...
         DC    C'DLHDPL  ',A(DLHDPL)                                            
         DC    C'OMKTOP  ',A(OMKTOP)                                            
         DC    C'SMKTOP  ',A(SMKTOP)                                            
         DC    C'DPTOPR  ',A(DPTOPR)                                            
         DC    C'SPILPCT ',A(SPILPCT)                                           
         DC    X'FF'                                                            
         EJECT                                                                  
*                                                                               
...
* INPUT ROUTINES                                                                
*                                                                               
MKTNUMO  DS    0H                  ORIGINATING MKT                              
         MVC   0(2,R3),ORIGMKT                                                  
         B     EXIT                                                             
*                                                                               
MKTNUMS  DS    0H                  SPILL MKT                                    
         CLC   ORIGMKT,MKNUM       IF ORIG MKT = SPILL MKT                      
         BNE   MKNS4                                                            
         XC    0(4,R3),0(R3)       SET SPILL MKT = 0                            
         MVI   SPILSW,C'N'                                                      
         B     EXIT                                                             
*                                                                               
MKNS4    DS    0H                                                               
         ...
         B     EXIT                                                             
*                                                                               
MKTNAMO  DS    0H                  ORIGINATING MKT NAME                         
         MVC   0(26,R3),ORIGNAM                                                 
         B     EXIT                                                             
*                                                                               
MKTNAMS  DS    0H                  SPILL MKT NAME                               
         MVC   0(26,R3),MKNAM                                                   
         B     EXIT                                                             
*                                                                               
STATID   DS    0H                                                               
...
*                                                                               
DPTIPR   DS    0H                  RATING                                       
         ZIC   RF,GLARGS           ARG IS DPT NUM                               
         BCTR  RF,R0                                                            
         MH    RF,=Y(NDEMS*4)      X NDEMS*4                                    
         L     R1,DPTDMS(RF)                                                    
         ST    R1,0(R3)                                                         
         B     EXIT                                                             
*                                                                               
DPTIPQ   DS    0H                  QTR HOURS                                    
         ZIC   RF,GLARGS           ARG IS DPT NUM                               
         SLL   RF,2                X 4                                          
         L     R1,DPTDVSRS-4(RF)                                                
         ST    R1,0(R3)                                                         
...
DPTNAM   DS    0H                                                               
         ...
         SPACE 2                                                                
*                                                                               
OMKTOP   DS    0H                  SAVE ORIG MKT  (REC 2 AND 3)                 
         MVI   GLHOOK,GLEDIT       LET DRIVER EDIT                              
         MVC   SVORMKT,0(R2)                                                    
         B     EXIT                                                             
         SPACE 2                                                                
*                                                                               
SMKTOP   DS    0H                  SAVE SPILL/ORIG STATUS (REC 3)               
         MVI   GLHOOK,GLEDIT       LET DRIVER EDIT                              
         MVI   SPILSW,C'N'                                                      
         OC    0(2,R2),0(R2)                                                    
         BZ    *+8                                                              
         ...
         SPACE 2                                                                
*                                                                               
DPTOPR   DS    0H                  SAVE ORIGINATING MKT RTG                     
         MVI   GLHOOK,GLEDIT       LET DRIVER EDIT                              
         CLI   SPILSW,C'N'                                                      
         BNE   EXIT                                                             
*                                                                               
         XC    X,X                                                              
         MVC   X(2),SVORMKT        LOOK FOR ORIG MKT                            
         GOTO1 BINSRCH,MKTPARS,X                                                
         CLI   0(R1),1                                                          
         BNE   *+6                                                              
         DC    H'0'                MKT NOT FOUND                                
         L     R7,0(R1)                                                         
         USING MKTTABD,R7                                                       
         ZIC   RF,GLARGS           ARG IS DPT NUM                               
         BCTR  RF,R0                                                            
         ...
         SPACE 2                                                                
*                                                                               
SPILPCT  DS    0H                  SAVE ORIGINATING MKT RTG                     
         MVI   GLHOOK,GLEDIT       LET DRIVER EDIT                              
         XC    X,X                                                              
         MVC   X(2),SVORMKT        LOOK FOR ORIG MKT                            
         GOTO1 BINSRCH,MKTPARS,X                                                
...
SPLP4    DS    0H                                                               
         ...
         M     R0,=F'10000'                                                     
         BAS   RE,DIV                                                           
         ST    R1,0(R2)            SET OUTPUT                                   
         B     EXIT                                                             
*                                                                               
DLHNMKTO DS    0H                  NUMBER OF ACTIVE MARKETS                     
         MVI   GLHOOK,GLEDIT                                                    
         MVC   0(2,R2),SMKTCNT+2                                                
         B     EXIT                                                             
         DROP R7                                                                
         SPACE 2                                                                
* RESOLVE LITERALS                                                              
...
*                                                                               
DH452    DS    0H                                                               
         CLI   GLRECNO,2           REC 2 (ORIG RECS)                            
         BNE   DH454                                                            
         CLI   SPILSW,C'Y'         ONLY DO IF NOT SPILL                         
         BNE   EXIT                                                             
         MVI   GLHOOK,GLDONT                                                    
         B     EXIT                                                             
*                                                                               
...
DH500    DS    0H                                                               
         ...
         L     R2,0(R1)                                                         
         USING MKTTABD,R2                                                       
         CLI   MKSPIL,C'Y'         TEST MKT SPILLS TO OTHERS                    
         BE    EXIT                YES - OK                                     
         MVI   GLHOOK,GLDONT       ELSE SUPPRESS                                
         B     EXIT                                                             
*                                                                               
DH502    DS    0H                                                               
         CLI   GLRECNO,3           FOR REC 3 (SPILLS)                           
         BNE   DH504                                                            
         CLI   SPILSW,C'Y'         MUST BE A SPILLED INTO                       
         BE    EXIT                                                             
         MVI   GLHOOK,GLDONT       ELSE SUPPRESS                                
         B     EXIT                                                             
*                                                                               
...
*                                                                               
         ...
         XC    DBSELMK,DBSELMK                                                  
         CLC   MKNUM,ORIGMKT       UNLESS ORIGINATING MKT                       
         BE    *+10                                                             
         MVC   DBSELMK,MKNUM       SET MARKET                                   
...
SVSDEMS  NTR1                                                                   
         ...
         GOTO1 (RF),DMCB,=C'PROG+',ADBLOCK,WORK                                 
         CLC   WORK(7),=C'OFF AIR'   SKIP                                       
         BE    SVDX                                                             
         GOTO1 (RF),DMCB,=C'DAY',ADBLOCK,X                                      
         MVC   BINDAY,X              SAVE DAY                                   
         GOTO1 (RF),DMCB,=C'TIME',ADBLOCK,X                                     
...
*                                                                               
         ...
         BZ    SVD55                                                            
*                                                                               
         CLI   STNTZ,C' '          TEST HAVE TZ FOR STATION                     
         BNH   SVD42D              NO- IGNORE TZ TEST                           
         CLI   STNTZ,C'4'          OR ALASKA,ETC BECAUSE I DON'T                
         BH    SVD42D              KNOW WHAT TO DO WITH IT                      
         CLI   DFTZ,C'E'           TEST TIME ZONES                              
         BNE   SVD42                                                            
         CLI   STNTZ,C'1'          EASTERN                                      
         BE    SVD42D                                                           
         CLI   STNTZ,C'4'          PACIFIC                                      
         BE    SVD42D                                                           
         B     SVD55               SKIP DEFINITION                              
*                                                                               
SVD42    DS    0H                                                               
         CLI   DFTZ,C'C'                                                        
         BNE   SVD42D                                                           
         CLI   STNTZ,C'2'          CENTRAL                                      
         BE    SVD42D                                                           
         CLI   STNTZ,C'3'          MOUNTAIN                                     
         BE    SVD42D                                                           
         B     SVD55               SKIP DEFINITION                              
*                                                                               
SVD42D   DS    0H                                                               
         CLI   DFAFF,C'N'          TEST AFFILIATION NETWORK ONLY                
         BNE   SVD42G                                                           
         CLI   STNAFF,C'A'         ABC                                          
         BE    SVD42J                                                           
         CLI   STNAFF,C'C'         CBS                                          
...
*                                                                               
SVD42G   DS    0H                                                               
         CLI   DFAFF,C'I'          INDEPENDENT ONLY                             
         BNE   SVD42J                                                           
         CLI   STNAFF,C'I'         IND                                          
         BE    SVD42J                                                           
...
*                                                                               
SVD47    DS    0H                                                               
         CLI   DFINEX,C'I'         IF INCLUDING                                 
         BE    SVD55               SKIP IF NOT FOUND                            
*                                                                               
SVD48    DS    0H                                                               
         L     RF,DBCOMFCS                                                      
...
*                                                                               
         ...
         L     RF,ACOMFACS                                                      
         L     RF,CDEFINE-COMFACSD(,RF)                                         
         GOTO1 (RF),DMCB,=C'PROG+',ADBLOCK,X                                    
         MVC   P+15(16),X                                                       
         GOTO1 (RF),DMCB,=C'TIME',ADBLOCK,X                                     
         ...
         GOTO1 (RF),DMCB,=C'DAY',ADBLOCK,X                                      
         MVC   P+43(3),X+2                                                      
         GOTO1 (RF),DMCB,=C'WEEK',ADBLOCK,X                                     
         MVC   P+47(4),X+1                                                      
         EDIT  (B4,DOUTS),(7,P+52),ZERO=NOBLANK                                 
         ZIC   RF,DFDPT            DPT NUM IS INDEX TO DIVISOR TABLE            
         BCTR  RF,R0                                                            
         MH    RF,=Y(NDEMS*4)                                                   
         L     R2,DPTDMS(RF)                                                    
...
CLTHDRD  DSECT                                                                  
       ++INCLUDE SPGENCLT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027SPREPPS02 05/11/05'                                      
         END                                                                    
