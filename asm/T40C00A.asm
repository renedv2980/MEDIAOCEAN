*          DATA SET T40C00A    AT LEVEL 013 AS OF 05/01/02                      
*          DATA SET T40C00     AT LEVEL 028 AS OF 05/14/90                      
*          DATA SET T40C00X    AT LEVEL 015 AS OF 12/27/89                      
*          DATA SET T40C00     AT LEVEL 026 AS OF 12/16/83                      
         TITLE 'CHANGE LOG'                                                     
*  ROSA  12/20/89  ADD FAX NUMBER                                  L01          
*                                                                               
***********************\              WHEN LIVE                   L01           
*    ++INCLUDE T40CFFD *********** REMEMBER TO CHANGE TO T40CFFD                
***********************/              WHEN LIVE                   L01           
*                                                                  L01          
*************\                                                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013T40C00A   05/01/02'                                      
         END                                                                    
