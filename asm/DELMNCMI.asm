*          DATA SET DELMNCMI   AT LEVEL 024 AS OF 10/24/17                      
*PROCESS USING(WARN(15))                                                        
*PHASE DELMNCMA                                                                 
*INCLUDE LMPAIR                                                                 
         TITLE 'NCM CONVERSION'                                                 
***********************************************************************         
*                                                                               
DELMNMI  CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
*                                                                               
* ONLY PROCESS 4 WEEK AVERAGE OR ALL WEEK AVERAGE RECORDS AND                   
* THE TRUE INDIVIDUAL WEEK RECORDS                                              
*                                                                               
*   THE MONTHLY 4WK AVERAGE OR ALL WEEK AVERAGE LINE ?                          
         CLI   W_KFILETYPE,W_KFILETYPE_MONTHLY                                  
         BNE   OPENOK02                                                         
...
LMSTAT   MVC   INTSTA(4),W_KOCALL                                               
         MVI   INTSTA+4,C'D'       NCM ALWAYS D BAND                            
***********************************************************************         
...
*  STANDARD                                                                     
         DC    AL1(STYP_NCM_TDMA),AL1(BOOKTYPE_STANDARD)                        
         DC    X'FF'                                                            
***********************************************************************         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024DELMNCMI  10/24/17'                                      
         END                                                                    
