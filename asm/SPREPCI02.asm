*          DATA SET SPREPCI02  AT LEVEL 043 AS OF 02/09/15                      
...
*INCLUDE NETNET                                                                 
*INCLUDE WIDE                                                                   
         TITLE 'SPREPCI02 - CONTINENTAL INTERFACE'                              
***********************************************************************         
...
*                                                                               
         LA    RE,INVEDESC                                                      
         LA    RF,20                                                            
ROB10B5  CLI   0(RE),C','        CHANGE COMMAS TO SPACES                        
         BNE   ROB10B6                                                          
         MVI   0(RE),C' '                                                       
         B     ROB10B8                                                          
*                                                                               
ROB10B6  CLI   0(RE),C'&&'         CHANGE & TO /                                
         BNE   ROB10B8                                                          
         MVI   0(RE),C'/'                                                       
         B     ROB10B8                                                          
*                                                                               
...
PRNTX    DS    0H                                                               
         ...
         LTORG                                                                  
         EJECT                                                                  
         TITLE 'DOWNLD - CREATE DOWNLOAD FILE'                                  
DOWNLD   CSECT                                                                  
         NMOD1 0,DOWNLD                                                         
         L     RA,0(R1)                                                         
         USING SPWORKD,RA                                                       
...
*                                                                               
         ...
         GOTO1 VDLFLD                                                           
*                                                                               
         MVC   DLCBFLD(3),=C',,,'  TO SEND 5 COMMAS                             
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
*                                                                               
...
*        INVOICE DATE FORMAT IS NOW MM/DD/YYYY                                  
*                                                                               
******                         ASSUME LAST CENTURY                              
...
*                                                                               
         ...
         L     R1,SAVER1          RESTORE                                       
*                                                                               
         MVI   DLCXDELC,C' '       LAST FIELDS - NO DELIMITERS                  
         MVC   DLCBFLD(6),WORK+6          MMM/YY                                
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
*                                                                               
         ZIC   R0,INVEST           ESTIMATE NUMBER                              
         CVD   R0,DUB                                                           
         OI    DUB+7,X'0F'                                                      
         UNPK  DLCBFLD(3),DUB                                                   
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         ...
         GOTO1 VDLFLD                                                           
*                                                                               
         MVC   DLCBFLD(L'INVEDESC),INVEDESC       ESTIMATE NAME                 
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
*                                  PRD USER 1 NAME                              
...
*****    MVC   WORK(10),SPACES                                                  
*****    EDIT  (B4,INVINS),(7,WORK),ALIGN=LEFT,FLOAT=-,ZERO=NOBLANK             
         L     R1,SAVER1      RESTORE R1                                        
*****    MVC   DLCBFLD(7),WORK                                                  
...
*                                                                               
         MVI   DLCBFLD,C','       WILL GET ME 2 COMMAS                          
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
*                                                                               
*******  MVC   DLCBFLD(L'INVEDESC),INVEDESC       ESTIMATE NAME                 
         MVC   DLCBFLD(L'INVEU1D),INVEU1D      EST USER 1 DATA                  
*                                       MAX IS 40                               
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
*                                                                               
         ...
         MVC   WORK(L'INVSTA),INVSTA                                            
         OC    WORK(L'INVSTA),SPACES                                            
         MVC   DLCBFLD(L'INVSTA),WORK                                           
         MVI   DLCBTYP,C'T'       TEXT FIELD                                    
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
*                                                                               
...
QOPT7    EQU   QGRP+1                                                           
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'043SPREPCI02 02/09/15'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
