*          DATA SET RELDBUDG   AT LEVEL 005 AS OF 05/01/02                      
*PHASE RELDBUDG,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
...
*                                                                               
         USING RCONREC,R3                                                       
         CLI   RCONKTYP,X'15'      S/P BUDGET RECORD?                           
         BNE   DMXKEEP             NO  - KEEP IT                                
         CLI   RCONKTYP+1,X'04'    S/P BUDGET RECORD?                           
         BE    DMXPURGE            YES - LOSE IT                                
         CLI   RCONKTYP+1,X'05'    S/P BUDGET RECORD?                           
         BE    DMXPURGE            YES - LOSE IT                                
         B     DMXKEEP                                                          
         EJECT                                                                  
*******************************************************************             
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005RELDBUDG  05/01/02'                                      
         END                                                                    
