*          DATA SET TRRECON    AT LEVEL 006 AS OF 06/07/11                      
*PHASE TRRECONA                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE PRINTER                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE CLUNPK                                                                 
*INCLUDE SPLDDEFN                                                               
         TITLE 'TRRECON - STRAFFIC RECONSTRUCT PROGRAM'                         
TRRECON  CSECT                                                                  
         SPACE 1                                                                
*=====================================================*                         
...
*                                                                               
         B     IN3                                                              
*                                                                               
*        REMOVE TRFFILE TEST IF TRAFFIC GETS ITS OWN TRLDDEFN                   
*                                                                               
...
CHGNEW   MVC   ROLDKEY,RKEY        SET FOR NEW/NEW REC                          
         SPACE 1                                                                
**************** MAKE SPECIAL TEST FOR BAD REC **************                   
         CLI   RKEY,X'FF'          TEST EOFREC                                  
         BE    CHGNEWX                                                          
         CLC   =XL13'00000000000000000000000001',RKEY 1ST REC                   
         BE    CHGNEWX                                                          
         CLI   RKEY,X'0A'        ' TEST BDELEM IS FIRST ELEMENT                 
         BNE   BADREC                                                           
****************************************************************                
         SPACE 1                                                                
CHGNEWX  DS    0H                                                               
...
OPSV1    LA    R0,RLEN             SAVE NEW RECOVERY REC                        
         ...
         MVCL  R0,R4                                                            
*                                                                               
OPSV2    SR    R0,R0               TRAILER HAS BEEN DELETED                     
*                                                                               
OPSV3    LH    RE,RLEN                                                          
...
OPDONE   CLOSE (FILEOUT,)                                                       
         SPACE 2                                                                
         MVC   LINE,=PL2'75'                                                    
         MVC   TITLE(19),=C'TRFFILE RECONSTRUCT'                                
*                                                                               
         LA    R3,CNTRS                                                         
         LA    R4,18                                                            
         LA    R5,CNTRSX                                                        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006TRRECON   06/07/11'                                      
         END                                                                    
