*          DATA SET SPREPIF02S AT LEVEL 059 AS OF 05/01/02                      
*PHASE SPIF02A                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE COVAIL                                                                 
...
*        QOPT5+1  D=DELETE IF NO INVOICE (NI)                                   
***********************************************************************         
         SPACE 2                                                                
SPIF02   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         STH   R0,HLDMKT                                                        
         DROP  R3                                                               
         CLI   QOPT3,C'Y'          TEST TO LIST INVOICE RECS                    
         BNE   IRP73D                                                           
         BAS   RE,FMTINV                                                        
         GOTO1 REPORT                                                           
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'059SPREPIF02S05/01/02'                                      
         END                                                                    
