*          DATA SET MY30B      AT LEVEL 078 AS OF 05/01/02                      
*PHASE T81030B,*                                                                
...
INV6C    GOTO1 SEQ                 KEEP READING                                 
         CLC   KEY(21),KEYSAVE     SAME NUMBER                                  
         BNE   *+20                NO                                           
         CLI   KEY+24,0            YES-IS IT A DATA RECORD                      
         BNE   INV6C               YES-READ AGAIN                               
         MVI   HALF,2              NO                                           
...
*--MTA                                                                          
         ...
         MVC   IBLK+3(1),INVSRC      BOOKVAL BITS                               
         MVC   IBLK+4(1),INVBTYPE    BOOKTYPE                                   
...
*                                                                               
         ...
         BNE   *+10                                                             
         MVC   WORK+7(2),=X'5A0B'                                               
         GOTO1 CDEMAINT,DMCB,=C'PUT',DBLOCK,IUNWORK+500,WORK                    
         DROP  R4                                                               
*                                                                               
         MVI   RESETDB,0                                                        
         CLI   DBSELMED,C'N'       IF NETWK, FUDGET MEDIA & SRC TO MAD          
         BNE   HOOK1F                                                           
         MVI   RESETDB,C'Y'         RESET AFTER MATH CALL                       
         MVI   DBSELMED,C'T'                                                    
         MVC   SVSRC,DBSELSRC                                                   
...
HOOK1F   MVC   MTHOSRC,=C'NSI'                                                  
         ...
         CLI   RESETDB,C'Y'         RESET AFTER MATH CALL?                      
         BNE   HOOK1G                                                           
         MVI   RESETDB,0                                                        
         MVI   DBSELMED,C'N'                                                    
         MVC   DBSELSRC,SVSRC                                                   
...
*                                                                               
         ...
         DROP  RF                                                               
         GOTO1 VGETKSRC,MYDMCB,(C'Q',DUB),DUB                                   
         CLI   MYDMCB+4,0                                                       
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   DHKSRC,DUB+(GKSPKSRC-GKSPARMD)                                   
BDH034   EQU   *                                                                
         ...
         MVC   GKSPKSRC,DHKSRC                                                  
         DROP  RF                                                               
         GOTO1 VGETKSRC,MYDMCB,(C'K',DUB),DUB                                   
         CLI   MYDMCB+4,0                                                       
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   DHSRC,DUB+(GKSPRSVC-GKSPARMD)                                    
         MVC   DHFRBT,DUB+(GKSPBKBT-GKSPARMD)                                   
         MVC   DHBTYP,DUB+(GKSPBTYP-GKSPARMD)                                   
...
E        USING RIDHEL,ELEM                                                      
         ...
         MVC   E.RIDHSTTN,DBACTSTA  STATION                                     
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'078MY30B     05/01/02'                                      
         END                                                                    
