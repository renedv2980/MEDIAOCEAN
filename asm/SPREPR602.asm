*          DATA SET SPREPR602  AT LEVEL 115 AS OF 02/16/05                      
*PHASE SPR602A,*                                                                
*INCLUDE COVAIL                                                                 
*INCLUDE DATVAL                                                                 
*INCLUDE HELLO                                                                  
...
*                                                                               
         ...
         CLC   15(2,R2),=C'AQ'     ALLIED ORDER ORIGINALLY?                     
         BNE   RMYN0110            NO                                           
         MVI   4(R2),C'1'          YES - INCREASE BY 1 MILLION                  
         MVC   15(2,R2),=C'MG'     INSERT MG AS COMPANY                         
RMYN0110 EQU   *                                                                
...
RMYN0360 EQU   *                                                                
         ...
         BZ    RMYN0080            NO PRODUCT: SKIP RECORD                      
***>>>   BNZ   *+6                 YES                                          
...
*                       (ACCESS ID ON SPOT FILE, WITH 2ND POSITION              
*                               = 1 IF TV                                       
*                               = 2 IF RADIO                                    
*                                                                               
*        CHAR 4      =  MEDIA CODE                                              
...
STAHDRD  DSECT                                                                  
       ...
       ++INCLUDE SPREPPTBUF                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'115SPREPR602 02/16/05'                                      
         END                                                                    
