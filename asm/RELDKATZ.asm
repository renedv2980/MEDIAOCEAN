*          DATA SET RELDKATZ   AT LEVEL 017 AS OF 05/01/02                      
*PHASE RELDKATZ,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
...
*                                                                               
         ...
         BNE   DMXKEEP                                                          
         USING RCONSEND,R5                                                      
         CLC   RCONSSID,=AL2(8162)                                              
         BNL   DMXKEEP                                                          
         TM    RCONSENF,X'40'      LAST SEND BY STATION?                        
         BZ    DMXKEEP                                                          
         TM    RCONSENF,X'02'                                                   
         BO    DMXKEEP             SKIP CONFIRMATION                            
         CLC   RCONSSDT,=X'C761'                                                
         BL    DMXKEEP             MUST BE AFTER NOV 1, 1999                    
         DROP  R5                                                               
*                                                                               
         L     R5,AREC             POINT TO RECORD                              
         USING RCONREC,R5                                                       
         ...
         MVC   P+4(5),RCONKSTA                                                  
         MVC   P+11(2),RCONKOFF                                                 
         GOTO1 =V(HEXOUT),DMCB,RCONKCON,P+14,4,=C'TOG'                          
         DROP  R5                                                               
*                                                                               
         GOTO1 VPRINTER                                                         
*                                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017RELDKATZ  05/01/02'                                      
         END                                                                    
