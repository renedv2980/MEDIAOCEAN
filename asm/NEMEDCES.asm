*          DATA SET NEMEDCES   AT LEVEL 004 AS OF 05/01/02                      
*          DATA SET NEMEDCE    AT LEVEL 041 AS OF 05/10/91                      
*PHASE T31ECEA                                                                  
*INCLUDE CLUNPK                                                                 
...
T31ECE   CSECT                                                                  
         ...
         LA    R6,1(RB)                                                         
         LA    R6,4095(R6)                                                      
         USING T31ECE,RB,R6        R6-SECOND BASE REGISTER                      
         LA    R1,HEADING                                                       
         ST    R1,SPECS                                                         
         LA    R1,HDRTN                                                         
         ST    R1,HEADHOOK                                                      
...
MAN12    DS    0H                                                               
         ...
         BNO   MAN10                                                            
         CLC   CURREST,NBACTEST    IS IT A NEW EST                              
         BNE   MAN20                                                            
...
STABWRIT LA    R3,P                                                             
         ...
         GOTO1 AMSUNPK,DMCB,STABKMKT,BPYRSRV,BPMNYR                             
...
ALLSUM   NTR1                                                                   
         ...
         EDIT  RUNASS,(15,45(R3)),2,MINUS=YES      ASSIGNED                     
         EDIT  RUNBILL,(15,65(R3)),2,MINUS=YES     UNTBILL2                     
...
BILLRECD DSECT                                                                  
       ...
       PRINT ON                                                                 
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004NEMEDCES  05/01/02'                                      
         END                                                                    
