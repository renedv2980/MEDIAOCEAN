*          DATA SET GABOG00    AT LEVEL 120 AS OF 05/01/02                      
*PHASE TB1800A                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE RANDOM                                                                 
...
*                                   VCALLOV=A(CALLOV)                           
         EJECT                                                                  
BEGIN    NI    SCRSHFLH+1,X'FF'-X'01'    DE-MODIFY FIELD.                       
         NI    SCRSVRQH+1,X'FF'-X'01'    DE-MODIFY FIELD.                       
*                                                                               
         NI    SCRSHFLH+1,X'FF'-X'20'  UNPROTECT SHUFFLE FIELD                  
         OI    SCRSHFLH+6,X'80'                                                 
         NI    SCRGNBDH+1,X'FF'-X'20'  UNPROTECT GNBD FIELD.                    
         OI    SCRGNBDH+6,X'80'                                                 
         NI    SCRSIZEH+1,X'FF'-X'20'  UNPROTECT SIZE FIELD.                    
         OI    SCRSIZEH+6,X'80'                                                 
*                                                                               
...
*                                                                               
BEGI00   MVC   SCRHEAD,BLANKS                                                   
*                                                                               
         CLI   SCRSHFL,C'Y'                                                     
         BE    BEGI01                                                           
         CLI   SCRSHFL,C'N'                                                     
         BE    BEGI01                                                           
         MVC   SCRHEAD(L'ERSHFMSG),ERSHFMSG TELL USER OF ERROR                  
         OI    SCRHEADH+6,X'80'    TRANSMIT MESSAGE.                            
         L     R2,LSTINDSP         CHANGE POS OF CURSOR INSERT.                 
         AR    R2,RA                                                            
         NI    6(R2),X'FF'-X'40'                                                
         LA    R2,SCRSHFLH                                                      
         OI    6(R2),X'40'         POSITION CURSOR AT SCRSHUFL.                 
         SR    R2,RA                                                            
         ST    R2,LSTINDSP         STORE POS. OF CURSOR INSERT.                 
******** MVC   SCRSHFL,KPSHFL      UNDO WHAT PLAYER DID.                        
******** OI    SCRSHFLH+6,X'80'                                                 
         B     EXIT1                                                            
*                                                                               
BEGI01   CLI   SCRGNBD,C'C'                                                     
         BE    BEGI02                                                           
         CLI   SCRGNBD,C'P'                                                     
         BE    BEGI02                                                           
         MVC   SCRHEAD(L'ERGBDMSG),ERGBDMSG TELL USER OF ERROR                  
         OI    SCRHEADH+6,X'80'    TRANSMIT MESSAGE.                            
         L     R2,LSTINDSP         CHANGE POS OF CURSOR INSERT.                 
         AR    R2,RA                                                            
         NI    6(R2),X'FF'-X'40'                                                
         ...
         SR    R2,RA                                                            
         ST    R2,LSTINDSP         STORE POS. OF CURSOR INSERT.                 
*******  MVC   SCRGNBD,KPGNBD      UNDO WHAT PLAYER DID.                        
*******  OI    SCRGNBDH+6,X'80'                                                 
         B     EXIT1                                                            
*                                                                               
BEGI02   CLI   SCRSIZE,C'4'                                                     
         BE    BEGI03                                                           
         CLI   SCRSIZE,C'5'                                                     
         BE    BEGI03                                                           
         MVC   SCRHEAD(L'ERSZEMSG),ERSZEMSG TELL USER OF ERROR                  
         OI    SCRHEADH+6,X'80'    TRANSMIT MESSAGE.                            
         L     R2,LSTINDSP         CHANGE POS OF CURSOR INSERT.                 
         AR    R2,RA                                                            
         NI    6(R2),X'FF'-X'40'                                                
         ...
         SR    R2,RA                                                            
         ST    R2,LSTINDSP         STORE POS. OF CURSOR INSERT.                 
******** MVC   SCRSIZE,KPSIZE      UNDO WHAT PLAYER DID.                        
******** OI    SCRSIZEH+6,X'80'                                                 
         B     EXIT1                                                            
*                                                                               
* INPUTS ARE VALID, SEE IF THEY HAVE CHANGED                                    
*                                                                               
BEGI03   CLC   KPGNBD,SCRGNBD      DOES PLAYER WANT A NEW BOARD                 
         BE    BEGI04               GENERATOR?                                  
         MVC   KPGNBD,SCRGNBD                                                   
         OI    FLAG,NEWGAMEQ       TURN NEW-GAME FLAG ON.                       
*                                                                               
BEGI04   CLC   KPSIZE,SCRSIZE      DOES PLAYER WANT A NEW BOARD SIZE?           
         BE    BEGI05                                                           
         MVC   KPSIZE,SCRSIZE                                                   
         OI    FLAG,NEWGAMEQ                                                    
*                                                                               
BEGI05   TM    FLAG,NEWGAMEQ                                                    
         BO    YSHUFFLE                                                         
*                                                                               
         CLI   SCRSHFL,C'Y'        DOES PLAYER WANT BOARD SHUFFLED?             
         BE    YSHUFFLE                                                         
*                                                                               
* RESHUFFLE = NO                                                                
*                                                                               
NSHUFFLE TM    FLAG,NEWGAMEQ       IS THIS A BRAND NEW GAME?                    
         BZ    NOTNEWGM                                                         
*                                                                               
         MVI   SCRSHFL,C'Y'        RESHUFFLE BOARD FOR NEW GAME.                
         OI    FLAG,NEWGAMEQ       TURN NEW GAME FLAG ON.                       
         L     R8,LSTINDSP         PREPARE TO UPDATE LSTINDSP.                  
         AR    R8,RA                                                            
         NI    6(R8),X'BF'                                                      
         LA    R8,SCRSIZEH                                                      
         OI    6(R8),X'40'         TURN ON POSITION-CURSOR HERE                 
         SR    R8,RA                (AT SIZE-INPUT FIELD).                      
         ST    R8,LSTINDSP                                                      
         MVC   SCRHEAD,BLANKS                                                   
         OI    SCRHEADH+6,X'80'                                                 
         MVI   SCRGNBD,C'C'        DEFAULT GENERATOR TO COMPUTER.               
         OI    SCRGNBDH+6,X'80'    TRANSMIT WHO-GENERATES FIELD.                
         B     EXIT1                                                            
*                                                                               
NOTNEWGM CLC   SCRGNBD,KPGNBD      HAS PLAYER CHANGE INPUT                      
         BE    MNSKP1               WHEN THEY ARE NOT SUPPOSED TO?              
         MVC   SCRGNBD,KPGNBD      CHANGE SCRGNBD BACK.                         
         OI    SCRGNBDH+6,X'80'                                                 
         CLC   SCRSIZE,KPSIZE      DO WE HAVE TO CHANGE SCRSIZE TOO?            
         BE    MNSKP2                                                           
*                                                                               
MNSKP1   CLC   SCRSIZE,KPSIZE      DO WE HAVE TO CHANGE SCRSIZE?                
         BE    MNSKP3                                                           
         MVC   SCRSIZE,KPSIZE      CHANGE SCRSIZE BACK.                         
         OI    SCRSIZEH+6,X'80'                                                 
*                                                                               
MNSKP2   MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(L'ERCHGMSG),ERCHGMSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         L     R2,LSTINDSP                                                      
         AR    R2,RA                                                            
         NI    6(R2),X'FF'-X'40'                                                
         ...
         SR    R2,RA                                                            
         ST    R2,LSTINDSP                                                      
         NI    SCRGUESH+1,X'FF'-X'20'                                           
         OI    SCRSHFLH+1,X'01'    TELL FACPAK SCREEN IS MODIFIED.              
         B     EXIT1                                                            
*                                                                               
...
*                                                                               
         ...
         NI    SCRSHFLH+1,X'FF'-X'20'  BIT, UNPROTECT INPUT FIELDS,             
         NI    SCRGNBDH+1,X'FF'-X'20'  AND PERFORM NEXT STEP.                   
         NI    SCRSIZEH+1,X'FF'-X'20'                                           
         NI    SCRGUESH+1,X'FF'-X'20'                                           
         OI    SCRSHFLH+6,X'80'                                                 
         OI    SCRGNBDH+6,X'80'                                                 
         OI    SCRSIZEH+6,X'80'                                                 
...
* RESHUFFLE = YES                                                               
*                                                                               
YSHUFFLE MVC   SCRGUES,BLANKS                                                   
         OI    SCRGUESH+6,X'80'    CLEAR GUESS FIELD.                           
*                                                                               
...
*                                                                               
         ...
         BZ    CKWHOGEN                                                         
*                                                                               
         CLI   SCRSIZE,C'4'        HAVE TO SEE WHAT NEW SIZE IS.                
         BNE   CKSIZE5                                                          
*                                                                               
         ...
         B     CKWHOGEN                                                         
*                                                                               
CKSIZE5  CLI   SCRSIZE,C'5'        SEE IF PLAYER WANTS 5X5 BOARD.               
         BNE   INVLDSZE                                                         
*                                                                               
         ...
         B     CKWHOGEN                                                         
*                                                                               
INVLDSZE MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(L'ERSZEMSG),ERSZEMSG                                     
         OI    SCRHEADH+6,X'80'                                                 
...
*                                                                               
CKWHOGEN MVI   SCRSHFL,C'N'        CHANGE RESHUFFLE OPTION TO NO.               
         OI    SCRSHFLH+6,X'80'                                                 
...
SKIP1    BAS   RE,MAKE5BRD         DRAW 5X5 GAME BOARD.                         
         BAS   RE,TRANSBRD                                                      
*                                                                               
SKIP2    CLI   SCRGNBD,C'P'        DOES PLAYER WANT TO GENERATE BOARD?          
         BE    PLYRGEN                                                          
*                                                                               
COMPGEN  NI    FLAG,X'FF'-NDVLDQ   DON'T NEED TO VALIDATE BOARD.                
         CLI   SCRGNBD,C'C'        SEE IF INPUT WAS REALLY VALID.               
         BE    SKIP3                                                            
         MVI   SCRGNBD,C'C'                                                     
         OI    SCRGNBDH+6,X'80'                                                 
*                                                                               
...
PLYRGEN  MVI   KPGNBD,C'P'                                                      
         ...
         L     R8,LSTINDSP          INPUTS BOARD.                               
         AR    R8,RA                                                            
         NI    6(R8),X'BF'         UPDATE ADDRESS OF INSERT CURSOR.             
         LA    R8,SCRROW1H         R8-->A WALL FIELD.                           
         ZIC   R1,0(R8)            NEED TO BUMP R8 TO 1ST CUBE FIELD.           
         AR    R8,R1               R8-->CUBE FIELD.                             
         OI    6(R8),X'40'         POSITION CURSOR AT FIRST CUBE.               
         SR    R8,RA                                                            
         ST    R8,LSTINDSP                                                      
         MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(L'ENBRDMSG),ENBRDMSG                                     
         OI    SCRHEADH+6,X'80'    TRANSMIT THE MESSAGE.                        
         LA    R1,DMCB                                                          
         MVI   3(R1),0             0 TO INDICATE UNPROTECT BOARD.               
         BAS   RE,BRDPRTCT                                                      
         BAS   RE,TRANSBRD                                                      
         OI    SCRSHFLH+1,X'20'    TURN PROTECT ON.                             
         OI    SCRSHFLH+6,X'80'                                                 
         OI    SCRGNBDH+1,X'20'                                                 
         OI    SCRGNBDH+6,X'80'                                                 
         OI    SCRSIZEH+1,X'20'                                                 
         ...
         OI    SCRGUESH+1,X'20'                                                 
         OI    SCRGUESH+6,X'80'                                                 
         OI    SCRSVRQH+1,X'01'    TELL FACPAK SCREEN IS MODIFIED.              
...
*                                                                               
         MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(L'NOWD1MSG),NOWD1MSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         MVI   SCRSHFL,C'Y'                                                     
         L     R6,LSTINDSP                                                      
         AR    R6,RA                                                            
         ...
         ST    R6,LSTINDSP                                                      
         OI    FLAG,NEWGAMEQ                                                    
         OI    SCRGUESH+1,X'20'    PROTECT GUESS FIELD.                         
         OI    SCRGUESH+6,X'80'                                                 
         B     EXIT1                                                            
*                                                                               
USRINPT  L     R8,LSTINDSP                                                      
         ...
         LA    R8,SCRGUESH         R8-->GUESS WORD FIELD.                       
         SR    R8,RA                                                            
         ST    R8,LSTINDSP                                                      
         NI    SCRGUESH+1,X'FF'-X'20'  UNPROTECT GUESSING FIELD.                
         OI    SCRGUESH+6,X'C0'    POSITION CURSOR AT GUESS PLACE.              
         MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(L'ENGSSMSG),ENGSSMSG                                     
         OI    SCRHEADH+1,X'08'    HIGH INTENSITY.                              
         OI    SCRHEADH+6,X'80'    TRANSMIT HEADER FIELD.                       
         MVI   SCRSHFL,C'N'                                                     
         OI    SCRSHFLH+6,X'80'    TRANSMIT SHUFFLE FIELD.                      
...
*                                                                               
CKGSSWRD CLI   SCRGUES,C'#'        DOES PLAYER WANT TO KNOW # OF WORDS          
         BNE   CKGSS2                                                           
*                                                                               
         ZIC   R2,CWRDCNT                                                       
         ZIC   R3,PWRDCNT                                                       
...
CKGS02   OI    SCRHEADH+6,X'80'                                                 
         B     PREPNXWD                                                         
*                                                                               
CKGSS2   CLI   SCRGUES,C'!'        DOES PLAYER WANT TO GIVE UP?                 
         BE    MAINGVUP                                                         
*                                                                               
         CLI   SCRGUESH+5,5        PLAYER WANTS WORD VALIDATED.                 
         BE    VLDTWRD             CHECK LENGTH OF INPUT.                       
*                                                                               
         MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(L'ERLENMSG),ERLENMSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         B     PREPNXWD                                                         
*                                                                               
* PLAYER GIVES UP                                                               
...
MAINGVUP BAS   RE,SHOWWRDS                                                      
         ...
         MVC   SCRGUES,BLANKS                                                   
         OI    SCRGUESH+1,X'20'    PROTECT GUESS FIELD.                         
         OI    SCRGUESH+6,X'80'    TRANSMIT THE BLANKS IN GUESS FIELD.          
         OI    SCRSHFLH+1,X'01'    TELL FACPAK SCREEN IS MODIFIED.              
         B     EXIT1                                                            
*                                                                               
VLDTWRD  ZIC   R2,CWRDCNT                                                       
         GOTO1 =V(BINSRCH),DMCB,(X'00',SCRGUES),DICTBRD,(R2),          +        
               5,(0,5),75,RR=RELO                                               
...
ADDPWORD LA    R2,1(R2)            INCREMENT PWRDCNT ONLY IF WORD               
         ...
         LA    R2,SCRPWRDH          SPOT ON SCREEN TO PUT WORD.                 
*                                                                               
         CLI   PWRDCNT,1                                                        
         BE    PUTPWORD                                                         
*                                                                               
...
*                                                                               
PUTPWORD MVC   8(5,R2),SCRGUES     MOVE GUESSED WORD ONTO SCREEN.               
         OI    6(R2),X'80'         TRANSMIT FIELD.                              
         MVC   SCRHEAD,BLANKS                                                   
         CLC   CWRDCNT,PWRDCNT     DID PLAYER GET ALL MY WORDS?                 
         BE    MNSKP4                                                           
*                                                                               
         MVC   SCRHEAD(L'ENGS1MSG),ENGS1MSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         B     PREPNXWD                                                         
*                                                                               
MNSKP4   MVC   SCRHEAD(L'ALWRDMSG),ALWRDMSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         B     MAINGVUP                                                         
*                                                                               
* WORD WAS INVALID, NEED TO DETERMINE WHAT KIND IT IS                           
*                                                                               
BADWORD  MVC   SCRHEAD,BLANKS      PREPARE FOR ERROR MESSAGE.                   
*                                                                               
** CHECK FOR INVALID LETTER IN PLAYER'S WORD.                                   
*                                                                               
         LA    R2,SCRGUES          CHECK EACH OF THE 5 CHARACTERS.              
CKLTR1   OI    0(R2),X'40'         "CAPITALIZE" THE CHARACTER.                  
         ...
         BH    INVLDLTR                                                         
NEXTLTR  LA    R2,1(R2)                                                         
         CLC   0(1,R2),SCRGUES+5                                                
         BNE   CKLTR1                                                           
         B     BADW01              GO CHECK FOR PATTERN FOUND.                  
*                                                                               
INVLDLTR MVC   SCRHEAD(1),0(R2)    INVALID LETTER ENCOUNTERED.                  
         MVC   SCRHEAD+2(L'ERLETMSG),ERLETMSG                                   
         OI    SCRHEADH+6,X'80'                                                 
         B     PREPNXWD                                                         
*                                                                               
...
*                                   POSSIBLE ERROR.                             
         MVC   SCRHEAD(5),SCRGUES                                               
         MVC   SCRHEAD+6(L'ERPATMSG),ERPATMSG                                   
         OI    SCRHEADH+6,X'80'                                                 
         B     PREPNXWD                                                         
*                                                                               
...
*                                                                               
         LH    R2,DICTLEN                                                       
         GOTO1 =V(BINSRCH),DMCB,(X'00',SCRGUES),DICTADD,(R2),          +        
               5,(0,5),,RR=RELO                                                 
         TM    0(R1),X'01'                                                      
         BO    *+6                                                              
         ...
         EX    R2,*+8                                                           
         B     *+10                                                             
         MVC   SCRHEAD(0),SCRGUES  PUT GUESSED WORD IN HEADER.                  
         LA    R2,2(R2)                                                         
         LA    R2,SCRHEAD(R2)                                                   
         MVC   0(L'ERWRDMSG,R2),ERWRDMSG  APPEND MESSAGE AFTER WORD.            
         OI    SCRHEADH+6,X'80'    TRANSMIT HEAD FIELD.                         
*                                                                               
...
*----------------------------- MAKE4BRD ------------------------------*         
MAKE4BRD NTR1                                                                   
         MVC   SCRTBDR,BLANKS                TOP BORDER                         
         MVC   SCRTBDR(L'TOPBDR4),TOPBDR4                                       
*                                                                               
         LA    R2,SCRROW1H                  DO 1ST ROW.                         
         BAS   RE,BWALLS4                                                       
         MVC   SCRDSH1,BLANKS                                                   
         MVC   SCRDSH1(L'DASH4),DASH4       1ST ROW OF DASHES                   
         LA    R2,SCRROW2H                  DO 2ND ROW.                         
         BAS   RE,BWALLS4                                                       
         MVC   SCRDSH2,BLANKS                                                   
         MVC   SCRDSH2(L'DASH4),DASH4       2ND ROW OF DASHES                   
         LA    R2,SCRROW3H                  DO 3RD ROW.                         
         BAS   RE,BWALLS4                                                       
         MVC   SCRDSH3,BLANKS                                                   
         MVC   SCRDSH3(L'DASH4),DASH4       3RD ROW OF DASHES                   
         LA    R2,SCRROW4H                  DO 4TH ROW.                         
         BAS   RE,BWALLS4                                                       
*                                                                               
         MVC   SCRDSH4,BLANKS                BOTTOM BORDER                      
         MVC   SCRDSH4(L'BOTBDR4),BOTBDR4                                       
*                                                                               
         LA    R2,SCRROW5H         CLEAR BOTTOM OF 5X5 BOARD                    
         LA    R3,11                (IF EXISTED)                                
...
MISC1    BCTR  R5,0                PREPARE TO DO EX INSTRUCTION.                
         ...
         BCT   R3,RECLRFLD                                                      
*                                                                               
         MVC   SCRBBDR,BLANKS      CLEAR BOTTOM BORDER.                         
         OI    SCRBBDRH+6,X'80'                                                 
*                                                                               
...
MAKE5BRD NTR1                                                                   
         MVC   SCRTBDR,BLANKS                TOP BORDER                         
         MVC   SCRTBDR(L'TOPBDR5),TOPBDR5                                       
*                                                                               
         LA    R2,SCRROW1H                  DO 1ST ROW.                         
         BAS   RE,BWALLS5                                                       
         MVC   SCRDSH1,BLANKS                                                   
         MVC   SCRDSH1(L'DASH5),DASH5       1ST ROW OF DASHES                   
         LA    R2,SCRROW2H                  DO 2ND ROW.                         
         BAS   RE,BWALLS5                                                       
         MVC   SCRDSH2,BLANKS                                                   
         MVC   SCRDSH2(L'DASH5),DASH5       2ND ROW OF DASHES                   
         LA    R2,SCRROW3H                  DO 3RD ROW.                         
         BAS   RE,BWALLS5                                                       
         MVC   SCRDSH3,BLANKS                                                   
         MVC   SCRDSH3(L'DASH5),DASH5       3RD ROW OF DASHES                   
         LA    R2,SCRROW4H                  DO 4TH ROW.                         
         BAS   RE,BWALLS5                                                       
         MVC   SCRDSH4,BLANKS                                                   
         MVC   SCRDSH4(L'DASH5),DASH5       4TH ROW OF DASHES                   
         LA    R2,SCRROW5H                  DO 5TH ROW.                         
         BAS   RE,BWALLS5                                                       
*                                                                               
         MVC   SCRBBDR,BLANKS                BOTTOM BORDER                      
         MVC   SCRBBDR(L'BOTBDR5),BOTBDR5                                       
*                                                                               
...
*                AND SETS BIT 0 OF FLAG CORRESPONDINGLY.                        
         ...
         BNE   VLDTE5                                                           
*                                                                               
         LA    R2,SCRROW1H         VALIDATE 1ST ROW.                            
         BAS   RE,VLDTROW                                                       
         TM    FLAG,INBDVLDQ                                                    
         BZ    XVLDTBRD                                                         
         LA    R2,SCRROW2H         VALIDATE 2ND ROW.                            
         BAS   RE,VLDTROW                                                       
         TM    FLAG,INBDVLDQ                                                    
         BZ    XVLDTBRD                                                         
         LA    R2,SCRROW3H         VALIDATE 3RD ROW.                            
         BAS   RE,VLDTROW                                                       
         TM    FLAG,INBDVLDQ                                                    
         BZ    XVLDTBRD                                                         
         LA    R2,SCRROW4H         VALIDATE 4TH ROW.                            
         BAS   RE,VLDTROW                                                       
         B     XVLDTBRD                                                         
*                                                                               
VLDTE5   LA    R2,SCRROW1H         VALIDATE 1ST ROW.                            
         BAS   RE,VLDTROW                                                       
         TM    FLAG,INBDVLDQ                                                    
         BZ    XVLDTBRD                                                         
         LA    R2,SCRROW2H         VALIDATE 2ND ROW.                            
         ...
         TM    FLAG,INBDVLDQ                                                    
         BZ    XVLDTBRD                                                         
         LA    R2,SCRROW5H         VALIDATE 5TH ROW.                            
         BAS   RE,VLDTROW                                                       
*                                                                               
XVLDTBRD B     EXIT1                                                            
         SPACE 4                                                                
...
INVLDBRD NI    FLAG,X'FF'-INBDVLDQ BOARD IS NOT VALID.                          
         ...
         MVC   SCRHEAD,BLANKS                                                   
         MVC   SCRHEAD(2),8(R2)                                                 
         MVC   SCRHEAD+3(L'ERLETMSG),ERLETMSG                                   
         OI    SCRHEADH+6,X'80'                                                 
*                                                                               
XVLDTROW B     EXIT1                                                            
***********************************************************************         
...
MVINTBRD NTR1                                                                   
         ...
         ZIC   R1,BOARDSZE                                                      
*                                                                               
         LA    R3,SCRROW1H         MOVE 1ST ROW.                                
         BAS   RE,MOVEROW                                                       
         AR    R2,R1                                                            
*                                                                               
         LA    R3,SCRROW2H         MOVE 2ND ROW.                                
         BAS   RE,MOVEROW                                                       
         AR    R2,R1                                                            
*                                                                               
         LA    R3,SCRROW3H         MOVE 3RD ROW.                                
         BAS   RE,MOVEROW                                                       
         AR    R2,R1                                                            
*                                                                               
         LA    R3,SCRROW4H         MOVE 4TH ROW.                                
         BAS   RE,MOVEROW                                                       
         AR    R2,R1                                                            
*                                                                               
         CLI   BOARDSZE,4                                                       
...
*               TRANSMIT THE ENTIRE BOARD (INCLUDING WALLS)                     
         LA    R2,SCRTBDRH         TRANSMIT TOP BORDER                          
         OI    6(R2),X'80'                                                      
*                                                                               
         LA    R2,SCRROW1H         TRANSMIT FIRST ROW.                          
         ZIC   R3,BOARDSZE                                                      
...
*                                                                               
         LA    R2,SCRDSH1H         TRANSMIT 1ST ROW OF DASHES.                  
         OI    6(R2),X'80'                                                      
*                                                                               
         LA    R2,SCRROW2H         TRANSMIT SECOND ROW.                         
         ZIC   R3,BOARDSZE                                                      
TLOOP2   OI    6(R2),X'80'         TRANSMIT WALL FIELD.                         
         ...
         OI    6(R2),X'80'         TRANSMIT "SOLID" WALL FIELD.                 
*                                                                               
         LA    R2,SCRDSH2H         TRANSMIT 2ND ROW OF DASHES.                  
         OI    6(R2),X'80'                                                      
*                                                                               
         LA    R2,SCRROW3H         TRANSMIT THIRD ROW.                          
         ZIC   R3,BOARDSZE                                                      
TLOOP3   OI    6(R2),X'80'         TRANSMIT WALL FIELD.                         
         ...
         OI    6(R2),X'80'         TRANSMIT "SOLID" WALL FIELD.                 
*                                                                               
         LA    R2,SCRDSH3H         TRANSMIT 3RD ROW OF DASHES.                  
         OI    6(R2),X'80'                                                      
*                                                                               
         LA    R2,SCRROW4H         TRANSMIT FOURTH ROW.                         
         ZIC   R3,BOARDSZE                                                      
TLOOP4   OI    6(R2),X'80'         TRANSMIT WALL FIELD.                         
         ...
         OI    6(R2),X'80'         TRANSMIT "SOLID" WALL FIELD.                 
*                                                                               
         LA    R2,SCRDSH4H         TRANSMIT 4TH ROW OF DASHES, OR               
         OI    6(R2),X'80'          BOTTOM BORDER OF 4X4 BOARD.                 
*                                                                               
         CLI   BOARDSZE,4                                                       
         BE    XTRANBRD                                                         
*                                                                               
         LA    R2,SCRROW5H         TRANSMIT FIFTH ROW.                          
         ZIC   R3,BOARDSZE                                                      
TLOOP5   OI    6(R2),X'80'         TRANSMIT WALL FIELD.                         
         ...
         OI    6(R2),X'80'         TRANSMIT "SOLID" WALL FIELD.                 
*                                                                               
         LA    R2,SCRBBDRH         TRANSMIT BOTTOM BORDER.                      
         OI    6(R2),X'80'                                                      
*                                                                               
XTRANBRD B     EXIT1                                                            
***********************************************************************         
...
*                                                                               
         ...
         BE    S2                                                               
*                                                                               
         LA    R2,SCRPWRDH         PLAYER HAS SOME WORDS.                       
         LA    R4,PWORDS                                                        
         ZIC   R3,PWRDCNT                                                       
...
* COMPUTER DID NOT FIND ANY WORDS                                               
*                                                                               
         MVC   SCRHEAD(L'NOWD2MSG),NOWD2MSG                                     
         OI    SCRHEADH+6,X'80'    TRANSMIT MESSAGE.                            
         B     XSHWWRDS                                                         
*                                                                               
...
SHOW01   CLC   CWRDCNT,PWRDCNT                                                  
         BH    SHOW02                                                           
         MVC   SCRHEAD(L'ALWRDMSG),ALWRDMSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         B     XSHWWRDS                                                         
*                                                                               
* COMPUTER HAS SOME MORE WORDS                                                  
*                                                                               
SHOW02   MVC   SCRHEAD(L'MRWRDMSG),MRWRDMSG                                     
         OI    SCRHEADH+6,X'80'                                                 
         LA    R2,SCRCWRDH         R2 BUMPS ALONG SCREEN.                       
...
CKPT02   LA    R3,INTBOARD(R2)     R3-->INTBOARD                                
         CLC   SCRGUES(1),0(R3)    LOOK FOR MATCH ON FIRST LETTER.              
         BNE   CKPT03                                                           
*                                                                               
...
FNDN05   ZIC   R2,0(R3)            R2=DIE # OF ADJ DIE.                         
         ...
         ZIC   R6,LTRCNT                                                        
         LA    R6,SCRGUES(R6)      R6-->NEXT LETTER IN GUESSED WORD             
...
***********************************************************************         
*------------------------------ TWA ---------------------------------*          
       ++INCLUDE GABOGFFD          DSECT FOR TWA.                               
*                                                                               
*                                                                               
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'120GABOG00   05/01/02'                                      
         END                                                                    
