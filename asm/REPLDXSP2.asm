*          DATA SET REPLDXSP2  AT LEVEL 003 AS OF 08/31/00                      
*          DATA SET REPLDXSP2  AT LEVEL 002 AS OF 05/20/96                      
*PHASE UNXREP2A                                                                 
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE RECUP                                                                  
...
NPRINT05 DS    0H                                                               
         USING RINVREC,R6                                                       
         CLC   RINVKREP,=C'B3'   NEW RECORD PURGE                               
         BNE   DMXKEEP                                                          
         CLC   =C'WPIX',RINVKSTA                                                
         BNE   DMXKEEP                                                          
         CLI   RINVKINV+3,X'40'    NEW RECORD PURGE                             
         BNL   DMXPURGE                                                         
*                                                                               
         L     R1,COUNT                                                         
         LA    R1,1(R1)                                                         
...
*                                                                               
NPRINT10 MVC   RINVKLEN,RINVKINV+2                                              
...
NPRINT15 CLI   RINVKSRC,0                                                       
         BNE   DMXKEEP                                                          
*                                                                               
         MVC   RINVOINV,RINVKINV   SAVE OLD INV NUMBER                          
*                                                                               
*                                                                               
* - ADD ELEMENTS                                                                
         XC    WORK,WORK                                                        
...
*SPGENPRD                                                                       
       ...
       ++INCLUDE REGENPRPNN                                                     
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003REPLDXSP2 08/31/00'                                      
         END                                                                    
