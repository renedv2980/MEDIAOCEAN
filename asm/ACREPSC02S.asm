*          DATA SET ACREPSC02S AT LEVEL 155 AS OF 05/01/02                      
*PHASE ACSC02A,*                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE HEXOUT                                                                 
...
REQF20   CLC   IOKEY(PERKCODE-PERKEY),SVKEY                                     
         BNE   REQFX                                                            
*                                                                               
...
*                                                                               
         ...
         BE    *+14                                                             
         MVC   PDESC,=CL30'SAPEREC F04 NOT FOUND'                               
         B     REQF190                                                          
*                                                                               
         LA    R3,IO                                                            
...
*                                                                               
         ...
         MVC   P(L'TOTMSG),TOTMSG                                               
         EDIT  (P4,PKCOUNT),(8,P+L'TOTMSG+1)                                    
         GOTO1 ACREPORT                  PRINT BLANK LINE                       
REQLX    B     EXIT                                                             
         EJECT                                                                  
******************************************************************              
...
*  ACMASTD                                                                      
       ...
       ++INCLUDE ACMASTD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'155ACREPSC02S05/01/02'                                      
         END                                                                    
