*          DATA SET REINF01S   AT LEVEL 143 AS OF 05/01/02                      
*PHASE T80B01A,*                                                                
*INCLUDE REGENWLD                                                               
...
SALE0070 DS    0H                                                               
         ...
         BNE   SETDONE                                                          
*                                                                               
SALE0080 BAS   RE,GETREC                                                        
         TM    FLTRBYT3,X'04'      KEYWORD FILTER?                              
         BZ    SALE0090            NO - SKIP CHECK                              
...
SALE0090 DS    0H                                                               
         ...
         BNE   SALE0060                                                         
SALE0100 CLC   TEMFLTR,ALL                                                      
         BE    SALE0120                                                         
         CLC   TEMFLTR,RSALTEAM+1                                               
         BNE   SALE0060                                                         
*                                                                               
SALE0120 CLC   OFFLTR,ALL                                                       
         BE    SALE0140                                                         
         CLC   OFFLTR,RSALOFF                                                   
         BNE   SALE0060                                                         
*                                                                               
SALE0140 MVC   SAVEKEY,KEY                                                      
         CLI   0(R2),0                                                          
         BE    SETNEXT                                                          
         USING LINE6,R2                                                         
*                                                                               
...
SALE0200 DS    0H                                                               
         ...
         BNE   SALE0220            NO  - DISPLAY IT                             
SALE0210 DS    0H                                                               
         BAS   RE,CLRLINE          YES - DON'T DISPLAY AND                      
*                                     CLEAR THE LINE                            
         XC    0(L'KEYTAB,R3),0(R3) CLEAR THE KEY TAB ENTRY                     
         B     SALE0060             READ ANOTHER RECORD                         
*                                                                               
SALE0220 DS    0H                  KEEP LINE AND KEY TAB ENTRY                  
...
*                                                                               
       ...
       ++INCLUDE REINFWRKA                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'143REINF01S  05/01/02'                                      
         END                                                                    
