*          DATA SET RERCVPEEL1 AT LEVEL 018 AS OF 09/25/00                      
*          DATA SET RERCVPEEL1 AT LEVEL 016 AS OF 10/24/91                      
*PHASE RERCVP1A                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PRINTER                                                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018RERCVPEEL109/25/00'                                      
         END                                                                    
