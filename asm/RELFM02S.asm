*          DATA SET RELFM02S   AT LEVEL 161 AS OF 12/01/03                      
*PHASE T80402A,*                                                                
***********************************************************************         
...
*                                                                               
         ...
         BE    FLERR7                                                           
*                                                                               
         GOTO1 =A(BITIN),DMCB,PROFBITS,RR=Y                                     
*                                                                               
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
         ZIC   R0,0(R2)                                                         
...
*                                   SCREEN TO FILE                              
         ...
         TM    SVPGPBIT+1,X'01'    CONVERT S/P EQUIV ALLOWED?                   
...
*                                                                               
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
         MVC   8(8,R2),=C'NNNNNNNN' DEFAULT SETTINGS                            
         OI    6(R2),X'80'                                                      
*                                                                               
*******************************************************************             
...
***>>>>>>>>>>>  GENDIR/GENFIL IO CONTROL                                        
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'161RELFM02S  12/01/03'                                      
         END                                                                    
