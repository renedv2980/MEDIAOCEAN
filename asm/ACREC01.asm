*          DATA SET ACREC01    AT LEVEL 009 AS OF 05/01/02                      
*PHASE T60801A                                                                  
ACREC01  TITLE '- U.K. OVERLAY TO HANDLE HEADER SCREEN AND POSTINGS'            
ACREC01  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**REC1**,RA,R9                                                 
         LR    RC,R1                                                            
...
SETLST   DS    0H                                                               
         ...
         MVI   TOTALSX,EOT                                                      
         MVC   BANKLIST,=Y(BANKULS-ACREC01)                                     
         MVC   DISCLIST,=Y(DISCULS-ACREC01)                                     
         MVC   RECVLIST,=Y(RECVULS-ACREC01)                                     
         MVC   VATLIST,=Y(RECVULS-ACREC01)                                      
         MVC   WOFFLIST,=Y(WOFFULS-ACREC01)                                     
*        MVC   TOTLIST,=Y(TOTALS-ACREC01)                                       
...
VALANL2  GOTO1 VACSRCHC,DMCB,FVADDR,TWAD,(C'*',ANALUL),                X        
...
TWAD     DSECT                                                                  
       ...
       ++INCLUDE ACRECF1D                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009ACREC01   05/01/02'                                      
         END                                                                    
