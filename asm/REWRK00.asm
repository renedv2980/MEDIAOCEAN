*          DATA SET REWRK00    AT LEVEL 010 AS OF 05/01/02                      
*PHASE T81100A,*                                                                
*INCLUDE SQUASHER                                                               
         SPACE 2                                                                
* 17SEP84 - SOFTEN FILE NAME VIA COMFACS CALL FOR WORK FILE ON                  
*           MULTIPLE SYSTEMS                                                    
         TITLE 'REP WRK - ROOT CONTROLLER'                                      
***********************************************************************         
* HISTORY OF CHANGES                                                  *         
***********************************************************************         
* OCT19/92 (BU ) --- DISPLAY THIRD DIGIT OF FILE-ID # OF LISTING      *         
*                    USE R2 AS SECOND BASE REGISTER                   *         
*                                                                     *         
*                                                                     *         
***********************************************************************         
         PRINT NOGEN                                                            
WKCNTL   CSECT                                                                  
         NMOD1 800,**RWK0**,R2,RR=R4  FILTAB=400 ENTRYS                         
         USING WRKWKD,RC                                                        
         LR    R6,R1               R6=A(PARAM LIST)                             
         L     R3,4(R6)                                                         
         USING REWRKFFD,R3         R3=A(TWA)                                    
         LR    R8,R3                                                            
...
INITX    ST    RB,ABASE                                                         
         ...
         ST    R5,CIENQDEQ                                                      
         L     R5,12(R6)           USE TIA FOR CIREC BUFFER                     
         ST    R5,ACIREC                                                        
         ST    R5,AFILTAB                                                       
         SPACE 2                                                                
...
FIDX6    OC    FISYSPRG(6),FISYSPRG                                             
         ...
         B     FIDX7A                                                           
FIDX7    EQU   *                                                                
         MVC   6(1,R4),5(R4)       MOVE ID # TO LEFT                            
         MVC   5(1,R4),4(R4)                                                    
         ZIC   RF,FICLASS          GET VALUE FROM CLASS FIELD                   
         SRL   RF,4                DROP LOW-ORDER 4 BITS                        
         STC   RF,4(R4)            PUT INTO DISPLAY, W/O ZONE BITS              
         OI    4(R4),X'F0'         ADD ZONE BITS                                
FIDX7A   EQU   *                                                                
         LA    R4,8(R4)                                                         
*                                                                               
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE CTGENFILE                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010REWRK00   05/01/02'                                      
         END                                                                    
