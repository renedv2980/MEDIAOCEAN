*          DATA SET SPLDEXTEST AT LEVEL 049 AS OF 06/03/03                      
*PHASE SPLDESTC                                                                 
*INCLUDE HEXOUT                                                                 
*INCLUDE CLUNPK                                                                 
         TITLE 'DELETE ESTIMATE AND PRODUCT RECORDS'                            
*                                                                               
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         CLI   1(R6),X'13'         AGENCY/MEDIA = MVNYN                         
         BNE   DMXKEEP                                                          
*                                                                               
         LA    RF,PRDLIST1         PG1 PRODUCT LIST                             
         CLC   2(2,R6),=XL2'BCDA'  CLIENT = PG1                                 
         BE    DMX10                                                            
*                                                                               
         B     DMXKEEP                                                          
*                                                                               
...
EXIT     XIT1                                                                   
         ...
         GETEL R6,24,ELCODE                                                     
*                                                                               
PRDLIST1 DC    C'CGM'             PG1 PRODUCT LIST                              
         DC    C'CS4'                                                           
         DC    C'ION'                                                           
         DC    C'LX1'                                                           
         DC    C'AN '                                                           
...
ESTRECD  DSECT                                                                  
       ++INCLUDE SPGENEST                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'049SPLDEXTEST06/03/03'                                      
         END                                                                    
