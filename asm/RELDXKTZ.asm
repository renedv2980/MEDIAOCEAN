*          DATA SET RELDXKTZ   AT LEVEL 251 AS OF 05/01/02                      
*PHASE RELDXKTZ                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDXKTZ - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*   MODIFY ALL REFERENCES TO AM/CQ/NK/MR TO QT/OT/K8/YT           *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
*                                                                               
         CLC   =C'AM',0(R7)        AMERICAN?                                    
         BNE   DMXREC3             NO                                           
         MVC   0(2,R7),=C'QT'      YES - CHANGE TO QT (AMER/TEST)               
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC3  EQU   *                                                                
         CLC   =C'CQ',0(R7)        CONTINENTAL?                                 
         BNE   DMXREC4             NO                                           
         MVC   0(2,R7),=C'OT'      YES - CHANGE TO OT (CONTIN/TEST)             
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC4  EQU   *                                                                
         CLC   =C'NK',0(R7)        NATIONAL?                                    
         BNE   DMXREC5             NO                                           
         MVC   0(2,R7),=C'K8'      YES - CHANGE TO K8 (NATL/TEST)               
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
DMXREC5  EQU   *                                                                
         CLC   =C'MR',0(R7)        KATZ TV MASTER?                              
         BNE   DMXKEEP             NO  - KEEP IT AS IS                          
         MVC   0(2,R7),=C'YT'      YES - CHANGE TO YT (MASTER/TEST)             
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
         EJECT                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'251RELDXKTZ  05/01/02'                                      
         END                                                                    
