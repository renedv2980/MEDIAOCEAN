*          DATA SET CTESS05    AT LEVEL 009 AS OF 09/24/19                      
*PHASE TA0E05A                                                                  
*INCLUDE NUMVAL                                                                 
*                                                                               
         TITLE 'CTESS05 - FILE MAINTENANCE - EXTRACT LOG RECORDS'               
ESS05    CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**ES05**,RA,RR=RE                                              
...
VKSYS    MVI   FVMINL,1            READ SYSTEM FIELD                            
         ...
         DROP  R1                                                               
*                                                                               
VKTHD    MVI   FVMINL,1            READ THREAD FIELD                            
         GOTO1 AFVAL,XLGTHDH                                                    
         BE    VKTHD10                                                          
         MVI   XLGTHD,C'0'                                                      
         B     VKDATE                                                           
VKTHD10  GOTO1 =V(NUMVAL),APPARM,XLGTHD,(X'02',0),RR=APRELO                     
         CLI   0(R1),0                                                          
         BNE   EIIF                                                             
         L     R1,4(R1)                                                         
         C     R1,=F'255'                                                       
...
*                                                                               
         ...
         BNE   VKR008                                                           
         CLC   GXRKTHD,APRECKEY+GXRKTHD-GXKEY                                   
         BE    VKR010                                                           
         LA    R1,IOGENDIR+IOSQD+IO1                                            
         B     VKR005                                                           
VKR008   MVI   APINDS,APIOKADD     NO RECORD WITH THIS KEY                      
...
*                                  UPDATE SCREEN KEY FIELDS                     
         ...
         OI    XLGTHDH+(FVOIND-FVIHDR),FVOXMT                                   
...
DISKEY   LA    R2,APRECKEY                                                      
         GOTO1 ADISSE,GXRKSEN                                                   
         MVC   XLGSYS,APWORK                                                    
         EDIT  GXRKTHD,(3,XLGTHD),ZERO=NOBLANK,ALIGN=LEFT                       
         XC    APWORK,APWORK                                                    
         MVC   APHALF,GXRKDAT                                                   
         XC    APHALF,FFS                                                       
         GOTO1 VDATCON,APPARM,(2,APHALF),(X'51',APWORK)                         
...
*                                  CLEAR TASK TABLE LINES                       
         USING TSKTD,RF                                                         
         LA    RF,XLGLIN1H         SET ADDRESS OF FIRST TABLE LINE              
         LA    R1,XLGTENDH         SET ADDRESS END OF TABLE                     
         LA    RE,XLGLIN2H         SET LIST LINE LENGTH                         
         SR    RE,RF                                                            
DREC010  CR    RF,R1                                                            
         BNL   DREC020                                                          
         XC    TSKTLIN,TSKTLIN                                                  
...
DRECTSKT EQU   *                                                                
         USING TSKTD,R4                                                         
         LA    R4,XLGLIN1H         SET ADDRESS OF FIRST TABLE LINE              
         LA    R1,XLGLIN2H         SET TABLE LINE LENGTH                        
         SR    R1,R4                                                            
         STH   R1,TSKTLEN                                                       
         ST    R4,TSKTSTA                                                       
         LA    R8,GXRSLDA                                                       
...
*                                                                               
         ...
         MVI   TSKTCNT,0                                                        
*                                                                               
DSIN010  CLI   TSKTCNT,GXRSTMAX                                                 
         BNL   DREC100                                                          
         GOTO1 VHEXOUT,APPARM,(R8),APWORK,4,=C'TOG'                             
         MVC   TSKTSN1(2),APWORK+6                                              
         MVI   TSKTSN1+2,C'/'                                                   
         MVC   TSKTSN1+3(6),APWORK                                              
         MVI   TSKTSN1+9,C' '                                                   
         LA    R8,L'GXSIVAL(R8)                                                 
         GOTO1 VHEXOUT,APPARM,(R8),APWORK,4,=C'TOG'                             
         MVC   TSKTSN2(2),APWORK+6                                              
         MVI   TSKTSN2+2,C'/'                                                   
         MVC   TSKTSN2+3(6),APWORK                                              
         MVI   TSKTSN2+9,C' '                                                   
         LA    R8,L'GXSIVAL(R8)                                                 
         GOTO1 VHEXOUT,APPARM,(R8),APWORK,4,=C'TOG'                             
         MVC   TSKTSN3(2),APWORK+6                                              
         MVI   TSKTSN3+2,C'/'                                                   
         MVC   TSKTSN3+3(6),APWORK                                              
         MVI   TSKTSN3+9,C' '                                                   
         LA    R8,L'GXSIVAL(R8)                                                 
         GOTO1 VHEXOUT,APPARM,(R8),APWORK,4,=C'TOG'                             
         MVC   TSKTSN4(2),APWORK+6                                              
         MVI   TSKTSN4+2,C'/'                                                   
         MVC   TSKTSN4+3(6),APWORK                                              
         MVI   TSKTSN4+9,C' '                                                   
         LA    R8,L'GXSIVAL(R8)                                                 
         CLC   TSKTSN1(9+1+8),=C'00/000000 00000000'                            
         BNE   *+10                                                             
         MVC   TSKTSN1(9+1+8),SPACES                                            
         CLC   TSKTSN2(9+1+8),=C'00/000000 00000000'                            
         BNE   *+10                                                             
         MVC   TSKTSN2(9+1+8),SPACES                                            
         CLC   TSKTSN3(9+1+8),=C'00/000000 00000000'                            
         BNE   *+10                                                             
         MVC   TSKTSN3(9+1+8),SPACES                                            
         CLC   TSKTSN4(9+1+8),=C'00/000000 00000000'                            
         BNE   *+10                                                             
         MVC   TSKTSN4(9+1+8),SPACES                                            
         ZIC   RF,TSKTCNT                                                       
         AH    RF,=H'4'                                                         
         STC   RF,TSKTCNT                                                       
         L     R4,TSKTSTA                                                       
...
VSELSYS  EQU   *                                                                
         GOTO1 AFVAL,LSTSYSH                                                    
         BNE   VSSYSX                                                           
         GOTO1 AVALSE,LSTSYSH                                                   
         BNE   VALSELX                                                          
         L     R1,APPARM                                                        
         USING SELISTD,R1                                                       
         MVC   LSTSYS(7),SENAME    DISPLAY FULL SYSTEM NAME                     
         OI    LSTSYSH+6,X'80'                                                  
         MVC   SELSYS,APWORK                                                    
         DROP  R1                                                               
VSSYSX   EQU   *                                                                
...
*                                                                               
SELKEY   DS    0XL32                                                            
SELSYS   DS    XL1                 SYSTEM SE NUMBER                             
SELTHDC  DS    CL1                 THREAD # SET, Y/N                            
SELTHD   DS    XL1                 THREAD #                                     
         ORG   SELKEY+L'SELKEY                                                  
*                                                                               
...
LOCALX   EQU   *                                                                
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009CTESS05   09/24/19'                                      
         END                                                                    
