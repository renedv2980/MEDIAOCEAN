*          DATA SET SPCBLNEW   AT LEVEL 028 AS OF 06/18/15                      
*PHASE SPCBNEWA,*                                                               
*INCLUDE DMDMGRL                                                                
*INCLUDE HELEN                                                                  
*INCLUDE HELLO                                                                  
...
*INCLUDE STXITER                                                                
*INCLUDE SORTER                                                                 
SPCBLNEW TITLE 'SPCBLNEW - COMBINES SYSTEMS AND NETWORKS INTO ONE FILE'         
SPCBLNEW CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 0,SPCBLNEW,=V(REGSAVE),R9                                        
*                                                                               
         USING DPRINT,RA                                                        
         L     RA,=V(CPRINT)                                                    
*                                                                               
...
*                                                                               
         GOTO1 NEXTFLD,DMCB,(1,(R2)),(L'WORK,WORK)                              
         BE    *+6                                                              
         DC    H'0'                                                             
...
*                                                                               
         CLI   LINETYPE,C'S'                                                    
         BNE   CSLNX                                                            
         MVI   OPUTDATA+5,C'0'     PUT ACTION DATA W/ CODE OF "N"               
         MVC   OPUTDATA+7(4),=C'"N" '                                           
         MVC   OPUTLGTH,=H'15'                                                  
*                                                                               
         LA    R8,OPUTLINE                                                      
         GOTO1 =V(SORTER),DMCB,=C'PUT',(R8)                                     
...
*                                                                               
       ...
       ++INCLUDE DDDPRINT                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028SPCBLNEW  06/18/15'                                      
         END                                                                    
