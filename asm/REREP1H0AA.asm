*          DATA SET REREP1H0AA AT LEVEL 061 AS OF 05/01/02                      
*PHASE RE1H02C,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
*        DC    AL1(REQFRST),AL3(INITIAL)  REQUEST A CONTRACT                    
         DC    AL1(REQFRST),AL3(SWEEPBUD) SWEEP SALESPERSON RECORDS             
*                                                                               
MDENTRYX EQU   *                                                                
...
*              SHOW CONTRACT DETAILS                                            
         EJECT                                                                  
*                                                                               
*   SWEEPBUD: CHECK FOR BAD OFFICES IN BUDGET RECOREDS         '                
*                                                                               
SWEEPBUD NTR1                                                                   
*                                                                               
         LA    R5,BUDGAREA         SET A(BUDGET AREA)                           
         LA    R4,IO1                                                           
         USING RBUDREC,R4                                                       
         ST    R4,AIOAREA                                                       
*                                                                               
         LA    RE,KEY                                                           
         XC    KEY,KEY                                                          
         MVI   KEY,X'13'           INSERT BUDGET KEY TYPE                       
         MVC   KEY+16(2),RCREPFL   INSERT REP CODE                              
         GOTO1 HIGH                START READ                                   
         B     SW020040                                                         
SW020020 EQU   *                                                                
         GOTO1 SEQ                 READ NEXT 13 KEY                             
SW020040 EQU   *                                                                
*                                                                               
*   TEST                                                                        
...
*                                                                               
*   TEST                                                                        
         MVC   P+1(10),=C'BAD KEY  :'                                           
         MVC   P+12(27),KEY                                                     
         MVC   P+45(27),KEYSAVE                                                 
         GOTO1 REPORT                                                           
*   TEST END                                                                    
SW020050 EQU   *                                                                
         CLC   KEY(18),KEYSAVE     SAME TYPE/REP?                               
         BE    SW020020            GO BACK FOR NEXT                             
SW020400 EQU   *                                                                
         GOTO1 REPORT                                                           
         GOTO1 REPORT                                                           
         MVC   P+1(10),=C'**********'                                           
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'061REREP1H0AA05/01/02'                                      
         END                                                                    
