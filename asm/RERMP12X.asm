*          DATA SET RERMP12X   AT LEVEL 168 AS OF 05/01/02                      
*PHASE T81012A,+0                                                               
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLSTB                                                               
...
T81012   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T81012,RR=R5                                                   
         LA    R9,2048(RB)                                                      
         LA    R9,2048(R9)                                                      
         USING T81012+4096,R9                                                   
*                                                                               
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
         L     RA,ATWA                                                          
...
VK20     LA    R2,MIVSTAH                                                       
         ...
         SPACE 1                                                                
*                                                                               
         BAS   RE,TRANINV          MOVE INVOUICE NUMBERS                        
*                                                                               
*              SERVICE                                                          
*                                                                               
*        MVI   ERROR,INVALID                                                    
...
*-----------------------------------------------------------------              
         ...
         BZ    VK22                                                             
         BAS   RE,FRMILIST         YES - MOVE IN SELECTED RECS                  
*-----------------------------------------------------------------              
*                                                                               
VK22     DS    0H                                                               
...
*                                                                               
         XC    WORK,WORK                                                        
         MVI   ERROR,INVALID                                                    
         GOTO1 VREBKLST,DMCB,(R2),(C'B',WORK),BOOKVAL,SCANNER                   
         CLI   DMCB,0                                                           
         BE    ERREND                                                           
...
*                                                                               
         ...
         BNE   ERREND              DON'T ALLOW MIXED UP BKTYPES                 
...
*                                                                               
         ...
         OI    6(R2),X'80'                                                      
*                                                                               
         BAS   RE,NEXTFLD          POINT TO NEXT LINE                           
         BAS   RE,NEXTFLD                                                       
         BAS   RE,NEXTFLD                                                       
         BAS   RE,NEXTFLD                                                       
         BAS   RE,NEXTFLD                                                       
...
*                                                                               
         ...
         BAS   RE,DYTIMSET         SET MULTI DAY TIME BLOCK                     
         BAS   RE,DATAREC                                                       
*        CLI   ERROR,0                                                          
...
*                                                                               
*        XC    TRBKLIST,TRBKLIST                                                
*        GOTO1 VREBKLST,DMCB,(R2),TRBKLIST,BOOKVAL,SCANNER                      
*        MVI   ERROR,INVALID                                                    
*        CLI   DMCB,0                                                           
*        BE    ERREND                                                           
...
FLP15    MVI   RINVAWHY,C'C'                                                    
         ...
         GOTO1 HELLO,DMCB,(C'P',REPFILE),(0,AIO),(R5)                           
         BAS   RE,MYFILWRT         WRITE BACK THE NEW                           
         NI    DMINBTS,X'F7'                                                    
         MVC   BSVDA,KEY+28                                                     
         B     EXIT                                                             
         DROP  R4                                                               
...
*                                                                               
RELO     DS    A                                                                
REPFILE  DC    C'REPFILE'          MELLO FILE NAME                              
*                                                                               
         LTORG                                                                  
         EJECT                                                                  
         EJECT                                                                  
...
LENVALS  EQU   NUMVALS*4                                                        
       ...
       ++INCLUDE REBKLSTD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'168RERMP12X  05/01/02'                                      
         END                                                                    
