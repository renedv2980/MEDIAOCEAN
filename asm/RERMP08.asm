*          DATA SET RERMP08    AT LEVEL 011 AS OF 06/27/08                      
*PHASE T81008A                                                                  
*INCLUDE CLPACK                                                                 
         TITLE 'T81008 - RERMP08 - MARKET PROFILE REPORT'                       
*                                                                               
**********************************************************************          
*                                                                    *          
*        RERMP08 (T81008) --- MARKET PROFILE REPORT                  *          
*                                                                    *          
* ------------------------------------------------------------------ *          
* UPDATE HISTORY:                                                    *          
*                                                                    *          
...
MP100    L     R5,AIO2             ELSE USE SCHEME 1                            
         LA    R2,MPRPJ1H                                                       
         SPACE 1                                                                
MP110    BAS   RE,RSID             GO TO RANSID AND CHECK FOR ERRORS            
...
TWADCOND DSECT                                                                  
       ++INCLUDE DDTWADCONS                                                     
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011RERMP08   06/27/08'                                      
         END                                                                    
