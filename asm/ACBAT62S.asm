*          DATA SET ACBAT62S   AT LEVEL 028 AS OF 02/10/03                      
*PHASE T61B62A,*                                                                
...
*                                                                               
         ...
         STC   R1,BOBYTE1                                                       
         LA    R0,L'PTXLIN1        RESET LINE LENGTH                            
PSTANA36 LA    R4,SUBLSTQ(R4)      NEXT SUBLST TABLE ENTRY                      
         B     PSTANA28                                                         
*                                                                               
PSTANAX  B     PSTTRANS                                                         
         DROP  R3,R4,RC                                                         
...
PRORATX  EQU   *                                                                
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028ACBAT62S  02/10/03'                                      
         END                                                                    
