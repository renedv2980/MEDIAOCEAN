*          DATA SET SPRES23    AT LEVEL 029 AS OF 05/01/02                      
*PHASE T20F23,*                                                                 
*INCLUDE BINSRCH2                                                               
...
*                                                                               
LR15     DS    0H                                                               
         XC    KEY,KEY             CLEAR KEY TO READ 1ST REC ON FILE            
         GOTO1 HIGH                                                             
         MVC   PSEUDOKY,KEY        SAVE KEY FOR GENCON'S LIST LOGIC             
         MVC   PSEUDODA,KEY+14     SAVE D/A USE AS PLACEBO FOR GENCON           
*                                                                               
LR20     L     R7,BINATAB                                                       
         USING BINRECD,R7                                                       
         L     R0,SVTBLNDX                                                      
...
LR50     L     R1,SVTBLNDX                                                      
         ...
         MVC   KEY,PSEUDOKY        FUDGE IN A VALID KEY FOR GENCON              
         MVC   DMDSKADD,PSEUDODA   SET A PLACEBO D/A FOR GENCON                 
*                                                                               
         DROP  R7                                                               
*                                                                               
...
DEMHOOK4 LA    R4,POSTLINE                                                      
         USING BINRECD,R4                                                       
         CLI   SBBOOK,120          BYPASS BAD STATION RECORDS                   
         BH    DEMHOOKX                                                         
...
SYSD     DSECT                                                                  
         ORG   OVWORK                                                           
BINSRCH  DS    V                                                                
PSEUDODA DS    A                   PSEUDO D/A TO FAKE OUT GENCON                
ENDNEAR  DS    C                                                                
...
PSEUDOKY DS    XL(L'KEY)           PSEUDO KEY TO FAKE OUT GENCON                
...
BINEND   EQU   *                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029SPRES23   05/01/02'                                      
         END                                                                    
