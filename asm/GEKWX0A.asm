*          DATA SET GEKWX0A    AT LEVEL 042 AS OF 05/01/02                      
*PHASE TF200AA,*                                                                
*INCLUDE GETLIST                                                                
...
*                                                                   *           
* SEP19/96 (SKU) --- FIX SEND BUG                                   *           
*                                                                   *           
* AUG13/01 (SKU) --- INCREASE 'SEND TO' ID MAX LENGTH FROM 6 TO 7   *           
*                                                                   *           
*********************************************************************           
*                                                                               
         PRINT NOGEN                                                            
...
T262     LH    R3,DESTNUM          COMPLETE ACCOUNTING RECORD                   
         ...
         LA    R1,KWXANEXT                                                      
*                                                                               
T264     DS    0H                  BUILD DEST ID STRING ELEMENTS OF UP          
         LR    R2,R1                                                            
         USING KWXDEL,R2           TO 125 ID'S PER ELEMENT                      
         LA    R0,125                                                           
         MVI   KWXDEL,KWXDELQ                                                   
...
T270     DS    0H                                                               
         LA    R2,KWXACTH                                                       
         CLI   SCOPY,0             SENDER'S COPY IF REQUIRED                    
         BNE   T280                                                             
         MVI   QLSUBID,C'S'                                                     
...
RBILPQNO DS    CL5       C         DDS PRINT QUEUE NUMBER                       
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'042GEKWX0A   05/01/02'                                      
         END                                                                    
