*          DATA SET ACINF19    AT LEVEL 004 AS OF 05/01/02                      
*PHASE T60513A,*,NOAUTO                                                         
         TITLE 'ACCOUNTS INFO PROGRAM - RECORD TYPE OL - OFFICE LISTS'          
T60513   CSECT                                                                  
         PRINT NOGEN                                                            
*              TABLES FOR RECORD TYPE OFFICE (CODE) ACCOUNTS INFO PROG          
*              TYPE : ENG = 'OF' / GERMAN = '??'                                
*                                                                               
*        DISPLAY OFFICE LISTS                                                   
*                                                                               
*              OVERLAY ADDRESSES                                                
...
HEADINGS DC    CL39'OFFICE SHORT NAME   ------------ LONG N'                    
         DC    CL39'CODE                                   '                    
         DC    CL39'AME ------------- NUMBER OF OFFICES IN '                    
         DC    CL39'                  THIS LIST            '                    
*                                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         DC    AL1(0)                                                           
*                                                                               
         DC    AL2(AKEY-GWS)       NO. OFFICES IN THE LIST                      
         DC    AL2(0)              OFFSET INTO EL                               
         DC    AL1(3)                                                           
         DC    XL2'FF00'                                                        
         DC    AL1(57)             START COL                                    
         DC    AL1(OFLELQ)         ELCODE                                       
*                                                                               
...
DNTRYPNT DS    0H                                                               
         ...
         L     RB,APHASE                                                        
         USING T60513,RB                                                        
         LA    R9,BINTAB           A(SOME LOCAL WORKING STORAGE)                
         USING LOCALD,R9                                                        
         USING DATTABD,R5                                                       
...
DNT20    CLI   0(R2),SNMELQ        IS IT A SHORT NAME FIELD                     
         BNE   DNT40               NO ,ITS OF OFFICES IN LIST                   
         USING SNMELD,R2                                                        
...
*                                                                               
         USING OFLELD,R2                                                        
DNT40    ZIC   R1,OFLLN            TOTAL LEN OF ELEMENT                         
         SH    R1,=Y(OFLLN1Q)      LESS ELCODE, LEN, ETC.                       
         SRL   R1,1                D1VIDE BY 2                                  
         STH   R1,MYDUB            STORE # OF OFFICES IN THIS LIST              
         LA    R2,MYDUB                                                         
         LA    R3,2                LENGTH OF SAME                               
         L     RF,EDITBIN3                                                      
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004ACINF19   05/01/02'                                      
         END                                                                    
