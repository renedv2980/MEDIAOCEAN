*          DATA SET CPREP0602  AT LEVEL 010 AS OF 05/01/02                      
*PHASE CP0602A                                                                  
...
PRS2     OC    SUMBTGT,SUMBTGT                                                  
         ...
         MVC   SPRSUP,SUMBTGT                                                   
         MVC   SPRACT,SUMBDEM                                                   
         EDIT  SUMBSPT,(7,SPRSPT),,COMMAS=YES                                   
         L     R5,SUMBSPT                                                       
         L     R1,TOTSPT                                                        
         BAS   RE,GETPCT                                                        
         EDIT  (R5),(3,SPRPCTS)                                                 
         EDIT  SUMBDOL,(12,SPRDOL),,COMMAS=YES,MINUS=YES                        
         L     R5,SUMBDOL                                                       
         L     R1,TOTDOL                                                        
         BAS   RE,GETPCT                                                        
         EDIT  (R5),(3,SPRPCTD)                                                 
...
*        INCLUDE CPGENFILE                                                      
       ...
       ++INCLUDE CPGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010CPREP0602 05/01/02'                                      
         END                                                                    
