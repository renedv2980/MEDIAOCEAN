*          DATA SET CTFIL22A   AT LEVEL 015 AS OF 10/25/99                      
*&&      SET   NOP=N                                                            
*PHASE TA1322A,*                                                                
...
***********************************************************************         
         SPACE 1                                                                
KNOWTAB  DC    AL2(00200),AL4(LUIDDTA)      LUID                                
...
*                                                                               
         ...
         B     EXITOK                                                           
***********************************************************************         
* DATA OBJECT FOR LUID                                                *         
*                                                                     *         
* R1 HOLDS EQUATED VERB                                               *         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                 *         
***********************************************************************         
         SPACE 1                                                                
LUIDDTA  LA    RF,INITBL           TABLE OF KNOWN VERBS                         
         B     ITER                                                             
*                                                                               
INITBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISLUID)                                
         DC    AL1(DVAL),AL1(0,0,0),AL4(VALLUID)                                
         DC    AL1(DFDIS),AL1(0,0,0),AL4(DFLTLUID)                              
         DC    AL1(DFVAL),AL1(0,0,0),AL4(VFLTLUID)                              
         DC    AL1(DFDO),AL1(0,0,0),AL4(DOFTLUID)                               
         DC    AL1(DDFLT),AL1(0,0,0),AL4(DDFTLUID)                              
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
* DISPLAY LUID FIELD                                                  *         
***********************************************************************         
         SPACE 1                                                                
DISLUID  MVC   FVIFLD(L'DASKLUID),DASKLUID                                      
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* VALIDATE LUID FIELD                                                 *         
...
*        MVC   DASKLUID,FVIFLD                                                  
         ...
         SPACE 2                                                                
***********************************************************************         
* DISPLAY LUID FILTER FIELD                                           *         
***********************************************************************         
         SPACE 1                                                                
DFLTLUID MVC   FVIFLD(L'DASKLUID),FLTIFLD                                       
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* VALIDATE LUID FILTER FIELD                                          *         
***********************************************************************         
         SPACE 1                                                                
VFLTLUID MVC   DASKLUID,FVIFLD                                                  
         MVC   FLTIFLD(L'DASKLUID),FVIFLD                                       
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
DOFTLUID CLC   DASKLUID,FLTIFLD                                                 
         BL    FLTXL                                                            
         BE    FLTXE                                                            
         BH    FLTXH                                                            
         EJECT                                                                  
***********************************************************************         
* DO DEFAULT FOR LUID FIELD                                           *         
***********************************************************************         
         SPACE 1                                                                
DDFTLUID MVC   DASKLUID,CUTSYM                                                  
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
* DATA OBJECT FOR PASSWORD                                            *         
*                                                                     *         
* R1 HOLDS EQUATED VERB                                               *         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                 *         
***********************************************************************         
         SPACE 1                                                                
PWDDTA   LA    RF,PWDTBL           TABLE OF KNOWN VERBS                         
         B     ITER                                                             
*                                                                               
PWDTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISPWD)                                 
         DC    AL1(DVAL),AL1(0,0,0),AL4(VALPWD)                                 
         DC    AL1(DFDIS),AL1(0,0,0),AL4(DFLTPWD)                               
         DC    AL1(DFVAL),AL1(0,0,0),AL4(VFLTPWD)                               
         DC    AL1(DFDO),AL1(0,0,0),AL4(DOFTPWD)                                
         DC    AL1(DDFLT),AL1(0,0,0),AL4(DDFTPWD)                               
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
DISPWD   DS    0H                                                               
         EDIT  DASKPW#,(5,FVIFLD),ALIGN=LEFT                                    
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
...
*        MVC   DASKPW#,FVIFLD                                                   
         ...
         SPACE 2                                                                
***********************************************************************         
* DISPLAY PASSWORD FILTER FIELD                                       *         
***********************************************************************         
         SPACE 1                                                                
DFLTPWD  MVC   FVIFLD(L'DASKPW#),FLTIFLD                                        
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* VALIDATE PASSWORD FILTER FIELD                                      *         
***********************************************************************         
         SPACE 1                                                                
VFLTPWD  DS    0H                                                               
*        MVC   DASKPW#,FVIFLD                                                   
         MVC   FLTIFLD(L'DASKPW#),FVIFLD                                        
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* DO FILTERING FOR SYSTEM                                             *         
***********************************************************************         
         SPACE 1                                                                
DOFTPWD  CLC   DASKPW#,FLTIFLD                                                  
         BL    FLTXL                                                            
         BE    FLTXE                                                            
         BH    FLTXH                                                            
         EJECT                                                                  
***********************************************************************         
* DO DEFAULT FOR SYSTEM                                               *         
***********************************************************************         
         SPACE 1                                                                
DDFTPWD  MVC   DASKPW#,CUPASS                                                   
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015CTFIL22A  10/25/99'                                      
         END                                                                    
