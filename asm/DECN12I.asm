*          DATA SET DECN12I    AT LEVEL 107 AS OF 09/12/13                      
*PROCESS USING(WARN(15))                                                        
*PHASE DECN12IA                                                                 
         TITLE '- DEMO CONVERSION - CABLE MIT'                                  
*                                                                               
**********************************************************************          
* INPUT-OUTPUT LOGIC:                                                           
* ------------------                                                            
...
RDR      DS    0H                                                               
*                                                                               
RDCREG   CLC   =C'EXTENDED CABLE MIT',MI0FILE                                   
         BNE   RDCWGT              FOR REG DATA,                                
         CLI   BOOKTYPE,0          SHOULD BE NO JCL ENFORCED BTYPE              
         BE    RDR5                                                             
         B     BADBTYPE                                                         
RDCWGT   CLC   =C'WGT EXTENDED CABLE MIT',MI0FILE                               
         BE    *+6                                                              
         DC    H'0'                UNKNOWN TAPE TYPE                            
         CLI   BOOKTYPE,C'E'       FOR WEIGHTED DATA,                           
         BE    RDR5                BTYPE SHOULD BE ENFORCED TO 'E'              
*                                                                               
         USING DPRINT,R7                                                        
BADBTYPE MVC   P,SPACES                                                         
         MVC   P(15),=C'!!!! ERROR !!!!'                                        
         GOTO1 VPRINTER                                                         
         GOTO1 VPRINTER                                                         
         MVC   P(44),=C'**** INPUT BOOK TYPE DOES NOT MATCH THE FILE'           
         GOTO1 VPRINTER                                                         
         MVC   P(36),=C'**** ENTER BTYPE=E FOR WEIGHTED DATA'                   
         GOTO1 VPRINTER                                                         
         MVC   P(30),=C'**** NO BTYPE FOR REGULAR DATA'                         
         GOTO1 VPRINTER                                                         
         B     ENDJOB                                                           
         DROP  R7                                                               
*                                                                               
...
*                                                                               
         CLI   BOOKTYPE,C'E'                                                    
         BNE   TVU1                                                             
         CLC   MITCOVG,=C'000000'                                               
         BNE   TVU1                                                             
         CLI   MITFEED,C'L'        BYPASS LIVE FEED TO AVOID BTYPE 'L'          
         BE    READ20                                                           
*                                                                               
...
HDR5B    CVB   R1,DUB                                                           
         ST    R1,CBLHUT           CABLE HUTS BY COVERAGE AREA                  
*                                                                               
...
*                                                                               
         XC    KEY,KEY             GET FILE NUMBER                              
         MVI   PJCODE,PJCODEQU     FOR THIS BOOK/PROGRAM                        
         MVI   PJMEDIA,C'C'                                                     
         MVC   PJSRC,INTKSRC                                                    
         MVC   PJSTAT(4),INTSTA                                                 
         MVI   PJSTAT+4,C'C'                                                    
...
*        DDCOMFACS                                                              
       ...
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'107DECN12I   09/12/13'                                      
         END                                                                    
