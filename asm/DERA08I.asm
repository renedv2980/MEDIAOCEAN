*          DATA SET DERA08I    AT LEVEL 063 AS OF 06/22/18                      
...
*                                                                               
         L     R0,=A(TOTTBLSZ)     GRAB BUFFER FROM HIGH CORE                   
...
LST015   MVI   NEWSTTN,C'Y'                   NEW STTN COMBO ID                 
...
*                                                                               
TOTTBLSZ EQU   (1200*1024)         "TOTAL TABLE" BUFFER SIZE                    
*                                                                               
EMMM     DS    CL3                 MON                                          
         DS    CL1                 /                                            
EYY      DS    CL2                 YY                                           
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'063DERA08I   06/22/18'                                      
         END                                                                    
