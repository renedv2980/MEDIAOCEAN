*          DATA SET CTREP9102M AT LEVEL 011 AS OF 05/01/02                      
*PHASE CT9102A,+0                                                               
*INCLUDE SORTER                                                                 
         TITLE 'DEMO SYSTEM CONTROL FILE REPORT'                                
**********************************************************************          
* FILTERS OUT ALL NETWORK/NETTV AND NETWORK/WEEKLY DCONS W/ACTIVITY             
* ELEMENT DATE >= MAY/95                                                        
**********************************************************************          
CT9102   CSECT                                                                  
         PRINT NOGEN                                                            
...
ROPRPT1  LA    R4,KEY                                                           
         ...
         MVI   CTRKSRC,C'N'        NETWORK                                      
         MVI   CTRKMED,C'N'        NETTV                                        
ROPR15   BAS   RE,HIGH                                                          
         B     ROPR25                                                           
*                                                                               
ROPRPT2  GOTO1 REPORT                                                           
ROPR2A   BAS   RE,SEQ              READ NEXT KEY                                
*                                                                               
ROPR25   LA    R4,KEY                                                           
         CLI   CTRKTYP,CTRKTEQU                                                 
         BNE   EXIT                                                             
         CLI   CTRKSRC,C'N'        NON NETWORK                                  
         BNE   EXIT                                                             
         CLI   CTRKMED,C'N'                                                     
         BE    ROPR30                                                           
         CLI   CTRKMED,C'W'                                                     
         ...
         MVI   CTRKSRC,C'N'                                                     
         MVI   CTRKMED,C'W'                                                     
         B     ROPR15              READ NSI WEEKLY                              
*                                                                               
ROPR30   DS    0H                  ONLY PRINT KEYS W/ACTV > MAY/95              
         CLI   CTRDATA,X'01'                                                    
         BE    *+6                                                              
         DC    H'0'                NO ACTIVITY ELEM????                         
         CLC   CTRDATA+2(2),=X'5F05'                                            
         BL    ROPR2A              NO ACTIVITY AFTER MAY ->NEXT KEY             
*                                                                               
...
PDNAM7   DS    CL7                 7 CHAR NAME                                  
         DS    CL4                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011CTREP9102M05/01/02'                                      
         END                                                                    
*                                                                               
