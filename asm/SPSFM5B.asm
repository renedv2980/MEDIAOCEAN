*          DATA SET SPSFM5B    AT LEVEL 029 AS OF 03/01/06                      
*PHASE T2175BA                                                                  
         TITLE 'SPSFM5B - UCOMM MAINTANANCE PROGRAMM'                           
******************************************************************              
* REGISTERS:  R0 -- WORK                                                        
*             R1 -- WORK                                                        
...
*                                                                               
         ...
         BE    VK20                                                             
VK10     MVI   USEIONUM,2          READ INTO AIO2                               
...
*                                                                               
         ...
         MVC   COMESTN,ESTNM       TRANSMIT DESCRIPTION                         
         OI    COMESTNH+6,X'80'                                                 
         MVC   UCOMKEST,BEST                                                    
...
* MARKET FIELD                                                                  
*                                                                               
VK40     LA    R2,COMMKTH          MARKET FIELD                                 
         TM    4(R2),X'20'         VALIDATED?                                   
         BO    *+8                                                              
         OI    FLAG2,KEYCHG                                                     
         XC    BMKT,BMKT                                                        
         CLI   COMMKTH+5,0         ANY INPUT?                                   
         BE    VK50                                                             
*                                                                               
         CLI   ACTNUM,ACTLIST      IF LIST - DON'T NEED EST                     
         BE    VK42                                                             
         OC    QEST,QEST           YES, ANY EST ?                               
         BZ    INVKEY              NO, NEED EST                                 
VK42     MVI   USEIONUM,2          READ INTO AIO2                               
         GOTO1 VALIMKT             VALIDATE MKT                                 
         MVC   COMMKTN,MKTNM       TRANSMIT DESCRIPTION                         
         OI    COMMKTNH+6,X'80'                                                 
*                                                                               
         CLI   ACTNUM,ACTLIST      IF LIST                                      
         BNE   VK44                                                             
         OC    BEST,BEST           AND DON'T HAVE ESTIMATE                      
         BZ    *+10                THEN DON'T FILL IN MKT IN KEY                
VK44     MVC   UCOMKMKT,BMKT                                                    
         OI    FLAG,MKTLEV         INDICATE MKT LEVEL                           
         NI    FLAG,X'FF'-PRDLEV   TURN OFF PRD LEV                             
         NI    FLAG,X'FF'-ESTLEV   TURN OFF EST LEV                             
         OI    4(R2),X'20'         SET VALIDATED                                
*                                                                               
VK50     TM    FLAG,PRDLEV+ESTLEV+MKTLEV  LOWER LEVEL?                          
         BZ    VK54                                                             
         BAS   RE,VKCKREC          CHECK CLT REC                                
         B     BLDKEY                                                           
*                                                                               
VK54     OI    FLAG,CLTLEV         CLT LEVEL UCOM REC                           
         MVC   SVFLAG,FLAG                                                      
*                                                                               
...
*                                                                               
         L     R6,AIO2                                                          
         MVI   ELCODE,X'41'        PRD ELEMS                                    
         TM    FLAG,PRDLEV                                                      
         BO    VKCKR12                                                          
         MVI   ELCODE,X'51'        EST ELEMS                                    
         TM    FLAG,ESTLEV                                                      
         BO    VKCKR12                                                          
         MVI   ELCODE,X'61'        MKT ELEMS                                    
VKCKR12  BAS   RE,GETEL                                                         
...
*                                                                               
         ...
         BE    VR10                IF CHANGE                                    
*                                                                               
         BAS   RE,COUNTPEM         COUNT HOW MANY PRD,EST,MKT ELEMS             
*                                                                               
VR10     L     R3,AIO              DELETE ALL ELEMENTS                          
         ...
         DROP  R3                                                               
*                                                                               
         LA    R4,12               SET # OF ROWS ON SCREEN FOR BCT              
         LA    R2,COMLN1TH                                                      
...
*                                                                               
VR15     CLI   5(R2),0             IS TYPE FIELD EMPTY ?                        
         BNE   VR20                                                             
...
VR30     CLI   8(R2),C'E'                                                       
         ...
         B     VR40                                                             
*                                                                               
VR35     CLI   8(R2),C'M'          TYPE M ?                                     
         BE    *+12                                                             
         MVI   ERROR,INVALID       IF NO, ERROR                                 
         B     TRAPERR                                                          
         MVC   ELCODE,MKTSW        YES, PUT ELCODE FOR MARKET                   
         ZIC   R0,MKTSW                                                         
         AHI   R0,1                                                             
         STC   R0,MKTSW                                                         
*                                                                               
...
*                                                                               
         ...
         BE    VRX                 IF LESS IN REBUILT REC -- DIE!               
*                                                                               
...
GETLC20  CLI   8(R2),C'E'          TYPE E ?                                     
         ...
         B     EXIT                                                             
*                                                                               
GETLC40  CLI   8(R2),C'M'          TYPE M ?                                     
         BE    *+6                                                              
         DC    H'0'                SHOULD NOT HAPPEN                            
         MVC   ELCODE,MKTSW        PUT ELCODE FOR MARKET                        
         ZIC   R0,MKTSW                                                         
         AHI   R0,1                                                             
         STC   R0,MKTSW                                                         
         B     EXIT                                                             
...
COMPELEM NTR1                                                                   
         ...
         NI    MKTSW,X'0F'         TURN OFF '6' FOR MKT ELEMS                   
*                                                                               
         ZIC   R0,PRDSW            DECREMENT, FOR PRDSW/ESTSW/MKTSW             
...
*                                                                               
********                                                                        
*  COUNT PRD, EST, AND MKT ELEMS IN UCOM CLT                                    
********                                                                        
*                                                                               
COUNTPEM NTR1                                                                   
         SR    R3,R3               FOR PRD COUNTS                               
         SR    R4,R4               FOR EST COUNTS                               
         SR    R6,R6               FOR MKT COUNTS                               
*                                                                               
         L     R5,AIO              POINT TO CLIENT LEVEL RECORD                 
         LA    R5,24(R5)           FIRST ELEMENT                                
CPEM10   CLI   0(R5),0             END OF RECORD ?                              
         BE    CPEMEND             YES - STORE COUNTS                           
*                                                                               
         CLI   0(R5),X'4A'         PRODUCT ELEM ?                               
         BH    CPEM20              NO - MUST BE ESTIMATE                        
         LA    R3,1(R3)            ADD TO PRD COUNT                             
         B     CPEM30                                                           
*                                                                               
CPEM20   CLI   0(R5),X'5A'         ESTIMATE ELEM ?                              
         BH    CPEM22              NO - MUST BE MARKET                          
         LA    R4,1(R4)            ADD TO EST COUNT                             
         B     CPEM30                                                           
*                                                                               
CPEM22   LA    R6,1(R6)            ADD TO MKT COUNT                             
*                                                                               
CPEM30   ZIC   R0,1(R5)                                                         
         AR    R5,R0               POINT TO NEXT ELEM                           
         B     CPEM10              LOOK FOR MORE ELEMENTS                       
*                                                                               
CPEMEND  DS    0H                                                               
         STC   R3,RPRDCNT          STORE PRD COUNT FOR "LATER"                  
         STC   R4,RESTCNT          STORE EST COUNT FOR "LATER"                  
         STC   R6,RMKTCNT          STORE MKT COUNT FOR "LATER"                  
         XIT1                                                                   
         EJECT                                                                  
*                                                                               
******************************************************************              
...
DRSEL10  CLI   0(R5),X'5E'         ESTIMATE ELEM ?                              
         ...
         B     DRNEXT                                                           
*                                                                               
DRSEL15  CLI   0(R5),X'6E'         MARKET ELEM ?                                
         BH    DRNEXT                                                           
         TM    FLAG,MKTLEV         DO WE WANT MKT?                              
         BO    DRKEEP                                                           
*                                                                               
DRNEXT   ZIC   R0,1(R5)                                                         
         AR    R5,R0                                                            
...
DRKEEP   DS    0H                                                               
         ...
         CLI   SUCMELEM,X'4E'      PRODUCT ELEM ?                               
         BNH   DRK10               YES                                          
         MVI   8(R2),C'E'                                                       
         CLI   SUCMELEM,X'5E'      ESTIMATE ELEM ?                              
         BNH   DRK10               YES                                          
         MVI   8(R2),C'M'          NO, MARKET ELEM                              
*                                                                               
DRK10    BAS   RE,DRKXMIT          SEND 'TYP' & -> TO 'EDT'                     
*                                                                               
         MVC   8(1,R2),SUCMEDIT                                                 
...
DRKNXT   BAS   RE,DRKXMIT                                                       
         B     DRNEXT                                                           
*                                                                               
DRKMORE  DS    0H                  ON PRD, EST, OR MKT LEV                      
...
DCLT20   CLI   0(R5),X'5E'         ESTIMATE ELEM ?                              
         ...
         B     DCLT30                                                           
*                                                                               
DCLT25   CLI   0(R5),X'6E'         MARKET ELEM ?                                
         BH    DCLT30                                                           
         TM    FLAG,MKTLEV         DO WE WANT MKT?                              
         BO    DCLT50                                                           
*                                                                               
...
*                                                                               
DCLT50   DS    0H                                                               
         MVI   8(R2),C'M'          "TYP" FIELD                                  
         CLI   SUCMELEM,X'5E'      MARKET ELEM ?                                
         BH    DCLT52              YES                                          
         MVI   8(R2),C'E'          "TYP" FIELD                                  
         CLI   SUCMELEM,X'4E'      ESTIMATE ELEM ?                              
         BH    DCLT52              YES                                          
         MVI   8(R2),C'P'          NO, PRODUCT ELEM                             
DCLT52   BAS   RE,DRKXMIT          SEND 'TYP' & -> TO 'EDT'                     
*                                                                               
         MVC   8(1,R2),SUCMEDIT                                                 
         BAS   RE,DRKXMIT          SEND 'EDT' GET 'LEN'                         
*                                                                               
...
SETPROS  NTR1                                                                   
         ...
         BO    SETP05                                                           
         MVI   PROSW,C'E'                                                       
         TM    FLAG,ESTLEV         ESTIMATE LEVEL ?                             
         BO    SETP05                                                           
         MVI   PROSW,C'M'                                                       
*                                                                               
SETP05   LA    R4,12               SET BCT COUNT                                
...
*                                                                               
         ...
         USING UCOMHDR,R3                                                       
         MVC   KEY+1(1),UCOMKAGY   AGENCY/MEDIA                                 
         MVC   KEY+2(2),UCOMKCLT   CLIENT                                       
         DROP  R3                                                               
*                                                                               
         GOTO1 HIGH                                                             
...
GAAN10   MVC   AIO,AIO1            RESTORE AIO                                  
         MVC   KEY(L'UCOMKEY),SAVEKEY   RESTORE DIR FOR SEQ READING             
         GOTO1 HIGH                                                             
         GOTO1 GETREC                                                           
*                                                                               
         B     EXIT                                                             
...
*                                                                               
         BAS   RE,GETAAN                                                        
         GOTO1 CLUNPK,DMCB,(CLTAAN,UCOMKCLT),COMCLI                             
         OI    COMCLIH+6,X'80'                                                  
...
*                                                                               
         ...
         MVI   COMPROH+5,2                                                      
*                                                                               
DK40     XC    COMEST,COMEST        CLEAR FIRST                                 
         MVI   COMESTH+5,0                                                      
         OI    COMESTH+6,X'80'      TRANSMIT PRODUCT CODE TO SCREEN             
*                                                                               
         ...
         MVI   COMESTH+5,3                                                      
*                                                                               
DK50     XC    COMMKT,COMMKT        CLEAR FIRST                                 
         MVI   COMMKTH+5,0                                                      
         OI    COMMKTH+6,X'80'      TRANSMIT PRODUCT CODE TO SCREEN             
*                                                                               
         OC    UCOMKMKT,UCOMKMKT                                                
         BZ    DKX                                                              
         EDIT  UCOMKMKT,COMMKT,FILL=0                                           
         OI    COMMKTH+4,X'08'      NUMERIC CODE                                
         MVI   COMMKTH+5,4                                                      
*                                                                               
DKX      B     VK                                                               
         DROP  R3                                                               
...
LR34     OC    COMEST,COMEST     SEE IF ESTIMATE GIVEN                          
         ...
         BNE   LRX                                                              
*                                                                               
LR36     OC    COMMKT,COMMKT     SEE IF MARKET GIVEN                            
         BZ    LR50                                                             
         CLC   KEY+10(2),BMKT                                                   
         BNE   LR20                                                             
*                                                                               
...
*                                                                               
         BAS   RE,GETAAN                                                        
         GOTO1 CLUNPK,DMCB,(CLTAAN,UCOMKCLT),LSTCLT                             
*                                                                               
         MVC   LSTPRD,UCOMKPRD                                                  
*                                                                               
         ...
         UNPK  LSTEST,DUB                                                       
*                                                                               
LR56     OC    UCOMKMKT,UCOMKMKT   MARKET   ?                                   
         BZ    LR60                NO                                           
         EDIT  UCOMKMKT,LSTMKT,FILL=0                                           
*                                                                               
...
NOCLTEST EQU   307                                                              
NOCLTMKT EQU   1                                                                
PREVKEY  EQU   2                   MUST FILL IN PREVIOUS KEY FIELDS             
*                                                                               
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
         ...
         PRINT ON                                                               
         ORG   CONTAGH                                                          
       ++INCLUDE SCSFM68D         MAINT SCREEN                                  
         EJECT                                                                  
         ORG   CONTAGH                                                          
       ++INCLUDE SCSFM69D         LIST SCREEN                                   
         EJECT                                                                  
*                                                                               
UCOMHDRD DSECT                                                                  
       ++INCLUDE SPGENUCOM                                                      
...
LSTMKT   DS    CL4                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029SPSFM5B   03/01/06'                                      
         END                                                                    
