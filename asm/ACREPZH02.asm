*          DATA SET ACREPZH02  AT LEVEL 055 AS OF 08/16/00                      
***********************************************************************         
* $BILL FIX                                                           *         
*   REMOVE WC FROM THE TRANSACTION KEY FOR 1 BYTE OFFICE COMPANY      *         
***********************************************************************         
*PHASE ACZH02A                                                                  
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
...
ACZH02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**ACZH**,R7,R9    BASE REGISTERS 11,9                          
         L     RA,0(R1)                                                         
         USING ACWORKD,RA          RA = A(GLOBAL W/S)                           
         LA    RC,SPACEND                                                       
         USING ACZHD,RC            RC = A(SAVE W/S)                             
         L     R8,VBIGPRNT                                                      
         USING BIGPRNTD,R8                                                      
*                                                                               
         ...
         BE    LDGF                                                             
         CLI   MODE,PROCTRNS       PROCESS TRANSACTION                          
         BE    PTRN                                                             
...
* ACBIGPRINTD                                                                   
       ...
       ++INCLUDE DDREPXTRAD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'055ACREPZH02 08/16/00'                                      
         END                                                                    
