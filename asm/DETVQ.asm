*          DATA SET DETVQ      AT LEVEL 114 AS OF 08/23/00                      
*PHASE DETVQA                                                                   
*INCLUDE PRINT                                                                  
*INCLUDE DEMTIME                                                                
*INCLUDE TIMVAL                                                                 
...
TAPECOPY CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 500,TAPECOPY,=V(REGSAVE),R6                                      
         L     RA,=V(CPRINT)                                                    
         USING DPRINT,RA                                                        
         L     RE,=A(PROGBUFF)                                                  
         L     RF,=F'65000'                                                     
...
*                                                                               
         ...
         BNE   *+8                                                              
         MVI   TBDPT,10                                                         
SYNOK    MVC   0(TBEND-TBSTART,R8),TBSTART                                      
         LA    RF,DPTSTAB                                                       
MATDPT   CLI   0(RF),X'FF'                                                      
         BE    MATDPT4                                                          
         CLC   TBDPT,0(RF)                                                      
         BE    MATDPT4                                                          
         LA    RF,8(RF)                                                         
         B     MATDPT                                                           
MATDPT4  MVC   P+21(3),1(RF)                                                    
*        CLI   TBNET,2             DON'T DEAL WITH CABLE                        
*        BE    ADDUPX                                                           
*                                                                               
*        CLI   TBNET,1             FORCE IQ FOR SYND AND CABLE                  
*        BE    *+8                                                              
...
*        MVC   TBIQ,TBTVQ                                                       
*                                                                               
         L     RF,4(RF)            ACCUMULATE THE DAYPARTS                      
         LA    RE,TBIQ                                                          
         LA    R1,L'TBIQ*2                                                      
ADDUP    ZIC   R9,0(RE)                                                         
         LTR   R9,R9                                                            
...
R13      DC    AL1(R13E-*)                                                      
         ...
         DC    AL1(ISAMP,TSAMP,NULL)                                            
         DC    AL1(IV0611,TV0611,NULL)                                          
         DC    AL1(IV1217,TV1217,NULL)                                          
         DC    AL1(IV0617,TV0617,NULL)                                          
         DC    AL1(IV1234,TV1234,NULL)                                          
         DC    AL1(IV1899,TV1899,NULL)                                          
         DC    AL1(IV1834,TV1834,NULL)                                          
         DC    AL1(IV3549,TV3549,NULL)                                          
         DC    AL1(IV5099,TV5099,NULL)                                          
         DC    AL1(IV1849,TV1849,NULL)                                          
         DC    AL1(IV2554,TV2554,NULL)                                          
         DC    AL1(IV2549,TV2549,NULL)                                          
         DC    AL1(IV3599,TV3599,NULL)                                          
         DC    AL1(IV3564,TV3564,NULL)                                          
         DC    X'FF'                                                            
R13E     DS    0C                                                               
R14      DC    AL1(R14E-*)                                                      
         DC    AL1(1,4)                                                         
...
R21      DC    AL1(R21E-*)                                                      
         DC    AL1(2,1)                                                         
         DC    AL1(PNAM)           PROG NAME                                    
         DC    AL1(IW1899,TW1899,NULL)                                          
         DC    AL1(IW1834,TW1834,NULL)                                          
         DC    AL1(IW3549,TW3549,NULL)                                          
         DC    AL1(IW5099,TW5099,NULL)                                          
         DC    AL1(IW1849,TW1849,NULL)                                          
         DC    AL1(IW2554,TW2554,NULL)                                          
         DC    AL1(IW2549,TW2549,NULL)                                          
         DC    AL1(IW3599,TW3599,NULL)                                          
         DC    AL1(IW3564,TW3564,NULL)                                          
         DC    X'FF'                                                            
R21E     DS    0C                                                               
R22      DC    AL1(R22E-*)                                                      
         DC    AL1(2,2)                                                         
...
R31      DC    AL1(R31E-*)                                                      
         DC    AL1(3,1)                                                         
         DC    AL1(PNAM)           PROG NAME                                    
         DC    AL1(IM1899,TM1899,NULL)                                          
         DC    AL1(IM1834,TM1834,NULL)                                          
         DC    AL1(IM3549,TM3549,NULL)                                          
         DC    AL1(IM5099,TM5099,NULL)                                          
         DC    AL1(IM1849,TM1849,NULL)                                          
         DC    AL1(IM2554,TM2554,NULL)                                          
         DC    AL1(IM2549,TM2549,NULL)                                          
         DC    AL1(IM3599,TM3599,NULL)                                          
         DC    AL1(IM3564,TM3564,NULL)                                          
         DC    X'FF'                                                            
R31E     DS    0C                                                               
R32      DC    AL1(R32E-*)                                                      
         DC    AL1(3,2)                                                         
...
PROGBUF2 DS    100000C                                                          
       ...
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'114DETVQ     08/23/00'                                      
         END                                                                    
