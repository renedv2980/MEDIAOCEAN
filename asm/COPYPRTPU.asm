*          DATA SET COPYPRTPU  AT LEVEL 012 AS OF 08/18/00                      
*PHASE COPYPRTF                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
***********************************************************************         
*                                                                               
*        FOR THIS RUN THE OUTPUT AGENCY IS HARDCODED TO IJ                      
...
*                                                                               
* ONLY INTERESTED IN MEDIA I,M,N,O,T                                            
*                                                                               
         CLI   REC+2,C'I'                                                       
         BNE   GET63A                                                           
         AP    MEDICNT,=P'1'                                                    
...
*                                                                               
GET63E   DS    0H                                                               
         AP    OTHMCNT,=P'1'       MEDIA OTHER THAN I,M,N,O,T                   
...
PUCNT    DC    PL5'0',CL30'AGENCY PU'                                           
NPUCNT   DC    PL5'0',CL30'NOT AGENCY PU'                                       
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012COPYPRTPU 08/18/00'                                      
         END                                                                    
