*          DATA SET PPFIXBUY   AT LEVEL 014 AS OF 05/01/02                      
*PHASE PP0202C,+0,NOAUTO                                                        
*INCLUDE MININAM                                                                
...
BAD      DS    0H                                                               
         ...
         DC    H'0'                                                             
*                                                                               
         GOTO1 HEXOUT,DMCB,KEYSS,P+4,31 =C'N'                                   
         BAS   RE,RPRT                                                          
         MVC   P(25),PBUYREC                                                    
         MVC   P+40(17),PBDSPACE                                                
         BAS   RE,RPRT                                                          
         B     AGYC3                                                            
*                                                                               
USERP    DS    0H                                                               
         B     EXIT                                                             
*                                                                               
*              CODE BELOW CHECKED FOR MISSING COMMENTS ON USERP                 
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(3),QOPT1                                                     
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014PPFIXBUY  05/01/02'                                      
         END                                                                    
