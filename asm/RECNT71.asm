*          DATA SET RECNT71    AT LEVEL 016 AS OF 09/22/10                      
*PHASE T80271A,+0                                                               
*INCLUDE RECONDAT                                                               
*INCLUDE REVALDAT                                                               
         TITLE 'T80271 - REP SAR "ADDS" DISP/EDIT FOR SASP USERS'               
*                                                                               
*******************************************************************             
*                                                                 *             
*        RECNT71 (T80271) --- SAR 'ADDS' DISP/EDIT FOR SASP USERS *             
*                                                                 *             
*  NOTE:  THIS MODULE NEEDS TO BE IN SYNC WITH RECNT70 & REPRO12  *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
*                                                                 *             
* 19APR93 (BU ) --- ORIGINAL ENTRY                                *             
*                                                                 *             
* 14JUN93 (BU ) --- ALL BUDGET $$ NOW MARKET $$                   *             
*                                                                 *             
* 30JUL93 (BU ) --- PROHIBIT BUDGET,SHR GOAL,  FOR TYPE N         *             
*                   CONTRACTS                                     *             
*                                                                 *             
* 03AUG93 (BU ) --- PROHIBIT BUDGET,SHR GOAL,  GEN/ZZ CONTRACTS   *             
*                                                                 *             
* 05AUG93 (BU ) --- INSTALL TRAP FOR EC KEY/ZERO DISK ADDRESS     *             
*                                                                 *             
* 01OCT93 (BU ) --- SWING BASIS FOR FORECAST BUCKETS TO BDCST MNTH*             
*                                                                 *             
* 21OCT93 (BU ) --- KEEP PENNIES FOR FORECAST BUCKETS             *             
*                                                                 *             
* 10JAN94 (BU ) --- ADD 'FORECAST?' FLAG                          *             
*                                                                 *             
* 28APR94 (SKU) --- ADD STATION BUDGET FIELD                      *             
*                                                                 *             
* 06MAY94 (BU ) --- FIX 'N' TYPE BUDGET ENTRY PROBLEM             *             
*                                                                 *             
* 17MAY94 (BU ) --- FIX 'GEN/ZZ' BUDGET ENTRY PROBLEM.            *             
*                   FIX MARKET BUDGET DIVISION                    *             
*                                                                 *             
* 06JUN94 (SKU) --- FIX STATION BUDGET 100% BUG                   *             
*                                                                 *             
* 09DEC94 (SKU) --- FIX DISPLAY BUGS                              *             
*                                                                 *             
* 04APR95 (BU ) --- REQUIRE NON-ZERO BUDGET/SHARE GOAL VALUES     *             
*                                                                 *             
* 18JUL95 (SKU) --- FIX DEM/BOOK DR VALIDATION BUG                *             
*                                                                 *             
* 12DEC95 (SKU) --- 2K CONTRACT SUPPORT                           *             
*                                                                 *             
* 07MAR96 (JRD) --- PROPOSAL SYSTEM SUPPORT                       *             
*                                                                 *             
...
*                                                                 *             
* 31MAY96 (SKU) --- ADD PP (PAID PROGRAMMING)                     *             
*                                                                 *             
...
*                                                                 *             
* 12FEB97 (SKU) --- SUPPORT SPECIAL BOOK TYPES                    *             
*                                                                 *             
* 23JUL97 (SKU) --- 4K CONTRACT SUPPORT                           *             
*                                                                 *             
* 20AUG98 (SKU) --- REFINE CHECK FOR ADV GEN                      *             
*                                                                 *             
* 22SEP04 (HQ ) --- HANDLE BIG SINGLE DAY BUDGET AMOUNT           *             
*                                                                 *             
* 22SEP10 (SKU) --- SKIP CHECK FOR CON PROF 4 IF RCU              *             
*                   **  END TOMBSTONE  **                         *             
*******************************************************************             
*                                                                               
T80271   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T80271,R9,RR=R5                                                
         L     RC,0(R1)                                                         
         USING GENOLD,RC                                                        
         USING TWAD,RA                                                          
         ST    R5,TEMP                                                          
...
*          DATA SET RECNT45A   AT LEVEL 090 AS OF 03/07/96                      
         L     RE,ACOMFACS                                                      
         USING COMFACSD,RE                                                      
...
*                                                                               
         ...
         USING RSARXEL,R6                                                       
*                                                                               
         OI    ADSSBUDH+6,X'80'    TRANSMIT                                     
         TM    RSARXFL2,X'80'      'BONUS' BUDGET?                              
         BZ    *+14                NO                                           
         MVC   ADSSBUD,=CL8'BONUS'                                              
         B     DSAR0020                                                         
         TM    RSARXFL2,X'40'      'TRADE' BUDGET?                              
         BZ    *+14                NO                                           
         MVC   ADSSBUD,=CL8'TRADE'                                              
         B     DSAR0020                                                         
         ...
         BZ    *+14                NO                                           
         MVC   ADSSBUD,=CL8'GEN AVL'                                            
         B     DSAR0020                                                         
*                                                                               
         LA    R8,ADSSBUD          ADDRESS OF BUDGET FIELD                      
...
*                                                                               
         ...
         D     RE,WORK                                                          
         LR    R2,RF                                                            
         EDIT  (R2),(8,ADSSTBD),ALIGN=LEFT                                      
         B     DSAR0020                                                         
DSAR0018 EQU   *                                                                
         TM    RSARXFLG,X'20'      SHARE GOAL ENTERED AS ZERO?                  
         BNO   DSAR0020            NO                                           
         MVI   ADSSGOL,C'0'        YES - SEND BACK A ZERO                       
         MVI   ADSSTBD,C'0'        STATION BUDGET MUST BE ZERO, TOO             
DSAR0020 EQU   *                                                                
         CLI   RSARXLEN,120        OLD OR NEW ELEMENT?                          
         BNH   DSAR0030            OLD - NEXT FIELD DOESN'T EXIST               
         OC    RSARXLAD,RSARXLAD   ANY LAST ACTIVITY DATE?                      
         BZ    DSAR0030            NO                                           
         GOTO1 DATCON,DMCB,(3,RSARXLAD),(5,ADSSACT)                             
*                                  DISPLAY LAST ACTIVITY DATE                   
         LA    R2,ADSSACTH         SET TRANSMIT FOR THIS FIELD                  
         FOUT  (R2)                                                             
DSAR0030 EQU   *                                                                
         EJECT                                                                  
*********************                                                           
...
**       BNZ   *+6                                                              
**       DC    H'0'                SOME UPLOADS DON'T HAVE DPTS                 
         EJECT                                                                  
*************************                                                       
** DISPLAY BOOKS FIELD **                                                       
*************************                                                       
DSARBK   CLC   RSARXBKS(2),=C'DR'                                               
         BNE   DSARBK05                                                         
         MVC   ADSSBUX,MYSPACES                                                 
         MVC   ADSSBUX(2),=C'DR'                                                
         MVC   ADSSDEM,MYSPACES                                                 
         B     DSARBKX                                                          
*                                                                               
...
DSARDP10 DS    0H                                                               
         ...
         EDIT  (B4,1(R4)),(L'ADSSCPP,0(R3)),2,ALIGN=LEFT                        
         LA    R2,ADSSNDP-ADSSDPT(R2)                                           
         LA    R3,ADSSNCP-ADSSCPP(R3)                                           
         LA    R4,L'SAVDPT(R4)                                                  
         BCT   RE,DSARDP10                                                      
*                                                                               
DSARDPX  DS    0H                                                               
...
DSAR0230 MVI   WORK3,C' '                                                       
         ...
         MVC   8(0,R2),WORK3                                                    
*                                                                               
         LA    R2,ADSSCM2H-ADSSCM1H(R2)      NEXT COMMENT                       
         LA    R0,ADSSLCMH                   LAST COMMENT ON SCREEN             
         CR    R2,R0                         PAST IT?                           
         BH    *+12                          YES - ALL DONE                     
...
DSAR0240 EQU   *                                                                
         LA    R2,ADSSBUDH         SET CURSOR POSITION                          
...
*                                                                               
         ...
         LA    RF,480                                                           
         XCEFL                                                                  
         MVC   BYTE,ADSSBUXH+5     INPUT LENGTH                                 
*                                                                               
         GOTO1 VPARSNIP,DMCB,(BYTE,ADSSBUX),(16,RBUYREC),('PSNAOKQ',0)          
         CLI   8(R1),0                                                          
         BNE   EXITNV              1 BOOK REQ'D                                 
*                                                                               
         MVI   BYTE,0                                                           
...
** EDIT DEMOS **                                                                
****************                                                                
ESARDM   LA    R2,ADSSDEMH         EDIT DEMOS                                   
         CLC   =C'DR',SAVBOOKS+2                                                
         BNE   ESARDM05                                                         
         CLI   5(R2),0                                                          
         BNE   EXITNV                                                           
...
*                                     IGNORE NEXT TESTS                         
         ...
         CLI   ADSSTBDH+5,0        EITHER MARKET BUDGET OR STATION              
...
**********************************                                              
         ...
         EX    RE,*+8                                                           
         B     *+10                                                             
         CLC   ADSSBUD(0),=CL8'BONUS'                                           
         BE    ESAR0024                                                         
*                                                                               
         EX    RE,*+8                                                           
         B     *+10                                                             
         CLC   ADSSBUD(0),=CL8'TRADE'                                           
         BE    ESAR0022                                                         
*                                                                               
         EX    RE,*+8                                                           
         B     *+10                                                             
         CLC   ADSSBUD(0),=CL8'ORDER'                                           
         BE    ESAR0026                                                         
*                                                                               
         EX    RE,*+8                                                           
         B     *+10                                                             
         CLC   ADSSBUD(0),=CL8'DR'                                              
         BE    ESAR0021                                                         
*                                                                               
         EX    RE,*+8                                                           
         B     *+10                                                             
         CLC   ADSSBUD(0),=CL8'GEN AVL'                                         
         BE    ESAR0028                                                         
*                                                                               
         EX    RE,*+8                                                           
         B     *+10                                                             
         CLC   ADSSBUD(0),=CL8'PP'                                              
         BNE   EXITNV                                                           
*                                                                               
         OI    RSARXFL2,X'08'      PP BUDGET                                    
         B     ESAR0090                                                         
*                                                                               
ESAR0021 OI    RSARXFL2,X'20'      DR BUDGET                                    
         B     ESAR0090                                                         
*                                                                               
ESAR0022 OI    RSARXFL2,X'40'      TRADE BUDGET                                 
         B     ESAR0090                                                         
*                                                                               
...
ESAR0060 EQU   *                                                                
         LA    R2,ADSSGOLH         SHARE GOAL FIELD                             
         CLI   RCONTYPE,C'N'       CONTRACT TYPE = N?                           
...
ESAR0072 EQU   *                                                                
         ...
         CLI   ADSSBUDH+5,0        CALCULATE MARKET BUDGET IF                   
...
ESARDP5  CLI   0(R7),C' '              ANY INPUT ON THIS LINE?                  
         BH    ESARDP10                                                         
         LA    R0,ADSSLDP              ARE WE ON THE LAST DPT LINE?             
         CR    R7,R0                                                            
...
*                                                                               
         ...
         LA    R5,L'SAVDPT(R5)                                                  
ESARDP60 LA    R2,ADSSNDPH-ADSSDPTH(R2)    NEXT FIELD                           
         LA    R7,ADSSNDP-ADSSDPT(R7)                                           
         LA    R0,ADSSLDP                  PAST LAST DPT FIELD?                 
         CR    R7,R0                                                            
...
ESARCP10 DS    0H                                                               
         ...
         BNH   *+8                                                              
         LA    R4,L'SAVDPT(R4)                                                  
         LA    R2,ADSSNCPH-ADSSCPPH(R2)    NEXT FIELD                           
         LA    R3,ADSSNDPH-ADSSDPTH(R3)                                         
         LA    R0,ADSSLCPH                 PAST LAST CPP FIELD?                 
         CR    R2,R0                                                            
...
*                                                                               
         ...
         XC    ADSSTBD,ADSSTBD     FORCE STATION BUDGET TO ZERO                 
         MVI   ADSSTBD,C'0'        SINCE SHARE GOAL IS 0%                       
         MVI   ADSSTBDH+5,1                                                     
         OI    ADSSTBDH+6,X'80'    XMIT                                         
         B     VALSTBX                                                          
...
*        SLDA  RE,1                DOUBLE FOR ROUNDING                          
         ...
         MVC   WORK+8(8),DUB       USE FIRST 16 BYTE OF WORK AREA               
*                                                                               
         CVD   R2,DUB              CONVERT TO PACK                              
         AP    WORK(16),DUB                                                     
*        AR    RF,R2               ADD TOTDAYS FOR ROUNDING                     
*                                                                               
*        DR    RE,R2               DIVIDE BY TOTDAYS                            
         DP    WORK(16),DUB(8)                                                  
         MVC   WORK+8(8),WORK      ONLY CARE ABOUT QUOTIENT                     
         XC    WORK(8),WORK                                                     
*                                                                               
*        SRA   RF,1                DIVIDE BY 2                                  
         DP    WORK(16),=PL8'2'                                                 
         MVC   DUB,WORK            MOVE FOR DOUBLE WORD BOUNDRY                 
         CVB   RF,DUB              CONVERT PACK TO BINARY                       
*                                                                               
...
*                                                                               
         ...
         EJECT                                                                  
*                                                                               
*   SEE IF BUYS OR SPL EXIST FOR CONTRACT.  IF SO, PREVENT FORECAST?            
*     = Y ENTRY.                                                                
*                                                                               
         DS    0F                                                               
FCSTNOGD NMOD1 0,*FNOG*                                                         
         L     RC,0(R1)            RELOAD A(WORKSPACE)                          
         LA    R6,RCONELEM         A(1ST ELEMENT)                               
FNOG0010 EQU   *                                                                
         ZIC   RF,1(R6)            BUMP TO NEXT ELEMENT                         
         AR    R6,RF                                                            
         CLI   0(R6),0             END OF RECORD?                               
         BE    FNOG0090            YES - EXIT                                   
         CLI   0(R6),3             BOOKED ELEMENT?                              
         BE    FNOG0080            YES - DON'T PERMIT Y                         
         CLI   0(R6),4             BILLED ELEMENT?                              
         BE    FNOG0080            YES - DON'T PERMIT Y                         
         CLI   0(R6),6             SPL    ELEMENT?                              
         BE    FNOG0080            YES - DON'T PERMIT Y                         
         B     FNOG0010            GO BACK FOR NEXT                             
FNOG0080 EQU   *                                                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016RECNT71   09/22/10'                                      
         END                                                                    
**************************************************************                  
*                                                                               
*   SET 'FORECAST?' FLAG ON SCREEN.  EXAMINE BIT IN RSARXFLG.  IF YES           
*     DISPLAY AS NO IF BUYS OR SPL ENTERED.                                     
*                                                                               
         DS    0F                                                               
FORECAST NMOD1 0,*FCST*                                                         
         L     RC,0(R1)            RELOAD A(WORKSPACE)                          
         L     R6,4(R1)            RELOAD A(SAR ELEMENT)                        
         USING RSARXEL,R6                                                       
         MVI   ADSSFCS,C'N'        SET SCREEN FIELD TO NO                       
         TM    RSARXFLG,X'10'      FORECAST? SET TO YES?                        
         BNO   FCAS0090            NO  - EXIT                                   
*                                                                               
         DROP  R6                                                               
*                                                                               
         MVI   ADSSFCS,C'Y'        YES - SET SCREEN FIELD YES                   
         LA    R6,RCONELEM         A(1ST ELEMENT)                               
FCAS0010 EQU   *                                                                
         ZIC   RF,1(R6)            BUMP TO NEXT ELEMENT                         
         AR    R6,RF                                                            
         CLI   0(R6),0             END OF RECORD?                               
         BE    FCAS0090            YES - EXIT                                   
         CLI   0(R6),3             BOOKED ELEMENT?                              
         BE    FCAS0080            YES - CHANGE FORECAST? TO NO                 
         CLI   0(R6),4             BILLED ELEMENT?                              
         BE    FCAS0080            YES - CHANGE FORECAST? TO NO                 
         CLI   0(R6),6             SPL    ELEMENT?                              
         BE    FCAS0080            YES - CHANGE FORECAST? TO NO                 
         B     FCAS0010            GO BACK FOR NEXT                             
FCAS0080 EQU   *                                                                
         MVI   ADSSFCS,C'N'        SET SCREEN FIELD TO NO                       
FCAS0090 EQU   *                                                                
         LA    R2,ADSSFCSH                                                      
