*          DATA SET NEWRI90    AT LEVEL 191 AS OF 02/19/15                      
*PHASE T32090A                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*                                                                               
...
INIT10   OC    HDTITLE,HDTITLE     WAS THERE A TITLE OVERRIDE?                  
         BZ    INIT11                                                           
         B     *+10                                                             
INIT11   MVC   HDTITLE(22),=C'CHANGE ANALYSIS REPORT'                           
         OC    HDTITLE,SPACES                                                   
...
* - SORT KEY FIELDS                                                             
         ...
         MVC   SRPROD,NHPROD3      ALPHA PRODS                                  
         MVC   SRTKPROD,NHPROD3    SET ALPHA PROD                               
         CLI   NHPROD3,X'40'       DO WE HAVE ALPHA PROD?                       
         BH    NOPRDBRK            YES                                          
...
* - SORT DATA FIELDS                                                            
         ...
         MVI   SRCOST,C'0'         YES                                          
HASCOST  DS    0H                                                               
         MVC   SRPROD,NHPROD3     ALPHA PROD                                    
         CLI   NHPROD3,X'40'                                                    
         BH    HASALPHA                                                         
         MVC   SRPROD,NNHOPRD      PRODUCT                                      
         MVC   SRTAMC,SAVAMC       SET AGY/MED/CLT - NEED FOR GETPRD            
         BAS   RE,GETPRD                                                        
         XC    SRPROD,SRPROD                                                    
         MVC   SRPROD(3),WORK                                                   
HASALPHA DS    0H                                                               
...
WRT35    DS    0H                                                               
         ...
         CLI   SRREASON,C'X'       IF REASON=X                                  
         BE    WRTNXT              SKIP THIS LINE                               
...
MOV22    ZIC   R1,NCHGLEN         ..GET LENGTH                                  
         ...
         CLI   NCHGFCOD,C'B'       IF BRAND                                     
         BNE   MOVX                                                             
         TM    NCHGSTAT,X'04'      PASSING ALPHA PROD?                          
         BO    MOVX                YES                                          
         LR    R4,RE               RE -> R4                                     
         BAS   RE,GETPRD                                                        
         MVC   0(3,R4),WORK                                                     
...
***      DC    H'0'                MUST BE THERE                                
         BNE   FLT5NX              IF NO UNIT FOR HISTORY-REJECT HIST           
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'191NEWRI90   02/19/15'                                      
         END                                                                    
