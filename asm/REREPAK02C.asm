*          DATA SET REREPAK02C AT LEVEL 203 AS OF 05/01/02                      
*PHASE REAK02C,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
*                                                                               
         L     R4,AEDIR11                                                       
         LA    R4,27(R4)           REUSE FIRST AREA: LEAVE KEY                  
...
*                                                                               
         ...
         MVCL  R4,R6               CLEAR KATZ BUILD RECORD AREA2                
*                                                                               
         LA    R3,AEDIR11          BUILD BUYS IN EDIREC11                       
         USING DAKDTAIL,R3                                                      
...
*                                                                               
         LR    RF,RC               SET A(EDIREC11/12/13/14)                     
         A     RF,=A(EDIREC11-FILED)                                            
         ST    RF,AEDIR11          SAVE ADDRESS                                 
         A     RF,=F'529'          BUMP TO A(EDIREC12)                          
...
*                                                                               
       ...
       ++INCLUDE DRKZEDIAKD                                                     
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'203REREPAK02C05/01/02'                                      
         END                                                                    
