*          DATA SET CTFIL10    AT LEVEL 040 AS OF 07/17/03                      
*&&      SET   NOP=N                                                            
*PHASE TA1310A                                                                  
         TITLE 'OBJECT VERSION OF FIELD RECORDS'                                
FIL10    CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,CTFIL10*,R6,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
         L     R8,AGWORK                                                        
         USING GWORKD,R8                                                        
...
X        USING FDRRECD,R3                                                       
         ...
         MVC   FDRKCTRY,X.FDRKCTRY                                              
         MVC   FDRKSUB,X.FDRKSUB                                                
...
DLOAD    LM    R0,R3,SVPARMS                                                    
         ...
         B     ITER                ITERATE KEY TABLE                            
*                                                                               
DLOTABL  DC    AL1(DPQINIT,0,0,0),AL4(PQINIT)                                   
         DC    AL1(DLDO,0,0,0),AL4(EXITH)                                       
         DC    AL1(DSCREEN,0,0,0),AL4(EXITH)                                    
         DC    AL1(DAPPCOL,0,0,0),AL4(APPCOL)                                   
         DC    AL1(DAPPFLT,0,0,0),AL4(APPFLT)                                   
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
* INITIALISE FAREPBLK                                                 *         
...
***********************************************************************         
         SPACE 1                                                                
APPCOL   LA    RF,CLMDWN                                                        
         XC    LSVARNUM,LSVARNUM                                                
         LA    R1,LSVARCLM                                                      
         USING DCTABD,R1                                                        
*                                                                               
DCLM02   XC    0(DCTABL,R1),0(R1)  CLEAR COLUMN ENTRY                           
...
*                                                                               
         ...
         LH    RE,LSVARNUM                                                      
         LA    RE,1(RE)                                                         
         STH   RE,LSVARNUM         INCREMENT NUMBER OF FIXED COLUMNS            
*                                                                               
         LA    R1,DCTABL(R1)                                                    
         LA    RF,3(RF)                                                         
         B     DCLM02                                                           
*                                                                               
DCLM04   XC    0(DCTABL,R1),0(R1)                                               
         B     EXITOK                                                           
*                                                                               
CLMDWN   DC    AL2(00001),AL1(0)                                                
         DC    AL2(00002),AL1(0)                                                
         DC    AL2(00003),AL1(0)                                                
         DC    AL2(00004),AL1(0)                                                
         DC    AL2(EOT)                                                         
...
DATA04   CLC   KNOWID,=AL2(EOT)    REACH END - NOT A KNOWN DATA TYPE            
         ...
         B     DATA04                                                           
*                                                                               
DATA06   ICM   R7,15,KNOWADD       A(KNOWN OBJECT)                              
         A     R7,BORELO           RELOCATE IT                                  
*                                                                               
...
KNOWTAB  DC    AL2(00001),AL4(SYSDTA)    SYSTEM                                 
         ...
         DC    AL2(00067),AL4(TOLDTA)    TAG OVERRIDE                           
...
LISTABL  DC    AL1(LGETFRST),AL1(0,0,0),AL4(FLST)                               
         ...
         DC    AL1(LTSARTSA),AL1(0,0,0),AL4(TFLT)                               
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
* FIRST FOR LIST                                                      *         
...
NLST02   CLC   IOKEY(FDRKSYS-FDRRECD),THIS.FDRRECD                              
         ...
         SPACE 2                                                                
***********************************************************************         
* FILTERING TE ST FOR DOWNLOAD                                        *         
***********************************************************************         
         SPACE 1                                                                
TFLT     CLI   CSACT,A#LST                                                      
         BE    EXITOK                                                           
         L     RF,AIOREC                                                        
         CLI   FDRKSYS-FDRRECD(RF),X'0A'                                        
         BNE   EXITL                                                            
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
...
*                                                                               
       ++INCLUDE FACTRYTAB                                                      
         EJECT                                                                  
***********************************************************************         
* DATA OBJECTS FOR EACH OF THE FIELDS ARE HERE OFF R7 FOR ADDRESSING  *         
***********************************************************************         
         SPACE 1                                                                
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* DATA OBJECT FOR TAG OVERRIDE LENGTH                                 *         
*                                                                     *         
* R1 HOLDS EQUATED VERB                                               *         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                 *         
***********************************************************************         
         ...
         DS    0H                                                               
         USING *,R7                                                             
TOLDTA   LA    RF,TOLTBL           TABLE OF KNOWN VERBS                         
         B     ITER                ITERATE TABLE                                
*                                                                               
TOLTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISTOL)                                 
         DC    AL1(DVAL),AL1(0,0,0),AL4(VALTOL)                                 
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
* DISPLAY A TAG OVERRIDE FIELD                                        *         
***********************************************************************         
         SPACE 1                                                                
DISTOL   ICM   R3,15,AFLTRL        FLTRL?                                       
         BZ    EXITOK                                                           
         CLI   FDRFTOL,0                                                        
         BE    EXITOK                                                           
         CURED FDRFTOL,(5,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT                      
         B     EXITOK                                                           
         SPACE 1                                                                
***********************************************************************         
* VALIDATE A TAG OVERRIDE FIELD                                       *         
***********************************************************************         
         SPACE 1                                                                
VALTOL   ICM   R3,15,AFLTRL        FLTRL?                                       
         BNZ   *+16                                                             
         CLI   FVILEN,0                                                         
         BE    EXITOK                                                           
         B     EXITNV                                                           
...
DISHLP   LTR   R3,R3               FDREL?                                       
         BZ    EXITOK                                                           
         CURED FDRHLP,(3,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT                       
         B     EXITOK                                                           
         SPACE 1                                                                
***********************************************************************         
...
*                                                                               
         ...
         ICM   R3,15,AFLTRL                                                     
         BZ    EXITOK                                                           
         STCM  RF,1,FDRHLP         COPY TO FLTRL                                
         B     EXITOK                                                           
*                                                                               
         LTORG                                                                  
         EJECT                                                                  
...
*        FACTRYEQUS                                                             
       ...
       ++INCLUDE FACTRYEQUS                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'040CTFIL10   07/17/03'                                      
         END                                                                    
