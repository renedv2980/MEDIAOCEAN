*          DATA SET NEWRIC9    AT LEVEL 009 AS OF 11/08/95                      
*PHASE T320C9A,*                                                                
         TITLE 'T320C9-EDIT FOR NETWORK INTERFACE TAPE'                         
T320C9   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**NEC9**,RR=R2                                                 
         L     RC,0(R1)                                                         
...
*                                  ANETWS4 FOR 3000  IS FREE                    
         EJECT                                                                  
*HIPO******************************************************************         
*  TITLE: NEMEDPX (T320PZ) NETWORK INTERFACE TAPE                    *          
*                                                                     *         
...
PRDHD    DSECT                                                                  
       ...
       ++INCLUDE SPGENCLT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009NEWRIC9   11/08/95'                                      
         END                                                                    
