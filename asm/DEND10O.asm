*          DATA SET DEND10O    AT LEVEL 052 AS OF 07/11/16                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEND10OA                                                                 
*INCLUDE DEBKUPDT                                                               
         TITLE 'OUTPUT PHASE FOR DEND10O NTI CNV'                               
DEND10O  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         NMOD1 NTIWRKX-NTIWRKD,DEND10O,R7                                       
...
*                                                                               
         ...
         CLI   INTRTYP,PMCODEQU    TEST FOR NETWORK PROGRAM RECORD (Q)          
         BNE   CNV100                                                           
*   READ THE SAME WEEK Q RECORD TO SEE IF IT WAS ALREADY ADDED                  
*   WE HAVE TO MERGE THE DAYWK BIT                                              
*                                  ************* -Q- ONLY ***********           
         MVC   THISSQH,INTSQH                                                   
         MVC   THISDW,INTDAYWK                                                  
...
ADDBUFFX B     CNVX                                                             
         EJECT                                                                  
*                                                                               
* ARE THE QRECORDS THE SAME DAY                                                 
* INPUT DMCB(4)  Q RECORD 1                                                     
*       DMCB(8)  1 RECORD 2                                                     
QSAMEDAY NTR1                                                                   
         L     R6,DMCB                                                          
         MVC   DATADISP,=H'23'                                                  
...
*        (BH)                       STILL IN DOUBT                              
PKEY46   MVC   SVAOREC,AOREC       SAVE THE OUTPUT RECORD ADDRESS               
         LA    RE,IOAREA                                                        
...
* SAME PROGRAM NUMBER FOUND ON FILE                                             
PKEY50   DS    0C                                                               
         MVI   ADDCHA,C'C'         CHANGE - PUT CORRECTION RECORD               
...
* IF THE CORRECTION IS SAME DAY AS FILE THAN REPLACE ELSE                       
* PUT OLD RECORDS OUT IF DIFFERENT DAY                                          
         B     PKEYX                                                            
****     B     PKEY46                                                           
*                                                                               
...
*       (BH)                       STILL IN DOUBT                               
QKEY46   MVC   SVAOREC,AOREC       SAVE THE OUTPUT RECORD ADDRESS               
         LA    RE,IOAREA                                                        
         ST    RE,AOREC            PUT OUT OLD RECORD                           
         GOTO1 APUTTAPE                                                         
         BAS   RE,SVFLDS           SAVE  BOOK AND STATION                       
...
*                                                                               
         ...
         STCM  RE,15,DMCB+4                                                     
         BAS   RE,QSAMEDAY                                                      
         BE    QKEY56              SAME DAY- CORRECTION                         
         B     QKEY46              ELSE DIFFERENT DAY = MERGE                   
*                                                                               
*                                                                               
QKEY56   MVI   ADDCHA,C'C'         CHANGE - PUT CORRECTION RECORD               
         BAS   RE,UPDATE           FLAG NETWORK PROGRAM TYPE ELEMENT            
         GOTO1 APUTTAPE                                                         
         BAS   RE,SVFLDS           SAVE  BOOK AND STATION                       
         CLI   TAPE,C'D'           BYPASS FOR DAILIES                           
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE DBUPARMSD                                                      
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'052DEND10O   07/11/16'                                      
         END                                                                    
