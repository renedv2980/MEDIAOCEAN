*          DATA SET REROIRC0   AT LEVEL 180 AS OF 09/05/13                      
*PHASE REROIR0A,*                                                               
*INCLUDE STXITER                                                                
*INCLUDE DATCON                                                                 
*INCLUDE DATVAL                                                                 
...
*                                                                   *           
* SEP08/00 (BU ) --- SKIP RECORDS WHICH ARE > 3659 UNTIL FURTHER    *           
*                    NOTICE                                         *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
...
*                                                                               
         ...
         BE    IPT200              YES                                          
*                                                                               
*   TEST FOR RECORD SIZE, TO SKIP RECORDS LARGER THAN THOSE WHICH               
*        CAN BE HANDLED BY WRKERFILE                                            
*                                                                               
         CLC   WRKREC(2),=X'E09'   EXCEEDS MAX SIZE = 3659?                     
         BH    IPT200              YES - SKIP FILE WRITE                        
*                                                                               
...
*                                                                               
       ...
       ++INCLUDE DMWRKRD                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'180REROIRC0  09/05/13'                                      
         END                                                                    
