*          DATA SET RERMP0BS   AT LEVEL 064 AS OF 05/01/02                      
*PHASE T8100BA,*                                                                
...
*                                                                               
         ...
         MVC   RINVKSTA,CSTAT                                                   
*                                                                               
         MVI   RINVKSRC,C'M'       ASSUME MARKET TEXT WANTED                    
*                                                                               
...
MA020    GOTO1 SEQ                                                              
*                                                                               
MA030    CLC   KEYSAVE(25),KEY     SKIP IF NO RECORD TYPE BREAK                 
         BE    MA040                                                            
*                                                                               
         CLC   KEYSAVE(24),KEY     DONE ON STATION BREAK                        
         BNE   MA090                                                            
*                                                                               
         CLI   TITTYP,C'S'                                                      
...
*                                                                               
         CLC   KEY(24),KEYSAVE     DONE ON INVENTORY BREAK                      
         BNE   DE999                                                            
*                                                                               
...
*                                                                               
         LA    RF,23               ..TRACKS:  THRU EFF. START DATE              
*                                                                               
         MVI   RINVKSRC,X'01'       IN ORDER TO BYPASS MASTER                   
*                                                                               
         TM    DELBYTE,DELINVQ     OKAY IF DELETING INVENTORY                   
         BO    DE035                                                            
*                                                                               
         LA    RF,24               ..TEXT: THRU X'FF' INDICATOR                 
         MVI   RINVKSRC,X'FF'                                                   
*                                  DELETING TEXT                                
...
*                                                                               
         ...
         BNE   DE999               DONE                                         
*                                                                               
         CLI   RINVKSRC,X'FF'      SKIP IF TEXT RECORD                          
         BE    DE150                                                            
*                                                                               
         CLI   RINVKSRC,C'Z'       SKIP IF RATE RECORD                          
         BE    DE150                                                            
*                                                                               
*        TRANSLATE KSRC                                                         
*                                                                               
...
DE070    GOTO1 GETREC                                                           
*                                                                               
         CLI   GSORSVC,C'N'        IF NSI SERVICE                               
         BNE   *+14                                                             
         MVC   DUB(3),=C'NSI'      NSI INV DATA                                 
         B     DE120                                                            
*                                                                               
         CLI   GSORSVC,C'M'        IF MFX SERVICE                               
         BNE   *+14                                                             
         MVC   DUB(3),=C'MFX'      MFX INV DATA                                 
         B     DE120                                                            
*                                                                               
         MVC   DUB(3),=C'SRC'      SRC INV DATA                                 
*                                                                               
...
DE145    DS    0H                                                               
*                                                                               
         CLC   GSOBKTYP,3(RF)      MATCH ON BOOK TYPE                           
         BNE   DE146                                                            
*                                                                               
         MVC   HALF(1),GSOBITS     COPY BOOKVAL BITS FOR THIS INV REC           
...
*                                                                               
DE170    MVC   PL1+74(9),=C'INVENTORY' FORMAT INV BOOK                          
...
STACK    CSECT                                                                  
         DC    5000X'00'                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'064RERMP0BS  05/01/02'                                      
         END                                                                    
