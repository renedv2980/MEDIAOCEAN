*          DATA SET GEKWX01    AT LEVEL 016 AS OF 05/01/02                      
*PHASE TF2001A,+0                                                               
...
T025     CLI   FXNUM,0             RETENTION ON FORMAT BOOKS DEFAULTS           
         BNE   T028                TO 2000 AND ON MESSAGE BOOKS TO 1            
         MVI   FXNUM,C'X'                                                       
         MVC   NUM,=H'1'           EFFECTIVE 1/17/85                            
         CLI   SAVMODE,FORMAT                                                   
         BNE   T028                                                             
****>>>  MVC   NUM,=H'2000'        EFFECTIVE 24FEB93                            
         MVC   NUM,=H'1000'        EFFECTIVE 21JUL95                            
*                                                                               
...
* GEKWXDSECT                                                                    
       ...
       ++INCLUDE GEKWXDSECT                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016GEKWX01   05/01/02'                                      
         END                                                                    
