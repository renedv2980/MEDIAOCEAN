*          DATA SET REREP8A02  AT LEVEL 025 AS OF 05/01/02                      
*PHASE RE8A02A,*                                                                
*INCLUDE CENTER                                                                 
*INCLUDE SCANNER                                                                
...
ACT2L    MVC   RCDATE,SVRCDATE     USE ORIGINAL RCDATE                          
         ...
         SPACE                                                                  
ACT3     EQU   *                                                                
**       MVC   P+1(11),=C'QSTART/END='                                          
**       MVC   P+12(12),QSTART                                                  
**       GOTO1 REPORT                                                           
         CLC   QEND,SPACES         GENERATE A MONDAY-SUNDAY WEEK IF             
         BE    ACT5                ONLY A START DATE IS GIVEN                   
         GOTO1 DATCON,DMCB,(0,QSTART),(2,WORK)                                  
         GOTO1 DATCON,DMCB,(0,QEND),(2,WORK+2)                                  
         CLC   WORK,WORK+2         BLOW UP IF REPORT PERIOD IS                  
...
ACT10    GOTO1 ADDAY,DMCB,QEND,DUB,1                                            
         ...
         SPACE                                                                  
ACT12    EQU   *                                                                
**       MVC   P+1(10),=C'START/END='                                           
**       MVC   P+11(03),START                                                   
**       MVC   P+15(03),END                                                     
         GOTO1 REPORT                                                           
         MVC   QEND,SPACES         DUMMY THE REPORT START DATE TO               
...
* WORKD AND FILE DSECTS                                                         
       ...
       ++INCLUDE REREPMODES                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025REREP8A02 05/01/02'                                      
         END                                                                    
