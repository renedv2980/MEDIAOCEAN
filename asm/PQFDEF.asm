*          DATA SET PQFDEF     AT LEVEL 002 AS OF 04/13/20                      
*PHASE PQFDEFA                                                                  
*INCLUDE DMDMGRL                                                                
*INCLUDE ADDAY                                                                  
*INCLUDE CARDS                                                                  
...
CPYPQ3B  TM    INPUT,DISK          TEST IF HIDDEN <ARC=CARD...>                 
         ...
         CLC   0(8,RF),ARCLINE     IS FIRST LINE <ARC=AG,.....>                 
         BNE   CPYPQ4              NO                                           
...
PRTPQ1A  MVC   SAVE(32),QLINDEX    SAVE INDEX ENTRY                             
         ...
         LH    R1,=H'14336'                                                     
         MOVE  ((RF),(R1)),(RE)                                                 
         MVI   NXFLAG,UKFLDAT+UKFLDSW  X'C0' SWITCH TO/PASS BACK DATA           
         GOTO1 VDATAMGR,DMCB,(X'20',=C'SEQ'),PRTQID,INDEX,(R3),(R5)             
         CLI   8(R1),0                                                          
...
PRTPQ3B  GOTO1 =V(PRINTER)                                                      
         ...
         MVC   HALF,PQDATEL                                                     
         TM    PQTYP1,PQTYNCD      SET HALF TO CMPRSD NEW DATE                  
         BO    *+8                                                              
         NI    HALF,X'7F'                                                       
         GOTO1 =V(DATCON),DMCB,(14,HALF),(5,P+19)                               
*&&UK*&& OI    P+19,C'0'                                                        
         GOTO1 =V(PRINTER)                                                      
         LA    R7,16(R7)                                                        
...
PRTPQ4   CLI   ARCMODE,0           ARCHIVING REPORT                             
         ...
         CLC   0(8,RE),ARCLINE     IS FIRST LINE <ARC=AG,.....>                 
         BNE   PRTPQ4A                                                          
...
*                                                                               
PRTPQ4A  MVC   WORK(L'ARCCARD),ARCCARD USE MODEL ARC=CARD                       
...
PRTPQ4E  MVC   0(L'SPACES,R3),SPACES                                            
         ...
         BO    *+8                                                              
         NI    HALF,X'7F'                                                       
         GOTO1 =V(DATCON),DMCB,(14,HALF),(10,6(R3))                             
         MVI   FLAG,0                                                           
...
ROUTDLI  MVC   DUB,SPACES          LIVE DATE/TIME                               
         ...
         BO    *+8                                                              
         NI    HALF,X'7F'                                                       
         GOTO1 =V(DATCON),DMCB,(14,HALF),(8,DUB)                                
         MVC   00(5,R2),DUB                                                     
*&&UK*&& OI    00(R2),C'0'                                                      
         XC    DUB(2),DUB                                                       
         SR    R0,R0                                                            
...
***********************************************************************         
* LOCK/UNLOCK THE PRINT QUEUE FILE (ENQUEUE/DEQUEUE)                            
***********************************************************************         
PQLOCK   LA    R0,C'E'                                                          
         B     *+8                                                              
PQUNLK   LA    R0,C'D'                                                          
         ...
         BZR   RE                                                               
         ST    RE,CISAVRE                                                       
         L     RF,CIENQDEQ         DMISGENQ                                     
         GOTO1 (RF),CIP1,(R0),PRTQID,X'FF000000'  EXCLUSIVE FILE LOCK           
         L     RE,CISAVRE                                                       
         BR    RE                                                               
         EJECT                                                                  
*                                                                               
...
TSTCLY   SR    RE,RE               CC=EQL IF CLASS IS WANTED                    
         ...
         BR    RE                                                               
         EJECT                                                                  
TSTRTYPE ST    RE,DUB+4            TEST IF RTYPE AT DUB(1) IS WANTED            
         CLI   RTYPEL,0                                                         
...
TSTRA1   CLI   CRANGE,0            TEST IF CREATE DATE FILTER                   
         BE    TSTRA2                                                           
         MVC   HALF,DUB            DUB+0(2) HAS CREATED DATE                    
         TM    PQTYP1,PQTYNCD      SET HALF TO CMPRSD NEW DATE                  
         BO    *+8                                                              
         NI    HALF,X'7F'                                                       
         CLC   HALF,REPCSDAT                                                    
...
TSTRA2   CLI   DRANGE,0            TEST IF DEAD DATE FILTER                     
         BE    TSTRAY                                                           
         MVC   HALF,DUB+2          DUB+2(2) HAS DAED DATE                       
         TM    PQTYP1,PQTYNCD      SET HALF TO CMPRSD NEW DATE                  
         BO    *+8                                                              
         NI    HALF,X'7F'                                                       
         CLC   HALF,REPDSDAT                                                    
...
RIGHTT   EQU   X'EC'               BOX CHR RIGHT T JUNCTIONTION                 
         EJECT                                                                  
PERMNEW  DC    X'BF9F'             CMPRSD NEW 31DEC2059                         
...
TODAY2   DS    0XL2                                                             
DATECPR  DC    XL2'00'             CMPRSD NEW B'YYYYYYYMMMMDDDDD'               
TIMEINC  DC    XL1'00'                                                          
         DC    XL1'00'                                                          
*                                                                               
P0       DS    F                                                                
...
REPTYP1  DS    XL1                                                              
*                                                                               
REPKDATE DS    XL2                 CMPRSD NEW DATE                              
REPLDATE DS    XL2                 CMPRSD NEW DATE                              
REPDDATE DS    XL2                 CMPRSD NEW DATE                              
REPCSDAT DS    XL2                 CMPRSD NEW DATE                              
REPCEDAT DS    XL2                 CMPRSD NEW DATE                              
REPDSDAT DS    XL2                 CMPRSD NEW DATE                              
REPDEDAT DS    XL2                 CMPRSD NEW DATE                              
         DS    XL2                                                              
REPKDAYS DS    F                                                                
REPLDAYS DS    F                                                                
REPDDAYS DS    F                                                                
...
PQMA2    GOTO1 =V(DATCON),DMCB,(5,DUB),(10,DATEIPL)                             
         GOTO1 (RF),(R1),(4,DATEIPL),(00,DATEYMD)                               
         GOTO1 (RF),(R1),(0,DATEYMD),(30,DATECPR)                               
*                                                                               
...
VCDATE   NTR1                      CREATE DATE                                  
         ...
         MVC   10(2,RF),DUB1       SET CMPRSD NEW DATE                          
         B     *+8                                                              
VCDERR   MVI   ERRNUM,4                                                         
VCDX     XIT1                                                                   
         SPACE 2                                                                
...
*PQA1    TM    WRITE,NO            TEST IF WRITE=NO                             
*        BO    IPQA2                                                            
*        GOTO1 VDATAMGR,P0,DADDS                                                
...
IPQUNLK  LA    R0,C'D'                                                          
         ...
         ST    RE,CISAVRE                                                       
         L     RF,CIENQDEQ         DMISGENQ                                     
         GOTOR (RF),CIP1,(R0),PRTQID,X'FF000000' EXCLUSIVE FILE LOCK            
         L     RE,CISAVRE                                                       
         BR    RE                                                               
*                                                                               
...
*FASSBOFF                                                                       
       ++INCLUDE FASSBOFF                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002PQFDEF    04/13/20'                                      
         END                                                                    
