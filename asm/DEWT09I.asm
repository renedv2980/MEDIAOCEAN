*          DATA SET DEWT09I    AT LEVEL 008 AS OF 02/14/14                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEWT09IA                                                                 
         TITLE 'DEMO CONVERSION'                                                
DEWT09I  TITLE '- WB1 TCAR CONVERSION INPUT PHASE'                              
...
CNVRTN   NMOD1 0,**CNVW**                                                       
         ...
         USING WORKD,R4            R4 = DEWT09I WORK                            
*                                                                               
...
ZDSCT    DSECT                                                                  
       ...
       ++INCLUDE DEDEMTABD                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008DEWT09I   02/14/14'                                      
         END                                                                    
