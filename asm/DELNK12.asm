...
RUNPG88  CLI   TMPLATBN,0            FOR SPOT DESKTOP FEATURE LATEST            
         ...
         B     RUNPG170                                                         
*                                                                               
RUNPG88A CLI   NUMLATBK,0                       DONT UPDATE THE TOTAL           
...
CANLK02  MVC   NMAMKTS,CANNMKTS                  NUMBER OF ALPHA MKTS           
         ...
         SR    R5,R5                             GET DEMO                       
         ICM   R5,7,ADEMO                                                       
         JZ    *+2         ADEMO SHOULD NOT BE ZERO - DO NOT PROCEED            
         LA    R2,1        ON ELSE STORAGE GETS CLOBBERD                        
         TM    DEMOIND,LQ_TSINQ                                                 
...
PROGSHRF DS    C                   PROGRAM SHARES FLAG                          
RHOMEMKT DS    CL3                                                              
FORCEBT  DS    X                                                                
FORCEFT  DS    C                                                                
...
PTABLNQ  EQU   *-PTABMOD                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'054DELNK12   02/26/21'                                      
         END                                                                    
