*          DATA SET PBIGPUB    AT LEVEL 032 AS OF 05/01/02                      
*PHASE PBIGPUBA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PBIGPUB- EXPAND PUB ELEMS'                                      
*                                                                               
*              COPIES ALL RECORDS                                               
*                                                                               
PBIGPUB CSECT                                                                   
         NBASE 0,PBIGPUB,=V(REGSAVE)                                            
         SPACE 2                                                                
         LA    R6,PBIGPUB+4095                                                  
         LA    R6,1(R6)                                                         
         USING PBIGPUB+4096,R6                                                  
...
*                                                                               
*              USE TO EXPAND PUBREPELN FROM 32 TO 45 BYTES                      
*                                                                               
         CLC   REC(3),=3X'FF'      EOF RECORD                                   
         BE    EOF                                                              
         CLI   REC+9,X'81'         MAIN PUBREC                                  
         BE    PUB                                                              
         BNE   PUTXX                                                            
*                                                                               
         SPACE 3                                                                
...
*                                                                               
*                                                                               
         MVI   ELEM+1,X'2D'        SET NEW ELEM LENGHT (45)                     
...
ELECNT   DC    PL5'0',CL20'14 ELEMENTS '                                        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'032PBIGPUB   05/01/02'                                      
         END                                                                    
