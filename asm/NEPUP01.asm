*          DATA SET NEPUP01    AT LEVEL 005 AS OF 05/01/02                      
*PHASE T32201A,*                                                                
         TITLE 'T32201 - PLAN MAINTENANCE'                                      
T32201   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T32201**,RA                                                    
         L     RC,0(R1)                                                         
...
*                                                                               
         ...
         SPACE 1                                                                
*                                      TVQ BOOK                                 
VREC3    XC    ELEMENT,ELEMENT                                                  
         MVI   ELEMENT,X'08'           ELEMENT CODE                             
         MVI   ELEMENT+1,30            ELEMENT LENGTH                           
         LA    R3,ELEMENT                                                       
         USING NPLNEL2,R3                                                       
         MVI   ELCODE,X'08'                                                     
         L     R6,AIO                                                           
         ...
         BNE   VREC3A                                                           
         MVC   ELEMENT(30),0(R6)                                                
         XC    NPL2BOOK,NPL2BOOK                                                
         GOTO1 REMELEM                                                          
*                                                                               
VREC3A   LA    R2,PUPBOOKH         TVQ BOOK                                     
         CLI   5(R2),0                                                          
         BE    VREC3F                                                           
         GOTO1 DATVAL,DMCB,(0,8(R2)),DUB                                        
         OC    DMCB(4),DMCB                                                     
         BZ    BADBOOK                                                          
         GOTO1 DATCON,DMCB,(0,DUB),(2,NPL2BOOK)                                 
         DROP  R3                                                               
*                                                                               
VREC3F   LA    R6,ELEMENT                                                       
         GOTO1 ADDELEM                                                          
*                                                                               
VREC4    XC    NPLNUNIV,NPLNUNIV   UNIVERSE CODE (OPTIONAL)                     
         LA    R2,PUPUNIVH                                                      
         CLI   5(R2),0                                                          
         BE    VREC5                                                            
         GOTO1 ANY                                                              
         ...
         MVC   NPLNUNIV,DUB+2                                                   
         SPACE 1                                                                
VREC5    GOTO1 VLUPUNIV            CHECK IF UNIVS NOW OK                        
         CLI   ERROR,X'FF'                                                      
         BE    BADUNIV                                                          
         SPACE 1                                                                
...
*        EDIT  (1,PLANYEAR),(2,2(R2))                                           
         OI    PUPYEARH+6,X'80'                                                 
         SPACE 1                                                                
         MVC   PUPNAME(16),PLANNAME  PLAN NAME                                  
         OI    PUPNAMEH+6,X'80'                                                 
...
DREC7C   OI    PUPDCPMH+6,X'80'                                                 
         ...
         XC    PUPBOOK,PUPBOOK                                                  
         OI    PUPBOOKH+6,X'80'                                                 
         MVI   ELCODE,X'08'         TVQ BOOK                                    
         L     R6,AIO                                                           
         BAS   RE,GETEL                                                         
         BNE   DREC7E                                                           
         USING NPLNEL2,R6                                                       
         OC    NPL2BOOK,NPL2BOOK                                                
         BZ    DREC7E                                                           
         GOTO1 DATCON,DMCB,(2,NPL2BOOK),(8,PUPBOOK)                             
         OI    PUPBOOKH+6,X'80'                                                 
*              TRANSFER INDICATOR                                               
DREC7E   XC    PUPTRAN,PUPTRAN                                                  
         TM    NPL2UPST,X'80'                                                   
         BZ    *+8                                                              
         MVI   PUPTRAN,C'4'                                                     
         TM    NPL2UPST,X'40'                                                   
...
BADZONE  MVC   CONHEAD(L'ZONEERR),ZONEERR                                       
         B     MYEND                                                            
         SPACE 1                                                                
BADBOOK  MVC   CONHEAD(L'BOOKERR),BOOKERR                                       
         B     MYEND                                                            
         SPACE 1                                                                
...
BOOKERR  DC    C'* ERROR * INVALID BOOK INPUT'                                  
         EJECT                                                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005NEPUP01   05/01/02'                                      
         END                                                                    
