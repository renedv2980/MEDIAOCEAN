*          DATA SET RERIS02    AT LEVEL 043 AS OF 11/04/13                      
*PHASE T80D02A,+0                                                               
...
*                                                                     *         
*                                                                     *         
* FEB05/02 (HQ ) --- BUG FIX FOR TEST AGAINST STATION CLOSE DATE      *         
*                    ESTIMATE DOLLAR                                  *         
*                                                                     *         
*                      **  END TOMBSTONE  **                          *         
***********************************************************************         
...
*                                                                               
         MVC   TEMPHALF,CDATE      GET PRIOR CLOSE DATE                         
         IC    RE,TEMPHALF         GET YR FROM YYMM                             
         BCTR  RE,0                DECREASE YEAR                                
         STC   RE,TEMPHALF         STORE PRIOR CLOSE DATE                       
* ??PRIOR YEAR MUST BE PROPORTIONAL WITH CURRENT YEAR CLOSE DATES               
*                                                                               
         CLC   TEMPHALF,HALF   IS STATION CLOSE DATE < PRIOR BKT DAT?           
...
TEMPHALF DS    H                                                                
       ...
       ++INCLUDE REPIOBLK                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'043RERIS02   11/04/13'                                      
         END                                                                    
