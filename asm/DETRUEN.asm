*          DATA SET DETRUEN    AT LEVEL 079 AS OF 07/24/08                      
*PHASE DETRUENA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DEMTIME                                                                
*INCLUDE TIMVAL                                                                 
...
*                                                                               
         LA    R1,INREC+4          ONLY PROCESSING RECORDS THAT STARTS          
         TM    0(R1),X'F0'         WITH NUMBERS                                 
         BNO   GET                                                              
*                                                                               
         MVC   TVNYEAR,0(R1)       YEAR                                         
         LA    R1,L'TVNYEAR+1(R1)                                               
*                                                                               
         MVC   TVNNET,0(R1)        NETWORK                                      
         CLI   TVNNET+2,C','                                                    
         BNE   NET10                                                            
         MVI   TVNNET+2,C' '       HANDLE 2-CHAR NETWORK                        
         LA    R1,L'TVNNET(R1)     ADVANCE ONLY 2 CHARACTERS + COMMA            
         B     *+8                                                              
NET10    LA    R1,L'TVNNET+1(R1)   ADVANCE 3 CHARACTERS + COMMA                 
                                                                                
         MVC   TVNNUM,=CL6' '      PROGRAM CODE                                 
NUM15    LA    R8,TVNNUM                                                        
         MVI   TEMPCHAR,C','                                                    
*                                                                               
...
PROGBUF2 DS    200000C                                                          
       ...
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'079DETRUEN   07/24/08'                                      
         END                                                                    
