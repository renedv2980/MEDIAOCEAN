*          DATA SET RESTR05    AT LEVEL 058 AS OF 11/25/97                      
*PHASE T80E05A                                                                  
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(8,WORK),(6,ACCPERI)                                 
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,ACCPERI+7)                               
...
LR70     DS    0H                                                               
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,LACCPERI)                                
         ...
         SP    WORK+4(4),WORK+8(4) GET 9'S COMPLEMENT                           
         MVO   WORK(4),WORK+4(4)   CHANGE TO PWOS                               
         GOTO1 DATCON,DMCB,(8,WORK),(6,LACCPERI+7)                              
         DROP  R6                                                               
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058RESTR05   11/25/97'                                      
         END                                                                    
