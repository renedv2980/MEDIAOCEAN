*          DATA SET REDAR10    AT LEVEL 070 AS OF 02/13/12                      
...
* UPDATE HISTORY:                                                     *         
*                                                                     *         
* 13FEB12 SKU SKIP LOCAL CHECK FOR FOXLOC                             *         
* 22OCT07 SKU SKIP LOCAL CHECK FOR CBS                                *         
* 22JUN04 HQ  FIX PFKEY LINE AFTER SWAPPING FROM DIFFERENCES SCREEN   *         
* 18JUN04 HQ  DISPLAY XML BANNER FOR XML ORDERS                       *         
* 15APR03 HQ  SUPRESS DEMO IF LOCAL SIGON                             *         
* 23JAN03 HQ  FIX PF8 PREVIOUS ORDER SCROLLING BUG                    *         
...
VK       DS    0H                                                               
         ...
         USING SVDSECT,R2                                                       
         TM    DMISFLGX,X'10'      COMING FROM DIFFERENCE                       
         BO    VKX                 LET IT PASS                                  
         DROP  R2                                                               
*                                                                               
...
*        GOTO1 VREDAR30,DMCB,(RC),(PRTSTAT,0),(PRTSTAT2,0)                      
         MVC   DMCB+4(4),=F'0'                                                  
         MVC   DMCB+4(1),PRTSTAT                                                
         MVC   DMCB+5(1),PRTSTAT2                                               
         GOTO1 VLOAD,DMCB,(X'30',0)                                             
                                                                                
         NI    BITFLAG,X'FF'-BFPRINT                                            
*                                                                               
         GOTO1 VTOUCHED            MARK PRINTED                                 
         B     EXIT                                                             
*                                                                               
...
VR02     TM    BUYDPFLG,BFIRSTPG   START FROM THE BEGINNING?                    
         BO    VR03                                                             
*                                                                               
         CLC   BUYKEY+2(RDARKRT-RDARKEY-2),SELECTKY+2                           
...
*                                                                               
         ...
         TM    BITFLAG3,B3XMLORD   XML?                                         
         BZ    *+10                                                             
         MVC   DRBNOTE(9),=C'XML Order'                                         
*                                                                               
VR20     DS    0H                                                               
...
*                                                                               
K        USING RDARKEY,KEY                                                      
         CLC   K.RDARKREP,=C'CB'   SKIP CHECK FOR CBS                           
         BE    DISB7801                                                         
         CLC   K.RDARKREP,=C'FF'   SKIP CHECK FOR FOXLOC                        
         BE    DISB7801                                                         
         DROP  K                                                                
         CLI   SIGNONID+4,C'L'                                                  
         BNE   DISB7801                                                         
...
*                                                                               
DISB7801 CLC   RTKODATE,FLTSTART   TAKEOVER DATE CHOPPING REQUIRED??            
         BL    DISB79                                                           
*                                                                               
         MVC   WORK(4),VREDARTK                                                 
...
*                                                                               
         PRINT GEN                                                              
         GOTO1 VREGENDB,DMCB,(BYTE,BUYKEY),(BLISTNUM,LISTAREA),(BUYNUM,X        
               AIO2),DMCB2,WORK                                                 
         B     DISB79A                                                          
*                                                                               
DISB79   DS    0H                                                               
         OI    BYTE,X'20'                                                       
*                                                                               
         GOTO1 VREGENDB,DMCB,(BYTE,BUYKEY),(BLISTNUM,LISTAREA),        X        
               (BUYNUM,AIO2),DMCB2                                              
         PRINT NOGEN                                                            
...
STPFKL20 DS    0H                                                               
         ...
         USING SVDSECT,RF                                                       
         TM    DMISFLGX,X'10'      RETURN TO DIFFERENCE FROM BUY/LIST           
         BZ    STPFINIT                                                         
*                                                                               
         CLI   PFKEY,12                                                         
         BNE   *+8                                                              
         NI    BITFLAG2,X'FF'-B2SCRCHG                                          
*                                                                               
         OI    DMISFLGX,X'08'                                                   
         DROP  RF                                                               
         LA    R2,DPFTABLE                                                      
...
*                                                                               
***********************************************************************         
* LIST PFKEY TABLE DEFINITIONS (RETURN TO DIFFERENCE SCREEN)                    
***********************************************************************         
DPFTABLE DS    0C                                                               
*                                                                               
* PRINT                                                                         
         DC    AL1(DPF05X-*,05,0,0,0,PFTRETRN)                                  
         DC    CL3' ',CL8' ',CL8' '                                             
DPF05X   EQU   *                                                                
*                                                                               
* PREVIOUS VERSION OF THE ORDER (SHADOW)                                        
         DC    AL1(DPF08X-*,08,0,0,0,PFTRETRN)                                  
         DC    CL3' ',CL8' ',CL8' '                                             
DPF08X   EQU   *                                                                
* RETURN TO SELECT SCREEN                                                       
         DC    AL1(DPF12X-*,12,0,0,(DPF12X-DPF12)/KEYLNQ,0)                     
...
LBUYSPT  DS    CL4                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'070REDAR10   02/13/12'                                      
         END                                                                    
