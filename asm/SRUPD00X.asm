*          DATA SET SRUPD00X   AT LEVEL 032 AS OF 02/04/99                      
*PHASE T10D00A                                                                  
...
SYSNOP   DC    H'0'                FOR NOW                                      
         EJECT                                                                  
************************************************                                
*  FACWK RECOVERY RECORD IS IN IOA             *                                
*  ATTEMPT TO DUPLICATE CHANGES IN REAL FILE   *                                
************************************************                                
UPDATE   NTR1                                                                   
         SPACE 1                                                                
...
ACTTAB   B     COPY                                                             
         ...
         EJECT                                                                  
*****************************************************                           
* COPY RECORDS MUST BE IDENTICAL TO RECORDS ON FILE *                           
* IF RECOVERY COPY IS DIFFERENT THEN PROTECTION     *                           
* USED DURING THE UPDATE MUST HAVE FAILED           *                           
*****************************************************                           
         SPACE 1                                                                
...
COPYX    B     UPDATEX                                                          
         EJECT                                                                  
*****************************************************                           
* COPY RECORD HAS BEEN READ FOR UPDATE NOW REPLACE  *                           
* WITH CHANGE RECORD                                *                           
*****************************************************                           
         SPACE 1                                                                
...
*   TO ADD 'IS' RECORDS FIRST CHECK IF IS/DA PAIR   *                           
*   IF NOT DO DMADD.                                *                           
*   IF SO CHECK DISK ADDRESS, IF NON ZERO USE IT AS *                           
*   IT MUST BE A PASSIVE OF AN EXISTING DA RECORD   *                           
*   IF IT IS ZERO TEST KEY WITH PREVIOUS ADDREC     *                           
*   KEY, IF ITS IDENTICAL IGNORE THE RECORD AS      *                           
*   ADDREC HAS ALREADY ADDED IT IF NOT INSERT       *                           
*   LAST DA KEY AND ADD AS IT MUST BE A NEW PASSIVE *                           
*****************************************************                           
         SPACE 1                                                                
...
ACCEXIT  EQU    *                ACCPAK - SOON CHECKS/A27-A29 BILLING           
         ...
         EJECT                                                                  
* CODE FOR TRAFFIC PATTERN RECORDS ADDED 03/18/92                               
         SPACE                                                                  
*&&US                                                                           
SAIEXIT  DS    0H                                                               
...
*                                                                               
*                                                                               
IOA      DS    4152C               FACWK IO AREA                                
IOA1     EQU   IOA+28              ACTUAL RECORD LOCATION                       
IOA2     DS    6144C               UPDATE IO AREA                               
IOA3     DS    4096C               SAVE IOA1 FOR COMPARE                        
...
*&&                                                                             
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'032SRUPD00X  02/04/99'                                      
         END                                                                    
