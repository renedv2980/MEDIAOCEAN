*          DATA SET REREP3R02  AT LEVEL 006 AS OF 02/06/09                      
*          DATA SET REREP3R02  AT LEVEL 005 AS OF 02/06/08                      
*PHASE RE3R02B                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3R02 - REREP3R02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3R02 - RE3R02 - MEDIA OCEAN DEMO FEED - (PETRY    )        *           
*                                                                   *           
*********************************************************************           
...
RE3R02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3R02,R7,R8,RR=RE                                    
*                                                                               
...
INPBLOCK DC    X'5B'               NUMSTAS:   91                                
         ...
         DC    CL05'WXOW '                                                      
         DC    CL05'XDTV '                                                      
         DC    CL05'XRIO '         END OF SHEET 2                               
*********************************************************************           
*        DC    X'12'                  NUMDPTS                                   
*        DC    CL18'ACDEGIJKLMNPQRTWYZ'  DAYPARTS:  18                          
         DC    X'01'               NUMDPTS                                      
         DC    CL1'Z'              DAYPARTS:  1                                 
**       DC    X'02'               NUMDPTS                                      
...
NUMDEMQ  EQU   (2*NUMCATQ)                                                      
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006REREP3R02 02/06/09'                                      
         END                                                                    
**  INSERT END  >>                                                              
