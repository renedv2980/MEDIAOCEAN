*          DATA SET RELDXKH    AT LEVEL 249 AS OF 05/01/02                      
*PHASE RELDXKH                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDXKH - LOAD/DUMP MODEL EXTERNAL ROUTINE'                     
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*   EXTRACT KH FILE AND COPY OVER TO EE AND NN                                  
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
* SEE IF REP IS KH                                                              
         CLC   =C'KH',0(R7)                                                     
         BNE   DMXPURGE            PURGE IF NOT KH                              
         MVC   0(2,R7),=C'NN'      CHANGE TO EE                                 
         AP    CHANGE,=P'1'                                                     
         AP    10(5,R5),=P'1'                                                   
         B     DMXKEEP                                                          
         EJECT                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'249RELDXKH   05/01/02'                                      
         END                                                                    
