*          DATA SET SPOMS20    AT LEVEL 008 AS OF 01/17/07                      
*PHASE T23420A                                                                  
T23420   TITLE 'SPOMS20 - ORDER MANAGER COMMENT PREVIEW'                        
...
*===========================================================                    
         SPACE 1                                                                
         GOTO1 INITIAL,DMCB,PFKEYTAB  INITIALIZE THE PFKEYS                     
*                                                                               
...
INVLFLD  MVI   GERROR1,INVALID                                                  
         B     ERREXIT                                                          
*                                                                               
BADORDER MVI   GERROR1,BADORD                                                   
         B     ERREXIT                                                          
*                                                                               
NOCOMMNT MVI   GERROR1,NOCOMS                                                   
         B     ERREXIT                                                          
*                                                                               
ERREXIT  GOTO1 MYERR                                                            
*                                                                               
...
NOCOMS   EQU   216                                                              
       ...
       ++INCLUDE SPOMSFFD          (BASE SCREEN FOR SYSTEM)                     
         PRINT ON                                                               
         ORG   CONTAGH                                                          
       ++INCLUDE SPOMSD0D          (OUR MAINTENANCE SCREEN OVERLAY)             
         EJECT                                                                  
...
LINELEN  EQU   *-LINED                                                          
       ...
       ++INCLUDE SPGENDRORD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008SPOMS20   01/17/07'                                      
         END                                                                    
