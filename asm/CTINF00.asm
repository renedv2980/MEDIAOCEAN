*          DATA SET CTINF00    AT LEVEL 021 AS OF 05/01/02                      
*PHASE TA0500A,*                                                                
*INCLUDE CHOPPER                                                                
*INCLUDE SQUASHER                                                               
...
VR3      LA    R4,L'RECTAB(R4)                                                  
         ...
         BZ    VR3                                                              
         TM    10(R4),X'40'        TEST AUTHORIZATION?                          
         BO    VR4                 NO                                           
...
*                                                                               
* ENTRY+10 ARE FLAGS                                                            
*  X'80' = NOT RESTRICTED TO DDS                                                
*  X'40' = DON'T CHECK AUTHORIZATION BITS IN TWA                                
*                                                                               
RECTAB   DS    0XL14                                                            
...
* FASYSLSTD                                                                     
       ...
       ++INCLUDE FASYSLSTD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021CTINF00   05/01/02'                                      
         END                                                                    
