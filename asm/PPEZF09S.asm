*          DATA SET PPEZF09S   AT LEVEL 035 AS OF 05/27/97                      
...
*                                                                               
         ...
         BNE   LRRBATCN                                                         
*                                                                               
         OC    RQMED,RQMED         IF SPECIFIC MEDIA ASKED FOR                  
         BZ    *+14                                                             
         CLC   EZWIMED,RQMED          SKIP IF NOT RIGHT MEDIA                   
         BNE   LRRBATCN                                                         
*                                                                               
...
*                                                                               
         CLI   EZMODE,EZSPTP       (51) PROCESS INSERTION                       
         BE    SPTPRTN                                                          
         CLI   EZMODE,EZRECP       (51) PROCESS RECONCILIATION REMARK           
         BE    RECPRTN                                                          
         CLI   EZMODE,EZSPTL       (51) PROCESS LAST FOR INSERTION              
         BE    SPTLRTN                                                          
...
*                                                                               
         ...
         USING BOXD,R3                                                          
*                                                                               
         CLI   TCOMSW,C'X'         SKIP IF BOXES ALREADY OFF                    
         BE    INVCOFFX                                                         
*                                                                               
         MVI   TCOMSW,C'X'         INDICATE BOXES ARE OFF                       
         MVI   BOXROWS+14+3,C'B'   PUT BOTTOM LINE TO HEADINGS                  
*                                                                               
         MVC   0(PLINSWID,R5),0(R4) CLEAR LINE                                  
*                                                                               
         GOTO1 SPOOL,DMCB,SPOOLD   PRINT A BLANK LINE TO FORCE HEADS            
*                                                                               
...
*                                                                               
         CLI   BOXROWS+14+3,C'B'   IF BOXES WERE CLOSED FOR COMMENTS            
         BNE   SPTPROWX                                                         
*                                                                               
         MVI   BOXREQ,C'O'         FORCE BOXES TO BE OPENED                     
         MVI   BOXROWS+14+3,C'M'   RESTORE TO MIDDLE LINE                       
*                                                                               
...
SPTEDN   DS    0H                                                               
*                                                                               
         LA    R2,PEDN             POINT TO START OF ESITION                    
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE CTGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035PPEZF09S  05/27/97'                                      
         END                                                                    
