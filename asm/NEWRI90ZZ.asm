*          DATA SET NEWRI90ZZ  AT LEVEL 003 AS OF 05/01/02                      
*          DATA SET NEWRI90Z   AT LEVEL 014 AS OF 10/09/98                      
*          DATA SET NEWRI90N   AT LEVEL 026 AS OF 10/07/98                      
...
*                                                                               
* PXZ *** NEW VERSION BREAKS ON PRODGROUP CODE                                  
*                                                                               
*************************************************************                   
         SPACE 2                                                                
T32090   CSECT                                                                  
...
RECCARD  DC    CL80'RECORD TYPE=F,LENGTH=210'                                   
*                                                                               
...
***      BZ    EXIT                                                             
         ...
         CLI   DOWNIT,0                                                         
         BE    EXIT                                                             
         CLI   DOWNIT,1               DOWNLOAD AND NO DATA?                     
         BNE   EXIT                                                             
         MVI   DOWNIT,3            3=NO DATA                                    
         BAS   RE,FORMATLN                                                      
         B     EXIT                                                             
...
*                                                                               
         CLI   PRDBRK,C'G'         PRDGROUP BREAKS?                             
         BNE   PRD30                                                            
         MVC   MYKEY,KEY                                                        
         XC    KEY,KEY                                                          
*                                                                               
...
FORMATIT NMOD1 0,**ANXX**                                                       
         ...
         LA    R1,DOWNHOOK                                                      
         ST    R1,DLCBAPR                                                       
         CLI   DOWNIT,3            NO DATA?                                     
         BE    *+12                                                             
         CLI   DOWNIT,1          FIRST CALL                                     
         BNE   *+8                                                              
         BAS   RE,FIRSTDWN       START DOWNLOAD REPORT                          
...
DODATA   DS    0H                                                               
         ...
         BH    FRMCOST                                                          
         MVI   DLCBFLD,C'0'        NO - SET IN ZERO                             
         B     FRMCOST2                                                         
FRMCOST  LA    R1,L'PLCOST                                                      
         BCTR  R1,0                                                             
         EX    R1,*+8                                                           
         B     *+10                                                             
         MVC   DLCBFLD(0),PLCOST                                                
FRMCOST2 MVI   DLCBACT,C'P'        PUT                                          
...
*                                                                               
DODLFLD  NTR1                                                                   
         LR    R1,R3           R3=WORK AREA FOR DLFLD                           
         L     RF,=V(DLFLD)                                                     
         BASR  RE,RF                                                            
         XIT1                                                                   
*                                                                               
...
*                                                                               
MYP      DS    CL185                                                            
DOWNWORK DS    CL300               FOR EXTENDED TEXT                            
         LTORG                                                                  
*                                                                               
         EJECT                                                                  
*                                                                               
...
*********************************************************                       
*                                                                               
SRTTBL   DS    0CL210    *** NOTE HARD CODED                                    
SRTKCLT  DS    CL3               * CLIENT                                       
SRTKPGRP DS    CL3               * PROD GROUP                                   
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003NEWRI90ZZ 05/01/02'                                      
         END                                                                    
