*          DATA SET PUBCOPY    AT LEVEL 021 AS OF 05/01/02                      
*PHASE PUBCOPYA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
******                                                                          
******   THIS PROGRAM IS TO BE USED WHEN COPYING TO AN AGENCY                   
******   ON THE SAME PRINT FILE. IT'S OUTPUT IS THE NEW (AN ONLY)               
******   LOAD TAPE FOR THAT PRINT FILE.                                         
******                                                                          
******   THE CONTROL CARDS CONTAIN THE "FROM" AGENCY AND                        
******   MEDIA IN COLUMNS 1-3 (AGENCY (2) MEDIA (1))                            
******   AND THE "TO" AGENCY AND MEDIA IN COLS. 4-6                             
******                                                                          
         PRINT NOGEN                                                            
PURGEON  CSECT                                                                  
...
GET4B    DS    0H                                                               
         CLI   0(R2),0                                                          
         BE    GET6                                                             
         CLI   0(R2),X'08'        ADDRESS ELEMENTS                              
         BE    GET5             - ONLY KEEP ONES FOR ALL CLIENTS                
         CLI   0(R2),X'09'                                                      
         BE    GET5                                                             
         CLI   0(R2),X'0A'                                                      
         BE    GET5                                                             
         CLI   0(R2),X'0B'                                                      
         BE    GET5                                                             
         CLI   0(R2),X'14'         CLIENT ELEMENTS                              
         BE    GET5                                                             
*                                                                               
         CLI   0(R2),X'80'        AOR PUB LINK ELEM                             
         BE    GET5F                                                            
         CLI   0(R2),X'10'         NAME ELEMENT                                 
         BNE   GET4D                                                            
*                                                                               
         CLI   COPYREP,C'Y'         SEE IF COPYING REPS                         
         BE    GET4D                YES - THEN DON'T CLEAR PUBLISHER            
*                                                                               
         USING PUBNAMED,R2                                                      
         XC    PUBPLSH,PUBPLSH      MUST CLEAR PUBLISHER (REP)                  
         DROP  R2                                                               
*                                                                               
GET4D    DS    0H                                                               
         SR    R0,R0                                                            
...
*                                                                               
         ...
         BE    GET5A             YES - ONLY SAVE ALL CLIENT ELEMS               
         B     GET5B             NO - DELETE ALL X'14' ELEMS                    
*                                                                               
GET5A    DS    0H                                                               
         CLC   2(3,R2),=3X'FF'                                                  
         BE    GET4D                                                            
...
*                                                                               
         B     GET4B                                                            
*                                                                               
GET5F    DS    0H            SEE IF COPYING ADVAOR PUB LINK ELEMS               
         OC    ADVAOR,ADVAOR                                                    
         BZ    GET5B         NO - THEN DELETE AOR PUB LINK ELEMS                
         CLC   2(5,R2),ADVAOR  YES - THEN MUST MATCH                            
         BNE   GET5B                                                            
         B     GET4D                                                            
*                                                                               
GET6     DS    0H                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021PUBCOPY   05/01/02'                                      
         END                                                                    
