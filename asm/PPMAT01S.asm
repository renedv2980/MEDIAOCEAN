*          DATA SET PPMAT01S   AT LEVEL 070 AS OF 05/01/02                      
*PHASE T40201A                ***** NOTE "A" APPENDED TO PHASE NAME             
*                                                                               
...
*                                                                               
VK70LOOP CLI   0(R1),1             JUST AN E=, S=, OR N=?                       
...
**********************************************************************          
********              SEPTEMBER/1999                         *********          
*             YEAR HAS NOT BEEN ENTERED IN INVOICE DATE.             *          
*               IF ABOVE LOGIC RESULTS IN A YEAR OF:                 *          
*   X'5A' (90) IN BYTE 1 OF FULL, REPLACE WITH X'64' FOR YEAR 2000   *          
**********************************************************************          
*                                                                    *          
*NOP*    CLI   FULL,X'5A'          90 (FOR 1990) ?                   *          
*NOP*    BNE   VL10A10             NO                                *          
*NOP*    MVI   FULL,X'64'          REPLACE WITH 100 (FOR 2000)       *          
*NOP*    B     VL10A70                                               *          
*                                                                    *          
VL10A10  DS    0H                                                    *          
*                                                                    *          
...
VL34     DS    0H                  SEE IF ENTERED ONLY THE MONTH                
         ...
         BZ    VL35                NO                                           
*NOP*    CLC   LSTYEAR,PVALCPER+7                                               
*NOP*    BL    VL34L                                                            
*NOP*    CLI   PVALBSTA,X'0A'      IS CURRENT YEAR GREATER THAN 10              
*NOP*    BNL   VL34A                                                            
*NOP*    MVC   LINPER(3),PVALCPER      YES THEN USE MONTH/9?                    
*NOP*    MVC   LINPER+3(2),=C'/9'          /YEAR                                
*NOP*    MVC   LINPER+5(1),LSTYEAR         /YEAR                                
*NOP*    MVI   LINPERH+5,X'06'    LENGTH                                        
*NOP*    B     VL34PER                                                          
**********************************************************************          
*                                                                    *          
...
*****    VL34A BEL0W                                                            
*                                                                               
VL34A    DS    0H            CURRENT YEAR GREATER THAN LINPER YEAR              
...
**********************************************************************          
********              SEPTEMBER/1999                         *********          
*             YEAR HAS NOT BEEN ENTERED IN PERIOD.                   *          
*             IF ABOVE LOGIC RESULTS IN A YEAR OF:                   *          
*      C'90' IN LINPER+4, REPLACE WITH C'00' FOR YEAR 2000           *          
*                                                                    *          
**********************************************************************          
*                                                                    *          
*NOP*    CLC   LINPER+4(2),=C'90'                                    *          
*NOP*    BNE   *+8                                                   *          
*NOP*VL34N    MVI   LINPER+4,C'0'                                    *          
**********************************************************************          
*NOP*    B     VL34PER                                                          
...
*                                                                               
         ...
         BNZ   PFTBL05                                                          
*                                                                               
PFTBL00  XC    SEQLIST,SEQLIST     THEN SEQUENCE LIST GETS CLOBBERED            
         LA    R3,LSTLSTF                                                       
         USING LINDSECT,R3                                                      
         LA    R3,LINSREPH                                                      
         DROP  R3                                                               
...
LINNEXTL DS    0C                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'070PPMAT01S  05/01/02'                                      
         END                                                                    
