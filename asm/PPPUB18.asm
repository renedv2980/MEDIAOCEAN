*          DATA SET PPPUB18    AT LEVEL 008 AS OF 02/01/99                      
*PHASE T40618A,+0,NOAUTO                                                        
*INCLUDE PSIZEVAL                                                               
         TITLE 'CHANGE LOG'                                                     
*                                                                               
***********************************************************************         
*                                                                               
*   KWAN  1/99   ERROR ON REPEATED BLEED AD SIZE CODE (3 CHARS)                 
*                                                                               
*   SMYE  9/98   DO NOT ALLOW RECORD ADD WITH NO ELEMENTS                       
*                                                                               
*   BPLA  9/98   PUBIO EXPANDED TO 4000 BYTES                                   
*                IF DELETED - DON'T SET ON LTLIND (X'10')                       
*                ONLY MARK DELETED IF NO ELEMENTS REMAIN                        
*                DELETE BOTH ELEMENT TYPES AT EDT00                             
***********************************************************************         
*                                                                               
         TITLE 'T40618  PUBFILE MAINT - BLEED AD SIZING'                        
         PRINT NOGEN                                                            
*                                                                               
T40618   CSECT                                                                  
         NMOD1 0,T40618,RR=R9                                                   
         L     RC,0(R1)                                                         
         USING GENOLD,RC                                                        
*                                                                               
         ST    R9,RELO                                                          
...
RELO     DC    F'0'                                                             
*                                                                               
         LA    R8,T40618+4095      R8 = SECOND BASE REGISTER                    
         LA    R8,1(R8)                                                         
         USING T40618+4096,R8                                                   
*                                                                               
         USING T406FFD,RA                                                       
*                                                                               
         LA    R9,PUBIO                                                         
...
STARTGET BAS   RE,GETPUB                                                        
         ...
         CLI   KEY+25,X'FF'        SEE IF DELETED                               
...
*                                                                               
         ...
         GOTO1 (RF),DMCB,(C'D',=C'PUBFILE'),(X'15',PUBZREC),0,0                 
         CLI   DMCB+12,0                                                        
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
         L     RF,ACOMFACS                                                      
         L     RF,(CHELLO-COMFACSD)(RF)                                         
         GOTO1 (RF),DMCB,(C'D',=C'PUBFILE'),(X'30',PUBZREC),0,0                 
         CLI   DMCB+12,0                                                        
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
         ...
         STH   R3,RECLEN                                                        
*                                                                               
         LA    R2,BLDEDGEH         FIRST SCR FIELD                              
         LA    R1,BLDDPLSH         LAST SCR FIELD                               
EDIT10   CR    R2,R1               PASS LAST SCR FIELD YET?                     
         ...
         BAS   RE,NEXTFLD                                                       
         B     EDIT10                                                           
EDIT25   MVI   ESWITCH,0           NO INPUT AT ALL                              
         B     EDITXX                                                           
*                                                                               
EDIT20   LA    R7,ELEAREA                                                       
         USING PPPUBSD,R7          SAFETY ELEMENT                               
*                                                                               
         LA    R2,BLDEDGEH         FIELD POINTER                                
         LA    R4,1                LOOP COUNTER                                 
*                                                                               
EDIT21   CHI   R4,6                                                             
         BH    EDIT29              LOOP GOES 6 TIMES                            
         XC    ELEAREA,ELEAREA                                                  
         MVI   PPPUBSEL,PPPUBSEQ   SAFETY ELEMENT CODE                          
         MVI   PPPUBSLN,PPPUBSLNQ  SAFETY ELEMENT LENGTH                        
         MVI   PPPUBSUI,C'I'       SAFETY UNIT INDICATOR (I=INCH)               
*                                                                               
         CLI   5(R2),0                                                          
         BE    EDIT26              NOTHING IN INPUT, GO TO NEXT FIELD           
         BAS   RE,CKWDDP           CHECK ANY EDGE, TOP, BOTTOM, FACE,           
         BE    *+12                      GUTTER, FROM TRIM FIELDS               
         LA    R3,2                                                             
         B     ERROR                                                            
         ...
         LA    R3,2                                                             
         B     ERROR                                                            
         MVC   PPPUBSU,WKINT       TRIM WIDTH (BINARY)                          
         MVC   PPPUBSNU,WKNUMTOR+3                                              
         MVC   PPPUBSDE,WKDENTOR+3                                              
*                                                                               
         CHI   R4,1                                                             
         BNE   *+12                                                             
         MVI   PPPUBSCD,C'5'       5 = FROM EDGE                                
         B     EDIT22                                                           
         CHI   R4,2                                                             
         BNE   *+12                                                             
         MVI   PPPUBSCD,C'1'       1 = TOP                                      
         B     EDIT22                                                           
         CHI   R4,3                                                             
         BNE   *+12                                                             
         MVI   PPPUBSCD,C'2'       2 = BOTTOM                                   
         B     EDIT22                                                           
         CHI   R4,4                                                             
         BNE   *+12                                                             
         MVI   PPPUBSCD,C'3'       3 = FACE                                     
         B     EDIT22                                                           
         CHI   R4,5                                                             
         BNE   *+12                                                             
         MVI   PPPUBSCD,C'4'       4 = GUTTER                                   
         B     EDIT22                                                           
         CHI   R4,6                                                             
         BNE   *+12                                                             
         MVI   PPPUBSCD,C'6'       6 = FROM TRIM                                
         B     EDIT22                                                           
*                                                                               
         DC    H'0'                NO OTHER POSSIBLILITY                        
*                                                                               
EDIT22   OI    ESWITCH,1           SOMETHING HAS BEEN ENTERED                   
*                                                                               
         L     RF,ACOMFACS                                                      
         L     RF,(CHELLO-COMFACSD)(RF)                                         
...
*                                                                               
         ...
         STH   R3,RECLEN                                                        
*                                                                               
EDIT26   LA    R4,1(R4)            LOOP COUNTER INCREMENT                       
         BAS   RE,NEXTFLD          BUMP PROTECTED FIELD                         
         BAS   RE,NEXTFLD          POINT TO NEXT INPUT FIELD                    
EDIT27   B     EDIT21              LOOP AGAIN                                   
         DROP  R7                                                               
*                                                                               
EDIT29   LA    R7,ELEAREA                                                       
         USING PPPUBBD,R7          BLEED AD SIZE ELEM DSECT                     
*                                                                               
         XC    CODELIST,CODELIST   LIST OF CODES FOR NO DUPLICATES              
         LA    R2,BLDSPFSH         FIRST SPACE FIELD                            
...
EDIT35   CLC   0(3,RE),WORK        SEE IF CODE ALREADY IN LIST                  
         ...
         B     EDIT35                                                           
         MVC   PPPUBBCD,WORK       3 CHAR AD SIZE CODE                          
...
*                                                                               
EDIT60   LA    R6,2                                                             
         MVI   PPPUBBEL,PPPUBBEQ   BLEED AD SIZE ELEMENT CODE                   
         MVI   PPPUBBLN,PPPUBLNQ   BLEED AD SIZE ELEMENT LENGTH                 
         MVI   PPPUBBUI,C'I'       BLEED AD SIZE UNIT INDICATOR (I=IN)          
*                                                                               
EDIT65   DS    0X                                                               
         BAS   RE,NEXTFLD                                                       
         ...
         CH    R6,=H'2'                                                         
         BNE   EDIT66                                                           
         MVC   PPPUBBWU,WKINT      BLEED ADS WIDTH (BINARY)                     
         MVC   PPPUBBWN,WKNUMTOR+3                                              
         MVC   PPPUBBWD,WKDENTOR+3                                              
         B     EDIT68                                                           
EDIT66   CH    R6,=H'1'                                                         
         BNE   EDIT67                                                           
         MVC   PPPUBBDU,WKINT      BLEED ADS DEPTH (BINARY)                     
         MVC   PPPUBBDN,WKNUMTOR+3                                              
         MVC   PPPUBBDD,WKDENTOR+3                                              
         B     EDIT68                                                           
...
*       IF ESWITCH=0 FLAG FOR DELETE  (IF REALLY EMPTY)                         
*       ELSE REWRITE RECORD                                                     
*                                                                               
***********************************************************************         
*                                                                               
...
*                                  NO - RECORD EXISTS                           
         ...
         CLC   RECLEN,=H'33'       SEE IF REALLY EMPTY                          
         BNE   *+8                                                              
         MVI   KEY+25,X'FF'        FLAG DELETED                                 
         BAS   RE,WRITEPUB                                                      
...
*                                                                               
FMT20    LA    R6,PBLLAST                                                       
         GOTO1 VCALLOV,WORK,(R6),X'D90406F5'                                    
         CLI   4(R1),X'FF'                                                      
         BE    VIRGERR                                                          
         MVI   SAVSCRN,X'18'                                                    
*                                                                               
FMT50    DS    0H                                                               
         ...
         BNZ   PUTFLD00                                                         
*                                                                               
FMT55    FOUT  BLDEDGEH,SPACES,8                                                
         FOUT  BLDTOPH,SPACES,8                                                 
         FOUT  BLDBOTTH,SPACES,8                                                
         FOUT  BLDFACEH,SPACES,8                                                
         FOUT  BLDGUTTH,SPACES,8                                                
         FOUT  BLDTRIMH,SPACES,8                                                
*                                                                               
         LA    R2,BLDSPFSH                                                      
...
PUTFLD00 DS    0X                                                               
         ...
         USING PPPUBSD,R4                                                       
*                                                                               
         MVI   ELCODE,PPPUBSEQ     SAFETY ELEM CODE                             
PUTFLD27 BAS   RE,GETEL            GET ELEMENT                                  
         BNE   PUTFLD29            DONE WITH SAFETY ELEM                        
*                                                                               
         CLI   PPPUBSCD,C'1'                                                    
         BNE   *+12                                                             
         LA    R2,BLDTOPH          TOP                                          
         ...
         CLI   PPPUBSCD,C'4'                                                    
         BNE   *+12                                                             
         LA    R2,BLDGUTTH         GUTTER                                       
         B     PUTFLD28                                                         
         CLI   PPPUBSCD,C'5'                                                    
         BNE   *+12                                                             
         LA    R2,BLDEDGEH         ANY EDGE                                     
         B     PUTFLD28                                                         
         CLI   PPPUBSCD,C'6'                                                    
         BNE   *+12                                                             
         LA    R2,BLDTRIMH         FROM TRIM                                    
         B     PUTFLD28                                                         
         DC    H'0'                THERE'S NO OTHER POSSIBILITY                 
*                                                                               
PUTFLD28 LA    R1,WKTEMP                                                        
         MVC   WK2BYTES,PPPUBSU                                                 
         MVC   WKBYTE1,PPPUBSNU                                                 
         MVC   WKBYTE2,PPPUBSDE                                                 
         BAS   RE,PUTFLD20                                                      
         BAS   RE,NEXTEL           POINT TO NEXT ELEMENT                        
         BNE   PUTFLD29                                                         
         B     PUTFLD27            LOOP BACK FOR MORE                           
         DROP  R4                                                               
*                                                                               
PUTFLD29 LA    R4,PUBZREC+33                                                    
         USING PPPUBBD,R4                                                       
*                                                                               
         LA    R2,BLDSPFSH         POINT TO FIRST SPACE FIELD                   
         MVI   ELCODE,PPPUBBEQ     BLEED AD SIZE ELEMENT                        
PUTFLD30 BAS   RE,GETEL            GET ELEMENT                                  
         BNE   DONE                                                             
*                                                                               
         GOTO1 =V(PSIZEVAL),DMCB,(1,PPPUBBCD),WORK,RR=RELO                      
         CLI   DMCB,X'FF'                                                       
         BNE   *+6                                                              
         DC    H'0'                CAN'T FAIL!                                  
...
*                                                                               
         LA    R1,WKTEMP                                                        
         MVC   WK2BYTES,PPPUBBWU                                                
         MVC   WKBYTE1,PPPUBBWN                                                 
         MVC   WKBYTE2,PPPUBBWD                                                 
         BAS   RE,PUTFLD20                                                      
*                                                                               
         BAS   RE,NEXTFLD                                                       
         LA    R1,WKTEMP                                                        
         MVC   WK2BYTES,PPPUBBDU                                                
         MVC   WKBYTE1,PPPUBBDN                                                 
         MVC   WKBYTE2,PPPUBBDD                                                 
         BAS   RE,PUTFLD20                                                      
         BAS   RE,NEXTFLD                                                       
         BAS   RE,NEXTEL           POINT TO NEXT ELEMENT                        
         BNE   DONE                                                             
         B     PUTFLD30            SEE IF THERE IS MORE BLEED ELEM              
         DROP  R4                                                               
*                                                                               
         B     DONE                                                             
*                                                                               
...
***********************************************************************         
*                                                                               
NUMBCONV NTR1                      CONVERT INPUT USING FRACTION TABLE           
*                                                                               
...
*                                                                               
       ++INCLUDE PPPUBFFD                                                       
         ORG   PBLLAST                                                          
       ++INCLUDE PPPUBF5D          BLEED AD PAGE SCR                            
*                                                                               
         ORG   T406FFD                                                          
         DS    CL16                                                             
BMED     DS    CL1                                                              
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008PPPUB18   02/01/99'                                      
         END                                                                    
