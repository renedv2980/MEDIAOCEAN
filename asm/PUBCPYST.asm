*          DATA SET PUBCPYST   AT LEVEL 021 AS OF 05/01/02                      
*PHASE PUBCPYST,*,NOAUTO                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*                                                                               
*       SPECIAL PUB COPY FOR SGTO (ST) TO SBSTO (F6)                            
*       COPIES ALL PUB DATA INCLUDING ALL ADDRESS RECORDS                       
*       LEAVES ALL REPS CODES IN ELEMENTS                                       
*                                                                               
         PRINT NOGEN                                                            
PURGEON  CSECT                                                                  
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021PUBCPYST  05/01/02'                                      
         END                                                                    
