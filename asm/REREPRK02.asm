*          DATA SET REREPRK02  AT LEVEL 008 AS OF 05/01/02                      
*PHASE RERK02A,*                                                                
...
*                                                                   *           
* 19JUN1997 (JRD) -- NEGATIVE DOLLAR TOTAL FIX                      *           
*                    EOF CHECK ON PRIOR READ                        *           
*                    INIT WORKING STORAGE EACH TIME                 *           
*                                                                   *           
* 19FEB1998 (JRD) -- UPGRADE FOR 4K CONTRACTS                       *           
*                                                                   *           
* 27JUL1998 (JRD) -- EXCLUDE REP 'I2'                                           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*                                                                   *           
*********************************************************************           
...
***********************************************************************         
POST     NTR1                                                                   
         CLC   RREPKREP,=C'I2'     SKIP INTERREP NON REP                        
         BE    POSTX                                                            
*                                                                               
...
MASTD    DSECT                                                                  
       ++INCLUDE DDMASTC                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008REREPRK02 05/01/02'                                      
         END                                                                    
