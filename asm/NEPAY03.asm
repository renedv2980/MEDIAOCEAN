*          DATA SET NEPAY03    AT LEVEL 060 AS OF 11/20/17                      
*PHASE T31303A,+0                                                               
...
T31303   CSECT                                                                  
         ...
         SPACE                                                                  
         MVC   DATADISP,=H'27'                                                  
         OI    NBSBKEND,NBNODPT2   SUPRESS DAYPART LOOKUP                       
...
*                                                                               
         ...
         BNE   LS600               IF IT IS - SKIP RECORD                       
*                                                                               
         CH    R3,=H'2'                                                         
         BNE   LS720                                                            
         CLI   NBPR2CL3,0          3 CHAR PROD?                                 
         BNE   LS710                                                            
***      CLI   NBPRD2,0                                                         
***      BE    LS740                                                            
*        CLC   NBPRD2,NBSPLPRN     LINE 2 = 2ND PRODUCT NO PIGGY                
LS710    CLI   NBSPLTYP,C'S'       LINE 2 = 2ND PRODUCT NO PIGGY                
         BE    LS740               - NEXT LINE                                  
         MVI   PIGGYOK,C'Y'                                                     
         B     LS760                                                            
*                                                                               
...
*                                                                               
         OC    SVDFCML,SVDFCML                                                  
         BNZ   CH420                                                            
         CLI   NBPR2CL3,0          IF PIGGYBACK PRD'S MAKE SURE BOTH -          
...
**       MVC   NUPCPRD,NBSPLPRN    PRODUCT NAME                                 
         MVC   NUPCAPRD,NBSPLPR3    PRODUCT NAME                                
         MVC   NUPCCML,8(R2)                                                    
         GOTO1 VHELLO,DMCB,(C'P',UNTFILE),NBAIO,(R5),0                          
         CLI   12(R1),0                                                         
         BE    CH500                                                            
...
ED120    MVI   MORESW,YES                                                       
         ...
         BE    ED180               YES                                          
*                                  AT END-OF-FILE                               
ED140    LA    RE,SVDATAA          CLEAR ENTIRE SAVE AREA                       
         LA    RF,SVDATAAL                                                      
         SR    R1,R1                                                            
         MVCL  RE,R0                                                            
...
*                                                                               
         ...
         BZ    ESB100                                                           
*                                                                               
ESB090   MVI   5(R5),STAR          NOTE BILLING ON UNIT                         
ESB100   LA    R5,6(R5)                                                         
*                                                                               
         L     RE,SAVEREG2                                                      
         BR    RE                                                               
...
* CHECK SECOND PRODUCT TABLE                                                    
         LA    R0,35                                                            
         LA    R1,CLIST2           POINT TO PRODUCT LIST                        
PT130    OC    0(4,R1),0(R1)       TEST FOR END-OF-LIST                         
         BZ    PTDUMP              YES                                          
         CLC   NBSPLPRN,3(R1)                                                   
         BE    PT200                                                            
         LA    R1,4(R1)                                                         
...
CML100   GOTO1 MYGETEL,DMCB,(X'24',NBAIO)                                       
         ...
         L     RE,4(R1)                                                         
         USING NUPCELD,RE                                                       
         CLI   NUPCLEN,15         NEW ELEM WITH 3 CHAR PROD?                    
         BNE   CML110                                                           
         CLC   NBSPLPR3,NUPCAPRD  YES                                           
         BE    CML112                                                           
         B     CML100                                                           
CML110   CLC   NBSPLPRN,NUPCPRD                                                 
         BNE   CML100                                                           
CML112   MVC   8(8,R2),NUPCCML                                                  
*                                                                               
...
*                                                                               
       ++INCLUDE NETBILLRD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'060NEPAY03   11/20/17'                                      
         END                                                                    
