*          DATA SET PPREPFXOBP AT LEVEL 015 AS OF 03/22/96                      
*                                                                               
*        CONVERTS BDAT (BP)  ACC OFFICES                                        
*                                                                               
...
LOOP     CLC   PCLTOFF,2(R1)                                                    
         ...
         BCT   R0,LOOP                                                          
*                                                                               
ERR      MVC   P(26),=C'COULDN''T CONVERT BP CLIENT'                            
         MVC   P+32(3),PCLTKCLT                                                 
...
*                                                                               
         ...
         SPACE 2                                                                
*---------------------------------------------------------------------*         
*        OFFICE CONVERSION TABLE - BDAT (BP)                          *         
*---------------------------------------------------------------------*         
OFFTAB   DS    0H                                                               
         DC    CL2'AA',X'00'         OFFICE MISSING                             
         DC    CL2'AA',CL1' '        OFFICE MISSING                             
         DC    CL2'AA',CL1'H'                                                   
         DC    CL2'AA',CL1'S'                                                   
         DC    CL2'AA',CL1'1'                                                   
         DC    CL2'AA',CL1'6'                                                   
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015PPREPFXOBP03/22/96'                                      
         END                                                                    
