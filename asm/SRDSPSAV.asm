*          DATA SET SRDSPSAV   AT LEVEL 032 AS OF 10/16/98                      
...
*                                                                               
*                              PROCESSING OF ISSUE DATE AND DIGITAL             
MAINP09  DS    0H              RECORDS WILL "USE" MAINP09 TO MAINP50            
*                                                                               
...
*                                                                               
MAINP50  DS    0H                                                               
         CLI   GPUBSTYP,1          ISSUE DATE RECORD SUB-TYPE ?                 
         BE    ISSUP10             RETURN TO ISSUE DATE I/P RECORDS             
*NOP*    CLI   GPUBSTYP,2          DIGITAL DATA RECORD SUB-TYPE ?               
*NOP*    BE    DIGIP10             RETURN TO DIGITAL DATA I/P RECORDS           
*                                  ELSE ADD FIRST MAIN PUB ELEMENT              
         XC    ELEM,ELEM                                                        
         LA    R6,ELEM                                                          
         USING GPUBHD,R6                                                        
...
*                                                                               
         ...
         MVC   GKEY,PCONREC        SET KEY FOR READ                             
         MVC   GKEYSAVE,GKEY                                                    
         B     MAINP09             READ GEN FILE - SET ADDSW, ETC.              
*                              MAINP09 BRANCH WILL RETURN TO ISSUP05            
ISSUP05  DS    0H                                                               
*                                                                               
**********************************************************************          
*        ISSUE DATE ELEMENT                                          *          
...
*                                                                               
         OC    ISID,SPACES                                                      
         MVC   GPUBIID,ISID        20 CHARACTERS OF ISSUE DESCRIPTION           
...
**********************************************************************          
PUBOUTP  NTR1                      ADD OR UPDATE SRDS PUB RECORD                
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'032SRDSPSAV  10/16/98'                                      
         END                                                                    
