*          DATA SET ACREPTT02  AT LEVEL 013 AS OF 01/19/21                      
*PHASE ACTT02A,*                                                                
*INCLUDE SORTER                                                                 
*INCLUDE DLFLD                                                                  
*INCLUDE CONVMOS                                                                
...
***********************************************************************         
*CPAT 010 19JAN18 <SPEC19059> UPDATE COMPANY INFORMATION IN ACTT      *         
*CPAT 011 12MAR19 <SPEC32302> CORRECT LOGIC TO STORE UP TO 240 OFFICE *         
*                             IDS INTO OFFICE LIST BUFFER             *         
* GHOA 012 28OCT20 SPEC-51025 1099 NEW REQUIREMENTS FOR 2020          *         
* GHOA 013 19JAN21 SPEC-53164 1099 NEC B RECORD AMT IN AMOUNT 1       *         
***********************************************************************         
         SPACE 1                                                                
ACTT02   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         CLI   FOUNDIT,C'Y'                                                     
         BE    REQL                                                             
         CLI   QOPT1,C'X'          ARE WE RUNNING FAKE REQUEST?                 
         BE    EXIT                                                             
*                                                                               
...
PREQ     DS    0H                                                               
         USING ACQD,RF                                                          
         L     RF,ADQSTACK                                                      
         CLI   ACQOPT1,C'X'        ARE WE RUNNING FAKE REQUEST?                 
         BNE   PREQ10                                                           
         MVI   RCREQREP,C'N'                                                    
         B     PREQX                                                            
         DROP  RF                                                               
*                                                                               
PREQ10   CLI   QOPT7,C'Y'          ARE WE DOWNLOADING?                          
         BE    PREQX                                                            
*                                                                               
         USING MASTD,R2                                                         
         L     R2,ADMASTC                                                       
...
*                                                                               
         LA    R1,REQUEST                                                       
*        MVC   0(2,R1),=C'/*'      SET NULL REQUEST                             
         MVI   QOPT1-QRECORD(R1),C'X'  DEFAULT TO NO RUN                        
         CLI   QOPT1,C'Y'          ONLY COPY REQUEST CARD IF LIVE RUN           
         BNE   REQF10                                                           
         MVC   0(L'REQUEST,R1),QRECORD                                          
         MVI   QOPT1-QRECORD(R1),C' '  RUN DRAFT AS 2ND REQUEST                 
*                                                                               
REQF10   L     R1,=A(AC99RQF)                                                   
         PUT   (1),REQUEST                                                      
*                                                                               
...
*                                                                               
         CLI   QOPT1,C'Y'                                                       
         BNE   REQF20                                                           
         CLI   REQUEST+QCNTINUE-QRECORD,QCNTQ   REQUEST2 FIELDS?                
         BNE   REQF20                                                           
         LA    R1,REQUEST2                                                      
         MVC   0(L'REQUEST2,R1),QRECORD2                                        
         L     R1,=A(AC99RQF)                                                   
         PUT   (1),REQUEST2                                                     
*                                                                               
REQF20   GOTO1 DATCON,DMCB,(0,QSTART),(1,SVSDAT)                                
...
*                                                                               
         ...
         BNE   REQF30              GO DIRECTLY TO PRINT REGISTER.               
         BAS   RE,DOREG                                                         
         B     EXIT                                                             
*                                                                               
         USING CPYELD,R2                                                        
REQF30   L     R2,ADCMPEL          THE COMPANY ELEMENT                          
         CLI   0(R2),X'10'                                                      
         BE    *+6                                                              
         DC    H'0'                                                             
...
*                                                                               
         ...
         LA    R1,L'SVOFFL                                                      
         LR    RF,R1                                                            
         MVCL  R0,RE               SAVE OFF OFFICE LIST FROM MONACC             
*                                                                               
         DROP  RF                                                               
*                                                                               
...
REQF80   DS    0H                                                               
         ...
         BNE   REQF110             NO - GET NEXTEL                              
         CLI   CTSYSLMT,0                                                       
         BE    REQF110             IF EQUAL - NO LIMIT ACCESS                   
...
*                                                                               
         ...
         LA    R1,COFFLNQ                                                       
         LR    RF,R1                                                            
         MVCL  RE,R0               LIMITED ACCESS/REQUEST OFFICE LIST           
         L     R1,SAVER1                                                        
         J     REQF95                                                           
*                                                                               
REQF90   ST    R1,SAVER1                                                        
         ...
         LA    R1,COFFLNQ                                                       
         LR    RF,R1                                                            
         MVCL  R0,RE               SAVE OFF OFFICE LST FOR LATER                
         L     R1,SAVER1                                                        
         J     REQF110                                                          
*                                                                               
         USING CTDSTD,R1                                                        
REQF95   SR    RF,RF                                                            
REQF100  CLI   0(R1),X'30'         DESTINATION DETAIL ELEMENT                   
         BNE   REQF110                                                          
         CLC   CNAME,SPACES        IF NAME IS HARDCODED SKIP                    
         BNE   *+10                                                             
         MVC   CNAME(L'CTDSTNAM),CTDSTNAM                                       
...
REQF110  SR    R0,R0                                                            
         ...
         B     REQF70                                                           
*                                                                               
REQF120  CLI   FOUNDIT,C'Y'        AGENCY SETUP FOR 1099'S?                     
...
PTRN     DS    0H                                                               
*                                                                               
         CLI   QAPPL,C'N'          1099-NEC                                     
         BNE   PTRN03                                                           
         CLI   D1PTYPE,RSTXNCMP    MUST BE NON EMPLOYEE COMP                    
         BNE   PTRNX               NO, SKIP TRANSACTION                         
         B     PTRN05                                                           
*                                                                               
PTRN03   CLI   D1PTYPE,RSTXNCMP    1099-MISC, CAN'T BE NON EMPL COMP            
         BE    PTRNX               YES, SKIP TRANSACTION                        
*                                                                               
PTRN05   CLI   READIT,C'T'         READ TRANSACTIONS OR BUCKETS                 
         BNE   PTRNX                                                            
         L     R2,ADTRANS                                                       
         CLI   0(R2),X'44'                                                      
         BNE   PTRNX                                                            
...
OTHRLDGR DS    0H                                                               
         ...
         BNE   OL03                                                             
         CLI   D1PTYPE,RSTXNCMP    MUST BE NON EMPLOYEE COMP                    
         BNE   OLX                 NO, SKIP TRANSACTION                         
         B     OL05                                                             
*                                                                               
OL03     CLI   D1PTYPE,RSTXNCMP    1099-MISC, CAN'T BE NON EMPL COMP            
         BE    OLX                 YES, SKIP TRANSACTION                        
*                                                                               
OL05     CLI   READIT,C'T'      IF READING TRANSACTIONS DONT PUT HERE           
         BE    *+8                                                              
...
*                                                                               
         ...
         BNE   OL90                                                             
         ZAP   D1RAMT,TRNSAMNT                                                  
         XI    D1RAMT+L'D1RAMT-1,X'01' REVERSE SIGN                             
*        MP    D1RAMT,=P'-1'                                                    
*                                                                               
         LR    RF,R2                                                            
OL80     ZIC   R1,1(RF)                                                         
...
*                                                                               
REQLX    CLI   QOPT7,C'Y'          IF DOWNLOAD - MARK T99 RECORD                
         BE    *+12                                                             
         CLI   QOPT1,C'Y'          IF LIVE RUN - MARK T99 RECORD                
         BNE   REQLXX                                                           
...
*                                                                               
         CLI   QOPT3,C'T'          IS THIS A TEST FILE?                         
         BNE   DOT05                                                            
         MVC   TCPYADD1,SPACES     CLEAR COMPANY STREET ADDRESS                 
         MVC   TCPYADD2,SPACES               -   CITY + STATE + ZIP             
         MVC   TCONNM,SPACES                 -   CONTACT NAME                   
         MVC   TCPHONE,SPACES                -   PHONE NUMBER                   
         MVC   TCEMAIL,SPACES                -   EMAIL                          
         MVC   TCPYADD1(L'DADDRSTR),DADDRSTR                                    
         MVC   TCPYCTY(L'DADDRCTY),DADDRCTY CITY                                
         MVC   TCPYST,DADDRST               STATE                               
         MVC   TCPYZIP(L'DADDRZIP),DADDRZIP ZIP                                 
         MVC   TCONNM(L'CNTNAME),CNTNAME    TEST CONTACT NAME                   
         MVC   TCPHONE(L'CNTPHON),CNTPHON   TEST PHONE NUMBER                   
         MVC   TCEMAIL(L'CNTEMAIL),CNTEMAIL TEST EMAIL                          
         B     *+22                                                             
*                                                                               
DOT05    MVC   TCONNM,SRECCNM      AGENCY CONTACT NAME                          
...
*                                                                               
         ...
         MVC   TVNDNM(TVNDLENQ),SPACES  CLEAR VENDOR NAME AND ADDRESS           
         MVC   TVNDCNM,SPACES                    -   CONTACT NAME               
         MVC   TVNDCPH,SPACES                    -   CONTACT NUMBER             
         MVC   TVNDNM(L'DCPYNAME),DCPYNAME                                      
         MVC   TVNDADD(L'DADDRSTR),DADDRSTR                                     
         MVC   TVNDCTY(L'DADDRCTY),DADDRCTY                                     
         MVC   TVNDST,DADDRST                                                   
         MVC   TVNDZIP(L'DADDRZIP),DADDRZIP                                     
         MVC   TVNDCNM(L'CNTNAME),CNTNAME                                       
         MVC   TVNDCPH(L'CNTPHON),CNTPHON                                       
*                                                                               
         ...
         MVC   TCONNM(L'AGYNAME),AGYNAME                                        
         MVC   TCPHONE(L'AGYPHON),AGYPHON                                       
         MVC   TCEMAIL(L'AGYEMAIL),AGYEMAIL                                     
         MVC   TCPYADD1,SPACES     CLEAR COMPANY STREET ADDRESS                 
         MVC   TCPYADD2,SPACES               -   CITY + STATE + ZIP             
         MVC   TTRNNM,SPACES       CLEAR TRANSMITTER NAME                       
         MVC   TTRNNM(L'DCPYNAME),DCPYNAME                                      
         MVC   TCPYNM,TTRNNM       TRANSMITTER NAME AND COMPANY NAME            
         MVC   TCPYADD1(L'DADDRSTR),DADDRSTR                                    
         MVC   TCPYCTY(L'DADDRCTY),DADDRCTY                                     
         MVC   TCPYST,DADDRST                                                   
         MVC   TCPYZIP(L'DADDRZIP),DADDRZIP                                     
*                                                                               
...
*                                                                               
         ...
         MVC   AAMTCD,=CL16'1236'  AMOUNT CODES FOR 1099-MISC                   
         CLI   QAPPL,C'N'                                                       
         BNE   DOA10                                                            
         MVC   AFRMTYP,=C'NE'      1099-NEC                                     
         MVC   AAMTCD,=CL16'1'     AMOUNT CODES                                 
*                                                                               
DOA10    MVC   ACOMPNM,SPACES      CLEAR AGENCY NAME                            
         CLI   QOPT3,C'T'          IS THIS A TEST FILE?                         
         BNE   *+14                                                             
         MVC   ACOMPNM(L'DCPYNAME),DCPYNAME                                     
         B     *+10                                                             
         MVC   ACOMPNM,D1CNM       COMPANY NAME                                 
         ...
         CLI   QOPT3,C'T'          IS THIS A TEST FILE?                         
         BNE   DOA15                                                            
         MVC   ACADD1,SPACES       CLEAR AGENCY STREET ADDRESS                  
         MVC   ACADD2,SPACES                 -  CITY + STATE + ZIP              
         MVC   ACPHONE,SPACES                -  PHONE NUMBER                    
         MVC   ACADD1(L'DADDRSTR),DADDRSTR                                      
         MVC   ACADCTY(L'DADDRCTY),DADDRCTY                                     
         MVC   ACADST,DADDRST                                                   
         MVC   ACADZIP(L'DADDRZIP),DADDRZIP                                     
         MVC   ACPHONE(10),=C'2126335531'  TEST PHONE NUMBER                    
         B     *+10                                                             
DOA15    MVC   ACPHONE,SRECPHON    PHONE NUMBER                                 
...
*                                                                               
         CLI   QAPPL,C'N'           1099-NEC                                    
         BNE   WB02                                                             
         CLI   SVPTYPE,0            NON-EMPLOYEE COMPENSATION                   
         BNZ   EXIT                 NO, DON'T WANT IT                           
         B     WB04                                                             
*                                   1099-MISC                                   
WB02     CLI   SVPTYPE,0            NON-EMPLOYEE COMPENSATION                   
         BZ    EXIT                 YES, DON'T WANT IT                          
*                                                                               
WB04     CLI   QOPT2,C'Y'           SUPPRESS UNDER $600                         
...
WB05     UNPK  WORK(12),PAYERAMT                                                
         OI    WORK+11,X'F0'                                                    
*                                                                               
         MVC   BAMT1,WORK           PUT IT AMOUNT 1                             
         B     WB30                                                             
*                                                                               
...
*                                                                               
         CLI   QAPPL,C'N'           1099-NEC                                    
         BNE   WB30                                                             
         MVC   BAMT1,WORK          NON EMPLOYEE COMPENSATION (DEFAULT)          
         AP    BTOT1,PAYERAMT                                                   
*                                                                               
...
*                                                                               
DC100    DS    0H                                                               
         MVI   FIRSTPRT,C'Y'          IF NEW COMPANY, REALIGN FORMS.            
*        MVC   MSG,=CL10'CREC'                                                  
...
*                                                                               
         ...
         MVI   FORCECLR,C'Y'       CLEAR PRINT LINE.                            
         MVC   PAGE,=H'1'                                                       
         MVI   SPACING,1                                                        
         MVI   LINE,1                                                           
         MVC   SVSUBPRG,RCSUBPRG   SAVE PRINT OPTION                            
         MVI   RCSUBPRG,X'FF'                                                   
         GOTO1 ACREPORT                                                         
...
DFM200   LA    R9,SVSREC           REAL PRINT                                   
         ...
         CLI   FIRSTPRT,C'Y'       LINE-UP PATTERN FIRST-TIME                   
         BE    *+12                                                             
         CLI   QOPT1,C'Y'          IS THIS THE REPORT RUN?                      
         BNE   DFM210                                                           
         MVI   FORCEHED,C'Y'       FORCE NEW PAGE                               
         MVC   PAGE,=H'1'                                                       
         MVI   SPACING,1                                                        
         ...
         MVI   FIRSTPRT,C'N'       TURN OFF FIRST TIME SWITCH                   
*                                                                               
DFM210   CLI   QAPPL,C'N'          WANT 1099-NEC PRINTED                        
         BE    DFM300                                                           
         BAS   RE,PRNT             NO, PRINT 1099-MISC                          
         B     EXIT                                                             
*                                                                               
DFM300   BRAS  RE,PNEC             YES, PRINT 1099-NEC                          
         B     EXIT                                                             
         EJECT                                                                  
**********************************************************************          
* PRINT 1099 FORM                                                    *          
...
*                                                                               
         ...
         LA    R4,ADDRCSZ                                                       
         BRAS  RE,COMMAS           INSERT COMMA/SPACE CITY OUT                  
*                                                                               
...
*                                                                               
         TM    SVPTYPE,RSTXRENT+RSTXROYL+RSTXPRIZ+RSTXMEDC                      
         BZ    PRNTX                                                            
         TM    SVPTYPE,RSTXRENT                                                 
         BZ    *+8                                                              
         LA    R4,BFRENT           RENT                                         
...
PCREC05  EDIT  (P8,BTOTALS),(14,P+55),2,COMMAS=NO                               
PCREC07  GOTO1 ACREPORT                                                         
*                                                                               
PCREC10  GOTO1 ACREPORT                                                         
         ...
         MVC   P+31(9),=CL9'BTOT2 = '                                           
         EDIT  (P8,BTOT2),(14,P+40),2,COMMAS=NO                                 
         MVC   P+61(9),=CL9'BTOT3 = '                                           
         EDIT  (P8,BTOT3),(14,P+70),2,COMMAS=NO                                 
         MVC   P+91(9),=CL9'BTOT6 = '                                           
         EDIT  (P8,BTOT6),(14,P+100),2,COMMAS=NO                                
         GOTO1 ACREPORT                                                         
*                                                                               
...
*                                                                               
         ...
         MVC   PFOURTH+60(4),=C'1236'                                           
         CLI   QAPPL,C'N'                      1099-NEC                         
         BNE   FAREC10                                                          
         MVC   PTHIRD+50(L'DOCTYPN),DOCTYPN                                     
         MVC   PFOURTH+60(4),=C'1   '                                           
*                                                                               
FAREC10  MVI   SPACING,2                                                        
         GOTO1 ACREPORT                                                         
         B     FO10                                                             
         DROP  R5                                                               
*                                                                               
...
DAT      DC    C'DATE'                                                          
*                                                                               
DEFLTADR DS    0CL44               DEFAULT ADDRESS                              
DCPYNAME DC    CL10'MEDIAOCEAN'    DEFAULT COMPANY NAME                         
DADDRSTR DC    CL19'45 WEST 18TH STREET' STREET                                 
DADDRCSZ DS    0CL15               CITY STATE ZIP                               
DADDRCTY DC    CL8'NEW YORK'       CITY                                         
DADDRST  DC    CL2'NY'             STATE                                        
DADDRZIP DC    CL5'10011'          ZIP                                          
*                                                                               
TSTCNTCT DS    0CL71               TEST CONTACT                                 
CNTNAME  DC    CL11'RAJIV GUPTA'                NAME                            
CNTPHON  DC    CL10'2126335198'                 PHONE NUMBER                    
CNTEMAIL DC    CL50'RGUPTA@MEDIAOCEAN.COM'      EMAIL                           
*                                                                               
AGYCNTCT DS    0CL78               AGY CONTACT NAME/NUM                         
AGYNAME  DC    CL18'YANA NOVODVORSKAYA'         NAME                            
AGYPHON  DC    CL10'2126335838'                 PHONE NUMBER                    
AGYEMAIL DC    CL50'YNOVODVORSKAYA@MEDIAOCEAN.COM'  EMAIL                       
         EJECT                                                                  
**********************************************************************          
* TAPE DEFINITIONS                                                   *          
**********************************************************************          
...
*                                                                               
         DS    0D                                                               
AC99RQF  DCB   DSORG=PS,MACRF=PM,DDNAME=AC99RQF,RECFM=FB,              X        
...
**********************************************************************          
         SPACE 1                                                                
PNEC     NTR1  BASE=*,LABEL=*      CLEAR OUT BUFFER                             
         LA    R0,SPACES           A(SOURCE)                                    
         SR    R1,R1               L'SOURCE                                     
         ICM   R1,8,SPACES         PAD CHAR = C' '                              
         L     RE,ABUF1099         A(DESTINATION)                               
...
*                                                                               
         ...
         LA    R0,4                # INPUT LINES                                
         LA    R2,BFCMPAD1         FIRST LINE OF PRINT BUFFER                   
PNEC10   MVC   0(L'BFCMPAD1,R2),0(R3)                                           
         CLC   0(L'BFCMPAD1,R2),SPACES                                          
         JE    *+8                 SKIP A LINE ONLY IF SMTHNG PRNTED            
         LA    R2,132(R2)                                                       
         LA    R3,L'ADDRST(R3)                                                  
         BCT   R0,PNEC10                                                        
*                                                                               
         ...
         MVC   0(L'BFPHON1,R1),SRECPHON                                         
*                                                                               
PNEC20   MVC   BFCIDNO(2),SRECCID  COMPANY ID #  EX/ 99-9999999                 
         MVI   BFCIDNO+2,C'-'                                                   
         MVC   BFCIDNO+3(7),SRECCID+2                                           
*                                                                               
         CLI   D1SSORID,C'I'       IS IT A FED ID NO                            
         ...
         J     PNEC40                                                           
*                                                                               
PNEC30   MVC   BFSSNO(3),SRECRID   SOCIAL SECURITY NUMBER                       
         MVI   BFSSNO+3,C'-'                                                    
         MVC   BFSSNO+4(2),SRECRID+3                                            
         MVI   BFSSNO+6,C'-'                                                    
         MVC   BFSSNO+7(4),SRECRID+5                                            
...
*                                                                               
         MVC   BFRNAME,D1RNM       RECIPIENTS NAME / ADDRESS                    
*                                                                               
         LA    R4,BFNECAMT         NON EMPLOYEE COMPENSATION (BOX 1)            
         EDIT  (P6,D1RAMT),(12,(R4)),2                                          
*                                                                               
         CLC   D1RADLN1,SPACES     REMOVE BLANK LINES                           
         JNE   PNEC50                                                           
...
*                                                                               
         ...
         LA    R1,D1RADLN1         COUNT THE NUMBER OF LINES USED               
         LA    R2,0                                                             
PNEC60   CLC   0(L'D1RADLN1,R1),SPACES                                          
         JE    PNEC70                                                           
         LA    R2,1(R2)            INCREMENT COUNTER                            
         LA    R1,L'D1RADLN1(R1)   NEXT LINE                                    
         BCT   R0,PNEC60                                                        
*                                                                               
PNEC70   DS    0H                  R2 HAS #LINES                                
         OR    R2,R2                                                            
         JZ    PNEC100                                                          
         LA    R1,BFRADD2          FOR 1 OR 2 LINES OF ADDRESS                  
         C     R2,=F'1'            START ON 2ND LINE                            
...
PNEC80   DS    0H                                                               
         LA    R3,D1RADLN1                                                      
*                                                                               
PNEC90   MVC   0(L'BFRADD1,R1),0(R3)                                            
         LA    R1,132(R1)                                                       
         LA    R3,L'D1RADLN1(R3)                                                
         BCT   R2,PNEC90                                                        
*                                                                               
PNEC100  MVC   ADDRCSZ,D1RADLN4    CITY, STATE ZIP ALWAYS ON 4TH LINE           
         LA    R4,ADDRCSZ                                                       
         CLI   D1FORGN,C'Y'        NO EXTRA FORMATING FOR FOREIGN ADDRS         
         JE    *+8                                                              
         BRAS  RE,COMMAS           INSERT COMMA/SPACE CITY OUT                  
...
*                                                                               
         ...
         L     R6,ABUF1099         PRINT OUT 1099 FORM                          
         LA    R0,BFEQU            NUMBER OF LINES                              
PNEC110  MVC   P,0(R6)             MOVE IN PRINT LINE                           
         OC    P,SPACES            MAKE UPPER                                   
         BRAS  RE,WRITE                                                         
         LA    R6,132(R6)          BUMP TO NEXT LINE                            
         BCT   R0,PNEC110                                                       
*                                                                               
PNEC120  CLI   QOPT2,C'Y'           IF ITEMS<$600 = Y THEN DONT                 
         JNE   *+14                 PRINT ON INVALID ADDRESS REPORT             
         CP    D1RAMT,=P'60000'                                                 
         JL    PNECX                                                            
*                                                                               
         CLC   D1RADLN4,=CL40'*** INVALID ADDRESS ***'                          
...
*                                                                               
COMMAS   NTR1  BASE=*,LABEL=*      R4 POINTS AT INPUT                           
         MVI   WORK2,C' '                                                       
         MVC   WORK2+1(L'WORK2-1),WORK2                                         
         MVC   WORK2(29),0(R4)                                                  
...
BLDCPY50 CLI   QOPT3,C'R'          IS THIS A REPLACEMENT RUN                    
         JNE   BLDCPY25                                                         
*                                                                               
         LLC   R1,OFLLN            FETSH THE ELEMENT LENGTH                     
         SHI   R1,OFLLN1Q+1        SUBTRACT OVERHEAD TO GET THE OFFICE          
*                                  LIST DATA LENGTH                             
         L     RF,ACOFFLST         GET THE COMPANY OFFICE LIST                  
         EXMVC R1,0(RF),OFLNTRY                                                 
         AR    RF,R1               ADD THE OFFICE LIST LENGTH                   
         AHI   RF,1                                                             
         ST    RF,ACOFFLST         SAVE THE OFFICE LIST FOR FURTHER USE         
         J     BLDCPY25                                                         
*                                                                               
         USING FFTELD,R2                                                        
BLDCPY60 CLI   FFTTYPE,FFTTCNAM    NAME ELEMENT?                                
         ...
         CLI   BYTE,49                                                          
         BL    *+8                                                              
         LA    R1,49               MAXIMUM LENGTH OF FIELD IS 49                
...
BLDD2    NTR1                                                                   
         LA    R4,IO                                                            
         LA    RE,SVOFFL                                                        
         ST    RE,ASVOFFL          STORE THE ADDRESS FOR FURTHER USE            
         XC    SVSEQ#,SVSEQ#                                                    
*                                                                               
         LA    R2,T99RFST                                                       
BLDD210  CLI   0(R2),0             END OF RECORD?                               
         JE    BLDD220             NO D2 ELEM-ADD IT                            
*                                                                               
         CLI   0(R2),OFLELQ        FOUND D2-DEL IT AND RE-ADD IT                
         JNE   *+8                                                              
         MVI   0(R2),DELETEQ       MARK DELETE OFFICE ELEMENT                   
*                                                                               
         LLC   R1,1(R2)            READ NEXT ELEMENT                            
         AR    R2,R1                                                            
         J     BLDD210                                                          
*                                                                               
         USING OFLELD,R2                                                        
BLDD220  JAS   RE,DELIT            DELETE OFFICE ELEMENT AND REBUILD            
*                                                                               
BLDD230  LA    R2,ELEM                                                          
         XC    ELEM,ELEM                                                        
         MVI   OFLEL,OFLELQ        X'D2'                                        
*                                                                               
         LLC   RF,SVSEQ#           GET THE NEXT SEQ#                            
         AHI   RF,1                                                             
         STC   RF,SVSEQ#                                                        
*                                                                               
         MVC   OFLSEQ,SVSEQ#       START THE SEQ# WITH 1                        
         LHI   R0,COFFLNQ1         R0=LENGTH OF OFFICE LIST                     
*                                                                               
         L     R1,ASVOFFL          POINT TO OFFICE LIST                         
         SR    RE,RE                                                            
         TM    OFFSTAT,STASOFF2    TEST IF NEW OFFICE CODE IN EFFECT            
         BO    BLDD250                                                          
*                                                                               
...
*                                                                               
         ...
         BCT   R0,BLDD255                                                       
*                                                                               
BLDD260  L     RF,ASVOFFL          POINT TO THE SAVE OFFICE LIST                
         LR    R1,RE                                                            
         BCTR  R1,0                                                             
         EXMVC R1,OFLNTRY,0(RF)                                                 
*                                                                               
         AHI   R1,1                                                             
         AR    RF,R1               REACHING TO THE NEXT LIST                    
         ST    RF,ASVOFFL          STORE ADDRESS FOR NEXT OFFICE LIST           
*                                                                               
         AHI   R1,OFLLN1Q          ADD OVERHEAD TO GET THE ELEM LENGTH          
         STC   R1,OFLLN            PUT THE ELEMENT LENGTH                       
         JAS   RE,ADDL             ADD ELEMENT TO RECORD                        
*                                                                               
         CLI   0(RF),X'40'         DO WE HAVE MORE THAN 120 OFFICES?            
         JH    BLDD230             YES - GET NEXT SET OF OFFICES                
         J     BLDD2X              ELSE EXIT                                    
*                                                                               
BLDD2X   XIT1                                                                   
         DROP  R2,R4                                                            
...
REGHEAD  DS    0H                                                               
         ...
         CLI   QOPT7,C'Y'          DOWNLOADING                                  
         BE    REGHEADX                                                         
*        CLI   QOPT1,C'Y'          IS THIS THE LIVE RUN?                        
*        BNE   *+12                                                             
         CLI   RCSUBPRG,X'FF'                                                   
         BE    REGHEADX                                                         
         CLI   RCSUBPRG,4                                                       
         ...
         BNE   REGHEAD4                                                         
*                                                                               
REGHEAD2 MVC   HEAD3+9(36),SVCNM                                                
         B     REGHEADX                                                         
*                                                                               
REGHEAD4 MVC   HEAD1+75(5),SVTRID                                               
...
SAVER1   DS    A                   SAVE R1                                      
ASVOFFL  DS    A(SVOFFL)           SVOFFL                                       
ACOFFLST DS    A(COFFLIST)         COFFLIST                                     
DISP2    DS    H                   DISPLACEMENT TO ELEMENTS                     
SVSEQ#   DS    XL1                 SEQUENCE NUMBER                              
*                                                                               
REQUEST  DS    CL80                REQUEST CARD 1                               
REQUEST2 DS    CL80                REQUEST CARD 2                               
*                                                                               
...
COFFLIST DS    CL480               LIMITED ACCESS OFFICE LIST                   
COFFLNQ  EQU   (*-COFFLIST)        LENGTH OF OFFICE LIST                        
COFFLNQ1 EQU   (*-COFFLIST)/2      LENGTH OF 1ST OFFICE LIST = 240              
CCONTNM  DS    CL40                AGENCY CONTACT NAME                          
CPHONE   DS    CL15                AGENCY PHONE NUMBER                          
CEMAIL   DS    CL50                AGENCY CONTACT EMAIL                         
CTLENQ   EQU   (*-CPYTABD)                                                      
         EJECT                                                                  
***********************************************************************         
...
BFPRIZES DS    CL12                (PRIZES,AWARDS)                              
         ORG   BFPRIZES                                                         
BFNECAMT DS    CL12               1099-NEC NONEMPLOYEE COMP (BOX 1)             
         DS    CL1                                                              
...
BF20     DS    0CL132             **** LINE #20 ****                            
         ORG   BF20+132                                                         
*                                                                               
BF21     DS    0CL132             **** LINE #21 ****                            
         DS    CL5                                                              
BFRADD4  DS    CL33                (RECIPIENT'S ADDRESS #4)                     
         ORG   BF21+132                                                         
*                                                                               
BF22     DS    CL132              **** LINE #22 ****                            
*                                                                               
...
TCEMAIL  DS    CL50                CONTACT E-MAIL ADDRESS                       
         DS    CL91                                                             
...
TVNDLENQ EQU   *-TVNDNM            VENDOR NAME + ADDRESS LENGTH                 
...
ACCOID   DS    CL9                 EIN  BLANK ONLY FOR FOREIGN CORP             
         ...
         DS    CL1                 BLANK                                        
AFRMTYP  DS    CL2                 FORM TYPE (CONSTANT) 1099-MISC               
AAMTCD   DS    CL16                AMOUNT CODES (CONSTANT)                      
         DS    CL4                 BLANK                                        
...
BAMTD    DS    CL12                DOLLAR AMOUNT OF AMT D                       
BAMTE    DS    CL12                DOLLAR AMOUNT OF AMT E                       
BAMTF    DS    CL12                DOLLAR AMOUNT OF AMT F                       
BAMTG    DS    CL12                DOLLAR AMOUNT OF AMT G                       
...
BRECSEQ  DS    CL8                 RECORD SEQUENCE NUMBER                       
         ...
         DS    CL2                 BLANKS                                       
BLENQ    EQU   (*-BREC)                                                         
BSRCLIST DS    CL240               SOURCE LIST  (LENGTH/ACCT/AMOUNT)            
         EJECT                                                                  
***********************************************************************         
*               'C' RECORD DSECT                                      *         
***********************************************************************         
...
SRCELNQ  EQU   *-SRCED                                                          
SRCEMAX  EQU   11                  MAXIMUM NUMBER OF ACCTS TO SAVE              
         EJECT                                                                  
***********************************************************************         
...
SRECCEM  DS    CL50                COMPANY CONTACT EMAIL                        
*                                                                               
...
*ACQD                                                                           
       ...
       ++INCLUDE ACQD                                                           
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013ACREPTT02 01/19/21'                                      
         END                                                                    
