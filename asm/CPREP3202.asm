*          DATA SET CPREP3202  AT LEVEL 047 AS OF 05/10/05                      
*PHASE CP3202A                                                                  
*INCLUDE SORTER                                                                 
*INCLUDE EDITOR                                                                 
...
*                                                                               
PROD02   DS    0C                                                               
         CLI   CPKAFFIL,C'H'       EXCLUDE ALL HISPANIC                         
         BE    EXIT                                                             
         MVC   SRDEMO,CPKDEMO                                                   
         MVC   SRPRG,CPKPROG                                                    
         MVC   SRAFL,CPKAFFIL                                                   
...
PD22     CLI   REQSENT,C'Y'                                                     
         ...
         LA    R1,4(R1)                                                         
         MVI   0(R1),QUOTE                                                      
         MVI   1(R1),C'N'          NEW MACRO REQUEST RECORD                     
*---->   MVI   1(R1),C'R'          OLD MACRO REQUEST RECORD                     
         MVC   2(3,R1),=C'","'                                                  
         LA    R1,5(R1)                                                         
         MVC   0(2,R1),QAGY                                                     
         MVC   2(3,R1),=C'","'                                                  
...
CSVW04   LA    R9,0(R9,R8)        FIND END                                      
         ...
         BCT   R8,*-10                                                          
*                                                                               
CSVW06   MVI   0(R9),C' '          NO DATA, SEND A QUOTED SPACE                 
         B     CSVW08                                                           
*SVW06   BCTR  R9,0                NO DATA, BACK UP BEFORE QUOTE                
...
*        DC    C'LM',C' ',AL1(15)  LOWE/MARSCHALK 4/12/90                       
         DC    C'WI',C' ',AL1(15)  LCI                                          
         DC    C'MC',C' ',AL1(15)  LCI                                          
         DC    C'M1',C' ',AL1(15)  MFI                                          
         DC    C'NE',C' ',AL1(16)                                               
         DC    C'NW',C' ',AL1(17)                                               
         DC    C'OM',C' ',AL1(18)                                               
         DC    C'QJ',C' ',AL1(19)                                               
...
EDBLOCK  DSECT                                                                  
       ...
       ++INCLUDE CPGENFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'047CPREP3202 05/10/05'                                      
         END                                                                    
