*          DATA SET NESFM03A   AT LEVEL 071 AS OF 04/28/00                      
*PHASE T31C03A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
         MVC   TEMPDEM1(60),SVDEMLST STORE ALL DEMOS INTO ONE BLOCK             
...
DR110    MVC   DMCB+4(4),=X'D9000AE0'                                           
         ...
         DC    H'0'                                                             
         L     RF,DMCB                                                          
         GOTO1 (RF),(R1),(21,TEMPDEM1),(13,BLOCK),(C'S',ELEM),EUSRNMS           
         DROP  R4                                                               
*                                                                               
         LA    R2,TEMPDEM1                                                      
         LA    RF,BLOCK                                                         
...
**********************************************************************          
*                                                                               
DR310    MVC   ESTMENU,EDAYMENU      DAYPART MENU                               
         OI    ESTMENUH+6,X'80'                                                 
*                                                                               
**********************************************************************          
*                                                                               
...
VR540    MVC   DMCB+4(4),=X'D9000AD9'                                           
         ...
         DC    H'0'                                                             
         L     RF,DMCB                                                          
         GOTO1 (RF),(R1),(3,ESTDEMSH),(21,BLOCK),(C'S',(R5)),EUSRNMS            
         CLI   DMCB+4,0                                                         
         BNE   *+12                                                             
         L     R2,DMCB             POINT TO WHERE THE PROBLEM IS                
         B     ERRINV                                                           
*                                                                               
         CLI   DMCB+4,21             21 DEMOS?                                  
         BNE   VR545                                                            
         MVC   EDEMLST,BLOCK         FIRST 20 DEMOS GO HERE                     
         MVC   EDEM21,BLOCK+60       LAST ONE HERE                              
         B     VR550                                                            
*                                                                               
...
*                                                                               
*        CLC   0(3,R4),=X'00C97B'  CH6-11                                       
*        BNE   *+6                                                              
*        DC    H'00'                                                            
*                                                                               
*        CLC   0(3,R4),=X'00C922'  WM1524                                       
*        BNE   *+6                                                              
*        DC    H'00'                                                            
*                                                                               
*        CLC   0(3,R4),=X'00C92E'  WM2534                                       
*        BNE   *+6                                                              
*        DC    H'00'                                                            
*                                                                               
*        CLC   0(3,R4),=X'00C91D'  WM1234                                       
*        BNE   *+6                                                              
*        DC    H'00'                                                            
*                                                                               
         CLC   0(3,R5),=3X'00'                                                  
...
VR1090   NTR1  BASE=*,LABEL=*                                                   
         ...
         CLI   5(R2),0               REQUIRED                                   
         BNE   *+16                                                             
         MVI   8(R2),C'0'            FILL IN C'0' IF LEFT EMPTY                 
         MVI   5(R2),1                                                          
         OI    6(R2),X'80'                                                      
*                                                                               
...
*                                                                               
         ...
         MVC   KEY+4(1),EDAYMENU     DAYPART MENU                               
         GOTO1 HIGH                                                             
...
*                                                                               
         CLI   EMSTRIND,0            DAYPART MENU CANNOT BE CHANGED             
...
TEMPWGT3 DS    XL21                                                             
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'071NESFM03A  04/28/00'                                      
         END                                                                    
