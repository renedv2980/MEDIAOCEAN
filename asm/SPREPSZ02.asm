*          DATA SET SPREPSZ02  AT LEVEL 004 AS OF 08/01/13                      
*PHASE SPSZ02A                                                                  
*INCLUDE BINSRCH2                                                               
         TITLE 'PURGE MARKETS'                                                  
SPSZ02   CSECT                                                                  
...
FX100    DS    0H                                                               
         OC    TYPMCNT,TYPMCNT                                                  
         BNZ   FX102                                                            
         MVC   P1(30),=CL30'NO MARKETS WITH *PURGE FOUND'                       
         GOTO1 REPORT                                                           
         B     FINX                                                             
*                                                                               
FX102    LA    R6,MKTLST                                                        
...
FX230    MVC   P(15),0(R5)                                                      
         GOTO1 HEXOUT,DMCB,15(R5),P+20,3,=C'TOG'                                
         EDIT  STACOUNT,(10,P+50),COMMAS=YES,ALIGN=LEFT,ZERO=NOBLANK            
         GOTO1 REPORT                                                           
*                                                                               
...
FX640    MVC   P(15),0(R5)                                                      
         ...
         DROP  R5                                                               
*                                                                               
* DELETE THE K RECORDS (PASSIVE MASTER KEYS)                                    
FX700    DS    0H                                                               
         XC    KEY,KEY                                                          
         LA    R5,KEY                                                           
         USING STAREC,R5                                                        
         MVI   STKKTYPE,STKKTYPQ   C'K'                                         
         MVC   STKKAGY,QAGY                                                     
         MVC   STKKMED,QMED                                                     
         MVC   SAVEKEY,KEY                                                      
         GOTO1 HIGHSTA             READ FIRST RECORD.                           
...
FX730    DS    0H                                                               
         L     R5,ADSTAT              ADSTAT-->RECORD FOUND.                    
         CLC   STKKTYPE(4),SAVEKEY    TYP(1),AGY(2),MED(1)                      
         BNE   FX800                                                            
         MVC   MRKET,STKKMKT                                                    
         GOTO1 BINSRCH,BINPARMS,(0,MRKET)                                       
         CLI   BINPARMS,1          CHECK IF MARKET IN TABLE                     
...
FX740    MVC   P(15),0(R5)                                                      
         ...
         DROP  R5                                                               
*                                                                               
FX800    MVC   P1(18),=C'M-TYPE DELETED  = '                                    
         ...
         MVC   P1(18),=C'K-TYPE DELETED  = '                                    
         EDIT  TYPKCNT,(10,P1+25),COMMAS=YES,ALIGN=LEFT,ZERO=NOBLANK            
         MVI   P2,0                                                             
         GOTO1 REPORT                                                           
...
TYPKCNT  DS    F                   # OF TYPE-'K' RECORDS.                       
...
STACOUNT DS    F                   COUNTER FOR MASTER RECORDS                   
PASCOUNT DS    F                   COUNTER FOR PASSIVE K MASTER KEYS            
MRKET    DS    CL2                                                              
STATN    DS    CL5                                                              
SAVEKEY  DS    XL32                                                             
PASSKEY  DS    XL32                                                             
...
MKTRECD  DSECT                                                                  
       ...
       ++INCLUDE SPREPWORKD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004SPREPSZ02 08/01/13'                                      
         END                                                                    
