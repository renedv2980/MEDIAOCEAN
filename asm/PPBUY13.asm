*          DATA SET PPBUY13    AT LEVEL 091 AS OF 06/02/20                      
*PHASE T41113A                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
         TITLE 'PPBUY13 - OUTDOOR  BUY/DEL/CHA'                                 
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
...
*                                                                               
* KWAN 06/25/15 ADJUST STANDARD SPACE FOR PBT DRAFT ADD                         
*                                                                               
...
*                                                                               
* KWAN 02/07/11 FIX STANDARD SPACE DESCRIPTION FOR ADBUYER CHANGES              
*                                                                               
...
*                                                                               
* KWAN 09/29/10 REQUIRE STANDARD SPACE IF PROFILE IS SET                        
*                                                                               
* KWAN 07/29/10 ENABLE STANDARD SPACE DESCRIPTION FOR OUTDOOR                   
*                                                                               
...
*                                                                               
* KWAN 05/00/07 ADD DATE PASSIVE POINTERS                                       
*                                                                               
* KWAN 04/10/07 FIX BD & PD CHANGE VALIDATION FOR OPEN RATE ELEM                
*                                                                               
...
*                                                                               
* KWAN 10/04/05 DEL MAT= REPEAT PASSIVE FOR DEL, INS DATE CHG & AD CHG          
*                                                                               
* KWAN 08/19/05 COS2 FACTOR ROUNDING OPTION IN F0 PROFILE                       
*                                                                               
* KWAN 12/14/04 ADBUYER COMMENTS UPLOAD CHANGE INDICATOR FIX                    
*                                                                               
* SMYE 09/04    FOR PBDCDATE & PBDMDATE CHANGE NON-WORK DAY                     
...
*                                                                               
* KWAN 12/22/99 VALIDATING BUYS WITH EXCLUSION CLASS                            
*                                                                               
* KWAN 07/06/99 CHANGE ELEM (X'24') FOR CT, PV AND IMPS CHANGES                 
*                                                                               
* KWAN 05/20/99 REMOVE "SJ ONLY" FROM IMPRESSION OPTION                         
*                                                                               
* BPLA   5/99   COST2 CHANGES AND DELETED BUY COMMENT CHANGES                   
*                                                                               
* KWAN 04/02/99 ADD CODES FOR IMPRESSION OPTION (SJ ONLY)                       
*                                                                               
* KWAN 02/24/99 SET UP KEYWORD TABLE FOR LOOK UPS                               
*                                                                               
* BPLA 4/98     CHANGES FOR FROZEN CLIENTS                                      
*                                                                               
* BPLA 3/98     SFH FEATURE LIVE FOR ALL AGENCIES                               
*                                                                               
* BPLA 11/97    SAVE CHANGES TO SFH STATUS IN PCHGELEM                          
*                                                                               
* BPLA 11/97    USE VGETINS                                                     
*                                                                               
* BPLA 10/97    CHANGES FOR SFH BUYS (SPECIAL FINANCIAL HANDLING)               
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
T41113   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 WORK13X-WORK13D,T41113,RR=RE,CLEAR=YES                           
*                                                                               
         LR    R9,RC                                                            
         USING WORK13D,R9          R9 = A(GLOBAL STORAGE)                       
*                                                                               
         BASR  R8,0                                                             
         AHI   R8,GLOBALS-*                                                     
...
*                                                                               
         ...
         BRAS  RE,UPD              ADD UPLOAD ELEM IF NEEDED                    
*                                                                               
         CLC   =C'ZZZ',BUYPR                                                    
         BNE   *+16                                                             
         BRAS  RE,POL_P1                                                        
...
BUY_X    BRAS  RE,FMTTR                                                         
         ...
         CLC   =C'DL',TRCODE                                                    
         BE    ALLDONE                                                          
         BRAS  RE,FMTSHOW          REFORMAT SHOW,REG,ILLUM                      
         GOTOR FMT_PACK,PBDREG                                                  
         GOTOR FMT_PACK,PBDILLUM                                                
         BRAS  RE,FMTRTM                                                        
*                                                                               
         BRAS  RE,FMTDTES          CLOSE DATE + MAT CLOSE                       
         XC    UPID,UPID                                                        
         MVI   UPLSW,0                                                          
         B     ALLDONE                                                          
         EJECT                                                                  
...
FMTDTES  LR    R0,RE                                                            
         L     R2,TRADDR                                                        
         LHI   RF,7               CURSOR TO CLOSING DATE                        
         BRAS  RE,BUMPFLDS                                                      
         CLI   5(R2),0                                                          
         JNE   FMTDTES2                                                         
         OC    PBDCDATE,PBDCDATE                                                
...
FMTDTES2 BRAS  RE,BUMPFLD          POINT TO MAT CLOSE DATE                      
         CLI   5(R2),0                                                          
         JNE   FMTDTESX                                                         
...
*                                                                               
         ...
         CLI   SVSCRN,X'F7'        TEST LIST BUYING                             
         BH    ALLDONE2                                                         
         LA    R2,BUYPBH           PUT CURSOR TO PUB                            
         B     EXIT                                                             
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
P_BUYCHG NTR1  BASE=*,LABEL=*      PROCESS NEW BUY & CHANGE BUY                 
*                                                                               
         BRAS  RE,BLDREC                                                        
         CLI   8(R2),C'C'                                                       
         BNE   P_BC20                                                           
...
P_BC20   BRAS  RE,EDTINS           EDIT INSERTION DATE                          
         ...
         BRAS  RE,EDTSHOW          EDIT SHOWING                                 
         JNE   EXIT                                                             
         BRAS  RE,EDTREG           EDIT REGULAR DISPLAY                         
         JNE   EXIT                                                             
         BRAS  RE,EDTILL           EDIT ILLUMINATED PANEL                       
         JNE   EXIT                                                             
         ...
         MVC   PBDCDATE,DUB                                                     
         BRAS  RE,EDTDT            EDIT MAT CLOSE DATE                          
         BRAS  RE,CGWRKDT          NON-WORK DAY TEST AND ADJUST                 
         MVC   PBDMDATE,DUB                                                     
*                                                                               
...
P_BC_ER1 LA    R3,INVRTERR                                                      
         LHI   RF,6                CURSOR TO RATE                               
         B     P_BC_ERR                                                         
*                                                                               
P_BC_ER2 LA    R3,MSSNGERR                                                      
         LHI   RF,7                CURSOR TO CLOSE DATE                         
         B     P_BC_ERR                                                         
*                                                                               
P_BC_ER3 LA    R3,MSSNGERR                                                      
         LHI   RF,8                CURSOR TO MAT CLOSING DATE                   
         B     P_BC_ERR                                                         
*                                                                               
...
P_CHG26  LA    R7,PBDBFD-NEWREC+REC                                             
         MVC   0(1,R7),PBDBFD                                                   
         LA    R7,PBDSHOW-NEWREC+REC                                            
         CLC   PBDSHOW(9),0(R7)      SAME SHOW,REG,ILLUM (PL3 EACH)?            
         BE    P_CHG26K                                                         
*                                                                               
...
*                                                                               
         ...
         BE    P_CHG28                                                          
         OC    PBDSDATE,PBDSDATE   OVERRIDDEN SALE DATE?                        
         BZ    P_CHG28                                                          
         MVC   0(3,R7),PBDSDATE                                                 
         OI    CHGIND2,X'40'       SALE DATE CHANGE                             
*                                                                               
* MUST SEE IF "*" IS BEING REMOVED FROM FIRST COMMENT ELEMENT                   
* (17 CHARACTERS LONG OR LESS) IF THERE IS NO SHOWING                           
*                                                                               
P_CHG28  MVI   WORK,0              INDICATOR FOR "*" REGULAR COMMENT            
         CLC   PBDSPACE-NEWREC+REC(4),=X'FF00000C'                              
         BNE   P_CHG30                                                          
         LA    R5,REC+33                                                        
         MVI   ELCODE,X'66'                                                     
         BRAS  RE,NXTELEM          FOUND FIRST REGULAR COMMENT?                 
         BNE   P_CHG30                                                          
         CLI   1(R5),17+2                                                       
         BH    P_CHG30                                                          
         CLI   2(R5),C'*'                                                       
...
*                                                                               
P_CHG34B CHI   R4,10               FIRST COMMENT?                               
         BNE   P_CHG34C                                                         
         CLI   0(R7),X'66'         REGULAR COMMENT?                             
         BNE   P_CHG34C                                                         
         CLI   1(R7),2             DELETED COMMENT?                             
         BE    P_CHG34C                                                         
         CP    PBDSHOW,=P'0'       HAVE SPACE IN FIRST COMMENT?                 
         BNE   P_CHG34C                                                         
         CLI   1(R7),17+2          COMMENT LONGER THAN SPACE DESP?              
         BH    P_CHG34C                                                         
         CLI   WORK,0              IS THIS AN '*' OR '#' INSERTION?             
         BE    P_CHG34H                                                         
         CLI   2(R7),C'*'          STILL AN '*' INSERTION?                      
         BE    P_CHG34H                                                         
         CLI   2(R7),C'#'          STILL AN '#' INSERTION?                      
         BE    P_CHG34H                                                         
         BRAS  RE,COM              FIRST DO COMPETITIVE BRAND CHECK             
         BRAS  RE,ASC              AUTO SCHEDULE CHECKING                       
         B     P_CHG34H            REALLY A SPACE DESCRIPTION CHANGE            
*                                                                               
P_CHG34C CLI   WORK,0              IS THIS AN '*' OR '#' INSERTION?             
         BE    P_CHG34D                                                         
         BRAS  RE,COM              FIRST DO COMPETITIVE BRAND CHECK             
         BRAS  RE,ASC              AUTO SCHEDULE CHECKING                       
*                                                                               
...
P_CHG42A BRAS  RE,NXTELEM                                                       
         ...
         B     P_CHGE_7                                                         
*                                                                               
P_CHG42B MVI   ELCODE,X'28'        OPEN BILLING ELEM CODE                       
         LA    R5,REC+33                                                        
P_CHG42C BRAS  RE,NXTELEM                                                       
         BNE   P_CHG42D                                                         
         OC    5(3,R5),5(R5)                                                    
         BZ    P_CHG42C                                                         
         TM    10(R5),X'C0'        IGNORE REVERSALS & REVERSED ELEMS?           
         BNZ   P_CHG42C                                                         
         B     P_CHGE_7                                                         
*                                                                               
P_CHG42D CP    PBDCD,=P'0'         CASH DISCOUNT PRESENT?                       
         BE    P_CHG43D                                                         
         CP    PBDCD,=P'1'         CD OVERRIDE?                                 
         BNE   *+10                                                             
         ZAP   PBDCD,=P'0'         RESET TO REAL VALUE                          
         LA    R7,PBDCD-NEWREC+REC                                              
         CLC   PBDCD,0(R7)         CASH DISCOUNT CHANGED?                       
         BE    P_CHG43D                                                         
         TM    MATSW,X'C0'         MATCHED?                                     
         BM    P_CHGE_6            MIXED - MATCHED/NOT PAID                     
         MVC   0(L'PBDCD,R7),PBDCD                                              
         OI    CHGIND2,X'02'       CASH DISCOUNT CHANGED                        
         MVC   TRCODE,=C'RZ'                                                    
*                                                                               
P_CHG43D CP    PBDACP,=P'0'        AC PRESENT?                                  
         BE    P_CHG44                                                          
         CP    PBDACP,=P'1'                                                     
         BNE   *+10                                                             
         ZAP   PBDACP,=P'0'                                                     
...
*                                                                               
         ...
         MVI   8(RE),C'C'          RESET TO CHANGE                              
*                                                                               
P_CHG43G MVC   0(L'PBDACP,R7),PBDACP                                            
         OI    CHGIND2,X'04'                                                    
         MVC   TRCODE,=C'RZ'                                                    
*                                                                               
P_CHG44  LA    R7,PBDPLCOS-NEWREC+REC                                           
         CLC   PBDPLCOS,0(R7)      PLANNED COST CHANGED?                        
         BE    P_CHG44F                                                         
         OC    PBDPLCOS,PBDPLCOS   HAVE PLANNED COST?                           
         BZ    P_CHG44F                                                         
         OI    CHGIND3,X'10'       PLANNED COST HAS BEEN CHANGED                
         LA    RE,PBDDTIN3-NEWREC+REC                                           
         OI    0(RE),X'10'         PLANNED COST LAST CHANGED                    
         CLI   PBDPLCOS,X'FF'      NONE?                                        
         BNE   *+10                                                             
...
P_CHG54W LR    R5,R7               RESTORE NEWREC'S R5                          
         ...
         B     P_CHG54B                                                         
*                                                                               
P_CHG55  LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'81'        DAILY EFFECTIVE CIRCULATION                  
P_CHG55B BRAS  RE,NXTELEM                                                       
         BNE   P_CHG57                                                          
         CLI   2(R5),C'X'          SPECIAL DELETION CODE?                       
         BE    P_CHG55P                                                         
         CLC   REC+25(2),=H'3900'  ALMOST MAXIMUM REC SIZE?                     
         BNL   P_CHGE_B                                                         
         LR    R7,R5               SAVE NEWREC'S R5                             
         ...
         BRAS  RE,NXTELEM                                                       
         BNE   P_CHG55J                                                         
         CLC   0(10,R5),0(R7)      SAME DAILY EFFECTIVE CIRCULATION?            
         BE    P_CHG57                                                          
         MVC   0(10,R5),0(R7)      USE OLD ELEM                                 
         B     P_CHG55W                                                         
P_CHG55J GOTO1 VRECUP,DMCB,(1,REC),(R7),(R5)                                    
         B     P_CHG55W                                                         
P_CHG55P LR    R7,R5               SAVE NEWREC'S R5                             
         SR    R4,R4                                                            
         LA    R5,REC+33                                                        
P_CHG55Q BRAS  RE,NXTELEM                                                       
         BE    P_CHG55S                                                         
         LTR   R4,R4               DAILY EFFECTIVE CIRCULATION FOUND?           
         BZ    P_CHGE_3                                                         
         B     P_CHG55U            GO DELETE ELEM                               
P_CHG55S LR    R4,R5               ADDR OF ELEM TO DELETE                       
         B     P_CHG55Q                                                         
P_CHG55U GOTO1 VRECUP,DMCB,(1,REC),(R4)                                         
P_CHG55W LR    R5,R7               RESTORE NEWREC'S R5                          
         B     P_CHG55B            BACK FOR MORE (SHOULD NOT BE ONE)            
*                                                                               
P_CHG57  LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'85'        NUMBER OF REPAINT ELEM CODE                  
P_CHG57B BRAS  RE,NXTELEM                                                       
         BNE   P_CHG60                                                          
         CLI   2(R5),C'X'          SPECIAL DELETION CODE?                       
         BE    P_CHG57P                                                         
         CLC   REC+25(2),=H'3900'  ALMOST MAXIMUM REC SIZE?                     
         ...
         BRAS  RE,NXTELEM                                                       
         BNE   P_CHG57J                                                         
         CLC   0(5,R5),0(R7)       SAME NUMBER OF REPAINT?                      
         BE    P_CHG60                                                          
         MVC   0(5,R5),0(R7)       CAN JUST MOVE IN NEW ELEM                    
         B     P_CHG57W                                                         
P_CHG57J GOTO1 VRECUP,DMCB,(1,REC),(R7),(R5)                                    
         B     P_CHG57W                                                         
P_CHG57P LR    R7,R5               SAVE NEWREC'S R5                             
         SR    R4,R4                                                            
         LA    R5,REC+33                                                        
P_CHG57Q BRAS  RE,NXTELEM                                                       
         BE    P_CHG57S                                                         
         LTR   R4,R4               REPAINT ELEM FOUND?                          
         BZ    P_CHGE_3                                                         
         B     CHG19U              GO DELETE ELEM                               
P_CHG57S LR    R4,R5               SAVE ADDR OF RPT ELEM TO DELETE              
         B     P_CHG57Q                                                         
CHG19U   GOTO1 VRECUP,DMCB,(1,REC),(R4)                                         
P_CHG57W LR    R5,R7               RESTORE NEWREC'S R5                          
         B     P_CHG57B            BACK FOR MORE (SHOULD NOT BE ONE)            
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTSHOW  NTR1  BASE=*,LABEL=*      EDIT SHOWING                                 
*                                                                               
         BRAS  RE,BUMPFLD                                                       
         LA    R3,INVERR                                                        
         MVI   PBDSPACE,X'FF'                                                   
         ...
         B     EDTSX                                                            
*                                                                               
EDTS1    TM    4(R2),X'08'       TEST NUMERIC                                   
         JZ    ERROR                                                            
         SR    RE,RE                                                            
         IC    RE,5(R2)                                                         
         BCTR  RE,0                                                             
         ...
         JH    ERROR                                                            
*                                                                               
EDTSX    J     SCCEQ_R             R2 POINTS TO SHOWING FIELD                   
*                                                                               
         DROP  RB                                                               
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTREG   NTR1  BASE=*,LABEL=*      EDIT REGULAR DISPLAY                         
*                                                                               
         BRAS  RE,BUMPFLD                                                       
         ZAP   PBDREG,=P'0'                                                     
         CLI   5(R2),0                                                          
         ...
         CP    PBDREG,=P'0'                                                     
         BNE   EDTRX                                                            
         ZAP   PBDREG,=P'99999'    SUPPRESS RATELOOK                            
*                                                                               
EDTRX    J     SCCEQ_R             R2 POINTS TO REGULAR DISPLAY FIELD           
*                                                                               
         DROP  RB                                                               
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTILL   NTR1  BASE=*,LABEL=*      EDIT ILLUMINATED PANEL                       
*                                                                               
         BRAS  RE,BUMPFLD                                                       
         ZAP   PBDILLUM,=P'0'                                                   
         CLI   5(R2),0                                                          
         ...
         CP    PBDILLUM,=P'0'                                                   
         BNE   EDTIX                                                            
         ZAP   PBDILLUM,=P'99999'  SUPPRESS RATELOOK                            
*                                                                               
EDTIX    J     SCCEQ_R             R2 POINTS TO ILLUMINATED PANEL FLD           
*                                                                               
         DROP  RB                                                               
         EJECT                                                                  
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTRTM   NTR1  BASE=*,LABEL=*      EDIT OUTDOOR RATES                           
*                                                                               
         LA    R3,INVRTERR                                                      
         BRAS  RE,BUMPFLD                                                       
         MVI   PBDCOSIN,C' '                                                    
         MVI   PBDCTYP,0                                                        
         NI    PBDRLIND,X'F7'      SET OFF FORZEN BIT                           
         CLI   5(R2),0                                                          
         JE    SCCEQ_R                                                          
         SR    R7,R7                                                            
         IC    R7,5(R2)                                                         
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FMTSHOW  NTR1  BASE=*,LABEL=*      FORMAT SHOWING                               
*                                                                               
         L     R2,TRADDR                                                        
         LHI   RF,3                                                             
         BRAS  RE,BUMPFLDS                                                      
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FMT_PACK NTR1  BASE=*,LABEL=*      FORMAT PACKED                                
*                                                                               
         LR    R3,R1               SAVE FORMATTING FIELD                        
         BRAS  RE,BUMPFLDS                                                      
         CLI   5(R2),0                                                          
         JNE   SCCEQ_R                                                          
...
FIXERR2  LA    R3,INVERR           NO ELEMENT IS FOUND                          
         L     R2,TRADDR                                                        
         LA    RF,10                                                            
         BRAS  RE,BUMPFLD          POINT R2 TO ERROR FIELD                      
         B     FIXRERR                                                          
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
BEXCL    NTR1  BASE=*,LABEL=*      PRD EXCLUSION CLASS VALIDATION               
*                                                                               
         CLI   BYPROF+6,0                                                       
...
*                                                                               
         ...
         CLI   BYPROF+7,C'R'       CHANGE ALLOWED?                              
         BE    CKR20                                                            
CKR05    CLI   BYPROF+7,C'B'       BOTH CHANGE AND DELETE ALLOWED?              
         BE    CKR20                                                            
         B     CKRXX                                                            
*                                                                               
CKR10    CHI   R1,2                DELETING?                                    
         ...
         CLI   BYPROF+7,C'D'       DELETE ALLOWED?                              
         BE    CKR20                                                            
         B     CKR05                                                            
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
FMTRTM   NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         L     R2,TRADDR                                                        
         LA    RF,6                                                             
         BRAS  RE,BUMPFLDS         CURSOR TO RATE                               
*                                                                               
         CLI   5(R2),0                                                          
         BNE   FMTRTMX                                                          
         MVI   X,C' '                                                           
...
*                                                                               
         ...
         SRA   R1,1                                                             
*                                                                               
FMTRTM4  EDIT  (R1),(9,X+5),2,ALIGN=LEFT,FLOAT=-                                
         LA    R1,X+5                                                           
...
*                                                                               
EDTC0    CP    PBDSHOW,=P'0'       SEE IF SPACE IN FIRST COMMENT                
         BE    EDTC1B              YES MUST UNVALIDATE COMMENTS                 
         LA    R3,5                                                             
...
EDTCOMAA ZIC   R1,5(R2)                                                         
         ...
         AHI   RE,-4                                                            
         LA    R4,12(R2)           PASS SRC= AND POINT TO COMMENT               
         B     EDTCOM2                                                          
*                                                                               
...
EDTCOM2D BCTR  RE,0                                                             
         ...
         LA    RF,2                FOR BCT                                      
         MVI   60(R7),X'66'                                                     
         STC   R0,61(R7)           STORE LENGHT                                 
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVC   62(0,R7),0(R4)                                                   
EDTCOM3  CP    PBDSHOW,=P'0'       SPACE IN COMMENT?                            
         BE    EDTCOM4                                                          
         OC    INSDA,INSDA         ADD?                                         
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTPLCOS MVI   PBDPLCOS,X'FF'      EDIT PLANNED COST, SET PC=NONE               
         CLC   =C'NONE',11(R2)                                                  
         JE    EDTPLC4                                                          
         LA    R3,INVERR                                                        
         ...
         STCM  RF,15,PBDPLCOS                                                   
*                                                                               
EDTPLC4  MVC   TRCODE,=C'RZ'       SET FOR EXPANDED RECALL                      
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTTAX   OC    PBDTAX,PBDTAX       EDIT TAX OVERRIDE                            
         JNZ   ERROR                                                            
         LHI   R3,NOFRZCER         NO FINANCIAL CHANGES TO FRZ CLIENT           
         BRAS  RE,CKCLTFRZ         CLIENT FROZEN OPTION FOUND?                  
         JNE   ERROR                                                            
         ...
         MVC   PBDTAX,5(R1)                                                     
*                                                                               
EDTTAX4  CLI   SVESPROF+28,C'C'    'C' RATE ESTIMATE?                           
         JNE   EDTTAX6                                                          
         CLC   PBDTAX,=X'000001'   MUST BE ZERO                                 
         JNE   ERROR                                                            
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTCU    OC    PBDCU,PBDCU         EDIT CONTRACT UNITS                          
         JNZ   ERROR                                                            
...
*                                                                               
         ...
         JZ    EDTCU4                                                           
         JM    ERROR                                                            
         C     RF,=F'1'            .0001 IS INVALID SINCE 0 IS CARRIED          
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTCCD   CP    PBDCD,=P'0'         EDIT CASH DISCOUNT OVERRIDE                  
         JNE   FLDINV                                                           
         LHI   R3,NOFRZCER         NO FINANCIAL CHANGES TO FRZ CLIENT           
         BRAS  RE,CKCLTFRZ         CLIENT FROZEN OPTION FOUND?                  
         JNE   ERROR                                                            
...
EDTSREP  BRAS  RE,EDTSR                                                         
         ...
         J     NEXTD                                                            
*                                                                               
EDTLW    MVI   WORK,X'94'          LEGAL WARNINGS                               
         BRAS  RE,CHKLW                                                         
         JNE   EXIT                                                             
         J     NEXTD                                                            
*                                                                               
EDTTRAFF BRAS  RE,CHKNTRA          NO TRAFFIC                                   
         ...
         J     NEXTD                                                            
*                                                                               
EDTORATE BRAS  RE,EDTOR            EDIT OPEN RATE OVERRIDE                      
         JNE   EXIT                                                             
         J     NEXTD                                                            
*                                                                               
EDTCSHDT BRAS  RE,EDTSHIP          EDIT DATE                                    
         JNE   EXIT                                                             
         J     NEXTD                                                            
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTDLC   DS    0H                  EDIT DAILY EFFECTIVE CIRCULATION             
         LA    R4,8+5(R2)          POINT TO INPUT                               
         LA    R3,INVERR                                                        
         ZIC   R5,5(R2)                                                         
         AHI   R5,-4               ADJUST INPUT LENGTH (FOR DLC=)               
         JP    EDTDLC4                                                          
         XC    DUB,DUB                                                          
         MVI   DUB,C'X'            SPECIAL DELETE CODE                          
         L     R1,TRADDR                                                        
         CLI   8(R1),C'B'          SEE IF BUYING                                
         JE    ERROR               ERROR WHEN BUYING                            
         J     EDTDLC10                                                         
EDTDLC4  CHI   R5,11               MAX IS 999,999,999                           
         JH    ERROR                                                            
         LA    R3,INVERR                                                        
         ZIC   R0,5(R2)            LENGTH OF FIELD                              
         AHI   R0,-4               ADJUST FOR DLC=                              
         GOTO1 VCASHVAL,DMCB,(C'0',12(R2)),(R0)                                 
         CLI   0(R1),X'FF'                                                      
         JE    ERROR                                                            
         CP    4(8,R1),=P'999999999'                                            
         JH    ERROR                                                            
         ZAP   DUB(6),4(8,R1)                                                   
EDTDLC10 LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'81'                                                     
         BRAS  RE,NXTELEM                                                       
         BNE   EDTDLC20            MUST ADD ONE                                 
         LA    R3,INVERR                                                        
         J     ERROR               CAN'T ALREADY HAVE DLC ELEM                  
EDTDLC20 XC    WORK+10(10),WORK+10                                              
         MVC   WORK+10(2),=X'810A' CODE AND LENGHT                              
         MVC   WORK+12(6),DUB      REP CODE OR C'X'                             
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTRPT   DS    0H                  EDIT NUMBER OF REPAINTS                      
         LA    R4,8+5(R2)          POINT TO INPUT                               
         LA    R3,INVERR                                                        
         ZIC   R5,5(R2)                                                         
         AHI   R5,-4               ADJUST INPUT LENGTH (FOR RPT=)               
         JP    EDTRPT4                                                          
         MVI   DUB+3,C'X'          SPECIAL DELETE CODE                          
         L     R1,TRADDR                                                        
         CLI   8(R1),C'B'          SEE IF BUYING                                
         JE    ERROR               CAN'T DELETE IF BUYING                       
         J     EDTRPT10                                                         
EDTRPT4  CHI   R5,3                MAX IS 999                                   
         JH    ERROR                                                            
         LA    R3,INVERR                                                        
         ZIC   R0,5(R2)            LENGTH OF FIELD                              
         AHI   R0,-4               ADJUST FOR RPT=                              
         ...
         DP    DUB,=P'100'                                                      
         CP    DUB+6(2),=P'0'                                                   
         JNE   ERROR               MUST GET REMAINDER 0 (NO DECIMALS)           
EDTRPT10 LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'85'                                                     
         BRAS  RE,NXTELEM                                                       
         JNE   EDTRPT20            MUST ADD ONE                                 
         LA    R3,INVERR                                                        
         J     ERROR               CAN'T ALREADY HAVE RPT ELEM                  
EDTRPT20 XC    WORK+10(10),WORK+10                                              
         MVC   WORK+10(2),=X'8505' CODE AND LENGHT                              
         MVC   WORK+12(3),DUB+3                                                 
         GOTO1 VRECUP,DMCB,(1,NEWREC),WORK+10,(R5)                              
EDTRPT30 J     NEXTD                                                            
         EJECT                                                                  
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTREF   DS    0H                  EDIT REFERENCE NUMBER                        
...
EDTREF6  CHI   R5,10               SJR + OTHERS - MAX IS 10 CHARS               
         JH    ERROR                                                            
         MVC   WORK(10),0(R4)                                                   
EDTREF10 LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'83'                                                     
         BRAS  RE,NXTELEM                                                       
         JNE   EDTREF20            MUST ADD ONE                                 
         LA    R3,INVERR                                                        
...
EDTCBLDT LA    R4,PBDBDATE         BILLABLE DATE FORMAT IS MMMDD/YY             
         ...
         JE    *+12                                                             
         TM    T411FFD+12,X'80'    NO "BD=" ACCESS?                             
         JO    ACCERROR                                                         
         LA    R5,11(R2)                                                        
         MVI   BYTE,0                                                           
         J     EDTCDT                                                           
...
*                                                                               
KEYWTAB  DC    AL1(01),CL7'C=     ',AL4(00)                                     
         DC    AL1(01),CL7'D=     ',AL4(00)                                     
         DC    AL1(02),CL7'IC=    ',AL4(00)                                     
         DC    AL1(02),CL7'PI=    ',AL4(00)                                     
         DC    AL1(02),CL7'SRC=   ',AL4(00)                                     
         DC    AL1(03),CL7'DLC=   ',AL4(EDTDLC)                                 
         DC    AL1(03),CL7'RPT=   ',AL4(EDTRPT)                                 
...
*                                                                               
CHKNTERR J     ERROR               NOT EQUAL (ERROR)                            
*                                                                               
         DROP  RB                                                               
         EJECT                                                                  
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTSHIP  NTR1  BASE=*,LABEL=*      EDIT DATE                                    
*                                                                               
         LA    R4,8+3(R2)          POINT TO INPUT                               
         LA    R3,INVERR                                                        
         XC    WORK(20),WORK                                                    
         ZIC   R5,5(R2)                                                         
...
EDTSHP4X DS    0H                                                               
*                                                                               
EDTSHP10 DS    0H                  NOW STORE IN PBSHPDEL                        
         LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'86'                                                     
         CLI   BYTE2,X'96'         EXTENSION DATE?                              
         BNE   *+8                                                              
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
EDTOR    NTR1  BASE=*,LABEL=*      EDIT OPEN RATE OVERRIDE                      
*                                                                               
         LA    R3,INVERR                                                        
         CLI   SVESPROF+30,C'Y'    FINANCIAL CLIENT (SET IN T41101)?            
         JNE   ERROR                                                            
*                                                                               
         LA    R3,INVRTERR         ONLY FIN CLT CAN HAVE OPEN RATES             
...
EDTOR8D  XC    X(15),X                                                          
         ...
         LA    R3,X                                                             
         USING PORELEMD,R3                                                      
         CLC   11(3,R2),=C'CON'    USING CONTRACT RATE?                         
         BNE   EDTOR8G                                                          
         MVC   PORCOS,PBDCOS                                                    
         MVI   PORCOSTY,C'C'       TO USE CONTRACT RATES                        
         B     EDTOR10                                                          
*                                                                               
EDTOR8G  ZAP   PORCOS,DUB                                                       
         LTR   R0,R0               IF OPEN RATE IS FREE, PBDCOS MUST            
         BNZ   EDTOR9              ALSO BE FREE  (=.00001)                      
         ZAP   PORCOS,=P'1'                                                     
         CP    PBDCOS,=P'1'                                                     
         BE    EDTOR9                                                           
         LA    R3,INVRTERR                                                      
...
EDTOR10  LA    R5,NEWREC+33                                                     
         MVI   ELCODE,X'30'        ALREADY HAVE OPEN RATE ELEM?                 
         BRAS  RE,NXTELEM                                                       
         BNE   EDTOR12                                                          
         LA    R3,INVERR                                                        
         J     ERROR                                                            
*                                                                               
EDTOR12  GOTO1 VRECUP,DMCB,(1,NEWREC),X,(R5)                                    
*                                                                               
EDTORX   J     SETCCEQ                                                          
*                                                                               
         DROP  RB,R3                                                            
...
*                                                                               
         ...
         AHI   R0,-1                                                            
         LA    R5,1(R5)                                                         
EDTPAC4B CLC   =C'DEL',0(R5)       SEE IF IMPS=DEL OR EIMPS=DEL                 
...
EDTPAC4C CLI   WORK,X'93'          SEE IF ACTUAL IMPRESSION                     
         ...
         LA    R5,3(R5)                                                         
         CLC   =C'DEL',0(R5)       SEE IF AIMPS=DEL                             
         BE    EDTPAC2X            NO NEED TO VALIDATE FURTHER                  
         B     EDTPAC4J                                                         
*                                                                               
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
CKUPLID  NTR1  BASE=*,LABEL=*      EDIT UPLOAD ID                               
*                                                                               
         LA    R3,INVERR                                                        
         CLI   MADSW,C'Y'          PBU?                                         
         JE    ERROR                                                            
...
*                                                                               
         ...
         J     SETCCEQ                                                          
*                                                                               
ACCERROR LA    R3,FACCERR          FUNCTION LIMIT ACCESS ERROR                  
         J     ERROR                                                            
*                                                                               
FLDINV   LA    R3,INVERR                                                        
         J     ERROR                                                            
...
*                                                                               
         ...
         BNE   CKSPDX              NO NEED TO LOOK UP SPC DESP RECORD           
*                                                                               
         CLI   DDLINKSW,0          ADBUYER?                                     
         BNE   CKSPD10                                                          
         LA    R2,BUYTR1H                                                       
         LHI   RF,10               POINT TO FIRST OPTIONAL DATA FIELD           
         BRAS  RE,BUMPFLDS                                                      
         CLI   5(R2),0             ANY INPUT?                                   
         BNH   CKSPD18                                                          
         CLI   5(R2),L'PBDSPACE    NOT A SPACE DESCRIPTION?                     
         BH    CKSPDX                                                           
         XC    S.CKSPWORK,S.CKSPWORK                                            
         LLC   RF,5(R2)                                                         
         BCTR  RF,0                                                             
         BASR  RE,0                                                             
         MVC   S.CKSPWORK(0),8(R2) COPY INPUT FIELD                             
         EX    RF,0(RE)                                                         
         B     CKSPD16                                                          
*                                                                               
CKSPD10  XC    S.CKSPWORK,S.CKSPWORK                                            
         L     R3,VTIA             FIRST 4096 BYTES HAVE WORKER REC             
         LA    R3,4(R3)            POINT TO WORKER ELEM                         
         USING LQ_EL,R3                                                         
CKSPD12  CLI   LQ_EL,LQ_RDATQ      RETURNED DATA HEADER ELEM?                   
         BE    CKSPD15                                                          
         CLI   LQ_EL,LQ_RQSTQ      REQUEST DATA ELEM?                           
         BE    *+12                                                             
CKSPD14  BRAS  RE,NXTWFELM                                                      
         B     CKSPD12                                                          
         CLC   =AL2(D#REGCO1+0),3(R3)                                           
         BE    *+14                                                             
         CLC   =AL2(D#REGCO1+1),3(R3)                                           
         BNE   CKSPD14                                                          
         XC    S.CKSPWORK,S.CKSPWORK                                            
         SR    RF,RF                                                            
         ...
         AHI   RF,-6-1                                                          
         BASR  RE,0                                                             
         MVC   S.CKSPWORK(0),6(R3) COPY INPUT FIELD                             
         EX    RF,0(RE)                                                         
         B     CKSPD14                                                          
*                                                                               
CKSPD15  OC    S.CKSPWORK,S.CKSPWORK                                            
         JNZ   CKSPD16                                                          
         L     R3,VTIA             FIRST 4096 BYTES HAVE WORKER REC             
         LA    R3,4(R3)            POINT TO WORKER ELEM                         
CKSPD15H CLI   LQ_EL,LQ_RDATQ      RETURNED DATA HEADER ELEM?                   
         JE    CKSPD16                                                          
         CLI   LQ_EL,LQ_RQSTQ      REQUEST DATA ELEM?                           
         JE    *+12                                                             
CKSPD15M BRAS  RE,NXTWFELM                                                      
         J     CKSPD15H                                                         
         CLC   =AL2(D#SPCDSC),3(R3)                                             
         JNE   CKSPD15M                                                         
         XC    S.CKSPWORK,S.CKSPWORK                                            
         SR    RF,RF                                                            
         ICM   RF,3,(LQ_LN-LQ_D)(R3)                                            
         ...
         EX    RF,0(RE)                                                         
*                                                                               
CKSPD16  CLC   S.CKSPWORK,SPACES                                                
         JH    CKSPD20                                                          
         CLI   TRCODE,C'C'         CHANGING?                                    
         JNE   CKSPD18                                                          
         LA    R5,REC+33                                                        
         MVI   ELCODE,X'66'                                                     
         BRAS  RE,NXTELEM          FIRST REGULAR COMMENT ELEM FOUND?            
         JNE   CKSPD18                                                          
         LLC   RF,1(R5)                                                         
         AHI   RF,-2               ADJUST ELEM OVERHEAD                         
         CHI   RF,L'PBDSPACE       ALREADY HAVE SPACE DESCRIPTION?              
         JH    CKSPD18                                                          
         BCTR  RF,0                                                             
         BASR  RE,0                                                             
         MVC   S.CKSPWORK(0),2(R5) SAVE IT TO CHECK AGAINST JOB RECORD          
         J     CKSPD70                                                          
CKSPD18  LA    R3,SPDSPREQ         SPACE DESCRIPTION IS REQUIRED                
         J     CKSPDNO                                                          
*                                                                               
CKSPD20  CLI   TRCODE,C'C'         CHANGING?                                    
         BE    CKSPD30                                                          
         CLI   TRCODE,C'B'         BUYING?                                      
         BE    CKSPD40                                                          
*                                                                               
         B     CKSPDX              NO NEED TO LOOK UP SPC DESP RECORD           
*                                                                               
* SEE IF SPACE DESP ENTERED IS SAME AS IN RECORD NOW                            
*                                                                               
CKSPD30  LA    R5,REC+33                                                        
         MVI   ELCODE,X'66'                                                     
         BRAS  RE,NXTELEM          FIRST REGULAR COMMENT ELEM FOUND?            
         BNE   CKSPD40                                                          
         LLC   RF,1(R5)                                                         
         ...
         BCTR  RF,0                                                             
         BASR  RE,0                                                             
         CLC   S.CKSPWORK(0),2(R5) SAME AS IN RECORD?                           
         EX    RF,0(RE)                                                         
         BE    CKSPDX              NO NEED TO LOOK UP SPC DESP RECORD           
*                                                                               
CKSPD40  CLI   S.CKSPWORK,C'*'                                                  
         BE    CKSPDX              NO NEED TO LOOK UP SPC DESP RECORD           
*                                                                               
         CLI   S.CKSPWORK,C'#'     START WITH "#"? IF SO, IGNORE IT             
         BNE   CKSPD46                                                          
         MVC   S.CKSPKEY(L'CKSPWORK),S.CKSPWORK                                 
         XC    S.CKSPWORK,S.CKSPWORK                                            
         MVC   S.CKSPWORK(L'PBDSPACE-1),S.CKSPKEY+1                             
         XC    S.CKSPKEY,S.CKSPKEY                                              
*                                                                               
CKSPD46  MVC   S.CKSPKEY(L'KEY),KEY                                             
...
CKSPD50  MVC   KEY,S.CKSPKEY                                                    
         MVC   KEYSAVE,S.CKSPKEY+L'KEY                                          
*                                                                               
CKSPD70  OC    PBDJOB,PBDJOB                                                    
         BZ    CKSPDX                                                           
         L     RE,AJOBIO                                                        
         CLC   S.CKSPWORK,PJOBSPC-PJOBREC(RE)                                   
         BE    CKSPDX                                                           
         OI    WARN,X'80'          SPACE WARNING                                
*                                                                               
CKSPDX   J     SETCCEQ             SPACE DESCRIPTION MATCH OR NOT CK'D          
*                                                                               
CKSPDNO  J     ERROR               SPACE DESCRIPTION DOES NOT MATCH             
*                                                                               
         DROP  S                                                                
         DROP  RB,R6,R3                                                         
         EJECT                                                                  
...
GLOBALS  DS    0D                                                               
*                                                                               
FIXELTAB DC    AL1(PORELMEQ)       COS2 $ RATE (OPEN RATE) ELEMENT              
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'091PPBUY13   06/02/20'                                      
         END                                                                    
