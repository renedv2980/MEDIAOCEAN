*          DATA SET RELDKRG    AT LEVEL 013 AS OF 05/01/02                      
*PHASE RELDKRG,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
...
*                                  PROCESS FOR STATION RECORDS                  
         CLI   RSTAKTYP,X'02'                                                   
         BNE   DMXKEEP                                                          
         CLC   =C'S3',RSTAKREP     SENNY                                        
         BE    DMX10                                                            
         CLC   =C'KU',RSTAKREP     KRNY                                         
         BE    DMX10                                                            
         CLC   =C'KF',RSTAKREP     KHNY                                         
         BE    DMX10                                                            
         CLC   =C'EA',RSTAKREP     EASTNY                                       
         BE    DMX10                                                            
         CLC   =C'CR',RSTAKREP     CHRNY                                        
         BNE   DMXKEEP                                                          
*                                                                               
DMX10    DS    0H                                                               
         MVC   P+2(2),RSTAKREP                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013RELDKRG   05/01/02'                                      
         END                                                                    
