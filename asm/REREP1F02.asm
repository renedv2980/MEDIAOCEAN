*          DATA SET REREP1F02  AT LEVEL 123 AS OF 12/30/03                      
*PHASE RE1F02C,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
*                                                                   *           
* 30DEC03  (BU ) --- EMPTY DISK ADDRESS IN 8D/8E KEYS FIXED         *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*********************************************************************           
...
UPRI0030 EQU   *                                                                
*                                                                               
*  THIS SITUATION SHOULD NEVER HAPPEN.  BECAUSE NO RECORD IS FOUND,             
*        THERE IS NO DISK ADDRESS TO ADD TO THE RECORD.                         
*                                                                               
         XC    KEY,KEY             CLEAR ENTIRE KEY                             
         MVC   KEY(27),ORIGKEY     RESET KEY NOT FOUND                          
         B     UPRI0080            ADD NEW 8D KEY                               
UPRI0040 EQU   *                                                                
         MVC   DISKADDR,KEY+28     SAVE DISK ADDRESS OF ORDER                   
*                                                                               
...
*                                                                               
         ...
         MVC   KEY+28(4),DISKADDR  INSERT DISK ADDRESS OF RECORD                
*                                     AS IT MAY BE DIFFERENT                    
         CLI   QOPTION2,C'T'       TEST RUN?                                    
         BE    UPRI0090            YES - DON'T REWRITE IT                       
         GOTO1 WRITE                                                            
UPRI0090 EQU   *                                                                
...
UPRI0100 EQU   *                                                                
         XC    KEY,KEY             CLEAR ENTIRE KEY                             
         MVC   KEY(27),KEYSAVE     RESET KEY NOT FOUND                          
         MVC   KEY+28(4),DISKADDR  INSERT DISK ADDRESS OF RECORD                
         CLI   QOPTION2,C'T'       TEST RUN?                                    
         BE    UPRI0110            YES - DON'T REWRITE IT                       
...
*                                     AS IT MAY BE DIFFERENT                    
         CLI   QOPTION2,C'T'       TEST RUN?                                    
         BE    UPRI0185            YES - DON'T REWRITE IT                       
         GOTO1 WRITE                                                            
UPRI0185 EQU   *                                                                
         MVC   P+1(09),=C'8E REWRI:'                                            
         MVC   P+10(34),KEY                                                     
         GOTO1 REPORT                                                           
         B     UPRI0200                                                         
UPRI0190 EQU   *                                                                
         ...
         MVC   KEY+28(4),DISKADDR  INSERT DISK ADDRESS OF RECORD                
         CLI   QOPTION2,C'T'       TEST RUN?                                    
         BE    UPRI0195            YES - DON'T REWRITE IT                       
         GOTO1 ADD                 WRITE NEW KEY                                
UPRI0195 EQU   *                                                                
         CLC   =C'PRINT',QUESTOR                                                
         BNE   UPRI0200                                                         
...
*                                                                               
       ...
       ++INCLUDE REXADDRD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'123REREP1F02 12/30/03'                                      
         END                                                                    
