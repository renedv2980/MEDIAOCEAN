*          DATA SET SPREPMD02  AT LEVEL 049 AS OF 06/19/13                      
*PHASE SPMD02A                                                                  
*INCLUDE COVAIL                                                                 
*INCLUDE MEDADDWT                                                               
         TITLE 'SPREPMD02 - STATION COMMERCIAL PERFORMANCE REPORT'              
         PRINT NOGEN                                                            
SPMD02   CSECT                                                                  
         NMOD1 0,SPMD02,RA                                                      
*                                                                               
...
SP120    MVC   GLASYSDR,ASYSDRV    SYSTEM DRIVER ADDR                           
         ...
         MVI   GLFHEADL,13         HEAD ROWS                                    
         MVI   GLLHEADL,14                                                      
         OI    GLINDS,GLISDONT     SUPPRESS SPACING FOR REJECTED LINES          
         CLI   QOPT5,C'Y'          TEST DOWNLOADING                             
         BNE   *+8                                                              
         OI    GLDOWNLD,X'80'      YES                                          
*                                                                               
...
*                                                                               
         ...
         CLC   QBOOK1,SPACES                                                    
         BE    *+12                                                             
         MVI   QRERATE,C'I'        IF RERATE, THEN RERATE BY AFFID              
         LA    R1,5(R1)                                                         
         STC   R1,GETBYP2                                                       
*                                                                               
...
*                                                                               
         ...
         L     R6,=A(BUFFALOC)                                                  
         GOTO1 COVAIL,DMCB,C'SETB',40000,1300000,(R6)                           
         OC    DMCB+4(4),DMCB+4                                                 
         BNZ   *+6                                                              
         DC    H'0'                                                             
...
SP132    ZIC   RE,SDNPGRPS         DETERMINE LEVEL NUMBERS                      
         ...
         BNO   *+8                                                              
         LA    RE,1(RE)                                                         
         CLI   QOPT5,C'Y'          TEST DOWNLOAD                                
         BNE   *+16                                                             
         CLI   QOPT2,C'F'          AND COMMERCIAL IN HEADLINE                   
         BNE   *+8                                                              
         LA    RE,1(RE)            YES-ADD EXTRA LEV FOR CML IN COLS            
...
*                                                                               
         ...
         L     R1,ADCLT                                                         
         MVC   CMLCLTCD,CMCLTCOD-CLTHDR(R1)                                     
         OC    CMLCLTCD,CMLCLTCD   TEST MASTER TRAFFIC CLIENT CODE              
         BZ    *+10                                                             
         MVC   KEY+3(2),CMLCLTCD   YES-USE THAT                                 
         GOTO1 HIGH                                                             
*                                                                               
SP133    CLC   KEY(5),KEYSAVE      SAME TYPE/A-M/CLT                            
         BNE   SP136                                                            
         GOTO1 GET                                                              
         MVC   0(2,R2),CMLSEQ+1    2 BYTES OF SEQUENCE NUMBER                   
         MVC   2(4,R2),CMLCLASS                                                 
...
SP136    XC    CMLTBCNT,CMLTBCNT                                                
         ...
         BZ    SP145                                                            
         ST    R4,CMLTBCNT                                                      
         GOTO1 XSORT,DMCB,COMLTAB,(R4),29,2,0    SORT ON FILM SEQ               
*                                                                               
...
*                                                                               
         OC    DMNAMES,DMNAMES     TEST DEMO NAMES SET YET                      
         BZ    SP155               NO                                           
         CLC   QPRD,=C'ALL'        YES-TEST DEMO NAMES MIGHT CHANGE             
         BE    SP155                                                            
         CLC   QEST,=C'ALL'                                                     
         BE    SP155                                                            
         B     EXIT                                                             
...
SP210    CLI   0(R2),0                                                          
         BE    SP250                                                            
         CLI   BPRD,X'FF'          TEST PRD=POL                                 
         BE    *+14                                                             
         CLC   BPRD,0(R2)          NO-CHECK PRODUCT IS CURRENT                  
         BNE   SP240                                                            
...
*                                                                               
         ...
         B     SP214                                                            
*                                                                               
SP212    OC    MEDBYSPT,MEDBYSPT   TEST ANY UNKNOWN CMLS OR CLASS               
         BZ    SP230                                                            
...
SP214    XC    BFREC,BFREC         CLEAR BUFFALO REC                            
         ...
         MVI   BFMAXTLV,0                                                       
         CLI   QOPT3,C'M'          TEST MARKET SUMMARY REPORT                   
         BE    SP220               YES                                          
*                                                                               
...
*                                                                               
SP220    CLC   BFSTA,XFF           TEST FOR COMMERCIAL TOTAL DONE               
         BE    SP225                                                            
         MVC   BFSTA,XFF                                                        
         MVC   BFMAXTLV,TOTLEV                                                  
         B     SP215                                                            
*                                                                               
SP225    CLC   BFFILM,XFF          TEST ALL COMMERCIALS DONE                    
         BE    SP227                                                            
         TM    CMLSW,FLM                                                        
         BZ    SP227                                                            
         MVC   BFFILM,XFF                                                       
         B     SP215                                                            
*                                                                               
SP227    CLC   BFCLASS,XFF         TEST ALL COMMERCIAL CLASSES DONE             
         BE    SP230                                                            
         TM    CMLSW,CLS                                                        
         BZ    SP230                                                            
         CLI   QFILTER+1,C' '      NO NEED FOR ALL CLASSES WHEN ONE             
         BNE   SP230                                                            
         MVC   BFCLASS,XFF                                                      
         B     SP215                                                            
*                                                                               
...
BUYHKR7  DC    6F'0'                                                            
         DROP  RF                                                               
*                                                                               
BH010    L     R6,SPOTADDR         R6=A(BUY ELEMENT)                            
         TM    6(R6),X'80'+X'40'   TEST SPOT IS MINUSED                         
         BNZ   BH990               YES-IGNORE                                   
         SR    R0,R0                                                            
         MVI   SECBRAND,C'N'                                                    
...
BH035    OC    0(2,R4),0(R4)       TEST NULL FILM                               
         ...
         MVC   FILMSEQ,0(R4)                                                    
         BAS   RE,LKUPFILM                                                      
         CLC   Q2USER(8),SPACES    TEST SINGLE FILM FILTER                      
         BNH   *+14                                                             
         CLC   FILMNUM,Q2USER      YES-COMPARE FILM NUMBERS                     
         BNE   BH990               NOT EQUAL-REJECT                             
...
BH050    OC    0(2,R3),0(R3)                                                    
         ...
         DC    H'0'                                                             
*                                                                               
BH900    CLC   Q2USER(8),SPACES    NO FILM ELE, UNKNOWN FILM OR CLASS           
         BH    BH990               IF SINGLE FILM FILTER, REJECT                
         TM    CMLSW,CLS                                                        
...
SP600    CLI   ANYDATA,C'Y'        TEST FOR ANY DATA                            
         ...
         MVI   RCSUBPRG,1                                                       
         MVI   FORCEHED,C'Y'                                                    
         XC    SPWEIGHT,SPWEIGHT   DON'T LET SPONSOR PRINT WEIGHTS              
...
*                                                                               
*                                  COMMERCIAL                                   
FILMDOWN MVC   0(24,R3),SPACES     DOWNLOAD ROUTINE                             
         CLC   0(8,R2),XFF                                                      
         BE    EXIT                                                             
         CLI   0(R2),X'FE'                                                      
         BE    FILMDWN2                                                         
         ...
         BAS   RE,GETFLMNM                                                      
         BNE   FILMDWN2                                                         
         MVC   9(15,R3),FILMNAME                                                
         B     EXIT                                                             
FILMDWN2 MVC   0(8,R3),=C'UNKNOWN '                                             
         B     EXIT                                                             
*                                                                               
FILMO    MVC   0(45,R3),SPACES     NON-DOWNLOAD ROUTINE                         
         CLC   0(8,R2),XFF                                                      
         BE    EXIT                                                             
         MVC   0(3,R3),ASTS                                                     
         ...
         B     FILMO4                                                           
*                                                                               
FILMO2   MVC   15(8,R3),=C'UNKNOWN '                                            
*                                                                               
FILMO4   MVC   42(3,R3),ASTS                                                    
         GOTO1 SQUASHER,DMCB,(R3),45                                            
         B     EXIT                                                             
*                                                                               
GETFLMNM NTR1  ,                   ROUTINE TO GET FILM NAME                     
         CLC   SVFLMNUM,0(R2)                                                   
         BNE   *+18                                                             
         OC    FILMNAME,FILMNAME                                                
         BZ    NEQXIT                                                           
         B     EQXIT                                                            
         MVC   SVFLMNUM,0(R2)                                                   
         MVC   FILMNAME,SPACES                                                  
...
STATIONO CLC   0(3,R2),XFF         STATION                                      
         BNE   STATO2                                                           
         CLI   QOPT3,C'M'          ALL STATIONS - TEST MKT SUMMARY              
         BE    STATO1              YES-ALWAYS PRINT                             
         CP    STATCNTR,=P'2'      MARKET TOTAL                                 
         BH    *+12                - ONLY PRINT IF MORE THAN 1 STATION          
         MVI   PRTSW,C'N'                                                       
         B     EXIT                                                             
*                                                                               
...
* ESTIMATE FIRST                                                                
*                                                                               
ESTFST   ICM   RE,15,AMKTS         CLEAR LOWER LEVELS OF MARKET TOTALS          
         BZ    ESTFST2                                                          
         LA    RF,MKTMG3+8                                                      
         SR    RF,RE                                                            
         XCEF                                                                   
...
*                                                                               
ESTFST2  CLC   QPRD,=C'ALL'        ONLY GET DEMO NAMES IF THEY MIGHT            
         BE    *+14                                                             
         CLC   QEST,=C'ALL'                                                     
         BNE   EXIT                                                             
...
ESTFST10 CLC   KEY(7),KEYSAVE                                                   
         ...
         B     ESTFST6                                                          
*                                                                               
ESTFST12 GOTO1 MEDPRDRD,DMCB,(R8)                                               
*                                                                               
         ZIC   RE,BPRD                                                          
         BCTR  RE,0                                                             
         MH    RE,PRDBUFLN                                                      
...
MGRPFST  CLC   0(2,R2),XFF         TEST FOR ALL AT THIS MGRP LEVEL              
         BNE   EXIT                                                             
         OC    AMKTS,AMKTS         IF HIGHER LEVELK TOTAL, EXIT                 
         BNZ   EXIT                                                             
         CLI   GLARGS,1            MKTGRP1                                      
         BNE   *+14                                                             
         MVI   MODE,PRDLAST        SUPPRESS MKTGRP HEADLINES                    
         MVC   AMKTS,=A(MKTALL)                                                 
...
MKTFST   CLC   0(4,R2),XFF         TEST FOR ALL MARKETS                         
         BNE   MKTFST2                                                          
         MVI   CROSSMKT,C'Y'       YES -                                        
         OC    AMKTS,AMKTS               SET MARKET TOTAL ADDRESS               
         BNZ   *+14                                                             
         MVI   MODE,MGR3LAST             SUPPRESS MARKET FROM HEADLINE          
         MVC   AMKTS,=A(MKTMG3)                                                 
...
*                                                                               
CLASSFST ZAP   STATCNTR,=P'0'      INIT STATION COUNTER                         
         CLC   0(4,R2),XFF         TEST FOR ALL CLASSES                         
         BNE   EXIT                                                             
         ZAP   STATCNTR,=P'9'      YES - MAKE SURE LINE PRINTS                  
         B     EXIT                                                             
         SPACE 2                                                                
*                                                                               
* COMMERCIAL FIRST                                                              
*                                                                               
FILMFST  ZAP   STATCNTR,=P'0'      INIT STATION COUNTER                         
         CLC   0(8,R2),XFF         TEST FOR ALL COMMERCIALS                     
         BNE   EXIT                                                             
         ZAP   STATCNTR,=P'9'      YES - MAKE SURE LINE PRINTS                  
         B     EXIT                                                             
         EJECT                                                                  
...
PD010    BAS   RE,SEQBUFF                                                       
         ...
         GOTO1 ADRIVER,DMCB,(RC)                                                
         CLC   BFSTA,XFF           TEST FOR ALL STATIONS                        
         BNE   PD010                                                            
         TM    CMLSW,CLS                                                        
         BNZ   *+18                                                             
         CLC   BFFILM,XFF          TEST ALL COMMERCIALS                         
         BNE   PD010                                                            
         B     PD015                                                            
         CLI   QFILTER+1,C' '      TEST ALL COMMERCIAL CLASSES                  
         BNE   PD015                                                            
         CLC   BFCLASS,XFF                                                      
         BNE   PD010                                                            
*                                                                               
PD015    CLI   MKTDATA,C'Y'              YES - MARKET TOTAL                     
         BE    PD040                                                            
...
PD055    LA    R1,3(R1)                                                         
         BCT   R0,PD045                                                         
*                                                                               
         MVC   MKT,XFF             ALL MARKETS                                  
         MVC   BFCLASS,XFF         MAKE SURE ALL COMMERCIAL CLASSES             
         GOTO1 ADRIVER,DMCB,(RC)                                                
         SR    R2,R2                                                            
         ICM   R2,1,SDNMGRPS                                                    
         BZ    PD080                                                            
*                                                                               
PD070    STC   R2,MGTOT            ALL MARKET GROUPS                            
         GOTO1 ADRIVER,DMCB,(RC)                                                
         BCT   R2,PD070                                                         
*                                                                               
PD080    MVC   MKT,MKTSV           RESTORE MARKET                               
         MVI   MGTOT,0                                                          
         B     PD010                                                            
*                                                                               
...
BFRECSV  DS    CL68                                                             
       ...
       ++INCLUDE DDEBLOCK                                                       
         ...
         DS    0D                                                               
         DC    CL8'*CMLTAB*'                                                    
COMLTAB  DS    3000XL29            COMMERCIAL TABLE                             
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE SPTRCMML                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'049SPREPMD02 06/19/13'                                      
         END                                                                    
