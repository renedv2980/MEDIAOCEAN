*          DATA SET ACREPAB02O AT LEVEL 001 AS OF 12/06/16                      
*PHASE ACAB02A,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE XSORT                                                                  
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
         TITLE 'ACAB02 - TRANSACTION REPORT AND EDI OUTPUT'                     
***********************************************************************         
* THIS BOOK IS A COPY OF ABX AS OF 4/26/05. THIS VERSION IS A SPECIAL *         
* VERSION BEING USED BY DDB (NE) TO SEND EDI TRANSMISSION IN OLD 3030 *         
* FORMAT TO ANHEUSER BUSCH ABX HAS A CODE TO SEND TRANSMISSION IN NEW *         
* FORMAT 4010.                                                        *         
* THIS BOOK SHOULD BECOME OBSOLETE AFTER DEC/2006. CHECK WITH JOHN    *         
* ACAMPORA IF THIS VERSION IS STILL BEING USED BY DDB.                *         
*                                                                     *         
***********************************************************************         
ACAB02   CSECT                                                                  
         PRINT NOGEN                                                            
...
REQF     ZAP   RCBLAMT,=P'0'                                                    
         L     R2,AAGYTAB                                                       
REQF3    CLI   0(R2),X'FF'         MAKE SURE VALID AGENCY TO OUTPUT             
         BNE   *+12                EDI REPORT                                   
...
PUT1     L     R2,AIO                                                           
         ...
         MVC   EDISPA,SPACES                                                    
         MVC   EDISEG(6),0(R4)      SEQMENT AND SEQUENCE                        
         MVC   EDIZRO,=C'00000'                                                 
         LA    R3,EDILNQ                                                        
...
PUT3     CLI   0(R4),ESC           TEST ESCAPE SEQUENCE                         
         BE    PUT5                                                             
...
*                                                                               
         ...
         DC    C'DPA',AL1(0)        CLIENT                                      
         DC    A(NEDELL)            A(AGENCY DATA)                              
*                                                                               
         DC    C'NE',AL2(0)         DNCH - DDB NEEDHAM                          
         DC    C'DPC',AL1(0)        CLIENT                                      
         DC    A(NEDELL)            A(AGENCY DATA)                              
*                                                                               
         DC    C'NE',AL2(0)         DNCH - DDB NEEDHAM                          
         DC    C'   ',AL1(0)        CLIENT                                      
...
MXENTRY  EQU   100                 MAX TABLE ENTRIES                            
*                                                                               
...
GOBLOCKD DSECT                                                                  
       ++INCLUDE ACGOBLOCK                                                      
         PRINT   ON                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001ACREPAB02O12/06/16'                                      
         END                                                                    
