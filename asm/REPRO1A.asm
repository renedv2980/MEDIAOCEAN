*          DATA SET REPRO1A    AT LEVEL 035 AS OF 09/30/02                      
*&&      SET   NOP=N                                                            
*PHASE T80A1AA                                                                  
T80A10   TITLE 'REPRO1A - PROPROSAL RECORDS - REPORT OVERLAY'                   
***********************************************************************         
* NOTES--                                                                       
*                                                                               
*    PROGRAM IS CALLED BY REPRO10 WHICH SETS UP THE PAGE BUFFER IN THE          
*      PROGRAMS AREA.  THIS IS DONE DUE TO A LACK OF WORKING STORAGE            
*      ONLINE.                                                                  
***********************************************************************         
PRO1A    CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T80A1A*,R7,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
*                                                                               
         L     R8,AGWORK                                                        
...
*                                                                               
         MVI   FVIFLD,C'N'                                                      
         TM    SELPROF+SELDFCVB,SELDFCVA       DEFUALT TO PRINT?                
         BZ    VALCVRX                         NO                               
*                                                                               
         MVI   FVIFLD,C'Y'                                                      
...
VSR02    DS    0H                                                               
         L     RE,AIO4                                                          
         XC    0(256,RE),0(RE)                                                  
         GOTO1 VSCANNER,BODMCB,FVIHDR,(X'80',AIO4)                              
*                                                                               
         ZIC   R0,4(R1)            NUMBER OF LINES                              
         CHI   R0,0                                                             
         BZ    VSR40                                                            
         L     R3,AIO4                                                          
         LA    R2,SORTREQ                                                       
...
*                                                                               
       ...
       ++INCLUDE REPRORWRK                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035REPRO1A   09/30/02'                                      
         END                                                                    
