*          DATA SET CTFIL13    AT LEVEL 016 AS OF 08/22/00                      
*&&      SET   NOP=N                                                            
*PHASE TA1313A                                                                  
...
KNOWTAB  DC    AL2(00001),AL4(SYSDTA)    SYSTEM                                 
         ...
         DC    AL2(00169),AL4(SECDTA)    SECURITY OVERRIDE NUMBER               
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
KNOWTABD DSECT                                                                  
...
*                                                                               
         MVC   FRANUM,FRAKACT                                                   
*                                                                               
         LA    RF,IOKEY            COUNTRY + TEST                               
         USING FRRRECD,RF                                                       
         XC    FRRKEY,FRRKEY                                                    
         MVI   FRRKMIN,FRRKMINQ                                                 
         MVI   FRRKTYP,FRRKTYPQ                                                 
         MVC   FRRKSYS,FRAKSYS                                                  
         MVC   FRRKPRG,FRAKPRG                                                  
         MVC   FRRKREC,FRAKREC                                                  
         MVC   FRRKCTRY,FRAKCTRY                                                
         MVC   FRRKSUB,FRAKSUB                                                  
         MVC   FRRKTEST,FRAKTEST                                                
...
*                                                                               
         ...
         MVC   FRRKCTRY,FRAKCTRY                                                
         MVC   FRRKSUB,FRAKSUB                                                  
         XC    FRRKTEST,FRRKTEST                                                
         L     R1,=AL4(XOREAD+XOGENDIR+XIO1)                                    
         GOTOX ('XIO',AGROUTS)                                                  
         BE    DLDV01                                                           
*                                                                               
         LA    RF,IOKEY            HOST + TEST                                  
         XC    FRRKEY,FRRKEY                                                    
         MVI   FRRKMIN,FRRKMINQ                                                 
         MVI   FRRKTYP,FRRKTYPQ                                                 
         MVC   FRRKSYS,FRAKSYS                                                  
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
DLDV01   L     R1,=AL4(XOGET+XOGENFIL+XIO1)                                     
         GOTOX ('XIO',AGROUTS)                                                  
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
...
DISRCO   OC    FRAKREC,FRAKREC     GLOBAL FIELD?                                
         ...
         BE    EXITOK                                                           
         CURED FRAKREC,(4,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT                      
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
...
DISSEL   LTR   R3,R3               FRAEL?                                       
         ...
         CLI   FRATYPE,FRATMNT                                                  
         BNE   *+14                                                             
         MVC   FVIFLD(L'FL@MAINT),FL@MAINT                                      
         B     EXITOK                                                           
*                                                                               
         CLI   FRATYPE,FRATLIST                                                 
         BNE   *+14                                                             
         MVC   FVIFLD(L'FL@LIST),FL@LIST                                        
         B     EXITOK                                                           
*                                                                               
         CLI   FRATYPE,FRATREP                                                  
         BNE   *+14                                                             
         MVC   FVIFLD(L'FL@REP),FL@REP                                          
         B     EXITOK                                                           
*                                                                               
         CLI   FRATYPE,FRATDWN                                                  
         BNE   *+14                                                             
         MVC   FVIFLD(L'FL@DLOAD),FL@DLOAD                                      
         B     EXITOK                                                           
*                                                                               
...
*                                                                               
         EX    RE,*+8              MAINTAIN                                     
         BE    VSEL02                                                           
         CLC   FVIFLD(0),FU@MAINT                                               
         EX    RE,*+8              MAINTAIN                                     
         BE    VSEL02                                                           
         CLC   FVIFLD(0),FL@MAINT                                               
         B     VSEL04                                                           
*                                                                               
...
VSEL04   EX    RE,*+8              LIST                                         
         BE    VSEL06                                                           
         CLC   FVIFLD(0),FU@LIST                                                
         EX    RE,*+8              LIST                                         
         BE    VSEL06                                                           
         CLC   FVIFLD(0),FL@LIST                                                
         B     VSEL08                                                           
*                                                                               
...
VSEL12   EX    RE,*+8              DOWNLOAD                                     
         BE    VSEL14                                                           
         CLC   FVIFLD(0),FU@DLOAD                                               
         EX    RE,*+8              DOWNLOAD                                     
         BE    VSEL14                                                           
         CLC   FVIFLD(0),FL@DLOAD                                               
         B     VSELNV                                                           
*                                                                               
...
*                                                                               
         ...
         CLC   FVIFLD(0),FL@YES                                                 
*                                                                               
VUDT02   OI    FRAINDS1,FRA1UPD                                                 
         B     EXITOK                                                           
*                                                                               
VUDT04   B     EXITNV              NOTHING ELSE IS VALID                        
         EJECT                                                                  
***********************************************************************         
...
VSUB04   EX    RE,*+8              NO                                           
         ...
         CLC   FVIFLD(0),FL@NO                                                  
*                                                                               
VSUB06   NI    FRAINDS1,FF-(FRA1SUB)                                            
         XC    FRANREC,FRANREC     RESET SUB RECORD/ACTION                      
         XC    FRANACT,FRANACT                                                  
         XC    FRASACT,FRASACT                                                  
         B     EXITOK                                                           
*                                                                               
VSUB08   B     EXITNV              NOTHING ELSE IS VALID                        
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
         ...
         CLC   FVIFLD(0),FL@YES                                                 
*                                                                               
VHLP02   OI    FRAINDS1,FRA1NOH                                                 
         B     EXITOK                                                           
*                                                                               
VHLP04   B     EXITNV              NOTHING ELSE IS VALID                        
         EJECT                                                                  
***********************************************************************         
...
DISRTG   OC    FRANREC,FRANREC     GLOBAL FIELD?                                
         ...
         GOTO1 AGEN,BOPARM,ORTYPE,RTXDIS,(RF)                                   
         BE    EXITOK                                                           
         CURED FRANREC,(4,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT                      
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* DATA OBJECT FOR SECURITY OVERRIDE                                   *         
*                                                                     *         
* R1 HOLDS EQUATED VERB                                               *         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                 *         
***********************************************************************         
         SPACE 1                                                                
SECDTA   LA    RF,SECTBL           TABLE OF KNOWN VERBS                         
         B     ITER                ITERATE TABLE                                
*                                                                               
SECTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISSEC)                                 
         DC    AL1(DVAL),AL1(0,0,0),AL4(VALSEC)                                 
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
         SPACE 2                                                                
***********************************************************************         
* DISPLAY OVERRIDE FIELD                                              *         
***********************************************************************         
         SPACE 1                                                                
DISSEC   CURED FRAASEC,(3,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT,ZERO=BLANK           
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
...
*        FACTRYEQUS                                                             
       ...
       ++INCLUDE FACTRYEQUS                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'016CTFIL13   08/22/00'                                      
         END                                                                    
