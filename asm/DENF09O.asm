*          DATA SET DENF09O    AT LEVEL 054 AS OF 10/20/09                      
*PHASE DENF09OA                                                                 
*INCLUDE DEBKUPDT                                                               
                                                                                
*---------------------------------------------------------------------*         
* NSS FOX CONVERSION: OUTPUT PHASE                                    *         
*---------------------------------------------------------------------*         
                                                                                
DENF09O  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         NMOD1 NTIWRKX-NTIWRKD,DENF09O                                          
         USING NTIWRKD,RC          RC=A(TEMP W/S)                               
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DENF09O+4096,R7     R7=2ND BASE REGISTER                         
...
CNV77    XC    TEMP,TEMP           CLEAR ELEMENT AREA                           
         MVI   PHTCODE,PHTCODEQ                                                 
         MVI   PHTLEN,PHTLNEQ                                                   
         MVC   PHTDTYP,INTDTYP                                                  
         MVC   PHTPTYP,INTPTYP4                                                 
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'054DENF09O   10/20/09'                                      
         END                                                                    
