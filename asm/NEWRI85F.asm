*          DATA SET NEWRI85F   AT LEVEL 002 AS OF 05/01/02                      
*          DATA SET NEWRI85    AT LEVEL 026 AS OF 06/15/01                      
*          DATA SET NEWRI85    AT LEVEL 226 AS OF 05/14/98                      
*PHASE T32085F,+0                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*                                                                               
...
*****    MVC   TODAYC,=X'C497'          APRIL23/98                              
                                                                                
         B     INIT00                                                           
                                                                                
* FOR RERUNS/TESTS SET RUN DATE AND RECOVERY HEADER                             
***      MVC   TODAYC,=X'C490'          APRIL16/98                              
**8      MVC   RERUNREC(10),=X'2A035162000188840095'                            
***      MVC   RERUNREC+10(14),=X'748C7B691B00231162040DF00011'                 
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002NEWRI85F  05/01/02'                                      
         END                                                                    
