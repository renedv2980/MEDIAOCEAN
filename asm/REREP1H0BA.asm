*          DATA SET REREP1H0BA AT LEVEL 020 AS OF 05/01/02                      
*PHASE RE1H02A,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
INITIAL  NTR1                                                                   
         ...
         MVC   KEY+1(7),=C'KUKEZKF'                                             
*                                  LOAD REP + STATION CALL LETTERS              
INIT0010 EQU   *                                                                
         GOTO1 HIGH                                                             
         B     INIT0040                                                         
INIT0020 EQU   *                                                                
...
INIT0040 EQU   *                                                                
         ...
         CLC   KEY+1(7),=C'KUKEZKF'                                             
         BH    INIT0080            FINISHED IF HIGH                             
         ...
         GOTO1 REPORT                                                           
INIT0050 EQU   *                                                                
         CLC   KEY+10(2),=X'C421'  FLIGHT END   DATE                            
         BL    INIT0053            BEFORE 1/1/98 - SKIP IT                      
...
INIT0070 EQU   *                                                                
         ...
         B     INIT0020                                                         
INIT0080 EQU   *                                                                
         MVC   P+1(26),=C'COUNT:  1998             :'                           
         EDIT  CTR1998,(8,P+30)                                                 
         GOTO1 REPORT                                                           
         MVC   P+1(26),=C'COUNT:  1999             :'                           
         EDIT  CTR1999,(8,P+30)                                                 
         GOTO1 REPORT                                                           
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020REREP1H0BA05/01/02'                                      
         END                                                                    
