*          DATA SET FRMQG      AT LEVEL 007 AS OF 05/01/02                      
...
*                  specified queue -- NON-BROWSE MODE                 *         
*                                                                     *         
...
*                                                                               
*                                                                               
MSGDESC    CMQMDA  DSECT=YES,LIST=YES        MESSAGE DESCRIPTOR                 
         DS    0D                                                               
WORKC    CSECT                                                                  
         DS    5000D               WORKING STORAGE                              
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007FRMQG     05/01/02'                                      
         END                                                                    
