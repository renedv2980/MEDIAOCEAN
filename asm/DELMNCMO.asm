*          DATA SET DELMNCMO   AT LEVEL 055 AS OF 10/24/17                      
*PROCESS USING(WARN(15))                                                        
*PHASE DELMNMOB                                                                 
         TITLE 'DEMCON - NCM - OUTPUT PHASE'                                    
DELMNMO  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 TPTWRKX-TPTWRKD,**LMNMO,R7                                       
...
CNV31A   LA    R5,DBLOCKA                                                       
         ...
         MVC   DBFILE,=C'TP '                                                   
***      MVC   DBSELMED,MEDIA                                                   
         MVI   DBSELMED,C'T'    SAME AS REGULAR NIELSEN MONTHLY                 
***      MVC   DBSELSRC,OUTSRC                                                  
         MVI   DBSELSRC,C'N'    SAME AS REGULAR NIELSEN MONTHLY                 
         MVC   DBSELBK,INTBOOK                                                  
         ST    RA,DBCOMFCS                                                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'055DELMNCMO  10/24/17'                                      
         END                                                                    
