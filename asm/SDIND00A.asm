*          DATA SET SDIND00A   AT LEVEL 045 AS OF 05/01/02                      
*PHASE T16500                                                                   
*&&      SET   SF=Y,TT=N                                                        
...
IND10    MVC   INDOUT(20),=CL20'COMMENCING TRANSFER'                            
         XC    SV$INDF(256),SV$INDF  CLEAR SAVE AREA                            
...
* SBA XX YY INDFILE GET SBA XX YY FILENAME,SEQNUM SBA ...          *           
*-------------------------------------------------------------------*           
         SPACE 1                                                                
         SR    R1,R1                                                            
IND20    CLI   0(R8),SBA           FIND SECOND SBA                              
         BE    IND30                                                            
         LA    R8,1(R8)                                                         
         B     IND20                                                            
*                                                                               
...
*                                                                               
         MVI   SVERRCD,NOTCONQ                                                  
         BAS   RE,INDERR                        NOT CONNECTED, BAIL OUT         
*                                                                               
PARSE02  MVC   SVUSER,TUSER                                                     
*&&                                                                             
         L     RF,VCOMFACS                       GET THE WRKF FILENAME          
         L     RF,CSCANNER-COMFACSD(RF)                                         
         GOTO1 (RF),DMCB,(C'C',SVARGS),(2,WRKREC)                               
*                                                                               
         MVI   SVERRCD,INVFILQ                                                  
*                                                                               
         CLI   4(R1),2                           CORRECT ARGUMENTS?             
         BE    *+8                                                              
         BAS   RE,INDERR                         NO                             
*                                                                               
PARSE10  LA    R1,WRKREC              GET CCCCNNC,NN                            
         MVC   SVSUBID(4),12(R1)      READ FIRST 4 CARACTERS                    
         L     RF,APQCHARS                                                      
         TR    SVSUBID(4),0(RF)       TRANSLATE CHARS                           
*                                                                               
         LA    RF,12+4(R1)         CHECK FOR 2 NUMERIC CHARACTERS               
         CLI   0(RF),C'0'                                                       
         BNL   *+8                                                              
         BAS   RE,INDERR                                                        
         CLI   0(RF),C'9'                                                       
...
*                                                                               
         PACK  DUB(2),0(2,RF)                                                   
         MVO   DUB+4(2),DUB(2)                                                  
         MVC   SVSUBID+4(1),DUB+4                                               
*                                                                               
         MVC   SVSUBID+5(1),12+6(R1)      READ THE LAST CHARACTER               
         L     RF,APQCHARS                                                      
         TR    SVSUBID+5(1),0(RF)         TRANSLATE CHARS                       
*                                                                               
         LA    R1,WRKREC+32               SECOND SCANNER LINE                   
         TM    2(R1),X'80'                SEQ # NUMERIC?                        
         BO    *+8                                                              
         BAS   RE,INDERR                  NO                                    
*                                                                               
         L     R0,4(R1)                   GET SEQUENCE NUMBER                   
...
*                                                                               
         ...
         MVC   WRKFID,UKUSRINF     SAVE THE FILENAME (WRKFN)                    
*                                                                               
         XC    UKINDEX,UKINDEX                                                  
         MVC   UKUSRID,SVUSER                                                   
         MVC   UKSYSPRG,SVSUBID                                                 
         MVC   UKFILENO,SVFILNUM                                                
         GOTO1 (RF),DMCB,(X'08',INDEX),WRKFID,KEY,WRKREC,CIREC,0                
*                                                                               
         CLI   8(R1),0                                                          
         BE    *+12                                                             
         MVI   SVERRCD,FILNTFQ                                                  
...
*                                                                               
         ...
         L     RF,VCOMFACS                                                      
         L     RF,CDATAMGR-COMFACSD(RF)                                         
         GOTO1 (RF),DMCB,(X'01',RANDOM),WRKFID,KEY,WRKREC,CIREC,0               
         CLI   8(R1),0                                                          
         BE    INDGB10                                                          
*                                                                               
...
*                                                                               
         ...
         L     RF,CDATAMGR-COMFACSD(RF)                                         
         GOTO1 (RF),DMCB,(X'01',READ),WRKFID,KEY,WRKREC,CIREC,0                 
         CLI   8(R1),0                                                          
...
SVBUFF   DS    XL256               SAVE DATA TO RESTORE WRKF SEQ                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045SDIND00A  05/01/02'                                      
         END                                                                    
