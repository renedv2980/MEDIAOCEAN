*          DATA SET RECNT5F    AT LEVEL 023 AS OF 01/15/08                      
*PHASE T8025FB,*                                                                
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
*INCLUDE DAYUNPK                                                                
         TITLE 'T8025F - RECNT5F - CBS ENTERPRISE EC CHANGES'                   
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT5F --- CBS  ENTERPRISE ELECTRONIC CON INTERFACE       *           
*********************************************************************           
* UPDATE HISTORY:                                                   *           
*                                                                   *           
...
T8025F   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T8025F*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
DINF0010 EQU   *                                                                
         ...
         L     RE,LNSPOTS          CALCULATE TOTAL SPOTS FOR LINE               
         AR    RE,RF                                                            
...
LNSPOTS  DS    F                   TOTAL SPOTS FOR LINE                         
DAYBUMP  DS    F                                                                
DAYCNT   DS    F                                                                
SPOTLEFT DS    F                                                                
SPOTMAX  DS    F                                                                
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023RECNT5F   01/15/08'                                      
         END                                                                    
