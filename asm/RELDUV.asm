*          DATA SET RELDUV     AT LEVEL 252 AS OF 05/01/02                      
...
*                                                                               
         ...
         BNE   DMXKEEP                                                          
         USING RCONSEND,R5                                                      
         CLC   RCONSSID,=AL2(7826) KWEXL SIGNON                                 
         BNE   DMXKEEP                                                          
         DROP  R5                                                               
*                                                                               
         L     R5,AREC                                                          
         ...
         TM    RCONCONF,X'40'                                                   
         BZ    DMXR05                                                           
         MVC   P+40(13),=C'* CONFIRMED *'                                       
         DROP  R5                                                               
*                                                                               
DMXR05   DS    0H                                                               
         L     R5,AREC                                                          
         USING RCONREC,R5                                                       
         GOTO1 =V(HEXOUT),DMCB,RCONKCON,P+2,4                                   
         MVC   P+20(14),=C'* NOT MARKED *'                                      
         DROP  R5                                                               
*                                                                               
         L     R5,AREC                                                          
         MVI   ELCODE,X'1E'                                                     
         ...
         USING RCONRFEL,R5                                                      
*                                                                               
         GOTO1 =V(HEXOUT),DMCB,RCONRF1,P+12,1                                   
*                                                                               
         TM    RCONRF1,X'20'                                                    
         BZ    DMXR10                                                           
*                                                                               
         MVC   P+20(15),=C'MARKED AS LOCAL'                                     
*                                                                               
DMXR10   DS    0H                                                               
         GOTO1 VPRINTER                                                         
         B     DMXKEEP                                                          
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'252RELDUV    05/01/02'                                      
         END                                                                    
