*          DATA SET NESFM34    AT LEVEL 022 AS OF 06/15/16                      
*PHASE T31C34A                                                                  
*                                                                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         BE    *+12                YES, DON'T TURN THE SWITCH ON                
         OI    USRFLG2,CFLGREQB    REQUIRED FOR BILLING                         
         B     BLDBLK05                                                         
*                                                                               
...
*                                                                               
         ...
         BZ    *+12                 NOPE, ASSUMPTION IS CORRECT.                
         MVI   8(R2),C'Y'          "REQUIRED" INDICATED.                        
         B     DISBLK05                                                         
*                                                                               
         TM    USRFLG2,CFLGREQB                                                 
         BNO   DISBLK05             CHECK FOR REQUIRED FOR BILLING              
         MVI   8(R2),C'B'                                                       
*                                                                               
...
**********************************************************************          
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'022NESFM34   06/15/16'                                      
         END                                                                    
