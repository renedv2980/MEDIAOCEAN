*          DATA SET CPREP7302  AT LEVEL 115 AS OF 05/01/02                      
*PHASE CP7302A                                                                  
*INCLUDE SORTER                                                                 
         TITLE 'CPREP7302- CPP- COST ANALYSIS'                                  
         PRINT NOGEN                                                            
CP7302   CSECT                                                                  
         NMOD1 0,CP7302,RR=R5                                                   
         L     RA,0(R1)                                                         
         LA    RC,2048(RA)                                                      
         LA    RC,2048(RC)                                                      
         USING CPWORKD,RA,RC                                                    
...
SD1      DS    0H                                                               
         ...
         CLC   SRMKT,HLDMKT                                                     
         BNE   CPMR                                                             
SD2      BAS   R9,FSLOT            FIND LENGTH SLOT                             
         L     RE,SLOT                                                          
         MH    RE,=H'32'                                                        
         L     R4,DPAREA                                                        
         USING DPD,R4                                                           
...
DPAREAC  CSECT                                                                  
       ...
       ++INCLUDE CPGENFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'115CPREP7302 05/01/02'                                      
         END                                                                    
