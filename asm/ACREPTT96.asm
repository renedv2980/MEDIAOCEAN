*          DATA SET ACREPTT96  AT LEVEL 010 AS OF 05/01/02                      
*PHASE ACTT02A,*                                                                
*INCLUDE SORTER                                                                 
*INCLUDE DLFLD                                                                  
*INCLUDE CONVMOS                                                                
...
*                                                                               
         ...
         DC    C'30870'            TRANSMITTER#(00000 USE DDS#)-TCC             
...
*CTGENFILE                                                                      
       ...
       ++INCLUDE DDDLCB                                                         
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010ACREPTT96 05/01/02'                                      
         END                                                                    
