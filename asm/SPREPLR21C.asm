*          DATA SET SPREPLR21C AT LEVEL 063 AS OF 05/01/02                      
*PHASE SPLR02C,+0,NOAUTO                                                        
         TITLE 'SPREPLR21C BBM DIRECTORY REPORT'                                
SPLR02   CSECT                                                                  
         PRINT NOGEN                                                            
         ...
         CLI   MODE,REQFRST                                                     
         BNE   EXIT                                                             
         MVC   H8,=CL132'STATION      MAR00   JUL00   NOV00   MAR01   JX        
               UL01'                                                            
         MVI   FORCEHED,C'Y'                                                    
         MVI   SHOWPLUS,C'Y'                                                    
         MVI   SPLUSNOW,C'Y'                                                    
         ...
         USING SBKEY,R6                                                         
         XC    SPLKEY,SPLKEY                                                    
         MVC   SBCODE(3),=C'SCA'   SET TO READ PRIMARY DIRECTORY                
         MVC   SVSPLKEY,SPLKEY                                                  
         XC    SPILCTR,SPILCTR                                                  
...
SPLR6    CLI   SBCODE,C'S'         STATIONS ONLY                                
         BNE   EXIT                                                             
         CLI   SBMEDIA,C'C'        CANADIAN TELEVISION ONLY                     
         BNE   EXIT                                                             
         CLI   SBSRC,C'A'          BBM                                          
         BNE   EXIT                                                             
...
GOODBOOK CLC   SBBOOK,=X'6402'                                                  
         ...
         B     SPLR2                                                            
GDBOOK1  CLC   SBBOOK,=X'6403'     CHECK ONLY BOOKS AFTER MAR '00               
...
TABLE    DC    AL1(100,03,14)       MAR 00                                      
         DC    AL1(100,07,22)       JUL 00                                      
         DC    AL1(100,11,30)       NOV 00                                      
         DC    AL1(101,03,38)       MAR 01                                      
         DC    AL1(101,07,46)       JUL 01                                      
         DC    X'FFFF'                                                          
         SPACE 2                                                                
SPLRRA DC      F'0'                                                             
SPLRRB DC      F'0'                                                             
...
PSBOOKS  DS    CL80                                                             
       ...
       ++INCLUDE SPREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'063SPREPLR21C05/01/02'                                      
         END                                                                    
