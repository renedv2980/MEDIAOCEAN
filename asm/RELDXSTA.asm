*          DATA SET RELDXSTA   AT LEVEL 250 AS OF 05/01/02                      
*          DATA SET RELDTEST   AT LEVEL 240 AS OF 09/20/95                      
*PHASE RELDXSTA,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDXSTA - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*  DELETE KATZ NATIONAL CONTRACTS FOR WGNT AND KNXV               *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'250RELDXSTA  05/01/02'                                      
         END                                                                    
