*          DATA SET DDSPANKERR AT LEVEL 003 AS OF 05/01/02                      
*          DATA SET DDSPANKER  AT LEVEL 037 AS OF 03/05/96                      
*PHASE SPANKERR                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE CARDS                                                                  
*INCLUDE DMDMGRL                                                                
...
******   GOTO1 (RF),(R1),0,(1,WORK)                                             
         OPEN  ((R4),OUTPUT)                                                    
         LTR   RF,RF               TEST OPEN WORKED OKAY                        
         BZ    *+6                  YES                                         
         DC    H'0'                                                             
*                                                                               
...
SYSTAB   DS    0CL19                                                            
         ...
         DC    C'ROIFILE ',X'08',AL3(ROIDEFN)                                   
         DC    AL2(31,31,38),X'80'                                              
         DC    X'FF'                                                            
*                                  KEY FORMAT TABLE                             
KEYTAB   DS    0CL4                                                             
...
REPDEFN  DS    0C                                                               
         ...
         DC    AL1(02,AGYA)                                                     
         DC    X'0D000FFF',AL1(00,00),AL1(12),X'00',AL3(0)                      
         DC    AL1(23,AGYA)                                                     
...
ROIDEFN  DS    0C                                                               
         DC    X'00000000',AL1(00,00),AL1(01),X'40',AL3(0)                      
         DC    AL1(0,0)                                                         
         DC    X'2F002FFF',AL1(00,00),AL1(02),X'00',AL3(0)                      
         DC    AL1(25,AGYA)                                                     
         DC    X'FFFFFFFF',AL1(00,00),AL1(03),X'20',AL3(0)                      
         DC    AL1(0,0)                                                         
         DC    X'0000FFFF',AL1(00,00),AL1(04),X'98',AL3(0)                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003DDSPANKERR05/01/02'                                      
         END                                                                    
