*          DATA SET CTFUS00    AT LEVEL 048 AS OF 02/24/17                      
*PHASE TA0800A                                                                  
*INCLUDE EXPRESS                                                                
*INCLUDE HEXIN                                                                  
...
FUSPROFS CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 WORKX-WORKD,**FUS**,RA,R8,RR=RE,CLEAR=YES                        
...
*                                                                               
         ...
         GOTO1 (RF),DMCB,0         GET A(SYSTEMS LIST)                          
*                                                                               
         L     R1,0(R1)                                                         
...
*                                                                               
         L     R1,ASECBLK                                                       
         USING SECD,R1                                                          
         MVC   PSECINDS,SECINDS    COPY OVER SECURITY INDICATORS                
         DROP  R1                                                               
*                                                                               
...
*                                                                               
         ...
         BNE   FUSP020             NO ACCESS                                    
         B     FUSP010                                                          
*                                                                               
FUSP008  TM    INDICS,X'80'          IF AUTHORISED                              
         BO    FUSP010                                                          
...
*                                                                               
         TM    PSECINDS,SECIOLD    OLD SECURITY?                                
         BO    VALSYS              . YES                                        
         LA    R2,FUSACTN          R3=(RECORD, A(ACTION))                       
         GOTO1 PSECRET,DMCB,('SECPRACT',ASECBLK),('PPROFQ',ACTION)              
...
*                                                                               
         TM    PSECINDS,SECIOLD    OLD SECURITY?                                
         BO    VALPRG                                                           
         LA    R2,FUSSYSH          R3=(RECORD, A(ACTION))                       
         MVC   BYTE,SYSNUM                                                      
*                                                                               
VALSYS20 OI    BYTE,X'20'          ADJUST FOR SYSTEM/ACTION NUMBER              
...
***********************************************************************         
* CHECK FOR OFFICE LIST                                                         
***********************************************************************         
CHKOFFL  DS    0H                                                               
*&&US                                                                           
         CLI   SYSEQU,C'S'         SPOT?                                        
         BE    *+12                                                             
         CLI   SYSEQU,C'P'         OR PRINT?                                    
         BNE   GETPID              NO: MOVE ON                                  
         CLI   PRGNUM,C'$'         CHECK FOR OFFICE LISTS                       
         BE    *+12                                                             
         CLI   PRGNUM+1,C'$'       OFFICE LIST?                                 
         BNE   GETPID              NO: MOVE ON                                  
...
*                                                                               
         GOTO1 AFVAL,FUSUIDH                                                    
         BE    VUID004                                                          
         XC    FUSUID,FUSUID       HERE FOR NO USERID INPUT                     
         OI    FUSUIDH+6,X'80'                                                  
         MVI   LISTFLAG,1          FLAG FOR FULL AGENCY/USERID LIST             
         B     VALUIDX                                                          
*                                                                               
VUID004  SR    RF,RF               HERE FOR USERID INPUT                        
         IC    RF,FLDH+5                                                        
         BCTR  RF,0                                                             
         CLI   FLDH+5,4                                                         
         BH    VUID008                                                          
...
VUID100  CLC   INUAGY,AGYALPH      NOT OK IF NOT SAME AGENCY                    
         BNE   EISL                                                             
         TM    PSECINDS,SECIOLD    OLD SECURITY?                                
         BZ    *+12                                                             
         TM    INDICS,X'80'        OK IF DDS                                    
...
*                                                                               
         ...
         BZ    EUAU                                                             
         CLI   ACTION,DISPLAY      DISPLAY?                                     
         BE    VUID200                                                          
         CLC   USERID,PUSERIDN     OK IF PRINCIPLE ID                           
         BNE   EUCP                  FOR THE SAME AGENCY                        
*                                                                               
...
*                                                                               
********* REMOVED 4/NOV/2008 - CHANGE USER-ID LEVEL FROM PRNCPL CON ID          
*                                  BUILD COMPATIBLE ID LIST IN TIA              
*                                    FROM PASSWORD AUTH RECORD                  
*        USING CT0REC,R4                                                        
*UID110  OC    PASSWD,PASSWD       UNLESS NOT CONNECTED TO A PASSWORD           
*        BZ    EISL                                                             
*        LA    R4,IO                                                            
*        XC    CT0KEY,CT0KEY                                                    
...
*                                                                               
         ...
         BNE   VALEND10                                                         
         CLC   INUALL,LINUALL      CHECK "ALL" CHANGED                          
         BNE   VALEND10                                                         
         B     *+8                                                              
...
VALEND20 CLI   SYSNUM,X'0A'        ALWAYS USE ALPHA IF CONTROL                  
         BE    VALEND22                                                         
         MVC   CTUKAGY(1),AGYBINY                                               
         TM    SYSINDS,X'80'                                                    
         BO    *+10                                                             
VALEND22 MVC   CTUKAGY,AGYALPH                                                  
*                                                                               
...
DSP005   GOTOR CTIO,DMCB,(X'80',DMRDHI),IO                                      
         BNE   EIIO                                                             
         CLI   DMCB+8,0                                                         
         BNE   ERNF                                                             
         B     DSP020                                                           
*                                                                               
DSP010   GOTOR CTIO,DMCB,(X'80',DMRSEQ),IO                                      
         BNE   EIIO                                                             
         CLI   DMCB+8,0                                                         
         BNE   ERNF                                                             
         MVC   KEY,IO              SET RETURNED KEY FOR NEXT SEQ                
*                                                                               
DSP020   LA    R4,IO                                                            
...
*                                                                               
         TM    PSECINDS,SECIOLD    OLD SECURITY?                                
         BZ    DSP030                                                           
         TM    INDICS,X'80'        TEST IF DDS                                  
         BO    *+22                                                             
         TM    TWAAUTH-TWAD(R9),X'10'  CLIENT ONLY IF AUTH=1000                 
         BZ    *+14                                                             
         OC    CTUKCLT,CTUKCLT                                                  
         BZ    DSP010                                                           
*                                                                               
DSP030   CLI   LISTFLAG,1          CHECK IF FULL USER ID/AGENCY LIST            
         BNE   DSP054                                                           
*                                                                               
         NI    INDICS,X'FF'-IAGYLQ TURN OFF AGENCY LEVEL PROFILE                
         CLI   CTUKUID,X'4D'       CHECK NEXT RECORD AGENCY LEVEL               
         BNL   DSP048                                                           
*                                                                               
...
*                                                                               
         ...
         BE    DSP058                DISPLAY IT                                 
         B     DSP010                ELSE GET NEXT                              
*                                                                               
DSP040   MVC   INUNUM,CTUKUID      VALIDATE NEW USER ID                         
         MVC   KEY,IO                                                           
         BRAS  RE,VALKUID                                                       
         CLI   KUIDFLAG,0                                                       
         BE    DSP044                                                           
*                                  HERE IF INVALID USERID                       
         GOTOR CTIO,DMCB,(X'80',DMRDHI),IO                                      
         BNE   EIIO                                                             
         CLI   DMCB+8,0                                                         
         BNE   ERNF                                                             
         B     DSP010              GET NEXT RECORD                              
*                                  HERE IF VALID USER ID                        
DSP044   GOTOR CTIO,DMCB,(X'80',DMRDHI),IO                                      
         BNE   EIIO                                                             
         CLI   DMCB+8,0                                                         
         BNE   ERNF                                                             
         B     DSP058              DISPLAY RECORD                               
*                                  DISPLAY AGENCY LEVEL RECORD                  
DSP048   OI    INDICS,IAGYLQ       X'20' AGENCY LEVEL PROFILE                   
         MVI   LISTFLAG,0                                                       
         XC    INUNUM,INUNUM                                                    
         LA    R4,KEY                                                           
         CLC   CTUKAGY,AGYALPH                                                  
...
*                                  CHECK SECURITY AGENCY LEVEL                  
DSP050   TM    PSECINDS,SECIOLD    OLD SECURITY?                                
         BO    *+16                                                             
         CLI   ACTION,DISPLAY                                                   
         BE    DSP005                                                           
         B     *+12                                                             
...
*                                                                               
DSP054   OC    INUNUM,INUNUM       CHECK IF USERID INPUT                        
         BZ    DSP060                                                           
         CLC   CTUKUID,INUNUM                                                   
         BNE   DSPEND                                                           
*                                                                               
DSP058   CLI   SYSNUM,6                                                         
         ...
         B     DSPREC8                                                          
*                                                                               
DSP060   CLI   SYSNUM,X'0A'        ALWAYS USE ALPHA FOR CONTROL SYSTEM          
         BE    *+12                                                             
         TM    SYSINDS,X'80'                                                    
         BO    DSPREC6                                                          
         CLC   CTUKAGY,AGYALPH                                                  
...
DSPRECI  TM    FLTCLI,X'40'        TEST SPECIAL CLIENT FILTER VALUE             
         ...
         BL    DSP010              GREATER THAN OR EQUAL TO FILTER              
         B     DSPRECK                                                          
*                                                                               
...
DSPRECO  CLI   0(RF),0                                                          
         ...
         BE    DSPRECR                                                          
         CLC   0(1,R3),0(RE)                                                    
         BNE   DSP010              GET NEXT RECORD IF FILTER VALID              
*                                                                               
...
DSPRECR2 MVC   0(3,RE),CT@ALL                                                   
         ...
         LA    RE,4(RE)                                                         
*                                                                               
         CLI   SYSNUM,X'0A'        IF CONTROL, THEN IGNORE SYSINDS              
         BO    *+12                                                             
...
DSPRECT  MVC   0(1,RE),CTUKMED                                                  
         LA    RE,1(RE)                                                         
*                                                                               
DSPRECV  OC    CTUKCLT,CTUKCLT     IF ALL CLIENTS DISPLAY BLANK                 
         BZ    DSPREC10            (ALLOWS FOR CLIENT VALUE OF 'ALL')           
         MVI   0(RE),C','          MOVE DELIMITER                               
         MVC   1(3,RE),CTUKCLT                                                  
*                                                                               
         LR    R6,RE                                                            
         GOTOR CONOFF,DMCB,(1,1(R6)),(C'C',0)                                   
         LR    RE,R6                                                            
         BE    DSPREC10            OFFICE CODE CLIENT                           
*                                                                               
...
DSPREC12 OC    0(2,R3),0(R3)                                                    
         ...
         MVC   WORK+6(3),0(R6)                                                  
*                                                                               
DSPREC14 SR    R1,R1               TEST IF PROFILE VALUE IS VALID               
         IC    R1,FLAG                                                          
         AHI   R1,1                                                             
         STC   R1,FLAG                                                          
         XC    FADR,FADR                                                        
*                                                                               
         GOTOR CONOFF,DMCB,(1,0(R6)),(C'P',0)                                   
         BE    DSPREC16            OFFICE CODE                                  
*                                                                               
         SR    R1,R1                                                            
         IC    R1,FLAG             RESET R1                                     
*                                                                               
         GOTOR VALVAL                                                           
         BE    DSPREC16            YES                                          
         MHI   R1,L'FLDDEFS        NO - DISPLAY DEFAULT VALUE INSTEAD           
         LA    R1,FLDDEFS-L'FLDDEFS(R1)                                         
         MVC   WORK(1),CTFDDEF-CTFDD(R1)                                        
         MVC   0(1,R6),WORK                                                     
         CLI   1(R3),C'C'                                                       
         BE    DSPREC16                                                         
         GOTO1 PHEXOUT,DMCB,WORK,0(R6),1,=C'TOG'                                
         CLI   1(R3),C'X'                                                       
         BE    DSPREC16                                                         
         EDIT  (B1,WORK),(3,0(R6)),ALIGN=LEFT                                   
         OI    0(R6),X'F0'                                                      
*                                                                               
DSPREC16 LA    R6,1(R6)            FIND END OF OUTPUT VALUE                     
         CLI   0(R6),C' '                                                       
         BH    DSPREC16                                                         
         ...
         BCT   R7,DSPREC12                                                      
*                                                                               
DSPREC18 BCTR  R6,0                REMOVE LAST DELIMITER                        
         MVI   0(R6),0                                                          
*                                                                               
         DROP  R5                                                               
         TM    OPTNFLAG,DISPACTV            DISPLAY ACTIVITY DATE?              
...
CHAREC4  LA    R3,L'SCANBLK(R3)    BUMP TO NEXT SCAN BLOCK ENTRY                
         ...
         MVC   FLAG,FNDX                                                        
*                                                                               
         GOTOR CONOFF,DMCB,(2,WORK+6),(C'P',0)                                  
         MVC   DUB(L'OFCOFC),WORK+6                                             
         BE    CHAREC5             OFFICE CODE                                  
         BL    EORN                OFFICE RECORD NOT FOUND                      
*                                                                               
         BAS   RE,VALVAL                                                        
...
CHAREC9  GOTOR CTIO,DMCB,(X'80',DMREAD),IO                                      
         BNE   EIIO                                                             
         CLI   DMCB+8,0                                                         
         BNE   CHARECM                                                          
         LA    R4,IO                                                            
...
CHARECK  GOTOR CTIO,DMCB,DMWRT,IO                                               
         BNE   EIIO                                                             
         CLI   DMCB+8,0                                                         
         BNE   ERNF                                                             
         OI    UPDFLAG,X'80'                                                    
...
*                                                                               
         ...
         BNE   *+8                                                              
         BCT   R1,*-8                                                           
         MVC   REQUEST+62(1),0(R1) LAST CHR OF SENAME.INV FOR 2 CHR SYS         
...
VALCLI3  LTR   R0,R0               TEST CODE SUFFIXED WITH AN AMPERSAND         
         ...
         B     VALEXT                                                           
*                                                                               
VALCLI4  GOTOR CONOFF,DMCB,(2,DUB),(C'C',0)                                     
         BL    EORN                                                             
         B     VALEXT                                                           
*                                  UPDATE FIELD VALUE RECORD                    
*----------------------------------------------------------------------         
...
EUCP     LA    RF,CE#MUSP          USER ID LEVEL CHNG FROM PRINCIPAL ID         
         B     ERRX                                                             
ENOL     LA    RF,113              OFFICE LIST NOT SUPPORTED HERE               
         B     ERRX                                                             
...
***********************************************************************         
CTIO     NTR1  BASE=*,LABEL=*                                                   
         CLI   ACTION,DISPLAY      TEST DISPLAY                                 
         BNE   *+8                 NO                                           
         NI    0(R1),X'7F'         DO NOT DO READ FOR UPDATE                    
*                                                                               
         L     R0,4(R1)                                                         
...
*        LA    RF,WORK                                                          
*        GOTO1 PSECRET,DMCB,('SECPOPTP',ASECBLK),(RF)                           
*        BNE   DAUTNO              NO ACCESS                                    
*        B     DAUT021                                                          
*                                                                               
DAUT020  TM    TWAAUTH-TWAD(R9),X'20'                                           
         BNO   DAUTNO                                                           
DAUT021  EQU   *                                                                
*&&US*&& B     DAUTOK                                                           
...
*                                                                               
         ...
         CLI   PRGNUM,C'$'                                                      
         BE    *+10                                                             
         MVC   OFCMOL,PRGNUM+2     OFFICE LIST VALUE                            
         MVC   OFCSYS,SYSEQU       SYSTEM ID                                    
         MVC   OFCAGY,AGYALPH      ALPHA AGENCY                                 
         OI    OFCINDS,OFCIMOLC    CONVERT TWO CHAR OFFICE LIST                 
*                                                                               
         GOTO1 POFFICER,DMCB,(C'2',WORK),SVCFACS                                
         JNE   CKMOLOX             INVALID OFFICE LIST                          
*                                                                               
         LA    R6,KEY                                                           
         USING CTUREC,R6           BUILD MAIN OFFICE LIST RECORD                
         XC    CTUKEY,CTUKEY                                                    
         MVI   CTUKEY,CTUKTYPQ                                                  
         MVC   CTUKSYS,SYSEQU                                                   
         MVI   CTUKPROG+1,C'$'                                                  
...
*                                                                               
         LA    R0,=C'DMREAD  '                                                  
         GOTOR PDATAMGR,DMCB,(X'08',(R0)),=C'CTFILE ',KEY,IO,0                  
         CLI   8(R1),0                                                          
         BE    CKMO10                                                           
         TM    8(R1),X'02'                                                      
         BO    CKMO10                                                           
...
*                                                                               
CKMO10   LA    R6,IO                                                            
         LHI   RE,CTUDATA-CTUREC                                                
         STH   RE,DATADISP                                                      
         MVI   ELCODE,CTOFELQ      GET NEW OFFICE LIST ELEMENT                  
         BRAS  RE,GETEL                                                         
         JE    CKMOHIX             NEW LIST PROGRAM NEEDED                      
         J     CKMOEQX                                                          
         DROP  R5,R6                                                            
*                                                                               
CKMOHIX  LHI   R1,2                      HIGH - NOT AN OFFICE VALUE             
         J     CKMOX                                                            
CKMOLOX  LHI   R1,0                      LOW - OFFICE VALUE INVALID             
         J     CKMOX                                                            
CKMOEQX  LHI   R1,1                      EQUAL - OFFICE VALID                   
CKMOX    CHI   R1,1                                                             
         J     XIT                                                              
         LTORG                                                                  
*&&                                                                             
...
*                                                                               
         USING CTFDD,R7                                                         
         TM    CTFDOTHR,X'20'            VALUE IS A MEDIA OFFICE?               
         BO    COFF015                                                          
         DROP  R7                                                               
*                                                                               
         CLI   PRGNUM,C'$'               OFFICE LIST?                           
         BE    COFF015                                                          
         CLI   PRGNUM,0                  OR COULD BE X'00'C'$N'                 
         BNE   COHIXIT                                                          
         CLI   PRGNUM+1,C'$'             OFFICE LIST?                           
         BNE   COHIXIT                                                          
...
COFF015  CLI   0(R2),C'*'                OFF PROF OF * MEANS NO OFFICE          
         ...
         BE    COHIXIT                                                          
*                                                                               
COFF020  MVI   DUB2,C'S'                                                        
         CLI   SYSNUM,2                  SPOT                                   
         BE    COFF030                                                          
         CLI   SYSNUM,13                 SPOT TRAFFIC                           
         BE    COFF030                                                          
         MVI   DUB2,C'N'                                                        
         CLI   SYSNUM,3                  NETWORK                                
         BE    COFF030                                                          
         MVI   DUB2,C'P'                                                        
         CLI   SYSNUM,4                  PRINT                                  
         BNE   COHIXIT                                                          
*                                        DISPLAY PROFILE VALUES                 
         USING OFFICED,R5                                                       
COFF030  LA    R5,WORK+20                                                       
         XC    OFFICED(OFCLENQ),OFFICED                                         
         MVC   OFCSYS,DUB2               SYSTEM ID                              
         MVC   OFCAGY,AGYALPH            ALPHA AGENCY                           
*                                                                               
         CHI   R4,1                      ONE BYTE OFFICE?                       
         BNE   COFF040                   . NO                                   
         MVC   OFCOFC,0(R2)              ONE BYTE OFFICE                        
         B     COFF050                                                          
COFF040  MVC   OFCOFC2,0(R2)             TWO BYTE OFFICE                        
*                                                                               
COFF050  GOTO1 POFFICER,DMCB,(C'2',OFFICED),SVCFACS                             
*                                                                               
         CHI   R4,2                      DISPLAYING OFFICE?                     
         BE    COFF052                   . NO                                   
         MVC   KEY,IO                                                           
         GOTOR CTIO,DMCB,(X'80',DMREAD),IO  RE-READ REC FOR SEQUENCE            
*                                                                               
COFF052  TM    OFCINDS,OFCINOLA          NOT USING 2 CHAR MED OFFICES           
         BO    COHIXIT                                                          
...
COFF060  MVC   0(L'OFCOFC,R2),OFCOFC     1 BYTE OFFICE CODE                     
         ...
         DROP  R5                                                               
*                                                                               
COHIXIT  LHI   R1,2                      HIGH - NOT AN OFFICE VALUE             
         J     COXIT                                                            
COLOXIT  LHI   R1,0                      LOW - OFFICE VALUE INVALID             
         J     COXIT                                                            
COEQXIT  LHI   R1,1                      EQUAL - OFFICE VALID                   
COXIT    CHI   R1,1                                                             
         J     XIT                                                              
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                               
         USING CTSYSD,R3                                                        
VKID050  CLI   CTSYSNUM,X'0A'      SAVE CONTROL/PRO AUTH CODE                   
         BNE   VKID020                                                          
         MVC   PROGAUTH,CTSYSALL                                                
         LA    R1,CTSYSPGM                                                      
         ZIC   RE,CTSYSLEN                                                      
...
VKID052  CHI   RE,16                                                            
         ...
         B     VKID052                                                          
*                                                                               
VKID054  MVC   PROGAUTH,1(R1)      SAVE ACCESS CODE                             
         B     VKID020                                                          
         DROP  R3                                                               
*                                  CHECK VALID USERID ACCESS                    
VKID100  TM    PSECINDS,SECIOLD    OLD SECURITY?                                
         BZ    *+12                                                             
         TM    PROGAUTH,X'40'      OK IF =FUS AUTH=4000                         
         BNO   VKIDNO                                                           
         CLC   INUAGY,AGYALPH      NOT OK IF NOT CONNECTED AGENCY               
         BNE   VKIDNO                                                           
         CLI   ACTION,DISPLAY      DISPLAY?                                     
         BE    VKIDOK                                                           
         CLC   USERID,PUSERIDN     OK IF PRINCIPLE ID                           
         BE    VKIDOK                FOR THE SAME AGENCY                        
         B     VKIDNO                                                           
*                                                                               
*                                                                               
...
* EQUATES                                                                       
***********************************************************************         
DISPLAY  EQU   2                   ACTION - DISPLAY                             
CHANGE   EQU   3                   ACTION - CHANGE                              
*                                                                               
FIRST    EQU   0                                                                
NEXT     EQU   1                                                                
LAST     EQU   2                                                                
...
DATADISP DS    H                                                                
*                                                                               
INDICS   DS    XL1                 INDICATOR                                    
*        EQU   X'80'               . DDS TERMINAL                               
*        EQU   X'40'               . GLOBAL KEY CHANGE                          
IAGYLQ   EQU   X'20'               . AGENCY LEVEL PROFILE                       
*                                                                               
TODAYB   DS    CL3                                                              
SCANFLDS DS    XL1                                                              
*                                                                               
...
INUALL   DS    C                   INPUT USERID FLAG                            
INUALLQ  EQU   C'Y'                . "ALL" INPUT IN USER ID FIELD               
...
PSECINDS DS    XL1                 PROGRAM SECURITY INDICATORS                  
*                                                                               
FLTVALS  DS    0CL12                                                            
FLTSYS   DS    XL1                                                              
FLTINDS  DS    XL1                                                              
...
***********************************************************************         
PPROFQ   EQU   1     ACCESS           PROFILE                                   
PPSYSQ   EQU   2     SYSTEM           SYSTEM FIELD                              
*                                                                               
OUIDQ    EQU   1     OCONTROL         USER-ID                                   
*ODDSQ    EQU   2     OCONTROL         AUTHORIZED FOR DDS ONLY PROFILES         
*                                                                               
FMEDQ    EQU   1     FIELD CONTROL    MEDIA                                     
FCLIQ    EQU   2     FIELD CONTROL    CLIENT                                    
...
LFLTDATE DS    XL3                                                              
LOPTFLAG DS    X                                                                
LINUALL  DS    C                   INPUT USERID FLAG                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'048CTFUS00   02/24/17'                                      
         END                                                                    
