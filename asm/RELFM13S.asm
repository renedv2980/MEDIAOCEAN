*          DATA SET RELFM13S   AT LEVEL 071 AS OF 05/01/02                      
*PHASE T80413A,*                                                                
*INCLUDE NUMVAL                                                                 
*INCLUDE RIGHT                                                                  
...
*                                                                   *           
*  JUL01/97 (BU ) --- UPGRADE EOM RECORD DATES FOR YR-2000          *           
*                                                                   *           
*  JAN26/98 (ASTE) -- BUDGET LEVEL RESTRICTIONS ACCORDING TO REP    *           
*                     RECORD  PROFILES PROVIDED WHEN ADDING NEW     *           
*                     BUDGET RECORDS                                            
*                                                                   *           
*                     ***  END TOMBSTONE  ***                       *           
*********************************************************************           
...
BE0003   MVC   LFMMSG(L'CONPROF),CONPROF                                        
         ...
         BNE   BE0004              NONE OF THE THREE, ALLOW ANYTHING            
         CLI   BCONTYP,C' '        FOR 'C' - CONTRACT MUST BE FILLED            
         BNH   MYERROR                                                          
         DROP  R5                                                               
*                                                                               
BE0004   XC    KEY,KEY             RESTORE KEY                                  
         MVC   KEY,SAVEKEY2                                                     
         GOTO1 HIGH                RESTORE ORIGINAL REC                         
*                                                                               
         XC    RBUDELEM(110),RBUDELEM    ZERO OUT RECORD                        
...
DEMOD    DSECT                                                                  
       ++INCLUDE DEDBLOCK                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'071RELFM13S  05/01/02'                                      
         END                                                                    
