*          DATA SET RERMP1CT   AT LEVEL 072 AS OF 05/01/02                      
*PHASE T8101CT,*                                                                
*INCLUDE DYNALLOC                                                               
*INCLUDE UPOUT                                                                  
*INCLUDE COVAIL                                                                 
...
*                                                                               
         OI    GENSTAT2,NOREQDET  DONT PRINT COVER SHEET                        
*                                                                               
         MVI   BLANKS,X'40'                                                     
...
*                                                                               
         LH    R0,RECLEN                                                        
*        AHI   R0,4               5/22/00 FDOY                                  
         GOTO1 =V(PRNTBL),DMCB,=C'REC',AIO3,C'DUMP',(R0),=C'1D'                 
         B     EXXMOD                                                           
         EJECT                                                                  
HOOK     NTR1                                                                   
         L     R6,ASPOOLD          ESTABLISH SPOOL WORKAREA                     
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'072RERMP1CT  05/01/02'                                      
         END                                                                    
