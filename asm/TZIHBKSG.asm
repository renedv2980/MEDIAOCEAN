*          DATA SET TZIHBKSG   AT LEVEL 185 AS OF 10/10/00                      
*PHASE TZIHBKSG                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE KHDUMMY                                                                
*INCLUDE PDUMPER                                                                
...
FIL1     DCB   DDNAME=BOOKS,DSORG=PS,MACRF=GM,RECFM=FB,LRECL=70,       X        
               BLKSIZE=700,EODAD=EMAINRD                                        
RECCARD  DC    CL80'RECORD TYPE=F,LENGTH=60'                                    
SORTC1   DC    CL80'SORT FIELDS=(58,1,A,1,51,A),FORMAT=BI,WORK=1'               
******************************************************                          
...
*                                                                               
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'185TZIHBKSG  10/10/00'                                      
         END                                                                    
