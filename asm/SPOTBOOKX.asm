*          DATA SET SPOTBOOKX  AT LEVEL 029 AS OF 05/01/02                      
*PHASE T00A49A,*                                                                
*INCLUDE GETBROAD                                                               
         SPACE 1                                                                
*================================================================*              
...
*                                                                               
ACT      XC    SBNBKS,SBNBKS       CLEAR N'BOOK LOOKUP ENTRIES                  
...
* FOLLOWING INSTRUCTIONS BECAUSE ZEN SAYS SO                                    
         CLC   2(2,R4),=X'C481'    IF WEEK ENDS ON 4/1/98                       
         BNE   SPLTW40                                                          
         CLI   ACTBOOKS+2,3        AND THERE IS NO MARCH BOOK                   
         BE    SPLTW40                                                          
         MVC   4(2,R4),=X'6204'    THE USE APRIL BOOK                           
*                                                                               
SPLTW40  LA    R4,7(R4)            NEXT WEEKLIST ENTRY                          
...
* SPGENBUY                                                                      
       ...
       ++INCLUDE SPGENBUY                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029SPOTBOOKX 05/01/02'                                      
         END                                                                    
