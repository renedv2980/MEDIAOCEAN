*          DATA SET CTMAD14EDR AT LEVEL 065 AS OF 05/01/02                      
*PHASE TA0C14A                                                                  
*INCLUDE PUBVAL                                                                 
*INCLUDE RECUP                                                                  
*INCLUDE SIXPACK                                                                
...
*                                                                               
         ...
         MVI   MEDIAMOK,C'N'       ASSUME MEDIA 'M' NOT OK (FOR EDR)            
         MVI   MEDIATOK,C'N'       ASSUME MEDIA 'T' NOT OK (FOR EDR)            
...
*                                                                               
         ...
         BNE   *+8                                                              
         MVI   SVUPDFLG,C'Y'       CORRECT -- WRITE=NO                          
*                                                                               
         MVC   SVUPTYPE,UHDRTYPE   UPLOAD TYPE (STANDARD, EDR, ETC.)            
         DROP  R2                                                               
*                                                                               
         CLI   SVUPTYPE,C'E'       EDR UPLOAD?                                  
         BNE   PS45                                                             
         CLI   SVMED,C' '                                                       
         BE    *+6                 MEDIA MUST BE BLANK FOR EDR                  
         DC    H'0'                                                             
*                                                                               
* MUST DO EDR MEDIA IN ALPHABETICAL ORDER (FOR PUBLIST BUILD)                   
*                                                                               
         MVI   SVMED,C'M'          FIRST DO MAGAZINES                           
         BAS   RE,VALHEADR                                                      
         CLI   ERFLDNUM,0                                                       
         BNE   *+8                                                              
         MVI   MEDIAMOK,C'Y'                                                    
         MVI   SVMED,C'T'          NOW DO TRADE                                 
         BAS   RE,VALHEADR                                                      
         CLI   ERFLDNUM,0                                                       
         BNE   *+8                                                              
         MVI   MEDIATOK,C'Y'                                                    
*                                                                               
         CLI   MEDIAMOK,C'Y'       ONE OF THESE HAD BETTER BE OK                
         BE    PS48                                                             
         CLI   MEDIATOK,C'Y'                                                    
         BE    PS48                                                             
*                                                                               
         MVI   ERFLDNUM,7          NEITHER M NOR T IS OK                        
         MVC   ERRNUM,=H'16'       FIELD IN ERROR IS ESTIMATE                   
         B     PS50                                                             
*                                                                               
PS45     BAS   RE,VALHEADR         VALIDATE HEADER RECORD FIELDS                
*                                                                               
...
* BOGUS INSERTIONS FOR NOTHING.  IF IT'S AN EDR UPLOAD, HOWEVER, THEN           
* SEE WHETHER MEDIAS 'M' AND/OR 'T' ARE VALID AND REMEMBER THAT FACT.           
***********************************************************************         
VALHEADR NTR1                                                                   
*                                                                               
...
*                                                                               
         ...
         MVC   ERRNUM,=H'1'        MISSING FIELD                                
         B     VHX                                                              
         MVC   WORK(2),SVPESTST+4  CONSTRUCT START DATE: FORMAT MMDDYY          
         MVC   WORK+2(2),SVPESTST+6                                             
         MVC   WORK+4(2),SVPESTST+2  IGNORE CENTURY                             
         GOTO1 PERVAL,DMCB,(6,WORK),(X'40',WORK+6)                              
         TM    DMCB+4,X'03'                                                     
         BZ    *+14                                                             
         MVC   ERRNUM,=H'2'        INVALID FIELD                                
         B     VHX                                                              
         PACK  DUB,SVPESTST+2(2)   IGNORE CENTURY, PACK INSERTION YEAR          
         CVB   R1,DUB                                                           
         STC   R1,SVPESTS3         BINARY YEAR                                  
         PACK  DUB,SVPESTST+4(2)   PACK INSERTION MONTH                         
         CVB   R1,DUB                                                           
         STC   R1,SVPESTS3+1       BINARY MONTH                                 
         PACK  DUB,SVPESTST+6(2)   PACK INSERTION DAY                           
         CVB   R1,DUB                                                           
         STC   R1,SVPESTS3+2       BINARY DAY                                   
*                                                                               
         ...
         MVC   ERRNUM,=H'1'        MISSING FIELD                                
         B     VHX                                                              
         MVC   WORK(2),SVPESTEN+4  CONSTRUCT END DATE IN FORMAT MMDDYY          
         MVC   WORK+2(2),SVPESTEN+6                                             
         MVC   WORK+4(2),SVPESTEN+2  IGNORE CENTURY                             
         GOTO1 PERVAL,DMCB,(6,WORK),(X'40',WORK+6)                              
         TM    DMCB+4,X'03'                                                     
         BZ    *+14                                                             
         MVC   ERRNUM,=H'2'        INVALID FIELD                                
         B     VHX                                                              
         PACK  DUB,SVPESTEN+2(2)   IGNORE CENTURY, PACK INSERTION YEAR          
         CVB   R1,DUB                                                           
         STC   R1,SVPESTE3         BINARY YEAR                                  
         PACK  DUB,SVPESTEN+4(2)   PACK INSERTION MONTH                         
         CVB   R1,DUB                                                           
         STC   R1,SVPESTE3+1       BINARY MONTH                                 
         PACK  DUB,SVPESTEN+6(2)   PACK INSERTION DAY                           
         CVB   R1,DUB                                                           
         STC   R1,SVPESTE3+2       BINARY DAY                                   
...
*                                                                               
         ...
         CLI   DMCB,X'FF'                                                       
         BE    VOBJ106             INVALID PUBCODE                              
         MVC   PPAKPUB,SVPUB                                                    
         B     VOBJ108                                                          
*                                                                               
VOBJ102  CLC   UINSZNED,=C'*****'  WAS A PAK-ID GIVEN?                          
         BNE   VOBJ103             NO                                           
         PACK  DUB,UINSPUB         EDR PAK-ID                                   
         LM    R0,R1,DUB                                                        
         SRDL  R0,4                                                             
         STCM  R1,15,SVPUB         PWOS                                         
         MVI   SVPUB+4,0                                                        
         MVI   SVPUB+5,X'FF'       THIS MEANS IT'S A PAK-ID                     
*                                                                               
         LA    R4,KEYSAVE                                                       
         USING PE2PRECD,R4                                                      
         XC    PE2PKEY,PE2PKEY     BUILD EDR/PUB PASSIVE POINTER                
         MVC   PE2PKAGY,SVAGY                                                   
         MVI   PE2PKMED,C'Z'                                                    
         MVI   PE2PKRCD,PE2PKIDQ                                                
         MVC   PE2PKEDR,UINSPUB                                                 
*                                                                               
         GOTO1 DATAMGR,DMCB,(0,=C'DMRDHI'),=C'PRTDIR',KEYSAVE,KEY               
         CLI   DMCB+8,0                                                         
         BE    *+6                                                              
         DC    H'0'                BAD RETURN CODE FROM DATAMGR                 
         CLC   KEY(PE2PKPMD-PE2PKEY),KEYSAVE                                    
         BNE   VOBJ106             NO POINTER -- INVALID PUBCODE                
         LA    R4,KEY                                                           
         MVC   SVMED,PE2PKPMD      PICK UP MEDIA CODE                           
         MVC   PPAKPUB,PE2PKPUB    PICK UP PRINTPAK PUBCODE                     
         B     VOBJ104                                                          
         DROP  R4                                                               
*                                                                               
VOBJ103  MVC   SVMED,UINSMED       MEDIA COMES FROM INSERTION RECORD            
         CLI   UINSEDRE,C'E'       DID EDR SAY THIS WAS IN ERROR?               
         BE    VOBJ106             YES - WE KNOW THE PUBCODE IS INVALID         
         MVC   WORK,SPACES                                                      
         MVC   WORK(L'UINSPUB),UINSPUB                                          
         MVC   WORK+L'UINSPUB+1(L'UINSZONE),UINSZONE                            
         MVC   WORK+L'UINSPUB+L'UINSZONE+2(L'UINSEDTN),UINSEDTN                 
         ...
         MVC   PPAKPUB,SVPUB                                                    
*                                                                               
VOBJ104  CLI   SVMED,C'M'          MEDIA 'M'?                                   
         BNE   VOBJ105                                                          
         CLI   MEDIAMOK,C'Y'                                                    
         BE    VOBJ108                                                          
         MVI   SVMED,X'FF'         TELL PRINT/BUY MEDIA IS BAD                  
         B     VOBJ106             ERROR                                        
*                                                                               
VOBJ105  CLI   SVMED,C'T'          MEDIA 'T'?                                   
         BE    *+6                                                              
         DC    H'0'                INVALID MEDIA FOR EDR                        
         CLI   MEDIATOK,C'Y'                                                    
         BE    VOBJ108                                                          
         MVI   SVMED,X'FF'         TELL PRINT/BUY MEDIA IS BAD                  
*                                                                               
VOBJ106  XC    SVPUB,SVPUB                                                      
         MVC   PPAKPUB,XFF                                                      
         MVI   SVACT,C'A'          INVALID PUBCODE, SO TELL PRT/BUY...          
         MVI   INSCHG,C'Y'         ...TO ADD, KNOWING WE'LL GET ERROR           
         B     VOBJ180                                                          
*                                                                               
VOBJ108  MVC   WORK(2),UINSMNTH    CONSTRUCT DATE IN FORMAT MMDDYY              
         MVC   WORK+2(2),UINSDAY                                                
         CLC   WORK+2(2),SPACES    ANY DAY GIVEN?                               
         BNE   *+10                                                             
         MVC   WORK+2(2),=C'01'    NO - FORCE DAY 1 JUST FOR NOW                
         MVC   WORK+4(2),UINSYEAR+2  IGNORE CENTURY                             
         GOTO1 PERVAL,DMCB,(6,WORK),(X'40',WORK+6)                              
         TM    DMCB+4,X'03'                                                     
         BZ    VOBJ110                                                          
         MVC   UINSDATE,XFF                                                     
         ...
         B     VOBJ180             ...SO HE KNOWS IT'S AN ERROR                 
*                                                                               
VOBJ110  XC    SVDATE,SVDATE                                                    
         PACK  DUB,UINSYEAR+2(2)   IGNORE CENTURY, PACK INSERTION YEAR          
         CVB   R1,DUB                                                           
         STC   R1,SVDATE           BINARY YEAR                                  
         PACK  DUB,UINSMNTH        PACK INSERTION MONTH                         
         CVB   R1,DUB                                                           
         STC   R1,SVDATE+1         BINARY MONTH                                 
         CLC   UINSDAY,SPACES      ANY DAY GIVEN?                               
         BE    *+18                                                             
         PACK  DUB,UINSDAY         PACK INSERTION DAY                           
         CVB   R1,DUB                                                           
         STC   R1,SVDATE+2         BINARY DAY                                   
*                                                                               
         CLC   LASTPUB,SVPUB       CHANGE OF PUB?                               
...
*                                                                               
VOBJ170  XC    MINEKEY,MINEKEY     LOOK FOR THIS UNIQUE ID                      
         MVI   MINEKEY,X'90'                                                    
...
VOBJ180  CLC   UINSCLOS,SPACES     IS THERE A CLOSING DATE?                     
         BE    VOBJ185             NO                                           
         MVC   WORK(2),UINSCLOS+4  CONSTRUCT DATE IN FORMAT MMDDYY              
         MVC   WORK+2(2),UINSCLOS+6                                             
         MVC   WORK+4(2),UINSCLOS+2  IGNORE CENTURY                             
         GOTO1 PERVAL,DMCB,(6,WORK),(X'40',WORK+6)                              
         TM    DMCB+4,X'03'                                                     
         BZ    VOBJ185                                                          
...
VOBJ185  CLC   UINSSALE,SPACES     IS THERE A SALE DATE?                        
         BE    VOBJ190             NO                                           
         MVC   WORK(2),UINSSALE+4  CONSTRUCT DATE IN FORMAT MMDDYY              
         MVC   WORK+2(2),UINSSALE+6                                             
         MVC   WORK+4(2),UINSSALE+2  IGNORE CENTURY                             
         GOTO1 PERVAL,DMCB,(6,WORK),(X'40',WORK+6)                              
         TM    DMCB+4,X'03'                                                     
         BZ    VOBJ190                                                          
...
VOBJ190  CLC   UINSMATC,SPACES     IS THERE A MATERIAL CLOSE DATE?              
         BE    VOBJ195             NO                                           
         MVC   WORK(2),UINSMATC+4  CONSTRUCT DATE IN FORMAT MMDDYY              
         MVC   WORK+2(2),UINSMATC+6                                             
         MVC   WORK+4(2),UINSMATC+2  IGNORE CENTURY                             
         GOTO1 PERVAL,DMCB,(6,WORK),(X'40',WORK+6)                              
         TM    DMCB+4,X'03'                                                     
         BZ    VOBJ195                                                          
...
VOBJ195  LA    RE,MYOBJECT         BUILD INSERTION OBJECT HERE                  
         ...
         B     VOBJX                                                            
*                                                                               
VOBJ200  L     R6,AIO              ADDITIONAL DATA OBJECT                       
         USING UOPTD,R6                                                         
         MVC   UOPTTYPE,=C'OPT*'                                                
*                                                                               
...
*                                                                               
         ...
         DROP  R6,RE                                                            
*                                                                               
VOBJ300  L     R6,AIO              CORPORATE BUY OBJECT                         
         USING UZZZD,R6                                                         
         MVC   UZZZTYPE,=C'ZZZ*'                                                
*                                                                               
         LH    RF,SUBNUM           INCREMENT SUB-RECORD NUMBER                  
...
*                                                                               
CNF105   CLI   SVUPTYPE,C'E'       EDR UPLOAD?                                  
         BNE   CNF110              YES                                          
         MVC   SVMED,PINSMED                                                    
         CLC   PINSZNED,=C'*****'  WAS A PAK-ID GIVEN?                          
         BNE   CNF110              IT'S VALID                                   
         PACK  DUB,PINSPUB         EDR PUBCODE                                  
         LM    R0,R1,DUB                                                        
         SRDL  R0,4                                                             
         STCM  R1,15,SVPUB                                                      
         MVI   SVPUB+4,0                                                        
...
CNF110   XC    SVDATE,SVDATE                                                    
         ...
         BE    CNF120                                                           
*                                                                               
         PACK  DUB,PINSYEAR+2(2)   IGNORE CENTURY, PACK INSERTION YEAR          
         CVB   R1,DUB                                                           
         STC   R1,SVDATE           BINARY YEAR                                  
         PACK  DUB,PINSMNTH        PACK INSERTION MONTH                         
         CVB   R1,DUB                                                           
         STC   R1,SVDATE+1         BINARY MONTH                                 
         CLC   PINSDAY,SPACES      ANY DAY GIVEN?                               
         BE    CNF120                                                           
         PACK  DUB,PINSDAY         PACK INSERTION DAY                           
         CVB   R1,DUB                                                           
         STC   R1,SVDATE+2         BINARY DAY                                   
*                                                                               
...
MEDIAMOK DS    C                   'Y' = MEDIA 'M' IS OK (FOR EDR)              
MEDIATOK DS    C                   'Y' = MEDIA 'T' IS OK (FOR EDR)              
...
SVUPTYPE DS    CL3                 UPLOAD TYPE (STANDARD, EDR, ETC.)            
...
UINSUNIQ DS    CL8                 UNIQUE INSERTION ID                          
         DS    CL20                                                             
UINSMED  DS    C                   MEDIA CODE (EDR OVERRIDE)                    
UINSEDRE DS    C                   'E' = EDR SAYS PUBCODE IS IN ERROR           
...
WORKX    EQU   *                                                                
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'065CTMAD14EDR05/01/02'                                      
         END                                                                    
