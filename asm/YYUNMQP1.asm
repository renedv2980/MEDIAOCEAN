*          DATA SET YYUNMQP1   AT LEVEL 047 AS OF 05/01/02                      
*PHASE YYUNMQP1A                                                                
*INCLUDE HEXOUT                                                                 
*INCLUDE PDUMPER                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
         TITLE 'DEIS TEST MQ FOR DARE'                                          
*PUT INTERLEAVE MESSAGES IN A SINGLE MQ QUEUE BY ATTACHING A SUBTASK TO         
*PUT THE SAME MESSAGES FROM INFILE.  THE CHILD AND PARENT TASK ARE              
*COMPLETING WITH EACH OTHER TO PUT MESSAGES TO THE QUEUE.                       
         MACRO                                                                  
&NAME    PRNT  &A,&PRINT=                                                       
&NAME    DS    0H                                                               
         AIF   (T'&A EQ 'O').NOMOVE                                             
...
YYUNMQP1 CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 0,**YYUN**,=A(R13CHAIN),R9                                       
*                                                                               
         L     RA,=V(CPRINT)                                                    
         USING DPRINT,RA                                                        
*                                                                               
         L     RF,=V(PRNTER)       A(SYSPRINT DCB)                              
         MVC   DCBDDNAM-IHADCB(8,RF),=C'MQPUT1  '                               
*                                                                               
...
*                                                                               
         LA    RF,RECORD+149       POINT TO LAST CHARACTER IN RECORD            
...
***ME        DC      CL48'DARE.DSI.TEST.INPUTQ'                                 
***ME        DC      CL48'CJDSDSI.QREMOTE'                                      
***ME        DC      CL48'FREDQM.TEST.QREMOTE'                                  
QNAME        DC      CL48'DARE.TEST.INPUTQ2'                                    
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'047YYUNMQP1  05/01/02'                                      
         END                                                                    
