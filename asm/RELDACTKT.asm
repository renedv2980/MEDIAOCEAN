*          DATA SET RELDACTKT  AT LEVEL 048 AS OF 05/01/02                      
*PHASE RELDACT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DATCON                                                                 
...
* LEV  47 MAR27/97 BG SET UP FOR KATZ TV JAN95-DEC96                            
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         ...
         GETEL R5,34,ELCODE                                                     
         SPACE 1                                                                
SCLSDTE  DC    X'5F01'             START OF CLOSE PERIOD                        
...
*                      READ   CHGED  READ   CHGED  ADDED                        
         DC    CL2'AM',PL5'0',PL5'0',PL5'0',PL5'0',PL5'0'                       
         DC    CL2'CQ',PL5'0',PL5'0',PL5'0',PL5'0',PL5'0'                       
         DC    CL2'NK',PL5'0',PL5'0',PL5'0',PL5'0',PL5'0'                       
         DC    X'FF'                                                            
         EJECT                                                                  
         LTORG                                                                  
         EJECT                                                                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'048RELDACTKT 05/01/02'                                      
         END                                                                    
