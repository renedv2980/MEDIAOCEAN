*          DATA SET DESQADH    AT LEVEL 075 AS OF 04/14/16                      
...
*        SR    R5,RE                                                            
*                                                                               
* R5 POINTS TO LAST DEMO HEADER                                                 
*        LA    RE,DEMOLLN               DEMO ELEMENT LENGTH                     
*        AR    RE,R5                                                            
         LR    RE,R5                                                            
...
BLDBSKEY NTR1                                                                   
         ...
         MVI   BSBTYP,C'R'                                                      
         MVI   BSIND,BSINDEQU                                                   
**       EDIT  (2,DRKMKT),(4,BSSTAT),ALIGN=RIGHT,FLOAT=0                        
         MVC   BSSTAT,SVMKT                                                     
...
BLDMLKEY NTR1                                                                   
         ...
         MVC   MLSTAT,SVMKT                                                     
         MVI   MLBTYP,C'R'                                                      
**       EDIT  (2,DRKMKT),(4,MLSTAT),ALIGN=RIGHT,FLOAT=0                        
...
BLDSBKEY NTR1                                                                   
         ...
         XC    SBBOOK,=X'FFFF'                                                  
         MVC   SBSTAT,SVMKT                                                     
**       EDIT  (2,DRKMKT),(4,SBSTAT),ALIGN=RIGHT,FLOAT=0                        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'075DESQADH   04/14/16'                                      
         END                                                                    
