*          DATA SET REGAV18    AT LEVEL 021 AS OF 02/07/12                      
*PHASE T81318A                                                                  
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLST                                                                
*INCLUDE RECUP                                                                  
...
********************************************************************            
*  HISTORY OF CHANGES:                                             *            
*  JUL18/01 (BU ) --- CHANGE MIN LEN OF RATE CARD NAME TO 2 CHAR   *            
*                                                                  *            
*  MAY08/09 (SMY) --- SUPPORT NEW INVENTORY KEY                    *            
*  SEE *SMY* - MAY NEED ADDITIONAL LOGIC CHANGE - "SPLIT" COMPARES *            
*                                                                  *            
*  JUN02/11 (SMY) --- FIX "END-OF-LIST" BUG AT VALLC10             *            
*                                                                  *            
*   DEC/11  (SMY) --- APPLY LIMIT ACCESS TO STATION IN VKEY        *            
*                                                                  *            
*  JAN07/12 (SMY) --- COMMENT OUT JUN02/11 "FIX" - MAY BE CAUSING  *            
*                       A "DISAPPEARING RATE" PROBLEM              *            
*                                                                  *            
********************************************************************            
T81318   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         CLC   TWAACCS(2),=C'O='   CHECK LIMIT ACCESS FOR THIS STATION?         
         JNE   VK30                NO                                           
*                                                                               
*              **********  JANUARY/2012   **********                            
*    THE BELOW TEST ASSUMES THAT THE LIMIT ACCESS VALUES TO PREVENT             
*  ACCESS TO STATIONS BASED UPON SIGN-ON WILL ALWAYS BE NUMERIC 00-99           
*                                                                               
         CLC   TWAACCS+2(2),=C'00'   GREATER THAN ZERO ?                        
         JL    VK30                  NO                                         
*                                                                               
         CLC   TWAACCS+2(2),=C'99'   99 OR LESS ?                               
         JH    VK30                  NO                                         
*                                                                               
* GET REP DATA FROM CONTROL FILE USER ID RECORD                                 
*                                                                               
         ...
         MVI   ELCODE,X'21'                                                     
         BRAS  RE,FIRSTEL                                                       
         JNE   VKSECER             SECURITY LOCKOUT                             
         USING CTSYSD,R6                                                        
         CLI   CTSYSNUM,X'08'      REP SYSTEM ?                                 
         JE    VKSECTST            YES                                          
VKSECNXT DS    0H                                                               
         BRAS  RE,NEXTEL                                                        
         JNE   VKSECER             SECURITY LOCKOUT                             
         CLI   CTSYSNUM,X'08'      REP SYSTEM ?                                 
         JNE   VKSECNXT            NO - TRY NEXT ELEMENT                        
VKSECTST DS    0H                                                               
         CLC   CTSYSLMT,TWAACCS    LIMIT ACCESS MATCH ?                         
         JE    VKSECOK             YES - OKAY                                   
VKSECER  DS    0H                                                               
...
PR30     DS    0H                                                               
         ...
         BNE   PRNTRPTX                                                         
*                                                                               
         OC    RINVKRTP,RINVKRTP   MUST BE A HEADER                             
         BNZ   PRSEQ                                                            
...
*                                                                               
         ...
         USING REINVREC,R6                                                      
*                                                                               
         MVC   KEY(RINVKRSR-RINVKEY),HDRKEY   COPY KEY UP TO SOURCE             
*                                                                               
         MVI   RINVKRSR,C'Z'       GAV RATE RECORD                              
         MVC   RINVKNUM,EQUNUM     UNIQUE GAV NUMBER EQUATE                     
         MVC   RINVKYR,YEARHLD     AVAIL YEAR                                   
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE     **SMY** MAY NEED "SPLIT" COMPARE             
...
*                                                                               
         MVC   KEY(RINVKRSR-RINVKEY),HDRKEY   COPY KEY UP TO SOURCE             
         MVI   RINVKRSR,C'Z'       RDETAIL RECORD TYPE                          
         MVC   RINVKNUM,EQUNUM     EQUATE NUMBER                                
         MVC   RINVKYR,YEARHLD     YEAR                                         
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE     *SMY* (MAY NEED "SPLIT" COMPARES)            
         BE    VWWK25                                                           
         XC    DEFCOST,DEFCOST                                                  
         GOTO1 =A(ADDRDET),RR=RELO     ADD NEW RDETAIL REC W/ NO COSTS          
         B     VWWK20                                                           
...
*SMY*    BE    VALLC200            NO                                           
*SMY*    CLI   0(R3),X'FF'         ANY MORE RECORDS TO CHECK?                   
         BE    VALLC200            NO                                           
*                                                                               
         BRAS  RE,NEXTFLD                                                       
...
*                                                                               
         ...
         MVC   RINVKYR,YEARHLD     AVAIL YEAR                                   
*                                                                               
         GOTO1 HIGH                **SMY** MAY NEED "SPLIT" COMPARE             
...
DL50     DS    0H                                                               
         LA    R6,KEY                                                           
*                                                                               
         CLC   KEY(RINVKINV-RINVKEY),KEYSAVE    SAME STATION?                   
         BE    *+14                                                             
         XC    LASTKEY,LASTKEY                                                  
         B     DISPLX              NO - DONE WITH LISTING                       
*                                                                               
         OC    RINVKRTP,RINVKRTP   IS IT A HEADER?                              
         BNZ   DLSEQ                                                            
...
*                                                                               
         ...
         MVC   KEY(RINVKRSR-RINVKEY),HDRKEY   COPY KEY UP TO SOURCE             
*                                                                               
         MVI   RINVKRSR,C'Z'       GET RDETAIL RECORD                           
         MVC   RINVKNUM,EQUNUM     EQUATE NUMBER                                
         MVC   RINVKYR,YEARHLD     YEAR                                         
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE     IF REC EXISTS, THEN DISPLAY RATE             
         BNE   DLR60               **SMY** MAY NEED "SPLIT" COMPARE             
*                                                                               
         MVC   AIO,AIO2                                                         
         GOTO1 GETREC                                                           
*                                                                               
...
* INITIALIZATION                                                                
*                                                                               
*           ALWAYS INIT ADDRESSES (IN CASE DIFFERENT TASK AREA)                 
DWNL10   LA    RE,P                PRINT LINE                                   
         ST    RE,DLCBAPL                                                       
         LA    RE,DWNHOOK          POINT TO HOOK FOR APPLICATION                
         ST    RE,DLCBAPR                                                       
                                                                                
         TM    DWNSTAT,DWNINTZ     HAS REST ALREADY BEEN INITIALIZED?           
         BO    DWNLX               YES - EXIT                                   
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021REGAV18   02/07/12'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
