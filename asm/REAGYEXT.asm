*          DATA SET REAGYEXT   AT LEVEL 008 AS OF 05/01/02                      
*PHASE REAGYEXA REAGYEXT                                                        
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'REAGYEXT - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* EXTERN TO CHANGE REP CODES (USED ON REPTILE)                                  
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         PRINT NOGEN                                                            
DMAGYEXT CSECT                                                                  
         NMOD1 WORKX-WORKD,DMAGYEXT,RR=R5                                       
         USING WORKD,RC                                                         
         EJECT                                                                  
*******************************************************************             
* CONTROL FLOW LOGIC                                              *             
...
DR20     DS    0H                                                               
         ...
         AR    R7,R3                                                            
         MVC   0(2,R7),=C'B3'      CHANGE ALL CODES TO B3 (FROM BL)             
         AP    10(6,R5),=P'1'                                                   
         B     DMXKEEP                                                          
         EJECT                                                                  
*******************************************************************             
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008REAGYEXT  05/01/02'                                      
         END                                                                    
