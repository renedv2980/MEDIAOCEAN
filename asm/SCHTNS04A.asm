*          DATA SET SCHTNS04A  AT LEVEL 084 AS OF 05/01/02                      
*PHASE T31C02A,*                                                                
*INCLUDE BINSRCH2                                                               
***********************************************************************         
*                                                                               
...
VK50     LA    R2,PRDCLTH             * CLIENT                                  
         ...
         MVC   PKEYCLT,BCLT                                                     
*                                                                               
         CLI   PRDUSR1H+5,0        ALREADY INPUT?                               
         BE    *+10                                                             
         XC    PRDUSR1,PRDUSR1                                                  
         XC    PRDDSC1,PRDDSC1                                                  
...
*                                                                               
VK55     CLI   PRDUSR2H+5,0        ALREADY INPUT?                               
         BE    *+10                                                             
         XC    PRDUSR2,PRDUSR2                                                  
         XC    PRDDSC2,PRDDSC2                                                  
...
*                                                                               
         ...
         L     R6,AIO                                                           
         USING PKEY,R6                                                          
         GOTO1 CLUNPK,DMCB,(WORK2,PKEYCLT),PCLT     * CLIENT                    
...
PRODD    DSECT                                                                  
       ++INCLUDE SPGENPRD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'084SCHTNS04A 05/01/02'                                      
         END                                                                    
