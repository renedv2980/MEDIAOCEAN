*          DATA SET PPLFM01    AT LEVEL 035 AS OF 09/06/12                      
*PHASE T40401A                                                                  
*INCLUDE SCANNER                                                                
*INCLUDE HEXOUT                                                                 
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
         TITLE 'T40401 PRINT LOGICAL FILE MAINT'                                
*                                                                               
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
...
*                                                                               
* SMYE 03/01     NO-OPPPED "INCOMPLETE" TRAFFIC OFFICE AND PRD OFFICE           
*                     PROCESSING OF 01/01 BELOW (SEE *NOP*)                     
*                                                                               
* SMYE 01/01     ADD TRAFFIC OFFICE CODE (ELEM X'50') AND PRD ASSIGN            
*                BIT (X'20' IN PCLTSTAT) FOR PRD OFFICE SECURITY                
*                  (SJR ONLY FOR TESTING)                                       
*                                                                               
* SMYE 10/00     ADD DATE (MM/YY) AND ELEM X'47' TO FRZ OPTION AND              
*                INCREASE ALLOWABLE MAX RECORD SIZE TO 500 BYTES                
*                                                                               
* KWAN 07/00     FOR FINANCIAL CLIENTS DO NOT ALLOW COS2                        
*                                                                               
* SMYE 09/99     CODE FOR 5TH CLIENT OPTION (RFPGRP)                            
*                  (SJR ONLY FOR TESTING)     (MODIFIED 04/28/00)               
*                  INCLUDES MEDIA NAME OVERRIDE BUG FIX                         
*                                                                               
...
*                                                                               
         ...
         OI    CLTPSTH+1,X'20'                                                  
**                                                                              
* IF NOT AUTHORIZED FOR PRD SECURITY CODE DO NOT DISPLAY ***                    
* (USE SJR FOR NOW (01/01) - MAY BE ON PROFILE OR SOMETHING ELSE)               
*                                                                               
SET20    DS    0H                                                               
*NOP*    CLC   AGYALPHA,=C'SJ'     SJR ?                                        
*NOP*    BE    NOCLR               YES - OK TO SHOW                             
*                                                                               
*NOP*    XC    CLTPASN,CLTPASN     CLEAR "PRODUCT ASSIGN..."                    
*NOP*    FOUT  CLTPASNH                                                         
*NOP*    XC    CLTPASD,CLTPASD     CLEAR 'N' - DEFAULT                          
*NOP*    OI    CLTPASDH+1,X'20'    PROTECT                                      
*NOP*    FOUT  CLTPASDH                                                         
*                                                                               
*NOP*    XC    CLTTONM,CLTTONM     CLEAR "TRAFFIC OFFICE..."                    
*NOP*    FOUT  CLTTONMH                                                         
*NOP*    OI    CLTTOFFH+1,X'20'                                                 
**                                                                              
NOCLR    DS    0H                                                               
...
*                                                                               
*NOP*    CLC   AGYALPHA,=C'SJ'     SJR ?                                        
*NOP*    BNE   CKOFF               TEMP LIMIT BY SJ (01/01)                     
*                                                                               
*NOP*    LA    R2,CLTPASDH                                                      
*NOP*    NI    PCLTSTAT,X'FF'-X'20' TURN OFF PRD OFFICE ALLOWED BIT             
*NOP*    CLI   CLTPASD,C'Y'        ALLOW PRD OFFICE ?                           
*NOP*    BNE   CLTS10                                                           
*NOP*    OI    PCLTSTAT,X'20'      TURN ON PRD OFFICE ALLOWED BIT               
*NOP*    B     CLTS30              GO CHECK TRAFFIC OFFICE CODE                 
*NOP*CLTS10   CLI   CLTPASD,C'N'                                                
*NOP*    BE    CLTS20              TEST FOR PASSIVE PRD/OFF POINTERS            
*NOP*    CLI   5(R2),0                                                          
*NOP*    BNE   FLDERR              MUST BE 'Y' OR 'N' OR "BLANK"                
*                                                                               
CLTS20   DS    0H                  TEST FOR PASSIVE PRD/OFF POINTERS            
*NOP*    MVC   SAVEKEY,KEY                                                      
*NOP*    XC    KEY,KEY                                                          
*NOP*    MVC   KEY(7),PCLTREC                                                   
*NOP*    MVI   KEY+3,X'A3'         OFF/PRD PASSIVE POINTER                      
*NOP*    GOTO1 HIGH                                                             
*NOP*    CLC   KEY(7),PCLTREC                                                   
*NOP*    BE    FLDERR              CLTPASD NOT 'Y' AND POINTER FOUND            
*                                                                               
*NOP*    XC    KEY,KEY                                                          
*NOP*    MVC   KEY(7),PCLTREC                                                   
*NOP*    MVI   KEY+3,X'A4'         TRA/PRD PASSIVE POINTER                      
*NOP*    GOTO1 HIGH                                                             
*NOP*    CLC   KEY(7),PCLTREC                                                   
*NOP*    BE    FLDERR              CLTPASD NOT 'Y' AND POINTER FOUND            
*NOP*    MVC   KEY(32),SAVEKEY     OK - RESTORE CLIENT HDR KEY                  
*                                                                               
*NOP*CLTS30   DS    0H                  TRAFFIC OFFICE                          
*   A/O 03/21/01 NOTHING DONE ON TRAFFIC OFFICE ***************                 
*                                                                               
CKOFF    LA    R2,CLTOFFH                                                       
...
*                                                                               
*                               THEN DELETE T/A RFP ELEMENT                     
EDTOP3   LA    R6,PCLTELEM                                                      
         MVI   ELCODE,X'46'                                                     
         BAS   RE,PNEXTEL                                                       
         BNE   EDTOP4                                                           
         GOTO1 VRECUP,DMCB,(1,PCLTREC),0(R6),0                                  
         B     EDTOP3              CHECK FOR MORE                               
*                                                                               
*                               THEN DELETE FREEZE STATUS ELEMENT               
EDTOP4   LA    R6,PCLTELEM                                                      
         MVI   ELCODE,X'47'                                                     
         BAS   RE,PNEXTEL                                                       
         BNE   EDTOP8                                                           
         GOTO1 VRECUP,DMCB,(1,PCLTREC),0(R6),0                                  
...
EDTOP15T LA    R6,PCLTELEM         DELETE COST2 FACTOR ELEM                     
         ...
         B     EDTOP15T                                                         
*                                                                               
EDTOP15U CLC   PCLTLEN,=H'500'     CK FOR MAX REC LENGTH                        
         BNH   *+12                                                             
         LA    R3,MAXSERR                                                       
         B     ERROR                                                            
*                                                                               
...
*                                                                               
*                                                                               
EDTOP17  DS    0H                TEST FOR RFPGRP OPTION                         
*                                                                               
         ZIC   R1,FLD1LEN                                                       
         BCTR  R1,0                                                             
         EX    R1,TSTRFP                                                        
         BNE   EDTOP19                                                          
*                                 ********  TESTING  *******                    
         CLC   AGYALPHA,=C'SJ'    ALLOW ONLY SJR FOR TESTING                    
         BNE   ERROR                     AS OF 09/99                            
*                                 ********  TESTING  *******                    
*                                                                               
         CLC   SVAGPINI,=X'0000'    EXISTING RFP ID NUMBER ?                    
         BNH   ERROR               NO                                           
*                                                                               
         CLI   FLD2LEN,2                                                        
         BL    ERROR                                                            
         ...
         LA    RE,FLD2                                                          
*                                                                               
EDTOP17A CLI   0(RE),C' '      CHECK FOR BLANK                                  
         BL    ERROR                                                            
         CLI   0(RE),C'9'                                                       
         BH    ERROR                                                            
         LA    RE,1(RE)                                                         
         BCT   R1,EDTOP17A                                                      
*                                                                               
         LA    R6,PCLTELEM      CHECK FOR EXISTING T/A RFP ELEMENT              
         MVI   ELCODE,X'46'                                                     
         BAS   RE,PNEXTEL                                                       
         BE    ERROR            INVALID - MORE THAN ONE ENTRY                   
*                                                                               
         LA    R6,PCLTELEM      SET R6 TO END OF RECORD                         
         MVI   ELCODE,X'FE'                                                     
         BAS   RE,PNEXTEL                                                       
...
*                                                                               
         ...
         ZIC   R1,FLD2LEN                                                       
         BCTR  R1,0                                                             
         EXMVC R1,PCLTTAGRP,FLD2                                                
         OC    PCLTTAGRP,SPACES                                                 
*                                                                               
*---------------------------------------------------------------------*         
*                     VALIDATE T/A GROUP RFP ID                       *         
*---------------------------------------------------------------------*         
*                                                                               
         L     RF,VTWA                                                          
...
*                                                                               
         ...
         MVI   CT$GRPKSYST,C'P'                                                 
         MVC   CT$GRPKAGY,AGYALPHA                                              
*NOP*    MVC   CT$GRPKUSER,10(RA)                                               
         MVC   CT$GRPKUSER,SVAGPINI                                             
         MVC   CT$GRPKGRP,PCLTTAGRP                                             
         MVC   KEYSAVE,MYCTKEY                                                  
         GOTO1 VDATAMGR,DMCB,=C'DMRDHI',=C'GENDIR',MYCTKEY,MYCTKEY              
*                                                                               
         L     RF,VTWA                                                          
         L     RF,CSWITCH-COMFACSD(RF)                                          
         XC    DMCB(8),DMCB                                                     
...
*                                                                               
*                                                                               
EDTOP19  DS    0H                  TEST FOR "FRZ" (FROZEN)                      
         CLI   FLD1LEN,3                                                        
         BNE   ERROR               UNKNOWN OPTION                               
         CLC   FLD1(3),=C'FRZ'                                                  
         BNE   ERROR               MUST BE EITHER FRZ OR FRZ=                   
*                                                                               
         NI    PCLTSTAT,X'FF'-X'12'     TURN OFF "FRZ" OPTIONS                  
         CLI   FLD2LEN,0                                                        
         BE    EDTOP19X            ONLY "FRZ" ENTERED - GO SET STATUS           
         CLI   FLD2LEN,1                                                        
         BH    EDTOP19D            CHECK DATE ENTRY                             
*                                                                               
         CLI   FLD2,C'Y'           SHOULD "FRZ" OPTION BE ON ?                  
         BE    EDTOP19X            YES                                          
         CLI   FLD2,C'N'                                                        
         BNE   ERROR               MUST BE 'Y' OR 'N'                           
         B     EDTOP30                                                          
*                                                                               
EDTOP19D DS    0H                  TEST FOR VALID DATE                          
         CLI   FLD2LEN,3                                                        
         BL    ERROR               TOO SHORT FOR M/Y                            
         CLI   FLD2LEN,7                                                        
         BH    ERROR               TOO LONG  FOR M/Y (AND "+" OR "-")           
*                                                                               
         MVI   BYTE,X'02'                                                       
         ZIC   R1,FLD2LEN                                                       
         LA    RE,FLD2                                                          
         AHI   R1,-1                                                            
         AR    RE,R1               RE POINTING TO LAST CHAR IN FLD2             
         CLI   0(RE),C'+'          PLUS  (+) ?                                  
         BNE   *+8                 NO                                           
         MVI   BYTE,X'08'                                                       
         CLI   0(RE),C'-'          MINUS (+) ?                                  
         ...
         BE    *+8                 NO                                           
         MVI   0(RE),X'00'         YES - CLEAR IT FROM END OF FLD2              
*                                                                               
         XC    WORK,WORK                                                        
         GOTO1 VDATVAL,DMCB,(2,FLD2),WORK          VALIDATE FOR M/Y             
         OC    DMCB(4),DMCB                                                     
         BZ    ERROR               INVALID DATE                                 
*                                                                               
         LA    R6,PCLTELEM      CHK FOR EXISTING FREEZE-STATUS ELEMENT          
         MVI   ELCODE,X'47'                                                     
         BAS   RE,PNEXTEL                                                       
         BE    ERROR            INVALID - MORE THAN ONE FRZ ENTRY               
*                                                                               
         LA    R6,PCLTELEM      SET R6 TO END OF RECORD                         
         MVI   ELCODE,X'FE'                                                     
         BAS   RE,PNEXTEL                                                       
...
*                                  WORK HAS YYMMDD FROM DATVAL                  
         GOTO1 VDATCON,DMCB,(0,WORK),(3,WORK+10)   O/P YMD BINARY               
         MVC   PCLTFDTE,WORK+10    MOVE ONLY YM TO ELEMENT                      
*                                  BYTE SET IN EDTOP19D ABOVE                   
         OC    PCLTFIND,BYTE       X'08'(+) OR X'04'(-) OR X'02'                
*                                                                               
         GOTO1 VRECUP,DMCB,(1,PCLTREC),ELEM,0(R6)                               
*                                                                               
         OI    PCLTSTAT,X'12'      INDICATES FROZEN WITH DATE                   
*                                                                               
         DROP  R4                                                               
EDTOP19X DS    0H                                                               
...
CLTC3    CLC   PCLTLEN(2),=H'500'     MAX RECORD LENGTH FOR NEWFILE             
         BNH   CLTC5                                                            
         LA    R3,MAXSERR                                                       
         B     ERROR                                                            
*                                                                               
...
*                                                                               
TSTRFP   CLC   FLD1(0),=C'RFPGRP'    EXECUTED  (T/A RFP GROUP)                  
*                                                                               
         DROP  R5                                                               
*                                                                               
         EJECT                                                                  
...
*                                  PRODUCT ASSIGN AND TRAFFIC OFFICE            
*NOP*    CLC   AGYALPHA(2),=C'SJ'  ONLY 'SJ' FOR NOW                            
*NOP*    BNE   PUTCF30             MAYBE PROFILE OR... LATER                    
*NOP*                                                                           
*NOP*    MVI   CLTPASD,C'N'        DEFAULT                                      
*NOP*    TM    PCLTSTAT,X'20'      PRODUCT ASSIGN ALLOWED ?                     
*NOP*    BNO   *+8                 NO                                           
*NOP*    MVI   CLTPASD,C'Y'                                                     
*NOP*    FOUT  CLTPASDH                                                         
*                                                                               
*NOP*    XC    CLTTOFF,CLTTOFF     CLEAR TRAFFIC OFFICE CODE                    
*NOP*    LA    R6,PCLTELEM                                                      
*NOP*    MVI   ELCODE,X'50'        LOOK FOR TRAFFIC OFFICE CODE ELEM            
*NOP*    BAS   RE,PNEXTEL                                                       
*NOP*    BNE   *+10                                                             
*NOP*    MVC   CLTTOFF(1),2(R6)                                                 
*NOP*    FOUT  CLTTOFFH                                                         
*                                                                               
PUTCF30  DS    0H                                                               
         XC    CLTOFFX,CLTOFFX     CLEAR CLT OFFICE HEXOUT AREA                 
...
*                                                                               
         MVI   BYTE,C' '                                                        
         MVC   WORK(L'PCLTFDTE),PCLTFDTE      BINARY YM                         
         MVI   WORK+2,X'01'        DAY                                          
...
*                                                                               
         DROP  R6                                                               
*                                                                               
         LR    R6,R1               R1 POINTS TO NEXT OPTION POSITION            
         LA    R6,4(R6)                                                         
*                                                                               
         ST    R1,FULL             SAVE R1                                      
*                                                                               
         GOTO1 VDATCON,DMCB,(3,WORK),(6,0(R6))                                  
*                                                                               
...
*                                                                               
         ...
         LA    R1,1(R1)                                                         
*                                                                               
PUTCF7DU LA    R1,7(R1)            =MMM/YY (7 BYTES)                            
PUTCF7DX LA    R1,3(R1)            POINT TO NEXT OPTION POSITION                
         MVI   0(R1),C','                                                       
         LA    R1,1(R1)                                                         
*                                                                               
...
*                                                                               
*                                                                               
PUTCF7F  DS    0H                  NEXT OPTION (T/A RFPGRP)                     
*                                                                               
*                                 ********  TESTING  *******                    
*****    CLC   AGYALPHA,=C'SJ'    ALLOW ONLY SJR FOR TESTING                    
*****    BNE   PUTCF7G                   AS OF 09/99                            
*                                 ********  TESTING  *******                    
         LA    R6,PCLTELEM                                                      
         MVI   ELCODE,X'46'                                                     
         BAS   RE,PNEXTEL                                                       
...
*                                                                               
         ...
         SR    RE,RE               FOR CHARACTER COUNT                          
         LA    R5,PCLTTAGRP                                                     
PUTCF7FA CLI   0(R5),X'40'                                                      
         BNH   PUTCF7FB                                                         
         LA    RE,1(RE)            ADD TO CHAR. COUNT                           
         LA    R5,1(R5)            NEXT PCLTTAGRP POS'N                         
         CHI   RE,8                MAX LNTH OF PCLTTAGRP IS 08                  
         BL    PUTCF7FA                                                         
PUTCF7FB EXMVC RE,7(R1),PCLTTAGRP                                               
         LA    R1,7(R1,RE)                                                      
         MVI   0(R1),C','                                                       
         LA    R1,1(R1)                                                         
*                                                                               
...
*                                                                               
SVAGPINI DS    XL2         PAGYPINI (BINARY RFP ID NUMBER) FROM AGY HDR         
...
*                                                                               
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035PPLFM01   09/06/12'                                      
         END                                                                    
