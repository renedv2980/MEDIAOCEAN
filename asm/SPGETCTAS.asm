*          DATA SET SPGETCTAS  AT LEVEL 050 AS OF 05/01/02                      
*PHASE T00A7CA                                                                  
...
*                                                                               
         ...
         B     EXIT                                                             
*                                                                               
GCTA05   TM    BDCIND2,X'02'       TEST TRADE BUY                               
         BO    GCTA10              YES                                          
...
GETCON10 DS    0H                                                               
         ...
         BE    BADCON                                                           
*                                                                               
         CLI   CIBIAM,CIBPAYQ      IS THIS A PAY PROGRAM CALL                   
...
*                                                                               
UPDB10   TM    BDCIND2,X'02'       TEST TRADE BUY                               
         BZ    EXIT                NO - EXIT                                    
...
STARECD  DSECT                                                                  
       ++INCLUDE SPGENSTA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'050SPGETCTAS 05/01/02'                                      
         END                                                                    
