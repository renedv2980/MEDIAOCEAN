*          DATA SET NEWRIA9    AT LEVEL 004 AS OF 03/14/18                      
*          DATA SET NEWRIA9    AT LEVEL 007 AS OF 11/08/95                      
*PHASE T320A9A,*                                                                
         TITLE 'T320A9-NETWORK INTERFACE TAPE'                                  
T320A9   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**NEA9**,RR=R2                                                 
         L     RC,0(R1)                                                         
...
*                                  ANETWS4 FOR 3000  IS FREE                    
         EJECT                                                                  
*HIPO******************************************************************         
*  TITLE: NEMEDPZ (T320PZ) NETWORK INTERFACE TAPE                    *          
*                                                                     *         
...
DSNAME   DC    CL20'NETTAPE.NE0SWAA1'                                           
DCBOPEN  DC    C'N'                                                             
*                                                                               
LR5      DS    0H                                                               
         CLI   SPLTAPE,C'Y'                                                     
...
*                                                                               
         CLC   NBSELAGY,=C'YN'     ...IF IT'S  YNR                              
         BNE   DOT0                                                             
         CLC   NBACTCLI,=X'8977'   ...AND CLOROXX                               
         BNE   DOT0                                                             
         BAS   RE,DAYPT2           ...IF THERE IS 2ND DAYPART                   
         CLI   WORK,0                                                           
         BE    DOT0                                                             
         MVC   TPDAYPT,WORK        ...USE IT                                    
*                                                                               
DOT0     EDIT  (B1,NBLEN),(4,FULL)                 SPOTLENGTH                   
...
DOTX     B     EXIT                                                             
         EJECT                                                                  
*****************************************                                       
* SPECIAL DATA FOR YNR/CLX CLIENT                                               
*     OUPUT: RETURNS 2ND DAYPART IN WORK                                        
*                                                                               
DAYPT2   NTR1                                                                   
         MVI   WORK,0                                                           
         L     R2,NBAIO                                                         
         ...
         BAS   RE,GETEL                                                         
         BNE   DXX                                                              
D2A      CLI   2(R2),C'D'          IS IT DAYPART                                
         BE    D2AA                                                             
         BAS   RE,NEXTEL                                                        
         BNE   DXX                                                              
         B     D2A                                                              
D2AA     MVC   WORK(1),3(R2)        YES/RETURN IT                               
*                                                                               
DXX      B     EXIT                                                             
         EJECT                                                                  
*****************************************                                       
...
PRDHD    DSECT                                                                  
       ...
       ++INCLUDE NEGENUNIT                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004NEWRIA9   03/14/18'                                      
         END                                                                    
