*          DATA SET TALDFIXC   AT LEVEL 013 AS OF 01/02/04                      
*PHASE TALDFICA TALDFIXC                                                        
*INCLUDE SCANNER                                                                
*INCLUDE HELEN                                                                  
*INCLUDE HELLO                                                                  
*                                                                               
*                                                                               
*                                                                               
*    DO NOT REUSE THIS PHASE!!!  IT IS USED TO DROP W2 RECORDS.                 
*                                                                               
*                                                                               
*                                                                               
*                                                                               
         TITLE 'TALDFIXC - TALENT LOAD/DUMP FILE FIX MODULE'                    
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC   DS    0H                                                               
         ...
         CLI   0(R3),TLW2CDQ       CHECKING W2 RECORDS                          
         BNE   DMXKEEP                                                          
         USING TLW2D,R3                                                         
         CLC   TLW2YEAR,=C'2003'   DROP 2003 RECORDS                            
         BE    DMXPURGE                                                         
         B     DMXKEEP                                                          
         EJECT                                                                  
...
*********INCLUDE TAGENFILE                                                      
       ...
       ++INCLUDE TAGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013TALDFIXC  01/02/04'                                      
         END                                                                    
