*          DATA SET REROIUP0   AT LEVEL 234 AS OF 04/21/15                      
*PHASE REROIU0A,*                                                               
*INCLUDE SORTER                                                                 
*INCLUDE STXITER                                                                
*INCLUDE DATCON                                                                 
...
*                                                                     *         
*  03/18/98 (BU ) --- CHANGE RECORD SIZE OF RECOVERY FILE             *         
*                                                                     *         
* AUG09/99 (BGR) 233 4K RECORDS & UPDATE SSB                          *         
*                                                                     *         
*                                                                     *         
*                     ***  END TOMBSTONE  ***                         *         
***********************************************************************         
...
*                                                                               
***                                                                             
*    TO PROCESS FULL WEEK, COMMENT OUT STATEMENT ABOVE, TURN ON NEXT            
***                                                                             
***>>>   MVI   FULLWEEK,C'Y'       PROCESS ENTIRE WEEK (TEMP)                   
*                                                                               
*                                                                               
...
*  WE'RE DONE WHEN WE READ LAST RECORD FROM LAST INDEX.                         
         LA    R2,INDEXTBL                                                      
*                                                                               
         L     RC,ASORTREC         SORT RECORD AREA                             
         USING SORTRECD,RC                                                      
*                                                                               
WRKR100  EQU   *                                                                
...
*- SET SORT RECORD LENGTH                                                       
         ...
         SLL   RF,16               (LLLL....)                                   
         L     RE,ASORTREC                                                      
         ST    RF,0(RE)            = SORT RECORD LENGTH                         
*                                                                               
*- RELEASE SORT RECORD                                                          
         PRINT GEN                                                              
         GOTO1 =V(SORTER),DMCB,=C'PUT',ASORTREC                                 
         PRINT NOGEN                                                            
         AP    NUMPWC,=P'1'                                                     
*                                                                               
...
*                                                                               
         ...
         L     RE,ASORTREC         LOAD A(SORTREC)                              
         MVC   0(2,RE),=AL2(LSORTKEY+4)                                         
         PRINT GEN                                                              
         GOTO1 =V(SORTER),DMCB,=C'PUT',ASORTREC                                 
         PRINT NOGEN                                                            
*                                                                               
...
*                                                                               
         CLI   P3,0                                                             
         BE    GINDX205                                                         
         MVC   P(24),=C'GINDX205: NO INDEX FOUND'                               
         GOTO1 VPRINTER                                                         
...
*                                                                               
RECTYP   DC    CL80'RECORD TYPE=V,LENGTH=(4096) '                               
...
AWRKRB   DC    A(MY4KBUF)                                                       
ASORTREC DC    A(SORTREC)          A(SORTED RECORD)                             
         SPACE                                                                  
NUMSORT  DC    PL4'0'                                                           
         SPACE 2                                                                
         DC    C'SWITCHES*'                                                     
...
RWDLEN   EQU   *-RELWEEKD          LENGTH OF RELWEEK DSECT                      
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'234REROIUP0  04/21/15'                                      
         END                                                                    
