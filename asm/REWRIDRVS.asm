*          DATA SET REWRIDRVS  AT LEVEL 035 AS OF 05/01/02                      
*          DATA SET REWRIDRV   AT LEVEL 087 AS OF 12/22/94                      
*PHASE T82113A,+0                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
...
* STATION OWNER TABLE - ONLY BUILT IF OWNER PART OF REPORT *                    
         SPACE                                                                  
STAOWNTB DS    CL11000   COVERED BY STABLD IN REWRIWORKD                        
*                                                                               
...
*        PRINT OFF                                                              
       ...
       ++INCLUDE REWRISTBD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035REWRIDRVS 05/01/02'                                      
         END                                                                    
