*          DATA SET SPINF00    AT LEVEL 037 AS OF 07/23/13                      
*PHASE T21A00A                                                                  
*=============================================================*                 
* SEP/08  BPLA SOON AND OV RUN= FILTER FOR BILLS                                
* MAY/07  BPLA FIX FOR USER DISPLAYS                                            
* 09JUN04 AKAT EQU FOR SPOT ONLY SUPPORTED IN SFM                               
* 24MAY99 BPLA FIX BUG IN GETROW  (GETROW1)                                     
*         MUST CHECK FOR END OF SCREEN                                          
*         LOOPS OCCUR IF A LOWER SCREEN IS NOT PRESENT                          
*                                                                               
...
* SET STEREO FLAG (WILL SUPPRESS PFKEY DATA)                                    
         ...
         TM    FATSTAT6,X'80'      TEST REGULAR STEREO                          
         BZ    *+8                                                              
         OI    SVSTEREO,SVSTEREO_REG                                            
         TM    FATSTAT6,X'08'      TEST FULL STEREO                             
         BZ    *+8                                                              
         OI    SVSTEREO,SVSTEREO_FUL                                            
         DROP  RE                                                               
...
*                                                                               
FL1X2    DS    0H                                                               
* ====>  GOTO1 =A(SETPF),RR=RELO   <====  MOVED TO FL 10                        
*                                                                               
...
*                                                                               
         CLI   10(R7),X'FD'        TEST IF N/FIL MOVED TO NET/SFM               
         BNE   FL210                                                            
         CLI   SVOVSYS,3           MUST BE NET                                  
         BE    FL2A                                                             
*                                                                               
FL210    CLI   10(R7),X'FE'        TEST MOVED TO SFM                            
         BL    FL2B                NO                                           
         BH    FL2A                OK IF SYSTEM = NET                           
         CLI   SVOVSYS,3           X'FE' OK IF SYS=NET                          
         BE    FL2B                                                             
*                                                                               
FL2A     MVI   ERRCD,NEWERRS                                                    
         MVC   NERRCD,=AL2(1105)   NOW IN SFM                                   
         CLI   SVOVSYS,3           SYS = NET?                                   
         BNE   *+10                                                             
         MVC   NERRCD,=AL2(1131)   NOW IN NET                                   
         LA    R2,SINIRECH                                                      
         B     FLERR                                                            
*                                                                               
FL2B     MVI   ERRCD,ACCSERR                                                    
...
* SET DUMMY ACTION                                                              
FL10     DS    0H                                                               
         GOTO1 =A(SETPF),RR=RELO   ADD PFKEY DATA AS NEEDED                     
         MVI   SVACT,C'C'                                                       
...
*                                                                               
         ...
         L     RE,0(R1)             R1 POINTS TO SECRET BLOCK                   
*                                                                               
         GOTO1 (RF),DMCB,('SECPINIT',(R2)),0                                    
         BE    *+6                                                              
         DC    H'0'                                                             
         B     SPCOMXIT                                                         
*=========================================================                      
...
*=========================================================                      
         SPACE 1                                                                
*                                                                               
SPSECCHK L     R2,0(R1)             SECRET BUFFER                               
         L     R3,4(R1)             CLIENT RECORD                               
         L     R4,8(R1)             A(CLIENT 3 BYTE NAME)                       
*                                                                               
         USING CLTHDR,R3                                                        
*                                                                               
         L     R5,VTWA                                                          
...
****     TM    SVSTEREO,SVSTEREO_REG    STEREO OK NOW                           
****     BO    SETPFX                                                           
*                                                                               
         CLI   SVREC,X'11'                                                      
         BL    SETPF1                                                           
...
SETPF4   DS    0H                                                               
         ...
         B     *+10                SKIP OVER SEPTF5 MVC                         
*                                                                               
SETPF5   MVC   0(STRFLDX-STRFLDH+3,R2),STRFLDH  (INCLUDE X'000101')             
...
GETROW1  IC    R0,0(R2)                                                         
         AR    R2,R0                                                            
*                                                                               
         CLI   0(R2),0             CHECK END OF SCREEN                          
         BE    GETROW2    SEND ERROR - PREVENTS LOOPS                           
*                         IF NO LOWER SCREEN PRESENT                            
*                                                                               
...
*                      08    RECORD NUMBER                                      
*                      09    OVERLAY NUMBER                                     
* AS OF JUN09/04       10    X'FF' = SUPPORT MOVED TO SFM                       
*                            X'FE' = NETWORK STILL IN FILE                      
*                            X'FD' = SPOT STILL IN FILE                         
*                      11    SPARE                                              
...
*                                                                               
         ...
         DC    CL8'INVOICE ',X'18180000',AL4(0)                                 
*                                                                               
...
*                                                                               
         ...
         DC    CL8'EQUHDR  ',X'3535FE00',AL4(0)   <<< NOTE NO PFKEY             
*                                                                               
...
*                                                                               
         DC    AL1(L'F13E)                                                      
         DC    AL1(5)                                                           
F13E     DC    C'DATA=DATE,COPY,NAME,MENU,DEMO,USER1,USER2'                     
*                                                                               
         DC    AL1(L'F13F)                                                      
         DC    AL1(4)                                                           
F13F     DC    C'REQ=Y/N'                                                       
...
*                                                                               
         DC    AL1(L'F18G)                                                      
         DC    AL1(7)                                                           
F18G     DC    C'SUBMED= C,D,N,O,S,V (FOR NETPAK)'                              
*                                                                               
         DC    AL1(L'F18H)                                                      
         DC    AL1(8)                                                           
F18H     DC    C'GMBILLTY'                                                      
*                                                                               
         DC    AL1(L'F18I)                                                      
         DC    AL1(4)                                                           
F18I     DC    C'RUN=SOON OR OV (OVERNIGHT)'                                    
*                                                                               
         DC    AL1(L'F18T)                                                      
         DC    AL1(6)                                                           
F18T     DC    C'TOTAL=YES - SHOW ONLY TOTAL LINE'                              
*                                                                               
         DC    X'FF'                                                            
         SPACE 2                                                                
F32      DC    X'32'                                                            
