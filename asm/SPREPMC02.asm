*          DATA SET SPREPMC02  AT LEVEL 064 AS OF 06/19/13                      
*PHASE SPMC02A                                                                  
*INCLUDE COVAIL                                                                 
*INCLUDE MEDADDWT                                                               
         TITLE 'SPREPMC02 - STATION COMMERCIAL PERFORMANCE REPORT'              
         PRINT NOGEN                                                            
SPMC02   CSECT                                                                  
         NMOD1 0,SPMC02,RA                                                      
*                                                                               
...
*                                                                               
         L     R1,=A(COMLTAB)                                                   
         ST    R1,ACOMLTAB         A(COMMERCIAL TBALE)                          
*                                                                               
         L     RC,=A(GLAREA)                                                    
         USING GLOBALD,RC                                                       
*                                                                               
...
SP100    MVI   FORCEHED,C'Y'                                                    
         ...
         LA    R0,GLOBALD          INIT DRIVER STORAGE TO ZEROS                 
         L     R1,=F'40000'                                                     
         SR    RE,RE                                                            
         SR    RF,RF                                                            
         MVCL  R0,RE                                                            
...
*                                                                               
         ...
         L     R6,=A(BUFFALOC)                                                  
         GOTO1 COVAIL,DMCB,C'SETB',40000,1350000,(R6)                           
         OC    4(4,R1),4(R1)                                                    
         BNZ   *+6                                                              
         DC    H'0'                                                             
         MVC   BUFFBUFF,12(R1)                                                  
...
*                                                                               
         L     R0,ACOMLTAB         CLEAR COMMERCIAL TABLE                       
         L     R1,=A(COMLTABX-COMLTAB)                                          
         SR    RE,RE                                                            
         SR    RF,RF                                                            
         MVCL  R0,RE                                                            
*                                                                               
         L     R2,ACOMLTAB         BUILD COMMERCIAL TABLE                       
...
SP136    XC    CMLTBCNT,CMLTBCNT                                                
         ...
         BZ    SP145                                                            
         ST    R4,CMLTBCNT                                                      
         GOTO1 XSORT,DMCB,ACOMLTAB,(R4),29,2,0   SORT ON FILM SEQUENCE          
*                                                                               
         L     R2,ACOMLTAB         POST FILM NUMBERS AND NAMES TO TABLE         
         XC    KEY,KEY                                                          
         MVC   KEY(2),=X'0AA1'                                                  
         MVC   KEY+2(1),BAGYMD                                                  
         MVC   KEY+3(2),BCLT                                                    
...
SP200    L     R6,ADBUY                                                         
         ...
         LA    R2,PSLIST                                                        
*                                                                               
SP210    CLI   0(R2),0             TEST END OF LIST                             
         BE    SP250                                                            
         CLC   QPRD,=C'ALL'        TEST PRODUCT=ALL                             
         BNE   *+14                                                             
         CLC   BPRD,0(R2)          YES-FILTER ON CURRENT PRODUCT                
         BNE   SP240                                                            
         ...
         BNE   *+8                                                              
         MVI   MEDBRAND,219                                                     
         L     R0,=A(FILMLST)      CLEAR FILM LIST                              
         LHI   R1,FILMLSTL                                                      
         SR    RE,RE                                                            
         SR    RF,RF                                                            
         MVCL  R0,RE                                                            
...
SP214    XC    BFREC,BFREC         CLEAR BUFFALO REC                            
         ...
         BE    SP220               YES-SKIP STATION DETAIL                      
*                                                                               
...
BH035    OC    0(2,R4),0(R4)       TEST NULL FILM                               
         ...
         BE    BH900                                                            
*                                                                               
BH040    L     R3,=A(FILMLST)      ADD FILM TO FILM LIST                        
*                                                                               
...
BH900    CLC   Q2USER(8),SPACES    NO FILM ELE, UNKNOWN FILM OR CLASS           
         ...
         TM    CMLSW,CLS           IF NOT CML CLASS, EXIT(FILM UNKNOWN)         
         BZ    BH999                                                            
         CLI   QFILTER+1,C' '                                                   
         BE    BH999                                                            
         CLI   QFILTER+1,C'Z'                                                   
...
*                                                                               
         ...
         BZ    SP610                                                            
         GOTO1 XSORT,DMCB,ACOMLTAB,(R4),29,8,6                                  
*                                                                               
...
BUYDEM2  ZIC   RF,GLARGS                                                        
         BCTR  RF,0                                                             
         LR    R1,RF               CHECK WHETHER REPORTING THIS DEMO            
         MHI   R1,7                                                             
         LA    R1,DMNAMES(R1)                                                   
         CLC   0(7,R1),SPACES                                                   
         BNH   EXIT                                                             
...
*                                                                               
         ...
         BE    *+12                                                             
         CLI   0(R1),C'E'          OR EXTENDED RATING                           
         BNE   EXIT                                                             
* ROUND TO 1 DECIMAL                                                            
         L     R1,0(RE)                                                         
         M     R0,=F'2'                                                         
...
* ESTIMATE FIRST                                                                
*                                                                               
ESTFST   CLC   QPRD,=C'ALL'        ONLY GET DEMO NAMES IF THEY MIGHT            
         BE    *+14                CHANGE                                       
         CLC   QEST,=C'ALL'                                                     
         BNE   ESTFST8                                                          
...
ESTFST3  CLC   KEY(7),KEYSAVE                                                   
         ...
         B     ESTFST1                                                          
*                                                                               
ESTFST4  GOTO1 MEDPRDRD,DMCB,(R8)                                               
*                                                                               
         ZIC   RE,BPRD                                                          
         BCTR  RE,0                                                             
         MH    RE,PRDBUFLN                                                      
         ...
         DROP  R5                                                               
*                                                                               
ESTFST8  L     RE,AMKTWTAB         TURN OFF ALL MARKET ENCOUNTERED              
*                                  SWITCHES                                     
ESTFST9  OC    0(8,RE),0(RE)                                                    
         BZ    EXIT                                                             
         NI    4(RE),FF-MESTIM                                                  
         LA    RE,8(RE)                                                         
         B     ESTFST9                                                          
...
DBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE SPTRCMML                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'064SPREPMC02 06/19/13'                                      
         END                                                                    
