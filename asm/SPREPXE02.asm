*          DATA SET SPREPXE02  AT LEVEL 018 AS OF 06/01/04                      
*PHASE SPXE02A                                                                  
         TITLE 'SPXE02 - SPOTPAK CLOSEOUT CONTROL REPORT'                       
SPXE02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,SPXE02,R8,RR=R7                                                
         LA    R8,2048(RB)                                                      
         LA    R8,2048(RC)                                                      
         L     RA,0(R1)                                                         
         USING SPWORKD,RA                                                       
...
DETREC2  LA    R4,P1                                                            
         ...
         CLI   REC+4,0             NO - TEST FOR CLTHDR                         
         BE    CLTSAVE             YES - SAVE CLIENT NAME                       
         CLI   REC+7,0             TEST FOR PRDHDR                              
         BE    PRDSAVE                                                          
         TM    REC+15,X'C0'        EST HDR                                      
         BNO   GETNXT              NO - GET ANOTHER REC                         
...
ESTHDRD  DSECT                                                                  
       ++INCLUDE SPGENEST                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018SPREPXE02 06/01/04'                                      
         END                                                                    
