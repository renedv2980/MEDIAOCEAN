*          DATA SET SPREPP702  AT LEVEL 119 AS OF 05/01/02                      
*PHASE SPP702A                                                                  
         TITLE 'SPREPP702 - NETWORK FILE CREATION - NIELSEN'                    
         PRINT NOGEN                                                            
*                                                                               
*                                                                               
*        QOPT1   RATING SOURCE- N=ACN                                           
...
*                                                                               
SP120F   DS    0H                                                               
         MVI   QOPT1,C'N'          FORCE TO NIESLEN                             
...
CLTHDRD  DSECT                                                                  
       ++INCLUDE SPGENCLT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'119SPREPP702 05/01/02'                                      
         END                                                                    
