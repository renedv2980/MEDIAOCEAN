*          DATA SET PRSFM41    AT LEVEL 004 AS OF 03/16/09                      
*PHASE T41C41A                                                                  
*INCLUDE SRCHCALL                                                               
*INCLUDE PUBEDIT                                                                
*INCLUDE NUMED                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE PPBROWSE                                                               
*        TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS'                         
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS'                         
***********************************************************************         
*                                                                     *         
*         CHANGE LOG                                                  *         
...
*                                                                               
* SMYE  08/05    NEW PROGRAM (COPIED FROM PRSFM31 AND MODIFIED)                 
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - INIT'                  
***********************************************************************         
*                                                                     *         
*        INITIALISATION                                               *         
*                                                                     *         
...
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - ANAL'                  
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - VK'                    
***********************************************************************         
*                                                                     *         
*        VALIDATE KEY                                                 *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R4,KEY                                                           
         USING SRVRECD,R4          ESTABLISH VENDOR CONTACT LIST KEY            
*                                                                               
         MVC   SRVKMED,QMED        MEDIA                                        
         MVC   SRVKPUB,BPUB                                                     
         MVC   SRVKAGY,AGENCY      AGENCY                                       
         MVI   SRVKRCD,SRVKRCDQ    RECORD TYPE                                  
         MVC   SRVKCLT,QCLT        CLIENT                                       
         MVC   SRVKPRD,QPRD        PRODUCT                                      
*                                                                               
* * * * * * * * BELOW NOT IN USE A/O 03/13/09 * * * * * * * * * * * * *         
******   MVC   SRVKPID,QPID        USER ID                                      
* * * * * * * * ABOVE NOT IN USE A/O 03/13/09 * * * * * * * * * * * * *         
*                                                                               
         MVC   ORIGKEY,KEY         SAVE THIS KEY (USE WITH LIST)                
*                                                                               
         CLC   TWAKEYSV(L'SRVKEY),KEY    CHECK FOR NEWKEY                       
         BE    *+8                                                              
         MVI   NEWKEY,C'Y'                                                      
*                                                                               
         B     VKX                                                              
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - VKL'                   
***********************************************************************         
*                                                                     *         
*        VALIDATE LIST KEY                                            *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - MYPUBVAL'              
***********************************************************************         
*                                                                     *         
*        VALIDATE PUB FIELD                                           *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - DK'                    
***********************************************************************         
*                                                                     *         
*        DISPLAY KEY                                                  *         
*                                                                     *         
...
*                                                                               
         XC    SCRMED,SCRMED                                                    
         MVC   SCRMED(L'SRVKMED),SRVKMED   MEDIA                                
         MVI   SCRMEDH+5,L'SRVKMED SET INPUT LENGTH                             
...
DKPUBED  DS    0H                                                               
*                                                                               
         GOTO1 =V(PUBEDIT),DMCB,SRVKPUB,(C'S',SCRPUB),RR=RELO                   
*                                                                               
...
*                                                                               
         XC    SCRCLT,SCRCLT                                                    
         MVC   SCRCLT(L'SRVKCLT),SRVKCLT      CLIENT                            
         MVI   SCRCLTH+5,L'SRVKCLT SET INPUT LENGTH                             
*                                                                               
...
*                                                                               
         CLC   SRVKCLT,=X'FFFFFF'  IF ALL CLIENTS                               
         BNE   DKCLTX                                                           
*                                                                               
         MVC   CLTNM,SPACES                                                     
         MVC   SCRCLT(3),=C'ALL'                                                
...
*                                                                               
         XC    SCRPRD,SCRPRD                                                    
         MVC   SCRPRD(L'SRVKPRD),SRVKPRD      PRODUCT                           
         MVI   SCRPRDH+5,L'SRVKPRD SET INPUT LENGTH                             
*                                                                               
...
*                                                                               
         CLC   SRVKPRD,=X'FFFFFF'  IF ALL PRODUCTS                              
         BNE   DKPRDX                                                           
*                                                                               
         MVC   PRDNM,SPACES                                                     
         MVC   SCRPRD(3),=C'ALL'                                                
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - VR'                    
***********************************************************************         
*                                                                     *         
*        VALIDATE RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R3,SVEBASE                                                       
         USING SRVEBASD,R3         ESTABLISH BASE ADDRESS ELEMENT               
*                                                                               
         MVI   SRVEBCDE,SRVEBIDQ   SET ELEMENT CODE                             
         MVI   SRVEBLEN,SRVEBLQ    SET BASIC ELEMENT LENGTH                     
*                                                                               
...
*                                                                               
         ...
         BNO   *+8                                                              
         OI    SVACH1,SRVAEBCH        EBASE CHANGED                             
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SRVEBASE(0),0(R1)   SAVE DOMAIN NAME                             
*                                                                               
         LR    R0,RF               SAVE EXECUTE LENGTH                          
*                                                                               
         AHI   RF,SRVEBLQ+1        CALCULATE TRUE ELM LENGTH                    
         STC   RF,SRVEBLEN         SET ELEMENT LENGTH                           
*                                                                               
...
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),SRVEBASE RE-DIPLAY INPUT                              
*                                                                               
...
*                                                                               
         ...
         USING SRVEBASD,R3         ESTABLISH E-BASE ELEMENT                     
*                                                                               
         L     R6,AIO1             GET RECORD ADDRESS                           
         ST    R6,DMCB             PASS TO RECUP                                
         MVI   DMCB,C'P'           INDICATE PRINT SYSTEM                        
*                                                                               
         LA    R6,SRVFIRST-SRVREC(R6)    POINT TO FIRST ELEMENT IN REC          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - DR'                    
***********************************************************************         
*                                                                     *         
*        DISPLAY  RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         USING SRVEBASD,R6         ESTABLISH AS E-MAIL BASE ELEMENT             
*                                                                               
         LA    R2,SCRBASH          POINT TO FIELD ON SCREEN                     
         USING FLDHDRD,R2          ESTABLISH BASIC FIELD                        
*                                                                               
...
*                                                                               
         MVI   ELCODE,SRVEBIDQ     LOOK FOR E-BASE ELM                          
         BRAS  RE,GETEL            FIND IN RECORD                               
         BNE   DREBASOK            SKIP IF NONE FOUND                           
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRVEBLEN         GET ELEMENT LENGTH                           
         SHI   RF,SRVEBLQ          SUBTRACT BASIC ELM LENGTH                    
         BNP   DREBASOK                                                         
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),SRVEBASE    DISPLAY E-MAIL BASE                       
*                                                                               
DREBASOK DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - RDEL'                  
***********************************************************************         
*                                                                     *         
*        DELETE   RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R3,SVACTELM                                                      
         USING SRVACTHD,R3         ESTABLISH ACTIVITY ELM                       
*                                                                               
         MVI   SRVACDE,SRVAIDQ     SET ELEMENT CODE                             
         MVI   SRVALEN,SRVACTLQ    SET ELEMENT LENGTH                           
*                                                                               
         GOTO1 DATCON,DUB,(5,0),(3,SRVADTE) SET TODAY'S DATE                    
*                                                                               
         MVC   SRVAPID,SVPID       SET CHANGER'S PID                            
         MVC   SRVASCID,SVSCID     SET CHANGER'S SECURITY PID                   
*                                                                               
         OI    SVACH1,SRVADEL      SET RECORD DELETED                           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - RR'                    
***********************************************************************         
*                                                                     *         
*        RESTORE  RECORD                                              *         
*                                                                     *         
...
*        ADD ACTIVITY ELEMENT                                                   
*                                                                               
         OI    SVACH1,SRVARES      SET RECORD RESTORED                          
*                                                                               
         BRAS  RE,ACTPUT           ADD ACTIVITY ELEMENT                         
*                                                                               
RRX      DS    0H                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - LR'                    
***********************************************************************         
*                                                                     *         
*        LIST RECRDS                                                  *         
*                                                                     *         
...
*        BUILD STARTING KEY                                                     
*                                                                               
         MVC   SRVKMED,QMED        MEDIA CODE                                   
*                                                                               
         CLI   SCLPUBH+5,0         IF PUB ENTERED                               
         BE    *+10                                                             
         MVC   SRVKPUB,BPUB                     PUB                             
*                                                                               
         MVC   SRVKAGY,AGENCY      AGENCY                                       
         MVI   SRVKRCD,SRVKRCDQ    TYPE                                         
*                                                                               
         MVC   SRVKCLT,QCLT           CLIENT                                    
*                                                                               
         MVC   SRVKPRD,QPRD           PRODUCT                                   
...
*                                                                               
         CLC   SRVKEY(SRVKPUB-SRVKEY),KEYSAVE  DONE AT END OF MEDIA             
         BNE   LRDONE                                                           
*                                                                               
         TM    SRVDCNTL,SRVCDELQ   SKIP DELETED RECORDS                         
         BO    LRCONT2                                                          
*                                                                               
*        FILTER ON PUB                                                          
*                                                                               
...
*                                                                               
         ...
         BNZ   LRPUBW              YES                                          
*                                                                               
         CLC   SRVKPBCD,BPUB       FILTER ON BASE PUB ONLY                      
         BE    LRPUBX                                                           
*                                                                               
LRPUBW   DS    0H                                                               
*                                                                               
         CLC   SRVKPUB,BPUB        FILTER ON WHOLE PUB                          
         BNE   LRDONE                                                           
*                                                                               
LRPUBX   DS    0H                                                               
*                                                                               
         CLC   SRVKAGY,AGENCY      FILTER ON AGENCY                             
         BNE   LRCONT2                                                          
*                                                                               
         CLI   SRVKRCD,SRVKRCDQ    FILTER ON RECORD CODE                        
         BNE   LRCONT2                                                          
*                                                                               
...
*                                                                               
LRPRDX4  DS    0H                                                               
         GOTO1 =V(PUBEDIT),DMCB,SRVKPUB,(C'S',LPUB),RR=RELO                     
*                                                                               
         MVC   MYPUB,SRVKPUB                                                    
*                                                                               
         BRAS  RE,MYVPUB                                                        
...
*        DISPLAY CLIENT                                                         
*                                                                               
         MVC   LCLT,SRVKCLT        CLIENT                                       
*                                                                               
         CLC   SRVKCLT,=X'FFFFFF'                                               
         BNE   *+10                                                             
         MVC   LCLT,=C'ALL'                                                     
*                                                                               
*        DISPLAY PRODUCT                                                        
*                                                                               
         MVC   LPRD,SRVKPRD        PRODUCT                                      
*                                                                               
         CLC   SRVKPRD,=X'FFFFFF'                                               
         BNE   *+10                                                             
         MVC   LPRD,=C'ALL'                                                     
*                                                                               
...
*                                                                               
         USING SRVEBASD,R6         ESTABLISH DOMAIN ELEMENT                     
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRVEBLEN         GET ELEMENT LENGTH                           
         SHI   RF,SRVEBLQ          SUBTRACT BASIC ELM LENGTH                    
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SAVEBASE(0),SRVEBASE    DISPLAY E-MAIL BASE                      
*                                                                               
LREBASOK DS    0H                                                               
*                                                                               
...
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,SRVLIDQ      LOOK FOR LIST ELMS                           
...
*        PRINT CONTACT NAME                                                     
*                                                                               
         MVC   PCNAME,SRVLNAME     PRINT CONTACT NAME                           
*                                                                               
...
LRFAX    DS    0H                                                               
*                                                                               
         CLI   SRVLTYPE,0          SKIP IF NOT FAX NUMBER                       
         BE    *+8                                                              
         CLI   SRVLTYPE,C'F'       SKIP IF NOT FAX NUMBER                       
         BNE   LRFAXN                                                           
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,SRVLLEN        GET FAX# LENGTH                              
         SHI   RF,SRVLSTLQ         DECREMENT BY BASIC LENGTH                    
*                                                                               
         LA    R1,SRVLADDR         START OF FAX #                               
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRVLLEN          GET ELEMENT LENGTH                           
         SHI   RF,SRVLSTLQ         DECREMENT BY BASIC LENGTH                    
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   PCADDR(0),SRVLADDR  DISPLAY ADDRESS                              
*                                                                               
         CLI   SRVLTYPE,C'E'       SKIP IF NOT AN E-MAIL                        
         BNE   LRADRX                                                           
*                                                                               
...
LRFYI    DS    0H                                                               
*                                                                               
         CLI   SRVLTYP2,C'Y'       IF FYI VERSION                               
         BNE   *+10                                                             
...
*                                                                               
         CLI   SRVLSUP,C'Y'        IF W/O COSTS VERSION                         
         BNE   *+10                                                             
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - MYVPUB'                
***********************************************************************         
*                                                                     *         
*        GET PUB NAME                                                 *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - MYVCLT'                
***********************************************************************         
*                                                                     *         
*        GET CLIENT NAME                                              *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - LINSET'                
**********************************************************************          
*   LINUP INTERFACE                                                  *          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 ESR VENDOR CONTACT LIST RECORDS - LINHOOK'               
**********************************************************************          
*                                                                    *          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 - BUILD TABLE OF ELEMENTS ON FILE - LSBLDTAB'            
***********************************************************************         
*                                                                     *         
...
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,SRVLIDQ      LIST ENTRY ELEMENT                           
         USING SRVLSTD,R6          ESTABLISH LIST ELEMENT                       
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,SRVLLEN        ELEMENT LENGTH                               
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   ELTELEM(0),SRVLELM  SAVE LIST ELEMENT                            
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 - SEARCH TABLE FOR ELEMENTS - LSSRCH'                    
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 - VALIDATE LINE - LHVALLIN'                              
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         USING SRVLSTD,R3          ESTABLISH STANDARD CONTRACT UNIT ELM         
*                                                                               
...
*                                                                               
         TITLE 'T41C41 - VALIDATE LINE - LHVNAM'                                
***********************************************************************         
*                                                                     *         
...
*                                                                               
         LA    R4,WRKELTAB         SET TO BUILD TABLE ELEMENT                   
*                                                                               
         MVI   SRVLCDE,SRVLIDQ     SET ELEMENT CODE                             
         MVI   SRVLLEN,SRVLSTLQ    SET BASIC ELEMENT LENGTH                     
         MVC   SRVLNAME,FLDDATA    SAVE CONTACT NAME                            
*                                                                               
         TM    FLDIIND,FINPTHIS    IF FIELD INPUT THIS TIME                     
         BNO   *+8                                                              
         OI    SVACH1,SRVALSCH        LIST CHANGED                              
*                                                                               
LHVNAMOK DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
LHVNAMX  DS    0H                                                               
*                                                                               
         TITLE 'T41C41 - VALIDATE CONTACT TYPE - LHVTYP'                        
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         BZ    LHVTYPOK                                                         
*                                                                               
         MVI   SRVLTYPE,C'E'       ASSUME THIS IS AN E-MAIL ADDRESS             
*                                                                               
...
*                                                                               
         ...
         BNE   LHVTYPNV                                                         
*                                                                               
         MVC   SRVLTYPE,FLDDATA    SAVE ADDRESS TYPE                            
*                                                                               
LHVTYP10 DS    0H                                                               
*                                                                               
         TWAXC (R2),(R2)           CLEAR FIELD                                  
*                                                                               
         CLI   SRVLTYPE,C'E'       EXPAND CODE LETTER                           
         BNE   *+14                                                             
         MVC   FLDDATA(L'LHVTYPEM),LHVTYPEM                                     
         B     LHVTYPOK                                                         
*                                                                               
         CLI   SRVLTYPE,C'F'       EXPAND CODE LETTER                           
         BNE   *+10                                                             
...
LHVTYPX  DS    0H                                                               
*                                                                               
         TITLE 'T41C41 - VALIDATE FYI FIELD - LHVFYI'                           
***********************************************************************         
*                                                                     *         
*        ROUTINE TO VALIDATE FYI FIELD                                *         
*              C'Y' - SET SRVLTYP2 TO Y                               *         
*  NO ENTRY OR C'N' - CLEAR SRVLTYP2                                  *         
...
LHVFYI   DS    0H                                                               
*                                                                               
         MVI   SRVLTYP2,0          CLEAR FYI FIELD                              
*                                                                               
...
*                                                                               
         ...
         BNE   LHVTYPNV                                                         
*                                                                               
         MVI   SRVLTYP2,C'Y'       SET FYI FIELD                                
         CLI   FLDDATA,C'N'        C'N' ?                                       
         BNE   LHVFYIOK                                                         
         MVI   SRVLTYP2,0          CLEAR FYI FIELD                              
*                                                                               
...
LHVFYIX  DS    0H                                                               
*                                                                               
         TITLE 'T41C41 - VALIDATE SUPPRESS COST FIELD - LHVSUP'                 
***********************************************************************         
*                                                                     *         
*        ROUTINE TO VALIDATE SUPPRESS COST FIELD                      *         
*              C'Y' - SET SRVLSUP TO Y                                *         
*  NO ENTRY OR C'N' - CLEAR SRVLSUP                                   *         
*   ANY OTHER ENTRY - INVALID                                         *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
LHVSUP   DS    0H                                                               
*                                                                               
         MVI   SRVLSUP,0           CLEAR SUPPRESS COST FIELD                    
*                                                                               
...
*                                                                               
         ...
         BNE   LHVTYPNV                                                         
*                                                                               
         MVI   SRVLSUP,C'Y'        SET SUPPRESS COST FIELD                      
         CLI   FLDDATA,C'N'        C'N' ?                                       
         BNE   LHVSUPOK                                                         
         MVI   SRVLSUP,0           CLEAR SUPPRESS COST FIELD                    
*                                                                               
...
LHVSUPX  DS    0H                                                               
*                                                                               
         TITLE 'T41C41 - VALIDATE CONTACT E-ADDRESS - LHVADDR'                  
***********************************************************************         
*                                                                     *         
...
LHVFAX   DS    0H                                                               
*                                                                               
         CLI   SRVLTYPE,C'F'       SKIP IF NOT A FAX NUMBER                     
         BNE   LHVFAXN                                                          
*                                                                               
...
*                                                                               
         ...
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVC   SRVLADDR(0),WORK    SAVE FAX NUMBER                              
         ST    RE,FULL             SAVE RE                                      
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRVLLEN          BUMP ELEMENT LENGTH                          
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SRVLADDR(0),FLDDATA    SAVE E-MAIL ADDRESS                       
*                                                                               
         AHI   RF,SRVLSTLQ+1       CALCULATE ELEMENT LENGTH                     
         STC   RF,SRVLLEN          NEW ELEMENT LENGTH                           
*                                                                               
LHVADDFD DS    0H                                                               
*                                                                               
         TM    FLDIIND,FINPTHIS    IF FIELD INPUT THIS TIME                     
...
*                                                                               
         ...
         MVC   ELTELEM,SRVLELM     SET NEW ELEM IN TABLE                        
*                                  SET NEW ELTLAST                              
         ICM   R1,15,BSPNOR        NUMBER OF ENTRIES                            
         BZ    *+10                                                             
         BCTR  R1,0                                                             
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 - VALIDATE CONTACT E-ADDRESS - LHDISLIN'                 
***********************************************************************         
*                                                                     *         
...
LHDNAM   DS    0H                                                               
*                                                                               
         MVC   FLDDATA(L'SRVLNAME),SRVLNAME  DISPLAY CONTACT NAME               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BZ    LHDTYPX                                                          
*                                                                               
         MVC   FLDDATA(L'SRVLTYPE),SRVLTYPE  DISPLAY ADDRESS TYPE               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
*                                                                               
...
*                                                                               
         ...
         BZ    LHDFYIX                                                          
*                                                                               
         MVC   FLDDATA(L'SRVLTYP2),SRVLTYP2   DISPLAY (Y OR NULL)               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BZ    LHDSUPX                                                          
*                                                                               
         MVC   FLDDATA(L'SRVLSUP),SRVLSUP    DISPLAY (Y OR NULL)                
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BNE   LHDFAXN                                                          
*                                                                               
         MVC   FLDDATA(3),SRVLADDR AREA CODE                                    
         MVI   FLDDATA+3,C'-'                                                   
         MVC   FLDDATA+4(3),SRVLADDR+3 EXCHANGE                                 
         MVI   FLDDATA+7,C'-'                                                   
         MVC   FLDDATA+8(4),SRVLADDR+6 NUMBER                                   
*                                                                               
         B     LHDADR99                                                         
*                                                                               
LHDFAXN  DS    0H                                                               
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),SRVLADDR  DISPLAY ADDRESS                             
*                                                                               
LHDADR99 DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 - VALIDATE CONTACT E-ADDRESS - LHWRTTAB'                 
***********************************************************************         
*                                                                     *         
...
*                                                                               
         USING SRVLSTD,R6          ESTABLISH LIST ELEMENT                       
*                                                                               
         CLI   SRVLCDE,0           DONE IF EOR REACHED                          
         BE    LSWTDELD                                                         
*                                                                               
         CLI   SRVLCDE,SRVEBIDQ    DELETE IF E-BASE ELEMENT                     
         BE    *+8                                                              
         CLI   SRVLCDE,SRVLIDQ     DELETE IF LIST ELEMENT                       
         BNE   LSWTDELC                                                         
*                                                                               
...
*                                                                               
         ...
         USING SRVLSTD,R3          ESTABLISH SPARM ELEMENT                      
*                                                                               
         CLI   SRVLLEN,0           GET ELEMENT LENGTH                           
...
*                                                                               
         ...
         BNE   *+8                                                              
         OI    SVACH1,SRVAADD         SET RECORD ADDED                          
*                                                                               
*        ADD ACTIVITY ELEMENT                                                   
*                                                                               
         BRAS  RE,ACTPUT                                                        
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE 'T41C41 - VENDOR CONTACT E-ADDRESS - ACTPUT'                     
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         MVC   SRVASCID,SVSCID     SET CHANGER'S SECURITY PID                   
*                                                                               
         MVC   SRVACHGS,SVACHGS    SET ACTIVITY INDICATORS                      
*                                                                               
         L     R6,AIO              POINT TO RECORD FOR DISPLAY                  
         ST    R6,DMCB             PASS TO RECUP                                
         MVI   DMCB,C'P'           INDICATE PRINT SYSTEM                        
...
*                                                                               
         MVI   ELCODE,SRVAIDQ      LOOK FOR ACTIVITY ELM                        
         BRAS  RE,GETEL            FIND IN RECORD                               
*                                                                               
ACTPUTLP DS    0H                                                               
*                                                                               
...
*                                                                               
         CLC   SRVAPID,SRVAPID-SRVAELM(R6)  IF SAME PERSON                      
         BNE   ACTPUTCN                                                         
         CLC   SRVASCID,SRVASCID-SRVAELM(R6) IF SAME SCID                       
         BNE   ACTPUTCN                                                         
         CLC   SRVADTE,SRVADTE-SRVAELM(R6)  AND DATE                            
         BNE   ACTPUTCN                                                         
*                                                                               
         OC    SRVACHGS-SRVAELM(L'SRVACHGS,R6),SVACHGS UPDATE CHANGES           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM41 - SFM VENDOR CONTACT LIST - ACTLMT'                     
***********************************************************************         
*                                                                     *         
...
*                                                                               
         MVI   ELCODE,SRVAIDQ      LOOK FOR ACTIVITY ELEM                       
         BRAS  RE,GETEL            FIND IN RECORD                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C41 - SFM VENDOR CONTACT LIST - PIDGET'                      
***********************************************************************         
*                                                                     *         
...
*                                                                               
         TITLE 'T41C41 - PUB LIST RECORD - PFKEYS'                              
***********************************************************************         
*                                                                     *         
*        ANALYZE PFKEYS                                               *         
*              PF4  - INSERT A LINE                                   *         
...
*                                                                               
         DROP  R3                                                               
*                                                                               
         TITLE 'T41C41 - PUB LIST RECORD - LNADD'                               
***********************************************************************         
*                                                                     *         
*        ADD A LINE                                                   *         
*                                                                     *         
...
*                                                                               
         B     PFKEYSX                                                          
*                                                                               
         TITLE 'T41C41 - PBL FILE - INSTRUCTION RECORD - LNDEL'                 
***********************************************************************         
*                                                                     *         
*        DELETE A LINE                                                *         
*                                                                     *         
...
*                                                                               
         B     PFKEYSX                                                          
*                                                                               
         TITLE 'T41C41 - PUB LIST POSTING - PFKEYS - EXITS'                     
***********************************************************************         
*                                                                     *         
*        EXIT ROUTINES                                                *         
*                                                                     *         
...
*                                                                               
         TITLE 'T41C41 - PUB LIST POSTING - LNTBL'                              
***********************************************************************         
*                                                                     *         
...
*                                                                               
         EJECT                                                                  
         TITLE 'T41C41 - VALIDATE CONTACT E-ADDRESS - SUBROUTS'                 
***********************************************************************         
...
HEDSPECS DS    0H                                                               
         SPROG 0,1                                                              
         PSPEC H1,51,C'ESR VENDOR CONTACT LIST REPORT'                          
         PSPEC H2,51,C'------------------------------'                          
         PSPEC H1,95,AGYNAME                                                    
         PSPEC H2,95,AGYADD                                                     
         PSPEC H4,95,RUN                                                        
...
*                                                                               
SRVKSAVE DS    XL(L'SRVKEY)        KEY SAVEAREA                                 
SVEBASE  DS    XL(SRVEBLQ)         E-MAIL ELM SAVEAREA                          
SVACTELM DS    XL(SRVACTLQ)        ACTIVITY ELM SAVEAREA                        
...
*                                                                               
LISTD    DSECT                                                                  
LLINE    DS    0CL132              PRINT/LIST LINE                              
...
ELTELEM  DS    CL(SRVLSTLQ+79)        CONTACT ELEMENT                           
ELTABL   EQU   *-ELTABD            ENTRY LENGTH                                 
*                                                                               
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004PRSFM41   03/16/09'                                      
         END                                                                    
