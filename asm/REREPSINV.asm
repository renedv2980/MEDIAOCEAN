*          DATA SET REREPSINV  AT LEVEL 136 AS OF 05/01/02                      
*PHASE REST02C,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE BINSRCH2                                                               
...
*INCLUDE XSORT                                                                  
*INCLUDE SCANNER                                                                
         TITLE 'REREPSDEL - KATZ RADIO INVOICE FIX'                             
*                                                                               
********************************************************************            
*                                                                  *            
*        REREPSDEL -- SCAN STATIONS FOR TAKEOVER ORDERS.           *            
...
CPRO0125 EQU   *                                                                
         ...
         BZ    CPRO0090            NO  - GO BACK FOR NEXT CON X'03'             
         CLC   4(2,R6),=C'C96A'    BUCKET AFTER NOV10/00                        
         BL    CPRO0090            NO  - GO BACK FOR NEXT CON X'03'             
...
MASTD    DSECT                                                                  
       ...
       EJECT                                                                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'136REREPSINV 05/01/02'                                      
         END                                                                    
