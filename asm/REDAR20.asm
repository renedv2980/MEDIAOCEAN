*          DATA SET REDAR20    AT LEVEL 010 AS OF 02/09/12                      
*PHASE T80F20A                                                                  
*&&      SET   XM=N                                                             
         TITLE 'T80F20 - REDAR20 - DARE ORDER OPEN/REJECT'                      
***********************************************************************         
*                                                                     *         
*  REDAR20 (T80F20) --- DARE ORDER OPEN/REJECT                        *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
* FEB09/12 KUI ALLOW FOXLOC TO SAVE OFF DEMO DATA                     *         
* MAR24/10 KUI ESPERANTO XML OOW FIX                                  *         
*              REMOVE SUPPORT FOR VARIOUS/BRAND ORDERS                *         
* NOV17/09 KUI FIX UNWIRED PROCESSING BUG                             *         
* SEP18/09 KUI FIX ZERO SPOTS START WEEK OVERRIDE BUG                 *         
* FEB06/09 SKU ESPERANTO SUPPORT                                      *         
* FEB05/08 SKU FIX XML OOW                                            *         
* OCT22/07 SKU SKIP LOCAL CHECK FOR CBS                               *         
* DEC10/05 SKU FIX DEMO ADDING EMPTY ELEMENT                          *         
* JUL06/05 SKU ADD ACTUAL XML AGENCY LINK                             *         
* JAN31/05 SKU ADD LEADING BLANK TO 2ND COMMENT LINE                  *         
* OCT19/04 SKU FIX BUG OF CUTTING OFF COMMENT AT 60 CHARACTERS        *         
* OCT05/04 HQ  FIX CONFLICT END DATE FLAG                             *         
* SEP09/04 HQ  DELETE PASSIVE KEYS FOR UNDARE ACTION                  *         
* AUG24/04 HQ  FIX CONFLICT END DATE NO 03 ELEMENT BUG                *         
* AUG20/04 HQ  HANDLE PASSIVE KEYS                                    *         
* MAY24/04 HQ  SUPPRESS DARE TRANSACTION FOR XML ORDER                *         
* MAR24/04 HQ  DEMO FIX FOR NULL CATEGORY WITH VALUE                  *         
* FEB09/04 SKU PRESERVE 1D FOR UNDARE                                 *         
* OCT03/03 HQ  POPULATE COST OVERRIDE FLAG                            *         
* OCT02/03 BU  UPGRADE PASSIVE MAINT FOR SINGLE-LINE INBOX            *         
* JAN17/03 SKU PASS ESTIMATE AS EBCDIC                                *         
* DEC23/02 SKU FIX BUY COMMENT BUG                                    *         
* JUN10/02 SKU FIX DEMO RATING VALUE STORAGE                          *         
*              STORE DEMO RATING CATETORIES TO CONTRACT HEADER        *         
*              DISALLOW REJECTION OF CONFIRMED ORDERS                 *         
...
*        L     R1,SYSPARMS                                                      
*        L     R4,16(R1)           COMPFACS                                     
         XC    MISCFLAG,MISCFLAG                                                
*                                                                               
         MVI   SVDARFL2,0          CLEAR FLAG                                   
*                                                                               
...
*                                                                               
         MVC   ORDROTST,RDAROROT-RDARFLEM(R6)                                   
*                                                                               
...
VREC0494 EQU   *                                                                
         ...
         USING RDARDMEL,R6                                                      
*                                                                               
         NI    MISCFLAG,X'FF'-X'10'                                             
         CLI   2(R6),C'('          IS TARGET DEMO A USER DEFINED DEMO           
         BNE   VR0494A             YES,DON'T CONVERT                            
         OI    MISCFLAG,X'10'      MARK USER DEFINE DEMO                        
         B     VREC0495            SKIP CONVERTING DEMOS                        
VR0494A  EQU   *                                                                
*                                                                               
         ZIC   R1,RDARDMLN                                                      
...
*                                                                               
         GOTOR AGYPROC             CYCLE AGENCY RECORDS,                        
*                                     GENERATING BUYLINES                       
*                                                                               
...
VREC0800 DS    0H                                                               
         ...
         BE    VREC0880                                                         
*        TM    SVDARFL2,SF2XML     XML ORDER - SKIP                             
*        BO    VREC0880                                                         
...
GETC0200 EQU   *                                                                
         ...
         BNE   GETC0210                                                         
         MVC   RERROR,=AL2(677)    SET ERROR MESSAGE                            
         B     GETC0400            EXIT CC NOT ZERO                             
GETC0210 EQU   *                                                                
...
*                                                                               
         TM    MISCFLAG,MF1EDIER   EDI ERROR?                                   
         BZ    APRO0050                                                         
...
APRO0160 EQU   *                                                                
         ...
         CLI   SKIPRECS,C'Y'       SKIP THIS RECORD?                            
         BE    APRO0080            YES - GO BACK FOR NEXT                       
         GOTO1 =A(BUYCOMMT),DMCB,(RC),(R3),RR=RELO                              
...
EASID    USING RCONIEL,R6                                                       
         ...
         BZ    APRO0610            INCASE OF ALPHA CHARACTERS                   
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* PROCESS BUY COMMENTS                                                          
* R3 HAS BUY DARE RECORD                                                        
* AIO2 HAS REP BUY RECORD                                                       
***********************************************************************         
PROCCOMT NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         XCEFL WORK2,300                                                        
         LA    R4,WORK2                                                         
*                                                                               
         LA    R8,4                                                             
*                                  CHECK IF ANY AGENCY BUY COMMENTS ARE         
         LR    R6,R3               OVER 60 CHARS LONG                           
         MVI   ELCODE,X'02'                                                     
         BAS   RE,GETEL                                                         
         BNE   PRCCNO                                                           
         USING RDARCTEL,R6                                                      
*                                                                               
PRCCMT03 DS    0H                  CHECK FIRST 4 LINES ONLY                     
         CLI   RDARCTLN,62                                                      
         BH    PRCCMT05                                                         
         BAS   RE,NEXTEL                                                        
         BNE   PRCCNO                                                           
         BCT   R8,PRCCMT03                                                      
*                                                                               
* PUT MAX 4 DARE BUY COMMENT ELEMENTS IN TO A BUFFER                            
*                                                                               
PRCCMT05 DS    0H                                                               
         LA    R8,1                                                             
         LR    R6,R3                                                            
...
*                                                                               
         ...
         AR    R4,R1                                                            
*                                                                               
         MVI   0(R4),C' '          ALWAYS ADD LEADING BLANK                     
         AHI   R4,1                                                             
*                                                                               
PRCCMT20 DS    0H                                                               
         BAS   RE,NEXTEL                                                        
...
*                                                                               
PRCCMT67 DS    0H                                                               
         GOTO1 LOADELT,DMCB,AIO2,ELTBUILD,=C'ADD=CODE'                          
         AHI   R4,60                                                            
*                                                                               
         LA    RE,60                                                            
PRCCMT68 DS    0H                                                               
...
*&&DO                                                                           
         ...
         BNE   SVDEMX                                                           
*&&                                                                             
         TM    MISCFLAG,X'10'      TARGET DEMO A USER DEFINED DEMO?             
         BO    SVDEMX              YES, DON'T BUILD DEMO FOR CONTRACT           
*                                                                               
         L     R6,AIO1                                                          
         MVI   ELCODE,X'20'                                                     
         BRAS  RE,GETEL                                                         
...
*                                                                               
SVDEM20  DS    0H                                                               
         CLI   ELEM+1,2            DON'T ADD EMPTY ELEMENT                      
         BNH   SVDEMX                                                           
         GOTO1 HELLO,DMCB,(C'P',=C'REPFILE'),AIO2,ELEM,=C'ADD=CODE'             
*                                                                               
SVDEMX   DS    0H                                                               
...
*                                                                               
         ...
         TM    RDARBDFL,X'10'                                                   
         BNO   BDET0015                                                         
         OI    MISCFLAG,MF1CDTE    MARK CONFLICT END DATE FLAG                  
*                                                                               
BDET0015 NI    MISCFLAG,X'7F'      TURN OFF 'DAILY' BUY FLAG                    
...
*                                  INSERT NUMBER OF WEEKS                       
         ...
         GOTO1 LOADELT,DMCB,(R2),ELTBUILD,=C'ADD=CODE'                          
         TM    MISCFLAG,X'80'      'DAILY' BUY?                                 
         BNO   BDET0295            NO  - GO BACK FOR NEXT ELEMENT               
...
STEX0280 EQU   *                                                                
         ...
         BE    STEX0300            YES - SET START=END IN RECORD                
         OI    MISCFLAG,MF1EDIER   SHOULD NEVER HAPPEN                          
*                                     MEANS EMPTY ARRAY!!!                      
STEX0300 EQU   *                                                                
...
*   UPDATE ALL APPROPRIATE PASSIVE KEYS FOR TV ORDERS                           
...
*                                                                               
         ...
         CLI   DELAGORD,C'Y'       DELETE AGENCY ORDER?                         
         BNE   WR20                                                             
         LA    R6,800(R3)          YES, DELETE OLD PASSIVE                      
         LHI   RF,800                                                           
         XCEF  (R6)                                                             
         B     WR30                                                             
WR20     DS    0H                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010REDAR20   02/09/12'                                      
         END                                                                    
