*          DATA SET PPLNK01    AT LEVEL 008 AS OF 06/09/10                      
*PHASE T41401A                                                                  
*INCLUDE TWABLD                                                                 
...
VALCLT   J     *+12                                                             
         ...
         XC    PCLTKEY,PCLTKEY                                                  
         L     RF,ALP                                                           
         MVC   PCLTKAGY,LP_AGY-LP_D(RF)                                         
         MVC   PCLTKMED,QMED                                                    
         CLI   PCLTKMED,C' '       NO MEDIA CODE?                               
         BH    *+8                                                              
         MVI   PCLTKMED,C'I'       DEFAULT TO INTERACTIVE                       
         MVI   PCLTKRCD,X'02'                                                   
         MVC   PCLTKCLT,0(R2)                                                   
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008PPLNK01   06/09/10'                                      
         END                                                                    
