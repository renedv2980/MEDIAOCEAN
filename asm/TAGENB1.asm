*          DATA SET TAGENB1    AT LEVEL 002 AS OF 05/01/02                      
*PHASE T702B1A                                                                  
         TITLE 'T702B1 - AREA LIST'                                             
T702B1   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T702B1                                                         
...
*              ROUTINE TO VALIDATE THE KEY                                      
         SPACE 1                                                                
VKEY     NTR1                                                                   
         LA    R2,SARSTRTH         START AT SPECIFIC AREA                       
         SPACE 1                                                                
...
MYSPECS  DS    0H                                                               
         ...
         SSPEC H2,73,PAGE                                                       
         SPACE 1                                                                
         SSPEC H1,34,C'AREA LIST'                                               
         SSPEC H2,34,C'---------'                                               
         SPACE 1                                                                
         SSPEC H4,2,C'AREA  NAME'                                               
         SSPEC H5,2,C'----  ----'                                               
         DC    X'00'                                                            
         EJECT                                                                  
...
* DDSPLWORKD                                                                    
       ...
       ++INCLUDE DDSPLWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002TAGENB1   05/01/02'                                      
         END                                                                    
