*          DATA SET NEBUY17    AT LEVEL 018 AS OF 06/01/15                      
*PHASE T31117A                                                                  
*INCLUDE NETINTG                                                                
...
******   MVC   NBSELEND,ESTEND                                                  
         ...
         MVI   NBRESUME,0                                                       
         OI    NBINDS2,NBBILLRD                                                 
*  SET CHECK BILLING INFORMATIO                                                 
         XC    BILLBLCK,BILLBLCK                                                
         LA    RE,BILLBLCK                                                      
...
PU23     TM    KEYUNCTL,NOUPDATE                                                
         BO    PU25                                                             
         TM    KEYUNCTL,NOBILL     NO UPDATE FOR BILLED                         
         BZ    PU23C                                                            
         LA    RE,BILLBLCK                                                      
         USING NBLBILLD,RE                                                      
         TM    NBLFUNC,NBLBILD     TEST BILLED                                  
         BZ    PU23C                                                            
         MVI   FERN,INVERR                                                      
         B     ERROR                                                            
PU23C    TM    KEYUNCTL,NOADUPFB   NO UPDATE FOR ADU/PFB UNITS                  
         BZ    PU23D                                                            
         TM    NBUNITST,X'04'      TEST PFB                                     
         BO    PU25                                                             
         TM    NBUNST3,X'02'      TEST ADU                                      
         BO    PU25                                                             
PU23D    TM    KEYUNCTL,NOUPPAID   NO UPDATE FOR PAID UNITS                     
         BZ    PU23E                                                            
         OC    NBPAYTGR(16),NBPAYTGR                                            
         BNZ   PU25                                                             
PU23E    TM    KEYUNCTL,ROUTINE                                                 
         BZ    PU24                                                             
         SR    RF,RF                                                            
         ICM   RF,3,KEYUNIT                                                     
         A     RF,MYBASE                                                        
...
PU24     TM    KEYUNCTL,DATADISP                                                
         ...
         MVC   0(0,RE),0(RF)                                                    
*                                                                               
PU25     L     R3,TABADDR           RESET TABLE ADDRESS                         
         LA    R3,KEYTABL(R3)                                                   
         ST    R3,TABADDR                                                       
         BCT   R2,PU23                                                          
         SPACE 1                                                                
...
*                                                                               
         ...
         BE    ERROR                                                            
*                                                                               
         TM    SVAGYFL2,SVAGYFL2_2DP   2 DECIMAL AGENCY?                        
         BO    *+12                                                             
...
*                                                                               
         ...
         BE    ERROR                                                            
*                                                                               
EDIT1    MVI   FNDX,0              INITIALIZE ERROR FIELD INDEX                 
...
VALHTAVG ST    RE,SAVEREG          HUT TYPE                                     
         ...
         B     VALEXIT                                                          
         SPACE                                                                  
VTRADE   ST    RE,SAVEREG          TRADE PERCENT                                
         CLI   FLDH+5,3                                                         
         BH    ERROR                                                            
         TM    FLDH+4,X'08'                                                     
         BZ    ERROR                                                            
...
VALBTYP  ST    RE,SAVEREG          HUT TYPE                                     
         ...
         B     VALEXIT                                                          
         SPACE 2                                                                
VALTTAG  ST    RE,SAVEREG          TRAFIC TAG                                   
         MVC   TRAFTAG,FLD                                                      
         CLI   FLD,C'^'            REMOVE TRAFFIC TAGS                          
         BE    VALEXIT                                                          
         CLI   FLDH+5,2                                                         
         BNE   ERROR                                                            
         CLI   FLD,C'T'                                                         
         ...
         B     VALEXIT                                                          
         SPACE 2                                                                
VALVT    ST    RE,SAVEREG          V TYPE                                       
         LA    RE,VTYPTAB                                                       
         MVC   VTYPED,FLD                                                       
         CLI   FLDH+5,3                                                         
         BE    VALVT40                                                          
*                                                                               
VALVT20  CLI   0(RE),X'FF'                                                      
         BE    VALVT40                                                          
         CLC   0(2,RE),FLD                                                      
         BE    VALEXIT                                                          
         LA    RE,2(RE)                                                         
         B     VALVT20                                                          
*                                                                               
VALVT40  CLI   NBPOSTYP,C'S'                                                    
         BE    ERROR                                                            
         LA    RE,MINVTYP                                                       
*                                                                               
VALVT50  CLI   0(RE),X'FF'                                                      
         BE    ERROR                                                            
         CLC   0(2,RE),FLD                                                      
         BE    VALVT60                                                          
         LA    RE,2(RE)                                                         
...
*                                                                               
         LA    R3,UNIVIO                                                        
         GOTO1 VHELLO,DMCB2,(C'G',SPTFILE),(X'C1',(R3)),0                       
...
*                                                                               
         ...
         MVC   ELEM(15),0(R3)                                                   
*                                                                               
         GOTO1 VHELLO,DMCB,(C'P',UNTFILE),NBAIO,ELEM,0                          
*                                                                               
         ZIC   RF,1(R3)                                                         
         AR    R3,RF                                                            
         B     UPUNIV10                                                         
...
UTRADEX  B     UPEXIT                                                           
         DROP  RE                                                               
         SPACE 1                                                                
* UPDATE PACKAGE VTYPE FIELD                                                    
UPPVT    ST    RE,SAVEREG                                                       
         USING NPK2D,RE                                                         
         GOTO1 VHELLO,DMCB2,(C'G',UNTFILE),(X'02',NBAIO),0                      
         CLI   12(R1),0            TEST IF PKG GUARANTEE FOUND                  
         BNE   UPPVTY60            NO                                           
         L     RE,12(R1)                                                        
         MVC   NPK2VTYP,VTYPED                                                  
         MVC   NPK2MPOD,VTYPED+2                                                
         B     UPPVTYEX                                                         
*                                                                               
UPPVTY60 XC    ELEM,ELEM                                                        
         LA    RE,ELEM                                                          
         MVI   NPK2EL,X'02'                                                     
         MVI   NPK2LEN,NPK2ELN                                                  
         MVC   NPK2VTYP,VTYPED                                                  
...
UPBTYPX  B     UPEXIT                                                           
         SPACE 1                                                                
UPTTAG   ST    RE,SAVEREG                                                       
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'60',AIOAREA1),(1,=C'Q')            
         CLI   TRAFTAG,C'^'                                                     
         BE    UPTTAGX                                                          
*                                                                               
         XC    WORK(11),WORK                                                    
         MVC   WORK(3),=XL3'6005D8'                                             
         MVC   WORK+3(2),TRAFTAG                                                
         BAS   RE,PUTEL                                                         
*                                                                               
UPTTAGX  B     UPEXIT                                                           
         SPACE 1                                                                
...
*                                                                               
******** DC    CL6'TRADE',AL1(TRADE),AL1(3)                                     
******** DC    AL3(VTRADE-T31117)                                               
******** DC    AL1(L'TRADEHLD)                                                  
******** DC    AL2(TRADEHLD-TEMPD)                                              
******** DC    AL1(ROUTINE)                                                     
******** DC    AL2(PTRADE-T31117)                                               
******** DC    AL1(ROUTINE+NOBILL)                                              
******** DC    AL2(UTRADE-T31117)                                               
*                                                                               
...
*                                                                               
         DC    CL6'TG',AL1(TTAG),AL1(2)                                         
         DC    AL3(VALTTAG-T31117)                                              
         DC    AL1(0)                                                           
         DC    AL2(0)                                                           
         DC    AL1(NOUPDATE)                                                    
         DC    AL2(0)                                                           
         DC    AL1(ROUTINE)                                                     
         DC    AL2(UPTTAG-T31117)                                               
*                                                                               
         DC    CL6'VTYPE',AL1(VT),AL1(2)                                        
         DC    AL3(VALVT-T31117)                                                
         DC    AL1(L'VTYPED)                                                    
         DC    AL2(VTYPED-TEMPD)                                                
         DC    AL1(ROUTINE)                                                     
...
TRAFTAG  DS    CL2                 TRAFFIC TAG                                  
TRADEHLD DS    H                                                                
VTYPED   DS    CL3                 V TYPE TAG                                   
*                                                                               
ELEM     DS    CL151                                                            
*                                                                               
BILLBLCK DS    CL96                BILL READER BLOCK                            
*                                                                               
...
TTAG     EQU   14                  TRAFFIC TAG  (T1-T9)                         
TRADE    EQU   15                  TRADE PERCENT                                
VT       EQU   16                  V TYPE                                       
         SPACE 2                                                                
* DDCOMFACS                                                                     
         PRINT OFF                                                              
...
* NETBILLRD                                                                     
       ...
       ++INCLUDE NETBILLRD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018NEBUY17   06/01/15'                                      
         END                                                                    
