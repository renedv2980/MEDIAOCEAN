*          DATA SET SPOTBOOKA  AT LEVEL 061 AS OF 05/01/02                      
*PHASE T00A49A,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ACTBKG                                                                 
         SPACE 1                                                                
...
ACT02    DS    0H                                                               
         ...
         GOTO1 =V(ACTBKG),DMCB,ABKAREA,RR=RELO                                  
         LA    R1,ABKOLIST         POINT TO BOOK LIST                           
         L     RE,SBABKLST         POINT TO OUTPUT LIST                         
         SR    R0,R0                                                            
BLDOLST  MVC   0(6,RE),0(R1)       MOVE THEM OUT                                
         LA    RE,6(RE)                                                         
         LA    R1,6(R1)                                                         
         OC    0(2,R1),0(R1)                                                    
         BZ    BLDOLST2                                                         
...
* SPGENBUY                                                                      
       ...
       ++INCLUDE SPGENBUY                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'061SPOTBOOKA 05/01/02'                                      
         END                                                                    
