*          DATA SET REROM22    AT LEVEL 053 AS OF 11/20/03                      
*PHASE T83F22A                                                                  
*&&      SET   DB=N,TK=Y                                                        
...
* 10SEP03 HQ  ERROR MESSAGE FOR MISSING PRODUCT CODE                  *         
...
T83F22   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 WORKLQ,*T83F22*,RR=R3                                            
         LR    R5,RC                                                            
         USING MYAREAD,R5                                                       
         L     RC,0(R1)            STANDARD CODING                              
         USING GEND,RC                                                          
         LR    R7,RB                                                            
         A     R7,=A(COMMON-T83F22)                                             
...
VR03     DS    0H                                                               
         ...
         CLC   =C'REJ',CONACT                                                   
         BNE   VR04                                                             
         MVC   AORPFLN+16(RJECTPFQ),RJECTPFK                                    
         B     VR10                                                             
*                                                                               
VR04     DS    0H                                                               
         CLC   =C'AME',CONACT                                                   
         BNE   VR05                                                             
         LA    R2,AORHDLNH                                                      
         MVC   AORRMSG+11(10),=C'Amend:    '                                    
         MVC   AORPFLN+16(AMENDPFQ),AMENDPFK                                    
*                                                                               
         TM    AORREASH+4,X'80'    FIELD INPUT THIS TIME?                       
         BO    VR04010             YES                                          
         TM    AORREASH+4,X'40'    FIELD INPUT BEFORE?                          
         BO    VR04010             YES                                          
         MVC   AORREAS(AMENDM1Q),AMENDMS1   MUST BE FIRST TIME IN               
*                                                                               
VR04010  DS    0H                                                               
         TM    AORREA2H+4,X'80'                                                 
         BO    VR04020                                                          
...
VR04020  DS    0H                                                               
         ...
         TM    AORREA3H+4,X'40'                                                 
         BO    VR04030                                                          
         MVC   AORREA3(AMENDM3Q),AMENDMS3                                       
*                                                                               
VR04030  DS    0H                                                               
         LA    RE,AORREASH         Turn on lower case to make                   
         LA    RF,AORAMN1H         consistent STYLE                             
VR04040  DS    0H                                                               
         CR    RE,RF                                                            
         BE    VR04050                                                          
         OI    1(RE),X'40'                                                      
...
VR04050  DS    0H                                                               
*&&DO                                                                           
         OI    AORREASH+6,X'80'    XMIT                                         
         OI    AORREA2H+6,X'80'    XMIT                                         
         OI    AORREA3H+6,X'80'    XMIT                                         
*                                                                               
         MVC   AORREAS(AMENDM1Q),AMENDMS1                                       
         MVC   AORREA2(AMENDM2Q),AMENDMS2                                       
         MVC   AORREA3(AMENDM3Q),AMENDMS3                                       
         OI    AORREASH+6,X'80'    XMIT                                         
         OI    AORREA2H+6,X'80'    XMIT                                         
         OI    AORREA3H+6,X'80'    XMIT                                         
*&&                                                                             
         NI    AORAMN1H+1,X'FF'-X'08'-X'04'                                     
         NI    AORAMN2H+1,X'FF'-X'08'-X'04'                                     
         NI    AORAMN3H+1,X'FF'-X'08'-X'04'                                     
         NI    AORAMN4H+1,X'FF'-X'08'-X'04'                                     
         OI    AORAMN1H+6,X'80'                                                 
         OI    AORAMN2H+6,X'80'                                                 
         OI    AORAMN3H+6,X'80'                                                 
         OI    AORAMN4H+6,X'80'                                                 
...
ERDUMP   DS    0H                                                               
         ...
         EDIT  (P5,WORK+20),(8,WORK),ALIGN=LEFT                                 
         LA    R1,WORK                                                          
         ST    R1,DMCB+12                                                       
         MVI   DMCB+12,8                                                        
...
*                                  GET 9'S REVERSE FOR BUYS LATER               
         ...
         OC    CCONNUM,CCONNUM     COULD BE UNLINK (ROM)                        
         BZ    GETC0370                                                         
*                                                                               
         LA    R6,KEY                                                           
         USING RCONKEY,R6                                                       
...
*                                                                               
         ...
         BRAS  RE,GETEL                                                         
         BE    AP538               FOUND: JUST REPLACE THE CODES                
...
VALP0050 DS    0H                                                               
         ...
         BNZ   ERPRDDAT            EMPTY?                                       
         TM    MISCFLG2,MF2TKO     TAKE OVER CONTRACT?                          
         BZ    ERPRDDAT            NO                                           
...
*                                                                               
* UPDATE EI FIELDS. ALSO SUPPORT FOR ALPHANUMERIC ESTIMATE #                    
         GOTO1 =A(GETCON),RR=RELO                                               
         L     R6,AIO3                                                          
         MVI   ELCODE,X'A2'        RETRIEVE                                     
         BRAS  RE,GETEL                                                         
         BE    PAR100              FOUND: JUST REPLACE THE CODES                
         XC    ELTBUILD,ELTBUILD   NOT FOUND: BUILD IT                          
         MVC   ELTBUILD(2),=X'A220'                                             
         MVC   ELTBUILD+2(L'SAVEEASI),SAVEEASI                                  
*              INSERT EASI CODES FROM AGY HEADER                                
...
*                                                                               
         ...
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE                                                  
         BNE   ERNOSAL             DUMP IN BACK GROUD                           
*        DC    H'0'                AND PUT OUT ERR MESSAGE                      
         MVI   RDUPDATE,C'N'                                                    
         GOTO1 GETREC                                                           
         L     R3,AIO                                                           
...
MF2TKO   EQU   X'08'                  X'08'  =  TAKE OVER ORDER                 
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'053REROM22   11/20/03'                                      
         END                                                                    
