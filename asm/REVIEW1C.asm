*          DATA SET REVIEW1C   AT LEVEL 026 AS OF 09/07/05                      
*          DATA SET REVIEW1C   AT LEVEL 005 AS OF 11/19/99                      
*PHASE T8171CA                                                                  
VIEW1C   TITLE 'KC REPORT FOR VIEWER'                                           
VIEW1C   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,REVIEW1C,R7,RR=RE                                              
         USING TWAD,RA                                                          
         USING WORKD,R9                                                         
         L     R8,AGWORK                                                        
         USING GWORKD,R8                                                        
...
***********************************************************************         
         SPACE 1                                                                
DISGRP   MVC   FVIFLD(L'REKCGRP),FLTIFLD                                        
         B     EXITOK                                                           
         SPACE 1                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
DOFQTR   OC    REKCTOT,REKCTOT                                                  
         BZ    FLTXX               NOT A TOTAL LINE                             
*                                                                               
         CLC   REKCPRD+1(1),FLTIFLD                                             
         BL    FLTXL                                                            
         BE    FLTXE                                                            
         BH    FLTXH                                                            
         DROP  R2                                                               
...
***********************************************************************         
         SPACE 1                                                                
         USING REKCKEY,R2                                                       
DISLIN   LH    R1,LSROWREP         SET CURSOR OVERRIDE TO FIRST KEY             
         CHI   R1,1                                                             
         BH    DLIN00                                                           
*                                                                               
...
*                                                                               
         ...
         DROP  R4                                                               
*                                                                               
DLIN00   LH    R1,LSROWREP         SECOND LINE IS FIRST RECORD                  
         CHI   R1,2                                                             
         BH    DLIN02                                                           
*                                                                               
         L     R0,AIO2             NO '00' ON RECORD END - MUST CLEAR           
         LHI   R1,2000             AIO1 TO ZEROS                                
         XR    RE,RE                                                            
         XR    RF,RF                                                            
         MVCL  R0,RE                                                            
*                                                                               
         MVC   IOKEY,REKCKEY       SET CURRENT RECORD INTO IO2                  
...
*                                                                               
DLIN02   L     R4,AIO2                                                          
REC      USING REKCKEY,R4                                                       
         MVC   IOKEY,0(R4)         SET KEY IN IOKEY                             
         MVC   LSLASKEY,0(R4)      SAVE THIS KEY                                
*                                                                               
DLIN03   L     R0,AIO2             NO '00' ON RECORD END - MUST CLEAR           
         LHI   R1,2000             AIO1 TO ZEROS                                
         XR    RE,RE                                                            
         XR    RF,RF                                                            
         MVCL  R0,RE                                                            
...
*                                                                               
         MVC   IOKEY,0(R4)                                                      
         CLC   REKCKEY(REKCRNK-REKCKEY),REC.REKCKEY                             
...
*                                                                               
DLIN04   L     R4,AIO2                                                          
         CLC   SVAGY,REC.REKCAGY   SAME AGENCY?                                 
         BE    DLIN08              YES                                          
         MVC   SVAGY,REC.REKCAGY                                                
*                                                                               
         CLC   REC.REKCAGY,BCEFFS  RANK                                         
         BE    DLIN06                                                           
         ICM   RF,15,REC.REKCRNK                                                
         CURED (RF),(4,L1.L1RANK),0,DMCB=BOPARM,ALIGN=LEFT                      
*                                                                               
DLIN06   GOTOX DOAGY,BOPARM,REC.REKCKEY                                         
         MVC   L1.L1AGY,BOWORK1                                                 
*                                                                               
DLIN08   GOTOX DOLINE,BOPARM,FVIFLD,REC.REKCKEY                                 
*                                                                               
         L     R4,AIO2                                                          
         MVC   LSLASKEY,0(R4)                                                   
*                                                                               
...
GETDATE  NTR1  ,                                                                
         XC    IOKEY,IOKEY                                                      
X        USING REKCKEY,IOKEY                                                    
         L     RF,AIOREC                                                        
         USING REKCKEY,RF                                                       
         MVC   X.REKCRPT,=AL2(REKCRPTQ)                                         
         MVC   X.REKCREP,CUAALF                                                 
...
X        USING RAGYRECD,IOKEY                                                   
         MVI   X.RAGYKTYP,X'0A'                                                 
         MVC   X.RAGYKAGY,REKCAGY                                               
         MVC   X.RAGYKAOF,REKCAGY+L'RAGYKAGY                                    
...
*                               ** PERIOD IS YYMM BINARY                        
         ...
         CLI   REKCPRD+1,X'0D'      IF MM IS 'OD' THIS IS A YRLY TOTAL          
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         MVC   L1PED(L'ALL),ALL                                                 
         CLI   REKCPRD+1,FF         IF MM IS 'FF' PUT OUT 'ALL'                 
         BE    DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         ...
         MVI   L1PED+2,C'4'                                                     
*                                                                               
DOL00    OC    REKCTOT,REKCTOT      IF SET THIS IS SUB-TOTAL LINE               
         BNZ   DOL01                                                            
*                                                                               
         MVC   L1PED,BCSPACES                                                   
         XR    RF,RF                                                            
...
*                                                                               
DOL01    LA    RF,REKCFRST                                                      
         XR    RE,RE                                                            
*                                                                               
DOL02    CLI   0(RF),0                                                          
         BE    EXITOK                                                           
         CLI   0(RF),RCPBIELQ      PRIOR BILLING                                
         BE    DOL06                                                            
         CLI   0(RF),RCPSHELQ      PRIOR SHARE                                  
         BE    DOL08                                                            
         CLI   0(RF),RCCBIELQ      CURRENT BILLING                              
         BE    DOL10                                                            
         CLI   0(RF),RCCSHELQ      CURRENT SHARE                                
         BE    DOL12                                                            
*                                                                               
...
SCRL02   MVC   0(L'GROUP,R4),GROUP                                              
         MVI   L'GROUP(R4),C'='                                                 
         LA    R4,L'GROUP+1(R4)                                                 
         MVC   0(L'REKCGRP,R4),REKCGRP                                          
         CLC   REKCGRP,BCSPACES   IS THIS FOR ALL GROUPS?                       
         BH    SCRL04             NO                                            
         MVC   0(L'ALL,R4),ALL                                                  
         LA    R4,L'ALL(R4)                                                     
         B     *+8                                                              
SCRL04   LA    R4,L'REKCGRP(R4)                                                 
         MVI   0(R4),C','                                                       
         LA    R4,1(R4)                                                         
*                               ** STATION FILTER                               
...
*                               ** OFFICE FILTER                                
         ...
         MVI   L'OFFICE(R4),C'='                                                
         LA    R4,L'OFFICE+1(R4)                                                
         MVC   0(L'REKCOFF,R4),REKCOFF                                          
         CLC   REKCOFF,BCEFFS     IS THIS FOR ALL OFFICES?                      
         BNE   *+10               NO                                            
         MVC   0(L'ALL,R4),ALL                                                  
*                                                                               
...
*                                                                               
         TM    LSLTIND1,LSLTISOL   STARTED LIST?                                
         BZ    NLST02              NO                                           
         B     NLST                                                             
         SPACE 2                                                                
***********************************************************************         
...
NLST02   L     RF,AIOREC           I/S RETURNS INTO RECORD BUFFER               
         CLC   0(REKCGRP-REKCKEY,RF),LSINIKEY                                   
         BNE   EXITL               MAKE SURE SAME REPORT/REP                    
*                                                                               
         CLC   =C'DATES=',REKCSTN-REKCKEY(RF)                                   
         BE    NLST                                                             
*                                                                               
...
FF       EQU   X'FF'                                                            
         SPACE 1                                                                
FILTTAB  DC    AL2(00001),AL1(REKCGRP-REKCDSCT,L'REKCGRP)                       
         DC    AL2(00002),AL1(REKCSTN-REKCDSCT,L'REKCSTN)                       
         DC    AL2(00003),AL1(REKCOFF-REKCDSCT,L'REKCOFF)                       
         DC    AL2(00005),AL1(REKCRNK-REKCDSCT,L'REKCRNK)                       
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
...
*        DDFLDHDR                                                               
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'026REVIEW1C  09/07/05'                                      
         END                                                                    
