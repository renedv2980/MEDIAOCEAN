*          DATA SET COMINTER   AT LEVEL 008 AS OF 02/28/18                      
...
*                                                                               
         LA    R3,BNWREC                                                        
         MVI   BNWSEQ,0            INIT SEQUENCE NUMBER                         
...
*                                                                               
         ...
         JNE   BBINNR24                                                         
         ZIC   RF,PHNWHSEQ         BUMP UP SEQUENCE NUMBER                      
         AHI   RF,1                                                             
         STC   RF,BNWSEQ                                                        
...
*                                                                               
         ...
         JE    PGETNR20                                                         
*                                                                               
         ZIC   RF,PHNWHSEQ         FOUND HASHKEY BUT NOT DEMO LIST              
...
*                                                                               
PPUTS02  MVC   REQPREC,DBCMPREC    PRECISION                                    
*                                                                               
         OC    DBCMMKT,DBCMMKT                                                  
         JZ    PPUTS10                                                          
...
PHNWHSEQ DS    X                   PREVIOUS HASHKEY SEQUENCE #                  
...
SWPTDAY  DS    CL2                 DAY                                          
         DS    CL1                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008COMINTER  02/28/18'                                      
         END                                                                    
