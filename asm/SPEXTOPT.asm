*          DATA SET SPEXTOPT   AT LEVEL 020 AS OF 05/01/02                      
*PHASE SPEXTOPT,*                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
...
* LEV 19 SMUR AUG31/99 CLEAR SORTESTS TABLE                           *         
*                                                                     *         
***********************************************************************         
         SPACE 3                                                                
***********************************************************************         
...
DMXEOF28 GOTO1 VPRINTER                                                         
         ...
         BE    DMXEOF30                                                         
         SPACE                                                                  
         LA    RE,SORTESTS         CLEAR SORT TABLE                             
         LA    RF,L'SORTESTS                                                    
         XCEF                                                                   
         SPACE                                                                  
         B     DMXEOF10                                                         
         SPACE                                                                  
DMXEOF30 MVC   P+34(L'HDG-33),HDG+33                                            
         GOTO1 VPRINTER                                                         
         LA    R2,GRSORD                                                        
         LA    R3,P+30                                                          
         LA    R4,4                                                             
...
CLTHDRD   DSECT                                                                 
       ...
       ++INCLUDE SPNWSDTL                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020SPEXTOPT  05/01/02'                                      
         END                                                                    
