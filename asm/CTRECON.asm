*          DATA SET CTRECON    AT LEVEL 004 AS OF 09/01/11                      
*PHASE CTRECONA                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE PRINTER                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE SORTER                                                                 
*INCLUDE PRNTBL                                                                 
         TITLE 'CTRECON - CTFILE RECONSTRUCT PROGRAM'                           
CTRECON  CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 0,CTRECON,=V(REGSAVE)                                            
*                                                                               
         L     RC,=A(RECONWKC)                                                  
         USING RECONWK,RC                                                       
*                                                                               
...
*                                                                               
         ...
         MVC   RSIN,=F'0'                                                       
*                                                                               
         CLI   RFILTY,CTFILEQ      TEST CTFILE                                  
         BNE   IN2                                                              
*                                                                               
...
OP2      CLC   FKEY(L'ROLDKEY),ROLDKEY                                          
         ...
         BNE   OP8                                                              
         LA    R0,FKEY-4                                                        
         BAS   R9,PUT              OUTPUT FILE EOF RECORD                       
         B     OPDONE                                                           
...
*                                                                               
         MVC   LINE,=PL2'75'                                                    
         MVC   TITLE(18),=C'CTFILE RECONSTRUCT'                                 
*                                                                               
         LA    R3,CNTRS                                                         
         LA    R4,18                                                            
         LA    R5,CNTRSX                                                        
...
*                                                                               
         LTORG                                                                  
*                                                                               
KEYLEN   EQU   25                  ***** USER DEFINED *****                     
CTFILEQ  EQU   X'A1'               ***** USER DEFINED *****                     
FILNAME  DC    C'CTFILE '          ***** USER DEFINED *****                     
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004CTRECON   09/01/11'                                      
         END                                                                    
