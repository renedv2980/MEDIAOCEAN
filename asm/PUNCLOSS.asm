*          DATA SET PUNCLOSS   AT LEVEL 020 AS OF 05/01/02                      
*PHASE PUNCLOSS,*,NOAUTO                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PUNCLOSS - PRT/PUB FILE PEEL-OFF'                               
*                                                                               
*              STRIP OFF DATA TO BE UNCLOSED                                    
*                                                                               
PUNCLOSS CSECT                                                                  
         NBASE 0,PUNCLOSS,=V(REGSAVE)                                           
         SPACE 2                                                                
         LA    R6,PUNCLOSS+4095                                                 
         LA    R6,1(R6)                                                         
         USING PUNCLOSS+4096,R6                                                 
...
XIT      XIT1                                                                   
         ...
         EJECT                                                                  
*&&DO                                                                           
IN       DTFMT BLKSIZE=8200,RECFORM=VARBLK,TYPEFLE=INPUT,              X        
...
*&&                                                                             
         EJECT                                                                  
*&&DO                                                                           
OUT      DTFMT BLKSIZE=8200,RECFORM=VARBLK,TYPEFLE=OUTPUT,             X        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020PUNCLOSS  05/01/02'                                      
         END                                                                    
