*          DATA SET DESQPRR    AT LEVEL 001 AS OF 02/08/17                      
...
SORTKTAB DS    0H                      (FIELD #, MAX LENGTH OF FIELD)           
         ...
         DC    AL1(P_MQ),AL1(L'SRTP_M)                                          
         DC    AL1(R_MQ),AL1(L'SRTR_M)                                          
         DC    X'FF'                                                            
*                                                                               
DDNAME   DC    C'FILIN1'                                                        
TUKEY    DC    X'C017'                                                          
...
P_MQ     EQU   12                  POP METRO                                    
R_MQ     EQU   13                  RANK METRO                                   
*                                                                               
SRTKD    DSECT                                                                  
...
SRTA_C   DS    CL8                 AVG CPP                                      
         DS    CL1                                                              
SRTA_D_C DS    CL8                 AVG DMA CPM                                  
         DS    CL1                                                              
SRTL_C   DS    CL8                 LOW CPP                                      
         DS    CL1                                                              
SRTL_D_C DS    CL8                 LOW DMA CPM                                  
         DS    CL1                                                              
SRTP_M   DS    CL8                 POP METRO                                    
         DS    CL1                                                              
SRTR_M   DS    CL8                 RANK METRO                                   
SRTKDQ   EQU   *-SRTKY                                                          
*                                                                               
       ++INCLUDE DDDPRINT                                                       
       ++INCLUDE DEMITD                                                         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001DESQPRR   02/08/17'                                      
         END                                                                    
