*          DATA SET SPNWS34    AT LEVEL 109 AS OF 05/14/09                      
*PHASE T20734A,*                                                                
...
*                                                                               
FSTR13   BRAS  RE,BOOKS            INSPECT BOOK FIELDS                          
         BNE   FSTRX                                                            
         OC    SVBKS,SVBKS                                                      
...
*        AR    RF,RE                                                            
*        BCT   R0,*-10                                                          
DISR36   BRAS  RE,BOOKS            INSPECT THE BOOK FIELDS                      
         BNE   DISRX                                                            
         BRAS  RE,DISBKS           MAKE SURE BOOKS ARE DISPLAYED                
*                                                                               
...
UPGR4G   MVC   NBRUPINP(L'LEDUPG),LEDUPG                                        
...
*********                                                                       
         XC    LEDSUB,LEDSUB       DON'T KNOW IF WE NEED IT YET                 
         MVI   LEDSDP,0                                                         
         CLI   0(R3),NBRKTYPQ      BUY REVISION RECORD?                         
...
*                                                                               
         MVC   LEDSDP,NBRSSBDP     SAVE OFF THE SUBDAYPART AS WELL              
         CLI   LEDSDP,C' '         DOES IT HAVE ANYTHING?                       
...
DEMU15G  TM    SPUPFBK+1,BTYBITSQ  SPECIAL BOOK?                                
         BZ    DEMU15T                                                          
         TM    SPUPFBK+1,BTY2CHAR  2 CHARACTER BOOKTYPES?                       
         BO    DEMU15R              - YUP, ALREADY HAVE QBOOKTYP                
*                                                                               
         GOTO1 AGETBKTY,APPARM,(C'B',SPUPFBK+1),SPUPBTYP                        
...
* SPDEMLKXTD                                                                    
       ...
       ++INCLUDE SPDEMLKXTD                                                     
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'109SPNWS34   05/14/09'                                      
         END                                                                    
