*          DATA SET CTFIL20    AT LEVEL 048 AS OF 08/10/11                      
*&&      SET   NOP=N                                                            
*PHASE TA1320C                                                                  
*INCLUDE GETBOOK                                                                
*INCLUDE SQUASHER                                                               
...
***********************************************************************         
         SPACE 1                                                                
SCRSET   MVI   GSSMCODE,C'A'                                                    
         CLI   CSACT,A#CHA         CHANGE HAS DIFFERENT SCREEN                  
         BNE   *+8                                                              
         MVI   GSSMCODE,0                                                       
         B     EXITOK                                                           
         EJECT                                                                  
...
RECORD   LM    R0,R3,SVPARMS                                                    
         ...
         B     ITER                ITERATE TABLE                                
*                                                                               
TABLREC  DC    AL1(RLAST),AL1(0,0,0),AL4(RECLAST)                               
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
...
RECLAST  L     R1,SVPARMS4         R1=INVOKER`S VERB                            
         ...
         B     ITER                ITERATE TABLE                                
*                                                                               
RLTABL   DC    AL1(RCPY),AL1(0,0,0),AL4(RLCPY)                                  
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
...
*                                                                               
         ...
         B     RLCP02                                                           
*                                                                               
*LCPX    DC    H'0',C'$ABEND'  <== test $abend code                             
RLCPX    B     EXITOK                                                           
         POP   USING                                                            
         EJECT                                                                  
***********************************************************************         
...
KNOWTAB  DC    AL2(01000),AL4(RTYDTA)    RECORD TYPE                            
         ...
         DC    AL2(01004),AL4(LINDTA)    DATA LINE - CHANGE                     
         DC    AL2(01010),AL4(LINDTA)    DATA LINE - ALL OTHERS                 
         ...
         DC    AL2(01009),AL4(MXNDTA)    NUMBER OF LINES IN LIST                
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
KNOWTABD DSECT                                                                  
...
*                                                                               
         ...
         L     R1,0(R1)                                                         
         CLI   FASYSID-FACTSD(R1),1  TST                                        
         BE    EXITOK                                                           
         CLI   FASYSID-FACTSD(R1),6  MEL                                        
         BE    EXITOK                                                           
         CLI   FASYSID-FACTSD(R1),11 CSC                                        
         BE    EXITOK                                                           
         CLI   FASYSID-FACTSD(R1),15 FQA                                        
         BE    EXITOK                                                           
...
***********************************************************************         
         SPACE 1                                                                
MXNDTA   LA    RF,MXNTBL           TABLE OF KNOWN VERBS                         
         B     ITER                ITERATE TABLE                                
*                                                                               
MXNTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISMXN)                                 
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
DISMXN   GOTOX AGETEL,BOPARM,('CTINDELQ',AIOREC),0                              
         BNE   EXITOK                                                           
         LA    RF,BOELEM          SET UP BLANK INDEX ELEMENT                    
         USING CTINDD,RF                                                        
         XR    R0,R0                                                            
         ICM   R0,1,CTINDHI       GET CURRENT HIGHEST USED                      
         BZ    EXITOK                                                           
         CURED (R0),(3,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT                         
         B     EXITOK                                                           
         DROP  RF                                                               
         SPACE 2                                                                
***********************************************************************         
...
***********************************************************************         
         SPACE 1                                                                
INITL1   OI    LSSTAT2,LSSNOSEQ                                                 
         OI    LSSTAT1,(LSSTSAR+LSSBALL)                                        
         MVC   LSNUMHED,=AL2(1)                                                 
         MVI   LSSUBLEN,0                                                       
         NI    LSSTAT2,(255-LSSADD)                                             
         CLI   CSACT,A#CHA                                                      
         BNE   *+12                                                             
         MVI   LSSUBLEN,SBLEN                                                   
         OI    LSSTAT2,LSSADD+LSSIUPD                                           
*                                                                               
...
*                                                                               
         CLC   FVMSGNO,=AL2(CE#MCIP)                                            
         BNE   EXITOK                                                           
         B     EXITL               SETTING OWN MESSAGE                          
*                                                                               
SLAST10  GOTO1 STUMBLE             TRY TO COMPILE THE DAMN THING                
         B     EXIT                PRESERVE CONDITION CODE                      
         EJECT                                                                  
***********************************************************************         
* SUB ACTION OBJECT                                                   *         
* -----------------                                                   *         
...
*                                                                               
         LA    R1,TSANXT                                                        
SRT10    GOTO1 (RF),(R1)           READ NEXT N RECORDS TO DELETE THEM           
         BL    SRT20               END OF FILE                                  
         CLC   TLKSES,TWASESNL     TEST NEST LEVEL                              
         BNE   SRT20               DONE ALL FOR THIS LEVEL                      
         BCT   R0,SRT10                                                         
         B     SRT08               PROCESS NEXT RECORD                          
*                                                                               
SRT12    MVI   BOBYTE2,0           RESET ADD INTO LIST FLAG                     
...
*                                                                               
         MVC   BOWORK1,TLLINE      SAVE DATA LINE                               
         MVC   TLMSTAT,TLUSTAT     AND LINE STATUS BYTE                         
*                                                                               
         ...
         LA    R0,1                                                             
*                                                                               
SRT16    TM    TLUSTAT,TLUSINS     INSERTING A LINE?                            
         BZ    *+14                NO                                           
         MVC   TLLINE,BCSPACES     CLEAR LINE TO SPACES                         
         OI    TLUSTAT,TLUTINS     FLAG THIS LINE INSERTED                      
*                                                                               
         LH    RE,CCOUNT           YES - ADD MULTIPLE IMAGES                    
         LA    RE,1(RE)                                                         
         STH   RE,CCOUNT                                                        
         ...
         GOTOX (RF),TSAADD                                                      
*                                                                               
         MVC   TLLINE,BOWORK1      RESTORE LINE DATA AND STATUS FLAG            
         MVC   TLUSTAT,TLMSTAT                                                  
         BCT   R0,SRT16            LOOP FOR REQUIRED REPEAT COUNT               
*                                                                               
SRT18    LH    RE,CCOUNT           SET NEW ORDERING FOR LINE COUNT              
         LA    RE,1(RE)                                                         
         STH   RE,CCOUNT                                                        
         STCM  RE,3,TLKSNUM        RESET KEY NUMBER                             
         CVD   RE,BODUB1                                                        
...
*                                                                               
SRT20    XC    TLKEY,TLKEY         DELETE ALL CURRENT RECORDS                   
         MVC   TLKSES,TWASESNL                                                  
         GOTOX (RF),TSARDH                                                      
...
***********************************************************************         
         SPACE 1                                                                
STUMBLE  NTR1  BASE=*                                                           
         GOTOX ('PUTRAC',AGROUTS),BOPARM,('RACTCHA',AIOREC)                     
...
*                                                                               
         ...
         B     STUMOK                                                           
*                                                                               
STUMH    CLI   *,0                 SET CC HIGH                                  
         B     STUMX                                                            
STUML    CLI   *,FF                SET CC LOW                                   
         B     STUMX                                                            
STUMOK   CR    RB,RB               SET CC EQUAL                                 
         SPACE 1                                                                
STUMX    XIT1  ,                                                                
*                                                                               
         LTORG                                                                  
...
*                                                                               
SAVER3   DS    A                   R3 USED IN CALLBACK FROM SUBROUTINE          
...
*DDFLDHDR                                                                       
       ...
       ++INCLUDE DDFLDHDR                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'048CTFIL20   08/10/11'                                      
         END                                                                    
