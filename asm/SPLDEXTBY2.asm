*          DATA SET SPLDEXTBY2 AT LEVEL 001 AS OF 03/19/01                      
*PHASE SPEXTBY2                                                                 
*INCLUDE HEXOUT                                                                 
         TITLE 'DMLDEXTBY2 - RESTORE BUYER CODES FOR BBDO'                      
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC   DS    0H                                                               
         ...
         CLI   0(R6),X'06'                                                      
         BNE   DMXREC30                                                         
         CLC   1(2,R6),=C'BN'      <----- COMPARE AGENCY CODE                   
         BNE   DMXPURGE                                                         
...
BYRLNQ   EQU   *-BYRMD                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001SPLDEXTBY203/19/01'                                      
         END                                                                    
