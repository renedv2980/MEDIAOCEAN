*          DATA SET YYUNAPPCK  AT LEVEL 035 AS OF 05/01/02                      
*PHASE YYUNAPPCA                                                                
*INCLUDE HEXOUT                                                                 
*INCLUDE PDUMPER                                                                
*INCLUDE PRINT                                                                  
...
*                                                                               
         XC    BUFFER,BUFFER                                                    
         MVC   BUFFER(61),=C'VERSION=1,USERID=SJR       ,SUBID=SDE,DESC+        
               RIPTION=TEST RPT.  '                                             
         LA    R5,61                                                            
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035YYUNAPPCK 05/01/02'                                      
         END                                                                    
