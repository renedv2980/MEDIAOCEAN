*          DATA SET DETVQ4     AT LEVEL 241 AS OF 03/21/02                      
*PHASE DETVQ4A                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE DEMTIME                                                                
*INCLUDE TIMVAL                                                                 
...
*        MVC   PHTPTYP(2),NTIFILT                                               
         ...
         MVI   PHELN,PHELNEQ                                                    
         MVC   PHDWKS,X'0F'                                                     
*        MVC   PHDBOOK,=X'630B'    #3                                           
*        MVC   PHDBOOK,=X'6401'    #4                                           
*        MVC   PHDBOOK,=X'6402'    #5                                           
*        MVC   PHDBOOK,=X'6403'    #6                                           
*        MVC   PHDBOOK,=X'6405'    #7                                           
*        MVC   PHDBOOK,=X'6407'    #8                                           
*        MVC   PHDBOOK,=X'6409'    #1                                           
*        MVC   PHDBOOK,=X'640A'    #2                                           
*        MVC   PHDBOOK,=X'640B'    #3                                           
*        MVC   PHDBOOK,=X'6501'    #4                                           
*        MVC   PHDBOOK,=X'6502'    #5                                           
*        MVC   PHDBOOK,=X'6503'    #6                                           
*        MVC   PHDBOOK,=X'6505'    #7                                           
*        MVC   PHDBOOK,=X'6507'    #8                                           
*        MVC   PHDBOOK,=X'6509'    #1                                           
*        MVC   PHDBOOK,=X'650A'    #2                                           
*        MVC   PHDBOOK,=X'650B'    #3                                           
*        MVC   PHDBOOK,=X'6601'    #4                                           
         MVC   PHDBOOK,=X'6602'    #5                                           
         ICM   R4,3,PMRLEN                                                      
         ZIC   R5,1(RF)                                                         
         AR    R4,R5                                                            
         STCM  R4,3,PMRLEN                                                      
...
PARSTAB  DS    0C                                                               
         ...
         DC    C'HD',AL1(00,00,00)                                              
         DC    C'"1999-2000 TVQ#4, CARAT PROPRIETARY!'                          
*        DC    C'HD',AL1(00,00,00)                                              
...
*        DC    C'HD',AL1(00,00,00)                                              
*        DC    C'"1998-99 TVQ#8, CARAT PROPRIET!'                               
*        DC    C'HD',AL1(00,00,00)                                              
*        DC    C'"1998-99 TVQ#7, CARAT PROPRIET!'                               
*        DC    C'HD',AL1(00,00,00)                                              
...
*        DC    C',       ,,Pgm,,18+,,,18-34,,,35-49!'                           
         ...
         DC    C',       ,,Pgm,,Sample,,,,6-11,,,,,12!'                         
         DC    C'HA',AL1(00,00,04) 14                                           
         DC    C',       ,,Pgm,Day,Sample,,,6-11,,,1!'                          
                                                                                
         DC    C'HA',AL1(00,00,04) 14                                           
         DC    C',       ,,Pgm,,Sample,,,6-11,,,12!'                            
         DC    C'HA',AL1(00,00,04) 14                                           
         DC    C',       ,Pgm,,,Sample,,,6-11,,,12-1!'                          
...
PROGBUF2 DS    220000C                                                          
       ...
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'241DETVQ4    03/21/02'                                      
         END                                                                    
