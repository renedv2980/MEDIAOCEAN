*          DATA SET REROM10    AT LEVEL 060 AS OF 02/17/04                      
*          DATA SET REROM10    AT LEVEL 114 AS OF 05/31/94                      
*PHASE T83F10B                                                                  
*                                                                               
         TITLE 'T83F10 - REROM10 - DARE AGENCY BUY LIST'                        
***********************************************************************         
*                                                                     *         
*  REROM10 (T83F10) --- DARE AGENCY BUY LIST                          *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
* MODIFY SO THIS CAN RETURN TO DIFFERENCE SCREEN                      *         
...
LPF12    DC    AL1(KEYTYTWA,L'DRBHDLN-1),AL2(DRBHDLN-T83FFFD)                   
LPF12X   EQU   *                                                                
*                                                                               
***********************************************************************         
* LIST PFKEY TABLE DEFINITIONS                                                  
...
BLPF12   DC    AL1(KEYTYTWA,L'DRBHDLN-1),AL2(DRBHDLN-T83FFFD)                   
BLPF12X  EQU   *                                                                
*                                                                               
***********************************************************************         
...
LBUYSPT  DS    CL4                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'060REROM10   02/17/04'                                      
         END                                                                    
