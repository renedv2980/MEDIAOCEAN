*          DATA SET SPNFI10    AT LEVEL 182 AS OF 02/23/01                      
*PHASE T22710A                                                                  
*INCLUDE DECODE                                                                 
NFI10    TITLE 'FILE MAINTENANCE OVERLAY FOR SPT SYSTEM'                        
NFI10    CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,SPNFI10*,RA,R7,RR=RE                                           
         USING WORKD,R9                                                         
         L     R8,AGWORK                                                        
         USING GWORKD,R8                                                        
         LH    R6,=Y(TWUSER-TWAD)                                               
...
***********************************************************************         
         SPACE 1                                                                
KFKDIS   CLI   GSSKCODE,C'A'       ONLY IF COPY OR ADD SCREEN LOADED            
         BNE   EXITOK                                                           
         CLI   SESNL,1             AND NESTED                                   
         BNH   EXITOK                                                           
*                                                                               
         L     R1,AIOREC           GET FILE RECORD KEY                          
         L     RF,RTDSPDIR                                                      
         XR    RE,RE                                                            
...
*                                                                               
         CLI   IOKEY,X'10'         THESE HAVE DIFFERENT DIRECTORY KEY           
         BL    KFKD02                                                           
         MVC   BOHALF1,IOKEY+10    FUDGE FOR NEW STRUCTURE                      
         MVC   IOKEY+11(2),BOHALF1                                              
         MVI   IOKEY+10,0                                                       
*                                                                               
KFKD02   L     RF,RTDSPDIR         NOW TRY TO READ THE THING                    
         XR    R1,R1                                                            
...
VALDSK   MVC   ADSK,FVADDR                                                      
         CLI   SPFMACT,0                                                        
         BE    VDSK01                                                           
         GOTO1 VHEXOUT,BOPARM,SPFMDA,FVIFLD,4,0                                 
         MVI   FVILEN,8                                                         
         OI    FVIIND,FVIHEX       DISK ADDRESSES MUST BE HEX                   
*                                                                               
VDSK01   CLI   FVILEN,0                                                         
         BNE   VDSK08                                                           
         CLI   CSACT,A#ADD                                                      
...
VDSK14   MVC   0(L'IOKEY,R2),IOKEY                                              
         ...
         B     VDSK18                                                           
*                                                                               
VDSK16   CLC   GCLASKEY,GSRECKEY   COMPARE RECORDS                              
         MVC   GCLASKEY,GSRECKEY   STOP LEVEL RESET                             
         BE    EXITOK                                                           
         XC    LSSTAT1,LSSTAT1                                                  
         B     EXITOK                                                           
*                                                                               
VDSK18   MVC   GCLASKEY,GSRECKEY   STOP LEVEL RESET                             
...
XIN06    LA    R3,0(R5,R3)                                                      
         B     XIN02                                                            
*                                                                               
XIN08    CLI   NSREC,X'11'                                                      
         BNE   *+8                                                              
         NI    GCINDS2,255-GCIXITS                                              
         B     EXITOK                                                           
         DROP  R3                                                               
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
SLAST02  BRAS  RE,SORT             PROVIDE CODE TO RESOLVE RESULTS              
         BE    SLAST04                                                          
*                                                                               
         BRAS  RE,REACT            ACTIONS NEED REDRAWING                       
         MVC   BOCURSOR,AFRSTFR    MOVE/COPY BEFORE/AFTER CONFLICT              
         MVC   FVMSGNO,=AL2(GE$CCONF)                                           
         B     EXITL                                                            
*                                                                               
SLAST04  BRAS  RE,REDRAW                                                        
         OI    GCINDS2,GCIANYCH    SET CHANGES THIS TIME                        
         B     SLAST12                                                          
*                                                                               
SLAST06  BRAS  RE,REACT            ACTIONS NEED REDRAWING                       
*                                                                               
...
*                                                                               
         ...
         B     SORT14                                                           
*                                                                               
         BRAS  RE,ADDIN            ADD RECORD(S) BEFORE THIS RECORD             
*                                                                               
...
*                                                                               
         ...
         BNE   *+8                 NO                                           
         BRAS  RE,ADDIN            ADD RECORD AFTER THIS RECORD                 
*                                                                               
...
LMCOUNT  DS    H                   REPEAT COUNT FOR MULTIPLES                   
*                                                                               
...
TLLENQ   EQU   *-TLSTD                                                          
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'182SPNFI10   02/23/01'                                      
         END                                                                    
