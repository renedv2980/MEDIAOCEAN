*          DATA SET DELDEXCTD  AT LEVEL 046 AS OF 03/17/05                      
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'046DELDEXCTD 03/17/05'                                      
         END                                                                    
