*          DATA SET PUBCOPYT   AT LEVEL 025 AS OF 09/20/04                      
*PHASE PUBCOPTA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
******                                                                          
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*        DO NOT MODIFY THIS PUBCOPY VERSION (PUBCOPYT)                *         
*            IT IS THE "MASTER" PUB COPY PROGRAM                      *         
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
******                                                                          
******   THIS PROGRAM IS TO BE USED WHEN COPYING TO AN AGENCY                   
******   ON A DIFFERENT PRINT FILE.                                             
******   THE OUTPUT IS AN ADDITIONAL LOAD TAPE FOR THAT FILE.                   
******                                                                          
...
*                                                                               
START4   DS    0H                                                               
         CLC   =C'CLTS=Y',CARD         SEE IF COPYING CLIENTS                   
         BNE   START5                                                           
         MVI   COPYCLT,C'Y'                                                     
         B     START1                                                           
*                                                                               
START5   DS    0H                                                               
         CLC   =C'/*',CARD          LAST CARD                                   
         BE    GET                                                              
         LA    R0,AGMLSTX                                                       
         CR    R4,R0                                                            
         BL    *+6                                                              
...
*                                                                               
         ...
         BNE   GET                 NO - SKIP                                    
*                                                                               
         CLI   COPYCLT,C'Y'       SEE IF COPYING CLIENT DATA                    
         BE    GET6                YES COPY ALL ADDRESS RECORDS                 
*                                                                               
*                           ELSE COPY ONLY "ALL CLIENT" ADDRESSES               
*                                                                               
...
GET5     DS    0H                                                               
         ...
         BNE   GET5A                                                            
         CLI   COPYREP,C'Y'     SEE IF SAVING REPS                              
         BE    GET5A            YES - ONLY SAVE ALL CLIENT DATA                 
         B     GET5B            NO - DELETE ALL CLIENT ELEMS                    
*                                                                               
GET5A    DS    0H                                                               
*                                                                               
         CLI   COPYCLT,C'Y'     SEE IF COPYING CLIENTS                          
         BE    GET4D            COPY ALL THESE ELEMENTS                         
*                                                                               
*                          ELSE COPY ONLY "ALL CLIENT" ELEMENTS                 
*                                                                               
         CLC   2(3,R2),=3X'FF'                                                  
         BE    GET4D                                                            
GET5B    DS    0H                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025PUBCOPYT  09/20/04'                                      
         END                                                                    
