*          DATA SET RESFM0D    AT LEVEL 075 AS OF 11/14/07                      
*PHASE T8180DA                                                                  
*INCLUDE CLPACK                                                                 
         TITLE 'T8180D - RESFM0D - MARKET PROFILE REPORT'                       
*                                                                               
**********************************************************************          
*                                                                    *          
*        RESFM0D (T8180D) --- MARKET PROFILE REPORT                  *          
*                                                                    *          
* ------------------------------------------------------------------ *          
* UPDATE HISTORY:                                                    *          
*                                                                    *          
...
*                                                                    *          
* NOV11/03 (BU ) --- CHANGE TO SIZE OF SPDEMLK PER MEL.              *          
*                                                                    *          
* MAR28/05 (BU ) --- ADD DEMFILV TO LIST                             *          
*                                                                    *          
* OCT25/07 (BU ) --- FIX PAGE0 ASSEMBLY ERROR                        *          
*                                                                    *          
* OCT26/07 (DE ) --- USE SOFT DEMO FILE OPEN LISTS                   *          
*                                                                    *          
*                    ***  END TOMBSTONE  ***                         *          
**********************************************************************          
*                                                                    *          
...
MP7      LA    R1,HOOK                                                          
         ...
         LA    RE,BUFF             AND SAVE ADDRESS OF AREA FOR INDEX           
         LA    RE,2048(RE)                                                      
         LA    RE,2048(RE)                                                      
         LA    RE,904(RE)                                                       
         ST    RE,AINDEX1                                                       
...
MP80     EQU   *                                                                
         ...
         LA    R5,BUFF             PUT LINES FOR A DAY/TIME TOGETHER            
         ST    R5,ABUFF                                                         
...
MP100    L     R5,AIO2             ELSE USE SCHEME 1                            
         LA    R2,MPRPJ1H                                                       
         SPACE 1                                                                
MP110    ICM   RE,4,AINDEX2        CLEAR INDEX AREA                             
         BZ    *+10                                                             
         XC    0(200,RE),0(RE)                                                  
         SPACE 1                                                                
...
* BLOCK HAS DEMOS FOR LAST BOOK.  SAVE THEM AT AINDEX1                          
         SPACE 1                                                                
         L     RE,AINDEX1                                                       
         ZIC   R1,CNUMDEM          NUMBER OF DEMOS                              
         MH    R1,=H'8'            DEMO IS 4 BYTES, + SVI DEMO                  
         BCTR  R1,0                                                             
         EX    R1,*+8                                                           
         B     *+10                                                             
...
GP55     EQU   *                                                                
         XC    BLOCK(240),BLOCK                                                 
         XC    BLOCK+240(240),BLOCK+240                                         
         GOTO1 SPDEMUP,DMCB,SPDEMUPD,CDEMOS,BLOCK                               
...
IND20    LA    R6,8(R6)                                                         
         ...
         ZIC   R5,CNUMDEM          NUMBER OF DEMOS                              
IND30    CLI   0(R2),X'FD'                                                      
         BNE   IND33                                                            
         MVC   2(2,R3),=C'--'                                                   
         B     IND40                                                            
...
TWADCOND DSECT                                                                  
       ++INCLUDE DDTWADCONS                                                     
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'075RESFM0D   11/14/07'                                      
         END                                                                    
