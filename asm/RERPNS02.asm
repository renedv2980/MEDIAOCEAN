*          DATA SET RERPNS02   AT LEVEL 004 AS OF 05/01/02                      
*          DATA SET REREPSW02  AT LEVEL 254 AS OF 10/04/96                      
*PHASE RENS02A,*                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE PRINT                                                                  
...
********************************************************************            
*                                                                  *            
*        REREPNS02 --- READ DUMP TAPE TO FIX REP INVENTOREY RECS.  *            
*                       AVAIL DAY AND TIME FIELDS,                 *            
*                                                                               
         PRINT NOGEN                                                            
RENS02   CSECT                                                                  
...
*                                                                               
         ...
         BAS   RE,GETEL                                                         
         BNE   CONT0050            ELEM NOT THERE                               
         USING RCONDVEL,R6                                                      
         CLC   RCONDVSP,FDSP       DEVELOPMENTAL SALESPERSON                    
         BNE   CONT0050                                                         
         DROP  R6                                                               
*                                                                               
CONT0030 CLC   FADV,SPACES                                                      
         BE    *+14                                                             
...
*                                                                               
         ...
         MVI   ELCODE,X'18'        DEVSAL ELEM                                  
         BAS   RE,GETEL                                                         
         BNE   CONT0081            ELEM NOT THERE                               
         USING RCONDVEL,R6                                                      
         MVC   RCONDVSP,NDSP       DEVELOPMENTAL SALESPERSON                    
         DROP  R6                                                               
*                                                                               
CONT0081 CLC   NADV,SPACES                                                      
         BE    CONT0082                                                         
         MVC   RCONKADV,NADV                                                    
...
CONT0120 EQU   *                                                                
         LA    R5,CONCNT                                                        
         BAS   RE,DMPPUT                                                        
         B     CONT0050            LOOP THROUGH ENTIRE TABLE                    
         EJECT                                                                  
*                                                                               
...
MKGD0020 EQU   *                                                                
         ...
         BE    MKGD0040                                                         
         SPACE 1                                                                
MKGD0030 LA    R4,LENFIXT(R4)                                                   
         B     MKGD0020                                                         
         SPACE 1                                                                
MKGD0040 EQU   *                                                                
         CLC   FSTA,SPACES         STATION CHANGE IN REQUEST?                   
         BE    MKGD0030            NO - CHECK NEXT REQUEST                      
*                                                                               
         CLC   RMKGKSTA,FSTA       STATION TO BE CHANGED?                       
         BNE   MKGD0030            NO - CHECK NEXT REQUEST                      
         CLC   NSTA,SPACES         ANY NEW STATION?                             
         BE    MKGD0030            NO - CHECK NEXT REQUEST                      
         BAS   RE,DMPGET           DUMP                                         
         MVC   RMKGKSTA,NSTA       YES - INSERT NEW STATION                     
*                                                                               
MKGD0050 LA    R5,MKGCNT                                                        
         BAS   RE,DMPPUT                                                        
         B     MKGD0030                                                         
*                                                                               
         EJECT                                                                  
...
*                                                                               
         LA    R3,REC              RESET A(INPUT RECORD)                        
         MVC   HALF,27(R3)                                                      
         LH    R8,HALF                                                          
         LA    R6,P+5                                                           
         LH    R4,=H'60'           PRINT IN GROUPS OF 60                        
...
RCVROUT  DCB   DDNAME=RCVROUT,DSORG=PS,RECFM=VB,MACRF=PM,              X        
               LRECL=02024,BLKSIZE=26364,BUFNO=2                                
         SPACE 3                                                                
         LTORG                                                                  
         EJECT                                                                  
PURGCNT  DC    PL5'0'                                                           
...
*                                                                               
       ...
       ++INCLUDE DMRCVRHDR                                                      
RCVREC   DS    CL2024              AREA FOR RECOVERY RECORD                     
         EJECT                                                                  
         DS    F                   LENGTH OF RECORD                             
REC      DS    CL4008              AREA FOR RECORD                              
         SPACE 2                                                                
MYWORKX  EQU   *                                                                
*                                                                               
         EJECT                                                                  
...
NREPEX   EQU   *                                                                
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004RERPNS02  05/01/02'                                      
         END                                                                    
