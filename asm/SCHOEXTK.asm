*          DATA SET SCHOEXTK   AT LEVEL 104 AS OF 05/01/02                      
*PHASE SCHOEXTB SCHOEXTK                                                        
*INCLUDE LOGIO                                                                  
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXOUT                                                                 
...
**********************************************************************          
* SCHOEXTK - SEPARETES THE CURRENT NTIFILE TO TWO PARTS:                        
...
CREC     OC    CHOBOOK,CHOBOOK                                                  
         BZ    RECX                DELETE REC'S W/O BOOK                        
         CLC   CHOBOOK,=X'6400'                                                 
         BL    PVXKEEP             DELETE ALL PRIOR TO YEAR 2000.               
         B     RECX                                                             
*                                                                               
         USING PJKEY,R3                                                         
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE DEDEMFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'104SCHOEXTK  05/01/02'                                      
         END                                                                    
