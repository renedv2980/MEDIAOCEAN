*          DATA SET SRQUI00S   AT LEVEL 037 AS OF 05/01/02                      
*PHASE T12500A                                                                  
...
*&&                                                                             
*                                                                               
DFIL065  TM    0(R4),SFRCV                                                      
         BZ    *+10                                                             
         MVC   FTYPE(6),=C'RCVR  '                                              
         TM    0(R4),SFREQ                                                      
         BZ    *+10                                                             
         MVC   FTYPE(6),=C'REQUEST'                                             
         TM    0(R4),SFPRTQ                                                     
         BZ    *+10                                                             
         MVC   FTYPE(6),=C'PRTQUE'                                              
*                                                                               
         TM    0(R4),SFHDR                                                      
         BZ    *+10                                                             
         MVC   FHDR,YES                                                         
*                                                                               
         TM    0(R4),SFISF         TEST FOR INDEX SEQ                           
         BO    DFIL080                                                          
*                                                                               
         USING DTFPHD,R6                                                        
...
DFIL071  LA    R2,1(R2)                                                         
         SR    RF,RF                                                            
         ICM   RF,3,12(RE)         PICK UP HIGH TRACK                           
         AR    R1,RF                                                            
         LA    RE,14(RE)                                                        
...
*                                                                               
         ICM   RF,3,DNEXT          RF=CURRENT R1=MAX                            
         TM    DTFTYPE,DTFTBIG                                                  
         BZ    *+12                                                             
         ICM   RF,7,DNEXT          USE THIS FOR 18 BIT TRACKS                   
         SRL   RF,6                                                             
         MH    RF,=H'100'                                                       
         SR    RE,RE                                                            
         LTR   R1,R1                                                            
...
*                                                                               
         ICM   RF,3,ISOVLAST       RF=CURRENT R1=MAX                            
         BZ    DFIL089                                                          
         TM    ISFTYPE,ISFTBIG                                                  
         BZ    *+12                                                             
         ICM   RF,7,ISOVLAST       USE THIS FOR 18 BIT TRACKS                   
         SRL   RF,6                                                             
         MH    RF,=H'100'                                                       
         SR    RE,RE                                                            
         LTR   R1,R1                                                            
...
SEHEADER DC    C'Sel Sename  Num  Strt Pend Actv Access e'                      
         DC    C'sc  ENQ  Nop  Qlen Act  Max  No Files  '                       
SEUNDER  DC    C'--- ------- ---- ---- ---- ---- ------ -'                      
         DC    C'--- ---- ---- ---- ---- ---- ----------'                       
...
FLHEADR0 DC    C'            Ext                Dyna     '                      
         DC    C'            Usable                     '                       
FLHEADER DC    C'Sel File-Id Num  Status   Nop  DD   Acc'''                     
         DC    C' Prot''  Xtn Tracks  Used Or Type   Hdr '                      
FLUNDER  DC    C'--- ------- ---- -------- ---- ---- ----'                      
         DC    C' ------ --- ------- ---- -- ------ --- '                       
...
LLLINEL  EQU   *-LSLINED                                                        
         EJECT                                                                  
*                                                                               
*        EQUATES FROM DMFILES                                                   
*                                                                               
* XL1 FILE FLAGS    DEFINED BY EQUATES                                          
* XL2 N/D                                                                       
* XL1 FILE NUMBER   EXTERNAL                                                    
* XL1 N/D                                                                       
* AL3 FILE DTF ADDR                                                             
*                                                                               
* LIST TERMINATED BY X'FF' SYSTEM NUMBER                                        
         SPACE 2                                                                
SFNOP    EQU   X'80'               FILE IS NO-OP                                
SFRCV    EQU   X'40'               FILE IS RECOVERY FILE                        
SFREQ    EQU   X'20'               FILE IS REQUEST FILE                         
SFPRTQ   EQU   X'10'               FILE IS PRTQ FILE                            
SFCPU    EQU   X'08'               FILE IS X-CPU PROTECTED                      
SFNOEOF  EQU   X'04'               DO NOT SEARCH FOR EOF AT OPEN TIME           
SFHDR    EQU   X'02'               FILE HAS A HEADER RECORD                     
SFISF    EQU   X'01'               FILE IS INDEX SEQUENTIAL                     
         SPACE 2                                                                
DAOPEN   EQU   14                                                               
RDID     EQU   01                                                               
ADDADR   EQU   11                                                               
...
*SRQUIFFD                                                                       
       ++INCLUDE SRQUIFFD                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'037SRQUI00S  05/01/02'                                      
         END                                                                    
