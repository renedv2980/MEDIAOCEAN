*          DATA SET CTPRO00S   AT LEVEL 003 AS OF 05/01/02                      
*PHASE TA0300B                                                                  
*INCLUDE EXPRESS                                                                
*INCLUDE GETIDS                                                                 
*INCLUDE HEXIN                                                                  
...
CLIVAL   LA    R2,PROCLIH                                                       
         ...
         BE    VALEND                                                           
         OC    PDQUNAM,PDQUNAM     IS THIS A DQU WRITER PROFILE?                
...
PFH30    DS    0H                  GET HELP TEXT                                
         ...
         LA    R4,15               # OF HELP LINES ALLOWED                      
*                                                                               
...
*                                                                               
         ...
         MVC   HV1SYS,PSYSN        SYSTEM NUMBER                                
*                                                                               
HH5      MVC   HV1PROF,PPRG        PROGRAM NAME                                 
         CLI   HV1PROF,0           FIRST BYTE NULLS?                            
...
* CTGENHV1                                                                      
       ++INCLUDE CTGENHV1                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003CTPRO00S  05/01/02'                                      
         END                                                                    
