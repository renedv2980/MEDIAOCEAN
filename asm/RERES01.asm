*          DATA SET RERES01    AT LEVEL 033 AS OF 05/25/11                      
*PHASE T81901A                                                                  
*INCLUDE DEMTIME                                                                
*INCLUDE UNTIME                                                                 
*INCLUDE TIMVAL                                                                 
...
FILLT50  EQU   *                                                                
         ...
         CLC   PURDAYF,=C'VAR'     IF "VAR" REQUEST                             
         BNE   FILLT55                                                          
         CLC   WORK+2(2),=C'AV'    CHECK FOR NON-STANDARD RETURN                
         BNE   XIT                 NOT FOUND, SKIP IT                           
         B     FILL1               FOUND, PROCESS                               
                                                                                
FILLT55  CLC   WORK+2(3),PURDAYF                                                
...
*                                                                               
         GOTO1 DEFINE,PARAS,=C'TOT2DUR',DBLOCKD,WORK                            
         SR    R2,R2                                                            
         ICM   R2,3,WORK                                                        
         EDIT  (R2),(3,37(R3))                                                  
         SPACE 2                                                                
FILL60   MVC   SAVBK,DBACTBK                                                    
         ...
         ZIC   R1,NUMDEMS                                                       
         SPACE 2                                                                
FILL70   CLI   1(R2),C'U'          IF UNIVERSE                                  
         BE    FILL75              THEN, NO DECIMAL                             
         EDIT  (4,0(R5)),(6,0(R6)),1   1 DECIMAL POINT FOR                      
         B     FILL77                                                           
                                                                                
FILL75   EDIT  (4,0(R5)),(6,0(R6))                                              
                                                                                
FILL77   LA    R2,3(R2)            NEXT DEMO                                    
...
*                                                                               
         L     RF,DBEXTEND                                                      
         CLC   =C'UID ',0(RF)                                                   
         JE    XIT                         ONLY DO THIS ONCE                    
*                                                                               
         LA    RF,DBXTUID                  POINT TO USER ID STORAGE             
         USING DBXTUIDD,RF                                                      
*                                                                               
         MVC   DBXNXT,DBEXTEND             SET NEXT LINK                        
         ST    RF,DBEXTEND                 STORE ADDRESS INTO DBXTND            
...
*                                                                               
DBXTUID  DS    0X                  EXTENDED BLOCK FOR USER ID                   
         DS    CL4                 C'UID '                                      
         DS    A                   NEXT EXTENSION                               
         DS    H                   BINARY USER ID                               
*                                                                               
...
SAVELN   EQU   *-SYSSPARE          SAVE AREA LENGTH                             
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'033RERES01   05/25/11'                                      
         END                                                                    
