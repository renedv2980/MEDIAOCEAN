*          DATA SET DEHW07I    AT LEVEL 019 AS OF 09/30/15                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEHW07IA                                                                 
*INCLUDE SMTP                                                                   
*-------------------------------------------------------------------*           
* NTIH -  HISPANIC WEEKLY TAPE - INPUT PHASE                                    
*                                                                               
...
*  !!!  FOR DATA PRIOR TO 8/27/07, PLEASE USE DEHW05I & DEHW05O   !!!           
**********************************************************************          
         TITLE 'DEMO CONVERSION - NTIH HISPANIC WEEKLY MIT'                     
DEHW07I  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,DEHW07I*,RA,R3,R4                                              
...
RDR      CLC   =C'POCKETPIECE',RDRRPT                                           
         BE    *+10                                                             
         CLC   =C'NTIH POCKETPIECE',RDRRPT                                      
         BE    *+6                                                              
         DC    H'0'                                                             
                                                                                
         MVC   TAPEMKT,=H'515'     MARKET NUMBER (USED FOR DCON ACCESS)         
         MVI   BOOKTYPE,0                                                       
         ...
         CLC   TAPEBK,=AL1(YR_2007,WEEK_35)  FOR DATA PRIOR TO 8/27/07          
         BNL   *+6                                                              
...
RLHSUM4A LAY   RE,CRCOTAB         RELEASE THE DEMOS                             
...
RLHISUM  ZIC   RF,SUMSLOT          NEXT SUMMARY CATEGORY                        
         LA    RF,1(RF)                                                         
         STC   RF,SUMSLOT                                                       
...
D4R06    CLC   MIDDAYS,=C'1111100'  ---AVERAGED DATA --(01,04,05) M-F?          
         ...
         LA    RE,1(RE)                                                         
         BCT   R0,*-16                                                          
         CHI   RF,1                MULTI WK AVG ACROSS 1-DAY?                   
...
D4R13    MVC   PNUM,0(R1)          SAVE PROGRAM NUMBER                          
         ...
         CLC   =C'UMA',PNET        CALL LETTER CHANGE                           
         BNE   *+16                                                             
         MVC   INTSTA(3),=C'TF '                                                
         MVC   PNET(3),=C'TF '                                                  
                                                                                
         CLC   =C'MMX',PNET        CALL LETTER CHANGE                           
         BNE   *+16                                                             
         MVC   INTSTA(3),=C'MFX'                                                
         MVC   PNET(3),=C'MFX'                                                  
...
*                                                                               
         ...
         BNE   *+10                                                             
         MVC   INTSTA(3),=C'PAX'                                                
         CLC   =C'UMA',INTSTA      CALL LETTER CHANGE                           
         BNE   *+10                                                             
         MVC   INTSTA(3),=C'TF '                                                
         CLC   =C'MMX',INTSTA      CALL LETTER CHANGE                           
         BNE   *+10                                                             
         MVC   INTSTA(3),=C'MFX'                                                
*                                                                               
         MVI   INTBTYP,0                                                        
...
RELSUM2B LAY   R9,PTDPNAME         SET PRG TYPE NAME                            
         XC    INTPNAME,INTPNAME                                                
...
RELSUM4A LAY   RE,CRCOTAB          RELEASE THE DEMOS                            
...
INCRSUM  ZIC   RF,SUMSLOT          NEXT SUMMARY CATEGORY                        
         LA    RF,1(RF)                                                         
         STC   RF,SUMSLOT                                                       
...
OUTSL15  DS    0H                  PROCESS PUTS                                 
         ...
         LAY   R9,OUTUNVS          SAME DISP FORMAT AS UNIVS DO                 
         B     OUTSL30                                                          
         SPACE 1                                                                
...
OUTSL20  DS    0H                  PROCESS UNIVS                                
         ...
         LAY   R7,DEMAREA          SOURCE                                       
         LAY   R9,OUTUNVS          TELLS WHAT UNIVS GO INTO OUTP CATAG          
         SPACE 1                                                                
...
H5R38    MVI   DUB+2,C'M'          DUB=HOUR   DUB+1=AM/PM                       
         ...
         USING NEHTAGD,RE                                                       
H5R40    CLI   0(RE),X'FF'                                                      
         BE    H5R43               AGGRGT NOT FOUND. CK GEN MARKET AGGS         
         CLC   INTSTA(1),NEHTAGNO+1 MATCH ON VIEWING SOURCE NUMBER              
         BE    H5R41                                                            
         AR    RE,RF                                                            
         B     H5R40                                                            
H5R41    MVC   INTSTA(3),NEHTAGNT  MOVE IN ALPHA AGGREGATE CODE                 
         B     H5R50                                                            
         DROP  RE                                                               
*                                                                               
H5R43    ICM   RF,15,ACOMFACS                                                   
         ICM   RF,15,CDEMTABS-COMFACSD(RF)                                      
...
H5R45    CLI   0(RE),X'FF'                                                      
         ...
         AR    RE,RF                                                            
         B     H5R45                                                            
H5R47    MVC   INTSTA(3),NEHGAGNT  MOVE IN ALPHA AGGREGATE CODE                 
*                                                                               
H5R50    MVC   INTMRKT,TAPEMKT     MOVE IN MKT NUMBER FOR FAST WEEKLY           
         MVI   INTADUR,30                                                       
         MVI   INTDUR,2                                                         
         MVI   INTDURM,30                                                       
         XC    INTRSF,INTRSF                                                    
...
RLGSUM4A LAY   RE,CRCOTAB         RELEASE THE DEMOS                             
...
RLGISUM  ZIC   RF,SUMSLOT          NEXT SUMMARY CATEGORY                        
         LA    RF,1(RF)                                                         
         STC   RF,SUMSLOT                                                       
         MVI   RELSLOT,0           PT TO 1ST MKT BREAK IN TABLE                 
         B     RLGSUM                                                           
...
CNV40    LAY   R1,PACKWT           CLEAR TO P'0' FOR NEXT TIME                  
...
CNV70    LAY   R1,PACKWT            PACKED WEIGHTED DEMOS                       
         CLI   GAASW,C'G'                                                       
         BE    CNV80                                                            
         LH    RF,HALF                                                          
         AH    RF,CURRDUR                                                       
...
*                                                                               
         ...
         DROP  RE                                                               
         MVC   PMSTAT,=C'ABC H'                                                 
         L     R6,AOREC            READ WITH 'KEY' INTO WREC                    
         LA    R6,4(R6)                                                         
         XC    0(L'KEY,R6),0(R6)                                                
         GOTO1 VDATAMGR,DMCB,(0,=C'DMREAD '),=C'NTIDIR',KEY,(R6)                
         CLI   8(R1),X'10'         WAS MONTHLY RECORD FOUND?                    
         BE    YES                 NO, MONTHLY BOOK NOT LOADED. GREAT!          
...
*                                                                               
         LAY   R2,WRN1TXT                                                       
SNDEM10  DS    0H                  ADD TO E-MAIL BODY                           
...
IN1      DCB   DDNAME=IN1,                                             X        
               ...
               MACRF=GM,                                               X        
               EODAD=DONE                                                       
*EFFECTIVE WITH THE JAN 1, 2007 NTIH WEEKLY DATA, THE RECORDS ON THE            
...
SENDTO   DC    C'US-DEMOLOADTEAM@MEDIAOCEAN.COM,US-DEMOSTEAM@MEDIAOCEAN+        
               .COM '                                                           
SUBJECT  DC    C'*** WARNING *** WEEKLY NTIH DATA WILL BE LOADED AFTER +        
               MONTHLY NTIH. '                                                  
SUBJJBNM DS    CL8                                                              
         DC    C'('                                                             
SUBJJBID DS    CL8                                                              
...
*                                                                               
WRN1TXT  DS    0D                                                               
         DC    CL80'**** WEEKLY NTIH DATA IS BEING LOADED AFTER MONTHLY+        
                NTIH DATA ****'                                                 
         DC    CL80' '                                                          
WRN1WK1  DC    C'NTIH WEEKLY DATA WILL BE LOADED FOR '                          
WRN1WK   DC    CL8'MM/DD/YY'                                                    
         DC    CL(80-(*-WRN1WK1))'.'                                            
WRN1MTH1 DC    C'NTIH MONTHLY DATA WAS ALREADY LOADED FOR '                     
WRN1MTH  DC    CL6'MMM/YY'                                                      
         DC    CL(80-(*-WRN1MTH1))'.'                                           
         DC    CL80' '                                                          
         DC    CL80'THE MONTHLY NTIH DATA SHOULD BE THE BETTER DATA, AN+        
...
PROCSD   NTR1  BASE=*,LABEL=*                                                   
         LAY   R1,SLOTSD           POINTS TO THE CALCULATION TABLE              
...
***  ++INCLUDE DDMONYREQU                                                       
       ...
       ++INCLUDE DDMONYREQU                                                     
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'019DEHW07I   09/30/15'                                      
         END                                                                    
