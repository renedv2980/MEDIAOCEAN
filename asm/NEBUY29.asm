*          DATA SET NEBUY29    AT LEVEL 058 AS OF 08/01/19                      
*PHASE T31129B,+0                                                               
         TITLE 'NETPAK BUY PROGRAM - IMP MULT DIS/CHA OVERLAY - T31129'         
T31129   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*IMULT**,RA,RR=R2                                              
         LA    RC,2048(RA)         RC IS THIRD BASE REGISTER                    
         LA    RC,2048(RC)                                                      
         USING T31129+8192,RC                                                   
         L     R9,0(R1)                                                         
         USING BUYWRKD,R9                                                       
         L     R8,ATWA                                                          
         USING TWAD,R8                                                          
...
MULT1    GOTO1 =A(ACTED),RR=MYRELO                                              
         ...
         BZ    MULT1A              NO                                           
         GOTO1 =A(OVFLRTN),DMCB,(3,DUB),(RC),(R9),RR=MYRELO  SCRGEN             
******   BAS   RE,SCRGEN           YES-GENERATE A SCREEN FIRST                  
MULT1A   BAS   RE,FINDSCR          SET POINTERS TO SCREEN FIELDS                
         SPACE                                                                  
...
DIS4A    CLI   NBMODE,NBPROCUN                                                  
         ...
         GOTO1 VEXIT                                                            
         SPACE                                                                  
DIS5     GOTO1 VCHKAIR,DMCB,NBAIO  CHECK FOR AIR STAION INPUT                   
         OC    SVLDATE,SVLDATE     TEST IF RESUMING DISPLAY                     
         BZ    DIS6                NO                                           
...
*        BRAS  RE,RESGUAR                                                       
         ...
         LR    R8,R2               SAVE LIST OF DEMOS                           
         SPACE                                                                  
LOOK2    ST    RE,SAVEREG                                                       
         MVC   ENCDEMO,0(R8)                                                    
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)   DECODE THE DEMO                       
         L     RE,SAVEREG                                                       
         LH    R0,0(RE)            GET VPH                                      
         CLI   DECDEMO+1,C'V'                                                   
         BE    LOOK3                                                            
...
FLD13    GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(ELCODE,NBAIO),(LFIL,DUB)             
         ...
         MVI   DUB+2,C'T'                                                       
         BAS   RE,ENCDUB                                                        
         GOTO1 VHELLO,DMCB,(C'G',UNTFILE),(ELCODE,NBAIO),(LFIL,DUB)             
         CLI   12(R1),0                                                         
         BNE   *+16                                                             
FLD13A   L     RF,12(R1)           ADDRESS OF ELEMENT                           
         MVI   0(R4),STAR                                                       
         LA    R4,1(R4)                                                         
FLD13B   MVC   ENCDEMO,0(R2)                                                    
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)   DECODE THE DEMO                       
         CLI   DECDEMO+1,C'R'      TEST FOR RATING                              
         BE    FLD14                                                            
* NEW CODE TO HANDLE IMPRESSION PRECISSION                                      
         CLI   DECDEMO+1,C'T'       TEST FOR IMP                                
         BE    *+12                                                             
         CLI   DECDEMO+1,C'H'       TEST FOR IMP                                
         BNE   FLD13E                                                           
         TM    DEMPREC+1,X'82'      CHECK 2 DECIMAL PRECISSION                  
         BO    FLD14B                                                           
         B     FLD13E                                                           
...
*****    BE    FLD14B                                                           
FLD13E   EDIT  (R0),(5,(R4)),ALIGN=LEFT,ZERO=NOBLANK                            
         B     FLD15                                                            
         SPACE                                                                  
...
FLDX     L     R2,AFLD                                                          
         ...
         DROP  R3                                                               
         SPACE 5                                                                
* CHECK PERSONAL LANGUAGE SETTINGS AND ENCODE IN DUB                            
ENCDUB   NTR1                                                                   
         MVC   DECDEMO(3),DUB+1                                                 
         GOTO1 VENCDEC,DMCB,(1,DECDEMO)                                         
         MVC   DUB+1(3),ENCDEMO    ENCODED DEMO                                 
         B     EXXMOD                                                           
         SPACE 5                                                                
         EJECT                                                                  
*                                                                               
* DISPLAY BILLING ACTIVITY                                                      
*                                                                               
DBILLED  NTR1                                                                   
...
*                                                                               
         L     R5,12(R1)                                                        
         AR    R5,R4                POINT TO THE RIGHT FIELD                    
*                                                                               
         CH    R4,=H'6'                                                         
         BNE   DEIC40                                                           
         TM    4(R5),X'80'                                                      
         BZ    DEIC40                                                           
*  DISPLAY EARNED COST OVERRIDE                                                 
         L     R4,0(R5)                                                         
         EDIT  (R4),(11,FLD),2,ALIGN=LEFT,MINUS=YES,FLOAT=*                     
         B     DEIC50                                                           
*                                                                               
DEIC40   OC    0(4,R5),0(R5)                                                    
         BZ    DEICEX                                                           
         L     R4,0(R5)                                                         
         EDIT  (R4),(11,FLD),2,ALIGN=LEFT,MINUS=YES                             
DEIC50   LR    RF,R0                                                            
         LTR   R4,R4                                                            
         BM    *+6                                                              
         BCTR  RF,0                                                             
...
DEICEX   B     EXXMOD                                                           
         EJECT                                                                  
* OVERRIDE DISPLAY ROUTINES                                                     
* ADJUSTED INTEGRATION (COS2)                                                   
*                                                                               
DISIC2   NTR1                                                                   
         TM    NBUNITST,X'42'       CHECK IF MISSED OR PREEMPTED                
         BNZ   DIC2EX                                                           
         MVI   FLDH+7,0                                                         
         MVI   BYTE,X'74'                                                       
         BAS   RE,GETEL                                                         
         ...
         TM    NUC2STAT,NUC2INT                                                 
         BZ    DIC2EX                                                           
         EDIT  NUC2AINT,(10,FLD),2,ALIGN=LEFT,MINUS=YES                         
         LR    RF,R0                                                            
         LTR   R4,R4                                                            
         BM    *+6                                                              
         BCTR  RF,0                                                             
...
DISCOS2  NTR1                                                                   
         ...
         USING NUCOS2D,R4                                                       
         L     R4,12(R1)                                                        
         EDIT  NUC2FACT,(8,FLD),6,ALIGN=LEFT,FILL=0,DROP=5                      
         LR    RF,R0                                                            
         BCTR  RF,0                                                             
         STCM  RF,1,FLDH+7                                                      
DCOS2EX  B     EXXMOD                                                           
         DROP  R4                                                               
         EJECT                                                                  
*          DATA SET NEBUY15    AT LEVEL 052 AS OF 07/11/07                      
* OVERRIDE DISPLAY ROUTINES                                                     
* V TYPE                                                                        
*                                                                               
DVTYPE   NTR1                                                                   
...
DDATE    ST    RE,SAVEREG                                                       
         ...
         EJECT                                                                  
*                                                                               
*--DISPLAY AFFIRMATIVE DATE                                                     
*                                                                               
DAFDATE  ST    RE,SAVEREG                                                       
         GOTO1 =A(OVFLRTN),DMCB,(1,DUB),(RC),(R9),RR=MYRELO                     
         L     RE,SAVEREG                                                       
         BR    RE                                                               
         EJECT                                                                  
*                                                                               
DTRADE   ST    RE,SAVEREG          DISPLAY TRADE PERCENT                        
         GOTO1 =A(OVFLRTN),DMCB,(5,DUB),(RC),(R9),RR=MYRELO                     
         L     RE,SAVEREG                                                       
         BR    RE                                                               
*                                                                               
DDCS     ST    RE,SAVEREG          DISPLAY DEAL/CONTRACT/SERIAL                 
...
*--DISPLAY PRODUCT                                                              
DPROD    NTR1                                                                   
*--CHECK TO SEE IF WORKING OFF ALPHA ELEMENT                                    
         MVI   BYTE,X'19'                                                       
         BAS   RE,GETEL                                                         
         BE    DPRODA                                                           
...
DPRDEX   B     EXXMOD                                                           
         SPACE 3                                                                
*--DISPLAY PRODUCT FREOM ALPHA ELEMENT                                          
*                                                                               
DPRODA   MVI   BYTE,X'19'                                                       
         BAS   RE,GETEL                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
*--MORE THEN 2 PRODUCT DISPLAY                                                  
...
*                                                                               
         MVC   HUTBLK(100),SPACES                                               
         LA    R2,NUPDEPR          FIRST PRODUCT                                
         LA    R3,HUTBLK           OUTPUT                                       
         LR    R4,RF               PRODUCT COUNT                                
         DROP  R4                                                               
*                                                                               
DPRDA100 MVC   FLD(3),0(R2)                                                     
         MVI   FLDH+7,3             SET DEFAULT LENGTH TO 3                     
         CLI   2(R2),X'40'                                                      
         BH    *+8                                                              
         MVI   FLDH+7,2             2 BYTE PRODUCT CODE                         
         ZIC   R1,FLDH+7           LENGTH OF OUTPUT                             
         EX    R1,FLDMOVE                                                       
         AR    R3,R1                                                            
         MVI   0(R3),C'*'                                                       
         LA    R3,1(R3)                                                         
         LA    R2,7(R2)            GET NEXT PRODUCT                             
*                                                                               
         BCT   R4,DPRDA100                                                      
         SH    R3,=H'1'            GET TO PREVIOUS FIELD                        
         MVI   0(R3),X'40'         NO DASH FOR LAST PRODUCT                     
...
DPRDA160 CLI   0(RE),X'40'                                                      
         ...
         DC    H'0'                                                             
*                                                                               
DPRDA180 STC   R1,FLDH+7           STORE OUTPUT LENGTH                          
         B     DPRDAEX                                                          
*                                                                               
*--REGULAR UNIT                                                                 
DPRDA200 MVI   BYTE,UPRD                                                        
         GOTO1 VDISPLAY,DMCB,(BYTE,(R9))                                        
*                                                                               
DPRDAEX  B     EXXMOD                                                           
         EJECT                                                                  
...
*                                                                               
         L     R4,12(R1)           PRODUCT ELEMENT                              
         USING NUPDED,R4                                                        
         TM    NUPDEIND,X'C0'       CHK FOR COPYSPLIT OR TRIGGY                 
         BZ    DFDSH600                                                         
*-GET NUMBER OF PRODUCTS                                                        
         SR    RE,RE                                                            
         ZIC   RF,NUPDELEN                                                      
...
*                                                                               
         ...
         DROP  R4                                                               
*                                                                               
DFDSH100 MVC   0(3,R3),0(R2)                                                    
         LA    R3,2(R3)                                                         
         CLI   2(R2),X'40'                                                      
         BNH   *+8                                                              
         LA    R3,1(R3)                                                         
         MVC   NBP1SHR,3(R2)       1ST PRODUCT PCT                              
         MVC   NBFEED,5(R2)        FEED PCT                                     
         MVI   0(R3),C'='                                                       
         LA    R3,1(R3)                                                         
*                                                                               
...
DFDSH200 CLI   0(RE),X'40'                                                      
         ...
         BCT   RF,DFDSH200                                                      
         DC    H'0'                CHECK OUTPUT                                 
DFDSH220 STC   R1,FLDH+7                                                        
         B     DFDSHEX                                                          
*                                                                               
*--CHECK TO SEE IF MORE THEN 2 PRODUCTS                                         
DFDSH400 MVI   BYTE,X'14'                                                       
         BAS   RE,GETEL                                                         
         BNE   DFDSH600                                                         
*                                                                               
         L     R4,12(R1)           PRODUCT ELEMENT                              
...
*--GET OUTPUT LENGTH                                                            
         ...
         LA    RF,60                                                            
         SR    R1,R1                                                            
DFDSH500 CLI   0(RE),X'40'                                                      
         BE    DFDSH520                                                         
         LA    R1,1(R1)                                                         
         LA    RE,1(RE)                                                         
         BCT   RF,DFDSH500                                                      
         DC    H'0'                CHECK OUTPUT                                 
DFDSH520 STC   R1,FLDH+7                                                        
         B     DFDSHEX                                                          
*                                                                               
*--REGULAR UNIT                                                                 
DFDSH600 GOTO1 VDISPLAY,DMCB,(HALF,(R9))                                        
*                                                                               
DFDSHEX  B     EXXMOD                                                           
         EJECT                                                                  
* OVERRIDE DISPLAY ROUTINES                                                     
...
DFEEDC   NTR1                                                                   
         ...
         BZ    DFEDC800                                                         
*--CHECK TO SEE IF ALPHA PRODUCTS                                               
         MVI   BYTE,X'19'                                                       
         BAS   RE,GETEL                                                         
         BE    DFEDC400                                                         
*--CHECK TO SEE IF MORE THEN 2 PRODUCTS                                         
...
DFEDC320 STC   R1,FLDH+7                                                        
         B     DFEDCEX                                                          
*  ALPHA PRODUCT LOGIC 19 ELEMENT                                               
*                                                                               
DFEDC400 L     R4,12(R1)           PRODUCT ELEMENT                              
         USING NUPDED,R4                                                        
*-GET NUMBER OF PRODUCTS                                                        
         SR    RE,RE                                                            
         ZIC   RF,NUPDELEN                                                      
...
*                                                                               
         ...
         LA    R3,HUTBLK           OUTPUT                                       
         LR    R4,RF               PRODUCT COUNT                                
         MVI   FULL+3,1            FIRST PRODUCT                                
         DROP  R4                                                               
*                                                                               
DFEDC450 MVC   0(3,R3),0(R2)                                                    
         LA    R3,2(R3)                                                         
         CLI   2(R2),X'40'                                                      
         BNH   *+8                                                              
         LA    R3,1(R3)                                                         
...
*                                                                               
         ZIC   R1,FULL+3                                                        
         LA    R1,1(R1)                                                         
         STCM  R1,1,FULL+3         BUMP TO NEXT PRODUCT                         
         BCT   R4,DFEDC450                                                      
         SH    R3,=H'1'            GET TO PREVIOUS FIELD                        
         MVI   0(R3),X'40'         NO DASH FOR LAST PRODUCT                     
         MVI   NBPRD,0                                                          
...
*--GET OUTPUT LENGTH                                                            
         ...
         LA    RF,54                                                            
         SR    R1,R1                                                            
DFEDC500 CLI   0(RE),X'40'                                                      
         BE    DFEDC520                                                         
         LA    R1,1(R1)                                                         
         LA    RE,1(RE)                                                         
         BCT   RF,DFEDC500                                                      
         DC    H'0'                CHECK OUTPUT                                 
DFEDC520 STC   R1,FLDH+7                                                        
         B     DFEDCEX                                                          
*                                                                               
*                                                                               
*--REGULAR UNIT                                                                 
DFEDC800 MVI   BYTE,UFEEDCD                                                     
         GOTO1 VDISPLAY,DMCB,(BYTE,(R9))                                        
*                                                                               
DFEDCEX  B     EXXMOD                                                           
...
*        CLC   NEWEHIMP,NBESTHOM+4                                              
*        BE    CHA8A                                                            
*        GOTO1 HOMOVER,DMCB,(ESTDEMOS,ESTLIST),ESTVAL,ESTGLOB                   
*        B     CHA9                                                             
CHA8A    GOTO1 =A(OVERDEM),DMCB,(ESTDEMOS,ESTLIST),ESTVAL,ESTGLOB,     X        
               ESTUNIV,RR=MYRELO                                                
         SPACE                                                                  
...
*                                                                               
         ...
         PRINT GEN                                                              
         GOTO1 =A(OVERDEM),(R1),(ACTDEMOS,ACTLIST),ACTVALS,ACTGLOB,    X        
               ACTUNIV,RR=MYRELO                                                
         PRINT NOGEN                                                            
         SPACE 1                                                                
CHA10    L     R3,NBAIO                                                         
         ...
         GOTO1 VDISPROG                                                         
*                                                                               
         OC    NBMGFPCD(NBMGFLEN),NBMGFPCD   TEST IF A MAKE-GOOD                
         BZ    CHA11               NO                                           
...
*                                                                               
*--SAVE NEW KEY ON DELETED RECORD TO KEEP A LINK                                
*                                                                               
         XC    WORK,WORK                                                        
         MVI   WORK,X'90'                                                       
         MVI   WORK+1,22                                                        
...
*                                                                               
         CLI   NBACTSUB,2          TEST FOR SUB-LINE 2                          
         BNE   CHA30                                                            
         MVC   NEWDATE,NUKDATE                                                  
         LA    RE,OLDKEY                                                        
         ...
         SPACE                                                                  
CHA30    DS    0H                                                               
         L     R2,AUNPRFLD         BUMP TO NEXT FIELD                           
         ZIC   R0,0(R2)                                                         
         AR    R2,R0                                                            
         B     CHA2                                                             
         SPACE                                                                  
...
*        BRAS  RE,RESGUAR                                                       
         ...
         B     GETUNIT2                                                         
         SPACE 2                                                                
OKEXIT   GOTO1 VCHKAIR,DMCB,NBAIO  CHECK FOR AIR STAION INPUT                   
         CR    RB,RB                                                            
         B     *+6                                                              
ERREXIT  LTR   RB,RB                                                            
         L     RE,SAVEREG                                                       
...
*                                                                               
EMAXC    NTR1                                                                   
         LA    R5,2                 DISPALCEMENT IN ELEMENT TO MAX COST         
         B     EMAX10                                                           
EEICC    NTR1                                                                   
         LA    R5,6                 DISPALCEMENT IN ELEMENT TO EIC COST         
*                                                                               
EMAX10   CLI   FLDH+5,0             ANY INPUT                                   
         BE    EMAXEX               NO EXIT                                     
*                                                                               
         XC    DUB+4(4),DUB+4                                                   
         XC    OVEREL,OVEREL                                                    
         MVI   OVEREL,X'15'                                                     
         MVI   OVEREL+1,NUMCSLNQ                                                
*                                                                               
         MVI   BYTE,X'15'                                                       
         BAS   RE,GETEL                                                         
         BNE   EMAX20                                                           
...
*                                                                               
EMAX20   CLI   FLD,C'X'             CHECK TO REMOVE OVERRIDE                    
         BNE   EMAX25                                                           
         XC    DUB,DUB              CLEAR COST                                  
         CH    R5,=H'6'             CHECK EARNED COST CLEARENCE                 
         BNE   EMAX60                                                           
         NI    OVEREL+10,X'7F'      UNSET THE OVERRIDE STATUS                   
         B     EMAX60                                                           
*                                                                               
EMAX25   BAS   RE,EVALCOST                                                      
...
*                                                                               
         ...
         BNZ   EMAX60                                                           
EMAX30   OI    OVEREL+10,X'80'      SET EARNED COST OVERRIDE BIT                
*                                                                               
EMAX60   LA    RE,OVEREL                                                        
         AR    RE,R5                DISPLACEMENT TO FIELD                       
         MVC   0(4,RE),DUB         UPDATE MAX COST                              
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'15',AIOAREA1),0                    
         BAS   RE,PUTEL                                                         
EMAXEX   B     EXXMOD                                                           
         DROP  RE                                                               
         SPACE 2                                                                
...
*                                                                               
         CLI   FLD,C'*'             CHECK FOR OVERRIDE                          
         BNE   *+8                                                              
         MVI   FLD,C'0'             REMOVE OVERRIDE FOR VALIDATION              
*                                                                               
         MVI   FERN,INVERR                                                      
         ZIC   R1,FLDH+5                                                        
         ...
         MVI   0(RE),C' '                                                       
         SH    R1,=H'1'                                                         
         BZ    ERRED               ITS AN ERROR - ONLY DASH IN FIELD            
         SPACE 1                                                                
...
* THEM AND RECALCULATE THE VPH'S FOR HOMES OVERRIDE                             
*                                                                               
...
HOV100   OC    0(4,RE),0(RE)       TEST FOR NON-ZERO GLOBAL VALUE               
         BZ    *+10                                                             
...
*                                                                               
         ...
         MVI   USEREL,X'CD'                                                     
         SPACE                                                                  
HOV200   CLC   0(4,R4),0(R3)       TEST INPUT AGAINST RECORD VALUE              
         BE    HOV800                                                           
*                                                                               
         MVI   LFIL,5                                                           
         XC    DUB,DUB                                                          
...
*                                                                               
HOV240   MVI   FERN,PAKFERR                                                     
         L     RE,APACKREC                                                      
         USING NPRECD,RE                                                        
         TM    NPAKSTAT,X'80'      TEST FOR FROZEN PACKAGE                      
         BO    ERROR               CHANGES TO EST. DEMOS NOT ALLOWED            
         SPACE 1                                                                
HOV300   GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(LFIL,DUB)          
*                                                                               
HOV400   CLC   0(4,R4),=F'-1'      TEST FOR OVERRIDE VALUE                      
         BE    HOV800                                                           
*                                                                               
...
*                                                                               
         ...
         BNE   HOV440                                                           
         MVI   NUOVMOD,C'H'                                                     
HOV440   BAS   RE,SETPRE           SET DEMO PRECISION                           
...
HOV800   LA    R2,4(R2)                                                         
         ...
         BCT   R0,HOV200                                                        
         SPACE                                                                  
*--DELETE THE VPH ELEMENTS AND RECREATE THEM                                    
*--USING THE NEW HOMES IMPRESSION NUMBER.                                       
         MVI   BYTE,C'V'                                                        
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'CD',AIOAREA1),(1,BYTE)             
*                                                                               
         MVI   BYTE,X'DD'                                                       
         BAS   RE,GETEL                                                         
         BNE   HOV1200                                                          
...
HOV1050  ZIC   RE,1(R3)                                                         
         AR    R3,RE                                                            
HOV1070  CLI   0(R3),X'DD'                                                      
         BNE   HOV1200                                                          
HOV1100  CLI   4(R3),C'V'                                                       
         BNE   HOV1050                                                          
         MVC   DUB,2(R3)                                                        
         GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(X'DD',AIOAREA1),(8,DUB)              
         B     HOV1070                                                          
*                                                                               
HOV1200  LA    R2,FULL                                                          
         XC    FULL,FULL                                                        
...
HOV1300  ZIC   RE,1(R3)                                                         
         ...
         CLI   0(R3),X'DD'                                                      
         BNE   HOV1500                                                          
HOV1400  CLI   4(R3),C'T'                                                       
         BE    *+12                                                             
         CLI   4(R3),C'H'                                                       
         BNE   HOV1300                                                          
         CLI   5(R3),X'01'         CHECK FOR HOMES                              
         BE    HOV1300                                                          
         MVC   DUB2+1(3),3(3)      DEMO CAT/MOD                                 
         LA    R4,8(R3)                                                         
         BAS   RE,VPH                                                           
         B     HOV1300                                                          
*                                                                               
HOV1500  XC    FULL,FULL                                                        
         LA    R2,FULL                                                          
         MVI   FULL+1,USERMOD      USER DEMO SWITCH                             
         MVI   BYTE,X'CD'                                                       
         BAS   RE,GETEL                                                         
         BNE   HOVERX                                                           
         L     R3,12(R1)                                                        
...
HOV1600  ZIC   RE,1(R3)                                                         
         ...
         CLI   0(R3),X'CD'                                                      
         BNE   HOVERX                                                           
HOV1700  CLI   2(R3),C'T'                                                       
         BE    *+12                                                             
         CLI   2(R3),C'H'                                                       
         BNE   HOV1600                                                          
         MVC   DUB2,2(R3)          DEMO NAME                                    
         LA    R4,10(R3)                                                        
         BAS   RE,VPH                                                           
         B     HOV1600                                                          
*                                                                               
...
VPH      NTR1                                                                   
         ...
         CLC   NEWEHIMP,=F'-1'                                                  
         BE    VPHX                                                             
         OC    NEWEHIMP,NEWEHIMP                                                
         BZ    VPHX                                                             
         L     R1,NEWEHIMP         HOME IMPRESSION                              
*                                                                               
...
KEYED4   TM    KEYCTL,DISONLY      TEST FOR DISPLAY ONLY DATA                   
         JO    KEYED6              YES-SKIP TO NEXT KEYWORD                     
         TM    NBUNST3,X'40'                                                    
         JZ    KEYED4A                                                          
...
KEYEDR   J     ERRED                                                            
         ...
         EJECT                                                                  
         DROP  RA,RB,RC                                                         
OVFLRTN  NMOD1 0,**29OV**,RA                                                    
         LA    RC,2048(RC)                                                      
         LA    RC,2048(RC)                                                      
         USING OVFLRTN+8192,RC                                                  
         L     R9,8(R1)                                                         
         USING BUYWRKD,R9                                                       
*                                                                               
         ZIC   RF,0(R1)                                                         
...
OVBRANCH B     EDDEM                                                            
         ...
         EJECT                                                                  
*                                                                               
DAFDTE   DS    0H                  DISPLAY AFFIRMATIVE DATE                     
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'02',AIOAREA1),0                   
         CLI   12(R1),0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
         L     R4,12(R1)                                                        
         USING NUSDRD,R4                                                        
*                                                                               
         GOTO1 VDATCON,DMCB,(2,NUSDAFDT),(5,FLD)                                
         MVI   FLDH+7,8                                                         
         DROP  R4                                                               
*                                                                               
DAFDTEX  B     OVEXIT                                                           
OVUNTFLE DC    CL8'UNTFILE'                                                     
         EJECT                                                                  
...
EDDEM    XC    INPVALS,INPVALS                                                  
         MVC   NEWEHIMP,NBESTHOM+4    SAVE EST. HOME IMP.                       
         L     R2,12(R1)           R2 POINTS TO DEMOS                           
         ZIC   R3,12(R1)           R3 IS A COUNTER                              
         LA    R4,INPVALS                                                       
         SR    R0,R0                                                            
         SPACE                                                                  
ED100    MVC   ENCDEMO,0(R2)                                                    
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)   DECODE THE DEMO                       
         XC    FTERM,FTERM                                                      
         MVC   FTERM(3),=C'*.,'                                                 
         GOTO1 AFVAL,0                                                          
...
*--IMPRESSION SETUP                                                             
         ...
         BH    EDDEMR                                                           
         CLI   FLDH+5,7             OR 4 BEFORE POINT IF CABLE IMP              
         BH    EDDEMR                                                           
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   ED360                                                            
         CLI   FSTOP,C'.'                                                       
         BE    ED390                                                            
ED350    MH    R0,=H'10'           SCALE TO TENTHS                              
         B     ED390                                                            
ED360    CLI   FSTOP,C'.'                                                       
         BE    EDDEMR                                                           
         B     ED390                                                            
...
*--IMPRESSION EDIT                                                              
         CLI   DECDEMO+1,C'T'                                                   
         BNE   ED450                                                            
* IF NO VALUE AFTER DECIMAL POINT SCALE THE NUMBER                              
         CLI   FLDH+5,0                                                         
         BNE   ED420                                                            
         MH    R0,=H'10'                                                        
         ST    R0,0(R4)                                                         
...
ED750    ST    R0,0(R4)                                                         
*                                                                               
ED800    CLC   0(3,R2),=XL3'00E301'    CHECK HOMES IMPRESSION                   
         BE    *+14                                                             
         CLC   0(3,R2),=XL3'00C801'    CHECK HOMES IMPRESSION                   
         BNE   *+10                                                             
         MVC   NEWEHIMP,0(R4)                                                   
*                                                                               
         LA    R2,4(R2)                                                         
...
*                                                                               
EDFEDSHR DS    0H                                                               
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'19',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
         BE    EAFEDSHR                                                         
*                                                                               
         USING KEYTABD,R3                                                       
...
*                                                                               
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'14',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
         BNE   EFDSH080                                                         
*                                                                               
         XC    HALF2,HALF2                                                      
...
*                                                                               
*-FILL IN THE TABLE                                                             
BLDCP80  GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'14',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
         BE    *+6                 MORE THEN 2 PRODUCTS                         
         DC    H'0'                ELEMENT MUST BE THERE                        
...
BLDPCEX  B     OVEXIT                                                           
         DROP  R2                                                               
         EJECT                                                                  
* SUB-ROUTINE TO EDIT FEED AND SHARE PERCENTS FOR ALPHA PRODUCTS                
*                                                                               
EAFEDSHR DS    0H                                                               
         USING KEYTABD,R3                                                       
         MVC   KDATASV,KEYDATA     SAVE DATA TYPE                               
...
*--SET UP EDIT BLOCK                                                            
         ...
         MVC   UNFLDH,FADDR                                                     
*                                                                               
         SR    R2,R2               POINTER TO 19 ELEMENT                        
         LA    R3,1                SET UP FOR SINGLE PRODUCT                    
         TM    NBUNST3,X'40'       IS BUY A COPY SPLIT                          
         BZ    EADSH080            NO PROCESS NORMALLY                          
*--SAVE CURRENT PRODUCTS IN TRPRSAVE MOVE PRODUCTS TO TRPRDHLD                  
*                                                                               
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'19',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
...
*                                                                               
         LR    R3,RF               PRODUCT COUNT                                
         LA    RE,TAPRDHLD         PRODUCT STORE AREA                           
         LA    R1,NUPDEPR          FIRST PRODUCT                                
EADSH010 MVC   0(3,RE),0(R1)                                                    
         LA    RE,3(RE)                                                         
         LA    R1,7(R1)            NEXT PRODUCT                                 
         BCT   RF,EADSH010                                                      
*                                                                               
EADSH018 GOTO1 VSCANNER,DMCB,(10,FLDH),(6,BLOCK),C',=-='                        
         L     R5,DMCB+4                                                        
         CLI   4(R1),0                                                          
         BE    EADSHEX                                                          
         CLI   22(R5),C'C'         DO THEY WANT A RECALC                        
         BNE   EADSH020                                                         
         BAS   RE,BLDAPCT          RE-CALC ALL TH EPCTS.                        
         B     EADSHEX                                                          
*                                                                               
*-- VALIDATE PRODUCT                                                            
*                                                                               
...
*--FOR A SCANNER BUG THAT PUTS OUT NULL LINES. SORRY.                           
*                                                                               
EADSH020 OC    0(2,R5),0(R5)                                                    
         BNZ   EADSH022                                                         
         LA    R5,32(R5)                                                        
         B     EADSH020                                                         
EADSH022 MVC   FLD,SPACES                                                       
         MVC   FLD(10),12(R5)      PRODUCT                                      
         MVC   FLDH+5(1),0(R5)     SET DATA LENGTH                              
         OI    FLDH+4,X'04'        AND ALPHA BITS                               
*                                                                               
         ...
         B     OVERRED                                                          
*                                                                               
EADSH040 MVI   FERN,PRDERR                                                      
         CLC   DUB2(3),TAPRDHLD    DO PRODUCTS MATCH                            
         BNE   OVERRED                                                          
         MVC   TAPRDHLD(15),TAPRDHLD+3    BUMP TO NEXT PRODUCT                  
*-- CREATE TRAFFIC FEED CODE ELEMENTS                                           
EADSH050 MVC   FLD,SPACES                                                       
         MVC   FLD(20),22(R5)      FEED OR PROD PCT                             
         MVC   FLDH+5(1),1(R5)     SET DATA LENGTH                              
         OI    FLDH+4,X'08'        AND NUMERIC BITS                             
*                                                                               
EADSH080 LA    R4,HUTBLK                                                        
         USING UNBLOCKD,R4                                                      
         MVC   UNEDATA,KDATASV                                                  
         GOTO1 VEDIT,DMCB,(C'X',(R4))                                           
         CLI   UNERROR,0                                                        
         ...
         B     OVERRED                                                          
*                                                                               
EADSH100 LTR   R2,R2               IS THERE A 19 ELEMENT TO UPDATE              
         BZ    EADSHEX             NO PROCESS NORMALLY                          
         L     RE,NBAIO                                                         
         USING NURECD,RE                                                        
*  UPDATE 19 ELEMENT                                                            
         CLI   KDATASV,UP1SHR      ARE WE DOING PROD SHARE                      
...
*--MOVE FIRST PRODUCT PERCENT OUT                                               
         ...
         B     EADSH130                                                         
*--MOVE FEED PERCENT OUT                                                        
EADSH120 MVC   5(2,R2),NUFEED                                                   
         XC    NUFEED,NUFEED                                                    
EADSH130 LA    R5,32(R5)                                                        
         LA    R2,7(R2)            GET TO NEXT PRODUCT                          
         BCT   R3,EADSH020                                                      
         DROP  RE                                                               
*                                                                               
EADSHEX  LTR   R2,R2                                                            
         ...
         MVC   BLOCK,HUTBLK                                                     
         MVC   NBPRD,TRPRSAVE                                                   
         BAS   RE,CHKAPCT          MAKE SUR PCTS. ADD UP TO 100                 
         B     OVEXIT                                                           
         DROP  R3,R4,R5                                                         
         SPACE 3                                                                
* SYNC THE VALS IN THE 19 ELEMENT WITH THE 14 ELEMENT OR THE 01 ELEMENT         
*                                                                               
SYNCELEM NTR1                                                                   
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'19',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
...
* SET UP SHARE                                                                  
         ...
         B     SYNCEL30                                                         
* SET UP FEED PERCENT                                                           
SYNCEL10 LA    R2,NUPDEFD                                                       
         LA    R3,NUPRDFD                                                       
SYNCEL30 MVC   0(2,R3),0(R2)                                                    
         LA    R2,7(R2)                                                         
         LA    R3,6(R3)                                                         
         BCT   RF,SYNCEL30                                                      
*                                                                               
...
*                                                                               
         ...
         CLI   KDATASV,UP1SHR      ARE WE DOING PROD SHARE                      
         BE    *+8                                                              
         LA    R4,NUPDEFD          NO SET UP FOR FEED PCT                       
*                                                                               
         ZIC   R3,NUMPRD           NUMBER OF PRODUCTS                           
         SR    R1,R1                                                            
         SR    RE,RE                                                            
CHAPC140 ICM   RE,3,0(R4)                                                       
         AR    R1,RE               TOTAL UP THE PERCENTS                        
         LA    R4,7(R4)            NEXT PRODUCT ENTRY                           
         BCT   R3,CHAPC140                                                      
*                                                                               
*- PCT MUST ADD UP TO 100                                                       
         C     R1,=F'10000'                                                     
...
*                                                                               
*-FILL IN THE TABLE                                                             
BDACP80  GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'19',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
         BE    *+6                 MORE THEN 2 PRODUCTS                         
         DC    H'0'                ELEMENT MUST BE THERE                        
         L     R2,12(R1)           PRODUCT ELEMENT                              
...
*                                                                               
         ...
         CLI   KDATASV,UP1SHR      ARE WE DOING PROD SHARE                      
         BE    *+8                                                              
         LA    R1,NUPDEFD          NO SET UP FOR FEED PCT                       
*                                                                               
         ZIC   R3,NUMPRD           NUMBER OF PRODUCTS                           
BDAPC140 SR    RE,RE                                                            
         AR    RE,R4               ADD REMAINDER TO FIRST ENTRY                 
...
*                                                                               
OVSCRGN  LA    RE,SVAREA           BUILD A PROTECTED LINE FIRST                 
         ST    RE,BLDTWAX                                                       
         MVI   BLDLIST+1,78                                                     
         MVI   BLDLIST+2,X'20'                                                  
         GOTO1 VBLDFLD                                                          
...
SCRGEN4  ICM   RF,1,ESTDEMOS       GET NUMBER OF ESTIMATED DEMOS                
         ...
         GOTO1 LENDEM,DMCB,(ESTDEMOS,ESTLIST),ESTIMOD                           
...
*                                                                               
LENDEM2  MVC   ENCDEMO,0(R3)                                                    
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)   DECODE THE DEMO                       
         LR    RE,R4               POINT TO START OF MODIFIER TABLE             
         SR    R0,R0               CLEAR WORK REGISTER                          
*                                                                               
LENDEM3  CLC   DECDEMO+1(1),0(RE)  TEST MODIFIER VS. TABLE                      
         BE    LENDEM4                                                          
...
LENDEM4  IC    R0,1(RE)            GET LENGTH OF DATA                           
         ...
         A     R0,DEMOLEN          UPDATE TOTAL LENGTH                          
         ST    R0,DEMOLEN                                                       
...
*                                                                               
DISPID   DS    0H                                                               
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'99',NBAIO),0                      
         CLI   12(R1),0                                                         
         BNE   OVEXIT                                                           
         L     RF,12(R1)                                                        
         USING NUACTD,RF                                                        
...
*                                                                               
         ...
         MVC   SA0KAGY,AGYALPH     SECURITY ALPHA ID                            
         MVC   SA0KNUM,HALF                                                     
         GOTO1 VDATAMGR,DMCB,=C'DMRDHI',=C'CTFILE ',WORK,AIOAREA4               
         L     R4,AIOAREA4                                                      
         CLC   WORK(L'SA0KEY),0(R4)                                             
         BNE   OVEXIT                                                           
...
*                                                                               
DISPID10 XC    FLD,FLD                                                          
         MVC   FLD(L'SAPALPID),SAPALPID                                         
         MVI   FLDH+7,L'SAPALPID                                                
         B     OVEXIT                                                           
         DROP  R4                                                               
*                                                                               
* CHECK AGAINST NEW BILLING RECORDS                                             
*                                                                               
DISBILL  DS    0H                                                               
         ST    RE,FULL2            SAVE RETURN POINT                            
*                                                                               
         L     R4,AIOAREA4                                                      
         L     R2,NBAIO                                                         
         SR    R3,R3                                                            
...
*                                                                               
         XC    DMWORK(96),DMWORK                                                
         LA    RF,DMWORK                                                        
         STCM  RF,15,NBABILRD       ADDRESS OF BILL DSECT IN NETBLOCK           
         USING NBLBILLD,RF                                                      
         MVC   NBLUNAIO,AIOAREA4                                                
******   OI    NBLFUNC,NBLSEED                                                  
         OI    NBINDS2,NBBILLRD+NBLCMPR                                         
         MVI   NBWHERE,C'I'                                                     
*                                                                               
         GOTO1 VBILLRDR,DMCB,NETBLOCK                                           
*                                                                               
         XC    NBABILRD,NBABILRD                                                
         NI    NBINDS2,X'FF'-NBBILLRD                                           
         NI    NBINDS2,X'FF'-NBLCMPR                                            
         NI    NBLFUNC,X'FF'-NBLSEED                                            
         MVI   NBWHERE,0                                                        
*                                                                               
         BAS   RE,PROCNBIL         PROCESS THE X'10' ELEMENTS                   
*                                                                               
         XC    FLD,FLD                                                          
         MVI   FLDH+7,49                                                        
         MVI   FLD,TIMEEQU         TIME DATA FIRST                              
         MVI   FLD+1,EQUAL                                                      
         LA    R4,FLD+2            INITIALIZE R4 AS OUTPUT POINTER              
*!!!!    L     R2,NBBILTGR         SET UP FOR BILLING VALUES                    
         L     R2,BTGROSS          SET UP FOR BILLING VALUES                    
         MVI   FULL,X'10'          BILLING ELEMENT CODE                         
         MVC   DUB2,=C'BILLABLE'                                                
         SPACE 1                                                                
DBILL2   BAS   R5,EDTACC           EDIT OUT TIME AMOUNT                         
         AR    R4,R0               UPDATE OUTPUT POINTER                        
         MVI   0(R4),LPAREN                                                     
         MVC   1(8,R4),DUB2        INITIALIZE TO NO BILL                        
         MVI   FULL+1,TIMEEQU      TIME DATA                                    
*!!!     BAS   RE,GETLAT           GET DATE OF LATEST EVENT                     
*!!!     BZ    *+8                 NONE                                         
         MVC   FULL+2(2),BTRDATE                                                
         OC    FULL+2(2),FULL+2                                                 
         BZ    *+8                                                              
         BAS   RE,DATOUT           EDIT THE DATE OUT                            
         MVI   9(R4),RPAREN                                                     
         MVI   10(R4),SLASH        SEPARATE TIME AND INT                        
         LA    R4,11(R4)           POINT TO CURRENT POSITION                    
         SPACE 1                                                                
DBILL4   MVI   0(R4),INTEQU        INTEGRATION DATA                             
         MVI   1(R4),EQUAL                                                      
         LA    R4,2(R4)                                                         
*!!!!    L     R2,NBBILIGR                                                      
         L     R2,BIGROSS                                                       
         ...
         BE    *+8                                                              
         L     R2,NBPAYIGR                                                      
         BAS   R5,EDTACC           EDIT OUT INTEGRATION DOLLARS                 
         AR    R4,R0                                                            
         MVI   0(R4),LPAREN                                                     
         MVC   1(8,R4),DUB2                                                     
         MVI   FULL+1,INTEQU                                                    
...
*--GET OUTPUT LENGTH                                                            
         ...
         LA    RF,49                                                            
         SR    R1,R1                                                            
DBILL15  CLI   0(RE),X'00'                                                      
         BE    DBILL20                                                          
         LA    R1,1(R1)                                                         
         LA    RE,1(RE)                                                         
         BCT   RF,DBILL15                                                       
         DC    H'0'                CHECK OUTPUT                                 
DBILL20  STC   R1,FLDH+7                                                        
         L     RE,FULL2                                                         
         B     OVEXIT                                                           
         SPACE 2                                                                
...
*                                                                               
DATOUT   NTR1                                                                   
         GOTO1 VDATCON,DMCB2,(2,FULL+2),(5,1(R4))                               
         B     OVEXIT                                                           
         SPACE 2                                                                
...
GETLAT4  IC    R0,1(RF)            BUMP TO NEXT ELEMENT                         
         ...
         B     GETLAT2                                                          
         SPACE 1                                                                
GETLAT5  CLI   FULL,X'10'           TEST FOR BILLING LOOKUP                     
         BNE   GETLATX                                                          
         OC    FULL+2(2),FULL+2     TEST IF ANY BILLING FOUND                   
         BNZ   GETLATX                                                          
*                                                                               
* CHECK AGAINST NEW BILLING RECORDS                                             
*                                                                               
...
GETLATX  OC    FULL+2(2),FULL+2    SET CC ON EXIT                               
         ...
         EJECT                                                                  
********************************************************************            
*    PROCESS BILLING ELEMENTS AND GET TOTAL BILL $ (TIME & INT)                 
********************************************************************            
PROCNBIL NTR1                                                                   
         XC    BTGROSS,BTGROSS                                                  
         XC    BIGROSS,BIGROSS                                                  
         ...
         XC    BIRDATE,BIRDATE                                                  
*                                                                               
         GOTO1 VHELLO,DMCB,(C'G',=C'UNTFILE'),(X'10',AIOAREA4),0                
         CLI   12(R1),0            SET CC ON EXIT                               
         BNE   PROCNBEX                                                         
*                                                                               
         L     R2,12(R1)                                                        
...
*                                                                               
PROCN10  DS    0H                                                               
         CLI   0(R2),X'10'         STILL BILLING ELEMENT?                       
         BH    PROCNBEX                                                         
*                                                                               
         TM    NUBILST,X'20'       TEST FOR UNBILLED ELEMENT                    
         BO    PROCN60             YES                                          
*                                                                               
         ...
         BNE   PROCN50                                                          
*                                                                               
         L     R3,BTGROSS          ACCUMULATE GROSS TOTALS                      
         ICM   R4,15,NUBILGRS                                                   
         AR    R3,R4                                                            
         ST    R3,BTGROSS                                                       
*                                                                               
         CLC   BTRDATE,NUBILDAT    LATEST DATE?                                 
         BH    *+10                                                             
         MVC   BTRDATE,NUBILDAT    YES-SAVE IT                                  
         B     PROCN60                                                          
*                                                                               
PROCN50  DS    0H                                                               
         CLI   NUBILTYP,C'I'       INTEGRATION?                                 
         BNE   PROCNBEX                                                         
*                                                                               
         L     R3,BIGROSS          ACCUMULATE GROSS TOTALS                      
         ICM   R4,15,NUBILGRS                                                   
         AR    R3,R4                                                            
         ST    R3,BIGROSS                                                       
*                                                                               
         CLC   BIRDATE,NUBILDAT    LATEST DATE?                                 
         BH    *+10                                                             
         MVC   BIRDATE,NUBILDAT    YES-SAVE IT                                  
*                                                                               
PROCN60  DS    0H                                                               
         ZIC   RF,1(R2)            BUMP TO NEXT BILLING ELEMENT                 
         AR    R2,RF                                                            
         B     PROCN10                                                          
*                                                                               
PROCNBEX DS    0H                                                               
         ...
         EJECT                                                                  
*                                                                               
DISTRADE DS    0H                  DISPLAY TRADE PERCENT                        
         MVI   FLD,C'0'            SET DEFAULT                                  
         MVI   FLDH+7,1                                                         
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'18',AIOAREA1),0                   
         CLI   12(R1),0                                                         
         BNE   DTRADEX                                                          
         L     R4,12(R1)                                                        
         USING NUDTAD,R4                                                        
         OC    NUDTTRAD,NUDTTRAD                                                
         BZ    DTRADEX                                                          
         EDIT  (B2,NUDTTRAD),(3,FLD),ALIGN=LEFT,ZERO=NOBLANK                    
         STCM  R0,1,FLDH+7                                                      
         DROP  R4                                                               
*                                                                               
DTRADEX  B     OVEXIT                                                           
         EJECT                                                                  
*******************************************************************             
*        DISPLAY DEAL/CONTRACT/SERIAL #                                         
*******************************************************************             
DISDCS   DS    0H                                                               
         USING KEYTABD,R3                                                       
         XC    FLD,FLD                                                          
         MVI   FLDH+7,X'00'                                                     
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'75',AIOAREA1),0                   
         CLI   12(R1),0                                                         
         BNE   DISDCSX                                                          
         L     R4,12(R1)                                                        
         USING NUSQD,R4                                                         
*                                                                               
         ...
         CLI   KEYNUM,DDSDEAL                                                   
         BNE   DISDCS10                                                         
         MVC   FLD(10),NUSQDEAL     DEAL #                                      
         MVI   FLDH+7,10                                                        
         B     DISDCSX                                                          
*                                                                               
DISDCS10 CLI   KEYNUM,SER                                                       
         BE    *+12                                                             
         CLI   KEYNUM,DDSSER                                                    
         BNE   DISDCS20                                                         
         MVC   FLD(12),NUSQSER      SERIAL #                                    
         MVI   FLDH+7,12                                                        
         B     DISDCSX                                                          
*                                                                               
DISDCS20 CLI   KEYNUM,CONT                                                      
         BE    *+12                                                             
         CLI   KEYNUM,DDSCON                                                    
         BNE   DISDCSX                                                          
         MVC   FLD(10),NUSQCON      CONTRACT #                                  
         MVI   FLDH+7,10                                                        
         DROP  R3,R4                                                            
*                                                                               
DISDCSX  B     OVEXIT                                                           
...
*--SET UP EDIT BLOCK                                                            
         ...
         MVC   UNFLDH,FADDR                                                     
*                                                                               
* CHECK FOR ALPHA PRODUCT STORAGE                                               
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'19',AIOAREA1),0                   
         CLI   12(R1),0                                                         
         BNE   *+12                                                             
         L     R5,12(R1)           PRODUCT ELEMENT                              
...
EFEDC018 GOTO1 VSCANNER,DMCB,(20,FLDH),(6,BLOCK),C',=-='                        
         ...
         BE    EFEDC300                                                         
*                                                                               
         MVI   FULL+3,1             SET TRAFFIC POSITION                        
*                                                                               
*-- VALIDATE PRODUCT                                                            
*                                                                               
*--THE FOLLOWING FOUR LINES ARE THERE TO COMPENSATE                             
...
EFEDC030 MVC   FULL(3),DUB2        MOVE ALPHA PROD TO FULL                      
         CLI   OVEREL,0            PROCESS CODE FIRST PASS ONLY                 
         BNE   EFEDC040                                                         
         MVC   OVEREL(1),BYTE                                                   
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'21',AIOAREA1),0                   
         CLI   12(R1),0                                                         
         BE    EFEDC035                                                         
*****    MVI   BYTE,X'21'                                                       
*****    BAS   RE,GETEL                                                         
...
*--ELEMENT NOT FOUND BUILD 21 ELEMENT                                           
         ...
         MVC   NUCMLPRD(1),BYTE                                                 
         GOTO1 VHELLO,DMCB,(C'P',OVUNTFLE),AIOAREA1,OVEREL,0                    
*****    BAS   RE,PUTEL                                                         
         DROP  RE                                                               
         B     EFEDC040                                                         
*                                                                               
...
EFEDC120 LA    R5,42(R5)                                                        
         ...
         ZIC   RE,FULL+3                                                        
         LA    RE,1(RE)                                                         
         STCM  RE,1,FULL+3            NEXT POSITION NUMBER                      
         BCT   R3,EFEDC020                                                      
*                                                                               
         TM    NBUNST3,X'40'                                                    
         BZ    EFEDC300                                                         
*                                                                               
         USING NUFDCEL,R4                                                       
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'23',AIOAREA1),0                   
         CLI   12(R1),0                                                         
         BNE   OVERRED                                                          
*****    MVI   BYTE,X'23'                                                       
*****    BAS   RE,GETEL                                                         
...
*                                                                               
         ...
         BZ    EFEDC330                                                         
         MVC   DUB(4),NUFDCFED                                                  
         GOTO1 VHELLO,DMCB,(C'D',OVUNTFLE),(X'23',NBAIO),(4,DUB)                
         B     EFEDC350                                                         
*                                                                               
...
********************************************************************            
*******************************************************************             
* SUB-ROUTINE TO EDIT TRAFFIC FEED CODES ALPHA ELEMENTS                         
* R5 POINTS TO 19 ELEMENT                                                       
*******************************************************************             
EAFDC001 DS    0H                                                               
         XC    FULL,FULL                                                        
         USING NUPDED,R5                                                        
         TM    NUPDEIND,X'20'       CHECK IF SECTIONAL                          
         BO    EAFDCEX1             EXIT                                        
         TM    NUPDEIND,X'40'       CHECK IF COPYSPLIT                          
         BZ    EAFDC080             NO, PROCESS NORMALLY                        
*--GET NUMBER OF PRODUCTS                                                       
         LA    R3,2                DEFAULT NUMBER OF PRODS TO 2                 
*                                                                               
         XC    HALF2,HALF2                                                      
...
*                                                                               
         ...
         LA    RE,TAPRDHLD         PRODUCT STORE AREA                           
         LA    R1,NUPDEPR          FIRST PRODUCT                                
EAFDC010 MVC   0(3,RE),0(R1)                                                    
         LA    RE,3(RE)                                                         
         LA    R1,7(R1)            NEXT PRODUCT                                 
         BCT   RF,EAFDC010                                                      
*                                                                               
EAFDC018 GOTO1 VSCANNER,DMCB,(20,FLDH),(6,BLOCK),C',=-='                        
         L     R5,DMCB+4                                                        
         CLI   4(R1),0                                                          
         BE    EAFDC300                                                         
*                                                                               
         MVI   FULL+3,1            PRODUCT POSITION                             
*                                                                               
*-- VALIDATE PRODUCT                                                            
*                                                                               
*--THE FOLLOWING FOUR LINES ARE THERE TO COMPENSATE                             
*--FOR A SCANNER BUG THAT PUTS OUT NULL LINES. SORRY.                           
*                                                                               
EAFDC020 OC    0(2,R5),0(R5)                                                    
         BNZ   EAFDC022                                                         
         LA    R5,42(R5)                                                        
         B     EAFDC020                                                         
EAFDC022 MVC   FLD,SPACES                                                       
         MVC   FLD(10),12(R5)      PRODUCT                                      
         MVC   FLDH+5(1),0(R5)     SET DATA LENGTH                              
         OI    FLDH+4,X'04'        AND ALPHA BITS                               
*                                                                               
         ...
         DROP  R4                                                               
*--LOAD NATIONAL PRODUCT (NBPRD) INTO THE 21 ELEMENT                            
EAFDC030 MVC   FULL(3),DUB2        MOVE ALPHA PROD TO FULL                      
         CLI   OVEREL,0            PROCESS CODE FIRST PASS ONLY                 
         BNE   EAFDC040                                                         
         MVC   OVEREL(1),BYTE                                                   
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'21',AIOAREA1),0                   
...
*                                                                               
         ...
         MVC   NUCMPROD(3),FLD                                                  
         NI    NUCMLFL2,X'FE'       SET FOR NATIONAL                            
         GOTO1 VHELLO,(R1),(C'D',OVUNTFLE),(X'21',AIOAREA1),0                   
         GOTO1 VHELLO,DMCB,(C'P',OVUNTFLE),AIOAREA1,OVEREL,0                    
         DROP  RE                                                               
*                                                                               
EAFDC040 MVI   FERN,PRDERR                                                      
         CLC   FLD(3),TAPRDHLD       DO PRODUCTS MATCH                          
         BNE   OVERRED                                                          
         MVC   TAPRDHLD(15),TAPRDHLD+3    BUMP TO NEXT PRODUCT                  
*-- CREATE TRAFFIC FEED CODE ELEMENTS                                           
EAFDC050 CLC   22(2,R5),=C'* '                                                  
         BE    EAFDC120                                                         
         MVC   FLD,SPACES                                                       
         MVC   FLD(20),22(R5)      FEED CODES                                   
         MVC   FLDH+5(1),1(R5)     SET DATA LENGTH                              
...
EAFDC080 LA    R4,HUTBLK                                                        
         ...
         B     OVERRED                                                          
*                                                                               
EAFDC100 MVI   DUB,X'FF'                                                        
EAFDC120 LA    R5,42(R5)                                                        
         XC    HALF,HALF                                                        
         ZIC   RE,FULL+3                                                        
         LA    RE,1(RE)                                                         
         STCM  RE,1,FULL+3            NEXT POSITION NUMBER                      
...
*****    BNE   OVERRED                                                          
         ...
         B     EAFDC150                                                         
*                                                                               
EAFDC130 ZIC   RE,1(R4)                                                         
         AR    R4,RE                                                            
         CLI   0(R4),X'23'                                                      
         BNE   EAFDC300                                                         
EAFDC150 OI    NUFDCFL2,X'01'                                                   
         B     EAFDC130                                                         
*                                                                               
***** EAFDC300 MVI   BYTE,X'23'                                                 
EAFDC300 DS    0H                                                               
         USING NUFDCEL,R4                                                       
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFLE),(X'23',AIOAREA1),0                   
         CLI   12(R1),0                                                         
...
*****    BNE   EAFDCEX                                                          
         ...
         B     EAFDC350                                                         
*                                                                               
EAFDC330 ZIC   RE,1(R4)                                                         
         AR    R4,RE                                                            
EAFDC350 CLI   0(R4),X'23'                                                      
         BNE   EAFDCEX                                                          
*                                                                               
         TM    NUFDCFL2,X'40'                                                   
         BO    EAFDC330                                                         
...
*                                                                               
         DROP  RA,RB,RC                                                         
OVERDEM  NMOD1 0,**OVDM**,RA                                                    
         LA    RC,2048(RC)         RB IS SECOND BASE REGISTER                   
         LA    RC,2048(RC)                                                      
         USING OVERDEM+8192,RC                                                  
         LM    R2,R3,0(R1)         R2=A(DEMO LIST), R3=A(DEMO VALUES)           
         L     R5,12(R1)           R5=A(UNIVERSES)                              
         ZIC   R0,0(R1)            GET COUNT OF DEMOS                           
         LR    RF,R0               SAVE COUNT IN RF                             
...
*                                                                               
         ...
         XC    DUB,DUB                                                          
         MVC   DUB+1(3),0(R2)      EXTRACT MODIFIER/CATEGORY                    
         MVC   ENCDEMO,DUB+1       DECODE THE DEMO                              
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)                                         
         MVC   DMDECHLD,DECDEMO                                                 
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OV220                                                            
*        CLI   DEMOEL,X'DE'        ACTUAL                                       
*        BNE   OV220                                                            
         CLI   DECDEMO+1,C'T'      IMPRESSION                                   
         BNE   OV220                                                            
         MVI   DUB+2,C'H'          HUNDREDS OVERRIDE                            
...
OV240    CLI   DEMTYPE,C'E'                                                     
         ...
         USING NPRECD,RE                                                        
         TM    NPAKSTAT,X'80'      TEST FOR FROZEN PACKAGE                      
         BO    OVERR               CHANGES TO EST. DEMOS NOT ALLOWED            
         SPACE 1                                                                
OV300    CLI   1(R2),USERMOD       TEST FOR USER DEMO                           
         BE    OV302               YES                                          
         BAS   RE,OENCDUB                                                       
OV302    GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(ELCODE,AIOAREA1),(LFIL,DUB)         
         MVC   DUB2,DUB                                                         
         CLI   1(R2),USERMOD       TEST FOR USER DEMO                           
         BE    OV360                                                            
         CLI   DMDECHLD+1,C'R'     TEST FOR RATING                              
         BE    OV310               YES                                          
         CLI   DEMTYPE,C'E'        TEST FOR ESTIMATED DEMOS                     
         BNE   OV400               YES                                          
         B     OV400                                                            
         CLI   DMDECHLD+1,C'H'     TEST FOR ESTIMATED IMP                       
         BE    OV305               NO                                           
         CLI   DMDECHLD+1,C'T'     TEST FOR ESTIMATED IMP                       
         BNE   OV400               NO                                           
OV305    MVI   DUB2+2,C'H'                                                      
         BAS   RE,OENCDUB2                                                      
         GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(ELCODE,AIOAREA1),          X        
               (LFIL,DUB2)                                                      
         MVI   DUB2+2,C'T'                                                      
         BAS   RE,OENCDUB2                                                      
         GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(ELCODE,AIOAREA1),          X        
         ...
         BAS   RE,OENCDUB2                                                      
         B     OV340                                                            
OV310    MVI   DUB2+2,C'V'         DELETE VPH OVERRIDE ALSO                     
         CLI   DEMTYPE,C'E'        TEST FOR ESTIMATED DEMOS                     
         BE    OV320               YES                                          
         MVI   DUB2+2,C'T'         NO-DELETE THE IMP OVERRIDE ALSO              
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OV320                                                            
         MVI   DUB2+2,C'H'                                                      
OV320    BAS   RE,OENCDUB2                                                      
         GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(ELCODE,AIOAREA1),          X        
               (LFIL,DUB2)                                                      
         CLI   DEMTYPE,C'E'        TEST FOR ESTIMATED DEMOS                     
         BNE   OV400               NO                                           
         MVI   DUB2+2,C'T'         -DELETE THE E IMP OVERRIDE ALSO              
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OV335                                                            
         MVI   DUB2+2,C'H'                                                      
OV335    BAS   RE,OENCDUB2                                                      
OV340    GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(ELCODE,AIOAREA1),          X        
               (LFIL,DUB2)                                                      
         B     OV400                                                            
*--USER DEMOS                                                                   
OV360    CLI   USEREL,X'CD'        TEST FOR ESTIMATED                           
         BNE   OV400                                                            
         CLI   3(R2),C'T'          TEST FOR IMPRESSION                          
         BNE   OV400                                                            
         MVI   DUB2,C'R'           DELETE THE RATING                            
         GOTO1 (RF),(R1),,,(LFIL,DUB2)                                          
         MVI   DUB2,C'H'           DELETE THE IMP                               
         GOTO1 (RF),(R1),,,(LFIL,DUB2)                                          
*                                                                               
...
*--EVEN IF A PACKAGE GUARANTEE EXISTS                                           
         ...
         BNL   OV415                                                            
         MVI   FERN,PGNOSHR                                                     
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFIL),(X'B3',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
         BE    OVERR                                                            
         GOTO1 VHELLO,DMCB,(C'G',OVUNTFIL),(X'B4',AIOAREA1),0                   
         CLI   12(R1),0            SET CC ON EXIT                               
         BE    OVERR                                                            
OV415    MVI   FERN,0                                                           
*                                                                               
...
*                                                                               
         ...
         MVC   NUOVEL,ELCODE                                                    
         MVI   NUOVLEN,12                                                       
         MVC   DECDEMO,DMDECHLD                                                 
         CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BNE   OV440                                                            
         CLI   DECDEMO+1,C'T'                                                   
         BNE   OV440                                                            
         MVI   DECDEMO+1,C'H'                                                   
OV440    GOTO1 VENCDEC,DMCB,(1,DECDEMO)                                         
         MVC   NUOVCAT(3),ENCDEMO                                               
         BAS   RE,SETOVPRE         SET DEMO PRECISION                           
         MVC   BYTE,NUOVPRE        BYTE CONTAINS PRECISION                      
         CLC   0(4,R4),=F'-2'      TEST FOR ZERO VALUE                          
         BE    OV600                                                            
         MVC   NUOVVAL(4),0(R4)                                                 
...
OV600    L     R3,SAVEREG3                                                      
*                                                                               
         GOTO1 VHELLO,DMCB,(C'P',OVUNTFIL),AIOAREA1,OVEREL,0                    
         CLI   12(R1),0                                                         
         BE    OV620                                                            
         CLI   12(R1),5                                                         
         BE    *+6                                                              
         ...
         B     OVERR                                                            
*                                                                               
*--CALC RATING FOR USER DEMO EST IMPRESSIONS                                    
OV620    CLI   1(R2),USERMOD                                                    
         BNE   OV640                                                            
         CLI   DEMTYPE,C'E'        ESTIMATED                                    
         BNE   OV700                                                            
         CLI   3(R2),C'T'          IMPRESSION                                   
         BNE   OV700                                                            
         BAS   RE,ERTG                                                          
         B     OV700                                                            
*                                                                               
OV640    CLI   DMDECHLD+1,C'R'     TEST FOR RATING OVERRIDE                     
         BE    OV650                                                            
         CLI   DEMTYPE,C'E'                                                     
*        BNE   OV700                                                            
*        BAS   RE,VPH              ALSO GENERATE THE VPH FOR EST.               
         B     *+8                                                              
OV650    BAS   RE,CALCIMP          GENERATE THE IMP FOR ACTUALS                 
*                                                                               
OV700    L     R1,NBAIO                                                         
         USING NURECD,R1                                                        
         OI    NUACTWHY,X'08'                                                   
...
OENCDUB  NTR1                                                                   
         ...
         B     EXXMOD1                                                          
         SPACE 5                                                                
* CHECK PERSONAL LANGUAGE SETTINGS AND ENCODE IN DUB2                           
OENCDUB2 NTR1                                                                   
         MVC   DECDEMO(3),DUB2+1                                                
         GOTO1 VENCDEC,DMCB,(1,DECDEMO)                                         
         MVC   DUB2+1(3),ENCDEMO    ENCODED DEMO                                
         B     EXXMOD1                                                          
         EJECT                                                                  
* SUB-ROUTINE TO CALCULATE THE ESTIMATE RTG AND TO ADD AN OVERRIDE              
*                                                                               
* AT ENTRY R2 CONTAINS OVERRIDE IMPRESSION                                      
...
*        BE    ERTGX                                                            
         OC    0(4,R5),0(R5)       IS THERE A UNIVERSE                          
         BZ    ERTGX               NO EXIT                                      
         L     R3,0(R5)            PUT UNIVERSE IN R3                           
         L     R1,0(R4)            PUT IMPRESSION IN R1                         
         SR    R0,R0                                                            
*                                                                               
...
ERTG30   XC    OVEREL,OVEREL                                                    
         ...
         MVC   UDOVNAM,DUB+1                                                    
         STCM  R1,15,UDOVVAL                                                    
         GOTO1 VHELLO,DMCB,(C'D',OVUNTFIL),(X'CD',AIOAREA1),(8,UDOVMOD)         
         GOTO1 VHELLO,DMCB,(C'P',OVUNTFIL),AIOAREA1,OVEREL,0                    
         CLI   12(R1),0                                                         
         BE    ERTGX                                                            
         CLI   12(R1),5                                                         
...
SETOVPRE NTR1                                                                   
         ...
         GOTO1 VENCDEC,DMCB,(2,ENCDEMO)                                         
*                                                                               
SOVP20   CLC   0(1,R4),DECDEMO+1                                                
         BE    SOVP40                                                           
         LA    R4,2(R4)                                                         
         BCT   RE,SOVP20                                                        
         DC    H'0'                                                             
SOVP40   MVC   7(1,R3),1(R4)                                                    
         B     EXXMOD1                                                          
         SPACE 2                                                                
OVERR    GOTO1 VERROR                                                           
         SPACE 2                                                                
...
ACTED16  LA    R3,KEYTABL(R3)                                                   
         ...
         SPACE                                                                  
ACTED18  TM    KEYCTL,ONLYDDS      DDS ONLY?                                    
         JZ    *+12                                                             
         CLI   DDS,YES                                                          
         JNE   ACTEDR                                                           
*                                                                               
...
*                                                                               
         ...
         CLI   DECDEMO+1,C'T'      TEST FOR IMP                                 
         BE    *+12                                                             
AC700    CLI   DECDEMO+1,C'R'      TEST FOR RATING                              
         BNE   *+8                                                              
         MVI   WORK+50,C'Y'                                                     
...
DEMADD1  CLI   0(RE),X'FF'         TEST FOR EOL                                 
         ...
         CLC   DECDEMO+1(1),0(RE)  DEMO VS. LIST                                
         BE    DEMADD2             VALID                                        
...
DEMADD1R MVC   XTRA(13),=C'DEMO MODIFIER'                                       
         B     DEMERR                                                           
*--HOMES IMPRESSIONS CAN ONLY BE CHANGED FOR ESTIMATED                          
DEMADD2  B     DEMADD2A                                                         
*                                                                               
*        CLI   NBPOSTYP,C'C'                                                    
*        BE    DEMADD2A                                                         
...
DEMADD2A CLI   DEMO+1,USERMOD      TEST FOR USER DEMO                           
         ...
         LA    RE,ESTDEMSE                                                      
         ZIC   R0,ESTNDEMS                                                      
         CLC   DEMO(1),0(RE)       IF NAD CATEGORY EQUAL                        
         BNE   DEMADD2B                                                         
...
*                                                                               
         DC    CL7'AFDATE',AL1(AFDATE),AL1(6),AL1(0),AL1(8),AL1(DAY)            
         DC    AL1(DISONLY),AL3(DAFDATE),AL3(0)                                 
*                                                                               
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'TRADE',AL1(TRADE),AL1(3),AL1(0),AL1(3),X'00'                 
         DC    AL1(DISONLY),AL3(DTRADE),AL3(0)                                  
*                                                                               
         DC    CL7'VTYPE',AL1(VTYPE),AL1(2),AL1(0),AL1(3),X'00'                 
         DC    AL1(DISONLY),AL3(DVTYPE),AL3(0)                                  
*                                                                               
         DC    CL7'TINV',AL1(INVT),AL1(4),AL1(0),AL1(10),X'00'                  
         DC    AL1(DISONLY),AL3(DINVT),AL3(0)                                   
*                                                                               
         DC    CL7'IINV',AL1(INVI),AL1(4),AL1(0),AL1(10),X'00'                  
         DC    AL1(DISONLY),AL3(DINVI),AL3(0)                                   
*                                                                               
         DC    CL7'DEAL',AL1(DEAL),AL1(3),AL1(0),AL1(10),X'00'                  
         DC    AL1(DISONLY),AL3(DDCS),AL3(0)                                    
*                                                                               
         DC    CL7'DDSDEAL',AL1(DDSDEAL),AL1(7),AL1(UDDSDEAL),AL1(10)           
         DC    X'00',AL1(ONLYDDS),AL3(DDCS),AL3(0)                              
*                                                                               
         DC    CL7'DDSSER',AL1(DDSSER),AL1(6),AL1(UDDSSER),AL1(12)              
         DC    X'00',AL1(ONLYDDS),AL3(DDCS),AL3(0)                              
*                                                                               
         DC    CL7'DDSCON',AL1(DDSCON),AL1(6),AL1(UDDSCON),AL1(10)              
         DC    X'00',AL1(ONLYDDS),AL3(DDCS),AL3(0)                              
*                                                                               
         DC    CL7'CONT',AL1(CONT),AL1(3),AL1(0),AL1(10),X'00'                  
         DC    AL1(DISONLY),AL3(DDCS),AL3(0)                                    
*                                                                               
         DC    CL7'SER',AL1(SER),AL1(3),AL1(0),AL1(12),X'00'                    
         DC    AL1(DISONLY),AL3(DDCS),AL3(0)                                    
*                                                                               
...
*                                                                               
         DC    CL7'FLIGHT',AL1(FLITE),AL1(3),AL1(UFLT),AL1(11),X'00'            
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
PRODUCT  DC    CL7'PRODUCT',AL1(PROD),AL1(3),AL1(UPRD),AL1(23),X'00'            
         DC    AL1(COPSDIS),AL3(DPROD),AL3(0)                                   
*                                                                               
         DC    CL7'FPRDSHR',AL1(FPR),AL1(2),AL1(UP1SHR),AL1(60),X'00'           
         DC    X'00',AL3(DFEDSHR),AL3(EFEDSHR)                                  
*                                                                               
         DC    CL7'ASS',AL1(ASS),AL1(3),AL1(UASS),AL1(10),X'00'                 
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'TG',AL1(OTH),AL1(02),AL1(UOTHER),AL1(5),X'00'                
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'ECOST',AL1(OTH),AL1(03),AL1(UOTHER),AL1(15),X'00'            
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'HP',AL1(OTH),AL1(02),AL1(UOTHER),AL1(10),X'00'               
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'MR',AL1(OTH),AL1(02),AL1(UOTHER),AL1(5),X'00'                
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'DP',AL1(OTH),AL1(02),AL1(UOTHER),AL1(20),X'00'               
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
*****    DC    CL7'FLT',AL1(OTH),AL1(03),AL1(UOTHER),AL1(14),X'00'              
*****    DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'BO',AL1(OTH),AL1(02),AL1(UOTHER),AL1(4),X'00'                
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'IPR',AL1(OTH),AL1(02),AL1(UOTHER),AL1(7),X'00'               
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'AIR',AL1(OTH),AL1(03),AL1(UOTHER),AL1(7),X'00'               
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'POD',AL1(OTH),AL1(03),AL1(UOTHER),AL1(7),X'00'               
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
*                                                                               
...
ACTUAL   DC    CL7'ACT',AL1(ACT),AL1(3),AL1(UACT),AL1(10),X'00'                 
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'WB1',AL1(TCAR),AL1(3),AL1(UTCAR),AL1(1),AL1(TCAR1)           
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'TCAR',AL1(TCAR1),AL1(4),AL1(UTCAR1),AL1(1),AL1(TCAR)         
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'INTEG',AL1(INT),AL1(1),AL1(UINT),AL1(8),X'00'                
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'C2INT',AL1(ICS),AL1(3),AL1(UICS),AL1(10),AL1(PREMPT)         
         DC    X'80',AL3(DISIC2),AL3(0)                                         
*                                                                               
         DC    CL7'COS2',AL1(CS2),AL1(3),AL1(UCS2),AL1(8),X'00'                 
         DC    X'80',AL3(DISCOS2),AL3(0)                                        
*                                                                               
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'FEED',AL1(FEED),AL1(1),AL1(UFEED),AL1(60),X'00'              
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'OVAFF',AL1(GAFFID),AL1(5),AL1(UGAFFID),AL1(5),X'00'          
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
...
*                                                                               
         ...
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'PRTYPE',AL1(PTYPE),AL1(6),AL1(UPRTYPE),AL1(6),X'00'          
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'NEW',AL1(NEW),AL1(3),AL1(UNEW),AL1(1),X'00'                  
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'CONTENT',AL1(CONTENT),AL1(7),AL1(UCONT),AL1(2),X'00'         
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'TIER',AL1(TIER),AL1(4),AL1(UTIER),AL1(1),X'00'               
         DC    X'00',AL3(0),AL3(0)                                              
*                                                                               
         DC    CL7'RCP',AL1(RCP),AL1(3),AL1(URCP),AL1(1),X'00'                  
         DC    AL1(DISONLY),AL3(0),AL3(0)                                       
*                                                                               
         DC    CL7'BILL',AL1(BILL),AL1(1),AL1(UBILL),AL1(49),X'00'              
         DC    AL1(DISONLY),AL3(DBILLED),AL3(0)                                 
*                                                                               
         DC    CL7'PAY',AL1(PAY),AL1(3),AL1(UPAY),AL1(49),X'00'                 
         DC    AL1(DISONLY),AL3(0),AL3(0)                                       
*                                                                               
         DC    CL7'PID',AL1(PID),AL1(3),AL1(UPID),AL1(49),X'00'                 
         DC    AL1(DISONLY),AL3(DPID),AL3(0)                                    
*                                                                               
         DC    CL7'MAXC',AL1(MAXC),AL1(4),AL1(UMAXC),AL1(10),X'00'              
         DC    X'00',AL3(DMAXC),AL3(0)                                          
*                                                                               
         DC    CL7'EARNC',AL1(EIC),AL1(5),AL1(UEARNC),AL1(10),X'00'             
         DC    X'00',AL3(DEICC),AL3(0)                                          
*                                                                               
...
SVKEYL   DS    CL71                LAST KEYWORD LIST                            
...
MINUSSW  DS    C                   CHECK FOR NEGATIVE COST                      
...
DEMOLEN  DS    XL4                 LENGTH OF DEMOS FOR OUTPUT                   
...
TAPRDHLD DS    CL18                TRAFFIC PRODUCT HOLD AREA ALPHA              
TAPRSAVE DS    CL6                 TRAFFIC SAVE OF NBPRD ALPHA                  
*                                                                               
KEYLIST  DS    CL71                                                             
...
NEWEHIMP DS    F                   UPDATED ESTIMATED HOMES IMP                  
         SPACE 2                                                                
*                                                                               
BTGROSS  DS    F                   BILLING TIME GROSS                           
BIGROSS  DS    F                   BILLING INT GROSS                            
BTRDATE  DS    XL2                 DATE OF TIME BILLING                         
BIRDATE  DS    XL2                 DATE OF INT BILLING                          
*                                                                               
...
INTERNAL EQU   X'40'                                                            
COPSDIS  EQU   X'20'                                                            
ONLYDDS  EQU   X'10'               DDS ONLY FEATURE                             
DAY      EQU   1                                                                
TIME     EQU   2                                                                
LENGTH   EQU   3                                                                
NAME     EQU   4                                                                
...
EIC      EQU   42                                                               
TCAR1    EQU   43                   TCAR                                        
ICS      EQU   44                   ADJUSTED INTEGRATION (COS2)                 
CS2      EQU   45                   COS2 FACTOR                                 
VTYPE    EQU   46                   VTYPE                                       
FLITE    EQU   47                                                               
GAFFID   EQU   48                                                               
ESTDE    EQU   50                                                               
...
*                                                                               
       ...
       ++INCLUDE SEACSFILE                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058NEBUY29   08/01/19'                                      
         END                                                                    
