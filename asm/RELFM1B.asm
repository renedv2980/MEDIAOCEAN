*          DATA SET RELFM1B    AT LEVEL 034 AS OF 05/01/02                      
*PHASE T8041BA,*                                                                
*INCLUDE NUMVAL                                                                 
*INCLUDE RIGHT                                                                  
         TITLE 'T8041B - RELFM1B - RRG SPEC GENERATOR'                          
*                                                                               
*********************************************************************           
*                                                                   *           
*        RELFM1B - T8041B - REP FILE PROGRAM                        *           
*                                                                   *           
*********************************************************************           
*  HISTORY OF CHANGES                                               *           
*********************************************************************           
*  31DEC92  (BU ) --- ORIGINAL ENTRY                                *           
*                                                                   *           
*********************************************************************           
*                                                                               
T8041B   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T8041B,R8,R9                                                   
...
*                                                                               
         ...
         MVC   KEY+28(4),BSVDA                                                  
*                                                                               
         TITLE 'T8041B - RELFM1B - OFFICE BUDGET RECORD'                        
...
SAVER4   DS    F                                                                
       ...
       ++INCLUDE DDCOMFACS                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034RELFM1B   05/01/02'                                      
         END                                                                    
