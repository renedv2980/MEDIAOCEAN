*          DATA SET SCHTP04A   AT LEVEL 099 AS OF 05/01/02                      
*PHASE T31304A,+0                                                               
...
GU2      CLI   NBMODE,NBREQLST     TEST FOR END-OF-FILE                         
         ...
         BNE   GU4                                                              
         BAS   RE,TOTALS                                                        
         BAS   RE,ENDSPOOL         CLOSE PRINT QUEUE, PRINT ID                  
         B     PRINXIT                                                          
...
DOC1     MVC   CLACT+5(2),=C'$0'      IF SO, PRINT $0                           
         B     DOC4                                                             
*                                                                               
DOC2     EDIT  NBACTUAL,(10,CLACT),2,FLOAT=-                                    
DOC4     EDIT  NBINTEG,(10,CLICOS),2,FLOAT=-                                    
         L     R2,NBACTUAL                                                      
         A     R2,NBINTEG                                                       
         ST    R2,UNITCOST                                                      
...
DOPAY    CLI   PAYRSN,0            TEST FOR PAYABLE ERROR                       
         ...
         B     DOFILT                                                           
*                                                                               
DOPAY2   EDIT  TIMEPAYG,(10,CLPAYGR),2,FLOAT=-                                  
...
*--MOVE DESCRIPTION OUT TO PRINT LINE                                           
         LA    RE,DESCTAB                                                       
         LA    RF,8                                                             
SRTP150  CLC   0(1,R2),0(RE)                                                    
         BE    SRTP170                                                          
         LA    RE,6(RE)                                                         
         BCT   RF,SRTP150                                                       
         DC    H'0'                                                             
SRTP170  MVC   CLSRA,1(RE)                                                      
         MVC   CLSPRDS(15),PRDLINE                                              
         MVC   PRDLINE,SPACES                                                   
         EDIT  (4,28(R2)),(10,CLSACT),2,FLOAT=-    RATE COST                    
         EDIT  (4,12(R2)),(10,CLSCLR),2,FLOAT=-    RATE CLEARED                 
         EDIT  (4,16(R2)),(10,CLSCLRN),2,FLOAT=-   RATE CLEARED NET             
         EDIT  (4,20(R2)),(10,CLSPAYGR),2,FLOAT=-  RATE PAYABLE                 
         EDIT  (4,24(R2)),(10,CLSPAYNT),2,FLOAT=-  RATE PAYABLE NET             
         CLC   1(3,R2),=XL3'404040'                                             
         BE    SRTP200                                                          
         OC    1(3,R2),1(R2)                                                    
         BZ    SRTP200                                                          
...
*                                                                               
         EDIT  TOTCOST,(10,TEMPOUT),2,FLOAT=-                                   
         MVC   CLACT+2(8),TEMPOUT                                               
         CLC   TEMPOUT,=XL4'3B9AC9FF'                                           
         BH    *+10                                                             
         MVC   CLACT,TEMPOUT                                                    
*                                                                               
         EDIT  TOTCLEAR,(10,TEMPOUT),2,FLOAT=-                                  
         MVC   CLCLR+2(8),TEMPOUT                                               
         CLC   TEMPOUT,=XL4'3B9AC9FF'                                           
         BH    *+10                                                             
         MVC   CLCLR,TEMPOUT                                                    
*                                                                               
         EDIT  TOTCLRN,(10,TEMPOUT),2,FLOAT=-                                   
         MVC   CLCLRN+2(8),TEMPOUT                                              
         CLC   TEMPOUT,=XL4'3B9AC9FF'                                           
         BH    *+10                                                             
         MVC   CLCLRN,TEMPOUT                                                   
*                                                                               
         EDIT  TOTG,(10,TEMPOUT),2,FLOAT=-                                      
         MVC   CLPAYGR+2(8),TEMPOUT                                             
         CLC   TEMPOUT,=XL4'3B9AC9FF'                                           
         BH    *+10                                                             
         MVC   CLPAYGR,TEMPOUT                                                  
*                                                                               
         EDIT  TOTN,(10,TEMPOUT),2,FLOAT=-                                      
         MVC   CLPAYNT+2(8),TEMPOUT                                             
         CLC   TEMPOUT,=XL4'3B9AC9FF'                                           
         BH    *+10                                                             
         MVC   CLPAYNT,TEMPOUT                                                  
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'099SCHTP04A  05/01/02'                                      
         END                                                                    
