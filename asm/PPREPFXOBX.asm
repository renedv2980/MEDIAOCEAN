*          DATA SET PPREPFXOBX AT LEVEL 026 AS OF 03/25/96                      
...
*                                                                               
*        QOPT1  X=  RESTORE PCLTACCA TO BB FOR OFFICES 5 AND C                  
*                   RESTORE PCLTACCA TO BP FOR OFFICES 6 AND S                  
*                                                                               
...
PRT      DS    0H                                                               
         ...
         CLI   PCLTOFF,C'4'                                                     
         BE    PRT2                                                             
         MVC   PCLTACCA,=C'BB'      RESET PCLTACCA TO BB                        
         CLI   PCLTOFF,C'5'        IF OFFICE 5                                  
         BE    PRT2                                                             
         MVC   PCLTACCA,=C'BP'      RESET PCLTACCA TO BP                        
         CLI   PCLTOFF,C'6'        IF OFFICE 6                                  
         BE    PRT2                                                             
         CLI   PCLTOFF,C'7'                                                     
         BE    PRT2                                                             
         CLI   PCLTOFF,C'8'                                                     
...
PRT2     CLI   QOPT1,C'X'           SEE IF UNDOING CONVERSION                   
         BE    PRT5                                                             
*                                                                               
         XC    PCLTACCA,PCLTACCA   CLEAR ACC AGENCY                             
*                                                                               
PRT5     DS    0H                                                               
         CLI   RCWRITE,C'N'                                                     
         BE    AGYC6D                                                           
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'026PPREPFXOBX03/25/96'                                      
         END                                                                    
