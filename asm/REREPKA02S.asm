*          DATA SET REREPKA02S AT LEVEL 065 AS OF 05/10/02                      
*PHASE REKA02A,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH2                                                               
...
VORD0160 EQU   *                                                                
         ...
         MVC   RCONKADV,KEY+21     INSERT ADVERTISER INTO KEY                   
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'065REREPKA02S05/10/02'                                      
         END                                                                    
