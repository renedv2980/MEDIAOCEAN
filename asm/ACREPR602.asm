*          DATA SET ACREPR602  AT LEVEL 031 AS OF 12/11/09                      
*PHASE ACR602A,+0                                                               
*INCLUDE QSORT                                                                  
*INCLUDE ACGETSTD                                                               
*INCLUDE PERVERT                                                                
...
*                                                                               
PRTMP35  LA    R1,MONBUCK          NO-ZERO TOTAL RECORD                         
         LA    R0,13                                                            
         BAS   RE,INITBK2                                                       
         B     PRTMP50                                                          
*                                                                               
...
*                                                                               
PRTMP75  LA    R1,MONBUCK          NO-ZERO TOTAL RECORD WAS                     
...
*        ACQD                                                                   
       ...
       ++INCLUDE ACQD                                                           
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'031ACREPR602 12/11/09'                                      
         END                                                                    
