*          DATA SET PPREPEB02D AT LEVEL 027 AS OF 05/01/02                      
*PHASE PPEB02D,+0,NOAUTO                                                        
*INCLUDE BINSRCH2                                                               
*INCLUDE DYNALLOC                                                               
*INCLUDE DLFLD                                                                  
...
*   CHANGE LOG                                                                  
*                                                                               
*   BPLA   3/00    CHANGES FOR DOWNLOADING                                      
*                                                                               
...
RUNL     DS    0H                                                               
*                                                                               
         CLI   DOWNRUN,C'Y'     SEE IF DOWNLOAD REQUEST ENCOUNTERED             
         BNE   RUNL02                                                           
         GOTO1 VDOWNLD,DMCB,(RA)                                                
*                                                                               
RUNL02   DS    0H                                                               
...
*                                                                               
         ...
         BAS   RE,PRTWKR                                                        
*                                                                               
         CLI   RQTOPT4,C'D'        SEE IF DOWNLOADING                           
         BNE   RWP7D                                                            
         BAS   RE,DOWNWKR                                                       
         B     RWP7E                                                            
*                                                                               
...
WRKMVC   MVC   P1+2(0),WRKRREC+4                                                
         EJECT                                                                  
*                                                                               
*    NOTE:  WORKER FILE IS ALREADY IN A DOWNLOAD FORMAT                         
*                                                                               
DOWNWKR  NTR1                      PRINT WKR RECORD                             
*                                    SPECIAL IDENTIFICATION RECORD              
         LA    R1,DLCB                                                          
         USING DLCBD,R1                                                         
         OI    DLCBFLG1,DLCBFXTN                                                
         OI    DLCBFLG1,DLCBFXFL    USE EXTENDED FIELD FOR TEXT                 
         MVC   DLCXTND(7),DWMAXL                                                
         MVC   DLCBAPR,=A(DWPRINT)                                              
         LA    R0,P1                                                            
         ST    R0,DLCBAPL                                                       
*                                                                               
...
*                                                                               
DWK04D   DS    0H                  FIND ENTRY FOR THIS RECORD TYPE              
         CLI   0(R5),X'FF'         EOT                                          
         BNE   *+6                                                              
...
*                                                                               
DWK05D   DS    0H                                                               
         MVC   DLCBFLD,SPACES       CLEAR EACH TIME                             
         MVC   DLCBFLX(132),SPACES                                              
         MVC   DLCBFLX+132(28),SPACES                                           
*                                                                               
         CLI   0(R5),X'FF'         END OF FIELD DESCRIPTORS                     
         BE    DWK20               DONE, IGNORE ANY FIELDS BEYOND TABLE         
*                                                                               
         LR    RE,R8               SAVE START OF WKR FIELD                      
...
DWK07    DS    0H                                                               
         ...
         CLI   0(R5),11            SEE IF NUMERIC FIELD                         
         BNE   DWK07T                                                           
         NI    DLCBFLG1,X'EF'      SET OFF EXTENDED FIELD FOR TEXT              
         BCTR  R3,0                                                             
         EX    R3,*+8                                                           
         B     DWK08                                                            
         MVC   DLCBFLD(0),0(RE)    SAVE TEXT                                    
*                                                                               
DWK07T   DS    0H      ALL TEXT FIELDS USE EXTENDED                             
         OI    DLCBFLG1,DLCBFXFL    USE EXTENDED FIELD FOR TEXT                 
         BCTR  R3,0                                                             
         EX    R3,*+8                                                           
         B     DWK08                                                            
         MVC   DLCBFLX(0),0(RE)  USE EXTENDED DATA FIELD                        
*                                                                               
DWK08    DS    0H                                                               
...
*                                                                               
         CLI   0(R5),11            SEE IF AN AMOUNT FIELD                       
*                     THEY ARE THE ONLY ONE 11 BYTES LONG IN TABLE              
         BE    DWK08N                                                           
         MVI   DLCBTYP,C'T'         TEXT FIELD                                  
         MVI   DLCBACT,DLCBPUT                                                  
         GOTO1 VDLFLD                                                           
...
*******  BNE   DWK08X                                                           
*******  MVC   SAVINVD,DLCBFLD     SAVE INVOICE DATE                            
         B     DWK08X                                                           
*                                                                               
DWK08N   DS    0H                                                               
...
*                                                                               
DWMAXL   DC    H'160'                                                           
         DC    C' '        FIELD DELIMITER                                      
         DC    C'"'        END OF TEXT FIELD DELIMITER                          
         DC    C''''       END OF TEXT CHR ALTERNATE                            
         DC    X'5E'       END OF LINE CHAR - SEMI-COLON                        
         DC    C':'        END OF REPORT CHR                                    
         EJECT                                                                  
***********************************************************************         
...
*                                                                               
*                                                                               
         CLI   RQTOPT4,C'D'        SEE FI DOWNLOADING                           
         BE    MYPRNTX                                                          
MYPRNT4  DS    0H                                                               
...
DOWNRUN  DS    CL1    WILL BE Y IF DOWNLOAD REQ ENCOUNTERED                     
*                                                                               
FIXREC   DS    0XL400                                                           
         DS    XL4                                                              
         DS    XL396                                                            
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027PPREPEB02D05/01/02'                                      
         END                                                                    
