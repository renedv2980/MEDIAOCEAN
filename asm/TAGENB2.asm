*          DATA SET TAGENB2    AT LEVEL 002 AS OF 05/01/02                      
*PHASE T702B2A                                                                  
         TITLE 'T702B2 - USE RECORD MAINTENANCE'                                
T702B2   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T702B2                                                         
...
*              MODE CONTROLLED ROUTINES                                         
         ...
         BNE   MAIN10                                                           
         GOTO1 RECVAL,DMCB,TLUSCDQ,(X'40',SUSUSEH) BUILD THE KEY                
         B     MAINX                                                            
         SPACE 3                                                                
...
MAIN30   CLI   MODE,DISPKEY        DISPLAY KEY FOR SELECT                       
         ...
         L     R3,AIO                                                           
         USING TLUSD,R3                                                         
         MVC   SUSUSE,TLUSUSE      USE CODE                                     
         OI    SUSUSEH+6,X'80'     TRANSMIT                                     
MAINX    B     XIT                                                              
         SPACE 3                                                                
XIT      XIT1                                                                   
         EJECT                                                                  
*              BUILD THE RECORD                                                 
         SPACE 1                                                                
BLDREC   NTR1                                                                   
         GOTO1 NAMIN,DMCB,TANAELQ,SUSUSENH    USE NAME                          
         SPACE 1                                                                
...
*              DISPLAY THE RECORD                                               
         SPACE 1                                                                
DISPLAY  NTR1                                                                   
         GOTO1 CHAROUT,DMCB,TANAELQ,SUSUSENH  USE NAME                          
         SPACE 1                                                                
         GOTO1 ACTVOUT,DMCB,SUSLCHGH          LAST CHANGED                      
         B     XIT                                                              
         EJECT                                                                  
*              CONSTANTS, ETC.                                                  
         SPACE 2                                                                
...
* DDSPLWORKD                                                                    
       ...
       ++INCLUDE DDSPLWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002TAGENB2   05/01/02'                                      
         END                                                                    
