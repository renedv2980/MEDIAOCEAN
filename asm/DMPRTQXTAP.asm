*          DATA SET DMPRTQXTAP AT LEVEL 015 AS OF 08/28/08                      
*PHASE PQXTAPA                                                                  
         TITLE 'PRTQEXTT - PRTQXFR EXTERNAL ROUTINE FOR TAPSCAN'                
...
DMXINX   CLOSE (EXTSYSIN)          OPEN EXTERN PARAMETER FILE                   
         ...
         DC    H'0'                                                             
*                                                                               
         CLC   DSN,BLANKS          DSN IS REQUIRED                              
         BNE   *+6                                                              
         DC    H'0'                                                             
*                                                                               
...
HDRREC   DC    C'    *HDR*EDICT=*TVSCAN               D*TVSCAN'                 
HDRRECLN EQU   *-HDRRECOV                                                       
*                                                                               
TRNRECOV DC    X'00000000',X'09'                                                
TRNREC   DC    C'++DDS REDTRTRN'                                                
TRNRECLN EQU   *-TRNRECOV                                                       
*                                                                               
DSNRECOV DC    X'00000000',X'09'                                                
DSNREC   DC    C'++DDS      DSN XXXXXX.XXXXXXXX.XXX'                            
...
WORKX    EQU   *                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'015DMPRTQXTAP08/28/08'                                      
         END                                                                    
