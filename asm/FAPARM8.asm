*          DATA SET FAPARM8    AT LEVEL 036 AS OF 01/07/21                      
*PHASE FAPARM8A                                                                 
         TITLE 'FACPAK startup variables - ADV8'                                
FAPARMS  CSECT                                                                  
K        EQU   1024                                                             
YES      EQU   C'Y'                                                             
NO       EQU   C'N'                                                             
...
*                                                                               
SEOPNOP  DC    C'!'                Everything as read-only                      
SELIST   DC    80CL8' '            Except                                       
         ORG   SELIST                                                           
         DC    CL8'ACC0'                                                        
         DC    CL8'ACCT'                                                        
         DC    CL8'ACCY'                                                        
...
FACPGMUP DC    AL1(NO)             UPDATE PRGMS FILE FROM THIS SYS              
*                                                                               
VTAMAPL  DC    CL8'ADV8'           VTAM APPLICATION ID                          
VTAMUTL  DC    H'1000'             VTAM NUM ENTRIES IN UTL                      
VTAMPRQ  DC    H'50'               VTAM NUM ENTRIES IN PRQ                      
...
FACXA9MB DC    AL1(1)              NUMBER OF MB OF XA9 WORK PER TASK            
         DC    XL2'00'             N/D                                          
*                                                                               
FACMQION DC    F'0'                MQ SERIES 0=OFF, 1=ON, 2=ON w/trace          
...
FACMQMAX DC    F'08'                                                            
FAMOFA   DC    C'N'                                                             
FACMQIO  DC    CL08'FAMQIO '       No MQ for this FACPAK for now                
FAGLOBAL DC    AL1(NO)             GET DSN NAMES FROM DATASPACE                 
FABULKUP DC    AL1(NO)             FALINK BULK UPLOAD                           
FAPOLING DC    AL1(NO)             DDLINK polling code                          
         DC    XL23'00'            SPARE                                        
*                                                                               
FAPARMX  DS    0C                  END OF FIXED PART                            
*                                  MQ SERIES MANAGER NAME                       
FACMQM   DC    CL48' '                                                          
FACMQIN  DC    CL48'ADV8.INPUT.ALIASQ'                                          
FACMQOU  DC    CL48'DDS.BROKER.LOCALQ'                                          
FACMQWK  DC    CL48'ADV8.WORK.ALIASQ'                                           
FACMQCT  DC    CL48'ADV8.CONTROL.ALIASQ'                                        
*                                                                               
DMFLIST  DS    0CL20                                                            
         DC    C'PRGMS     ',C'PRGMS     '                                      
...
*                                                                               
         ...
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'036FAPARM8   01/07/21'                                      
         END                                                                    
