*          DATA SET CTFIL12    AT LEVEL 011 AS OF 08/22/00                      
*&&      SET   NOP=N                                                            
*PHASE TA1312A                                                                  
...
*        DC    AL2(00151),AL4(SCTDTA)    SUB-COUNTRY FILTER                     
         ...
         DC    AL2(00167),AL4(ULCDTA)    LIST SCREEN CODE                       
         DC    AL2(00114),AL4(LENDTA)    VALIDATION LENGTH                      
         DC    AL2(00116),AL4(TSTDTA)    TEST PHASE                             
         DC    AL2(00150),AL4(CTRDTA)    COUNTRY CODE                           
         DC    AL2(00168),AL4(TSODTA)    TEST SYSTEM ONLY                       
         DC    AL2(00169),AL4(SECDTA)    SECURITY OVERRIDE                      
         DC    AL2(EOT)                                                         
         SPACE 1                                                                
KNOWTABD DSECT                                                                  
...
VUKC04   OI    FRRINDS1,FRR1UKC                                                 
         ...
         EJECT                                                                  
***********************************************************************         
* DATA OBJECT FOR RECORD IS TEST ONLY                                 *         
*                                                                     *         
* R1 HOLDS EQUATED VERB                                               *         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                 *         
***********************************************************************         
         SPACE 1                                                                
TSODTA   LA    RF,TSOTBL           TABLE OF KNOWN VERBS                         
         B     ITER                ITERATE TABLE                                
*                                                                               
TSOTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISTSO)                                 
         DC    AL1(DVAL),AL1(0,0,0),AL4(VALTSO)                                 
         DC    AL1(EOT)                                                         
         SPACE 2                                                                
***********************************************************************         
* DISPLAY RECORD IS TEST ONLY                                         *         
***********************************************************************         
         SPACE 1                                                                
DISTSO   LTR   R3,R3               FRREL?                                       
         BZ    EXITOK                                                           
         MVC   FVIFLD(L'FL@NO),FL@NO                                            
         TM    FRRINDS2,FRR2TSO                                                 
         BZ    EXITOK                                                           
...
***********************************************************************         
         SPACE 1                                                                
VALTSO   LTR   R3,R3               FRREL?                                       
         BZ    DIE                                                              
         NI    FRRINDS2,FF-(FRR2TSO)                                            
         CLI   FVILEN,0                                                         
         BE    EXITOK              DEFAULT IS NO                                
         XR    RE,RE                                                            
         IC    RE,FVXLEN                                                        
...
VTSO02   EX    RE,*+8              YES                                          
         ...
         B     EXITNV              NOTHING ELSE IS VALID                        
*                                                                               
VTSO04   OI    FRRINDS2,FRR2TSO                                                 
         B     EXITOK                                                           
         EJECT                                                                  
***********************************************************************         
* DATA OBJECT FOR RECORD USES LIST SCREEN CODES                       *         
*                                                                     *         
* R1 HOLDS EQUATED VERB                                               *         
* R2 HOLDS A(RECORD AT CORRECT LEVEL)                                 *         
***********************************************************************         
         SPACE 1                                                                
ULCDTA   LA    RF,ULCTBL           TABLE OF KNOWN VERBS                         
         B     ITER                ITERATE TABLE                                
*                                                                               
ULCTBL   DC    AL1(DDIS),AL1(0,0,0),AL4(DISULC)                                 
         ...
         SPACE 2                                                                
***********************************************************************         
* DISPLAY RECORD USES LIST CODES                                      *         
***********************************************************************         
         SPACE 1                                                                
DISULC   LTR   R3,R3               FRREL?                                       
         BZ    EXITOK                                                           
         MVC   FVIFLD(L'FL@NO),FL@NO                                            
         TM    FRRINDS1,FRR1ULC                                                 
         BZ    EXITOK                                                           
         ...
         SPACE 2                                                                
***********************************************************************         
* VALIDATE RECORD USES LIST CODES                                     *         
***********************************************************************         
         SPACE 1                                                                
VALULC   LTR   R3,R3               FRREL?                                       
         BZ    DIE                                                              
         NI    FRRINDS1,FF-(FRR1ULC)                                            
         CLI   FVILEN,0                                                         
         BE    EXITOK              DEFAULT IS NO                                
         XR    RE,RE                                                            
         IC    RE,FVXLEN                                                        
...
***********************************************************************         
         SPACE 1                                                                
DISSEC   CURED FRRSEC,(3,FVIFLD),0,DMCB=BOPARM,ALIGN=LEFT,ZERO=BLANK            
         B     EXITOK                                                           
         SPACE 2                                                                
***********************************************************************         
* VALIDATE A RECORD FIELD                                             *         
...
*        FACTRYEQUS                                                             
       ...
       ++INCLUDE FACTRYEQUS                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011CTFIL12   08/22/00'                                      
         END                                                                    
