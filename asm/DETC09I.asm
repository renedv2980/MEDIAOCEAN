*          DATA SET DETC09I    AT LEVEL 009 AS OF 03/18/15                      
*PHASE DETC09IA                                                                 
         TITLE 'DEMO CONVERSION'                                                
DETC09I  TITLE '- TCAR CONVERSION STARTING MAY/2009'                            
...
CNVRTN   NMOD1 0,**CNVW**,RA,RR=RE                                              
         ...
         USING WORKD,R4            R4 = DETC09I WORK                            
*                                                                               
...
K1797    DS    CL0004              NHWC6                                        
       ...
       ++INCLUDE DEDEMTABD                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009DETC09I   03/18/15'                                      
         END                                                                    
