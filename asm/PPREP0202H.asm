*          DATA SET PPREP0202H AT LEVEL 011 AS OF 05/01/02                      
*PHASE PP0202H,+0,NOAUTO                                                        
*INCLUDE MININAM                                                                
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011PPREP0202H05/01/02'                                      
         END                                                                    
