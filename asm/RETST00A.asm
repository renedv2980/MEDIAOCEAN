*          DATA SET RETST00A   AT LEVEL 159 AS OF 08/31/00                      
*          DATA SET RETST00A   AT LEVEL 158 AS OF 07/05/00                      
*PHASE T81C00A                                                                  
*INCLUDE TWABLD                                                                 
*INCLUDE UNBOOK                                                                 
*INCLUDE RECUP                                                                  
...
***>     MVC   RKLAGY,=CL4'ROB '                                                
         MVC   RKLSTA,=CL5'WROB '                                               
         MVC   RKLSTART,=X'6301'   1/99                                         
         MVC   RKLEND,=X'630C'   12/99                                          
         MVI   RKLTYPE,C'R'                                                     
*                                                                               
         XC    WORK2,WORK2                                                      
         MVC   WORK2(2),RKLREP                                                  
         MVC   WORK2+2(60),RKLSTART                                             
...
*                                                                               
         XC    WORK,WORK                                                        
         MVC   RKLPRDN,=CL9'PRODUCT'                                            
         BAS   RE,DOLST                                                         
*&&                                                                             
ENDMAIN  DS    0H                                                               
         B     EXITOK                                                           
*                                                                               
* DOLST - CALL TO RECONLST                                                      
*                                                                               
DOLST    NTR1                                                                   
         MVC   RKLAIO,AIOREC                                                    
*                                                                               
         ...
         GOTO1 =V(RECONLST),DMCB,(X'20',RKLD),0,0,DUB,VREPFACS,RR=Y             
         BL    EXITL                                                            
         XC    WORK2,WORK2                                                      
         GOTO1 VHEXOUT,DMCB,RKLKEY,WORK2,27                                     
         GOTO1 PRINTOUT,DMCB,WORK2                                              
         XC    WORK2,WORK2                                                      
         MVC   WORK2(27),RKLKEY                                                 
         GOTO1 PRINTOUT,DMCB,WORK2                                              
...
TESTSEC  NTR1                                                                   
         XC    WORK2,WORK2                                                      
         MVC   WORK2(55),=C'GRP   OFC   STA   OWN   MKT   REG   SAL   1+        
                2 3 4   REP'                                                    
         GOTO1 PRINTOUT,DMCB,WORK2                                              
         XC    WORK2,WORK2                                                      
         MVC   WORK2(SBBREAKS-SBLOCK),WORK                                      
...
TSEC005  DS    0H                                                               
         ...
         MVC   DUB(4),ACOMFACS                                                  
         MVC   DUB+4(2),HALF                                                    
         GOTOX (RFCKSEC,VREPFACS),DMCB,WORK,(R2),ATIOB,DUB                      
         BE    *+10                                                             
...
VHPARMLQ EQU   *-VHPARMD                                                        
       ...
       ++INCLUDE RECONLSTD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'159RETST00A  08/31/00'                                      
         END                                                                    
