*          DATA SET UNLDEXT3   AT LEVEL 005 AS OF 05/01/02                      
*          DATA SET UNLDEXT    AT LEVEL 225 AS OF 07/29/96                      
*PHASE UNLDEX3A,+0                                                              
*INCLUDE DATCON                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
...
UNXIT    XMOD1 1                                                                
         EJECT                                                                  
*******************************************************************             
* PROCESS RECORD LOGIC  - RESTORE CLOSED OUT RECS                               
*                                                                 *             
*******************************************************************             
         SPACE 1                                                                
UNXREC   DS    0H                                                               
*                                                                               
         ...
         BNE   UNX10                                                            
         USING NPKEY,R3                                                         
         CLI   NPKAM,X'63'         AGENCY OMCO ONLY                             
         BNE   UNXPURGE                                                         
         CLC   NPKCLT,=X'81FF'     CLIENT AP ONLY                               
         BNE   UNXPURGE                                                         
UNX12    TM    NPKRSTAT,X'C0'      ONLY CLOSED OUT RECS                         
         BNO   UNXPURGE                                                         
         NI    NPKRSTAT,X'FF'-X'C0'                                             
         B     UNX20                                                            
                                                                                
UNX10    CLI   0(R3),X'04'         UNITS                                        
         BNE   UNXPURGE                                                         
         CLI   1(R3),X'63'         FOR AGENCY OMCO ONLY                         
         BNE   UNXPURGE                                                         
         USING NURECD,R3                                                        
         CLC   NUKCLT,=X'81FF'     CLIENT AA ONLY                               
         BNE   UNXPURGE                                                         
UNX15    DS    0H                                                               
         TM    NURSTAT,X'C0'                                                    
         BNO   UNXPURGE                                                         
         NI    NURSTAT,X'FF'-X'C0'                                              
         B     UNX20                                                            
*************************************************                               
UNX20    L     R1,COUNT                                                         
         LA    R1,1(R1)                                                         
         ...
         C     R1,=F'300'                                                       
         BH    UNXKEEP                                                          
         GOTO1 VPRNTBL,DMCB,=C'RECS',AREC,C'DUMP',60,=C'1D'                     
         B     UNXKEEP                                                          
*                                                                               
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE SPTRNREV                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005UNLDEXT3  05/01/02'                                      
         END                                                                    
