*          DATA SET NEMEDA8T   AT LEVEL 002 AS OF 05/01/02                      
*          DATA SET NEMEDA8    AT LEVEL 037 AS OF 10/18/90                      
*PHASE T31EA8A,*                                                                
*INCLUDE BINSRCH2                                                               
...
VK10     LA    R2,SPLESTH                ESTIMATE                               
         ...
         USING ESTHDR,R3                                                        
         MVC   NDDEMOS(60),EDEMLST    GET STANDARD 20                           
         MVC   NDDEMOS+60(3),EDEM21   GET 21ST                                  
...
PRDHD    DSECT                                                                  
       ...
       ++INCLUDE SPGENCLT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002NEMEDA8T  05/01/02'                                      
         END                                                                    
