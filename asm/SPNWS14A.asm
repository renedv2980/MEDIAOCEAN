*          DATA SET SPNWS14A   AT LEVEL 146 AS OF 07/17/02                      
*PHASE T20714A,*                                                                
...
*                                                                               
         ...
         BZ    DISB4               NEITHER                                      
*  INCREASED SPACE ON SCREEN, NO NEED TO GET RID OF '/' ANYMORE                 
*                                07/11/02   MHC                                 
...
*                                                                               
         ...
         NI    SPLKDBK+1,X'FF'-X'80'                                            
*                                                                               
GETD5    TM    SVWKYIND,SVONEBK    TEST 1 BOOK, 4 WEEKS                         
         BZ    *+8                                                              
...
* DDGLOBEQUS                                                                    
       ...
       ++INCLUDE DDGLOBEQUS                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'146SPNWS14A  07/17/02'                                      
         END                                                                    
