*          DATA SET RERMP26S   AT LEVEL 108 AS OF 05/01/02                      
*PHASE T81026B,*                                                                
...
*                                                                               
         ...
         LA    R3,L'DPLIST         MAX NUMBER OF DAYPARTS                       
*                                                                               
PRMDPTLP DS    0H                                                               
*                                                                               
...
*                                                                               
         ...
         XC    KEY,KEY                                                          
*                                                                               
         MVI   RIDPKTYP,X'92'      RECORD ID                                    
         MVC   RIDPKREP,REP        REP ID                                       
         MVC   RIDPKSTA,CSTAT      ACTIVE STATION                               
         L     RF,ADPT                                                          
...
*                                                                               
         ...
         BNE   PRDSTKDN                                                         
*                                                                               
         OC    INVRANGE,INVRANGE   SKIP IF NO INVENTORY RANGE ENTERED           
         BZ    PRDSTK20                                                         
*                                                                               
         CLC   RIDPKINV,INVRANGE   INVENTORY NUMBER MUST LIE IN RANGE           
         BL    PRDSTKCN                                                         
         CLC   RIDPKINV,INVRANGE+4                                              
         BH    PRDSTKCN                                                         
*                                                                               
PRDSTK20 DS    0H                                                               
*                                                                               
...
*                                                                               
         ...
         MVC   GSIBITS,FROM        BOOKVAL BITS                                 
         MVC   GSIBKTYP,FROM+3     BOOK TYPE                                    
*                                                                               
...
*                                                                               
         ...
         MVC   PL1+64(2),LASTCD      PRINT CODE                                 
*                                                                               
         LA    R3,PL1                                                           
...
*                                                                               
         MVC   GSIRSVC,TITSRCE     SET RATING SERVICE                           
         MVC   GSIBITS,TO          BOOKVAL BITS                                 
         MVC   GSIBKTYP,TO+3       BOOK TYPE                                    
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'B',GSRCIN),GSRCOUT                              
         CLI   DMCB+4,0            CHECK FOR ERRORS                             
         BE    *+6                                                              
...
*                                                                               
         L     R5,APJBUFF                                                       
         MVC   PL1+64(66),PL2+64   IF PJ WINS, PRINT PJ LINE                    
*                                                                               
...
*                                                                               
MC4      CLC   THISCD,=C'PJ'       ADD AN UPGRADE ELM FOR PROJECTION            
******   BE    *+10                                                             
...
*                                                                               
         ...
         MVI   BOXCOLS+067,C'C'    CODE                                         
         MVI   BOXCOLS+074,C'C'    HUT                                          
         MVI   BOXCOLS+081,C'C'    SHR                                          
         MVI   BOXCOLS+088,C'C'    RTG                                          
         MVI   BOXCOLS+095,C'C'    W18+                                         
         MVI   BOXCOLS+102,C'C'    M18+                                         
         MVI   BOXCOLS+109,C'R'    TOTAL HOMES                                  
         MVI   BOXROWS+06,C'T'                                                  
         MVI   BOXROWS+09,C'M'                                                  
         MVI   BOXROWS+56,C'B'                                                  
*                                                                               
...
*                                                                               
INVRANGE DS    XL8                 INVENTORY RANGE CL4/CL4                      
*                                                                               
ADPT     DS    F                                                                
SAVESTAK DS    2F                                                               
ASTACK   DS    A                                                                
...
*                                                                               
       ++INCLUDE DDCOMFACS                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'108RERMP26S  05/01/02'                                      
         END                                                                    
