*          DATA SET REREP1H0C  AT LEVEL 026 AS OF 05/01/02                      
*PHASE RE1H02B,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
* UPDATE HISTORY                                                    *           
*                                                                   *           
* NOV14/96 (BU ) --- SWEEP/FIX CLOSEOUT INV BUCKETS WHEN            *           
*                       DOUBLE NEGATIVE.                            *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
...
*                                                                               
*                                                                               
*   SCAN CONTRACTS FOR DOUBLE NEGATIVE X'04' ELEMENTS.                          
*                                                                               
BUCK     NTR1                                                                   
*                                                                               
*        BAS   RE,INITIAL                                                       
...
BUCK0120 EQU   *                                                                
         ...
         CLI   0(R4),X'04'         X'04' ELEMENT?                               
         BNE   BUCK0120            NO  - BUMP TO NEXT ELEMENT                   
*                                  YES - COMPARE AGAINST NEXT ELEMENT           
         CLC   0(4,R4),10(R4)      ELEMENT CODE+DATE SAME?                      
         BNE   BUCK0120            NO  - GO BACK FOR NEXT ELEMENT               
         CLC   6(4,R4),16(R4)      YES - DOLLAR VALUES THE SAME?                
         BNE   BUCK0120            NO  - GO BACK FOR NEXT ELEMENT               
         TM    6(R4),X'80'         YES - DOLLAR VALUE NEGATIVE?                 
         BNO   BUCK0120            NO  - GO BACK FOR NEXT                       
*                                                                               
*   BUCKETS MEET CRITERIA:  MORE THAN ONE BUCKET FOR SAME MONTH AND             
*        NEGATIVE DOLLAR VALUE:  DISPLAY THE CONTRACT INFORMATION               
*                                                                               
...
*                                                                               
       ...
       ++INCLUDE REGENINVA                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'026REREP1H0C 05/01/02'                                      
         END                                                                    
