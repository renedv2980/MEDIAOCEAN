*          DATA SET ACREPIJ01  AT LEVEL 003 AS OF 08/17/00                      
*PHASE ACIJ01A                                                                  
ACIJ01   TITLE '- SPECS FOR REQUESTABLE DAILY JOURNAL'                          
...
* ACDDEQUES                                                                     
       ...
       ++INCLUDE ACDDEQUS                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003ACREPIJ01 08/17/00'                                      
         END                                                                    
