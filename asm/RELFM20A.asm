*          DATA SET RELFM20A   AT LEVEL 005 AS OF 05/01/02                      
...
*                                                                 *             
* SEP16/97 (GL ) --->USE GETKSRC FOR BOOKVAL<==>KSRC CONVERSIN    *             
*                                                                 *             
*                     ***  END TOMBSTONE  ***                     *             
*******************************************************************             
*                                                                               
...
INV262   OC    0(3,R6),0(R6)                                                    
         BZ    INV265                                                           
*^^GYL                                                                          
         DS    0H                  GET BOOKVAL BITS FROM KSRC                   
         XC    DUB,DUB                                                          
GKS1     USING GKSPARMD,DUB                                                     
         MVC   GKS1.GKSPKSRC,0(R6)                                              
         MVI   BYTE2,C'K'                                                       
         BAS   RE,CALLGKS                                                       
         MVC   0(1,R5),GKS1.GKSPBKBT                                            
         DROP  GKS1                                                             
*&&DO                                                                           
...
* AT ENTRY,                                                                     
*   BYTE2 = BYTE 0 OF PARAMETER 1 FOR GETKSRC CALL                              
*   DUB   = INPUT BLOCK TO GETKSRC                                              
* AT EXIT,                                                                      
*   DUB   = OUTPUT BLOCK FROM GETKSRC                                           
* !!WARNGIN!! DO NOT CLOBBER  DUB  IN THIS ROUTINE                              
                                                                                
CALLGKS  NTR1  WORK=(R8,CGKSWRKN)                                               
         USING CGKSWRKD,R8                                                      
*                                                                               
         LA    RE,CGKS_A                                                        
         S     RE,CGKS_A                                                        
...
*                                                                               
         DS    0H                                                               
         GOTO1 =V(GETKSRC),DMCB,(BYTE2,DUB),DUB,RR=CGWRELO                      
         CLI   DMCB+4,0                                                         
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
...
CGWRELO  DS    F                                                                
CGKSWRKX EQU   *                                                                
CGKSWRKN EQU   (((CGKSWRKX-CGKSWRKD)/8)+1)*8                                    
...
GKSPARML EQU   GKSPARMX-GKSPARMD                                                
         DS    0XL(L'DUB-GKSPARML+1)   DUB USED AS GETKSRC PARM BLOCK           
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005RELFM20A  05/01/02'                                      
         END                                                                    
