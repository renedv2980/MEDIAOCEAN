*          DATA SET NESFM05    AT LEVEL 176 AS OF 10/31/05                      
*PHASE T31C05A                                                                  
*INCLUDE SCINKEY                                                                
*INCLUDE XSORT                                                                  
...
HEDSPECS DS    0H                                                               
         ...
         SSPEC H2,71,PAGE                                                       
         SPACE 1                                                                
         SSPEC H1,30,C'MARKET LIST'                                             
         SSPEC H2,30,C'-----------'                                             
         SPACE 1                                                                
         SSPEC H4,2,C'MARKET'                                                   
         SSPEC H5,2,C'------'                                                   
         SSPEC H4,17,C'MARKET NAME'                                             
         SSPEC H5,11,C'----------------------'                                  
         DC    X'00'                                                            
         EJECT                                                                  
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'176NESFM05   10/31/05'                                      
         END                                                                    
