*          DATA SET REREPP102A AT LEVEL 190 AS OF 05/01/02                      
*PHASE REP102A,*                                                                
*INCLUDE HEXIN                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE DAYPAK                                                                 
...
*INCLUDE PERVERT                                                                
*INCLUDE QSORT                                                                  
         TITLE 'REREPP102  (REP102A) --- NEW WORLD CONVERSION'                  
*                                                                               
********************************************************************            
*                                                                  *            
*        REREPP102  -- NEW WORLD CONVERT:CONTRACT FILE CONVERSION. *            
...
*                                                                  *            
* FEB24/97 (BU ) --- NEW VERSION TO HANDLE NEW WORLD TV            *            
*                                                                  *            
* MAR07/97 (BU ) --- MODIFY FOR THREE LOCAL REPS                   *            
*                                                                  *            
* MAR10/97 (BU ) --- MODIFY COMMENT INSERT FOR 3 LOCAL REPS        *            
*                                                                  *            
*                                                                  *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
...
*                 = C  DISPLAY AGENCY I/P + O/P (1ST N RECS)       *            
*                 = D  DISPLAY AGENCY TABLE AT START OF CON CONV   *            
...
MAIN0080 EQU   *                                                                
         CLC   RECORD2+30(2),=X'0020'      BUYS ARE FINAL                       
**TEST2* CLC   RECORD2+30(2),=X'0010'      CONS ARE FINAL                       
**TEST3* CLC   RECORD2+30(2),=X'0004'      S/PS ARE FINAL                       
...
*    NOW HANDLED IN STARPROC       NOT CONVERTED:  NEED COMPETITIVE             
...
MAIN0260 EQU   *                                                                
         ...
         BNE   MAIN0280            NO                                           
         GOTO1 =A(AGYRPROC),DMCB,(RC),RR=RELO                                   
         B     MAIN0040            GO BACK FOR NEXT                             
MAIN0280 EQU   *                                                                
...
SALRPROC NTR1                                                                   
         ...
         CLC   =C'03',JSALKREP     LOCAL S/P?                                   
         BE    SALR0020            YES -                                        
         CLC   =C'04',JSALKREP     LOCAL S/P?                                   
         BE    SALR0020            YES -                                        
         CLC   =C'05',JSALKREP     LOCAL S/P?                                   
         BE    SALR0020            YES -                                        
         CLC   =C'NW',JSALKREP     'NW' S/P?                                    
         BNE   SALR0900            NO  - SKIP THIS RECORD                       
SALR0020 EQU   *                                                                
         L     RF,NAMCTR           INCREMENT S/P NAME COUNT                     
         LA    RF,1(RF)                                                         
         ST    RF,NAMCTR                                                        
         MVC   0(2,R3),JSALKREP    INSERT REP CODE                              
         MVC   2(8,R3),JSALKSAL    INSERT SP/DIV-TEAM/OFFICE                    
         MVC   10(30,R3),JSALNAME  INSERT SP NAME INTO TABLE                    
         MVC   40(12,R3),JSALNMBR  INSERT TELEPHONE NUMBER                      
         CLI   QUESTOR+9,C'Y'      DISPLAY NAME TABLE ENTRY?                    
         BNE   SALR0040            NO                                           
         GOTO1 =A(DISPIPUT),DMCB,(RC),RR=Y                                      
*        MVC   P+1(05),=C'NAME:'                                                
*        MVC   P+6(52),0(R3)       INSERT TABLE ENTRY                           
*        GOTO1 REPORT                                                           
SALR0040 EQU   *                                                                
         LA    R3,52(R3)           BUMP TO NEXT SLOT                            
...
ADVRPROC NTR1                                                                   
         ...
         CLC   =C'03',JADVKREP     LOCAL ADVERTISER?                            
         BE    ADVR0075            YES -                                        
         CLC   =C'04',JADVKREP     LOCAL ADVERTISER?                            
         BE    ADVR0075            YES -                                        
         CLC   =C'05',JADVKREP     LOCAL ADVERTISER?                            
         BE    ADVR0075            YES -                                        
         CLC   =C'NW',JADVKREP     'NW' ADVERTISER?                             
...
ADVR0020 EQU   *                                                                
         ...
         ST    RF,ADVCTR                                                        
         GOTO1 =A(DISPIPUT),DMCB,(RC),RR=Y                                      
         CLC   JADVKADV(4),LASTADV SAME CODE AGAIN?                             
         BE    ADVR0080                                                         
         CLC   JADVKADV(3),LASTADV SAME 1ST THREE CHARS?                        
         BNE   ADVR0040            NO  - NEW CODE                               
         L     RF,ASPECCHR         YES - BUMP A(SPECIAL CHARACTER)              
         LA    RF,1(RF)                                                         
         ST    RF,ASPECCHR         SAVE NEW ADDRESS                             
         CLI   0(RF),0             DELIMITER REACHED?                           
         BNE   ADVR0060            NO  - PROCESS                                
         DC    H'0'                YES - NO MORE SPECIAL CHARACTERS             
ADVR0040 EQU   *                                                                
         LA    RF,SPECCHRS         NEW CODE:  RESET 1ST SPECIAL CHAR            
         ST    RF,ASPECCHR         SAVE A(SPECIAL CHARACTER)                    
ADVR0060 EQU   *                                                                
         MVC   LASTADV,JADVKADV    SAVE ADVERTISER CODE                         
         L     R2,AADVEND          SET A(NEXT SLOT IN ADVERT TABLE)             
         L     R4,ADVCTRTB         CURRENT # OF TABLE ENTRIES                   
         LA    R4,1(R4)            BUMP TABLE COUNTER                           
         ST    R4,ADVCTRTB         SAVE COUNTER                                 
         MVC   0(2,R2),JADVKREP    INSERT REP CODE INTO TABLE                   
         MVC   2(4,R2),JADVKADV    INSERT ORIGINAL ADVERTISER CODE              
         MVC   6(4,R2),JADVKADV    PREP EQUIVALENCY CODE                        
         L     RF,ASPECCHR         SET A(SPECIAL CHAR TO USE)                   
         MVC   9(1,R2),0(RF)       INSERT SPECIAL CHAR OVER LAST                
         CLI   8(R2),C' '          IS THIRD CHARACTER A SPACE?                  
         BNE   ADVR0070            NO  - LEAVE ALONE                            
         MVC   8(1,R2),0(RF)       YES - DOUBLE UP SPECIAL CHARACTER            
ADVR0070 EQU   *                                                                
         MVC   LASTADVN,6(R2)      SAVE NEW CODE FOR INSERT                     
         LA    R2,10(R2)           BUMP TO NEXT SLOT                            
         ST    R2,AADVEND          SAVE A(NEXT SLOT IN ADVERT TABLE)            
         B     ADVR0080                                                         
ADVR0075 EQU   *                                                                
         MVC   LASTADVN,JADVKADV   FORCE LOCAL ADVERTISER CODE TO BE            
*                                     DDS OUTPUT CODE                           
ADVR0080 EQU   *                                                                
         MVC   RADVLEN(2),=X'0064'                                              
         MVI   RADVKTYP,X'08'      INSERT RECORD TYPE                           
         MVC   RADVKADV(4),LASTADVN                                             
*                                  INSERT ADVERT CODE                           
         LA    R1,REPTABLE         DETERMINE OUTPUT REP                         
ADVR0090 EQU   *                                                                
         CLI   0(R1),X'FF'         END OF TABLE?                                
         BNE   *+6                                                              
         DC    H'0'                MUST BE THERE                                
         CLC   JADVKREP,0(R1)      REP IN TABLE?                                
         BE    ADVR0100            YES                                          
         LA    R1,6(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     ADVR0090            GO BACK FOR NEXT                             
ADVR0100 EQU   *                                                                
         ZIC   RF,REPDISP          DISPLACE TO TEST/LIVE REP                    
         AR    R1,RF                                                            
         MVC   RADVKREP,2(R1)      INSERT DDS REP CODE                          
*                                                                               
...
ADVR0120 EQU   *                                                                
         CLI   0(R1),X'FF'         END OF TABLE?                                
         BE    ADVR0160            YES - NOT FOUND - INSERT DEFAULT             
*                                                                               
*   TEST                                                                        
...
*                                                                               
         ...
         BE    ADVR0140            YES - USE VALUE                              
         LA    R1,LCATTABL(R1)     NO  - BUMP TO NEXT ENTRY                     
         B     ADVR0120            GO BACK FOR NEXT                             
ADVR0140 EQU   *                                                                
...
*                                                                               
*                                                                               
*        CLI   QUESTOR+6,C'D'      DISPLAY AGENCY TABLE ONCE?                   
*        BNE   CONR0010            NO                                           
*        MVI   QUESTOR+6,C'Z'      YES - TURN IT OFF                            
*        L     R1,AAGYAREA         SET A(AGENCY TABLE)                          
CONR0000 EQU   *                                                                
*        OC    0(10,R1),0(R1)      ANYTHING IN ENTRY?                           
*        BZ    CONR0010            NO  - FINISHED                               
*        MVC   P+1(10),0(R1)                                                    
*        GOTO1 REPORT                                                           
*        LA    R1,10(R1)           BUMP TO NEXT ENTRY                           
*        B     CONR0000            GO BACK FOR NEXT                             
CONR0010 EQU   *                                                                
         L     RF,CONSREAD         INCREMENT CON COUNTER                        
         LA    RF,1(RF)                                                         
         ST    RF,CONSREAD                                                      
         CLC   =C'03',JCONKREP     LOCAL  CONTRACT?                             
         BE    CONR0020            YES - PROCESS THIS CONTRACT                  
         CLC   =C'04',JCONKREP     LOCAL  CONTRACT?                             
         BE    CONR0020            YES - PROCESS THIS CONTRACT                  
         CLC   =C'05',JCONKREP     LOCAL  CONTRACT?                             
         BE    CONR0020            YES - PROCESS THIS CONTRACT                  
         CLC   =C'NW',JCONKREP     'NW' CONTRACT?                               
         BNE   CONR0960            NO  - SKIP THIS RECORD                       
CONR0020 EQU   *                                                                
         CLC   JCONKAGY(2),=C'$$'  BUDGET ORDER?                                
         BE    CONR0022            YES - SKIP IT                                
         CLC   JCONKADV(2),=C'$$'  DITTO                                        
         BE    CONR0022                                                         
         CLC   JCONKSAL(2),=C'$$'  DITTO                                        
         BNE   CONR0024            YES - DON'T PUT OUT ANY $$ BUCKETS           
CONR0022 EQU   *                                                                
         L     RF,BUDGCTR          COUNT BUDGET ORDERS                          
         LA    RF,1(RF)                                                         
         ST    RF,BUDGCTR                                                       
         B     CONR0960            SKIP THE ORDER                               
CONR0024 EQU   *                                                                
         TM    JCONIND,X'80'       'FORECAST' CONTRACT?                         
         BNO   CONR0030            NO                                           
         L     RF,FORECTR          YES -                                        
         LA    RF,1(RF)                                                         
         ST    RF,FORECTR                                                       
*                                                                               
*   COUNT FORECAST ORDERS, BUT DON'T SKIP THEM!!!                               
*                                                                               
****>>   B     CONR0960            SKIP THIS ORDER                              
CONR0030 EQU   *                                                                
*                                                                               
*   TEST SPECIFIC CONTRACT FILTER                                               
*                                                                               
*        CLC   =C'RENA',JCONKAGY   REGIONAL TO NATIONAL AGENCY?                 
*        BNE   CONR0960            SKIP ALL OTHERS                              
*        CLC   =X'00239371',JCONKCON                                            
*        BE    TCON0001            SKIP ALL OTHERS                              
*        CLC   =X'00258717',JCONKCON                                            
*        BNE   CONR0960            SKIP ALL OTHERS                              
TCON0001 EQU   *                                                                
*   TEST END                                                                    
*                                                                               
...
*                                                                               
*   TEST TRAFFIC NUMBER                                                         
*        CLC   CONCTR,=F'00001'    CHECK FROM ORDER N                           
*        BL    TTRF0200                                                         
*        CLC   CONCTR,=F'05000'       TO ORDER N+50000                          
*        BH    TTRF0200                                                         
*        MVI   JDSELT,X'0E'        GET CONFLICT CODE ELEMENT                    
*        GOTO1 GETJDSEL,DMCB,(RC)                                               
*        BNZ   TTRF0200            NOT FOUND                                    
*        MVC   P+1(09),=C'TRAFFIC?='                                            
*        L     RF,JDSADDR          SET A(JDS ELT)                               
*        L     RE,JDSLEN           SET L(JDS DATA)                              
*        EX    RE,TTRF0020         MOVE BUYER NAME BY LENGTH                    
*        EDIT CONCTR,(5,P+12)                                                   
*        GOTO1 GETJDSNX,DMCB,(RC)                                               
*        BNZ   TTRF0010            NOT FOUND                                    
*        L     RF,JDSADDR          SET A(JDS ELT)                               
*        L     RE,JDSLEN           SET L(JDS DATA)                              
*        EX    RE,TTRF0030         MOVE BUYER NAME BY LENGTH                    
TTRF0010 EQU   *                                                                
*        GOTO1 REPORT                                                           
*        B     TTRF0200                                                         
TTRF0020 EQU   *                                                                
*        MVC   P+20(0),0(RF)       MOVE ELEMENT BY LENGTH                       
TTRF0030 EQU   *                                                                
*        MVC   P+60(0),0(RF)       MOVE ELEMENT BY LENGTH                       
TTRF0200 EQU   *                                                                
*   TEST TRAFFIC END                                                            
*                                                                               
*   TEST                                                                        
...
*        BL    CONR0040            NOT REACHED: DON'T DISPLAY                   
...
CONR0050 EQU   *                                                                
         ...
         BNE   *+6                                                              
         DC    H'0'                MUST BE THERE                                
         CLC   JCONKREP,0(R1)      REP IN TABLE?                                
         BE    CONR0060            YES                                          
         LA    R1,6(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     CONR0050            GO BACK FOR NEXT                             
CONR0060 EQU   *                                                                
         ZIC   RF,REPDISP          DISPLACE TO TEST/LIVE REP                    
         AR    R1,RF                                                            
         MVC   RCONKREP,2(R1)      INSERT DDS REP CODE                          
*                                                                               
...
*        GOTO1 REPORT                                                           
*                                                                               
*   DUMMY GROUP FOR STATION NOT IN TABLE????                                    
*                                                                               
         MVC   RCONKGRP,=C'F '     INSERT DUMMY GROUP/SUBGROUP                  
...
*                                                                               
         CLC   JCONKREP,=C'NW'     INPUT RECORD FOR NEW WORLD?                  
         BNE   CONR0110            NO  - USE CODES DIRECTLY                     
         GOTO1 =A(CONVAGY),DMCB,(RC),RR=Y                                       
*                                  INSERT AGENCY/AGENCY OFFICE                  
         GOTO1 =A(CONVADV),DMCB,(RC),RR=Y                                       
*                                  INSERT ADVERTISER                            
         B     CONR0115                                                         
CONR0110 EQU   *                                                                
         MVC   RCONKAGY(6),JCONKAGY                                             
*                                  INSERT AGENCY+AGY OFFICE DIRECTLY            
         MVC   RCONKADV(6),JCONKADV                                             
*                                  INSERT ADVERTISER DIRECTLY                   
CONR0115 EQU   *                                                                
...
*                                                                               
         ...
         EX    RE,CONR0120         MOVE BUYER NAME BY LENGTH                    
         B     CONR0140                                                         
CONR0120 EQU   *                                                                
...
*                                  BUILD PRODUCT NAME ELEMENT                   
         ...
         GOTO1 GETJDSEL,DMCB,(RC)                                               
         BNZ   CONR0180            NOT FOUND - ADD ELEMENT ANYWAY               
         L     RF,JDSADDR          SET A(JDS ELT)                               
*                                                                               
*   TEST                                                                        
...
CONR0160 EQU   *                                                                
         L     RE,JDSLEN           SET L(JDS DATA)                              
         BCTR  RE,0                DECREMENT BY 1 FOR EX                        
         EX    RE,CONR0220         MOVE PRODUCT NAME BY LENGTH                  
         B     CONR0200                                                         
CONR0180 EQU   *                                                                
...
*                                                                               
*    CONTRACTS WITH JCONIND = X'80' WILL BE GENERATED WITHOUT                   
*        BUCKETS.  THE DOLLARS IN THESE ORDERS ARE NOT USABLE                   
*        WITHIN THE DONOVAN SYSTEM SETUP.                                       
*                                                                               
         MVC   SCONIND,JCONIND     SAVE INDICATOR FIELD FOR                     
*                                     SETTING FORECAST BUCKETS                  
         GOTO1 JDSDATE,DMCB,JCONMODD,RCONMODD,(2,0)                             
*                                                                               
         OI    RCONMODR+1,X'10'    INDICATE 'CONVERTED' ORDER                   
         TM    JCONCNTL,X'40'      PENDING BIT ON?                              
         BO    CONR0260            YES - PENDING                                
         OI    RCONMODR,X'30'      NO  - SET BUY ADDED/NOT PENDING              
CONR0260 EQU   *                                                                
         TM    JCONCNTL,X'40'      PENDING BIT ON?                              
         BO    CONR0280            YES - PENDING                                
...
*        CHAR  1  =  JDS CODE                                                   
*        CHAR  2  =  DDS CODE                                                   
*        IF NOT IN TABLE, SET TO 'SPOT (S)'                                     
*                                                                               
CONTYTAB DC    C'TE'               TAKEOVER                                     
         DC    C'UN'               UNWIRED NETWORK                              
         DC    C'DR'               DIRECT RESPONSE                              
         DC    X'FF',C'S'          DELIMITER/DEFAULT TYPE                       
CONR0400 EQU   *                                                                
         CLC   =C'03',JCONKREP     LOCAL REP?                                   
         BE    CONR0401            YES                                          
         CLC   =C'04',JCONKREP     LOCAL REP?                                   
         BE    CONR0401            YES                                          
         CLC   =C'05',JCONKREP     LOCAL REP?                                   
         BNE   CONR0402            YES                                          
CONR0401 EQU   *                                                                
         MVI   RCONTYPE,0          SET CON TYPE TO 'NONE'                       
         B     CONR0408                                                         
CONR0402 EQU   *                                                                
         LA    R1,CONTYTAB                                                      
CONR0404 EQU   *                                                                
         CLI   0(R1),X'FF'         END OF TABLE?                                
         BE    CONR0406            YES                                          
         CLC   JCONTYPE(1),0(R1)   JDS CONTYPE IN TABLE?                        
         BE    CONR0406            YES                                          
         LA    R1,2(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     CONR0404            GO BACK FOR NEXT                             
CONR0406 EQU   *                                                                
         MVC   RCONTYPE,1(R1)      INSERT CONVERTED CONTRACT TYPE               
*                                     OR DEFAULT TYPE OF 'S'                    
CONR0408 EQU   *                                                                
         MVI   JDSELT,X'05'        GET CATEGORY CODE ELT                        
         GOTO1 GETJDSEL,DMCB,(RC)                                               
         BNZ   CONR0560            NOT FOUND                                    
...
CONR0520 EQU   *                                                                
         CLI   0(R1),X'FF'         END OF TABLE?                                
         BE    CONR0560            YES - NOT FOUND - INSERT DEFAULT             
*                                                                               
*   TEST                                                                        
*        MVC   P+1(08),=C'CAT TAB='                                             
*        MVC   P+9(6),0(R1)        INSERT CATEGORY CAT TABLE ENTRY              
...
*                                                                               
         ...
         BE    CONR0540            YES - USE VALUE                              
         LA    R1,LCATTABL(R1)     NO  - BUMP TO NEXT ENTRY                     
         B     CONR0520            GO BACK FOR NEXT                             
CONR0540 EQU   *                                                                
...
CONR0580 EQU   *                                                                
         ...
         BE    CONR0600            YES - ADD AT END                             
         CLC   2(4,R2),0(RF)       ENTRY ALREADY IN TABLE?                      
         BE    CONR0620            YES - DON'T INSERT AGAIN                     
         LA    RF,4(RF)            NO  - BUMP TO NEXT ENTRY                     
         B     CONR0580            GO BACK AND CHECK NEXT                       
CONR0600 EQU   *                                                                
...
CONR0620 EQU   *                                                                
         ...
         GOTO1 GETJDSEL,DMCB,(RC)                                               
CONR0640 EQU   *                                                                
         BNZ   CONR0760            NOT FOUND                                    
         L     RF,JDSADDR          SET A(JDS ELT)                               
         CLC   =C'A=',2(RF)        AVAIL COMMENT?                               
         BE    CONR0720            YES - SKIP IT                                
...
CONR0680 EQU   *                                                                
         L     RE,JDSLEN           SET L(JDS DATA)                              
         BCTR  RE,0                DECREMENT BY 1 FOR EX                        
         EX    RE,CONR0740         MOVE PRODUCT NAME BY LENGTH                  
...
CONR0720 EQU   *                                                                
         ...
         BCT   R0,CONR0640         GO BACK AND CHECK IF FOUND                   
         B     CONR0760                                                         
CONR0740 EQU   *                                                                
...
*                                                                               
         ...
         BE    CONR0900            YES - DON'T PUT OUT ANY $$ BUCKETS           
CONR0780 EQU   *                                                                
...
CONR0800 EQU   *                                                                
         GOTO1 GETJDSNX,DMCB,(RC)                                               
CONR0820 EQU   *                                                                
         BNZ   CONR0840            NOT FOUND                                    
         TM    SCONIND,X'80'       FORECAST ORDER?                              
         BO    CONR0830            YES - SET TO 'FORECAST BUCKETS'              
         GOTO1 DOLBUCK,DMCB,(RC),(3,0)                                          
*                                  NO  - SET TO ESTIMATE BUCKETS                
         B     CONR0800            GO BACK FOR NEXT ELEMENT                     
CONR0830 EQU   *                                                                
*                                                                               
*   'FORECAST' ORDERS ARE BEING GENERATED WITH NO BUCKETS AT ALL.               
*                                                                               
****>>>  GOTO1 DOLBUCK,DMCB,(RC),(X'23',0)                                      
*                                  SET TO FORECAST BUCKETS                      
         B     CONR0800            GO BACK FOR NEXT ELEMENT                     
CONR0840 EQU   *                                                                
...
CONR0860 EQU   *                                                                
         GOTO1 GETJDSNX,DMCB,(RC)                                               
CONR0880 EQU   *                                                                
         BNZ   CONR0900            NOT FOUND                                    
         GOTO1 DOLBUCK,DMCB,(RC),(4,0)                                          
         B     CONR0860            GO BACK FOR NEXT ELEMENT                     
CONR0900 EQU   *                                                                
...
BSAR0180 EQU   *                                                                
         ...
         B     BSAR0199                                                         
BSAR0181 EQU   *                                                                
         CLI   0(R7),C'M'          DAYPART SWITCH? M -> T                       
         BNE   BSAR0182            NO                                           
...
BSAR0182 EQU   *                                                                
         ...
         B     BSAR0199                                                         
BSAR0183 EQU   *                                                                
         CLI   0(R7),C'H'          DAYPART SWITCH? H -> R                       
         BNE   BSAR0184            NO                                           
         MVI   0(R7),C'R'          YES - SWITCH IT                              
         B     BSAR0199                                                         
BSAR0184 EQU   *                                                                
         CLI   0(R7),C'J'          DAYPART SWITCH? J -> C                       
         BNE   BSAR0185            NO                                           
         MVI   0(R7),C'C'          YES - SWITCH IT                              
         B     BSAR0199                                                         
BSAR0185 EQU   *                                                                
BSAR0199 EQU   *                                                                
...
BUYRPROC NTR1                                                                   
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         MVI   ORIDISP,0           SET 'DISPLAY OVERRIDE' DISPLAY OFF           
         L     RF,BUYSREAD         INCREMENT BUY COUNTER                        
         LA    RF,1(RF)                                                         
         ST    RF,BUYSREAD                                                      
         CLC   =C'03',JBUYKREP     LOCAL BUYLINE?                               
         BE    TBUY0020            YES                                          
         CLC   =C'04',JBUYKREP     LOCAL BUYLINE?                               
         BE    TBUY0020            YES                                          
         CLC   =C'05',JBUYKREP     LOCAL BUYLINE?                               
         BE    TBUY0020            YES                                          
         CLC   =C'NW',JBUYKREP     'NW' BUYLINE?                                
...
*                                                                               
*   TEST                                                                        
*        CLC   JBUYKCON+1(3),=X'755678'       CONTRACT # 244321                 
*        BNE   BUYR0680            SKIP ALL OTHERS                              
*   TEST END                                                                    
*                                                                               
         XCEFL RECORD,1008         CLEAR THE RECORD BUILD AREA                  
...
BUYR0030 EQU   *                                                                
         ...
         BNE   *+6                                                              
         DC    H'0'                MUST BE THERE                                
         CLC   JBUYKREP,0(R1)      REP IN TABLE?                                
         BE    BUYR0035            YES                                          
         LA    R1,6(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     BUYR0030            GO BACK FOR NEXT                             
BUYR0035 EQU   *                                                                
         ZIC   RF,REPDISP          DISPLACE TO TEST/LIVE REP                    
         AR    R1,RF                                                            
         MVC   RBUYKREP,2(R1)      INSERT DDS REP CODE                          
...
*        HOWEVER, THE HIGH-ORDER BYTE, IF CON # < 1,000,000, IS                 
*        BINARY ZERO, RATHER THAN X'00'                                         
*                                                                               
...
*                                                                               
         ...
         CLI   JBUYKCON+0,0        BINARY ZERO FIRST BYTE?                      
*                                     CON # < 1MEG                              
         BNE   BUYR0050            NO  - 1MEG OR GREATER                        
         MVI   JBUYKCON+0,X'99'    SET 1ST BYTE COMPLEMENT                      
BUYR0050 EQU   *                                                                
...
*                                                                               
         ...
         MVC   SAVESTED,JBUYSTED   SAVE START/END FOR EFF DATES                 
...
*                                  SET END DATE TO START                        
         ...
         BNE   BUYR0270            NO  - USE END DATE ENTERED                   
         GOTO1 =A(ENDDATE),DMCB,ELTBILD1+2,(RC),RR=Y                            
*                                  CALCULATE END DATE FOR JDS                   
         B     BUYR0280                                                         
BUYR0270 EQU   *                                                                
...
*                                  TURN OFF HIGH-ORDER 2 BITS                   
         CLC   ELTBILD1+9(1),RBUYNW                                             
*                                  EFF DATE NPW = BUYLINE NPW?                  
         BE    BUYR0305            YES                                          
         OI    ELTBILD1+8,X'01'    NO  - TURN ON NPW OVERRIDE                   
         CLI   ORIDISP,1           DISPLAY OVERRIDE SET 'ON'?                   
         BE    BUYR0305            YES - DON'T ADD SAME BUY > 1 TIME            
         L     RF,BUYORIDE                                                      
         LA    RF,1(RF)                                                         
         ST    RF,BUYORIDE                                                      
         MVI   ORIDISP,1           SET 'DISPLAY OVERRIDE' DISPLAY ON            
BUYR0305 EQU   *                                                                
...
*                                                                               
         MVI   ELTBILD1,4          INSERT ELEMENT TYPE                          
         BCTR  RF,0                DECREMENT FOR MOVE BY LENGTH                 
         CH    RF,=H'59'           MAX LENGTH = 60                              
         BNH   BUYR0445            60 OR LESS                                   
         LA    RF,59               FORCE TO 60 OR LESS                          
BUYR0445 EQU   *                                                                
         EX    RF,BUYR0460         MOVE PROGRAM NAME BY LENGTH                  
         LA    RF,3(RF)            SET LENGTH                                   
         STC   RF,ELTBILD1+1       INSERT LENGTH                                
         GOTO1 HELOBUYC            INSERT ELEMENT W/ERASE, SORTING              
*                                     ON ELEMENT CODE ONLY                      
         BCT   R0,BUYR0420         LOOK FOR ANOTHER COMMENT                     
         B     BUYR0480                                                         
*                                                                               
BUYR0460 MVC   ELTBILD1+2(0),2(RE) MOVE BUY COMMENT BY LENGTH                   
*                                                                               
BUYR0480 EQU   *                                                                
*                                                                               
...
*                                                                               
         ...
         BCTR  RF,0                DECREMENT FOR MOVE BY LENGTH                 
         CH    RF,=H'59'           MAX LENGTH = 60                              
         BNH   BUYR0595            60 OR LESS                                   
         LA    RF,59               FORCE TO 60 OR LESS                          
BUYR0595 EQU   *                                                                
         EX    RF,BUYR0600         MOVE BUY ORDER COMMT BY LENGTH               
         MVI   ELTBILD1+2,X'80'    SET 'REP BUY ORDER COMMENT'                  
         LA    RF,4(RF)            SET ELEMENT LENGTH                           
         STC   RF,ELTBILD1+1       INSERT LENGTH INTO ELEMENT                   
         GOTO1 HELOBUY1            INSERT ELEMENT W/ERASE                       
         BCT   R0,BUYR0560         LOOK FOR ANOTHER COMMENT                     
         B     BUYR0620                                                         
*                                                                               
BUYR0600 MVC   ELTBILD1+3(0),2(RE) MOVE BUY ORD COM BY LENGTH                   
*                                                                               
BUYR0620 EQU   *                                                                
...
*                                                                               
*   TEST                                                                        
*        CLI   ORIDISP,1           DISPLAY OVERRIDE RECORD?                     
*        BNE   TESTB000            NO  - DEPART                                 
**       GOTO1 =A(DISPORYD),DMCB,(RC),RR=Y                                      
TESTB000 EQU   *                                                                
*   TEST END                                                                    
*                                                                               
         B     BUYR0660                                                         
...
HELOREC4 NTR1                                                                   
         ...
         SPACE 3                                                                
HELOBUYC NTR1                                                                   
         GOTO1 =V(HELLO),DMCB,(C'P',=C'REPFILE'),RBUYREC,ELTBILD1,     X        
               =C'ADD=CODE'                                                     
         XC    ELTBILD1,ELTBILD1                                                
         B     HELOEXIT                                                         
         SPACE 3                                                                
...
ASPECCHR DS    A                   A(CURRENT SPECIAL CHARACTER)                 
...
ANEXTMIS DS    A                                                                
AADVAREA DS    A                   ADVERT CONVERSION AREA                       
AADVEND  DS    A                   A(LAST ENTRY IN TABLE)                       
...
ADVCTR   DS    F                                                                
ADVCTRTB DS    F                                                                
LASTADV  DS    CL4                 LAST ADVERTISER CODE                         
LASTADVN DS    CL4                 LAST ADVERTISER CODE EQUIVALENT              
AGYCTRIN DS    F                                                                
AGYCTR   DS    F                                                                
AGYCTRTB DS    F                                                                
LASTAGY  DS    CL4                 LAST AGENCY CODE                             
LASTAGYN DS    CL4                 LAST AGENCY CODE EQUIVALENT                  
AGYCTR2  DS    F                                                                
AGYCTR3  DS    F                                                                
AG2CTR   DS    F                                                                
TSPTCTR  DS    F                                                                
...
BASEYEAR DC    F'91'               BASE YEAR IS UNDETERMINED!!                  
...
SAVESTED DS    CL1                 JDS START/END DAYS                           
SPECCHRS DC    C'#$%=*+!@><()-":'                                               
         DC    X'00'                                                            
*                                                                               
*   REPTABLE  6-BYTE ENTRIES CONSISTING OF:                                     
*        BYTES   1  -  2   =  JDS INPUT REP CODE                                
*        BYTES   3  -  4   =  DDS OUTPUT REP CODE (PRODUCTION)                  
*        BYTES   5  -  6   -  DDS OUTPUT REP CODE (TEST)                        
*                                                                               
REPTABLE DC    C'NWFNV4'           NATIONAL REP 'NEWWORLD'                      
         DC    C'03JAF2'           STATION WJW                                  
         DC    C'04JBF1'           STATION WJBK                                 
         DC    C'05IWF3'           STATION WITI                                 
         DC    X'FFFF'             DELIMITER                                    
REPDISP  DS    CL1                 OFFSET:  PRODUCTION = 0                      
*                                           TEST       = 2                      
ORIDISP  DS    CL1                                                              
*                                                                               
*                                                                               
...
*********************************************************************           
         CSECT                                                                  
*                                                                               
*   ENDDATE:  JDS DOES NOT SUPPLY AN END DATE.  SAVEDATE CONTAINS               
*        DAYS OF WEEK ORDER RUNS.  IF DIFFERENT, END DATE MUST BE               
*        CALCULATED, USING START DATE PLUS # DAYS DIFFERENCE.                   
*        P1  =   ADDR(INPUT DATE)                                               
*                                                                               
ENDDATE  NMOD1 0,*ENDT*                                                         
         L     R2,0(R1)                                                         
         L     RC,4(R1)            RESET A(WORKSPACE)                           
         GOTO1 DATCON,DMCB,(3,ELTBILD1+2),(0,ENDWORK)                           
         ZIC   RF,SAVESTED         GET START DAY                                
         SRL   RF,4                DROP END DAY                                 
         ZIC   RE,SAVESTED         GET END DAY                                  
         SLL   RE,28               SHIFT START DAY OUT                          
         SRL   RE,28               REALIGN END DAY                              
*                                                                               
*   TEST                                                                        
*        ST    RF,ENDTRF                                                        
*        ST    RE,ENDTRE                                                        
*        MVC   P+1(15),=C'START/END DAYS='                                      
*        EDIT  (RF),(2,P+20)                                                    
*        EDIT  (RE),(2,P+24)                                                    
*        GOTO1 REPORT                                                           
*        L     RF,ENDTRF                                                        
...
*   TEST RF/RE END                                                              
*                                                                               
         CR    RF,RE               START DAY VS END DAY:                        
         BE    ENDD0160            SAME - USE START = END DATE                  
         BL    ENDD0020            START BEFORE END (MON VS WED, IE)            
         LA    RE,7(RE)            END BEFORE START (THUR VS MON, IE)           
ENDD0020 EQU   *                                                                
         SR    RE,RF               END DAY - START DAY =                        
*                                     # DAYS DIFFERENCE                         
         ST    RE,DMCB+8           PUT INTO PAR 3                               
         GOTO1 ADDAY,DMCB,ENDWORK,ENDWORK+6,,RR=RELO                            
*                                                                               
*   TEST                                                                        
*        MVC   P+1(15),=C'START/END DATES='                                     
*        MVC  P+20(6),ENDWORK                                                   
*        MVC  P+30(6),ENDWORK+6                                                 
*        GOTO1 REPORT                                                           
*   TEST DATES END                                                              
*                                                                               
         GOTO1 DATCON,DMCB,(0,ENDWORK+6),(3,ELTBILD1+5)                         
...
ENDWORK  DS    CL12                                                             
         ...
         EJECT                                                                  
******************************************************************              
*  DISPORYD:  DISPLAY RECORD WITH NPW OVERRIDE SET.              *              
*                                                                *              
******************************************************************              
*                                                                               
DISPORYD NMOD1 0,*ORYD*                                                         
*                                                                               
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         MVC   P+1(12),=C'BUY OVERRIDE'                                         
         CLC   BUYORIDE,=F'25'                                                  
         BH    DIOV0090                                                         
         MVC   P+14(06),=C'OUTPUT'                                              
         EDIT  BUYORIDE,(4,P+25)                                                
         GOTO1 REPORT                                                           
         LA    R4,RBUYREC          A(RECORD LENGTH FIELD)                       
         SR    RF,RF                                                            
...
******************************************************************              
*                                                                               
STARPROC NMOD1 0,*STAR*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
STAR0005 EQU   *                                                                
         GOTO1 =A(GETTPREC),DMCB,(RC),RR=Y                                      
*                                  UNBLOCK AND DELIVER TAPE REC                 
         BZ    STAR0900            CC = ZERO = END OF FILE                      
         CLC   RECORD2+30(2),=X'0014'                                           
*                                  COMPETITIVE STATION RECORD?                  
         BH    STAR0900            FINISHED                                     
         BNE   STAR0005            NO  - GO BACK FOR NEXT                       
*                                  FOUND - CHECK IT OUT                         
         CLC   =C'03',JSTAKREP     YES - LOCAL STATION?                         
         BE    STAR0010            YES -                                        
         CLC   =C'04',JSTAKREP     LOCAL STATION?                               
         BE    STAR0010            YES -                                        
         CLC   =C'05',JSTAKREP     LOCAL STATION?                               
         BE    STAR0010            YES -                                        
         CLC   =C'NW',JSTAKREP     'NW' STATION?                                
         BNE   STAR0005            NO  - SKIP THIS RECORD                       
STAR0010 EQU   *                                                                
*                                                                               
*   TEST STATION                                                                
...
*                                                                               
         ...
         L     R3,ACMPNXT                                                       
         LA    R3,9(R3)            BUMP TO FIRST COMPETITIVE                    
         MVC   0(2,R2),JSTAKREP    INSERT REP CODE INTO 1ST POSITION            
         MVC   2(4,R2),JSTAKSTA    INSERT REP'D STA                             
         MVC   6(2,R2),JSTAKGRP    INSERT GROUP/SUBGROUP                        
...
*        GOTO1 REPORT                                                           
*   TEST COMP DISPLAY END                                                       
*                                                                               
         LA    R2,65(R2)           BUMP TO NEXT TABLE ENTRY                     
         ST    R2,ACMPNXT                                                       
         B     STAR0005            GO BACK FOR NEXT                             
STAR0900 EQU   *                                                                
         CLOSE INTAPE              CLOSE INPUT FILE                             
         OPEN  (INTAPE,(INPUT))    REOPEN INPUT FILE                            
...
ORDR0010 EQU   *                                                                
         ...
         BE    ORDR0015            YES                                          
         LA    R1,6(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     ORDR0010            GO BACK FOR NEXT                             
ORDR0015 EQU   *                                                                
         ZIC   RF,REPDISP          DISPLACE TO TEST/LIVE REP                    
         AR    R1,RF                                                            
         MVC   KEY+20(2),2(R1)     INSERT DDS REP CODE                          
...
EXCO0280 EQU   *                                                                
         ...
         MVC   SVSENF,RCONSENF                                                  
*                                                                               
         GOTO1 TRAFFIC,DMCB,(R2)   RETRIEVE/SET TRAFFIC NUMBER                  
*                                     IN X'1F' ELEMENT                          
         DROP  R2,R3                                                            
*                                                                               
...
EXCO0360 EQU   *                                                                
         ...
         EJECT                                                                  
TRAFFIC  NTR1                                                                   
         L     R2,0(R1)            RESET A(1F ELEMENT BEING BUILT)              
         LA    R2,ELTBILD1                                                      
         USING RCONXEL,R2          SET THE X'1F' ELT                            
         MVI   JDSELT,X'0E'        GET CONFLICT CODE ELEMENT                    
*                                     LOOKING FOR TRAFFIC CODE                  
         GOTO1 GETJDSEL,DMCB,(RC)                                               
         B     TRAF0040                                                         
TRAF0020 EQU   *                                                                
         GOTO1 GETJDSNX,DMCB,(RC)                                               
TRAF0040 EQU   *                                                                
         BNZ   TRAF0400            NOT FOUND - FINISHED                         
         L     R3,JDSADDR          SET A(JDS ELT)                               
         L     R4,JDSLEN           SET L(JDS DATA)                              
         CLC   2(2,R3),=C'IN'      INDICATOR FOR TRAFFIC CODE?                  
         BNE   TRAF0020            NO  - GO BACK FOR NEXT ELEMENT               
         SH    R4,=H'3'            SUBTRACT 2 FOR 'IN', 1 FOR EX                
         EX    R4,TRAF0600         MOVE TRAFFIC NUMBER BY LENGTH                
TRAF0400 EQU   *                                                                
         XIT1                                                                   
TRAF0600 MVC   RCONTRF(0),4(R3)    JDS TRAFFIC -> DDS TRAFFIC                   
         DROP  R2                                                               
         EJECT                                                                  
         LTORG                                                                  
         EJECT                                                                  
...
AGYRPROC NMOD1 0,*AGYR*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         CLC   =C'03',JAGYKREP     LOCAL  AGENCY?                               
         BE    AGYR0035            YES -                                        
         CLC   =C'04',JAGYKREP     LOCAL  AGENCY?                               
         BE    AGYR0035            YES -                                        
         CLC   =C'05',JAGYKREP     LOCAL  AGENCY?                               
         BE    AGYR0035            YES -                                        
         CLC   =C'NW',JAGYKREP     'NW' AGENCY?                                 
         BNE   AGYR0200            NO  - SKIP THIS RECORD                       
*                                                                               
AGYR0005 EQU   *                                                                
         CLC   JAGYKAGY(4),LASTAGY SAME CODE AGAIN?                             
         BE    AGYR0040                                                         
         CLC   JAGYKAGY(3),LASTAGY SAME 1ST THREE CHARS?                        
         BNE   AGYR0010            NO  - NEW CODE                               
         L     RF,ASPECCHR         YES - BUMP A(SPECIAL CHARACTER)              
         LA    RF,1(RF)                                                         
         ST    RF,ASPECCHR         SAVE NEW ADDRESS                             
         CLI   0(RF),0             DELIMITER REACHED?                           
         BNE   AGYR0020            NO  - PROCESS                                
         DC    H'0'                YES - NO MORE SPECIAL CHARACTERS             
AGYR0010 EQU   *                                                                
         LA    RF,SPECCHRS         NEW CODE:  RESET 1ST SPECIAL CHAR            
         ST    RF,ASPECCHR         SAVE A(SPECIAL CHARACTER)                    
AGYR0020 EQU   *                                                                
         MVC   LASTAGY,JAGYKAGY    SAVE AGENCY CODE                             
         L     R2,AAGYEND          SET A(NEXT SLOT IN AGENCY TABLE)             
         L     R4,AGYCTRTB         CURRENT # OF TABLE ENTRIES                   
         LA    R4,1(R4)            BUMP TABLE COUNTER                           
         ST    R4,AGYCTRTB         SAVE COUNTER                                 
         MVC   0(2,R2),JAGYKREP    INSERT REP CODE INTO TABLE                   
         MVC   2(4,R2),JAGYKAGY    INSERT ORIGINAL AGENCY CODE                  
         MVC   6(4,R2),JAGYKAGY    PREP EQUIVALENCY CODE                        
         L     RF,ASPECCHR         SET A(SPECIAL CHAR TO USE)                   
         MVC   9(1,R2),0(RF)       INSERT SPECIAL CHAR OVER LAST                
         CLI   8(R2),C' '          IS THIRD CHARACTER A SPACE?                  
         BNE   AGYR0030            NO  - LEAVE ALONE                            
         MVC   8(1,R2),0(RF)       YES - DOUBLE UP SPECIAL CHARACTER            
AGYR0030 EQU   *                                                                
         MVC   LASTAGYN,6(R2)      SAVE EQUIVALENT AGENCY CODE                  
         LA    R2,10(R2)           BUMP TO NEXT SLOT                            
         ST    R2,AAGYEND          SAVE A(NEXT SLOT IN AGENCY TABLE)            
         B     AGYR0040                                                         
AGYR0035 EQU   *                                                                
         MVC   LASTAGYN,JAGYKAGY   FORCE LOCAL AGY CODE INTO PRIMER             
*                                     AREA:  LOCALS WILL USE OWN CDS            
*                                                                               
AGYR0040 EQU   *                                                                
         GOTO1 =A(DISPIPUT),DMCB,(RC),RR=Y                                      
...
*                                                                               
         ...
         MVC   RAGYKAGY(4),LASTAGYN                                             
*                                  INSERT AGENCY                                
*                                     AS EQUIVALENCY AGENCY CODE                
         MVC   RAGYKAOF,JAGYKAOF   INSERT ORIGINAL AGY/OFF CODE                 
         LA    R1,REPTABLE         DETERMINE OUTPUT REP                         
AGYR0042 EQU   *                                                                
         CLI   0(R1),X'FF'         END OF TABLE?                                
         BNE   *+6                                                              
         DC    H'0'                MUST BE THERE                                
         CLC   JAGYKREP,0(R1)      REP IN TABLE?                                
         BE    AGYR0044            YES                                          
         LA    R1,6(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     AGYR0042            GO BACK FOR NEXT                             
AGYR0044 EQU   *                                                                
         ZIC   RF,REPDISP          DISPLACE TO TEST/LIVE REP                    
         AR    R1,RF                                                            
         MVC   RAGYKREP,2(R1)      INSERT DDS REP CODE                          
*                                                                               
...
*                                                                               
         ...
         L     RF,AGYCTR2          INCREMENT AGENCY OUTPUT COUNT                
         LA    RF,1(RF)                                                         
         ST    RF,AGYCTR2                                                       
*                                                                               
         ...
         BE    AGYR0060            YES                                          
         CLI   QUESTOR+6,C'C'      DISPLAY AGY I/P + NEW O/P?                   
         BNE   AGYR0080            NO                                           
AGYR0060 EQU   *                                                                
...
*                                  INSERT ELT CODE/LENGTH                       
         MVC   RAGY2EQU,JAGYKAGY   INSERT ORIGINAL AGENCY CODE                  
         MVC   RAGY2EQO,JAGYKAOF   INSERT ORIGINAL AGENCY OFFICE CODE           
...
*        OUTPUT.  IF NOT FOUND, ABORT:  VALUES MUST BE IN TABLE FROM            
*        CONVERSION OF THE AGENCY RECORDS.                                      
*                                                                               
         DS    0F                                                               
CONVAGY  NMOD1 0,*CAGY*                                                         
         ...
         L     R4,AGYCTRTB         CURRENT # OF TABLE ENTRIES                   
         MVC   COVAWORK(2),JCONKREP                                             
         MVC   COVAWORK+2(4),JCONKAGY                                           
*                                  BUILD TABLE SEARCH ARGUMENT                  
*                                                                               
         GOTO1 =V(BINSRCH),DMCB,COVAWORK,(R2),(R4),10,6,10000,RR=RELO           
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
         BE    COVA0020            YES                                          
         DC    H'0'                AGENCY RECORD MUST BE FOUND                  
*                                                                               
COVA0020 EQU   *                                                                
         ZICM  R2,DMCB+1,3         SET A(TABLE ENTRY FOUND)                     
         MVC   RCONKAGY(4),6(R2)   INSERT AGENCY/AGY OFF FROM TABLE             
         MVC   RCONKAOF(2),JCONKAOF                                             
*                                  INSERT AGENCY OFFICE FROM RECORD             
         XIT1                                                                   
COVAWORK DS    CL6                                                              
         EJECT                                                                  
*                                                                               
*  CONVADV:  FIND ADVERT IN CONVERSION LIST.  USE CONVERSION VALUE AS           
*        OUTPUT.                                                                
*                                                                               
         DS    0F                                                               
CONVADV  NMOD1 0,*CADV*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         L     R2,AADVAREA         SET A(ADVERT TABLE)                          
         L     R4,ADVCTRTB         CURRENT # OF TABLE ENTRIES                   
         MVC   COADWORK(2),JCONKREP                                             
         MVC   COADWORK+2(4),JCONKADV                                           
*                                  BUILD TABLE SEARCH ARGUMENT                  
*                                                                               
         GOTO1 =V(BINSRCH),DMCB,COADWORK,(R2),(R4),10,6,10000,RR=RELO           
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
         BE    CODV0020            YES                                          
         DC    H'0'                ADVERT RECORD MUST BE FOUND                  
*                                                                               
CODV0020 EQU   *                                                                
         ZICM  R2,DMCB+1,3         SET A(TABLE ENTRY FOUND)                     
         MVC   RCONKADV(4),6(R2)   INSERT ADVERT FROM TABLE                     
         XIT1                                                                   
COADWORK DS    CL6                                                              
         EJECT                                                                  
*                                                                               
...
MIST0060 EQU   *                                                                
         ...
         MVC   4(2,RF),JCONKREP    LOAD REP CODE TO TABLE                       
         L     RF,MISSTAT                                                       
         LA    RF,1(RF)                                                         
...
COMPELEM NMOD1 0,*COMP*                                                         
         ...
         MVC   STAWORK(2),JCONKREP                                              
         MVC   STAWORK+2(4),JCONKSTA                                            
         MVC   STAWORK+6(2),JCONKGRP                                            
*                                                                               
*   SEARCH TABLE FOR STATION + GROUP/SUBGROUP                                   
*                                                                               
         GOTO1 =V(BINSRCH),DMCB,STAWORK,(R2),(R4),65,8,200,RR=RELO              
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
         BE    COMP0010            YES                                          
...
COMP0010 EQU   *                                                                
         ZICM  R2,DMCB+1,3         SET A(TABLE ENTRY FOUND)                     
*                                    A(REP'D STATION IN LIST)                   
         LA    R2,2(R2)            SKIP OVER REP CODE IN TABLE ENTRY            
...
*                                                                               
         ...
         OC    0(7,R2),0(R2)       ANYTHING IN FIELD?                           
         BNZ   COMP0070            YES                                          
         S     R2,=F'7'            NO  - STAY AT LAST ENTRY                     
         B     COMP0070                                                         
COMP0050 EQU   *                                                                
...
COMP0400 EQU   *                                                                
         ...
         EJECT                                                                  
*                                                                               
*   COMPCOMT:  RETRIEVE JDS 03 ELEMENT, CONSTRUCT UP TO TWELVE                  
*        COMPETITIVE COMMENT ELEMENTS                                           
*                                                                               
COMPCOMT NTR1  0,*COMT*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         LA    R0,12               SET LOOP CONTROL: 12 MAX                     
...
*        THIS CONTRACT NUMBER.  SPL COMMENTS ARE IN COMPETITIVE COMMENT         
*        RECORD AS X'03' ELEMENTS.                                              
*        IF FOUND, ADD X'03' COMMENTS TO THE RECORD AS X'07' ELEMENTS.          
...
*           IF COMMENT RECORD IS FOUND, AND ORDER IS PENDING, ADD               
*        COMMENTS TO THE RECORD AS TYPE 11 ELEMENTS.                            
*           IF COMMENT RECORD IS FOUND, AND ORDER IS NOT PENDING, ADD           
*        COMMENTS TO THE RECORD AS TYPE 07 ELEMENTS.                            
...
SRCM0020 EQU   *                                                                
         ...
         MVI   0(R5),X'11'         YES - CHANGE ITS IDENTIFIER TO               
*                                     ACTIVITY COMMENT                          
         TM    JCONCNTL,X'40'      IS ORDER PENDING?                            
         BO    SRCM0030            YES - LEAVE AS X'11'                         
         MVI   0(R5),X'07'         NO  - CHANGE ITS IDENTIFIER TO               
*                                     INCOMPLETE 'SPL' COMMENT                  
SRCM0030 EQU   *                                                                
         GOTO1 =V(HELLO),DMCB,(C'P',=C'REPFILE'),RCONREC,(R5),         X        
               =C'ADD=CODE'                                                     
*                                  ADD FROM COMMENT RECORD                      
...
*                                  AGY RECORD?                                  
         BNE   DIPI0090            YES                                          
         CLI   QUESTOR+6,C'6'      DISPLAY AGENCY   INPUT?                      
...
*                                                                               
         ...
         GOTO1 REPORT                                                           
         MVC   P+1(24),=C'FORECASTS RECOGNIZED   :'                             
         EDIT  FORECTR,(12,P+30),COMMAS=YES                                     
         GOTO1 REPORT                                                           
         MVC   P+1(24),=C'BUDGET CONTRCTS SKIPPED:'                             
         EDIT  BUDGCTR,(12,P+30),COMMAS=YES                                     
         GOTO1 REPORT                                                           
         ...
         GOTO1 REPORT                                                           
         MVC   P+1(24),=C'AGENCY RECS GENERATED  :'                             
         EDIT  AGYCTR2,(12,P+30),COMMAS=YES                                     
         GOTO1 REPORT                                                           
         MVC   P+1(24),=C'AGENCY2 RECS GENERATED :'                             
         ...
         GOTO1 REPORT                                                           
         MVC   P+1(24),=C'BUYS WITH OVERRIDES    :'                             
         EDIT  BUYORIDE,(12,P+30),COMMAS=YES                                    
         GOTO1 REPORT                                                           
*                                                                               
         GOTO1 REPORT                                                           
         TIME  DEC                 RETRIEVE TIME: R0 AS HH:MM:SS:TT             
...
*                                                                               
         ...
         BZ    SSPS0040            NO  - EXIT                                   
SSPS0020 EQU   *                                                                
         MVC   P+1(2),0(R2)        DISPLAY JDS REP CODE                         
         MVC   P+6(4),2(R2)        DISPLAY JDS CODE                             
         MVC   P+11(2),6(R2)       DISPLAY JDS DIV/TEAM                         
         MVC   P+14(2),8(R2)       DISPLAY JDS OFFICE                           
         MVC   P+20(3),10(R2)      DISPLAY DDS CODE                             
         MVC   P+24(2),13(R2)      DISPLAY DDS DIV/TEAM                         
         MVC   P+27(2),15(R2)      DISPLAY DDS OFFICE                           
         GOTO1 REPORT                                                           
         LA    R2,18(R2)           BUMP TO NEXT ENTRY                           
...
*                                  INSERT TODAY'S DATE AS JOINED                
         ...
         MVC   RSTAGRUP,=C'F '     INSERT GROUP/SUBGROUP                        
...
GENS0130 EQU   *                                                                
         ...
         BNE   *+6                                                              
         DC    H'0'                MUST BE THERE                                
         CLC   4(2,R7),0(R1)       REP IN TABLE?                                
         BE    GENS0140            YES                                          
         LA    R1,6(R1)            NO  - BUMP TO NEXT ENTRY                     
         B     GENS0130            GO BACK FOR NEXT                             
GENS0140 EQU   *                                                                
         ZIC   RF,REPDISP          DISPLACE TO TEST/LIVE REP                    
         AR    R1,RF                                                            
         MVC   RSTAKREP,2(R1)      INSERT DDS REP CODE INTO RECORD              
...
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
*                                                                               
*   TREAT ALL AS NO-FIND:  GENERATE NEW CODE                                    
*                                                                               
         B     TEMC0040            NO  - GENERATE NEW CODE                      
...
SALCONV  NMOD1 0,**SPCV**                                                       
         ...
         XC    WORK2(18),WORK2     CLEAR THE WORK AREA                          
         MVC   WORK2+0(2),JCONKREP CONSTRUCT SEARCH ARGUMENT                    
         MVC   WORK2+2(4),JCONKSAL                                              
         MVC   WORK2+6(2),JCONKDIV     SAL/DIVTEAM/OFF                          
         MVC   WORK2+8(2),JCONKOFF                                              
*                                                                               
         GOTO1 =V(BINSRCH),DMCB,WORK2,(R2),(R4),18,10,2000,RR=RELO              
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
         BNE   SPCV0040            NO  - GENERATE NEW CODE                      
*                                  YES - USE CODE FROM TABLE                    
         ZICM  R2,DMCB+1,3         SET A(TABLE ENTRY FOUND)                     
         MVC   RCONSAL(3),10(R2)   INSERT S/P FROM TABLE                        
         MVC   RCONKOFF(2),15(R2)  INSERT S/P OFFICE FROM TABLE                 
         CLC   RCONKOFF,=C'DT'     NEWORLD 'DETROIT'?                           
         BNE   SPCV0100            NO  - FINISHED                               
         CLC   =C'NW',JCONKREP     NEWORLD IN PROCESS?                          
         BNE   SPCV0100            NO  - LEAVE IT AS 'DT'                       
         MVC   RCONKOFF,=C'DE'     YES - SET TO DDS 'DETROIT'                   
         B     SPCV0100            FINISHED                                     
SPCV0040 EQU   *                                                                
...
*                                                                               
         ...
         GOTO1 =V(BINSRCH),DMCB,WORK2,(R2),(R4),52,10,3000,RR=RELO              
*                                                                               
...
SNEW0040 EQU   *                                                                
         ...
         LA    R7,1(R7)                                                         
         GOTO1 REPORT                                                           
         LA    R2,52(R2)           BUMP TO NEXT ENTRY                           
...
SNEW0120 EQU   *                                                                
         ZICM  R2,DMCB+1,3         SET A(TABLE ENTRY FOUND)                     
         MVC   NAMESAVE(30),10(R2) SAVE NAME FROM TABLE                         
         MVC   TELESAVE(12),40(R2) SAVE TELEPHONE NUMBER FROM TABLE             
*                                                                               
SNEW0160 EQU   *                                                                
...
*                                  LOAD ALPHA TABLE                             
         B     SNEW0360                                                         
SNEW0240 EQU   *                                                                
         LA    R3,10(R2)           SET A(1ST CHAR OF NAME)                      
...
*                                                                               
         ...
         LA    R4,NAMEWORK+2                                                    
SNEW0400 EQU   *                                                                
         MVC   CODEWORK+0(2),RCONKREP                                           
         MVC   CODEWORK+2(1),0(R2)   BUILD CODE FROM LETTERS                    
         MVC   CODEWORK+3(1),0(R3)                                              
         MVC   CODEWORK+4(1),0(R4)                                              
*                                                                               
...
*                                                                               
*   TEST                                                                        
*        MVC   P+1(08),=C'SEEKING:'                                             
*        MVC   P+10(5),CODEWORK                                                 
*        GOTO1 REPORT                                                           
*        L     R1,A2SPAREA                                                      
*        MVC   P+1(09),=C'2ND TABLE'                                            
*        GOTO1 REPORT                                                           
TESTS010 EQU   *                                                                
*        OC    0(5,R1),0(R1)       ANY ENTRY?                                   
*        BZ    SNEW0440            NO                                           
*        MVC   P+1(05),0(R1)                                                    
*        GOTO1 REPORT                                                           
*        LA    R1,5(R1)                                                         
...
SNEW0440 EQU   *                                                                
         ...
         GOTO1 =V(BINSRCH),DMCB,(1,CODEWORK),(R6),(R7),5,5,6000,RR=RELO         
*                                                                               
*                                  MAX TABLE ENTRIES MAY CHANGE                 
         CLI   DMCB,0              RECORD FOUND?                                
...
*                                                                               
         ...
         MVC   RCONSAL,CODEWORK+2  INSERT CODE INTO RECORD                      
         MVC   RCONKOFF,JCONKOFF   INSERT OFFICE INTO RECORD                    
         CLC   RCONKOFF,=C'DT'     NEWORLD 'DETROIT'?                           
         BNE   SNEW0450            NO                                           
         CLC   =C'NW',JCONKREP     NEWORLD IN PROCESS?                          
         BNE   SNEW0450            NO  - LEAVE IT AS 'DT'                       
         MVC   RCONKOFF,=C'DE'     YES - SET DDS 'DETROIT'                      
SNEW0450 EQU   *                                                                
*                                                                               
         MVC   WORK2+10(3),CODEWORK+2                                           
*                                  INSERT NEW CODE INTO TABLE                   
***>>>   MVC   WORK2+13(2),JCONKDIV INSERT DIVISION/TEAM                        
         MVC   WORK2+13(2),=C'T '   FORCE DIV/TEAM TO 'T '                      
         MVC   WORK2+15(2),JCONKOFF INSERT OFFICE                               
*                                                                               
*   TEST                                                                        
...
*                                  INSERT INTO EQUIV TABLE                      
         ...
         GOTO1 =V(BINSRCH),DMCB,(1,WORK2),(R6),(R7),18,10,2000,RR=RELO          
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
...
*        LA    R6,18(R6)           BUMP TO NEXT TABLE ENTRY                     
*        BCT   R7,SNEW0480                                                      
*   TEST END                                                                    
*                                                                               
         DC    H'0'                DUMP                                         
...
*                                                                               
         ...
         MVC   RSALKSAL,CODEWORK+2 INSERT SALESPERSON CODE                      
...
INIT0020 EQU   *                                                                
         ...
         A     RF,=F'100000'       SAVE ROOM FOR 10000 ENTRIES                  
*                                  2 CHARS REP CODE                             
*                                  4 CHARS ORIGINAL                             
*                                  4 CHARS EQUIVALENT                           
         ST    RF,AADVAREA         SET A(ADVERT AREA)                           
         ST    RF,AADVEND          SET A(NEXT ADVERT)                           
         A     RF,=F'200000'       SAVE ROOM FOR 20000 ENTRIES                  
*                                  2 CHARS REP CODE                             
*                                  4 CHARS ORIGINAL                             
*                                  4 CHARS EQUIVALENT                           
...
*        (2 + (7 X 9)) X 200  =  13000                                          
*                                                                               
         A     RF,=F'13000'        SIZE OF STA COMPETITIVE TABLE                
...
*                                                                               
*   LEAVE SUFFICIENT SPACE IN NATIONAL S/P TABLE FOR 2,000 ENTRIES.             
*        EACH ENTRY:  (18 CHARS)                                                
*        2 CHARS:  JDS REP CODE                                                 
*        4 CHARS:  JDS CODE                                                     
...
*        TABLE FOR 6000 ENTRIES: 30,000 BYTES                                   
*        2 BYTES  =  REP CODE                                                   
*        3 BYTES  =  S/P CODE                                                   
         A     RF,=F'30000'                                                     
*                                                                               
...
*        OF 52 CHARS EACH:                                                      
*        CHARS 1 - 2 :  JDS REP CODE                                            
*        CHARS 3 - 10:  JDS S/P CODE - DIV/TEAM - OFFICE                        
*        CHAR  11- 40:  JDS S/P NAME (1ST 30 CHARS)                             
*        CHAR  41- 52:  JDS S/P TELEPHONE NUMBER                                
*                                                                               
...
*                                  SAVE OUTPUT LOCAL REP                        
         MVI   REPDISP,2           DISPLACE TO TEST O/P REP                     
         CLI   QRECORD+70,C'L'     LIVE RUN?                                    
         BNE   INIT0040            NO                                           
         MVI   REPDISP,0           YES - DISPLACE TO LIVE O/P REP               
INIT0040 EQU   *                                                                
...
STAT0070 EQU   *                                                                
         ...
         BE    STAT0080            YES                                          
         LA    R2,2(R2)            NO  - BUMP TO NEXT REP                       
         CLI   0(R2),0             ANY ENTRY IN TABLE?                          
         BE    STAT0800            NO  - ALL REPS SCANNED: FINISHED             
         B     STAT0020            GO BACK AND DO REP                           
STAT0080 EQU   *                                                                
...
*   THIS MUST BE CHANGED FOR THE LIVE RUN, TO BRING IN THE S/PS                 
*      FROM THE ACTUAL COMPANIES!!                                              
*                                                                               
*TAREPS  DC    C'V4'               NEW WORLD (TEST)                             
*        DC    C'01'               LOCAL STATION: WJW                           
*        DC    C'02'               LOCAL STATION: WJBK                          
*        DC    C'03'               LOCAL STATION: WITI                          
*        DC    X'0000'                                                          
STAREPS  DC    C'FN'               NEW WORLD (PRODUCTION)                       
*        DC    C'JA'               LOCAL STATION: WJW                           
*        DC    C'JB'               LOCAL STATION: WJBK                          
*        DC    C'IW'               LOCAL STATION: WITI                          
         DC    X'0000'                                                          
*                                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         MVI   17(R3),1            STUFF FIRST ENTRY WITH MISCELL               
         MVI   04(R4),1            STUFF FIRST ENTRY WITH MISCELL               
         LA    R3,18(R3)           BUMP TO 2ND ENTRY OF S/P TABLE               
         LA    R4,05(R4)           BUMP TO 2ND ENTRY OF 2ND S/P TAB             
...
SALT0060 EQU   *                                                                
         ...
         GOTO1 GREC1               RETRIEVE RECORD                              
         MVC   0(2,R4),RSALKREP    INSERT REP CODE INTO 2ND S/P TABLE           
         MVC   2(3,R4),RSALKSAL    INSERT SALESPERSON CODE INTO                 
*                                     2ND S/P TABLE                             
         LA    R4,5(R4)            BUMP TO NEXT POSITION                        
*                                     OF SECOND TABLE                           
         L     RF,SP2CTR                                                        
...
*                                                                               
*   NO EQUIVALENCIES ARE PERMITTED.  DON'T INSERT INTO FIRST TABLE.             
*                                                                               
         B     SALT0040            NO  - SKIP THIS RECORD                       
***>>>   BZ    SALT0040            NO  - SKIP THIS RECORD                       
*                                                                               
*   NEED ORIGINAL JDS REP CODE IN POS 1-2 HERE                                  
*                                                                               
         MVC   2(8,R3),RSALEQU     INSERT SP/DIV-TEAM/OFFICE                    
*                                  INSERT ORIGINAL SALESPERSON CODE             
         MVC   10(3,R3),RSALKSAL   INSERT SALESPERSON CODE                      
         MVC   13(2,R3),RSALTEAM   INSERT NEW SALESPERSON DIV/TEAM              
         MVC   15(2,R3),RSALOFF    INSERT NEW SALESPERSON OFFICE                
...
SALT0115 EQU   *                                                                
         ...
         LA    R3,18(R3)           BUMP SALSPERSON TABLE ADDR                   
         L     RF,SALCTR           INCREMENT COUNTER                            
         LA    RF,1(RF)                                                         
         ST    RF,SALCTR                                                        
         B     SALT0040            GO BACK FOR NEXT SALESPERSON                 
SALT0120 EQU   *                                                                
         MVC   0(5,R4),=X'FFFFFF'  FLAG LAST ENRY IN 2ND TABLE                  
...
*                                  SORT TABLE OF EQUIV S/P CODES                
         GOTO1 =V(QSORT),DMCB,(R2),(R3),18,10,0                                 
...
SALT0200 EQU   *                                                                
         MVC   P+1(03),=C'S/P'                                                  
         MVC   P+5(18),0(R2)       MOVE TABLE ENTRY                             
         GOTO1 REPORT                                                           
         LA    R2,18(R2)                                                        
         OC    0(18,R2),0(R2)      ANY ENTRY?                                   
         BNZ   SALT0200            YES                                          
...
SALT0220 EQU   *                                                                
         MVC   P+1(03),=C'2ND'                                                  
         MVC   P+5(05),0(R2)       MOVE TABLE ENTRY                             
         GOTO1 REPORT                                                           
         LA    R2,05(R2)                                                        
         OC    0(05,R2),0(R2)      ANY ENTRY?                                   
         BNZ   SALT0220            YES                                          
         GOTO1 REPORT              NO  - PUT OUT A BLANK                        
SALT0240 EQU   *                                                                
*                                                                               
...
AGYTABLE EQU   *                                                                
         ...
         GOTO1 REPORT                                                           
*                                                                               
         B     AGYT0400            DON'T LOAD ANYTHING HERE!!                   
*                                                                               
         LA    RF,RECORD           SET A(IO AREA FOR PROCEDURE)                 
         ST    RF,AIOAREA                                                       
AGYT0020 EQU   *                                                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'190REREPP102A05/01/02'                                      
         END                                                                    
