*          DATA SET ACREP6102S AT LEVEL 062 AS OF 11/24/99                      
*PHASE AC6102A,+0                                                               
*INCLUDE HEXIN                                                                  
*INCLUDE ACASOF                                                                 
*                                                                               
...
AGEIT20  CLC   POSTDATE,0(R5)                                                   
         BNH   AGEIT30                                                          
*                                                                               
         LA    R5,2(R5)            GET PREVOIUS BUCKET                          
         SH    R2,=Y(BUCKLN)                                                    
         BCT   R3,AGEIT20                                                       
*                                                                               
...
*                                                                               
         ...
         B     EST1A               NO ACSTSTAT, OFFICE PRINTS W/PROD            
*                                                                               
EST1     MVC   STATUS+3(1),ACPRBILL BILL TYPE                                   
         L     R2,ADACCSTA                                                      
         USING ACSTATD,R2                                                       
         TM    ACSTSTAT,X'40'                                                   
         BZ    *+8                                                              
...
*                                                                               
         ...
         MVI   HALF,C'N'                                                        
*                                                                               
EST2     CLI   JBCOLTYP,JBCOLTWC                                                
         BE    EST3                                                             
         AH    R3,JBLCOL                                                        
         BCT   R1,EST2                                                          
         B     *+8                                                              
*                                                                               
EST3     MVI   HALF,C'Y'           YES, WE HAVE AN ESTIMATE                     
*                                                                               
EST6     CP    DOUBLE,=P'0'                                                     
         BE    EST7                                                             
*                                                                               
         ...
         BNE   EST7                NO                                           
*                                                                               
EST6A    SRP   DOUBLE,64-2,5       ROUND OUT PENNIES                            
         EDIT  (P8,DOUBLE),(6,STATUS+6)                                         
*                                                                               
EST7     EQU   *                   CHECK ESTIMATE OPTION ON REQCARD             
         ...
         BE    EST9                ONLY JOBS WITH HIGHER UNAPP REVS             
*                                                                               
EST8     CLI   JBNEWEST,C'Y'       IS JOB ON NEW ESTIMATES                      
         BNE   EST8B               NO                                           
...
EST8B    EQU   *                                                                
         ...
         CLI   HALF,C'Y'           HAVE AN ESTIMATE                             
         BNE   EST8C               NO, CANT BE UNAPPROVED                       
         OI    ESTSTAT,HAVENEST                                                 
EST8C    CLI   GONEEDES,C'Y'       DOES THIS JOB NEED AN ESTIMATE?              
         BNE   EST8D                                                            
         OI    ESTSTAT,NEEDNEST                                                 
EST8D    L     R4,ADACC            JOB USES OLD ESTIMATE                        
         MVI   ELCODE,X'26'        GET JOB ELEMENT                              
         BAS   RE,GETEL            IS IT UPAPPROVED                             
         BE    *+6                                                              
         DC    H'0'                                                             
         CLI   ACJBLEN,X'17'       IS EL LONG ENUF TO HAVE UPAPP BIT            
         BNE   EST8E               NO, ITS APPROVED                             
         TM    ACJBSTAT,X'80'      DOES JOB HAVE AN UNAPPROVED EST              
         BNO   EST8E               NO                                           
         OI    ESTSTAT,ESTUNAPP                                                 
*                                                                               
EST8E    LA    R4,ESTTAB                                                        
EST8F    CLC   0(1,R4),ESTSTAT     PATTERN MATCH ON TABLE                       
         BNE   EST8G                                                            
         CLC   1(1,R4),QOPT3       IS THIS THE PATTERN THEY WANT                
         BE    XIT                 YES                                          
         B     ESTX                NO                                           
EST8G    LA    R4,L'ESTTAB(R4)                                                  
         B     EST8F                                                            
*                                                                               
EST9     CLI   JBNEWEST,C'Y'                                                    
         BNE   ESTX                                                             
         CLI   GONEEDAE,C'Y'                                                    
         BNE   ESTX                                                             
         CLI   JBHIAPP,0                                                        
...
PROFLAG  DS    CL1                                                              
*                                                                               
MNTH1    DS    CL2              X'YYMM' MONTH OF SERVICE                        
MNTH2    DS    CL2                                                              
MNTH3    DS    CL2                                                              
MNTH4    DS    CL2                                                              
*                                                                               
...
JBLOCKD  DSECT                                                                  
       ++INCLUDE ACJOBBLOCK                                                     
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'062ACREP6102S11/24/99'                                      
         END                                                                    
