*          DATA SET RESFM41    AT LEVEL 043 AS OF 09/18/02                      
*          DATA SET RESFM41A   AT LEVEL 001 AS OF 09/24/99                      
*PHASE T81841A,*                                                                
*INCLUDE REGENBUC                                                               
         TITLE 'T81841 - RESFM41 - CONTRACT TAKEOVER SCROLLER'                  
*                                                                               
*******************************************************************             
*                                                                 *             
*        RESFM41 (T81841) --- CONTRACT TAKEOVER SCROLLER          *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
*                                                                 *             
...
*                                                                 *             
* SEP24/99 (BU ) --- HISTORY  PROCESSING                          *             
*                    UPGRADE:  NO DATE CUTS                       *             
*                              EXACT PACING                       *             
*                              NO PAPERWORK                       *             
*                              PROFILE CONTROLLED                 *             
*                                                                 *             
* OCT22/99 (BU ) --- PERMIT CONTYPE N/X TAKEOVERS                 *             
*                    RESTRICT TAKEOVERS TO STATIONS/FROM-TO REPS  *             
*                                                                 *             
* JUL05/00 (BU ) --- REMOVE REFERENCES TO GLV1GOTO PER MEL H.     *             
*                                                                 *             
* SEP18/02 (BU ) --- ADD 'BF' KEY FOR CODESWIT                    *             
*                                                                 *             
*                                                                 *             
*                    ***  END TOMBSTONE  ***                      *             
*******************************************************************             
...
*        PERMIT MOVEMENT                                                        
*                                                                               
         CLI   HISTTAKE,C'Y'       HISTORY TAKEOVER?                            
         BE    VKEY0140            YES - SKIP THIS CHECK                        
...
LIST0060 EQU   *                                                                
         ...
         BNE   LIST0070            NO                                           
*                                                                               
*   FIND STATION IN TABLE:  CHECK SOURCE/TARGET REPS                            
*                                                                               
         LA    R2,CTOSTAH          SET CURSOR RETURN POSITION                   
         LA    RF,LISTSTA                                                       
LIST0062 EQU   *                                                                
         CLI   0(RF),0             END OF TABLE                                 
         BE    STABARRS            YES - NOT CLEARED FOR TRANSFER               
         CLC   0(4,RF),SRCESTAT    STATION IN TABLE?                            
         BE    LIST0064            YES - CHECK OLD/NEW REPS                     
         LA    RF,LLISTSTA(RF)     NO  - BUMP TO NEXT ENTRY                     
         B     LIST0062                                                         
LIST0064 EQU   *                                                                
         CLC   4(2,RF),SRCEREP     OLD REP = OLD REP?                           
         BNE   STABARRS            NO  - DON'T PERMIT TRANSFER                  
         CLC   6(2,RF),TARGREP     NEW REP = NEW REP?                           
         BE    LIST0080            YES - ACCEPT                                 
         CLC   =C'WNNE',SRCESTAT   SPECIAL TEST STATION?                        
         BNE   STABARRS            NO  - DON'T PERMIT TRANSFER                  
         CLC   =C'4S',TARGREP      SPECIAL TEST TARGET?                         
         BE    LIST0080            YES - ACCEPT                                 
         B     STABARRS            NO  - DON'T PERMIT TRANSFER                  
LIST0070 EQU   *                                                                
         GOTO1 =A(CHEKSSTA),DMCB,(RC),RR=Y                                      
*                                  CHECK SOURCE STATION RECORD                  
...
*                                                                               
LISTSTA  DC    C'WNNESZAM'         SELTEL TO KAMNY                              
LLISTSTA EQU   *-LISTSTA '         LENGTH EQUATE                                
         DC    C'WLKYCQAM'         CONTINENTAL TO KAMNY                         
         DC    C'WNEPAMSZ'         KAMNY TO SELTEL                              
         DC    C'WVUEAMSZ'         KAMNY TO SELTEL                              
         DC    C'WFTCAMSZ'         KAMNY TO SELTEL                              
         DC    C'KUSIAMSZ'         KAMNY TO SELTEL                              
         DC    C'WAWSAMSZ'         KAMNY TO SELTEL                              
         DC    C'WUTVAMSZ'         KAMNY TO SELTEL                              
         DC    C'KLRTAMSZ'         KAMNY TO SELTEL                              
         DC    C'KASNAMSZ'         KAMNY TO SELTEL                              
         DC    C'KFORAMSZ'         KAMNY TO SELTEL                              
         DC    C'WNACAMSZ'         KAMNY TO SELTEL                              
         DC    C'WHO AMSZ'         KAMNY TO SELTEL                              
         DC    C'WQADAMSZ'         KAMNY TO SELTEL                              
         DC    C'WTEVAMSZ'         KAMNY TO SELTEL                              
         DC    C'WDTNAMCQ'         KAMNY TO KCONY                               
         DC    C'KASYAMCQ'         KAMNY TO KCONY                               
         DC    C'KMTVAMCQ'         KAMNY TO KCONY                               
         DC    C'KRQEAMCQ'         KAMNY TO KCONY                               
         DC    X'0000'             DELIMITER                                    
*                                                                               
LIST0080 EQU   *                                                                
         LA    RF,CTOSELH          SET A(FIRST SELECT FIELD)                    
...
*                                                                               
         ...
         BE    LIST0440            YES - NO 9E KEY TEST DONE                    
...
***********************************************************************         
SETFILES DS    0H                                                               
         GOTO1 =A(REPPROF),DMCB,(RC),RR=Y                                       
*                                  RETRIEVE TARGET REP PROFILE                  
         MVI   HISTTAKE,C'Y'       FORCE TO HISTTAKE PATH                       
         BAS   RE,SWSRCREP         SWITCH TO SOURCE REP                         
...
*                                  PASS IN A(CONTRACT IN AIO1)                  
         CLI   HISTTAKE,C'Y'       HISTORY TAKEOVER?                            
         BNE   ACON0223            NO                                           
         GOTO1 =A(RESETDAT),DMCB,(RC),(R4),RR=Y                                 
*                                  PASS IN A(CONTRACT IN AIO1)                  
ACON0223 EQU   *                                                                
...
*                                  1  =  VERSION                                
HISTTAKE DS    CL1                 HISTORY TAKEOVER FLAG                        
TODAY    DS    CL3                 DATE OF RUN                                  
BUCKDATS DS    CL64                BUCKET ACTIVITY DATE AREA                    
*                                  16 POSSIBLE ENTRIES                          
*                                  PER ENTRY:                                   
*                                     1-4  =  MONTH OF SRVC OF BUCKET           
*                                        (IE:  APRIL98)                         
*                                     5-8  =  ACTIVITY DATE                     
*                                        (IE:  MAR15/98)                        
...
CTYPTABL DS    CL64                CONTRACT TYPE TABLES                         
         DS    0F                                                               
*CONTABLE DS    3000C               750 CONTRACT NUMBER TABLE                   
         EJECT                                                                  
...
*<<<<                                                                           
*                                                                               
*   CODE MOVED OUT OF LINE TO GAIN ADDRESSABILITY                               
*                                                                               
ACONNMOD NMOD1 0,*ACMD*                                                         
*                                                                               
...
*                                  INSERT NEW ELEMENT INTO RECORD               
         GOTO1 HELLO,DMCB,(C'D',=C'REPFILE'),(X'2E',RCONREC),0,0                
*                                  DELETE OLD HISTTAKE HIST ELT                 
*                                     IN ALL CASES                              
         CLI   HISTTAKE,C'Y'       HISTORY TAKEOVER RUN?                        
         BNE   ACMD0180            NO  - DON'T REINSERT ELEMENT                 
*                                                                               
*                                  INSERT NEW HISTTAKE ELT                      
         XC    ELEM(RCON2ELQ),ELEM                                              
         MVI   ELEM,X'2E'                                                       
         MVI   ELEM+1,RCON2ELQ     NEW ELEMENT LENGTH                           
         GOTO1 DATCON,DMCB,(5,WORK),(2,ELEM+2)                                  
*                                  INSERT DATE OF TAKEOVER                      
         MVC   ELEM+4(3),=X'620101'    INSERT EFF DATE OF TAKEOVER              
         PRINT GEN                                                              
         GOTO1 ADDELEM                                                          
*                                  INSERT NEW ELEMENT INTO RECORD               
ACMD0180 EQU   *                                                                
...
ACMD0210 EQU   *                                                                
         CLI   0(RF),0             END OF RECORD?                               
         BE    ACMD0270            YES - NO X'9F' ELT                           
         CLI   0(RF),X'9F'         EXTRA DESCRIPTOR ELT?                        
         BE    ACMD0240            YES                                          
         ZIC   RE,1(RF)            NO  - BUMP TO NEXT ELEMENT                   
         AR    RF,RE                                                            
         B     ACMD0210            GO BACK FOR NEXT                             
ACMD0240 EQU   *                                                                
...
*                                  GENERATE 2-CHAR COMPRESSED DATE              
         MVC   EFDTCOMP,=X'C39D'   SET EFFECTIVE DATE TO 12/29/97               
...
*                                                                               
         CLI   HISTTAKE,C'Y'       HISTORY TAKEOVER?                            
         BE    UPDT0042            YES - LEAVE ORDER UNCHANGED:                 
*                                     SAME DATES                                
*                                     SAME BUYLINES (NO CUTBACKS)               
*                                     SAME BUCKETS                              
...
*                                  CONVERT TKO DATE TO EBCDIC                   
         GOTO1 ADDAY,DMCB,WORK,WORK,,                                           
         GOTO1 DATCON,DMCB,(0,WORK),(3,RCONDATE)                                
*                                  CONVERT OOWR START TO BINARY                 
UPDT0040 EQU   *                                                                
         BAS   RE,ESTPACE          TRAP EST $ BUCKET PACING DATES               
*                                                                               
...
*                                                                               
         EJECT                                                                  
*                                                                               
*   ESTPACE:  TRAP PACING DATES FROM X'03' CONTRACT BUCKETS.                    
*                                                                               
ESTPACE  NTR1                                                                   
         XC    BUCKDATS,BUCKDATS   CLEAR BUCKET TABLE                           
         LA    R3,RCONELEM         A(DESCRIPTION ELEMENT)                       
EPAC0020 EQU   *                                                                
         CLI   0(R3),0             END OF RECORD?                               
         BE    EPAC0800            YES - FINISHED                               
         CLI   0(R3),3             EST $ ELEMENT?                               
         BNE   EPAC0080            NO                                           
         LA    R2,BUCKDATS         A(BUCKET DATE TABLE)                         
EPAC0040 EQU   *                                                                
         OC    0(4,R2),0(R2)       SLOT EMPTY?                                  
         BNZ   EPAC0060            NO  - CHECK FOR SAME DATE                    
         MVC   0(4,R2),2(R3)       YES - MOVE MONTH OF SERVICE PLUS             
         B     EPAC0080            BUMP TO NEXT ELT IN CONTRACT                 
EPAC0060 EQU   *                                                                
         CLC   0(2,R2),2(R3)       BUCKET DATE = EST $ ELEMENT DATE?            
         BE    EPAC0080            YES - ALREADY IN TABLE                       
*                                     ACTIVITY DATE FOR THIS BUCKET             
         LA    R2,4(R2)            NO  - BUMP TO NEXT TABLE SLOT                
         B     EPAC0040            GO BACK AND CHECK NEXT SLOT                  
EPAC0080 EQU   *                                                                
         ZIC   RF,1(R3)                                                         
         AR    R3,RF               BUMP TO NEXT ELEMENT                         
         B     EPAC0020            GO BACK FOR NEXT ELT                         
EPAC0800 EQU   *                                                                
         XIT1                                                                   
         DROP  R5                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         EJECT                                                                  
*                                                                               
*   REPPROF:  READ REP RECORD FROM TARGET FILE, RETRIEVE PROFILE(S)             
*        NEEDED.  FILES POSITIONED TO TARGET REP AT THIS POINT.                 
*                                                                               
REPPROF  NMOD1 0,*RPPF*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
*                                                                               
*                                                                               
         XC    KEY,KEY             CLEAR THE KEY                                
...
*                                                                               
         GOTO1 GETREC,DMCB,RREPREC                                              
*                                  RETRIEVE ORIGINAL REP RECORD                 
         MVC   AIO,SAVEAIO         RESET ORIGINAL IO AREA                       
*                                                                               
         MVC   HISTTAKE,RREPPROF+28                                             
*                                  TAKEOVER VS HISTORY TAKEOVER FLAG            
*                                  Y  =  HISTORY TAKEOVER                       
         XIT1                                                                   
*                                                                               
         DROP  R4                                                               
...
*                                  SWITCH TO TARGET FILE, IF NEEDED             
         MVC   AIO,AIO3                                                         
         L     R4,AIO3                                                          
         CLI   HISTTAKE,C'Y'       HISTORY RUN? (NO FLIGHTS CHANGED)            
         BE    TKBY0280            YES - LEAVE RECORD AS IS                     
...
TKBY0280 EQU   *                                                                
         CLI   HISTTAKE,C'Y'       HISTORY TAKEOVER?                            
         BE    TKBY0300            YES - OUTPUT ALL BUYS                        
...
*INSRT*>                                                                        
*                                                                               
*   RESETDAT:  SCAN CONTRACT FOR X'03' BUCKETS.  RESET ACTIVITY DATES           
*        FOR EACH MONTH OF SRVCE TO THAT INDICATED IN TABLE BUCKDATS            
*                                                                               
RESETDAT NMOD1 0,*RDAT*                                                         
         L     RC,0(R1)            RESET A(WORKSPACE)                           
         L     R5,4(R1)            RESET A(CONTRACT RECORD)                     
         USING RCONREC,R5                                                       
...
RDAT0020 EQU   *                                                                
         ...
         BE    RDAT0800            YES - FINISHED                               
         CLI   0(R2),3             ESTIMATE BUCKET?                             
         BE    RDAT0040            YES                                          
RDAT0030 EQU   *                                                                
         ZIC   RF,1(R2)            NO  - BUMP TO NEXT ELEMENT                   
         AR    R2,RF                                                            
         B     RDAT0020            GO BACK FOR NEXT                             
RDAT0040 EQU   *                                                                
         LA    R3,BUCKDATS         SET A(BUCKET DATE TABLE)                     
RDAT0060 EQU   *                                                                
         CLI   0(R3),0             END OF TABLE REACHED?                        
         BZ    RDAT0030            YES - SHOULDN'T HAPPEN                       
*                                  LEAVE DATE OF RUN IN FIELD,                  
*                                     GO BACK FOR NEXT BUCKET                   
         CLC   0(2,R3),2(R2)       TABLE MON OF SVC = BUCKET MOS?               
         BE    RDAT0080            YES - UPDATE BUCKET                          
         LA    R3,4(R3)            NO  - BUMP TO NEXT BUCKET                    
         B     RDAT0060            GO BACK FOR NEXT                             
RDAT0080 EQU   *                                                                
         MVC   4(2,R2),2(R3)       INSERT ACTIVITY DATE INTO BUCKET             
         B     RDAT0030            GO BACK FOR NEXT CONTRACT BUCKET             
RDAT0200 EQU   *                                                                
...
SSTA0210 EQU   *                                                                
         CLI   0(RF),0             END OF RECORD?                               
         BE    SSTA0230            YES - NO X'05' ELEMENT                       
         CLI   0(RF),5             END OF RECORD?                               
         BNE   SSTA0220            YES - NO X'05' ELEMENT                       
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'043RESFM41   09/18/02'                                      
         END                                                                    
