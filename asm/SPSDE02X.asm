*          DATA SET SPSDE02X   AT LEVEL 008 AS OF 02/10/03                      
*PHASE T23102A                                                                  
...
*                                                                               
         ...
         MVI   ERRORCD,0                                                        
*                                                                               
INIT10   CLI   SVRCVEL+1,X'02'           AUTHORIZATION EDIT/ADD                 
         BE    RCV02H                                                           
*                                                                               
...
RCV02H   DS    0H                                                               
         ...
         B     EXIT                                                             
*                                                                               
R02H05   TM    FLAG2,MKTSNT              WAS A SPECIFIC MARKET SENT?            
         BO    *+8                                                              
...
R02H10   CLI   SVTRANT,NEWVERS           ADDING A NEW VERSION?                  
         ...
         DC    H'0'                                                             
*                                                                               
         BAS   RE,VALFLT                 VALIDATE FLIGHT DATES                  
...
*                                                                               
BAUTH40  MVC   AINFBYGR,SVBYGRP          BUYING GRP OF PERSON EDITING           
...
BAUTH70  MVI   ELCDLO,ATCHELQ                                                   
         MVI   ELCDHI,ATCHELQ                                                   
         BAS   RE,DELEL                  DELETE ALL ATTACHMENT ELEMENTS         
*                                                                               
         USING ATCHELD,R3                                                       
         LA    R3,BLOCK                                                         
*                                                                               
...
BAUTH90  CLI   SVTRANT,EDTAUTH                                                  
         ...
         MVI   ELCDLO,AMKTAELQ                                                  
         MVI   ELCDHI,AMKTRELQ                                                  
         BAS   RE,DELEL                  DELETE AMKTAELQ & AMKTRELQ             
         MVI   BYTE,AMKTRELQ                                                    
...
BAUTH110 GOTO1 PUTREC                                                           
         ...
         OI    OVFLAG1,NOUPDATE                                                 
         BAS   RE,RDAMKT                 REVISE ALL ACTIVE MARKETS              
*                                                                               
...
DWNA30   L     R6,AIO2                   GET AUTH MARKET RECORD                 
         ST    R6,AIO                                                           
         GOTO1 GETREC                                                           
         BAS   RE,SND07H                 DOWNLOAD AUTH MARKET DETAILS           
         BNE   NEXIT                                                            
*                                                                               
...
*                                                                               
         ...
         GOTO1 PUTREC                                                           
*                                                                               
AAUTH40  BAS   RE,SDBIT                  TURN ON SDESK FLAG IN EST REC          
*                                                                               
         B     EXIT                                                             
         EJECT                                                                  
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *         
...
ADMKT10  CHI   R0,0                                                             
         ...
         LR    R5,R0               SUBTRACT 252 FROM TOTAL LENGTH               
         CHI   R5,252              AT A TIME                                    
         BL    ADMKT20                                                          
         LHI   R5,252                                                           
*                                                                               
ADMKT20  BCTR  R5,0                                                             
...
*                                                                               
         SR    R0,R5                                                            
         LA    R2,252(R2)          ADVANCE TO REMAINING MARKETS                 
         B     ADMKT10                                                          
         DROP  R3                                                               
ADMKTRVX LR    RE,R4                                                            
         BR    RE                                                               
...
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *         
STATAB   DC    AL1(MSTACMPQ),X'05',AL1(MSTACANQ),AL1(MSTAREJQ),X'00'            
         DC    AL1(MSTAREJQ),X'05',AL1(MSTAAPPQ),AL1(MSTACMPQ)                  
         DC    AL1(MSTACMSQ)                                                    
         DC    AL1(MSTACMSQ),X'05',AL1(MSTACANQ),AL1(MSTAREJQ),X'00'            
...
*                                                                               
         ...
         ST    R6,AIO                                                           
         GOTO1 GETREC                                                           
         BAS   RE,SND07H                 SEND MARKET DETAILS                    
RCV05HX  B     EXIT                                                             
         EJECT                                                                  
*                                                                               
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *         
...
*                                                                               
         TM    FLAG2,DNLAYOUT                                                   
         BNO   *+8                                                              
         MVI   AUPKSUB,X'C9'              DONE LAYOUT PASSIVES                  
         MVC   AUPKDUE,SVSTADT                                                  
         MVI   XSP,C'Y'                                                         
R06H10   GOTO1 HIGH                                                             
*                                                                               
...
* CHECK DUE DATE/START DATE FILTERS                                             
         ...
         CLC   AUPKDUE,SVSTADT                                                  
         BNE   R06H50                    NO MORE LEFT FOR THAT DATE             
         B     R06H30                                                           
*                                                                               
...
*                                                                               
         ...
         BAS   RE,SETDLM                                                        
*                                                                               
S02H60   MVC   WORK2(3),AUDDUEDT                                                
         BRAS  RE,SETDATE                SEND DUE DATE                          
*                                                                               
         MVC   WORK2(3),AUDFLST                                                 
...
* FOR REVISION HISTORY, PASS DOWN NAME                                          
         ...
         GOTO1 VALISPV                                                          
         BE    *+10                                                             
         MVC   SVUSRNM,AINFUSCD          USE CODE IF RECORD NOT THERE           
...
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *         
         ...
         BRAS  RE,SETNUM                 SEND SUPERVISOR APPROVAL DATE          
         B     S07H50                                                           
*                                                                               
...
S07H10   LA    R6,AUTEL                  FIRST ELEMENT                          
         ...
         MVI   ELCDHI,MSTACMSQ           HIGHEST STATUS ELEMENT CODE            
         BRAS  RE,NEXTEL3                                                       
         BE    S07H20                                                           
...
*                                                                               
         BAS   RE,STNSTA                 GET STATION STATUS                     
...
*                                                                               
         MVI   BYTE,1                    EDIT/REV/ADD LATEST                    
         GOTO1 VDATCON,DMCB,(3,MINFRVDT),(0,WORK)    CONV TO CHAR               
         GOTO1 VADDAY,DMCB,(C'D',WORK),WORK+6,F'1' ADD TWO DAYS                 
         GOTO1 VDATCON,DMCB,(0,WORK+6),(3,WORK)     CONV TO BINARY              
         CLC   TODAY,WORK                                                       
         BH    S07H150                   2 DAYS ARE UP,LOOKUP NEXT STAT         
...
S07H160  LA    R6,AUTEL                  POINT TO FIRST ELEMENT                 
         ...
         BNE   S07H170                                                          
         MVI   ELCDHI,MSTACANQ           IF COMPLETED, CHECK IF CANCLD          
...
RCV0BH   DS    0H                                                               
         ...
         MVC   AIO,AIO1                                                         
         GOTO1 GETREC                                                           
         GOTO1 =A(SND0BH),RR=OVRELO      SEND 0B W/ COMMENTS & ATTCHMNT         
         B     EXIT                                                             
*                                                                               
         EJECT                                                                  
EQXIT    SR    RC,RC                                                            
...
*                                                                               
         ...
         USING AUTKEY,R6                                                        
         GOTO1 GETREC                                                           
         BAS   RE,SND02H                 SEND 08 HEADER, MIMMICK 02 HDR         
         MVC   KEY,SVAUKEY                                                      
...
S08H40   LA    R4,AMKTMKT                 LIST ELEMENT TO PROCESS               
         SR    R5,R5                     CLEAR OVERRIDE LENGTH                  
*                                                                               
* GIVE R1 VALUE OF MAPCODE BASED ON WHETHER MKT CANCELD, ADDED, EDITED          
...
S0BH40   ZIC   R5,ATCHLEN                                                       
         SHI   R5,2                                                             
         LA    R1,MCATACH                ATTACMENT MAPCODE                      
         LA    R4,ATCHFLNM                                                      
         BAS   RE,SENDD                                                         
         BRAS  RE,NEXTEL2                                                       
         BE    S0BH40                                                           
...
*                                                                               
         ...
         BNO   REVMKT10                  FLIGHT DATE & FOUND NEW GOALS?         
         GOTO1 VDATCON,DMCB,(2,FULL),(3,MINFGIDT) GOAL INPUT DATE               
         GOTO1 (RF),DMCB,(2,FULL+2),(3,MINFGCDT)  GOAL CHANGE DATE              
         GOTO1 PUTREC                                                           
         B     REVMKTX                                                          
*                                                                               
REVMKT10 TM    AUTRSTAT,AUTRSCAN         MARKET CANCELLED?                      
         BNO   *+8                                                              
         OI    OVMFLAG1,MKTCANLD         YES, MARKET IS CANCELLED               
         MVC   MINFRVNM,SVREVNM          REVISION NUMBER                        
         MVC   MINFRVDT,TODAY            REVISION DATE                          
         TM    OVFLAG1,DUEDTCH           DID DUE DATE CHANGE?                   
         BNO   *+10                                                             
         MVC   MINFDUDT,SVDUEDT                                                 
...
REVMKT20 TM    OVMFLAG1,MKTCANLD         IS MARKET CANCELLED?                   
         BNO   REVMKT50                  NO                                     
...
REVMKT30 MVC   ERROR,=Y(MKTCNLD)                                                
         TM    SVFLAG1,F1CANMK           TRYING TO CANCEL THIS MARKET?          
         BNO   REVMKT40                                                         
         MVI   ERRORFLG,C'A'             UNDO FILE UPDATE FOR THIS TRAN         
         J     SNDERMSG                  TRYING TO CANCEL CANCLD MKT            
*                                                                               
REVMKT40 OI    OVMFLAG1,ADDCNLD          RE-ADDING A CANCELED MARKED            
         NI    AUTRSTAT,X'FF'-AUTRSCAN   TURN OFF CANCEL STATUS                 
         MVI   ELCDLO,MSTAREJQ                                                  
         MVI   ELCDHI,MSTACANQ                                                  
         BAS   RE,DELEL                  DELETE ALL STATUS ELEMENTS             
...
REVMKT50 TM    SVFLAG1,F1CANMK           CANCEL MARKETS?                        
         BNO   REVMKT60                                                         
         NI    MINFFLAG,X'FF'-MINFREV    REV NO LONGER LATEST STATUS            
...
*                                                                               
         TM    OVMFLAG1,ADDCNLD          RE-ADDING A CANCELED MARKED            
         BO    REVMKT70                  YES, NEED TO TURN OFF CAN BIT          
         TM    SVFLAG1,F1CANMK           CANCELLING THIS MARKET?                
         BNO   REVMKTX                                                          
*                                                                               
...
GOLRECD  DSECT                                                                  
       ++INCLUDE SPGENGOAL                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008SPSDE02X  02/10/03'                                      
         END                                                                    
