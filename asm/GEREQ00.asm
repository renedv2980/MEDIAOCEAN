*          DATA SET GEREQ00    AT LEVEL 063 AS OF 07/09/98                      
*PHASE TFD800A,+0                                                               
...
*&&US                                                                           
         L     RF,EFHREC                                                        
         CLC   =C'PW',8(RF)        IF RECORD FIELD SAYS PW                      
         BNE   QDIS35                                                           
         CLI   REQFILTH+5,0        TEST AT LEAST ONE FILTER ENTERED             
         BNE   QDIS35                                                           
         LA    R2,REQFILTH                                                      
         MVC   CONHEAD(L'NEEDFLTR),NEEDFLTR                                     
         B     QDIS90                                                           
NEEDFLTR DC    C'** ERROR **  NEED A SUPVSR FILTER **'                          
*&&                                                                             
QDIS35   LA    R2,REQSEL1H                                                      
...
*                                                                               
         ...
         BO    QDIS36A             YES - MUST BE NO REQUESTS                    
*                                                                               
         CLI   8(R1),0                                                          
         BE    *+6                                                              
         DC    H'0'                                                             
         B     QDIS36D                                                          
*                                                                               
QDIS36A  CLC   QREQFILE(3),=C'ACC'  IS THIS ACC                                 
         BNE   QDIS70              ALL DONE                                     
         LA    RF,ACCTAB           ACC ALIAS TABLE                              
QDIS36B  CLI   0(RF),X'FF'         EOT                                          
         BE    QDIS70              ALL DONE                                     
         CLC   QCRDCODE,0(RF)      MATCH REQUEST CODE TO REAL NAME              
         BE    QDIS36C                                                          
         LA    RF,L'ACCTAB(RF)                                                  
         B     QDIS36B                                                          
*                                                                               
QDIS36C  MVC   QCRDCODE,2(RF)      MOVE ALIAS                                   
         MVC   LASTLIST(2),QCRDCODE YES - START AT FIRST REQ                    
         MVI   LASTLIST+2,0                                                     
         MVI   LASTLIST+3,X'FF'                                                 
         XC    QADDR,QADDR                                                      
...
* SINCE EOD CODES ARE NOT UNIQUE, MATCH ON RECORD NAME AND ACTION *             
         SPACE 1                                                                
         L     RF,EFHREC                                                        
         PACK  DUB,2(2,R1)         PACK LENGTH                                  
         CVB   R7,DUB                                                           
         BCTR  R7,0                SET UP EX COMPARE                            
         EX    R7,*+8                                                           
         B     *+10                                                             
         CLC   8(0,RF),4(R1)       MATCH CHARACTERS                             
         BE    QDIS58              AND SINCE IT MATCHED, NO DISPLAY             
*&&US                                                                           
         CLC   =C'PW',8(RF)        IF RECORD FIELD SAYS PW                      
         BNE   QDIS36                                                           
         CLC   =C'SL',4(R1)        STA/LOCK REQUESTS ARE GENERATED              
         BE    QDIS58                                                           
*&&                                                                             
         B     QDIS36                                                           
*                                                                               
QDIS53   CLC   =C'03',0(R1)        NOT SPOOL ONLY - TEST ACTION FIELD           
         ...
         BE    QDIS58              AND SINCE IT MATCHED, NO DISPLAY             
*&&US                                                                           
         CLC   =C'MAI',8(RF)       IF REC/ACT = PW/MAINT                        
         BE    *+14                                                             
         CLC   =C'LIS',8(RF)       OR PW/LIST                                   
         BNE   QDIS36                                                           
         CLC   =C'REPORT',4(R1)    STALOCK/REP REQUESTS ARE GENERATED           
         BE    QDIS58                                                           
*&&                                                                             
         B     QDIS36              NO - SKIP REQUEST                            
*                                                                               
...
QDIS90   OI    6(R2),X'40'         POSITION CURSOR                              
         B     EXIT                                                             
         EJECT                                                                  
ACCTAB   DS    0CL4                REAL NAME/ALIAS                              
         DC    C'ESEY'                                                          
         DC    X'FF'                                                            
         EJECT                                                                  
         LTORG                                                                  
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'063GEREQ00   07/09/98'                                      
         END                                                                    
