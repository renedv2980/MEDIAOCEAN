*          DATA SET RERMP17    AT LEVEL 065 AS OF 04/23/18                      
*PHASE T81017C                                                                  
*INCLUDE BINSRCH2                                                               
...
* -------- --- ----   ------------------------------------------------*         
* MAR00/09     BOBY - NEW INVENTORY RECORD KEY                        *         
*                                                                     *         
...
*                                                                     *         
* Apr20/17 064 SKUI - Change default book from NOV96 to NOV00         *         
***********************************************************************         
         EJECT                                                                  
RMP17    CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         BE    *+8                                                              
         CLI   CCONKSTA+4,C' '     CHECK FOR SATELLITES                         
         BE    *+14                                                             
         MVI   0(RF),C'-'                                                       
...
*                                                                               
         ...
         MVI   MYRDUPDT,C'N'                                                    
         MVI   TMPSRC,0             GOING FOR INVENTORY HEADER RECORD           
         MVI   TMPBITS,0            GOING FOR INVENTORY HEADER RECORD           
         MVI   TMPBTYP,0            GOING FOR INVENTORY HEADER RECORD           
         MVI   TMPQLFK,0            GOING FOR INVENTORY HEADER RECORD           
         MVI   TMPQLFY,0            GOING FOR INVENTORY HEADER RECORD           
*                                                                               
         XC    TMPKBK,TMPKBK                                                    
*                                                                               
         MVI   GOSUBN,GIR#                                                      
...
*                                                                               
DR035    MVC   TMPSRC(1),LTSRC     RATING SOURCE                                
         MVC   TMPQLFK,LTQLFK                                                   
         MVC   TMPFRBTS,TMPQLFK    BOOKVAL BITS                                 
         MVC   TMPQLFY,LTQLFY                                                   
         MVC   TMPQLFS,LTQLFS                                                   
         MVC   TMPBTYP,LTBTYP      BOOKTYPE                                     
*                                                                               
******   MVI   GOSUBN,RKS#                                                      
******   GOTO1 AGOSUB                                                           
*                                                                               
         ...
         MVC   TMPBOOK,LTXKBK      BOOK                                         
         XC    TMPBOOK,=X'FFFF'    BOOK INVERTED                                
*                                                                               
         B     DR039               NOT NEEDED                                   
*                                                                               
         L     RF,AQLFKYTB                                                      
         LA    R0,QLFKYTBQ                                                      
*                                                                               
DR037    CLC   1(1,RF),TMPQLFS     TRANSLATE QUALIFIER                          
         BE    DR038                                                            
         LA    RF,L'QLFKYTAB(RF)                                                
         BCT   R0,DR037                                                         
         B     DR039                                                            
...
DR038    DS    0H                                                               
         MVC   TMPQLFY,0(RF)        RETURN: TRACK QUALIFIER KEY CODE            
*                                                                               
DR039    DS    0H                  GET BOOKVAL BITS                             
*                                                                               
         XC    MYFLD(MYFLDL),MYFLD                                              
*                                                                               
         LA    RE,MYFLDD           POINT TO START OF FIELD                      
         LR    RF,RE               COPY START                                   
*                                                                               
         CLI   TMPQLFY,C' '        FILL IN QUALIFIER                            
         BE    *+14                                                             
         MVC   0(1,RF),TMPQLFY                                                  
         LA    RF,1(RF)                                                         
*                                                                               
...
*                                                                               
         ...
         MVC   TMPFRBTS,TMPQLFK     RETURN: BOOKVAL BITS                        
*                                                                               
         MVI   GOSUBN,TBK#         FORMAT BOOK                                  
         GOTO1 AGOSUB                                                           
*                                                                               
...
*                                                                               
DR055    MVC   TMPBTYP,LTBTYP      BOOK TYPE                                    
         MVC   TMPQLFK,LTQLFK      INTERNAL QUALIFIER CODE                      
         MVC   TMPQLFY,LTQLFY      EXTERNAL QUALIFIER CODE                      
         MVC   TMPQLFS,LTQLFS      SORT KEY QUALIFIER CODE                      
         MVC   TMPSRC(1),LTSRC     RATING SOURCE                                
*                                                                               
         L     RF,AQLFKYTB                                                      
         LA    R0,QLFKYTBQ                                                      
*                                                                               
DR057    CLC   0(1,RF),TMPQLFY     TRANSLATE QUALIFIER                          
         BE    DR058                                                            
*                                                                               
         LA    RF,L'QLFKYTAB(RF)                                                
         BCT   R0,DR057                                                         
...
DR058    DS    0H                                                               
         MVC   TMPQLFS,1(RF)        RETURN: TRACK QUALIFIER KEY CODE            
*                                                                               
DR059    DS    0H                                                               
*                                                                               
******   MVI   GOSUBN,RKS#                                                      
...
*                                                                               
         ...
         DC    PL2'2'                                                           
*                                                                               
         TM    DEMSELH+1,X'20'      TP TRACK?                                   
         BO    DR070                                                            
*                                                                               
         XC    KEY,KEY                                                          
IKD      USING RINVKEY,KEY                                                      
*                                                                               
         MVC   KEY(27),KEYSAVE                                                  
         MVC   IKD.RINVKRSR,LTSRC                                               
         MVC   IKD.RINVKQLF,LTQLFK                                              
         MVC   IKD.RINVKBTP,LTBTYP                                              
         MVC   IKD.RINVKBK,TMPBOOK                                              
*                                                                               
...
*&&DO                                                                           
* ENABLE THIS CODE IF WE WANT THE WARNING GENERATED                             
*  (SEE PANAPT MR 21829)                                                        
         CLC   BSP3,BSP6           N'BINSRCH ENTRIES = MAX?                     
         BNE   *+12                NO                                           
         MVI   OURWRNCD,W2MUCHQ    YES: WARN USER THAT LIST OVERFLOWED          
         B     OURWARN                                                          
*&&                                                                             
*                                                                               
         B     XIT                                                              
...
IVK      USING REINVRCD,KEY                                                     
         ...
         MVC   IVK.RINVKRSR,TMPSRC    RATING SOURCE                             
         MVI   IVK.RINVKDSR,0         DATA SOURCE                               
         MVC   IVK.RINVKQLF,TMPQLFK   QUALIFIER                                 
         MVC   IVK.RINVKBTP,TMPBTYP   BOOKTYPE                                  
...
*                                                                               
         STCM  R1,7,RINVKSTD                                                    
         MVC   RINVKRSR,TMPSRC                                                  
         MVC   RINVKQLF,TMPQLFK                                                 
         MVC   RINVKBTP,TMPBTYP                                                 
         MVC   RINVKBK,TMPKBK                                                   
...
*                                                                               
         ...
         BL    GIR025                                                           
*                                                                               
         CLC   RINVKQLF,TMPQLFK                                                 
         BH    GIR010                                                           
         BL    GIR025                                                           
*                                                                               
         CLC   RINVKBTP,TMPBTYP                                                 
         BH    GIR010                                                           
         BE    GIR030                                                           
...
*                                                                               
         ...
         MVI   KEY+(RINVKRTP-RINVKEY),X01    SKIP READ OF INV HDR               
         DROP  R5                                                               
*                                                                               
...
*                                                                               
         MVC   TMPSRC,KEY+(RINVKRSR-RINVKEY)                                    
         MVC   TMPQLFK,KEY+(RINVKQLF-RINVKEY)                                   
         MVC   TMPFRBTS,KEY+(RINVKQLF-RINVKEY)                                  
         MVC   TMPBTYP,KEY+(RINVKBTP-RINVKEY)                                   
*                                                                               
         MVI   GOSUBN,RKS#         GET QUALIFIER EXTERNAL VALUE                 
         GOTO1 AGOSUB                                                           
         BNE   ILT022                                                           
*                                                                               
         GOTO1 GETREC                                                           
...
*                                                                               
         XC    LTXKBK,=X'FFFF'     INVERT BOOK                                  
*                                                                               
         MVC   LTQLFS,TMPQLFS      (FROM RKS# ROUTINE ABOVE)                    
...
LTW      USING LISTTABD,WORK                                                    
         ...
         MVC   LTW.LTQLFK,TMPQLFK                                               
         MVC   LTW.LTQLFY,TMPQLFY                                               
         MVC   LTW.LTQLFS,TMPQLFS                                               
...
*   TMPFRBTS  = book bits,                                                      
*   TMPBTYP   = book type,                                                      
*   TMPQLFY   = EXTERNAL KEY CODE FOR QUALIFIER,                                
...
*                                                                               
         DROP  R3                                                               
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'B',GKSIPARM),GKSOPARM,ACOMFACS                  
         CLI   DMCB+4,0                                                         
         BNE   RKSXN                                                            
*                                                                               
         LA    R3,GKSOPARM                                                      
...
RKS025   DS    0H                                                               
*                                                                               
         MVC   TMPQLFS,1(RF)        RETURN: TRACK QUAL SORT KEY CODE            
*                                                                               
         DS    0H                  GET BOOKVAL BITS                             
*                                                                               
*        SET UP DUMMY BOOK SCREEN FIELD                                         
*                                                                               
         XC    MYFLD(MYFLDL),MYFLD                                              
         LA    RE,MYFLDD                                                        
         LR    RF,RE                                                            
...
*                                                                               
         ...
         STC   RF,MYFLDH+0                                                      
*                                                                               
         GOTO1 BOOKVAL,DMCB,(TMPSRC,MYFLD),(1,DUB),SCANNER,0                    
         CLI   DMCB+4,1                                                         
         BNE   RKSXN                                                            
*                                                                               
         DS    0H                  SET RETURN VALUES                            
...
W2MUCHQ  EQU   ((XMWRN05-XMWRN00)/4)+1                                          
...
XMWRN02  B     WBOT                BOTTOM OF LIST                               
         NOP   *                                                                
         NOP   *                                                                
XMWRN05  B     W2MUCH              LIST IS TOO LONG                             
...
WBOT     DS    0H                       BOTTOM OF LIST                          
         ...
         B     WRNGTXT                                                          
*                                                                               
W2MUCH   DS    0H                       TOO MUCH DATA TO LIST                   
         MVC   MSGNUM2,=AL2(RW#2MANY)                                           
         B     WRNGTXT                                                          
         EJECT                                                                  
...
*MXLTNTRY EQU   18*MXLSTLNS         MAX ENTRIES FOR LIST TABLE (10 PP.)         
MXLTNTRY EQU   09*MXLSTLNS         MAX ENTRIES FOR LIST TABLE (10 PP.)          
...
*                                 ************ TEMP STORAGE ***********         
TMPBITS  DS    CL1                 TEMP STORAGE FOR KEY FIELD--BKVL BTS         
TMPKBK   DS    XL2                  "      "     "  KEY FIELD--BOOK             
TMPSRC   DS    CL3                  "      "     "  RATING SOURCE               
...
TMPQLFS  DS    XL1                  "      "     "  QUALIFIER SORT CDE          
...
LTQLFS   DS     XL1                 SORT KEY FOR TYPE OF BOOK                   
LTSRC    DS     CL1                 RATING SOURCE                               
LTBTYP   DS     CL1                 BOOK TYPE                                   
LTKEYL   EQU   *-LTKEY             L(KEY)                                       
                                                                                
LTDATA   DS    0X                  DATA                                         
LTQLFK   DS     XL1                 QUALIFIER INTERIOR VALUE                    
LTQLFY   DS     XL1                 QUALIFIER EXTERNAL VALUE                    
...
MYTIALEN EQU   *-BIGAREA                                                        
         DS    0CL((X'4100'-MYTIALEN)+1)  2ND HALF FOR OVRLYS UNDRNEATH         
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'065RERMP17   04/23/18'                                      
         END                                                                    
