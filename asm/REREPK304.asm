*          DATA SET REREPK304  AT LEVEL 020 AS OF 05/01/02                      
*PHASE REK302C,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
*                                                                  *            
*        SPECIAL VERSION:  UPDATE FAX NUMBER INTO ORIGINAL         *            
*                      STATIONS.                                   *            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
...
*                                                                               
         CLC   KMKTFAX#,SPACES     ANY FAX NUMBER?                              
         BE    STAP0480            NO  - NOTHING TO PROCESS                     
         LA    R3,REC                                                           
         USING RSTAREC,R3                                                       
         XCEFL REC,1008                                                         
...
STAP0200 EQU   *                                                                
*                                                                               
         LA    R6,RSTAREC          SET A(STATION RECORD)                        
         MVI   ELCODE,8            FIND EXTRA DESCRIPTION ELEMENT               
         BAS   RE,GETEL                                                         
         BZ    *+6                                                              
         DC    H'0'                                                             
*                                  INSERT NEW FAX NUMBER                        
         CLC   KMKTFAX#(10),RSTAOFAX                                            
         BNE   STAP0240            NO  - ALREADY CLEARED                        
         XC    RSTAOFAX,RSTAOFAX                                                
*                                  CLEAR ORIGINAL AREA INTO WHICH               
*                                     FAX WAS INSERTED                          
STAP0240 EQU   *                                                                
         USING RSTAXXEL,R6                                                      
*                                  NOW SET CORRECT FAX NUMBER                   
         MVC   RSTAOFAX,SPACES     CLEAR ENTIRE FAX # FIELD                     
         MVC   RSTAOFAX(10),KMKTFAX#                                            
         DROP  R6                                                               
*                                  INSERT FAX NUMBER                            
...
KMKTSTA  DS    CL5      +24        STATION CALL LETTERS                         
         DS    CL13     +29        IGNORE                                       
KMKTFAX# DS    CL10     +42        FAX NUMBER                                   
         DS    CL20     +52        IGNORE                                       
KMKTFXCD DS    CL2      +72        FAX CODE                                     
         DS    CL2      +74        IGNORE                                       
KMKTDIV  DS    CL1      +76        DIVISION CODE                                
         DS    CL3      +77        IGNORE                                       
*                                                                               
*                                                                               
         EJECT                                                                  
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
         ...
         SPACE 4                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020REREPK304 05/01/02'                                      
         END                                                                    
