*          DATA SET DDEDINJE   AT LEVEL 057 AS OF 01/31/17                      
*PHASE EDINJEA                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE DATCON                                                                 
*INCLUDE DATVAL                                                                 
...
.SKIP    L     RF,=V(PRINTER)                                                   
         ...
         MEND                                                                   
         EJECT                                                                  
         TITLE 'DDEDINJE -- PROCESS MQ STATUS MESSAGE'                          
***********************************************************************         
* PROCESS NOTIFY COMMAND VIA MQ MESSAGE                                         
***********************************************************************         
EDINJE   CSECT                                                                  
         PRINT NOGEN                                                            
         NBASE 0,*EDINJE,=A(R13CHAIN)                                           
*                                                                               
         LR    R5,RC                                                            
...
*                                                                               
         ...
         MVC   DCBDDNAM-IHADCB(8,RF),=C'NJETRACE'  DDNAME=NJETRACE              
*                                                                               
         MVC   TITLE(41),=C'EDICT: SUBTASK TO PROCESS MQ MESSAGE'               
...
*                                                                               
         GOTO1 DATAMGR,DMCB,=CL7'ISGENQ',C'#06K'                                
*                                                                               
         XBASE                                                                  
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                               
         MVC   ASSB,SUBASSB          A(SSB)                                     
         L     RE,ASSB                                                          
         USING SSBD,RE                                                          
         MVC   DSPACE,SSODSPAC                                                  
         DROP  RE                                                               
*                                      CALCULATE TIME ADJUSTMENT                
         TIME  BIN,ZONE=LT             BETWEEN UTC AND LT(LOCAL TIME)           
...
*                                                                               
*----------------------------------                                             
* FROM 2007, THE DAYLIGHT SAVING                                                
* TIME BEGINS THE SECOND SUNDAY                                                 
* OF MARCH AND ENDS THE FIRST                                                   
* SUNDAY OF NOVEMBER                                                            
*----------------------------------                                             
...
*                                                                               
         MVI   DSTFLAG,YES         IT'S DAYLIGHT SAVING TIME!                   
         MVC   P+30(6),TODAY                                                    
         PRNT  DAYLIGHTSAVING,PRINT=ALWAYS                                      
DAYLITEX EQU   *                                                                
*                                                                               
         MVC   OBJDESC2_OBJECTNAME,=CL48'DDS.BROKER.LOCALQ'                     
         CLI   DSPACE,C'T'         TEST EDICT?                                  
         BNE   *+10                YES                                          
         MVC   OBJDESC2_OBJECTNAME,=CL48'DDS.BROKER.TEST.LOCALQ'                
         CLI   DSPACE,C'Q'         FQA EDICT?                                   
         BNE   *+10                NO                                           
         MVC   OBJDESC2_OBJECTNAME,=CL48'DDS.BROKER.FQA.LOCALQ'                 
         CLI   DSPACE,C'C'         CSC EDICT?                                   
         BNE   *+10                NO                                           
         MVC   OBJDESC2_OBJECTNAME,=CL48'DDS.BROKER.CSC.LOCALQ'                 
*                                                                               
*                                                                               
* SET (#) TASK CODE (NJ) & TCB ADDR IN ISGENQ / CLEAR TASK ENQUEUES (K)         
*                                                                               
         GOTO1 DATAMGR,DMCB,=CL7'ISGENQ',C'#06K'                                
*                                                                               
         XIT1                                                                   
...
***********************************************************************         
* READ PARAMETER CARDS BETWEEN "++NJE" AND "++NJEEND" CARDS                     
*                                                                               
...
RC10     GOTO1 =V(CARDS),DMCB,CARD,=C'RE00'                                     
         ...
         BNE   *+6                                                              
         DC    H'0'                                                             
         CLC   =C'++NJE',CARD      LOOK FOR START OF PARAMETERS                 
         BNE   RC10                                                             
*                                                                               
RC20     GOTO1 =V(CARDS),DMCB,CARD,=C'RE00'                                     
         ...
         BNE   *+6                                                              
         DC    H'0'                                                             
         CLC   =C'++NJEEND',CARD   LOOK FOR END OF PARAMETERS                   
         BE    RCX                                                              
*                                                                               
...
*                                                                               
MQBUF10  MVI   OVERSIZE,NO         ASSUME NO OVERSIZE                           
...
*                                                                               
MQBUF20  GOTO1 DATAMGR,DMCB,=CL7'ISGENQ',C'TASK'                                
*                                                                               
         PRNT  ABOUTTOWAIT                                                      
*                                                                               
...
*                                                                               
         L     R3,=A(MQBUFF)                                                    
         CLC   =C'01',0(R3)        BDE RESPONSE?                                
         BNE   PMB020                                                           
         CLC   MAJORNAM+5(1),4(R3) MATCH ON EDICT TYPE (A/R/T/Q/C)?             
         BE    PMB020              YES - CONTINUE PROCESS THE MSG               
         BRAS  RE,PROMBDEA         NO -  SEND TO BROKER Q                       
         B     PMBX                                                             
*                                                                               
PMB020   MVC   MSG_ACT,0(R3)       ACTION                                       
         CLC   =C'ADD',MSG_ACT                                                  
         BE    PMBADD                                                           
         CLC   =C'JNK',MSG_ACT                                                  
         BE    PMBADD                                                           
...
PMUKNX   XIT1                                                                   
         ...
         EJECT                                                                  
*********************************************************************           
* PROCESS BDE - STRAIGHT COPY                                                   
*********************************************************************           
PROMBDEA NTR1  BASE=*,LABEL=*                                                   
*                                  JUST COPY EXACT MSG TO BROKER Q              
...
PBDEAX   XIT1                                                                   
         ...
         EJECT                                                                  
*********************************************************************           
* PROCESS BDE - EXTRACT OLD OR NEW REFERENCE                                    
*********************************************************************           
...
* PROCESS BSS                                                                   
***********************************************************************         
PROMBSS  NTR1  BASE=*,LABEL=*                                                   
         LAY   R4,MQBUFF                                                        
         BRAS  RE,GETBSSNF         PARSE BSS NOTIFCIATION                       
         BNE   PMBSSX                                                           
         OC    NEWCREF,NEWCREF                                                  
         BZ    PMBSS20                                                          
         BRAS  RE,CHKBSSNF         CHECK NEW BDE NOTIFICATION                   
         B     PMBSSX                                                           
*                                                                               
PMBSS20  BRAS  RE,CHKBSSON         CHECK OLD BDE NOTIFICATION                   
*                                                                               
PMBSSX   XIT1                                                                   
         LTORG                                                                  
         DROP  RB                                                               
...
* DOCID:                CL9                                                     
* SENDERCN:             CL20                                                    
* BSS BDE ERROR CODE:   CL6                                                     
* BSS BDE ERROR TEXT:   CL50                                                    
***********************************************************************         
GETBDENF NTR1  BASE=*,LABEL=*                                                   
         ORG   GETBDENF                                                         
GETBSSNF EQU   *                                                                
         ORG                                                                    
         LA    R3,FLDTAB           USE 01'S TABLE                               
         CLC   =C'02',0(R4)                                                     
         BNE   GBNF10                                                           
         LA    R3,FLDTAB02         USE 02'S TABLE                               
*                                                                               
*                                                                               
GBNF10   MVC   FIELD+1(L'FIELD-1),0(R4)                                         
         LR    R2,R4                                                            
*                                                                               
         LA    RF,L'FIELD          EXTRACT EACH FIELD BASED ON FLDTAB           
         CLI   0(R4),X'5E'                                                      
         BE    GBNF20                                                           
         AHI   R4,1                                                             
         BCT   RF,*-12                                                          
...
FLDTAB02 DS    0F                                                               
         ...
         DC    A(GEVTIME)                                                       
         DC    A(GDOCID)                                                        
         DC    A(0)                BSS SENDER NAME                              
         DC    A(GBDEER)           BSS BDE ERROR CODE                           
         DC    A(GBDEEMSG)         BSS BDE ERROR TEXT                           
         DC    X'FF'                                                            
*                                                                               
         LTORG                                                                  
         DROP  RB                                                               
...
*                                                                               
         ...
         B     GBEROK                                                           
*                                                                               
GBER30   MVC   P+11(13),=C'*** ERROR ***'                                       
         MVC   P+30(26),=C'INVALID BSS BDE ERROR CODE'                          
         GOTO1 =V(PRINTER)                                                      
         B     GBERBAD                                                          
*                                                                               
GBEROK   CR    RB,RB                                                            
...
*                                                                               
         MVI   RETRY,NO            ASSUME NO RETRY YET                          
         LA    R1,DMCB                                                          
         USING CONVDSKD,R1                                                      
...
* CHECK                                                                         
**********************************************************************          
CHKBSSNF NTR1  BASE=*,LABEL=*                                                   
         GOTOR GETXMNT,NEWCREF                                                  
         BE    CKBSF50                                                          
         MVC   P+11(13),=C'*** ERROR ***'                                       
         MVC   P+30(24),=C'XMTTABLE ENTRY NOT FOUND'                            
         GOTO1 =V(PRINTER)                                                      
         B     CKBSF90             COULD NOT POST EDICT FILE                    
*                                                                               
CKBSF50  MVC   OPMSG6A(L'BDEEMSG),BDEEMSG                                       
         OC    OPMSG6A,SPACES      JUST IN CASE OF BINARY DATA                  
         BRAS  RE,CHKOPM                                                        
         BNE   CKBSF60                                                          
         GOTO1 DATAMGR,DMCB,=C'OPMSG',('OPMSG6Q',OPMSG6)                        
*                                                                               
CKBSF60  DS    0H                                                               
         CLC   EVTYPE,=C'REJ'                                                   
         BE    CKBSF70                                                          
         MVC   P+30(13),=C'*** ERROR ***'                                       
         MVC   P+30(22),=CL21'INVALID EVENT TYPE'                               
         PRNT  CANTPOST,PRINT=ALWAYS                                            
         B     CKBSFX                                                           
*                                                                               
CKBSF70  LA    R1,DMCB                                                          
         ...
         MVC   EXMTTBLE,AXMTTBL                                                 
         MVC   ETBLNTRY,XMTDSKAD                                                
         OI    EACTION,EACTFILQ    DISK ADDRESS BEING PASSED                    
         MVI   EACTION2,EACTREJQ                                                
         MVC   EMAJORNM,=A(MAJORNAM)                                            
         MVC   EABDEDTA,=A(BDEERHDR)    BSS BDE ERROR CODE                      
         MVC   EDAYNUM,EVDAY       DAY                                          
         MVC   ETIME,EVTIME        TIME                                         
         MVC   EADTAMGR,DATAMGR                                                 
         GOTO1 =V(POSTSENT)                                                     
         BNE   CKBSF90             COULD NOT POST EDICT FILE                    
         DROP  R1                                                               
*                                                                               
         GOTO1 =V(HEXOUT),DMCB,XMTDSKAD,P+30,4,=C'TOG'                          
         PRNT  EDIFILEMARKREJ,PRINT=ALWAYS                                      
         B     CKBSFX                                                           
         DROP  R3                                                               
*                                                                               
CKBSF90  MVC   P+30(13),=C'*** ERROR ***'                                       
         PRNT  CANTPOST,PRINT=ALWAYS                                            
*                                                                               
CKBSFX   XIT1                                                                   
         LTORG                                                                  
...
CHKBSO70 LA    R1,DMCB                                                          
         ...
         MVC   EADTAMGR,DATAMGR                                                 
         GOTO1 =V(POSTSENT)                                                     
         BNE   CHKBSO90            COULD NOT POST EDICT FILE                    
         DROP  R1                                                               
*                                                                               
         GOTO1 =V(HEXOUT),DMCB,FULL,P+30,4,=C'TOG'                              
         PRNT  EDIFILEMARKREJ,PRINT=ALWAYS                                      
...
*                                                                               
         ...
         MVI   ENQPQFLG,NO         ASSUME WE WON'T ENQ PRINT QUEUE              
*                                                                               
...
*                                                                               
         ...
         MVI   ENQPQFLG,YES        REMEMBER WE ENQUEUED                         
*                                                                               
         LA    RE,R                                                             
         USING PQPLD,RE                                                         
...
*                                                                               
EZINBDEQ CLI   ENQPQFLG,YES        REMEMBER WE ENQUEUED                         
         BNE   EZINBX                                                           
         MVC   P+30(8),MAJORNAM                                                 
         MVC   P+40(5),PRTQNAME                                                 
         PRNT  DEQUEUE                                                          
...
PROMADD  NTR1  BASE=*,LABEL=*                                                   
         ...
         XC    MSG_UUID,MSG_UUID   UNIQUE ID                                    
         XC    MSG_EMAL,MSG_EMAL   EMAIL ADDRESS OR FILE NAME                   
*                                                                               
         L     R3,=A(MQBUFF)                                                    
...
*                                                                               
         ...
         B     PMADDX                                                           
*                                                                               
PMADD10  AHI   R3,L'MSG_REF#       JUMP TO NEXT FIELD                           
         CLC   CRLF,0(R3)                                                       
         BE    *+12                                                             
         AHI   R3,1                                                             
         B     *-14                                                             
...
*                                                                               
         ...
         AHI   R3,2                                                             
*                                                                               
         CLI   MSG_METH,EDIPDFQ    METH=PDF? C'O'                               
         BE    PMADD18             NO ACCOUNT INFO                              
         ...
         B     PMADD15                                                          
*                                                                               
PMADD12  MVC   MSG_BFN,0(R3)       BDE FILE NAME                                
         AHI   R3,L'MSG_BFN        JUMP TO NEXT FIELD                           
*                                                                               
PMADD15  CLC   CRLF,0(R3)                                                       
         BE    *+12                                                             
         AHI   R3,1                                                             
         B     *-14                                                             
         AHI   R3,2                                                             
*                                                                               
PMADD18  MVC   MSG_DTT,0(R3)       DESTINATION TYPE                             
...
*                                                                               
         ...
         AHI   R3,2                                                             
*                                                                               
* CHANGE OTHERS TO HAVE EXTRA INFO IN THE FUTURE BUT FOR NOW PDF ONLY           
*                                                                               
         CLI   MSG_METH,EDIPDFQ    METH=PDF? C'O'                               
         BNE   PMADD40             FOR NOW ONLY PDF                             
         CLC   CRLF,0(R3)          OPTIONAL FIELD                               
         BE    PMADD36             NOTHING - SKIP IT                            
         MVC   MSG_UUID,0(R3)      UNIQUE ID                                    
*                                                                               
         AHI   R3,L'MSG_UUID       JUMP TO NEXT FIELD                           
         CLC   CRLF,0(R3)                                                       
         BE    *+12                                                             
         AHI   R3,1                                                             
         B     *-14                                                             
...
*                                                                               
         CLC   CRLF,0(R3)          OPTIONAL FIELD                               
         BE    PMADD38             NOTHING - SKIP IT                            
         LA    RF,L'MSG_EMAL       GOT INTO A PICKLE                            
         LA    RE,MSG_EMAL                                                      
PMADD37A CLI   0(R3),0                                                          
         BE    PMADD40             PREMATURE END                                
         CLI   0(R3),C' '                                                       
         BH    PMADD37B            GOOD SO FAR                                  
         CLC   CRLF,0(R3)                                                       
         BE    PMADD38             DONE                                         
         B     PMADD40             PREMATURE END                                
*                                                                               
PMADD37B MVC   0(1,RE),0(R3)                                                    
         AHI   RE,1                                                             
         AHI   R3,1                                                             
         BCT   RF,PMADD37A                                                      
         B     PMADD40                                                          
...
PMADD38  AHI   R3,2                                                             
*                                                                               
PMADD40  GOTO1 =V(PRINTER)                                                      
         MVC   P+00(7),=C'ACTION:'                                              
         MVC   P+08(L'MSG_ACT),MSG_ACT                                          
         GOTO1 =V(PRINTER)                                                      
         MVC   P+00(7),=C'REFNUM:'                                              
         MVC   P+08(L'MSG_REF#),MSG_REF#                                        
         GOTO1 =V(PRINTER)                                                      
         MVC   P+00(7),=C'METHOD:'                                              
         MVC   P+08(L'MSG_METH),MSG_METH                                        
         GOTO1 =V(PRINTER)                                                      
         CLI   MSG_METH,C'P'       METH=BDF?                                    
         BNE   PMADD40A                                                         
         MVC   P+00(7),=C'DSN   :'                                              
         MVC   P+08(L'MSG_BFN),MSG_BFN                                          
         OC    MSG_DSN,MSG_DSN     EMAIL OR DSN                                 
         BZ    *+10                                                             
         MVC   P+08(L'MSG_DSN),MSG_DSN                                          
         B     PMADD40C                                                         
*                                                                               
PMADD40A CLI   MSG_METH,C'O'       METH=PDF?                                    
         BNE   PMADD40B                                                         
         OC    MSG_EMAL,MSG_EMAL                                                
         BZ    PMADD40D                                                         
         MVC   P+00(7),=C'EMAIL :'                                              
         MVC   P+08(L'MSG_EMAL),MSG_EMAL                                        
         B     PMADD40C                                                         
*                                                                               
PMADD40B MVC   P+00(7),=C'ACCT# :'                                              
         MVC   P+08(L'MSG_ACC#),MSG_ACC#                                        
*                                                                               
PMADD40C GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40D MVC   P+00(7),=C'DEST  :'                                              
         MVC   P+08(L'MSG_DTT),MSG_DTT                                          
         MVC   P+10(L'MSG_DST),MSG_DST                                          
         MVC   P+38(L'MSG_FDST),MSG_FDST                                        
         GOTO1 =V(PRINTER)                                                      
*                                                                               
         OC    MSG_HDR,MSG_HDR                                                  
         BZ    PMADD40H                                                         
         MVC   P+00(7),=C'*HDR* :'                                              
         MVC   P+08(L'MSG_HDR),MSG_HDR                                          
         GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40H OC    MSG_TRN,MSG_TRN                                                  
         BZ    PMADD40I                                                         
         MVC   P+00(7),=C'*TRN* :'                                              
         MVC   P+08(L'MSG_TRN),MSG_TRN                                          
         GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40I OC    MSG_MQN,MSG_MQN                                                  
         BZ    PMADD40J                                                         
         MVC   P+00(7),=C'MQ    :'                                              
         MVC   P+08(L'MSG_MQN),MSG_MQN                                          
         GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40J OC    MSG_PQRT,MSG_PQRT                                                
         BZ    PMADD40K                                                         
         MVC   P+00(7),=C'PQ    :'                                              
         MVC   P+08(L'MSG_PQRT),MSG_PQRT                                        
         MVC   P+12(L'MSG_PQS),MSG_PQS                                          
         GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40K OC    MSG_PQS,MSG_PQS                                                  
         BZ    PMADD40L                                                         
         MVC   P+00(7),=C'BDE ID:'                                              
         MVC   P+08(L'MSG_BSID),MSG_BSID                                        
         GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40L OC    MSG_UUID,MSG_UUID                                                
         BZ    PMADD40M                                                         
         MVC   P+00(7),=C'UUID  :'                                              
         MVC   P+08(L'MSG_UUID),MSG_UUID                                        
         GOTO1 =V(PRINTER)                                                      
*                                                                               
PMADD40M CLI   MSG_REF#,C'D'       GENERATED DURING DR TEST?                    
         BNE   PMADD50             NO -- CONTINUE TO BUILD RECORD               
         CLI   DRTEST,YES          IS THIS THE DR TEST?                         
...
*                                                                               
         ...
         CLI   EDFMETH,C'O'        PDF METHOD?                                  
         BNE   BREC10                                                           
         MVC   EDFAPPL,MSG_UUID+16 UNIQUE ID                                    
         MVC   EDFEMAIL,MSG_EMAL   EMAIL RELATED TO                             
*                                  PQ USERID#, SUBID, REPORT REF#               
BREC10   GOTO1 =V(HEXIN),DMCB,MSG_REF#+02,EDFPQUID,4,0                          
...
*                                                                               
         MVC   EDFBDECR,MSG_REF#   SAVE THE BDE CUSTOMER REF#                   
*                                                                               
...
*                                                                               
         ...
         BE    BREC60                                                           
         CLI   MSG_METH,EDIEXRRQ   EXTREME REACH                                
         BE    BREC62                                                           
...
BREC60   MVC   EDFECNID,MSG_ACC#                                                
         B     BREC70                                                           
*                                                                               
BREC62   MVC   EDFXRRID,MSG_ACC#                                                
         B     BREC70                                                           
*                                                                               
BREC65   MVC   EDFBDFIL,MSG_BFN    SAVE BDF FILE NAME                           
         OC    MSG_DSN,MSG_DSN                                                  
         BZ    BREC70                                                           
         MVC   EDFDSN,MSG_DSN      SAVE FULL FILE NAME                          
*                                                                               
BREC70   OI    EDFSTAT,EDFSTSNT+EDFSTPRT    REPORT MARKED SENT & PRTD           
...
ERRDXX   XIT1                                                                   
         ...
         EJECT                                                                  
***********************************************************************         
* THIS ROUTINE HANDLES EZLINK/ECN/EXTREME REACH                                 
* DELIVERY/CANCELLATION NOTIFICATIONS                                           
...
*                                                                               
         CLI   MSG_REF#,VERSION4   VERSION 4 CUSTOMER REF. NUMBER?              
         BE    EZDLN18                                                          
         GOTOR GETXMNT,MSG_REF#    GET XMTNTRY ENTRY                            
         BE    EZDLN18                                                          
         MVC   P+11(13),=C'*** ERROR ***'                                       
         MVC   P+30(24),=C'XMTTABLE ENTRY NOT FOUND'                            
         GOTO1 =V(PRINTER)                                                      
...
*                                  GO TO NEXT FIELD                             
EZDLN18  CLC   CRLF,0(R3)                                                       
         BE    *+12                                                             
         AHI   R3,1                                                             
         B     *-14                                                             
         AHI   R3,2                BUMP PAST CRLF                               
*                                                                               
EZDLN20  DS    0H                  R3 -> DATE DDMMMYY OR DMMMYY                 
         ...
         B     EZDLN24                                                          
*                                                                               
EZDLN22  MVI   HALF,C'0'           1 DIGIT, SO FORCE 1ST DIGIT TO ZERO          
         MVC   HALF+1(1),0(R3)                                                  
         LA    R3,1(R3)            BUMP PAST THE SINGLE DIGIT                   
*                                                                               
EZDLN24  GOTO1 =V(HEXIN),DMCB,HALF,DELDAY,2                                     
         CLC   =F'1',DMCB+12                                                    
         BE    EZDLN30                                                          
         MVC   P+11(13),=C'*** ERROR ***'                                       
         ...
         B     EZDLN190            IGNORE THIS ONE                              
*                                                                               
EZDLN30  XC    WORK,WORK           CONVERT MMMDD/YY THEN TO YYMMDD              
...
EZDLN60  TBIN  DDSTIME=YES         R0 = DDS TIME DIFFERENCE (IN SECS.)          
         ...
         CLC   =F'1',DMCB+12                                                    
         JNE   *+2                 DAY NUMBER IS DDS DAY                        
*                                                                               
EZDLN65  XC    RLFAXNUM,RLFAXNUM   RESET "SENT TO" FAX NUMBER                   
         XC    ERRCODE,ERRCODE     RESET CANCELLATION ERROR CODE                
         CLI   MSG_REF#,VERSION4   VERSION 4 CUSTOMER REF. NUMBER?              
         BE    EZDLN66                                                          
         LA    R4,XMTNTRY                                                       
         USING XMTTABLD,R4                                                      
         CLI   XMTMETH,C'O'        PDF TRANSACTION?                             
         BNE   EZDLN66                                                          
         CLI   DELIVERY,DELIVERD   DELIVERY NOTIFICATION RECEIVED?              
         BE    EZDLN73                                                          
         AHI   R3,11               BUMP PAST 'MMMYY HH:MM'                      
         CLC   CRLF,0(R3)                                                       
         BNE   EZDLN65E            MARK AS UNKNOWN                              
         AHI   R3,2                BUMP PAST CRLF                               
         MVC   ERRCODE,0(R3)       SAVE ERROR                                   
         CLI   DELIVERY,REJECTED   REJECTION NOTIFICATION RECEIVED?             
         BE    EZDLN73                                                          
         CLI   DELIVERY,CANCELLD   CANCELLATION NOTIFICATION RECEIVED?          
         BE    EZDLN73                                                          
EZDLN65E OC    ERRCODE,ERRCODE     WAS IT SET?                                  
         BNZ   EZDLN73             YES                                          
         MVC   ERRCODE,=C'UNKN'    NO, THEN UNKNOWN                             
         B     EZDLN73                                                          
         DROP  R4                                                               
*                                                                               
EZDLN66  MVC   EZLEDGER,13(R3)     EZ LEDGER # OR ECN TRACKING NUMBER           
         CLI   DELIVERY,REJECTED   REJECTION NOTIFICATION RECEIVED?             
         BE    EZDLN67                                                          
         CLI   DELIVERY,CANCELLD   CANCELLATION NOTIFICATION RECEIVED?          
         BE    EZDLN67                                                          
...
*                                                                               
         CLI   MSG_REF#,VERSION4   VERSION 4 CUSTOMER REF. NUMBER?              
         BE    *+12                                                             
         CLI   MSG_REF#,VERSION1   VERSION 1 CUSTOMER REF. NUMBER?              
         BNE   *+16                                                             
         CLI   DRTEST,YES          IS THIS THE DR TEST?                         
         BE    EZDLN80             YES -- THROW AWAY LIVE TRAFFIC               
         B     EZDLN75             NO -- TAKE IT                                
*                                                                               
         CLI   MSG_REF#,VERSIOND   GENERATED DURING DR TEST?                    
...
*        B     EZDLN190            IGNORE THIS ONE                              
*                                                                               
EZDLN100 LA    R4,XMTNTRY                                                       
         USING XMTTABLD,R4                                                      
         CLI   XMTMETH,C'E'        EASYLINK TRANSACTION?                        
         BNE   EZDLN110                                                         
         CLI   DSTFLAG,YES         IS IT DAYLIGHT SAVING TIME?                  
         BNE   EZDLN110                                                         
*                                                                               
         XC    HALF,HALF                                                        
...
*                                                                               
         ...
         MVC   EXMTTBLE,AXMTTBL                                                 
         MVC   ETBLNTRY,XMTDSKAD                                                
         CLI   MSG_REF#,VERSION4   V4, OLD STYLE?                               
         BNE   *+10                NO                                           
...
*                                                                               
         ...
         B     EZDLN115                                                         
*                                                                               
EZDLN114 MVI   EACTION2,EACTREAQ   OTHERWISE, REATTEMPT NOTIFICATION            
         DROP  R4                                                               
*                                                                               
...
*                                                                               
         ...
         EJECT                                                                  
**********************************************************************          
* GET ENTRY FROM XMTTABLE BASED ON REFERENCE                                    
**********************************************************************          
GETXMNT  NTR1  BASE=*,LABEL=*                                                   
         LR    R3,R1               R1->REF# IN CHARACTER FORM                   
...
*                                                                               
         ...
         LA    R3,MSG_REF#                                                      
*                                                                               
         MVC   XMTSUBID,XREFSUBD                                                
         GOTO1 =V(HEXIN),DMCB,XREFUSRD,XMTUSRID,4,0                             
         GOTO1 =V(HEXIN),DMCB,XREFRPT#,XMTREFNO,4,0                             
         GOTO1 =V(HEXIN),DMCB,XREFCDAT,XMTCRDAT,4,0                             
         GOTO1 =V(HEXIN),DMCB,XREFCTIM,XMTCRTIM,4,0                             
         MVI   XMTLOGNO,0                                                       
         GOTO1 =V(HEXIN),DMCB,XREFLOG#,XMTLOGNO+0,4,0                           
         MVI   XMTDSTNO,0                                                       
         GOTO1 =V(HEXIN),DMCB,XREFDES#,XMTDSTNO+1,2,0                           
...
*                                                                               
         ...
         MVI   XMTSOURC,XMTSRCPQ   PRINT QUEUE REPORT                           
*                                                                               
         MVC   P+11(13),=CL13'***MSG_REF#**'                                    
         MVC   P+30(L'MSG_REF#),MSG_REF#                                        
         GOTO1 =V(PRINTER)                                                      
         MVC   P+11(13),=CL13'***BIN_KEY***'                                    
         MVC   P+30(XMTKEYQ),XMTNTRY                                            
         GOTO1 =V(PRINTER)                                                      
*                                                                               
         LA    R9,=C'XMTTABLE'     MINOR RESOURCE NAME                          
         MVC   P+30(8),MAJORNAM                                                 
...
*                                                                               
         ...
         BO    GETXMN90            NO                                           
         L     R4,DMCB             A(RECORD IN TABLE)                           
         ST    R4,AXMTNTRY         STORE A(THIS TABLE ENTRY)                    
         MVC   XMTNTRY,0(R4)       SAVE THE TABLE ENTRY                         
         SR    R5,R5                                                            
         B     *+6                                                              
GETXMN90 LR    R5,RE                                                            
*                                                                               
...
CALLMQ   NTR1  BASE=*,LABEL=*                                                   
         CLI   DOMQCALL,YES        DISABLED ALL MQ CALLS?                       
...
MSG_UUID DS    CL80                UUID - UNIQUE ID                             
MSG_DSN  DS    0CL80               FULL DSN FOR BDF                             
MSG_EMAL DS    CL80                EMAIL- SENT TO FOR PDF                       
*                                                                               
         DC    C'***FIELD***'      BDE NOTIFICATION INFO                        
FIELD    DS    CL201               1ST IS LEN, REST IS DATA                     
...
BDEERHDR DC    0CL9                                                             
         DC    CL3'ERR'            MARK IT 'ERR' FOR BDE ERROR                  
BDEER    DS    CL6                 BDE ERROR CODE #                             
BDEEMSG  DS    CL40                BDE ERROR CODE TEXT                          
*                                                                               
ELCODE   DS    X                                                                
...
VERSION1 EQU   C'1'                                                             
VERSION4 EQU   C'4'                                                             
VERSIOND EQU   C'D'                DISASTER RECOVER TESTING                     
*                                                                               
...
ECNTRKNM DS    CL8                 ECN TRACKING NUMBER                          
         ORG   EZLEDGER                                                         
XRRTRKNM DS    CL8                 EXTREME REACH TRACKING NUMBER                
         ORG                                                                    
RLFAXNUM DS    CL10                EAZYLINK DLN REDILIST FAX NUMBER             
*                                                                               
*                                                                               
OVERSIZE DC    AL1(NO)             MESSAGE OVERSIZE FLAG                        
*                                                                               
OPMCNT   DC    F'0'                OPMSG COUNTER                                
OPMTBIN  DC    F'0'                OPMSG LAST SENT AT THIS TIME                 
*                                                                               
OPMSG2   DS    0C                                                               
         DC    C'AUTONOTE*US-MF_FAC_NOTIFY:ECN ERROR, '                         
OPMSG2A  DC    C'?'                                                             
         DC    C'#'                                                             
...
*                                                                               
OPMSG6   DS    0C                                                               
         DC    C'AUTONOTE*US-MF_FAC_NOTIFY:BSS REJ MESSAGE-'                    
OPMSG6A  DS    CL50                                                             
OPMSG6Q  EQU   *-OPMSG6                                                         
*                                                                               
OPERSTOP DC    AL1(NO)             'Y' IF OPERATOR WANTS TO STOP                
DSTFLAG  DC    AL1(NO)             'Y' = DAYLIGHT SAVING TIME                   
...
DOMQCALL DC    AL1(YES)            'Y' IF DO ALL MQ CALLS                       
...
FACIDTAB DS    0CL8                                                             
         ...
         EJECT                                                                  
***********************************************************************         
* IO BLOCKS AND BUFFERS AND DCHAIN AREA                                         
***********************************************************************         
         DS    0D                                                               
         DC    C'*CIREC**'                                                      
...
***********************************************************************         
XREFKEYD DSECT                                                                  
XREFVER# DS    C               01  VERSION 1                                    
XREFDSPC DS    C               02  DATA SPACE                                   
XREFUSRD DS    CL4             03  USER ID IN HEX                               
XREFSUBD DS    CL3             06  SUB ID                                       
XREFRPT# DS    CL4             09  REPORT NUMBER IN HEX                         
XREFCDAT DS    CL4             13  CREATION DATE COMPRESSED IN HEX              
XREFCTIM DS    CL4             17  CREATION TIME IN HEX                         
XREFLOG# DS    CL4             21                                               
XREFDES# DS    CL2             25                                               
...
* CTGENMQDEF                                                                    
       ...
       ++INCLUDE CTGENMQDEF                                                     
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'057DDEDINJE  01/31/17'                                      
         END                                                                    
