*          DATA SET SPSFM58    AT LEVEL 047 AS OF 03/06/06                      
*PHASE T21758A                                                                  
T21758   TITLE 'SPSFM58 - COST2 TO TAKE OVER PROFIT WITHIN'                     
T21758   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,*T21758*,R7,RR=RE                                              
*                                                                               
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
         L     RA,ATWA                                                          
...
*                                                                               
         ...
         BC    0,C2NAVE             IS WILA (WHEN ASKED FOR)                    
*                                                                               
...
C2NAVE   DS    0H                                                               
         ...
         B     MYERROR                                                          
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY (VALKEY)'                  
***********************************************************************         
...
*------------------------- VALIDATE ESTIMATE -------------------------*         
*                                                                               
         LA    R2,CS2ESTH          ESTIMATE                                     
         BAS   RE,KYCHNGED         DID THIS KEY FIELD CHANGE?                   
         XC    CS2ESDT,CS2ESDT     CLEAR FIELD THAT DISPLAYS                    
         OI    CS2ESDTH+6,X80       THE ESTIMATE STRT/END DATES                 
*                                                                               
         GOTO1 VALIEST                                                          
         OI    4(R2),X'20'                                                      
*                                                                               
         ...
         ST    R1,OC2PCT           HOLD ONTO PW%                                
         EDIT  (R1),(8,CS2PRCT),6,ZERO=NOBLANK,FLOAT=-                          
         OI    CS2PRCTH+6,X80       AND DISPLAY IT                              
*                                                                               
         ...
         GOTO1 (RF),(R1),(X'10',ESTART),(5,CS2ESDT),0                           
*                                                                               
...
*                                                                               
         ...
         BNE   VKFLT20                                                          
*                                                                               
         TM    MISCFLG1,MF1MKFLT   DID WE HAVE MARKET FILTER LAST PASS?         
         BZ    *+8                  - NOPE, NO NEED TO REBUILD                  
         NI    MISCFLG1,XFF-MF1BLTAB   WE NEED TO REBUILD TABLE                 
*                                                                               
         OI    CHNGFLG1,CF1FLT      YES, FLAG THAT IT DID                       
*                                                                               
VKFLT20  BAS   RE,VALFLTS                                                       
         BNE   MYERROR                                                          
         OI    4(R2),X20           FIELD HAS BEEN VALIDATED                     
         B     VKBUYR                                                           
*                                                                               
...
VK110    DS    0H                                                               
         ...
         NI    SELFLAG1,XFF-SF1MNSEL-SF1TSLOK-SF1SELCT                          
         MVI   LKALLMDE,C'N'                                                    
         MVI   LKALLDNE,C'N'                                                    
...
*                                                                               
         ...
         GOTO1 (RF)                                                             
*                                                                               
         MVI   GOSUBN,C2S#         SET UP PW STUFF                              
         GOTO1 (RF)                                                             
*                                                                               
         B     XIT                                                              
         EJECT                                                                  
...
*                                                                               
         ...
         BE    VOPT14                                                           
         MVC   WORK(12),ESDATE     SET UP WORK FOR REQUEST TO MOBILE            
...
*                                                                               
         ...
         LA    RE,BRDWKTB2                                                      
VOPT12   CLM   R1,1,BYTE           CHECK FOR END CONDITIONS                     
         BH    VALOPTXN                                                         
         CLI   0(RE),X'FF'                                                      
         BE    VALOPTXN                                                         
         CLC   HALF,2(RE)          EST START DATE < END DATE OF MONTH?          
         BL    VOPT13              YES, WE FOUND THE VALID MONTHS               
         LA    RE,4(RE)                                                         
         LA    R1,1(R1)                                                         
         B     VOPT12                                                           
*                                                                               
VOPT13   ZIC   R0,SPOTPROF+6                                                    
         BCTR  R1,0                                                             
         AR    R1,R0                                                            
...
*                                                                               
         ...
         CLM   R1,1,HALF+1                                                      
         BNH   VOPT15                                                           
         B     VALOPTXN            THIS MONTH OUTSIDE BILLING MONTHS            
*                                                                               
VOPT13A  CLC   DATE3+1(1),HALF+1                                                
         BNH   VOPT15                                                           
         B     VALOPTXN            THIS MONTH OUTSIDE BILLING MONTHS            
*                                                                               
*                                  GET CALENDAR MNTH OF EST STRT DATE           
VOPT14   GOTO1 DATCON,DMCB,(3,ESDATEB),(0,DATE6),0                              
...
*                                                                               
         ...
         BH    VALOPTXN                                                         
*                                                                               
VOPT15   MVC   BILLYRMT,DATE3      SAVE (IMPLICIT YR &) MONTH INPUTTED          
...
VOPT17   CLI   0(R4),EOT           ARE WE AT THE END OF KEYWORD TABLE?          
...
*                                                                               
         ...
         BE    VOPT18                                                           
         LA    R1,1(R1)                                                         
VOPT17A  LA    R4,1(R4,R1)         BUMP TO NEXT KEYWORD IN TABLE                
         B     VOPT17                                                           
*                                                                               
VOPT18   DS    0H                  OPTION ENTRY FOUND                           
...
VALFLTS  NTR1                                                                   
*                                                                               
         CLC   =C'MKT',CS2FLTR     IS IT MKT=?                                  
         BE    VFLT02               - YUP, GO TO SCANNER RIGHT AWAY             
         NI    MISCFLG1,XFF-MF1MKFLT TURN OFF MARKET FILTER FLAG                
         B     VFLT05               - NOPE, CHECK OTHER FILTERS                 
***  NEW MARKET FILTER FOR C2           MHC 02/28/06                            
VFLT02   GOTO1 SCANNER,DMCB,(R2),(X'80',AIO3),0                                 
*                                                                               
         L     R2,AIO3                                                          
         USING SCANBLKD,R2                                                      
         TM    SC2NDVAL,SCNUMQ     X'80' - MUST BE ONLY NUMERIC                 
         BZ    VMKTBAD              - GET OUT OF HERE                           
         MVC   SVMKTFLT,SC2NDNUM+L'SC2NDNUM-L'BMKT                              
         OI    CHNGFLG1,CF1FLT     NEED TO FAKE OUT THE PROGRAM                 
***                                  EVEN IF THE MARKET DIDN'T CHANGE           
         NI    MISCFLG1,XFF-MF1BLTAB   WE NEED TO REBUILD TABLE                 
         OI    MISCFLG1,MF1MKFLT   WE HAVE A MARKET FILTER                      
         B     VALFLTXY                                                         
         DROP  R2                                                               
VMKTBAD  LA    R2,CS2FLTRH         INVALID MARKET                               
         B     EMKT                                                             
***  NEW MARKET FILTER FOR C2           MHC 02/28/06                            
*                                                                               
VFLT05   XC    SVMKTFLT,SVMKTFLT   CLEAR OUT MARKET FILTER                      
         LA    R2,CS2FLTRH                                                      
         MVI   GOSUBN,IFV#                                                      
         GOTO1 AGOSUB                                                           
*                                                                               
...
MTRQE    DS    0H                                                               
         ...
         B     MYERROR                                                          
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY (LISTRECS)'                
***********************************************************************         
*============================ LIST RECORD ============================*         
VL       GOTO1 =A(VALLINE),RR=RELO                                              
         B     XIT                                                              
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY (LISTRECS)'                
***********************************************************************         
...
LR04     DS    0H                                                               
         MVC   CS2TOTL,SPACES                                                   
         OI    CS2TOTLH+6,X80      TRANSMIT TOTALS LINE                         
*                                                                               
         LA    R4,CS2TOTL                GET R4-->DISPLAY LINE                  
         USING LISTD,R4                                                         
         XC    DUB,DUB                                                          
...
*                                                                               
         B     XIT                                                              
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST'                                   
***********************************************************************         
...
GOSUBGO  GOTO1 ASUBRTN,DMCB,(GOSUBN,(RC))                                       
         ...
         XIT1                                                                   
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (MISC STUFF)'                      
***********************************************************************         
*======================== MISCELLANEOUS STUFF ========================*         
*                                                                               
YES      SR    RC,RC                                                            
...
MYERR23  B     C2NAV               PW FUNCTIONS NOT AVAIL TO BUY SVCE           
...
NBKP     MVC   MSGNUM2,=AL2(SE#NBKUP)                                           
         B     ERRGTXT                                                          
*                                                                               
C2NAV    MVC   MSGNUM2,=AL2(SE#PWNAV)                                           
         B     ERRGTXT                                                          
*                                                                               
...
ERREXIT  DS    0H                                                               
         ...
         B     XIT                                                              
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (LTORG && CONST)'                  
***********************************************************************         
*======================== LTORG AND CONSTANTS ========================*         
         LTORG                                                                  
         SPACE 2                                                                
...
*                                                                               
         ...
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR01)'                          
***********************************************************************         
*======================== SUBROUTINE POOL ONE ========================*         
SUBR01Q  EQU   ((((*-T21758)/4096)+1)*4096)                                     
*                                                                               
         ORG   T21758+SUBR01Q                                                   
SUBR01   NMOD1 0,**5801**                                                       
         SR    RC,RC                                                            
...
NO_01    LTR   RC,RC                                                            
XIT_01   XIT1                                                                   
         TITLE 'SPSFM58 - PW LIST (SUBR01--IOV#)'                               
*------------------------- INIT OPTION VALUES ------------------------*         
*                                                                               
...
IOVX     DS    0H                                                               
         B     XIT_01                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR01--VLA#)'                               
...
VLAXY    DS    0H                                                               
         B     YES_01                                                           
         DROP  R3                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR01--IFV#)'                               
*------------------------- INIT FILTER VALUES ------------------------*         
*                                                                               
...
IFVX     DS    0H                                                               
         B     XIT_01                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR01--VFD#)'                               
...
VFDXN    DS    0H                                                               
         B     NO_01                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR01--VFL#)'                               
...
VFLXN    DS    0H                                                               
         B     NO_01                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR01--ISL#)'                               
*------------------------- TEST SELECT FIELD -------------------------*         
*                                                                               
...
ISLX     DS    0H                                                               
         B     XIT_01                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR01--TSL#)'                               
*------------------------- TEST SELECT FIELD -------------------------*         
*                                                                               
...
** CHECK LISTED LINES **                                                        
*                                                                               
         LA    R2,CS2SELH          R2-->FIRST SELECT FIELD.                     
...
TSL12    CLI   0(RE),XFF                                                        
         ...
         MVC   WORK(L'CS2SEL),8(R2)                                             
         OC    WORK(L'CS2SEL),SPACES                                            
...
TSL40    DS    0H                                                               
         ...
         LA    RF,CS2PFLNH         RF-->LAST LINE ON SCREEN                     
...
TSLBUMP  DS    0H                  MAKE SURE ONLY R1 & R2 ARE CHANGED           
         ...
         AR    R2,R1               R2-->NEXT SELECT FIELD                       
         BR    RE                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR01--FSL#)'                               
*------------------------- FILL SELECT FIELDS ------------------------*         
*                                                                               
...
FSLBUMP  DS    0H                  MAKE SURE ONLY R1 & R2 ARE CHANGED           
         ...
         AR    R2,R1               R2-->NEXT SELECT FIELD                       
         BR    RE                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR01--VSL#)'                               
...
VSLBUMP  DS    0H                  MAKE SURE ONLY R1 & R2 ARE CHANGED           
         ...
         AR    R2,R1               R2-->NEXT SELECT FIELD                       
         BR    RE                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR01--IPF#)'                               
*------------------------- INITIALIZE PFKEYS -------------------------*         
*                                                                               
IPFKEY   DS    0H                                                               
*                                                                               
...
IPFX     DS    0H                                                               
         B     XIT_01                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR01--C2S#)'                               
*-------------------------- GENERAL PW SETUP -------------------------*         
*                                                                               
C2SETUP  DS    0H                                                               
...
*                                                                               
         ...
         BO    C2S10                YES, JUST RESTORE TABLES                    
*                                                                               
...
*                                                                               
         ...
         BZ    C2S20                NOPE, BUILD THEM NOW                        
         B     C2S10               ELSE, GO RESTORE TABLES                      
*                                                                               
** RESTORE TIA TABLES **                                                        
*                                                                               
C2S10    DS    0H                  RESTORE TIA TABLES                           
         MVI   GOSUBN,RTI#                                                      
         GOTO1 AGOSUB                                                           
*                                                                               
         L     RF,ATIA                                                          
         ...
         BE    C2S30                       IF YES, RE-PROCESS ACCUTAB,          
         MVC   0(8,RF),=C'*ACTB42*'         RIGHT ACCUTAB                       
         OI    CHNGFLG1,CF1ACCTB                                                
         B     C2S20                        ELSE, REBUILD TABLES                
*                                                                               
** BUILD TABLES **                                                              
*                                                                               
C2S20    DS    0H                   BUILD EVERYTHING FROM SCRATCH               
...
*                                                                               
         ...
         B     C2S30               GO PROCESS ACCUTAB                           
*                                                                               
** PROCESS ACCUTAB **                                                           
*                                                                               
C2S30    DS    0H                  PROCESS ACCUTAB                              
...
*                                                                               
         ...
         BNZ   C2S35                YES, NEED TO PROCESS ACCUTAB                
         TM    SELFLAG1,SF1SELCT   ANY SELECTION MADE?                          
         BO    C2S35                YES, PW RECDS MAY HAVE CHANGED              
         B     C2S40                                                            
*                                                                               
C2S35    DS    0H                                                               
...
C2SX     DS    0H                                                               
         B     XIT_01                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR01--SDC#)'                               
...
*                                                                               
         B     XIT_01                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR01--PAT#)'                               
*--------------------------- PROCESS ACCUTAB -------------------------*         
*                                                                               
...
PAT24A   BAS   RE,NEXTEL                                                        
         ...
         AR    R5,R0                                                            
         L     RE,APWREC                                                        
         OC    PWKSTA-PWFKEY(L'PWKSTA,RE),PWKSTA-PWFKEY(RE)                     
         BNZ   PAT24A                                                           
         MVC   ATCS2,C2STPCT       ONLY MARKET LEVEL HAS LOCKED C2              
         B     PAT24A                                                           
*                                                                               
PAT24B   GOTO1 SEQ                                                              
...
PATX     DS    0H                                                               
         ...
         DROP  R2                                                               
*                                                                               
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR01--LTORG && CONSTANT+        
                S)'                                                             
*------------------------- LTORG & CONSTANTS -------------------------*         
         LTORG                                                                  
*                                                                               
X6FFS    DC    6X'FF'                                                           
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR01--MISC STUFF)'              
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR02)'                          
***********************************************************************         
*======================== SUBROUTINE POOL TWO ========================*         
SUBR02Q  EQU   ((((*-T21758)/4096)+1)*4096)                                     
*                                                                               
         ORG   T21758+SUBR02Q                                                   
SUBR02   NMOD1 0,**5802**                                                       
         SR    RC,RC                                                            
...
*                                                                               
         ...
         B     R02_00(R1)                                                       
*                                                                               
C2PW#    EQU   ((R02_01-R02_00)/4+1)+R01#                                       
...
NO_02    LTR   RC,RC                                                            
XIT_02   XIT1                                                                   
         TITLE 'SPSFM58 - PW LIST (SUBR02--C2PW#)'                              
*--------------------------- CALCULATE PW% ---------------------------*         
*                                                                               
* At entry, TEMPAJB, TEMPACB, TEMPACG, TEMPTAX, & TEMPCOS2 are set.             
* At exit, TEMPCOS2 has the calculated PW%.                                     
*                                                                               
C2CPW    DS    0H                                                               
*******  MVC   TEMPCOS2,OC2PCT     SET DEFAULT VALUE                            
...
C2CPWX   DS    0H                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--RUP#)'                               
*------------------------------ ROUNDING -----------------------------*         
*                                                                               
...
ROUNDUP  DS    0H                                                               
         ...
         ST    R1,FULL                                                          
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--CAN#)'                               
*-------------------------- CHECK ALPHANUMERIC -----------------------*         
*                                                                               
...
CANXY    B     YES_02                                                           
CANXN    B     NO_02                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR02--FCW#)'                               
...
*^^NOP   MVI   WORK+15,X'21'                                                    
         ...
         BR    RE                                                               
*                                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR02--FPL#)'                               
*---------------------- FORMAT PW% ONTO LISTLINE ---------------------*         
*                                                                               
* CALCULATES AND PUTS CS2 ONTO LIST LINE.                                       
* At entry,                                                                     
*   R4-->list line.                                                             
...
*                                                                               
         ...
         LA    R5,TOTLCOS2                                                      
*                                                                               
         MVC   0(L'LSTCOS2,R5),SPACES                                           
         MVC   0(L'LSTCOS2,R5),=C'***N/A**'  ASSUME CS2% NOT APPLICABLE         
         OC    TEMPACB,TEMPACB     IS LOCKED ACTUAL COST ZERO?                  
         BZ    FPL30                YES, GOOD ASSUMPTION                        
*                                                                               
*                                  LOCKED ACTUAL COST NON-ZERO                  
         MVC   0(L'LSTCOS2,R5),=C'**RNGE**'  ASSUM LCKD CS2% OUT-OF-RNG         
...
*****    CR    R4,R1                                                            
*****    BL    FPL10                                                            
         MVI   GOSUBN,C2PW#         NO, CALCULATE THE LOCKED PW%                
         GOTO1 AGOSUB                                                           
*                                                                               
FPL10    L     R1,TEMPCOS2                                                      
         C     R1,=A(MINPWQ)                                                    
...
*                                                                               
         MVC   0(L'LSTCOS2,R5),SPACES                                           
         MVI   0(R5),C'0'        ASSUME LOCKED PW% IS ZERO                      
         LTR   R1,R1                                                            
         BZ    FPL30                                                            
         EDIT  (R1),(8,(R5)),6                                                  
         B     FPL30                                                            
...
FPLX     DS    0H                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--BGI#)'                               
...
*                                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--STI# && RTI#)'                       
*--------------------------- SAVE TIA TABLES -------------------------*         
*                                                                               
...
RSTRTIA  DS    0H                                                               
         ...
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--VDC#)'                               
...
VDCXN    DS    0H                                                               
         ...
         B     NO_02                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR02--CMB#)'                               
...
*                                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--VBI#)'                               
...
VBIXN    DS    0H                                                               
         MVC   4(1,R2),8(R2)       FUDGE IT TO HAVE DSPL TO 2ND FIELD           
         B     NO_02                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR02--FTE#)'                               
*---------------------------- FILTER TEST ----------------------------*         
*                                                                               
FLTRTST  DS    0H                                                               
         L     R2,AFLTABS                                                       
...
FTEXY    DS    0H                  PASSED FILTER                                
         B     YES_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--LMK#)'                               
*----------------------------- LOCATE MARKET -------------------------*         
*                                                                               
...
LMKXN    DS    0H                                                               
         B     NO_02                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR02--AMK#)'                               
*------------------------------ ADD MARKET ---------------------------*         
*                                                                               
...
*                                                                               
         ...
         BNZ   ADDMKT10                                                         
         MVC   CONHEAD(40),=C'ERROR: MORE THAN 255 MKTS WITH BUY/GOAL/'         
         MVC   CONHEAD+40(12),=C'C2 RECORDS!!'                                  
         OI    CONHEADH+6,X'C8'    HIGH INTENSITY AND CURSOR HERE               
         DC    H'0',C'$ABEND'       YEP, DIE                                    
*                                                                               
ADDMKT10 L     R0,8(R1)            R0=# OF RECORDS SO FAR                       
         STH   R0,ACCUTABN                                                      
         MVC   FULL+1(3),1(R1)     FULL=A(ENTRY FOR MARKET)                     
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--SCR#)'                               
*------------------------------ SET SCREEN ---------------------------*         
*                                                                               
...
SETSCRN  DS    0H                                                               
         ...
         XC    CS2PFLN,CS2PFLN                                                  
         MVC   CS2CHDR(3),=C'SEL'                                               
         OI    CS2CHDRH+6,X80      TRANSMIT COLUMNS HEADER LINE                 
         OI    CS2TOTLH+6,X80      TRANSMIT TOTALS LINE                         
         OI    CS2PFLNH+6,X80      TRANSMIT PFLINE                              
*                                                                               
...
SCRB10   DS    0H                                                               
         ...
         USING BLSTMKT,R2                                                       
         PRINT GEN                                                              
         MVC   BLSTMKT,=C'MKT#/MARKET NAME'                                     
         MVC   BLSTPLK(4),=C'C2LK'                                              
         MVCDD BLSTBILL,SP#BLLD    BLLD                                         
         MVCDD BLSTDRCR+1,SP#PWADC ADJUSTED DR/CR                               
         PRINT NOGEN                                                            
         DROP  R2                                                               
*                                                                               
         MVCDD CS2PFLN,SP#PWLPB                                                 
         B     SCRX                                                             
*                                                                               
SCRM10   DS    0H                                                               
         LA    R2,CS2CHDR+4                                                     
         USING LSTMKT,R2                                                        
         MVC   LSTMKT(16),=C'MKT#/MARKET NAME'                                  
         MVI   LSTBYS,C'B'                                                      
         MVI   LSTGLS,C'G'                                                      
*****    MVC   LSTCLK,=C'CL$LK'                                                 
         MVC   LSTSLK,=C'STALK'                                                 
         MVC   LSTBLK(5),=C'BUYLK'                                              
         MVC   LSTPLK(4),=C'C2LK'                                               
         MVC   LSTCLOCK(6),=C'CLLOCK'                                           
         MVC   LSTWLOCK(7),=C'WIMLOCK'                                          
         MVC   LSTCOS2(6),=C'LKCOS2'                                            
         DROP  R2                                                               
         MVCDD CS2PFLN,SP#PWLPM                                                 
         B     SCRX                                                             
*                                                                               
SCRX     DS    0H                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--SMB#)'                               
*---------------------------- SET MAINT/BILL -------------------------*         
*                                                                               
...
SMBX     DS    0H                                                               
         B     XIT_02                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR02--VMTH#)'                              
*--------------------------- VALIDATE MONTH --------------------------*         
*                                                                               
...
VMTHXY   DS    0H                                                               
         B     YES_02                                                           
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR02--LTORG && CONSTANT+        
                S)'                                                             
*------------------------- LTORG & CONSTANTS -------------------------*         
         LTORG                                                                  
*                                                                               
ALPHANUM DC    C'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\'                         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR02--MISC STUFF)'              
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SUBR03)'                          
***********************************************************************         
*======================= SUBROUTINE POOL THREE =======================*         
SUBR03Q  EQU   ((((*-T21758)/4096)+1)*4096)                                     
*                                                                               
         ORG   T21758+SUBR03Q                                                   
SUBR03   NMOD1 0,**5803**                                                       
         SR    RC,RC                                                            
...
NO_03    LTR   RC,RC                                                            
XIT_03   XIT1                                                                   
         TITLE 'SPSFM58 - PW LIST (SUBR03--GMB#)'                               
...
*                                                                               
         ...
         USING BUYRECD,R6                                                       
****   MARKET FILTER CODE                                                       
         OC    SVMKTFLT,SVMKTFLT   DO WE HAVE A MARKET FILTER?                  
         BZ    GMB17                - NOPE, NORMAL                              
         CLC   SVMKTFLT,BUYMSTA    IS IT WHAT WE WANT?                          
         BNE   GMB12                - NOPE                                      
****   MARKET FILTER CODE              MHC  02/28/06                            
*                                                                               
GMB17    CLC   BUYKEST,BEST        DID WE MATCH ON ESTIMATES?                   
...
GMB32G   EQU   *                                                                
         DROP  R3                                                               
*                                                                               
GMB33    MVC   TEMPBMKT,BUYMSTA    LOCATE MARKET IN ACCUTAB                     
         MVI   GOSUBN,LMK#                                                      
         GOTO1 AGOSUB                                                           
         BE    GMB35                                                            
*                                                                               
...
GMB35    DS    0H                  FULL=A(ACCUTAB ENTRY FOR MARKET)             
         ...
         DROP  R2                                                               
         OC    SVMKTFLT,SVMKTFLT   WE HAVE A MARKET FILTER?                     
         BNZ   GMBX                 - YUP, WE'RE DONE                           
*                                                                               
...
GMBGTRDX DS    0H                                                               
         B     XIT_03                                                           
         DROP  R3,R6                                                            
         TITLE 'SPSFM58 - PW LIST (SUBR03--GMG#)'                               
...
****   MARKET FILTER CODE                                                       
         OC    SVMKTFLT,SVMKTFLT   DO WE HAVE A MARKET FILTER?                  
         BZ    GMG15                - NOPE, NORMAL                              
         CLC   SVMKTFLT,GKEYMKT    IS IT WHAT WE WANT?                          
         BNE   GMG10C               - NOPE                                      
****   MARKET FILTER CODE              MHC  02/28/06                            
*                                                                               
GMG15    CLC   GKEYEST,BEST        DID WE MATCH ON ESTIMATES?                   
...
GMGX     DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR03--GSB#)'                               
*------------------------ GET STATION BUCKET -------------------------*         
*                                                                               
...
GSBX     DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR03--GBI#)'                               
*-------------------------- GET BILL RECORD --------------------------*         
*                                                                               
...
GBIX     DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR03--GBT#)'                               
...
*                                                                               
         ...
         BNE   GBT039                                                           
*                                                                               
         CLI   SPOTPROF+2,0        USING STANDARD BROADCAST?                    
         BE    *+12                YES                                          
         LA    RF,BRDWKTB2         NO, WE HAVE THE START DATE                   
         B     GBT038                  NOW WE GET THE END AS WELL               
*                                                                               
...
*                                                                               
         ...
         LA    RF,WORK                                                          
GBT038   MVC   BILLYMSE+0(2),0(RF)   START DATE OF FIRST WEEK                   
         CLI   4(RF),XFF                                                        
         BE    *+12                                                             
         LA    RF,4(RF)                                                         
         B     *-12                                                             
...
*                                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR03--BPK#, BBK#, BGK#, BSK#, && B+        
               BLK#)'                                                           
*---------------------------- BUILD PW KEY ---------------------------*         
*                                                                               
...
*                                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR03--GPR#)'                               
*---------------------------- GET PW RECORD --------------------------*         
*                                                                               
...
GPRX     DS    0H                                                               
         B     XIT_03                                                           
         DROP  R6                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR03--GMP#)'                               
*------------------------- GET MARKETS WITH PW -----------------------*         
*                                                                               
...
****   MARKET FILTER CODE                                                       
         OC    SVMKTFLT,SVMKTFLT   DO WE HAVE A MARKET FILTER?                  
         BZ    GMP20                - NOPE, NORMAL                              
         CLC   SVMKTFLT,PWKMKT     IS IT WHAT WE WANT?                          
         BNE   GMPX                 - NOPE                                      
****   MARKET FILTER CODE              MHC  02/28/06                            
GMP20    MVC   TEMPBMKT,PWKMKT     LOCATE MARKET IN ACCUTAB                     
         MVI   GOSUBN,LMK#                                                      
         GOTO1 AGOSUB                                                           
         BE    GMP35                                                            
*                                                                               
...
GMPX     DS    0H                                                               
         B     XIT_03                                                           
         TITLE 'SPSFM58 - PW LIST (SUBR03--???#)'                               
*--------------------------- ????????????? ---------------------------*         
*                                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR03--LTORG && CONSTANTS)'                 
*------------------------- LTORG & CONSTANTS -------------------------*         
         LTORG                                                                  
*                                                                               
*                                                                               
         TITLE 'SPSFM58 - PW LIST (SUBR03--MISC STUFF)'                         
...
***********************************************************************         
         DROP  R8,R9,RA,RB,RC                                                   
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (TABLES)'                          
***********************************************************************         
*======================== MISCELLANEOUS TABLES =======================*         
*                                                                               
TTABDSP  DS    0H                  TABLE OF TABLE DISPLACEMENTS                 
         DC    Y(DATDSPTB-T21758)                                               
         DC    Y(LBLTAB-T21758)                                                 
         DC    Y(COREQLST-T21758)                                               
         DC    Y(MPFTABLE-T21758)                                               
         DC    Y(BPFTABLE-T21758)                                               
         DC    Y(MFLTABLE-T21758)                                               
         DC    Y(BFLTABLE-T21758)                                               
         DC    Y(MOPTABLE-T21758)                                               
         DC    Y(BOPTABLE-T21758)                                               
         DC    Y(GOSUB-T21758)                                                  
         DC    Y(SUBR01-T21758)                                                 
         DC    Y(SUBR02-T21758)                                                 
         DC    Y(SUBR03-T21758)                                                 
...
LBLTAB   DS    0CL(2+2+8)          TABLE OF LABELS FOR SPOT STRG AREA           
         ...
         DC    AL2(C2RCLABL-SPOTAREA,C2REC-SPOTAREA),CL8'*PWRECD*'              
...
PFT02K   DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
...
PFT03SEL DC    CL3'R  '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'MAINTAIN'        ACTION                                      
PFT03K   DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
...
PFT05SEL DC    CL3'SL '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'MAINTAIN'        ACTION                                      
PFT05K   DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
...
PFT06SEL DC    CL3'BL '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'MAINTAIN'        ACTION                                      
PFT06K   DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
...
PFT07SEL DC    CL3'BU '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'MAINTAIN'        ACTION                                      
PFT07K   DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
...
PFT08SEL DC    CL3'PL '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'MAINTAIN'        ACTION                                      
PFT08K   DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
...
BPFT03SL DC    CL3'B  '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'BILL    '        ACTION                                      
BPFT03K  DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
BPFT03X  EQU   *                                                                
*                                                                               
BPFT04   DS    0C                  COST2/Bill & force CLT$ Adj DR/CR=0          
...
BPFT04SL DC    CL3'B0 '             SELECT CODE                                 
         DC    CL8'C2      '        RECORD                                      
         DC    CL8'BILL    '        ACTION                                      
BPFT04K  DC    AL1(KEYTYTWA,L'CS2MED-1),AL2(CS2MED-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2CLT-1),AL2(CS2CLT-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2PRD-1),AL2(CS2PRD-T217FFD)                     
         DC    AL1(KEYTYTWA,L'CS2EST-1),AL2(CS2EST-T217FFD)                     
         DC    AL1(KEYTYCUR,L'LSTMKT-1),AL2(LSTMKT-LISTD)                       
...
FLT5NAM2 DC    AL1(FLT5NAMX-FLT5NAM2-1),C'C2LK'                                 
FLT5NAMX DC    AL1(EOT)                                                         
FLT5FTS1 DC    AL1(FTSTYXCT),AL1(L'FTVLLOCK)                                    
         DC    AL2(C2LOCK-SYSD,0)                                               
         DC    AL2(FTVLLOCK-FTVLDTD)                                            
...
BFLT1NA2 DC    AL1(BFLT1NAX-BFLT1NA2-1),C'C2LK'                                 
BFLT1NAX DC    AL1(EOT)                                                         
...
*                                                                               
         ...
         LTORG                                                                  
***********************************************************************         
* VALIDATE THE LISTED LINE                                                      
***********************************************************************         
VALLINE  NTR1  BASE=*,LABEL=*                                                   
VLX      XIT1                                                                   
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST'                                   
***********************************************************************         
...
NLSTLINQ EQU   ((CS2TOTLH-CS2SELH)/(CS2DATA+L'CS2DATA-CS2SELH))                 
C2BLKL   EQU   C2BLKX-C2BLKD                                                    
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SPSFMWORKD)'                      
***********************************************************************         
*============================= SPSFMWORKD ============================*         
       ++INCLUDE SPSFMWORKD                                                     
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (TWA DSECTS)'                      
***********************************************************************         
*================================ TWA ================================*         
*                                                                               
*---------------------------- BASE SCREEN ----------------------------*         
...
*--------------------------- PW LIST SCREEN --------------------------*         
       ...
       ++INCLUDE SPSFM65D                                                       
*                                                                               
         DS    0CL((L'CS2OPTN-L'C2MOPTN)+1)                                     
         DS    0CL((L'C2MOPTN-L'CS2OPTN)+1)                                     
         EJECT                                                                  
*---------------------------- STORAGE AREA ---------------------------*         
*                                                                               
...
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY'                           
***********************************************************************         
*============================ OTHER DSECTS ===========================*         
*                                                                               
* DDGENTWA                                                                      
...
* SPMSGEQUS                                                                     
       ...
       ++INCLUDE SPMSGEQUS                                                      
         PRINT ON                                                               
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST (SPGEN DSECTS)'                    
***********************************************************************         
*============================ SPGEN DSECTS ===========================*         
*                                                                               
*----------------------------- SPGENWIPW -----------------------------*         
...
*                                                                               
       ++INCLUDE SPC2BLOCK                                                      
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY (SYSD)'                    
***********************************************************************         
*========================== SAVED WORK AREA ==========================*         
*                                                                               
SYSD     DSECT                                                                  
...
SVOPTFLD DS    CL(L'CS2OPTN)       SAVE TEXT IN OPTIONS FIELD                   
*                                                                               
...
BASE1    DS    A                   A(T21758)                                    
BASE2    DS    A                   A(T21758+X'1000')                            
*                                                                               
ATABS    DS    0A                  A(TABLES IN T21758 CSECT)                    
...
*                                 **************** MISC ***************         
MYDUB    DS    D                                                                
OC2PCT   DS    F                   THE PW% FROM ESTIMATE RECORD                 
HOLDRE   DS    F                                                                
*                                                                               
TOTLVALS DS    0F                                                               
WIMLKTOT DS    F                                                                
...
SVINPMKT DS    XL(L'BMKT)          SAVE INPUT MARKET  (STARTING MARKET)         
SVMKTFLT DS    XL(L'BMKT)          SAVE MARKET FILTER                           
...
C2LOCK   DS    CL1                 PW  STATUS--(L)OCK/(U)NLOCK                  
...
CF1ACCTB EQU   X02                  NON-SPSFM58 ACCUTAB IN TEMPSTR              
...
MF1MKFLT EQU   X04                  WE HAVE (HAD) A MARKET FILTER               
*                                                                               
...
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY (MISC DSECTS)'             
***********************************************************************         
*========================== LIST LINE DSECT ==========================*         
*                                                                               
*------------------------ BUYER (MAINT) SCREEN -----------------------*         
...
LSTGLS   DS    CL1                                                              
         DS    CL1                                                              
         DS    CL5    <=== LABEL USED TO BE LSTCLK                              
         DS    CL1                                                              
LSTSLK   DS    CL5                                                              
         DS    CL1                                                              
LSTBLK   DS    CL6                                                              
...
FLTRTNUM DS    XL1                 VALIDATION ROUTINE # (FLFVLRTN)              
         ORG   FLTRTNUM                                                         
FLTTBDSP DS    AL2                 VLDTN TABLE DSPL FROM T21758 CSECT           
...
*                                                                               
***********************************************************************         
         TITLE 'SPSFM58 - PROFIT WITHIN LIST OVERLAY (SPOT STRG AREA)'          
***********************************************************************         
*========================= SPOT STORAGE AREA =========================*         
*                                                                               
SPOTAREA DSECT                                                                  
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'047SPSFM58   03/06/06'                                      
         END                                                                    
