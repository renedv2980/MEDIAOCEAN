*          DATA SET ACREPXY02B AT LEVEL 133 AS OF 05/01/02                      
*PHASE ACXY02A                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE HELLO                                                                  
*INCLUDE DATCON                                                                 
...
*                                                                               
         LA    R5,DKEY                                                          
         MVC   TRNKEY,SKKEY        GET SK POSTING                               
         L     R3,AIO1                                                          
         BAS   RE,READ                                                          
         BE    *+6                                                              
         DC    H'00'                                                            
...
*  DMDTFIS                                                                      
       ...
       ++INCLUDE DMDTFIS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'133ACREPXY02B05/01/02'                                      
         END                                                                    
