*          DATA SET RECNT00    AT LEVEL 127 AS OF 01/09/13                      
*PHASE T80200A                                                                  
*INCLUDE GETBROAD                                                               
*INCLUDE REGENSTC                                                               
*INCLUDE REGENDAY                                                               
...
*                                                                     *         
* 05APR12 KWA Handle Globber objects from Rep Link program            *         
* 30JAN12 SKU ADD UY TO TURNAROUND AND ARCHIVE                        *         
* 17JAN12 BOB PF KEYS FOR AUDIT RECORDS                               *         
* 01DEC11 SKU ADD UV TO TURNAROUND AND ARCHIVE                        *         
* 05OCT10 SKU FIX PARTIAL CONFIRM COMMENT BUG                         *         
* 02AUG10 SKU SCRIPT CONTRACT UPLOAD SUPPORT                          *         
*             COMMENT OUT SETCOMBO ROUTINE FOR ADDRESSIBILITY         *         
*             COMMENT OUT AVN TERMINAL CHECK FOR ADDRESIBILITY        *         
*             COMMENT OUT AVNFLD ROUTINE FOR ADDRESIBILITY            *         
* 22OCT07 SKU SKIP HOME MARKET CHECK FOR CBS                          *         
* 03OCT07 HQ  SPOT # CHANGE SHOULDN'T BE CONSIDERED EFF DATE CHANGE   *         
* 30JUL07 BU  GLOBBER CALL FROM SWP: SKIP PAR CHECK                   *         
* 18APR06 BU  CBS HOME MARKET CHANGE                                  *         
* 31AUG05 BU  HOME MARKET EC FIX                                      *         
* 04MAY05 HQ  GET DEMCON ADDRESS PER DEIS                             *         
* 10FEB04 HQ  CLEAR CONTRACT NUMBER FIELD ON GLOBBER RETURN           *         
* 09FEB04 SKU ACCOMMODATE 8 DIGIT CONTRACT NUMBER IN T/A              *         
...
*                                                                               
         ...
         SPACE 1                                                                
         NI    TWASTREO,X'FF'-TWARCUQ RESET SCRIPT IN USE                       
...
*                                                                               
         ...
         L     R1,0(R1)                                                         
         USING F@UTLD,R1                                                        
*                                  TEST FOR SCRIPT UPLOAD                       
         TM    F@TSTAT6,TST6SCRP                                                
         BZ    *+8                                                              
         OI    TWASTREO,TWARCUQ    SET SCRIPT IN USE                            
*                                                                               
         ...
         OI    TWASTREO,TWARCUQ    SET SCRIPT IN USE                            
*                                                                               
CON12    DS    0H                  TEST FOR STEREO                              
         TM    F@TSTAT6,TST6STRO+TST6STFU                                       
         BO    CON13                                                            
         DROP  R1                                                               
*                                                                               
****>>>  XC    TWASTREO,TWASTREO   'CLEAR' MOVED UP A BIT                       
         B     CON14                                                            
*                                                                               
CON13    DS    0H                                                               
...
*                                                                               
******   BRAS  RE,AUDPFK           CHECK FOR AUDIT REC & PFKEY                  
*                                                                               
...
*              GET THE CONTRACT                                                 
         SPACE 1                                                                
CON20    DS    0H                                                               
         CLC   =C'RCU',CONCACT     SPECIAL RCU ACTION                           
         BNE   CON21                                                            
         GOTOR RCUDISP                                                          
         B     CON33                                                            
*                                                                               
CON21    DS    0H                                                               
         CLC   =C'R$,',CONCACT     SPECIAL SCRIPT ACTION                        
         BNE   CON22                                                            
         LA    R3,102              INVALID REP                                  
         CLC   REPALPHA,CONCACT+3                                               
         BNE   ERROR                                                            
         OI    CONCACTH+6,X'40'+X'80'                                           
         GOTO1 GETTXT,DMCB,156,0,(C'I',0),0,X'44',0                             
         B     EXXMOD                                                           
*                                                                               
CON22    DS    0H                                                               
         CLC   =C'R#',CONCACT      SPECIAL SCRIPT ACTION                        
...
*                                                                               
CON33    DS    0H                                                               
         XC    WORK,WORK           BUILD PAR SECURITY CHECK                     
         LA    R1,WORK                                                          
         USING SBLOCK,R1                                                        
...
SWP      USING GLVXFRSY,R3                                                      
         ...
         BE    CON40               YES - IGNORE THE ERROR RETURN                
*                                                                               
         DROP  SWP                                                              
*                                                                               
         XC    DUB,DUB                                                          
         ...
         BE    CON40                                                            
         LA    R3,860              NO  - TREAT AS AN ERROR                      
         LA    R2,CONCNUMH                                                      
         OI    6(R2),X'40'+X'80'                                                
         B     ERROR                                                            
*                                                                               
* SPECIAL ACTION ADDN TO ALLOW PAR TO PRE-ASSIGN CONTRACT NUMBERS               
...
CK400    CLI   0(R5),C'T'          TIMES?                                       
         ...
         B     CK600                                                            
*                                                                               
CK410    CLI   0(R5),C'S'          spot/week?                                   
         BNE   CK420                                                            
         CLC   8(2,R2),8(R3)       NEW V OLD spots/week                         
         BNE   CKXIT                                                            
         B     CK600                                                            
*                                                                               
CK420    CLI   0(R5),C'E'          EFFECTIVE DAYS                               
         BNE   CK500                                                            
         CLC   2(6,R2),2(R3)       NEW V OLD EFFECTIVE DATES                    
         BNE   CKXIT                                                            
         B     CK600                                                            
...
*        UNPK  QCONT(8),RCONKCON(5)                                             
         GOTO1 HEXOUT,DMCB,RCONKCON,QCONT,4                                     
*                                                                               
...
*                                                                               
BERROR08 DS    0H                                                               
         CLC   =C'LIN',TWAGENCP    From Rep/Link program?                       
         JE    BERROR09                                                         
...
*                                                                               
         ...
         EJECT                                                                  
*                                                                               
PRCMQMSG NTR1  BASE=*,LABEL=*      Process MQ message                           
*                                                                               
         LR    R3,RA                                                            
         AHI   R3,TWAWORKQ                                                      
         USING TWAWORK,R3                                                       
*                                                                               
         TM    TWACONFG,TW_WIPSQ   Contract is in WIPS?                         
         JZ    P_MQM20                                                          
         GOTO1 VLOAD,DMCB,(X'81',0),=C'MQWIP'   Process MQ WIPS msg             
         J     P_MQM30                                                          
*                                                                               
P_MQM20  TM    TWACONFG,TW_TRFOQ   Traffic order# is changed?                   
         JZ    P_MQM22                                                          
         GOTO1 VLOAD,DMCB,(X'81',0),=C'MQTR#'   Process MQ traf ord#            
         J     P_MQM30                                                          
*                                                                               
P_MQM22  GOTO1 VLOAD,DMCB,(X'81',0),=C'MQMSG'   Process MQ message              
*                                                                               
P_MQM30  DS    0H                                                               
*                                                                               
         XIT1                                                                   
...
*                                                                               
***********************************************************************         
* RCUDISP - DISP CONTRACT BY STATION AND TRAFFIC NUMBER                         
***********************************************************************         
RCUDISP  NTR1  BASE=*,LABEL=*                                                   
         LR    R7,RA                                                            
         AH    R7,=Y(TWAWORKQ)                                                  
         USING TWAWORK,R7                                                       
*                                                                               
         MVC   TWARCUT#,CONCACT+4                                               
         OC    TWARCUT#,MYSPACES                                                
         MVC   TWARCUST,CONCNUM                                                 
         OC    TWARCUST,MYSPACES                                                
         XC    TWARCUP#,TWARCUP#                                                
*                                                                               
         XC    RSTAREC(32),RSTAREC                                              
         MVI   RSTAREC,2           INSERT TYPE                                  
         MVC   RSTAKREP,REPALPHA   INSERT REP CODE                              
         MVC   RSTAKSTA,TWARCUST   INSERT STATION                               
         CLI   RSTAKSTA+4,C'T'                                                  
         BNE   *+8                                                              
         MVI   RSTAKSTA+4,C' '                                                  
...
*                                                                               
         XC    RCONREC(32),RCONREC                                              
         MVI   RCONCUTP,X'AE'                                                   
         MVC   RCONCURP,REPALPHA                                                
         MVC   RCONCUST,TWARCUST   STATION CALL                                 
         MVC   RCONCUT#,TWARCUT#   TRAFFIC ORDER NUMBER                         
         MVC   KEY,RCONREC                                                      
         OI    DMINBTS,X'08'                                                    
         GOTO1 VHIGH                                                            
         LA    R3,CONERR                                                        
...
*                                                                               
         ...
         BO    ERROR                                                            
         LA    R3,STAERR                                                        
         CLC   RCONKSTA,TWARCUST                                                
         BNE   ERROR                                                            
*                                                                               
         XC    CONCACT,CONCACT                                                  
         MVC   CONCACT(11),=C'DIS,HIS,RCU'                                      
         MVI   CONCACTH+5,11                                                    
         OI    CONCACTH+6,X'80'    XMIT FIELD                                   
*                                                                               
         XIT1                                                                   
         ...
         EJECT                                                                  
***********************************************************************         
* RCUDOR# - MOVE CODE OUT OF LINE FOR ADDRESSABILITY                            
*           REPPAK CONTRACT UPLOAD SUPPORT                                      
***********************************************************************         
RCUDOR#  NTR1  BASE=*,LABEL=*                                                   
         LR    R7,RA                                                            
         AH    R7,=Y(TWAWORKQ)                                                  
         USING TWAWORK,R7                                                       
*                                                                               
         OI    TWASTREO,TWARCUEQ   SET ERRORED                                  
         MVC   TWARCUSA,CONCACT+3                                               
         OC    TWARCUSA,MYSPACES                                                
         MVC   TWARCUT#(2),CONCACT+13                                           
         MVC   TWARCUT#+2(8),CONCNUM                                            
         OC    TWARCUT#,MYSPACES                                                
         XC    TWARCUP#,TWARCUP#                                                
*                                                                               
         CLC   TWARCUSA+5(5),MYSPACES                                           
         BNE   RCU#R10                                                          
*                                                                               
         XC    RSTAREC(32),RSTAREC                                              
         MVI   RSTAREC,2           INSERT TYPE                                  
         MVC   RSTAKREP,REPALPHA   INSERT REP CODE                              
         MVC   RSTAKSTA,TWARCUSA   INSERT STATION                               
         CLI   RSTAKSTA+4,C'T'                                                  
         BNE   *+8                                                              
         MVI   RSTAKSTA+4,C' '                                                  
         MVC   KEY,RSTAKEY         LOAD KEY FOR READ                            
         ...
         CLC   KEY(27),KEYSAVE     KEY FOUND?                                   
         BNE   RCU#R10             YES                                          
         MVC   TWARCUST,RSTAKSTA                                                
         B     RCU#R20                                                          
*                                                                               
RCU#R10  DS    0H                  STATION NOT FOUND, CHECK IF ALIAS            
         XC    RSTAREC(32),RSTAREC                                              
         MVI   RSTLKTYP,X'83'      INSERT TYPE                                  
         MVI   RSTLKSTP,X'0A'      INSERT SUBTYPE                               
         MVC   RSTLKREP,REPALPHA   INSERT REP CODE                              
         MVC   RSTLKSAL,TWARCUSA   INSERT STATION ALIAS                         
         MVC   KEY,RSTAKEY         LOAD KEY FOR READ                            
         GOTO1 VHIGH               ACCESS KEY                                   
         CLC   KEY(22),KEYSAVE     KEY FOUND?                                   
         BE    RCU#R15                                                          
         LA    R3,STAERR                                                        
         LA    R2,CONSTAH                                                       
         B     ERROR                                                            
...
*                                                                               
RCU#R20  DS    0H                                                               
         LA    R3,1014             TRAFFIC ORDER NUMBER REQUIRED                
         CLC   TWARCUT#,MYSPACES                                                
         BE    ERROR                                                            
         XC    RCONREC(32),RCONREC                                              
         MVI   RCONCUTP,X'AE'                                                   
         MVC   RCONCURP,REPALPHA                                                
...
*                                                                               
         ...
         B     RCU#R40                                                          
*                                                                               
* CHECK IF PENDING NUMBER WAS PASSED                                            
*                                                                               
RCU#R30  DS    0H                                                               
         LA    R3,82               CONTRACT NOT FOUND                           
         CLI   CONCOM1,C'#'                                                     
         BNE   ERROR                                                            
         LA    R3,1020             REPPAK DATA FIELD INVALID                    
         CLI   CONCOM1H+5,1                                                     
         BNH   ERROR                                                            
*                                                                               
         MVC   TWARCUP#,CONCOM1+1                                               
*                                                                               
         ZIC   R1,CONCOM1H+5                                                    
...
*                                                                               
         ...
         LA    RE,CONCOM1+1                                                     
*                                                                               
RCU#R33  DS    0H                  CHECK IF NUMERIC                             
         CLI   0(RE),C'0'                                                       
         BL    ERROR                                                            
         CLI   0(RE),C'9'                                                       
         BH    ERROR                                                            
...
RCU#R35  DS    0H                                                               
         ...
         CVB   R0,DUB                                                           
*                                                                               
         ZAP   WORK+30(5),=P'99999999'                                          
         SP    WORK+30(5),DUB+3(5)                                              
         MVO   WORK+20(5),WORK+30(5)                                            
                                                                                
         XC    RCONREC(32),RCONREC                                              
         MVC   RCONPCON,WORK+20    NUMBER                                       
         MVC   RCONPREP,REPALPHA                                                
         MVI   RCONPTYP,X'8C'                                                   
         ...
         OI    DMINBTS,X'08'                                                    
         GOTO1 VHIGH                                                            
         LA    R3,1011             PENDING HEADER NOT FOUND                     
         CLC   KEY(27),KEYSAVE     KEY FOUND?                                   
         BNE   ERROR                                                            
*                                                                               
         MVC   TWAKADDR,KEY+28     SAVE DISK ADDR                               
...
*                                                                               
         ...
         CLC   RCONKSTA,TWARCUST                                                
         BE    RCU#R50                                                          
         LA    R3,1021             STATION MISMATCH, NOT PROCESSED              
         LA    R2,CONSTAH                                                       
         B     ERROR                                                            
*                                                                               
RCU#R50  DS    0H                                                               
         XC    CONCACT+2(13),CONCACT+2                                          
         MVI   CONCACTH+5,2                                                     
         OI    CONCACTH+6,X'80'    XMIT FIELD                                   
*                                                                               
         NI    TWASTREO,X'FF'-TWARCUEQ   RESET ERROR, CONTRACT FOUND            
*                                                                               
         XIT1                                                                   
*                                                                               
PENPACK  PACK  DUB,CONCOM1+1(0)                                                 
         DROP  R7                                                               
         LTORG                                                                  
         EJECT                                                                  
***>>>   HOMEMKT                                                                
***********************************************************************         
* HOMEMKT - MOVE CODE OUT OF LINE FOR ADDRESSABILITY                            
*                                                                               
***********************************************************************         
HOMEMKT  NTR1  BASE=*,LABEL=*                                                   
...
*                                                                               
         ...
         NI    TWASTREO,X'FF'-TWACBSHM                                          
*                                  CLEAR CBS HOME MARKET FLAG                   
         CLC   =C'CB',REPALPHA     SIGNON FROM CBS?                             
         BNE   HMKT0020            NO                                           
*        CLC   =C'CBS',WORK        YES - SIGNON = "CBS"?                        
*        BE    HMKT0060            YES - ALWAYS NATIONAL                        
         B     HMKT0060                                                         
         OI    TWASTREO,TWACBSHM   NO  - TURN ON CBS HOME MARKET                
         B     HMKT0040            NOW SET TO LOCAL                             
HMKT0020 EQU   *                                                                
         CLI   WORK+4,C'L'         5 POSITION OF SIGNON = 'L'?                  
         BNE   HMKT0060                                                         
         CLI   WORK+5,C' '         6 POSITION OF SIGNON > ' '?                  
         BH    HMKT0060            YES                                          
HMKT0040 OI    TWAFLAGS,TWAFLHMQ   HOME MARKET IN PROGRESS                      
HMKT0060 DS    0H                                                               
         XIT1                                                                   
         LTORG                                                                  
         EJECT                                                                  
...
*                                                                               
         ...
         AHI   RF,TWAWORKQ                                                      
         USING TWAWORK,RF                                                       
         OI    TWACONFG,TW_WIPSQ   Contract is now in WIPS                      
         DROP  RF                                                               
         CR    RB,RB               Must reset CC to equal                       
*                                                                               
DOGENV90 XMOD1                                                                  
         LTORG                                                                  
*                                                                               
...
*                                                                               
         ...
         DC    H'0'                MUST HAVE K NUMBER                           
*                                                                               
         XC    CONCNUM,CONCNUM     CLEAR CONTRACT NUMBER FIELD                  
*                                                                               
         LA    R2,CONCNUMH                                                      
         STC   R5,5(R2)                                                         
         BCTR  R5,0                                                             
...
HK900    DS    0H                  GENERIC RETURN TO CALLER (PF12)              
         LA    R3,696                                                           
*                                                                               
******   CLI   TWASCRN,X'BF'       SKIP IF AUDIT SCREEN                         
******   BE    HKX                    HANDLED ELSEWHERE                         
*                                                                               
...
***********************************************************************         
*                                                                     *         
*        CHECK FOR AUDIT RECORDS AND PF KEYS                          *         
*                                                                     *         
***********************************************************************         
         DS    0D                                                               
AUDPFK   NTR1  BASE=*,LABEL=*                                                   
*                                                                               
         USING TWAWORK,R7                                                       
*                                                                               
         CLI   TWASCRN,X'BF'       SKIP IF NOT AUDIT DETAIL SCREEN              
         BNE   AUDPFKX                                                          
*                                                                               
*        GET PFKEY IF USED                                                      
*                                                                               
...
*                                                                               
         STC   R0,HALF             SAVE OFF KEY HIT                             
*                                                                               
         CLI   HALF,0              DONE IF NO PFKEY                             
         BE    AUDPFKX                                                          
*                                                                               
         OI    CONCACTH+1,X'01'    FORCE ACTION ENTRY MODIFIED                  
*                                                                               
         LA    R1,CONCACT+L'CONCACT-1 END OF ACTION FIELD                       
         LA    R0,L'CONCACT        LENGTH OF ACTION FIELD                       
*                                                                               
*                                                                               
         ...
         BCT   R0,*-10                                                          
*                                                                               
         AHI   R1,1                NEXT AVAILABLE SPACE                         
*                                                                               
         LA    RF,CONCACT                                                       
         SR    R1,RF               LENGTH OF INPUT                              
         STC   R1,CONCACTH+5       SET INPUT LENGTH                             
*                                                                               
         CLI   HALF,12             DONE IF NOT PF12                             
         BNE   AUDPFKX                                                          
*                                                                               
         MVC   CONCACT(3),=C'AUL'  FORCE TO LIST SCREEN                         
         MVI   CONCACTH+5,3        ENTRY IS 4 LONG                              
         MVC   CONACT,=C'AUL'                                                   
*                                                                               
AUDPFKX  DS    0H                                                               
         XIT1                                                                   
...
REQD     DSECT                                                                  
       ...
       ++INCLUDE REGENSBLK                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'127RECNT00   01/09/13'                                      
         END                                                                    
