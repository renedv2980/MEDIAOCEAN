*          DATA SET RELFM06    AT LEVEL 018 AS OF 05/01/02                      
*PHASE T80406A,*                                                                
*INCLUDE UNBOOK                                                                 
         TITLE 'T80406 - RELFM06 - REP FILE DEMOS OVERLAY'                      
*                                                                               
*******************************************************************             
*                                                                 *             
*        RELFM06 --- REP INVENTORY DEMO RECORD DEMOS SCREEN       *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
*                                                                 *             
...
*                                                                 *             
* MAR12/96 (SKU) --->CHANGE REC2 TO POINT TO REC2K IO AREA IN TWA *             
*                                                                 *             
*                     ***  END TOMBSTONE  ***                     *             
*******************************************************************             
*                                                                               
...
DISP05   MVC   8(8,R2),SPACES      CLEAR BOOK FILEDS                            
         ...
         BCT   R3,DISP05                                                        
         SPACE 1                                                                
         LA    R4,REC2K            HEADER IS IN REC2K                           
         LA    R2,INCEDTE                                                       
...
*                                                                               
HEADER   NTR1                                                                   
         LA    RE,REC2K            GET HEADER IN REC2K                          
         ST    RE,AIOAREA                                                       
         MVC   KEY,RINVREC                                                      
...
RINVD    DSECT                                                                  
       ...
       ++INCLUDE FATWA                                                          
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018RELFM06   05/01/02'                                      
         END                                                                    
