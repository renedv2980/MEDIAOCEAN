*          DATA SET ACREPDJ02  AT LEVEL 029 AS OF 03/03/17                      
...
*                                                                               
         ...
         GOTO1 =A(OUTTRNTO),DMCB,AIO4,SKOUID                                    
...
SELS22   CLC   SREC1,SREC2         TEST FOR END OF SORT RECORDS                 
         ...
         BE    SELS28                                                           
         BRAS  RE,ADDODDS          YES - ADD AN ODDS FILE ENTRY                 
...
*                                                                               
SELS30   DS    0H                                                               
         BRAS  RE,ADDODDS          ADD THE LAST ODDS ENTRY                      
         TM    PRMODE,PRMREMO      PRINT END LOGOS IF ACTIVE                    
         BZ    SELS32                                                           
         TM    COMP8,CPYSRLOG                                                   
         BO    SELS32                                                           
...
*                                                                               
         BRAS  RE,SETARC           SET ARCHIVE STATUS                           
*                                                                               
...
*                                                                               
         MVC   AIOBUFF,AIO4                                                     
         BRAS  RE,SETOUT           SET OUTPUT TYPE AND REMOTE                   
*                                                                               
REMX     B     XIT                                                              
         DROP  R3                                                               
         EJECT                                                                  
...
ACDJ02   CSECT                                                                  
***********************************************************************         
* SET ARCHIVE STATUS ON REPORTS                                       *         
***********************************************************************         
         SPACE 1                                                                
SETARC   NTR1  BASE=*,LABEL=*                                                   
         L     R3,REMOTEC                                                       
         USING REMOTED,R3                                                       
*                                                                               
         XC    WORK2,WORK2                                                      
...
SAVE     USING REMOTED,R4                                                       
         XC    WORK,WORK                                                        
         MVI   WORK,WKISACC        SYSTEM 'A'                                   
         MVC   WORK+1(2),=C'DJ'    PROGRAM 'DJ'                                 
         MVC   WORK+3(2),HALF         USERID                                    
         GOTO1 PQPROF,DMCB,(0,WORK),(0,WORK2),ADCOMFAC                          
...
***********************************************************************         
         SPACE 1                                                                
REMSET   NTR1  BASE=*,LABEL=*                                                   
         L     R3,REMOTEC                                                       
         USING REMOTED,R3                                                       
         MVI   REMOTFLG,X'FA'                                                   
         MVC   REMOTSYS(3),=C'ADJ'                                              
         MVC   REMOTDST(2),HALF                                                 
         MVC   REMOTDSC(8),=C'JOURNALS'                                         
         ...
         EJECT                                                                  
***********************************************************************         
* SET OUTPUT VALUE FROM DEFAULT LEVEL OR AGENCY LEVEL PROFILE RECORD. *         
***********************************************************************         
SETOUT   NTR1  BASE=*,LABEL=*                                                   
         USING CTPREC,R2           R2=A(PROFILE RECORD)                         
         XC    IOKEY,IOKEY         READ USER PROFILE RECORD                     
         XC    TEMP,TEMP                                                        
         LA    R2,IOKEY                                                         
SETOUT10 MVI   CTPKTYP,CTPKTYPQ                                                 
         MVC   CTPKSYS(3),=C'ADJ'                                               
         GOTO1 DATAMGR,DMCB,=C'DMREAD',=C'CTFILE',IOKEY,AIOBUFF                 
         CLI   DMCB+8,0                                                         
         BNE   SETOUT50                                                         
*                                                                               
         L     R2,AIOBUFF                                                       
         ...
         LA    R1,CTPDATA                                                       
         XR    R0,R0                                                            
SETOUT20 CLI   CTOCOEL,0           TEST E-O-R                                   
         BE    SETOUT50                                                         
         CLI   CTOCOEL,CTOCOELQ            OUTPUT CODE ELEMENT                  
         BNE   SETOUT30                                                         
         MVC   TEMP(L'CTOCODE),CTOCODE     SET OUTPUT TYPE                      
         B     SETOUT50                                                         
*                                                                               
SETOUT30 CLI   CTOCOEL,X'43'                                                    
         BNE   SETOUT40                                                         
         MVC   TEMP(L'CTOCODE),CTOCODE     Set Output type                      
         B     SETOUT50                                                         
         DROP  R1                                                               
*                                                                               
SETOUT40 IC    R0,1(R1)            BUMP TO NEXT ELEMENT                         
         BXH   R1,R0,SETOUT20                                                   
*                                                                               
SETOUT50 LA    R2,IOKEY                                                         
         ...
         B     SETOUT10                                                         
*                                                                               
SETOUT60 CLC   =C'S1',TEMP         TEST SERIES 1 (SHUTTLE)                      
         BNE   *+8                                                              
         NI    PRMODE,X'FF'-PRMREMO                                             
         CLC   =C'REMOTE',TEMP     TEST REMOTE                                  
         BNE   SETOUTX                                                          
         BRAS  RE,REMSET                                                        
...
WSIZE    EQU   5000                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029ACREPDJ02 03/03/17'                                      
         END                                                                    
