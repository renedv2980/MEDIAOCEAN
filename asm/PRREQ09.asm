*          DATA SET PRREQ09    AT LEVEL 006 AS OF 07/15/02                      
*PHASE T41209B,+0                                                               
*INCLUDE RECUP                                                                  
*INCLUDE SQUASHER                                                               
*                                                                               
*                                                                               
*                                                                               
* KWAN   01/00    CORRECT ++INCLUDE PRREQFFBD TO PRREQFFD                       
*                                                                               
*                                                                               
*                                                                               
         TITLE 'PRREQ09 - REQUEST - $RFP INIT MODULE'                           
T41209   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 WORKX,T41209,RR=R9                                               
*                                                                               
         USING WORKD,RC                                                         
         ST    R9,RELO                                                          
         L     R9,0(R1)                                                         
...
RFPBLKD  DSECT                                                                  
       ...
       ++INCLUDE FLDIND                                                         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006PRREQ09   07/15/02'                                      
         END                                                                    
