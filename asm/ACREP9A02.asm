*          DATA SET ACREP9A02  AT LEVEL 093 AS OF 07/10/14                      
...
* 12     NUMBER OF LOW LEVS FOR HI TO PRINT                          *          
...
*                                                                               
         ...
         ST    R2,HEADHOOK                                                      
*                                                                               
         MVC   SVPROF,PROGPROF     SAVE OFF COMPANY PROFILES                    
*                                                                               
         CLI   SVPROF1,C'Y'                                                     
         BNE   *+8                                                              
...
*&&US*&& ZAP   LOWNO,=P'0'         NUMBER TEST                                  
         CLI   SVPROF12,0          ELSE USE PROFILE VALUE                       
         BE    PR01A                                                            
         ZIC   RE,SVPROF12                                                      
         CVD   RE,DUB                                                           
         ZAP   LOWNO,DUB                                                        
...
PR40     CLI   MODE,PROCHIST                                                    
         ...
         BNE   XIT                                                              
         CLI   SVPROF15,C'O'         COMBINE 15 AND 16 AS OVERHEAD              
         BNE   PR40A                                                            
...
*                                                                               
PR43     DS    0H                                                               
         CLI   SVPROF10,C'Y'       PROFILE OPTION TO CALCULATE BILLINGS         
...
*                                                                               
PR581    CLI   SVPROF10,C'Y'       CALCULATE BILLING FIGURES                    
         BNE   PR59                                                             
         CLI   QOPT3,C'Y'                                                       
         BE    PR59                                                             
         CLI   BUFKEY+2,C'2'                                                    
...
*                                                                               
PR4C     DS    0H                                                               
         CLI   SVPROF9,C'Y'        PROFILE OPTION TO SKIP ALL BUT               
         BNE   F4G                 TOTAL LINES                                  
         CLI   BUFKEY+3,C' '                                                    
         BE    F4G                                                              
         CLI   BUFKEY+1,C'S'                                                    
...
*                                                                               
F4G      DS    0H                                                               
         CLI   SVPROF13,C'Y'       OPTION TO SKIP C/A 13 DETAILS                
         BNE   F4GN                                                             
         CLI   SVPROF1,C'Y'                                                     
         BE    F4GI                                                             
...
F4GI     CLI   BUFKEY+1,C'P'       IF 13 AND 14 INVERTED                        
         BE    F40                                                              
*                                                                               
F4GN     CLI   SVPROF14,C'Y'       OPTION TO SKIP C/A 14 DETAILS                
         BNE   *+12                                                             
         CLI   BUFKEY+1,C'L'                                                    
         BE    F40                                                              
         CLI   SVPROF15,C'Y'       OPTION TO SKIP C/A 15 DETAILS                
         BNE   *+12                                                             
         CLI   BUFKEY+1,C'U'                                                    
         BE    F40                                                              
*&&US                                                                           
...
*                                                                               
         CLI   BUFKEY+1,C'R'                                                    
         BNE   *+12                                                             
         CLI   SVPROF5,C'Y'        PROF OPTION FOR TOTAL TIME/EXPENSES          
         BNE   F40                                                              
         CLI   BUFKEY+1,C'S'                                                    
         BNE   *+12                                                             
         CLI   SVPROF3,C'Y'        PROFILE OPT FOR  DIRECT MARGIN LINE          
         BNE   F40                                                              
         CLI   BUFKEY+1,C'W'                                                    
         BNE   *+12                                                             
         CLI   SVPROF4,C'Y'        PROFILE OPT FOR OVERHEAD TOTAL LINE          
         BNE   F40                                                              
         CLI   QOPT3,C'Y'                                                       
         BE    F5                                                               
...
F23      CLC   P+31(100),SPACES    NOW THE FANCY PRINTING                       
         ...
         MVC   P+1(29),LINHEAD                                                  
         CLI   SVPROF9,C'Y'        NO CHICKEN TRACKS IF COMPRESSING             
         BE    F36                                                              
*&&US                                                                           
         CLI   BUFKEY+1,C'X'                                                    
         BE    F34                                                              
*&&                                                                             
         ...
         BNE   F26                                                              
*                                                                               
F24      CLI   SVPROF6,C'Y'        PROFILE OPTION FOR FANCY                     
         BE    F34                 PRINTING ON TOTAL EXPENSES                   
         B     F36                                                              
*                                                                               
F26      CLI   BUFKEY+1,C'R'                                                    
         BNE   F36                                                              
         CLI   SVPROF7,C'Y'        FANCY PRINTING ON TIME+EXPENSE LINE          
         BE    F34                                                              
         B     F36                                                              
*                                                                               
...
*&&                                                                             
*                                                                               
F46      CLI   SVPROF1,C'Y'        IF ORDER IS INVERTED - WE MUST               
...
*                                                                               
         ...
         B     FEND4                                                            
*                                                                               
FEND2B   EDIT  (P8,PK16Q),(9,(R2)),MINUS=YES                                    
         B     FEND4                                                            
*                                                                               
FEND3    SRP   PK16Q,63,0          DIVIDE BY 10                                 
         CLI   SVPROF11,C'Y'                                                    
         BNE   FEND3B                                                           
         CP    PK16Q,=P'0'                                                      
         BNL   FEND3B                                                           
         ...
         B     FEND3C                                                           
*                                                                               
FEND3B   EDIT  (P8,PK16Q),(9,WORK+30),1                                         
         CP    PK16Q,=P'0'                                                      
         BNL   *+8                                                              
         MVI   WORK+39,C'-'                                                     
*                                                                               
...
*                                                                               
SVPROF   DS    0XL16     SAVED AREA FOR PROFILES                                
SVPROF1  DS    XL1       REVERSE PRINTING ORDER OF 13/14                        
SVPROF2  DS    XL1       USE LEDGER NAMES NOT TABLE NAMES FOR TOTALS            
SVPROF3  DS    XL1       SKIP DIRECT MARGIN LINE(PRE OVERHEAD PROFIT)           
SVPROF4  DS    XL1       SKIP TOTAL OVERHEAD LINE                               
SVPROF5  DS    XL1       SKIP TOTAL TIME+EXPENSE LINE                           
SVPROF6  DS    XL1       CHICKEN TRACK TOTAL EXPENSE LINE                       
SVPROF7  DS    XL1       CHICKEN TRACK TIME+EXPENSE LINE                        
SVPROF8  DS    XL1       PRINT SPECIAL SUMMARY IN MONEY MODE ALSO               
SVPROF9  DS    XL1       PRINT TOTAL LINES ONLY                                 
SVPROF10 DS    XL1       CALCULATE BILLINGS FROM INCOME(CAPITALIZE)             
SVPROF11 DS    XL1       DO NOT PRINT DETAILS OF BILLING/INCOME                 
SVPROF12 DS    XL1       NUMBER OF LOW LEVS FOR HI TO PRINT                     
SVPROF13 DS    XL1       SUPPRESS 13 DETAILS                                    
SVPROF14 DS    XL1       SUPPRESS 14 DETAILS                                    
SVPROF15 DS    XL1       SUPPRESS 15 DETAILS N,Y(O TO ADD 15/16 OVERHD)         
SVPROF16 DS    XL1       TAX RATE                                               
*                                                                               
PACK16   DS    0PL16               PACKED FIELD FOR PERCENTS                    
PK16Q    DS    PL8                 QUOTIENT                                     
PK16R    DS    PL8                 REMAINDER                                    
PACK8    DS    PL8                 PACKED FIELD FOR MP/DP                       
*                                                                               
...
*DDREMOTED                                                                      
       ...
       ++INCLUDE DDDLCB                                                         
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'093ACREP9A02 07/10/14'                                      
         END                                                                    
