*          DATA SET SPLDEXTBS2 AT LEVEL 034 AS OF 02/08/99                      
*PHASE SPEXTBS2                                                                 
*INCLUDE HEXOUT                                                                 
...
DMXREC01 CLI   0(R5),X'FF'                                                      
         BE    DMXKEEP             END OF TABLE, NOT A MILLER RECORD            
         CLC   5(2,R6),0(R5)                                                    
         BE    DMXREC05                                                         
         LA    R5,2(R5)                                                         
         B     DMXREC01                                                         
*                                                                               
DMXREC05 DS    0H                                                               
         NI    1(R6),X'0F'         TURN OFF AGY HEX 20                          
         OI    1(R6),X'50'         AND TURN ON AGY 50                           
*                                                                               
...
SPGENBUYD DSECT                                                                 
       ++INCLUDE SPGENBUY                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034SPLDEXTBS202/08/99'                                      
         END                                                                    
