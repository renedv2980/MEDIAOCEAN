*          DATA SET SXLDEXTCBL AT LEVEL 058 AS OF 06/02/98                      
*PHASE SXEXTCBL                                                                 
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH2                                                               
****************************************************************                
...
SNV10    BAS   RE,NEXTEL                                                        
         ...
         B     DMXKEEP                                                          
         USING SNVIDELD,R6                                                      
SNV20    MVC   NETNUM,SNVIDNWK                                                  
         MVC   MYNET,SNVIDNWK                                                   
         ST    R6,NETADDR                                                       
         GOTO1 GETSTA                                                           
         BNE   SNV30           IF CC =0 THEN ERROR  ELSE JUST GET NEXT          
         MVC   SNVIDNWK,MYNET                                 ELEMENT           
...
NBUYRECD  DSECT                                                                 
       ++INCLUDE SPNWSHDR                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'058SXLDEXTCBL06/02/98'                                      
         END                                                                    
*                                                                               
