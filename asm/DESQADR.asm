*          DATA SET DESQADR    AT LEVEL 154 AS OF 04/14/16                      
...
*                                                                               
DYP05    DS    0H                                                               
         ZIC   RE,5(R1)            GET THE TIME CODE                            
         STC   RE,DRHIQHR                                                       
         MVC   SVDPRTCD(4),0(R1)   GET THE DDS CODE                             
*                                                                               
         MVI   DRHIGHD,X'95'                                                    
...
OUT50    LA    R9,OUTDATA           R2 POINTS TO THE OUTDATA                    
         USING DRKEY,R9                                                         
         LA    R4,SQADTGTR          LIST OF DEMO CATEGORIES                     
         LA    R8,0                                                             
*                                                                               
**********************************************************                      
*    DEMO TARGET ID                                                             
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'154DESQADR   04/14/16'                                      
         END                                                                    
