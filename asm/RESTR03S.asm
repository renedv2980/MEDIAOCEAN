*          DATA SET RESTR03S   AT LEVEL 020 AS OF 05/01/02                      
*PHASE T80E03A                                                                  
...
*                                                                               
         ...
         GOTO1 DATCON,DMCB,(1,WORK),(6,GKCPERI)                                 
         ...
         MVO   WORK(3),WORK+3(3)   CHANGE TO PWOS                               
         XC    WORK+2(1),WORK+2    NO DAY                                       
         GOTO1 DATCON,DMCB,(1,WORK),(6,GKCPERI+7)                               
...
LR70     ZAP   WORK+6(3),=P'0'                                                  
         ...
         MVO   WORK(3),WORK+3(3)   CHANGE TO PWOS                               
         XC    WORK+2(1),WORK+2    NO DAY                                       
         GOTO1 DATCON,DMCB,(1,WORK),(6,LGKCPERI)                                
         ...
         MVO   WORK(3),WORK+3(3)   CHANGE TO PWOS                               
         XC    WORK+2(1),WORK+2    NO DAY                                       
         GOTO1 DATCON,DMCB,(1,WORK),(6,LGKCPERI+7)                              
         DROP  R6                                                               
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020RESTR03S  05/01/02'                                      
         END                                                                    
