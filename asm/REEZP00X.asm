*          DATA SET REEZP00X   AT LEVEL 131 AS OF 01/24/03                      
*PHASE T82A00A                                                                  
*INCLUDE TWABLD                                                                 
*INCLUDE UNBOOK                                                                 
*INCLUDE RECUP                                                                  
...
* 07/15/2002  ABEA   ADD AGENCY INVOICES                              *         
* 01/24/2003  JRD    ONLY ONE MARKET IN GTSTABKS                      *         
*                                                                     *         
***********************************************************************         
T82A00   CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         B     EXITOK                                                           
*----------------------------------------------------------------------         
* BOOKHOOK- GET BOOKS FOR STATION(FROM TAPE)                                    
*   INPUT:   P1  A(STATION)                                                     
*            P2  A(OUTPUT AREA)                                                 
*                                                                               
*----------------------------------------------------------------------         
...
*                                                                               
         MVC   BYTE,SBBTYP                                                      
*                                                                               
         GOTO1 AADDDATA,DMCB,AFABLK,STABTYEL,SBBTYP,0                           
*                                                                               
BKH0010  DS    0H                                                               
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'131REEZP00X  01/24/03'                                      
         END                                                                    
