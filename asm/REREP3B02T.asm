*          DATA SET REREP3B02T AT LEVEL 196 AS OF 07/02/02                      
*PHASE RE3B02A,*                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE DEMEL                                                                  
*INCLUDE DEMOMATH                                                               
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3B02 - REREP3B02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3B02 - RE3B02 - MEDIA OCEAN DEMO FEED                      *           
*                                                                   *           
*********************************************************************           
...
*    QUESTOR+5 = TST -  LOAD T00AA4C AS TEST                        *           
*                                                                   *           
*********************************************************************           
*                                                                               
**  INSERT HERE >>                                                              
...
RE3B02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3B02,R7,R8,RR=RE                                    
*                                                                               
...
INIT0040 EQU   *                                                                
*                                                                               
*   CALL VERSION OF REFETCH WITH EXPANDED DEMO RETRIEVAL                        
*                                                                               
***      GOTOX LOADER,DMCB,=CL8'T00AA4',0                                       
...
*                                                                               
         ...
         CLI   NUMDEMS,MAXDEMOS    TOO MANY DEMOS?                              
         BNH   *+8                 NO  - SHOULD BE OKAY                         
         LA    R1,MAXDEMOS         YES - SET TO MAX NUMBER                      
*                                                                               
...
*                                                                               
         ...
         MVI   RFTCDMNM,MAXDEMOS   INSERT NUMBER OF DEMOS                       
         ...
         LA    RF,DEMORTG          SET A(RATING RETURN AREA)                    
         STCM  RF,15,RFTCDMRT      INSERT INTO BLOCK                            
         LA    RF,DEMOSHR          SET A(SHARE RETURN AREA)                     
         STCM  RF,15,RFTCDMSH      INSERT INTO BLOCK                            
         LA    RF,DEMOLVL          SET A(LEVEL RETURN AREA)                     
...
*                                     PROCESSED                                 
         LR    R4,RF               SAVE LOOP CTL: EST BOOK COUNT                
...
*                                                                               
         ...
         LR    RF,R4               RESET # ESTIMATE BOOKS                       
*                                                                               
         MVC   WORK+10(1),WORK+6   INSERT CURRENT YEAR                          
         MVI   WORK+11,2           INSERT 'FEBRUARY' INTO MONTH                 
         CLI   WORK+7,4            CURRENT MONTH PRE-APRIL?                     
         BL    SPBK0120            YES - USE CURR YR+ FEBRUARY                  
         MVI   WORK+11,5           NO  - INSERT 'MAY' INTO MONTH                
         CLI   WORK+7,6            CURRENT MONTH PRE-JUNE?                      
         BL    SPBK0120            YES - USE CURR YR+ MAY                       
         MVI   WORK+11,7           NO  - INSERT 'JULY' INTO MONTH               
         CLI   WORK+7,8            CURRENT MONTH PRE-AUGUST?                    
         BL    SPBK0120            YES - USE CURR YR+ JULY                      
         MVI   WORK+11,11          NO  - INSERT 'NOVEMBER' INTO MONTH           
SPBK0120 EQU   *                                                                
         CLI   0(R2),X'60'         ESTIMATE BOOK?                               
         BE    *+6                 YES - PROCESS                                
...
*                                  BOOK DATE PRE CUTOFF DATE?                   
         BNL   SPBK0140            NO  - KEEP ESTIMATE BOOK IN LIST             
         MVI   DINPBKYR(R2),X'99'  YES - CHANGE TO UNRETRIEVABLE DATA           
SPBK0140 EQU   *                                                                
         LA    R2,LINPBKS(R2)      BUMP TO NEXT BOOK                            
         BCT   RF,SPBK0120         GO BACK FOR NEXT                             
*                                                                               
         B     SPBK0800                                                         
*                                                                               
*   REMOVE ABOVE BRANCH TO ACTIVATE DISPLAY                                     
*                                                                               
*   TEST DISPLAY                                                                
         ZIC   R1,INP#BKS                                                       
         LA    R2,INPBOOKS                                                      
TINP0020 EQU   *                                                                
         ...
         GOTO1 REPORT                                                           
         LA    R2,LINPBKS(R2)                                                   
         BCT   R1,TINP0020         GO BACK FOR NEXT                             
         DC    H'0'                                                             
SPBK0800 EQU   *                                                                
         XIT1                                                                   
         EJECT                                                                  
...
*                                                                               
INPBLOCK DC    X'0D'               NUMSTAS:   13                                
         DC    CL05'WRC  '         STATION :  1                                 
         DC    CL05'WVTM '         STATION :  2                                 
         DC    CL05'WVIT '         STATION :  3                                 
         DC    CL05'KNBC '         STATION :  4                                 
         DC    CL05'KNSD '         STATION :  5                                 
         DC    CL05'KXAS '         STATION :  6                                 
         DC    CL05'WCAU '         STATION :  7                                 
         DC    CL05'WCMH '         STATION :  8                                 
         DC    CL05'WJAR '         STATION :  9                                 
         DC    CL05'WMAQ '         STATION : 10                                 
         DC    CL05'WNBC '         STATION : 11                                 
         DC    CL05'WNCN '         STATION : 12                                 
         DC    CL05'WTVJ '         STATION : 13                                 
*********************************************************************           
         DC    X'01'               NUMDPTS                                      
         DC    CL1'Z'              DAYPARTS:  1                                 
**       DC    X'02'               NUMDPTS                                      
...
*********************************************************************           
         DC    X'2C'               NUMDEMS:   44                                
         DC    XL04'00D90100'      HOMES:                                       
         DC    XL04'00D98D00'      RA1834                                       
         DC    XL04'00D98E00'      RA1849                                       
         DC    XL04'00D99100'      RA18+                                        
         DC    XL04'00D99300'      RA2549                                       
         DC    XL04'00D99400'      RA2554                                       
         DC    XL04'00D99A00'      RA35+                                        
         DC    XL04'00D99D00'      RA50+                                        
         DC    XL04'00D92900'      RW1834                                       
         DC    XL04'00D92A00'      RW1849                                       
         DC    XL04'00D92D00'      RW18+                                        
         DC    XL04'00D92F00'      RW2549                                       
         DC    XL04'00D93000'      RW2554                                       
         DC    XL04'00D93600'      RW35+                                        
         DC    XL04'00D93900'      RW50+                                        
         DC    XL04'00D95B00'      RM1834                                       
         DC    XL04'00D95C00'      RM1849                                       
         DC    XL04'00D99F00'      RM18+                                        
         DC    XL04'00D96100'      RM2549                                       
         DC    XL04'00D96200'      RM2554                                       
         DC    XL04'00D96800'      RM35+                                        
         DC    XL04'00D96B00'      RM50+                                        
*                                                                               
*   IMPRESSIONS BEGIN HERE                                                      
         DC    XL04'00E30100'      HOMES:                                       
         DC    XL04'00E38D00'       A1834                                       
         DC    XL04'00E38E00'       A1849                                       
         DC    XL04'00E39100'       A18+                                        
         DC    XL04'00E39300'       A2549                                       
         DC    XL04'00E39400'       A2554                                       
         DC    XL04'00E39A00'       A35+                                        
         DC    XL04'00E39D00'       A50+                                        
         DC    XL04'00E32900'       W1834                                       
         DC    XL04'00E32A00'       W1849                                       
         DC    XL04'00E32D00'       W18+                                        
         DC    XL04'00E32F00'       W2549                                       
         DC    XL04'00E33000'       W2554                                       
         DC    XL04'00E33600'       W35+                                        
         DC    XL04'00E33900'       W50+                                        
         DC    XL04'00E35B00'       M1834                                       
         DC    XL04'00E35C00'       M1849                                       
         DC    XL04'00E39F00'       M18+                                        
         DC    XL04'00E36100'       M2549                                       
         DC    XL04'00E36200'       M2554                                       
         DC    XL04'00E36800'       M35+                                        
         DC    XL04'00E36B00'       M50+                                        
*                                  FORMAT:                                      
*                                  BYTE 1:    QUALIFIER                         
*                                  BYTE 2:    MODIFIER (P=PUTS, ETC)            
...
*                                                                               
DEMLIST  DS    CL((MAXDEMOS+1)*4)                                               
DEMSAVE  DS    CL((MAXDEMOS+1)*4)                                               
DEMORTG  DS    CL((MAXDEMOS+1)*4)                                               
DEMOSHR  DS    CL((MAXDEMOS+1)*4)                                               
DEMOLVL  DS    CL((MAXDEMOS+1)*4)                                               
*                                                                               
...
*   TEST:  END                                                                  
*                                                                               
         OC    DEMORTG(MAXDEMOS*4),DEMORTG                                      
         BNZ   IBK00001                                                         
         OC    DEMOSHR(MAXDEMOS*4),DEMOSHR                                      
         BNZ   IBK00001                                                         
         OC    DEMOLVL(MAXDEMOS*4),DEMOLVL                                      
         BZ    FTCHEXIT            NO INTERESTING DATA                          
*                                                                               
IBK00001 DS    0H                                                               
*                                                                               
*   TEST                                                                        
...
*                                                                               
         ...
         LA    R2,DEMORTG          RATING VALUES                                
         LA    R3,DEMOSHR          SHARE VALUES                                 
         LA    R6,DEMOLVL          HUT/PUT LEVEL VALUES                         
*                                                                               
IDEM010  DS    0H                                                               
*                                                                               
*   SEND ALL TRIPLETS, IN ALL CASES.  OUTPUT RECORD FORMATTING IS               
*        EXPECTING R/S/H FOR EACH DEMO IN LIST                                  
*                                                                               
...
ITXT0010 DS    0H                                                               
         OI    MISCFLG1,MF1DATA    SET DATA IN BUFFER                           
*                                                                               
*        GOTO1 SETELEM,DMCB,TXTDATA                                             
*                                                                               
         GOTO1 ADDDATA,DMCB,RFTFTXT#,0,32                                       
*                                                                               
*        L     RF,ATWA                                                          
*        USING T81AFFD,RF                                                       
*        CLC   VERSION,=XL4'02010014'  AS OF VERSION 2.1.0.20                   
...
*   TEST PRINT OUTPUT END                                                       
*                                                                               
         CLI   DEMOCTR+3,MAXDEMOS  MAX DEMOS REACHED?                           
...
INTFILE  DCB   DDNAME=INTFILE,                                         X        
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'196REREP3B02T07/02/02'                                      
         END                                                                    
**  INSERT END  >>                                                              
