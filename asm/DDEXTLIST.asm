*          DATA SET DDEXTLIST  AT LEVEL 006 AS OF 05/01/02                      
*PHASE EXTLIST,*                                                                
*INCLUDE CARDS                                                                  
*INCLUDE DATCON                                                                 
*INCLUDE PRINT                                                                  
...
*INCLUDE SORTER                                                                 
*INCLUDE SQUASHER                                                               
         TITLE 'EXTLIST - LIST IN EXTENSION SEQUENCE'                           
PHONEXT  CSECT                                                                  
         PRINT NOGEN                                                            
...
READ     MVC   IO,SPACES                                                        
         ...
         CLI   0(R3),X'41'         MUST HAVE AN EXTENSION                       
         BL    READ                                                             
         LA    R3,5(R3)                                                         
         GOTO1 GETWORD,DMCB,=C'FIRST',(R3)                                      
         CLI   0(R3),X'41'         AND A FIRST NAME                             
         BL    READ                                                             
         MVI   11(R3),C' '                                                      
         LA    R3,12(R3)                                                        
         GOTO1 GETWORD,DMCB,=C'NAME',(R3)                                       
         CLI   0(R3),X'41'         AND A SURNAME                                
         BL    READ                                                             
...
BBLOCK   DS    20CL60                                                           
       ++INCLUDE DDBIGBOX                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006DDEXTLIST 05/01/02'                                      
         END                                                                    
