*          DATA SET ACREPIG02  AT LEVEL 009 AS OF 01/10/07                      
*PHASE ACIG02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*                                                                               
...
*                                                                               
         USING VOSTBD,R1                                                        
         LA    R1,VOSTAB           VENDOR NUMBER TABLE                          
         MVC   VENID(VOSLNQ),SPACES  SPACE OUT VENID,OPID,SRCINIT               
         LA    R0,VOSTBLNQ         NUMBER OF ENTRIES IN TABLE                   
REQF40   CLC   ORIGINUM,VOSORIG    MATCH ON ORIGIN NUMBER                       
         BNE   REQF50                                                           
         CLC   VOSCLI,SPACES                                                    
         BE    *+14                                                             
         CLC   VOSCLI,QACCOUNT     MATCH ON CLIENT                              
         BNE   REQF50                                                           
         MVC   VENID,VOSVEND       MOVE IN VENDOR NUMBER                        
         MVC   OPID,VOSOPID        MOVE IN OPERATOR ID                          
         MVC   SRCINIT,VOSSRC      MOVE IN SOURCE INITIALS                      
         B     REQFX                                                            
*                                                                               
REQF50   LA    R1,L'VOSTAB(R1)                                                  
         BCT   R0,REQF40                                                        
*        DC    H'0'                                                             
         MVC   VENID,=C'1111111'   VENDOR NUMBER                                
         MVC   OPID,=C'Y&&R'       MOVE IN OPERATOR ID                          
         MVC   SRCINIT,=C'Y&&R'    MOVE IN SOURCE INITIALS                      
*                                                                               
REQFX    B     EXIT                                                             
         EJECT                                                                  
**********************************************************************          
...
*                                                                               
         ...
         AH    R5,DATADISP                                                      
*                                                                               
         MVI   FCRDTRNS,C'N'       READ TRANSACTIONS                            
         CLI   0(R5),0                                                          
         BNE   *+6                                                              
         DC    H'0'                                                             
PACC10   CLI   0(R5),RSTELQ        IS IT X'30' ELEMENT                          
         BE    PACC20                                                           
         SR    R1,R1                                                            
         IC    R1,1(R5)                                                         
         AR    R5,R1                                                            
...
*                                                                               
PACC20   DS    0H                                                               
         CLI   RSTFILT4,C'P'       DO NOT READ F4=P                             
         BE    PACCX                                                            
         CLI   RSTFILT5,C'P'       DO NOT READ F5=P                             
         BE    PACCX                                                            
*                                                                               
...
*                                                                               
         ...
         BO    PTRN40              EXCLUDE REVERSALS IMDB # 1914141             
*        BO    PTRN60                                                           
         B     PTRN70                                                           
*                                                                               
...
*                                                                               
         ...
         TM    PTASTAT1,PTASPEND   IS IT PENDING?                               
         BO    EXIT                                                             
         TM    PTASTAT1,PTASREVS   HAS IT BEEN REVERSED                         
         BO    EXIT                EXCLUDE REVERSALS                            
*                                                                               
         USING TRNELD,R7                                                        
PTRN110  L     R7,ADTRANS          FILL BILL DATA                               
         MVC   BINUM,TRNREF                                                     
         GOTO1 DATCON,DMCB,(1,TRNDATE),(20,BIDATE)                              
*                                                                               
         MVC   BIDRCR,=C'DR'                                                    
         CP    TRNAMNT,=P'0'                                                    
         BL    EXIT                CALL LOG# 0104832N                           
*        BNL   *+10                                                             
*        MVC   BIDRCR,=C'CR'                                                    
*                                                                               
         ZAP   BINET,TRNAMNT                                                    
...
REQL     BAS   RE,PUTTRAIL         PUT INVOICE TRAILER RECORD                   
         MVC   P+2(10),=C'END OF RUN'                                           
         MVI   SPACING,2                                                        
         BAS   RE,PRINTEM                                                       
*                                                                               
         BAS   RE,PRTOTALS         PRINT TOTALS                                 
*                                                                               
         BAS   RE,PRRECCNT         PRINT RECORD COUNT                           
*                                                                               
         ...
         EJECT                                                                  
*******************************************************************             
* PRINT HEADERS AND DETAILS TOTALS                                *             
*******************************************************************             
         USING PRINTD,R3                                                        
PRTOTALS NTR1                                                                   
         MVI   RCSUBPRG,2          SUMMARY OF TOTALS                            
         MVI   FORCEHED,C'Y'                                                    
*                                                                               
         LA    R3,P                                                             
         MVC   P,SPACES                                                         
         MVC   PTOTWHAT(7),=C'AMOUNTS'                                          
         MVC   PTOTDESC(12),=C'SUM OF GROSS'                                    
...
*        MVC   P,SPACES                                                         
         LA    R3,P                                                             
         MVC   PTOTDESC(28),=C'SUM DISTRIBUTION LINE AMOUNT'                    
         ZAP   DOUBLE,DENETTOT     DETAIL'S TOTALS                              
         LA    R3,PTOTALS          PRINT LINE FIELD                             
         BAS   RE,PRTAMNT                                                       
         MVI   SPACING,2                                                        
         BAS   RE,PRINTEM                                                       
PRTOTX   XIT1                                                                   
...
PRRECCNT NTR1                                                                   
         ...
         LA    R3,P                                                             
*                                                                               
         MVC   PTOTWHAT(14),=C'NO. OF RECORDS'                                  
*                                                                               
         ZAP   DOUBLE,TOTLRECS                                                  
         EDIT  (P8,DOUBLE),(4,PTOTALS)                                          
         MVC   PTOTDESC(15),=C'HEADER + DETAIL'                                 
         BAS   RE,PRINTEM                                                       
*                                                                               
         ZAP   DOUBLE,INVCNT                                                    
         EDIT  (P8,DOUBLE),(4,PTOTALS)                                          
         MVC   PTOTDESC(6),=C'HEADER'                                           
         BAS   RE,PRINTEM                                                       
*                                                                               
         ZAP   DOUBLE,TOTDETRE     NO. OF DETAIL RECORDS                        
         EDIT  (P8,DOUBLE),(4,PTOTALS)                                          
         MVC   PTOTDESC(6),=C'DETAIL'                                           
         BAS   RE,PRINTEM                                                       
PRRECX   XIT1                                                                   
         DROP  R3                                                               
         EJECT                                                                  
...
*                                                                               
         ...
         MVC   SVMEDIA,ACTKACT+6   SAVE OFF MEDIA CODE FOR PRINTING             
*                                                                               
         USING NAMELD,R7                                                        
         MVC   JBNAME,SPACES                                                    
         MVI   ELCODE,NAMELQ                                                    
...
*                                                                               
         ...
         BAS   RE,CHGUF            CHANGE USER FIELD AC IF CC=111052            
         B     EXIT                                                             
         DROP  R7                                                               
         EJECT                                                                  
**********************************************************************          
...
*                                                                               
         ...
         MVC   PCOL1INV(L'SVMEDIA),SVMEDIA  T-01-1234                           
         MVI   PCOL1INV+1,C'-'                                                  
         MVC   PCOL1INV+2(2),BINUM          INVOICE NUMBER                      
         MVI   PCOL1INV+4,C'-'                                                  
         MVC   PCOL1INV+5(4),BINUM+2        INVOICE NUMBER                      
         MVC   PCOL1OID,OPID                OPERATOR ID                         
*                                                                               
         MVI   PCOL1IC,C'I'        ASSUME IT IS DEBIT                           
         MVC   PCOL1DT,=C'RN'      DOCUMENT TYPE RN FOR DEBIT                   
         MVI   PCOL1SN,C'+'        ASSUME IT IS DEBIT                           
         CLC   BIDRCR,=C'DR'                                                    
         BE    INVHD10                                                          
...
*                                                                               
         MVC   PCOL2INV(L'SVMEDIA),SVMEDIA  T-01-1234                           
         MVI   PCOL2INV+1,C'-'                                                  
         MVC   PCOL2INV+2(2),DRTNUM                                             
         MVI   PCOL2INV+4,C'-'                                                  
         MVC   PCOL2INV+5(4),DRTNUM+2                                           
*                                                                               
...
*                                                                               
         MVC   PCOL2INI,SRCINIT              SOURCE INITIALS                    
         MVC   PCOL2DD,SPACES                                                   
...
*                                                                               
         MVC   PCOL9CT,SVTIME               TIME THIS REPORT GENERATED          
...
*                                                                               
         USING PRINTD,R4                                                        
         LA    R4,P                                                             
         MVC   PRMEDIA,SVMEDIA     MEDIA CODE                                   
         MVI   PRDASH,C'-'                                                      
         MVC   PRBNUM,BINUM                                                     
         MVI   PRDASH2,C'-'                                                     
         MVC   PRBNUM1,BINUM+2                                                  
...
*                                                                               
         ...
         BAS   RE,PRTAMNT                                                       
*                                                                               
         CLI   JOBSTAT,PRINTED     HAVE I PRINTED THIS JOBS DATA                
         BE    *+8                 YES                                          
         BAS   RE,PRTJOB                                                        
         MVI   JOBSTAT,PRINTED                                                  
*                                                                               
...
*                                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* LOOP THRU USERTAB TWICE CHANGE AC= TO 000000000 IF CC=111052        *         
***********************************************************************         
         SPACE 1                                                                
CHGUF    NTR1                                                                   
*                                                                               
         ...
         LA    R0,LUNUM                                                         
         SR    R1,R1                                                            
         NI    FLAG,X'FF'-FLGCHAC                                               
*                                                                               
         LA    R5,JBUFS                                                         
CHUF10   CLC   LUCODE,=C'CC'                                                    
         BNE   CHUF20                                                           
         IC    R1,LUJBLEN                                                       
         CHI   R1,L'PCOL2SGA       MUST BE THE LENGTH OF 111052 6 CHAR          
         BNE   CHUFX                                                            
         SR    R1,R1                                                            
         ICM   R1,3,LUJBFLD        GET DISPLACMENT TO FIELD                     
         AR    R5,R1               POINT R5 TO CORRECT USERFIELD                
         CLC   0(L'PCOL2SGA,R5),=C'111052'                                      
         BNE   CHUFX                                                            
         OI    FLAG,FLGCHAC         FLAG THAT WE NEED TO CHANGE AC FLD          
         B     CHUF30                                                           
CHUF20   LA    R3,LUDLN(R3)        AND NEXT TABLE ENTRY                         
         BCT   R0,CHUF10                                                        
*                                                                               
CHUF30   TM    FLAG,FLGCHAC                                                     
         BNO   CHUFX                                                            
         L     R3,AUSERTAB                                                      
         LA    R0,LUNUM                                                         
         LA    R5,JBUFS                                                         
CHUF40   CLC   LUCODE,=C'AC'                                                    
         BNE   CHUF50                                                           
         SR    RE,RE                                                            
         ICM   RE,3,LUJBFLD                                                     
         AR    R5,RE                 BUMP TO AC'S VALUE FLD                     
         MVC   0(L'PCOL2SCC,R5),=CL9'000000000'                                 
         LHI   RE,L'PCOL2SCC                                                    
         STC   RE,LUJBLEN                                                       
         B     CHUFX                                                            
CHUF50   LA    R3,LUDLN(R3)        AND NEXT TABLE ENTRY                         
         BCT   R0,CHUF40                                                        
*                                                                               
CHUFX    B     EXIT                                                             
         DROP  R4                                                               
...
***********************************************************************         
         SPACE 1                                                                
DSPARM   DC    CL20'ACCTAPE.AC0IGYN1'                                           
DDPARM   DC    CL8'OUTP'                                                        
...
ADCONS   DS    0F                                                               
         DC    A(DRTABC)                                                        
         DC    A(XTABC)            TABLE OF UNMARKED CHARGES                    
         DC    A(BINADDC)                                                       
         DC    A(WCTABC)                                                        
         DC    A(TOTTABC)                                                       
         DC    A(USERTAB)                                                       
...
*                                                                               
* VENDOR #/OPERATOR ID/SOURCE INITALS TABLE - MATCHED BY ORIGIN NUMBER          
*                                                                               
VOSTAB   DS    0CL18                                                            
         DC    HL2'1141',C'   ',C'1252071',C'Y&&R',C'Y&&R'    YNRA              
         DC    HL2'8808',C'COP',C'2507029',C'TDE',C'TDE'      YNTDE             
VOSTBLNQ EQU   (*-VOSTAB)/L'VOSTAB                                              
         EJECT                                                                  
**********************************************************************          
* LITERALS                                                           *          
**********************************************************************          
...
BXHOOK   DS    0D                                                               
         ...
         L     R4,ADBOX                                                         
*                                                                               
         CLI   RCSUBPRG,2          PRINTING TOTALS                              
         BE    BXHOOK10                                                         
*                                                                               
         MVC   BOXCOLS,SPACES                                                   
         MVC   BOXROWS,SPACES                                                   
         ...
         MVI   BOXCOLS+1,C'L'                                                   
*                                                                               
         MVI   BOXCOLS+(PRUFS-PRTLNE-1),C'C'                                    
         MVI   BOXCOLS+(PRRNUM-PRTLNE-1),C'C'                                   
         MVI   BOXCOLS+(PRBDATE-PRTLNE-1),C'C'                                  
         MVI   BOXCOLS+(PRWC-PRTLNE-1),C'C'                                     
         MVI   BOXCOLS+(PRNET-PRTLNE-1),C'C'                                    
         MVI   BOXCOLS+PRLNQ,C'R'                                               
         B     BXXIT                                                            
*                                                                               
BXHOOK10 DS    0H                                                               
         MVC   HEAD4+57(19),=C'SUMMARY TOTALS PAGE'                             
         MVC   HEAD5+57(19),=C'-------------------'                             
*                                                                               
         MVC   BOXCOLS,SPACES                                                   
         MVC   BOXROWS,SPACES                                                   
         ...
         MVI   BOXCOLS+36,C'L'                                                  
*                                                                               
         MVI   BOXCOLS+(PTOTDESC-PRTLNE-1),C'C'                                 
         MVI   BOXCOLS+(PTOTALS-PRTLNE-1),C'C'                                  
         MVI   BOXCOLS+PTOTLNQ,C'R'                                             
         B     BXXIT                                                            
*                                                                               
...
OPID     DS    CL(L'PCOL1OID)      OPERATOR ID                                  
SRCINIT  DS    CL(L'PCOL2INI)      SOURCE INITIALS                              
VOSLNQ   EQU   *-VENID                                                          
SVTIME   DS    CL6                                                              
SVMEDIA  DS    CL1                 MEDIA IS THE 1ST LETTER OF JOB               
...
*                                                                               
FLAG     DS    XL1                                                              
FLGCHAC  EQU   X'80'               CHANGE USER FIELD AC TO 000000000            
*                                                                               
********************************************************************            
...
LUDLN    EQU   *-LUD                                                            
         EJECT                                                                  
***********************************************************************         
* DSECT TO COVER VENDOR/OPERATOR/SOURCE INIT TABLE                    *         
***********************************************************************         
         SPACE 1                                                                
VOSTBD   DSECT                                                                  
VOSORIG  DS    HL2                 ORIGIN ID                                    
VOSCLI   DS    CL3                 CLIENT                                       
VOSVEND  DS    CL7                 VENDOR NUMBER                                
VOSOPID  DS    CL3                 OPERATOR ID                                  
VOSSRC   DS    CL3                 SOURCE INITIALS                              
VOSTBDLN EQU   *-VOSTBD                                                         
         EJECT                                                                  
***********************************************************************         
...
PRCOL2   DS    CL1                                                              
*                                                                               
PRRNUM   DS    0CL9                T-01-2345 T=MEDIA                            
PRMEDIA  DS    CL1                 MEDIA CODE                                   
PRDASH   DS    CL1                 DASH                                         
PRBNUM   DS    CL2                 1ST TWO DGTS OF INVOICE NUMBER               
PRDASH2  DS    CL1                 DASH                                         
PRBNUM1  DS    CL4                 LAST FOUR DGTS OF INVOICE NUMBER             
*                                                                               
PRCOL3   DS    CL1                                                              
PRBDATE  DS    CL8                                                              
PRCOL4   DS    CL1                                                              
...
*                                                                               
         ORG   PRTLNE                                                           
         DS    CL37                                                             
PTOTWHAT DS    CL15                AMOUNT OR RECORDS                            
         DS    CL2                                                              
PTOTDESC DS    CL28                DESCRIPTION OF TOTALS                        
         DS    CL2                                                              
PTOTALS  DS    CL15                NET AMOUNT TOTALS                            
         DS    CL14                                                             
PTOTLNQ  EQU   *-PRTLNE                                                         
         EJECT                                                                  
...
JBLOCKD  DSECT                                                                  
       ...
       ++INCLUDE ACJOBBERD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009ACREPIG02 01/10/07'                                      
         END                                                                    
