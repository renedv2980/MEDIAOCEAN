*          DATA SET PDELBUY    AT LEVEL 041 AS OF 05/01/02                      
*PHASE PDELBUYA                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PDELBUY- DELETE DATA'                                           
*                                                                               
*            DELETES BUYS WHOSE PBDSPACE(2) MATCHES QOPT1(2)                    
*            DELETES CONS WHOSE FIRST COMMENT IS SAME AS QOPT1(2)               
*            COPIES ALL OTHER RECORDS                                           
*                                                                               
PDELBUY  CSECT                                                                  
         NBASE 0,PDELBUY,=V(REGSAVE)                                            
         SPACE 2                                                                
         LA    R6,PDELBUY+4095                                                  
         LA    R6,1(R6)                                                         
         USING PDELBUY+4096,R6                                                  
...
START2   DS    0H                                                               
         ...
         B     START1                                                           
START3   DS    0H                                                               
         MVC   QOPT1(2),CARD+61           SAVE DELETE CODE                      
         XC    WORK(11),WORK                                                    
         MVC   WORK(6),CARD+2                                                   
         CLC   CARD+5(3),=C'ALL'                                                
         BNE   *+10                                                             
...
CON      DS    0H                                                               
         ...
         BNE   PUTXX                                                            
         CLC   2(2,R2),QOPT1                                                    
         BNE   PUTXX                    ONLY CHECK FIRST COMMENT                
         XC    WORK,WORK                                                        
         MVC   WORK(3),REC                                                      
...
BUY      DS    0H                                                               
         MVI   DDSBILL,C'N'                                                     
         XC    DDSDATE,DDSDATE          SAVE DATE OF DDS BILLING (REV)          
         CLC   PBDSPACE(2),QOPT1                                                
         BNE   PUTXX                    OUTPUT THIS BUY                         
         LA    R2,PBDELEM                                                       
         MVI   ELCODE,X'26'             CHECK FOR DDS BILLING                   
BUY5     BAS   RE,NEXTEL                                                        
         BNE   BUY8                                                             
         OC    5(3,R2),5(R2)            CHECK FOR DATE                          
         BZ    BUY5                                                             
         OC    8(2,R2),8(R2)     CHECK FOR DDS BILLING - INVOICE                
         BZ    BUY5                                                             
         TM    10(R2),X'C0'       SKIP  REVERSED AND REVERSALS                  
         BNZ   BUY6                                                             
         MVI   DDSBILL,C'Y'       LIVE BILLING FOUND - KEEP THIS BUY            
         AP    YDDSCNT,=P'1'                                                    
         B     PUTXX                                                            
*                                                                               
BUY6     OC    DDSDATE,DDSDATE        SEE IF I HAVE DATE                        
         BNZ   BUY6C                                                            
         MVC   DDSDATE,5(R2)          SAVE DATE                                 
         MVI   DDSBILL,C'R'                                                     
         B     BUY5                                                             
*                                                                               
BUY6C    CLC   DDSDATE(2),5(R2)        SEE IF SAME MONTH                        
         BE    BUY5                                                             
         MVI   DDSBILL,C'E'             REVERSAL ACROSS MONTH                   
         AP    EDDSCNT,=P'1'                                                    
         B     PUTXX                    CAN'T DELETE                            
*                                                                               
BUY8     XC    WORK,WORK                                                        
         MVC   WORK(3),REC                                                      
         MVC   WORK+3(6),REC+4                                                  
...
*                                                                               
         ...
         AP    RDDSCNT,=P'1'                                                    
*                                                                               
         MVC   P+1(33),=C'*** REV DDS BILLING SAME MONTH ***'                   
         BAS   RE,PRNT                                                          
         BAS   RE,DMPREC                                                        
*                                                                               
BUY9     GOTO1 =V(BINSRCH),ESTPARS,(1,WORK)                                     
         L     R8,ESTPARS                                                       
         LTR   R8,R8                                                            
         BNZ   *+6                                                              
         DC    H'0'                                                             
...
*                                  PRINT ESTIMATE LIST                          
         BAS   RE,SKIP                                                          
         MVC   P+31(16),=C'PRINTPAK PURGE  '                                    
         MVC   P+71(8),TODAY                                                    
         BAS   RE,PRNT3                                                         
         MVC   P+01(78),=C'                                           GX        
               ROSS       GROSS-CD       GROSS-CD'                              
         BAS   RE,PRNT                                                          
         MVC   P+01(78),=C'AG M CLT PRD EST     BUYS    CONS        ORDX        
               ERED           PAID         BILLED'                              
         BAS   RE,PRNT                                                          
         MVC   P+01(78),=C'-- - --- --- ---     ----    ----        ---X        
               ----           ----         ------'                              
...
EDT      DS    0H                                                               
         ...
         EDIT  (B4,ETCONS),(7,P+27),COMMAS=YES                                  
         BR    R9                                                               
*                                                                               
EDTPK    DS    0H                                                               
...
*                                                                               
         CLI   DDSBILL,C'Y'                                                     
         BNE   PUTREC2                                                          
         MVC   P+1(35),=C'*** DDS BILLING ON $$ INSERTION ***'                  
         BAS   RE,PRNT                                                          
         BAS   RE,DMPREC                                                        
         B     PUTREC8                                                          
*                                                                               
PUTREC2  CLI   DDSBILL,C'E'                                                     
         BNE   PUTREC8                                                          
         MVC   P+1(36),=C'*** REV DDS BILLING OUT OF MONTH ***'                 
         BAS   RE,PRNT                                                          
         BAS   RE,DMPREC                                                        
         B     PUTREC8                                                          
*                                                                               
...
YDDSCNT  DC    PL5'0',CL20'UN-REV BILLING'                                      
EDDSCNT  DC    PL5'0',CL20'REV BILLING- 2 MONTHS'                               
RDDSCNT  DC    PL5'0',CL20'REV BILLING'                                         
...
*                                                                               
ESTTAB   CSECT                                                                  
         DS    13000CL56            ROOM FOR 13000 ESTS                         
         DC    X'0000'                                                          
*                                                                               
LKTAB    CSECT                                                                  
         DS    50CL11                                                           
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'041PDELBUY   05/01/02'                                      
         END                                                                    
