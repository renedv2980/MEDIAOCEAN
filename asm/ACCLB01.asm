*          DATA SET ACCLB01    AT LEVEL 045 AS OF 08/16/00                      
*PHASE T62101A                                                                  
...
*                                                                               
SETVAL70 CLC   CSBILCUR,CSCPYCUR                                                
         BNE   SETVAL72                                                         
         MVC   SETEXR,BCSPACES                                                  
         OI    SETEXRH+FHOID,FHOITR                                             
         B     SETVALX                                                          
SETVAL72 TM    SETEXRH+FHIID,FHIIVA                                             
         ...
         GOTO1 AFVAL,SETEXRH                                                    
         BNE   SETVAL74                                                         
         GOTO1 AVALAMT,BOPARM,(X'85',FVIHDR),(L'BOPL61,BOPL61)                  
         BNE   EXIT                                                             
         CP    BOPL61,BCPZERO                                                   
         BNE   *+14                                                             
         ...
         SR    RF,RE                                                            
         STC   RF,SETXSHF                                                       
SETVAL74 GOTO1 ASETUP,BOPARM,(X'08',0),0,SETXVAL                                
         BNE   EXIT                                                             
         BAS   RE,GETRAT                                                        
*                                  ** TEMP CODE **                              
         ...
         BE    *+6                                                              
         DC    H'0'                                                             
         GOTO1 VHELLO,BOPARM,(C'G',ACCMST),('JCBELQ',AIO1),0                    
         L     R3,12(R1)                                                        
         USING JCBELD,R3                                                        
         CLI   12(R1),0                                                         
         BE    SETVAL76                                                         
         ...
         MVI   JCBEL,JCBELQ                                                     
         MVI   JCBLN,JCBLNQ                                                     
         GOTO1 VHELLO,BOPARM,(C'P',ACCMST),AIO1,JCBELD                          
         CLI   12(R1),0                                                         
         BE     *+6                                                             
         DC     H'0'                                                            
         L     R3,16(R1)                                                        
SETVAL76 MVC   JCBXTYP,CSTYPEXC                                                 
...
*                                  ORDERS - NOT YET AVAILABLE                   
         CURED SETCBOO,(L'SETDA7,SETDA7),CSCURBIL,MINUS=YES,           X        
               ZERO=NOBLANK                                                     
         OI    SETDA7H+FHOID,FHOITR                                             
         CLC   CSBILCUR,CSCPYCUR                                                
         BE    SETLST22                                                         
         EXCHP SETBLBL,CSEXCVAL,DUB=SETBLBL,WRK=BOWORK1                         
...
***********************************************************************         
         SPACE 1                                                                
GETRAT   NTR1  ,                                                                
         GOTO1 AEDTRAT,BOPARM,(L'SETEXR,SETEXR),CSEXCRAT,0                      
         OI    SETEXRH+FHOID,FHOITR                                             
...
GETFMT10 MVC   SETFRMN,BCSPACES                                                 
         OI    SETFRMNH+FHOID,FHOITR                                            
         USING PBCRECD,IOKEY       READ FOMRAT CONTROL RECORD                   
         XC    PBCKEY,PBCKEY                                                    
...
* FALANG                                                                        
       ...
       ++INCLUDE FALANG                                                         
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045ACCLB01   08/16/00'                                      
         END                                                                    
