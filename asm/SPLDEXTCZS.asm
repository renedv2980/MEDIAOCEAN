*          DATA SET SPLDEXTCZS AT LEVEL 028 AS OF 04/26/00                      
*PHASE SPEXTCZ                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE RECUP                                                                  
...
*              QOPT4 'Y' - DO NOT MOVE CLIENT HEADERS                 *         
*              QOPT5 'Y' - DO NOT MOVE PRODUCT HEADERS                *         
...
*                                                                               
         ...
         MVI   MVCLT,C'Y'                                                       
*                                                                               
         CLI   QOPT5,C'Y'          TEST FOR PRODUCT RECORD SKIPPED              
         BNE   *+8                                                              
         MVI   MVPRD,C'Y'                                                       
*                                                                               
TABINICN DS    0H                                                               
...
*                                                                               
         ...
         BNZ   HDRKEY12                                                         
*                                                                               
         CLI   MVPRD,C'Y'          DROP IF NOT MOVING CLIENT HEADER             
         BE    HDRKEYCN                                                         
         B     HDRKEYFD                                                         
*                                                                               
HDRKEY12 DS    0H                                                               
...
GOALRECD DSECT                                                                  
       ++INCLUDE SPGENGOAL                                                      
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028SPLDEXTCZS04/26/00'                                      
         END                                                                    
*                                                                               
