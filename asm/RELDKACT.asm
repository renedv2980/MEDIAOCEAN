*          DATA SET RELDKACT   AT LEVEL 252 AS OF 05/01/02                      
*PHASE RELDKACT                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDKACT - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
**********************************************************************          
* HISTORY OF CHANGES                                                 *          
...
DMXREC4  EQU   *                                                                
         ...
         B     DMXKEEP                                                          
DMXREC5  EQU   *                                                                
         CLC   =C'K3',0(R7)        KATZ RADIO MASTER?                           
         BNE   DMXPURGE            NO  - RECORD'S REP CODE NOT KNOWN            
*                                     PURGE THE RECORD                          
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'252RELDKACT  05/01/02'                                      
         END                                                                    
