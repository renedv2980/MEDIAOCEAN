*          DATA SET SPPWCALCN  AT LEVEL 031 AS OF 05/01/02                      
*PHASE T00A79A                                                                  
*-------------------------------------------------------------------*           
...
*                                                                               
         L     R0,CLTGRS                                                        
         LHI   RF,100                                                           
         BAS   RE,DIV              SCALE CLTGRS/100 (TO DOLLARS)                
         LR    RF,R1               BECOME NEW DIVISOR                           
*                                                                               
         L     R1,CLTNET                                                        
         S     R1,WIMNET                                                        
         M     R0,=F'100'          SCALE                                        
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE SPPWBLOCK                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'031SPPWCALCN 05/01/02'                                      
         END                                                                    
