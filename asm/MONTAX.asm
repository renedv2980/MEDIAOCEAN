*          DATA SET MONTAX     AT LEVEL 011 AS OF 06/21/88                      
*PHASE MONTAX,*                                                                 
*INCLUDR ILBOSRV0                                                               
*INCLUDE SCANNER                                                                
...
LOOPB    MVC   ARRAY(ACWDYLNQ),0(RA)  MOVE TO WORK AREA                         
...
SEGUE    DS    0H                                                               
         ...
         MVC   0(ACWDYLNQ,RA),ARRAY MOVE WORK AREA TO REAL ARRAY                
         TM    ACWDSWIT,X'01'      IF NOT DPS THEN SKIP 99 CHECK                
         BZ    S40                                                              
         CLC   SOW,=C'9900'                                                     
         BE    S100                                                             
S40      CLC   ACWDUNIT,=C'0000'   IF THIS ISN'T FEDERAL                        
         BE    NOXCUN                                                           
         CLC   ACWDUNIT,SOW        AND IF THIS ISN'T SOW                        
         BE    NOXCUN                                                           
         CLC   SOW,=C'9000'        AND IF SOW ISN'T CANADA                      
         BE    NOXCUN              (SUTA BASED ON SOR IF SOW IS CANADA)         
S50      XC    ACWDUNMP,ACWDUNMP   ZERO OUT UNEMPLOYMENT                        
         B     NOXCUN                                                           
S100     CLC   ACWDUNIT,=C'0000'   IF SOW = OTHERS THEN                         
         BE    S50                 ZERO OUT FEDERAL UNEMP                       
         SPACE 1                                                                
...
FSOW     XC    FULL,FULL                                                        
         MVI   FULL+1,ACWDYLNQ                                                  
         SH    RA,FULL                  GO BACK TO LAST ENTRY                   
         CLC   ACWDUNIT,=C'0000'        AND IF IT'S FEDERAL                     
         BE    XIT                      DON'T LOKK FOR SOW, ETC.                
...
FREQRT   NTR1                                                                   
         ...
         CVD   R1,DUB                                                           
         ZAP   EARN,DUB                                                         
         MVN   EARN+5(1),=X'0C'     MAKE POSITIVE AND TEST FOR ABSOLUTE         
         CP    EARN,=P'99999'       VALUE OVER 999.99  (PER TF 6/5/86)          
         BNH   XIT                                                              
         MVC   FULL,FEDYTDE                                                     
         L     R1,FULL                                                          
         CVD   R1,DUB                                                           
         DP    DUB,WORK(3)                                                      
         MVN   EARN+5(1),DUB+4     MAKE ZONES THE SAME                          
         CP    DUB(5),EARN         AND ONLY HIGHER THAN MONTHLY AVG             
         BNL   XIT                                                              
         MVI   ACWDFREQ,C'4'       MAKE MONTHLY                                 
         MVC   SVDIS,ACWDFICA      SAVE DIS. FOR STATES                         
         MVC   ARRAY(ACWDYLNQ),0(RA)  NEED TO USE ARRAY FOR TALKING TO          
         LA    R8,ARRAY            ALLTAX 'CAUSE OF EMP & DATE AT END           
         L     RF,ATSEGUE                                                       
         CALL  (15),((8))          NOW SNEAK BACK INTO ALLTAX                   
         MVC   0(ACWDYLNQ,RA),ARRAY REPLACE THE REAL ENTRY                      
...
ARRAY    DC    (ACWDYLNQ)C' '          PICTURE OF ACDW ELEMENT.                 
...
*      INCLOOD ACTALENT                                                         
       ...
       ++INCLUDE ACTALENT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011MONTAX    06/21/88'                                      
         END                                                                    
