*          DATA SET DENH07I    AT LEVEL 017 AS OF 03/21/14                      
...
*                                                                               
         CLC   TAPEBK,=AL1(107,9)  USE THIS CONVERSION FOR DATA AFTER           
         BNL   *+6                 SEP/07. USE DEHSD008 BEFORE SEP07            
         DC    H'0'                                                             
*                                                                               
         CLC   TAPEBK,=AL1(109,2)  USE THIS CONVERSION FOR DATA BEFORE          
         BL    *+6                 FEB/09. USE DENH09I AFTER FEB/09             
         DC    H'0'                                                             
*                                                                               
...
*        STCM  R0,3,PNUM           SAVE AWAY PRG NUMBER                         
         ...
         MVC   PSHORT,MIDSDUR                                                   
*                                                                               
         MVC   INTMRKT,TAPEMKT     SET NTIH MKT=512 OR NHTAFF=501               
...
H5R47    MVC   INTSTA(3),NEHGAGNT  MOVE IN ALPHA AGGREGATE CODE                 
         ...
         L     R9,VCPRINT                                                       
         USING DPRINT,R9                                                        
         MVC   P(26),=C'GENERAL MARKET AGGREGATE: '                             
         MVC   P+27(3),INTSTA                                                   
         GOTO1 VPRINTER                                                         
         DROP  R9                                                               
*                                                                               
...
TAPEMKT  DS    H                   NTIH=512  NHTAFF=501                         
KEYSRC   DS    X                                                                
...
*        DDCOMFACS                                                              
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017DENH07I   03/21/14'                                      
         END                                                                    
