*          DATA SET REREPTK02  AT LEVEL 115 AS OF 12/14/05                      
*PHASE RETK02A,*                                                                
*INCLUDE PERVERT                                                                
*INCLUDE REGENBUC                                                               
*INCLUDE HELLO                                                                  
...
*                                                                   *           
* JAN22/02 (HQ ) --- ADD NEW/OLD FORMAT                             *           
*                                                                   *           
*********************************************************************           
*   REGISTER USAGE                                                  *           
...
*                                                                               
*  SPECIAL DUMP TEST                                                            
         CLC   =C'BILLUHRDUMP',QUESTOR                                          
         BNE   *+6                                                              
         DC    H'0'                                                             
*  SPECIAL DUMP TEST END                                                        
*                                                                               
...
*                                                                               
         ...
         BE    SRCE0050            YES - DON'T OPEN AGAIN                       
*                                                                               
...
*                                                                               
         ...
         BNE   SRCE0210                                                         
*                                                                               
         MVC   DMCB,SRCEREP        GET OLD REP FULL NAME                        
         BAS   RE,REPGET                                                        
         MVC   SRCENAME,TEMPNAME   COPY OLD REP FULL NAME                       
*                                                                               
         CLC   SAVEVUTL,NEWUTL     SAME SYSTEM?                                 
         BE    SRCE0060                                                         
*                                                                               
         L     R1,ADCONLST         SWITCH TO SAVEVUTL                           
         L     RE,VUTL-ADCONSD(R1)                                              
         MVC   4(1,RE),SAVEVUTL    INSERT UTL NUMBER                            
*                                                                               
SRCE0060 EQU   *                   EXTRA RECORD READ AFTER OLDREP               
         MVC   DMCB,RCREPFL        BECAUSE REPORT USE NEW REP NAME              
         BAS   RE,REPGET           TO PRINT OUT THE REP FIELD IN HDR            
         MVC   NREPNAME,TEMPNAME                                                
*                                                                               
         CLC   SAVEVUTL,NEWUTL     SAME SYSTEM?                                 
         BE    SRCE0210                                                         
*                                                                               
...
*&&DO                                                                           
*   TEST                                                                        
         CLC   RCON8ECN,=X'07657241'                                            
         BE    SRCE0300            YES - SKIP THIS ORDER                        
*   TEST END                                                                    
*&&                                                                             
...
BUYB0250 EQU   *                                                                
         ...
         LTR   RF,RF               ANY COMMENT?                                 
         BNZ   BUYB0252            YES                                          
         MVC   ELEM,=X'0402'       NO  - SET DUMMY ELEMENT                      
         LA    RE,2                SET DUMMY LENGTH                             
         B     BUYB0253                                                         
BUYB0252 EQU   *                                                                
...
*                                                                               
         ...
         MVC   KEY(2),=X'A201'     INSERT PASSIVE                               
         MVC   KEY+12(2),RCREPFL   INSERT REP CODE                              
         MVC   KEY+14(5),QSTATION                                               
         MVC   KEY+19(2),SRCEREP                                                
         MVC   KEY+23(4),SOLDCON#  INSERT SOURCE CONTRACT NUMBER                
         GOTO1 HIGH                                                             
*                                                                               
*   TEST DISPLAY REP                                                            
*        MVC   P+1(08),=C'KEY:    '                                             
...
*   TEST DISPLAY REP END                                                        
*                                                                               
         CLC   KEY(27),KEYSAVE     CONTRACT KEY FOUND?                          
...
RDON0060 EQU   *                                                                
         ...
         BNE   RDON0220            NO  - PUT OUT RECORD AS-IS                   
         MVC   SORTREC2,SORTREC    COPY SORTREC TO SORTREC2                     
*                                                                               
         DROP  R6                                                               
*                                                                               
*                                                                               
...
RDON0160 EQU   *                                                                
         ...
         BE    RDON0170            YES - ACCUMULATE                             
         CLI   0(R6),X'63'         trade ESTIMATE DOLLAR BUCKET?                
         BNE   RDON0180            no  - don't ACCUMULATE                       
RDON0170 EQU   *                                                                
...
*                                                                               
RDON0220 EQU   *                                                                
         MVC   DMCB,RCONKADV       GET NEW ADVERTISER NAME                      
         MVC   DMCB+4,RCREPFL                                                   
         GOTO1 ADVGET                                                           
         MVC   SNEWADV,TEMPNAME                                                 
*                                                                               
         MVC   DMCB(6),SAGENCY     GET NEW AGENCY NAME                          
         MVC   DMCB+6(2),RCREPFL                                                
         GOTO1 AGYGET                                                           
         MVC   SNEWAGY,TEMPNAME    INSERT NEW AGENCY NAME                       
         CLI   QOPTION3,C'Z'                                                    
         BNE   *+16                                                             
         MVC   SAGYOLD,SOLDAGYC                                                 
         MVC   SAOFOLD,SOLDAOF                                                  
*                                                                               
         LA    R0,SORTREC                                                       
...
*                                                                               
         ...
         MVI   RCSUBPRG,5                                                       
         B     RDON0410                                                         
         CLI   QOPTION3,C'Z'       NEW/OLD FORMAT?                              
         BNE   RDON0410            NO                                           
         MVI   RCSUBPRG,7                                                       
         CLI   QOPTION1,C'A'       AGENCY SEQ?                                  
         BNE   *+8                 NO, USE OFFICE HEADER                        
         MVI   RCSUBPRG,9          YES, USE AGY HEADER                          
*                                                                               
RDON0410 MVI   FORCEHED,C'Y'       FORCE PAGE TOP                               
         MVC   HEAD4+26(6),SRCESAVE                                             
         CLI   QOPTION3,C'Z'       INSERT NEW REP FOR NEW/OLD FORMAT            
         BNE   RDON0415                                                         
         MVC   HEAD4+35(33),SRCENAME                                            
         MVC   HEAD5+26(2),RCREPFL                                              
         MVC   HEAD5+35(33),NREPNAME                                            
*                                  INSERT SOURCE REP INTO HEADING               
RDON0415 MVC   HEAD4+96(4),QSTATION                                             
...
RDON0420 EQU   *                                                                
         CLI   QOPTION3,C'Z'                                                    
         BNE   D                                                                
         EDIT  CONCOUNT,(6,HEAD6+23)                                            
         EDIT  TKOCOUNT,(6,HEAD6+96)                                            
         GOTO1 DATCON,DMCB,(3,BEFFDATE),(5,HEAD7+21)                            
         B     E                                                                
D        EDIT  CONCOUNT,(6,HEAD5+23)                                            
         EDIT  TKOCOUNT,(6,HEAD5+96)                                            
         GOTO1 DATCON,DMCB,(3,BEFFDATE),(5,HEAD6+21)                            
*                                                                               
E        GOTO1 REPORT              FORCE OUT INITIAL HEADING                    
*                                                                               
         ...
         CLI   QOPTION1,C'A'       AGENCY SEQ?                                  
         BNE   *+8                                                              
         LA    RE,8                YES, USE SHORTEN AGY HEADER                  
RDON0430 EQU   *                                                                
         STC   RE,RCSUBPRG                                                      
*                                                                               
RDON0440 EQU   *                                                                
...
RDON0800 EQU   *                                                                
         ...
         B     EXIT                                                             
         EJECT                                                                  
* ZRPTPRNT: PRINT REPORT IN Z(NEW/OLD) FORMAT                                   
ZRPTPRNT NTR1                                                                   
         LA    R6,P                                                             
         USING PRINLIN2,R6                                                      
*                                                                               
* PRINT NEW CONTRACT INFORMATION                                                
         OC    SNEWCON#,SNEWCON#                                                
         BZ    ZRPT0105                                                         
         MVC   DRECTYP,=C'N:'      LABEL FOR NEW CONTRACT                       
         MVC   DOFFIC2,SOFFICE     INSERT NEW OFFICE                            
         CLI   QOPTION1,C'A'       AGENCY SEQUENCE REPORT?                      
         BNE   ZRPT0010            NO                                           
         MVC   DOFFIC2,SOFFIC2     YES - INSERT OFFIC2                          
ZRPT0010 EQU   *                                                                
         MVC   DAGYCOD,SAGENCY     INSERT AGENCY                                
         OC    SAGYOFF,SAGYOFF     ANY AGENCY OFFICE?                           
         BZ    ZRPT0020            NO                                           
         MVI   DAGYCOD+4,C'-'      YES - INSERT HYPHEN                          
         MVC   DAGYOFF2,SAGYOFF     INSERT AGENCY OFFICE                        
ZRPT0020 EQU   *                                                                
         CLI   QOPTION1,C'A'       AGENCY SEQUENCE REPORT?                      
         BNE   ZRPT0030            NO                                           
         MVC   WORK(2),DOFFIC2     YES - REARRANGE OFF/AGENCY+AOF               
         MVC   DOFFIC2(7),DAGYCOD  SLIDE AGENCY UP                              
         MVC   DAGYCOD+2(5),SPACES CLEAR REST OF FIELD                          
         MVC   DOFFIC2+9(2),WORK   REINSERT OFFICE CODE                         
*                                                                               
ZRPT0030 EQU   *                                                                
         MVC   DADVNAM,SNEWADV     INSERT ADVERTISER                            
         MVC   DAGYNAM,SNEWAGY     INSERT OLD AGY NAME                          
         MVC   DADVCODE,SADVERT                                                 
ZRPT0040 EQU   *                                                                
         MVC   DPRDNAM,SPRODUCT    INSERT PRODUCT                               
         MVC   DCONTYP,SCONTYPE    INSERT CONTRACT TYPE                         
         MVC   DSPCODE,SSALPER     INSERT SALESPERSON                           
         GOTO1 DATCON,DMCB,(3,SFLITEST),(5,DFLITSD2)                            
         GOTO1 DATCON,DMCB,(3,SFLITEND),(5,DFLITED2)                            
         EDIT  (B4,SDOLLARN),(11,DDOLLAR),2                                     
         GOTO1 HEXOUT,DMCB,SNEWCON#,WORK+32,4,=C'TOG'                           
         EDIT  (C8,WORK+32),(8,DCON#)                                           
         GOTO1 REPORT                                                           
*        MVC   DOLDCMBO,SCMBOFL1   SET COMBO FLAG                               
*                                                                               
ZRPT0105 EQU   *                                                                
         MVC   DRECTYP,=C'O:'      LABEL FOR OLD CONTRACT                       
         MVC   DOFFIC2,SOLDOFF     INSERT OLD OFFICE                            
         CLI   QOPTION1,C'A'       AGENCY SEQUENCE REPORT?                      
         BNE   ZRPT0110            NO                                           
         MVC   DOFFIC2,SOFFIC2     YES - INSERT OFFIC2                          
ZRPT0110 EQU   *                                                                
         MVC   DAGYCOD,SOLDAGYC    INSERT AGENCY                                
         OC    SOLDAOF,SOLDAOF     ANY AGENCY OFFICE?                           
         BZ    ZRPT0120            NO                                           
         MVI   DAGYCOD+4,C'-'      YES - INSERT HYPHEN                          
         MVC   DAGYOFF2,SOLDAOF    INSERT AGENCY OFFICE                         
ZRPT0120 EQU   *                                                                
         CLI   QOPTION1,C'A'       AGENCY SEQUENCE REPORT?                      
         BNE   ZRPT0130            NO                                           
         MVC   WORK(2),DOFFIC2     YES - REARRANGE OFF/AGENCY+AOF               
...
*                                                                               
ZRPT0130 EQU   *                                                                
         MVC   DADVNAM,SOLDADV     INSERT ADVERTISER                            
         MVC   DAGYNAM,SOLDAGY     INSERT OLD AGY NAME                          
         MVC   DADVCODE,SOLDADVC                                                
ZRPT0140 EQU   *                                                                
         MVC   DPRDNAM,SOLDPDT     INSERT PRODUCT                               
         MVC   DCONTYP,SOLDTYP     INSERT CONTRACT TYPE                         
         MVC   DSPCODE,SOLDSP      INSERT SALESPERSON                           
         GOTO1 DATCON,DMCB,(3,SOLDSDAT),(5,DFLITSD2)                            
         GOTO1 DATCON,DMCB,(3,SOLDEDAT),(5,DFLITED2)                            
         EDIT  (B4,SDOLLARO),(11,DDOLLAR),2                                     
         GOTO1 HEXOUT,DMCB,SOLDCON#,WORK+32,4,=C'TOG'                           
         EDIT  (C8,WORK+32),(8,DCON#)                                           
*        MVC   DOLDCMBO,SCMBOFL1   SET COMBO FLAG                               
*        MVC   DNEWCMBO,SCMBOFL2   SET COMBO FLAG                               
...
ZRPT0200 EQU   *                                                                
         ...
         XIT1                                                                   
*                                                                               
* ADVGET: GET ADVERTISER FULL NAME                                              
* P1: ADV CODE  P2: REP CODE                                                    
ADVGET   NTR1                                                                   
         MVC   KEYSAV2,KEY         SAVE ORIGINAL KEY                            
         XC    KEY,KEY                                                          
         LA    R4,KEY                                                           
         USING RADVREC,R4          READ ADVERTISER RECORD                       
         MVI   RADVKTYP,X'08'      RECORD TYPE = 08                             
         MVC   RADVKADV,DMCB       ADVERTISER CODE                              
         MVC   RADVKREP,DMCB+4     SOURCE REP CODE                              
         DROP  R4                                                               
*                                                                               
         GOTO1 HIGH                                                             
*        MVC   P+5(07),=C'ADV KEY' **TEST**                                     
*        MVC   P+15(27),KEY        **TEST**                                     
*        MVC   P+45(27),KEYSAVE    **TEST**                                     
*        GOTO1 REPORT              **TEST**                                     
         CLC   KEY(27),KEYSAVE     RECORD FOUND?                                
         BE    *+14                                                             
         MVC   TEMPNAME,=CL20'UNKNOWN'  NOT FOUND                               
         B     ADVG0010                                                         
*                                                                               
         GOTO1 GETADV                                                           
         MVC   TEMPNAME(L'RADVNAME),RADVNAME                                    
ADVG0010 EQU   *                                                                
*        MVC   P+5(08),=C'ADV NAME' **TEST**                                    
*        MVC   P+15(20),RADVNAME   **TEST**                                     
*        GOTO1 REPORT              **TEST**                                     
*        DROP  R4                                                               
         MVC   KEY,KEYSAV2         RESTORE KEY BEFORE EXIT                      
         XIT1                                                                   
*                                                                               
* REPGET: GET REP NAME                                                          
* P1: REP CODE                                                                  
REPGET   NTR1                                                                   
         XC    KEY,KEY                                                          
*        LA    R4,KEY                                                           
K        USING RREPKEY,KEY         READ AGENCY RECORD                           
         MVI   K.RREPKTYP,X'01'    RECORD TYPE = 0A                             
         MVC   K.RREPKREP,DMCB     REP CODE                                     
         DROP  K                                                                
*                                                                               
         GOTO1 HIGH                                                             
*        MVC   P+5(07),=C'REP KEY' **TEST**                                     
*        MVC   P+15(33),KEY        **TEST**                                     
*        MVC   P+50(33),KEYSAVE    **TEST**                                     
*        GOTO1 REPORT              **TEST**                                     
         CLC   KEY(27),KEYSAVE     NO REP RECORD?                               
         BE    *+6                                                              
         DC    H'0'                SHOULD'VE BEEN THERE                         
         GOTO1 GETREP              GET THE WHOLE RECORD                         
         L     R4,AIOAREA                                                       
K        USING RREPREC,R4                                                       
         MVC   TEMPNAME,K.RREPNAME INSERT OLD AGENCY NAME                       
*        MVC   P+5(07),=C'REP NAME' **TEST**                                    
*        MVC   P+15(33),TEMPNAME   **TEST**                                     
*        GOTO1 REPORT              **TEST**                                     
         DROP  K                                                                
         MVC   KEY,KEYSAV2         RESTORE KEY BEFORE EXIT                      
         XIT1                                                                   
*                                                                               
* AGYGET: GET AGENCY NAME, P1: AGY CODE  P2: SOURCE REP CODE                    
*                                                                               
AGYGET   NTR1                                                                   
         XC    KEY,KEY                                                          
         LA    R4,KEY                                                           
         USING RAGYKEY,R4          READ AGENCY RECORD                           
         MVI   RAGYKTYP,X'0A'      RECORD TYPE = 0A                             
         MVC   RAGYKAGY(6),DMCB    AGENCY CODE                                  
         MVC   RAGYKREP,DMCB+6     SOURCE REP CODE                              
         DROP  R4                                                               
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE                                                  
         ...
         MVC   TEMPNAME,=CL20'UNKNOWN'  NOT FOUND                               
         B     AGYG0010                                                         
         GOTO1 GETAGY              GET THE WHOLE RECORD                         
         MVC   TEMPNAME(L'RAGYNAM1),RAGYNAM1    INSERT OLD AGENCY NAME          
AGYG0010 EQU   *                                                                
*        MVC   P+5(07),=C'AGY NAME' **TEST**                                    
*        MVC   P+15(20),TEMPNAME   **TEST**                                     
*        GOTO1 REPORT              **TEST**                                     
*        DROP  R4                                                               
         MVC   KEY,KEYSAV2          RESTORE KEY BEFORE EXIT                     
         XIT1                                                                   
...
BTST0040 EQU   *                                                                
         CLC   LASTAGY+4(2),SAGYOFF                                             
*                                  AGENCY/OFFICE BREAK?                         
         BE    BTST0060            NO  - NO BREAKS                              
         GOTO1 REPORT                                                           
         CLI   QOPTION3,C'Z'       OPTION3 = Z?                                 
         BNE   *+8                                                              
         BAS   RE,OAGYBREK         YES - SHOW OLD AGENCY BREAK                  
         BAS   RE,AOFBREAK         YES - SHOW AGYOFF BREAK                      
         B     BTST0800                                                         
BTST0060 EQU   *                                                                
         CLI   QOPTION3,C'Z'                                                    
         BNE   BTST0800                                                         
         CLC   LASTAGYO,SOLDAGYC                                                
*                                  AGENCY BREAK FOR NEW/OLD FORMAT?             
...
AOFBREAK NTR1                                                                   
         ...
         EJECT                                                                  
OAGYBREK NTR1                                                                   
         MVC   P+45(14),=C'OLD AGY TOTAL:'                                      
         EDIT  OLDAGYDO,(11,DDOLLARO),2                                         
         XC    OLDAGYDO,OLDAGYDO   CLEAR OFFICE DOLLARS                         
         EDIT  OLDAGYDN,(11,DDOLLARN),2                                         
         XC    OLDAGYDN,OLDAGYDN   CLEAR OFFICE DOLLARS                         
         GOTO1 REPORT                                                           
         GOTO1 REPORT                                                           
         B     EXIT                                                             
         EJECT                                                                  
...
*                                                                               
SORTGEN  NTR1                                                                   
         MVC   DMCB,RCONKADV       GET OLD ADVERTISER NAME                      
         MVC   DMCB+4(2),SRCEREP                                                
         GOTO1 ADVGET                                                           
         MVC   SOLDADV,TEMPNAME    INSERT ADVERTISER NAME                       
*                                                                               
         MVC   DMCB(6),RCONKAGY    GET OLD AGENCY NAME                          
         MVC   DMCB+6(2),SRCEREP                                                
         GOTO1 AGYGET                                                           
         MVC   SOLDAGY,TEMPNAME    INSERT OLD AGENCY NAME                       
*        MVC   P+5(08),=C'AGY NAME' **TEST**                                    
*        MVC   P+15(20),SOLDAGY    **TEST**                                     
*        GOTO1 REPORT              **TEST**                                     
*                                                                               
         GOTO1 HIGH                EXTRA READ TO GET CONTRACT BACK              
         GOTO1 GETCON                                                           
         MVI   SORTREC,0                                                        
...
*                                                                               
         MVC   SOLDAGYC(6),SAGENCY SAVE INFORMATION OF OLD CON                  
         MVC   SOLDSP,SSALPER                                                   
         MVC   SOLDSDAT(6),SFLITEST                                             
         MVC   SOLDPDT,SPRODUCT                                                 
         MVC   SOLDTYP,SCONTYPE                                                 
         MVC   SOLDOFF,SOFFICE                                                  
         MVC   SOLDADVC,SADVERT    INSERT ADVERTISER                            
*                                                                               
         GOTO1 SORTER,DMCB,=C'PUT',SORTREC                                      
...
SAGYOLD  DS    CL4   +11           SEQ KEY FOR NEW/OLD FORMAT                   
SAOFOLD  DS    CL2   +15           SEQ KEY FOR NEW/OLD FORMAT                   
SADVERT  DS    CL4   +17           ADVERTISER CODE                              
SPRODUCT DS    CL20  +21           PRODUCT                                      
SCONTYPE DS    CL1   +41           CONTRACT TYPE                                
SSALPER  DS    CL3   +42           SALESPERSON                                  
SFLITEST DS    CL3   +45           FLIGHT START DATE                            
SFLITEND DS    CL3   +48           FLIGHT END   DATE                            
SDOLLARO DS    CL4   +51           CONTRACT VALUE:  OLD                         
SOLDCON# DS    CL4   +55           OLD CONTRACT NUMBER                          
SNEWCON# DS    CL4   +59           NEW CONTRACT NUMBER                          
SCMBOFL1 DS    CL1   +63           Y = COMBO ORDER: SOURCE                      
SCMBOFL2 DS    CL1   +64           Y = COMBO ORDER: TARGET                      
SDOLLARN DS    CL4   +65           CONTRACT VALUE:  NEW                         
SOLDADV  DS    CL20  +69           OLDER ADVERTISER NAME                        
SNEWADV  DS    CL20  +89           NEW ADVERTISER NAME                          
SOLDAGY  DS    CL20  +109          OLD AGY NAME                                 
SNEWAGY  DS    CL20  +129          NEW AGY NAME                                 
SOLDSP   DS    CL3   +149          OLD  SALESPERSON CODE                        
SOLDSDAT DS    CL3   +152          OLD START DATE END DATE                      
SOLDEDAT DS    CL3   +155                                                       
SOLDAGYC DS    CL4   +158          OLD AGENGY CODE                              
SOLDAOF DS     CL2   +162          OLD AGENCY OFFICE CODE                       
SOLDPDT  DS    CL20  +164                                                       
SOLDTYP  DS    CL1   +184                                                       
SOLDADVC DS    CL4   +185                                                       
SOLDOFF  DS    CL2   +189          OFFICE CODE                                  
         DS    CL1   +191          SPARE                                        
SRTRECLN EQU   *-SORTREC                                                        
*                                                                               
SORTREC2 DS    0CL192              SAVED SORTKEY                                
*                                                                               
TTYP     DS    CL1   +0                                                         
*                                  TYPE 0  =  SOURCE CONTRACT                   
*                                  TYPE 1  =  TARGET CONTRACT                   
...
TAGYOLD  DS    CL4   +11                                                        
TAOFOLD  DS    CL2   +15                                                        
TADVERT  DS    CL4   +17           ADVERTISER CODE                              
TPRODUCT DS    CL20  +21           PRODUCT                                      
TCONTYPE DS    CL1   +41           CONTRACT TYPE                                
TSALPER  DS    CL3   +42           SALESPERSON                                  
TFLITEST DS    CL3   +45           FLIGHT START DATE                            
TFLITEND DS    CL3   +48           FLIGHT END   DATE                            
TDOLLARO DS    CL4   +51           CONTRACT VALUE:  OLD                         
TOLDCON# DS    CL4   +55           OLD CONTRACT NUMBER                          
TNEWCON# DS    CL4   +59           NEW CONTRACT NUMBER                          
TCMBOFL1 DS    CL1   +63           Y = COMBO ORDER:  SOURCE                     
TCMBOFL2 DS    CL1   +64           Y = COMBO ORDER:  TARGET                     
TDOLLARN DS    CL4   +65           CONTRACT VALUE:  NEW                         
TOLDADV  DS    CL20  +69           OLDER ADVERTISER NAME                        
TNEWADV  DS    CL20  +89           NEW ADVERTISER NAME                          
TOLDAGY  DS    CL20  +109          OLD AGY NAME                                 
TNEWAGY  DS    CL20  +129          NEW AGY NAME                                 
TOLDSP   DS    CL3   +149          OLD  SALESPERSON CODE                        
TOLDSDAT DS    CL3   +152          OLD START DATE END DATE                      
TOLDEDAT DS    CL3   +155                                                       
TOLDAGYC DS    CL4   +158          OLD AGENGY CODE                              
TOLDAGYO DS    CL2   +162          OLD AGENCY OFFICE CODE                       
TOLDPDT  DS    CL20  +164                                                       
TOLDTYP  DS    CL1   +184                                                       
TOLDADVC DS    CL4   +185                                                       
TOLDOFF  DS    CL2   +189          OFFICE CODE                                  
         DS    CL1   +191          SPARE                                        
*                                                                               
*                                                                               
COUNTUPS EQU   *                                                                
...
TEMPNAME DS    CL33                                                             
*                                                                               
SRCENAME DS    CL33                SOURCE REP FULL NAME                         
NREPNAME DS    CL33                NEW REP FULL NAME                            
...
DRECTYP  DS    CL2                                                              
         DS    CL1                                                              
DOFFIC2  DS    CL2                 OFFICE CODE                                  
         DS    CL3                                                              
DAGYCOD  DS    CL4                 AGENCY CODE                                  
         DS    CL1                                                              
DAGYOFF2 DS    CL2                 AGENCY OFFICE                                
         DS    CL1                                                              
DAGYNAM  DS    CL20                AGENCY NAME                                  
         DS    CL1                                                              
DADVCODE DS    CL4                                                              
         DS    CL1                                                              
DADVNAM  DS    CL20                ADVERTISER NAME                              
         DS    CL1                                                              
DSPCODE  DS    CL3                 SALESPERSON CODE                             
         DS    CL3                                                              
DPRDNAM  DS    CL18                PRODUCT NAME                                 
         DS    CL1                                                              
DCONTYP  DS    CL1                 CONTRACT TYPE                                
         DS    CL3                                                              
DFLITSD2 DS    CL8                 FLIGHT START DATE                            
         DS    CL1                                                              
DFLITED2 DS    CL8                 FLIGHT END   DATE                            
         DS    CL1                                                              
DCON#    DS    CL8                 CONTRACT NUM                                 
         DS    CL2                                                              
DDOLLAR  DS    CL11                DOLLAR AMOUNT                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'115REREPTK02 12/14/05'                                      
         END                                                                    
