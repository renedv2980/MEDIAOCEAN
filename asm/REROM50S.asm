*          DATA SET REROM50S   AT LEVEL 029 AS OF 02/25/03                      
*          DATA SET REROM50    AT LEVEL 114 AS OF 05/31/94                      
*PHASE T82F50B                                                                  
*                                                                               
         TITLE 'T82F50 - REROM50 - DARE ORDER HISTORY LIST'                     
***********************************************************************         
*                                                                     *         
*  REROM50 (T82F50) --- DARE ORDER HISTORY LIST                       *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
* 16JAN03 (HQ ) ADD MATCH-S, SALESPERSON                              *         
...
*                                                                               
         CLI   RDARHSLN,RDARHL2Q   DISPLAY SALESPERSON INFORMATION              
         BNL   *+14                OLD ELEMENTS ARE ALL BY USER                 
         MVC   LHISDTYP,=C'USER     '                                           
         B     VR19                                                             
*                                                                               
         OC    RDARHSSP,RDARHSSP                                                
         BZ    VR18A                                                            
         MVC   LHISDSP,RDARHSSP                                                 
*                                                                               
VR18A    DS    0H                  WHAT CHANGED THE STATUS?                     
         OC    RDARHFG1,RDARHFG1                                                
         BZ    VR18D                                                            
         TM    RDARHFG1,X'80'                                                   
         BO    VR18B                                                            
         TM    RDARHFG1,X'40'                                                   
         ...
         TM    RDARHFG1,X'20'                                                   
         BZ    VR18X                                                            
         MVC   LHISDTYP,=C'USER CONF' STATUS CHANGED USER CONFIRM               
         B     VR18X                                                            
VR18B    DS    0H                                                               
         MVC   LHISDTYP,=C'SYSTEM   ' STATUS CHANGED BY SYSTEM                  
         B     VR18X                                                            
VR18C    DS    0H                                                               
         MVC   LHISDTYP,=C'USER LINK' STATUS CHANGED BY USER LINKING            
         B     VR18X                                                            
VR18D    DS    0H                                                               
         MVC   LHISDTYP,=C'USER     ' STATUS CHANGED BY USER LINKING            
         B     VR18X                                                            
VR18X    DS    0H                                                               
*                                                                               
VR19     DS    0H                                                               
...
STATLIST DS    0CL10                                                            
         ...
         DC    C'P',CL9'Pendng CF'                                              
         DC    C'Q',CL9'CF Apprvd'                                              
         DC    C'W',CL9'Sta CF'                                                 
         DC    C'M',CL9'Amended'                                                
         DC    C'G',CL9'Reassign'                                               
         DC    C'H',CL9'Match-s'                                                
...
LHISDTYP DS    CL9                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'029REROM50S  02/25/03'                                      
         END                                                                    
