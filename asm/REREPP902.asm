*          DATA SET REREPP902  AT LEVEL 046 AS OF 05/01/02                      
*PHASE REP902A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
*INCLUDE XSORT                                                                  
         TITLE 'REREPP902 (REP902) NEW REP P9 FILE EXTRACT/CREATION'            
*                                                                               
********************************************************************            
*                                                                  *            
*        REREPEA02 -- EXTRACTS AND CREATS A P9  FILE WITH REP      *            
*                      FROM THE TV FILE                           *             
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
* JAN25/96 (SKU) --- ORIGINAL ENTRY                                *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
BUY20    DS    0H                                                               
         CLC   KEY(18),KEYSAVE     DO ALL BUYS                                  
...
*                                                                               
         XC    WORK,WORK                                                        
         PACK  WORK+25(1),RBUYKCON+3(1)  REVERSE THE COMPLIMENT                 
         PACK  WORK+26(1),RBUYKCON+2(1)                                         
         PACK  WORK+27(1),RBUYKCON+1(1)                                         
         PACK  WORK+28(1),RBUYKCON(1)                                           
*                                                                               
         ZAP   WORK+30(5),=P'0'                                                 
...
*                                                                               
         EDIT  (P5,WORK+20),(8,P+20),ALIGN=LEFT                                 
*                                                                               
         GOTO1 REPORT                                                           
         DROP  R6                                                               
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'046REREPP902 05/01/02'                                      
         END                                                                    
