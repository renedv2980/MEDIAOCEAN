*          DATA SET ACCLB0D    AT LEVEL 137 AS OF 08/16/00                      
*PHASE T6210DA                                                                  
...
SFRST44  MVC   FLTLNG,LANGCODE                                                  
         ...
         DROP  R2                                                               
*                                                                               
SFRST50  GOTO1 AFVAL,CLTGRBH       VALIDATE GROUPING BASIS                      
         BL    SFRST60                                                          
         TM    FVIIND,FVINUM                                                    
         BZ    SCRFRSTN                                                         
         OC    BCFULL(3),BCFULL                                                 
...
* DDFH                                                                          
       ...
       ++INCLUDE DDFH                                                           
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'137ACCLB0D   08/16/00'                                      
         END                                                                    
