*          DATA SET REWRI20S   AT LEVEL 013 AS OF 07/14/03                      
...
*NVTB2SZ EQU   1+20000*ITLEN2                                                   
INVTB2SZ EQU   1+40000*ITLEN2                                                   
CONTABSZ EQU   8+(8*12000) 12000 8 BYTE ENTS (4 D/A,3 DEM,1 SPARE)              
...
STARECD  DSECT                                                                  
       ...
       ++INCLUDE REPIOBLK                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'013REWRI20S  07/14/03'                                      
         END                                                                    
