*          DATA SET DENITNO    AT LEVEL 057 AS OF 08/16/18                      
*PHASE DENITNOA                                                                 
*INCLUDE DEBKUPDT                                                               
         TITLE 'OUTPUT PHASE FOR ITN CONVERSION'                                
DENITNO  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         ...
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DENITNO+4096,R7     R7=2ND BASE REGISTER                         
...
*08/2018 WE WERE CHECKING FOR 30 BYTES BUT WE STARTED GETTING EMPTY             
*RECORDS WHICH HAD DATA IN THE LAST 4 BYTES.  I THINK IT IS SAFE                
* TO SIMPLY CHECK THE FIRST 24 BYTES OF INTKEY WHICH IS 24 BYTES                
* BECAUSE THEY SHOULD MAP TO REAL DEMO DIRECTORY KEYS                           
*                                                                               
*CNV20    OC    INTKEY,INTKEY       UNUSABLE RECORD                             
CNV20    OC    INTKEY(24),INTKEY       UNUSABLE RECORD                          
         BZ    CNVX                                                             
*                                                                               
...
*                                                                               
         ...
         BL    CNV72                                                            
         L     RF,=A(BLDDT)                                                     
         BRAS  RE,BLDDT            BUILD DEMO DATA TYPE ELEMENT                 
         GOTO1 APUTEL,TEMP         X'08'                                        
*                                                                               
         USING PHTELEM,R6          BUILD NETWORK PROGRAM TYPE ELEMENT           
CNV72    XC    TEMP,TEMP           CLEAR ELEMENT AREA                           
...
ADDCB05  XC    DBUPARMS,DBUPARMS                                                
         ...
         USING DBUPARMD,R2                                                      
*                                                                               
         MVI   DBUPSTYP,DBUPSYNQ   POSTING TYPE IS SYNDICATION                  
*                                                                               
         L     RE,AOREC                                                         
...
ADDCB20  CLI   DBUBOOK+1,0         SKIP IT FOR YEARLY HUTS                      
         ...
         MVC   DBUACOMS,ACOMFACS                                                
         MVI   DBURTYP,DBURNETQ                                                 
         MVI   DBUBKFLG,DBUBKWQ    WEEKLY BOOKS                                 
         DROP  R2                                                               
*                                                                               
...
PKEY     NTR1                                                                   
         ...
         BE    PKEY30              NO                                           
         XC    KEYP,KEYP                                                        
         MVC   PRCODE(3),=C'PNN'   YES - SET UP KEY                             
...
QKEY     NTR1                                                                   
         ...
         BE    QKEY30              NO                                           
         XC    KEYQ,KEYQ                                                        
         MVC   PMCODE(3),=C'QNN'   YES - SET UP KEY                             
...
*PREVCORR DS    0XL10               PREVIOUS CORRECTION KEY                     
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'057DENITNO   08/16/18'                                      
         END                                                                    
