*          DATA SET TAREP78    AT LEVEL 069 AS OF 08/19/14                      
*PHASE T70378C,*                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE DLFLD                                                                  
         TITLE 'T70378 - NR4 REPORTS'                                           
T70378   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 MYEND-MYSTART,T70378,R7                                          
         LR    RA,RC                                                            
         USING MYD,RA                                                           
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
...
*----------------------------------*                                            
         ...
         LA    R3,KEY                                                           
         USING TLN4D,R3                                                         
         MVI   TLN4CD,TLN4CDQ      X'24'                                        
         MVI   TLN4SCD,TLN4SCDQ    X'05'                                        
         MVC   TLN4YEAR,THISYEAR   YEAR                                         
         MVI   TLN4CUR,C'C'        CANADIAN                                     
         MVC   TLN4EMP,TIFEMP                                                   
         GOTO1 HIGH                                                             
         B     PNR4D150                                                         
PNR4D100 GOTO1 SEQ                                                              
                                                                                
PNR4D150 CLC   KEY(TLN4SSN-TLN4D),KEYSAVE     COMPARE KEY UP TO EMP             
         JNE   PNR4D900                                                         
         GOTO1 GETREC                                                           
         MVC   LASTSSN,TLN4SSN                                                  
...
*                                                                               
         ...
         BRAS  RE,GETEL                                                         
         B     PNR4D450                                                         
PNR4D400 BRAS  RE,NEXTEL                                                        
PNR4D450 JNE   PNR4D800                                                         
         ...
         GOTO1 (RF),DMCB,(C'T',TAN4UNIT),L'TAN4UNIT  PROVINCE                   
         GOTO1 (RF),DMCB,(C'T',SPACES),1                                        
         ...
         EDIT  (4,TAN4EARN),(12,BLOCK),2,ALIGN=LEFT,FLOAT=-                     
         GOTO1 OUTPDOWN,DMCB,(C'N',BLOCK),12         T4 RENMRATION              
                                                                                
                                                                                
         BRAS  RE,EOLDOWN                                                       
         B     PNR4D400            BUMP TO NEXT ELEMENT                         
                                                                                
PNR4D800 BRAS  RE,CHKSYS                                                        
         MVC   KEY,SAVEKEY         RESTORE READ SEQUENCE                        
         GOTO1 HIGH                                                             
         B     PNR4D100                                                         
                                                                                
PNR4D900 BRAS  RE,ENDDOWN                                                       
         J     XIT                                                              
         EJECT                                                                  
*------------------------------*                                                
*  NR4 / REPORT                *                                                
...
PROCHECK NTR1                                                                   
         LA    R5,TAPEIO                                                        
         USING TLN4D,R5                                                         
         CLC   TLN4EMP,TIEMP       CHECK IF FOR SAME EMP/CUR/SSN                
         JNE   PROC2                                                            
         CLI   TICUR,C'U'                                                       
         JNE   PROC2                                                            
         CLC   TLN4SSN,TISSN                                                    
...
PROC2    OC    TLN4SSN,TLN4SSN     IF THIS IS NOT THE FIRST                     
         JZ    PROC3                                                            
...
PROC3    LR    RE,R5                                                            
         LA    RF,2000                                                          
         XCEF                                                                   
         MVI   TLN4CD,TLN4CDQ      BUILD NEW T4 KEY                             
         MVI   TLN4SCD,TLN4SCDQ                                                 
         MVC   TLN4YEAR,THISYEAR                                                
         MVC   TLN4EMP,TIEMP                                                    
         MVI   TLN4CUR,C'C'                                                     
         MVC   TLN4SSN,TISSN                                                    
*                                                                               
...
PROC7    OC    TAT4AMTS,TAT4AMTS                                                
         ...
         J     XIT                                                              
         EJECT                                                                  
*              READ TAPE AND BUILD NEW NR4 RECORD                               
         SPACE 3                                                                
TREP     NTR1                                                                   
         LA    R4,INIO                                                          
         USING IND,R4                                                           
...
TREP3    CLC   LASTSSN,INSSN                                                    
         ...
         JNE   *+10                                                             
         MVC   TLN4EMP,=C'DM '                                                  
         MVI   TLN4CUR,C'U'        ONLY GETTING US, I HOPE                      
         UNPK  TLN4SSN,INSSN       CONVERT SSN FROM PACKED                      
*                                                                               
...
PUTTAPE2 LA    R5,TAPEIO                                                        
         ...
         LH    R1,TLN4LEN          NOT CSC, ADD TO TAPE                         
         LA    R1,4(R1)                                                         
         STH   R1,PRETAPIO                                                      
         L     R1,=A(T4TAPE)                                                    
         LA    R0,PRETAPIO                                                      
...
TWADCOND DSECT                                                                  
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'069TAREP78   08/19/14'                                      
         END                                                                    
