*          DATA SET RELFM17A   AT LEVEL 119 AS OF 05/01/02                      
*PHASE T80417A,*                                                                
*INCLUDE REGETIUA                                                               
...
*************************************************************                   
         MVI   TAPEOPT,C'Y'        PATCHABLE IMP. PRECISION                     
         MVI   TAPEOPT,C'N'                                                     
*************************************************************                   
         ZIC   R3,INVNO                                                         
         L     R5,INVLIST                                                       
...
*----->  B     HOOK1T              PUT THIS IN TO ROUND                         
         ...
         LA    RF,OFORMAT2                                                      
         ST    RF,DMCB+12                                                       
*<--OLD  GOTO1 CDEMAINT,DMCB,=C'PUT',DBLOCK,IUNWORK+500,OFORMAT                 
         GOTO1 CDEMAINT,DMCB,=C'PUT',DBLOCK,IUNWORK+500                         
         DROP  R4                                                               
*                                                                               
         MVC   MTHOSRC,=C'NSI'                                                  
...
OFORMAT  DC    C'IUNUIUN',X'530B00'  RATING BASED                               
OFORMAT2 DC    C'IUNUIUN',X'5A0B00'  IMPRESSION BASED                           
*                                                                               
...
RAVLD    DSECT                                                                  
       ++INCLUDE REGENAVL                                                       
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'119RELFM17A  05/01/02'                                      
         END                                                                    
