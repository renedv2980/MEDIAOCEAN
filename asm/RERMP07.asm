*          DATA SET RERMP07    AT LEVEL 008 AS OF 06/27/08                      
*PHASE T81007A                                                                  
*INCLUDE CLPACK                                                                 
         TITLE 'T81007 - RERMP07 - MARKET PROFILE REPORT'                       
*                                                                               
*******************************************************************             
*                                                                 *             
*        RERMP07 (T81007) --- MARKET PROFILE REPORT               *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
...
TWADCOND DSECT                                                                  
       ...
       ++INCLUDE DDTWADCONS                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008RERMP07   06/27/08'                                      
         END                                                                    
