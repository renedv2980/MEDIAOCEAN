*          DATA SET RERIS06    AT LEVEL 071 AS OF 07/11/12                      
*PHASE T80D06A                                                                  
...
*                                                                     *         
* AUG24/10 (SMY) --- ADD TRAFFIC ORDER # HEADLINE FOR RCU OPTION      *         
*                                                                     *         
*                                                                     *         
*                    **  END TOMBSTONE  **                            *         
***********************************************************************         
...
*                                                                               
         ...
         TM    VIEWS3,X'10'        LISTD,RCU OPTION ?                           
         BO    DOHEAD20            YES                                          
         TM    VIEWS3,X'08'        LISTD,RCM OPTION ?                           
         BNO   DOHEADP             NO - PRINT                                   
*                                                                               
DOHEAD20 DS    0H                                                               
         MVC   MYP(L'MYPLHED2),MYPLHED2    USE OTHER HEADER                     
                                                                                
DOHEADP  BAS   RE,PRINT                                                         
*                                                                               
         B     XIT                                                              
*                                                                               
...
MYPLHED2 DC    C'      STA/ADV  AGENCY/ADVERTISER      PRODUCT/SALES   X        
                      FLIGHT    CONT/TRAF     DOLLARS      CRD/ACTV   VX        
               ER/SNT'                                                          
...
*                                                                               
       ...
       ++INCLUDE DMPRTQL                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'071RERIS06   07/11/12'                                      
         END                                                                    
