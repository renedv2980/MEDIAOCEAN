*          DATA SET DENITNI    AT LEVEL 068 AS OF 02/14/14                      
*PROCESS USING(WARN(15))                                                        
*PHASE DENITNIA                                                                 
************************************************************                    
* DIFFER FROM WEEKLY SYNDICATION IN STATION = ITN*S                             
* WHERE * = DAY OF WEEK.                                                        
* UNIVSERSES ARE READ FROM FILE IN A LOOP FOR THE ENTIRE                        
* MONTH, AND ARE USED ACCORDINGLY.                                              
************************************************************                    
DENITNI TITLE '- DEMO CONVERSION - ITN SYNDICATION'                             
...
*********************************************************************           
*                                                                               
*ALLIGN1  EQU   (((*-DENITNI+4095)/4096)*4096)    ALLIGN AT 2000                
*         ORG   DENITNI+ALLIGN1                                                 
                                                                                
CNVRTN   NMOD1 0,**CNVW**                                                       
         USING (CNVRTN,CNVRTNX),RB                                              
         USING DEMCOND,R8          R8 = DEMCNV GLOBAL WORK                      
         USING WORKD,R4            R4 = DENITNI WORK                            
*                                                                               
...
*        DDCOMFACS                                                              
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'068DENITNI   02/14/14'                                      
         END                                                                    
