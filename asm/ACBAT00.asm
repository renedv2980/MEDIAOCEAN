*          DATA SET ACBAT00    AT LEVEL 069 AS OF 12/10/14                      
*PHASE T61B00A                                                                  
*INCLUDE AMTVALA                                                                
*INCLUDE CONVMOS                                                                
*INCLUDE BMONVAL                                                                
...
INITGV14 CLI   CPYEL,0             TEST EOR                                     
         ...
         LR    RE,R0                                                            
         BCTR  RE,0                                                             
         EXMVC RE,BCCPYEL,CPYELD                                                
*                                                                               
         XC    BCCPYGLM,BCCPYGLM                                                
         CLI   CPYLN,CPYLN4Q                                                    
         BL    *+10                                                             
         MVC   BCCPYGLM,CPYGLMOA                                                
*                                                                               
...
VALREC   TM    BASRECH+(FVIIND-FVIHDR),FVIVAL                                   
         ...
         MVCL  R0,RE                                                            
*                                  PRESERVE THESE BITS                          
         MVC   BCWORK(TWAPPLIC-TWAAIND1),TWAAIND1                               
         MVC   BCBYTE1,TWAINDS1                                                 
         NI    BCBYTE1,TWAIINIT+TWAIUPID+TWAIUGID                               
         XC    TWAVALS,TWAVALS                                                  
         MVC   TWAINDS1,BCBYTE1                                                 
         CLI   BCWORK+(TWATYPE-TWAAIND1),TWATYP10                               
         BNE   *+10                                                             
         MVC   TWAAIND1(TWAPPLIC-TWAAIND1),BCWORK                               
...
***********************************************************************         
         SPACE 1                                                                
VALSCR   CLI   BASSCR,C' '         IF NOT GREATER THAN A SPACE                  
         BNH   *+12                 MAKE IT PAGE                                
         CLI   BASSCRH+(FVILEN-FVIHDR),0                                        
         BNE   VALSCR02                                                         
...
*                                                                               
         ...
         DCDDL AC#TT009,15                                                      
*                                                                               
         DC    AL1(BT10,BTO10,BTS10),AL1(TBAGPRDQ)   MULTIPLE                   
         DC    AL1(TYPIORDS+TYPIOMEM)                                           
         DC    AL1(TYPIOPF)                                                     
         DC    AL1(TYPIMSCR+TYPIT250)                                           
         DC    AL1(TYPIBGIC+TYPIT200)                                           
         DC    AL1(TYPIFCUR+TYPIOVSS+TYPINODC+TYPIHRTX)                         
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
         DC    AL1(TYPIXOVL)                                                    
         DC    AL1(0)                                                           
         ...
         DCDDL AC#TT010,15                                                      
*                                                                               
         DC    AL1(BT10,BTO10,BTS10D),AL1(TBAGPRDQ)  DETAIL                     
         DC    AL1(TYPIORDS+TYPIOMEM)                                           
         DC    AL1(TYPIOPF)                                                     
         DC    AL1(TYPIMSCR+TYPIT250)                                           
         DC    AL1(TYPIBGIC+TYPIT200)                                           
         ...
         DCDDL AC#TT010,15                                                      
*                                                                               
         DC    AL1(BT10,BTO10,BTS10C),AL1(TBAGPRDQ)  MULTIPLE(CAN)              
         DC    AL1(TYPIORDS+TYPIOMEM)                                           
         DC    AL1(TYPIOPF)                                                     
         DC    AL1(TYPIMSCR+TYPIT250)                                           
         DC    AL1(TYPIBGIC+TYPIT200)                                           
         ...
         DCDDL AC#TT010,15                                                      
*                                                                               
         DC    AL1(BT10,BTO10,BTS10CD),AL1(TBAGPRDQ) DETAIL(CAN)                
         DC    AL1(TYPIORDS+TYPIOMEM)                                           
         DC    AL1(TYPIOPF)                                                     
         DC    AL1(TYPIMSCR+TYPIT250)                                           
         DC    AL1(TYPIBGIC+TYPIT200)                                           
         ...
         DCDDL AC#TT010,15                                                      
*                                                                               
         DC    AL1(BT13,BTO13,BTS13),AL1(TBAGGENQ)                              
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
         DC    AL1(TYPIT250)                                                    
         DC    AL1(TYPIT250)                                                    
...
*                                                                               
         ...
         DCDDL AC#TT072,15                                                      
*                                                                               
         DC    AL1(BT81,BTO81,BTS81),AL1(TBAGGENQ)                              
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
         DC    AL1(TYPIT250)                                                    
         DC    AL1(TYPIT250)                                                    
...
* ACBATWORK                                                                     
       ++INCLUDE ACBATWORK                                                      
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'069ACBAT00   12/10/14'                                      
         END                                                                    
