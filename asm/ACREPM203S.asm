*          DATA SET ACREPM203S AT LEVEL 034 AS OF 05/01/02                      
*PHASE ACM203A                                                                  
...
*&&US                                                                           
         ...
         BZ    *+12                                                             
         SH    RF,=H'48'           SUBTRACT X'30' ESCAPE SEQ ADJUSTMENT         
*        SH    RF,=H'37'           SUBTRACT X'25' ESCAPE SEQ ADJUSTMENT         
...
SBSIS    MVC   FORMBASE,2(R6)      BASIS                                        
         ...
         B     SPEC07                                                           
*                                                                               
SHLOD    L     R4,AHOOKCDE       HOOKLOAD PHASE                                 
         TM    RQSW,RQFLG        IS THIS FIRST FOR REQUEST                      
         BNO   SPEC07            NO-ALREADY LOADED                              
         GOTO1 LOADER,DMCB,2(R6),(R4),(C'M',(R4))                               
         OC    DMCB+4(4),DMCB+4                                                 
         BNZ   SPEC07                                                           
...
GEXE45   MVC   4(2,R3),=S(SPACES)  SET FOR SPACES                               
         ...
         SH    R2,=H'8'            LESS THE CONSTANT OF 7 AND 1 FOR EX          
         EX    R2,*+4                                                           
...
GEXL05   CLC   6(5,R6),=C'\LIST'   LIST CONNECTIVE                              
         ...
         BNE   GEXL10                                                           
         IC    R1,1(R6)                                                         
         SH    R1,=H'13'           GET LENGTH OF LIST CODE                      
         EX    R1,*+8                                                           
         B     *+10                                                             
...
SLV7     CLC   LDGLUNL,COSTUL      IS IT CLIENT LEDGER                          
         ...
         CLI   LDGCPOS,C' '        ANY DISPLACEMENT FOR CLIENT                  
         BE    SLV5                NO ENTRY, USE DEFAULT                        
         CLI   LDGCPOS,0                                                        
         BE    SLV5                                                             
         IC    R0,LDGCPOS                                                       
         STC   R0,CLIPOS           POSITION OF CLIENT IN 1C                     
         B     SLV5                                                             
*                                                                               
         USING ACLELD,R6                                                        
...
XTAB     DS    0F                                                               
         ...
         DC    AL1(CMKCOL),AL3(XKCOL)       KEYCOL                              
...
XCOL     BAS   RE,XCOLALL          COL                                          
         MVC   0(9,R3),3(R6)                                                    
         BAS   RE,CHKBUD           SEE IF BUDGETS ARE NEEDED                    
         BAS   RE,COLNAM                                                        
         B     XTRCT7                                                           
*                                                                               
XCLCN    DS    0H                  COLCOMP                                      
...
XRVED    SR    R3,R3               NOTOT AND REVEDIT ARE CELL OPTIONS           
         ...
         MH    R3,=Y(RSOMX)        X NUMBER OF COLUMN OPTION FIELDS             
...
XRVED5   SR    R0,R0                                                            
         IC    R0,1(R6)                                                         
         SH    R0,=H'3'            R0=GET NUMBER OF COLUMNS                     
...
COLINF3  ST    R1,COLWIDE                                                       
         ...
         CH    RE,=H'1'            IF WE HAVE REACHED START OF NEW FOLD         
         BNE   COLINF2                                                          
         MH    RF,=H'164'                                                       
...
*                                                                               
         ...
         SR    RF,RF                                                            
         IC    RF,ROLLING+1                                                     
         SH    RF,=H'11'           FOR PRIOR 12 MONTHS                          
         STC   RF,ROLLING                                                       
         LA    R2,ROLLING                                                       
         LA    R1,LASTROLL                                                      
         LA    R3,NEXTROLL                                                      
...
SETND2   BAS   RE,SETHOL                                                        
         ...
         BCT   R0,SETND2                                                        
*                                                                               
         LH    RE,=Y(LNSWH*WLN)    MOVE LINE 37 (STANDARD WRK HOURS) TO         
         A     RE,AZRO                                                          
         LA    RF,WLN              WIDTH OF LINE                                
         LH    R2,=Y(LNC30*WLN)    LINE 30                                      
         A     R2,AZRO                                                          
         LR    R3,RF                                                            
         MVCL  R2,RE                                                            
...
MNWK     NTR1  ,                                                                
         ...
         BNE   MNWK23                                                           
         LH    R3,=Y(52*3)         DEFAULT NUMBER OF WEEKS                      
         STH   R3,MNWKS                                                         
         BCTR  R3,0                                                             
         MH    R3,=Y(MNWKLNQ)                                                   
...
STDWK11  CLC   SHRSTART,MNWKEND                                                 
         ...
         LH    RE,=Y(LNSWH*WLN)    RE=STANDARD WORKING HOURS                    
         A     RE,AZRO                                                          
         SR    RF,RF                                                            
...
SVRP     DS    C                                                                
       ...
       ++INCLUDE ACAPGGEND                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034ACREPM203S05/01/02'                                      
         END                                                                    
