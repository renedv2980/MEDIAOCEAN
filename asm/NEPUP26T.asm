*          DATA SET NEPUP26T   AT LEVEL 004 AS OF 05/01/02                      
*          DATA SET NEPUP26    AT LEVEL 005 AS OF 02/23/99                      
...
POSTPROG NTR1                                                                   
         ...
         MVC   BINDATA,KEY                                                      
         GOTO1 =V(PRNTBL),DMCB,=C'PPP',BINDAY,C'DUMP',31,=C'1D'                 
         GOTO1 =V(BINSRCH),BINDMCB,(1,(R3)),RR=RELO                             
         CLI   0(R1),X'01'         IF FOUND                                     
         BE    *+6                                                              
         DC    H'0'                TAKE A HIT                                   
         B     XIT                                                              
         EJECT                                                                  
...
*                                                                               
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004NEPUP26T  05/01/02'                                      
         END                                                                    
