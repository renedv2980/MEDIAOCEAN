*          DATA SET YYUNMQP2   AT LEVEL 066 AS OF 05/01/02                      
*PHASE YYUNMQP2                                                                 
*INCLUDE HEXOUT                                                                 
*INCLUDE PDUMPER                                                                
*INCLUDE PRINT                                                                  
...
*PUT THE MESSAGE FROM FILEIN IN THE TARGET (QMGRNAME QNAME).                    
*MODIFY (QMGRNAME,QNAME) BEFORE RUNNING IT.                                     
         MACRO                                                                  
&NAME    PRNT  &A,&PRINT=                                                       
&NAME    DS    0H                                                               
         AIF   (T'&A EQ 'O').NOMOVE                                             
...
*                                                                               
         ...
         MVC   DCBDDNAM-IHADCB(8,RF),=C'MQPUT2  '  DDNAME=EZTRACE               
*                                                                               
*                                                                               
...
***ME        DC      CL48'DTALICE.QREMOTE'                                      
***ME        DC      CL48'DARE.TEST.INPUTQ'                                     
***ME        DC      CL48'DARE.TEST.REPLYQ'                                     
***ME        DC      CL48'DARE.TEST.INPUTQ'                                     
***ME        DC      CL48'DARE.TEST.OUTPUTQ.AGY1'                               
***ME        DC      CL48'INVOICE.REMOTEQ'                                      
***ME        DC      CL48'CJDSFLN.QREMOTE'                                      
QNAME        DC      CL48'CJDSDSI.QREMOTE'                                      
*                                                                               
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'066YYUNMQP2  05/01/02'                                      
         END                                                                    
