*          DATA SET RESFM0A    AT LEVEL 017 AS OF 05/01/02                      
*PHASE T8180AA,*                                                                
         TITLE 'T8180A - TEXT RECORDS'                                          
**********************************************************************          
*                                                                    *          
*        RESFM0A (T8180A) --- TEXT RECORDS                           *          
*                                                                    *          
* ------------------------------------------------------------------ *          
* UPDATE HISTORY:                                                    *          
*                                                                    *          
...
DEMOD    DSECT                                                                  
       ...
       ++INCLUDE DEDBLOCK                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017RESFM0A   05/01/02'                                      
         END                                                                    
