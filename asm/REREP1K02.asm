*          DATA SET REREP1K02  AT LEVEL 066 AS OF 05/01/02                      
*PHASE RE1K02A,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
*                                                                   *           
* AUG19/98 (SKU) --- MORE KEY RESTRUCTURING                         *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
*                    !!!  IMPORTANT  !!!                            *           
...
*                                                                               
SITKEYD  USING RSTRKEY,KEY         INSERT 'SITUATION ANALYSIS' TYPE             
         MVI   SITKEYD.RSTRKSUB,RSTRSITQ                                        
         DROP  SITKEYD                                                          
*                                                                               
         MVC   KEYSAVE,KEY                                                      
...
IOWRK3   DS    12D                                                              
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'066REREP1K02 05/01/02'                                      
         END                                                                    
