*          DATA SET NEDFAR     AT LEVEL 018 AS OF 06/02/20                      
*PHASE NEDFARA                                                                  
NEDFAR   TITLE 'Net System Daily File Activity Extract'                         
         PRINT NOGEN                                                            
NEDFAR   CSECT                                                                  
...
EDTPRD02 CLI   0(R2),0             TEST PRODUCT PRESENT                         
         JE    EXIT                                                             
         ...
         L     RF,DI_AOUT          RF=A(OUTPUT)                                 
EDTPRD04 CLC   CPLPNUMB,0(R2)      MATCH PRODUCT NUMBER TO INPUT                
         JNE   *+14                                                             
...
EDTEST02 L     RF,DI_ADRD                                                       
         CLI   2(RF),AORRECQ       AOR?                                         
         JNE   EDTEST02                                                         
         L     RF,DI_AOUT          RF=A(OUTPUT)                                 
         MVC   0(L'CPLPMNEM,RF),=C'ALL'                                         
         CLI   0(R2),X'FF'                                                      
...
EDTEFF   L     R2,DI_AINP                                                       
         L     R3,DI_AOUT                                                       
         OC    0(L'AOREFF,R2),0(R2)   ANY DATA?                                 
         BZR   RE                   - NOPE                                      
*                                                                               
         LR    R0,RE               SAVE OFF RE                                  
         GOTOR CDATCON,DMCB,(3,(R2)),(9,(R3))                                   
         LR    RE,R0               RESTORE RE                                   
*                                                                               
EDTEFFX  BR    RE                                                               
         EJECT                                                                  
...
EDTEFF2  L     R2,DI_AINP                                                       
         L     R3,DI_AOUT                                                       
         OC    0(L'ADDRCHDT,R2),0(R2)   ANY DATA?  (3 BYTES)                    
         BZR   RE                   - NOPE                                      
*                                                                               
         LR    R0,RE               SAVE OFF RE                                  
...
*                                                                               
         ...
         MVC   1(3,R3),DUB                                                      
         J     *+10                                                             
EGRPC30  MVC   2(3,R3),DUB                                                      
*                                                                               
EGRPC40  MVI   DI_LOUT,4                                                        
         CLI   4(R3),0                                                          
         JE    *+8                                                              
         MVI   DI_LOUT,5                                                        
*                                                                               
...
FILTAB   DS    0XL(DF_LNQ)                                                      
         ...
         DC    AL1(DF_TDA),AL1(13),AL1(1),AL1(24),AL4(FILREC)                   
...
FILREC   DS    0X                  ** SPTFIL RECORD DEFINITIONS **              
...
FILBFM   DS    0X                  ** BFORM RECORD DEFINITION **                
         DC    AL1(FILBFMX-*)                                                   
BFMRECQ  EQU   4                   RECORD IDENTIFIER                            
         DC    AL2(BFMRECQ)                                                     
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
...
FILAOR   DS    0X                  ** AOR RECORD DEFINITION **                  
         DC    AL1(FILAORX-*)                                                   
AORRECQ  EQU   5                   RECORD IDENTIFIER                            
         DC    AL2(AORRECQ)                                                     
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
...
CGDRECQ  EQU   6                   RECORD IDENTIFIER                            
         ...
         DC    AL1(0)                                                           
         DC    AL1(0)                                                           
         DC    CL(L'DR_NAMEF)'CGRDEF'                                           
         DC    CL(L'DR_NAMES)'CGRDEF'                                           
         DC    AL1(CLGKAGMD-CLGKEY)                                             
         DC    AL1(CLGKAGMD-CLGKEY)                                             
         DC    AL1(0)                                                           
         DC    AL1(DR_ITAGM)                                                    
         DC    AL4(0)                                                           
...
CGDARG1  DC    AL1(CGDARG2-*)                                                   
         DC    AL1(CLGKTYP-CLGKEY)                                              
         DC    AL1(DR_ATEQU)                                                    
CGDKTYPQ EQU   X'0D06'                                                          
         DC    AL2(CGDKTYPQ)                                                    
                                                                                
CGDARG2  DC    AL1(CGDARG3-*)                                                   
         DC    AL1(CLGKID-CLGKEY)                                               
         DC    AL1(DR_ATNBZ)                                                    
         DC    AL1(L'CLGKID)                                                    
                                                                                
CGDARG3  DC    AL1(CGDARG4-*)                                                   
         DC    AL1(CLGKGRP-CLGKEY)                                              
         DC    AL1(DR_ATBZ)                                                     
         DC    AL1(L'CLGKGRP)                                                   
...
BFMKEY   DS    0X                  ** BFORM KEY DEFINITIONS **                  
         ...
         DC    AL1(DK_TSHEQ)                                                    
         DC    AL1(BFKPRD-BFKEY,L'BFKPRD),AL4(EDTPRD)                           
         DC    AL2(0)                                                           
         DC    XL8'00'                                                          
         ...
         DC    AL1(DK_TBINQ)                                                    
         DC    AL1(BFKMKT-BFKEY,L'BFKMKT),AL4(0)                                
         DC    AL2(0)                                                           
         DC    XL8'00'                                                          
...
ARCKEY   DS    0X                  ** AOR KEY DEFINITIONS **                    
         ...
         DC    AL1(DK_TCHRQ)                                                    
         DC    AL1(AORKDPT-AORKEY,L'AORKDPT),AL4(0)                             
         DC    AL2(0)                                                           
         DC    XL8'00'                                                          
                                                                                
         DC    AL1(DK_TCHRQ)                                                    
         DC    AL1(AORKSTYP-AORKEY,L'AORKSTYP),AL4(0)                           
         DC    AL2(0)                                                           
         DC    XL8'00'                                                          
...
CGDKEY   DS    0X                  ** CLIENT GROUP KEY DEFINTIONS **            
         ...
         DC    AL1(DK_TMEBQ+DK_TSAVQ)                                           
         DC    AL1(CLGKAGMD-CLGKEY,L'CLGKAGMD),AL4(0)                           
         DC    AL2(RAGM-WORKD)                                                  
         DC    XL8'00'                                                          
                                                                                
         DC    AL1(DK_TSHEQ)                                                    
         DC    AL1(CLGKID-CLGKEY,L'CLGKID),AL4(EDTGRID)                         
         DC    AL2(0)                                                           
         DC    XL8'00'                                                          
...
CGGKEY   DS    0X                  ** CLIENT GROUP KEY **                       
         ...
         DC    AL1(DK_TSHEQ)                                                    
         DC    AL1(CLGKGRP-CLGKEY,L'CLGKGRP),AL4(EDTGRP)                        
         DC    AL2(0)                                                           
         DC    XL8'00'                                                          
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'018NEDFAR    06/02/20'                                      
         END                                                                    
