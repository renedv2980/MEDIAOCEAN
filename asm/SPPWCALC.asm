*          DATA SET SPPWCALC   AT LEVEL 035 AS OF 05/01/02                      
*PHASE T00A79A                                                                  
*-------------------------------------------------------------------*           
...
DIV2     XC    PDIV,PDIV                                                        
         ...
         CVD   R0,DUB                                                           
         MP    PDIV,DUB            R0 X R1                                      
         SRP   PDIV,1,0            SHIFT LEFT ONE POS                           
         CVD   RF,PDIVSOR                                                       
         DP    PDIV,PDIVSOR                                                     
         SRP   PDIV(8),64-1,5                                                   
         CVB   R1,PDIV             RESULT IN R1                                 
         BR    RE                  AND EXIT                                     
*&&DO                                                                           
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE SPPWBLOCK                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'035SPPWCALC  05/01/02'                                      
         END                                                                    
