*          DATA SET DEWC09I    AT LEVEL 055 AS OF 10/29/15                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEWC09IA                                                                 
         TITLE 'DEMO CONVERSION'                                                
***********************************************************************         
* THIS VERSION IS ONLY VALID FOR DATA PRIOR TO 8/27/12.                         
* THE NEW VERSION IS DEWC13I.                                                   
***********************************************************************         
DEWC09I TITLE '- WB1 COMMERCIAL (ACM) CONVERSION'                               
...
CNVRTN   NMOD1 0,**CNVW**                                                       
         ...
         USING WORKD,R4            R4 = DEWC09I WORK                            
*                                                                               
...
ZDSCT    DSECT                                                                  
       ...
       ++INCLUDE DEDEMTABD                                                      
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'055DEWC09I   10/29/15'                                      
         END                                                                    
