*          DATA SET DENF09I    AT LEVEL 254 AS OF 03/21/14                      
*PROCESS USING(WARN(15))                                                        
*PHASE DENF09IA                                                                 
                                                                                
*---------------------------------------------------------------------*         
* NSS FOX CONVERSION: INPUT PHASE                                     *         
*---------------------------------------------------------------------*         
...
*                                                                               
         ...
         BNE   READ42                                                           
*        CLI   MIREC+H2SCNTI-H2REC,C'1'   THIS FILE SHOULDN'T HAVE              
*        BE    READ20                     SCALED INTABS                         
...
*                                                                               
         ...
         BE    *+10                NSS - NO UNIVS ON TAPE, RD OUR FILE          
         CLC   =C'NSS CUSTOM MIT',B0REPORT                                      
         BE    *+10                NSS - NO UNIVS ON TAPE, RD OUR FILE          
         CLC   =C'FOX SPORTS',B0REPORT                                          
         ...
         L     R1,=A(UNIVSAVE)                                                  
         ST    R1,ASLOT                                                         
         MVI   GOSUBN,RSLOT#       SET DBUFFER AND SAVETIME                     
...
P5R10    BRAS  RE,BKPROC           PROCESS REC 2 DEMOS                          
         ...
         MVI   PRSRC,C'N'                                                       
         MVC   INTKSRC,KEYSRC                                                   
         L     RE,=A(NETTAB)       SET PROPER CALL LETTERS                      
         LA    R0,NETWORKS                                                      
         CLC   INTSTA(4),0(RE)                                                  
         BE    P5R12                                                            
         LA    RE,L'NETTAB(RE)                                                  
         BCT   R0,*-14                                                          
         CLC   INTSTA(4),=C'UPN '   CALL LETTER CHANGE                          
         BE    *+6                                                              
         DC    H'0'                                                             
         MVC   INTSTA,=C'PAR D'                                                 
         BE    *+10                                                             
*                                                                               
P5R12    MVC   INTSTA,4(RE)                                                     
         MVC   PRSTAT,INTSTA                                                    
         MVC   PRBOOK,INTBOOK                                                   
         MVC   PRSTIM,INTSQH                                                    
         MVC   PRDW,INTDAYWK                                                    
...
CNVRTN   NMOD1 0,**CNVW**                                                       
         ...
         USING WORKD,R4            R4 = DENF09I WORK                            
*                                                                               
...
**       DS    CL20        58-77                                                
         DS    CL10        58-67                                                
H2SCNTI  DS    C           68      SCALED COUNT INDICATOR                       
         DS    CL9         69-77                                                
         DS    CL20        58-77                                                
...
*        PRINT OFF                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'254DENF09I   03/21/14'                                      
         END                                                                    
