*          DATA SET RESFM42    AT LEVEL 126 AS OF 04/30/13                      
*PHASE T81842A,*                                                                
*INCLUDE REGENBUC                                                               
...
ACON0210 EQU   *                                                                
         CLI   0(RF),0             END OF RECORD?                               
         BE    ACON0218            YES - NO X'9F' ELT                           
         CLI   0(RF),X'1D'         DARE ELEMENT?                                
         BE    ACON0212            YES                                          
...
ACON0212 EQU   *                                                                
         NI    RCONDRFG-RCONDREL(RF),X'FF'-X'80'                                
*                                  TURN OFF 'LINKED TO AGY ORD' FLAG            
         B     ACON0211            GO GO NEXT ELT                               
ACON0216 EQU   *                                                                
         CLC   =C'ALL',CONREC      ALLHIST REQUEST?                             
         BE    ACON0218            YES - LEAVE SALES ASSISTANT ALONE            
...
*                                  SET ALT CAL FLAGS FOR STATION                
         ...
         CLI   ALTCAL,C'Y'                                                      
         BNE   UPDT0060                                                         
         OI    BUCKFLGS,X'80'      FORCE ALT CALENDAR                           
         DROP  RE                                                               
*                                  SET ALT CAL FLAGS FOR STATION                
UPDT0060 EQU   *                                                                
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'126RESFM42   04/30/13'                                      
         END                                                                    
