*          DATA SET APGHM2AGA  AT LEVEL 028 AS OF 05/01/02                      
*PHASE ACHM2AGA,+0                                                              
...
HK230    DS    0H                                                               
         ...
         B     HK240                                                            
HK237    DS    0H                                                               
*MN      MVC   H2CODE2,H2NSEQ2                                                  
         MVC   H2CODE2,SPACES                                                   
         MVC   H2NAME2,H2NSEQ2                                                  
HK238    DS    0H                                                               
*MN      MVC   H2CODE1,H2NSEQ1                                                  
         MVC   H2CODE1,SPACES                                                   
         MVC   H2NAME1,H2NSEQ1                                                  
...
*        ACGENBOTH                                                              
       ...
       ++INCLUDE ACGENBOTH                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028APGHM2AGA 05/01/02'                                      
         END                                                                    
