*          DATA SET REREP1H0DA AT LEVEL 021 AS OF 05/01/02                      
*PHASE RE1H02A,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
* UPDATE HISTORY                                                    *           
*                                                                   *           
* JUN24/96 (BU ) --- INITIAL ENTRY:  SCAN CONTRACTS, CHECK RECORD   *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
...
INIT0020 EQU   *                                                                
         GOTO1 SEQ                                                              
INIT0040 EQU   *                                                                
         CLI   KEY,X'80'           PASSIVE KEYS?                                
         BNL   INIT0080            YES - FINISHED                               
         BAS   RE,GETCON           RETRIEVE CONTRACT RECORD                     
         CLC   KEY(27),RCONREC     KEY = RECORD?                                
         BE    INIT0049            YES - GO BACK FOR NEXT                       
         MVC   P+1(08),=C'PROBLEM='                                             
         MVC   P+12(27),KEY                                                     
         GOTO1 REPORT                                                           
         B     INIT0049            GO BACK FOR NEXT                             
INIT0049 EQU   *                                                                
         L     RF,PULSECTR                                                      
         LA    RF,1(RF)                                                         
...
INIT0080 EQU   *                                                                
         MVC   P+1(26),=C'CONTRACT SCAN FINISHED   :'                           
         GOTO1 REPORT                                                           
         B     MODEEXIT                                                         
         EJECT                                                                  
...
BRDLEN   EQU   *-BRDSTART                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021REREP1H0DA05/01/02'                                      
         END                                                                    
