*          DATA SET SRPQT00B   AT LEVEL 245 AS OF 05/01/02                      
*PHASE T13400A                                                                  
         TITLE '$RPTEST - GENERATE RP TEST REPORTS'                             
         PRINT NOGEN                                                            
RPTEST   CSECT                                                                  
         NMOD1 WRKX-WRKD,**$PQT**,R9                                            
         USING WRKD,RC                                                          
         ST    R1,APARM                                                         
         L     R2,20(R1)           R2=A(TWA)                                    
         USING SRPQTFFD,R2                                                      
...
GEN4A    MVI   WCTL1,C'1'                                                       
         ...
         EJECT                                                                  
*OOP     LH    R4,WPAG             SET NUM OF PAGES                             
LOOP     LH    R4,=H'1'            SET NUM OF PAGES                             
*OOP1    LH    R5,WLIN             SET NUM OF LINES                             
LOOP1    LH    R5,=H'1'           SET NUM OF LINES                              
         MVC   WCTL,WCTL1                                                       
         CLI   WBA,C'A'                                                         
         BE    LOOP2                                                            
         CLI   SVLTYPE+1,C'C'                                                   
...
*&&UK                                                                           
* FTP TEST                                                                      
         MVC   WDAT,=CL132'    *HDR*EDICT=SJRDEIS             W     '           
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS ACWWTTRN APL,FTPWT'                            
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS      FTP FTPWT   '                             
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132':'                                                   
         BAS   RA,PRINT                                                         
         B     THERE                                                            
...
*&&UK                                                                           
* FAX TEST                                                                      
         MVC   WDAT,=CL132'    *HDR*FAXW 212-633-5779        WP  (212) +        
               633-5779  REPORT  DR'                                            
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS CTZ  TRN REPORT  DR   SENT BY  YYUN  '         
         BAS   RA,PRINT                                                         
*        MVC   WDAT,=CL132'++DDS      DST FAXW 12126336269          (21         
*              ) 633-6269'                                                      
*        BAS   RA,PRINT                                                         
*                                                                               
*&&                                                                             
...
* BDE    TEST                                                                   
*                                                                               
         MVC   WDAT,=CL132'    *HDR*EDICT=*BDE                         +        
                                         '                                      
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS XXXXXTRN                              +        
                                 '                                              
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS      RCP yi.yung@donovandata.com  '            
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS      SUB MQ BDE TEST FOR EDICT '               
         BAS   RA,PRINT                                                         
*                                                                               
*&&UK                                                                           
* E-MAIL TEST                                                                   
         ...
         MVC   WDAT,=CL132'++DDS      RCP YI.YUNG@DONOVANDATA.COM  '            
         BAS   RA,PRINT                                                         
*        MVC   WDAT,=CL132'++DDS      RCP YYUNG01@EXCITE.COM        '           
*        BAS   RA,PRINT                                                         
*        MVC   WDAT,=CL132'++DDS      BCC YYUNN                     '           
*        BAS   RA,PRINT                                                         
*        MVC   WDAT,=CL132'++DDS      RPY YI.YUNG@DONOVANDATA.COM  '            
*        BAS   RA,PRINT                                                         
*        MVC   WDAT,=CL132'++DDS      CCR YYUNN                     '           
*        BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS      SUB MQ E-MAIL TEST FOR EDICT '            
         BAS   RA,PRINT                                                         
*                                                                               
*                                                                               
* FTP TEST                                                                      
         MVC   WDAT,=CL132'    *HDR*EDICT=SJRDEIS            WP  (212) +        
               633-5678  REPORT  DR'                                            
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'++DDS CTZ  TRN REPORT  DR   SENT BY  SDE   T+        
               O  DAVID EISENBERG'                                              
         BAS   RA,PRINT                                                         
*                                                                               
* COL TEST                                                                      
...
*                                                                               
*&&                                                                             
         MVC   WDAT,=CL132'THIS IS A TEST SENT BY DDS.'                         
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'PLEASE IGNORE THIS MESSAGE.'                         
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'YI YUNG       '                                      
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'DONOVAN DATA SYSTEMS'                                
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'(212) 633-5269'                                      
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'12345     12345     12345     12345     1234+        
               5     12345     12345     12345     12345     12345     +        
               12345     12345     12345     12'                                
         BAS   RA,PRINT                                                         
         MVC   WDAT,=CL132'XXXX5     12345     XXXXXX    12345     1234+        
               5    XXXXXXX    XXXXXX    XXXXXX    12XXX     12345     +        
               12345     12345     1XXXXX    12'                                
         BAS   RA,PRINT                                                         
*                                                                               
THERE    MVC   WCTL,WCTL2                                                       
         BCT   R5,LOOP2                                                         
         BCT   R4,LOOP1                                                         
         SPACE 2                                                                
...
* DDCOMFACS                                                                     
       ++INCLUDE DDCOMFACS                                                      
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'245SRPQT00B  05/01/02'                                      
         END                                                                    
