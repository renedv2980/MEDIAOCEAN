*          DATA SET REREP3D02  AT LEVEL 249 AS OF 02/06/09                      
*PHASE RE3D02A                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3D02 - REREP3D02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3D02 - RE3D02 - MEDIA OCEAN DEMO FEED /ABC VERSION         *           
*                                                                   *           
*********************************************************************           
...
RE3D02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3D02,R7,R8,RR=RE                                    
*                                                                               
...
*                                                                               
INPBLOCK DC    X'0A'               NUMSTAS:   10                                
         DC    CL05'KABC '         STATION :  1                                 
         DC    CL05'KFSN '         STATION :  2                                 
         DC    CL05'KGO  '         STATION :  3                                 
         DC    CL05'KTRK '         STATION :  4                                 
         DC    CL05'WABC '         STATION :  5                                 
         DC    CL05'WJRT '         STATION :  6                                 
         DC    CL05'WLS  '         STATION :  7                                 
         DC    CL05'WPVI '         STATION :  8                                 
         DC    CL05'WTVD '         STATION :  9                                 
         DC    CL05'WTVG '         STATION : 10                                 
*********************************************************************           
         DC    X'01'               NUMDPTS                                      
         DC    CL1'Z'              DAYPARTS:  1                                 
**       DC    X'01'               NUMDPTS                                      
...
NUMDEMQ  EQU   (2*NUMCATQ)                                                      
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'249REREP3D02 02/06/09'                                      
         END                                                                    
**  INSERT END  >>                                                              
