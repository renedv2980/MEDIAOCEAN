*          DATA SET REPRO53S   AT LEVEL 005 AS OF 02/13/97                      
*&&      SET   NOP=N                                                            
*PHASE T80A53A                                                                  
...
INITL04  CR    R6,RE                                                            
         ...
         B     INITL04                                                          
*                                                                               
INITL06  MVC   BOWORK2(L'SVSTA1),SVSTA1                                         
         CLI   BOWORK2+4,C' '                                                   
         BNH   *+8                                                              
         MVI   BOWORK2+4,C'T'                                                   
*                                                                               
...
*                                                                               
         ...
         BZ    INITL10             NO DEMO INFO AVAILABLE                       
*                                                                               
...
*                                                                               
INITL10  OI    LSSTAT1,LSSTSAR        LIST OF TSAR RECS                         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005REPRO53S  02/13/97'                                      
         END                                                                    
