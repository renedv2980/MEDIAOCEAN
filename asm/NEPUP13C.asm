*          DATA SET NEPUP13C   AT LEVEL 011 AS OF 05/01/02                      
*          DATA SET NEPUP13    AT LEVEL 011 AS OF 02/26/97                      
...
*                                                                               
         CLI   0(R3),X'00'         IS THERE A NAD CODE?                         
         BE    SHOWPL3                                                          
*                                                                               
         LA    R5,WORK             WORK CONTAINS 9 BYPE HEADING                 
         SR    R1,R1                                                            
NAD001   AHI   R5,1                                                             
         AHI   R1,1                COUNTER                                      
         CLI   0(R5),C'.'          CHECK FOR NAD DEMO END                       
         BNE   NAD001                                                           
*                                                                               
         LA    R5,WORK                                                          
         AR    R5,R1               BUMP UP PAST NAD CODE                        
         AHI   R5,1                                                             
*                                                                               
*        BCTR  R1,0                VARIABLE MVC                                 
         EX    R1,*+8                                                           
         B     *+10                                                             
         MVC   9(0,R4),WORK        YES/SPLIT DISPLAY                            
         MVC   8(6,R2),0(R5)       DEMO INFO INTO HEADING                       
*                                                                               
         B     *+10                                                             
...
FIRSTIN  DS    XL1                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011NEPUP13C  05/01/02'                                      
         END                                                                    
