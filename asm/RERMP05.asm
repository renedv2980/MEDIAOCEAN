*          DATA SET RERMP05    AT LEVEL 045 AS OF 07/06/11                      
*PHASE T81005A                                                                  
*INCLUDE BINSRCH2                                                               
...
* UPDATE HISTORY:                                                    *          
*                                                                    *          
* 01JUL11  (SMYE)--- FIX MINOR ADD BUG IN VK                         *          
*                                                                    *          
*   MAR09  (BOBY)--- NEW INVENTORY RECORD KEY                        *          
*                                                                    *          
...
*                                                                               
         ...
         BE    VK3                                                              
*                                                                               
         CLI   WORK+40,C'1'        VALID SATELLITE?                             
         BE    VK20020             YES - USE IT                                 
         CLI   WORK+40,C'2'        VALID SATELLITE?                             
         BNE   VK3                 NO  - IGNORE VALUE                           
VK20020  EQU   *                                                                
...
*    VALID ENTRIES ARE 'MKT'         FOR MARKET TEXT        C'MKT'    *         
*                OR    'STA'         FOR STATION TEXT       C'STA'    *         
*                OR    IIII          FOR INVENTORY TEXT     X'FFFFFF' *         
...
VK5      CLI   5(R2),0                                                          
         BNE   VK7                                                              
*                                                                               
         XC    SOURCE(20),SOURCE   CLEAR SAVE AREAS                             
*                                                                               
...
*                                                                               
         ...
         BE    VKLSTSRC                                                         
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*        DISPLAY PROGRAM NAME (DSPHDR)                                          
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
         L     RF,AIO2             POINT TO HEADER SAVE AREA                    
         CLC   HDRKEY(RINVKRSR-RINVKEY),0(RF) IF MISSING HDR RECORD             
         BE    VKPGMDSP                                                         
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(RINVKRSR-RINVKEY),HDRKEY - NO SOURCE ETC                     
*                                                                               
         GOTO1 HIGH                READ IN HEADER RECORD                        
*                                                                               
...
*                                                                               
VKNUM10  DS    0H                                                               
         MVC   AIO,AIO2            READ HEADER INTO IO2                         
         GOTO1 GETREC                                                           
*                                                                               
VKPGMDSP DS    0H                                                               
         BRAS  RE,DSPHDR           DISPLAY INV HEADER FIELDS                    
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *         
*                                                                               
         LA    R2,TXTNUMH                                                       
*                                                                               
...
*                                                                               
         ...
         USING RINVKEY,R6                                                       
*                                                                               
         MVC   RINVKEY(RINVKRTP-RINVKEY),HDRKEY REP/STA/INV NO./(ST DT)         
*                                                                               
         GOTO1 HIGH                                                             
*                                                                               
         CLC   RINVKEY,KEYSAVE     IF RECORD FOUND                              
         BNE   VK90                                                             
*                                                                               
         GOTO1 GETREC                 READ IT INTO CORE                         
*                                                                               
...
*                                             MAKE SURE IT'S A HEADER           
         OC    RINVKRTP(L'RINVKEY-(RINVKRTP-RINVKEY)),RINVKRTP                  
         BNZ   VK115                                                            
*                                                                               
...
*****    GOTO1 HIGH                READ IN HEADER RECORD                        
*                                                                               
*****    CLC   KEY(L'RINVKEY),KEYSAVE ERROR IF NOT FOUND                        
*****    BE    *+12                                                             
*****    MVI   ERROR,NOTFOUND                                                   
*****    B     ERREND                                                           
*                                                                               
...
*                                                                               
         MVI   ERROR,INVALID                                                    
*                                                                               
         GOTO1 BOOKVAL,DMCB,(BYTE,(R2)),(1,WORK),(C'B',SCANNER),KFBKTP,X        
               (C'C',ACOMFACS)                                                  
*                                                                               
...
*                                                                               
         ...
         MVC   BYTE,FSRC                                                        
*                                                                               
         GOTO1 BOOKVAL,DMCB,(BYTE,(R2)),(1,WORK),(C'B',SCANNER),FBKTP, X        
               (C'C',ACOMFACS)                                                  
         CLI   DMCB+4,1                                                         
         BNE   ERREND                                                           
*                                                                               
         ...
         BO    ERREND                WHICH MEANS SUPPRESS CPM'S                 
*                                                                               
         MVC   RINVFBKT,WORK       BOOKVAL BITS                                 
         MVC   RINVFBK,WORK+1      BOOK                                         
         MVC   RINVFBTP,FBKTP      BOOK TYPE                                    
*                                                                               
         MVC   FBKBITS,WORK        BOOKVAL BITS                                 
...
*                                                                               
         ...
         MVC   SOURCE,RINVKRSR                                                  
*                                                                               
         CLI   RINVKRTP,X'FF'      SKIP IF RATIONALE RECORD                     
         BE    DK30                                                             
*                                                                               
         MVC   8(3,R2),=C'MKT'                                                  
*                                                                               
...
*                                                                               
*        READ INV HEADER INTO AIO2                                              
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(RINVKRSR-RINVKEY),RINVKEY  INV HDR KEY                       
*                                                                               
         GOTO1 HIGH                                                             
*                                                                               
         CLC   KEY(L'RINVKEY),KEYSAVE SKIP IF HDR NOT FOUND                     
         BNE   DK40                                                             
*                                                                               
         MVC   AIO,AIO2            READ INTO AIO2                               
         GOTO1 GETREC              GET INV HEADER RECORD                        
*                                                                               
         BRAS  RE,DSPHDR           DISPLAY HEADER FIELDS                        
*                                                                               
...
*                                                                               
         ...
         DROP  R6                                                               
         EJECT                                                                  
         TITLE 'RERMP05 - TEXT RECORD - LIST'                                   
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         USING RINVKEY,R4                                                       
*                                                                               
         MVI   RINVKTYP,RINVKTYQ   SET RECORD ID                                
         ...
         MVC   RINVKRSR,CPYFTYP    SET FROM TEXT TYPE                           
...
*                                                                               
         ...
         MVC   RINVKRSR,CPYTTYP    SET TO TEXT TYPE                             
...
*                                                                               
         ...
         BNE   FMTBKERR                                                         
*                                                                               
         MVC   WORK+10(L'WORK-10),SPACES                                        
         MVC   WORK+10(1),GSOQLF   BOOK QUALIFIER                               
*                                                                               
         LA    R3,WORK+10          START OF OUTPUT                              
*                                                                               
...
*                                                                               
         ...
         LA    R1,MONTH(R1)                                                     
         MVC   0(3,R3),0(R1)                                                    
         CLC   =C'ST ',0(R3)       IF SPECIAL ESTIMATE BOOK                     
         BNE   *+6                                                              
         BCTR  R3,0                   RECTIFY COUNT                             
         LA    R3,3(R3)                                                         
*                                                                               
         SR    R1,R1                                                            
...
*                                                                               
         CLI   GSIBKTYP,C' '       SKIP IF NO BOOK TYPE                         
         BE    FMTBOOKX                                                         
         CLI   GSIBKTYP,0          SKIP IF NO BOOK TYPE                         
         BE    FMTBOOKX                                                         
*                                                                               
         GOTO1 GETBTYPE,DMCB,(GSIBKTYP,0)                                       
         CLI   DMCB,0                                                           
         BE    FMTBOOKX                                                         
...
****************************************************************                
*                                                              *                
*        DISPLAY INVENTORY HEADER FIELDS                       *                
*                                                              *                
*NTRY    AIO2 ==> INV HEADER RECORD                            *                
*                                                              *                
****************************************************************                
         SPACE 1                                                                
DSPHDR   NTR1  BASE=*,LABEL=*                                                   
*                                                                               
*        CLEAR HEADER FIELDS                                                    
*                                                                               
         LA    R2,TXTPGM1H         PROGRAM FIELDS                               
         BRAS  RE,CLEAR                                                         
         LA    R2,TXTPGM2H         PROGRAM FIELDS                               
         BRAS  RE,CLEAR                                                         
         LA    R2,TXTMOREH         MORE FIELD                                   
         BRAS  RE,CLEAR                                                         
*                                                                               
         MVC   TXTPGM1,SPACES      INIT FIELD                                   
         MVI   TXTPGM1H+5,L'TXTPGM1 LENGTH                                      
         MVC   TXTPGM2,SPACES      INIT FIELD                                   
         MVI   TXTPGM2H+5,L'TXTPGM2 LENGTH                                      
         MVC   TXTMORE,SPACES      INIT FIELD                                   
         MVI   TXTMOREH+5,L'TXTMORE LENGTH                                      
*                                                                               
*        DISPLAY PROGRAM TITLES                                                 
*                                                                               
DHPGM    DS    0H                                                               
*                                                                               
         LA    R2,TXTPGM1H         POINT TO PROGRAMMING FIELD                   
*                                                                               
         L     R6,AIO2                                                          
         MVI   ELCODE,X'03'        FIND PROGRAM ELEMENT                         
         BRAS  RE,GETEL                                                         
         JNE   DHPGMX                 NONE FOUND                                
*                                                                               
         USING RIPGELEM,R6         ESTABLISH PROGRAM ELEMENT                    
*                                                                               
         LLC   RF,RIPGLEN          GET ELEMENT LENGTH                           
         SHI   RF,2                DHOP CODE AND LENGTH BYTES                   
         BZ    DHPGM1X             SKIP IF NO PROGRM TITLE LEFT                 
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   8(0,R2),RIPGNAME    DISPLAY PROGRAM NAME                         
*                                                                               
         OI    6(R2),X'80'         FORCE TRANSMISSION                           
*                                                                               
DHPGM1X  DS    0H                                                               
*                                                                               
         LA    R2,TXTPGM2H         POINT TO PROGRAMMING FIELD                   
*                                                                               
         BRAS  RE,NEXTEL           FIND NEXT PROGRAM TITLE ELEMENT              
         JNE   DHPGMX                 NONE FOUND                                
*                                                                               
         USING RIPGELEM,R6         ESTABLISH PROGRAM ELEMENT                    
*                                                                               
         LLC   RF,RIPGLEN          GET ELEMENT LENGTH                           
         SHI   RF,2                DHOP CODE AND LENGTH BYTES                   
         BZ    DHPGM2X             SKIP IF NO PROGRM TITLE LEFT                 
*                                                                               
         STC   RF,5(R2)            SET INPUT LENGTH                             
*                                                                               
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
...
*                                                                               
         ...
         JNE   DHPGMX                 NONE FOUND                                
*                                                                               
         LA    R2,TXTMOREH         POINT TO MORE FIELD                          
*                                                                               
         MVI   8(R2),C'+'          SET MORE TITLES AVAILABLE IND                
         MVI   5(R2),1             SET FIELD LENGTH                             
         OI    6(R2),X'80'         FORCE TRANSMISSION                           
*                                                                               
         B     DHPGMX                                                           
*                                                                               
...
*                                                                               
         XC    KEY,KEY                                                          
         MVC   KEY(L'RINVKEY),RINVKEY     COPY TEXT RECORD KEY                  
*                                                                               
         MVC   AIO,AIO2            DO INVENTORY STUFF IN IO2                    
*                                                                               
         LA    R5,KEY              POINT TO KEY BUILD AREA                      
         XC    RINVKRTP(L'RINVKEY-(RINVKRTP-RINVKEY)),RINVKRTP                  
*                                                                               
         MVC   RINVKRSR,FSRC       IF FILTER SOURCE, USE IT                     
*                                                                               
         GOTO1 HIGH                                                             
*                                                                               
XR20     CLC   RINVKEY(RINVKRTP-RINVKEY),KEYSAVE                                
...
*        FILTER ON BOOK                                                         
*                                                                               
         CLC   RINVKRSR,FSRC       MATCH ON RATING SERVICE                      
         BNE   *+10                                                             
         CLC   RINVKDSR,FDSRC      MATCH ON DATA   SOURCE                       
         BNE   *+10                                                             
         CLC   RINVKQLF,FBKBITS    MATCH ON QUALIFIER                           
         BNE   *+10                                                             
         CLC   RINVKBTP,FBKTP      MATCH ON BOOK TYPE                           
         BNE   XR100                                                            
*                                                                               
...
LR5      LA    R6,KEY                                                           
         USING RINVKEY,R6                                                       
*                                                                               
         OC    RINVKEY,RINVKEY     TEST FIRST TIME THROUGH                      
         BNZ   LR10                                                             
*                                                                               
         MVI   RINVKTYP,RINVKTYQ                                                
         MVC   RINVKREP,AGENCY                                                  
...
LR10     GOTO1 HIGH                                                             
*                                                                               
LR15     CLC   RINVKEY(RINVKINV-RINVKEY),SAVEKEY  CORRECT REP AND STA           
         BNE   LRXIT                                                            
*                                                                               
         CLI   RINVKRSR,C'M'       ONLY WANT TEXT - MARKET                      
         BE    LR20                                                             
*                                                                               
         CLI   RINVKRSR,C'S'       STATION                                      
         BE    LR20                                                             
*                                                                               
         CLI   RINVKRSR,X'FF'      OR INVENTORY TEXT                            
         BNE   LR200                                                            
*                                                                               
LR20     CLI   SOURCE,0            OKAY IF NO SOURCE                            
         BE    LR30                                                             
*                                                                               
         CLC   RINVKRSR,SOURCE     SOURCE MUST MATCH                            
         BNE   LRXIT                                                            
*                                                                               
         CLI   SOURCE,X'FF'                                                     
         BNE   LR30                                                             
*                                                                               
         ...
         BZ    LR30                NO                                           
*                                                                               
         CLC   RINVKINV,INVNO      SKIP IF NO INVENTORY # MATCH                 
         BNE   LRXIT                                                            
*                                                                               
         OC    DATE,DATE           OKAY IF NO DATE ENTERED                      
         BZ    LR30                                                             
*                                                                               
         CLC   RINVKSTD,DATE       SKIP IF DATE DOESN'T MATCH                   
         BNE   LRXIT                                                            
*                                                                               
...
LR50     OC    KFLOC,KFLOC         LOCAL TEXT ONLY FILTER                       
         BZ    LRLOCX                                                           
*                                                                               
         CLI   KFLOC,C'Y'          Y=ONLY LOCAL, N=EXCLUDE LOCAL                
         BE    LRLOC1                                                           
*                                                                               
         CLI   RINVFLOC,0                                                       
         BE    LRLOCX                                                           
...
FDSRC    DS    CL1                 FILTER DATA SOURCE FROM RECORD               
...
CPYFDSRC DS    CL1                 FROM DATA SOURCE                             
...
GSIBITS  DS    CL1                 RINVKSRC FOR KEY                             
...
*                                                                               
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045RERMP05   07/06/11'                                      
         END                                                                    
