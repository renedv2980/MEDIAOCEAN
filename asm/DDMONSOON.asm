*          DATA SET DDMONSOON  AT LEVEL 034 AS OF 05/28/03                      
*                                                                               
* THIS PROGRAM IS NO LONGER USED IN US.                                         
* THIS PROGRAM IS SPLIT INTO 2 PROGRAMS.                                        
* 1) DDMONSTER - MAIN JOB SCHEDULER                                             
* 2) DDMONSTM1 - ASCH JOB THAT RUN THE SOON REQUEST                             
*                                                                               
*                                                                               
*PHASE MONSOONA                                                                 
*INCLUDE BINSRCH2                                                               
...
*                                                                               
ATT35    BRAS  RE,EXTJCLFL         EXTRACT DATA (TMPFILE -> JCLBUF)             
         BNE   ATT36               BAD JCL                                      
         BRAS  RE,GETJCL           EXTRACT DATA (JCLBUF -> SYSIN)               
         BE    ATT40               JCL IS OK                                    
ATT36    MVC   OPMS1(7),=C'BAD*JCL'                                             
         GOTO1 =V(LOGIO),DMCB,X'FF000001',(L'OPMS1,OPMS1)                       
         B     ATT160              JCL ERROR                                    
*                                                                               
ATT40    L     RE,=A(JCLBUF)       CLEAR JCLBUF FOR 2ND STEP INPUT              
         LA    RF,MAXRECQ*(L'JCLBUF)                                            
         XCEFL                                                                  
*                                                                               
...
*                                                                               
         ...
         BNZ   ATT132              TASK ABENDED                                 
*                                                                               
         CLI   OPERKILL,C'Y'       OPERATOR WANT TO KILL THIS REQUEST?          
         BE    ATT140              NEVER MIND THE 2ND STEP                      
         TM    REQFLAGS,REQ2STEP   REQUEST HAS 2ND EXEC STEP?                   
         BNO   ATT140              NO MORE EXEC STEP                            
         PRNT  CONTINUE_NXT_STEP,PRINT=ALWAYS                                   
         BRAS  RE,NXTSTEP          GET NEXT STEP JCLFILE                        
         BE    ATT35               NEXT EXEC STEP                               
         B     ATT36               BAD JCL ERROR                                
*                                                                               
ATT132   SR    RF,RF                                                            
...
*                                                                               
ATT140   L     R1,TOTREQS          INCREMENT TOTAL NUMBER OF REQUESTS           
         LA    R1,1(R1)                                                         
         ST    R1,TOTREQS                                                       
*                                                                               
...
WRTJCLFL NTR1  BASE=*                                                           
*                                                                               
* A) IF REQUEST IS NOT IN JCLFILE YET                                           
...
*          II) SET REQ2STEP OFF                                                 
*                                                                               
* B) IF REQUEST IS ALREADY IN JCLFILE                                           
*    2) IF REQ2STEP ON                                                          
*          I)  COPY JCLFILE TO TMPFILE ONLY                                     
*    3) IF REQ2STEP OFF                                                         
*          I)  COPY JCLFILE TO JCLBUF IN CORE                                   
*                                                                               
*                                                                               
         MVC   AJCLBUF,=A(JCLBUF)                                               
*                                                                               
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
WJA10    GOTO1 =V(DATAMGR),DMCB,(0,=C'READ'),CFPQID,0,R,CXREC                   
         CLI   DMCB+8,0                                                         
         BNE   WJA30               NO MORE RECORDS                              
*                                                                               
...
*                                                                               
         ...
         BO    WJA50               YES - DON'T COPY TO JCLBUF                   
*                                                                               
         L     RE,=A(JCLBUF)       CLEAR JCLBUF                                 
         LA    RF,MAXRECQ*(L'JCLBUF)                                            
         XCEFL                                                                  
*                                                                               
         L     R3,=A(JCLBUF)                                                    
WJA40    GET   TMPFILE,CARD                                                     
         PUT   JCLFILE,CARD                                                     
         CLI   0(R3),X'FF'                                                      
         BNE   *+6                                                              
...
*                                                                               
         TM    REQFLAGS,REQ2STEP   HAS 2ND JCLFILE?                             
         BO    WJB40               YES - COPY TO TMPFILE ONLY                   
*                                  NO  - COPY TO JCLBUF ONLY                    
*                                                                               
         L     RE,=A(JCLBUF)       CLEAR JCLBUF                                 
         LA    RF,MAXRECQ*(L'JCLBUF)                                            
         XCEFL                                                                  
...
*                                                                               
         TM    REQFLAGS,REQ2STEP   HAS 2ND JCLFILE?                             
         BNO   EJOKX               NO - SYSIN CARDS ALREADY IN JCLBUF           
*                                                                               
         L     RE,=A(JCLBUF)       CLEAR JCLBUF                                 
         LA    RF,MAXRECQ*(L'JCLBUF)                                            
         XCEFL                                                                  
...
EJ120    CLOSE (TMPFILE,)                                                       
         ...
         DC    H'0'                                                             
*                                                                               
EJBADX   LTR   RB,RB               SET CC NOT EQUAL                             
         B     EJX                                                              
*                                                                               
EJOKX    CR    RB,RB               SET CC EQUAL                                 
*                                                                               
EJX      XIT1                                                                   
         SPACE 2                                                                
         LTORG                                                                  
...
NXTSTEP  NTR1  BASE=*                                                           
*                                                                               
* JCLFILE2 - JCL OF STEPS LEFT TO BE RAN                                        
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
NSBADX   LTR   RB,RB               SET CC NOT EQUAL                             
         B     NSX                                                              
*                                                                               
NSOKX    CR    RB,RB               SET CC EQUAL                                 
*                                                                               
NSX      XIT1                                                                   
         SPACE 2                                                                
         LTORG                                                                  
...
GJ150    MVC   CARD,SPACES                                                      
         ...
         GOTO1 =V(PRINTER)                                                      
*                                                                               
GJ151    MVC   CARD,SPACES                                                      
         MVC   CARD(8),=C'DUMP=YES'  ALWAYS PRINT THE SYS DUMP                  
         PUT   SYSIN,CARD                                                       
         CLI   TRACEFLG,C'Y'       PRINT DETAILED TRACE?                        
         BNE   GJ152               NO                                           
         MVC   P(80),CARD                                                       
...
*&&                                                                             
         ...
         B     GJ190                                                            
*                                                                               
GJ165    CLC   =C'DIRECT=',R       IS THIS THE DIRECT= CARD?                    
         BNE   GJ170                                                            
...
*                                                                               
         ANSR                                                                   
*                                                                               
GETJCLR  CLI   0(R3),X'FF'                                                      
         BE    GJBADX              END OF JCLBUF BEFORE GOT ALL INFO            
         MVC   R(80),0(R3)                                                      
         AHI   R3,L'JCLBUF                                                      
         BR    R7                                                               
         EJECT                                                                  
SYSIN    DCB   DDNAME=SYSIN,MACRF=PM,DSORG=PS,RECFM=FB,LRECL=80,       +        
               BLKSIZE=800                                                      
         SPACE 2                                                                
...
TIOT     DSECT                                                                  
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034DDMONSOON 05/28/03'                                      
         END                                                                    
