*          DATA SET GEFIL00S   AT LEVEL 022 AS OF 08/29/00                      
*PHASE T00AB0A                                                                  
...
*                                                                               
         ...
         BCT   RF,SWC04                                                         
*                                                                               
         L     RE,ASYSLST          SYSTEM NOT AUTHORISED                        
         LA    RE,6(RE)                                                         
...
***********************************************************************         
         ...
         PUSH  USING                                                            
         USING GUIDD,RTWORK                                                     
GUID     MVC   GUIDKEY,IOKEY       SAVE CURRENT KEY                             
         LA    R2,IOKEY                                                         
         USING CTIREC,R2                                                        
         XC    CTIKEY,CTIKEY                                                    
...
X        USING FRRRECD,IOKEY                                                    
         ...
         BZ    GTRC02                                                           
*                                                                               
         XC    X.FRRKEY,X.FRRKEY   TRY CONNECTED COUNTRY                        
         MVI   X.FRRKMIN,FRRKMINQ  AND TEST PHASE                               
         ...
         BE    GTRC06                                                           
*                                                                               
GTRC02   XC    X.FRRKEY,X.FRRKEY   TRY CONNECTED COUNTRY                        
         MVI   X.FRRKMIN,FRRKMINQ  AND LIVE PHASE                               
         MVI   X.FRRKTYP,FRRKTYPQ                                               
         MVC   X.FRRKSYS,RTFULL    SYSTEM                                       
         MVC   X.FRRKPRG,RTFULL+1  PROGRAM                                      
         MVC   X.FRRKREC,RTFULL+2  RECORD NUMBER                                
...
*                                                                               
         ...
         BZ    GTRC04                                                           
*                                                                               
         XC    X.FRRKEY,X.FRRKEY   TRY HOST PROCESSOR                           
         MVI   X.FRRKMIN,FRRKMINQ  AND TEST PHASE                               
         MVI   X.FRRKTYP,FRRKTYPQ                                               
         MVC   X.FRRKSYS,RTFULL    SYSTEM                                       
         MVC   X.FRRKPRG,RTFULL+1  PROGRAM                                      
         ...
         BE    GTRC06                                                           
*                                                                               
GTRC04   XC    X.FRRKEY,X.FRRKEY   TRY HOST PROCESSOR                           
         MVI   X.FRRKMIN,FRRKMINQ  AND LIVE PHASE                               
         MVI   X.FRRKTYP,FRRKTYPQ                                               
         MVC   X.FRRKSYS,RTFULL    SYSTEM                                       
         MVC   X.FRRKPRG,RTFULL+1  PROGRAM                                      
         ...
         J     EXITL                                                            
*                                                                               
GTRC06   L     R1,=AL4(XOGET+XOGENFIL+XIO1)                                     
         GOTOX ('XIO',AGROUTS)                                                  
         JE    *+6                                                              
...
X        USING FRARECD,IOKEY                                                    
         ...
         BZ    GTAC02                                                           
*                                                                               
         XC    X.FRAKEY,X.FRAKEY   TRY CONNECTED COUNTRY                        
         MVI   X.FRAKMIN,FRAKMINQ  AND TEST PHASE                               
         ...
         BE    GTAC06                                                           
*                                                                               
GTAC02   XC    X.FRAKEY,X.FRAKEY   TRY CONNECTED COUNTRY                        
         MVI   X.FRAKMIN,FRAKMINQ  AND LIVE PHASE                               
         MVI   X.FRAKTYP,FRAKTYPQ                                               
         MVC   X.FRAKSYS,RTFULL    SYSTEM                                       
         MVC   X.FRAKPRG,RTFULL+1  PROGRAM                                      
         MVC   X.FRAKREC,RTFULL+2  RECORD NUMBER                                
...
*                                                                               
         ...
         BZ    GTAC04                                                           
*                                                                               
         XC    X.FRAKEY,X.FRAKEY   TRY HOST PROCESSOR                           
         MVI   X.FRAKMIN,FRAKMINQ  AND TEST PHASE                               
         MVI   X.FRAKTYP,FRAKTYPQ                                               
         MVC   X.FRAKSYS,RTFULL    SYSTEM                                       
         MVC   X.FRAKPRG,RTFULL+1  PROGRAM                                      
         ...
         BE    GTAC06                                                           
*                                                                               
GTAC04   XC    X.FRAKEY,X.FRAKEY   TRY HOST PROCESSOR                           
         MVI   X.FRAKMIN,FRAKMINQ  AND LIVE PHASE                               
         MVI   X.FRAKTYP,FRAKTYPQ                                               
         MVC   X.FRAKSYS,RTFULL    SYSTEM                                       
         MVC   X.FRAKPRG,RTFULL+1  PROGRAM                                      
         ...
         B     EXITL                                                            
*                                                                               
GTAC06   L     R1,=AL4(XOGET+XOGENFIL+XIO1)                                     
         GOTOX ('XIO',AGROUTS)                                                  
         BE    *+6                                                              
         DC    H'0'                BAD RECORD ON GENDIR                         
*                                                                               
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'022GEFIL00S  08/29/00'                                      
         END                                                                    
