*          DATA SET SCHT5BA    AT LEVEL 020 AS OF 10/02/00                      
*PHASE T31C5BA                                                                  
...
*                                                                               
         LA    R2,COMMEDH          MEDIA                                        
         TM    4(R2),X'80'         CHANGED THIS FIELD                           
         BZ    *+8                                                              
         OI    MYFLAG,CHGKEY                                                    
*                                                                               
...
ESTLEV   EQU   X'40'                                                            
CLTLEV   EQU   X'20'                                                            
CHGKEY   EQU   X'10'               USER CHANGED A KEY FIELD                     
*                                                                               
*                                                                               
         PRINT OFF                                                              
         SPACE 1                                                                
...
LSTEST   DS    CL3                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020SCHT5BA   10/02/00'                                      
         END                                                                    
