*          DATA SET APGHFIEZA  AT LEVEL 070 AS OF 09/16/15                      
*PHASE ACHFEZAA                                                                 
...
*        ACGENBOTH                                                              
       ...
       ++INCLUDE ACGENBOTH                                                      
         PRINT   ON                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'070APGHFIEZA 09/16/15'                                      
         END                                                                    
