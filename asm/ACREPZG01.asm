*          DATA SET ACREPZG01  AT LEVEL 002 AS OF 03/02/00                      
*PHASE ACZG01A,+0                                                               
...
*                                                                               
         ACDEF SPROG,0                                                          
         ACDEF H1,2,RUN                                                         
         ACDEF H1,070,C'ZENITH FILE UPLOAD'                                     
         ACDEF H2,143,PAGE                                                      
*                                                                               
         ACDEF H5,004,C'ZENITH'                                                 
         ACDEF H6,003,C'CLI'                                                    
         ACDEF H7,003,C'CODE'                                                   
         ACDEF H6,008,C'PRD'                                                    
         ACDEF H7,008,C'CODE'                                                   
...
*                                                                               
         ACDEF SPROG,1                                                          
         ACDEF H1,2,RUN                                                         
         ACDEF H1,055,C'ZENITH FILE UPLOAD'                                     
         ACDEF H2,143,PAGE                                                      
*                                                                               
         ACDEF H5,003,C'AGN'                                                    
         ACDEF H6,003,C'CLI'                                                    
...
*                                                                               
         ACDEF SPROG,2                                                          
         ACDEF H1,2,RUN                                                         
         ACDEF H1,045,C'ZENITH FILE UPLOAD'                                     
         ACDEF H2,143,PAGE                                                      
*                                                                               
         ACDEF H5,003,C'AGN'                                                    
         ACDEF H6,003,C'CLI'                                                    
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002ACREPZG01 03/02/00'                                      
         END                                                                    
