*          DATA SET DDREFUSEA  AT LEVEL 037 AS OF 06/05/98                      
**********************************************************************          
...
CKUSER   CLC   =C'USERID=',CARD                                                 
         ...
         B     NXTCARD                                                          
*                                                                               
*-----------------> TYPE CARD FILTERS ON RECORD TYPE (COPY/CHANGE/ADD)          
CKTYPE   CLC   =C'TYPE=',CARD                                                   
         BNE   CKSYSIN                                                          
         LA    R2,CARD                                                          
         GOTO1 =V(SCANNER),DMCB,(C'C',(R2)),SCANBOX                             
         CLI   DMCB+4,0            ERROR                                        
         ...
         DC    H'0'                                                             
         MVI   RECTYPE,1                                                        
         CLC   =C'COPY',22(R2)     COPIES ONLY?                                 
         BE    NXTCARD                                                          
         MVI   RECTYPE,2                                                        
         CLC   =C'CHANGE',22(R2)   CHANGES ONLY?                                
         BE    NXTCARD                                                          
         MVI   RECTYPE,3                                                        
         CLC   =C'ADD',22(R2)      ADDS ONLY?                                   
         BE    NXTCARD                                                          
         DC    H'0'                                                             
*                                                                               
...
SI10     CLI   1(R2),X'06'         6 DIGITS?                                    
         ...
         B     NXTCARD                                                          
*                                                                               
*-----------------> TRNAMT CARD FILTERS ON TRANSACTION AMOUNT                   
CKTRNAMT CLC   =C'TRNAMT=',CARD                                                 
         ...
         DC    H'0'                                                             
*                                                                               
         CLC   =C'ALL',22(R2)      ALL TRANSACTIONS                             
         MVC   TRANAMT(3),=C'ALL'                                               
         B     NXTCARD                                                          
*                                                                               
         ZIC   R3,1(R2)            LENGTH                                       
...
TTRN05   CLI   0(R5),TRNELQ        X'44' TRANS ELEM                             
         ...
         B     TTRN05                                                           
         USING TRNELD,R5                                                        
TTRN10   CLC   =C'ALL',TRANAMT                                                  
         BE    OUTREC              ALL TRANSACTIONS                             
         CP    TRANAMT,TRNAMNT                                                  
         BNE   IN2                                                              
         B     OUTREC                                                           
         DROP  R5,R6                                                            
...
RDATALNQ EQU   2000                                                             
       ...
       ++INCLUDE ACGENFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'037DDREFUSEA 06/05/98'                                      
         END                                                                    
