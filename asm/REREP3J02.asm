*          DATA SET REREP3J02  AT LEVEL 164 AS OF 10/24/05                      
*          DATA SET REREP3J02  AT LEVEL 109 AS OF 07/17/97                      
*PHASE RE3J02A,*                                                                
         TITLE 'RE3J02 - REREP3J02 - LOTUS INTERFACE TAPE'                      
**********************************************************************          
...
* UPDATE HISTORY:                                                   *           
*                                                                   *           
* FEB09/05 (BU ) --- INITIAL ENTRY (FROM 3K02)                      *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
*                                                                   *           
...
RTOTLIST DC    AL4(ABSGROS),AL4(RTOTABGR)                                       
         ...
         LTORG                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'164REREP3J02 10/24/05'                                      
         END                                                                    
