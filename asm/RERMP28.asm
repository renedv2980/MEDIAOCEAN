*          DATA SET RERMP28    AT LEVEL 139 AS OF 05/19/09                      
*PHASE T81028C                                                                  
*INCLUDE REGETKSRC                                                              
*INCLUDE RECUP                                                                  
...
VRX      DS    0H                                                               
*                                                                               
*        TCOPY COPIES TRACKS TO UP TO 5 STATIONS.  THEREFORE,                   
*        LOCK STATIONS IF SOON PROCESSING. THIS PERMITS TCOPY                   
*        TO TAKE ADVANTAGE OF THE EXISTING LOCKS INSTALLED FOR                  
*        OTRANS SOON PROCESSING.                                                
*                                                                               
...
*                                                                               
         L     R5,DMCB             A(LOCKET)                                    
*                                                                               
         LA    R3,TOTABLE          POINT TO TABLE OF STATIONS                   
         USING TOTABLED,R3         ESTABLISH STATION LIST ENTRY                 
*                                                                               
VRLOCKLP DS    0H                                                               
*                                                                               
         OC    TOSTA,TOSTA         DONE AT END OF LIST                          
         BZ    VRLOCKDN                                                         
*                                                                               
         MVC   LOCKKEY(5),TOSTA    SET CALL LETTERS                             
*                                                                               
         GOTO1 (R5),DMCB,('LKLOCKQ',LKKEYD),(R6),0                              
*                                                                               
         CLI   DMCB+4,0            ANY ERRORS                                   
         BNE   VRLCKMSG            LOCK INVENTORY (??)                          
*                                                                               
VRLOCKCN DS    0H                                                               
*                                                                               
         LA    R3,TOTABLEL(R3)     NEXT STATION IN LIST                         
         B     VRLOCKLP                                                         
*                                                                               
         DROP  R3                                                               
*                                                                               
...
*                                                                               
         LA    R3,TOTABLE          POINT TO STATION LIST                        
         USING TOTABLED,R3         ESTABLISH STATION LIST ENTRY                 
*                                                                               
VRUNLKLP DS    0H                                                               
*                                                                               
...
*                                                                               
         ...
         BE    VRUNLKDN                                                         
*                                                                               
         MVC   CSTAT,TOSTA         SET CALL LETTERS                             
*                                                                               
...
*                                                                               
         CLI   TOSTA+4,C'T'        SKIP IF MEDIA T OR BLANK                     
         BE    *+8                                                              
         CLI   TOSTA+4,C' '                                                     
         BNH   *+18                                                             
...
*                                                                               
         LA    R2,ITC1STAH         CURSOR TO STATION FIELD                      
*                                                                               
...
*                                                                               
         ...
         BE    PR600               WE'RE DONE                                   
*                                                                               
         L     R4,AFROMTAB         ESTABLISH FROM TABLE                         
         USING FROMTABD,R4                                                      
*                                                                               
         MVI   COUNTER,0                                                        
*                                                                               
...
*                                                                               
         ...
         BE    *+12                         YES                                 
         MVI   STARTKEY,XFF        NO - END OF FROM TABLE                       
         B     PR200                                                            
*                                                                               
...
*                                                                               
         LA    RF,FRINVTB          INVENTORY # TABLE                            
*                                                                               
         LA    R2,ITCFINVH         POINT TO INVENTORY # FIELD                   
*                                                                               
         CLC   RINVKINV,ITCFINV    SAME INVENTORY NUMBER?                       
         BNE   PR055               NO - SKIP TO NEXT RECORD                     
*                                                                               
...
*                                                                               
PR090    DS    0H                                                               
         OC    RINVKRTP,RINVKRTP   HEADER RECORD?                               
         BZ    PR055                  YES - SKIP TO NEXT RECORD                 
*                                                                               
         CLI   FRCPYTXT,C'N'        IF NOT COPYING TEXT RECORDS?                
         BNE   PR092                                                            
*                                                                               
         CLI   RINVKRTP,XFF            SKIP TEXT RECORDS                        
         BE    PR055                                                            
         B     PR095                                                            
*                                                                               
PR092    CLI   RINVKRTP,XFF         YES - ADD RECORD IN FROM TABLE              
         BE    PR100                                                            
*                                                                               
...
*                                                                               
         ...
         BZ    PR095A              NO                                           
*                                                                               
         CLC   TRKSRCF,RINVKRSR     SAME SOURCE?                                
         BNE   PR055                                                            
         B     PR100                                                            
*                                                                               
...
*                                                                               
         USING TRCKTBLD,R5         ESTABLISH TRACK TABLE                        
*                                                                               
PR095B   DS    0H                                                               
*                                                                               
         CLC   TRKSRCF,RINVKRSR    MATCH SOURCE TO FILTER SOURCE                
         BNE   PR096                                                            
*                                                                               
         CLI   TRCTFLGS,ONEBOOK    IF ONLY ONE BOOK FILTER HERE?                
         BNE   *+14                                                             
         CLC   TRCTQLF,RINVKQLF       MATCH ON QUALIFIER                        
         BNE   PR096                                                            
*                                                                               
         CLC   RINVKBK,TRCTSBK     < START BOOK?                                
         BL    PR096                YES                                         
         CLC   RINVKBK,TRCTEBK     > END BOOK?                                  
         BH    PR096                YES                                         
*                                                                               
         B     PR100               INVREC PASSES FILTERS                        
*                                                                               
PR096    LA    R5,TRCTLNGQ(R5)                                                  
         BCT   R3,PR095B                                                        
         B     PR055                                                            
*                                                                               
         DROP  R5,R6                                                            
...
*                                                                               
         LA    R6,KEY                                                           
         USING RINVREC,R6                                                       
*                                  FILL IN FROM BOOK ENTRY                      
         MVC   FTINV,RINVKINV      INV #                                        
         MVC   FTSTD,RINVKSTD      EFFECTIVE DATE                               
         MVC   FTRSR,RINVKRSR      RATING SOURCE                                
         MVC   FTDSR,RINVKDSR      DATA SOURCE                                  
         MVC   FTQLF,RINVKQLF      QUALIFIER - INTERNAL                         
         MVC   FTBTP,RINVKBTP      BOOK TYPE                                    
         MVC   FTBK_TXT,RINVKBK    BOOK/TEXT NUMBER                             
*                                                                               
         DROP  R6                                                               
*                                                                               
         ZIC   R1,COUNTER                                                       
...
*                                                                               
         CLC   FTINV,PRVFTKEY+(FTINV-FROMTABD)   CHANGE IN INV#                 
         BNE   PR325P                                                           
*                                                                               
         CLC   FTSTD,PRVFTKEY+(FTSTD-FROMTABD)   OR EFF DATE - SEPARATE         
         BNE   PR325P                                                           
*                                                                               
         B     PR325X                                                           
*                                                                               
...
*&&                                                                             
*                                                                               
         L     R1,TOADDR           ESTABLISH TO RECS TABLE                      
         USING TOTABLED,R1                                                      
*                                                                               
...
*                                                                               
         ...
         LA    R2,1(R2,R1)                                                      
*                                                                               
PR345    CLI   FTRSR,0             CHECK IF "TO" RECORD IS A HEADER,            
         BE    PR360                                                            
*                                                                               
...
*                                                                               
         MVC   INBLOCK(1),FTRSR    RATIN G SOURCE                               
         MVC   INBLOCK+2(1),FTQLF  BOOKVAL BITS                                 
         MVC   INBLOCK+3(1),FTBTP  BOOK TYPE                                    
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'B',INBLOCK),OTBLOCK,ACOMFACS                    
         CLI   DMCB+4,0                                                         
         BNE   INVLFLD                                                          
*                                                                               
         MVC   TRKQUALF,OBLOCK+1   QUALIFIER TRANSLATION                        
*                                                                               
         MVC   TMPSRC,=C'NSI'      FORCE NEILSEN RATING SOURCE                  
         MVC   0(3,R2),TMPSRC                                                   
         LA    R2,3(R2)                                                         
         MVC   TMPRSR,TMPSRC                                                    
*                                                                               
         BAS   RE,INSCOMMA                                                      
*                                                                               
         CLI   TRKQUALF,C' '       IF QUALIFIER NON-BLANK                       
         BE    *+14                                                             
         MVC   0(1,R2),TRKQUALF       PRINT IT                                  
         LA    R2,1(R2)                                                         
*                                                                               
...
*                                                                               
         ...
         DROP  R1                                                               
*                                                                               
*   WHAT LOCK NEEDS TO BE RELEASED?  NOT DETERMINED YET.                        
*                                                                               
         LA    R3,TOTABLE          POINT TO TABLE OF STATIONS                   
         USING TOTABLED,R3         ESTABLISH STATION LIST ENTRY                 
*                                                                               
...
*                                                                               
         ...
         BZ    PRLCKX                                                           
*                                                                               
         MVC   CSTAT,TOSTA         INSERT STATION INTO ARGUMENT                 
***>>>   MVC   CSTAT,=C'KOB 1'                                                  
*                                                                               
*   TEST                                                                        
***      DC    H'0'                                                             
*   TEST                                                                        
*                                                                               
         GOTO1 CHKLOCK,DMCB,('LKUNLKQ',0)                                       
*                                                                               
         BE    *+6                 TEST FOR ERRORS                              
         DC    H'0'                                                             
*                                                                               
         LA    R3,TOTABLEL(R3)     NEXT STATION IN LIST                         
         B     PRX0020             GO BACK FOR NEXT                             
*                                                                               
         DROP  R3                                                               
*                                                                               
PRLCKX   DS    0H                                                               
...
*                                                                               
         XC    RINVKRTP,RINVKRTP   HEADER RECORD                                
         XC    RINVKBK,RINVKBK                                                  
*                                                                               
         GOTO1 HIGH                                                             
*                                                                               
...
*                                                                               
         USING TRCKTBLD,R4         ESTABLISH TABLE                              
*                                                                               
TRCK10   DS    0H                                                               
...
*                                                                               
         ...
         MVI   TRCTFLGS,ONEBOOK    ONLY ONE BOOK FILTER HERE                    
         B     TRCK12                                                           
*                                                                               
...
TRCK20   DS    0H                                                               
*                                                                               
         GOTO1 BOOKVAL,DMCB,BKVLHEAD,(2,BKLST),(C'B',SCANNER),BTLST,   X        
               (C'C',ACOMFACS)                                                  
...
*                                                                               
         ...
         BNE   INVLFLD                                                          
         CLC   BTLST(1),BTLST+1    NO MIXING OF BOOK TYPES                      
         BNE   INVLFLD                                                          
*                                                                               
         B     TRCK40                                                           
*                                                                               
...
*                                                                               
         GOTO1 VGETKSRC,DMCB,(C'Q',INBLOCK),OTBLOCK,ACOMFACS                    
         CLI   DMCB+4,0                                                         
         BNE   INVLFLD                                                          
*                                                                               
TRCK40   DS    0H                                                               
******                                                                          
******   MVC   TRCTRSR,BKDATA      RATING SOURCE IN RECORD                      
******   MVC   1(2,R4),BKLST+1     FIRST BOOK                                   
******   MVC   3(2,R4),BKLST+4     2ND BOOK                                     
******   MVC   5(1,R4),BKLST       BOOK QUALIFIER                               
*                                                                               
         MVC   TRCTRSR,BKDATA      RATING SOURCE                                
         MVI   TRCTDSR,0           DATA   SOURCE                                
         MVC   TRCTQLF,BKLST       BOOKVAL BITS                                 
         MVC   TRCTBTP,BTLST       BOOK TYPE                                    
         MVC   TRCTSBK,BKLST+1     FIRST BOOK                                   
         MVC   TRCTEBK,BKLST+4     2ND BOOK                                     
         MVC   TRCTQLFY,BKLST      BOOK QUALIFIER                               
*                                                                               
TRCK50   DS    0H                                                               
*                                                                               
         LA    R4,TRCTLNGQ(R4)     INIT NEXT ENTRY IN TABLE                     
         XC    0(TRCTLNGQ,R4),0(R4)                                             
         LA    R3,32(R3)                                                        
         BCT   R6,TRCK10                                                        
*                                                                               
TRCKX    DS    0H                                                               
...
*                                                                               
         CLI   TMPBOOK+1,X00       EST BOOK?                                    
         BNE   TBK10                                                            
         EDIT  (1,TMPBOOK),(2,2(R2))                                            
         MVC   0(2,R2),=C'ST'                                                   
         LA    R2,4(R2)                                                         
         B     TBK15                                                            
*                                                                               
TBK10    GOTO1 DATCON,DMCB,(X'83',DUB),(6,(R2))                                 
         ...
         MVI   0(R2),C' '                                                       
*                                                                               
TBK15    CLI   TMPBTYP,0                    ANY BOOKTYPE?                       
         BE    TBK029                                                           
*                                                                               
         GOTO1 GETBTYPE,DMCB,(TMPBTYP,0)                                        
         CLI   DMCB,0                                                           
         BE    TBK029                                                           
...
BKVLHLQ  EQU    31                                                              
*                                                                               
TRCKTBL  DS    12CL10              TABLE FOR TRACKS AFTER PERVAL                
*        DS    CL1                 RINVKRSR FOR KEY                             
*        DS    CL1                 RINVKDSR FOR KEY                             
*        DS    CL1                 RINVKQLF FOR KEY                             
*        DS    CL1                 RINVKBTP FOR KEY                             
*        DS    CL2                 START DATE                                   
*        DS    CL2                 END DATE                                     
...
*                                                                               
FLTRSR   DS    CL1                 RINVKRSR FOR KEY                             
FLTDSR   DS    CL1                 RINVKDSR FOR KEY                             
FLTQLF   DS    CL1                 RINVKQLF FOR KEY                             
FLTBTP   DS    CL1                 RINVKBTP FOR KEY                             
...
*                                 ************** BUFFERS **************         
TOTABLE  DS    5CL(TOTABLEL)       'TO' DETAILS                                 
...
***********************************************************************         
*                                                                     *         
*        DSECT FOR TRACK TABLE                                        *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
TRCKTBLD DSECT                     TABLE FOR TRACKS AFTER PERVAL                
TRCTRSR  DS    CL1                 RINVKRSR FOR KEY                             
TRCTDSR  DS    CL1                 RINVKDSR FOR KEY                             
TRCTQLF  DS    CL1                 RINVKQLF FOR KEY                             
TRCTBTP  DS    CL1                 RINVKBTP FOR KEY                             
TRCTSBK  DS    CL2                 START BOOK                                   
TRCTEBK  DS    CL2                 END BOOK                                     
TRCTQLFY DS    CL1                 TRKQUALF(TRACK QUALIFYING FILTER)            
TRCTFLGS DS    CL1                 TRKTBL FLAGS                                 
TRCTLNGQ EQU   *-TRCKTBLD          ENTRY IN TABLE LENGTH                        
***********************************************************************         
*================================ TWA ================================*         
...
TORSR    DS     CL(L'RINVKRSR)      RATING SOURCE                               
TODSR    DS     CL(L'RINVKDSR)      DATA SOURCE                                 
TOQLF    DS     CL(L'RINVKQLF)      QUALIFIER                                   
TOBTP    DS     CL(L'RINVKBTP)      BOOKTYPE                                    
...
***********************************************************************         
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'139RERMP28   05/19/09'                                      
         END                                                                    
