*          DATA SET DEMRGUXIT5 AT LEVEL 004 AS OF 02/28/14                      
...
* KEY IN THE INPUT FILE. THE RECORDS ARE RETURNED TO THE SORT.        *         
*                                                                     *         
***********************************************************************         
DEMRGU5  CSECT                                                                  
         PRINT NOGEN                                                            
...
*                                                                               
         ...
         BNE   GETFCARD            NOT PRESENT                                  
*                                                                               
         ICM   RF,15,=V(DDSIO)     USE ALTERNATE DDSIO                          
         MVC   0(8,RF),CARD+6                                                   
*                                                                               
         GOTOR ,DMCB,CARD,=C'RE00' READ THE NEXT PARAMETER CARD                 
         L     RF,=V(CARDS)                                                     
         BRAS  RE,CALL_DDS_SUBRTN                                               
*                                                                               
GETFCARD DS    0H                                                               
         CLC   =C'READFILE=DEMFILE',CARD                                        
         BE    CLSSYSIN            OKAY, AND NO MORE CARDS ALLOWED!             
...
*                                                                               
CLSSYSIN DS    0H                                                               
         GOTOR ,DMCB,CARD,=C'RE00' READ THE (LAST!) PARAMETER CARD              
         L     RF,=V(CARDS)                                                     
         BRAS  RE,CALL_DDS_SUBRTN                                               
         CLC   =C'/*',CARD                                                      
         BE    *+6                                                              
...
*                                  PUT THE RECORD TO THE OUTPUT FILE            
         ...
         AHI   R0,L'OUT_RDW+L'OUT_FLAG  PLUS SORT RECORD OVERHEAD               
...
DMFLIST  DC    0D                  OPEN ALL DEMO FILES AND DIRECTORIES          
         ...
         DC    C'X'                                                             
         SPACE 2                                                                
         ORG   DEMRGU5+(((*-DEMRGU5)/256)+1)*256  FOR I-CACHE PIPELINE          
         SPACE 2                                                                
         DS    0L                                                               
...
*                                                                               
         ...
         DC    C'*OUTREC*'                                                      
OUT_RDW  DC    F'0'                                                             
OUT_FLAG DC    C'F'                RECORD CAME FROM DEMO FILE                   
OUT_REC  DS    2000C                                                            
*                                                                               
         EJECT                                                                  
...
DRELEMS  DS    0X                  RECORD: FIRST DEMO ELEMENT                   
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004DEMRGUXIT502/28/14'                                      
         END                                                                    
