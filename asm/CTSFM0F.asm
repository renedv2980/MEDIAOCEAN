*          DATA SET CTSFM0F    AT LEVEL 005 AS OF 05/01/02                      
*PHASE TA0A0FA                                                                  
*INCLUDE DECODE                                                                 
*                                                                               
***********************************************************************         
...
* ------------------------                                            *         
*                                                                     *         
* 4-4   29APR93 EJOR  SUPPORT MULTIPLE ESC SEQ ELEMS                  *         
*                                                                     *         
*                                                                     *         
***********************************************************************         
...
*                                                                               
         ...
         LA    RF,L'SAVETXT        XCEF DOES THIS WRONG...                      
         XCEF  SAVETXT,(RF)                                                     
...
VRX      CLI   TXTFOUND,C'Y'         MAKE SURE SOME TEXT WAS FOUND              
         BNE   NOTXTERR                                                         
*                                                                               
         LA    R2,SFMTXTH          FOR ERROR EXIT (FROM ADDELEM)                
         XC    ELEM,ELEM                                                        
         LA    R6,ELEM                                                          
         USING ESCVALEL,R6                                                      
         ...
         LH    R5,SAVELN                                                        
*                                                                               
VRX10    CH    R5,=H'250'          MORE THAN 250 CHARS LEFT?                    
         BH    *+10                                                             
         LR    R3,R5                                                            
         B     *+8                                                              
         LA    R3,250                                                           
*                                                                               
         LA    R1,ESCVALOV(R3)     R1=EL LEN                                    
         STC   R1,ESCVALLN                                                      
         BCTR  R3,0                DEC R3                                       
         EX    R3,*+8                                                           
         B     *+10                                                             
...
*                                                                               
         ...
         B     PRNTIT              PRINT IT                                     
*                                                                               
MVC2IN   MVC   INAREA(0),ESCTXTTX  RECORD LINE TO DECODE INPUT AREA             
HEX      MVC   INAREA(L'INAREA),SPACES                                          
         EX    R1,MVC2IN           RECORD LINE TO DECODE INPUT AREA             
         LA    R7,SAVETXT          A(SAVE AREA)                                 
         GOTO1 =V(DECODE),DMCB,INAREA,(R7),RR=RELO                              
         CLI   8(R1),0                                                          
         BE    TRNS                                                             
         DC    H'0'                                                             
*                                                                               
TR       TR    SAVETXT(0),PRNTCHRS TRANSLATE TO PRINTABLE CHARACTERS            
MVC2P1   MVC   P1+22(0),SAVETXT    ESCAPE LINE OF TEXT                          
MVCDASH  MVC   P2+23(0),P2+22      UNDERLINE                                    
TRNS     EQU   *                                                                
         L     R1,8(R1)            DECODE OUTPUT LENGTH                         
         BCTR  R1,0                                                             
         EX    R1,TR               TRANSLATE                                    
         EX    R1,MVC2P1           MOVE TO PRINT LINE 1                         
         BCTR  R1,0                                                             
...
*                                                                               
         ...
         DC    H'0'                                                             
*                                                                               
MVCP3    MVC   P3+22(0),OUTAREA                                                 
MVCP4    MVC   P4+22(0),0(R7)                                                   
OK       LR    R1,R7                                                            
         BCTR  R1,0                                                             
         EX    R1,MVCP3            ZONES TO PRINT LINE 3                        
         LA    R7,OUTAREA                                                       
         LA    R7,1(R1,R7)                                                      
         EX    R1,MVCP4            DIGITS TO PRINT LINE 4                       
*                                                                               
         GOTO1 SPOOL,DMCB,(R8)                                                  
...
*                                                                               
         ...
         MVC   H5+53(60),ESCDESTX  PUT DESCRIPTION IN REPORT LINE               
...
OUTAREA  DS    XL154               CONVERTED TEXT FOR REPORT                    
SAVETXT  DS    XL1309              CONVERTED TEXT SAVE AREA                     
*                                                                               
* ONLINE LIST LINE   * * * * * * * * * * * * * * * * * * * * * * * * *          
*                                                                               
GEND     DSECT                                                                  
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005CTSFM0F   05/01/02'                                      
         END                                                                    
