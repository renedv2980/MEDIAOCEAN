*          DATA SET SPREPFXCNY AT LEVEL 001 AS OF 04/08/97                      
*PHASE SPFX02W                                                                  
********************************************************************            
*        R3 --- ALWAYS POINTS TO KEY                                            
*        R4 --- ALWAYS POINTS TO KEY                                            
********************************************************************            
      TITLE 'SPF02  - CHANGE ALL CMINY RADIO TO RTG SERVICE CODE 1'             
SPFX02   CSECT                                                                  
         DS    4000C                                                            
         ORG   SPFX02                                                           
         PRINT NOGEN                                                            
...
*                                                                               
FX10     DS    0H                                                               
         CLC   KEY(2),KEYSAVE      STILL AN '00D2' RECORD?                      
         BNE   FX100               NO                                           
*                                                                               
...
CLTRECD  DSECT                                                                  
       ...
       ++INCLUDE SPREPWORKD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001SPREPFXCNY04/08/97'                                      
         END                                                                    
