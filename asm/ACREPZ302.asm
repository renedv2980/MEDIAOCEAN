*          DATA SET ACREPZ302  AT LEVEL 034 AS OF 08/16/00                      
*PHASE ACZ302A                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE HELLO                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'FIND MISSING 1C ACCOUNTS USED AS CONTRAS'                       
         PRINT NOGEN                                                            
ACZ302   CSECT                                                                  
         NMOD1 0,**ACZ3**,RR=R7                                                 
         L     RA,0(R1)                                                         
...
*                                                                               
         ...
         LA    R3,CONCODE                                                       
         USING CONTRD,R4                                                        
         MVC   CONTUL(14),CACKCUNT                                              
         GOTO1 BINADD,DMCB,(R4),(R3)                                            
         B     REQF04                                                           
*                                                                               
REQF06   LA    R5,CONCODE          ADDR OF TABLE                                
         USING BIND,R5                                                          
         MVC   WORK,SPACES                                                      
...
REQF08   LA    R2,AKEY                                                          
         ...
         MVC   CACKEY,SPACES                                                    
         MVC   CACKCPY,RCCOMPFL                                                 
         MVC   CACKUNT(14),CONTUL                                               
         GOTO1 DATAMGR,DMCB,DMREAD,ACCDIR,AKEY,ADIR                             
         CLI   8(R1),0                                                          
         BE    REQF12                                                           
         MVC   P+1(14),CONTUL        MISSING CONTRA                             
         GOTO1 ACREPORT                                                         
*                                                                               
REQF12   LA    R4,CONTLEN(R4)                                                   
         BCT   R3,REQF08                                                        
         B     XIT                                                              
*                                                                               
XIT      XIT1  1                                                                
...
CONTTAB  DS    (CONTMAX*CONTLEN)C  THE TABLE                                    
*                                                                               
IOA      DS    XL2000                                                           
         EJECT                                                                  
***********************************************************************         
...
* ACREPWORKD                                                                    
       ...
       ++INCLUDE ACREPWORKD                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034ACREPZ302 08/16/00'                                      
         END                                                                    
