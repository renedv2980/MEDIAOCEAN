*          DATA SET ACCTA04    AT LEVEL 089 AS OF 06/03/15                      
*PHASE T61E04A                                                                  
*INCLUDE SORTER                                                                 
*                                                                               
***********************************************************************         
...
DR250    DS    0H                                                               
         ...
         CP    TOTMGCI,=P'0'                                                    
         BE    DR255                                                            
         ZAP   TOTPAYED,WORK2(6)   GCI % = (COST% * NET PAYBLE) / GCI           
         MP    TOTPAYED,=P'100'                                                 
         ZAP   WORK2(12),TOTPAYED                                               
         ZICM  R4,CATNPAY,2                                                     
         AR    R4,RA                                                            
         MP    WORK2(12),0(6,R4)                                                
         DP    WORK2(12),TOTMGCI                                                
         ZAP   TOTPAYED,WORK2(6)                                                
         ZAP   WORK2(12),TOTPAYED                                               
         MP    WORK2(12),TOTMDLVD   PAYABLE EARNED = GCI% * DELIVERED           
         ZAP   TOTPAYED,WORK2(12)                                               
         SRP   TOTPAYED,64-6,5                                                  
DR255    EDIT  TOTPAYED,(11,FINPYER),2,MINUS=YES,ZERO=NOBLANK                   
         OI    FINPYERH+6,X'80'                                                 
*                                                                               
         EDIT  (P6,TOTMGCI),(11,FINMGCI),2,MINUS=YES MEDIA GCI                  
         OI    FINMGCIH+6,X'80'                                                 
...
PR90     BAS   RE,NEXTEL                                                        
         ...
         SP    WORK(5),FULL(4)                                                  
         ZAP   FULL,WORK(5)                                                     
         EDIT  (P4,FULL),(5,TSXFRCON),FILL=0                                    
...
PR130    ZAP   WORK2(6),TSSCOST                                                 
         ...
         MP    WORK2(12),=P'10000'                                              
         DP    WORK2(12),TSSDLVD                                                
PR132    TM    PRSTAT,PRSXCOST     EXCLUDE COST INFO                            
         BO    PR150                                                            
         EDIT  (P6,WORK2),(6,PR1CPCT),2                                         
*                                                                               
PR150    ZAP   WORK3(12),WORK2(6)       CALCULATE PAYABLE EARNED                
         MP    WORK3(12),=P'100'                                                
         MP    WORK3(12),TSNET          COST% * NET                             
         DP    WORK3(12),TSGCI          / GCI                                   
         ZAP   WORK2(12),WORK3(6)                                               
         OC    LASTSAR,LASTSAR                                                  
         BZ    *+10                                                             
         MP    WORK2(12),LAST.TSMDLVD   * DLVD                                  
         SRP   WORK2(12),64-6,5                                                 
         ZAP   WORK3(6),WORK2(12)                                               
         EDIT  (P6,WORK3),(11,PR1MPERN),2,ZERO=NOBLANK,MINUS=YES                
*                                                                               
PR160    GOTO1 SPOOL,DMCB,(R8)                                                  
         B     PR110NX                                                          
*                                                                               
...
*                                                                               
         ...
         SSPEC H8,20,C'--------------- MEDIA -----------------------'           
         SSPEC H8,68,C'------------ SERVICES ------------'                      
         SSPEC H9,2,C'CON#'                                                     
         SSPEC H9,9,C'ST DATE'                                                  
         SSPEC H9,22,C'CONTRACT'                                                
         SSPEC H9,32,C'DELIVERED'                                               
         SSPEC H9,46,C'BALANCE'                                                 
         SSPEC H9,55,C'PAY EARNED'                                              
         SSPEC H9,71,C'CONTRACT'                                                
         SSPEC H9,81,C'DELIVERED'                                               
         SSPEC H9,95,C'BALANCE'                                                 
*                                                                               
         SPROG 1                                                                
...
HDHOOK   NTR1                                                                   
         ...
         TM    PRSTAT,PRSXCOST     EXCLUDE COST INFO                            
         BO    HDHKX                                                            
         MVC   H8+105(18),=C'------ COST ------'                                
         MVC   H9+106(9),=C'COST DLVD'                                          
         MVC   H9+118(5),=C'COST%'                                              
         B     HDHKX                                                            
*                                                                               
...
SETUP    NTR1                                                                   
*                                                                               
         CLI   RECNUM,RTFIN        FINANCE DISPLAY SCREEN?                      
         BNE   SET10               NO DON'T CHANGE TITLE                        
         CLI   ACTEQU,ACTDIS                                                    
         BNE   SET10                                                            
         CLC   ALPHA,=C'TY'        TBSNY                                        
         BE    SET10                                                            
         MVC   FINSTTL,WESTTITL                                                 
         OI    FINSTTLH+6,X'80'                                                 
*                                                                               
SET10    OI    GENSTAT2,DISTHSPG   REDISPLAY LIST PAGE AFTER SELECT             
*                                                                               
         L     R2,=A(PFTABLE)                                                   
         A     R2,RELO                                                          
         LA    R3,FINPFKYH                                                      
...
***********************************************************************         
*                                                                               
WESTTITL DC    C'CTGY     NET PAYABLE  PAY REQUEST      BALANCE '               
         DC    C'  PAY APPROVED       COST%'                                    
         LTORG                                                                  
         EJECT                                                                  
***********************************************************************         
...
PA20     MVI   ELCODE,CNTELQ       X'92' CONTRACT ELEM                          
         ...
         AP    TSSDLVD,CNTOPNPO    OPEN ORDERS                                  
         TM    PRSTAT,PRSINV                                                    
         BO    *+16                                                             
...
PI45     CP    LAST.TSSDLVD,=P'0'       NO SERVICES DELIVERED                   
         ...
         CLI   QMED,C'R'                                                        
         BNE   *+14                                                             
         MP    DUB,=P'40'               RADIO MEDIA (40%)                       
         B     *+10                                                             
         MP    DUB,=P'50'               TELEVISION MEDIA (50%)                  
         ZAP   WORK2(6),DUB                                                     
         SRP   WORK2(6),62,5                                                    
...
TOTPAYED DS    PL8                 PAYALBE EARNED VALUE                         
*                                                                               
...
PR1MBAL  DS    CL11                MEDIA BALANCE                                
         DS    CL1                                                              
PR1MPERN DS    CL11                MEDIA PAYABLE EARNED                         
         DS    CL2                                                              
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'089ACCTA04   06/03/15'                                      
         END                                                                    
