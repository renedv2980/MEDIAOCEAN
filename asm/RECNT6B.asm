*          DATA SET RECNT6B    AT LEVEL 011 AS OF 07/26/02                      
*PHASE T8026BA,*                                                                
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
*INCLUDE DAYUNPK                                                                
         TITLE 'T8026B - RECNT6B - VCI EC'                                      
*                                                                               
*********************************************************************           
*                                                                   *           
*        RECNT6B --- VCI      ELECTRONIC CONTRACT INTERFACE         *           
* ----------------------------------------------------------------- *           
* UPDATE HISTORY:                                                   *           
...
T8026B   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 LOCALEND-LOCALWRK,*T8026B*,R9,RR=R8                              
         ST    R8,RELX                                                          
...
*STCMTX  B     XIT                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011RECNT6B   07/26/02'                                      
         END                                                                    
