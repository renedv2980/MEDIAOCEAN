*          DATA SET DELDKEEP   AT LEVEL 005 AS OF 05/01/02                      
*PHASE DELDKEEP,+0                                                              
*INCLUDE DATCON                                                                 
*INCLUDE DATVAL                                                                 
*INCLUDE PERVERT                                                                
*INCLUDE PRNTBL                                                                 
*INCLUDE SCANNER                                                                
         TITLE 'DELDKEEP - LOAD/DUMP EXTERN TO EXTRACT A BOOK'                  
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         ...
         ST    R1,RECIN                                                         
*                                                                               
         CLI   MEDIA,0             CHECK FOR SUPPRESSION OF KEEP                
         BE    DMXRECP             RESULTING FROM PARAM CARD ERROR              
         CLC   BOOKFILT,=X'FFFF'                                                
         BE    DMXRECP                                                          
*                                                                               
...
DMXEOF1  DS    0H                                                               
         ...
         MVC   P+10(14),=C'RECORDS KEPT'                                        
         MVI   P+30,C'='                                                        
         EDIT  (R2),(10,P+32)                                                   
         GOTO1 VPRINTER                                                         
         GOTO1 VPRINTER                                                         
*                                                                               
         MVC   P+10(19),=C'RECORD TYPES KEPT'                                   
         MVI   P+30,C'='                                                        
         LA    R8,RECTAB           R8 POINTS TO TABLE                           
         LA    R0,RECORDS          TABLE ENTRIES                                
         LA    R6,P+32             R6 POINTS TO OUTPUT                          
         SPACE 1                                                                
DMXEOF2  OC    4(4,R8),4(R8)       ANY KEEPS FOR TYPE                           
         BZ    *+14                                                             
...
RECTAB   DS    0CL8                                                             
         ...
         DC    C'I',AL1(PIMEDIA-PIKEY),X'C0',AL1(PIBOOK-PIKEY),XL4'0'           
...
* DEDEMFILE                                                                     
       ...
       ++INCLUDE DEDEMFILE                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005DELDKEEP  05/01/02'                                      
         END                                                                    
