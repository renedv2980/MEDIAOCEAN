*          DATA SET RERMP13    AT LEVEL 020 AS OF 05/01/02                      
*PHASE T81013A,*                                                                
*INCLUDE UNBOOK                                                                 
         TITLE 'RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY - HISTORY'           
*                                                                               
*******************************************************************             
*                                                                 *             
*        RERMP13 --- REP INVENTORY DEMO RECORD DEMOS SCREEN       *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
*                                                                 *             
...
*******************************************************************             
*                                                                               
         TITLE 'RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY - START'             
***********************************************************************         
*                                                                     *         
*        RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY - START           *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
T81013   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T81013,R7,RR=RE                                                
         L     RC,0(R1)                                                         
         USING GEND,RC             ESTABLISH GENCON WORKAREA                    
         L     RA,ATWA                                                          
         USING CONHEADH-64,RA      ESTABLISH DETAIL SCREEN                      
         L     R9,ASYSD                                                         
         USING SYSD,R9             ESTABLISH SYSTEM WORKAREA                    
         L     R8,ASPOOLD                                                       
         USING SPOOLD,R8           ESTABLISH ON-LINE PRINT CONTROL AREA         
*                                                                               
         ST    RE,RELO             SAVE RELOCATION FACTOR                       
*                                                                               
         TITLE 'RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY - MODE'              
***********************************************************************         
*                                                                     *         
*        DETERMINE GENCON MODE                                        *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
MODE     DS    0H                                                               
...
*                                                                               
         ...
         BE    VREC                                                             
         CLI   MODE,XRECADD        ADD REC TO INVENTORY (FORCE)                 
         BE    XREC                                                             
         CLI   MODE,XRECPUT        ADD REC TO INVENTORY (FORCE)                 
         BE    XREC                                                             
...
*                                                                               
         B     XIT                                                              
*                                                                               
         TITLE 'RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY - VKEY'              
***********************************************************************         
*                                                                     *         
...
*                                    FOR UP TO 3 SUBFIELDS                      
         GOTO1 SCANNER,DMCB,(R2),((R3),WORK2)                                   
...
DISP05   MVC   8(8,R2),SPACES      CLEAR BOOK FILEDS                            
         ...
         SPACE 1                                                                
DISP07   GOTO1 VUNDAY,DMCB,RINVPDAY,INCDAYS                                     
         GOTO1 VUNTIME,DMCB,RINVPTIM,INCTIME                                    
         SPACE 1                                                                
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE 'RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY -RERMPWORKD'         
***********************************************************************         
*                                                                     *         
*        SYSTEM  WORKING STORAGE AREA                                 *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
       ++INCLUDE RERMPWORKD                                                     
         TITLE 'RERMP13 - RERMP13 - REP FILE DEMOS OVERLAY - RERMP13W'          
***********************************************************************         
*                                                                     *         
*        PROGRAM WORKING STORAGE AREA                                 *         
*                                                                     *         
***********************************************************************         
         SPACE 2                                                                
         ORG   SYSSPARE                                                         
RERMP13W DS    0D                                                               
RELO     DS    F                   PROGRAM RELOCATION FACTOR                    
*                                                                               
INVMED   DS    CL1                 MEDIA                                        
...
*DDGENTWA                                                                       
       ...
       ++INCLUDE RERMPDDD                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020RERMP13   05/01/02'                                      
         END                                                                    
