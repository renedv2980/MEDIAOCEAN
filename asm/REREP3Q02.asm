*          DATA SET REREP3Q02  AT LEVEL 007 AS OF 02/06/09                      
*PHASE RE3Q02B                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE UNBOOK                                                                 
         TITLE 'RE3Q02 - REREP3Q02 - MEDIA OCEAN DEMO FEED'                     
**********************************************************************          
*********************************************************************           
*                                                                   *           
*   REREP3Q02 - RE3Q02 - MEDIA OCEAN DEMO FEED - (UNIVISION/HISP)   *           
*                                                                   *           
*********************************************************************           
...
*                      ORIGINALLY 'REREP3V02', WHICH STILL          *           
...
*                                                                   *           
*   FEB05/08 (SKU) --- ADD ADDITIONAL PARENT PLUS STATIONS          *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
...
RE3Q02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 OVERWRKQ,**RE3Q02,R7,R8,RR=RE                                    
*                                                                               
...
NUMDEMQ  EQU   (2*NUMCATQ)                                                      
         DC    X'FF'                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007REREP3Q02 02/06/09'                                      
         END                                                                    
**  INSERT END  >>                                                              
