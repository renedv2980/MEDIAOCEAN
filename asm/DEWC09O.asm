*          DATA SET DEWC09O    AT LEVEL 108 AS OF 10/04/11                      
*PROCESS USING(WARN(15))                                                        
*PHASE DEWC09OA                                                                 
*INCLUDE DEBKUPDT                                                               
         TITLE 'OUTPUT PHASE FOR WB1 COMMERCIAL (ACM) CONVERSION'               
DEWC09O  CSECT                                                                  
NUMCATS  EQU   38                                                               
         PRINT NOGEN                                                            
         ...
         LA    R7,2048(RB)                                                      
         LA    R7,2048(R7)                                                      
         USING DEWC09O+4096,R7     R7=2ND BASE REGISTER                         
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DBUPARMSD                                                      
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'108DEWC09O   10/04/11'                                      
         END                                                                    
