*          DATA SET REAURUD    AT LEVEL 024 AS OF 07/07/14                      
*PHASE REAURUDA,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
         TITLE 'REAURUD - REPPAK AVERAGE UNIT RATE UPDATE'                      
********************************************************************            
*   HISTORY OF CHANGES                                             *            
********************************************************************            
...
*                                                                  *            
*   JUL16/07 (BU ) --- CHANGING REAURUPA TO REAURUD.  PMC HAS        *          
*                      BEEN RUNNING AN ALTERNATE VERSION OF        *            
*                      THE AUR, AND REAURCRA SOURCE CODE HAS BEEN  *            
*                      LOST IN THE INTERVENING YEARS.  THE         *            
*                      ALTERNATE VERSIONS WILL BECOME REAURCD AND  *            
*                      REAURUD, AND ALL JCL WILL BE CHANGED TO     *            
*                      PROPERLY REFERENCE.  THIS WILL NOW COMPLY   *            
*                      WITH PANAPT.                                *            
*                                                                  *            
*   JUL03/14 (YYUN)--- FIX THE MISSING XBASE ISSUE IN MAIN0130     *            
*                                                                  *            
*                                                                  *            
*                      ***  END TOMBSTONE  ***                     *            
********************************************************************            
...
REAURUD  CSECT                                                                  
         ...
         ENTRY SSB                                                              
         PRINT NOGEN                                                            
         NBASE 0,REAURUD,VREGSAVE,R9,RA                                         
****     LA    RC,2048(RB)                                                      
****     LA    RC,2048(RC)                                                      
****     LA    RA,2048(RC)                                                      
****     LA    RA,2048(RA)                                                      
****     USING REAURUD+4096,RC,RA                                               
*                                                                               
         L     R8,=V(CPRINT)                                                    
         USING DPRINT,R8                                                        
         XC    WORK,WORK                                                        
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'024REAURUD   07/07/14'                                      
         END                                                                    
