*          DATA SET CTLFM02    AT LEVEL 017 AS OF 05/14/19                      
*PHASE TA0202A                                                                  
*INCLUDE SCINKEY                                                                
...
KEYV2    XC    DMCB(20),DMCB       VALIDATE TERMINAL NUM                        
         ...
         B     KEYV6                                                            
*                                                                               
KEYV5    BRAS  RE,VALPSVN          VALIDATE #NNNNN TERM/PSWD NUMBER             
         BNZ   EXIT                                                             
...
DISPREC  TWAXC TRMPIDH                                                          
         ...
         CLI   SYSTEM,0                                                         
         BE    DISP1                                                            
         BRAS  RE,GETSE            GET A(SELIST ENTRY) INTO ASE                 
...
DISPSS1  MVC   SYSNUMS,CTSYSNUM                                                 
         BRAS  RE,GETSEN           GET SE NAME AND ADD TO LIST                  
         B     DISP4                                                            
         DROP  R5                                                               
...
DATAV36  CLI   SYSTEM,0            CAN'T INPUT PGMNAME IF NOT IN                
         BE    EIIF                SYSTEM MODE                                  
         BRAS  RE,GETSE            GET A(SELIST ENTRY) INTO ASE                 
         BRAS  RE,GETPRGX          GET PROGRAM NUMBER                           
         CLI   PROGRAM,X'FF'                                                    
         BE    EIIF                                                             
         MVC   DUB(1),SYSTEM                                                    
         MVC   DUB+1(1),PROGRAM                                                 
...
DATAV54  CLI   0(R7),3                                                          
         ...
         B     DATAV58                                                          
*                                                                               
DATAV56  BRAS  RE,GETPGAX          GET PROGRAM NUMBER                           
         CLI   PROGRAM,X'FF'                                                    
         BE    EIIF                                                             
         SR    R1,R1                                                            
         IC    R1,PROGRAM                                                       
...
*                                                                               
DVDEV    LARL  R8,DEVTBL           VALIDATE DEVICE                              
         LA    R1,TRMDEVH                                                       
         GOTO1 AFVAL                                                            
         BZ    DVDEV2                                                           
         SR    R1,R1                                                            
...
*                                                                               
DVTYP    LARL  R8,TYPTBL          VALIDATE TYPE                                 
         LA    R1,TRMTYPH                                                       
         GOTO1 AFVAL                                                            
         BZ    DVTYP2                                                           
         SR    R1,R1                                                            
...
*                                                                               
DVNDE    LARL  R8,NODETBL          VALIDATE NODE                                
         LR    R0,R8                                                            
         GOTO1 AFVAL,TRMNDEH                                                    
         BZ    DVNDE2                                                           
         CLI   FLDH+5,3                                                         
...
CHGTRM   CLI   ACTN,CHANGE         CHANGE TERMINAL RECORD                       
         ...
         MVI   DELKEY+6,C'P'                                                    
         BRAS  RE,DELREC           DELETE UNWANTED PASSIVE                      
         BRAS  RE,GETNUM           GET NEXT TERMINAL NUM PASSIVE                
         BNZ   CHGTRM1                                                          
         DC    H'0'                                                             
*                                                                               
...
CHGTRM4  MVC   KEY,KEYSAVE         RESTORE ORIGINAL TERM RECORD                 
         ...
         B     DATAX                                                            
*                                                                               
ADDTRM   BRAS  RE,GETNUM           ADD/COPY TERMINAL RECORD                     
         BNZ   *+6                                                              
         DC    H'0'                                                             
...
DISPSYS2 CH    R7,=H'16'                                                        
         ...
         MVC   PROGRAM,0(R6)                                                    
         LA    R6,1(R6)                                                         
         BRAS  RE,GETPGAN          GET PROGRAM NAME                             
...
* FASYSLSTD                                                                     
       ...
       ++INCLUDE FASYSLSTD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'017CTLFM02   05/14/19'                                      
         END                                                                    
