*          DATA SET SPNWS15    AT LEVEL 057 AS OF 03/13/07                      
*PHASE T20715A,*                                                                
...
***      BNE   *+8                                                              
         CLI   CLTSRCDF,C'A'       0=NSI,1=ARB (CLTSRC IS OVERRIDDEN            
         BNE   *+8                               BY MKTSRC)                     
         MVI   SDEFKRSV,C'1'                                                    
         MVC   SDEFKSTA(4),QSTA                                                 
...
UPGR4    MVC   UPGFILE,APWORK                                                   
         ...
         TM    UPGFRBK+1,BTY2CHAR   2 CHARACTHER BOOKTYPE?                      
         BNO   UPGR5G               - NOPE                                      
         MVC   UPGFRBKT,QBOOKTYP                                                
         MVI   UPGELLN,UPGELLQ2                                                 
UPGR5G   MVC   UPGINPUT(L'SPLUPG),SPLUPG                                        
...
***  2 DECIMAL  ***                                                             
GETD4C   TM    SVWKYIND,SVONEBK    TEST 1 BOOK, 4 WEEKS                         
         BZ    *+8                                                              
...
*****  CABLE/FUSION DATE LOOKUP                                                 
         CLI   QSTA,C'0'           IS IT A NUMBER?                              
         BL    DEMU1E               - NOPE, WE DON'T HAVE CABLE NETWORK         
         XC    SPUPSTA,SPUPSTA                                                  
         MVC   SPUPSTA(3),QSTA+5   MOVE THE NETWORK IN                          
         MVC   SPUPSYSE,QSTA                                                    
         B     DEMU1G                                                           
*****  CABLE/FUSION DATE LOOKUP                                                 
DEMU1E   MVC   SPUPSTA,QSTA                                                     
DEMU1G   MVC   SPUPDAY,BWDDAYS                                                  
         TM    LFLAG,LDAYOVR       TEST DAYS OVERRIDDEN                         
         BZ    *+10                                                             
         MVC   SPUPDAY,LDAYS                                                    
...
*                                                                               
         ...
         BNE   DEMU2G               - NO, OVERRIDE CMPBKTYP REGARDLESS          
DEMU2E   MVC   SPUPBTYP,QBOOKTYP                                                
DEMU2G   TM    SPUPFBK+1,BTYBITSQ  SPECIAL BOOK?                                
         BZ    DEMU3                                                            
         ...
         B     DEMU2T                                                           
*                                                                               
DEMU2R   GOTO1 AGETBKTY,APPARM,(C'B',SPUPFBK+1),SPUPBTYP                        
DEMU2T   NI    SPUPFBK+1,X'FF'-BTYBITSQ                                         
*                                                                               
DEMU3    ICM   RE,15,LASPIEL       TEST SPILL DEMO ELEMENT                      
         BZ    DEMU14                                                           
         USING SPIEL,RE                                                         
         SR    R0,R0                                                            
*                                                                               
...
***  2 DECIMAL  ***                                                             
DEMU14J  GOTO1 ASPDEMUP,APPARM,LDMUPBLK,SVDEM,(R9)                              
*                                                                               
...
*                                                                               
         ...
         BNE   SDEM5K                                                           
         CLI   STABKTYP,0          ANYTHING HERE?                               
         BNE   SDEM5M               - NO,OVERRIDE CMPBKTYP REGARDLESS           
SDEM5K   MVC   SPUPBTYP,QBOOKTYP                                                
SDEM5M   TM    SPUPFBK+1,BTYBITSQ  SPECIAL BOOK?                                
         BZ    SDEM10                                                           
         GOTO1 AGETBKTY,APPARM,(C'B',SPUPFBK+1),SPUPBTYP                        
         NI    SPUPFBK+1,X'FF'-BTYBITSQ                                         
*                                                                               
SDEM10   CLI   SVUPPUT,C'1'                                                     
         BNE   *+8                                                              
         MVI   SPUP2YRP,C'N'                                                    
         CLI   SVUPPUT,C'2'                                                     
         BNE   *+8                                                              
...
***  2 DECIMAL  ***                                                             
         ...
         OI    SPUPOPTS,SPOP2DEC    - YUP, SPECIAL 2 DECIMAL LOOKUP             
***  2 DECIMAL  ***                                                             
SDEM20   GOTO1 ASPDEMUP,APPARM,LDMUPBLK,SVDEM,LDEMVAL                           
*                                                                               
SDEMX    B     XIT                                                              
         EJECT                                                                  
***********************************************************************         
...
* SPDEMLKXTD                                                                    
       ...
       ++INCLUDE SPDEMLKXTD                                                     
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'057SPNWS15   03/13/07'                                      
         END                                                                    
