*          DATA SET DETR12O    AT LEVEL 004 AS OF 01/02/19                      
*PHASE DETR12OA                                                                 
         TITLE 'TRITON RADIO CONVERSION OPHASE'                                 
**********************************************************************          
* THIS MODULE WAS COPIED FROM THE ARBITRON OPHASE DECNVRA99. SOME CODE          
...
*&&                                                                             
         ...
         BE    CNV60       REMOVE THIS IF YOU DON'T WANT 'E' RECS               
         B     CNVX                                                             
*                                                                               
...
*                                                                               
         ...
         CLC   PREVQHR,INTEQH                                                   
         BNE   CNV16                                                            
* UNIVERSE DEMO RECORD ARE SORTED TOGETHER AND FOR ETHNIC BOOKTYPES             
* UNLIKE ARBITRON WHERE THE MKT NUMBERS ARE DIFFERENT FOR DIFF BOOKTYPE         
* THE MARKET NUMBERS ARE THE SAME FOR TRITON FOR ALL BOOKTYPES                  
* IF WE DONT CHECK THE BOOTKYPE ALSO FOR UNIVERSE RECORDS WE WILL               
* END UP WITH NO UNIVERSE ECORD FOR ALL SUBSEQUENT BOOKTYPES                    
* AFTER THE 1ST UNIVERSE RECORD WAS OUTPUTED                                    
*                                                                               
         CLI   INTSTA+4,C'U'                                                    
         BNE   CNV52                                                            
         CLC   PREVBTYP,INTBTYP                                                 
         BNE   CNV16                                                            
*                                                                               
...
CNV31    LA    R7,DBLOCKA                                                       
         ...
         XC    DBLOCK,DBLOCK                                                    
         MVC   DBFILE,=C'TP '                                                   
         MVC   DBSELMED,MEDIA      RADIO                                        
         MVC   DBSELSRC,OUTSRC     TRITON                                       
         MVC   DBSELBK,INTBOOK                                                  
...
* DDDPRINT                                                                      
       ...
       ++INCLUDE DDDPRINT                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004DETR12O   01/02/19'                                      
         END                                                                    
