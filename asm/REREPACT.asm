*          DATA SET REREPACT   AT LEVEL 039 AS OF 05/14/15                      
*PHASE REACTA                                                                   
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PDUMPER                                                                
...
*                                                                 *             
* 25OCT01 (SKU) --- CHANGE TERM ID TO LUID IN RECOVERY TRAILER    *             
*******************************************************************             
         ENTRY UTL                                                              
REACT    CSECT                                                                  
...
*                                                                               
P17      EQU   *                                                                
         LA    R3,RECVHDR-4        POINT TO RECORD LENGTH                       
         AH    R3,0(R3)            ADD RECORD LENGTH                            
         BCTR  R3,0                BACK UP TO THE LAST BYTE OF TRAILER          
         ZIC   RF,0(R3)            GET LENGTH OF TAILER                         
         BCTR  RF,0                                                             
         SR    R3,RF               BACK UP TO THE RECOVERY EXTENSION            
         USING RECVEXTD,R3                                                      
         MVC   P+63(8),RLUID                                                    
         GOTO1 =V(PRINTER)                                                      
         DROP  R3                                                               
...
RECCARD  DC    CL80'RECORD TYPE=F,LENGTH=4300'                                  
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'039REREPACT  05/14/15'                                      
         END                                                                    
