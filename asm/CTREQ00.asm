*          DATA SET CTREQ00    AT LEVEL 002 AS OF 08/04/15                      
*PHASE TA0400A                                                                  
         TITLE 'CTREQ00 - REQUEST - ROOT CONTROLLER'                            
         PRINT NOGEN                                                            
TA0400   CSECT                                                                  
         NMOD1 REQTEMPX-REQTEMP,TA0400                                          
         LR    R9,RC                                                            
...
VAL5     LA    RA,3(RA)            FIND NEXT REQ MAP ENTRY                      
         ...
         BNE   VAL7                                                             
         MVC   RQHCARD+2(78),8(R5) YES-MOVE SCREEN TO REQ REC                   
         B     UPDATE                                                           
*                                                                               
...
RT00X    DC    X'00',C'00'                                                      
*&&UK                                                                           
RTID     DC    AL1(RTIDX-*+3,99)   IL-ID LISTS                                  
         DC    X'0001',CL22'IDL-ID LISTINGS'                                    
         DC    AL1(00,00)                                                       
         DC    AL1(RTIDX-*+1),X'00'                                             
         DC    X'1304'             REPORT(S)=REPIDS                             
RTIDX    DC    X'00',C'IL'                                                      
*&&                                                                             
...
RT80X    DC    X'00',C'80'                                                      
*&&US                                                                           
RT88     DC    AL1(RT88X-*+3,88)   88-ACTIVE PERSON                             
         DC    X'0005',CL22'C88-ACTIVE PERSONS'                                 
         DC    AL1(00,00)                                                       
         DC    AL1(RT88X-*+1),X'00'                                             
         DC    X'1007'             AGID=OPT/XX                                  
         DC    X'0505'             STRD=OPT/YYMMDD                              
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002CTREQ00   08/04/15'                                      
         END                                                                    
