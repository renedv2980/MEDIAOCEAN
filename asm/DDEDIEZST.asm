*          DATA SET DDEDIEZST  AT LEVEL 064 AS OF 04/04/05                      
*PHASE EDIEZSTA                                                                 
*INCLUDE ADDAY                                                                  
*INCLUDE BINSR31                                                                
*INCLUDE CARDS                                                                  
...
*                                                                               
*                                                                               
* THIS VERSION OF EZ SENDER IS ONLY USED FOR TESTING                            
*      ACC3#=DDS000003                                                          
*      USER =TEST                                                               
*      PSWD =DDSTEST                                                            
*                                                                               
* THIS PROGRAM MAY NOT UP TO DATE.                                              
* SO, FIRST COPY THE LIVE DDEDIEZS AND THEN MERGE THE ***TEST SETTING**         
* TO CREATE A NEW TEST VERSION.                                                 
*                                                                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         MVC   BUFFER+10(6),=C'000003'   ****TEST SETTING****                   
*        MVC   BUFFER+10(6),MAILBOX                                             
         MVI   BUFFER+16,C' '                                                   
         LA    R3,BUFFER+17                                                     
*                                                                               
         MVC   USERID,=CL10'TEST'  ****TEST SETTING****                         
*                                                                               
...
SNDEZ20  MVC   0(1,R3),0(R6)       SIGNON-ID                                    
         ...
         BNE   SNDEZ20             NO                                           
*                                                                               
         MVC   USERID(8),DSTNAME    ****TEST SETTING****                        
*                                                                               
         MVC   0(8,R3),=C'.DDSTEST' ****TEST SETTING****                        
         LA    R3,8(R3)             ****TEST SETTING****                        
...
* CTGENFILE                                                                     
       ...
       ++INCLUDE CTGENAGRD                                                      
         ...
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'064DDEDIEZST 04/04/05'                                      
         END                                                                    
