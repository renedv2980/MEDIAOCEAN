*          DATA SET RERMP1B    AT LEVEL 092 AS OF 06/27/08                      
*PHASE T8101BA                                                                  
         TITLE 'T8101B - RERMP1B - SETS'                                        
***********************************************************************         
*                                                                     *         
*  RERMP1B (T8101B) --- INPUT OF SET RECORDS                          *         
*                                                                     *         
* ------------------------------------------------------------------- *         
* UPDATE HISTORY:                                                     *         
*                                                                     *         
...
*****    CLI   ACTNUM,ACTREP       SKIP FOR REPORT                              
*****    BE    *+8                                                              
...
DK       DS    0H                                                               
         ...
         EJECT                                                                  
***********************************************************************         
* DELETE RECORD UNLESS ID IS 'ALL'                                              
***********************************************************************         
DELR     DS    0H                                                               
*                                                                               
         LA    R6,KEY                                                           
         USING RSETKEY,R6                                                       
*                                                                               
         CLC   =C'ALL ',RSETKID    ID CAN'T BE 'ALL'                            
         BNE   *+12                                                             
         LA    R2,SETIDENH         FLAG SET IDENTIFIER                          
         B     INVLFLD                                                          
*                                                                               
         L     R6,AIO                                                           
         OI    29(R6),X'80'                                                     
...
*                                                                               
         ...
         B     *-12                                                             
*                                                                               
         LA    R1,8(R2)            START OF FIELD                               
         LR    RF,RE               END OF STATION CALL LETTERS                  
         SR    RF,R1               CALL LETTERS LENGTH                          
         LA    RF,3(RF)            EVENTUAL FIELD LENGTH                        
         STC   RF,5(R2)            FIELD LENGTH                                 
*                                                                               
...
*                                                                               
         ...
         CLI   1(RE),C'F'                                                       
         BNE   *+12                                                             
         MVI   2(RE),C'M'             SET MODULATION                            
         B     DR40                                                             
*                                                                               
         CLI   1(RE),C'L'          IF LOW FREQUENCY                             
         BNE   *+12                                                             
         MVI   2(RE),C'F'                                                       
         B     DR40                                                             
*                                                                               
...
DR65     DS    0H                                                               
         ...
         CLC   =C'MS',SETTYPE      SPECIAL FOR STATION                          
         BNE   *+14                                                             
         MVC   8(12,R2),WORK+10       MARKET NAME                               
         B     DR80                                                             
...
***********************************************************************         
LR       DS    0H                                                               
         MVI   NLISTS,14           NUMBER OF LINES ON THE SCREEN                
*                                                                               
...
LR20     DS    0H                                                               
         ...
         CLC   SETTYPE,RSETKSET-RSETKEY+KEY  CHANGE OF SET TYPE                 
         BNE   LRX                                                              
*                                                                               
         MVC   LISTAR,SPACES                                                    
...
PR20     DS    0H                                                               
*                                                                               
         CLC   KEY(23),KEYSAVE     SAME REP/TYPE                                
         BNE   PRX                                                              
*                                                                               
         CLI   SETIDENH+5,0        NO FILTER ON ID                              
         BE    PR40                                                             
*                                                                               
         CLC   KEY(27),KEYSAVE     SAME REP/TYPE/ID                             
         BNE   PRX                                                              
*                                                                               
PR40     DS    0H                                                               
*                                                                               
...
PR63     DS    0H                                                               
*                                                                               
         MVC   ELEM+8+4(3),SPACES                                               
*                                                                               
         LA    RE,ELEM+8           START OF CALL LETTERS                        
*                                                                               
         CLI   0(RE),C' '          FIND FIRST TRAILING SPACE                    
         BNH   *+12                                                             
         LA    RE,1(RE)                                                         
         B     *-12                                                             
*                                                                               
...
*                                                                               
         ...
         SR    R1,RF                                                            
         LA    R1,3(R1)            FOR '-TV'                                    
         STC   R1,ELEM+5           SET LENGTH                                   
*                                                                               
PR65     DS    0H                                                               
*                                                                               
         MVC   1(2,RE),=C'TV'      DEFAULT TO TV                                
*                                                                               
         CLI   4(R5),C'T'          OKAY IF BAND IS 'T' OR ' '                   
         BE    PR68                                                             
         CLI   4(R5),C' '                                                       
         BE    PR68                                                             
*                                                                               
         MVC   1(1,RE),4(R5)       SET BAND                                     
*                                                                               
         CLI   1(RE),C'A'          IF RADIO                                     
         BE    *+8                                                              
         CLI   1(RE),C'F'                                                       
...
*                                                                               
         ...
         B     PR68                                                             
*                                                                               
         MVI   2(RE),C' '          ELSE NO SECOND CHARACTER                     
*                                                                               
         SR    RF,RF                                                            
         IC    RF,ELEM+5           DECREMENT LENGTH                             
         BCTR  RF,0                                                             
         STC   RF,ELEM+5                                                        
*                                                                               
PR68     DS    0H                                                               
...
VALDPT   NTR1                                                                   
         ...
         TITLE 'T8101B - RERMP1B - SETS - DAYPART SET - DSPDPT'                 
***********************************************************************         
* DISPLAY  DAYPART CODE                                                         
* P1 HAS DPT CODE                                                               
* WORK HAS SHORT AND LONG DAYPART CODES CL3,CL15                                
* USES AIO2                                                                     
***********************************************************************         
DSPDPT   NTR1                                                                   
         ...
         BE    DSPDPT10                                                         
*                                  DAYPART NOT FOUND                            
         MVC   WORK(19),=C'DAYPART NOT ON FILE'                                 
         B     DSPDPTX                                                          
*                                                                               
DSPDPT10 DS    0H                                                               
         MVC   AIO,AIO2                                                         
...
DSPDPTX  DS    0H                                                               
         XIT1                                                                   
         TITLE 'T8101B - RERMP1B - SETS - MKT/STA SET - VALSTA'                 
***********************************************************************         
...
VALSTA   NTR1                                                                   
         ...
         MVC   AIO,AIO1            RESTORE IOAREA                               
         CR    RB,RB               RESULTS ARE OKAY                             
                                                                                
         B     YESXIT                                                           
                                                                                
         TITLE 'T8101B - RERMP1B - SETS - MKT/STA SET - DSPSTA'                 
***********************************************************************         
* DISPLAY  STATION CALL LETTERS                                                 
* P1   HAS STATION CALL LETTERS                                                 
* P1   HAS STATION CALL LETTERS                                                 
* R5   ==> INTERNAL STATION FORMAT                                              
***********************************************************************         
DSPSTA   NTR1                                                                   
         L     R2,0(R1)                                                         
*                                                                               
...
*                                                                               
         ...
         MVC   RSTAKSTA,0(R5)      STATION                                      
         CLI   RSTAKSTA+4,C'0'     IF SATELLITE                                 
         BL    *+8                                                              
         MVI   RSTAKSTA+4,C' '        FORCE TO TV                               
         MVI   RDUPDATE,C'N'                                                    
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE                                                  
         BE    DSPSTA10                                                         
*                                  STATION NOT ON FILE                          
         MVC   WORK(19),=C'STATION NOT ON FILE'                                 
         B     DSPSTAX                                                          
*                                                                               
DSPSTA10 DS    0H                                                               
*                                                                               
...
*  TYPE DECRIPTION            CL20                                              
         DS    0D                                                               
TYPELIST DS    0CL28                                                            
         DC    C'DP',AL1(1),XL1'00',AL4(VALDPT),AL4(DSPDPT)                     
         DC    CL20'    DAYPART MENU'                                           
TYPELSTL EQU   *-TYPELIST          LENGTH OF TABLE ENTRY                        
         DC    C'MS',AL1(5),XL1'00',AL4(VALSTA),AL4(DSPSTA)                     
         DC    CL20' STATIONS IN MARKET '                                       
*                                                                               
         DC    X'FF'               EOT                                          
         TITLE 'T8101B - RERMP1B - SETS - DAYPART SET - TYPLSTD'                
***********************************************************************         
*                                                                     *         
*        TYPELIST DSECT                                               *         
*                                                                     *         
...
TPLDSPA  DS    A                   A(DISPLAY    ROUTINE)                        
TPLTTL   DS    CL20                SCREEN TITLE                                 
TPLENTL  EQU   *-TPLENTRY          TABLE ENTRY LENGTH                           
*                                                                               
         TITLE 'T8101B - RERMP1B - SETS - DAYPART SET'                          
         EJECT                                                                  
       ++INCLUDE FATIOB                                                         
       ++INCLUDE RERMPWORKD                                                     
*                                                                               
         TITLE 'T8101B - RERMP1B - SETS - DAYPART SET - OVERLAY WORK'           
***********************************************************************         
*                                                                     *         
...
* RERMPFAD                                                                      
         ORG   CONTAGH                                                          
       ++INCLUDE RERMPFBD          (OUR MAINTENANCE SCREEN OVERLAY)             
         ORG   CONTAGH                                                          
       ++INCLUDE RERMPEBD          (OUR LIST SCREEN OVERLAY)                    
*REGENREPA                                                                      
       ++INCLUDE REGENREPA                                                      
RSETRECD DSECT                                                                  
       ++INCLUDE REGENSET                                                       
...
SPOOLD   DSECT                                                                  
         ORG   P                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'092RERMP1B   06/27/08'                                      
         END                                                                    
