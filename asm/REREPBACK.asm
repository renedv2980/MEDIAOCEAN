*          DATA SET REREPBACK  AT LEVEL 213 AS OF 05/01/02                      
*PHASE REBK02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE BINSRCH2                                                               
...
*                                                                               
*   DATE INSERTION HAS BEEN MOVED TO STATION PROCESSING                         
*                                                                               
...
*                                  LEAVE A BIG SPACE HERE                       
         ...
         A     RF,=F'60000'        60K FOR MISSING AGENCY CODES                 
         ST    RF,AMISSADV         A(MISSING ADVERT TABLE)                      
         A     RF,=F'15000'        15K FOR MISSING S/P CODES                    
         ST    RF,AMISSSAL         A(MISSING ADVERT TABLE)                      
*                                                                               
         L     RF,AMISSAGY                                                      
...
CONTPROC NTR1                                                                   
         L     RC,0(R1)            RESET A(WORKSPACE)                           
*                                                                               
         LA    R2,BLAIRSTA         SET A(STATION LIST - BLAIR)                  
         CLC   =C'BL',OLDREP       OLDREP = BLAIR?                              
         BE    CONT0020            YES                                          
         LA    R2,PETRYSTA         NO  - SET A(STATION LIST - PETRY)            
CONT0020 EQU   *                                                                
...
*                                                                               
CONT0040 DS    0H                                                               
         GOTO1 DATCON,DMCB,(3,DOLDDATE(R2)),(2,EARLYDTE)                        
*                                                                               
***>>    MVC   EARLYDTE,=X'C39D'   SET START BACKBILLING DATE                   
***>>                                 TO DEC29/97                               
*   VERIFY THE DATES!!!                                                         
*                                     TO DEC29/97                               
         GOTO1 DATCON,DMCB,(3,DNEWDATE(R2)),(2,LATEDTE)                         
*                                                                               
***>>    MVC   LATEDTE,=X'C78C'    SET END   BACKBILLING DATE                   
***>>                                 TO DEC12/99                               
         GOTO1 DATCON,DMCB,(2,EARLYDTE),(3,EARLYDTB)                            
         GOTO1 DATCON,DMCB,(2,LATEDTE),(3,LATEDTB)                              
         MVC   WORK(3),EARLYDTB    SET EARLY MONTH OF SERVICE                   
         MVC   WORK+2(1),15        FORCE MID-MONTH                              
...
*   TEST END                                                                    
*                                                                               
*   CONTRACT NUMBER ADJUSTMENT                                                  
*                                                                               
         AP    DUB(8),=P'3000000'  YES - ADD THIS CONT# ADJUSTMENT              
CONT0420 EQU   *                                                                
*                                                                               
*   TEST                                                                        
*        MVC   P+1(05),=C'PAK+:'                                                
...
CONT0900 DS    0H                                                               
         XIT1                                                                   
         DROP  R5                                                               
DNEWGRP  EQU   5                   DISPLACEMENT TO GROUP CODE                   
DOLDDATE EQU   7                   DISPLACEMENT TO HIST DATE                    
DNEWDATE EQU   10                  DISPLACEMENT TO TKO  DATE                    
LSTALIST EQU   13                                                               
NEWGROUP DS    CL2                                                              
MYWORK   DS    CL64                                                             
MYWORK2  DS    CL64                                                             
...
**MISS                                                                          
MISS0100 EQU   *                                                                
         L     R3,AMISSSAL         SET A(MISSING S/P)                           
MISS0120 EQU   *                                                                
         CLI   0(R3),X'FF'         END OF TABLE?                                
         BE    MISS0140            YES                                          
         MVC   P+1(15),=C'MISSING S/P   :'                                      
         MVC   P+20(3),0(R3)                                                    
         GOTO1 REPORT                                                           
         LA    R3,3(R3)                                                         
         B     MISS0120            GO BACK FOR NEXT                             
MISS0140 EQU   *                                                                
**MISS                                                                          
         XIT1                                                                   
         EJECT                                                                  
...
LUTLTABL EQU   *-UTLTABLE                                                       
         ...
         DC    X'0000'             DELIMITER                                    
BLAIRSTA DC    C'KETV TZ',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'KHBS TK',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'KOAT TK',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'KOCO TZ',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'WBAL TK',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'WDSU TK',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    X'0000'                                                          
PETRYSTA DC    C'KCCI TZ',X'610C1D',X'630B1C'   12/29/97 - 11/28/99             
         DC    C'WESH TS',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'WPTZ TS',X'610C1D',X'630A1F'   12/29/97 - 10/31/99             
         DC    C'KCRA TK',X'610C1D',X'630B1C'   12/29/97 - 11/28/99             
         DC    X'0000'                                                          
*   EQUATES                                                                     
SALTABLN EQU   13                                                               
...
*                                                                               
SCOD0160 EQU   *                                                                
         MVC   DUB(3),RCONSAL      SET UP SEARCH ARGUMENT                       
         L     R2,ASALAREA         SET A(ADVERT TABLE)                          
         L     R4,SALCTR           CURRENT # OF TABLE ENTRIES                   
         LTR   R4,R4               ANYTHING IN COUNTER?                         
         BZ    SCOD0180            NO  - SET AS MISSING                         
*                                                                               
         GOTO1 =V(BINSRCH),DMCB,DUB,(R2),(R4),13,3,1500                         
                                                                                
*                                                                               
         CLI   DMCB,0              RECORD FOUND?                                
         BE    SCOD0220            YES                                          
SCOD0180 EQU   *                                                                
         L     RF,NOSALREC         COUNT MISSING ADVERT ORDERS                  
         LA    RF,1(RF)                                                         
         ST    RF,NOSALREC                                                      
*                                                                               
SCOD0200 EQU   *                                                                
**       MVC   P+1(12),=C'MISSING SAL:'                                         
**       MVC   P+13(4),DUB                                                      
**       GOTO1 HEXOUT,DMCB,RCONKCON,P+24,4,=C'TOG'                              
**       GOTO1 REPORT                                                           
         L     R2,AMISSSAL         SET A(MISSING S/P)                           
         L     R4,MISSSALS         SET A(NUMBER OF S/P IN TABLE)                
         GOTO1 =V(BINSRCH),DMCB,(1,DUB),(R2),(R4),3,3,5000                      
         CLI   DMCB,0              RECORD FOUND?                                
         BE    SSAL0800            YES - DON'T ADD TO COUNTER                   
         MVC   MISSSALS,DMCB+8     SAVE NEW COUNT                               
         MVI   CODFOUND,C'N'       SET 'CODE NOT FOUND'                         
         B     SCOD0260            EXIT CC NOT ZERO                             
SCOD0220 EQU   *                                                                
         L     RF,DMCB             SET A(RECORD FOUND)                          
         CLC   =C'???',3(RF)      SKIP S/P INDICATOR?                           
         BNE   SCOD0240                                                         
         MVC   P+1(12),=C'????    SAL:'                                         
         MVC   P+13(4),DUB                                                      
         MVC   P+22(8),0(RF)                                                    
         ...
         B     SCOD0200                                                         
SCOD0240 EQU   *                                                                
         MVC   SAVESAL,3(RF)       SAVE NEW S/P FOUND                           
         MVC   SAVEKOFF,6(RF)      SAVE NEW S/P OFFICE FOUND                    
         MVC   SAVETEM,8(RF)       SAVE NEW S/P TEAM FOUND                      
SCOD0260 EQU   *                                                                
**SALP                                                                          
...
RBUK0120 EQU   *                                                                
         ...
         PRINT GEN                                                              
         GOTO1 =V(HELLO),DMCB,(C'P',=C'REPFILE'),RCONREC,0(R3),0                
         PRINT NOGEN                                                            
...
MASTD    DSECT                                                                  
       ...
       ++INCLUDE DDCOMFACS                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'213REREPBACK 05/01/02'                                      
         END                                                                    
