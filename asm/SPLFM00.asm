*          DATA SET SPLFM00    AT LEVEL 174 AS OF 06/26/13                      
*PHASE T21900A                                                                  
*INCLUDE BRDWK                                                                  
*INCLUDE DPTRD                                                                  
...
*                                                                               
         CLI   13(R7),X'FD'        TEST IF N/FIL MOVED TO NET/SFM               
         BNE   FL210                                                            
         CLI   SVOVSYS,3           MUST BE NET                                  
         BE    FL2A                                                             
*                                                                               
FL210    CLI   13(R7),X'FE'        TEST MOVED TO SFM                            
         BL    FL2B                NO                                           
...
****     CLI   SVSTEREO,C'Y'       STEREO OK NOW                                
****     BE    FL31                                                             
...
*                                                                               
FL40A    DS    0H                                                               
         CLI   SVREC,X'48'         PGEST/GFEST/ATEST -                          
         BE    FL40C               DO NOT FORCE INPUT IN FIRST FIELD            
...
*        MVC   LFMMSG(40),=C'** ENTER DELETE CODE TO DELETE RECORD **'          
         MVC   LFMMSG(40),=CL40'** PRESS ENTER TO CONFIRM DELETE  **'           
         LA    R2,LFMTABH                                                       
         BAS   RE,FNDUF                                                         
         B     EXIT                                                             
*                                                                               
...
*                                                                               
         ...
         LA    R1,WORK                                                          
         USING GETTXTD,R1                                                       
         MVI   GTMTYP,GTMERR       SET MESSAGE TYPE TO ERROR                    
...
RECLIST  DC    H'14'                                                            
         DC    A(RECLISTX-1)                                                    
*                                                                               
         DC    CL8'CLIENT  ',X'1111F100',X'44FF'   << SFM                       
         DC    CL8'CLTHDR  ',X'1111F100',X'44FF'   << SFM                       
         DC    CL8'CL2     ',X'3131D100',X'44FF'   << SFM                       
         DC    CL8'CGR     ',X'5454B400',X'4000'                                
         DC    CL8'PRODUCT ',X'1212F200',X'20FF'   << SFM                       
         DC    CL8'PRDHDR  ',X'1212F200',X'20FF'   << SFM                       
         DC    CL8'ESTIMATE',X'1313F380',X'10FF'   << SFM                       
         DC    CL8'ESTHDR  ',X'1313F380',X'10FF'   << SFM                       
         DC    CL8'ESTDOLS ',X'5353B300',X'10FF'   << SFM                       
         DC    CL8'EST$    ',X'5353B300',X'10FF'   << SFM                       
...
*                                                                               
         DC    CL8'MASTER  ',X'2121E100',X'80FD'  << NET IN SFM TOO             
         DC    CL8'ADDRESS ',X'2222E200',X'80FD'  << NETWORK ONLY               
         DC    CL8'REPREC  ',X'2323E300',X'80FD'  << NETWORK ONLY               
         DC    CL8'MARKET  ',X'2424E440',X'00FF'  << SFM                        
         DC    CL8'SPREP   ',X'2525E500',X'0000'                                
         DC    CL8'MENU    ',X'2626E600',X'00FE'  << SFM FOR SPOT               
         DC    CL8'FLIGHT  ',X'2727E700',X'0000'                                
         DC    CL8'SPLIT   ',X'2828E8C0',X'00FE'  << SFM FOR SPOT               
         ...
         DC    CL8'SPLDEF  ',X'2F2FEF00',X'00FF'  << SFM                        
         DC    CL8'SPILLDEF',X'2F2FEF00',X'00FF'  << SFM                        
*                                                                               
         DC    CL8'AGYHDR  ',X'3232D201',X'00FE'  << SFM FOR SPOT               
         DC    CL8'DPTHDR  ',X'3434D441',X'00FE'  << SFM FOR SPOT               
         DC    CL8'EQUHDR  ',X'3535D541',X'00FE'  << SFM FOR SPOT               
         DC    CL8'TALFAC  ',X'3636D600',X'0000'                                
*!!!     DC    CL8'EBDREC  ',X'3838D800',X'0000'                                
* FOLLOWING RECS FOR NETPAK                                                     
         DC    CL8'WHUT    ',X'4343C320',X'00FE' NEW HUT                        
         DC    CL8'MHUT    ',X'4444C420',X'00FE' NEW HUT MONTH                  
*!!!     DC    CL8'HOLIHUT ',X'4545C500',X'0000' NEW HOLI-HUT                   
* FOR SPOTPAK FILE MAINTENANCE                                                  
         DC    CL8'PXCREC  ',X'4646C640',X'00FE'  << SFM FOR SPOT               
...
*!!!     DC    CL8'PGEST   ',X'4848C800',X'0000' P$G PGEST REC                  
         ...
         DC    CL8'GFEST   ',X'4848CA40',X'00FE'  << SFM FOR SPOT               
RECLISTX EQU   *                                                                
         SPACE 2                                                                
...
SPCLACTS DS    0H                                                               
         ...
         DC    X'48',C'X',X'48CA'  GF EST DEL                                   
         DC    X'48',C'R',X'48CA'  GF EST RESTORE                               
**SFM    DC    X'2F',C'R',X'2FEF'  SPILL RESTORE                                
         DC    X'FF'                                                            
         EJECT                                                                  
KEYLIST  DS    0H                                                               
         DC    X'11',AL1(L'K11)                                                 
...
K35      DC    C'AGENCY,MEDIA,(CLIENT)'                                         
         DC    X'36',AL1(L'K36)                                                 
K36      DC    C'MED,CLT,TALFGRP<,NETWORK>'                                     
         DC    X'38',AL1(L'K38)                                                 
...
* FAGETTXTD                                                                     
       ...
       ++INCLUDE FATIOB                                                         
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'174SPLFM00   06/26/13'                                      
         END                                                                    
