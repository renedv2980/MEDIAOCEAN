*          DATA SET PPREP0302R AT LEVEL 007 AS OF 05/01/02                      
*PHASE PP0302R,+0,NOAUTO                                                        
*INCLUDE MININAM                                                                
         TITLE 'PP0302 - PRTFIX PROGRAM'                                        
*                                                                               
* THIS PROGRAM LOOKS FOR I/OCOM OR CONCOM AS STANDARD COMMENT NUMBERS           
*                                                                               
*                                                                               
PP0302   CSECT                                                                  
         PRINT NOGEN                                                            
...
RUNF     DS    0H                                                               
         ...
         ZAP   BADCNT,=P'0'        I/OCOM/CONCOM COUNTS (STD COM NUMS)          
         B     EXIT                                                             
*                                                                               
...
*                                                                               
         ...
         MVI   KEY+3,X'40'          STD COMM RECORDS                            
PROC2    GOTO1 HIGH                                                             
         B     PROC5                                                            
PROC3    GOTO1 SEQ                                                              
...
*                                                                               
PROC10   DS    0H                                                               
         CLC   KEY+4(6),=C'I/OCOM'                                              
         BE    PROC20                                                           
         CLC   KEY+4(6),=C'CONCOM'                                              
         BNE   PROC3                                                            
PROC20   DS    0H                                                               
         MVC   P(2),KEY            AGENCY                                       
         MVC   P+5(1),KEY+2        MEDIA                                        
         MVC   P+8(6),KEY+4        COMMENT NUMBER                               
         AP    BADCNT,=P'1'                                                     
*                                                                               
...
PROC80   DS    0H                                                               
         ...
         BE    EXIT                                                             
         XC    KEY+4(28),KEY+4                                                  
         MVI   KEY+3,X'40'         STD COMMENT RECORD                           
         B     PROC2                                                            
*                                                                               
*                                                                               
RUNL     DS    0H                                                               
...
COUNTS   DS    0C                                                               
INCNT    DS    PL8                                                              
         DC    CL15'COMM RECS READ'                                             
BADCNT   DS    PL8                                                              
         DC    CL15'COMM RECS OUT '                                             
         DC    X'FF'                                                            
DUMPCNT  DS    PL8                                                              
*                                                                               
SAVKEY   DS    CL32                                                             
...
*                                                                               
       ...
       ++INCLUDE PPMODEQU                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'007PPREP0302R05/01/02'                                      
         END                                                                    
