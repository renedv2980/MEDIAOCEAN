*          DATA SET PPREPIX02  AT LEVEL 014 AS OF 05/01/02                      
*PHASE PPIX02A,+0                                                               
*                                                                               
************  CHANGE LOG  ************                                          
*                                                                               
*  SMYE  8/96      CHANGED OPENR AND CLOSER MACROS TO OPEN AND CLOSE            
*                                                                               
*  SMYE  12/12/95  CHANGED DTCNV TO DATCON WITH NEW PARAM'S                     
*                                                                               
         TITLE 'PPIX02 - PRINTPAK INSERTION INTERFACE TAPE'                     
PPIX02   CSECT                                                                  
         NMOD1 0,PPIX02                                                         
         L     RA,0(R1)                                                         
         USING PPWORKD,RA                                                       
...
DDISPCE  DS    CL17                SPACE FOR M,T,S,O                            
         ORG   DDISPCE                                                          
*                                  NEWSPAPER FIELDS                             
DDILINES DS    CL5                 LINES,INCHES, OR INCHES +2 DECIMALS          
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014PPREPIX02 05/01/02'                                      
         END                                                                    
