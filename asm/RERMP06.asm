*          DATA SET RERMP06    AT LEVEL 005 AS OF 06/27/08                      
*PHASE T81006A,*                                                                
         TITLE 'T81006 - RERMP06 - MARKET RECORDS'                              
*                                                                               
*******************************************************************             
*                                                                 *             
*        RERMP06 --- REP RMP MARKET RECORDS                       *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
...
GETID    NTR1                                                                   
         ...
         MVC   15(10,R4),SPACES                                                 
         MVC   15(8,R4),WORK                                                    
         GOTO1 DATAMGR,DMCB,(0,=C'DMREAD'),=C'CTFILE',(R4),(R4),0               
...
*  DDFLDIND                                                                     
       ++INCLUDE DDFLDIND                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005RERMP06   06/27/08'                                      
         END                                                                    
