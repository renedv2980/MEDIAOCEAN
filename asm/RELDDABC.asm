*          DATA SET RELDDABC   AT LEVEL 010 AS OF 05/01/02                      
*PHASE RELDDABC,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDDABC - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
*******************************************************************             
* RELDDABC:  PURGES TEST REP NTVSTRN (NY) COMPLETELY, AND DROPS                 
*            CONTRACT RECORDS FROM NTVSNY (CV)                                  
*******************************************************************             
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC3  EQU   *                                                                
         ...
         BE    DMXREC4             NOT IN PURGE LIST: CHECK CV                  
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010RELDDABC  05/01/02'                                      
         END                                                                    
