*          DATA SET SPEZF28    AT LEVEL 012 AS OF 08/22/16                      
*PHASE T23028A                                                                  
***********************************************************************         
*                                                                     *         
*  TITLE: T23028 - EASI INVOICE UPDATIVE LIST                                   
...
***********************************************************************         
*                                                                               
         TITLE 'T23028 - UPDATIVE INVOICE LIST'                                 
*                                                                               
T23027   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,**3028**,R7,RR=R2                                              
         L     RC,0(R1)                                                         
         USING GEND,RC                                                          
...
*                                                                               
         ...
         BE    LS144                                                            
         XC    SVLSTBAT,SVLSTBAT   CLEAR KEY FIELDS                             
         B     LS100                                                            
         DROP  R2                  EZWKRCMD,R2                                  
*                                                                               
...
*                                                                               
         LAY   RF,EZITPACT                                                      
         SRP   0(L'EZITPACT,RF),62,0  SHIFT 2 DIGITS RIGHT, NO ROUNDING         
         EDIT  (P8,0(RF)),LINGDOL,COMMAS=YES,ZERO=NOBLANK,MINUS=YES             
*                                                                               
...
*        OI    LINPRDH+6,X'20'    IF YES-PROTECT, TO DISALLOW CHANGES           
*                                                                               
DL286    DS    0H                                                               
*                                                                               
         GOTO1 LISTMON                                                          
...
*        DC   AL1(KEYTYTWA,L'LINBDAT+2),AL2(TWASVDAT-T230FFD)                   
         DC   AL1(KEYTYTWA,L'DIVBDT-2),AL2(TWASVDAT-T230FFD)                    
...
*                                                                               
LINFRSTH DS    CL(L'LUPTTL1H)                                                   
LINFRST  DS    CL(L'LUPTTL1)   FIRST FIELD - NON UPDATIVE                       
*                                                                               
LINCLTH  DS    CL(L'LUPTTL2H)                                                   
LINCLT   DS    CL(L'LUPTTL2)   UPDATIVE FIELD - CLT, PRD, EST                   
*                                                                               
LINSCNDH DS    CL(L'LUPTTL3H)                                                   
LINSCND  DS    CL(L'LUPTTL3)   SECOND NON-UPDATIVE FIELD                        
*                                                                               
         ORG   LINFRST                                                          
LINSRCE  DS    CL4                                                              
         DS    C                                                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012SPEZF28   08/22/16'                                      
         END                                                                    
