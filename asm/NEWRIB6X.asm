*          DATA SET NEWRIB6X   AT LEVEL 005 AS OF 03/03/04                      
*          DATA SET NEWRI19    AT LEVEL 006 AS OF 11/29/89                      
*PHASE T32019A                                                                  
         TITLE 'T32019 - P3 WEEKLY GOALS/ACT/EST - EDIT'                        
T32019   CSECT                                                                  
         SPACE 3                                                                
*                                                                               
...
OPTIONS  DS    CL1                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005NEWRIB6X  03/03/04'                                      
         END                                                                    
