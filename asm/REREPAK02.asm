*          DATA SET REREPAK02  AT LEVEL 206 AS OF 05/01/02                      
*PHASE REAK02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
*                                                                               
*                                                                               
         L     R4,AEDIR11           CLEAR TARGET RECORD                         
...
*                                     FOR 529 BYTES                             
         ...
         MVCL  R4,R6               CLEAR KATZ BUILD RECORD AREA2                
*                                                                               
         L     R3,AEDIR11          BUILD BOTH HEADERS IN PARALLEL               
         USING DAKHEDR1,R3                                                      
         L     R4,AEDIR12                                                       
         USING DAKHEDR2,R4                                                      
         L     R5,AEDIR13                                                       
...
*                                                                               
*                                                                               
         GOTO1 DATCON,DMCB,(2,RDARDATE),(X'20',DAKHDATE) DATE                   
         PRINT GEN                                                              
...
*                                  SAVE FLIGHT ST/END DATES YYMMDD              
         GOTO1 DATCON,DMCB,(3,RCONDATE),(X'20',DAKHST1)                         
*                                  INSERT START DATE OF ORDER                   
         GOTO1 DATCON,DMCB,(3,RCONDATE+3),(X'20',DAKHEND1)                      
...
CPRO0360 EQU   *                                                                
         GOTO1 DATCON,DMCB,(3,RCONEDDT),(X'20',DAK2LTDT)                        
CPRO0380 EQU   *                                                                
         DROP  R6                                                               
*                                                                               
...
CPRO0480 EQU   *                                                                
****HERE:  CHANGES TO SKIP ORDER WITH NO BUY LINES                              
*                                                                               
*   IF CONFIRM RUN, ENSURE BUY LINES EXIST                                      
*                                                                               
         CLI   QOPTION1,C'A'       ACKNOWLEDGEMENT?                             
         BE    CPRO0490            YES - DON'T NEED BUYLINES                    
*                                                                               
*   TEST                                                                        
*        CLC   =X'04382633',RCONKCON                                            
*        BE    CPRO0520                                                         
*   TEST END                                                                    
*                                                                               
         ...
         BNE   CPRO0520            NO  - NO BUYS: SKIP THIS ORDER!              
CPRO0490 EQU   *                                                                
****HERE:  CHANGES TO SKIP ORDER WITH NO BUY LINES                              
...
*                                                                               
         ...
         MVCL  R4,R6               CLEAR KATZ BUILD RECORD AREA2                
*                                                                               
         L     R3,AEDIR11          BUILD BUYS IN EDIREC11                       
         USING DAKDTAIL,R3                                                      
...
BCOM0140 EQU   *                                                                
         L     R4,AEDIR11                                                       
         LA    R4,27(R4)           CLEAR FIRST AREA: LEAVE KEY                  
         L     R5,=F'502'          LOAD FULL WORD LENGTH                        
         LA    R6,SPACES                                                        
         XC    DUB,DUB             SET UP PADDING CHARACTER                     
         MVI   DUB,C' '            INSERT PADDING CHARACTER                     
...
*                                                                               
         LA    RF,RECORD                                                        
         AH    RF,=Y(LRECORD)      ADD L(RECORD IO AREA)                        
         ST    RF,AEDIR11          SET A(EDIREC11/12/13/14)                     
...
EDIREC99 DS    529C                                                             
       ...
       ++INCLUDE DRKZEDIAKD                                                     
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'206REREPAK02 05/01/02'                                      
         END                                                                    
