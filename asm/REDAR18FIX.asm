*          DATA SET REDAR18FIX AT LEVEL 139 AS OF 02/07/00                      
*PHASE T80F18A                                                                  
...
*                                                                               
VK120    DS    0H                                                               
         XC    TEMFILT,TEMFILT     CLEAR S/P TEAM    FILTER                     
         LA    R2,MKGTEMH                                                       
...
LR       DS    0H                                                               
         ...
         NI    BITFLAG,X'FF'-BFFORCEC                                           
*                                                                               
LIRE0020 DS    0H                                                               
         OI    BITFLAG,BFGETFKY    SET TO GET FIRST LIST KEY                    
         TM    BITFLAG,BFFRSTKY    USE FIRST KEY TO START LIST?                 
         BZ    LIRE0040                                                         
         MVC   KEY(L'FIRSTKEY),FIRSTKEY                                         
         NI    BITFLAG,X'FF'-BFFRSTKY                                           
*                                                                               
*   TEST                                                                        
         LTR   RF,RF                                                            
*   TEST END                                                                    
...
LIRE0040 DS    0H                                                               
         ...
         BZ    LIRE0060            YES                                          
         TM    BITFLAG,BFPASSKY    USE FIRST KEY TO START LIST?                 
...
*                                                                               
LIRE0180 DS    0H                                                               
         TM    BITFLAG,BFGETFKY    SAVE IN CASE OF SELECTION                    
         BZ    LIRE0200                                                         
         MVC   FIRSTKEY,KEY                                                     
         NI    BITFLAG,X'FF'-BFGETFKY                                           
         XC    KEYSAVE,KEYSAVE                                                  
*                                                                               
LIRE0200 DS    0H                                                               
         MVC   MGKEY,KEY                                                        
...
LIRE0205 DS    0H                                                               
         ...
         DC    H'0'                                                             
         USING RMKGXEL,R6                                                       
         CLC   =C'OM',RMKGXAGY     ONLY FOR OMNY                                
         BE    LIRE0210                                                         
         CLC   =C'OD',RMKGXAGY     ONLY FOR OMNY                                
         BE    LIRE0210                                                         
         CLC   =C'OG',RMKGXAGY     ONLY FOR OMNY                                
         BNE   LIRE0740                                                         
         DROP  R6                                                               
*                                                                               
LIRE0210 DS    0H                                                               
...
* IF STATION HASN'T SENT(MGS) IT BACK TO THE REP                                
*                                                                               
LIRE0640 DS    0H                  STATION IN WIP?                              
...
* USE FIRST KEY ON NEXT LIST AND FORCE CURSOR                                   
         OI    BITFLAG,BFFRSTKY+BFFORCEC+BFPASSKY                               
...
BITFLAG  DS    X                                                                
BFFRSTKY EQU   X'80'               USE FIRSTKEY FOR NEXT LIST SCREEN            
BFGETFKY EQU   X'40'               GET FIRSTKEY FOR NEXT LIST SCREEN            
BFFORCEC EQU   X'20'               FORCE CURSOR                                 
BFPASSKY EQU   X'10'               USE FIRSTKEY FOR PASSIVES                    
FIRSTKEY DS    CL(L'RMKGKEY)                                                    
...
LSTCWHO  DS    CL3                                                              
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'139REDAR18FIX02/07/00'                                      
         END                                                                    
