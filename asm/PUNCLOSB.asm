*          DATA SET PUNCLOSB   AT LEVEL 025 AS OF 05/01/02                      
*PHASE PUNCLOSB,*,NOAUTO                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025PUNCLOSB  05/01/02'                                      
         END                                                                    
