*          DATA SET REREPSW03B AT LEVEL 037 AS OF 05/01/02                      
*PHASE RESW02C,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
*INCLUDE QSORT                                                                  
         TITLE 'REREPSW03B (RESW03) --- BUY TIMER'                              
*                                                                               
********************************************************************            
*                                                                  *            
*        REREPSW03B -- BUY TIMER                                   *            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
* MAY28/97 (BU ) --- ORIGINAL ENTRY                                *            
*                                                                  *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
         ...
         SPACE 4                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'037REREPSW03B05/01/02'                                      
         END                                                                    
