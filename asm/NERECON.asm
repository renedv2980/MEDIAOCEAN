*          DATA SET NERECON    AT LEVEL 023 AS OF 06/07/11                      
*PHASE NERECONA                                                                 
*INCLUDE REGSAVE                                                                
*INCLUDE PRINTER                                                                
*INCLUDE PRINT                                                                  
...
*INCLUDE CLUNPK                                                                 
*INCLUDE UNLDDEFN                                                               
         TITLE 'NERECON - UNTFILE RECONSTRUCT PROGRAM'                          
NERECON  CSECT                                                                  
*                                                                               
QUNTFIL  EQU   X'2A'                                                            
*                                                                               
         NBASE 0,NERECON,=V(REGSAVE)                                            
*                                                                               
         L     RC,=A(RECONWKC)                                                  
         USING RECONWK,RC                                                       
*                                                                               
         L     R8,=V(LDDEFN)       ASSUME PRTFILE BEING RECONSTRUCTED           
...
*                                                                               
         ...
         B     OPEN                                                             
*                                                                               
SORTCARD DC    CL80'SORT FIELDS=(5,  ,A),FORMAT=BI'                             
...
*                                                                               
OP2      LAY   RF,FKEY                                                          
         CLC   0(L'ROLDKEY,RF),ROLDKEY                                          
         BL    OP6                                                              
         BH    OP8                                                              
*                                                                               
         CLI   0(RF),X'FF'         TEST RECV/FILE AT EOF                        
         BE    OPDONE                                                           
         B     OP8                                                              
*                                                                               
* FILE LOW - WRITE FILE                                                         
...
*                                                                               
OP8A     LAY   RF,FKEY                                                          
         CLC   0(L'ROLDKEY,RF),RKEY  TEST REC PREVIOUSLY ON FILE                
         BNE   OP8B                NO                                           
*                                                                               
...
*                                                                               
         LAY   RF,FKEY                                                          
         CLC   ROLDKEY,0(RF)       TEST REC ADDED TODAY                         
         BE    OP8D                NO                                           
...
OPDONE   CLOSE (FILEOUT,)                                                       
         SPACE 2                                                                
         MVC   LINE,=PL2'75'                                                    
         MVC   TITLE(19),=C'UNTFILE RECONSTRUCT'                                
*                                                                               
         LA    R3,CNTRS                                                         
         LA    R4,18                                                            
         LA    R5,CNTRSX                                                        
...
RLEN     DS    H                   LOGICAL IOCS LEN                             
         DS    H                                                                
ROLDKEY  DS    CL20     ***** HARD CODE KEY LENGTH HERE *****                   
RSEQ     DS    XL4                                                              
RSPARE   DS    CL4                                                              
       ++INCLUDE DMRCVRHDR                                                      
RKEY     DS    0C                                                               
...
RECONWKC CSECT                                                                  
       ...
       ++INCLUDE DMLDDEFN                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'023NERECON   06/07/11'                                      
         END                                                                    
