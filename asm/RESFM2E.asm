*          DATA SET RESFM2E    AT LEVEL 104 AS OF 03/18/10                      
*PHASE T8182EA,*                                                                
...
*                                                                               
* SPECIAL FOR FOX STATION SALES (FB), SKIP CONTRACT IF CONTRACT TYPE            
* IS 'Y'                                                                        
         CLC   =C'FB',RCONKREP                                                  
         BNE   UPDT110                                                          
         CLI   RCONTYPE,C'Y'                                                    
...
*                                                                               
         OI    1(R2),X'20'         NOT ENOUGH COMMENTS HERE - JRD               
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,X'12'                                                     
         BAS   RE,GETEL                                                         
...
DISK80   DS    0H                                                               
         ...
         BH    DISK85              YES - USE OVERRIDE LENGTH                    
...
* COMMENT LINE 2                                                                
         ...
         LA    R1,63               SET MAX LENGTH OF ELT                        
         CLI   RCONBCLN,63         COMMENT > MAX LEN?                           
         BH    DISK95              YES - USE OVERRIDE LENGTH                    
         ZIC   R1,RCONBCLN         NO  - USE ELEMENT LENGTH                     
DISK95   EQU   *                                                                
         ZIC   R1,RCONBCLN                                                      
         SH    R1,=H'3'                                                         
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'104RESFM2E   03/18/10'                                      
         END                                                                    
