*          DATA SET ACBAT3DB   AT LEVEL 045 AS OF 10/27/04                      
*PHASE T61B3DBA                                                                 
...
*                                                                               
         CLI   CSACT,ACTCHA        PREPARE CSOLINE FOR ITEM/CHANGE              
         BE    MUL00                                                            
         CLI   CSACT,ACTDEL        OR ITEM/DELETE                               
         BNE   MUL                                                              
*                                                                               
MUL00    OC    CSOLINE,CSOLINE     ONLY IF WE DON'T HAVE IT                     
         BNZ   MUL                                                              
         SR    R0,R0                                                            
         LA    RF,TBARFST-TBARECD(R2)                                           
         USING BIAELD,RF                                                        
         CLI   BIALN,BIALN2Q       HAVE THE LINE #?                             
         BNE   MUL                                                              
         MVC   CSOLINE,BIASIS                                                   
*                                                                               
...
*                                                                               
         ...
         BNE   MUL5                NO                                           
         BRAS  RE,ERASE            YES-CLEAR LOWER SCREEN                       
*                                                                               
MUL5     L     R2,ADETH                                                         
...
*                                                                               
         ...
         BAS   RE,VEN                                                           
*                                                                               
MUL6J    LA    R2,ATSACC2H                                                      
         CLI   5(R2),0                                                          
         BE    MUL7                                                             
         MVI   TYPE,C'E'                                                        
         BAS   RE,VEN                                                           
*                                                                               
MUL7     BAS   RE,EDT              MANAGE THE EDIT                              
*                                                                               
MUL8     LA    R2,ATRDOCH                                                       
         CLI   TWASCRN,X'E1'                                                    
         BE    *+8                                                              
...
PF20     CLI   PFKEY,PFK11         TEST PF11=ERASE SCREEN                       
         BNE   PFR                                                              
         CLI   CSACT,ACTDSP        ARE WE DISPLAYING?                           
         BE    PFX                 YES, PFK11 SOMETHING DIFFERENT               
         CLI   CSACT,ACTCHA        ARE WE CHANGING?                             
         BE    PFX                 YES, PFK11 SOMETHING DIFFERENT               
         CLI   CSACT,ACTDEL        ARE WE DELETING?                             
         BE    PFX                 YES, PFK11 SOMETHING DIFFERENT               
*                                                                               
PF21     BRAS  RE,ERASE                                                         
*                                                                               
...
EDT      NTR1  ,                                                                
         ...
         MVI   CSOLINE,1                                                        
*                                                                               
EDT0     LA    R6,2                R6=N'DETAIL LINES ON SCREEN                  
         CLI   TWASCRN,X'E1'       TEST FOR FIRST SCREEN                        
         BE    *+8                                                              
         LA    R6,3                                                             
*                                                                               
...
EDT5     LA    R3,4(R3)            NEXT FIELD POINTER                           
         BCT   R5,EDT4                                                          
         CLI   CSACT,ACTCHA        NEED THE OTHER LINES FOR CHANGE              
         BE    EDT10                                                            
...
PROC     NTR1  ,                                                                
         ...
         ZAP   CDAMNT,=P'0'                                                     
*                                                                               
PROC2    MVC   FLD,BCSPACES        CLEAR NAME FIELDS                            
         L     R2,ANAM1H                                                        
         BAS   RE,MOVEFLD                                                       
...
VEN4     CLI   SVCSHNUM,0         IS THERE A CASH ACCOUNT?                      
         ...
         BE    VEN10                                                            
         CLC   9(2,R2),=C'SR'     IS IT RECEIVABLE?                             
         BE    VEN10                                                            
*                                                                               
...
*                                                                               
VEN36    CLI   TWASCRN,X'EA'                                                    
         BE    *+12                                                             
         CLI   ATRACC2H+5,0       WAS EXP VENDOR INPUT?                         
         BE    VENX                                                             
         CLI   ATSACC2H+5,0                                                     
         BE    VENX                                                             
...
*                                                                               
         BRAS  RE,VALCD            FIND/VALIDATE CASH DISCOUNT A/C              
*                                                                               
PRODET20 GOTO1 =A(PROD),DMCB,(RC),RR=RELOA                                      
         BE    *+12                OK                                           
         L     R2,FVADDR                                                        
         B     ERRXIT                                                           
*                                                                               
...
*                                                                               
         ...
         EJECT                                                                  
*--------------------------------------------------------------                 
* SUB-ROUTINE TO PROTECT OR HIDE THE FIELDS                                     
*--------------------------------------------------------------                 
PROTHIDE NTR1  BASE=*,LABEL=*                                                   
         CLI   CSACT,ACTDSP        ONLY FOR DISPLAY, CHANGE & DELETE            
         BE    PRHD010                                                          
         CLI   CSACT,ACTCHA                                                     
         BE    PRHD010                                                          
         CLI   CSACT,ACTDEL                                                     
...
PRHD010  SR    R4,R4                                                            
         ...
         LA    R5,1                                                             
         LA    R2,ATRCLIH                                                       
         LA    R6,2                SET NUMBER OF LINES                          
         CLI   TWASCRN,X'E1'                                                    
         BE    *+12                                                             
         LA    R2,ATSCLIH                                                       
         LA    R6,3                SECOND SCREEN HAS 3 LINES                    
*                                                                               
PRHD020  BAS   RE,SETLIN                                                        
         CR    R4,R5                                                            
         BE    PRHD060                                                          
         MVC   FLD,BCSPACES                                                     
         LA    R3,ACLIH                                                         
...
PRHD030  L     R2,0(R3)                                                         
         CLI   CSACT,ACTDSP                                                     
         BNE   PRHD040                                                          
         BAS   RE,MOVEFLD          BLANK OUT LINES <> CURRENT LINE              
         B     PRHD050                                                          
*                                                                               
PRHD040  OI    1(R2),X'20'         PROTECT LINES <> CURRENT LINE                
         OI    1(R2),X'0C'         LOW INTENSITY                                
*                                                                               
PRHD050  OI    6(R2),X'80'                                                      
         LA    R3,4(R3)                                                         
         BCT   R0,PRHD030                                                       
*                                                                               
PRHD060  L     R2,ANEXT                                                         
...
*                                                                               
         ...
         OI    DLDSSTAT,X'40'                                                   
*                                                                               
PROD2    SR    R1,R1               GET NARRATIVE LENGTH                         
         ICM   R1,3,SVNARLEN                                                    
         BZ    *+6                                                              
         BCTR  R1,0                                                             
         EX    R1,*+4                                                           
...
*                                                                               
         ...
         AR    R8,R1                                                            
*                                                                               
PROD3    TM    ACOPSTAT,ACOXJOB    TEST FOR XJOB                                
         BZ    PROD4               NO                                           
*                                                                               
         USING SPDELD,R8                                                        
         ...
         AR    R8,R1                                                            
*                                                                               
PROD4    CP    CDAMNT,=P'0'        IS THERE DISCOUNT                            
         BE    PROD5               NO                                           
         CLI   SVCSHNUM,0          IS THERE A CASH ACCT?                        
         BNE   PROD5               YES - NO CD ALLOWED                          
...
*                                                                               
         USING SCIELD,R8                                                        
PROD5    TM    ACOPSTAT,ACOXJOB    TEST FOR XJOB                                
         BZ    PROD7               NO                                           
*                                                                               
         MVI   SCIEL,SCIELQ                                                     
         MVI   SCILN,SCILN1Q                                                    
...
*                                                                               
         ...
         DROP  R1                                                               
*                                                                               
PROD7    CLI   SVCSHNUM,0          IS THERE A CASH ACCOUNT?                     
         BNE   PROD9               YES, NO PAYABLE POSTING THEN                 
...
*                                                                               
         USING PAKELD,R8                                                        
PROD8    MVI   PAKEL,PAKELQ        PAYABLE ACCOUNT ELEMENT                      
         MVI   PAKLN,PAKLNQ                                                     
         MVC   PAKACC,SVCRACCT                                                  
         MVC   PAKOFF,SJOFFC                                                    
         OC    CRDOFF,CRDOFF                                                    
...
*                                                                               
         USING DLPOSTD,R8                                                       
PROD9    MVI   DLPSEL,DLPSEDRQ     DEBIT JOB                                    
         MVI   DLPSLEN,DLPSLNQ                                                  
         MVC   DLPSANAL,SPACES                                                  
...
*                                                                               
         USING ACOTHERD,R8                                                      
PROD30   MVC   ACOTEL(2),=X'230F'  BUILD 'OTHERS' ELEMENT FOR                   
...
*--------------------------------------------------------------                 
*                                                                               
PROD31   CP    CDAMNT,=P'0'                                                     
         BE    PROD32              CD FOR SUPPLIER                              
         CLI   SVCSHNUM,0          IS THERE A CASH ACCT?                        
         BNE   PROD32              YES - NO CD ALLOWED                          
         USING TRCASHD,R8                                                       
         ...
         AR    R8,R3                                                            
*                                                                               
PROD32   TM    ACOPSTAT,ACOXJOB                                                 
         BZ    PROD33                                                           
         MVC   0(L'TRSELEM,R8),TRSELEM                                          
         LA    R8,L'TRSELEM(R8)                                                 
*                                                                               
PROD33   CLC   SVCRACCT+1(2),=C'SR'                                             
         BNE   PROD34                                                           
         BAS   RE,RESTSR           REST OF THE SR POSTINGS                      
                                                                                
PROD34   BRAS   RE,ADDADB                                                       
         ...
         MVC   DLPSCRNM,SVACCTNM                                                
         CLC   SVCRACCT+1(2),=C'SR'                                             
         BE    PROD34A                                                          
         CLC   SVCRACCT+1(2),=C'SX'                                             
         BNE   PROD36                                                           
PROD34A  MVC   DLPSDBAC,SJJOBNUM   OR CLI/PRD/JOB FOR EXPENSE VENDORS           
         MVC   DLPSDBNM,SJJOBNAM                                                
         CLC   SVCRACCT+1(2),=C'SR'                                             
         BNE   PROD36                                                           
         MVI   DLPSEL,DLPSEDRQ     - DEBIT                                      
         MVC   DLPSCRAC,DLPSDBAC   CONTRA = PROD VENDOR                         
         MVC   DLPSCRNM,DLPSDBNM                                                
         MVC   DLPSDBAC,SVCRACCT   CR JOB - SJ                                  
         MVC   DLPSDBNM,SVACCTNM                                                
         MVC   DLPSCRAC(3),SPACES                                               
*                                                                               
PROD36   CLI   SVCSHNUM,0          IS THERE A CASH ACCOUNT?                     
         BE    PROD38              NO.                                          
*                                                                               
...
*                                                                               
         ...
         AR    R8,R3                                                            
*                                                                               
PROD42   CLI   PCONSULT,C'Y'       SHOULD WE POST TO 2C?                        
         BNE   PROD50              NO.                                          
*                                                                               
         USING DLPOSTD,R8                                                       
         TM    ACOPSTAT,ACOXJOB                                                 
...
*                                                                               
         ...
         B     PROD50              END                                          
*                                                                               
PROD50   TM    ACOPSTAT,ACOXJOB    TEST XJOB                                    
         BZ    PROD60              NO                                           
*                                                                               
         BRAS   RE,ADDADB                                                       
*                                                                               
...
PROD54   ZAP   EXCAMNT,INAMNT      SET POSTING AMOUNT                           
         ...
         ZAP   EXCDAMNT,CDAMNT                                                  
*                                                                               
PROD56   GOTO1 VEXCEL,EXCELD                                                    
         BNE   PRODX                                                            
*                                                                               
         L     R8,EXCADAY                                                       
*                                                                               
PROD60   MVI   0(R8),0             MARK END                                     
         LA    R8,1(R8)            END ADDR                                     
...
*                                                                               
PRODX    XMOD1 1                   RETURN                                       
         EJECT                                                                  
*--------------------------------------------------------------                 
*        POST REST OF THE SR POSTINGS                                           
*--------------------------------------------------------------                 
*                                                                               
RESTSR   NTR1                                                                   
         USING SPDELD,R8                                                        
         MVI   SPDEL,SPDELQ                                                     
         MVI   SPDLN,L'SJJOBNUM+1                                               
         MVC   SPDACCS(L'SJJOBNUM-1),SJJOBNUM+1                                 
         SR    R3,R3                                                            
         IC    R3,SPDLN                                                         
         AR    R8,R3                                                            
*                                                                               
         ...
         MVI   ACMTLEN,ACMTLNQ                                                  
         MVI   ACMTSYS,C'J'                                                     
         MVC   ACMTMED,SJJOBNUM+9        MEDIA CODE                             
         MVC   ACMTCLI(12),SJJOBNUM+3    CLI/PRD/JOB                            
         MVC   ACMTMOS,PMOS                                                     
         MVC   ACMTDSCP,SJJOBNAM                                                
         OC    ACMTDSCP,SPACES                                                  
         ZAP   DUB,CSHTOT                                                       
         MP    DUB,=P'-1'                                                       
         CVB   R0,DUB                                                           
...
* DDFLDIND                                                                      
       ...
       ++INCLUDE DDFLDIND                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'045ACBAT3DB  10/27/04'                                      
         END                                                                    
