*          DATA SET RELDBUY    AT LEVEL 020 AS OF 05/01/02                      
*PHASE RELDBUY                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
...
*                                                                               
         ...
         EDIT  RBUYKLIN,(3,P+16)                                                
         MVC   P+22(6),=C'ADDED:'                                               
         GOTO1 =V(DATCON),DMCB,(3,RBUYCREA),(5,P+30)                            
         MVC   P+40(6),=C'CHGED:'                                               
         GOTO1 =V(DATCON),DMCB,(3,RBUYCHGD),(5,P+48)                            
*                                                                               
         MVI   ELCODE,X'08'                                                     
         BAS   RE,GETEL                                                         
         BNE   DMXREC10                                                         
         MVC   P+60(13),=C'08 ELEM FOUND'                                       
*                                                                               
DMXREC10 DS    0H                                                               
         GOTO1 VPRINTER                                                         
         AP    CHANGE,=P'1'                                                     
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'020RELDBUY   05/01/02'                                      
         END                                                                    
