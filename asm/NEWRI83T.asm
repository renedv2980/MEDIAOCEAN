*          DATA SET NEWRI83T   AT LEVEL 003 AS OF 05/04/07                      
*          DATA SET NEWRI83    AT LEVEL 024 AS OF 10/29/97                      
*PHASE T32083A,+0                                                               
*INCLUDE CLPACK                                                                 
*INCLUDE CLUNPK                                                                 
*INCLUDE PRINT                                                                  
...
MYIO     DS    0D                                                               
**       DS    4048C                                                            
         DS    6048C      EXTENDED FOR CLEARANCE STATUS RECS                    
         EJECT                                                                  
         SPACE 2                                                                
*                                                                               
AUDITRD  DSECT                                                                  
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003NEWRI83T  05/04/07'                                      
         END                                                                    
