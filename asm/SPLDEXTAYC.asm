*          DATA SET SPLDEXTAYC AT LEVEL 142 AS OF 07/12/00                      
*PHASE SPEXTAYC,+0                                                              
*INCLUDE PRINT                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRNTBL                                                                 
...
*                         FOR ZENYA - KEEP CLIENT YC !!                         
*                                   - AND KEEP RECS WITH NO CLIENT              
************************>> KEEPS CLIENT LIST !! <<******************            
* PARAMETER LIST                                                                
*                                                                               
...
DMXREC10 CLI   0(R3),X'00'         AGY/CLT/PRD/EST/BILL                         
         ...
         BE    RECTYP6                                                          
* THIS IS WRONG... THESE ARE 0A37 & 0AB7                                        
...
RECTYP1  DS    0H                  XX XX A/M CLT CLT                            
         ...
         NI    BYTE,X'F0'                                                       
         CLI   BYTE,X'90'          TH = X'90'                                   
         BNE   DMXPURGE                                                         
         OC    3(2,R3),3(R3)       CLT                                          
         BZ    DMXKX               KEEP IF NO CLIENT                            
         LA    R5,3(R3)                                                         
         BAS   RE,CKHEXCLT                                                      
         BNE   DMXPURGE            KEEP IF IN LIST                              
         B     DMXKX                                                            
*                                                                               
...
SPGENESTD      DSECT                                                            
       ++INCLUDE SPGENEST                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'142SPLDEXTAYC07/12/00'                                      
         END                                                                    
