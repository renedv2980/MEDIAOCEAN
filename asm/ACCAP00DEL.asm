*          DATA SET ACCAP00DEL AT LEVEL 120 AS OF 05/01/02                      
*PHASE T61D00A                                                                  
*INCLUDE BMONVAL                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
...
*                                                                               
         BAS   RE,SYSINIT             INIT PROGRAM DEPENDENT VALUES             
*                                                                               
...
*                                                                               
         CLI   MODE,NEWSCR                                                      
         BNE   VUSR05                                                           
         CLI   PHSCREEN,X'E2'      STD HRS DISPLAY SCREEN?                      
         BNE   VUSR01                                                           
...
VUSR01   DS    0H                                                               
*                                                                               
VUSR02   CLI   RECNUM,RTEDT       IS THIS REC EDIT HRS?                         
         BNE   *+12                                                             
         CLI   SVREC,RTPER         AND WAS THE PREV REC PERSON?                 
         BE    VUSRX               YES-THEN DON'T FILL THE SCREEN               
         BAS   RE,FILLSCR          FILL IN ANY SCREEN FIELDS                    
         B     VUSRX                                                            
*                                                                               
VUSR05   CLI   OFFLINE,C'Y'        ALWAYS IF OFFLINE                            
         BE    VUSR10                                                           
         CLI   TWAFIRST,0          ELSE IF FIRST TIME IN                        
         BNE   VUSR20                                                           
VUSR10   BAS   RE,PRGINT           INITIALIZE PROGRAM                           
*                                                                               
VUSR20   CLI   TWAFIRST,0          IF FIRST TIME IN                             
         BNE   VUSR30                                                           
...
VUSR50   TM    TRANSTAT,RCHANG     IF RECORD CHANGE                             
         ...
         B     VUSR60                                                           
*                                                                               
VUSR55   DS    0H                  IF RECORD HASNT CHANGED                      
...
PFI8     CLI   PFTACT,C' '         TEST FOR ACTION CHANGE                       
         ...
         MVI   CONACTH+5,8         SET L'I/P - NOTE ONLY 5                      
*                                                                               
...
TSEL10   ZIC   R1,0(R2)            BUMP TO NEXT FIELD                           
         AR    R2,R1                                                            
         CLI   0(R2),0                                                          
         BE    TSELX               (E-O-S)                                      
...
VPF02    NI    PFXSTAT,X'FF'-PFXS2ND                                            
         ...
         OI    PFXSTAT,PFXS2ND                                                  
*                                                                               
VPF05    LA    R3,SCRTABL            TABLE OF SCREENS                           
         TM    PFXSTAT,PFXS2ND                                                  
         BZ    VPF10                                                            
...
*                                                                               
         ...
         DC    C'    ',AL1(0,0,0,0)                                             
         DC    X'03',AL1(RTTIM,ACTSEL),X'C130000081'                            
         DC    C'    ',AL1(0,0,0,0)                                             
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'120ACCAP00DEL05/01/02'                                      
         END                                                                    
