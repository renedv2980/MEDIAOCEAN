*          DATA SET SPREPWX02  AT LEVEL 006 AS OF 09/13/01                      
*          DATA SET SPREPMN02  AT LEVEL 002 AS OF 07/29/97                      
*PHASE SPWX02A                                                                  
*INCLUDE TIMVAL                                                                 
SPWX02   TITLE 'TRANSFER TRADE BUYS FROM WIM TO WESTERN TRADE'                  
SPWX02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,SPWX02,R8,RR=R2                                                
         ST    R2,RELO                                                          
...
*==================================================================*            
* FIND A SPOT AFTER REQUEST START DATE                             *            
*==================================================================*            
                                                                                
HDR10    DS    0H                  FIND DATE IN LAST 0B/0C ELEMENT              
...
HDR12    BAS   RE,NEXTEL                                                        
         ...
         CLC   RDATE,HALF                                                       
         BL    HDR12                                                            
         CLC   RPPRD,BPRD          MATCH PRODUCT                                
         BNE   HDR12               NO - IGNORE                                  
                                                                                
         L     R6,ADBUY                                                         
         USING BUYREC,R6                                                        
         XC    IO2L(14),IO2L                                                    
         LA    R3,IO2+10           POINT TO OUTPUT RECORD AREA                  
         CLI   RCWRITE,C'Y'                                                     
         BE    HDR30                                                            
         GOTO1 HEXOUT,DMCB,(R6),P1,13                                           
         GOTO1 REPORT                                                           
                                                                                
HDR30    NI    RECFLAG,X'FF'-NONEWHDR                                           
...
HDR50    DS    0H                                                               
         ...
         BH    HDR60                OPEN ANOTHER WORKER FILE                    
         BAS   RE,WRKRCLSE                                                      
         BAS   RE,WRKROPEN                                                      
                                                                                
HDR60    DS    0H                  MAKE SURE WE HAVE RIGHT EST RECORD           
         L     R5,ADEST                                                         
         USING ESTHDRD,R5                                                       
...
HDR120 DS      0H                                                               
         AHI   R5,-8               DEMO LENGTH                                  
         CHI   R5,8                DEMO LENGTH                                  
         BL    HDR130              CHECK IF ANY DEMOS LEFT                      
                                                                                
         LA    R2,8(R2)            POINT TO NEXT "FROM" DEMO                    
         B     HDR100                                                           
         DROP  R6                                                               
                                                                                
HDR130   TM    RECFLAG,NONEWHDR                                                 
         BO    MNBUY                                                            
...
ESTHDRD  DSECT                                                                  
       ++INCLUDE SPGENEST                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006SPREPWX02 09/13/01'                                      
         END                                                                    
