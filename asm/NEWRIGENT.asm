*          DATA SET NEWRIGENT  AT LEVEL 002 AS OF 05/01/02                      
*          DATA SET NEWRIGEN   AT LEVEL 012 AS OF 04/20/00                      
*PHASE T00A4AA,+0                                                               
...
VROW2    CLC   12(4,R4),=C'UDEF'   USER DEFINITION RECORDS                      
         ...
         BNE   BADROW                                                           
         SPACE 1                                                                
VROW2A   CLI   NDMYPOSO,C'H'       SPECIAL FOR HEADS                            
         BNE   VROW3                                                            
...
VROW3    CLC   12(4,R4),=C'VEND'   VENDOR NAME/CODE                             
         ...
         B     VROWNXT                                                          
         SPACE 1                                                                
VROW4    CLI   NDMYPOSO,C'M'       SPECIAL FOR MID                              
         BNE   VROWNXT                                                          
         OI    DRFIRST,X'80'       GENERATE FIRST STATEMENT                     
...
VCOL4B   CLI   DRATTRIB,C'I'       IS IT INVOICE HEADER KEYWORD?                
         BNE   *+8                                                              
         OI    NBVARIND,X'20'      YES/SET FLAG                                 
...
**       LA    R5,=C'DOWNHEAD'                                                  
**       GOTO1 =V(PRNTBL),DMCB,=C'FLT',0(R5),C'DUMP',12,=C'1D'                  
         BE    OPT67B                                                           
...
*        INCLUDE NEWRIFFD                                                       
       ...
       ++INCLUDE NETPQIND                                                       
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002NEWRIGENT 05/01/02'                                      
         END                                                                    
