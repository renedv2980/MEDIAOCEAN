*          DATA SET REREP1H09D AT LEVEL 009 AS OF 05/01/02                      
*PHASE RE1H02C,*                                                                
*INCLUDE GETBROAD                                                               
*INCLUDE ADDAY                                                                  
*INCLUDE GETDAY                                                                 
...
*                                                                               
         LA    RE,KEY                                                           
         XC    KEY,KEY                                                          
         MVI   KEY,X'08'           INSERT INV RECORD TYPE                       
...
*                                                                               
         MVC   P+1(12),=C'ADVERT REC :'                                         
         MVC   P+14(06),RADVKADV                                                
         MVC   P+24(2),RADVCATG                                                 
         GOTO1 REPORT                                                           
*                                                                               
         CLC   RADVCATG,=C'  '     ANY CATEGORY CODE?                           
         BH    SW020060            YES - CHECK FOR VALIDITY                     
...
SW020060 EQU   *                                                                
         ...
         MVC   KEY+25(2),RADVCATG  INSERT PRODUCT CATEGORY                      
         GOTO1 HIGH                                                             
         CLC   KEY(27),KEYSAVE     KEY ON FILE?                                 
         BE    SW020080            YES                                          
         MVC   P+1(21),=C'ADV CATG NOT ON FILE:'                                
         MVC   P+24(27),KEYSAVE                                                 
         GOTO1 REPORT                                                           
SW020080 EQU   *                                                                
...
RINVRECD DSECT                                                                  
       ++INCLUDE REGENINV                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009REREP1H09D05/01/02'                                      
         END                                                                    
