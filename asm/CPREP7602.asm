*          DATA SET CPREP7602  AT LEVEL 120 AS OF 05/01/02                      
*PHASE CP7602A                                                                  
*INCLUDE SORTER                                                                 
         TITLE 'CPREP7602- CPP- COST ANALYSIS'                                  
         PRINT NOGEN                                                            
CP7602   CSECT                                                                  
         NMOD1 0,CP7602,RR=R5                                                   
         L     RA,0(R1)                                                         
         LA    RC,2048(RA)                                                      
         LA    RC,2048(RC)                                                      
         USING CPWORKD,RA,RC                                                    
...
BK304    XC    SRREC,SRREC         BUILD PROTOTYPE RECORD                       
         ...
         MVC   SRTGT,CPKDEMO                                                    
         MVC   SRDEMO,CPKDEMO                                                   
         MVC   SRDPT,CPKDAYPT      LUMP ALL DPTS                                
         CLI   SRDPT,C'N'          CHANGE PRIME TO SORT HIGH                    
         BNE   *+8                                                              
         MVI   SRDPT,X'01'                                                      
         MVI   SRDPT,X'FF'         **LUMP ALL DPTS**                            
         MVI   SRSLN,X'FF'         AND LENGTHS                                  
         MVC   SRMKT,CPKMKT                                                     
...
*                                                                               
         ...
         USING CPERD,R4                                                         
         L     R5,NPERIODS                                                      
         MVI   TPERSW,C'N'         INDIVIDUAL PERIOS                            
*                                                                               
BK20C4   DS    0H                                                               
         MVC   SRDOL,CPCASH                                                     
         MVC   SRSPOT,CPSPOTS                                                   
...
PUTSORT  XC    SRREN,SRREN                                                      
         ...
         CLI   TPERSW,C'Y'                                                      
         BE    *+10                                                             
         MVC   SRMON,CPSTARTB+1    SET MONTH                                    
...
*                                                                               
         ...
         ST    RF,SRPNTW                                                        
*                                                                               
*        CLI   QOPT4,C'Y'          TEST TO USE MARKET LIST **NOOP               
*        BNE   SUPSL4                                                           
*        BAS   RE,MKTCHK           YES                                          
*        B     PUTSORT1                                                         
*                                                                               
...
*         XIT                                                                   
*                                                                               
SLNLST   DC    AL1(10,15,20,30,45,60,255)                                       
         EJECT                                                                  
...
SD1      DS    0H                                                               
         ...
         BNE   CPMR                 DO - REPORT                                 
         CLC   SRDPT,HLDDPT       DAYPART CHANGE                                
         BNE   CPMR                 DO - REPORT                                 
         CLC   SRMKT,HLDMKT                                                     
         BNE   CPMR                                                             
SD2      BAS   R9,FSLOT            FIND MONTH SLOT                              
         L     RE,SLOT                                                          
         MH    RE,=H'32'                                                        
         L     R4,DPAREA                                                        
         USING DPD,R4                                                           
         ...
         ST    RE,DPDIMP                                                        
*                                                                               
         CLI   SRMON,0             SAVE YEAR TOTALS                             
         BNE   SD4                                                              
         L     R1,SRDOLE                                                        
         M     R0,=F'10'                                                        
         L     RF,SRSPOT                                                        
         BAS   RE,DIVIDE                                                        
         ST    R1,CPSBAS           COST/SPOT                                    
*                                                                               
         L     R1,SRPNT                                                         
         M     R0,=F'1'                                                         
         L     RF,SRSPOT                                                        
         BAS   RE,DIVIDE                                                        
         ST    R1,PPSBAS          PNT/SPOT                                      
*                                                                               
SD4      DS    0H                                                               
         MVC   HOLDREC,SRREC                                                    
         B     PR1                                                              
         DROP  R4                                                               
         EJECT                                                                  
* FIND SLOT FOR CURRENT MONTH                                                   
FSLOT    DS    0H                                                               
         ZIC   R8,SRMON            MONTH IS SLOT                                
...
DPAREAC  CSECT                                                                  
       ...
       ++INCLUDE CPGENFILE                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'120CPREP7602 05/01/02'                                      
         END                                                                    
