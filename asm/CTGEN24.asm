*          DATA SET CTGEN24    AT LEVEL 006 AS OF 03/01/01                      
*                                                                               
*PHASE TA0B24A,*                                                                
*                                                                               
...
DISREC   L     R2,AIOAREA1         A(This Record)                               
         ...
         XC    APWORK,APWORK                                                    
*                                                                               
         MVI   APELEM,CTPANDLQ     GET PANBOOK ELEMENT                          
         GOTO1 AGETELS,CT7REC                                                   
         ICM   R1,15,APPARM        WAS EL FOUND                                 
         BZ    DREC200                                                          
         MVC   APWORK(32),2(R1)                                                 
         GOTO1 DISPFLD,SCRSORCH    DISPLAY THE SOURCE                           
*                                                                               
...
DREC220  LH    R1,APHALF           Length of a line has been                    
         CH    R1,=H'60'           Hard - Coded for now                         
         BNH   DREC230                                                          
         LA    R1,59               Move in 1 Screen Line of Data                
         EX    R1,*+4                                                           
         ...
         SH    R1,=H'60'           ..                                           
         STH   R1,APHALF           and save it..                                
         LA    R8,60(R8)           Next data in record                          
...
*                                                                               
         ...
         ICM   R1,15,APPARM        WAS EL FOUND                                 
         BZ    DISSELX                                                          
         MVC   LEPAN,2(R1)         SHOW PAN DETAIL                              
         DROP  R2                                                               
*                                                                               
DISSELX  B     EXIT                                                             
         DROP  R4                                                               
...
LEPAN    DS    CL32                                                             
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006CTGEN24   03/01/01'                                      
         END                                                                    
