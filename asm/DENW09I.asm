*          DATA SET DENW09I    AT LEVEL 146 AS OF 03/21/14                      
*PROCESS USING(WARN(15))                                                        
*PHASE DENW09IA                                                                 
*INCLUDE SMTP                                                                   
*-------------------------------------------------------------------*           
* FAST WEEKLY NAD CONVERSION                                        *           
* IPHASE: DENW09I                                                   *           
* OPHASE: DENW09O                                                   *           
*-------------------------------------------------------------------*           
         TITLE 'DEMO CONVERSION - FAST WEEKLY NAD'                              
         EJECT                                                                  
DENW09I  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,DENW09I,RA,R3,R4                                               
...
***********************************************************************         
RDR      DS    0H                                                               
         CLC   =C'NTI NAD REPORT',RDRRPT                                        
         BE    *+6                                                              
         DC    H'0'                                                             
         MVI   TAPETYP,C'N'        NAD                                          
         MVC   TAPWKMKT,=H'205'    FASTNAD WKLY                                 
...
*                                                                               
* THE ASSUMPTION IS THAT IT *PROBABLY* ISN'T CORRECT TO LOAD THE WEEKLY         
* DATA AFTER THE MONTHLY DATA HAS ALREADY BEEN LOADED. HOWEVER, WE'RE           
* NOT COMFORTABLE SAYING THAT IT IS *ALWAYS* INCORRECT TO DO SO.                
* THEREFORE, IF WE DETECT THAT THE MONTHLY DATA HAS BEEN LOADED, WE             
* ALLOW THE CONVERSION TO CONTINUE, BUT WE SEND A WARNING E-MAIL (AND           
* ISSUE A CONSOLE MESSAGE) SO THAT WE KNOW TO INVESTIGATE FURTHER. IF           
* IT IS DETERMINED THAT THE WEEKLY DATA SHOULD NOT HAVE BEEN LOADED,            
* THEN WE SHOULD SIMPLY RELOAD THE MONTHLY DATA. THAT WILL OVERWRITE            
* THE WEEKLY DATA THAT WE REGRETTED LOADING.                                    
*                                                                               
         BAS   RE,WARNMTH          SEND A WARNING EMAIL IF MONTHLY DATA         
*                                   WAS ALREADY LOADED                          
         BE    RDRX                IT WASN'T: THAT'S GOOD                       
*                                                                               
         GOTO1 VLOGIO,DMCB,X'FF000001',(L'SUBJECT,SUBJECT)                      
*                                                                               
RDRX     DS    0H                                                               
         B     EXIT                                                             
         EJECT                                                                  
...
*                                                                               
         LAY   R1,CRCITAB          GET MKT (ROW) DISPL INTO TABLE               
...
DUE20    LAY   R1,SLOTTAB          FIND DISPL TO DEMO CATEGORY                  
DUE22    CLI   0(R1),X'FF'                                                      
...
*                                                                               
* THIS IS A WEEKLY FILE, SO WE CREATE WEEKLY UNIVERSE RECORDS.                  
* IN ADDITION, WE CREATE A MONTHLY UNIVERSE RECORD THAT HAS THE SAME            
*  DATA AS THE WEEKLY RECORD, BUT WITH THE MONTHLY KEY. MONTHLY                 
*  RECORDS ARE NEEDED TO BUILD THE NAD UNIVERSE TABLE IN DATASPACE.             
*                                                                               
* THE MONTHLY RECORD WILL BE OVERRITEN WHEN THE MONTHLY BOOK COMES IN,          
*  BUT WE NEED THIS ARTIFICIAL RECORD TO CORRECTLY REPORT UNIVERSES             
*  FOR THE FAST WEEKLY NAD DATA BEFORE THE MONTHLY BOOK COMES IN.               
***********************************************************************         
RELUNV   DS    0H                                                               
...
*                                                                               
         CLI   MTHLYUNV,1                                                       
         BNE   RLUNV5                                                           
         BAS   RE,MTHLYBK          GET MONTHLY BOOK INTO INTBOOK                
         MVI   WKSFLG,C'N'         MEDIA FOR MONTHLY KEY                        
*                                                                               
RLUNV5   BAS   RE,LDCRCO           GET CORRECT CRCOTAB INTO FULL                
         L     RE,FULL                                                          
...
RLUNVX   MVI   BYPREAD,0           DONE RELS ALL UNV RECDS                      
         MVI   RELMKTB,0                                                        
         MVI   SUMPTR,0                                                         
         MVI   WKSFLG,C'W'         RESTORE MEDIA FOR WEEKLY KEY                 
         CLI   MTHLYUNV,1          ALREADY RELEASED MTHLY UNIV.EXIT             
         BE    READ40              PROCESS RECD IN RREC BUFFER                  
         MVI   MTHLYUNV,1                                                       
         B     RELUNV                                                           
         EJECT                                                                  
* *********************************************************************         
...
*                                                                               
         ...
         DROP  R9                                                               
*                                  RELEASE THE DEMOS                            
RLUSG4A  BAS   RE,LDCRCO           GET CORRECT CRCOTAB INTO FULL                
         L     RE,FULL                                                          
...
RLUSG5   L     R9,VCPRINT          RELEASE HUT RECORD                           
         ...
         B     BLDKEY                                                           
*                                                                               
RLHISUM  ZIC   RF,SUMPTR           NEXT SUMMARY CATEGORY                        
         LA    RF,1(RF)                                                         
         STC   RF,SUMPTR                                                        
...
*                                                                               
         ...
         LA    RE,1(RE)                                                         
         BCT   R0,*-16                                                          
         CHI   RF,1                IGNORE AVG WITH ONLY 1 DAY IN IT             
         BH    D4R07                                                            
         MVI   VARIOUS,0                                                        
...
*                                                                               
         CHI   R1,240              4-HOUR MAXIMUM SUPPORTED                     
         BNH   *+8                                                              
         LHI   R1,240                                                           
...
*                                  = 3 (38-52 MIN.)...ETC.                      
         ...
         SR    RE,RE                                                            
         D     RE,=F'15'                                                        
         CHI   RF,1                TEST FOR DUR OF AT LEAST ONE                 
         BH    *+8                                                              
         LA    RF,1                                                             
         STC   RF,INTDUR           DURATION IN QH                               
...
RELPRG   DS    0H                                                               
         ...
         MVC   INTIBOOK,TAPEBK                                                  
*                                                                               
RELP10   BAS   RE,LDCRCO           GET CORRECT CRCOTAB INTO FULL                
         L     RE,FULL                                                          
...
RELSUM   DS    0H                                                               
         ...
         MHI   RE,16                                                            
*                                                                               
         CLC   TAPEBK,=AL1(YR_2003,WEEK_36)    DATE BEFORE SEP1/2003?           
         BNL   *+12                                                             
         A     RE,=A(PTYPTAB)                                                   
         B     *+8                                                              
...
*                                                                               
         ...
         BL    INCRSUM                                                          
         LAY   R1,XCLIST           YES.SEARCH EXCLUDE LIST                      
...
RELSUM2  CLI   0(R1),C' '          LOOP THRU DAYPT POSSIBILES IN TABLE          
         ...
         B     RELSUM2                                                          
*                                                                               
         LAY   R1,SPCTYPS          SPC HANDLING FOR CERTAIN PRG TYPS            
...
*                                                                               
RELSUM2B DS    0H                                                               
         LAY   R9,PTDPNAME         SET PRG TYPE NAME                            
         CLC   INTBOOK,=AL1(YR_2003,WEEK_36)  RECORD DATE AFTER 9/1/03?         
         BL    *+10                                                             
         LAY   R9,PTDPNAS03        YES. USE NEW TABLE                           
*                                                                               
         XC    INTPNAME,INTPNAME                                                
...
RELSUM3A MVC   INTPNAME(25),2(R9)                                               
         ...
         CLC   INTBOOK,=AL1(YR_2003,WEEK_36)  RECORD DATE AFTER 9/1/03?         
         BL    *+10                                                             
         LAY   R9,PTYTAS03         YES. USE NEW TABLE                           
*                                                                               
         USING PTYTABD,R9                                                       
...
RELSUM3C MVC   INTSTIM,PTYSTIM     BUILD THE CONTROL DATA                       
         ...
         MVC   INTPNTI,DUB+2       SAVE SUMMARY PRG# AS 5 CHAR PWOS             
*                                  RELEASE THE DEMOS                            
RELSUM4A BAS   RE,LDCRCO           GET CORRECT CRCOTAB INTO FULL                
         L     RE,FULL                                                          
...
RELSUM6  ZIC   RE,RELMKTB                                                       
         ...
         B     BLDKEY                                                           
*                                                                               
INCRSUM  ZIC   RF,SUMPTR           NEXT SUMMARY CATEGORY                        
         LA    RF,1(RF)                                                         
         STC   RF,SUMPTR                                                        
...
OUTSL30  CLI   0(R9),X'FF'         END OF TABLE?--DONE SLOTTING UNIVS           
         BE    OUTSLX              DONE                                         
         ZIC   RF,0(R9)            SOURCE BUCKET (INPUT)                        
         MHI   RF,4                4BYTE BUCKETS                                
         AR    RF,R7               SOURCE                                       
         ZIC   R1,1(R9)            DESTINATION BUCKET POSITION (OUTPUT)         
         MHI   R1,4                4BYTE BUCKETS                                
         AR    R1,RE               DESTIN IN INTACCS                            
         MVC   0(4,R1),0(RF)       MOVE DEMO TO APPROPRIATE OUTPUT SLOT         
...
CNV25    MVC   PRVRSF,MKTBRK       NO, SAVE NEW TYPE OF RECD                    
         LAY   RE,DEMAREA          STORE RESULT OF PACKING HERE                 
...
*                                                                               
CNV40    DS    0H                                                               
         LAY   R1,PACKWT           CLEAR TO P'0' FOR NEXT TIME                  
         LA    R0,NDEMS*2          DEMS+UNIVS                                   
         ZAP   0(8,R1),=P'0'                                                    
         LA    R1,8(R1)                                                         
         BCT   R0,*-10                                                          
         XC    CURRDUR,CURRDUR                                                  
         LAY   RE,DEMAREA          CLEAR SAVE AREA FOR NEXT TIME                
         LA    RF,NDEMS*4*2                                                     
         XCEF                                                                   
         LA    RE,SAVEREC          RE PTS TO CURRENT KEY'S DEMOS                
*                                                                               
CNV70    DS    0H                                                               
         LAY   R1,PACKWT           PACKED WEIGHTED DEMOS                        
...
PDATA6   SR    RE,RE               CALCULATE AVERAGE DURATION                   
         ...
         LA    RF,1(RF)                                                         
         SRA   RF,1                                                             
         STCM  RF,3,PWK2DURM       RETURN AVE LONG DURATION      TED            
         CHI   RF,240              4-HOUR MAXIMUM SHORT DURATION                
         BNH   *+8                                                              
         LHI   RF,240                                                           
...
PROCD1A  CLC   =C'00',MITHLFID     NON-PUT & TOTAL DURATION?                    
         ...
         B     PROCDEM2                                                         
*                                                                               
PROCDEM0 LAY   R1,CRCITAB          GET THE CATEGORY INDEX                       
...
PROCDM2A OC    SVPROJ,ZEROS                                                     
         ...
         STCM  R1,15,RIHOMES*4(R7)                                              
*                                                                               
PROCDEM3 LAY   R1,SLOTTAB          FIND THE SLOT FOR DEMOS                      
...
***********************************************************************         
* ROUTINE TO CONVERT INTBOOK FROM WEEKLY BOOK TO MONTHLY BOOK                   
***********************************************************************         
...
*                                                                               
         USING NEWKSD,RE                                                        
MTLYBK10 CLI   0(RE),X'FF'                                                      
         BNE   *+6                                                              
         DC    H'0'               BOOK NOT FOUND IN DEMTABS UPDATE IT!          
         CLC   INTBOOK(1),NEWKSYR COMPARE ON YEAR                               
         BNE   MTLYBK30                                                         
         CLC   INTBOOK+1(1),NEWKSLST COMPARE ON END WEEK OF THE MONTH           
         BH    MTLYBK30                                                         
         MVC   INTBOOK+1(1),NEWKSMO  MOVE IN THE MONTH                          
         B     MTHLYBKX                                                         
                                                                                
MTLYBK30 LA    RE,NEWKSQ(RE)                                                    
         B     MTLYBK10                                                         
                                                                                
MTHLYBKX B     XIT                                                              
*                                                                               
***********************************************************************         
* SEND A WARNING EMAIL IF THE MONTHLY BOOK WAS ALREADY LOADED.                  
* IN GENERAL, THERE SHOULD BE NO REASON WHY A WEEKLY BOOK WOULD BE              
* LOADED AFTER THE FINAL MONTHLY BOOK HAS ARRIVED.  THE MONTHLY BOOK            
* OVERWRITES ALL THE PREVIOUSLY LOADED WEEKLY BOOKS FOR THAT MONTH.             
* RELOADING A WEEKLY BOOK COULD RESULT IN INCORRECT OR INCOMPLETE DATA.         
* FOR EXAMPLE, THE WEEKLY BOOKS DON'T HAVE UNIVERSES FOR ALL MARKET             
* BREAKS.                                                                       
***********************************************************************         
WARNMTH  NTR1                                                                   
*                                                                               
...
*                                                                               
         USING NEWKSD,RE                                                        
WARNMT10 CLI   0(RE),X'FF'                                                      
         BNE   *+6                                                              
         DC    H'0'               BOOK NOT FOUND IN DEMTABS UPDATE IT!          
         CLC   TAPEBK(1),NEWKSYR  COMPARE ON YEAR                               
         BNE   *+14                                                             
         CLC   TAPEBK+1(1),NEWKSLST  COMPARE ON END WEEK OF THE MONTH           
         BNH   *+10               FOUND THE MONTH THIS WEEK BELONGS TO          
         AR    RE,RF                                                            
         B     WARNMT10                                                         
*                                                                               
         LA    R5,KEY              READ FILE TO SEE IF MONTHLY BOOK             
         XC    KEY,KEY             WAS ALREADY LOADED                           
         USING PMKEY,R5                                                         
         MVI   PMCODE,C'Q'                                                      
         MVI   PMMEDIA,C'N'                                                     
         MVI   PMSRC,C'N'                                                       
         MVC   PMBOOK(1),NEWKSYR                                                
         MVC   PMBOOK+1(1),NEWKSMO   MONTHLY BOOK                               
         DROP  RE                                                               
         MVC   PMSTAT,=C'ABCPN'                                                 
         GOTO1 VDATAMGR,DMCB,(0,=C'DMREAD'),=C'NTIDIR',KEY,AOREC                
         CLI   8(R1),X'10'         WAS MONTHLY RECORD FOUND?                    
         BE    YES2                NO, MONTHLY BOOK NOT LOADED. GREAT!          
         CLI   8(R1),0             ANY OTHER DATAMGR ERROR IS FATAL             
         BE    *+6                 MONTHLY BOOK ALREADY LOADED                  
         DC    H'0'                                                             
*                                                                               
*SEND EMAIL                        SEND A WARNING EMAIL.                        
*                                                                               
         MVC   WRN1WK(2),MITSTART+3      PRINT WEEKLY BOOK                      
         MVC   WRN1WK+3(2),MITSTART+5                                           
         MVC   WRN1WK+6(2),MITSTART+1                                           
*                                        PRINT MONTHLY BOOK                     
         MVC   DUB(2),PMBOOK                                                    
         GOTO1 VDATCON,DMCB,(3,DUB),(9,WRN1MTH)                                 
*                                                                               
...
*                                                                               
         LAY   R2,WRN1TXT                                                       
WARNMT20 DS    0H                  ADD TO E-MAIL BODY                           
...
ASIDFLD  DC    F'0'                                                             
*                                                                               
SENDTO   DC    C'US-DEMOLOADTEAM@MEDIAOCEAN.COM,US-DEMOSTEAM@MEDIAOCEAN+        
               .COM '                                                           
SUBJECT  DC    C'*** WARNING *** WEEKLY NAD DATA WILL BE LOADED AFTER M+        
               ONTHLY NAD. '                                                    
SUBJJBNM DS    CL8                                                              
         DC    C'('                                                             
SUBJJBID DS    CL8                                                              
...
*                                                                               
WRN1TXT  DS    0D                                                               
         DC    CL80'**** WEEKLY NAD DATA IS BEING LOADED AFTER MONTHLY +        
               NAD DATA ****'                                                   
         DC    CL80' '                                                          
WRN1WK1  DC    C'NAD WEEKLY DATA WILL BE LOADED FOR '                           
WRN1WK   DC    CL8'MM/DD/YY'                                                    
         DC    CL(80-(*-WRN1WK1))'.'                                            
WRN1MTH1 DC    C'NAD MONTHLY DATA WAS ALREADY LOADED FOR '                      
WRN1MTH  DC    CL6'MMM/YY'                                                      
         DC    CL(80-(*-WRN1MTH1))'.'                                           
         DC    CL80' '                                                          
         DC    CL80'THE MONTHLY NAD DATA SHOULD BE THE BETTER DATA, AND+        
                THEREFORE SHOULD BE'                                            
         DC    CL80'LOADED LAST. PLEASE INVESTIGATE.'                           
         DC    CL80'IF IT IS DETERMINED THAT THIS WEEKLY DATA WAS LOADE+        
               D IN ERROR,'                                                     
         DC    CL80'RELOAD THE MONTHLY DATA. THAT WILL OVERWRITE THIS W+        
               EEKLY DATA.'                                                     
         DC    X'FF'                                                            
*                                                                               
CNWR1ST  DC    X'01'                                                            
...
MTHLYUNV DC    X'00'               MONTHLY UNIVERSE FLAG                        
*                                  1=CREATE ARTIFICIAL MONTHLY                  
*                                    UNIVERSE RECORD                            
...
DEMAREA  DS    (NDEMS*NMKTS)XL4     MKTBRKS*NDEMS*4BYTE BUCKETS EA              
         DS    (NDEMS)XL4           ONE EXTRA, JUST IN CASE                     
         EJECT                                                                  
MSU      EQU   8                                                                
MFR      EQU   0                                                                
...
GAADSPQ  EQU   156*4               DISP TO RAW ('F') GAA IMPS FOR NSS           
...
*                                                                               
CIDVR    EQU   105                DVR HOUSEHOLD   (5/2005)                      
*!! UPDATE NMKTS BELOW EVERY TIME YOU ADD A NEW MARKET BREAK                    
*                                                                               
NMKTS    EQU   106                 INCLUDES TOTAL SAMPLE=000                    
         EJECT                                                                  
**********************************************************************          
...
*                                                                               
         ...
         DC    AL2(CRDUAL50,CIDUAL50)  DUAL INCOME HH 40K+                      
         DC    AL2(CRDUAL75,CIDUAL75)  DUAL INCOME HH 75K+ (9/2003)             
         DC    X'FFFF',X'FFFF'                                                  
         SPACE 2                                                                
* TABLE TO CONVERT MARKET BREAKS TO OUTPUT SECTIONS                             
CRCOTAB  DS    0H                                                               
CRCO6B12 DC    AL1(YR_2007,WEEK_18)   MARKET BREAKS EFFECTIVE 04/30/07          
         DC    AL4(CRCO6901-CRCO6B12) LENGTH OF TABLE                           
                                                                                
         DC    AL2(CIDVR,CODVR),X'00'       DVR HOUSEHOLD                       
         DC    X'F0'                                                            
*                                                                               
CRCO6901 DC    AL1(YR_2005,WEEK_1)    MARKET BREAKS EFFECTIVE 12/27/04          
         DC    AL4(CRCO6724-CRCO6901) LENGTH OF TABLE                           
                                                                                
         DC    AL2(CIVGO,COVGO),X'00'       VIDEO GAME OWNER                    
         DC    AL2(CIIO125,COIO125),X'00'   125,000 PLUS                        
         DC    AL2(CIRENTH,CORENTH),X'00'   HOME IS RENTED                      
         DC    AL2(CIOWNH,COOWNH),X'00'     HOME IS OWNED                       
         DC    AL2(CICWPAY,COCWPAY),X'00'   WIRED DG CBL W/PAY                  
         DC    AL2(CICWNOPY,COCWNOPY),X'00' WIRED DG CBL W/O PY                 
         DC    X'F0'                                                            
*                                                                               
CRCO6724 DC    AL1(YR_2003,WEEK_36)   MARKET BREAKS EFFECTIVE SEP/2003          
         DC    AL4(CRCO0000-CRCO6724) LENGTH OF TABLE                           
                                                                                
         DC    AL2(CIDBS,CODBS),X'00'       DBS                                 
         DC    AL2(CIDVD,CODVD),X'00'       PRESENCE OF DVD                     
         DC    AL2(CIIU100,COIU100),X'00'   75,000-99,999                       
         DC    AL2(CIIO100,COIO100),X'00'   100,000 PLUS                        
         DC    AL2(CIIUDNA7,COIUDNA7),X'00' 75K+ & NON-ADULTS                   
         DC    AL2(CIIUDPM7,COIUDPM7),X'00' 75K+ & HOH IS POM                   
         DC    AL2(CIIUDCL7,COIUDCL7),X'00' 75K+ & COLLEGE                      
         DC    AL2(CIDUAL75,CODUAL75),X'00' DUAL INCOME HH 75K+                 
         DC    X'F0'                                                            
*                                                                               
...
*                                 COUNTY SIZE                                   
         DC    AL2(CICSA,COCSA),X'00' CS A                                      
         DC    AL2(CICSB,COCSB),X'00' CS B                                      
         DC    AL2(CICSCD,COCSCD),X'00' CS C+D                                  
*                                 CABLE                                         
         DC    AL2(CIPCBL,COPCBL),X'00' PAY CABLE                               
         DC    AL2(CIBCBL,COBCBL),X'00' BASIC CABLE                             
         DC    AL2(CINCBL,CONCBL),X'00' NO CABLE                                
         DC    AL2(CICPPAY,COCPPAY),X'00' CABLE PLUS & PAY                      
         DC    AL2(CICPNOPY,COCPNOPY),X'00' CABLE PLUS WITHOUT PAY              
         DC    AL2(CIBRDCST,COBRDCST),X'00' BROADCAST ONLY                      
*                                 HOUSEHOLD SIZE                                
         DC    AL2(CIHHS1,COHHS1),X'00' 1                                       
         DC    AL2(CIHHS2,COHHS2),X'00' 2                                       
         DC    AL2(CIHHS3O,COHHS3O),X'00' 3+                                    
...
*                                 INCOME                                        
         ...
         DC    AL2(CIIU75,COIU75),X'00' 60-74,999   --NEW 9/96                  
         DC    AL2(CIIO75,COIO75),X'00' OVER 75K    --NEW 9/96                  
*                                 SELECTED UPPER DEMOS                          
         DC    AL2(CIIUDNA,COIUDNA),X'00' 40K+ & NON-ADULTS                     
         DC    AL2(CIIUDPOM,COIUDPOM),X'00' 40K+ & POM                          
         DC    AL2(CIIUDCOL,COIUDCOL),X'00' 40K+ & COLLEGE                      
         DC    AL2(CIIUDNA5,COIUDNA5),X'00' 50K+ & NON-ADULTS (9/96)            
         DC    AL2(CIIUDPM5,COIUDPM5),X'00' 50K+ & POM        (9/96)            
         DC    AL2(CIIUDCL5,COIUDCL5),X'00' 50K+ & COLLEGE    (9/96)            
*                                 PRESENCE OF NON-ADULTS                        
         DC    AL2(CINAU18,CONAU18),X'00' ANY UNDER 18                          
         DC    AL2(CINAU12,CONAU12),X'00' ANY UNDER 12                          
         DC    AL2(CINAU06,CONAU06),X'00' ANY UNDER 6                           
         DC    AL2(CINAU03,CONAU03),X'00' ANY UNDER 3                           
         DC    AL2(CINA611,CONA611),X'00' ANY 6-11                              
         DC    AL2(CINA1217,CONA1217),X'00' ANY 12-17                           
*                                 TIME ZONE                                     
         DC    AL2(CITZEAST,COTZEAST),X'00' EASTERN                             
         DC    AL2(CITZCENT,COTZCENT),X'00' CENTRAL                             
         DC    AL2(CITZMP,COTZMP),X'00' MOUNTAIN AND PACIFIC                    
*                                                                               
         DC    AL2(CIVCR,COVCR),X'00' PRESENCE OF VCR                           
*                                                                               
         DC    AL2(CIREMOTE,COREMOTE),X'00' PRESENCE OF REMOTE CONTROL          
*                                 NUMBER OF TV SETS                             
         DC    AL2(CITV1,COTV1),X'00' 1                                         
         DC    AL2(CITV2,COTV2),X'00' 2                                         
         DC    AL2(CITV3,COTV3),X'00' 3                                         
         DC    AL2(CITV4O,COTV4O),X'00' 4+                                      
*                                 AGE OF HOH                                    
         DC    AL2(CIHO25U,COHO25U),X'00' UNDER 25                              
         DC    AL2(CIHO2534,COHO2534),X'00' 25-34                               
         DC    AL2(CIHO3554,COHO3554),X'00' 35-54                               
         DC    AL2(CIHO5564,COHO5564),X'00' 55-64                               
         DC    AL2(CIHO65O,COHO65O),X'00' 65+                                   
*                                 AGE OF HOH WITHIN HH SIZE                     
         DC    AL2(CIHO50U,COHO50U),X'00' 1-2 PERSONS, HOH UNDER 50             
         DC    AL2(CIHO50O,COHO50O),X'00' 1-2 PERSONS, HOH 50+                  
*                                 EDUCATION OF HOH                              
         DC    AL2(CIED8U,COED8U),X'00' UNDER 8 YEARS                           
         DC    AL2(CIED12U,COED12U),X'00' 1-3 YEARS HS                          
         DC    AL2(CIED12,COED12),X'00' 4 YEARS HS                              
         DC    AL2(CIED16U,COED16U),X'00' 1-3 YEARS COL                         
         DC    AL2(CIED16O,COED16O),X'00' 4+ YEARS COL                          
*                                 OCCUPATION OF HOH                             
         DC    AL2(CIOCWC,COOCWC),X'00' WHITE COLLAR                            
         DC    AL2(CIOCBC,COOCBC),X'00' BLUE COLLAR                             
         DC    AL2(CIOCNO,COOCNO),X'00' NOT IN LABOR FORCE                      
*                                 RACE                                          
         DC    AL2(CIRACEW,CORACEW),X'00' WHITE                                 
         DC    AL2(CIRACEB,CORACEB),X'00' BLACK                                 
...
*                                 PC OWNERSHIP                                  
         DC    AL2(CIPC,COPC),C'Q'   PC OWNER                                   
         DC    AL2(CINOPC,CONOPC),C'Q'  NOPC                                    
         DC    AL2(CIPCIA,COPCIA),C'Q'  PC W/INTERNET ACCESS                    
         DC    AL2(CIPCNOIA,COPCNOIA),C'Q'  PC W/INTERNET ACCESS                
*                                                                               
         DC    AL2(CIDUAL,CODUAL),X'00' DUAL INCOME HH 40K+                     
         DC    AL2(CIDUAL50,CODUAL50),X'00' DUAL INCOME HH 50K+                 
* COMPUTED SLOTS                                                                
         DC    AL2(CISO,COSO),X'00' SOUTH                                       
         DC    AL2(CIACBL,COACBL),X'00' ANY CABLE                               
         DC    AL2(CIHHS3O,COHHS3O),X'00' HH SIZE 3+                            
         ...
         DC    AL2(CICBLP,COCBLP),X'00'       CABLE+                            
         DC    X'FF'                                                            
         SPACE 2                                                                
CIGENTAB DS    0H                                                               
...
*        DEDEMCNVD                                                              
       ...
       ++INCLUDE DDMONYREQU                                                     
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'146DENW09I   03/21/14'                                      
         END                                                                    
