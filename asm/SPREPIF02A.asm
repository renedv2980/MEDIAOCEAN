*          DATA SET SPREPIF02A AT LEVEL 009 AS OF 05/01/02                      
*PHASE SPIF02A                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE COVAIL                                                                 
         TITLE 'SPIF02 - PRINT NINVS WITH NO SPOTS/DOLLARS'                     
         SPACE 2                                                                
***********************************************************************         
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'009SPREPIF02A05/01/02'                                      
         END                                                                    
