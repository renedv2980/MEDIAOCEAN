*          DATA SET TALDFIX10  AT LEVEL 028 AS OF 05/01/02                      
*PHASE TALDFI0A TALDFIX0                                                        
*INCLUDE SCANNER                                                                
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE TINVCON                                                                
*INCLUDE DATCON                                                                 
         TITLE 'TALDFIX10 - TALENT LOAD/DUMP FILE FIX MODULE'                   
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         MVI   ELCODE,TAPDELQ      LOOK FOR PAY DETAILS EL.                     
         BAS   RE,GETEL                                                         
         BNE   DMXKEEP                                                          
         USING TAPDD,R4                                                         
         TM    TAPDOPT3,TAPDOHNC   IF CORP HANDLING OVERRIDE BIT ON             
         BZ    DMXKEEP                                                          
         ...
         MVC   DUB(6),TLININV                                                   
         XC    DUB(6),=6X'FF'                                                   
         GOTO1 =V(TINVCON),DMCB,DUB,P+8,=V(DATCON)                              
         GOTO1 VPRINTER                                                         
         B     DMXKEEP                                                          
         SPACE 3                                                                
COUNT    DC    PL6'0'                                                           
...
*                                                                               
DMXEOF   DS    0H                                                               
         MVC   P(26),=C'# OF RECORDS WITH BIT ON ='                             
         EDIT  COUNT,(12,P+27),ALIGN=LEFT,COMMAS=YES,ZERO=NOBLANK               
         GOTO1 VPRINTER                                                         
         B     DMXIT                                                            
         SPACE 3                                                                
DELEL    NTR1                                                                   
...
*********INCLUDE TAGENFILE                                                      
       ...
       ++INCLUDE TAGENFILE                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'028TALDFIX10 05/01/02'                                      
         END                                                                    
