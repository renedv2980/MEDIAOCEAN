*          DATA SET NEPAY03S   AT LEVEL 044 AS OF 05/01/02                      
*PHASE T31303A,+0                                                               
...
LINGROSS DS    CL11                                                             
         DS    C                                                                
LINNET   DS    CL11                                                             
LINTOT   EQU   LINGROSS-7          POSITION FOR TOTALS LABEL                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'044NEPAY03S  05/01/02'                                      
         END                                                                    
