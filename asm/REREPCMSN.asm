*          DATA SET REREPCMSN  AT LEVEL 086 AS OF 05/01/02                      
*          DATA SET REREPCMSN  AT LEVEL 084 AS OF 08/08/89                      
*PHASE BLRCMSNA BLRCMSN3                                                        
*INCLUDE CARDS                                                                  
*INCLUDE PRINTER                                                                
*INCLUDE PRINT                                                                  
*INCLUDE DMDMGRL                                                                
*INCLUDE REGSAVE                                                                
         TITLE 'BLAIR COMMISSION REPORT'                                        
BLRCMSN  CSECT                                                                  
         ENTRY UTL                                                              
         PRINT NOGEN                                                            
         NBASE 0,BLRCMSN*,=V(REGSAVE),RA                                        
         L     R9,=V(CPRINT)                                                    
         USING DPRINT,R9                                                        
         XC    OFFNUM,OFFNUM                                                    
         XC    GRPNUM,GRPNUM                                                    
...
*                                  DO REST OF HEADLINES                         
         ...
         MVC   MID1(20),=C'JOHN BLAIR CO., INC.'                                
...
BC62     MVI   DONEBYTE,0                                                       
         ...
         CLC   ID(2),=C'BL'        TEST FOR BLAIR                               
         BE    BC63                                                             
         CLC   ID(2),=C'B1'        TEST FOR BLAIRSPAN                           
         BE    BC63                                                             
         CLC   ID(2),=C'TO'        TEST FOR TORBET                              
         BE    BC63                                                             
         CLC   ID(2),=C'JB'        OR RAR                                       
         BNE   BC62                SKIP IT                                      
...
PAMTS    DS    CL15                                                             
         ...
         ORG                                                                    
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'086REREPCMSN 05/01/02'                                      
         END                                                                    
