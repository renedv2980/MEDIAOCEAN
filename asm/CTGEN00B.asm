*          DATA SET CTGEN00B   AT LEVEL 049 AS OF 05/01/02                      
*PHASE TA0B00B,*                                                                
*                                                                               
*                                                                               
...
*        MVC   DDMQBHD_PROC_ID,DDMQBHC_PROCESS_TRANS                            
*        MVC   DDMQBHD_SOURCE_CODE,SPACES                                       
*        MVC   DDMQBHD_ROUTE_CODE,=CL8'TRNREQMQ'                                
*        MVC   DDMQBHD_MSG_CODE,=CL5'00001001'                                  
*        MVC   DDMQBHD_STATUS_CODE,=CL5'00000'                                  
*        LA    R4,DDMQBHD_STRUC_1_DATA                                          
*        USING DDMQTRND,R4                                                      
*        MVC   DDMQTRN_USER_ID(20),=CL20'RETURN DATA'                           
*        LA    R2,DDMQBHD_STRUC_1_LENQ                                          
*        LA    RE,DDMQTRN_MSG_1_LENQ                                            
*        AR    R2,RE                                                            
*        DROP  R4                                                               
*                                                                               
         XC    APWORK,APWORK                                                    
         MVC   APWORK(40),=CL40'TESTING PUTQ'                                   
         USING MQIOPD,R4                                                        
         LA    R4,APPARM                                                        
         LA    RF,=CL8'PUTQ'                                                    
         STCM  RF,7,MQPACMD                                                     
         ...
         LA    RF,40                                                            
         STCM  RF,15,MQPDBLN                                                    
         LA    RF,=CL48'DDMQB.LTTS.INPUT.LOCALQ'                                
         STCM  RF,15,MQPAQNM                                                    
         LA    RF,APDUB                                                         
         STCM  RF,15,MQPAERB                                                    
*                                                                               
...
*&&US                                                                           
         ...
         BNE   DLAC040                                                          
*                                                                               
DLAC035  CLI   0(R3),C'*'          TEST OFFICE/CLTGRP                           
         BNE   DLAC037                                                          
         MVC   APWORK(4),0(R3)                                                  
         B     DLAC040                                                          
*                                                                               
DLAC037  MVC   APPARM+4(4),=X'D9000A15' CLUNPK                                  
         L     RF,VCOLY                                                         
         GOTO1 (RF),APPARM,0                                                    
         L     RF,0(R1)                                                         
...
DLAC040  EQU   *                                                                
*&&                                                                             
DLAC050  CLI   RWORK,14            TEST PERSONNEL                               
         BNE   DLACX                                                            
         XC    APWORK,APWORK                                                    
         OC    2(2,R3),2(R3)                                                    
         BZ    DLACX                                                            
...
VLAC46   CLI   FVIFLD,C'*'                                                      
         BNE   VLAC048                                                          
         CLI   FVILEN,2            IF EXACTLY 2 BYTES IT'S AN OFFICE            
         BE    VLAC048             SO HANDLE AS BEFORE                          
         MVC   0(4,R3),FVIFLD      ELSE IT'S A CLIENT GROUP                     
         B     VLAC050                                                          
*                                                                               
VLAC048  MVC   APPARM+4(4),=X'D9000A14' CLPACK                                  
         L     RF,VCOLY                                                         
         GOTO1 (RF),APPARM,0                                                    
         L     RF,0(R1)                                                         
...
* FAFACTS                                                                       
       ...
       ++INCLUDE DDMQIOPD                                                       
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'049CTGEN00B  05/01/02'                                      
         END                                                                    
