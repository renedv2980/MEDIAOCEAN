*          DATA SET RELDUNNY   AT LEVEL 255 AS OF 05/01/02                      
*PHASE RELDUNNY,*                                                               
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
         TITLE 'RELDDARE - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
*******************************************************************             
*                                                                 *             
*  REMOVE CONTRACT TYPES EXCEPT FOR D, A, P, O AND W              *             
*                                                                 *             
*******************************************************************             
*                                                                               
         PRINT NOGEN                                                            
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'255RELDUNNY  05/01/02'                                      
         END                                                                    
