*          DATA SET REREPST0B2 AT LEVEL 093 AS OF 05/01/02                      
*PHASE REST02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE HEXIN                                                                  
...
*                                                                               
**NO!!   GOTO1 SALPROC,DMCB,(RC)   PROCESS SALESPERSON RECORDS                  
*                                                                               
...
ADVP0100 EQU   *                                                                
*                                                                               
         B     ADVP0140            ACCEPT ALL ADVERTISER RECORDS                
*                                                                               
...
**AGY                                                                           
**ADV                                                                           
         B     CONP0200            ACCEPT ALL ADVERTISERS                       
***                                                                             
         LA    R4,EXADVTAB         SET A(ADVERT TABLE)                          
CONP0180 EQU   *                                                                
         CLI   0(R4),X'FF'         END OF TABLE?                                
...
EXAGYTAB DS    0CL6                                                             
         ...
         DC    C'JWT NY'                                                        
         DC    C'DDA   '                                                        
**       DC    C'DFS   '           IN ORIGINAL EXTRACT                          
**       DC    C'DFS NY'           IN ORIGINAL EXTRACT                          
         DC    C'YR    '                                                        
         DC    C'YR  NY'                                                        
         DC    C'GREY  '                                                        
         DC    C'GREYNY'                                                        
...
RECORD   DS    CL4100                                                           
       ...
       ++INCLUDE REREPMODES                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'093REREPST0B205/01/02'                                      
         END                                                                    
