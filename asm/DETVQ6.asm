*          DATA SET DETVQ6     AT LEVEL 001 AS OF 02/25/08                      
*PHASE DETVQ6A                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE DATCON                                                                 
*INCLUDE PRINT                                                                  
...
*                                                                               
***********************************************************************         
* TVQ CONVERSION STARTING WITH THE 2008 SCHEDULE.                     *         
* FOR PREVIOUS SCHEDULES USE DETVQ05.                                 *         
***********************************************************************         
...
* 3 - ADULTS NEWS               INA3                                  *         
* 4 - ADULTS SPORTS             INA4                                  *         
* 5 - ADULTS LATE NIGHT         INA5                                  *         
* 6 - MEN PRIMETIME             INM1                                  *         
* 7 - MEN DAYTIME               INM2                                  *         
* 8 - MEN NEWS                  INM3                                  *         
* 9 - MEN SPORTS                INM4                                  *         
* 10- MEN LATE NIGHT            INM5                                  *         
* 11- WOMEN PRIMETIME           INW1                                  *         
* 12- WOMEN DAYTIME             INW2                                  *         
* 13- WOMEN NEWS                INW3                                  *         
* 14- WOMEN SPORTS              INW4                                  *         
* 15- WOMEN LATE NIGHT          INW5                                  *         
MAXFILQ  EQU   15                                                               
***********************************************************************         
DETVQ    CSECT                                                                  
         PRINT NOGEN                                                            
...
PRTABD   DSECT                     DSECT TO COVER TABLE OF PROGRAMS             
       ...
       ++INCLUDE DDMONYREQU                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'001DETVQ6    02/25/08'                                      
         END                                                                    
