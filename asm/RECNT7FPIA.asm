*          DATA SET RECNT7FPIA AT LEVEL 021 AS OF 05/01/02                      
*PHASE T8027FA,*                                                                
*INCLUDE OUTDAY                                                                 
*INCLUDE UNTIME                                                                 
         TITLE 'T8027F - RECNT7F - WIDE ORBIT EC CHANGES'                       
*                                                                               
*********************************************************************           
*                                                                   *           
...
*                                                                   *           
* FEB13/02 (BU ) --- OUT OF SERVICE:  PIANO VERSION                 *           
*                                                                   *           
*                    ***  END TOMBSTONE  ***                        *           
*********************************************************************           
*                                                                               
...
****>>>>                                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'021RECNT7FPIA05/01/02'                                      
         END                                                                    
