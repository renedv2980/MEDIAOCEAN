*          DATA SET GEGENCONS  AT LEVEL 011 AS OF 05/01/02                      
*PHASE T00A30A                                                                  
*INCLUDE GETIDS                                                                 
...
T00A30   CSECT                                                                  
         ...
         ST    RD,BASERD                                                        
         SPACE 1                                                                
         GOTO1 =A(INITIAL),DMCB,(RC),RR=GENCRELO                                
         L     RA,ATWA                                                          
...
ACT4     MVC   DUB+2(2),LISTSNAM   GENERATE BASE DISP FOR LA RF,0(0)            
         EX    R0,DUB              RF=A(LIST OPTION NAME)                       
         CLC   WORK(8),0(RF)                                                    
         BE    ACT6                                                             
         LA    R3,LISTLLQ(R3)                                                   
         CLI   0(R3),X'FF'                                                      
...
* LOAD REQUEST DISPLAY LOGIC (TFD800) *                                         
         ...
         AH    RF,=H'20000'        ALLOW ROOM FOR ROOT PHASE                    
         ST    RF,AOVERLAY                                                      
...
VPO1A    CLI   POPTSNAM,X'FF'      TEST EOT                                     
         ...
         EX    R0,DUB              RF=A(PRINT OPTION NAME)                      
...
VOUT10   DS    0H                                                               
*                                                                               
         GOTO1 =A(VALOUT),DMCB,(RC),RR=GENCRELO                                 
*                                                                               
VOUTX    DS    0H                                                               
*                                                                               
         EJECT                                                                  
...
VDEST10  DS    0H                                                               
*                                                                               
         GOTO1 =A(VALDEST),DMCB,(RC),RR=GENCRELO                                
*                                                                               
VDESTX   DS    0H                                                               
*                                                                               
         EJECT                                                                  
...
LOAD1B   GOTO1 =A(KEYMERGE),DMCB,(RC),RR=GENCRELO                               
...
LOAD2    L     R2,EFHKEY                                                        
         ...
         GOTO1 SCUNKEY,DMCB                                                     
         BAS   RE,CLEARFLD         CLEAR KEY FIELD                              
         B     LOAD6                                                            
         SPACE 1                                                                
...
CLEARFLD DS    0H                                                               
         ...
         BNO   *+8                                                              
         SH    R1,=H'8'                                                         
         EX    R1,CLROC            TEST IF ANYTHING IN FIELD                    
         BZR   RE                  DON'T BOTHER IF NOTHING THERE                
         EX    R1,CLRXC            ELSE GO AHEAD AND CLEAR IT                   
         OI    6(R2),X'80'         TRANSMIT IT                                  
         MVI   5(R2),0             AND SIMULATE NO INPUT LENGTH                 
         BR    RE                                                               
         SPACE 1                                                                
CLROC    OC    8(0,R2),8(R2)       TEST IF ANYTHING IN FIELD                    
CLRXC    XC    8(0,R2),8(R2)       CLEAR FIELD                                  
         EJECT                                                                  
...
LOAD8    CLI   PHEDIT,0            IS AN EDIT REQUIRED                          
         ...
         BE    LOAD9                                                            
         BAS   RE,ANYKEY           OR IF ANY KEY FIELDS ENTERED                 
         BE    LOAD9                                                            
...
CHANGE1  CLC   TWALREC,RECNUM      IF NEW RECORD TYPE                           
         ...
         BAS   RE,ANYKEY           SEE IF ANY KEY WAS INPUT                     
         BNE   CHANGE1B                                                         
...
SEL4     TM    0(R3),X'FF'-X'40'   LOOK FOR FIRST/NEXT SELECTION                
         ...
         SPACE 1                                                                
SEL6     ZIC   RE,LISTNUM          MOVE OUT DISK ADDRESS                        
         SR    RE,R0                                                            
...
LIST1    CLI   LISTSW,0                                                         
         BNE   LIST2                                                            
         BAS   RE,ANYKEY           IF KEY GOT INPUT AGAIN                       
         BNE   LIST2                                                            
...
LIST2    MVI   TWALACT,ACTLIST                                                  
         ...
         B     LIST2                                                            
         SPACE 1                                                                
         GOTO1 =A(ANYSELS),RR=GENCRELO IF ANY SELECTIONS WERE MADE              
******   BAS   RE,ANYSELS          IF ANY SELECTIONS WERE MADE                  
...
LIST14   LR    R3,R2                                                            
         ...
         BAS   RE,CLEARFLD         CLEAR ALL FIELDS ON THIS LINE                
         BAS   RE,BUMP                                                          
         CR    R2,R3                                                            
         BL    *-10                                                             
         BAS   RE,TESTSEL          IF SELECT FIELD PRESENT                      
...
*                                                                               
         GOTO1 REQTWA,DMCB,(RA),IO,ARFPBLK,(X'80',ACOMFACS),BLOCK,     X        
               EFHWHEN             ADD TO FILE                                  
*                                  CHECK FOR RFP ERRORS                         
         L     RE,ARFPBLK          POINT TO RFP CONTROL BLOCK                   
...
REP60    OC    VPRINT,VPRINT                                                    
         ...
         BZ    *+8                                                              
         MVI   DMCB+12,C'B'                                                     
         GOTO1 REQTWA,DMCB,(3,(RA)),IO,VPRINT                                   
         SPACE 1                                                                
...
CONP2    MVI   MODE,PRINTREP                                                    
         ...
         BNE   CONPX                                                            
*&&US                                                                           
         CLI   TWAWHEN,5           ALL SOONS MUST HAVE SOME OUTPUT              
         BE    CONP5                                                            
         CLI   TWAWHEN,2                                                        
         BE    CONP5                                                            
...
CONP5    DS    0H                                                               
*&&                                                                             
         MVC   P,SPACES            SET TO DISPLAY NOTHING TO REPORT MSG         
...
LOOKUP3  ZIC   R0,LRECACT                                                       
         ...
         SPACE 1                                                                
LOOKUP4  GOTO1 TSECBLK,(R3)        TEST SECURITY BLOCK                          
         BNE   LOOKUP3                                                          
...
LKR2     CLC   0(3,R3),WORK        NOW LOOK UP X'03' ENTRY                      
         BNE   LKR4                                                             
         GOTO1 TSECBLK,(R3)        TEST SECURITY BLOCK                          
         BNE   LKR3                                                             
         CLI   LRECACT,12          IF L'RECACT ENTRY IS GT 12                   
         BNH   LKRX                                                             
         OC    SECMASKS,SECMASKS   AND SECURITY BIT MASK(S) DEFINED             
...
*                                                                               
TBLK10   GOTO1 SECRET,DMCB,((R4),ASECBLK),(RF)                                  
*                                                                               
         B     XIT                 SECRET RETURNS CC                            
         EJECT                                                                  
*              UTILITY ROUTINES                                                 
         SPACE 1                                                                
LOADEM   NTR1                                                                   
...
LOADEMA  GOTO1 CALLOV,DMCB,,,0                                                  
         ...
         SPACE 1                                                                
LOADEMB  L     R1,DMCB                                                          
         LTR   R3,R3               TEST LOAD ADDRESS GIVEN                      
         BNZ   *+6                                                              
         LR    R3,R1               NO - SET LOADED ADDRESS IN R3                
         CR    R1,R3                                                            
         BE    *+6                                                              
         ...
         SRL   R1,3                                                             
         SLL   R1,3                                                             
         ST    R1,AOVERLAY         GET A(NEXT DOUBLE WORD)                      
         B     LOADEMX                                                          
         SPACE 1                                                                
...
*&&UK                                                                           
         ...
         BO    YES                 YES - TREAT AS KEY DATA INPUT                
*&&                                                                             
         L     R2,ATWA                                                          
         LA    R2,64(R2)                                                        
         SPACE 1                                                                
...
*                                                                               
         L     RD,SYSRD                                                         
****     MVI   TWAFIRST,1          MEL & KEN REMOVED THIS                       
         SPACE 2                                                                
XIT      XIT1                                                                   
...
AS3      CLI   0(R4),X'FF'                                                      
         ...
         EX    R0,DUB              RF=A(SINGLE CHR SELECT CODE)                 
         CLC   8(1,R2),0(RF)                                                    
         BE    *+12                                                             
         LA    R4,SELTABLQ(R4)                                                  
         B     AS3                                                              
...
AS3B     TM    GENSTAT3,OKVALSEL   TEST OK TO VALIDATE SELECT CODES             
         ...
         EX    R0,DUB              RF=A(SELECT ACTION NAME)                     
...
VPUTREC  MVC   COMMAND(6),=C'PUTREC'                                            
         BAS   RE,CHAACTIV         UPDATE ACTIVITY                              
         CLI   TWAWRITE,C'N'                                                    
         BE    XIT                                                              
...
VADDREC  MVC   COMMAND(6),=C'ADDREC'                                            
         BAS   RE,ADDACTIV         ADD AN ACTIVITY ELEMENT                      
         CLI   TWAWRITE,C'N'                                                    
         BE    XIT                                                              
...
*              EXITS                                                            
         SPACE 1                                                                
VERREX   L     R4,AERRAREA         ERRORS EXIT HERE                             
...
VERREXB1 GOTO1 GETTXT,GETTXTCB     CTL BLOCK MUST BE DEFINED                    
         SPACE 1                                                                
VERREX2  CLI   ACTNUM,ACTCHA       IS THIS A CHANGE ?                           
         BNE   VERREXC             NO - SKIP                                    
...
INITD2   LA    R2,64(RA)                                                        
         ...
         ST    R2,AREPINFO                                                      
*                                                                               
         TM    GENSTAT1,NOSETEFH   DON'T BOTHER - APPLICATION DID IT            
         BO    INITEX                                                           
...
VALDEST2 BAS   RE,CTREAD           READ ID RECORD                               
         ...
         GOTO1 =V(GETIDS),DMCB,(C'D',AIO),0,(R5),RR=GENCRELO                    
         CLI   DMCB,0                                                           
...
KEYM2    CLI   0(R4),0             TEST END-OF-(OLD)SCREEN                      
         ...
         BNE   KEYM3                                                            
         LR    R1,RF                                                            
         SH    R1,=H'9'            CONTENTS OF TAG FIELD                        
...
*                                                                               
         ...
         BZ    *+8                                                              
         SH    R0,=H'8'            R0=L'OLD DATA FIELD + IT'S HEADER            
         ZIC   R1,0(R6)                                                         
         TM    1(R6),X'02'                                                      
         BZ    *+8                                                              
         SH    R1,=H'8'            R1=L'NEW DATA FIELD + IT'S HEADER            
         CR    R0,R1                                                            
         BNE   KEYM3                                                            
*                                                                               
         LR    R3,R6               MOVE IN KEY DATA                             
         LR    R4,R5                                                            
         SH    R1,=H'5'            MOVEING SOME INDICES AND DATA                
         EX    R1,KEYMVC                                                        
...
* GEGENRFPD                                                                     
       ...
       ++INCLUDE GEGENRFPD                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'011GEGENCONS 05/01/02'                                      
         END                                                                    
