*          DATA SET SPREPR502C AT LEVEL 008 AS OF 05/01/02                      
...
*  -------                                                           *          
*                                                                    *          
*  AUG04/99 (BU ) --- >INITIAL DEVELOPMENT                           *          
*                                                                    *          
*  FEB02/00 (BU ) --- >RESEQUENCE SORT KEY, ADJUST PROCESSING        *          
*                                                                    *          
*                      ***  END TOMBSTONE  ***                       *          
**********************************************************************          
*                                                                               
...
*        THIS OUT.  FOR NOW, KRG IS ALWAYS '62'.                                
*                                                                               
         MVI   KEY,X'62'           SCAN KEY TYPE                                
         GOTO1 HIGH                GET FIRST RECORD                             
         B     RMYN0040                                                         
RMYN0020 EQU   *                                                                
         GOTO1 SEQ                                                              
RMYN0040 EQU   *                                                                
         CLI   KEY,X'62'           ALL KEYS PROCESSED?                          
...
UDAR0020 EQU   *                                                                
         ...
         BNE   UDAR0040            NO                                           
         CLC   REC2(4),=X'FFFFFFFF' SPOT END OF FILE REACHED?                   
         BE    UDAR0800            YES - BOTH FINISHED: END JOB                 
UDAR0040 EQU   *                                                                
*                                                                               
*   SINGLE STATION TEST                                                         
         CLC   =C'KQBT',REC+8      ACCEPT IT                                    
         BE    TEST0020                                                         
         CLC   REC(4),=X'FFFFFFFF' REP END OF FILE REACHED?                     
         BE    TEST0020            YES - DON'T READ AGAIN                       
         BAS   RE,GETREP           REJECT IT                                    
         B     UDAR0020            GO BACK AND TEST                             
TEST0020 EQU   *                                                                
         CLC   =C'KQBT',REC2+8     ACCEPT IT                                    
         BE    TEST0040                                                         
         CLC   REC2(4),=X'FFFFFFFF' SPOT END OF FILE REACHED?                   
         BE    TEST0040            YES - DON'T READ AGAIN                       
         BAS   RE,GETSPOT          REJECT IT                                    
         B     UDAR0020            GO BACK AND TEST                             
TEST0040 EQU   *                                                                
*                                                                               
*   TEST END OF JOB                                                             
...
SCON#    DS    CL4     +13         REP CONTRACT NUMBER                          
SBUYLN#  DS    CL1     +17         SPOTPAK BUYLINE NUMBER                       
SREPBYL# DS    CL1     +18         REP BUYLINE NUMBER                           
...
STAHDRD  DSECT                                                                  
       ...
       ++INCLUDE SPREPPTBUF                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008SPREPR502C05/01/02'                                      
         END                                                                    
