*          DATA SET REGAV00X   AT LEVEL 041 AS OF 05/01/02                      
*PHASE T81300A,*                                                                
*INCLUDE UNBOOK                                                                 
*INCLUDE CLPACK                                                                 
*INCLUDE UNUPGR                                                                 
...
*                                  CL2 CODE FOR EOD HANDLING                    
         ...
         DC    X'03',AL1(07,12),X'D418000070',C'RCRC'  RDETAIL  REPORT          
...
VPF65    GOTO1 CALLPROG,BLOCK,(C'Y',0),=C'SINV',=C'CHANGE',0,          X        
               (4,CCONKSTA),(4,CCONINV),(8,CCONEFF),0                           
*                                                                               
...
*                                                                               
         DC    X'D7040000',A(VPF60)    INV MNT --> PF5 --> TRACK TRAN           
         DC    X'D7050000',A(VPF80)    INV MNT --> PF6 --> INV TRAN             
         DC    X'D7060000',A(VPF90)    INV MNT --> PF4 --> MASTRE RPT           
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'041REGAV00X  05/01/02'                                      
         END                                                                    
