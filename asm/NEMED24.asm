*          DATA SET NEMED24    AT LEVEL 005 AS OF 07/08/03                      
*          DATA SET NEMED24    AT LEVEL 013 AS OF 01/03/00                      
*          DATA SET NEMED24    AT LEVEL 159 AS OF 12/06/96                      
*PHASE T31E24A,+0                                                               
...
GETPRD   NTR1                                                                   
         ...
         BNE   GPSPLIT                                                          
*                                                                               
         LA    R1,2               ** PROD = POL(SPLIT NOT ACTIVE)               
         LA    R3,NBPRD                                                         
         LA    R4,PRDCD                                                         
...
GPNXT22  BCT   R1,GPOL                                                          
         B     GPX                                                              
*                                                                               
GPSPLIT  LA    R3,NBSPLPRN         ** SPLIT PRODUCTS                            
         CLI   0(R3),0                                                          
         BE    GP10                                                             
         L     R2,ANETWS4                                                       
         LA    R2,2000(R2)         PXZ 7/9/99                                   
...
WORKEND  EQU   *-WORKD                                                          
       ...
       ++INCLUDE FAFACTS                                                        
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005NEMED24   07/08/03'                                      
         END                                                                    
