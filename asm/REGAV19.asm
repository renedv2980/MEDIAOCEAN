*          DATA SET REGAV19    AT LEVEL 014 AS OF 05/14/09                      
*PHASE T81319C                                                                  
*INCLUDE INVDAY                                                                 
*INCLUDE REBKLST                                                                
*INCLUDE RECUP                                                                  
...
********************************************************************            
*  SEP15/05 (BU ) --- HANDLE 14TH WEEK OF QUARTER ON A COPY        *            
*                                                                  *            
*  MAY14/09 (SMY) --- SUPPORT NEW INVENTORY KEY                    *            
*                                                                  *            
*                                                                  *            
********************************************************************            
T81319   CSECT                                                                  
...
*                                                                               
         GOTO1 HIGH                                                             
         CLC   KEY(RINVKINV-RINVKEY),KEYSAVE    THRU RINVKSTA                   
         BE    VKEYX                                                            
*                                                                               
...
*                                                                               
         ...
         USING REINVREC,R6                                                      
*                                                                               
*SMY*    MVC   KEY(24),HDRKEY      COPY KEY UP TO SOURCE                        
         MVC   KEY(RINVKRSR-RINVKEY),HDRKEY  COPY KEY UP TO SOURCE              
*                                                                               
         MVI   RINVKRSR,C'Z'       GAV RATE RECORD                              
...
*                                                                               
         ...
         BNE   CR10                                                             
         MVC   RIAVAMT,LASTAMT     YES - USE LAST WEEK'S AMOUNT                 
         B     CR10                                                             
CR12     DS    0H                                                               
*                                                                               
         CLC   RIAVQTR,QTRHLD      THIS REQ. TO QUARTER?                        
...
*                                                                               
         ...
         MVC   LASTAMT,RIAVAMT     SAVE AS 'LAST WEEK AMOUNT'                   
         B     CR80                                                             
*                                                                               
CR20     DS    0H                                                               
         XC    ADJHLD,ADJHLD                                                    
...
*                                                                               
         ...
         USING REINVREC,R6                                                      
*                                                                               
*SMY*    MVC   KEY(24),HDRKEY                                                   
         MVC   KEY(RINVKRSR-RINVKEY),HDRKEY    UP TO SOURCE                     
...
*                                                                               
*                                                                               
LASTAMT  DS    F                   LAST WEEKLY AMOUNT                           
*                                                                               
...
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'014REGAV19   05/14/09'                                      
         END                                                                    
**PAN#1  CSECT                                                                  
         END                                                                    
*&&DO                                                                           
