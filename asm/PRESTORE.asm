*          DATA SET PRESTORE   AT LEVEL 034 AS OF 05/01/02                      
*PHASE PRESTORA PRESTORE                                                        
*INCLUDE PRINT                                                                  
*INCLUDE CARDS                                                                  
*INCLUDE HEXOUT                                                                 
*INCLUDE BINSRCH                                                                
...
*INCLUDE IJFVZZWZ                                                               
*INCLUDE REGSAVE                                                                
         TITLE 'PRESTORE -RESTORE DATA'                                         
*                                                                               
*            RETRIEVE DATA FROM AN OLD FILE                                     
*            COPIES ONLY RETRIEVED DATA                                         
*                                                                               
*            RESTORES CLIENTS,PRODUCTS,ESTS,BILLS,BUYS,BUCKETS                  
*                                                                               
*                                                                               
PRESTORE CSECT                                                                  
         NBASE 0,PRESTORE,=V(REGSAVE)                                           
         SPACE 2                                                                
         LA    R6,PRESTORE+4095                                                 
         LA    R6,1(R6)                                                         
         USING PRESTORE+4096,R6                                                 
...
EDT      DS    0H                                                               
         ...
         EDIT  (B4,ETBILLS),(7,P+27),COMMAS=YES                                 
         L     R0,ETBUYGRS                                                      
         EDIT  (R0),(14,P+43),2,COMMAS=YES,MINUS=YES                            
         L     R0,ETPAYGRS                                                      
         EDIT  (R0),(14,P+58),2,COMMAS=YES,MINUS=YES                            
         L     R0,ETBILGRS                                                      
         EDIT  (R0),(14,P+73),2,COMMAS=YES,MINUS=YES                            
         BAS   RE,PRNT                                                          
...
*                                                                               
         ...
         MVC   P+71(8),TODAY                                                    
         BAS   RE,PRNT3                                                         
         MVC   P+01(85),=C'AG M CLT PRD EST     BUYS   BILLS           X        
                   ORDERED           PAID         BILLED'                       
         BAS   RE,PRNT                                                          
         MVC   P+01(85),=C'-- - --- --- ---     ----   -----           X        
                   -------           ----         ------'                       
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034PRESTORE  05/01/02'                                      
         END                                                                    
