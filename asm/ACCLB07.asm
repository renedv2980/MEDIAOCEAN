*          DATA SET ACCLB07    AT LEVEL 066 AS OF 08/16/00                      
*PHASE T62107A                                                                  
...
SFRST02  L     RE,=A(VALOPT)                                                    
         ...
         BNE   EXITL                                                            
*                                                                               
SFRST30  CLC   LSOVER,BOWORK1      TEST CHANGE IN OPTIONS                       
         BE    EXITY                                                            
         CLC   SVLIST,BOWORK1      TEST CHANGE IN LIST TYPE                     
         BE    *+8                                                              
         OI    BCINDS2,BCIREBLS                                                 
         B     EXITH                                                            
         EJECT                                                                  
...
SVJOBMAX DS    CL12                MAXIMUM JOB CODE                             
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'066ACCLB07   08/16/00'                                      
         END                                                                    
