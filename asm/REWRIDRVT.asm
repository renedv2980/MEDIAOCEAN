*          DATA SET REWRIDRVT  AT LEVEL 005 AS OF 05/01/02                      
*          DATA SET REWRIDRVT  AT LEVEL 003 AS OF 09/08/97                      
*          DATA SET REWRIDRV   AT LEVEL 067 AS OF 07/30/97                      
*PHASE T82113C,+0                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
...
*        BH    XIT                                                              
         CLC   RECONEND,REQPSTRB                                                
         BL    XIT                                                              
*        CLC   REQPENDB,RECONSTR                                                
*        BL    XIT                                                              
         CLC   RECONSTR,REQPENDB                                                
         BH    XIT                                                              
         ...
         BH    XIT                                                              
TCT05    MVI   3(R2),1                                                          
         GOTO1 =V(PRNTBL),DMCB,=C'RECD',REAREC,C'DUMP',30,=C'1D'                
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'005REWRIDRVT 05/01/02'                                      
         END                                                                    
