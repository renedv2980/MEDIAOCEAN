*          DATA SET ACREPPT01  AT LEVEL 002 AS OF 08/17/00                      
*PHASE ACPT01A                                                                  
         TITLE 'ACPT01 - PST REPORT SPECS'                                      
ACPT01   CSECT                                                                  
         PRINT NOGEN                                                            
         FSPEC READ,ACCOUNTS                                                    
...
*                                                                               
         SPROG 0                                                                
         ACDEF H7,60,AC#PSTBA,14,R                                              
         ACDEF H7,75,AC#PSTO,14,R                                               
         ACDEF H7,94,AC#PCT,10,R                                                
         ACDEF H8,60,AC#CLICO,14,RU                                             
         ACDEF H8,75,AC#PSTO,14,RU                                              
         ACDEF H8,94,AC#PCT,10,RU                                               
*                                                                               
         SPROG 1                                                                
         ACDEF H7,60,AC#PSTBA,14,R                                              
         ACDEF H7,75,AC#PSTI,14,R                                               
         ACDEF H7,94,AC#PCT,10,R                                                
         ACDEF H8,60,AC#PSTBA,14,RU                                             
         ACDEF H8,75,AC#PSTI,14,RU                                              
         ACDEF H8,94,AC#PCT,10,RU                                               
*                                                                               
         SPROG 2,3                                                              
...
*        ACDDEQUS                                                               
       ...
       ++INCLUDE ACDDEQUS                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002ACREPPT01 08/17/00'                                      
         END                                                                    
