*          DATA SET RERPSW03N  AT LEVEL 002 AS OF 05/01/02                      
...
*                       CREATE A SINGLE FILE FROM IF/GP/   DATA,   *            
*                       AS NEW COMPANY 'XX'                        *            
*                                                                  *            
* ---------------------------------------------------------------- *            
* UPDATE HISTORY:                                                  *            
...
*                    REREPSW02B (DI/HN)                            *            
*                                                                  *            
* FEB24/97 (PXZ) --- BASED ON REREPSWO3                            *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
NEWREP   DC    CL2'IF'             NEW REP CODE                                 
REP1     DC    CL2'IF'             1ST REP                                      
REP2     DC    CL2'GP'             2ND REP                                      
REP3     DC    2X'FF'              3D REP  - NO 3D REP USE X'FFFF'              
...
RECORD   DS    CL1008                                                           
       ...
       ++INCLUDE REREPMODES                                                     
         ...
         SPACE 4                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'002RERPSW03N 05/01/02'                                      
         END                                                                    
