*          DATA SET REREPSKATB AT LEVEL 096 AS OF 05/01/02                      
*PHASE REST02A,*                                                                
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*INCLUDE BINSRCH2                                                               
...
*                                                                  *            
* OCT26/99 (BU ) --- PARSE " DELIMITED AGENCY/ADVERT CODES         *            
*                                                                  *            
*                    **  END TOMBSTONE  **                         *            
********************************************************************            
...
*                                                                               
         ...
         L     R4,AWRKBLK2                                                      
         CLI   12(R4),C'"'         DOUBLE-QUOTE DELIMITER?                      
         BNE   LDIR0090            NO                                           
         MVC   0(4,R1),13(R4)      YES - SKIP " FOR NEXT 4 CHARS                
         B     LDIR0095                                                         
LDIR0090 EQU   *                                                                
...
*                                                                               
         ...
         CLI   12(R4),C'"'         DOUBLE-QUOTE DELIMITER?                      
         BNE   LDIR0096            NO                                           
         MVC   6(4,R1),13(R4)      YES - SKIP " FOR NEXT 4 CHARS                
         B     LDIR0097                                                         
LDIR0096 EQU   *                                                                
...
MASTD    DSECT                                                                  
       ++INCLUDE DDMASTC                                                        
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'096REREPSKATB05/01/02'                                      
         END                                                                    
