*          DATA SET CTESS00    AT LEVEL 006 AS OF 05/01/02                      
*PHASE TA0E00A                                                                  
*                                                                               
*                                                                               
         TITLE 'CTESS00 - ESS CONTROL RECORD MAINTENANCE - CONTROLLER'          
ESS00    CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 WORKX-WORKD,**ESS0**,RA,R9,R8,CLEAR=YES,RR=RE                    
         LR    R7,RC                                                            
...
*                                                                               
         ...
         BE    HOOKOKEX                                                         
*                                                                               
         LA    RE,ESSRECH          SET CURSOR ON ERROR                          
         ST    RE,FVADDR                                                        
         ZIC   RF,ACMODE                                                        
         SLL   RF,2                                                             
         B     *+0(RF)                                                          
...
DISSYS2  CLI   0(RE),0             TEST E-O-T                                   
         ...
         B     DISSYSX                                                          
*                                                                               
DISSYS3  LA    RE,SYSLEX                                                        
         LA    RE,6(RE)                                                         
         USING SYSLSTD,RE          RE=A(EXTENDED SYSTEM LIST)                   
DISSYS3A CLI   0(RE),0             TEST E-O-T                                   
         BE    DISSYS4                                                          
         CLM   RF,1,SYSLNUM        MATCH ON SYSTEM NUMBER                       
         BE    *+12                                                             
         LA    RE,SYSLLEN(RE)      NO - BUMP TO NEXT TABLE ENTRY                
...
* FAFACTS                                                                       
       ...
       ++INCLUDE FAFACTS                                                        
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'006CTESS00   05/01/02'                                      
         END                                                                    
