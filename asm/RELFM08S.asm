*          DATA SET RELFM08S   AT LEVEL 194 AS OF 05/01/02                      
*PHASE T80408A,*                                                                
*INCLUDE NUMVAL                                                                 
*INCLUDE MEDGET                                                                 
*INCLUDE GETBROAD                                                               
...
REPF30   CLC   0(1,R4),RREPFMON                                                 
         ...
         LA    R4,4(R4)                                                         
         B     REPF30                                                           
REPF40   MVC   8(3,R2),1(R4)                                                    
         FOUT  (R2)                                                             
         SPACE 1                                                                
*                                                                               
*- DISPLAY 30 PROFILES                                                          
REPF50   LA    R4,RREPPROF                                                      
...
REPF93   EQU   *                                                                
         ...
         BAS   RE,NEXTUF                                                        
         BCT   R5,REPF93                                                        
         B     REPF91               LOOK FOR A DIFFERENT EL                     
*                                                                               
REPF94   EQU   *                                                                
         LA    R2,RPMSPAGH                                                      
         MVC   8(2,R2),2(R3)                                                    
...
*                                                                               
         ...
         BAS   RE,SWIREP                                                        
         BNZ   MYERR                                                            
REPF99   EQU   *                   GET LOGO FILENAME FROM '06' ELEM             
         LA    R2,RPMLOGOH                                                      
         XC    RPMLOGO,RPMLOGO                                                  
         FOUT  (R2)                                                             
         GOTO1 VGETEL,DMCB,(X'06',IOAREA),DMCB+4                                
         CLI   DMCB,X'FF'                                                       
         BE    REPF100             NO ELEMENT FOUND                             
         L     R6,DMCB+4           A(ELEM)                                      
         MVC   RPMLOGO,2(R6)                                                    
*                                                                               
REPF100  EQU   *                                                                
...
*                                                                               
         ...
         FOUT  (R2)                                                             
*                                                                               
         BAS   RE,GETPOINT         POINT PERSON EXPANSION                       
         DROP  R3                                                               
*                                                                               
PRDI0160 EQU   *                                                                
*                                                                               
...
*                                                                               
         ...
         BE    PRED0105            NO - CHECK FLIGHT DATES                      
*                                                                               
         OC    SPOTLOCK(2),SPOTLOCK   IS COUNTER ZERO?                          
         BZ    PRED0102               YES - ALLOWE CHANGES                      
         OC    8(4,R2),SPACES                                                   
         CLC   SVAGYOFF(7),8(R2)                                                
...
PRED0112 EQU   *                                                                
         ...
         BZ    PRED0115            NO - DON'T ADD AN ELEMENT                    
...
PRED0140 EQU   *                                                                
         ...
         B     MYERR                                                            
*                                                                               
PRED0160 MVC   LFMMSG(0),0(R3)     R3 = A(MSG TEXT)                             
         SPACE 2                                                                
PRED0180 EQU   *                                                                
*                                                                               
...
PRED0300 EQU   *                                                                
         OC    8(3,R2),SPACES                                                   
         MVC   RPRDNPNT,8(R2)                                                   
         BAS   RE,GETPOINT         VALIDATE/DISPLAY EXPAN                       
         BNZ   FLERR2                                                           
*                                                                               
...
*                                                                               
         ...
         BAS   RE,MOVE                                                          
         MVC   PRDSPS1(3),WORK                                                  
         GOTO1 TESTEST,DMCB,PRDSPS1H,SPOTSPL1                                   
         BNZ   MYERR                                                            
         LA    R2,PRDSPS2H                                                      
         CLI   5(R2),0                                                          
         BE    FLERR1                                                           
         BAS   RE,MOVE                                                          
         MVC   PRDSPS2(3),WORK                                                  
         GOTO1 TESTEST,DMCB,PRDSPS2H,SPOTSPL2                                   
         BNZ   MYERR                                                            
PRED0600 EQU   *                                                                
*                                                                               
         LA    R2,PRDSPEH                                                       
         ...
         BAS   RE,MOVE                                                          
         MVC   PRDSPE(3),WORK                                                   
         GOTO1 TESTEST,DMCB,PRDSPEH,SPOTEST#                                    
         BNZ   MYERR                                                            
...
SPOTDIR  NTR1                                                                   
         ...
         IC    R3,TERMNAL                                                       
         MVC   KEYSAVE,KEY                                                      
         GOTO1 VDATAMGR,DMCB,((R4),COMMAND),=C'SPTDIR  ',KEYSAVE,KEY   X        
               ((R3),0),0                                                       
         B     DMCHECK                                                          
         EJECT                                                                  
...
*                                                                               
         ...
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'194RELFM08S  05/01/02'                                      
         END                                                                    
