*          DATA SET REWRIDRVZ  AT LEVEL 010 AS OF 05/01/02                      
*          DATA SET REWRIDRVX  AT LEVEL 057 AS OF 01/22/97                      
*          DATA SET REWRIDRV   AT LEVEL 030 AS OF 08/07/95                      
*PHASE T82113C,+0                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
...
CLIN     MVC   0(L'RECLS,R2),RECLS     CLASS                                    
         B     XIT                                                              
         SPACE                                                                  
CURESTIN MVC   0(L'RECUREST,R2),RECUREST  CURRENT EST ORDERED                   
         B     XIT                                                              
PRIESTIN MVC   0(L'REPRIEST,R2),REPRIEST                                        
         B     XIT                                                              
PRIACTIN MVC   0(L'REPRIACT,R2),REPRIACT                                        
         B     XIT                                                              
PRI2ESTI MVC   0(L'REPR2EST,R2),REPR2EST                                        
         B     XIT                                                              
PRI2ACTI MVC   0(L'REPR2ACT,R2),REPR2ACT                                        
         B     XIT                                                              
CURBKDIN MVC   0(L'RECURBKD,R2),RECURBKD                                        
         B     XIT                                                              
PRIBKDIN MVC   0(L'REPRIBKD,R2),REPRIBKD                                        
         B     XIT                                                              
TWKBKDIN MVC   0(L'RETWKBKD,R2),RETWKBKD                                        
         B     XIT                                                              
LWKBKDIN MVC   0(L'RELWKBKD,R2),RELWKBKD                                        
         B     XIT                                                              
CURINVIN MVC   0(L'REINVCUR,R2),REINVCUR                                        
         B     XIT                                                              
PRIINVIN MVC   0(L'REPRIINV,R2),REPRIINV                                        
         B     XIT                                                              
CURACTIN MVC   0(L'RECURACT,R2),RECURACT                                        
         B     XIT                                                              
PRI2BKDI MVC   0(L'RE2PRBKD,R2),RE2PRBKD                                        
         B     XIT                                                              
PRI2INVI MVC   0(L'RE2PRINV,R2),RE2PRINV                                        
         B     XIT                                                              
         SPACE                                                                  
...
TCT      CLC   REQPSTRB,RECONEND   IF OUTSIDE DATES, DON'T COUNT                
         BH    XIT                                                              
         CLC   REQPENDB,RECONSTR                                                
         BL    XIT                                                              
         CLI   MULTPOST,2          IF MULTIPLE POSTING                          
         BE    XIT                 ONLY COUNT FIRST TIME                        
         CLI   GLARGS,C'X'         XCLUDE DARE CONTRACTS ?                      
         BNE   TCT02               NO                                           
         L     R4,REAREC           ..YES                                        
         MVI   ELCODE,X'1D'        ..SO IF IT'S DARE                            
         BAS   RE,GETEL                                                         
         BE    XIT                 ..XCLUDE IT                                  
         SPACE                                                                  
TCT02    MVI   3(R2),1                                                          
...
DCT      CLC   REQPSTRB,RECONEND   IF OUTSIDE DATES, DON'T COUNT                
         ...
         SPACE                                                                  
         L     R4,REAREC                                                        
         MVI   ELCODE,X'1D'        IS IT DARE ORDER ?                           
         BAS   RE,GETEL                                                         
         BNE   XIT                                                              
         SPACE                                                                  
         MVI   3(R2),1                                                          
...
*                                                                               
YEARIN   DS    0H                                                               
         MVC   0(1,R2),RECURDAT      Y NEWMON TABLE DATE                        
         B     XIT                                                              
YEAROUT  DS    0H                                                               
         ...
         BH    *+10                                                             
         MVC   CODEAREA(2),=C'20'                                               
         MVC   CODEAREA+2(2),WORK                                               
         B     GENOUT                                                           
*                                                                               
MONDOLI  DS    0H                                                               
         MVC   0(2,R2),RECURDAT      Y/M NEWMON TABLE DATE                      
         B     XIT                                                              
*                                                                               
MONDOLO  MVC   LABLAREA(5),=C'MONTH'                                            
         MVC   DUB(2),0(R2)                          Y/M                        
         MVI   DUB+2,1                               DAY=1                      
         GOTO1 DATCON,DMCB,(3,DUB),(6,CODEAREA)                                 
         B     GENOUT                                                           
...
*                                                                               
QUAIN    DS    0H                  Y/M NEWMON TABLE QUARTER DATE                
         L     R1,ADATLIST                                                      
         USING DATELSTD,R1                                                      
         LA    R0,8                MAX 8 QUARTERS                               
         LA    R1,QURTLIST                                                      
         LA    RE,QURTLABL                                                      
QUATLOOP CLC   RECURDAT,0(R1)       CHECK AGAINST Y/M NEWMONTBL DATE            
         BNH   GOTQUAT             USE 1ST QUAT FOR UNDERFLOW                   
         CLC   RECURDAT,2(R1)       CHECK AGAINST END OF QUAT                   
         BNH   GOTQUAT                                                          
         LA    R1,4(R1)                                                         
         LA    RE,2(RE)                                                         
         BCT   R0,QUATLOOP                                                      
         A     RE,=F'-2'           USE LAST QUAT FOR OVERFLOW                   
GOTQUAT  MVC   0(2,R2),0(RE)                                                    
         B     XIT                                                              
*                                                                               
QUAOUT   DS    0H                  Y/M NEWMON TABLE QUARTER DATE                
         MVC   LABLAREA(7),=C'QUARTER'                                          
         MVC   CODEAREA(2),0(R2)                                                
         B     GENOUT                                                           
         DROP  R1                                                               
QURTLABL DC    C'Q1Q2Q3Q4Q5Q6Q7Q8'                                              
         EJECT                                                                  
...
****     BZ    ITSFINE                                                          
         OC    GLARGS+15,GLARGS+15        ARGS 16 DATE INDEX                    
         BZ    ITSFINE                                                          
************************************************************                    
* FOR NOW USE GLARGS+15 FOR DATE COL FILTER                                     
* DON'T KNOW IF ARGS10-16 ARE USED ??????????????                               
         ZIC   R2,GLARGS+15           INDEX INTO MON/QUART/YEAR                 
         LTR   R2,R2                                                            
         BZ    ITSFINE                                                          
         BCTR  R2,0                                                             
         SLL   R2,2                                                             
         A     R2,ADATLIST                                                      
*                                                                               
         CLI   GLARGS+15,26        IS IT MONTHS?                                
         BL    COLMNTH                                                          
         CLI   GLARGS+15,33        IS IT QUARTERS?                              
         BH    NOGOOD              NO - THAT'S ALL!!!!                          
         CLC   RECURDAT,0(R2)      YES                                          
         BL    NOGOOD                                                           
         CLC   RECURDAT,2(R2)                                                   
         BH    NOGOOD                                                           
         B     ITSFINE                                                          
                                                                                
* - CONVERT 4 BYTE START-END OF ADLIST TO Y/M OF NEWMON TBL                     
COLMNTH  LA    R0,10                                                            
         GOTO1 DATCON,DMCB,(2,(R2)),WORK    TAKE START DATE                     
         LA    R0,10                        BUMP BY 10 FOR BROAD MONTH          
         GOTO1 ADDAY,DMCB,WORK,WORK,(R0)                                        
         GOTO1 DATCON,DMCB,(0,WORK),(3,WORK+6)                                  
         CLC   RECURDAT,WORK+6               COMPARE TO NEWMON DATE             
         BNE   NOGOOD                                                           
         B     ITSFINE                                                          
******************************************************************              
...
CFILT10  OC    GLARGS+13(3),GLARGS+13  NO END DATE?                             
         ...
         B     ITSFINE                                                          
         EJECT                                                                  
*          DATA SET NEWRIDRIVE AT LEVEL 010 AS OF 08/13/96                      
*              ROUTINE TO OUTPUT DATES TO HEADINGS                              
         SPACE 3                                                                
*              ARGUMENTS           SEE FILTUNIT                                 
         SPACE 1                                                                
RHFILTER CLI   GLARGS+15,0         ONLY HANDLING DATES FOR NOW                  
         BE    XIT                                                              
         ...
         EX    R1,*+8                                                           
         B     *+10                                                             
         CLC   0(0,R3),MYSPACES    IF ANYTHING IS THERE ALREADY                 
         BE    RHFILT2                                                          
...
RHFILT2  DS    0H                                                               
         ...
         BCTR  R2,0                                                             
         SLL   R2,2                                                             
         A     R2,ADATLIST         (TO DISPLACE INTO DATE TABLE)                
         CLI   GLARGS+15,26        FOR 1-25                                     
         BL    NOMONTH             USE REGULAR MONTH ROUTINES                   
         CLI   GLARGS+15,33        FOR 26-32                                    
         BL    NOQUART             USE QUARTERS                                 
         CLI   GLARGS+15,35        FOR 33-34                                    
         BL    NOYEAR              USE YEAR                                     
         B     NOYEAR              USE YEAR IN AANY CASE FOR NOW                
***      B     NODATE              USE DATE                                     
         EJECT                                                                  
*                                                                               
...
NOQUART  MVC   LABLAREA(7),=C'QUARTER'                                          
         LA    R1,MYMONTHS                                                      
         ZIC   RE,1(R2)            MONTH NUMBER                                 
         B     *+8                                                              
         LA    R1,3(R1)                                                         
         BCT   RE,*-4                                                           
         MVC   NAMEAREA(3),0(R1)   START QUARTER MONTH                          
         MVI   NAMEAREA+3,C'-'                                                  
         LA    R1,MYMONTHS                                                      
         ZIC   RE,3(R2)            MONTH NUMBER                                 
         B     *+8                                                              
         LA    R1,3(R1)                                                         
         BCT   RE,*-4                                                           
         MVC   NAMEAREA+4(3),0(R1)   END QUARTER MONTH                          
         B     DATEGEN                                                          
...
*                                                                               
EDMON    NTR1                                                                   
         GOTO1 DATCON,DMCB,(2,(R2)),WORK                                        
         LA    R0,10               BUMP DATE BY 10 FOR BROAD MONTH              
         GOTO1 ADDAY,DMCB,WORK,WORK,(R0)                                        
         GOTO1 DATCON,DMCB,(0,WORK),(6,0(R3))                                   
         B     XIT                                                              
                                                                                
NODATE   MVC   LABLAREA(4),=C'DATE'                                             
...
XIT      XIT1                                                                   
         ...
         EJECT                                                                  
* RGON ROUTINES                                                                 
**** AT THIS POINT JUST MOVE DATA IN/OUT                                        
**** RGON RETUNRS ONLY CODES - NO NAMES - BUT BUFFERS EXIST WITH                
**** NAMES  THESE CAN BE ACCESSED LATER                                         
**                                                                              
NRADVIN  MVC   0(L'NRGADV,R2),NRGADV                                            
         B     XIT                                                              
NRADVOUT MVC   0(L'NRGADV,R3),0(R2)                                             
         B     XIT                                                              
                                                                                
NRAFFIN  MVC   0(L'NRGAFFIL,R2),NRGAFFIL                                        
         B     XIT                                                              
NRAFFOUT MVC   0(L'NRGAFFIL,R3),0(R2)                                           
         B     XIT                                                              
                                                                                
NRAGYIN  MVC   0(L'NRGAGY,R2),NRGAGY                                            
         B     XIT                                                              
NRAGYOUT MVC   0(L'NRGAGY,R3),0(R2)                                             
         B     XIT                                                              
                                                                                
NRCLSIN  MVC   0(L'NRGCLASS,R2),NRGCLASS                                        
         B     XIT                                                              
NRCLSOUT MVC   0(L'NRGCLASS,R3),0(R2)                                           
         B     XIT                                                              
                                                                                
NRCTPIN  MVC   0(L'NRGCNTP,R2),NRGCNTP                                          
         B     XIT                                                              
NRCTPOUT MVC   0(L'NRGCNTP,R3),0(R2)                                            
         B     XIT                                                              
                                                                                
NRCTGIN  MVC   0(L'NRGCTGY,R2),NRGCTGY                                          
         B     XIT                                                              
NRCTGOUT MVC   0(L'NRGCTGY,R3),0(R2)                                            
         B     XIT                                                              
                                                                                
NRYRMIN  MVC   0(L'NRGYRMON,R2),NRGYRMON                                        
         B     XIT                                                              
NRYRMOUT MVC   0(L'NRGYRMON,R3),0(R2)                                           
         B     XIT                                                              
                                                                                
NRDVTIN  MVC   0(L'NRGDVTP,R2),NRGDVTP                                          
         B     XIT                                                              
NRDVTOUT MVC   0(L'NRGDVTP,R3),0(R2)                                            
         B     XIT                                                              
                                                                                
NRMKTIN  MVC   0(L'NRGMKT,R2),NRGMKT                                            
         B     XIT                                                              
NRMKTOUT MVC   0(L'NRGMKT,R3),0(R2)                                             
         B     XIT                                                              
                                                                                
NROFIN   MVC   0(L'NRGOFF,R2),NRGOFF                                            
         B     XIT                                                              
NROFOUT  MVC   0(L'NRGOFF,R3),0(R2)                                             
         B     XIT                                                              
                                                                                
NROWNIN  MVC   0(L'NRGOWN,R2),NRGOWN                                            
         B     XIT                                                              
NROWNOUT MVC   0(L'NRGOWN,R3),0(R2)                                             
         B     XIT                                                              
                                                                                
NRRGIN   MVC   0(L'NRGREG,R2),NRGREG                                            
         B     XIT                                                              
NRRGOUT  MVC   0(L'NRGREG,R3),0(R2)                                             
         B     XIT                                                              
                                                                                
NRRNKIN  MVC   0(L'NRGRANK,R2),NRGRANK                                          
         B     XIT                                                              
NRRNKOUT MVC   0(L'NRGRANK,R3),0(R2)                                            
         B     XIT                                                              
                                                                                
NRSTAIN  MVC   0(L'NRGSTAT,R2),NRGSTAT                                          
         B     XIT                                                              
NRSTAOUT MVC   0(L'NRGSTAT,R3),0(R2)                                            
         B     XIT                                                              
                                                                                
NRTEMIN  MVC   0(L'NRGTEAM,R2),NRGTEAM                                          
         B     XIT                                                              
NRTEMOUT MVC   0(L'NRGTEAM,R3),0(R2)                                            
         B     XIT                                                              
                                                                                
NRTVBIN  MVC   0(L'NRGTVB,R2),NRGTVB                                            
         B     XIT                                                              
NRTVBOUT MVC   0(L'NRGTVB,R3),0(R2)                                             
         B     XIT                                                              
*                                                                               
NRCBKIN  MVC   0(L'NRGWCBK,R2),NRGWCBK                                          
         B     XIT                                                              
                                                                                
NRCBUDIN MVC   0(L'NRGWCBUD,R2),NRGWCBUD                                        
         B     XIT                                                              
                                                                                
NRCPACIN MVC   0(L'NRGWCPAC,R2),NRGWCPAC                                        
         B     XIT                                                              
                                                                                
NRCRBLIN MVC   0(L'NRGWCRBL,R2),NRGWCRBL                                        
         GOTO1 =V(PRNTBL),DMCB,=C'CRB',NRGWCRBL,C'DUMP',4,=C'1D'                
         B     XIT                                                              
                                                                                
NRPCTBIN MVC   0(L'NRGWPCTF,R2),NRGWPCTF                                        
         B     XIT                                                              
                                                                                
NRPCTFIN MVC   0(L'NRGWPCTF,R2),NRGWPCTF                                        
         B     XIT                                                              
                                                                                
NRPFININ MVC   0(L'NRGWPFIN,R2),NRGWPFIN                                        
         B     XIT                                                              
                                                                                
NRPRBIN  MVC   0(L'NRGWPRBL,R2),NRGWPRBL                                        
         B     XIT                                                              
*                                                                               
         EJECT                                                                  
*              LTORG ETC                                                        
...
RMCDIN   DC    C'MCDIN   ',A(MCDIN)       MARKET CODE                           
         ...
         DC    C'CURESTIN',A(CURESTIN)                                          
         DC    C'PRIESTIN',A(PRIESTIN)                                          
         DC    C'PRIACTIN',A(PRIACTIN)                                          
         DC    C'PRI2ESTI',A(PRI2ESTI)                                          
         DC    C'PRI2ACTI',A(PRI2ACTI)                                          
         DC    C'CURBKDIN',A(CURBKDIN)                                          
         DC    C'PRIBKDIN',A(PRIBKDIN)                                          
         DC    C'TWKBKDIN',A(TWKBKDIN)                                          
         DC    C'LWKBKDIN',A(LWKBKDIN)                                          
         DC    C'CURINVIN',A(CURINVIN)                                          
         DC    C'PRIINVIN',A(PRIINVIN)                                          
         DC    C'CURACTIN',A(CURACTIN)                                          
         DC    C'PRI2INVI',A(PRI2INVI)                                          
         DC    C'PRI2BKDI',A(PRI2BKDI)                                          
         SPACE                                                                  
         ...
         SPACE                                                                  
*                                      DATE RELATED                             
***      DC    C'MONIN   ',A(MONIN)    ** ARE THESE EVER CALLED ???             
**       DC    C'MONOUT  ',A(MONOUT)                                            
***      DC    C'QUARTIN ',A(QUARTIN)                                           
***      DC    C'QUARTOUT',A(QUARTOUT)                                          
         DC    C'MONDOLI ',A(MONDOLI)                                           
         DC    C'MONDOLO ',A(MONDOLO)                                           
         DC    C'QUAIN   ',A(QUAIN)                                             
         DC    C'QUAOUT  ',A(QUAOUT)                                            
...
PWCTYP3  DC    C'SAQTIN  ',A(SAQTIN)                                            
         ...
         DC    C'RHFILTER',A(RHFILTER) HEAD FILTER HEADINGS                     
         SPACE                                                                  
...
*                                                                               
* RGON READ ROUTINES                                                            
         DC    C'NRADVIN ',A(NRADVIN)                                           
         DC    C'NRADVOUT',A(NRADVOUT)                                          
         DC    C'NRAFFIN ',A(NRAFFIN)                                           
         DC    C'NRAFFOUT',A(NRAFFOUT)                                          
         DC    C'NRAGYIN ',A(NRAGYIN)                                           
         DC    C'NRAGYOUT',A(NRAGYOUT)                                          
         DC    C'NRCLSIN ',A(NRCLSIN)                                           
         DC    C'NRCLSOUT',A(NRCLSOUT)                                          
         DC    C'NRCTPIN ',A(NRCTPIN)                                           
         DC    C'NRCTPOUT',A(NRCTPOUT)                                          
         DC    C'NRCTGIN ',A(NRCTGIN)                                           
         DC    C'NRCTGOUT',A(NRCTGOUT)                                          
         DC    C'NRYRMIN ',A(NRYRMIN)                                           
         DC    C'NRYRMOUT',A(NRYRMOUT)                                          
         DC    C'NRDVTIN ',A(NRDVTIN)                                           
         DC    C'NRDVTOUT',A(NRDVTOUT)                                          
         DC    C'NRMKTIN ',A(NRMKTIN)                                           
         DC    C'NRMKTOUT',A(NRMKTOUT)                                          
         DC    C'NROFIN  ',A(NROFIN)                                            
         DC    C'NROFOUT ',A(NROFOUT)                                           
         DC    C'NROWNIN ',A(NROWNIN)                                           
         DC    C'NROWNOUT',A(NROWNOUT)                                          
         DC    C'NRRGIN  ',A(NRRGIN)                                            
         DC    C'NRRGOUT ',A(NRRGOUT)                                           
         DC    C'NRRNKIN ',A(NRRNKIN)                                           
         DC    C'NRRNKOUT',A(NRRNKOUT)                                          
         DC    C'NRSTAIN ',A(NRSTAIN)                                           
         DC    C'NRSTAOUT',A(NRSTAOUT)                                          
         DC    C'NRTEMIN ',A(NRTEMIN)                                           
         DC    C'NRTEMOUT',A(NRTEMOUT)                                          
         DC    C'NRTVBIN ',A(NRTVBIN)                                           
         DC    C'NRTVBOUT',A(NRTVBOUT)                                          
* RGON READ $ ROUTINES                                                          
         DC    C'NRCBKIN ',A(NRCBKIN)                                           
         DC    C'NRCBUDIN',A(NRCBUDIN)                                          
         DC    C'NRCPACIN',A(NRCPACIN)                                          
         DC    C'NRCRBLIN',A(NRCRBLIN)                                          
         DC    C'NRPCTBIN',A(NRPCTBIN)                                          
         DC    C'NRPCTFIN',A(NRPCTFIN)                                          
         DC    C'NRPFININ',A(NRPFININ)                                          
         DC    C'NRPRBIN ',A(NRPRBIN)                                           
         DC    X'FF'                                                            
         EJECT                                                                  
...
*        PRINT OFF                                                              
       ...
       ++INCLUDE REWRISTBD                                                      
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'010REWRIDRVZ 05/01/02'                                      
         END                                                                    
