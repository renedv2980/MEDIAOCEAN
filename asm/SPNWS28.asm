*          DATA SET SPNWS28    AT LEVEL 097 AS OF 05/14/09                      
*PHASE T20728A,*                                                                
         TITLE 'BWS28 - BWS - LEAD-IN LEAD-OUT AND ROTATIONAL ANALYSIS'         
T20728   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 0,T20728**,RA,RR=RE                                              
...
***********************************************************************         
         SPACE 1                                                                
VALKEY   GOTO1 =A(VALKEYF),RR=APRELO                                            
         B     EXIT                                                             
***********************************************************************         
...
*                                                                               
         ...
         BE    FSTR8A            - YUP, SKIP CHECK                              
         OC    SVUPINP,SVUPINP     ANY UPGRADE FORMULA?                         
         BZ    ENOUPG               - NOPE, ERROR                               
FSTR8A   MVC   LEDUPG,SVUPINP      NONE - EDIT UPGRADE EXPRESSION               
         OI    LEDUPGH+6,FVOXMT                                                 
*                                                                               
FSTR8B   CLI   ACSVACT,ACTROT      INSPECT PERCENT FIELD FOR ROTN ANAL          
         BNE   *+12                                                             
         BAS   RE,PCT                                                           
         BNE   FSTRX                                                            
*                                                                               
...
*                                                                               
         ...
         B     FSTR9                                                            
*                                                                               
FSTR8T   GOTO1 AGETBKTY,APPARM,(C'B',SVUPFRBK+1),QBOOKTYP                       
*                                                                               
FSTR9    GOTO1 ASDEMUP                                                          
*                                                                               
...
*                                                                               
         ...
         LA    R1,ROTPPRH                                                       
         MVC   8(L'LEDPRG,R1),BWDPROG   DISPLAY PROGRAMMING                     
         OI    6(R1),FVOXMT                                                     
*                                                                               
...
DISK10   MVC   IOKEY(13),APRECKEY  GET BWS RECORD                               
         ...
         MVC   LEDNUM,QCAM                                                      
         MVC   LEDSTA(L'BWDSTA),BWDSTA   STATION                                
         CLI   LEDSTA+4,C'T'                                                    
         BNE   *+8                                                              
         MVI   LEDSTA+4,C' '                                                    
...
DISR5G   MVC   SVUPFBL,CMPFBLST                                                 
         ...
         XC    LAODTEL,LAODTEL                                                  
*                                                                               
DISR6    CLI   QMED,C'R'        IS IT RADIO? LOGIC FOLLOWS LIKE SPNWS04         
         BE    DISR7             - YUP, SKIP CHECK                              
         OC    CMPUPIN,CMPUPIN     DO WE HAVE A CAMPAIGN UPGRADE?               
         BZ    ENOUPG               - NOPE, ERROR!!                             
DISR7    MVC   LEDUPG,CMPUPIN            DISPLAY CAMPAIGN UPGRADE               
         OI    LEDUPGH+6,FVOXMT                                                 
*                                                                               
...
*        AR    RF,RE                                                            
*        BCT   R0,*-10                                                          
DISR36   BAS   RE,BOOKS            INSPECT THE BOOK FIELDS                      
         BNE   DISRX                                                            
...
*                                  NO - TEST FOR CHANGES THAT'LL AFFECT         
         ...
         BZ    DISR42A                  NO                                      
         CLI   ACSVACT,ACTROT           YES- RE-DISPLAY CURRENT SCREEN          
         BNE   DISR44                                                           
         LHI   R1,1                     ROT - DETERMINE CURRENT SCREEN          
         CLC   SVHH,SVNUMHH+1                 CATER FOR LAST SCREEN             
         BL    *+10                                                             
         MVC   SVHH,SVNUMHH+1                                                   
         CLM   R1,1,SVHH                      (FIND WHICH HH WE USED TO         
         BH    *+12                            BEGIN THIS SCREEN)               
         LA    R1,4(R1)                       4 HH PER SCREEN                   
         B     *-12                                                             
         SHI   R1,4                                                             
         STC   R1,SVHH                                                          
         B     DISR44                       - RE-DISPLAY CURRENT SCREEN         
DISR42A  TM    LFLAG2,LNEWTIME+LNEWDAYS SAME FOR NEW DAYS/TIMES                 
         BNZ   DISR44                   (SVHH ALREADY RESET)                    
...
***  2 DECIMAL  ***                                                             
         ...
         BNO   *+12                                                             
         MVI   EBDECS,2                                                         
         NI    0(R4),X'FF'-DMODEM2D TAKE OFF THE BIT FOR CORRECT VALUE          
***  2 DECIMAL  ***                                                             
         MVI   EBSCIN,0                                                         
         ZIC   RE,EBLOUT                                                        
         BCTR  RE,0                                                             
...
*                                                                               
         ...
         NI    APFULL,255-X'80'                                                 
***  2 DECIMAL  ***                                                             
         NI    APFULL,X'FF'-DMODEM2D TAKE OFF 2 DECIMAL BIT                     
***  2 DECIMAL  ***                                                             
         OC    APFULL,APFULL                                                    
         BZ    DISR56                                                           
         MVI   EBFLOAT,0                                                        
         ...
         MVI   EBDECS,1                                                         
***  2 DECIMAL  ***                                                             
         TM    SVPROJ,DMODEM2D     WE NEED 2 DECIMAL?                           
         BNO   *+8                                                              
         MVI   EBDECS,2                                                         
***  2 DECIMAL  ***                                                             
         MVI   EBSCIN,0                                                         
...
DISR56   OI    ROTRCPH+6,FVOXMT    FORMAT THE PROJECTED CPP                     
         ...
         M     RE,=F'20'                                                        
***  2 DECIMAL  ***                                                             
         TM    SVPROJ,DMODEM2D     IS IT 2 DECIMALS?                            
         BNO   *+8                                                              
         M     RE,=F'10'           MULTIPLY BY 10 (APFULL 10X BIGGER)           
***  2 DECIMAL  ***                                                             
         D     RE,APFULL                                                        
         LA    RF,1(RF)                                                         
         SRA   RF,1                                                             
...
***  2 DECIMAL  ***                                                             
         CLI   EBDECS,2                                                         
         BNE   *+8                                                              
         OI    0(R4),DMODEM2D       TURN 2 DECIMAL X'40' BIT BACK ON            
***  2 DECIMAL  ***                                                             
*                                                                               
DISR64   CLI   ACSVACT,ACTLED                                                   
         ...
         L     RE,0(R4)                                                         
***  2 DECIMAL  ***                                                             
         TM    0(R4),DMODEM2D      IS IT 2 DECIMAL?                             
         BNO   DISR64E                                                          
         STCM  RE,8,APBYTE                                                      
         NI    APBYTE,X'FF'-DMODEM2D TURN OFF THE 2 DECIMAL X'40' BIT           
         ICM   RE,8,APBYTE                                                      
***  2 DECIMAL  ***                                                             
DISR64E  MH    RE,=H'10'                                                        
         C     RE,0(R1)                                                         
...
DISR74   LA    R1,L'LEDRTG         FORMAT PROJECTED RATING                      
         ...
         NI    APFULL,255-X'80'                                                 
***  2 DECIMAL  ***                                                             
         NI    APFULL,X'FF'-DMODEM2D TAKE OFF THE BIT FOR CORRECT VALUE         
***  2 DECIMAL  ***                                                             
         OC    APFULL,APFULL                                                    
         BZ    DISR76                                                           
         MVI   EBFLOAT,0                                                        
...
DISR78   ST    RE,EBAOUT                                                        
         ...
         ICM   RE,15,0(R1)                                                      
         BZ    DISR80                                                           
****   MAYBE I SHOULD LEAVE THE X'40' UNTIL IT GETS HERE ?                      
****   OR CHECK THE EBDEC?                                                      
         OC    APFULL,APFULL                                                    
         BZ    DISR80                                                           
         SRDA  RE,32                                                            
...
MINMAX   NTR1  ,                                                                
         ...
         LA    R0,4                                                             
*                                                                               
MINMAX2  MVI   APWORK,0                                                         
         XC    0(8,R4),0(R4)                                                    
         OC    0(2,R8),0(R8)                                                    
         BZ    MINMAX4                                                          
***  2 DECIMAL                                                                  
         MVC   APWORK(1),0(R9)     SAVE OFF X'40' BIT                           
         NI    0(R9),X'FF'-X'40'   TURN OFF THE X'40' BIT                       
***  2 DECIMAL                                                                  
         L     RF,0(R9)                                                         
         LH    R1,SVPCT                                                         
         SLDL  RE,1                                                             
         ...
         ST    RE,4(R4)                                                         
***  2 DECIMAL                                                                  
         TM    APWORK,X'40'        WAS IT 2 DECIMAL?                            
         BZ    MINMAX4              - NOPE                                      
         OI    0(R9),X'40'         TURN IT BACK ON                              
***  2 DECIMAL                                                                  
*                                                                               
MINMAX4  LA    R4,8(R4)                                                         
         LA    R8,2(R8)                                                         
...
***  2 DECIMAL                                                                  
         MVC   APWORK(1),SVPROJ    SAVE OFF X'40' BIT                           
         NI    SVPROJ,X'FF'-X'40'   TURN OFF THE X'40' BIT                      
***  2 DECIMAL                                                                  
         L     RF,SVPROJ                                                        
         SLDL  RE,1                                                             
         LH    R1,SVPCT                                                         
...
***  2 DECIMAL                                                                  
         TM    APWORK,X'40'        WAS IT 2 DECIMAL?                            
         BZ    MINMAXX              - NOPE                                      
         OI    SVPROJ,X'40'        TURN IT BACK ON                              
***  2 DECIMAL                                                                  
*                                                                               
MINMAXX  B     EXIT                                                             
         EJECT                                                                  
...
DISB2A   CLI   14(R8),C'+'         IGNORE LPM?                                  
         ...
         XC    8(L'LEDBK1,R8),8(R8)                                             
         OC    0(2,R4),0(R4)                                                    
         BZ    DISB4                                                            
         MVC   APWORK(2),0(R4)                                                  
         NI    APWORK+1,X'FF'-BTYBITSQ  REMOVE SPECIAL DATA BITS                
         GOTO1 VDATCON,APPARM,(3,APWORK),(6,8(R8))                              
*                                                                               
         TM    1(R4),BTYBITSQ      ANY SPECIAL BOOK TYPE?                       
         BNZ   DISB2G                 OTHER SPECIALS DON'T HAVE PPL MTR         
*                                                                               
...
*                                                                               
DISB2G   GOTO1 AGETBKTY,APPARM,(C'B',1(R4)),14(R8),0(R3)                        
*                                                                               
...
UPGR4    MVC   UPGFILE,APWORK                                                   
         ...
         MVI   UPGELLN,UPGELLQ2                                                 
UPGR4G   MVC   UPGINPUT(L'LEDUPG),LEDUPG                                        
...
BOOKS    NTR1                                                                   
         ...
         LA    R4,ROTBK1H                                                       
         LA    R8,SVBKS                                                         
         LA    R3,SVBKTPS          SVBKS BOOK TYPES (BINARY)                    
         LA    R0,4                                                             
*                                                                               
...
****                                - DON'T WANT LPM, READ DEMO BOOK            
         LA    R1,FVIFLD+6                                                      
*                                                                               
BOOK4A3  MVC   APWORK+16(1),0(R1)                                               
         MVI   0(R1),C' '                                                       
         CLI   1(R1),C' '                                                       
         BNH   BOOK5                                                            
         MVC   APWORK+17(1),1(R1)  2 CHARACTER BOOK TYPES                       
         MVI   1(R1),C' '                                                       
*                                                                               
...
VALK26   CLI   0(R4),0                                                          
         ...
         BZ    VALK26M                                                          
         OI    LFLAG1,LF1BUYRV                                                  
         BAS   RE,PROTIFLD         PROTECT INPUT FIELDS                         
         B     VALK26M                                                          
*                                                                               
VALK26B  IC    R0,1(R4)                                                         
         AR    R4,R0                                                            
...
PROTIFLD NTR1                                                                   
         ...
         LA    RE,LEDFLDTB                                                      
*                                                                               
PIFLD10  OC    0(L'ROTFLDTB,RE),0(RE)   ANY MORE INPUT FLDS?                    
         BZ    PIFLDX                                                           
*                                                                               
         XR    R1,R1               R1 = A(FIELD)                                
         ICM   R1,3,0(RE)                                                       
         ...
         LA    RE,L'ROTFLDTB(RE)   NEXT FIELD                                   
         B     PIFLD10                                                          
*                                                                               
PIFLDX   B     VALKX                                                            
*                                                                               
...
***  2 DECIMAL                                                                  
         ...
         BE    *+12                                                             
         CLI   SVDEM+1,C'E'                                                     
         BNE   VALRTG6E            IT IS IMPRESSION                             
         GOTO1 VCASHVAL,APPARM,(2,FVIFLD),(R8)                                  
         B     VALRTG6G                                                         
***  2 DECIMAL                                                                  
VALRTG6E GOTO1 VCASHVAL,APPARM,(1,FVIFLD),(R8)                                  
VALRTG6G CLI   APPARM,X'FF'                                                     
         BE    VALRTG99                                                         
...
***  2 DECIMAL                                                                  
         TM    APROFBTS,A00TWODC   IS 2 DECIMAL PRECISION ON?                   
         BZ    VALRTG7G             - NOPE IT ISN'T                             
         CLI   SVDEM+1,C'R'                                                     
         BE    *+12                                                             
         CLI   SVDEM+1,C'E'                                                     
         BNE   VALRTG7G            IT IS IMPRESSION                             
         OI    4(R4),X'40'          - YUP, PUT ON THE BIT                       
***  2 DECIMAL                                                                  
VALRTG7G OI    LCHG,LRTG                                                        
         MVC   SVPROJ(4),APPARM+4                                               
         OI    SVPROJ,X'80'              INDICATE OVERRIDE                      
***  2 DECIMAL                                                                  
         TM    4(R4),X'40'         WE DOING 2 DECIMALS?                         
         BZ    VALRTG8              - NOPE                                      
         OI    SVPROJ,X'40'                                                     
***  2 DECIMAL                                                                  
*                                                                               
...
***  2 DECIMAL  ***                                                             
SDEMUP5J GOTO1 ASPDEMUP,APPARM,LDMUPBLK,LDEMLST,LDEMVAL                         
...
*****  CABLE/FUSION DATE LOOKUP                                                 
         ...
         BL    DEMU14E              - NOPE, WE DON'T HAVE CABLE NETWORK         
         XC    SPUPSTA,SPUPSTA                                                  
         XC    SPUPSYSC,SPUPSYSC   CLEAR THIS SO 2ND+ INTERATION WORKS!         
         ...
         B     DEMU14G                                                          
*****  CABLE/FUSION DATE LOOKUP                                                 
DEMU14E  MVC   SPUPSTA,BWDSTA                                                   
DEMU14G  MVC   SPUPFIL,SVUPFILE                                                 
         MVC   SPUPSRC,CLTSRC                                                   
         MVC   SPUPFBK,SVUPFRBK                                                 
         MVC   SPUPFBKL,SVUPFBL                                                 
         LA    R1,LDEMOVR                                                       
...
***  2 DECIMAL  ***                                                             
         ...
         OI    SPUPOPTS,SPOP2DEC    - YUP, SPECIAL 2 DECIMAL LOOKUP             
***  2 DECIMAL  ***                                                             
DEMU16J  GOTO1 ASPDEMUP,APPARM,LDMUPBLK,SVDEM,(R9)                              
*                                                                               
****  CANADA DOESN'T NEED TO OVERRIDE THE RATING SERVICE                        
         CLI   CUDMED,C'C'         TEST CANADA                                  
         BE    *+10                 - YUP, SKIP THE OVERRIDE                    
...
*                                                                               
GETD00E  MVC   SPLKSTA,BWDSTA                                                   
GETD00G  MVI   SPLKFIL,C'T'                                                     
         MVC   SPLKSRC,CLTSRC                                                   
*                                                                               
...
*                                                                               
         ...
         TM    SPLKDBK+1,BTYBITSQ  SPECIAL BOOK?                                
         BZ    GETD5                                                            
...
GETD4F   NI    SPLKDBK+1,X'FF'-BTYBITSQ                                         
         CLI   SPLKBTYP,C'O'       OLYMPIC OVERRIDE?                            
         BNE   *+8                                                              
         OI    SPLKOPT,SPLKOEXO    YES                                          
*                                                                               
GETD5    XC    APFULL,APFULL                                                    
***  2 DECIMAL  ***                                                             
         TM    APROFBTS,A00TWODC   ARE WE DOING 2 DECIMALS?                     
         BNO   GETD5E                                                           
         OI    SPLKOPT,SPLKOP2D    - YUP, SPECIAL 2 DECIMAL LOOKUP              
***  2 DECIMAL  ***                                                             
GETD5E   GOTO1 VSPDEMLK,APPARM,(X'FF',SPDEMLK)   CALL SPGETDEM                  
...
LFLAG1   DS    X                                                                
LF1BUYRV EQU   X'80'                                                            
LF1NOLBK EQU   X'40'               CAN'T GET LATEST BOOK                        
*                                                                               
LFLAG2   DS    X                                                                
LDAYOVR  EQU   X'80'                                                            
LNEWDAYS EQU   X'40'                                                            
...
SVHH     DS    XL1                                                              
SVBKS    DS    XL8                                                              
SVBKTPS  DS    XL4                 SVBKS BOOK TYPES (BINARY)                    
SVFLAG   DS    XL1                                                              
SVFIRST  EQU   X'80'                                                            
SVDEM    DS    XL4                                                              
SVDAYS   DS    XL1                                                              
...
* SPDEMLKXTD                                                                    
       ...
       ++INCLUDE SPDEMLKXTD                                                     
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'097SPNWS28   05/14/09'                                      
         END                                                                    
