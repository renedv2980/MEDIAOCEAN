*          DATA SET REFIXR     AT LEVEL 012 AS OF 08/31/00                      
*          DATA SET REFIXR     AT LEVEL 011 AS OF 05/07/99                      
*PHASE REFIXRA,*,NOAUTO                                                         
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
*INCLUDE PRINTER                                                                
...
RECONWKC CSECT                                                                  
         DS    4000D                                                            
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012REFIXR    08/31/00'                                      
         END                                                                    
