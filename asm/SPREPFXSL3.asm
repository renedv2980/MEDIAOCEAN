*          DATA SET SPREPFXSL3 AT LEVEL 012 AS OF 09/29/00                      
*          DATA SET SPREPFXSLK AT LEVEL 027 AS OF 09/26/00                      
*PHASE SPFX02X                                                                  
*================================================================*              
* THIS VERSION CONVERTS ALL RECORDS ON A GIVEN FILE              *              
*================================================================*              
...
*                                                                               
         ...
         BAS   RE,BLDTAB           READ CLT/BUILD ESTTAB                        
*                                                                               
...
*                                                                               
         L     R6,ADCLT                                                         
         CLC   1(3,R6),SAVEKEY+2   SAME A-M/CLT                                 
         BE    BLDTABX             YES - EXIT                                   
*                                                                               
BLDTABXC XC    KEY,KEY                                                          
         ...
         GOTO1 GETCLT                                                           
*                                                                               
         MVC   P(17),=C'PROCESSING CLIENT'                                      
         GOTO1 HEXOUT,DMCB,KEY+1,P+18,1,=C'TOG'                                 
         MVC   P+22(3),CLT                                                      
         GOTO1 REPORT                                                           
*                                                                               
         L     R0,=A(ESTTAB)                                                    
...
BLDTABX  XIT1                                                                   
*                                                                               
MEDTAB   DC    C'TRNX567C'                                                      
         EJECT                                                                  
ESTERR   NTR1                                                                   
         MVC   P(18),=C'NO ESTIMATE HEADER'                                     
* AGY/MED GO OUT IN HEX                                                         
         GOTO1 HEXOUT,DMCB,KEY+2,P+20,1,=C'TOG'                                 
         MVC   P+23(3),CLT                                                      
*                                                                               
         L     R6,ADCLT                                                         
         LA    R6,CLIST-CLTHDRD(R6)                                             
...
XREC     DS    4000C                                                            
*                                                                               
FILEOUT  DCB   DDNAME=FILEOUT,DSORG=PS,RECFM=VB,LRECL=4000,            X        
               MACRF=PM                                                         
*                                                                               
ESTTAB   DS    256XL256                                                         
ESTTABX  EQU   *                                                                
...
*PREFIX=                                                                        
       ...
       ++INCLUDE SPREPWORKD                                                     
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'012SPREPFXSL309/29/00'                                      
         END                                                                    
