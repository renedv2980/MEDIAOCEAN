*          DATA SET NEWRI89    AT LEVEL 098 AS OF 05/01/02                      
*          DATA SET NEWRI89    AT LEVEL 210 AS OF 04/20/98                      
*PHASE T32089B,+0                                                               
*INCLUDE PRINT                                                                  
*INCLUDE PRNTBL                                                                 
*                                                                               
...
*  - GET REASON/USER CODE                                                       
         ...
         MVC   WORK+2(2),NUACTCID  CREATION PERSONAL ID                         
...
WRTPRG   DS    0H                                                               
         MVC   PLPROG,SRPRGNM                                                   
         B     ENDWRT                PROG CODE/EST/PKG FOR BUG CATCH            
...
*                                                                               
       ...
       ++INCLUDE DDGENTWA                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'098NEWRI89   05/01/02'                                      
         END                                                                    
