*          DATA SET ACLDXLED   AT LEVEL 054 AS OF 05/15/00                      
*PHASE ACLDXLED                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
*INCLUDE HELLO                                                                  
*INCLUDE HELEN                                                                  
*INCLUDE ACRECTYP                                                               
         TITLE 'CHECK LEDGER RECORDS FOR 54 ELEMENTS'                           
***********************************************************************         
*                                                                               
* PARAMETER LIST                                                                
*                                                                               
...
DMXEOF   DS    0H                                                               
         GOTO1 VPRINTER                                                         
         MVC   P(12),=C'RECS W/ELEMS'                                           
         EDIT  (P8,TOTREC),(14,P+14),ZERO=NOBLANK                               
         GOTO1 VPRINTER                                                         
         B     EXIT                                                             
         EJECT                                                                  
***********************************************************************         
...
DMXREC   DS    0H                                                               
         ...
         GOTO1 RECTYP,DMCB,(C'D',LDGRECD)                                       
         CLI   0(R1),ACRTLDG       IS IT A LEDGER RECORD                        
         BNE   DMXKEEP                                                          
         CLI   LDGKUNT,C'S'        IS IT UNIT S                                 
         BNE   DMXKEEP                                                          
         L     R2,AREC                                                          
         MVI   ELCODE,OCNELQ       X'54' OFFICE CHECK NUMBER ELEMENT            
         BAS   RE,GETEL                                                         
         BNE   DMXKEEP                                                          
...
* ACRECEQUS                                                                     
       ...
       ++INCLUDE ACRECEQUS                                                      
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'054ACLDXLED  05/15/00'                                      
         END                                                                    
