*          DATA SET PRSFM42    AT LEVEL 004 AS OF 03/16/09                      
*PHASE T41C42A                                                                  
*INCLUDE SRCHCALL                                                               
*INCLUDE PUBEDIT                                                                
*INCLUDE NUMED                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE PPBROWSE                                                               
*        TITLE 'T41C42 AGENCY CONTACT LIST RECORDS'                             
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS'                             
***********************************************************************         
*                                                                     *         
*         CHANGE LOG                                                  *         
...
*                                                                               
* SMYE  08/05    NEW PROGRAM (COPIED FROM PRSFM32 AND MODIFIED)                 
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - INIT'                      
***********************************************************************         
*                                                                     *         
*        INITIALISATION                                               *         
*                                                                     *         
...
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - ANAL'                      
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - VK'                        
***********************************************************************         
*                                                                     *         
*        VALIDATE KEY                                                 *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R4,KEY                                                           
         USING SRARECD,R4          ESTABLISH AGENCY CONTACT LIST KEY            
*                                                                               
         MVC   SRAKAGY,AGENCY      AGENCY                                       
         MVC   SRAKMED,QMED        MEDIA                                        
         MVI   SRAKRCD,SRAKRCDQ    RECORD TYPE                                  
         MVC   SRAKCLT,QCLT        CLIENT                                       
         MVC   SRAKPRD,QPRD        PRODUCT                                      
         MVC   SRAKPUB,BPUB        PUB                                          
*                                                                               
* * * * * * * * BELOW NOT IN USE A/O 03/13/09 * * * * * * * * * * * * *         
******   MVC   SRAKPID,QPID        USER ID                                      
...
*                                                                               
         B     VKX                                                              
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - VKL'                       
***********************************************************************         
*                                                                     *         
*        VALIDATE LIST KEY                                            *         
*                                                                     *         
...
*                                                                               
         ...
         BNE   VKLCLT30                                                         
*                                                                               
VKLCLT20 DS    0H                  CLIENT NOT ENTERED                           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - MYPUBVAL'                  
***********************************************************************         
*                                                                     *         
*        VALIDATE PUB FIELD                                           *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - DK'                        
***********************************************************************         
*                                                                     *         
*        DISPLAY KEY                                                  *         
*                                                                     *         
...
*                                                                               
         ...
         USING GEND,RC             GENCON WORKING STORAGE                       
*                                                                               
         L     R6,AIO              ESTABLISH AGENCY CONTACT LIST RECORD         
         USING SRAREC,R6                                                        
*                                                                               
*        DISPLAY MEDIA                                                          
*                                                                               
...
*                                                                               
         XC    SCRMED,SCRMED                                                    
         MVC   SCRMED(L'SRAKMED),SRAKMED   MEDIA                                
         MVI   SCRMEDH+5,L'SRAKMED SET INPUT LENGTH                             
...
*                                                                               
         XC    SCRCLT,SCRCLT                                                    
         MVC   SCRCLT(L'SRAKCLT),SRAKCLT      CLIENT                            
         MVI   SCRCLTH+5,L'SRAKCLT SET INPUT LENGTH                             
*                                                                               
...
*                                                                               
         CLC   SRAKCLT,=X'FFFFFF'  IF ALL CLIENTS                               
         BNE   DKCLTX                                                           
*                                                                               
         MVC   CLTNM,SPACES                                                     
*NOP*    MVC   SCRCLT,SPACES                                                    
*NOP*    MVI   SCRCLTH+5,0         NO INPUT                                     
         MVC   SCRCLT(3),=C'ALL'                                                
         MVI   SCRCLTH+5,3                                                      
*                                                                               
DKCLTX   DS    0H                                                               
...
*                                                                               
         XC    SCRPRD,SCRPRD                                                    
         MVC   SCRPRD(L'SRAKPRD),SRAKPRD      PRODUCT                           
         MVI   SCRPRDH+5,L'SRAKPRD SET INPUT LENGTH                             
*                                                                               
...
*                                                                               
         CLC   SRAKPRD,=X'FFFFFF'  IF ALL PRODUCTS                              
         BNE   DKPRDX                                                           
*                                                                               
         MVC   PRDNM,SPACES                                                     
*NOP*    MVC   SCRPRD,SPACES                                                    
*NOP*    MVI   SCRPRDH+5,0         NO INPUT                                     
         MVC   SCRPRD(3),=C'ALL'                                                
         MVI   SCRPRDH+5,3                                                      
*                                                                               
DKPRDX   DS    0H                                                               
...
*                                                                               
         ...
         MVI   SCRPUBH+5,0         ORIGINALLY NO INPUT                          
*                                                                               
         OC    SRAKPUB,SRAKPUB     SKIP IF NO PUB                               
         BZ    DKPUBX                                                           
*                                                                               
         CLI   SRAKPUB,X'FF'       "ALL" PUBS ?                                 
         BNE   DKPUBED             NO                                           
         MVC   SCRPUB(3),=C'ALL'                                                
...
*                                                                               
DKPUBED  DS    0H                                                               
         GOTO1 =V(PUBEDIT),DMCB,SRAKPUB,(C'S',SCRPUB),RR=RELO                   
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - VR'                        
***********************************************************************         
*                                                                     *         
*        VALIDATE RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R3,SVEBASE                                                       
         USING SRAEBASD,R3         ESTABLISH BASE ADDRESS ELEMENT               
*                                                                               
         MVI   SRAEBCDE,SRAEBIDQ   SET ELEMENT CODE                             
         MVI   SRAEBLEN,SRAEBLQ    SET basic ELEMENT LENGTH                     
*                                                                               
...
*                                                                               
         ...
         BNO   *+8                                                              
         OI    SVACH1,SRAAEBCH        EBASE CHANGED                             
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SRAEBASE(0),0(R1)   SAVE DOMAIN NAME                             
*                                                                               
         LR    R0,RF               SAVE EXECUTE LENGTH                          
*                                                                               
         AHI   RF,SRAEBLQ+1        CALCULATE TRUE ELM LENGTH                    
         STC   RF,SRAEBLEN         SET ELEMENT LENGTH                           
*                                                                               
...
*                                                                               
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),SRAEBASE RE-DISPLAY INPUT                             
*                                                                               
...
*                                                                               
         ...
         USING SRAEBASD,R3         ESTABLISH E-BASE ELEMENT                     
*                                                                               
         L     R6,AIO1             GET RECORD ADDRESS                           
         ST    R6,DMCB             PASS TO RECUP                                
         MVI   DMCB,C'P'           INDICATE PRINT SYSTEM                        
*                                                                               
         LA    R6,SRAFIRST-SRAREC(R6)    POINT TO FIRST ELEMENT IN REC          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - DR'                        
***********************************************************************         
*                                                                     *         
*        DISPLAY  RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         USING SRAEBASD,R6         ESTABLISH AS E-MAIL BASE ELEMENT             
*                                                                               
         LA    R2,SCRBASH          POINT TO FIELD ON SCREEN                     
         USING FLDHDRD,R2          ESTABLISH BASIC FIELD                        
*                                                                               
...
*                                                                               
         MVI   ELCODE,SRAEBIDQ     LOOK FOR E-BASE ELM                          
         BRAS  RE,GETEL            FIND IN RECORD                               
         BNE   DREBASOK            SKIP IF NONE FOUND                           
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRAEBLEN         GET ELEMENT LENGTH                           
         SHI   RF,SRAEBLQ          SUBTRACT BASIC ELM LENGTH                    
         BNP   DREBASOK                                                         
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   FLDDATA(0),SRAEBASE    DISPLAY E-MAIL BASE                       
*                                                                               
DREBASOK DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - RDEL'                      
***********************************************************************         
*                                                                     *         
*        DELETE   RECORD                                              *         
*                                                                     *         
...
*                                                                               
         ...
         LA    R3,SVACTELM                                                      
         USING SRAACTHD,R3         ESTABLISH ACTIVITY ELM                       
*                                                                               
         MVI   SRAACDE,SRAAIDQ     SET ELEMENT CODE                             
         MVI   SRAALEN,SRAACTLQ    SET ELEMENT LENGTH                           
*                                                                               
         GOTO1 DATCON,DUB,(5,0),(3,SRAADTE) SET TODAY'S DATE                    
*                                                                               
         MVC   SRAAPID,SVPID       SET CHANGER'S PID                            
         MVC   SRAASCID,SVSCID     SET CHANGER'S SECURITY PID                   
*                                                                               
         OI    SVACH1,SRAADEL      SET RECORD DELETED                           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - RR'                        
***********************************************************************         
*                                                                     *         
*        RESTORE  RECORD                                              *         
*                                                                     *         
...
*        ADD ACTIVITY ELEMENT                                                   
*                                                                               
         OI    SVACH1,SRAARES      SET RECORD RESTORED                          
*                                                                               
         BRAS  RE,ACTPUT           ADD ACTIVITY ELEMENT                         
*                                                                               
RRX      DS    0H                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - LR'                        
***********************************************************************         
*                                                                     *         
*        LIST RECRDS                                                  *         
*                                                                     *         
...
*                                                                               
         MVC   SRAKAGY,AGENCY      AGENCY                                       
         MVC   SRAKMED,QMED        MEDIA CODE                                   
         MVI   SRAKRCD,SRAKRCDQ    TYPE                                         
*                                                                               
         MVC   SRAKCLT,QCLT           CLIENT                                    
*                                                                               
         MVC   SRAKPRD,QPRD           PRODUCT                                   
...
*                                                                               
         CLC   SRAKEY(SRAKCLT-SRAKEY),KEYSAVE  DONE AT END OF MEDIA             
         BNE   LRDONE                                                           
*                                                                               
         TM    SRADCNTL,SRACDELQ   SKIP DELETED RECORDS                         
         BO    LRCONT2                                                          
*                                                                               
         CLC   SRAKAGY,AGENCY      FILTER ON AGENCY                             
         BNE   LRCONT2                                                          
*                                                                               
         CLI   SRAKRCD,SRAKRCDQ    FILTER ON RECORD CODE                        
         BNE   LRCONT2                                                          
*                                                                               
...
*                                                                               
         ...
         BNZ   LRPUBW              YES                                          
*                                                                               
         CLC   SRAKPBCD,BPUB       FILTER ON BASE PUB ONLY                      
         BE    LRPUBX                                                           
*                                                                               
LRPUBW   DS    0H                                                               
*                                                                               
         CLC   SRAKPUB,BPUB        FILTER ON WHOLE PUB                          
         BNE   LRCONT2                                                          
*                                                                               
LRPUBX   DS    0H                                                               
*                                                                               
...
*        DISPLAY CLIENT                                                         
*                                                                               
         MVC   LCLT,SRAKCLT        CLIENT                                       
*                                                                               
         CLC   SRAKCLT,=X'FFFFFF'                                               
         BNE   *+10                                                             
         MVC   LCLT,=C'ALL'                                                     
*                                                                               
*        DISPLAY PRODUCT                                                        
*                                                                               
         MVC   LPRD,SRAKPRD        PRODUCT                                      
*                                                                               
         CLC   SRAKPRD,=X'FFFFFF'                                               
         BNE   *+10                                                             
         MVC   LPRD,=C'ALL'                                                     
*                                                                               
...
LRPRDX4  DS    0H                                                               
*                                                                               
         GOTO1 =V(PUBEDIT),DMCB,SRAKPUB,(C'S',LPUB),RR=RELO                     
*                                                                               
         MVC   MYPUB,SRAKPUB                                                    
*                                                                               
         BRAS  RE,MYVPUB                                                        
...
*                                                                               
         USING SRAEBASD,R6         ESTABLISH DOMAIN ELEMENT                     
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRAEBLEN         GET ELEMENT LENGTH                           
         SHI   RF,SRAEBLQ          SUBTRACT BASIC ELM LENGTH                    
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SAVEBASE(0),SRAEBASE    DISPLAY E-MAIL BASE                      
*                                                                               
LREBASOK DS    0H                                                               
*                                                                               
...
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,SRALIDQ      LOOK FOR LIST ELMS                           
         BRAS  RE,GETEL            FIND FIRST IN RECORD                         
         BE    LRPRLOOP            ELEMENT FOUND                                
*                                                                               
         GOTO1 SPOOL,DMCB,SPOOLD   PRINT LINE- WILL FORCE SPACIN                
*                                     LINE                                      
         B     LRPRDONE                                                         
*                                                                               
LRPRLOOP DS    0H                                                               
...
*                                                                               
         MVC   PCNAME,SRALNAME     PRINT CONTACT NAME                           
*                                                                               
...
LRFAX    DS    0H                                                               
*                                                                               
         CLI   SRALTYPE,0          SKIP IF NOT FAX NUMBER                       
         BE    *+8                                                              
         CLI   SRALTYPE,C'F'       SKIP IF NOT FAX NUMBER                       
         BNE   LRFAXN                                                           
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,SRALLEN        GET FAX# LENGTH                              
         SHI   RF,SRALSTLQ         DECREMENT BY BASIC LENGTH                    
*                                                                               
         LA    R1,SRALADDR         START OF FAX #                               
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRALLEN          GET ELEMENT LENGTH                           
         SHI   RF,SRALSTLQ         DECREMENT BY BASIC LENGTH                    
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   PCADDR(0),SRALADDR  DISPLAY ADDRESS                              
*                                                                               
         CLI   SRALTYPE,C'E'       SKIP IF NOT AN E-MAIL                        
         BNE   LRADRX                                                           
*                                                                               
...
*                                                                               
         CLI   SRALSUP,C'Y'        IF W/O COSTS VERSION                         
         BNE   *+10                                                             
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - MYVPUB'                    
***********************************************************************         
*                                                                     *         
*        GET PUB NAME                                                 *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - MYVCLT'                    
***********************************************************************         
*                                                                     *         
*        GET CLIENT NAME                                              *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - PR'                        
***********************************************************************         
*                                                                     *         
*        PRINT REPORT                                                 *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - HOOK'                      
***********************************************************************         
*                                                                     *         
*        HEADLINE ROUTINES                                            *         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - LINSET'                    
**********************************************************************          
*   LINUP INTERFACE                                                  *          
...
NFLDS    EQU   4            4 FIELDS PER LINE (07/05 - SCRSUP ADDED)            
*                                                                               
         LTORG                                                                  
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - LINHOOK'                   
**********************************************************************          
*                                                                    *          
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - BUILD TABLE OF ELEMENTS ON FILE - LSBLDTAB'           
***********************************************************************         
*                                                                     *         
...
*                                                                               
         L     R6,AIO                                                           
         MVI   ELCODE,SRALIDQ      LIST ENTRY ELEMENT                           
         USING SRALSTD,R6          ESTABLISH LIST ELEMENT                       
*                                                                               
...
*                                                                               
         SR    RF,RF                                                            
         ICM   RF,1,SRALLEN        ELEMENT LENGTH                               
         BCTR  RF,0                DECREMENT FOR EXECUTE                        
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   ELTELEM(0),SRALELM  SAVE LIST ELEMENT                            
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - SEARCH TABLE FOR ELEMENTS - LSSRCH'                   
***********************************************************************         
*                                                                     *         
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - VALIDATE LINE - LHVALLIN'                             
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         USING SRALSTD,R3          ESTABLISH STANDARD CONTRACT UNIT ELM         
*                                                                               
...
*                                                                               
         TITLE 'PRSFM42 - VALIDATE LINE - LHVNAM'                               
***********************************************************************         
*                                                                     *         
...
*                                                                               
         LA    R4,WRKELTAB         SET TO BUILD TABLE ELEMENT                   
*                                                                               
         MVI   SRALCDE,SRALIDQ     SET ELEMENT CODE                             
         MVI   SRALLEN,SRALSTLQ    SET BASIC ELEMENT LENGTH                     
         MVC   SRALNAME,FLDDATA    SAVE CONTACT NAME                            
*                                                                               
         TM    FLDIIND,FINPTHIS    IF FIELD INPUT THIS TIME                     
         BNO   *+8                                                              
         OI    SVACH1,SRAALSCH        LIST CHANGED                              
*                                                                               
LHVNAMOK DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
LHVNAMX  DS    0H                                                               
*                                                                               
         TITLE 'PRSFM42 - VALIDATE CONTACT TYPE - LHVTYP'                       
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         BZ    LHVTYPOK                                                         
*                                                                               
         MVI   SRALTYPE,C'E'       ASSUME THIS IS AN E-MAIL ADDRESS             
*                                                                               
         CLI   FLDILEN,0           OKAY IF NO ENTRY                             
         BE    LHVTYP10                                                         
*                                                                               
         CLI   FLDDATA,C'E'        ENTRY MUST BE C'E'                           
         BNE   LHVTYPNV                                                         
*                                                                               
         MVC   SRALTYPE,FLDDATA    SAVE ADDRESS TYPE                            
*                                                                               
LHVTYP10 DS    0H                                                               
*                                                                               
         TWAXC (R2),(R2)           CLEAR FIELD                                  
*                                                                               
         CLI   SRALTYPE,C'E'       EXPAND CODE LETTER                           
         BNE   *+14                                                             
         MVC   FLDDATA(L'LHVTYPEM),LHVTYPEM                                     
         B     LHVTYPOK                                                         
*                                                                               
         CLI   SRALTYPE,C'F'       EXPAND CODE LETTER                           
         BNE   *+10                                                             
...
LHVTYPX  DS    0H                                                               
*                                                                               
         TITLE 'PRSFM42 - VALIDATE SUPPRESS COST FIELD - LHVSUP'                
***********************************************************************         
*                                                                     *         
*        ROUTINE TO VALIDATE SUPPRESS COST FIELD                      *         
*              C'Y' - SET CCVLSUP TO Y                                *         
*  NO ENTRY OR C'N' - CLEAR SRALSUP                                   *         
...
LHVSUP   DS    0H                                                               
*                                                                               
         MVI   SRALSUP,0           CLEAR SUPPRESS COST FIELD                    
*                                                                               
...
*                                                                               
         ...
         BNE   LHVTYPNV                                                         
*                                                                               
         MVI   SRALSUP,C'Y'        SET SUPPRESS COST FIELD                      
         CLI   FLDDATA,C'N'        C'N' ?                                       
         BNE   LHVSUPOK                                                         
         MVI   SRALSUP,0           CLEAR SUPPRESS COST FIELD                    
*                                                                               
...
LHVSUPX  DS    0H                                                               
*                                                                               
         TITLE 'PRSFM42 - VALIDATE CONTACT E-ADDRESS - LHVADDR'                 
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         BE    LHVADDNE                                                         
*                                                                               
*        FAX NUMBER MUST CONTAIN BETWEEN 10 AND 16 DIGITS                       
*                                                                               
LHVFAX   DS    0H                                                               
*                                                                               
         CLI   SRALTYPE,C'F'       SKIP IF NOT A FAX NUMBER                     
         BNE   LHVFAXN                                                          
*                                                                               
...
*                                                                               
         ...
         EX    RE,*+8                                                           
         B     *+10                                                             
         MVC   SRALADDR(0),WORK    SAVE FAX NUMBER                              
         ST    RE,FULL             SAVE RE                                      
*                                                                               
         SR    RF,RF                                                            
         IC    RF,SRALLEN          BUMP ELEMENT LENGTH                          
         AR    RF,RE               ADD FAX NUMBER LENGTH                        
         AHI   RF,1                RE WAS REDUCED FOR EXECUTED MOVE             
         STC   RF,SRALLEN                                                       
*                                                                               
...
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
         MVC   SRALADDR(0),FLDDATA    SAVE E-MAIL ADDRESS                       
*                                                                               
         AHI   RF,SRALSTLQ+1       CALCULATE ELEMENT LENGTH                     
         STC   RF,SRALLEN          NEW ELEMENT LENGTH                           
*                                                                               
LHVADDFD DS    0H                                                               
*                                                                               
         TM    FLDIIND,FINPTHIS    IF FIELD INPUT THIS TIME                     
...
*                                                                               
         ...
         MVC   ELTELEM,SRALELM     SET NEW ELEM IN TABLE                        
*                                  SET NEW ELTLAST                              
         ICM   R1,15,BSPNOR        NUMBER OF ENTRIES                            
         BZ    *+10                                                             
         BCTR  R1,R0                                                            
...
*                                                                               
         ...
         B     LHVERR0X            HANDLE FIELD IN ERROR                        
*                                                                               
         DROP  R4                                                               
         DROP  R3                                                               
         DROP  R2                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - VALIDATE CONTACT E-ADDRESS - LHDISLIN'                
***********************************************************************         
*                                                                     *         
...
LHDNAM   DS    0H                                                               
*                                                                               
         MVC   FLDDATA(L'SRALNAME),SRALNAME  DISPLAY CONTACT NAME               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BZ    LHDTYPX                                                          
*                                                                               
         MVC   FLDDATA(L'SRALTYPE),SRALTYPE  DISPLAY ADDRESS TYPE               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
*                                                                               
...
*                                                                               
         ...
         BZ    LHDSUPX                                                          
*                                                                               
         MVC   FLDDATA(L'SRALSUP),SRALSUP    DISPLAY (Y OR NULL)                
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
         OI    FLDOIND,FOUTTRN     TRANSMIT FIELD                               
*                                                                               
...
*                                                                               
         ...
         BNE   LHDFAXN                                                          
*                                                                               
         MVC   FLDDATA(3),SRALADDR AREA CODE                                    
         MVI   FLDDATA+3,C'-'                                                   
         MVC   FLDDATA+4(3),SRALADDR+3 EXCHANGE                                 
         MVI   FLDDATA+7,C'-'                                                   
         MVC   FLDDATA+8(4),SRALADDR+6 NUMBER                                   
*                                                                               
         B     LHDADR99                                                         
*                                                                               
LHDFAXN  DS    0H                                                               
*                                                                               
         ...
         EX    RF,*+8                                                           
         B     *+10                                                             
*NOP*    MVC   FLDDATA(L'SRALADDR),SRALADDR  DISPLAY ADDRESS                    
         MVC   FLDDATA(0),SRALADDR  DISPLAY ADDRESS                             
*                                                                               
LHDADR99 DS    0H                                                               
*                                                                               
         OI    FLDIIND,FINPVAL     INDICATE FIELD VALIDATED                     
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - VALIDATE CONTACT E-ADDRESS - LHWRTTAB'                
***********************************************************************         
*                                                                     *         
...
*                                                                               
         USING SRALSTD,R6          ESTABLISH LIST ELEMENT                       
*                                                                               
         CLI   SRALCDE,0           DONE IF EOR REACHED                          
         BE    LSWTDELD                                                         
*                                                                               
         CLI   SRALCDE,SRAEBIDQ    DELETE IF E-BASE ELEMENT                     
         BE    *+8                                                              
         CLI   SRALCDE,SRALIDQ     DELETE IF LIST ELEMENT                       
         BNE   LSWTDELC                                                         
*                                                                               
...
*                                                                               
         ...
         USING SRALSTD,R3          ESTABLISH LIST ELEMENT                       
*                                                                               
         CLI   SRALLEN,0           GET ELEMENT LENGTH                           
...
*                                                                               
         ...
         BNE   *+8                                                              
         OI    SVACH1,SRAAADD         SET RECORD ADDED                          
*                                                                               
*        ADD ACTIVITY ELEMENT                                                   
*                                                                               
         BRAS  RE,ACTPUT                                                        
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE 'PRSFM42 - AGENCY CONTACT E-ADDRESS - ACTPUT'                    
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         MVC   SRAASCID,SVSCID     SET CHANGER'S SECURITY PID                   
*                                                                               
         MVC   SRAACHGS,SVACHGS    SET ACTIVITY INDICATORS                      
*                                                                               
         L     R6,AIO              POINT TO RECORD FOR DISPLAY                  
         ST    R6,DMCB             PASS TO RECUP                                
         MVI   DMCB,C'P'           INDICATE PRINT SYSTEM                        
...
*                                                                               
         MVI   ELCODE,SRAAIDQ      LOOK FOR ACTIVITY ELM                        
         BRAS  RE,GETEL            FIND IN RECORD                               
*                                                                               
ACTPUTLP DS    0H                                                               
*                                                                               
...
*                                                                               
         CLC   SRAAPID,SRAAPID-SRAAELM(R6)  IF SAME PERSON                      
         BNE   ACTPUTCN                                                         
         CLC   SRAASCID,SRAASCID-SRAAELM(R6) IF SAME SCID                       
         BNE   ACTPUTCN                                                         
         CLC   SRAADTE,SRAADTE-SRAAELM(R6)  AND DATE                            
         BNE   ACTPUTCN                                                         
*                                                                               
         OC    SRAACHGS-SRAAELM(L'SRAACHGS,R6),SVACHGS UPDATE CHANGES           
*                                                                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - SFM AGENCY CONTACT LIST - ACTLMT'                     
***********************************************************************         
*                                                                     *         
...
*                                                                               
         MVI   ELCODE,SRAAIDQ      LOOK FOR ACTIVITY ELEM                       
         BRAS  RE,GETEL            FIND IN RECORD                               
...
*                                                                               
         DROP                                                                   
*                                                                               
         TITLE 'PRSFM42 - SFM AGENCY CONTACT LIST - PIDGET'                     
***********************************************************************         
*                                                                     *         
...
*                                                                               
         ...
         L     RE,=A(LSVTAB-T41CFFD) POINT TO START OF LINUP SAVEAREA           
         LA    RE,T41CFFD(RE)                                                   
...
LNTBLLS  DC    Y(SCRNAMLH-T41CFFD)  NAME LAST                                   
         ...
         LTORG                                                                  
*                                                                               
         TITLE 'PRSFM42 - VALIDATE CONTACT E-ADDRESS - SUBROUTS'                
***********************************************************************         
...
*                                                                               
         LTORG                                                                  
*                                                                               
         TITLE 'T41C42 AGENCY CONTACT LIST RECORDS - DSPFLD'                    
***********************************************************************         
*                                                                     *         
...
HEDSPECS DS    0H                                                               
         SPROG 0,1                                                              
         PSPEC H1,51,C'ESR AGENCY CONTACT LIST REPORT'                          
         PSPEC H2,51,C'------------------------------'                          
         PSPEC H1,95,AGYNAME                                                    
         PSPEC H2,95,AGYADD                                                     
         PSPEC H4,95,RUN                                                        
         ...
         PSPEC H6,1,C'CLT PRD PUB CODE        PUB NAME'                         
         PSPEC H7,1,C'--- --- --------        --------'                         
...
*                                                                               
SRAKSAVE DS    XL(L'SRAKEY)        KEY SAVEAREA                                 
SVEBASE  DS    XL(SRAEBLQ)         E-MAIL ELM SAVEAREA                          
SVACTELM DS    XL(SRAACTLQ)        ACTIVITY ELM SAVEAREA                        
...
ELTMAX   EQU   (3900/256)-1       MAX NUMBER OF ELEMENTS IN TABLE               
*                                                                               
...
PCNAME   DS    CL20                CONTACT NAME                                 
         DS    CL1                                                              
PCADDR   DS    CL61                CONTACT ADDRESS                              
         DS    CL1                                                              
         DS    CL1                                                              
...
ELTELEM  DS    CL(SRALSTLQ+79)     CONTACT ELEMENT                              
ELTABL   EQU   *-ELTABD            ENTRY LENGTH                                 
*                                                                               
         EJECT                                                                  
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004PRSFM42   03/16/09'                                      
         END                                                                    
