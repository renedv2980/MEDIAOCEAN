*          DATA SET TAGEN6A    AT LEVEL 048 AS OF 10/05/11                      
*PHASE T7026AC,*                                                                
         TITLE 'T7026A - TABLES FOR 1991 CONTRACTS'                             
T7026A   CSECT                                                                  
         DC    AL4(USETBLS-T7026A)                                              
         DC    AL4(USELUT-T7026A)                                               
         DC    AL4(MAJLUT-T7026A)                                               
         DC    AL4(AFMCOLS-T7026A)                                              
         DC    AL4(RADCOLS-T7026A)                                              
         DC    AL4(OFFCOLS-T7026A)                                              
         DC    AL4(ONCOLS-T7026A)                                               
         DC    AL4(MSWEET-T7026A)                                               
         DC    AL4(TAGFEE-T7026A)                                               
         EJECT                                                                  
...
MS8TAB   DC    AL1(09,16,0,0)      8-WEEK REUSE                                 
         ...
         DC    AL1(80),AL3(5850)                                                
         SPACE 2                                                                
MUSTAB92 DC    AL1(57,16,0,0)      REUSE                                        
         DC    F'6000'             CAST=1                                       
         DC    F'6485'                  2-4                                     
         DC    F'6000'                  5+                                      
         SPACE 3                                                                
BSMTAB92 DC    AL1(59,16,0,0)      SESSION                                      
         DC    F'8000'             CAST=1                                       
         DC    F'8645'                  2-4                                     
         DC    F'8000'                  5+                                      
         SPACE 3                                                                
MS8TAB92 DC    AL1(58,16,0,0)      8-WEEK REUSE                                 
         DC    AL1(80),AL3(6000)                                                
         DC    AL1(80),AL3(6485)                                                
         DC    AL1(80),AL3(6000)                                                
         EJECT                                                                  
...
*&&                                                                             
         ...
         DC    F'9260'                                                          
         SPACE 1                                                                
         DC    AL1(54,72,1,1)      TV TAGS - WITH 1 SESSION FEE                 
         DC    F'41425'                                                         
         DC    F'31150'                                                         
         DC    F'30325'                                                         
         DC    F'26845'                                                         
...
*                                                                               
         ...
         DC    AL1(09,UMUS,UMUSDSH8,ALL,0,0,0,ALL)    DUB TO SHRT 8WK           
...
*                                                                               
         ...
         DC    AL1(62,UFGR,UFGRWOR,ALL,0,0,0,TV)      WRD W/O UK&EUR            
...
*                                                                               
         DC    AL1(40,USNT,ALL,ALL,0,0,0,TV)          SPAN NWK                  
         DC    AL1(40,USNW,ALL,ALL,0,0,0,TV)          SPAN N/W COMB.            
         DC    AL1(10,USWS,ALL,ALL,0,0,0,TV)          SPAN WSP                  
*                                                                               
         DC    AL1(65,UADT,UADT3D,ALL,0,0,0,ALL)      AD SESS-TV-3D             
...
*                                                                               
         DC    AL1(62,UINR,UINR30D,ALL,0,0,0,TV)      TH/IND RE-30D             
...
******  USE NUMBERS 57-59 USED FOR 92 AFM CONTRACT                              
...
* TAGENFILE                                                                     
       ...
       ++INCLUDE TAGENFILE                                                      
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'048TAGEN6A   10/05/11'                                      
         END                                                                    
