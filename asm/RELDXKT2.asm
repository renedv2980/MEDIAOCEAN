*          DATA SET RELDXKT2   AT LEVEL 253 AS OF 05/01/02                      
*PHASE RELDXKT2                                                                 
*INCLUDE PRNTBL                                                                 
*INCLUDE PRINT                                                                  
         TITLE 'RELDXKT2 - LOAD/DUMP MODEL EXTERNAL ROUTINE'                    
* PARAMETER LIST                                                                
*                                                                               
...
*                                                                               
         CLC   =C'OT',0(R7)        KATZ CONTINENTAL CONVERTED?                  
         BE    DMXPURGE            YES - SKIP IT                                
         AP    10(5,R5),=P'1'      NO  - KEEP IT                                
         B     DMXKEEP                                                          
         EJECT                                                                  
*******************************************************************             
* END-OF-FILE LOGIC                                               *             
...
WORKX    EQU   *                                                                
       ...
       ++INCLUDE REGENSDD                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'253RELDXKT2  05/01/02'                                      
         END                                                                    
