*          DATA SET WBSIO      AT LEVEL 043 AS OF 05/01/02                      
*PHASE T00A4BA,*                                                                
...
WB38     MVC   WBCMP,CMPBFCMP      SET ACTIVE CAMPAIGN NUMBER                   
         ...
         UNPK  WBCMPEBC,DUB                                                     
*                                                                               
         ICM   R1,15,WBAMSBF       CLEAR MKTSTA BUFFER IF PRESENT               
         BZ    WB38X                                                            
         ICM   R0,15,WBLMSBF                                                    
         BZ    WB38X                                                            
         BAS   RE,CLRBUFF                                                       
...
*                                                                               
WB38X    CLC   WBQCLL(3),=C'ALL'   TEST ALL CELL REQ                            
         BE    WB39                                                             
...
* SINGLE CAMPAIGN REQUEST *                                                     
         ...
         CLC   IOKEY(13),IOKEYSAV                                               
         BE    BLDCM20                                                          
         CLI   WBQPRD,0           ALL PRODUCT REQUESTED - BUT CAN'T             
         BE    NEQXIT             FIND CAMPAIGN RECORD --- JUST EXIT            
*                                                                               
         DC    H'0'               MISSING CAMPAIGN RECORD FOR SINGLE            
...
* DDREPMASTD                                                                    
       ...
       ++INCLUDE DDREPMASTD                                                     
         ...
         SPACE 1                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'043WBSIO     05/01/02'                                      
         END                                                                    
