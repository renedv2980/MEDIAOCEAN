*          DATA SET NEBUY13    AT LEVEL 027 AS OF 05/17/18                      
*PHASE T31113B,+0                                                               
...
DEM2     BAS   RE,GETUNIT          GET THE UNIT RECORD                          
         ...
         OI    NBINDS,X'20'        ALWAYS SKIP GUARANTEE FACTORS                
         PRINT GEN                                                              
...
DEM3     OC    DEMS,DEMS                                                        
         BZ    DEMX                                                             
         BAS   RE,LOCKPACK                                                      
         BRAS  RE,LOOKDEM          LOOK UP RECORD VALUES                        
...
DEM3B    ST    RE,FADDR                                                         
         B     ERROR                                                            
*                                                                               
DEM3C    BRAS  RE,LOOKDEM          LOOK UP DEMO VALUES AGAIN                    
...
DEM4     BAS   RE,DISHEAD          DISPLAY HEADLINE FIELDS                      
         ...
         BZ    DEMX                                                             
         BAS   RE,DCAT                                                          
         BRAS  RE,LOOKDEM          LOOK UP DEMOS FOR SCREEN                     
...
*                                                                               
HO105    DS    0H                                                               
         TM    DEMFLAG,D2PRE       AGY IN 2 DEC PRECISION?                      
         BZ    HO106                                                            
         CLI   4(R3),X'02'         ESTIMATED IMPS?                              
         BE    HO120                                                            
         CLI   4(R3),X'82'         ACTUAL IMPS?                                 
         BE    HO120                                                            
*                                                                               
HO106    CLI   NBHUNOPT,C'Y'       HUNDREDS OPTION                              
         BE    HO120                                                            
*                                                                               
...
*                                                                               
         TM    DEMFLAG,D2PRE       AGY IN 2 DEC PRECISION?                      
         BZ    DS215                                                            
         CLI   VALMOD,C'T'         IMPRESSIONS?                                 
         BE    DS220               IF IT IS, DISPLAY WITH 1 DEC                 
*                                                                               
DS215    DS    0H                                                               
         TM    VALDIS,X'02'                                                     
         BZ    *+12                                                             
...
*                                                                               
         ...
         BE    DS220                                                            
*                                                                               
DS216    EDIT  (R0),(6,8(R2)),ALIGN=LEFT,ZERO=BLANK                             
         B     DS300                                                            
*                                                                               
...
OVER4B   CLI   THREE+1,USERMOD     TEST FOR USER DEMO                           
         ...
         SPACE 1                                                                
OVER5    BAS   RE,ENCDUB                                                        
OVER5A   GOTO1 VHELLO,DMCB,(C'D',UNTFILE),(ELCODE,AIOAREA1),(BYTE,DUB)          
         CLI   THREE+1,USERMOD     TEST FOR USER DEMO                           
         BE    OVER5E                                                           
*                                                                               
         CLI   VALMOD,C'T'                                                      
...
*                                                                               
         ...
         CLI   NBHUNOPT,C'Y'                                                    
         BNE   OVER6A                                                           
         CLI   DUB+2,C'T'          IS IMPRESSIONS                               
         BNE   OVER6A                                                           
         MVI   DUB+2,C'H'          CHANGE TO HUNDREDS                           
         BAS   RE,ENCDUB                                                        
OVER6A   MVC   NUOVZER(4),DUB                                                   
         STCM  R2,15,NUOVVAL                                                    
         BAS   RE,SETPRE                                                        
...
*                                                                               
         ...
         TM    DEMFLAG,D2PRE       AGY IN 2 DEC PRECISION?                      
         BZ    GT615                                                            
         CLI   1(R5),X'00'         SHOULD ONLY ALLOW 0 FOR ACTUAL               
         BNE   GETVERR             IMPRESSIONS                                  
         B     GT620                                                            
*                                                                               
GT615    TM    VALEDIT,X'01'       TEST IF DECIMAL POINT ALLOWED                
         BZ    GETVERR             NO                                           
GT620    ZIC   R1,FLDH+5                                                        
...
*                                                                               
IMPPRE   DS    X                   PRECISSION OF IMPRESSION                     
*                                                                               
...
NETUNIVD DSECT                                                                  
       ...
       ++INCLUDE NETBLKXTND                                                     
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'027NEBUY13   05/17/18'                                      
         END                                                                    
