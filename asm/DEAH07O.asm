*          DATA SET DEAH07O    AT LEVEL 025 AS OF 02/02/09                      
*PHASE DEAH07OA                                                                 
*--------------------------------------------------------------------*          
...
* OPHASE: DEAH07O                                                               
*--------------------------------------------------------------------*          
         TITLE 'DEMO CONVERSION - NTHI GENERAL MKTS OUTPUT PHASE'               
DEAH07O  CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 NADWRKX-NADWRKD,DEAH07O,R7                                       
...
BLDELEM  DS    0H                                                               
*                                                                               
         BRAS  RE,BLDELD           BUILD DESCRIPTIVE ELEMENTS                   
*                                                                               
BLDEL27  LA    R5,DBLOCKA          BUILD DEMO ELEMENTS                          
         USING DBLOCKD,R5                                                       
         XC    DBLOCK,DBLOCK                                                    
         MVC   DBFILE,=C'NAD'                                                   
         L     RE,AOREC                                                         
...
SVHUT    NTR1                                                                   
         ...
         BE    SVHUT10                                                          
         CLC   PREVKEY(8),=C'PN1UUUUH'   GET HOMES UNIV FROM RECD               
         BE    SVHUT10                                                          
         CLC   PREVKEY(8),=C'PN7UUUUH'   GET HOMES UNIV FROM RECD               
         BE    SVHUT10                                                          
*                                                                               
...
CNV30    L     R1,ACOMWRK          ADDRESS OF COMMON WORK AREA                  
         ...
         BE    CNV45                                                            
         CLC   PREVKEY(8),=C'PW1HUT H'  SAVE WEEKLY HUTS IN BUFFER              
         BE    CNV45                                                            
         CLC   PREVKEY(8),=C'PW7HUT H'  SAVE WEEKLY HUTS IN BUFFER              
         BE    CNV45                                                            
         CLC   PREVKEY(8),=C'PNNHUT H'                                          
         BE    CNV40                                                            
         CLC   PREVKEY(8),=C'PN1HUT H'                                          
...
*                                                                               
         CLI   DBSELBK,YR_2007    HAVE ALL STREAMS AFTER 2007                   
         BL    GETSUM1X                                                         
...
*                                                                               
         ...
         BE    BLDEL27X            BYPASS IF NO EPISODE PRESENT                 
...
* DEDEMTABD                                                                     
       ...
       ++INCLUDE DDMONYREQU                                                     
         ...
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'025DEAH07O   02/02/09'                                      
         END                                                                    
