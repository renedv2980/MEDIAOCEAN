*          DATA SET REATHNACRT AT LEVEL 152 AS OF 05/01/02                      
*PHASE REATNCRA,*                                                               
*INCLUDE REGSAVE                                                                
*INCLUDE STXITER                                                                
*INCLUDE PDUMPER                                                                
...
*                                                                               
         MVI   TRACE,C'Y'          ELSE - SET THE 'TRACE RUN' FLAG              
...
*                                                                               
         CLC   KEY+11(2),OFFICE    FOR REQUESTED OFFICE?                        
...
*                                                                               
         ...
         BNE   AT230                                                            
         XC    REJSTA,REJSTA                                                    
         ZIC   RE,KEY+10           NOT EQUAL TO MEDIA SKIP STATION              
         LA    RE,1(RE)                                                         
         STC   RE,KEY+10                                                        
         XC    KEY+11(16),KEY+11                                                
         B     AT120                                                            
...
AT230    OC    MED,MED                                                          
         ...
         CLI   KEY+10,C' '                                                      
         BE    AT300                                                            
         ZIC   RE,KEY+9            NOT EQUAL TO MEDIA SKIP STATION              
         LA    RE,1(RE)                                                         
         STC   RE,KEY+9                                                         
         MVI   KEY+10,C' '                                                      
         XC    KEY+11(16),KEY+11                                                
         B     AT120                                                            
*                                                                               
AT240    CLI   KEY+10,C' '         BLANK = TV ALL OTHERS RADIO                  
         BNE   AT300                                                            
         ZIC   RE,KEY+10           NOT EQUAL TO MEDIA SKIP MEDIA                
         LA    RE,1(RE)                                                         
         STC   RE,KEY+10                                                        
         XC    KEY+11(16),KEY+11                                                
         B     AT120                                                            
...
RB200    LR    R3,R2                                                            
         MVC   BFDPT(2),0(R2)                                                   
RB220    ZIC   R5,2(R2)            # OF TIMES THIS DPT                          
         LA    R2,3(R2)                                                         
RB240    ZIC   RE,0(R2)                                                         
...
*                                                                               
* LOOK FOR MAKEGOOD/CREDIT ELELMENTS                                            
...
*        BNE   AA600                                                            
AA520    GOTO1 =V(PRNTBL),DMCB,(0,(R4)),(R4),C'DUMP',(R3),=C'2D'                
*                                                                               
...
RECLN    DS    F                                                                
REC      DS    1024C               IOAREA                                       
REC2     DS    2008C               2ND IOAREA FOR CONTRACT RECORD               
REP      DS    CL2                 REP CODE                                     
MED      DS    CL1                 MEDIA                                        
...
* REGENCON                                                                      
       ...
       ++INCLUDE REGENCON                                                       
         ...
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'152REATHNACRT05/01/02'                                      
         END                                                                    
