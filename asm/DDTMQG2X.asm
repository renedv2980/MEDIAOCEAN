*          DATA SET DDTMQG2X   AT LEVEL 042 AS OF 05/01/02                      
DDTMQG2  TITLE 'MQSERIES TEST PROGRAM - GET MESSAGES FROM QUEUE'                
*PHASE DDTMQG2A                                                                 
***********************************************************************         
*                                                                     *         
* MODULE NAME    : DDTMQG2                                            *         
...
DDTMQG2  CSECT                                                                  
DDTMQG2  AMODE 31                                                               
         NBASE WORKX-WORKD,**MQG1**,WORK=A(WORKC),RA,CLEAR=YES                  
         USING WORKD,RC                                                         
*                                                                               
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'042DDTMQG2X  05/01/02'                                      
         END                                                                    
