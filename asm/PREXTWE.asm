*          DATA SET PREXTWE    AT LEVEL 044 AS OF 05/01/02                      
*PHASE PREXTWE,+0                                                               
*INCLUDE BINSRCH                                                                
*INCLUDE HEXOUT                                                                 
*INCLUDE RECUP                                                                  
...
DMXREC   DS    0H                                                               
         ...
         USING PBUYRECD,R3                                                      
*                                                                               
         CLC   0(3,R3),=C'WIN'     ONLY CHECK AGENCY WESTERN (NEWS..)           
         BNE   DMXKEEP                                                          
         CLI   3(R3),X'20'         SEE IF BUYREC                                
         BNE   DMXKEEP                                                          
*                                                                               
         CLC   4(3,R3),=C'BMO'     CHECK CLIENT                                 
         BE    DMXR10                                                           
         CLC   4(3,R3),=C'BMD'     CHECK CLIENT                                 
         BE    DMXR10                                                           
         CLC   4(3,R3),=C'LA2'     CHECK CLIENT                                 
         BNE   DMXKEEP                                                          
DMXR10   CLI   16(R3),X'62'       SEE IF BEFORE 1998                            
         BL    DMXKEEP                                                          
         CLI   14(R3),X'40'       CHECK FOR ZONE ABOVE 40                       
         BNH   DMXKEEP                                                          
         MVI   14(R3),0           CHANGE ZONE TO ZERO                           
         AP    CHGCOUNT,=P'1'                                                   
         BAS   RE,DDSTRACE                                                      
         B     DMXKEEP                                                          
         EJECT                                                                  
...
*                                                                               
         GOTO1 =V(HEXOUT),DMCB,PBUYREC,HEXBLOCK,28,=C'SEP'                      
         MVC   P+30(28),HEXBLOCK                                                
         GOTO1 VPRINTER                                                         
*                                                                               
         MVC   P+30(28),HEXBLOCK+28                                             
         GOTO1 VPRINTER                                                         
*                                                                               
*****    MVC   P(116),PBDELEM                                                   
*****    GOTO1 VPRINTER                                                         
...
*DDDPRINT                                                                       
       ++INCLUDE DDDPRINT                                                       
         SPACE 2                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'044PREXTWE   05/01/02'                                      
         END                                                                    
