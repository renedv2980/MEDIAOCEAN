*          DATA SET ACREPPT02  AT LEVEL 003 AS OF 05/01/02                      
*PHASE ACPT02A                                                                  
*INCLUDE UNDERLIN                                                               
         TITLE 'ACPT02 - PST REPORT'                                            
*                                                                               
ACPT02   CSECT                                                                  
         PRINT NOGEN                                                            
         NMOD1 000,**ACPT**                                                     
...
*                                                                               
         ZAP   THISPST,TRPST       BUMP TRAN TOTALS INTO ACCUMS                 
         ZAP   THISNET,TRNET                                                    
         BAS   RE,ROLLIT                                                        
         CLI   QOPT1,C' '                                                       
         BE    EXIT                                                             
...
ROLLIT   NTR1                                                                   
         ...
         LA    RE,3                                                             
*                                                                               
ROL020   AP    0(8,RF),THISPST     TRNAMNT                                      
...
*                                                                               
         ...
         AP    0(8,RF),THISPST                                                  
         AP    8(8,RF),THISNET                                                  
         AP    0(8,RE),THISPST     SAVE TOTALS FOR DIFF REPORT                  
         AP    8(8,RE),THISNET                                                  
         ZAP   THISPST,=P'0'                                                    
         ZAP   THISNET,=P'0'                                                    
         B     EXIT                                                             
...
FORMAT1  MVCDD P+60(13),AC#NIL,R                                                
         ...
         BE    FORMAT2                                                          
         CURED (P8,0(R2)),(14,P+75),2,MINUS=YES THISPST                         
         B     *+10                                                             
FORMAT2  MVCDD P+75(13),AC#NIL,R                                                
         ...
         BE    FORMAT3                                                          
         ZAP   PCT,0(8,R2)         PST                                          
         SRP   PCT,5,0             PST *100(%) *100(2.DP) *10 ROUND             
         DP    PCT,8(8,R2)         NET                                          
...
*                                                                               
REPORT   NTR1                                                                   
         MVC   HEAD1+51(21),=C'PST HISTORICAL REPORT'                           
         MVC   HEAD2+51(21),=C'---------------------'                           
         CLI   QOPT1,C' '                                                       
         BE    REPRYT                                                           
*                                                                               
         CLI   QOPT1,C'D'                                                       
         BNE   *+16                                                             
         MVC   HEAD1+51(21),=C'  PST DETAIL REPORT  '                           
         MVC   HEAD2+51(21),=C'  -----------------  '                           
*                                                                               
         CLI   QOPT1,C'T'                                                       
         BNE   *+16                                                             
         MVC   HEAD1+48(25),=C'PST CONTRA SUMMARY REPORT'                       
         MVC   HEAD2+48(25),=C'-------------------------'                       
*                                                                               
         CLI   MODE,REQLAST                                                     
         BE    REPRYT                                                           
...
*                                                                               
TOTLYN   NTR1                                                                   
         MVC   P+2(20),=C'TOTAL FOR PST OUTPUT'                                 
         LA    R2,ACCRQCR                                                       
         TM    RCSUBPRG,DEBIT                                                   
         BZ    *+14                                                             
         MVC   P+2(20),=C'TOTAL FOR PST INPUT '                                 
         LA    R2,ACCRQDR                                                       
         BAS   RE,FORMAT                                                        
         B     EXIT                                                             
         EJECT                                                                  
...
*                                                                               
         USING SCIELD,R1                                                        
         CLI   SCITYPE,SCITTQST    GROSS PST                                    
         BNE   SVTR20                                                           
         ZAP   TRNET,SCIAMNT                                                    
*                                                                               
         ZAP   TRPST,TRNAMNT       SET AMOUNT IF POSTING IS FOR PST             
         DROP  R1                                                               
*                                                                               
SVTR30   B     EXIT                                                             
         EJECT                                                                  
...
THISPST  DS    PL6                                                              
THISNET  DS    PL6                                                              
PCT      DS    PL16                PERCENTAGE OF PST TO NET                     
*                                                                               
DIFRQCR  DS    2PL8                                                             
DIFRQDR  DS    2PL8                                                             
DIFFBUCK DS    2PL8                                                             
...
*        ACDDEQUS                                                               
       ...
       ++INCLUDE ACDDEQUS                                                       
         PRINT ON                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'003ACREPPT02 05/01/02'                                      
         END                                                                    
