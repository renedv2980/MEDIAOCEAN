*          DATA SET RESFM07    AT LEVEL 034 AS OF 05/01/02                      
*PHASE T81807A,*                                                                
         TITLE 'T81807 - RESFM07 - ATHENA REPORT'                               
*                                                                               
*******************************************************************             
*                                                                 *             
*        RESFM07 (T81807) --- ATHENA REPORT                       *             
*                                                                 *             
* --------------------------------------------------------------- *             
* UPDATE HISTORY:                                                 *             
*                                                                 *             
...
*                                                                 *             
* 08OCT90  (EFJ) --- CHANGE LABEL MANYLEN TO MNYLEN TO AVOID      *             
*                    CONFLICT WITH LABEL IN RESFMWORKD            *             
*                                                                 *             
* 29JUN93  (BU ) --- FIX FILTERING ON GROUP ONLY                  *             
*                                                                 *             
*                                                                 *             
*******************************************************************             
*                                                                               
...
VK40     MVC   2(10,R1),SGROUPN    SUB GROUP NAME                               
         ...
         CLI   5(R2),0                                                          
         BE    VK60                                                             
         LA    R2,PSRGRPH          POINT AT GROUP FIELD FOR ERROR               
         B     VKGRPER                                                          
         SPACE 1                                                                
*                              ********************************                 
*                              *        VALIDATE              *                 
...
*                       ****************************************                
*                       *            VALIDATE FILTERS          *                
*                       *  S=RTG SVC, C=CAT, A=ADV, DEFAULT=ALL*                
*                       ****************************************                
VK650    LA    R2,PSRFLTH                                                       
         MVI   FILTER,1                                                         
         CLI   5(R2),0                                                          
...
VK660    EX    RE,CLCSCAN                                                       
         B     *+10                                                             
CLCSCAN  CLC   0(0,RF),22(R4)                                                   
         BE    VK680                                                            
         CLI   0(RF),X'FF'                                                      
         BNE   VK670                                                            
         MVC   CONHEAD+10(15),=C'INVALID SERVICE'                               
         B     MYEND                                                            
         SPACE 1                                                                
VK670    LA    RF,L'SVCTBL(RF)                                                  
         B     VK660                                                            
         SPACE 1                                                                
VK680    MVC   TYPCODE(1),22(R4)                                                
         MVI   FILTER,2                                                         
         B     VK800                                                            
         SPACE 2                                                                
*                                  CATEGORY                                     
VK690    CLI   12(R4),C'C'                                                      
         ...
         CLC   KEY(27),KEYSAVE                                                  
         BE    VK700                                                            
         MVC   CONHEAD+10(16),=C'INVALID CATEGORY'                              
         B     MYEND                                                            
         SPACE 1                                                                
VK700    MVI   FILTER,3                                                         
         MVC   TYPCODE(2),22(R4)                                                
...
*                                                                               
*                                  ADVERTISER                                   
VK710    CLI   12(R4),C'A'     INPUT IS ADVERTISER CODE                         
         BE    VK720                                                            
         MVI   ERROR,INVALID                                                    
         B     ERREND                                                           
         SPACE 1                                                                
VK720    XC    KEY,KEY                                                          
         ...
         CLC   KEY(27),KEYSAVE                                                  
         B     VK780                                                            
         MVC   CONHEAD+10(18),=C'INVALID ADVERTISER'                            
         B     MYEND                                                            
         SPACE 1                                                                
VK780    MVI   FILTER,4                                                         
         MVC   TYPCODE(4),KEY+21         FILL IN ADVERTISER                     
         MVC   TYPCODE+4(3),SPACES       SPACES FOR PRODUCT                     
         SPACE 1                                                                
VK800    L     R5,SVFOOTF                                                       
         MVC   0(2,R5),=C'F='                                                   
         LA    R5,2(R5)                                                         
...
*                                                                               
         ...
         BNE   PR25                YES                                          
         CLC   KEY(4),KEYSAVE      NO  - CHECK THRU GROUP ONLY                  
         BNE   PR500                                                            
         B     PR27                                                             
PR25     EQU   *                                                                
         CLC   KEY(5),KEYSAVE     ID/REP/GROUP                                  
         BNE   PR500                                                            
*                                                                               
PR27     EQU   *                                                                
...
*                                                                               
         ...
         BZ    PR60                NO                                           
*                                                                               
PR30     CLC   KEY+ATPEE(10),FILTER    CORRECT FILTER AND CODE                  
         BE    PR40                    YES                                      
         BH    PR60                    MOVE TO NEXT STATION                     
         MVC   KEY+ATPEE(10),FILTER    MAYBE WE CAN FIND IT                     
...
PR60     ZIC   RF,KEY+ASTAE+4      MOVE ON TO NEXT STATION                      
         ...
         B     PR20                                                             
*                                                                               
PR70     MVC   KEY+ASTAE(15),STATN     STATION,RECORD TYPE/SVC/CTG/ADV          
*                                                                               
...
PR157    EQU   *                                                                
         OC    STATN,STATN                                                      
         BNZ   PR160                                                            
         CLC   KEY+ASTAE(15),KEYSAVE+ASTAE   SAME STATION/FILTER/CODE           
         BNE   PR60                                                             
         B     PR170                                                            
*                                                                               
PR160    CLC   KEY+ASTAE(15),STATN     CORRECT STATION/FILTER/CODE              
         BNE   PR500                                                            
         SPACE 1                                                                
* FILTER RECORDS                                                                
...
PR310    OC    SVKEY,SVKEY                                                      
         ...
         B     PR380                                                            
         SPACE 1                                                                
PR315    CLC   SVKEY(10),KEY        STATION CHANGED                             
         BE    PR320                                                            
         BAS   RE,SUM1                                                          
         BAS   RE,SUM2                                                          
         BAS   RE,SUM3                                                          
         ...
         B     PR380                                                            
*                                                                               
PR320    CLC   SVKEY(21),KEY       DPT CHANGED                                  
         BE    PR340                                                            
         BAS   RE,SUM1                                                          
         BAS   RE,SUM2                                                          
         B     PR380                                                            
*                                                                               
PR340    CLC   SVKEY(22),KEY       SUB DPT CHANGED                              
         BE    PR350                                                            
         BAS   RE,SUM1                                                          
         B     PR380                                                            
*                                                                               
PR350    CLC   SVKEY(23),KEY       PROGRAM TYPE CHANGED                         
         BE    PR400                                                            
         BAS   RE,SUM2                                                          
*                                                                               
...
*                                                                               
PR460    GOTO1 BUFFALO,DMCB,=C'PUT',(0,ADBUFC),BUFREC                           
         SPACE 2                                                                
*                                                                               
...
*                                                                               
PS50     GOTO1 BUFFALO,DMCB,=C'HIGH',(BUFTYP,ADBUFC),BUFREC,1                   
         TM    DMCB+8,X'80'                                                     
...
*                                                                               
PS150    SR    RE,RE               KEEP ACCUMS FOR 1 LINE TOTAL                 
         ICM   RE,15,TOTUN                                                      
         A     RE,BUFUN                                                         
         STCM  RE,15,TOTUN                                                      
*                                                                               
...
*                                                                               
*                                                                               
PS450    CLI   TOTPRNT,C'Y'        ANYTHING TO PRINT FOR THIS LEVEL             
         BNE   PS460                                                            
         CLI   REPTYP,C'L'                                                      
         BNE   *+10                                                             
         MVC   PLEN(4),=C'TOT*'                                                 
...
CQ20     CLI   EMONTH+1,3          AND END WITH MARCH                           
         ...
         BE    CQ40                                                             
CQERR    LA    R2,PSRPERH          POINT CURSOR TO PERIOD                       
...
*                                                                               
         SR    RE,RE                                                            
         ICM   RE,15,UNACCM         UNITS (SPOTS)                               
         AH    RE,4(R6)                                                         
         STCM  RE,15,UNACCM                                                     
*                                                                               
         ICM   RE,15,DLACCM        DOLLARS                                      
         A     RE,6(R6)                                                         
         STCM  RE,15,DLACCM                                                     
*                                                                               
         B     GU20                                                             
...
BUFDL    DS    F                                                                
*                                                                               
AREPE    EQU   RATNKREP-RATNKEY    REP                                          
AGRPE    EQU   RATNKGRP-RATNKEY    GROUP                                        
ASTAE    EQU   RATNKSTA-RATNKEY    STATION                                      
ATPEE    EQU   RATNKTPE-RATNKEY    RECORD TYPE (FILTER)                         
ATCPE    EQU   RATNKTCD-RATNKEY    TYPE CODE                                    
ASERE    EQU   RATNKSER-RATNKEY    SERVICE                                      
ACATE    EQU   RATNKCAT-RATNKEY    CATEGORY                                     
APRDE    EQU   RATNKPRD-RATNKEY    ADVERTISER (WAS ADV/PRODUCT)                 
ADPTE    EQU   RATNKDPT-RATNKEY    DAYPART                                      
ASDTE    EQU   RATNKSDT-RATNKEY    SUB DAYPART                                  
APRGE    EQU   RATNKPRG-RATNKEY    PROGRAM CODE                                 
ASLNE    EQU   RATNKSLN-RATNKEY    SPOT LENGTH                                  
AYME     EQU   RATNKYM-RATNKEY     YEAR/MONTH                                   
*                                                                               
         EJECT                                                                  
T81807   CSECT                                                                  
         LTORG                                                                  
...
*TVB TABLE                                                                      
       ++INCLUDE RETVBTAB                                                       
         SPACE 3                                                                
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'034RESFM07   05/01/02'                                      
         END                                                                    
