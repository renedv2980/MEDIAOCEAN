*          DATA SET SPSDE00S   AT LEVEL 008 AS OF 11/21/02                      
*PHASE T23100A                                                                  
*INCLUDE TWABLD                                                                 
...
*                                                                               
         L     RF,CSECRET                                                       
         GOTO1 (RF),DMCB,('SECPINIT',ASECBLK)                                   
         BE    *+6                                                              
         DC    H'0'                                                             
*                                                                               
         DROP  R1                                                               
...
*                                                                               
         ...
         DC    H'00'                                                            
*                                                                               
         EX    R5,*+4              STORE COMMENT IN SVATHCM AFTER               
         MVC   0(0,RE),0(R4)       OTHER COMMENTS                               
         B     RCV10                                                            
*                                                                               
...
*                                                                               
         ...
         EX    R5,*+4                    STORE ATTACHMENT FILENAME              
         MVC   1(0,R2),0(R4)                                                    
         B     RCV10                                                            
*                                                                               
...
*                                                                               
         NI    FLAG2,X'FF'-ALLMKTS-MKTSNT  CLEAR FLAGS                          
...
MKTRECD  DSECT                                                                  
       ++INCLUDE SPGENMKT                                                       
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'008SPSDE00S  11/21/02'                                      
         END                                                                    
