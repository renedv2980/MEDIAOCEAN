*          DATA SET SPREPIF02  AT LEVEL 004 AS OF 05/01/02                      
*PHASE SPIF02A                                                                  
*INCLUDE BINSRCH2                                                               
*INCLUDE COVAIL                                                                 
         TITLE 'SPIF02 - CHECK INVOICE MATCH STATUS RECS'                       
         SPACE 2                                                                
***********************************************************************         
*        QOPT1    E=TABLE ENTRY ONLY IF ERROR                                   
*        QOPT2    Y=GENERATE I2 REQUESTS                                        
*                                                                               
*        NOTE- THIS PROGRAM TAKES CARE OF                                       
*              - NO STATUS REC ERRORS (NS)                                      
*              - STATUS AND INVOICE UNEQUAL (NEQ)                               
*              OTHER ERRORS DEALT WITH IN SPREPIF02D                            
*                                                                               
***********************************************************************         
         SPACE 2                                                                
SPIF02   CSECT                                                                  
...
**********************************************************************          
*                                                                               
         B     MLP08           ****NOOP LIST OF STATUS RECS                     
         MVI   FORCEHED,C'Y'                                                    
         MVC   P,SPACES                                                         
...
*                                                                               
MLP12    DS    0H                                                               
         B     MLP10               ALWAYS EXCLUDE POL AND EST=000               
*                                                                               
MLP14    DS    0H                                                               
...
*                                                                               
         ...
         CLI   DMCB+8,0                                                         
         BNE   MLP10               SKIP IF STATION NO GOOD                      
*                                                                               
         PACK  DUB,SMKT                                                         
         CVB   R0,DUB                                                           
         STH   R0,HLDMKT                                                        
...
*                                                                               
         LA    R2,MINMKEY                                                       
*                                                                               
         B     MLP71           ****NOOP LIST OF STATUS RECS                     
         BAS   RE,FMTMST                                                        
         GOTO1 REPORT                                                           
*                                                                               
MLP71    DS    0H                                                               
...
*                                                                               
*                                                                               
         B     IRP71           ****NOOP LIST OF INVOICE RECS                    
         MVI   FORCEHED,C'Y'                                                    
         MVC   P(12),=C'**INVOICES**'                                           
         MVI   RPTSW,C'I'                                                       
         GOTO1 REPORT                                                           
...
*                                                                               
         GOTO1 DATAMGR,DMCB,=C'DMREAD',=C'STATION',SREC,SREC                    
         CLI   DMCB+8,0                                                         
         BNE   IRP75             SKIP IF STATION NO GOOD                        
*                                                                               
         PACK  DUB,SMKT                                                         
         CVB   R0,DUB                                                           
         STH   R0,HLDMKT                                                        
...
IRP73    DS    0H                                                               
         USING SNVHDELD,R6                                                      
*                                                                               
         BAS   RE,IRPEST           SET HLDEST FROM HEAD OR DETAIL               
*                                                                               
         CLI   SNVHDPRD,0          SKIP POL, ETC.                               
         BE    IRP73B                                                           
         CLI   SNVHDPRD,X'FF'                                                   
         BE    IRP73B                                                           
         CLI   HLDEST,0                                                         
...
*                                                                               
IRP73B   DS    0H                                                               
         B     IRP75               ALWAYS SKIP POL AND EST=0                    
*                                                                               
IRP73C   DS    0H                                                               
*                                                                               
         B     IRP73D          ****NOOP LIST OF INV RECS                        
         BAS   RE,FMTINV                                                        
         GOTO1 REPORT                                                           
*                                                                               
IRP73D   DS    0H                                                               
...
**********************************************************************          
*                                                                               
IRPEST   DS    0H                  SET HLDEST FROM HEAD OR DETAIL               
...
*                                                                               
RPT06    DS    0H                                                               
         CLC   STISTAT(2),=C'ZZ'   FOR ZERO STATUS+INV                          
         BNE   RPT06A4                                                          
         TM    SCTSTAT,X'80'       IF HAVE STATUS REC                           
         BZ    RPT20               NO, SKIP IT                                  
         B     RPT06A6                                                          
*                                                                               
RPT06A4  DS    0H                                                               
         ...
         BNE   RPT06B                                                           
         CLC   SCTHOME,SCTMKT      OR NON-HOME MARKET                           
         BNE   RPT20               (NO LONGER PRINT NON-HOMES)                  
         CLI   SCTIPST,C'Y'        NOT IF PAID???                               
         BE    RPT06B                                                           
*                                                                               
RPT06A6  DS    0H                                                               
...
*                                                                               
         MVI   CKRCARD+64,C'S'     SET QOPT4=S (SUMMARIES ONLY)                 
*                                                                               
...
*                                                                               
         ...
         BE    RPT10                                                            
         CLC   STISTAT(3),=C'NEQ'                                               
         BNE   RPT20               SKIP OTHERS (THEY GET DELETED)               
*                                                                               
RPT10    DS    0H                                                               
         PUT   (R1),CKRCARD                                                     
*                                                                               
...
*                                                                               
         MVI   LININV+7,C'0'       ZERO SPOTS                                   
         TM    SCTSTAT,X'80'                                                    
         BNZ   *+8                                                              
         MVI   LININV+7,C'*'      * IF NO RECORD                                
         OC    SCTMSPTS,SCTMSPTS                                                
         BZ    FT5                                                              
         EDIT  (B4,SCTMSPTS),(8,LININV+00),ZERO=NOBLANK                         
*                                                                               
FT5      DS    0H                                                               
         EDIT  (B4,SCTMGRS),(9,LININV+09),2,ZERO=NOBLANK                        
         MVI   LININV+27,C'0'       ZERO SPOTS                                  
         TM    SCTSTAT,X'40'                                                    
         BNZ   *+8                                                              
         MVI   LININV+27,C'*'      * IF NO RECORD                               
         OC    SCTISPTS,SCTISPTS                                                
         BZ    FT5B                                                             
...
*                                                                               
**PAN#1  CSECT                                                                  
**PAN#1  DC    CL21'004SPREPIF02 05/01/02'                                      
         END                                                                    
